...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class ScreenMap : EntityTypeConfiguration<POCO.Screen>
    {
        ...
        { 
            ...
            this.Property(t => t.SortedByFieldCode).HasColumnName("SortedByFieldCode").IsRequired().HasMaxLength(0).IsUnicode(false);

            this.Property(t => t.SortedType).HasColumnName("SortedType").IsRequired().HasMaxLength(0).IsUnicode(false);

            this.Property(t => t.SearchFields).HasColumnName("SearchFields").IsRequired().HasMaxLength(0).IsUnicode(false);

            this.Property(t => t.RelatedScreenCode).HasColumnName("RelatedScreenCode").IsRequired().HasMaxLength(0).IsUnicode(false);
