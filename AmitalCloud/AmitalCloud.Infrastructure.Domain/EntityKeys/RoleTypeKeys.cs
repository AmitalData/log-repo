...
{
   public class RoleTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.RoleType,T> 
   {
		public RoleTypeKeys() : base() {}
        public RoleTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "RoleTypesPM";
	  public override Expression<Func<EntityPOCOs.RoleType, bool>> Predicate => a => a.Code == Code;
   }
}
