...
{
   public class ImageLibraryKeys<T> : BaseEntityKeyFields<ENTITIES.ImageLibrary,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ImageLibrary, bool>> Predicate => a => a.Id == Id;
   }
}
