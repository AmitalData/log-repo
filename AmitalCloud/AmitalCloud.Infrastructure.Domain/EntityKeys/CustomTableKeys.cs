...
{
   public class CustomTableKeys<T> : BaseEntityKeyFields<ENTITIES.CustomTable,T> 
   {
		public CustomTableKeys() : base() {}
        public CustomTableKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CustomTablesPM";
	  public override Expression<Func<ENTITIES.CustomTable, bool>> Predicate => a => a.Id == Id;
   }
}
