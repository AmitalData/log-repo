...
{
   public class PaymentChannelKeys<T> : BaseEntityKeyFields<ENTITIES.PaymentChannel,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PaymentChannel, bool>> Predicate => a => a.Code == Code;
   }
}
