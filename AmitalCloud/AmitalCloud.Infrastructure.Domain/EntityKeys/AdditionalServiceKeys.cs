...
{
   public class AdditionalServiceKeys<T> : BaseEntityKeyFields<ENTITIES.AdditionalService,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.AdditionalService, bool>> Predicate => a => a.Id == Id;
   }
}
