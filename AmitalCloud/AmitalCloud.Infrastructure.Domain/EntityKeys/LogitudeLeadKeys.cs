...
{
   public class LogitudeLeadKeys<T> : BaseEntityKeyFields<ENTITIES.LogitudeLead,T> 
   {
		public LogitudeLeadKeys() : base() {}
        public LogitudeLeadKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "LogitudeLeadsPM";
	  public override Expression<Func<ENTITIES.LogitudeLead, bool>> Predicate => a => a.Id == Id;
   }
}
