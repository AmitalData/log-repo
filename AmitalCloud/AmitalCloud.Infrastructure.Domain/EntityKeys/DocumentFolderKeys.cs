...
{
   public class DocumentFolderKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentFolder,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentFolder, bool>> Predicate => a => a.Id == Id;
   }
}
