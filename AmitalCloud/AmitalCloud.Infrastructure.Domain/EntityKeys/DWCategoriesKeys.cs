...
{
   public class DWCategoriesKeys<T> : BaseEntityKeyFields<ENTITIES.DWCategories,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DWCategories, bool>> Predicate => a => a.Code == Code;
   }
}
