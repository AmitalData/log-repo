...
{
   public class ContactTenantKeys<T> : BaseEntityKeyFields<ENTITIES.ContactTenant,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ContactTenant, bool>> Predicate => a => a.Id == Id;
   }
}
