...
{
   public class BIReportFolderKeys<T> : BaseEntityKeyFields<ENTITIES.BIReportFolder,T> 
   {
		public BIReportFolderKeys() : base() {}
        public BIReportFolderKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "BIReportFoldersPM";
	  public override Expression<Func<ENTITIES.BIReportFolder, bool>> Predicate => a => a.Id == Id;
   }
}
