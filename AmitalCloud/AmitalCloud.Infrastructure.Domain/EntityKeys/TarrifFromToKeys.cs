...
{
   public class TarrifFromToKeys<T> : BaseEntityKeyFields<ENTITIES.TarrifFromTo,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TarrifFromTo, bool>> Predicate => a => a.Id == Id;
   }
}
