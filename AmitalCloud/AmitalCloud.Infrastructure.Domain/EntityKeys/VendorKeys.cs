...
{
   public class VendorKeys<T> : BaseEntityKeyFields<ENTITIES.Vendor,T> 
   {
		public VendorKeys() : base() {}
        public VendorKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "VendorsPM";
	  public override Expression<Func<ENTITIES.Vendor, bool>> Predicate => a => a.Id == Id;
   }
}
