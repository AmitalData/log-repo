...
{
   public class QuoteChargesGroupKeys<T> : BaseEntityKeyFields<ENTITIES.QuoteChargesGroup,T> 
   {
		public QuoteChargesGroupKeys() : base() {}
        public QuoteChargesGroupKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "QuoteChargesGroupsPM";
	  public override Expression<Func<ENTITIES.QuoteChargesGroup, bool>> Predicate => a => a.Id == Id;
   }
}
