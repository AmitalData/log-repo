...
{
   public class DocumentsFilingKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentsFiling,T> 
   {
		public DocumentsFilingKeys() : base() {}
        public DocumentsFilingKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DocumentsFilingsPM";
	  public override Expression<Func<ENTITIES.DocumentsFiling, bool>> Predicate => a => a.Id == Id;
   }
}
