...
{
   public class VatMandatoryTypeKeys<T> : BaseEntityKeyFields<ENTITIES.VatMandatoryType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.VatMandatoryType, bool>> Predicate => a => a.Code == Code;
   }
}
