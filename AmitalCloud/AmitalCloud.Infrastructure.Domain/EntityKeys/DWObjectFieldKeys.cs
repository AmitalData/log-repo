...
{
   public class DWObjectFieldKeys<T> : BaseEntityKeyFields<ENTITIES.DWObjectField,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DWObjectField, bool>> Predicate => a => a.Id == Id;
   }
}
