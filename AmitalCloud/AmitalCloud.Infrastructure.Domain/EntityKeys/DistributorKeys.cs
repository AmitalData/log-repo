...
{
   public class DistributorKeys<T> : BaseEntityKeyFields<ENTITIES.Distributor,T> 
   {
		public DistributorKeys() : base() {}
        public DistributorKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DistributorsPM";
	  public override Expression<Func<ENTITIES.Distributor, bool>> Predicate => a => a.Code == Code;
   }
}
