...
{
   public class TextCodeTypeKeys<T> : BaseEntityKeyFields<ENTITIES.TextCodeType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TextCodeType, bool>> Predicate => a => a.Code == Code;
   }
}
