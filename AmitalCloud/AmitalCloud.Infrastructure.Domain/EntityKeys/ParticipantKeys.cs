...
{
   public class ParticipantKeys<T> : BaseEntityKeyFields<ENTITIES.Participant,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.Participant, bool>> Predicate => a => a.Id == Id;
   }
}
