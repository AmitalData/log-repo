...
{
   public class TipsVisibilityKeys<T> : BaseEntityKeyFields<EntityPOCOs.TipsVisibility,T> 
   {
		public TipsVisibilityKeys() : base() {}
        public TipsVisibilityKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
