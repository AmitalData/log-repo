...
{
   public class MetodoPagoKeys<T> : BaseEntityKeyFields<ENTITIES.MetodoPago,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.MetodoPago, bool>> Predicate => a => a.Code == Code;
   }
}
