...
{
   public class WeightUnitKeys<T> : BaseEntityKeyFields<EntityPOCOs.WeightUnit,T> 
   {
		public WeightUnitKeys() : base() {}
        public WeightUnitKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "WeightUnitsPM";
	  public override Expression<Func<EntityPOCOs.WeightUnit, bool>> Predicate => a => a.Code == Code;
   }
}
