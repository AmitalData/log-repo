...
{
   public class WeightUnitKeys<T> : BaseEntityKeyFields<ENTITIES.WeightUnit,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.WeightUnit, bool>> Predicate => a => a.Code == Code;
   }
}
