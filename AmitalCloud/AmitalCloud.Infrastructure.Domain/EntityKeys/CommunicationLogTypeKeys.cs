...
{
   public class CommunicationLogTypeKeys<T> : BaseEntityKeyFields<ENTITIES.CommunicationLogType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CommunicationLogType, bool>> Predicate => a => a.Code == Code;
   }
}
