...
{
   public class AirlineKeys<T> : BaseEntityKeyFields<EntityPOCOs.Airline,T> 
   {
		public AirlineKeys() : base() {}
        public AirlineKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AirlinesPM";
	  public override Expression<Func<EntityPOCOs.Airline, bool>> Predicate => a => a.Id == Id;
   }
}
