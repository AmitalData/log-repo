...
{
   public class UserPermittedBranchKeys<T> : BaseEntityKeyFields<ENTITIES.UserPermittedBranch,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.UserPermittedBranch, bool>> Predicate => a => a.Id == Id;
   }
}
