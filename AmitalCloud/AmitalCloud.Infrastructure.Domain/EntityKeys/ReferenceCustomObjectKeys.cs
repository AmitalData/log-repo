...
{
   public class ReferenceCustomObjectKeys<T> : BaseEntityKeyFields<ENTITIES.ReferenceCustomObject,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ReferenceCustomObject, bool>> Predicate => a => a.Id == Id;
   }
}
