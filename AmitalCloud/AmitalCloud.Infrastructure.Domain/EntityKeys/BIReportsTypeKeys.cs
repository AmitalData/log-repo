...
{
   public class BIReportsTypeKeys<T> : BaseEntityKeyFields<ENTITIES.BIReportsType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BIReportsType, bool>> Predicate => a => a.Code == Code;
   }
}
