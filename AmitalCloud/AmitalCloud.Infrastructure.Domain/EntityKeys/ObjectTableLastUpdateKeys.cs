...
{
   public class ObjectTableLastUpdateKeys<T> : BaseEntityKeyFields<ENTITIES.ObjectTableLastUpdate,T> 
   {
		public ObjectTableLastUpdateKeys() : base() {}
        public ObjectTableLastUpdateKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ObjectTableLastUpdatesPM";
	  public override Expression<Func<ENTITIES.ObjectTableLastUpdate, bool>> Predicate => a => a.Id == Id;
   }
}
