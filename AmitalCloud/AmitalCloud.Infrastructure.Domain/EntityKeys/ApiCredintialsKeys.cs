...
{
   public class ApiCredintialsKeys<T> : BaseEntityKeyFields<ENTITIES.ApiCredintials,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ApiCredintials, bool>> Predicate => a => a.Id == Id;
   }
}
