...
{
   public class MultiEntityUpdateLogKeys<T> : BaseEntityKeyFields<ENTITIES.MultiEntityUpdateLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.MultiEntityUpdateLog, bool>> Predicate => a => a.Id == Id;
   }
}
