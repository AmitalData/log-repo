...
{
   public class BusinessHourKeys<T> : BaseEntityKeyFields<ENTITIES.BusinessHour,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BusinessHour, bool>> Predicate => a => a.Id == Id;
   }
}
