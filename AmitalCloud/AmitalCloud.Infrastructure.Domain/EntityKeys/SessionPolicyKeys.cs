...
{
   public class SessionPolicyKeys<T> : BaseEntityKeyFields<ENTITIES.SessionPolicy,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.SessionPolicy, bool>> Predicate => a => a.Id == Id;
   }
}
