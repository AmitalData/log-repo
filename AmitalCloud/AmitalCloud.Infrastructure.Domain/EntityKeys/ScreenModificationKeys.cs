...
{
   public class ScreenModificationKeys<T> : BaseEntityKeyFields<ENTITIES.ScreenModification,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ScreenModification, bool>> Predicate => a => a.Id == Id;
   }
}
