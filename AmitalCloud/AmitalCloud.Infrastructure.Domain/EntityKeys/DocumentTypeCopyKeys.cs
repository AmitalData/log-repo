...
{
   public class DocumentTypeCopyKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentTypeCopy,T> 
   {
		public DocumentTypeCopyKeys() : base() {}
        public DocumentTypeCopyKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DocumentTypeCopiesPM";
	  public override Expression<Func<ENTITIES.DocumentTypeCopy, bool>> Predicate => a => a.Id == Id;
   }
}
