...
{
   public class PaymentTermKeys<T> : BaseEntityKeyFields<ENTITIES.PaymentTerm,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PaymentTerm, bool>> Predicate => a => a.Id == Id;
   }
}
