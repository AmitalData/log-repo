...
{
   public class ObjectFieldValidationKeys<T> : BaseEntityKeyFields<ENTITIES.ObjectFieldValidation,T> 
   {
		public ObjectFieldValidationKeys() : base() {}
        public ObjectFieldValidationKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ObjectFieldValidationsPM";
	  public override Expression<Func<ENTITIES.ObjectFieldValidation, bool>> Predicate => a => a.Id == Id;
   }
}
