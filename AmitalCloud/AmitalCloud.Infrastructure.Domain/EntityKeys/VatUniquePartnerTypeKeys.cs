...
{
   public class VatUniquePartnerTypeKeys<T> : BaseEntityKeyFields<ENTITIES.VatUniquePartnerType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.VatUniquePartnerType, bool>> Predicate => a => a.Code == Code;
   }
}
