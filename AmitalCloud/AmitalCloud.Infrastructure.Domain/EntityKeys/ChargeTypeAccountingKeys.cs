...
{
   public class ChargeTypeAccountingKeys<T> : BaseEntityKeyFields<ENTITIES.ChargeTypeAccounting,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ChargeTypeAccounting, bool>> Predicate => a => a.Id == Id;
   }
}
