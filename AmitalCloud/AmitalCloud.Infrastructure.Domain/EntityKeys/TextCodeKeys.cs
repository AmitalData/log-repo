...
{
   public class TextCodeKeys<T> : BaseEntityKeyFields<ENTITIES.TextCode,T> 
   {
		public TextCodeKeys() : base() {}
        public TextCodeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TextCodesPM";
	  public override Expression<Func<ENTITIES.TextCode, bool>> Predicate => a => a.Id == Id;
   }
}
