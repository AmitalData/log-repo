...
{
   public class CustomerStatusKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerStatus,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CustomerStatus, bool>> Predicate => a => a.Code == Code;
   }
}
