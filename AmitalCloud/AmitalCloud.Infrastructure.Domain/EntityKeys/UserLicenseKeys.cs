...
{
   public class UserLicenseKeys<T> : BaseEntityKeyFields<ENTITIES.UserLicense,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.UserLicense, bool>> Predicate => a => a.Id == Id;
   }
}
