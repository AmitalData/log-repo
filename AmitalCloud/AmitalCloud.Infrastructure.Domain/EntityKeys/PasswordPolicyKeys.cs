...
{
   public class PasswordPolicyKeys<T> : BaseEntityKeyFields<ENTITIES.PasswordPolicy,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PasswordPolicy, bool>> Predicate => a => a.Code == Code;
   }
}
