...
{
   public class PermissionTypeKeys<T> : BaseEntityKeyFields<ENTITIES.PermissionType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PermissionType, bool>> Predicate => a => a.Code == Code;
   }
}
