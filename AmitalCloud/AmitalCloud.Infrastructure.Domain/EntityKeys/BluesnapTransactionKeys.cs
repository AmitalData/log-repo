...
{
   public class BluesnapTransactionKeys<T> : BaseEntityKeyFields<ENTITIES.BluesnapTransaction,T> 
   {
		public BluesnapTransactionKeys() : base() {}
        public BluesnapTransactionKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "BluesnapTransactionsPM";
	  public override Expression<Func<ENTITIES.BluesnapTransaction, bool>> Predicate => a => a.Id == Id;
   }
}
