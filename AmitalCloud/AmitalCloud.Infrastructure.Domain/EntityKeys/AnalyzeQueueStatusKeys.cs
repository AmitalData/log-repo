...
{
   public class AnalyzeQueueStatusKeys<T> : BaseEntityKeyFields<ENTITIES.AnalyzeQueueStatus,T> 
   {
		public AnalyzeQueueStatusKeys() : base() {}
        public AnalyzeQueueStatusKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
	  ...
	  public override Expression<Func<ENTITIES.AnalyzeQueueStatus, bool>> Predicate => a => a.Code == Code;
   }
}
