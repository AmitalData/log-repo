...
{
   public class ChangePasswordLogKeys<T> : BaseEntityKeyFields<ENTITIES.ChangePasswordLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ChangePasswordLog, bool>> Predicate => a => a.Id == Id;
   }
}
