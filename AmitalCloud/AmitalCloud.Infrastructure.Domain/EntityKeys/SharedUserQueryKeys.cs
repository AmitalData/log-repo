...
{
   public class SharedUserQueryKeys<T> : BaseEntityKeyFields<ENTITIES.SharedUserQuery,T> 
   {
      ...
      public override string GetEntityPMName() => "shareduserqueriesPM";
	  public override Expression<Func<ENTITIES.SharedUserQuery, bool>> Predicate => a => a.Id == Id;
   }
}
