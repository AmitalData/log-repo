...
{
   public class CustomerGroupKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerGroup,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CustomerGroup, bool>> Predicate => a => a.Id == Id;
   }
}
