...
{
   public class CaptchaKeyKeys<T> : BaseEntityKeyFields<EntityPOCOs.CaptchaKey,T> 
   {
		public CaptchaKeyKeys() : base() {}
        public CaptchaKeyKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CaptchaKeysPM";
	  public override Expression<Func<EntityPOCOs.CaptchaKey, bool>> Predicate => a => a.Id == Id;
   }
}
