...
{
   public class UnassignedEntityKeys<T> : BaseEntityKeyFields<ENTITIES.UnassignedEntity,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.UnassignedEntity, bool>> Predicate => a => a.Id == Id;
   }
}
