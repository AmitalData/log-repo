...
{
   public class AdvancedQueryFilterKeys<T> : BaseEntityKeyFields<EntityPOCOs.AdvancedQueryFilter,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.AdvancedQueryFilter, bool>> Predicate => a => a.Id == Id;
   }
}
