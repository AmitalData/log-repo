...
{
   public class MeasurementKeys<T> : BaseEntityKeyFields<ENTITIES.Measurement,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.Measurement, bool>> Predicate => a => a.Id == Id;
   }
}
