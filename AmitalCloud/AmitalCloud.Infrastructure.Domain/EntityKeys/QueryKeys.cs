...
{
   public class QueryKeys<T> : BaseEntityKeyFields<EntityPOCOs.Query,T> 
   {
		public QueryKeys() : base() {}
        public QueryKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "QUERIESPM";
	  public override Expression<Func<EntityPOCOs.Query, bool>> Predicate => a => a.Id == Id;
   }
}
