...
{
   public class ReportGroupKeys<T> : BaseEntityKeyFields<ENTITIES.ReportGroup,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ReportGroup, bool>> Predicate => a => a.Id == Id;
   }
}
