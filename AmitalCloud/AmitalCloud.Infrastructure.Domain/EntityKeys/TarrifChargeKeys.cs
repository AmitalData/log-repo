...
{
   public class TarrifChargeKeys<T> : BaseEntityKeyFields<ENTITIES.TarrifCharge,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TarrifCharge, bool>> Predicate => a => a.Id == Id;
   }
}
