...
{
   public class QuoteTemplateSettingKeys<T> : BaseEntityKeyFields<ENTITIES.QuoteTemplateSetting,T> 
   {
		public QuoteTemplateSettingKeys() : base() {}
        public QuoteTemplateSettingKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "QuoteTemplateSettingsPM";
	  public override Expression<Func<ENTITIES.QuoteTemplateSetting, bool>> Predicate => a => a.Id == Id;
   }
}
