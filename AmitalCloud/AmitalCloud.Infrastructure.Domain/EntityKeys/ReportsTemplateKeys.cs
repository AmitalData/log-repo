...
{
   public class ReportsTemplateKeys<T> : BaseEntityKeyFields<ENTITIES.ReportsTemplate,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ReportsTemplate, bool>> Predicate => a => a.Id == Id;
   }
}
