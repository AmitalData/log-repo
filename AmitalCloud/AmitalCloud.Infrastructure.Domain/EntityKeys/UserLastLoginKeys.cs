...
{
   public class UserLastLoginKeys<T> : BaseEntityKeyFields<ENTITIES.UserLastLogin,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.UserLastLogin, bool>> Predicate => a => a.Id == Id;
   }
}
