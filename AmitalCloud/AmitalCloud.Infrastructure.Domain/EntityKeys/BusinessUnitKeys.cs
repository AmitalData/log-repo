...
{
   public class BusinessUnitKeys<T> : BaseEntityKeyFields<ENTITIES.BusinessUnit,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BusinessUnit, bool>> Predicate => a => a.Id == Id;
   }
}
