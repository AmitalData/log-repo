...
{
   public class FeatureChangeKeys<T> : BaseEntityKeyFields<ENTITIES.FeatureChange,T> 
   {
		public FeatureChangeKeys() : base() {}
        public FeatureChangeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "FeatureChangesPM";
	  public override Expression<Func<ENTITIES.FeatureChange, bool>> Predicate => a => a.Id == Id;
   }
}
