...
{
   public class AWBMessagesCCSTypeKeys<T> : BaseEntityKeyFields<ENTITIES.AWBMessagesCCSType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.AWBMessagesCCSType, bool>> Predicate => a => a.Code == Code;
   }
}
