...
{
   public class MenusTableKeys<T> : BaseEntityKeyFields<ENTITIES.MenusTable,T> 
   {
		public MenusTableKeys() : base() {}
        public MenusTableKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "MenusTablesPM";
	  public override Expression<Func<ENTITIES.MenusTable, bool>> Predicate => a => a.Id == Id;
   }
}
