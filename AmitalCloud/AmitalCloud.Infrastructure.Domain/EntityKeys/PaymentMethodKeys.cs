...
{
   public class PaymentMethodKeys<T> : BaseEntityKeyFields<ENTITIES.PaymentMethod,T> 
   {
		public PaymentMethodKeys() : base() {}
        public PaymentMethodKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "PaymentMethodsPM";
	  public override Expression<Func<ENTITIES.PaymentMethod, bool>> Predicate => a => a.Code == Code;
   }
}
