...
{
   public class RankKeys<T> : BaseEntityKeyFields<ENTITIES.Rank,T> 
   {
		public RankKeys() : base() {}
        public RankKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "RanksPM";
	  public override Expression<Func<ENTITIES.Rank, bool>> Predicate => a => a.Id == Id;
   }
}
