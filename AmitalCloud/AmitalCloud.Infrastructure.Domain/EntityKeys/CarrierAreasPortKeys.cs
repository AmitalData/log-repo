...
{
   public class CarrierAreasPortKeys<T> : BaseEntityKeyFields<ENTITIES.CarrierAreasPort,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CarrierAreasPort, bool>> Predicate => a => a.Id == Id;
   }
}
