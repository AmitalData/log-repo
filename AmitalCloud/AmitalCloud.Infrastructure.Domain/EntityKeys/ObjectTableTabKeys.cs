...
{
   public class ObjectTableTabKeys<T> : BaseEntityKeyFields<ENTITIES.ObjectTableTab,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ObjectTableTab, bool>> Predicate => a => a.Id == Id;
   }
}
