...
{
   public class QueryGroupKeys<T> : BaseEntityKeyFields<EntityPOCOs.QueryGroup,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.QueryGroup, bool>> Predicate => a => a.Code == Code;
   }
}
