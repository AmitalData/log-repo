...
{
   public class PackageTypeKeys<T> : BaseEntityKeyFields<ENTITIES.PackageType,T> 
   {
		public PackageTypeKeys() : base() {}
        public PackageTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "PackageTypesPM";
	  public override Expression<Func<ENTITIES.PackageType, bool>> Predicate => a => a.Id == Id;
   }
}
