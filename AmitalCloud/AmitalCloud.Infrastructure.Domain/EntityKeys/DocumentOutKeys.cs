...
{
   public class DocumentOutKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentOut,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentOut, bool>> Predicate => a => a.Id == Id;
   }
}
