...
{
   public class StateKeys<T> : BaseEntityKeyFields<EntityPOCOs.State,T> 
   {
		public StateKeys() : base() {}
        public StateKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "StatesPM";
	  public override Expression<Func<EntityPOCOs.State, bool>> Predicate => a => a.Id == Id;
   }
}
