...
{
   public class QuoteTemplateKeys<T> : BaseEntityKeyFields<ENTITIES.QuoteTemplate,T> 
   {
		public QuoteTemplateKeys() : base() {}
        public QuoteTemplateKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "QuoteTemplatesPM";
	  public override Expression<Func<ENTITIES.QuoteTemplate, bool>> Predicate => a => a.Id == Id;
   }
}
