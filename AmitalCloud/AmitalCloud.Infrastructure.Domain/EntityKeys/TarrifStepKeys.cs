...
{
   public class TarrifStepKeys<T> : BaseEntityKeyFields<EntityPOCOs.TarrifStep,T> 
   {
		public TarrifStepKeys() : base() {}
        public TarrifStepKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TarrifStepsPM";
	  public override Expression<Func<EntityPOCOs.TarrifStep, bool>> Predicate => a => a.Id == Id;
   }
}
