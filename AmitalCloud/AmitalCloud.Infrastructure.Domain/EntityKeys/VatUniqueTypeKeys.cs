...
{
   public class VatUniqueTypeKeys<T> : BaseEntityKeyFields<ENTITIES.VatUniqueType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.VatUniqueType, bool>> Predicate => a => a.Code == Code;
   }
}
