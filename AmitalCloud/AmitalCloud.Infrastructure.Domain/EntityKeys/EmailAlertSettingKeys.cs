...
{
   public class EmailAlertSettingKeys<T> : BaseEntityKeyFields<ENTITIES.EmailAlertSetting,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.EmailAlertSetting, bool>> Predicate => a => a.Id == Id;
   }
}
