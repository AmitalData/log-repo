...
{
   public class FeatureToggleKeys<T> : BaseEntityKeyFields<ENTITIES.FeatureToggle,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.FeatureToggle, bool>> Predicate => a => a.Id == Id;
   }
}
