...
{
   public class TarrifTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.TarrifType,T> 
   {
		public TarrifTypeKeys() : base() {}
        public TarrifTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TarrifTypesPM";
	  public override Expression<Func<EntityPOCOs.TarrifType, bool>> Predicate => a => a.Code == Code;
   }
}
