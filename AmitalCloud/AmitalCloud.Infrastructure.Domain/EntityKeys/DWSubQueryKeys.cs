...
{
   public class DWSubQueryKeys<T> : BaseEntityKeyFields<EntityPOCOs.DWSubQuery,T> 
   {
		public DWSubQueryKeys() : base() {}
        public DWSubQueryKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "dwsubqueriesPM";
	  public override Expression<Func<EntityPOCOs.DWSubQuery, bool>> Predicate => a => a.Id == Id;
   }
}
