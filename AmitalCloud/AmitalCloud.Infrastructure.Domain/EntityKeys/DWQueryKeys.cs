...
{
   public class DWQueryKeys<T> : BaseEntityKeyFields<ENTITIES.DWQuery,T> 
   {
      ...
      public override string GetEntityPMName() => "dwqueriesPM";
	  public override Expression<Func<ENTITIES.DWQuery, bool>> Predicate => a => a.Id == Id;
   }
}
