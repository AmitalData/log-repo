...
{
   public class VolumeUnitKeys<T> : BaseEntityKeyFields<EntityPOCOs.VolumeUnit,T> 
   {
		public VolumeUnitKeys() : base() {}
        public VolumeUnitKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "VolumeUnitsPM";
	  public override Expression<Func<EntityPOCOs.VolumeUnit, bool>> Predicate => a => a.Code == Code;
   }
}
