...
{
   public class VolumeUnitKeys<T> : BaseEntityKeyFields<ENTITIES.VolumeUnit,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.VolumeUnit, bool>> Predicate => a => a.Code == Code;
   }
}
