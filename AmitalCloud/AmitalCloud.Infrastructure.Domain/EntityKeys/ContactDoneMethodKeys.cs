...
{
   public class ContactDoneMethodKeys<T> : BaseEntityKeyFields<ENTITIES.ContactDoneMethod,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ContactDoneMethod, bool>> Predicate => a => a.Code == Code;
   }
}
