...
{
   public class QueueDefinitionKeys<T> : BaseEntityKeyFields<ENTITIES.QueueDefinition,T> 
   {
		public QueueDefinitionKeys() : base() {}
        public QueueDefinitionKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "QueueDefinitionsPM";
	  public override Expression<Func<ENTITIES.QueueDefinition, bool>> Predicate => a => a.Code == Code;
   }
}
