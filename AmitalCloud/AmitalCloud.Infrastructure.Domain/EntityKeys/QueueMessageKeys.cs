...
{
   public class QueueMessageKeys<T> : BaseEntityKeyFields<ENTITIES.QueueMessage,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.QueueMessage, bool>> Predicate => a => a.Id == Id;
   }
}
