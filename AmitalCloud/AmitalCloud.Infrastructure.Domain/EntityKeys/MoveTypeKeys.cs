...
{
   public class MoveTypeKeys<T> : BaseEntityKeyFields<ENTITIES.MoveType,T> 
   {
		public MoveTypeKeys() : base() {}
        public MoveTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "MoveTypesPM";
	  public override Expression<Func<ENTITIES.MoveType, bool>> Predicate => a => a.Id == Id;
   }
}
