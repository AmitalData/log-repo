...
{
   public class FeatureTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.FeatureType,T> 
   {
		public FeatureTypeKeys() : base() {}
        public FeatureTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "FeatureTypesPM";
	  public override Expression<Func<EntityPOCOs.FeatureType, bool>> Predicate => a => a.Code == Code;
   }
}
