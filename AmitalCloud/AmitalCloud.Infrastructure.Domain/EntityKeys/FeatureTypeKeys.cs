...
{
   public class FeatureTypeKeys<T> : BaseEntityKeyFields<ENTITIES.FeatureType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.FeatureType, bool>> Predicate => a => a.Code == Code;
   }
}
