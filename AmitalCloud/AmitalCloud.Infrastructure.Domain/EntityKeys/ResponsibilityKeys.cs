...
{
   public class ResponsibilityKeys<T> : BaseEntityKeyFields<ENTITIES.Responsibility,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.Responsibility, bool>> Predicate => a => a.Code == Code;
   }
}
