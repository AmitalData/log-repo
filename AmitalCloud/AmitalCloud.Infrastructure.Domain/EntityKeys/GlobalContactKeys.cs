...
{
   public class GlobalContactKeys<T> : BaseEntityKeyFields<ENTITIES.GlobalContact,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.GlobalContact, bool>> Predicate => a => a.Id == Id;
   }
}
