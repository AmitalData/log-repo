...
{
   public class UserLastSettingsKeys<T> : BaseEntityKeyFields<ENTITIES.UserLastSettings,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.UserLastSettings, bool>> Predicate => a => a.Id == Id;
   }
}
