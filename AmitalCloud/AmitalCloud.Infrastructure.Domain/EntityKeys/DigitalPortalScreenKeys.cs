...
{
   public class DigitalPortalScreenKeys<T> : BaseEntityKeyFields<ENTITIES.DigitalPortalScreen,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DigitalPortalScreen, bool>> Predicate => a => a.Id == Id;
   }
}
