...
{
   public class ProductTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.ProductType,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.ProductType, bool>> Predicate => a => a.Code == Code;
   }
}
