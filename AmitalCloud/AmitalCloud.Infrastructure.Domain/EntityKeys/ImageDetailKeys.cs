...
{
   public class ImageDetailKeys<T> : BaseEntityKeyFields<ENTITIES.ImageDetail,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ImageDetail, bool>> Predicate => a => a.Id == Id;
   }
}
