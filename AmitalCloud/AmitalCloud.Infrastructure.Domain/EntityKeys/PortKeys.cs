...
{
   public class PortKeys<T> : BaseEntityKeyFields<EntityPOCOs.Port,T> 
   {
		public PortKeys() : base() {}
        public PortKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "PortsPM";
	  public override Expression<Func<EntityPOCOs.Port, bool>> Predicate => a => a.Id == Id;
   }
}
