...
{
   public class AddressTypeKeys<T> : BaseEntityKeyFields<ENTITIES.AddressType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.AddressType, bool>> Predicate => a => a.Id == Id;
   }
}
