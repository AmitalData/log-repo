...
{
   public class SatisfactionSurveyKeys<T> : BaseEntityKeyFields<ENTITIES.SatisfactionSurvey,T> 
   {
		public SatisfactionSurveyKeys() : base() {}
        public SatisfactionSurveyKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "SatisfactionSurveysPM";
	  public override Expression<Func<ENTITIES.SatisfactionSurvey, bool>> Predicate => a => a.Id == Id;
   }
}
