...
{
   public class InboundEmailLineKeys<T> : BaseEntityKeyFields<ENTITIES.InboundEmailLine,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.InboundEmailLine, bool>> Predicate => a => a.Id == Id;
   }
}
