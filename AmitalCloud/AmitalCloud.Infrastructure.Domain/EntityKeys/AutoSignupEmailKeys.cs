...
{
   public class AutoSignupEmailKeys<T> : BaseEntityKeyFields<ENTITIES.AutoSignupEmail,T> 
   {
		public AutoSignupEmailKeys() : base() {}
        public AutoSignupEmailKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AutoSignupEmailsPM";
	  public override Expression<Func<ENTITIES.AutoSignupEmail, bool>> Predicate => a => a.Id == Id;
   }
}
