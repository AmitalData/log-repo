...
{
   public class APILogsDataKeys<T> : BaseEntityKeyFields<ENTITIES.APILogsData,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.APILogsData, bool>> Predicate => a => a.Id == Id;
   }
}
