...
{
   public class CounterDefinitionKeys<T> : BaseEntityKeyFields<ENTITIES.CounterDefinition,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CounterDefinition, bool>> Predicate => a => a.Id == Id;
   }
}
