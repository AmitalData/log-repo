...
{
   public class ContactActivityLogKeys<T> : BaseEntityKeyFields<ENTITIES.ContactActivityLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ContactActivityLog, bool>> Predicate => a => a.Id == Id;
   }
}
