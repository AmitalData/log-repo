...
{
   public class ComputingPartnerCodeKeys<T> : BaseEntityKeyFields<ENTITIES.ComputingPartnerCode,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ComputingPartnerCode, bool>> Predicate => a => a.Id == Id;
   }
}
