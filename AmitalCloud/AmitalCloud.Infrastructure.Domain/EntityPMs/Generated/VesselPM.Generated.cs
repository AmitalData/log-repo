...
namespace AmitalCloud.Infrastructure.Domain.EntityPMs
{
   ...
   public VesselPM(Vessel entity) : base()
   {
		_id = entity.Id;
	  ...
	  private string _iMOCode ;
       ...
       public string IMOCode  
	   {
		 ...
		 set
		 {
		   if(_iMOCode != value)
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="IMOCode",OldValue=_iMOCode,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   _iMOCode=value;
		   }
		 }
