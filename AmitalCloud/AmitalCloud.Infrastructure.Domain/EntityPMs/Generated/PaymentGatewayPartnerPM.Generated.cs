...
namespace AmitalCloud.Infrastructure.Domain.EntityPMs
{
   ...
   [DataContract]
   public partial class PaymentGatewayPartnerPM : BaseEntityPM   {
   #region Constructors
   public PaymentGatewayPartnerPM() : base() {} 
   public PaymentGatewayPartnerPM(POCO.PaymentGatewayPartner entity) : base()
   {
		_code = entity.Code;
		_name = entity.Name;
