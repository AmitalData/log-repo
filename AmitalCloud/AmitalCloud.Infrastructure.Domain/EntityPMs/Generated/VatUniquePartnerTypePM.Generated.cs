...
namespace AmitalCloud.Infrastructure.Domain.EntityPMs
{
   ...
   [DataContract]
   public partial class VatUniquePartnerTypePM : BaseEntityPM   {
   #region Constructors
   public VatUniquePartnerTypePM() : base() {} 
   public VatUniquePartnerTypePM(POCO.VatUniquePartnerType entity) : base()
   {
		_code = entity.Code;
