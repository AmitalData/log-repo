...
namespace AmitalCloud.Invoice.Domain.EntityPMs
{
   ...
   [DataContract]
   public partial class ARInvoiceStocksStatusPM : BaseEntityPM   {
   #region Constructors
   public ARInvoiceStocksStatusPM() : base() {} 
   public ARInvoiceStocksStatusPM(ARInvoiceStocksStatus entity) : base()
   {
		_code = entity.Code;
		_name = entity.Name;
