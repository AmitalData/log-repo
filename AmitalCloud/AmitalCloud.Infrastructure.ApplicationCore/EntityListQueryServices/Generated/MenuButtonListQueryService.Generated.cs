...
{ 
    ...
    {
	    protected override System.Data.Entity.IDbSet<POCO.MenuButton> contextEntity => (context as IAmitalCloudContext).MenuButtons;
		public MenuButtonListQueryService(int tenant) : base(AmitalCloudContext.GetContext(tenant)) { }
