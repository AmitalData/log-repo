...
namespace AmitalCloud.Shipment.Domain.EntityPMs
{
   ...
   public ShipmentCustomerTypePM(ShipmentCustomerType entity) : base()
   {
		_code = entity.Code;
		_name = entity.Name;
   ...
   #region Properties
	  ...
	  private bool _showInLOV ;
	  	   [CustomValidation(typeof(IShipmentValidationClass), "ValidateClass")]
	   [DataMember]
       public bool ShowInLOV  
	   {
	     get { return _showInLOV; }
		 set
		 {
		   if(_showInLOV != value)
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="ShowInLOV",OldValue=_showInLOV,NewValue=value,PropertyType="bool"};
		    NotifyPropertyChanged(values);
		   _showInLOV=value;
		   }
		 }
