...
namespace AmitalCloud.Shipment.Domain.EntityPMs
{
   ...
   public AWBAdditionalHandlingInfoPM(POCO.AWBAdditionalHandlingInfo entity) : base()
   {
		...
		_code = entity.Code;
		_name = entity.Name;
		_printDescription = entity.PrintDescription;
	  ...
	  private string _printDescription ;
       ...
       public string PrintDescription  
	   {
		 ...
		 set
		 {
		   ...
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="PrintDescription",OldValue=_printDescription,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
