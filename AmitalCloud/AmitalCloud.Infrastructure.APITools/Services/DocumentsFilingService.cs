...
namespace AmitalCloud.Infrastructure.APITools.Services
{
    public class DocumentsFilingService
    {
        ...
        //    private void AddImporterQueue(DocumentsFilingPM entityPM, TenantPM tenantPM, bool HavingDREL)
        //    {
        //        if (!LogitudeSettings.IsCostomsDeploy && !tenantPM.IsDocumentsArchive && IsDocumentMatchesLogboxConditions(entityPM, HavingDREL) && HasConnectedShipmentInLogbox(entityPM))
        //        {
        //            AddImportersShipmentDocumentsQueueMessage(null);
        //        }
        //    }

        //    private void AddImporterQueueWithDelay(DocumentsFilingPM entityPM, TenantPM tenantPM, bool HavingDREL)
        //    {
        ...
        //    private bool IsDocumentMatchesLogboxConditions(DocumentsFilingPM entityPM, bool HavingDREL)
        //    {
        //        if (entityPM.DirectionCode != "I" || !(!entityPM.IsSharedWithForwarder || (entityPM.IsSharedWithForwarder && HavingDREL == true)))
        //            return false;
        ...
        //        && (entityPM.IsSharedWithCustomer || (entityPM.IsSharedWithForwarder && HavingDREL == true))
        ...
        //        AddShipmentUpdateKafkaQueueMessage(entityPM);
        //    }

        //    private void AddShipmentUpdateKafkaQueueMessage(DocumentsFilingPM entityPM)
        //    {
        //        if (FeatureToggleHelper.HasFeatureToggle("CTL", entityPM.Tenant) &&
        //            entityPM.ObjectTableId.Equals(ObjectTableQuery.GetObjectTableByCode("Shipment", entityPM.Tenant)?.Id) &&
        //            entityPM.HasFile.Equals(true) &&
        //            entityPM.DirectionCode == "I" &&
        //            !entityPM.FromCTool)
        //        {
        //            //AddKafkaQueueMessage(entityPM, "CToolShipmentsUpdate");
        //            EntityChangesMessageProducer.ProduceShipmentDocumentUpload(entityPM.EntityId, entityPM.Tenant);
        //        }
        //    }

        //    private void AddKafkaQueueMessage(DocumentsFilingPM entityPM, string queueName)
        //    {
        //        IQueueService queueservice = new DbQueueService();
        //        queueservice.InitializeQueue(queueName, 0);
        //        var queueMessage = new Dictionary<string, string>() {
        //            { "ShipmentId", entityPM.EntityId },
        //            { "Tenant", entityPM.Tenant.ToString()}};
        //        queueservice.Send(queueMessage, entityPM.Tenant);
        //    }

        //    public void Update(DocumentsFilingPM entityPM, bool mapComposition = false)
        //    {
        //        if (mapComposition)
        //        {
        //            this.documentsFilingMetaDataValueChangeSet = entityPM.DocumentsFilingMetaDataValues;
        //        }
        //        this.isNewEntity = false;
        //        entityPM = entityPM;
        //        this.Poco = entityRepository.GetSingleDocumentsFiling(entityPM.Id, entityPM.Tenant);
        ...
        //                    //    }
        //                    //}
        //                    //ShipmentCompField.MissingDocumentsCount = documentsFilingQuery.GetMissingDocCountForEntity(this.Poco.EntityId, entityPM.ObjectTableId, tenant);
        //                    var document = documentRepository.GetSingleDocument(tenant, entityPM.DocumentId);
        //                    if (document != null && document.HasFile == true)
        //                    {
        //                        ShipmentCompField.LastDocumentDateTime = DateTime.Now;
        ...
        //                    bool shouldBeSentToForwarder = !entityPM.DontAddToQueue && ((entityPM.IsSharedWithForwarder && !entityPM.IsSharedWithCustomer) || (entityPM.IsSharedWithCustomer && entityPM.IsDigitallySigned && OldIsSigned == false) || (entityPM.IsSharedWithCustomer && WasRequested && entityPM.HasFile == true));
        //                    SendShipmentToForwarder(shouldBeSentToForwarder);
        ...
        //        this.OpenKPIDocumentUploderQueue(entityPM);
        //        this.SendQueueOfEntityDocumnetsToQuickbooks(entityPM);
        ...
        //        {
        //            AddToTasksQueue(entityPM, isNewEntity, null);
        //        }
        //        entityRepository.Update(Poco);
        //        entityRepository.SubmitChanges();
        //        AddImporterQueue(entityPM, tenantPM, HavingDREL);
        ...
        //    private void RunDocumentPopulateAutomaticDatesService(DocumentsFilingPM entityPM)
        //    {
        //        if (!entityPM.IsUoloadedField)
        //            return;
        ...
        //        DocumentType documentType = documentTypeRepository.GetSingleDocumentTypeByCode(entityPM.DocumentTypeCode, entityPM.Tenant);
        //        string objectTableName = GetDocumentObjectTableName(documentType);
        //        string childEntityId = GetDocumentChildEntityId(entityPM, documentType);
        //        documentPopulateAutomaticDateUpdateService.Update(new DocumentPopulateAutomaticDateArgs() { EntityId = entityPM.EntityId, ObjectTableName = objectTableName, DocumentTypeCode = entityPM.DocumentTypeCode, ProcessType = "Upload", Tenant = entityPM.Tenant, ChildEntityId = childEntityId });
        //    }

        //    private void RunAutomation(DocumentsFilingPM entityPM, string automationType)
        //    {
        //        if (!entityPM.IsUoloadedField && !entityPM.IsFromDigital)
        //            return;
        //        GeneralEntityChangeService generalEntityChangeService = new GeneralEntityChangeService();
        //        EntityDetails entityDetails = generalEntityChangeService.GetEntityDetails(entityPM.EntityId, entityPM.ObjectTableName, entityPM.Tenant);

        //        bool isHaveAutomation = generalEntityChangeService.CheckIfEntityHaveAutomation(entityDetails.CombinedObjectTableName, automationType, entityPM.Tenant);
        //        if (!isHaveAutomation) return;

        //        MainEntityChangeService mainEntityChangeService = new MainEntityChangeService(new EntityChangeArgs() { EntityPM = entityDetails.EntityPM, ProcessType = automationType, ObjectTableName = entityDetails.ObjectTableName, EntityId = entityPM.EntityId, Tenant = entityPM.Tenant, StartDate = DateTime.Now, ExtraDetails = new OnUpdateDocumentDetails { Type = "Upload", DocumentId = entityPM.DocumentId, DocumentTypeId = entityPM.DocumentTypeId }, OtherObjectTableName = entityDetails.OtherObjectTableName, EntityReference = entityPM.EntityReference });
        ...
        //    private static string GetDocumentChildEntityId(DocumentsFilingPM entityPM, DocumentType documentType)
        //    {
        //        if (documentType == null) return "";
        //        if (string.IsNullOrEmpty(documentType.ObjectTableId)) return "";
        //        if (documentType.ObjectTableId == entityPM.ObjectTableId) return "";

        //        return entityPM.ChildEntityId;
        //    }
        ...
        //        var amitalCustomFileCommunicationModel = new AmitalCommunicationModelBase(
        ...
        //        //    <AmitalCommunicationModelBase, Envelope>(
