...
//{
//    public partial class DocumentsFilingUpdateService
//    {
//    }
...
//            this.documentTypeRepository = new Repository<DocumentType>(currentContext);
...
//        {
//            if (!AmitalCloudSettings.IsCostomsDeploy && !tenantPM.IsDocumentsArchive && IsDocumentMatchesLogboxConditions(theEntityPm, HavingDREL) && HasConnectedShipmentInLogbox(theEntityPm))
//            {
...
//                    try
//                    {
//                        AmitalCloud .HandleLogMe("TOOK 1: ", true, "123", DateTime.Now);
//                        myICreateUD2LTService.JustDoIt(extDocPM);
//                        AmitalCloudSettings.HandleLogMe("TOOK 2: ", true, "123", DateTime.Now);
...
//                        AmitalCloudSettings.HandleLogMe("Error in ICreateUD2LTService JustDoIt: " + ex.Message, true, "CreateUD2LTService.Error", DateTime.Now);
//                    }
//                }
...
//                    try
//                    {
//                        AmitalCloudSettings.HandleLogMe("TOOK 3: ", true, "123", DateTime.Now);
//                        myISendBondedCustomDocumentService.JustDoIt(extDocPM);
//                        AmitalCloudSettings.HandleLogMe("TOOK 4: ", true, "123", DateTime.Now);
//                        // Commit the transaction if everything is successful
//                        transactionScope.Complete();
//                    }
//                    catch (Exception ex)
//                    {
//                        // Handle the exception or log it
//                        AmitalCloudSettings.HandleLogMe("Error in ISendBondedCustomDocumentService JustDoIt: " + ex.Message, true, "ISendBondedCustomDocumentService.Error", DateTime.Now);
//                    }
//                }
//            });
...
//            {
//                TenantRepository tenantRepository = new TenantRepository(currentContext);
...
//        {
//            return new Repository<DocumentType>(this.currentContext).GetMulti(record => record.Id == documentFilingId && record.Tenant == tenant, record => record.Code).FirstOrDefault();
//         }
...
//            DocumentType documentType = this.documentTypeRepository.GetMulti(record=> record.Code == theEntityPm.DocumentTypeCode && record.Tenant == theEntityPm.Tenant ).FirstOrDefault();
...
//        {
//            if (AmitalCloudSettings.IsCostomsDeploy && extDocPM.IsHybrid)//avoid non stop 
//            {
...
//            if
//                (
//                (!extDocPM.IsHybrid && AmitalCloudSettings.IsCostomsDeploy) ||
//                (AmitalCloudSettings.EnableHybridQueue && (CurrentHybridPartner != null && !CurrentHybridPartner.IsExternalPartner) && (!extDocPM.IsHybrid || (extDocPM.IsAttachment))
...
//                                AmitalCloudSettings.IsCostomsDeploy &&
//                                AmitalCloudSettings.StorageServiceMode == "db" &&
//                                !String.IsNullOrWhiteSpace(AmitalCloudSettings.GetLogitudeCustomsSettingsMInject(fileInfo.Tenant).OnPremiseFillingService)
//                                );
