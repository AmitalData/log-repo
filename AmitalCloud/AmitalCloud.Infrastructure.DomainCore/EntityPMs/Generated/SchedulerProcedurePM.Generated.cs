...
namespace AmitalCloud.Infrastructure.Domain.EntityPMs
{
   ...
   #region Properties
	  ...
	  private bool? _isInternallyDefined ;
	  	   [CustomValidation(typeof(IInfrastructureValidationClass), "ValidateClass")]
	   [DataMember]
       public bool? IsInternallyDefined  
	   {
	     get { return _isInternallyDefined; }
		 set
		 {
		   if(_isInternallyDefined != value)
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="IsInternallyDefined",OldValue=_isInternallyDefined,NewValue=value,PropertyType="bool?"};
		    NotifyPropertyChanged(values);
		   _isInternallyDefined=value;
		   }
		 }
	   }
	 }
