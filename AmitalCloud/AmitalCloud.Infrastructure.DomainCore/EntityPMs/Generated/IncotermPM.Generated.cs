	  ...
	  private string _freight ;
       ...
       public string Freight  
	   {
		 ...
		 set
		 {
		   if(_freight != value)
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="Freight",OldValue=_freight,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   _freight=value;
		   }
		 }
	  ...
	  private string _otherCharges ;
       ...
       public string OtherCharges  
	   {
		 ...
		 set
		 {
		   ...
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="OtherCharges",OldValue=_otherCharges,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   _otherCharges=value;
		   }
		 }
