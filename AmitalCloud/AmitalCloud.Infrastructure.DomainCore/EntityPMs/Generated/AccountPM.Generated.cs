...
namespace AmitalCloud.Infrastructure.Domain.EntityPMs
{
   ...
   [DataContract]
   public partial class AccountPM : BaseEntityPM   {
   #region Constructors
   public AccountPM() : base() {} 
   public AccountPM(POCO.Account entity) : base()
   {
		_id = entity.Id;
   ...
   #region Properties
	  ...
	  private string _accountTypeCode ;
       ...
       public string AccountTypeCode  
	   {
		 ...
		 set
		 {
		   ...
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="AccountTypeCode",OldValue=_accountTypeCode,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
	  ...
	  private string _externalAccountingCard ;
	  	   [CustomValidation(typeof(IInfrastructureValidationClass), "ValidateClass")]
	   [DataMember]
       public string ExternalAccountingCard  
	   {
	     get { return _externalAccountingCard; }
		 set
		 {
		   if(_externalAccountingCard != value)
		   {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="ExternalAccountingCard",OldValue=_externalAccountingCard,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   _externalAccountingCard=value;
		   }
		 }
	   }
