...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class CustomsInterfaceMap : EntityTypeConfiguration<POCO.CustomsInterface>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.InterfaceType).HasColumnName("InterfaceType").HasMaxLength(2).IsUnicode(false);
        }
    }
}
