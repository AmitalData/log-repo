...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class RecurringPeriodMap : EntityTypeConfiguration<POCO.RecurringPeriod>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.Code).HasColumnName("Code").IsRequired().HasMaxLength(2).IsUnicode(true);
