...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class FilingInboxMap : EntityTypeConfiguration<POCO.FilingInbox>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.BodyDocumentId).HasColumnName("BodyDocumentId").IsRequired().HasMaxLength(15).IsUnicode(false);
