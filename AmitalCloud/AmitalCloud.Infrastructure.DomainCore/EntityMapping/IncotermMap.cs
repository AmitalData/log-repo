...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class IncotermMap : EntityTypeConfiguration<POCO.Incoterm>
    {
	    string dbms;
        public IncotermMap()
        { 
            ...
            this.Property(t => t.Freight).HasColumnName("Freight").IsRequired().HasMaxLength(1).IsUnicode(false);

            this.Property(t => t.OtherCharges).HasColumnName("OtherCharges").IsRequired().HasMaxLength(1).IsUnicode(false);
