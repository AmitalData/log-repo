...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class RoleMap : EntityTypeConfiguration<POCO.Role>
    {
	    string dbms;
        public RoleMap()
        { 
            ...
            this.Property(t => t.RoleTypeCode).HasColumnName("RoleTypeCode").IsRequired().HasMaxLength(4).IsUnicode(false);

            this.Property(t => t.ParentRoleId).HasColumnName("ParentRoleId").HasMaxLength(15).IsUnicode(true);
