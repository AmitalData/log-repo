...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class StateMap : EntityTypeConfiguration<POCO.State>
    {
	    string dbms;
        public StateMap()
        { 
            ...
            this.Property(t => t.QBOTransactionLocationCode).HasColumnName("QBOTransactionLocationCode").HasMaxLength(3).IsUnicode(false);
