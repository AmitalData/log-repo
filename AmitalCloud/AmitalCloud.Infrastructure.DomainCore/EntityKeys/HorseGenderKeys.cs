...
{
   public class HorseGenderKeys<T> : BaseEntityKeyFields<EntityPOCOs.HorseGender,T> 
   {
		public HorseGenderKeys() : base() {}
        public HorseGenderKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "HorseGendersPM";
	  public override Expression<Func<EntityPOCOs.HorseGender, bool>> Predicate => a => a.Code == Code;
   }
}
