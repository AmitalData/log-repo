...
{
   public class UserPermittedBranchKeys<T> : BaseEntityKeyFields<EntityPOCOs.UserPermittedBranch,T> 
   {
		public UserPermittedBranchKeys() : base() {}
        public UserPermittedBranchKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
