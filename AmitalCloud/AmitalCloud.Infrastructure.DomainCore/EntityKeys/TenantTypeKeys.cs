...
{
   public class TenantTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.TenantType,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.TenantType, bool>> Predicate => a => a.Code == Code;
   }
}
