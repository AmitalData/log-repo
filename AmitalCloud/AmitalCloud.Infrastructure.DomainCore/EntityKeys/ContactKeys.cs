...
{
   public class ContactKeys<T> : BaseEntityKeyFields<EntityPOCOs.Contact,T> 
   {
		public ContactKeys() : base() {}
        public ContactKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ContactsPM";
	  public override Expression<Func<EntityPOCOs.Contact, bool>> Predicate => a => a.Id == Id;
   }
}
