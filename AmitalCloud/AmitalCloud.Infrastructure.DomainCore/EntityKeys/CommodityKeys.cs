...
{
   public class CommodityKeys<T> : BaseEntityKeyFields<EntityPOCOs.Commodity,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.Commodity, bool>> Predicate => a => a.Id == Id;
   }
}
