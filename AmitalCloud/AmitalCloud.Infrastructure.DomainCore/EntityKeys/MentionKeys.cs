...
{
   public class MentionKeys<T> : BaseEntityKeyFields<EntityPOCOs.Mention,T> 
   {
		public MentionKeys() : base() {}
        public MentionKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "MentionsPM";
	  public override Expression<Func<EntityPOCOs.Mention, bool>> Predicate => a => a.Id == Id;
   }
}
