...
{
   public class MenuButtonKeys<T> : BaseEntityKeyFields<EntityPOCOs.MenuButton,T> 
   {
		public MenuButtonKeys() : base() {}
	  ...
	  public override Expression<Func<EntityPOCOs.MenuButton, bool>> Predicate => a => a.Code == Code;
   }
}
