...
{
   public class GlobalDBKeys<T> : BaseEntityKeyFields<EntityPOCOs.GlobalDB,T> 
   {
		public GlobalDBKeys() : base() {}
        public GlobalDBKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "GlobalDBsPM";
	  public override Expression<Func<EntityPOCOs.GlobalDB, bool>> Predicate => a => a.Id == Id;
   }
}
