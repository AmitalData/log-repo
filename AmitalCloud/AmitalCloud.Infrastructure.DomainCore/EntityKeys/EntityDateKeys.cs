...
{
   public class EntityDateKeys<T> : BaseEntityKeyFields<EntityPOCOs.EntityDate,T> 
   {
		public EntityDateKeys() : base() {}
        public EntityDateKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "EntityDatesPM";
	  public override Expression<Func<EntityPOCOs.EntityDate, bool>> Predicate => a => a.Id == Id;
   }
}
