...
{
   public class RatesTableKeys<T> : BaseEntityKeyFields<EntityPOCOs.RatesTable,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.RatesTable, bool>> Predicate => a => a.Id == Id;
   }
}
