...
{
   public class IATACodeKeys<T> : BaseEntityKeyFields<EntityPOCOs.IATACode,T> 
   {
		public IATACodeKeys() : base() {}
        public IATACodeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "IATACodesPM";
	  public override Expression<Func<EntityPOCOs.IATACode, bool>> Predicate => a => a.Id == Id;
   }
}
