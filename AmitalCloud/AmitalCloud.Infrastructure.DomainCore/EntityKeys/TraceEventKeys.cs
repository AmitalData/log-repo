...
{
   public class TraceEventKeys<T> : BaseEntityKeyFields<EntityPOCOs.TraceEvent,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.TraceEvent, bool>> Predicate => a => a.Id == Id;
   }
}
