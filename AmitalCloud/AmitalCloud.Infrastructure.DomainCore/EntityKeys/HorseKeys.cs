...
{
   public class HorseKeys<T> : BaseEntityKeyFields<EntityPOCOs.Horse,T> 
   {
		public HorseKeys() : base() {}
        public HorseKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "HorsesPM";
	  public override Expression<Func<EntityPOCOs.Horse, bool>> Predicate => a => a.Id == Id;
   }
}
