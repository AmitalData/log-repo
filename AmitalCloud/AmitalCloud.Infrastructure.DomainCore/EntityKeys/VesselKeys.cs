...
{
   public class VesselKeys<T> : BaseEntityKeyFields<EntityPOCOs.Vessel,T> 
   {
		public VesselKeys() : base() {}
        public VesselKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "VesselsPM";
	  public override Expression<Func<EntityPOCOs.Vessel, bool>> Predicate => a => a.Id == Id;
   }
}
