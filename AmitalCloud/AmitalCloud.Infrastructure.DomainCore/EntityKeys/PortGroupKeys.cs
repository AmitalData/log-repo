...
{
   public class PortGroupKeys<T> : BaseEntityKeyFields<EntityPOCOs.PortGroup,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.PortGroup, bool>> Predicate => a => a.Id == Id;
   }
}
