...
{
   public class EventTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.EventType,T> 
   {
		public EventTypeKeys() : base() {}
        public EventTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "EventTypesPM";
	  public override Expression<Func<EntityPOCOs.EventType, bool>> Predicate => a => a.Id == Id;
   }
}
