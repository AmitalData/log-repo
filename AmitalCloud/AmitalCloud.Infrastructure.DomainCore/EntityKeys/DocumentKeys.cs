...
{
   public class DocumentKeys<T> : BaseEntityKeyFields<EntityPOCOs.Document,T> 
   {
		public DocumentKeys() : base() {}
        public DocumentKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DocumentsPM";
	  public override Expression<Func<EntityPOCOs.Document, bool>> Predicate => a => a.Id == Id;
   }
}
