...
{
   public class TruckerKeys<T> : BaseEntityKeyFields<EntityPOCOs.Trucker,T> 
   {
		public TruckerKeys() : base() {}
        public TruckerKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TruckersPM";
	  public override Expression<Func<EntityPOCOs.Trucker, bool>> Predicate => a => a.Id == Id;
   }
}
