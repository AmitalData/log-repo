...
{
   public class AccountTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.AccountType,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.AccountType, bool>> Predicate => a => a.Code == Code;
   }
}
