...
{
   public class HTSCodeKeys<T> : BaseEntityKeyFields<EntityPOCOs.HTSCode,T> 
   {
		public HTSCodeKeys() : base() {}
        public HTSCodeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "HTSCodesPM";
	  public override Expression<Func<EntityPOCOs.HTSCode, bool>> Predicate => a => a.Id == Id;
   }
}
