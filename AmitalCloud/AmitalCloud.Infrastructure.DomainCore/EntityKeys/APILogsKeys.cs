...
{
   public class APILogsKeys<T> : BaseEntityKeyFields<EntityPOCOs.APILogs,T> 
   {
		public APILogsKeys() : base() {}
        public APILogsKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "APILogsPM";
	  public override Expression<Func<EntityPOCOs.APILogs, bool>> Predicate => a => a.Id == Id;
   }
}
