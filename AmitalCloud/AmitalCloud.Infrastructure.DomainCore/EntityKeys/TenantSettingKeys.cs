...
{
   public class TenantSettingKeys<T> : BaseEntityKeyFields<EntityPOCOs.TenantSetting,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.TenantSetting, bool>> Predicate => a => a.Id == Id;
   }
}
