...
{
   public class CardContactKeys<T> : BaseEntityKeyFields<ENTITIES.CardContact,T> 
   {
		public CardContactKeys() : base() {}
        public CardContactKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CardContactsPM";
	  public override Expression<Func<ENTITIES.CardContact, bool>> Predicate => a => a.Id == Id;
   }
}
