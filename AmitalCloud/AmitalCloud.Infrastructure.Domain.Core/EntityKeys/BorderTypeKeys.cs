...
{
   public class BorderTypeKeys<T> : BaseEntityKeyFields<ENTITIES.BorderType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BorderType, bool>> Predicate => a => a.Code == Code;
   }
}
