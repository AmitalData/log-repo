...
{
   public class TipsVisibilityKeys<T> : BaseEntityKeyFields<ENTITIES.TipsVisibility,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TipsVisibility, bool>> Predicate => a => a.Id == Id;
   }
}
