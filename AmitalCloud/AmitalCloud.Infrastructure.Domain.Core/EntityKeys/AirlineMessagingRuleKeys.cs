...
{
   public class AirlineMessagingRuleKeys<T> : BaseEntityKeyFields<ENTITIES.AirlineMessagingRule,T> 
   {
		public AirlineMessagingRuleKeys() : base() {}
        public AirlineMessagingRuleKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AirlineMessagingRulesPM";
	  public override Expression<Func<ENTITIES.AirlineMessagingRule, bool>> Predicate => a => a.Id == Id;
   }
}
