...
{
   public class DigitalTextCodeKeys<T> : BaseEntityKeyFields<ENTITIES.DigitalTextCode,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DigitalTextCode, bool>> Predicate => a => a.Id == Id;
   }
}
