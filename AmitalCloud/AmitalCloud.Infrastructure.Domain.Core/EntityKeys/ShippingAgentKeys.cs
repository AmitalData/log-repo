...
{
   public class ShippingAgentKeys<T> : BaseEntityKeyFields<ENTITIES.ShippingAgent,T> 
   {
		public ShippingAgentKeys() : base() {}
        public ShippingAgentKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ShippingAgentsPM";
	  public override Expression<Func<ENTITIES.ShippingAgent, bool>> Predicate => a => a.Id == Id;
   }
}
