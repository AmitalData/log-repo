...
{
   public class ScreenFieldKeys<T> : BaseEntityKeyFields<ENTITIES.ScreenField,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ScreenField, bool>> Predicate => a => a.Id == Id;
   }
}
