...
{
   public class RecurringPeriodKeys<T> : BaseEntityKeyFields<ENTITIES.RecurringPeriod,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.RecurringPeriod, bool>> Predicate => a => a.Code == Code;
   }
}
