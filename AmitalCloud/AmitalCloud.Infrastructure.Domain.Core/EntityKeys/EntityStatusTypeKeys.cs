...
{
   public class EntityStatusTypeKeys<T> : BaseEntityKeyFields<ENTITIES.EntityStatusType,T> 
   {
		public EntityStatusTypeKeys() : base() {}
        public EntityStatusTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "EntityStatusTypesPM";
	  public override Expression<Func<ENTITIES.EntityStatusType, bool>> Predicate => a => a.Code == Code;
   }
}
