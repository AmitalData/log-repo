...
{ 
   public partial class CountryCityQueryService: BaseEntityQueryService<POCO.CountryCity,CountryCityKeys<string>,CountryCityPM,CountryCityList,string>
   {
        public CountryCityQueryService(int tenant) : base(new Repository<POCO.CountryCity>(tenant),new CountryCityDataMapping()) {}
