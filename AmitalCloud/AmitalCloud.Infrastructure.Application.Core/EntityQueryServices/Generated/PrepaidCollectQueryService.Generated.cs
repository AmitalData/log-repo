...
{ 
   public partial class PrepaidCollectQueryService: BaseEntityQueryService<POCO.PrepaidCollect,PrepaidCollectKeys<string>,PrepaidCollectPM,PrepaidCollectList,string>
   {
        public PrepaidCollectQueryService(int tenant) : base(new Repository<POCO.PrepaidCollect>(tenant),new PrepaidCollectDataMapping()) {}
