...
{ 
   public partial class CaptchaKeyQueryService: BaseEntityQueryService<POCO.CaptchaKey,CaptchaKeyKeys<string>,CaptchaKeyPM,CaptchaKeyList,string>
   {
        public CaptchaKeyQueryService(int tenant) : base(new Repository<POCO.CaptchaKey>(tenant),new CaptchaKeyDataMapping()) {}
