...
{
    public class ObjectTableRuleFieldRepository : Repository<ObjectTableRuleField>
    {
        ...
        public ObjectTableRuleFieldRepository(int tenant) : this(AmitalCloudContext.GetContext(tenant))
        {
        }
