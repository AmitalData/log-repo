...
{
   public partial class DistributorDataMapping: IMapping<DistributorPM, POCO.Distributor  ,DistributorList >,IMappingEncodeBase64NVARCHARFields<DistributorPM>
   {
	    ...
	    public void PMToPOCO(DistributorPM entityPM, POCO.Distributor entityPOCO)
        {
		...
		public void POCOToPM(DistributorPM entityPM, POCO.Distributor entityPOCO)
        {
		...
		public void PMToOldPM(DistributorPM entityPM, DistributorPM oldEntityPM)
        {
		...
		public void POCOToList(POCO.Distributor entityPOCO, DistributorList entityList)
        {
            //entityList.Code = entityPOCO.Code;
            //entityList.Name = entityPOCO.Name;
            //entityList.SearchFields = entityPOCO.SearchFields;
        }
		public IQueryable<DistributorList> GetIqueryableList(IQueryable<POCO.Distributor> iQueryable)
		{
			IQueryable<DistributorList> query = (from a in iQueryable
        ...
        public void AddPMPropertyName(PMPropertyNames pocoPropertyName)
        {
            CustomMappedPMProperties.Add(pocoPropertyName);
				...
				private void BuildSearchFieldsGenerated(DistributorPM entityPM, POCO.Distributor entityPOCO, bool isNewEntity)
        {
