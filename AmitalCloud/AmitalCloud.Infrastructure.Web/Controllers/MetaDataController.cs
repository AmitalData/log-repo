...
namespace AmitalCloud.Infrastructure.Web.Controllers
{
    ...
    public class MetaDataController : ApiController
    {
        ...
        public List<Translation> GetTenantLanguageTranslations(int tenant)
        {
            ...
            {
                AllTranslations = new TranslationQuery(tenant).GetTenantLanguageTranslations(tenantPM.Language);
            }
        ...
        public List<Translation> GetTranslations(int translationTenant)
        {
            ...
            List<Translation> AllTranslations = new TranslationQuery(translationTenant).GetTenantTranslations();
            return AllTranslations;
        }
