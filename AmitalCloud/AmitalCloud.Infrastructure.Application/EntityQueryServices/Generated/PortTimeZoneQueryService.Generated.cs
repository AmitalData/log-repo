...
{ 
   public partial class PortTimeZoneQueryService: BaseEntityQueryService<POCO.PortTimeZone,PortTimeZoneKeys<string>,PortTimeZonePM,PortTimeZoneList,string>
   {
        public PortTimeZoneQueryService(int tenant) : base(new Repository<POCO.PortTimeZone>(tenant),new PortTimeZoneDataMapping()) {}
