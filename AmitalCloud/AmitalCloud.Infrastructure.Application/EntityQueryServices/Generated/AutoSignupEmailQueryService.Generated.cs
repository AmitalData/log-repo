...
{ 
   public partial class AutoSignupEmailQueryService: BaseEntityQueryService<POCO.AutoSignupEmail,AutoSignupEmailKeys<string>,AutoSignupEmailPM,AutoSignupEmailList,string>
   {
        public AutoSignupEmailQueryService(int tenant) : base(new Repository<POCO.AutoSignupEmail>(tenant),new AutoSignupEmailDataMapping()) {}
