...
{ 
   public partial class BusinessProcessQueueQueryService: BaseEntityQueryService<POCO.BusinessProcessQueue,BusinessProcessQueueKeys<string>,BusinessProcessQueuePM,BusinessProcessQueueList,string>
   {
        public BusinessProcessQueueQueryService(int tenant) : base(new Repository<POCO.BusinessProcessQueue>(tenant),new BusinessProcessQueueDataMapping()) {}
