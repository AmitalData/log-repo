...
{ 
   public partial class GlobalDBQueryService: BaseEntityQueryService<POCO.GlobalDB,GlobalDBKeys<string>,GlobalDBPM,GlobalDBList,string>
   {
        public GlobalDBQueryService(int tenant) : base(new Repository<POCO.GlobalDB>(tenant),new GlobalDBDataMapping()) {}
