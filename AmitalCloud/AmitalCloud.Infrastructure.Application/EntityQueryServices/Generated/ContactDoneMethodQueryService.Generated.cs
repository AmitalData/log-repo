...
{ 
   public partial class ContactDoneMethodQueryService: BaseEntityQueryService<POCO.ContactDoneMethod,ContactDoneMethodKeys<string>,ContactDoneMethodPM,ContactDoneMethodList,string>
   {
        public ContactDoneMethodQueryService(int tenant) : base(new Repository<POCO.ContactDoneMethod>(tenant),new ContactDoneMethodDataMapping()) {}
