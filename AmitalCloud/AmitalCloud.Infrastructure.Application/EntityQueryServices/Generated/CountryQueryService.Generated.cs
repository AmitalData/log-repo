...
{ 
   public partial class CountryQueryService: BaseEntityQueryService<POCO.Country,CountryKeys<string>,CountryPM,CountryList,string>
   {
        public CountryQueryService(int tenant) : base(new Repository<POCO.Country>(tenant),new CountryDataMapping()) {}
