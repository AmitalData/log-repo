...
{ 
   public partial class SettingQueryService: BaseEntityQueryService<POCO.Setting,SettingKeys<string>,SettingPM,SettingList,string>
   {
        public SettingQueryService(int tenant) : base(new Repository<POCO.Setting>(tenant),new SettingDataMapping()) {}
