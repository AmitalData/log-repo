...
{ 
   public partial class DepartmentQueryService: BaseEntityQueryService<POCO.Department,DepartmentKeys<string>,DepartmentPM,DepartmentList,string>
   {
        public DepartmentQueryService(int tenant) : base(new Repository<POCO.Department>(tenant),new DepartmentDataMapping()) {}
