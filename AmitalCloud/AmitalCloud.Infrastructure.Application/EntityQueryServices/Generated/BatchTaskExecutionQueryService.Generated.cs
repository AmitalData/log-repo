...
{ 
   public partial class BatchTaskExecutionQueryService: BaseEntityQueryService<POCO.BatchTaskExecution,BatchTaskExecutionKeys<string>,BatchTaskExecutionPM,BatchTaskExecutionList,string>
   {
        public BatchTaskExecutionQueryService(int tenant) : base(new Repository<POCO.BatchTaskExecution>(tenant),new BatchTaskExecutionDataMapping()) {}
