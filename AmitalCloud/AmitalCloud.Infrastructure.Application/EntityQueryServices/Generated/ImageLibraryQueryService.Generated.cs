...
{ 
   public partial class ImageLibraryQueryService: BaseEntityQueryService<POCO.ImageLibrary,ImageLibraryKeys<string>,ImageLibraryPM,ImageLibraryList,string>
   {
        public ImageLibraryQueryService(int tenant) : base(new Repository<POCO.ImageLibrary>(tenant),new ImageLibraryDataMapping()) {}
