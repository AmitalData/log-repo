...
{ 
   public partial class GlobalTenantQueryService: BaseEntityQueryService<POCO.GlobalTenant,GlobalTenantKeys<int>,GlobalTenantPM,GlobalTenantList,int>
   {
        public GlobalTenantQueryService(int tenant) : base(new Repository<POCO.GlobalTenant>(tenant),new GlobalTenantDataMapping()) {}
