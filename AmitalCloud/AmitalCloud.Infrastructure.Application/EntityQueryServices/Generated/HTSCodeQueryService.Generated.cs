...
{ 
   public partial class HTSCodeQueryService: BaseEntityQueryService<POCO.HTSCode,HTSCodeKeys<string>,HTSCodePM,HTSCodeList,string>
   {
        public HTSCodeQueryService(int tenant) : base(new Repository<POCO.HTSCode>(tenant),new HTSCodeDataMapping()) {}
