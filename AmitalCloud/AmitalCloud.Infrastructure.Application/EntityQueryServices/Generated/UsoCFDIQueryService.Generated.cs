...
{ 
   public partial class UsoCFDIQueryService: BaseEntityQueryService<POCO.UsoCFDI,UsoCFDIKeys<string>,UsoCFDIPM,UsoCFDIList,string>
   {
        public UsoCFDIQueryService(int tenant) : base(new Repository<POCO.UsoCFDI>(tenant),new UsoCFDIDataMapping()) {}
