...
{ 
   public partial class CreditLimitSettingQueryService: BaseEntityQueryService<POCO.CreditLimitSetting,CreditLimitSettingKeys<string>,CreditLimitSettingPM,CreditLimitSettingList,string>
   {
        public CreditLimitSettingQueryService(int tenant) : base(new Repository<POCO.CreditLimitSetting>(tenant),new CreditLimitSettingDataMapping()) {}
