...
{ 
   public partial class SystemDataQueryService: BaseEntityQueryService<POCO.SystemData,SystemDataKeys<string>,SystemDataPM,SystemDataList,string>
   {
        public SystemDataQueryService(int tenant) : base(new Repository<POCO.SystemData>(tenant),new SystemDataDataMapping()) {}
