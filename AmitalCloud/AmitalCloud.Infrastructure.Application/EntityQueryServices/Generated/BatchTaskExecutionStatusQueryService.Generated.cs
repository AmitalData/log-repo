...
{ 
   public partial class BatchTaskExecutionStatusQueryService: BaseEntityQueryService<POCO.BatchTaskExecutionStatus,BatchTaskExecutionStatusKeys<string>,BatchTaskExecutionStatusPM,BatchTaskExecutionStatusList,string>
   {
        public BatchTaskExecutionStatusQueryService(int tenant) : base(new Repository<POCO.BatchTaskExecutionStatus>(tenant),new BatchTaskExecutionStatusDataMapping()) {}
