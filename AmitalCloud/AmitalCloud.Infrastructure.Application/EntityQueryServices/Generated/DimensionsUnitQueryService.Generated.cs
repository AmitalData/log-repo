...
{ 
   public partial class DimensionsUnitQueryService: BaseEntityQueryService<POCO.DimensionsUnit,DimensionsUnitKeys<string>,DimensionsUnitPM,DimensionsUnitList,string>
   {
        public DimensionsUnitQueryService(int tenant) : base(new Repository<POCO.DimensionsUnit>(tenant),new DimensionsUnitDataMapping()) {}
