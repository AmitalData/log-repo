...
{ 
   public partial class CurrencyQueryService: BaseEntityQueryService<POCO.Currency,CurrencyKeys<string>,CurrencyPM,CurrencyList,string>
   {
        public CurrencyQueryService(int tenant) : base(new Repository<POCO.Currency>(tenant),new CurrencyDataMapping()) {}
