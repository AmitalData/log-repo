...
{ 
   public partial class GlobalZoneQueryService: BaseEntityQueryService<POCO.GlobalZone,GlobalZoneKeys<string>,GlobalZonePM,GlobalZoneList,string>
   {
        public GlobalZoneQueryService(int tenant) : base(new Repository<POCO.GlobalZone>(tenant),new GlobalZoneDataMapping()) {}
