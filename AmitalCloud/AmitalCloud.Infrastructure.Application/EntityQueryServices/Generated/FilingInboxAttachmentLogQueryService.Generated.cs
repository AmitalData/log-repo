...
{ 
   public partial class FilingInboxAttachmentLogQueryService: BaseEntityQueryService<POCO.FilingInboxAttachmentLog,FilingInboxAttachmentLogKeys<string>,FilingInboxAttachmentLogPM,FilingInboxAttachmentLogList,string>
   {
        public FilingInboxAttachmentLogQueryService(int tenant) : base(new Repository<POCO.FilingInboxAttachmentLog>(tenant),new FilingInboxAttachmentLogDataMapping()) {}
