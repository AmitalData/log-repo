...
{ 
   public partial class RestrictionQueryService: BaseEntityQueryService<POCO.Restriction,RestrictionKeys<string>,RestrictionPM,RestrictionList,string>
   {
        public RestrictionQueryService(int tenant) : base(new Repository<POCO.Restriction>(tenant),new RestrictionDataMapping()) {}
