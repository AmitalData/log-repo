...
{ 
   public partial class BorderTypeQueryService: BaseEntityQueryService<POCO.BorderType,BorderTypeKeys<string>,BorderTypePM,BorderTypeList,string>
   {
        public BorderTypeQueryService(int tenant) : base(new Repository<POCO.BorderType>(tenant),new BorderTypeDataMapping()) {}
