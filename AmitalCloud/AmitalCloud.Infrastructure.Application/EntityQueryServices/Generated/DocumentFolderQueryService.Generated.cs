...
{ 
   public partial class DocumentFolderQueryService: BaseEntityQueryService<POCO.DocumentFolder,DocumentFolderKeys<string>,DocumentFolderPM,DocumentFolderList,string>
   {
        public DocumentFolderQueryService(int tenant) : base(new Repository<POCO.DocumentFolder>(tenant),new DocumentFolderDataMapping()) {}
