...
{ 
    ...
    {
	    protected override System.Data.Entity.IDbSet<POCO.AccountingSystem> contextEntity => (context as IAmitalCloudContext).AccountingSystems;
		public AccountingSystemListQueryService(int tenant) : base(AmitalCloudContext.GetContext(tenant)) { }
        public AccountingSystemList GetSingle(string code)
		{
