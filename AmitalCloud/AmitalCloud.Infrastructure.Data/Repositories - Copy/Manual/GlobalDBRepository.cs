...
{
    public class GlobalDBRepository:IRepository<GlobalDB,string>
    {
        ...
        public List<GlobalDB> GetMulti(IEntityKeyFields<GlobalDB,string> entityKeys)
        {
            throw new NotImplementedException();
        }

        public GlobalDB GetSingle(IEntityKeyFields<GlobalDB,string> entityKeys)
        {
            throw new NotImplementedException();
        }
