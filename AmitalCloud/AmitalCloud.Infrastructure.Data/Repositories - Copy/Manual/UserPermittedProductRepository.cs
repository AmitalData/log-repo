...
{
    public class UserPermittedProductRepository:IRepository<UserPermittedProduct,string>
    {
        IAmitalCloudContext currentContext;

        public UserPermittedProductRepository(IAmitalCloudContext context)
        {
        ...
        public List<UserPermittedProduct> GetMulti(IEntityKeyFields<UserPermittedProduct,string> entityKeys)
        {
            throw new NotImplementedException();
        }

        public UserPermittedProduct GetSingle(IEntityKeyFields<UserPermittedProduct,string> entityKeys)
        {
            throw new NotImplementedException();
        }
    }
