...
{
    public class CardContactRepository:IRepository<CardContact,string>
    {
        IAmitalCloudContext currentContext;
        public CardContactRepository(IAmitalCloudContext context)
        {
        ...
        public List<CardContact> GetMulti(IEntityKeyFields<CardContact,string> entityKeys)
        {
            throw new System.NotImplementedException();
        }

        public CardContact GetSingle(IEntityKeyFields<CardContact,string> entityKeys)
        {
            throw new System.NotImplementedException();
        }
