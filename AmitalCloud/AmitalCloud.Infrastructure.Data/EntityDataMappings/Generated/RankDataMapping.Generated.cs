...
{
   public partial class RankDataMapping: IMapping<RankPM, POCO.Rank  ,RankList >,IMappingEncodeBase64NVARCHARFields<RankPM>
   {
	    ...
	    public void PMToPOCO(RankPM entityPM, POCO.Rank entityPOCO)
        {
		...
		public void POCOToPM(RankPM entityPM, POCO.Rank entityPOCO)
        {
		...
		public void PMToOldPM(RankPM entityPM, RankPM oldEntityPM)
        {
		...
		public void POCOToList(POCO.Rank entityPOCO, RankList entityList)
        {
            //entityList.Code = entityPOCO.Code;
            //entityList.Name = entityPOCO.Name;
            //entityList.SearchFields = entityPOCO.SearchFields;
        }
		public IQueryable<RankList> GetIqueryableList(IQueryable<POCO.Rank> iQueryable)
		{
			IQueryable<RankList> query = (from a in iQueryable
                                            select new RankList()
											{
					                          //Code = a.Code,
		                    	            });
	    ...
	    public void EncodeBase64NVARCHARFields(RankPM entityPM)
        {
        ...
        public void AddPMPropertyName(PMPropertyNames pocoPropertyName)
        {
            CustomMappedPMProperties.Add(pocoPropertyName);
				...
				private void BuildSearchFieldsGenerated(RankPM entityPM, POCO.Rank entityPOCO, bool isNewEntity)
        {
