...
{
   public class CountryKeys<T> : BaseEntityKeyFields<ENTITIES.Country,T> 
   {
		public CountryKeys() : base() {}
        public CountryKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CountriesPM";
	  public override Expression<Func<ENTITIES.Country, bool>> Predicate => a => a.Id == Id;
   }
}
