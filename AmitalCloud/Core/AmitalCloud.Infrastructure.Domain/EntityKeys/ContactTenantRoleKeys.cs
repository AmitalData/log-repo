...
{
   public class ContactTenantRoleKeys<T> : BaseEntityKeyFields<ENTITIES.ContactTenantRole,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ContactTenantRole, bool>> Predicate => a => a.Id == Id;
   }
}
