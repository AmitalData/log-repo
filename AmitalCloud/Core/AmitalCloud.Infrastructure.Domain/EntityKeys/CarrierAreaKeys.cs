...
{
   public class CarrierAreaKeys<T> : BaseEntityKeyFields<ENTITIES.CarrierArea,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CarrierArea, bool>> Predicate => a => a.Id == Id;
   }
}
