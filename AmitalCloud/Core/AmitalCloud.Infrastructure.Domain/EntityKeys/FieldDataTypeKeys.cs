...
{
   public class FieldDataTypeKeys<T> : BaseEntityKeyFields<ENTITIES.FieldDataType,T> 
   {
		public FieldDataTypeKeys() : base() {}
        public FieldDataTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "FieldDataTypesPM";
	  public override Expression<Func<ENTITIES.FieldDataType, bool>> Predicate => a => a.Code == Code;
   }
}
