...
{
   public class FailedTokenLogKeys<T> : BaseEntityKeyFields<ENTITIES.FailedTokenLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.FailedTokenLog, bool>> Predicate => a => a.Id == Id;
   }
}
