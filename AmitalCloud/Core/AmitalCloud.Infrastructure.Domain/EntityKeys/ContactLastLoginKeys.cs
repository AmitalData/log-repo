...
{
   public class ContactLastLoginKeys<T> : BaseEntityKeyFields<ENTITIES.ContactLastLogin,T> 
   {
		public ContactLastLoginKeys() : base() {}
        public ContactLastLoginKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ContactLastLoginsPM";
	  public override Expression<Func<ENTITIES.ContactLastLogin, bool>> Predicate => a => a.Id == Id;
   }
}
