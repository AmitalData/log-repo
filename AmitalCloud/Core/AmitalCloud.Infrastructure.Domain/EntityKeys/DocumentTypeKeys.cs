...
{
   public class DocumentTypeKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentType, bool>> Predicate => a => a.Id == Id;
   }
}
