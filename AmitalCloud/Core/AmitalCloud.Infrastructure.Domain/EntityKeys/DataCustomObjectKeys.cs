...
{
   public class DataCustomObjectKeys<T> : BaseEntityKeyFields<ENTITIES.DataCustomObject,T> 
   {
		public DataCustomObjectKeys() : base() {}
        public DataCustomObjectKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DataCustomObjectsPM";
	  public override Expression<Func<ENTITIES.DataCustomObject, bool>> Predicate => a => a.Id == Id;
   }
}
