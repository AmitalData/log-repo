...
{
   public class PaymentTermDateTypeKeys<T> : BaseEntityKeyFields<ENTITIES.PaymentTermDateType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PaymentTermDateType, bool>> Predicate => a => a.Code == Code;
   }
}
