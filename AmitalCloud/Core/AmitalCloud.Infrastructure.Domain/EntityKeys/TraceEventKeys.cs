...
{
   public class TraceEventKeys<T> : BaseEntityKeyFields<ENTITIES.TraceEvent,T> 
   {
		public TraceEventKeys() : base() {}
        public TraceEventKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TraceEventsPM";
	  public override Expression<Func<ENTITIES.TraceEvent, bool>> Predicate => a => a.Id == Id;
   }
}
