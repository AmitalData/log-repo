...
{
   public class SchedulerProcedureKeys<T> : BaseEntityKeyFields<ENTITIES.SchedulerProcedure,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.SchedulerProcedure, bool>> Predicate => a => a.Code == Code;
   }
}
