...
{
   public class CreditLimitSettingKeys<T> : BaseEntityKeyFields<ENTITIES.CreditLimitSetting,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CreditLimitSetting, bool>> Predicate => a => a.Id == Id;
   }
}
