...
{
   public class CommodityKeys<T> : BaseEntityKeyFields<ENTITIES.Commodity,T> 
   {
		public CommodityKeys() : base() {}
        public CommodityKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CommoditiesPM";
	  public override Expression<Func<ENTITIES.Commodity, bool>> Predicate => a => a.Id == Id;
   }
}
