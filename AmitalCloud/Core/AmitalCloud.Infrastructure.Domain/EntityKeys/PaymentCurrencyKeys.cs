...
{
   public class PaymentCurrencyKeys<T> : BaseEntityKeyFields<ENTITIES.PaymentCurrency,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PaymentCurrency, bool>> Predicate => a => a.Code == Code;
   }
}
