...
{
   public class BusinessHoursHolidayKeys<T> : BaseEntityKeyFields<ENTITIES.BusinessHoursHoliday,T> 
   {
		public BusinessHoursHolidayKeys() : base() {}
        public BusinessHoursHolidayKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "BusinessHoursHolidaysPM";
	  public override Expression<Func<ENTITIES.BusinessHoursHoliday, bool>> Predicate => a => a.Id == Id;
   }
}
