...
{
   public class QuoteTemplateSectionKeys<T> : BaseEntityKeyFields<ENTITIES.QuoteTemplateSection,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.QuoteTemplateSection, bool>> Predicate => a => a.Id == Id;
   }
}
