...
{
   public class AnalyzeQueueKeys<T> : BaseEntityKeyFields<ENTITIES.AnalyzeQueue,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.AnalyzeQueue, bool>> Predicate => a => a.Id == Id;
   }
}
