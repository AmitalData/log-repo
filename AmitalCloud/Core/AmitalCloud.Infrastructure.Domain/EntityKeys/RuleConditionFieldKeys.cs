...
{
   public class RuleConditionFieldKeys<T> : BaseEntityKeyFields<ENTITIES.RuleConditionField,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.RuleConditionField, bool>> Predicate => a => a.Id == Id;
   }
}
