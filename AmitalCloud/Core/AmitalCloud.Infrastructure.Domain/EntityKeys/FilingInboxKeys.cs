...
{
   public class FilingInboxKeys<T> : BaseEntityKeyFields<ENTITIES.FilingInbox,T> 
   {
		public FilingInboxKeys() : base() {}
        public FilingInboxKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "FilingInboxesPM";
	  public override Expression<Func<ENTITIES.FilingInbox, bool>> Predicate => a => a.Id == Id;
   }
}
