...
{
   public class CountryCityKeys<T> : BaseEntityKeyFields<ENTITIES.CountryCity,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CountryCity, bool>> Predicate => a => a.Id == Id;
   }
}
