...
{
   public class EntityStatusKeys<T> : BaseEntityKeyFields<ENTITIES.EntityStatus,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.EntityStatus, bool>> Predicate => a => a.Id == Id;
   }
}
