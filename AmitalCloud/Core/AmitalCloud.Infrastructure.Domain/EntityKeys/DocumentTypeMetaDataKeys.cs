...
{
   public class DocumentTypeMetaDataKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentTypeMetaData,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentTypeMetaData, bool>> Predicate => a => a.Id == Id;
   }
}
