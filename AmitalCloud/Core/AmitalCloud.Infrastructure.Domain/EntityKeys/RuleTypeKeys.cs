...
{
   public class RuleTypeKeys<T> : BaseEntityKeyFields<ENTITIES.RuleType,T> 
   {
		public RuleTypeKeys() : base() {}
        public RuleTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "RuleTypesPM";
	  public override Expression<Func<ENTITIES.RuleType, bool>> Predicate => a => a.Code == Code;
   }
}
