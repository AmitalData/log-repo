...
{
   public class MobileNotificationLogKeys<T> : BaseEntityKeyFields<ENTITIES.MobileNotificationLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.MobileNotificationLog, bool>> Predicate => a => a.Id == Id;
   }
}
