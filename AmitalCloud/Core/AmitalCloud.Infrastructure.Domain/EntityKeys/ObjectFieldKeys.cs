...
{
   public class ObjectFieldKeys<T> : BaseEntityKeyFields<ENTITIES.ObjectField,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ObjectField, bool>> Predicate => a => a.Id == Id;
   }
}
