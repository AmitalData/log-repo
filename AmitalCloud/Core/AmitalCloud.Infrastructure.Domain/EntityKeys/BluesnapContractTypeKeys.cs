...
{
   public class BluesnapContractTypeKeys<T> : BaseEntityKeyFields<ENTITIES.BluesnapContractType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BluesnapContractType, bool>> Predicate => a => a.Code == Code;
   }
}
