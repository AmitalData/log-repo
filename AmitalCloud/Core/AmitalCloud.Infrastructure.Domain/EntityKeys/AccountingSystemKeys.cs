...
{
   public class AccountingSystemKeys<T> : BaseEntityKeyFields<ENTITIES.AccountingSystem,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.AccountingSystem, bool>> Predicate => a => a.Code == Code;
   }
}
