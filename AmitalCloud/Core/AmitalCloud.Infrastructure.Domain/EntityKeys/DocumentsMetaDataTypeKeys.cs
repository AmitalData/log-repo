...
{
   public class DocumentsMetaDataTypeKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentsMetaDataType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentsMetaDataType, bool>> Predicate => a => a.Id == Id;
   }
}
