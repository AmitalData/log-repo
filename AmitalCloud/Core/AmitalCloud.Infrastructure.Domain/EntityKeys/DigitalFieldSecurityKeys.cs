...
{
   public class DigitalFieldSecurityKeys<T> : BaseEntityKeyFields<ENTITIES.DigitalFieldSecurity,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DigitalFieldSecurity, bool>> Predicate => a => a.Id == Id;
   }
}
