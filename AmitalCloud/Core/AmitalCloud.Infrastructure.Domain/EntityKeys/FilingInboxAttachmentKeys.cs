...
{
   public class FilingInboxAttachmentKeys<T> : BaseEntityKeyFields<ENTITIES.FilingInboxAttachment,T> 
   {
		public FilingInboxAttachmentKeys() : base() {}
        public FilingInboxAttachmentKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "FilingInboxAttachmentsPM";
	  public override Expression<Func<ENTITIES.FilingInboxAttachment, bool>> Predicate => a => a.Id == Id;
   }
}
