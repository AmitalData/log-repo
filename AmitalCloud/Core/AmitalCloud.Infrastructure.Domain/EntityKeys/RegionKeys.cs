...
{
   public class RegionKeys<T> : BaseEntityKeyFields<ENTITIES.Region,T> 
   {
		public RegionKeys() : base() {}
        public RegionKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "RegionsPM";
	  public override Expression<Func<ENTITIES.Region, bool>> Predicate => a => a.Id == Id;
   }
}
