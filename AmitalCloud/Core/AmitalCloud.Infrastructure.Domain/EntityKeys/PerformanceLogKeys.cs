...
{
   public class PerformanceLogKeys<T> : BaseEntityKeyFields<ENTITIES.PerformanceLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PerformanceLog, bool>> Predicate => a => a.Id == Id;
   }
}
