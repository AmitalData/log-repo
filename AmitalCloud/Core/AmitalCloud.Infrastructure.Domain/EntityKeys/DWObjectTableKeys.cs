...
{
   public class DWObjectTableKeys<T> : BaseEntityKeyFields<ENTITIES.DWObjectTable,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DWObjectTable, bool>> Predicate => a => a.Code == Code;
   }
}
