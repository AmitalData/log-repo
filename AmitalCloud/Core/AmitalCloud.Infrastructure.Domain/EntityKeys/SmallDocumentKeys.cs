...
{
   public class SmallDocumentKeys<T> : BaseEntityKeyFields<ENTITIES.SmallDocument,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.SmallDocument, bool>> Predicate => a => a.Id == Id;
   }
}
