...
{
   public class BatchServicesLogKeys<T> : BaseEntityKeyFields<ENTITIES.BatchServicesLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BatchServicesLog, bool>> Predicate => a => a.Id == Id;
   }
}
