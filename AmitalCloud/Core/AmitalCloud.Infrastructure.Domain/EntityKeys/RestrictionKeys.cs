...
{
   public class RestrictionKeys<T> : BaseEntityKeyFields<ENTITIES.Restriction,T> 
   {
		public RestrictionKeys() : base() {}
        public RestrictionKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "RestrictionsPM";
	  public override Expression<Func<ENTITIES.Restriction, bool>> Predicate => a => a.Id == Id;
   }
}
