...
{
   public class HelpResourceKeys<T> : BaseEntityKeyFields<ENTITIES.HelpResource,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.HelpResource, bool>> Predicate => a => a.Code == Code;
   }
}
