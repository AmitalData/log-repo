...
{
   public class SpecialServiceKeys<T> : BaseEntityKeyFields<ENTITIES.SpecialService,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.SpecialService, bool>> Predicate => a => a.Id == Id;
   }
}
