...
{
   public class AWBDescriptionOfGoodsKeys<T> : BaseEntityKeyFields<ENTITIES.AWBDescriptionOfGoods,T> 
   {
		public AWBDescriptionOfGoodsKeys() : base() {}
        public AWBDescriptionOfGoodsKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AWBDescriptionOfGoodsPM";
	  public override Expression<Func<ENTITIES.AWBDescriptionOfGoods, bool>> Predicate => a => a.Id == Id;
   }
}
