...
{
   public class FeatureAccessLevelKeys<T> : BaseEntityKeyFields<ENTITIES.FeatureAccessLevel,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.FeatureAccessLevel, bool>> Predicate => a => a.Code == Code;
   }
}
