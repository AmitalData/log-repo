...
{
   public class BIReportKeys<T> : BaseEntityKeyFields<ENTITIES.BIReport,T> 
   {
		public BIReportKeys() : base() {}
        public BIReportKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "BIReportsPM";
	  public override Expression<Func<ENTITIES.BIReport, bool>> Predicate => a => a.Id == Id;
   }
}
