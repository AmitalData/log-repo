...
{
   public class VatTypePercentageKeys<T> : BaseEntityKeyFields<ENTITIES.VatTypePercentage,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.VatTypePercentage, bool>> Predicate => a => a.Id == Id;
   }
}
