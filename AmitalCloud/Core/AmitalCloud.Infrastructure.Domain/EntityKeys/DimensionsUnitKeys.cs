...
{
   public class DimensionsUnitKeys<T> : BaseEntityKeyFields<ENTITIES.DimensionsUnit,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DimensionsUnit, bool>> Predicate => a => a.Code == Code;
   }
}
