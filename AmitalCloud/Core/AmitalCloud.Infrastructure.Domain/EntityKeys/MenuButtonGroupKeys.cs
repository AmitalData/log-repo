...
{
   public class MenuButtonGroupKeys<T> : BaseEntityKeyFields<ENTITIES.MenuButtonGroup,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.MenuButtonGroup, bool>> Predicate => a => a.Id == Id;
   }
}
