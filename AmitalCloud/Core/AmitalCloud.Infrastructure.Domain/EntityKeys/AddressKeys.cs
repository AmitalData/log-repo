...
{
   public class AddressKeys<T> : BaseEntityKeyFields<ENTITIES.Address,T> 
   {
		public AddressKeys() : base() {}
        public AddressKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AddressesPM";
	  public override Expression<Func<ENTITIES.Address, bool>> Predicate => a => a.Id == Id;
   }
}
