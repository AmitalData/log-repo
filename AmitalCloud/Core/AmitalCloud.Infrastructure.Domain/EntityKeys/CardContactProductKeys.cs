...
{
   public class CardContactProductKeys<T> : BaseEntityKeyFields<ENTITIES.CardContactProduct,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CardContactProduct, bool>> Predicate => a => a.Id == Id;
   }
}
