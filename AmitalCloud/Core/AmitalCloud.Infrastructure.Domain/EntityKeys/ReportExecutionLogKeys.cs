...
{
   public class ReportExecutionLogKeys<T> : BaseEntityKeyFields<ENTITIES.ReportExecutionLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ReportExecutionLog, bool>> Predicate => a => a.Id == Id;
   }
}
