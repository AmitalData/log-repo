...
{
   public class RegistryDateTypeKeys<T> : BaseEntityKeyFields<ENTITIES.RegistryDateType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.RegistryDateType, bool>> Predicate => a => a.Code == Code;
   }
}
