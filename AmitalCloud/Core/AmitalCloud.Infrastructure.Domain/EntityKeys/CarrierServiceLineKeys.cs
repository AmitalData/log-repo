...
{
   public class CarrierServiceLineKeys<T> : BaseEntityKeyFields<ENTITIES.CarrierServiceLine,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CarrierServiceLine, bool>> Predicate => a => a.Id == Id;
   }
}
