...
{
   public class BIReportsExecutionLogKeys<T> : BaseEntityKeyFields<ENTITIES.BIReportsExecutionLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BIReportsExecutionLog, bool>> Predicate => a => a.Id == Id;
   }
}
