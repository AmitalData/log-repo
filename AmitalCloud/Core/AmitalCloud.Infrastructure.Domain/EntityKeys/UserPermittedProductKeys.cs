...
{
   public class UserPermittedProductKeys<T> : BaseEntityKeyFields<ENTITIES.UserPermittedProduct,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.UserPermittedProduct, bool>> Predicate => a => a.Id == Id;
   }
}
