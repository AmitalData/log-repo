...
{
   public class VatFormatTypeKeys<T> : BaseEntityKeyFields<ENTITIES.VatFormatType,T> 
   {
		public VatFormatTypeKeys() : base() {}
        public VatFormatTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "VatFormatTypePM";
	  public override Expression<Func<ENTITIES.VatFormatType, bool>> Predicate => a => a.Code == Code;
   }
}
