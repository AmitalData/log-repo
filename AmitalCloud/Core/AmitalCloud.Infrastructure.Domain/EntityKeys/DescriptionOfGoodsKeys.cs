...
{
   public class DescriptionOfGoodsKeys<T> : BaseEntityKeyFields<ENTITIES.DescriptionOfGoods,T> 
   {
		public DescriptionOfGoodsKeys() : base() {}
        public DescriptionOfGoodsKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DescriptionOfGoodsPM";
	  public override Expression<Func<ENTITIES.DescriptionOfGoods, bool>> Predicate => a => a.Id == Id;
   }
}
