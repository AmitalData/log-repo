...
{
   public class OneTimePasswordKeys<T> : BaseEntityKeyFields<ENTITIES.OneTimePassword,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.OneTimePassword, bool>> Predicate => a => a.Id == Id;
   }
}
