...
{
   public class TaskSchedulerHistoryKeys<T> : BaseEntityKeyFields<ENTITIES.TaskSchedulerHistory,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TaskSchedulerHistory, bool>> Predicate => a => a.Id == Id;
   }
}
