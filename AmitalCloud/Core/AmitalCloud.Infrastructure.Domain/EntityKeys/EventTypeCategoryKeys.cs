...
{
   public class EventTypeCategoryKeys<T> : BaseEntityKeyFields<ENTITIES.EventTypeCategory,T> 
   {
		public EventTypeCategoryKeys() : base() {}
        public EventTypeCategoryKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "EventTypeCategoriesPM";
	  public override Expression<Func<ENTITIES.EventTypeCategory, bool>> Predicate => a => a.Code == Code;
   }
}
