...
{
   public class TarrifHeaderKeys<T> : BaseEntityKeyFields<ENTITIES.TarrifHeader,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TarrifHeader, bool>> Predicate => a => a.Id == Id;
   }
}
