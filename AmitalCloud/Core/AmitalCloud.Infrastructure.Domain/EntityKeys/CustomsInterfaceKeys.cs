...
{
   public class CustomsInterfaceKeys<T> : BaseEntityKeyFields<ENTITIES.CustomsInterface,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CustomsInterface, bool>> Predicate => a => a.Code == Code;
   }
}
