...
{
   public class HybridPartnerKeys<T> : BaseEntityKeyFields<ENTITIES.HybridPartner,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.HybridPartner, bool>> Predicate => a => a.Id == Id;
   }
}
