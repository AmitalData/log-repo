...
{
   public class TarrifFromToTypeKeys<T> : BaseEntityKeyFields<ENTITIES.TarrifFromToType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TarrifFromToType, bool>> Predicate => a => a.Code == Code;
   }
}
