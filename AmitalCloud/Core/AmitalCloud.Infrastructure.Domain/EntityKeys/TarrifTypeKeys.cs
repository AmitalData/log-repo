...
{
   public class TarrifTypeKeys<T> : BaseEntityKeyFields<ENTITIES.TarrifType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TarrifType, bool>> Predicate => a => a.Code == Code;
   }
}
