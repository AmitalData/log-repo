...
{
   public class NumberFormatKeys<T> : BaseEntityKeyFields<ENTITIES.NumberFormat,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.NumberFormat, bool>> Predicate => a => a.Code == Code;
   }
}
