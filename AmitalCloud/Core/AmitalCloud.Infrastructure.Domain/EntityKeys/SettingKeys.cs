...
{
   public class SettingKeys<T> : BaseEntityKeyFields<ENTITIES.Setting,T> 
   {
		public SettingKeys() : base() {}
        public SettingKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "SettingsPM";
	  public override Expression<Func<ENTITIES.Setting, bool>> Predicate => a => a.Id == Id;
   }
}
