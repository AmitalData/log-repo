...
{
   public class CommunicationLogKeys<T> : BaseEntityKeyFields<ENTITIES.CommunicationLog,T> 
   {
		public CommunicationLogKeys() : base() {}
        public CommunicationLogKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CommunicationLogsPM";
	  public override Expression<Func<ENTITIES.CommunicationLog, bool>> Predicate => a => a.Id == Id;
   }
}
