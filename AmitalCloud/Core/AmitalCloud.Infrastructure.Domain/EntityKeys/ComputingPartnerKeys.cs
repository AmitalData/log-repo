...
{
   public class ComputingPartnerKeys<T> : BaseEntityKeyFields<ENTITIES.ComputingPartner,T> 
   {
		public ComputingPartnerKeys() : base() {}
        public ComputingPartnerKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ComputingPartnersPM";
	  public override Expression<Func<ENTITIES.ComputingPartner, bool>> Predicate => a => a.Id == Id;
   }
}
