...
{
   public class TabModificationKeys<T> : BaseEntityKeyFields<ENTITIES.TabModification,T> 
   {
		public TabModificationKeys() : base() {}
        public TabModificationKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TabsModificationsPM";
	  public override Expression<Func<ENTITIES.TabModification, bool>> Predicate => a => a.Id == Id;
   }
}
