...
{
   public class ContainerSettingKeys<T> : BaseEntityKeyFields<ENTITIES.ContainerSetting,T> 
   {
		public ContainerSettingKeys() : base() {}
        public ContainerSettingKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ContainerSettingsPM";
	  public override Expression<Func<ENTITIES.ContainerSetting, bool>> Predicate => a => a.Id == Id;
   }
}
