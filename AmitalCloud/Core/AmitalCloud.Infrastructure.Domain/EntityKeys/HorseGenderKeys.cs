...
{
   public class HorseGenderKeys<T> : BaseEntityKeyFields<ENTITIES.HorseGender,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.HorseGender, bool>> Predicate => a => a.Code == Code;
   }
}
