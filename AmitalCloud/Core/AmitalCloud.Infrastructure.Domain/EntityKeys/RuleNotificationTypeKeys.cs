...
{
   public class RuleNotificationTypeKeys<T> : BaseEntityKeyFields<ENTITIES.RuleNotificationType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.RuleNotificationType, bool>> Predicate => a => a.Code == Code;
   }
}
