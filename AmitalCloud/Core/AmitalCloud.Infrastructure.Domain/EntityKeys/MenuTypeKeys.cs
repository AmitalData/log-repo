...
{
   public class MenuTypeKeys<T> : BaseEntityKeyFields<ENTITIES.MenuType,T> 
   {
		public MenuTypeKeys() : base() {}
        public MenuTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "MenuTypesPM";
	  public override Expression<Func<ENTITIES.MenuType, bool>> Predicate => a => a.Code == Code;
   }
}
