...
{
   public class BluesnapContractKeys<T> : BaseEntityKeyFields<ENTITIES.BluesnapContract,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BluesnapContract, bool>> Predicate => a => a.Id == Id;
   }
}
