...
{
   public class CurrencyKeys<T> : BaseEntityKeyFields<ENTITIES.Currency,T> 
   {
		public CurrencyKeys() : base() {}
        public CurrencyKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CurrenciesPM";
	  public override Expression<Func<ENTITIES.Currency, bool>> Predicate => a => a.Id == Id;
   }
}
