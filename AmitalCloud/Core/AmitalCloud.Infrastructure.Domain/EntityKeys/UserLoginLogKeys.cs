...
{
   public class UserLoginLogKeys<T> : BaseEntityKeyFields<ENTITIES.UserLoginLog,T> 
   {
		public UserLoginLogKeys() : base() {}
        public UserLoginLogKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "UserLoginLogsPM";
	  public override Expression<Func<ENTITIES.UserLoginLog, bool>> Predicate => a => a.Id == Id;
   }
}
