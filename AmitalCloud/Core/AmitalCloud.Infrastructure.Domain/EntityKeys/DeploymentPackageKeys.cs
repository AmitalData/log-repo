...
{
   public class DeploymentPackageKeys<T> : BaseEntityKeyFields<ENTITIES.DeploymentPackage,T> 
   {
		public DeploymentPackageKeys() : base() {}
        public DeploymentPackageKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DeploymentPackagesPM";
	  public override Expression<Func<ENTITIES.DeploymentPackage, bool>> Predicate => a => a.Id == Id;
   }
}
