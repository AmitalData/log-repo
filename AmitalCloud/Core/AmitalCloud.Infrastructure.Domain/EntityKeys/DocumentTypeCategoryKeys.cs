...
{
   public class DocumentTypeCategoryKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentTypeCategory,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentTypeCategory, bool>> Predicate => a => a.Code == Code;
   }
}
