...
{
   public class DWQueryFilterKeys<T> : BaseEntityKeyFields<ENTITIES.DWQueryFilter,T> 
   {
		public DWQueryFilterKeys() : base() {}
        public DWQueryFilterKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DWQueryFiltersPM";
	  public override Expression<Func<ENTITIES.DWQueryFilter, bool>> Predicate => a => a.Id == Id;
   }
}
