...
{
   public class AuditLogKeys<T> : BaseEntityKeyFields<ENTITIES.AuditLog,T> 
   {
		public AuditLogKeys() : base() {}
        public AuditLogKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AuditLogsPM";
	  public override Expression<Func<ENTITIES.AuditLog, bool>> Predicate => a => a.Id == Id;
   }
}
