...
{
   public class DataProviderKeys<T> : BaseEntityKeyFields<ENTITIES.DataProvider,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DataProvider, bool>> Predicate => a => a.Code == Code;
   }
}
