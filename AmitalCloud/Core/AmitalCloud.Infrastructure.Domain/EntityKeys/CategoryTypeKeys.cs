...
{
   public class CategoryTypeKeys<T> : BaseEntityKeyFields<ENTITIES.CategoryType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CategoryType, bool>> Predicate => a => a.Code == Code;
   }
}
