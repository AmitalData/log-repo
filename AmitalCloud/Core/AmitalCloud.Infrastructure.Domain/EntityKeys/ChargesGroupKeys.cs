...
{
   public class ChargesGroupKeys<T> : BaseEntityKeyFields<ENTITIES.ChargesGroup,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ChargesGroup, bool>> Predicate => a => a.Id == Id;
   }
}
