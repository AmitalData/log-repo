...
{
   public class EntityLastUpdateKeys<T> : BaseEntityKeyFields<ENTITIES.EntityLastUpdate,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.EntityLastUpdate, bool>> Predicate => a => a.Id == Id;
   }
}
