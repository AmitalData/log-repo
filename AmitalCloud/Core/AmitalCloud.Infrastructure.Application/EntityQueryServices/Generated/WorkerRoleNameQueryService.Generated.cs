...
{ 
   public partial class WorkerRoleNameQueryService: BaseEntityQueryService<POCO.WorkerRoleName,WorkerRoleNameKeys<string>,WorkerRoleNamePM,WorkerRoleNameList,string>
   {
        public WorkerRoleNameQueryService(int tenant) : base(new Repository<POCO.WorkerRoleName>(tenant),new WorkerRoleNameDataMapping()) {}
