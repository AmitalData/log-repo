...
{ 
   public partial class InboundEmailQueryService: BaseEntityQueryService<POCO.InboundEmail,InboundEmailKeys<string>,InboundEmailPM,InboundEmailList,string>
   {
        public InboundEmailQueryService(int tenant) : base(new Repository<POCO.InboundEmail>(tenant),new InboundEmailDataMapping()) {}
