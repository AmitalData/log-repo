...
{ 
   public partial class CommodityQueryService: BaseEntityQueryService<POCO.Commodity,CommodityKeys<string>,CommodityPM,CommodityList,string>
   {
        public CommodityQueryService(int tenant) : base(new Repository<POCO.Commodity>(tenant),new CommodityDataMapping()) {}
