...
{ 
   public partial class CarrierAreaQueryService: BaseEntityQueryService<POCO.CarrierArea,CarrierAreaKeys<string>,CarrierAreaPM,CarrierAreaList,string>
   {
        public CarrierAreaQueryService(int tenant) : base(new Repository<POCO.CarrierArea>(tenant),new CarrierAreaDataMapping()) {}
