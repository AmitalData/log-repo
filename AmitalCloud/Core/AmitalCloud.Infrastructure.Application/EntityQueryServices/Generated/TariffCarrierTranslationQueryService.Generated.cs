...
{ 
   public partial class TariffCarrierTranslationQueryService: BaseEntityQueryService<POCO.TariffCarrierTranslation,TariffCarrierTranslationKeys<string>,TariffCarrierTranslationPM,TariffCarrierTranslationList,string>
   {
        public TariffCarrierTranslationQueryService(int tenant) : base(new Repository<POCO.TariffCarrierTranslation>(tenant),new TariffCarrierTranslationDataMapping()) {}
