...
{ 
   public partial class BusinessUnitQueryService: BaseEntityQueryService<POCO.BusinessUnit,BusinessUnitKeys<string>,BusinessUnitPM,BusinessUnitList,string>
   {
        public BusinessUnitQueryService(int tenant) : base(new Repository<POCO.BusinessUnit>(tenant),new BusinessUnitDataMapping()) {}
