...
{ 
   public partial class TraceEventQueryService: BaseEntityQueryService<POCO.TraceEvent,TraceEventKeys<string>,TraceEventPM,TraceEventList,string>
   {
        public TraceEventQueryService(int tenant) : base(new Repository<POCO.TraceEvent>(tenant),new TraceEventDataMapping()) {}
