...
{ 
   public partial class FeatureToggleQueryService: BaseEntityQueryService<POCO.FeatureToggle,FeatureToggleKeys<string>,FeatureTogglePM,FeatureToggleList,string>
   {
        public FeatureToggleQueryService(int tenant) : base(new Repository<POCO.FeatureToggle>(tenant),new FeatureToggleDataMapping()) {}
