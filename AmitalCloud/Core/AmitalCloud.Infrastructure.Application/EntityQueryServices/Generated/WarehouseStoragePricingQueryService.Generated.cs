...
{ 
   public partial class WarehouseStoragePricingQueryService: BaseEntityQueryService<POCO.WarehouseStoragePricing,WarehouseStoragePricingKeys<string>,WarehouseStoragePricingPM,WarehouseStoragePricingList,string>
   {
        public WarehouseStoragePricingQueryService(int tenant) : base(new Repository<POCO.WarehouseStoragePricing>(tenant),new WarehouseStoragePricingDataMapping()) {}
