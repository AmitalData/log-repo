...
{ 
   public partial class TaskSchedulerHistoryQueryService: BaseEntityQueryService<POCO.TaskSchedulerHistory,TaskSchedulerHistoryKeys<string>,TaskSchedulerHistoryPM,TaskSchedulerHistoryList,string>
   {
        public TaskSchedulerHistoryQueryService(int tenant) : base(new Repository<POCO.TaskSchedulerHistory>(tenant),new TaskSchedulerHistoryDataMapping()) {}
