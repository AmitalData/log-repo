...
{ 
   public partial class LBPTeamMemberQueryService: BaseEntityQueryService<POCO.LBPTeamMember,LBPTeamMemberKeys<string>,LBPTeamMemberPM,LBPTeamMemberList,string>
   {
        public LBPTeamMemberQueryService(int tenant) : base(new Repository<POCO.LBPTeamMember>(tenant),new LBPTeamMemberDataMapping()) {}
