...
{ 
   public partial class AuditLogQueryService: BaseEntityQueryService<POCO.AuditLog,AuditLogKeys<string>,AuditLogPM,AuditLogList,string>
   {
        public AuditLogQueryService(int tenant) : base(new Repository<POCO.AuditLog>(tenant),new AuditLogDataMapping()) {}
