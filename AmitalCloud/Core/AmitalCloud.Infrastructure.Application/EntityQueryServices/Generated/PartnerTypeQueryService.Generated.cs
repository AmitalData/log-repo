...
{ 
   public partial class PartnerTypeQueryService: BaseEntityQueryService<POCO.PartnerType,PartnerTypeKeys<string>,PartnerTypePM,PartnerTypeList,string>
   {
        public PartnerTypeQueryService(int tenant) : base(new Repository<POCO.PartnerType>(tenant),new PartnerTypeDataMapping()) {}
