...
{ 
   public partial class RegionQueryService: BaseEntityQueryService<POCO.Region,RegionKeys<string>,RegionPM,RegionList,string>
   {
        public RegionQueryService(int tenant) : base(new Repository<POCO.Region>(tenant),new RegionDataMapping()) {}
