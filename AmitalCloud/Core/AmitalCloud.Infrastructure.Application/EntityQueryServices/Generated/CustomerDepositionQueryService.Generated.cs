...
{ 
   public partial class CustomerDepositionQueryService: BaseEntityQueryService<POCO.CustomerDeposition,CustomerDepositionKeys<string>,CustomerDepositionPM,CustomerDepositionList,string>
   {
        public CustomerDepositionQueryService(int tenant) : base(new Repository<POCO.CustomerDeposition>(tenant),new CustomerDepositionDataMapping()) {}
