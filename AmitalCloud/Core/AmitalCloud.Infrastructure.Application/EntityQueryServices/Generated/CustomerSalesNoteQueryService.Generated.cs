...
{ 
   public partial class CustomerSalesNoteQueryService: BaseEntityQueryService<POCO.CustomerSalesNote,CustomerSalesNoteKeys<string>,CustomerSalesNotePM,CustomerSalesNoteList,string>
   {
        public CustomerSalesNoteQueryService(int tenant) : base(new Repository<POCO.CustomerSalesNote>(tenant),new CustomerSalesNoteDataMapping()) {}
