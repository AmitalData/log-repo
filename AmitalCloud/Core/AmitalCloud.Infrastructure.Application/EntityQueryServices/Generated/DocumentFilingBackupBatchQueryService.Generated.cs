...
{ 
   public partial class DocumentFilingBackupBatchQueryService: BaseEntityQueryService<POCO.DocumentFilingBackupBatch,DocumentFilingBackupBatchKeys<string>,DocumentFilingBackupBatchPM,DocumentFilingBackupBatchList,string>
   {
        public DocumentFilingBackupBatchQueryService(int tenant) : base(new Repository<POCO.DocumentFilingBackupBatch>(tenant),new DocumentFilingBackupBatchDataMapping()) {}
