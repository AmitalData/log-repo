...
{ 
   public partial class VendorQueryService: BaseEntityQueryService<POCO.Vendor,VendorKeys<string>,VendorPM,VendorList,string>
   {
        public VendorQueryService(int tenant) : base(new Repository<POCO.Vendor>(tenant),new VendorDataMapping()) {}
