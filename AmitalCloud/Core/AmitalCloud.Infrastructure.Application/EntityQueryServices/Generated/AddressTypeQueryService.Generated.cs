...
{ 
   public partial class AddressTypeQueryService: BaseEntityQueryService<POCO.AddressType,AddressTypeKeys<string>,AddressTypePM,AddressTypeList,string>
   {
        public AddressTypeQueryService(int tenant) : base(new Repository<POCO.AddressType>(tenant),new AddressTypeDataMapping()) {}
