...
{ 
   public partial class CompetitorQueryService: BaseEntityQueryService<POCO.Competitor,CompetitorKeys<string>,CompetitorPM,CompetitorList,string>
   {
        public CompetitorQueryService(int tenant) : base(new Repository<POCO.Competitor>(tenant),new CompetitorDataMapping()) {}
