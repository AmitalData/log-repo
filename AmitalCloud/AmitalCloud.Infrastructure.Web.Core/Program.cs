...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddControllers(options =>
        {
            ...
            options.Filters.Add<AmitalCloud.Infrastructure.Web.Helpers.AuthenticationExceptionFilter>();
        ...
        builder.Services.AddScoped<IRulesValidator, AmitalCloud.Infrastructure.Web.Validators.RulesValidator>();
        builder.Services.AddScoped<ITreeFilterQueryService, AmitalCloud.Infrastructure.Web.Helpers.TreeFilterQuery.TreeFilterQueryService>();
    ...
    private static void InitInjectionUtil()
    {
        ...
        InjectionUtil.Init(createAmitalRestrictOwnerModelService, getTenantFromToken, AmitalCloudSecurityUtility.CheckContactFeature,
            ...
            () => (new AmitalCloud.Infrastructure.Web.Helpers.TreeFilterQuery.TreeFilterQueryService()) as ITreeFilterQueryService);
    }
    ...
    private static string MapGetContent(IConfiguration configuration)
    {
        ...
        try
        {
            string applicationUrl = configuration.GetValue<string>("profiles:IIS Express:applicationUrl");
