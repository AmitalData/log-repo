...
< BillTo  Code = '10009065' >
 ...
 <Receivables>
                ...
                case 8:
                    {
                       ...
                       <LocalName>Base64Encodec2FtYXI=</LocalName>
        ...
        private async void CallEntityApi(string api)
        {
            ...
            if (!string.IsNullOrEmpty(this.Token))
            {
                using (var client = new HttpClient())
                {
                    ...
                    else if (operationCombo.SelectedIndex == 2)
                    {
                        ...
                        else
                        {
                            ...
                            else if ( apiName == "APInvoice")
                            {
                                   ...
                                   response = await client.GetAsync(txtServerUrl.Text + "/" + api + "?id=" + textBox4.Text + "&number=" + txtParameter2.Text + "&externalId=" + textBox7.Text + "&internalNumber=" + textBox8.Text);
                            }
                    ...
                    {
                        if (apiName == "APInvoice")
                        {
                            client.DefaultRequestHeaders.Add("Accept", "application/xml");
                            response = await client.GetAsync(txtServerUrl.Text + "/" + api + "/GetCancel/" + "?externalId=" + textBox7.Text);
        ...
        {
            txtServerUrl.Text = "http://test-merged-qa.azurewebsites.net/api/";
            txtCredentialsPrimary.Text = "4c42ed24-6d18-427c-9b6c-cf316f2a240b";
