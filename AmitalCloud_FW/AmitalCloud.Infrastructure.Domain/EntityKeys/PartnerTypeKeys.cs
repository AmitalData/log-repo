...
{
   public class PartnerTypeKeys<T> : BaseEntityKeyFields<ENTITIES.PartnerType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PartnerType, bool>> Predicate => a => a.Id == Id;
   }
}
