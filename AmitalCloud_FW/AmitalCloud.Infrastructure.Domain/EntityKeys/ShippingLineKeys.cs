...
{
   public class ShippingLineKeys<T> : BaseEntityKeyFields<ENTITIES.ShippingLine,T> 
   {
		public ShippingLineKeys() : base() {}
        public ShippingLineKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ShippingLinesPM";
	  public override Expression<Func<ENTITIES.ShippingLine, bool>> Predicate => a => a.Id == Id;
   }
}
