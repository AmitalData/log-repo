...
{
   public class INTTRASettingKeys<T> : BaseEntityKeyFields<ENTITIES.INTTRASetting,T> 
   {
		public INTTRASettingKeys() : base() {}
        public INTTRASettingKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "INTTRASettingsPM";
	  public override Expression<Func<ENTITIES.INTTRASetting, bool>> Predicate => a => a.Id == Id;
   }
}
