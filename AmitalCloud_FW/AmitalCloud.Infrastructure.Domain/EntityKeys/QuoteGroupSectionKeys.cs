...
{
   public class QuoteGroupSectionKeys<T> : BaseEntityKeyFields<ENTITIES.QuoteGroupSection,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.QuoteGroupSection, bool>> Predicate => a => a.Code == Code;
   }
}
