...
{
   public class ObjectTableRuleFieldKeys<T> : BaseEntityKeyFields<ENTITIES.ObjectTableRuleField,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ObjectTableRuleField, bool>> Predicate => a => a.Id == Id;
   }
}
