...
{
   public class CustomsShipperKeys<T> : BaseEntityKeyFields<ENTITIES.CustomsShipper,T> 
   {
		public CustomsShipperKeys() : base() {}
        public CustomsShipperKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CustomsShippersPM";
	  public override Expression<Func<ENTITIES.CustomsShipper, bool>> Predicate => a => a.Id == Id;
   }
}
