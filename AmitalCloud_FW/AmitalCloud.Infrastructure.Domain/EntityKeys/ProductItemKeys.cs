...
{
   public class ProductItemKeys<T> : BaseEntityKeyFields<ENTITIES.ProductItem,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ProductItem, bool>> Predicate => a => a.Id == Id;
   }
}
