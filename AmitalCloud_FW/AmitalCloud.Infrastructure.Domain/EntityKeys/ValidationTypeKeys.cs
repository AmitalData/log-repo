...
{
   public class ValidationTypeKeys<T> : BaseEntityKeyFields<ENTITIES.ValidationType,T> 
   {
		public ValidationTypeKeys() : base() {}
        public ValidationTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ValidationTypesPM";
	  public override Expression<Func<ENTITIES.ValidationType, bool>> Predicate => a => a.Id == Id;
   }
}
