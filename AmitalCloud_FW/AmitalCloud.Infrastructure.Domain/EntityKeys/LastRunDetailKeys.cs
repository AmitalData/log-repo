...
{
   public class LastRunDetailKeys<T> : BaseEntityKeyFields<ENTITIES.LastRunDetail,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.LastRunDetail, bool>> Predicate => a => a.Id == Id;
   }
}
