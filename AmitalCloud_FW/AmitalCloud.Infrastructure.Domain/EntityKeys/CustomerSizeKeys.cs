...
{
   public class CustomerSizeKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerSize,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CustomerSize, bool>> Predicate => a => a.Id == Id;
   }
}
