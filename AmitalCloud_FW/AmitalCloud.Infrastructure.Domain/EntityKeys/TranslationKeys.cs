...
{
   public class TranslationKeys<T> : BaseEntityKeyFields<ENTITIES.Translation,T> 
   {
		public TranslationKeys() : base() {}
        public TranslationKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TranslationsPM";
	  public override Expression<Func<ENTITIES.Translation, bool>> Predicate => a => a.Id == Id;
   }
}
