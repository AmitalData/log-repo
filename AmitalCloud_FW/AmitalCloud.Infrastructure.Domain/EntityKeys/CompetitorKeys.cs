...
{
   public class CompetitorKeys<T> : BaseEntityKeyFields<ENTITIES.Competitor,T> 
   {
		public CompetitorKeys() : base() {}
        public CompetitorKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CompetitorsPM";
	  public override Expression<Func<ENTITIES.Competitor, bool>> Predicate => a => a.Id == Id;
   }
}
