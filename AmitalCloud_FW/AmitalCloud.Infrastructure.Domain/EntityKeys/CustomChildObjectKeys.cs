...
{
   public class CustomChildObjectKeys<T> : BaseEntityKeyFields<ENTITIES.CustomChildObject,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CustomChildObject, bool>> Predicate => a => a.Id == Id;
   }
}
