...
{
   public class DigitalProfileKeys<T> : BaseEntityKeyFields<ENTITIES.DigitalProfile,T> 
   {
		public DigitalProfileKeys() : base() {}
        public DigitalProfileKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DigitalProfilesPM";
	  public override Expression<Func<ENTITIES.DigitalProfile, bool>> Predicate => a => a.Id == Id;
   }
}
