...
{
   public class AccountingPartnerKeys<T> : BaseEntityKeyFields<ENTITIES.AccountingPartner,T> 
   {
		public AccountingPartnerKeys() : base() {}
        public AccountingPartnerKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AccountingPartnersPM";
	  public override Expression<Func<ENTITIES.AccountingPartner, bool>> Predicate => a => a.Id == Id;
   }
}
