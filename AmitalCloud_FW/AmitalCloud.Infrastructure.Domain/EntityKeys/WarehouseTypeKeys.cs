...
{
   public class WarehouseTypeKeys<T> : BaseEntityKeyFields<ENTITIES.WarehouseType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.WarehouseType, bool>> Predicate => a => a.Code == Code;
   }
}
