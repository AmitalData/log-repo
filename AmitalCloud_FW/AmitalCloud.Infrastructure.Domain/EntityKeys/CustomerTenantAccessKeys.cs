...
{
   public class CustomerTenantAccessKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerTenantAccess,T> 
   {
		public CustomerTenantAccessKeys() : base() {}
        public CustomerTenantAccessKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CustomerTenantAccessesPM";
	  public override Expression<Func<ENTITIES.CustomerTenantAccess, bool>> Predicate => a => a.Id == Id;
   }
}
