...
{
   public class BusinessRoleKeys<T> : BaseEntityKeyFields<ENTITIES.BusinessRole,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BusinessRole, bool>> Predicate => a => a.Id == Id;
   }
}
