...
{
   public class ChargesTypeKeys<T> : BaseEntityKeyFields<ENTITIES.ChargesType,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ChargesType, bool>> Predicate => a => a.Id == Id;
   }
}
