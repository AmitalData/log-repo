...
{
   public class ContactLoginLogKeys<T> : BaseEntityKeyFields<ENTITIES.ContactLoginLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.ContactLoginLog, bool>> Predicate => a => a.Id == Id;
   }
}
