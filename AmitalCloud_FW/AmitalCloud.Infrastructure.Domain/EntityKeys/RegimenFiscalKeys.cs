...
{
   public class RegimenFiscalKeys<T> : BaseEntityKeyFields<ENTITIES.RegimenFiscal,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.RegimenFiscal, bool>> Predicate => a => a.Code == Code;
   }
}
