...
{
   public class TenantSettingKeys<T> : BaseEntityKeyFields<ENTITIES.TenantSetting,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TenantSetting, bool>> Predicate => a => a.Id == Id;
   }
}
