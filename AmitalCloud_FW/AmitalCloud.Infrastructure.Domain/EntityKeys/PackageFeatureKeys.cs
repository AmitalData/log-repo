...
{
   public class PackageFeatureKeys<T> : BaseEntityKeyFields<ENTITIES.PackageFeature,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PackageFeature, bool>> Predicate => a => a.Id == Id;
   }
}
