...
{
   public class BatchTaskExecutionKeys<T> : BaseEntityKeyFields<ENTITIES.BatchTaskExecution,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BatchTaskExecution, bool>> Predicate => a => a.Id == Id;
   }
}
