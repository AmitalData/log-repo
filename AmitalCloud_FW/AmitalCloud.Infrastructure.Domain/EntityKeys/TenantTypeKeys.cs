...
{
   public class TenantTypeKeys<T> : BaseEntityKeyFields<ENTITIES.TenantType,T> 
   {
		public TenantTypeKeys() : base() {}
        public TenantTypeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TenantTypesPM";
	  public override Expression<Func<ENTITIES.TenantType, bool>> Predicate => a => a.Code == Code;
   }
}
