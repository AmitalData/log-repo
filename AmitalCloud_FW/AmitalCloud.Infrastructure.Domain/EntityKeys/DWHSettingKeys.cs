...
{
   public class DWHSettingKeys<T> : BaseEntityKeyFields<ENTITIES.DWHSetting,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DWHSetting, bool>> Predicate => a => a.Tenant == Tenant;
   }
}
