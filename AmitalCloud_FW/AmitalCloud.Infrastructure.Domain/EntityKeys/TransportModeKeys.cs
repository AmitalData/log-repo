...
{
   public class TransportModeKeys<T> : BaseEntityKeyFields<ENTITIES.TransportMode,T> 
   {
		public TransportModeKeys() : base() {}
        public TransportModeKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TransportModesPM";
	  public override Expression<Func<ENTITIES.TransportMode, bool>> Predicate => a => a.Id == Id;
   }
}
