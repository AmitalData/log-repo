...
{
   public class CustomerDepositionKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerDeposition,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.CustomerDeposition, bool>> Predicate => a => a.Id == Id;
   }
}
