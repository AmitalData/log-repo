...
{
   public class DocumentsExecutionLogKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentsExecutionLog,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentsExecutionLog, bool>> Predicate => a => a.Id == Id;
   }
}
