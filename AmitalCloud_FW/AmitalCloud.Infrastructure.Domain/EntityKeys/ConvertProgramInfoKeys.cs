...
{
   public class ConvertProgramInfoKeys<T> : BaseEntityKeyFields<ENTITIES.ConvertProgramInfo,T> 
   {
		public ConvertProgramInfoKeys() : base() {}
        public ConvertProgramInfoKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ConvertProgramInfoesPM";
	  public override Expression<Func<ENTITIES.ConvertProgramInfo, bool>> Predicate => a => a.Id == Id;
   }
}
