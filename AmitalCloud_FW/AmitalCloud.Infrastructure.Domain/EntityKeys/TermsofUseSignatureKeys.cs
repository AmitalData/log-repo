...
{
   public class TermsofUseSignatureKeys<T> : BaseEntityKeyFields<ENTITIES.TermsofUseSignature,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.TermsofUseSignature, bool>> Predicate => a => a.Id == Id;
   }
}
