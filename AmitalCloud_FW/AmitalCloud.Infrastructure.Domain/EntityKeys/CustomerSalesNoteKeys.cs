...
{
   public class CustomerSalesNoteKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerSalesNote,T> 
   {
		public CustomerSalesNoteKeys() : base() {}
        public CustomerSalesNoteKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CustomerSalesNotePM";
	  public override Expression<Func<ENTITIES.CustomerSalesNote, bool>> Predicate => a => a.Id == Id;
   }
}
