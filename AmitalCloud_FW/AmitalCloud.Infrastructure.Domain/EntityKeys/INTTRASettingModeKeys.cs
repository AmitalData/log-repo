...
{
   public class INTTRASettingModeKeys<T> : BaseEntityKeyFields<ENTITIES.INTTRASettingMode,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.INTTRASettingMode, bool>> Predicate => a => a.Code == Code;
   }
}
