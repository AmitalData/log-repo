...
{
   public class PaymentGatewayPartnerKeys<T> : BaseEntityKeyFields<ENTITIES.PaymentGatewayPartner,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PaymentGatewayPartner, bool>> Predicate => a => a.Code == Code;
   }
}
