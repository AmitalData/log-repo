...
{
   public class ObjectTableRuleKeys<T> : BaseEntityKeyFields<ENTITIES.ObjectTableRule,T> 
   {
		public ObjectTableRuleKeys() : base() {}
        public ObjectTableRuleKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ObjectTableRulesPM";
	  public override Expression<Func<ENTITIES.ObjectTableRule, bool>> Predicate => a => a.Id == Id;
   }
}
