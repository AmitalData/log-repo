...
{
   public class PrepaidCollectKeys<T> : BaseEntityKeyFields<ENTITIES.PrepaidCollect,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.PrepaidCollect, bool>> Predicate => a => a.Id == Id;
   }
}
