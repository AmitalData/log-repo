...
{
   public class BIFoldersPermissionKeys<T> : BaseEntityKeyFields<ENTITIES.BIFoldersPermission,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.BIFoldersPermission, bool>> Predicate => a => a.Id == Id;
   }
}
