...
{
   public class QueryColumnKeys<T> : BaseEntityKeyFields<ENTITIES.QueryColumn,T> 
   {
		public QueryColumnKeys() : base() {}
        public QueryColumnKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "QueryColumnsPM";
	  public override Expression<Func<ENTITIES.QueryColumn, bool>> Predicate => a => a.Id == Id;
   }
}
