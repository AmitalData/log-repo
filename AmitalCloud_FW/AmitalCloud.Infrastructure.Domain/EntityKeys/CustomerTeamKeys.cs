...
{
   public class CustomerTeamKeys<T> : BaseEntityKeyFields<ENTITIES.CustomerTeam,T> 
   {
		public CustomerTeamKeys() : base() {}
        public CustomerTeamKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CustomerTeamsPM";
	  public override Expression<Func<ENTITIES.CustomerTeam, bool>> Predicate => a => a.Id == Id;
   }
}
