...
{
   public class DocumentsDataProviderKeys<T> : BaseEntityKeyFields<ENTITIES.DocumentsDataProvider,T> 
   {
	  ...
	  public override Expression<Func<ENTITIES.DocumentsDataProvider, bool>> Predicate => a => a.Code == Code;
   }
}
