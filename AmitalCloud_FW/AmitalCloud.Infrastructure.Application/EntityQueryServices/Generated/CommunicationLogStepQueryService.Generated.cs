...
{ 
   public partial class CommunicationLogStepQueryService: BaseEntityQueryService<POCO.CommunicationLogStep,CommunicationLogStepKeys<string>,CommunicationLogStepPM,CommunicationLogStepList,string>
   {
        public CommunicationLogStepQueryService(int tenant) : base(new Repository<POCO.CommunicationLogStep>(tenant),new CommunicationLogStepDataMapping()) {}
