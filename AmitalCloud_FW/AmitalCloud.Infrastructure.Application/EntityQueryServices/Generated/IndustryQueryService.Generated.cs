...
{ 
   public partial class IndustryQueryService: BaseEntityQueryService<POCO.Industry,IndustryKeys<string>,IndustryPM,IndustryList,string>
   {
        public IndustryQueryService(int tenant) : base(new Repository<POCO.Industry>(tenant),new IndustryDataMapping()) {}
