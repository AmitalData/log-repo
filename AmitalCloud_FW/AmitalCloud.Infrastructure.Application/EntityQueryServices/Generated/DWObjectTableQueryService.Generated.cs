...
{ 
   public partial class DWObjectTableQueryService: BaseEntityQueryService<POCO.DWObjectTable,DWObjectTableKeys<string>,DWObjectTablePM,DWObjectTableList,string>
   {
        public DWObjectTableQueryService(int tenant) : base(new Repository<POCO.DWObjectTable>(tenant),new DWObjectTableDataMapping()) {}
