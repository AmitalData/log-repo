...
{ 
   public partial class EventTypeCategoryQueryService: BaseEntityQueryService<POCO.EventTypeCategory,EventTypeCategoryKeys<string>,EventTypeCategoryPM,EventTypeCategoryList,string>
   {
        public EventTypeCategoryQueryService(int tenant) : base(new Repository<POCO.EventTypeCategory>(tenant),new EventTypeCategoryDataMapping()) {}
