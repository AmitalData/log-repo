...
{ 
   public partial class CounterDefinitionQueryService: BaseEntityQueryService<POCO.CounterDefinition,CounterDefinitionKeys<string>,CounterDefinitionPM,CounterDefinitionList,string>
   {
        public CounterDefinitionQueryService(int tenant) : base(new Repository<POCO.CounterDefinition>(tenant),new CounterDefinitionDataMapping()) {}
