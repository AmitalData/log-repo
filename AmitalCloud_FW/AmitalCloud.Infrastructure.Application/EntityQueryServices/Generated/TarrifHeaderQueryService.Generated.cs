...
{ 
   public partial class TarrifHeaderQueryService: BaseEntityQueryService<POCO.TarrifHeader,TarrifHeaderKeys<string>,TarrifHeaderPM,TarrifHeaderList,string>
   {
        public TarrifHeaderQueryService(int tenant) : base(new Repository<POCO.TarrifHeader>(tenant),new TarrifHeaderDataMapping()) {}
