...
{ 
   public partial class ProductItemQueryService: BaseEntityQueryService<POCO.ProductItem,ProductItemKeys<string>,ProductItemPM,ProductItemList,string>
   {
        public ProductItemQueryService(int tenant) : base(new Repository<POCO.ProductItem>(tenant),new ProductItemDataMapping()) {}
