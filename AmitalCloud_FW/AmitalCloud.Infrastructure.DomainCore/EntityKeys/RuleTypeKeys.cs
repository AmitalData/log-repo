...
{
   public class RuleTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.RuleType,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.RuleType, bool>> Predicate => a => a.Code == Code;
   }
}
