...
{
   public class MenusTableKeys<T> : BaseEntityKeyFields<EntityPOCOs.MenusTable,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.MenusTable, bool>> Predicate => a => a.Id == Id;
   }
}
