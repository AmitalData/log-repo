...
{
   public class DistributorKeys<T> : BaseEntityKeyFields<EntityPOCOs.Distributor,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.Distributor, bool>> Predicate => a => a.Code == Code;
   }
}
