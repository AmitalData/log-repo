...
{
   public class TeamKeys<T> : BaseEntityKeyFields<EntityPOCOs.Team,T> 
   {
		public TeamKeys() : base() {}
        public TeamKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "TeamsPM";
	  public override Expression<Func<EntityPOCOs.Team, bool>> Predicate => a => a.Id == Id;
   }
}
