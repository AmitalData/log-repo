...
{
   public class DirectionKeys<T> : BaseEntityKeyFields<EntityPOCOs.Direction,T> 
   {
		public DirectionKeys() : base() {}
        public DirectionKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DirectionsPM";
	  public override Expression<Func<EntityPOCOs.Direction, bool>> Predicate => a => a.Id == Id;
   }
}
