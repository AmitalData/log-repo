...
{
   public class AutomationKeys<T> : BaseEntityKeyFields<EntityPOCOs.Automation,T> 
   {
		public AutomationKeys() : base() {}
        public AutomationKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "AutomationsPM";
	  public override Expression<Func<EntityPOCOs.Automation, bool>> Predicate => a => a.Id == Id;
   }
}
