...
{
   public class DWQueryKeys<T> : BaseEntityKeyFields<EntityPOCOs.DWQuery,T> 
   {
		public DWQueryKeys() : base() {}
        public DWQueryKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DWQuerysPM";
	  public override Expression<Func<EntityPOCOs.DWQuery, bool>> Predicate => a => a.Id == Id;
   }
}
