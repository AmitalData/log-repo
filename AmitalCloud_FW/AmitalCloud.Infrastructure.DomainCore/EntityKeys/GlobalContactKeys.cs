...
{
   public class GlobalContactKeys<T> : BaseEntityKeyFields<EntityPOCOs.GlobalContact,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.GlobalContact, bool>> Predicate => a => a.Id == Id;
   }
}
