...
{
   public class DepartmentKeys<T> : BaseEntityKeyFields<EntityPOCOs.Department,T> 
   {
		public DepartmentKeys() : base() {}
        public DepartmentKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "DepartmentsPM";
	  public override Expression<Func<EntityPOCOs.Department, bool>> Predicate => a => a.Id == Id;
   }
}
