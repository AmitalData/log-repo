...
{
   public class ErrorLogKeys<T> : BaseEntityKeyFields<EntityPOCOs.ErrorLog,T> 
   {
		public ErrorLogKeys() : base() {}
        public ErrorLogKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "ErrorLogsPM";
	  public override Expression<Func<EntityPOCOs.ErrorLog, bool>> Predicate => a => a.Id == Id;
   }
}
