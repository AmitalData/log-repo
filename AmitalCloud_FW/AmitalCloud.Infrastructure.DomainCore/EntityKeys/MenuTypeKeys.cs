...
{
   public class MenuTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.MenuType,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.MenuType, bool>> Predicate => a => a.Code == Code;
   }
}
