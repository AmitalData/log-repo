...
{
   public class TriggerTypeKeys<T> : BaseEntityKeyFields<EntityPOCOs.TriggerType,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.TriggerType, bool>> Predicate => a => a.Code == Code;
   }
}
