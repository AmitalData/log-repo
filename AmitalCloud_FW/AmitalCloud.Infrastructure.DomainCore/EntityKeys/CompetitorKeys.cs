...
{
   public class CompetitorKeys<T> : BaseEntityKeyFields<EntityPOCOs.Competitor,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.Competitor, bool>> Predicate => a => a.Id == Id;
   }
}
