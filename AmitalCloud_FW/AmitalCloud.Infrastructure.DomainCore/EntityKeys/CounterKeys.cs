...
{
   public class CounterKeys<T> : BaseEntityKeyFields<EntityPOCOs.Counter,T> 
   {
		public CounterKeys() : base() {}
        public CounterKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
      ...
      public override string GetEntityPMName() => "CountersPM";
	  public override Expression<Func<EntityPOCOs.Counter, bool>> Predicate => a => a.Id == Id;
   }
}
