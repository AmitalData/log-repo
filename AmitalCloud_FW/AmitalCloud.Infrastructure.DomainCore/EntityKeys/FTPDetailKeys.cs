...
{
   public class FTPDetailKeys<T> : BaseEntityKeyFields<EntityPOCOs.FTPDetail,T> 
   {
	  ...
	  public override Expression<Func<EntityPOCOs.FTPDetail, bool>> Predicate => a => a.Id == Id;
   }
}
