...
namespace AmitalCloud.Infrastructure.Domain.EntityPMs
{
   ...
   [DataContract]
   public partial class BatchTaskExecutionStatusPM : BaseEntityPM   {
   #region Constructors
   public BatchTaskExecutionStatusPM() : base() {} 
   public BatchTaskExecutionStatusPM(POCO.BatchTaskExecutionStatus entity) : base()
   {
		_code = entity.Code;
		_name = entity.Name;
