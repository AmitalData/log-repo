...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class PackageMap : EntityTypeConfiguration<POCO.Package>
    {
	    string dbms;
        public PackageMap()
        { 
            ...
            this.Property(t => t.FeaturePackageTypeCode).HasColumnName("FeaturePackageTypeCode").IsRequired().HasMaxLength(2).IsUnicode(false);
