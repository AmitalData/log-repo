...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class CheckDigitControlAlgorithmMap : EntityTypeConfiguration<POCO.CheckDigitControlAlgorithm>
    {
	    string dbms;
        public CheckDigitControlAlgorithmMap()
        { 
				this.ToTable("CheckDigitControlAlgorithms");
