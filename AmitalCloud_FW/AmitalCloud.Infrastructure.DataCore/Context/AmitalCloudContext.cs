   ...
   public partial class AmitalCloudContext: DbContextBase, IAmitalCloudContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Conventions.Remove<OneToManyCascadeDeleteConvention>();
	            ...
	            modelBuilder.Configurations.Add(new DefaultAndConfigurationMap());
	            modelBuilder.Configurations.Add(new DefaultAndConfigurationKeyMap());
	            ...
	            modelBuilder.Configurations.Add(new DescriptionOfGoodsMap());
	            ...
	            modelBuilder.Configurations.Add(new EntityStatusMap());
	            ...
	            modelBuilder.Configurations.Add(new InboundEmailMap());
	            modelBuilder.Configurations.Add(new InboundEmailLineMap());
	            ...
	            modelBuilder.Configurations.Add(new PortGroupMap());
	            ...
	            modelBuilder.Configurations.Add(new QuoteChargesGroupMap());
	            ...
	            modelBuilder.Configurations.Add(new RegimenFiscalMap());
	            ...
	            modelBuilder.Configurations.Add(new SystemDataMap());
	            ...
	            modelBuilder.Configurations.Add(new WorkerRoleNameMap());
							modelBuilder.Entity<CustomerOpenFilesAmount>().Property(x => x.TotalOpenFilesAmount).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProduct>().Property(x => x.PotentialChargeableWeight).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProduct>().Property(x => x.CommitmentChargeableWeight).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProduct>().Property(x => x.PotentialTEU).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProduct>().Property(x => x.CommitmentTEU).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProduct>().Property(x => x.PotentialRevenue).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProduct>().Property(x => x.CommitmentRevenue).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductActualData>().Property(x => x.ChargeableWeight).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductActualData>().Property(x => x.TEU).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductActualData>().Property(x => x.Revenue).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductLocation>().Property(x => x.PotentialChargeableWeight).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductLocation>().Property(x => x.CommitmentChargeableWeight).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductLocation>().Property(x => x.PotentialTEU).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductLocation>().Property(x => x.CommitmentTEU).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductLocation>().Property(x => x.PotentialRevenue).HasPrecision(18, 2);
						modelBuilder.Entity<CustomerProductLocation>().Property(x => x.CommitmentRevenue).HasPrecision(18, 2);
						modelBuilder.Entity<LogitudeMessagesTransmissionLog>().Property(x => x.GrossWeight).HasPrecision(18, 2);
						modelBuilder.Entity<LogitudeMessagesTransmissionLog>().Property(x => x.ChargeableWeight).HasPrecision(18, 2);
						modelBuilder.Entity<LogitudeMessagesTransmissionLog>().Property(x => x.Volume).HasPrecision(18, 2);
						modelBuilder.Entity<PackageType>().Property(x => x.Volume).HasPrecision(18, 2);
						modelBuilder.Entity<TarrifCharge>().Property(x => x.MinPrice).HasPrecision(14, 3);
						modelBuilder.Entity<TarrifCharge>().Property(x => x.MaxPrice).HasPrecision(14, 3);
						modelBuilder.Entity<TarrifCharge>().Property(x => x.UnitPrice).HasPrecision(14, 3);
						modelBuilder.Entity<TarrifStep>().Property(x => x.MinPrice).HasPrecision(14, 3);
						modelBuilder.Entity<TarrifStep>().Property(x => x.MaxPrice).HasPrecision(14, 3);
						modelBuilder.Entity<TarrifStep>().Property(x => x.UnitPrice).HasPrecision(14, 3);
						modelBuilder.Entity<TarrifStep>().Property(x => x.Step).HasPrecision(14, 3);
						modelBuilder.Entity<TenantLoginPolicy>().Property(x => x.SessionTimeout).HasPrecision(18, 2);
						modelBuilder.Entity<WarehouseStoragePricing>().Property(x => x.SalePrice).HasPrecision(18, 3);
									            #region Manual Added
            modelBuilder.Configurations.Add(new AccountingSystemMap());
            modelBuilder.Configurations.Add(new AccountingSettingMap());
            modelBuilder.Configurations.Add(new AccountMap());
