...
let R: CreateRandom= new CreateRandom();
 ...
 //cy.get('input[id="Customs.Vehicle_ImporterPassportNumber"]').type(str,{ force: true })


  // cy.get('input[id="Customs.Vehicle_ImporterPassCountryCode"]').type('1').should("have.value", '1')

   //         cy.get('ul[id="mydatalist_Customs.Vehicle_ImporterPassCountryCode"]').contains('1').then(a => {
     //         a[0].click();
     //       })

// cy.get('input[id="Customs.Vehicle_PassportName"]').type(str,{ force: true })

  // cy.get('input[id="Customs.Vehicle_ImporterPassportTypeCode"]').type('1').should("have.value", '1')

      //      cy.get('ul[id="mydatalist_Customs.Vehicle_ImporterPassportTypeCode"]').contains('1').then(a => {
      //        a[0].click();
       //     })
...
cy.get('#CheckBox_0_99').check({ force: true }).should('be.checked') 
cy.get('input[id="Customs.Vehicle_SelfVehicleWeight"]').type('8000')
cy.get('input[id="Customs.Vehicle_MedalNumber"]').type('4')

cy.get('input[id="date_Customs.Vehicle_DateOnRoadAbroad"]').type('1/2/2020')

cy.get('input[id="date_Customs.Vehicle_TransmissionDateWithoutTax"]').type('5/12/2019')
cy.get('input[id="Customs.Vehicle_VehicleMaxPowerKW"]').type('4000')
