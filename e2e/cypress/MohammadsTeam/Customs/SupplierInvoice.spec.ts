...
cy.get('#edit-log-grid_0_20_1_0').click();
 cy.get('input[id="Customs.SupplierInvoice_Amount"]').type('50').should("have.value", '50');
           ...
           cy.get('#edit-log-grid_0_30_1_0').click();

           cy.get('input[id="Customs.SupplierInvoice_ItemCode"]').type('10').should("have.value", '10');
...
cy.get('#edit-log-grid_0_140_1_0').click();
 cy.get('input[id="Customs.SupplierInvoiceItemVehicle_RichbitFileNumber"]').type('12310');
