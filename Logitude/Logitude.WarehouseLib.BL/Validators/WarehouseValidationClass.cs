...
namespace Logitude.WarehouseLib.BL.Validators
{
    public partial class WarehouseValidationClass : IWarehouseValidateContext
    {
        ...
        public WarehouseValidationClass(string objectTableName, int tenant)
        {
            this.tenant = tenant;
        ...
        public string GetErrorMessage(object value, object instance, string propertyName)
        {
            ...
            if (field.IsRequiered)
            {
                ...
                if (value == null)
                {
                    error = WarehouseTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", field.FullNameTextCode.Code, null, null, field.Tenant);
                }
