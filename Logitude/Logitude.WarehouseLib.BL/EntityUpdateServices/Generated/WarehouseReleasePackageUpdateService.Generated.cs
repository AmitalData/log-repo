...
{ 
   public partial class WarehouseReleasePackageUpdateService:EntityUpdateService<WarehouseReleasePackage,WarehouseReleasePackagePM,WarehouseReleasePM>
   {
        ...
        WarehouseReleasePackageRepository entityRepository;
        public WarehouseReleasePackageUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public WarehouseReleasePackageUpdateService(int tenant)
        {
            currentContext = WarehouseContext.GetContext(tenant);
        }

        public WarehouseReleasePackageUpdateService(IWarehouseContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(WarehouseReleasePackagePM entityPM)
        {
            WarehouseReleasePackageKeys entityKeys = new WarehouseReleasePackageKeys() { Id = entityPM.Id };
            return entityKeys;
        }

		
		protected override void FillDefaultValuesOnCreate(WarehouseReleasePackagePM entityPM)
        {     
		...
		protected override void FillDefaultValuesOnUpdate(WarehouseReleasePackagePM entityPM)
        {       
