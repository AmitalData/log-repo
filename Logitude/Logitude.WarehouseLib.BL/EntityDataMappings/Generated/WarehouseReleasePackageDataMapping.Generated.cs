...
namespace Logitude.WarehouseLib.BL.EntityDataMappings
{
   ...
   public partial class WarehouseReleasePackageDataMapping: IMapping<WarehouseReleasePackagePM, WarehouseReleasePackage>,IMappingEncodeBase64NVARCHARFields<WarehouseReleasePackagePM>
   {
	    ...
	    public void PMToPOCO(WarehouseReleasePackagePM entityPM, WarehouseReleasePackage entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.WarehouseReleaseId))
            {
				entityPOCO.WarehouseReleaseId = entityPM.WarehouseReleaseId;
			}
		...
		public void POCOToPM(WarehouseReleasePackagePM entityPM, WarehouseReleasePackage entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.WarehouseReleaseId))
            {
					entityPM.WarehouseReleaseId = entityPOCO.WarehouseReleaseId;
            }
		...
		public void PMToOldPM(WarehouseReleasePackagePM entityPM, WarehouseReleasePackagePM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.WarehouseReleaseId))
            {
                oldEntityPM.WarehouseReleaseId = entityPM.WarehouseReleaseId;
            }
	    ...
	    public void EncodeBase64NVARCHARFields(WarehouseReleasePackagePM entityPM)
        {
