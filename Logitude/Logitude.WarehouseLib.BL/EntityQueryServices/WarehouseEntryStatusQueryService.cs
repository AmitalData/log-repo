...
{
    public partial class WarehouseEntryStatusQueryService
    {
        public IQueryable<WarehouseEntryStatusList> GetIQueryableEntityList(IQueryable<WarehouseEntryStatus> entities)
        {
