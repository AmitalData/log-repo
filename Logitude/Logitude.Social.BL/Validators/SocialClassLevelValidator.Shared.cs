...
namespace Logitude.Social.BL.Validators
{
    public partial class SocialClassLevelValidator : ISocialClassLevelValidator
    {
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            int tenant = 0;
            if (objectTableName != "Tenant" && objectTableName != "TenantManagement" && tenantProp != null)
            {
            ...
            Validators.SocialClassLevelValidator temp = new Validators.SocialClassLevelValidator(objectTableName, tenant);
    ...
    public interface ISocialClassLevelValidator
    {
