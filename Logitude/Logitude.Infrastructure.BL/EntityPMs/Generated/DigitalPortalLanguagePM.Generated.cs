...
namespace Logitude.Infrastructure.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class DigitalPortalLanguagePM : EntityPM
   {
   	  private string code ;
       ...
       public string DisplayText  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		  ...
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="DisplayText",OldValue=displayText,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   displayText=value;
		   }
