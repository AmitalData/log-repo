...
namespace Logitude.Infrastructure.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class DigitalFieldSecurityPM : EntityPM
   {
   	  private string id ;
       ...
       public string DefaultSettings  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		  ...
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="DefaultSettings",OldValue=defaultSettings,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
       ...
       public string ProfileName  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		  ...
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="ProfileName",OldValue=profileName,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   profileName=value;
		   }
