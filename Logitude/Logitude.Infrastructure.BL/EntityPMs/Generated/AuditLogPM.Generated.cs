...
namespace Logitude.Infrastructure.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class AuditLogPM : EntityPM
   {
   	  private string id ;
	  ...
	  private string changesJson ;
       ...
       public string ChangesJson  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(changesJson != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="ChangesJson",OldValue=changesJson,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   changesJson=value;
		   }
