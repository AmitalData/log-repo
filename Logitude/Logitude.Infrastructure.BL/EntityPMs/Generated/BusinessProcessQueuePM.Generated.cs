...
namespace Logitude.Infrastructure.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class BusinessProcessQueuePM : EntityPM
   {
   	  private string id ;
       ...
       public string EntityName  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(entityName != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="EntityName",OldValue=entityName,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   entityName=value;
		   }
	  ...
	  private string businessRoleName ;
       ...
       public string BusinessRoleName  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(businessRoleName != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="BusinessRoleName",OldValue=businessRoleName,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   businessRoleName=value;
		   }
