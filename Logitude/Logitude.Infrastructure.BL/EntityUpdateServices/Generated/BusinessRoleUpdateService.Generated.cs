...
{ 
   public partial class BusinessRoleUpdateService:EntityUpdateService<BusinessRole,BusinessRolePM,EntityPM>
   {
   
        BusinessRoleRepository entityRepository;
        ...
        public BusinessRoleUpdateService(int tenant)
        {
            currentContext = InfrastructureContext.GetContext(tenant);
        }

        public BusinessRoleUpdateService(IInfrastructureContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(BusinessRolePM entityPM)
        {
            BusinessRoleKeys entityKeys = new BusinessRoleKeys() { Id = entityPM.Id };
            return entityKeys;
        }
