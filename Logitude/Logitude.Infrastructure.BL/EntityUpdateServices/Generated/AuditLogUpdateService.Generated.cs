...
{ 
   public partial class AuditLogUpdateService:EntityUpdateService<AuditLog,AuditLogPM,EntityPM>
   {
   
        AuditLogRepository entityRepository;
        ...
        public AuditLogUpdateService(int tenant)
        {
            currentContext = InfrastructureContext.GetContext(tenant);
        }

        public AuditLogUpdateService(IInfrastructureContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(AuditLogPM entityPM)
        {
            AuditLogKeys entityKeys = new AuditLogKeys() { Id = entityPM.Id };
            return entityKeys;
        }
