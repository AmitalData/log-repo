...
{ 
   public partial class DigitalProfileUpdateService:EntityUpdateService<DigitalProfile,DigitalProfilePM,EntityPM>
   {
   
        DigitalProfileRepository entityRepository;
        ...
        public DigitalProfileUpdateService(int tenant)
        {
            currentContext = InfrastructureContext.GetContext(tenant);
        }

        public DigitalProfileUpdateService(IInfrastructureContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(DigitalProfilePM entityPM)
        {
            DigitalProfileKeys entityKeys = new DigitalProfileKeys() { Id = entityPM.Id };
            return entityKeys;
        }
