...
{ 
   public partial class BIReportUpdateService:EntityUpdateService<BIReport,BIReportPM,EntityPM>
   {
   
        BIReportRepository entityRepository;
        ...
        public BIReportUpdateService(int tenant)
        {
            currentContext = InfrastructureContext.GetContext(tenant);
        }

        public BIReportUpdateService(IInfrastructureContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(BIReportPM entityPM)
        {
            BIReportKeys entityKeys = new BIReportKeys() { Id = entityPM.Id };
            return entityKeys;
        }
