...
{ 
   public partial class BIReportsExecutionLogUpdateService:EntityUpdateService<BIReportsExecutionLog,BIReportsExecutionLogPM,EntityPM>
   {
   
        BIReportsExecutionLogRepository entityRepository;
        ...
        public BIReportsExecutionLogUpdateService(int tenant)
        {
            currentContext = InfrastructureContext.GetContext(tenant);
        }

        public BIReportsExecutionLogUpdateService(IInfrastructureContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(BIReportsExecutionLogPM entityPM)
        {
            BIReportsExecutionLogKeys entityKeys = new BIReportsExecutionLogKeys() { Id = entityPM.Id };
            return entityKeys;
        }
