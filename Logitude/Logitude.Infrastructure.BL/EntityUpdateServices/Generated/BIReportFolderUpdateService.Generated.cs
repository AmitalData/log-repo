...
{ 
   public partial class BIReportFolderUpdateService:EntityUpdateService<BIReportFolder,BIReportFolderPM,EntityPM>
   {
   
        BIReportFolderRepository entityRepository;
        ...
        public BIReportFolderUpdateService(int tenant)
        {
            currentContext = InfrastructureContext.GetContext(tenant);
        }

        public BIReportFolderUpdateService(IInfrastructureContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(BIReportFolderPM entityPM)
        {
            BIReportFolderKeys entityKeys = new BIReportFolderKeys() { Id = entityPM.Id };
            return entityKeys;
        }
