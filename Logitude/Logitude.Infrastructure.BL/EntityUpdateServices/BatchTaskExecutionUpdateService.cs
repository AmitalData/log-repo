...
{
    public partial class BatchTaskExecutionUpdateService
    {
        protected override void OnCreating(BatchTaskExecutionPM entityPM, EntityPM entityParentPM)
        {
            ...
            if(entityPM.Id == null) entityPM.Id = IdCounter.GetNumber("BatchTaskExecution", entityPM.Tenant);
