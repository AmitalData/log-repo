...
namespace Logitude.Infrastructure.BL.EntityDataMappings
{
   ...
   public partial class BusinessRoleDataMapping: IMapping<BusinessRolePM, BusinessRole>,IMappingEncodeBase64NVARCHARFields<BusinessRolePM>
   {
	    ...
	    public void PMToPOCO(BusinessRolePM entityPM, BusinessRole entityPOCO)
        {
		...
		public void POCOToPM(BusinessRolePM entityPM, BusinessRole entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(BusinessRolePM entityPM, BusinessRole entityPOCO, bool isNewEntity)
        {
