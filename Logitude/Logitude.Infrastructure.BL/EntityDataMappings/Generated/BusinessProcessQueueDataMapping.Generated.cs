...
namespace Logitude.Infrastructure.BL.EntityDataMappings
{
   ...
   public partial class BusinessProcessQueueDataMapping: IMapping<BusinessProcessQueuePM, BusinessProcessQueue>,IMappingEncodeBase64NVARCHARFields<BusinessProcessQueuePM>
   {
	    ...
	    public void PMToPOCO(BusinessProcessQueuePM entityPM, BusinessProcessQueue entityPOCO)
        {
		...
		public void POCOToPM(BusinessProcessQueuePM entityPM, BusinessProcessQueue entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(BusinessProcessQueuePM entityPM, BusinessProcessQueue entityPOCO, bool isNewEntity)
        {
