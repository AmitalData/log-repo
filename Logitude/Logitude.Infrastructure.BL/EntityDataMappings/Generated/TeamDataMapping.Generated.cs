...
namespace Logitude.Infrastructure.BL.EntityDataMappings
{
   ...
   public partial class TeamDataMapping: IMapping<TeamPM, Team>,IMappingEncodeBase64NVARCHARFields<TeamPM>
   {
	    ...
	    public void PMToPOCO(TeamPM entityPM, Team entityPOCO)
        {
            ...
            {
				entityPOCO.Notify = entityPM.Notify;
			}
		...
		public void POCOToPM(TeamPM entityPM, Team entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(TeamPM entityPM, Team entityPOCO, bool isNewEntity)
        {
