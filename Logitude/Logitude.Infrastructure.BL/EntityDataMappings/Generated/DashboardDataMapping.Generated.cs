...
namespace Logitude.Infrastructure.BL.EntityDataMappings
{
   ...
   public partial class DashboardDataMapping: IMapping<DashboardPM, Dashboard>,IMappingEncodeBase64NVARCHARFields<DashboardPM>
   {
	    ...
	    public void PMToPOCO(DashboardPM entityPM, Dashboard entityPOCO)
        {
		...
		public void POCOToPM(DashboardPM entityPM, Dashboard entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DashboardPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DashboardPM entityPM, Dashboard entityPOCO, bool isNewEntity)
        {
