    ...
    public class InterfaceManagementDetails : InterfaceManagement, ICloseTable<InterfaceManagement, InterfaceManagementDetails>
    {
        ...
        public List<InterfaceManagementDetails> GetAll()
        {
            ...
            all.Add(new InterfaceManagementDetails()
            {
                ...
                DcaPrefixName = "SendDF_MSG8237_ExportDeclarationAmendmentReplyMsg_EX_Out.",
                DcaPrefixName2 = "SendDF_MSG8237_ExportDeclarationAmendmentReplyMsg_Out.",
                DefaultSendOptionsCode = null,
                DefaultPriority = 5,
                AllowRestore = true,
                //NotificationId = "",//NotificationDefinitionDetails.GetAll().FirstOrDefault(rec=> rec.Code="").Code
            ...
            new InterfaceManagementDetails()
            {
                ...
                DcaPrefixName2 = "SendVAL_MSG8228_RequiredDocumentVerificationDecisionMessage_EX_Out.",
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                AllowRestore = true,
                Active = true,
            ...
            new InterfaceManagementDetails()
            {
                ...
                DcaPrefixName2 = "SendCOLT_MSG_8211_CollateralRequestMsg_EX_Out.",
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                AllowRestore = true,
                //NotificationId = "",
            ...
            new InterfaceManagementDetails()
            {
                ...
                DcaPrefixName2 = "SendCOLT_MSG_8213_CollateralAnswerApprovalMsg_EX_Out.",
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                AllowRestore = true,
                //    NotificationId = "",
            ...
            new InterfaceManagementDetails()
            {
                ...
                DcaPrefixName2 = "SendEV_MSG8215_ConstraintApprovalDecision_EX_Out.", // "GetDF_WEB8250_8251_DeclarationStatusQuery_Request_Out.",
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                AllowRestore = true,
                //NotificationId = "",
            ...
            all.Add(new InterfaceManagementDetails()
            {
                ...
                DcaPrefixName2 = "SendMN_MSG8374_CargoSplitRequestFeedBack_Message_EX_Out.",
            ...
            all.Add(new InterfaceManagementDetails()
            {
                ...
                ///DCAInUniCourierBatchSend_MsgMessagingService
                InOut = InOutEnum.I.ToString(),
                Description = "הגשת הצהרות יצוא",// "Unifreight Courier *2750* Batch Send",
                DcaPrefixName = "Export_UCB2755E_Out.",
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                AllowRestore = true,
            ...
            all.Add(new InterfaceManagementDetails()
            {
                Code = "DCACESIFF",
                InOut = InOutEnum.I.ToString(),
                Description = "קליטת חשבונות יצואן מאקסל",
                DcaPrefixName = "DCACESIFF_OUT",
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                AllowRestore = true,
                Active = true,
            ...
            all.Add(new InterfaceManagementDetails()
            {
                ...
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                DcaPrefixName = "SaveDF_MSG2751_2757_TransshipmentDeclarationRequest_Out.",
                DcaPrefixName2 = "SaveDF_MSG2751_TransshipmentDeclarationRequest_Out.",
                AllowRestore = true,
                Active = true,
                SendAsDual = false,
                ResponseInterfaceCode = null,
            ...
            all.Add(new InterfaceManagementDetails()
            {
                ...
                DefaultSendOptionsCode = null,
                DefaultPriority = CONST_DefaultPriority,
                DcaPrefixName = "SendLG_NG_8411_LogisticActionRequestMessageDecision_Out.",
                DcaPrefixName2 = "SendLG_NG_8411_LogisticActionRequestMessageDecision_EX_Out.",
                AllowRestore = true,
                Active = true,
                SendAsDual = false,
                ResponseInterfaceCode = null,
			...
			all.Add(new InterfaceManagementDetails()
			{
				...
				DefaultSendOptionsCode = null,
				DefaultPriority = CONST_DefaultPriority,
				DcaPrefixName = "SendPC_NG_2281_MSG02_CertificateOfOriginRequestFeedback_Out.",
				DcaPrefixName2 = "",
				AllowRestore = true,
				Active = true,
				SendAsDual = false,
