...
namespace Logitude.Customs.Def.EntityPMs
{
   ...
   public partial class CourierMasterPM : EntityPM
   {
	  ...
	  private bool sentDeclarationStatus ;
	  	  
       
	   [CustomValidation(typeof(CustomsValidationClass), "ValidateClass")]
	   [DataMember]
       public bool SentDeclarationStatus  
	   {
	    
	     get
		{
		   return sentDeclarationStatus;
		 }
		 set
		 {
		   if(sentDeclarationStatus != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="SentDeclarationStatus",OldValue=sentDeclarationStatus,NewValue=value,PropertyType="bool"};
		    NotifyPropertyChanged(values);
		   sentDeclarationStatus=value;
		   }
