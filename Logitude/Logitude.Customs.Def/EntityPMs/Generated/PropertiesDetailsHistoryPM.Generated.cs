...
namespace Logitude.Customs.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class PropertiesDetailsHistoryPM : EntityPM
   {
       ...
       public int? MeasurementUnitID  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		  ...
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="MeasurementUnitID",OldValue=measurementUnitID,NewValue=value,PropertyType="int?"};
		    NotifyPropertyChanged(values);
