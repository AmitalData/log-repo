...
namespace Logitude.Customs.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class SiteLookupPM : EntityPM
   {
   	  private string code ;
	  ...
	  private string siteTypeCode ;
       ...
       public string SiteTypeCode  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(siteTypeCode != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="SiteTypeCode",OldValue=siteTypeCode,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   siteTypeCode=value;
		   }
