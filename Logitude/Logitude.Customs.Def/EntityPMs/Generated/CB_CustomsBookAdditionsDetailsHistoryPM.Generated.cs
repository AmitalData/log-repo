...
namespace Logitude.Customs.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class CB_CustomsBookAdditionsDetailsHistoryPM : EntityPM
   {
   	  private string iD ;
       ...
       public string EnglishTitle  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		  ...
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="EnglishTitle",OldValue=englishTitle,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   englishTitle=value;
		   }
	  ...
	  private string customsBookAdditionID ;
	  	  
       
	   [CustomValidation(typeof(CustomsValidationClass), "ValidateClass")]
	   [DataMember]
       public string CustomsBookAdditionID  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		  ...
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="CustomsBookAdditionID",OldValue=customsBookAdditionID,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
