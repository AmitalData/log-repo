...
namespace Logitude.Customs.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class CertificateOfOriginStatusCodeEnumPM : EntityPM
   {
   	  private string code ;
	  ...
	  private bool? recordEditable ;
	  	  
       
	   [CustomValidation(typeof(CustomsValidationClass), "ValidateClass")]
	   [DataMember]
       public bool? RecordEditable  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(recordEditable != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="RecordEditable",OldValue=recordEditable,NewValue=value,PropertyType="bool?"};
		    NotifyPropertyChanged(values);
