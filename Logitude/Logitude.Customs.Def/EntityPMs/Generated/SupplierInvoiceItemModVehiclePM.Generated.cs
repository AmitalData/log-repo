...
namespace Logitude.Customs.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class SupplierInvoiceItemModVehiclePM : EntityPM
   {
	  ...
	  private string adjustmentTypeName ;
       ...
       public string AdjustmentTypeName  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(adjustmentTypeName != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="AdjustmentTypeName",OldValue=adjustmentTypeName,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   adjustmentTypeName=value;
		   }
