...
namespace Amital.QuoteOPM.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class QuoteOPCustomerTypePM : EntityPM
   {
       ...
       public bool ShowInLOV  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(showInLOV != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="ShowInLOV",OldValue=showInLOV,NewValue=value,PropertyType="bool"};
		    NotifyPropertyChanged(values);
		   showInLOV=value;
		   }
