...
namespace Amital.QuoteOPM.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class QuoteOPStagePM : EntityPM
   {
   	  private string id ;
       ...
       public int Rank  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(rank != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="Rank",OldValue=rank,NewValue=value,PropertyType="int"};
		    NotifyPropertyChanged(values);
		   rank=value;
		   }
