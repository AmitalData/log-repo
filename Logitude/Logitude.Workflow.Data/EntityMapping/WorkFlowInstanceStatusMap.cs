...
namespace Logitude.Workflow.Data.EntityMapping
{
    ...
    public class WorkFlowInstanceStatusMap : EntityTypeConfiguration<WorkFlowInstanceStatus>
    {
	    string dbms;
        public WorkFlowInstanceStatusMap()
        { 
				this.ToTable("WorkFlowInstanceStatuses");
