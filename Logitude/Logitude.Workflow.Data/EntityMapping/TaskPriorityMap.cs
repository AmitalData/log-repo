...
namespace Logitude.Workflow.Data.EntityMapping
{
    ...
    public class TaskPriorityMap : EntityTypeConfiguration<TaskPriority>
    {
	    string dbms;
        public TaskPriorityMap()
        { 
				this.ToTable("TaskPriorities");
            ...
            this.Property(t => t.DisplayOrder).HasColumnName("DisplayOrder").IsRequired();
        }
    }
}
