...
namespace Logitude.TimeManagement.BL.EntityDataMappings
{
   ...
   public partial class TMProjectCategoryDataMapping: IMapping<TMProjectCategoryPM, TMProjectCategory>,IMappingEncodeBase64NVARCHARFields<TMProjectCategoryPM>
   {
	    ...
	    public void PMToPOCO(TMProjectCategoryPM entityPM, TMProjectCategory entityPOCO)
        {
		...
		public void POCOToPM(TMProjectCategoryPM entityPM, TMProjectCategory entityPOCO)
        {
		...
		public void PMToOldPM(TMProjectCategoryPM entityPM, TMProjectCategoryPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TMProjectCategoryPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TMProjectCategoryPM entityPM, TMProjectCategory entityPOCO, bool isNewEntity)
        {
