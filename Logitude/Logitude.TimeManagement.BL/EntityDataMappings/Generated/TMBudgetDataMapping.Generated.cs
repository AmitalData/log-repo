...
namespace Logitude.TimeManagement.BL.EntityDataMappings
{
   ...
   public partial class TMBudgetDataMapping: IMapping<TMBudgetPM, TMBudget>,IMappingEncodeBase64NVARCHARFields<TMBudgetPM>
   {
	    ...
	    public void PMToPOCO(TMBudgetPM entityPM, TMBudget entityPOCO)
        {
		...
		public void POCOToPM(TMBudgetPM entityPM, TMBudget entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TMBudgetPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TMBudgetPM entityPM, TMBudget entityPOCO, bool isNewEntity)
        {
