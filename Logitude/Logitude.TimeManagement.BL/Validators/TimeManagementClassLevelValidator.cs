...
{
    public partial class TimeManagementClassLevelValidator : ITimeManagementClassLevelValidator
    {
        int tenant;
        ...
        public TimeManagementClassLevelValidator(string objectTableName, int tenant)
        {
            ...
            foreach (ObjectField objectfeildprop in objectFieldList)
            {
                ...
                if (propertyInf != null)
                {
                    ...
                    if (objectfeildprop.IsRequiered)
                    {
                        ...
                        {
                            requiredError = requiredError + "," + TimeManagementTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", objectfeildprop.FullNameTextCode.Code, null, null, objectfeildprop.Tenant);
                        }
                    ...
                    if (objectfeildprop.DataTypeCode == "Text" || objectfeildprop.DataTypeCode == "nText")
                    {
                        ...
                        {
                            stringLengthError = stringLengthError + "," + TimeManagementTranslateTextsClass.GetTranslation("General.M.MinMax", objectfeildprop.FullNameTextCode.Code, objectfeildprop.MinLength.ToString(), objectfeildprop.MaxLength.ToString(), objectfeildprop.Tenant);
                        }
                    }
        ...
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            if (value != null)
            {
                ...
                TimeManagementClassLevelValidator temp = new TimeManagementClassLevelValidator(objectTableName, tenant);
    ...
    public interface ITimeManagementClassLevelValidator
    {
