...
{ 
   public partial class TMProjectUpdateService:EntityUpdateService<TMProject,TMProjectPM,EntityPM>
   {
   
        TMProjectRepository entityRepository;
        public TMProjectUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public TMProjectUpdateService(int tenant)
        {
            currentContext = TimeManagementContext.GetContext(tenant);
        }

        public TMProjectUpdateService(ITimeManagementContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(TMProjectPM entityPM)
        {
            TMProjectKeys entityKeys = new TMProjectKeys() { Id = entityPM.Id };
            return entityKeys;
        }

		
		protected override void FillDefaultValuesOnCreate(TMProjectPM entityPM)
        {     
