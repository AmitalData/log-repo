...
namespace Logitude.CRM.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class TicketSeverityPM : EntityPM
   {
   	  private string id ;
       ...
       public int Severity  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(severity != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="Severity",OldValue=severity,NewValue=value,PropertyType="int"};
		    NotifyPropertyChanged(values);
		   severity=value;
		   }
