...
namespace Logitude.CRM.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class SLAHeaderPM : EntityPM
   {
   	  private string id ;
	  ...
	  private string description ;
	   ...
	   private List<SLALinePM> sLALines;
	    
       [Composition]
 
		     
	   [Include]
	   [Association("SLALineSLAHeader", "Id","SLAHeaderId")]
	   [DataMember]
	   public virtual List<SLALinePM> SLALines  
	   {
	        get
             {
                 if (sLALines == null)
                 {
                     sLALines = new List<SLALinePM>();
                 }
                 return sLALines;
              }
             set { sLALines = value; }
	   ...
	   private List<SLALinePM>  deletedSLALines;
	   public virtual List<SLALinePM> DeletedSLALines  
	   {
	        get
             {
                 if ( deletedSLALines == null)
                 {
                      deletedSLALines = new List<SLALinePM>();
                 }
                 return  deletedSLALines;
              }
             set {  deletedSLALines = value; }
	    }
	  
	   private List<SLAEscalationPM> sLAEscalations;
	    
       [Composition]
 
		     
	   [Include]
	   [Association("SLAEscalationSLAHeader", "Id","SLAHeaderId")]
	   [DataMember]
	   public virtual List<SLAEscalationPM> SLAEscalations  
	   {
	        get
             {
                 if (sLAEscalations == null)
                 {
                     sLAEscalations = new List<SLAEscalationPM>();
                 }
                 return sLAEscalations;
              }
             set { sLAEscalations = value; }
	    }
		   
	   private List<SLAEscalationPM>  deletedSLAEscalations;
	   public virtual List<SLAEscalationPM> DeletedSLAEscalations  
	   {
	        get
             {
                 if ( deletedSLAEscalations == null)
                 {
                      deletedSLAEscalations = new List<SLAEscalationPM>();
                 }
                 return  deletedSLAEscalations;
              }
             set {  deletedSLAEscalations = value; }
	    }
