...
namespace Logitude.CRM.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class ActivityNotePM : EntityPM
   {
   	  private string id ;
	  ...
	  private bool postToFollowers ;
       ...
       public bool PostToFollowers  
	   {
	     ...
	     get
		{
		   return postToFollowers;
		 }
		 set
		 {
		   if(postToFollowers != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="PostToFollowers",OldValue=postToFollowers,NewValue=value,PropertyType="bool"};
		    NotifyPropertyChanged(values);
		   postToFollowers=value;
		   }
