...
namespace Logitude.CRM.BL.Validators
{
    public partial class CRMClassLevelValidator : ICRMClassLevelValidator
    {
        ...
        public CRMClassLevelValidator(string objectTableName, int tenant)
        {
            ...
            foreach (ObjectField objectfeildprop in objectFieldList)
            {
                ...
                if (propertyInf != null)
                {
                    ...
                    if (objectfeildprop.IsRequiered)
                    {
                        if (propertyValue == null)
                        {
                            requiredError = requiredError + "," + CRMTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", objectfeildprop.FullNameTextCode.Code, null, null, objectfeildprop.Tenant);
                        }
                    ...
                    if (objectfeildprop.DataTypeCode == "Text" || objectfeildprop.DataTypeCode == "nText")
                    {
                        ...
                        if (propertyValue != null && FieldValueValidator.IsNotValidMinMaxValue(objectfeildprop, propertyValue.ToString()))
                        {
                            stringLengthError = stringLengthError + "," + CRMTranslateTextsClass.GetTranslation("General.M.MinMax", objectfeildprop.FullNameTextCode.Code, objectfeildprop.MinLength.ToString(), objectfeildprop.MaxLength.ToString(), objectfeildprop.Tenant);
                        }
                    }
