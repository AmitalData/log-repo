...
namespace Logitude.CRM.BL.EntityDataMappings
{
   ...
   public partial class OpportunityTypeDataMapping: IMapping<OpportunityTypePM, OpportunityType>,IMappingEncodeBase64NVARCHARFields<OpportunityTypePM>
   {
	    ...
	    public void PMToPOCO(OpportunityTypePM entityPM, OpportunityType entityPOCO)
        {
		...
		public void POCOToPM(OpportunityTypePM entityPM, OpportunityType entityPOCO)
        {
		...
		public void PMToOldPM(OpportunityTypePM entityPM, OpportunityTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(OpportunityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(OpportunityTypePM entityPM, OpportunityType entityPOCO, bool isNewEntity)
        {
