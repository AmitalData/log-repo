...
namespace Logitude.CRM.BL.EntityDataMappings
{
   ...
   public partial class TicketTypeDataMapping: IMapping<TicketTypePM, TicketType>,IMappingEncodeBase64NVARCHARFields<TicketTypePM>
   {
	    ...
	    public void PMToPOCO(TicketTypePM entityPM, TicketType entityPOCO)
        {
		...
		public void POCOToPM(TicketTypePM entityPM, TicketType entityPOCO)
        {
		...
		public void PMToOldPM(TicketTypePM entityPM, TicketTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TicketTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TicketTypePM entityPM, TicketType entityPOCO, bool isNewEntity)
        {
