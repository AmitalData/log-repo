...
namespace Logitude.CRM.BL.EntityDataMappings
{
   ...
   public partial class SupportMailboxDataMapping: IMapping<SupportMailboxPM, SupportMailbox>,IMappingEncodeBase64NVARCHARFields<SupportMailboxPM>
   {
	    ...
	    public void PMToPOCO(SupportMailboxPM entityPM, SupportMailbox entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.Mailbox))
            {
				entityPOCO.Mailbox = entityPM.Mailbox;
			}
		...
		public void POCOToPM(SupportMailboxPM entityPM, SupportMailbox entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.Mailbox))
            {
					entityPM.Mailbox = entityPOCO.Mailbox;
            }
		...
		public void PMToOldPM(SupportMailboxPM entityPM, SupportMailboxPM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.Mailbox))
            {
                oldEntityPM.Mailbox = entityPM.Mailbox;
            }
