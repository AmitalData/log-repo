...
namespace Logitude.CRM.BL.EntityDataMappings
{
   ...
   public partial class EmployeeGroupDataMapping: IMapping<EmployeeGroupPM, EmployeeGroup>,IMappingEncodeBase64NVARCHARFields<EmployeeGroupPM>
   {
	    ...
	    public void PMToPOCO(EmployeeGroupPM entityPM, EmployeeGroup entityPOCO)
        {
		...
		public void POCOToPM(EmployeeGroupPM entityPM, EmployeeGroup entityPOCO)
        {
		...
		public void PMToOldPM(EmployeeGroupPM entityPM, EmployeeGroupPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(EmployeeGroupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(EmployeeGroupPM entityPM, EmployeeGroup entityPOCO, bool isNewEntity)
        {
