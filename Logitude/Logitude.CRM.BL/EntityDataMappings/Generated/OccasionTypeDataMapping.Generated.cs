...
namespace Logitude.CRM.BL.EntityDataMappings
{
   ...
   public partial class OccasionTypeDataMapping: IMapping<OccasionTypePM, OccasionType>,IMappingEncodeBase64NVARCHARFields<OccasionTypePM>
   {
	    ...
	    public void PMToPOCO(OccasionTypePM entityPM, OccasionType entityPOCO)
        {
		...
		public void POCOToPM(OccasionTypePM entityPM, OccasionType entityPOCO)
        {
		...
		public void PMToOldPM(OccasionTypePM entityPM, OccasionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(OccasionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(OccasionTypePM entityPM, OccasionType entityPOCO, bool isNewEntity)
        {
