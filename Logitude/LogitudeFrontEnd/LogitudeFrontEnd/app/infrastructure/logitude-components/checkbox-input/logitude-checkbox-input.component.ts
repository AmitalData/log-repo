...
@Component({
    selector: 'logitude-checkbox-input',
    template:
    `

       <div *ngIf="uiProperty.IsVisible" >

        <input [disabled]="!uiProperty.IsEnabled" *ngIf="logitudeForm" type="checkbox" [ngFormControl]="ctrl" [(ngModel)]="DataContext[objectfieldname]" (focus)="onFocus()" (blur)="onBlur()"/>
...
export class LogitudeCheckboxInputComponent implements OnInit {
