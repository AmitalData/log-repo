...
@Component({
    selector: 'logitude-text-input',
    template:
    `

       <div *ngIf="uiProperty.IsVisible" >

        <input [disabled]="!uiProperty.IsEnabled" *ngIf="logitudeForm" type="text" [ngFormControl]="ctrl" [(ngModel)]="DataContext[objectfieldname]" (focus)="onFocus()" (blur)="onBlur()"/>
...
export class LogitudeTextInputComponent implements OnInit{
