...
namespace Logitude.Accounting.Data.EntityListQueryServices
{
    ...
    public partial class LedgerTransactionListQueryService
    {
        ...
        public IQueryable<LedgerTransactionList> GetReportLinesLedgerTransactions(LedgerTransactionBalanceFilter ledgerTransactionBalanceFilter, IQueryable<LedgerTransactionList> query)
        {
            ...
            {
                IQueryable<LedgerTransactionList> inputs = GetInputTransactions(taxReport, transactionBalanceFilter, accountingSettingList, query).OrderByDescending(d => d.AccountingDate).Skip(ledgerTransactionBalanceFilter.PageStartAtRecordIndex).Take(ledgerTransactionBalanceFilter.PageSize);
                transactions = inputTransactions = inputs;


            }
            if (ledgerTransactionBalanceFilter.GLAccountId == accountingSettingList.VATOutputGLAccountId)
            {
                transactions = outputTransactions = GetOutputTransactions(taxReport, accountingSettingList, query);
            }
        ...
        public IQueryable<LedgerTransactionList> GetTaxReportsLedgerTransactionsByJournalIds(List<string> journalIds, TaxReportList taxReport, string accountId, IQueryable<LedgerTransactionList> query)
        {
            ...
            return transactions.Concat(creditLines);
        }
        ...
        {
            IQueryable<JournalLine> journalLines = GetJournalLinesForTransactions(transactions, tenant);
        ...
        private IQueryable<JournalLine> GetJournalLinesForTransactions(IQueryable<LedgerTransactionList> transactions, int tenant)
        {
        ...
        private IQueryable<LedgerTransactionList> GetCreditLinesFromSelectedTransactionsGroupedByJournalId(IQueryable<LedgerTransactionList> outputLines, IQueryable<JournalLine> JournalLines)
