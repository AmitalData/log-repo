...
namespace Logitude.Accounting.Data.Utilities
{
    public class LedgerTransactionsSorter
    {
        ...
        public IQueryable<LedgerTransactionList> SortQuery()
        {
        ...
        private IQueryable<LedgerTransactionList> GetDefaultSortedQuery() => serviceArgs.Transactions.OrderByDescending(d => d.DocumentDate);

        private IQueryable<LedgerTransactionList> GetSortedQuery()
        {
            IQueryable<LedgerTransactionList> reconciliationsIQuerable = serviceArgs.Transactions;
            ...
            return reconciliationsIQuerable;
        }

        private IQueryable<LedgerTransactionList> GetSortedByOriginalAmountQuery()
        {
        ...
        {
            GLAccountRepository gLAccountRepo = new GLAccountRepository(serviceArgs.Tenant);
            GLAccount glaccount = gLAccountRepo.GetSingle(serviceArgs.AccountId, serviceArgs.Tenant);
            return glaccount;
        }
    ...
    public class LedgerTransactionSorterArgs
    {
        ...
        public IQueryable<LedgerTransactionList> Transactions { get; set; }
