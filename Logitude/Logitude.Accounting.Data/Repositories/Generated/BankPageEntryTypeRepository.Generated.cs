...
{
   public partial class BankPageEntryTypeRepository:IRepository<POCO.BankPageEntryType>
   {
		...
		public  POCO.BankPageEntryType GetSingle(string code)
        {
        ...
        public IQueryable<POCO.BankPageEntryType> GetAll()
        {
            return from a in context.BankPageEntryTypes  
                   select a;
        }
				 
        public POCO.BankPageEntryType GetSingle(EntityKeyFields entityKeys)
        {
        ...
        public void Add(POCO.BankPageEntryType entity)
        {
            onAdd();
            context.BankPageEntryTypes.Add(entity);
        }

        public void Remove(POCO.BankPageEntryType entity)
        {
        ...
        public void Update(POCO.BankPageEntryType entity)
        {
            onUpdate();
            context.BankPageEntryTypes.Attach(entity);
        ...
        public List<POCO.BankPageEntryType> All()
        {
