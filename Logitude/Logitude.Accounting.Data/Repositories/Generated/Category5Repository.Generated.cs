...
{
   public partial class Category5Repository:IRepository<POCO.Category5>
   {
		...
		public  POCO.Category5 GetSingle(string id, int tenant)
        {
        ...
        public IQueryable<POCO.Category5> GetAll(int tenant)
        {
            return from a in context.Category5  
        ...
        public POCO.Category5 GetSingle(EntityKeyFields entityKeys)
        {
        ...
        public void Add(POCO.Category5 entity)
        {
            onAdd();
            context.Category5.Add(entity);
        }

        public void Remove(POCO.Category5 entity)
        {
        ...
        public void Update(POCO.Category5 entity)
        {
            onUpdate();
            context.Category5.Attach(entity);
        ...
        public List<POCO.Category5> All()
        {
