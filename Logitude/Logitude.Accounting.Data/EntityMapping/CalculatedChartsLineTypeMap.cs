...
namespace Logitude.Accounting.Data.EntityMapping
{
    ...
    public class CalculatedChartsLineTypeMap : EntityTypeConfiguration<CalculatedChartsLineType>
    {
	    string dbms;
        public CalculatedChartsLineTypeMap()
        { 
				this.ToTable("CalculatedChartsLineTypes");
