...
namespace Logitude.Accounting.Data.EntityMapping
{
    ...
    public class JournalTypeMap : EntityTypeConfiguration<JournalType>
    {
        ...
        { 
				this.ToTable("JournalTypes");
		
		    this.HasKey(t => new { t.JournalTypeID });
	 
            this.Property(t => t.JournalTypeID).HasColumnName("JournalTypeID").IsRequired().HasMaxLength(3).IsUnicode(false);
