...
namespace Logitude.Accounting.Data.EntityMapping
{
    ...
    public class TaxDeductionReportStatusMap : EntityTypeConfiguration<TaxDeductionReportStatus>
    {
	    string dbms;
        public TaxDeductionReportStatusMap()
        { 
				this.ToTable("TaxDeductionReportStatuses");
