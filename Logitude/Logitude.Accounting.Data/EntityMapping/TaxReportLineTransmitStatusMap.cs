...
namespace Logitude.Accounting.Data.EntityMapping
{
    ...
    public class TaxReportLineTransmitStatusMap : EntityTypeConfiguration<TaxReportLineTransmitStatus>
    {
	    string dbms;
        public TaxReportLineTransmitStatusMap()
        { 
				this.ToTable("TaxReportLineTransmitStatuses");
