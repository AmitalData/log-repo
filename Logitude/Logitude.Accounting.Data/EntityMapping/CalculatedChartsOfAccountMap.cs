...
namespace Logitude.Accounting.Data.EntityMapping
{
    ...
    public class CalculatedChartsOfAccountMap : EntityTypeConfiguration<CalculatedChartsOfAccount>
    {
	    string dbms;
        public CalculatedChartsOfAccountMap()
        { 
				this.ToTable("CalculatedChartsOfAccounts");
            ...
            this.Property(t => t.ChartOfAccountTypeCode).HasColumnName("ChartOfAccountTypeCode").HasMaxLength(1).IsUnicode(false);
