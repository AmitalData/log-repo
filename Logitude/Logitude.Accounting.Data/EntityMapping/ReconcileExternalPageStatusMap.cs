...
namespace Logitude.Accounting.Data.EntityMapping
{
    ...
    public class ReconcileExternalPageStatusMap : EntityTypeConfiguration<ReconcileExternalPageStatus>
    {
	    string dbms;
        public ReconcileExternalPageStatusMap()
        { 
				this.ToTable("ReconcileExternalPageStatuses");
