...
--select * from Contacts where email like '%system@tenant%'
--select * from Tenants
--select * from ContactTenants where ContactId in (select id from Contacts where email like '%system@tenant%')
--select * from ContactTenantRoleSet where ContactTenantId in (select id from ContactTenants where ContactId in (select id from Contacts where email like '%system@tenant%'))
--select * from users where id in (select id from Contacts where email like '%system@tenant%')

--delete from Contacts where id not in (select id from users where id in (select id from Contacts where email like '%system@tenant%'))and email like '%system@tenant%'
--delete from ContactTenants where ContactId in (select id from Contacts where id not in (select id from users where id in (select id from Contacts where email like '%system@tenant%'))and email like '%system@tenant%')
--delete from ContactTenantRoleSet where ContactTenantId in (select id from ContactTenants where ContactId in (select id from Contacts where id not in (select id from users where id in (select id from Contacts where email like '%system@tenant%'))and email like '%system@tenant%'))
