...
IF OBJECT_ID('[dbo].[usp_UpdateShipmentOperationalDate]', 'P') IS NOT NULL
drop PROCEDURE [dbo].[usp_UpdateShipmentOperationalDate]
GO

Create PROCEDURE [dbo].[usp_UpdateShipmentOperationalDate]
(
