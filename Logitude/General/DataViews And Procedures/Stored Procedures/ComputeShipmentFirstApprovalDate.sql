...
IF OBJECT_ID('[dbo].[usp_ComputeShipmentFirstApprovalDate]', 'P') IS NOT NULL
drop PROCEDURE [dbo].[usp_ComputeShipmentFirstApprovalDate]
GO

Create PROCEDURE [dbo].[usp_ComputeShipmentFirstApprovalDate]
(
