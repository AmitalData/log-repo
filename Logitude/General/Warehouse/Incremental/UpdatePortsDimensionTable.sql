 ...
 begin
   ...
   declare @ParentTenant int
	...
	else begin update   Dim_Ports set Name =@Name,  LocalName =@LocalName ,  UNLocCode = @CombinedCode ,Country = @Country, StateName = @State,   SourceTenant = @SourceTenant , ParentTenant = @ParentTenant  Where Id = @Id; end
