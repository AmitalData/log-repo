...
----Queries
update Queries set OriginalQueryId =  (select q1.Id from Queries q1 where q1.UniqueCode = Queries.OriginalQueryCode and userid is null);
...
--
-- select Code,count(*) from TextCodes where tenant=0
-- group by Code having count(*) >1
-- 
-- select code,objecttableid,count(*) from eventtypes where tenant=0 group by code,objecttableid having count(*) >1
--Customs.DeclarationReferantData
--select * from eventtypes where code='UPEV' and objecttableid='1-844'
--delete from eventtypes where id='1-6318'
--select * from objecttables where id ='1-844'
--select * from textcodes where code ='TenantManagement.FSULastReceivedDateHelpText'
