	...
	BEGIN
	   ...
	   --From Port
		    ...
		    if(@Transshipment3ToPortId is not null)BEGIN set @ToPortId = @Transshipment3ToPortId;END
	             ...
	             Update WarehouseEntries set FromPortId = @FromPortId , ToPortId = @ToPortId where Id = @Id and tenant =@Tenant

		        End

	  Update  WarehouseEntries set DirectionId = @DirectionId where Id = @Id and tenant =@Tenant
