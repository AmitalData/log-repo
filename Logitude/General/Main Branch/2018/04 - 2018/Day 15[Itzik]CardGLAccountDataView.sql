...
/****** Object:  View [dbo].[CardGLAccountDataView]    Script Date: 04/15/2018 09:02:59 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CardGLAccountDataView]'))
...
INNER JOIN dbo.GLAccountMoreDatas as MOREDATA ON dbo.GLAccounts.Id = MOREDATA.AccountId
