...
declare @Cat2Code varchar(150)
	...
	BEGIN
		...
		begin 
			...
			insert into [dbo].[DWObjectFieldCategories]([Id],[DWObjectFieldId],[DWCategoryCode]) values(@NewId,@Id,@Cat1Code) 	
		end		
		...
		begin 
		    EXEC   [dbo].[usp_GetNextTableIdValue]
		                @pLastNumber = @NewId OUTPUT,
		                @pTableName = N'DWObjectFieldCategories'
			insert into [dbo].[DWObjectFieldCategories]([Id],[DWObjectFieldId],[DWCategoryCode]) values(@NewId,@Id,'General') 	
		end		
		...
		begin 
		    EXEC   [dbo].[usp_GetNextTableIdValue]
		                @pLastNumber = @NewId OUTPUT,
		                @pTableName = N'DWObjectFieldCategories'
			insert into [dbo].[DWObjectFieldCategories]([Id],[DWObjectFieldId],[DWCategoryCode]) values(@NewId,@Id,@Cat2Code) 	
		end		
