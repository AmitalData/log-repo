...
update DWObjectTables set DefaultFilterBy= DefaultFilterBy+',[Local Name]' where DefaultFilterBy not like ('%Local Name%') and code in (select DWObjectTableCode from DWObjectFields where name='Local Name')