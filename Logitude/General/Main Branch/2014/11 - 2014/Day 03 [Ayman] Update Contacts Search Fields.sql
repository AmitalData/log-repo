...
BEGIN
		...
		FROM Contacts
		OPEN ContactsCursor FETCH NEXT FROM ContactsCursor INTO @EntityId, @Tenant, @EnglishName, @LocalName, @Email, @BusinessPhone, @Mobile, @Fax
		...
		FETCH NEXT FROM ContactsCursor INTO @EntityId, @Tenant, @EnglishName, @LocalName, @Email, @BusinessPhone, @Mobile, @Fax
