...
drop view [dbo].[AgingReportInvoiceDataView]
go

/****** Object:  View [dbo].[AgingReportInvoiceDataView]    Script Date: 06/05/2012 16:49:07 ******/
...
CREATE VIEW [dbo].[AgingReportInvoiceDataView]
AS
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'AgingReportInvoiceDataView'
GO
