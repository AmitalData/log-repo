...
namespace AmitalCloud.Shipment.Domain.EntityMapping
{
    ...
    public class AccountingInformationIdentifierMap : EntityTypeConfiguration<POCO.AccountingInformationIdentifier>
    {
	    string dbms;
      ...
      if (dbms == "oracle")
      {
		this.ToTable("AccountingInformationIdentifie");
      }
	  else
	  {
