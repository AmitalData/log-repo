...
namespace AmitalCloud.Shipment.Domain.EntityMapping
{
    ...
    public class ContainerStatusSourceMap : EntityTypeConfiguration<POCO.ContainerStatusSource>
    {
	    string dbms;
        public ContainerStatusSourceMap()
        { 
				this.ToTable("ContainerStatusSources");
