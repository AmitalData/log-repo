...
namespace Logitude.Customs.Data.Repsitories
{
   public partial class SupplierInvoiceItemModVehicleRepository:IRepository<SupplierInvoiceItemModVehicle>
   {
		...
		public List<SupplierInvoiceItemModVehicle> GetMulti(EntityKeyFields entityKeys)
        {
        ...
        public List<SupplierInvoiceItemModVehicle> GetSupplierInvoiceItemModVehiclesForSupplierInvoice(string declarationId, int invoiceCounterKey, int tenant, List<int> FilterLine = null)
        {
            //return (from a in context.SupplierInvoiceItemModVehicles
            //        where a.DeclarationId == declarationId && a.InvoiceCounterKey == invoiceCounterKey
            //        select a).ToList();

            var q = (from a in context.SupplierInvoiceItemModVehicles
                     where a.DeclarationId == declarationId && a.InvoiceCounterKey == invoiceCounterKey
                     select a);
            if (FilterLine != null)
            {
        ...
        public void FastDeleteMulti(DeclarationKeys entityKeyFields)
        {
            ...
            (context as DbContextBase)
                .DeleteWhere<SupplierInvoiceItemModVehicle>(rec => rec.DeclarationId == entityKeyFields.Id);
        }

        public List<SupplierInvoiceItemModVehicle> GetSupplierInvoiceItemModVehiclesForSupplierInvoiceWithSpecificKeys(string declarationId, int invoiceCounterKey, List<int> itemsLineNumbers, int tenant)
        {
            return (from a in context.SupplierInvoiceItemModVehicles
        ...
        {
            (context as DbContextBase)
                .DeleteWhere<SupplierInvoiceItemModVehicle>(rec => rec.DeclarationId == entityKeyFields.DeclarationId && rec.InvoiceCounterKey == entityKeyFields.InvoiceCounterKey && supplierInvoiceItemsParentsLines.Contains(rec.InvoiceItemLineNumber));
