...
{
   public partial class SupplierInvoiceItemsProdIdentRepository:IRepository<POCO.SupplierInvoiceItemsProdIdent>
   {
		...
		public  POCO.SupplierInvoiceItemsProdIdent GetSingle(string declarationid, int invoicecounterkey, int invoiceitemlinenumber, int linenumber, int tenant)
        {
        ...
        public IQueryable<POCO.SupplierInvoiceItemsProdIdent> GetAll(int tenant)
        {
            return from a in context.SupplierInvoiceItemsProdIdents  
        ...
        public POCO.SupplierInvoiceItemsProdIdent GetSingle(EntityKeyFields entityKeys)
        {
        ...
        public void Add(POCO.SupplierInvoiceItemsProdIdent entity)
        {
            onAdd();
            context.SupplierInvoiceItemsProdIdents.Add(entity);
        }

        public void Remove(POCO.SupplierInvoiceItemsProdIdent entity)
        {
        ...
        public void Update(POCO.SupplierInvoiceItemsProdIdent entity)
        {
            onUpdate();
            context.SupplierInvoiceItemsProdIdents.Attach(entity);
        ...
        public List<POCO.SupplierInvoiceItemsProdIdent> All()
        {
