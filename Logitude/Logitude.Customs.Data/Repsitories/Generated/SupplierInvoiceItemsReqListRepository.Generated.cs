...
namespace Logitude.Customs.Data.Repsitories
{
   public partial class SupplierInvoiceItemsReqListRepository:IRepository<SupplierInvoiceItemsReqList>
   {
		...
		public  SupplierInvoiceItemsReqList GetSingle(string declarationid, int linenumber, string siirequestid, int invoicecounterkey, int invoiceitemlinenumber, int tenant)
        {
