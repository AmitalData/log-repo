...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsItemCategoryMap : EntityTypeConfiguration<CustomsItemCategory>
    {
	    string dbms;
        public CustomsItemCategoryMap()
        { 
			  this.ToTable("CustomsItemCategories", "Customs");
