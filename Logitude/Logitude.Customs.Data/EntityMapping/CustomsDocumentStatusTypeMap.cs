...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsDocumentStatusTypeMap : EntityTypeConfiguration<CustomsDocumentStatusType>
    {
	    string dbms;
        public CustomsDocumentStatusTypeMap()
        { 
			  this.ToTable("CustomsDocumentStatusTypes", "Customs");
