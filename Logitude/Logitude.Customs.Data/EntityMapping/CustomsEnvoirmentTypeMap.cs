...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsEnvoirmentTypeMap : EntityTypeConfiguration<CustomsEnvoirmentType>
    {
	    string dbms;
        public CustomsEnvoirmentTypeMap()
        { 
			  this.ToTable("CustomsEnvoirmentTypes", "Customs");
