...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ProceduralFaultInProcessTypeMap : EntityTypeConfiguration<ProceduralFaultInProcessType>
    {
	    string dbms;
        public ProceduralFaultInProcessTypeMap()
        { 
			  this.ToTable("ProceduralFaultInProcessTypes", "Customs");
