...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class LeadDocumentExceptionTypeMap : EntityTypeConfiguration<LeadDocumentExceptionType>
    {
	    string dbms;
        public LeadDocumentExceptionTypeMap()
        { 
			  this.ToTable("LeadDocumentExceptionTypes", "Customs");
