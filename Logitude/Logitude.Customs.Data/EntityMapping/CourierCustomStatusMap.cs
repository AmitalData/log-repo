...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CourierCustomStatusMap : EntityTypeConfiguration<CourierCustomStatus>
    {
	    string dbms;
        public CourierCustomStatusMap()
        { 
			  this.ToTable("CourierCustomStatuses", "Customs");
