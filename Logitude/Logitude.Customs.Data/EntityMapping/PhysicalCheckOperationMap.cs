...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class PhysicalCheckOperationMap : EntityTypeConfiguration<PhysicalCheckOperation>
    {
	    string dbms;
        public PhysicalCheckOperationMap()
        { 
			  this.ToTable("PhysicalCheckOperations", "Customs");
