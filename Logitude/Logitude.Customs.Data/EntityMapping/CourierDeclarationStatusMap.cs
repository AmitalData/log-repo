...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CourierDeclarationStatusMap : EntityTypeConfiguration<CourierDeclarationStatus>
    {
	    string dbms;
        public CourierDeclarationStatusMap()
        { 
			  this.ToTable("CourierDeclarationStatuses", "Customs");
