...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ManifestCargoStatusMap : EntityTypeConfiguration<ManifestCargoStatus>
    {
	    string dbms;
        public ManifestCargoStatusMap()
        { 
			  this.ToTable("ManifestCargoStatuses", "Customs");
