...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class RequestReasonCodeEnumMap : EntityTypeConfiguration<RequestReasonCodeEnum>
    {
	    string dbms;
        public RequestReasonCodeEnumMap()
        { 
			  this.ToTable("RequestReasonCodeEnums", "Customs");
