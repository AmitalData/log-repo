...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class AmendmentRequestStatusMap : EntityTypeConfiguration<AmendmentRequestStatus>
    {
	    string dbms;
        public AmendmentRequestStatusMap()
        { 
			  this.ToTable("AmendmentRequestStatuses", "Customs");
