...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class PackageMeasureQualifierMap : EntityTypeConfiguration<PackageMeasureQualifier>
    {
	    string dbms;
        public PackageMeasureQualifierMap()
        { 
			  this.ToTable("PackageMeasureQualifiers", "Customs");
