...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class DangerousGoodsPackingReqMap : EntityTypeConfiguration<DangerousGoodsPackingReq>
    {
	    string dbms;
        public DangerousGoodsPackingReqMap()
        { 
			  this.ToTable("DangerousGoodsPackingReqs", "Customs");
