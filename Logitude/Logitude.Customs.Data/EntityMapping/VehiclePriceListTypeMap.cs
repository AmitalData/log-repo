...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class VehiclePriceListTypeMap : EntityTypeConfiguration<VehiclePriceListType>
    {
	    string dbms;
        public VehiclePriceListTypeMap()
        { 
			  this.ToTable("VehiclePriceListType", "Customs");
