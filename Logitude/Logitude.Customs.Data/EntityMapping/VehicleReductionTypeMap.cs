...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class VehicleReductionTypeMap : EntityTypeConfiguration<VehicleReductionType>
    {
	    string dbms;
        public VehicleReductionTypeMap()
        { 
			  this.ToTable("VehicleReductionTypes", "Customs");
