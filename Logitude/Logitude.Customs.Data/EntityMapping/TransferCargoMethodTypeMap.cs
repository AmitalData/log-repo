...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class TransferCargoMethodTypeMap : EntityTypeConfiguration<TransferCargoMethodType>
    {
	    string dbms;
        public TransferCargoMethodTypeMap()
        { 
			  this.ToTable("TransferCargoMethodTypes", "Customs");
