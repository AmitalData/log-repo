...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class DepositCustomerActivityMap : EntityTypeConfiguration<DepositCustomerActivity>
    {
	    string dbms;
        public DepositCustomerActivityMap()
        { 
			  this.ToTable("DepositCustomerActivities", "Customs");
