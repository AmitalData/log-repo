...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsShipMap : EntityTypeConfiguration<CustomsShip>
    {
	    string dbms;
        public CustomsShipMap()
        { 
			  this.ToTable("CustomsShips", "Customs");
		
		    this.HasKey(t => new { t.Code });
	 
            this.Property(t => t.Code).HasColumnName("Code").HasMaxLength(25).IsUnicode(false);
