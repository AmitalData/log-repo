...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CourierManifestStatusMap : EntityTypeConfiguration<CourierManifestStatus>
    {
	    string dbms;
        public CourierManifestStatusMap()
        { 
			  this.ToTable("CourierManifestStatuses", "Customs");
