...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class VendorTransactionTypeMap : EntityTypeConfiguration<VendorTransactionType>
    {
	    string dbms;
        public VendorTransactionTypeMap()
        { 
			  this.ToTable("VendorTransactionTypes", "Customs");
