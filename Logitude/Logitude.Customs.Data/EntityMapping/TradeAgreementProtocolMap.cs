...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class TradeAgreementProtocolMap : EntityTypeConfiguration<TradeAgreementProtocol>
    {
	    string dbms;
        public TradeAgreementProtocolMap()
        { 
			  this.ToTable("TradeAgreementProtocols", "Customs");
