...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class FreightPaymentMethodMap : EntityTypeConfiguration<FreightPaymentMethod>
    {
	    string dbms;
        public FreightPaymentMethodMap()
        { 
			  this.ToTable("FreightPaymentMethods", "Customs");
