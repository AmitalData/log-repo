...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsVerificationStatusTypeMap : EntityTypeConfiguration<CustomsVerificationStatusType>
    {
	    string dbms;
        public CustomsVerificationStatusTypeMap()
        { 
			  this.ToTable("CustomsVerificationStatusTypes", "Customs");
