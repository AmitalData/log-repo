...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CollateralAnswerTypeMap : EntityTypeConfiguration<CollateralAnswerType>
    {
	    string dbms;
        public CollateralAnswerTypeMap()
        { 
			  this.ToTable("CollateralAnswerTypes", "Customs");
