...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ProductIdentificationTypeMap : EntityTypeConfiguration<ProductIdentificationType>
    {
	    string dbms;
        public ProductIdentificationTypeMap()
        { 
			  this.ToTable("ProductIdentificationTypes", "Customs");
