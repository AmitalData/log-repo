...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CourierPaymentStatusMap : EntityTypeConfiguration<CourierPaymentStatus>
    {
	    string dbms;
        public CourierPaymentStatusMap()
        { 
			  this.ToTable("CourierPaymentStatuses", "Customs");
