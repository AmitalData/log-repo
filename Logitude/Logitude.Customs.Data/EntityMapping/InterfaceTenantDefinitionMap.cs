...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class InterfaceTenantDefinitionMap : EntityTypeConfiguration<InterfaceTenantDefinition>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.QueueGroupCode).HasColumnName("QueueGroupCode").HasMaxLength(30).IsUnicode(false);
