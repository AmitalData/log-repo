...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CollateralRequestStatusMap : EntityTypeConfiguration<CollateralRequestStatus>
    {
	    string dbms;
        public CollateralRequestStatusMap()
        { 
			  this.ToTable("CollateralRequestStatus", "Customs");
