...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class RegisteredWarehouseSiteTypeMap : EntityTypeConfiguration<RegisteredWarehouseSiteType>
    {
	    string dbms;
        public RegisteredWarehouseSiteTypeMap()
        { 
			  this.ToTable("RegisteredWarehouseSiteTypes", "Customs");
