...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class VehicleSafeAccessoryInstlTypeMap : EntityTypeConfiguration<VehicleSafeAccessoryInstlType>
    {
	    string dbms;
        public VehicleSafeAccessoryInstlTypeMap()
        { 
			  this.ToTable("VehicleSafeAccessoryInstlTypes", "Customs");
