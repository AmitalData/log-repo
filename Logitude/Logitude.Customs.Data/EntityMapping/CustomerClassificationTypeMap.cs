...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomerClassificationTypeMap : EntityTypeConfiguration<CustomerClassificationType>
    {
	    string dbms;
        public CustomerClassificationTypeMap()
        { 
			  this.ToTable("CustomerClassificationTypes", "Customs");
