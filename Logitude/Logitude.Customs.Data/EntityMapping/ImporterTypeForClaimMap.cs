...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ImporterTypeForClaimMap : EntityTypeConfiguration<ImporterTypeForClaim>
    {
	    string dbms;
        public ImporterTypeForClaimMap()
        { 
			  this.ToTable("ImporterTypeForClaims", "Customs");
