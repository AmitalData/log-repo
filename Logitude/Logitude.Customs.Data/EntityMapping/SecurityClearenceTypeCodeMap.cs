...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SecurityClearenceTypeCodeMap : EntityTypeConfiguration<SecurityClearenceTypeCode>
    {
	    string dbms;
        public SecurityClearenceTypeCodeMap()
        { 
			  this.ToTable("SecurityClearenceTypeCodes", "Customs");
