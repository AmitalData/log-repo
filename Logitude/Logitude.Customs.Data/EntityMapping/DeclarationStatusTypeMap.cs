...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class DeclarationStatusTypeMap : EntityTypeConfiguration<DeclarationStatusType>
    {
	    string dbms;
        public DeclarationStatusTypeMap()
        { 
			  this.ToTable("DeclarationStatusTypes", "Customs");
