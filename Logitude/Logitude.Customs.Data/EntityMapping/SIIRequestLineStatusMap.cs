...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SIIRequestLineStatusMap : EntityTypeConfiguration<POCO.SIIRequestLineStatus>
    {
	    string dbms;
        public SIIRequestLineStatusMap()
        { 
			  this.ToTable("SIIRequestLineStatuses", "Customs");
