...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsEntityStatusMap : EntityTypeConfiguration<CustomsEntityStatus>
    {
	    string dbms;
        public CustomsEntityStatusMap()
        { 
			  this.ToTable("CustomsEntityStatuses", "Customs");
