...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class RefundCustomerActivityTypeMap : EntityTypeConfiguration<RefundCustomerActivityType>
    {
	    string dbms;
        public RefundCustomerActivityTypeMap()
        { 
			  this.ToTable("RefundCustomerActivityTypes", "Customs");
