...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class QuotaComputationBasisMap : EntityTypeConfiguration<QuotaComputationBasis>
    {
	    string dbms;
        public QuotaComputationBasisMap()
        { 
			  this.ToTable("QuotaComputationBasises", "Customs");
