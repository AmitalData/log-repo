...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class GuaranteeCertificateTypeMap : EntityTypeConfiguration<GuaranteeCertificateType>
    {
	    string dbms;
        public GuaranteeCertificateTypeMap()
        { 
			  this.ToTable("GuaranteeCertificateTypes", "Customs");
