...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ConditionalExemptionTypeMap : EntityTypeConfiguration<ConditionalExemptionType>
    {
	    string dbms;
        public ConditionalExemptionTypeMap()
        { 
			  this.ToTable("ConditionalExemptionTypes", "Customs");
