...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class PhysicalCheckStatusMessageMap : EntityTypeConfiguration<PhysicalCheckStatusMessage>
    {
	    string dbms;
        public PhysicalCheckStatusMessageMap()
        { 
			  this.ToTable("PhysicalCheckStatusMessages", "Customs");
