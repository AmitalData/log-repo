...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CancellationRequestStatusMap : EntityTypeConfiguration<CancellationRequestStatus>
    {
	    string dbms;
        public CancellationRequestStatusMap()
        { 
			  this.ToTable("CancellationRequestStatuses", "Customs");
