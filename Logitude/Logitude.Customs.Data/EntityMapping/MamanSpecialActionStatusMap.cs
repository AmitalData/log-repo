...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class MamanSpecialActionStatusMap : EntityTypeConfiguration<MamanSpecialActionStatus>
    {
	    string dbms;
        public MamanSpecialActionStatusMap()
        { 
			  this.ToTable("MamanSpecialActionStatuses", "Customs");
