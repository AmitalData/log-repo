...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CheckRepresentativeTypeMap : EntityTypeConfiguration<CheckRepresentativeType>
    {
	    string dbms;
        public CheckRepresentativeTypeMap()
        { 
			  this.ToTable("CheckRepresentativeTypes", "Customs");
