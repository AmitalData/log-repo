...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ProceduralFaultStatusMap : EntityTypeConfiguration<ProceduralFaultStatus>
    {
	    string dbms;
        public ProceduralFaultStatusMap()
        { 
			  this.ToTable("ProceduralFaultStatuses", "Customs");
