...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsHouseTypeTenantMap : EntityTypeConfiguration<CustomsHouseTypeTenant>
    {
	    string dbms;
        public CustomsHouseTypeTenantMap()
        { 
			  this.ToTable("CustomsHouseTypeTenants", "Customs");
