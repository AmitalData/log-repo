...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ContinuousRequestTypeMap : EntityTypeConfiguration<ContinuousRequestType>
    {
	    string dbms;
        public ContinuousRequestTypeMap()
        { 
			  this.ToTable("ContinuousRequestTypes", "Customs");
