...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SupplierInvoiceItemVehiclesAddtionalMap : EntityTypeConfiguration<SupplierInvoiceItemVehiclesAddtional>
    {
	    string dbms;
        public SupplierInvoiceItemVehiclesAddtionalMap()
        { 
		
     dbms = System.Configuration.ConfigurationManager.AppSettings.Get("DBMS");
    if (dbms == "oracle")
    {
	  this.ToTable("SupplierInvoiceItemVehiclesAdd", "Customs");
	}
    else
    {
	  this.ToTable("SupplierInvoiceItemVehiclesAddtionals", "Customs");
	}
            ...
            this.Property(t => t.RichbitNumber).HasColumnName("RichbitNumber").HasMaxLength(10).IsUnicode(false);
