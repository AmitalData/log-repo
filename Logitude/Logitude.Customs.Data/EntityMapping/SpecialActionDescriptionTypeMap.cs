...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SpecialActionDescriptionTypeMap : EntityTypeConfiguration<SpecialActionDescriptionType>
    {
	    string dbms;
        public SpecialActionDescriptionTypeMap()
        { 
			  this.ToTable("SpecialActionDescriptionTypes", "Customs");
