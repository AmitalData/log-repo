...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class PartyRelationshipTypeMap : EntityTypeConfiguration<PartyRelationshipType>
    {
	    string dbms;
        public PartyRelationshipTypeMap()
        { 
			  this.ToTable("PartyRelationshipTypes", "Customs");
