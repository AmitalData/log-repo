...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CancellationReasonRequestTypeMap : EntityTypeConfiguration<CancellationReasonRequestType>
    {
	    string dbms;
        public CancellationReasonRequestTypeMap()
        { 
			  this.ToTable("CancellationReasonRequestTypes", "Customs");
