...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class LastReleaseFromWarehouseMap : EntityTypeConfiguration<LastReleaseFromWarehouse>
    {
	    string dbms;
        public LastReleaseFromWarehouseMap()
        { 
			  this.ToTable("LastReleaseFromWarehouses", "Customs");
