...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class RequestToAdvanceAQueueMap : EntityTypeConfiguration<RequestToAdvanceAQueue>
    {
	    string dbms;
        public RequestToAdvanceAQueueMap()
        { 
			  this.ToTable("RequestToAdvanceAQueues", "Customs");
