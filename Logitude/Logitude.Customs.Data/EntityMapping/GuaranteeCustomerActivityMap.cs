...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class GuaranteeCustomerActivityMap : EntityTypeConfiguration<GuaranteeCustomerActivity>
    {
	    string dbms;
        public GuaranteeCustomerActivityMap()
        { 
			  this.ToTable("GuaranteeCustomerActivities", "Customs");
