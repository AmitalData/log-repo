...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CoolingReportingMethodMap : EntityTypeConfiguration<CoolingReportingMethod>
    {
	    string dbms;
        public CoolingReportingMethodMap()
        { 
			  this.ToTable("CoolingReportingMethods", "Customs");
