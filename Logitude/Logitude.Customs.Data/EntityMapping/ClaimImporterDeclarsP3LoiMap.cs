...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ClaimImporterDeclarsP3LoiMap : EntityTypeConfiguration<ClaimImporterDeclarsP3Loi>
    {
	    string dbms;
        public ClaimImporterDeclarsP3LoiMap()
        { 
			  this.ToTable("ClaimImporterDeclarsP3Lois", "Customs");
