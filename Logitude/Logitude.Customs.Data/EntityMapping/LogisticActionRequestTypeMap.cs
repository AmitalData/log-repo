...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class LogisticActionRequestTypeMap : EntityTypeConfiguration<LogisticActionRequestType>
    {
	    string dbms;
        public LogisticActionRequestTypeMap()
        { 
			  this.ToTable("LogisticActionRequestTypes", "Customs");
