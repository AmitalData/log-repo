...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ContinuousMessagesTypeCodeMap : EntityTypeConfiguration<ContinuousMessagesTypeCode>
    {
	    string dbms;
        public ContinuousMessagesTypeCodeMap()
        { 
			  this.ToTable("ContinuousMessagesTypeCodes", "Customs");
