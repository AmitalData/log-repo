...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ClaimExplanationCodeMap : EntityTypeConfiguration<ClaimExplanationCode>
    {
	    string dbms;
        public ClaimExplanationCodeMap()
        { 
			  this.ToTable("ClaimExplanationCodes", "Customs");
