...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SupplierInvoiceItemsSerialNumMap : EntityTypeConfiguration<SupplierInvoiceItemsSerialNum>
    {
	    string dbms;
        public SupplierInvoiceItemsSerialNumMap()
        { 
			  this.ToTable("SupplierInvoiceItemsSerialNums", "Customs");
            ...
            this.Property(t => t.SerialNumber).HasColumnName("SerialNumber").HasMaxLength(35).IsUnicode(false);
        }
    }
}
