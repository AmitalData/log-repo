...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ProceduralFaultInSourceTypeMap : EntityTypeConfiguration<ProceduralFaultInSourceType>
    {
	    string dbms;
        public ProceduralFaultInSourceTypeMap()
        { 
			  this.ToTable("ProceduralFaultInSourceTypes", "Customs");
