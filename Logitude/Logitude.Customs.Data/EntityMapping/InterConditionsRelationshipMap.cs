...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class InterConditionsRelationshipMap : EntityTypeConfiguration<InterConditionsRelationship>
    {
	    string dbms;
        public InterConditionsRelationshipMap()
        { 
			  this.ToTable("InterConditionsRelationships", "Customs");
