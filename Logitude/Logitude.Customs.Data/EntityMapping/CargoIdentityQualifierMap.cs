...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CargoIdentityQualifierMap : EntityTypeConfiguration<CargoIdentityQualifier>
    {
	    string dbms;
        public CargoIdentityQualifierMap()
        { 
			  this.ToTable("CargoIdentityQualifiers", "Customs");
