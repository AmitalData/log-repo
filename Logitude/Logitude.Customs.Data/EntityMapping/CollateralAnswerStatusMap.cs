...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CollateralAnswerStatusMap : EntityTypeConfiguration<CollateralAnswerStatus>
    {
	    string dbms;
        public CollateralAnswerStatusMap()
        { 
			  this.ToTable("CollateralAnswerStatus", "Customs");
