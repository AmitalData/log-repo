...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ConstraintProcessTypeMap : EntityTypeConfiguration<ConstraintProcessType>
    {
	    string dbms;
        public ConstraintProcessTypeMap()
        { 
			  this.ToTable("ConstraintProcessTypes", "Customs");
