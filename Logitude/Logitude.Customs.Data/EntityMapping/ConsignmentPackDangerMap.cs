...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ConsignmentPackDangerMap : EntityTypeConfiguration<ConsignmentPackDanger>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.UNCode).HasColumnName("UNCode").HasMaxLength(4).IsUnicode(true);
