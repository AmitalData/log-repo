...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ExportLogisticPermitActionMap : EntityTypeConfiguration<ExportLogisticPermitAction>
    {
	    string dbms;
        public ExportLogisticPermitActionMap()
        { 
			  this.ToTable("ExportLogisticPermitActions", "Customs");
