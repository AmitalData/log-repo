...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class PendingByKeywordMap : EntityTypeConfiguration<PendingByKeyword>
    {
        ...
        { 
            ...
            this.Property(t => t.SearchByFieldCode).HasColumnName("SearchByFieldCode").IsRequired().HasMaxLength(2).IsUnicode(true);

            this.Property(t => t.SearchType).HasColumnName("SearchType").IsRequired().HasMaxLength(2).IsUnicode(true);

            this.Property(t => t.ExceptKeywords).HasColumnName("ExceptKeywords").HasMaxLength(2000).IsUnicode(true);
        }
    }
}
