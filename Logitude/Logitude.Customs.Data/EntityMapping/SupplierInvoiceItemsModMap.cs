...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SupplierInvoiceItemsModMap : EntityTypeConfiguration<SupplierInvoiceItemsMod>
    {
	    string dbms;
        public SupplierInvoiceItemsModMap()
        { 
			  this.ToTable("SupplierInvoiceItemsMods", "Customs");
		
		    this.HasKey(t => new { t.DeclarationId, t.InvoiceCounterKey, t.LineNumber, t.ModificationCounterKey });
