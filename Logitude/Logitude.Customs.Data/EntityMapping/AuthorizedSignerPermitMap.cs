...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class AuthorizedSignerPermitMap : EntityTypeConfiguration<AuthorizedSignerPermit>
    {
	    string dbms;
        public AuthorizedSignerPermitMap()
        { 
			  this.ToTable("AuthorizedSignerPermits", "Customs");
