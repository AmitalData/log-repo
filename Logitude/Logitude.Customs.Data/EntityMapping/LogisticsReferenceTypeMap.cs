...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class LogisticsReferenceTypeMap : EntityTypeConfiguration<LogisticsReferenceType>
    {
	    string dbms;
        public LogisticsReferenceTypeMap()
        { 
			  this.ToTable("LogisticsReferenceTypes", "Customs");
