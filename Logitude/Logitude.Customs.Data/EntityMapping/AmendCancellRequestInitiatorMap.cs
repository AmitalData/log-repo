...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class AmendCancellRequestInitiatorMap : EntityTypeConfiguration<AmendCancellRequestInitiator>
    {
	    string dbms;
        public AmendCancellRequestInitiatorMap()
        { 
			  this.ToTable("AmendCancellRequestInitiators", "Customs");
