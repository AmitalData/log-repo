...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ItemGovernmentProcedureTypeMap : EntityTypeConfiguration<ItemGovernmentProcedureType>
    {
	    string dbms;
        public ItemGovernmentProcedureTypeMap()
        { 
			  this.ToTable("ItemGovernmentProcedureTypes", "Customs");
