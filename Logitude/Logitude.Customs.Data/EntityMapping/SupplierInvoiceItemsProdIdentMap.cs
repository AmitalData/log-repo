...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SupplierInvoiceItemsProdIdentMap : EntityTypeConfiguration<SupplierInvoiceItemsProdIdent>
    {
	    string dbms;
        public SupplierInvoiceItemsProdIdentMap()
        { 
			  this.ToTable("SupplierInvoiceItemsProdIdents", "Customs");
            ...
            this.Property(t => t.Identification).HasColumnName("Identification").HasMaxLength(35).IsUnicode(false);
        }
    }
}
