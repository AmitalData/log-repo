...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ImporterPeriodicDeclarStatusMap : EntityTypeConfiguration<ImporterPeriodicDeclarStatus>
    {
	    string dbms;
        public ImporterPeriodicDeclarStatusMap()
        { 
			  this.ToTable("ImporterPeriodicDeclarStatuses", "Customs");
