...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class VehicleSafetyAccessoryTypeMap : EntityTypeConfiguration<VehicleSafetyAccessoryType>
    {
	    string dbms;
        public VehicleSafetyAccessoryTypeMap()
        { 
			  this.ToTable("VehicleSafetyAccessoryTypes", "Customs");
