...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class RegularityPublicationMap : EntityTypeConfiguration<RegularityPublication>
    {
	    string dbms;
        public RegularityPublicationMap()
        { 
			  this.ToTable("RegularityPublications", "Customs");
