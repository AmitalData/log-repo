...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class TransactionNatureTypeMap : EntityTypeConfiguration<TransactionNatureType>
    {
	    string dbms;
        public TransactionNatureTypeMap()
        { 
			  this.ToTable("TransactionNatureTypes", "Customs");
