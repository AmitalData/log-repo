...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsItemHierarchicLocationMap : EntityTypeConfiguration<CustomsItemHierarchicLocation>
    {
	    string dbms;
        public CustomsItemHierarchicLocationMap()
        { 
			  this.ToTable("CustomsItemHierarchicLocations", "Customs");
