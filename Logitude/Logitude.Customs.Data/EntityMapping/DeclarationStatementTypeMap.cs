...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class DeclarationStatementTypeMap : EntityTypeConfiguration<DeclarationStatementType>
    {
	    string dbms;
        public DeclarationStatementTypeMap()
        { 
			  this.ToTable("DeclarationStatementTypes", "Customs");
