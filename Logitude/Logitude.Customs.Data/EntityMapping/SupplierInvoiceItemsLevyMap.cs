...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SupplierInvoiceItemsLevyMap : EntityTypeConfiguration<SupplierInvoiceItemsLevy>
    {
	    string dbms;
        public SupplierInvoiceItemsLevyMap()
        { 
			  this.ToTable("SupplierInvoiceItemsLevies", "Customs");
            ...
            this.Property(t => t.TradeLevyExamptCode).HasColumnName("TradeLevyExamptCode").HasMaxLength(3).IsUnicode(false);

            this.Property(t => t.TradeLevyNumber).HasColumnName("TradeLevyNumber").HasMaxLength(10).IsUnicode(false);
        }
    }
}
