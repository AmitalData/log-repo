...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class DebtNotificationTypeMap : EntityTypeConfiguration<DebtNotificationType>
    {
	    string dbms;
        public DebtNotificationTypeMap()
        { 
			  this.ToTable("DebtNotificationTypes", "Customs");
