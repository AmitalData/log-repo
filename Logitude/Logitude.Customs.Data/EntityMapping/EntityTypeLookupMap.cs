...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class EntityTypeLookupMap : EntityTypeConfiguration<EntityTypeLookup>
    {
        ...
        { 
			  this.ToTable("EntityTypeLookups", "Customs");
		
		    this.HasKey(t => new { t.Code });
	 
            this.Property(t => t.Code).HasColumnName("Code").HasMaxLength(9).IsUnicode(false);
            ...
            this.Property(t => t.EntityType).HasColumnName("EntityType").HasMaxLength(3).IsUnicode(false);
        }
    }
}
