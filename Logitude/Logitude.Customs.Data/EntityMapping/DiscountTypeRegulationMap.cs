...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class DiscountTypeRegulationMap : EntityTypeConfiguration<DiscountTypeRegulation>
    {
	    string dbms;
        public DiscountTypeRegulationMap()
        { 
			  this.ToTable("DiscountTypeRegulations", "Customs");
