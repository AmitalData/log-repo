...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class ConstraintApprovalDecisionMap : EntityTypeConfiguration<ConstraintApprovalDecision>
    {
	    string dbms;
        public ConstraintApprovalDecisionMap()
        { 
			  this.ToTable("ConstraintApprovalDecisions", "Customs");
