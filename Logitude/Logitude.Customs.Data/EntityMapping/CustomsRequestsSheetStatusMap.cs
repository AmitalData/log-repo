...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsRequestsSheetStatusMap : EntityTypeConfiguration<CustomsRequestsSheetStatus>
    {
	    string dbms;
        public CustomsRequestsSheetStatusMap()
        { 
			  this.ToTable("CustomsRequestsSheetStatuses", "Customs");
