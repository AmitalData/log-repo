...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomerIdentifyTypeMap : EntityTypeConfiguration<CustomerIdentifyType>
    {
	    string dbms;
        public CustomerIdentifyTypeMap()
        { 
			  this.ToTable("CustomerIdentifyTypes", "Customs");
