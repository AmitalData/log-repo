...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class AssigneeNotificationTypeMap : EntityTypeConfiguration<AssigneeNotificationType>
    {
	    string dbms;
        public AssigneeNotificationTypeMap()
        { 
			  this.ToTable("AssigneeNotificationTypes", "Customs");
