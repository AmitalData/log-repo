...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class RegularityRequirementWarningMap : EntityTypeConfiguration<RegularityRequirementWarning>
    {
	    string dbms;
        public RegularityRequirementWarningMap()
        { 
			  this.ToTable("RegularityRequirementWarnings", "Customs");
