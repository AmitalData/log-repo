...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsDocumentUploadMap : EntityTypeConfiguration<CustomsDocumentUpload>
    {
	    string dbms;
        public CustomsDocumentUploadMap()
        { 
			  this.ToTable("CustomsDocumentUploads", "Customs");
