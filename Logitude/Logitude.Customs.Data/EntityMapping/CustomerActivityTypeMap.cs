...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomerActivityTypeMap : EntityTypeConfiguration<CustomerActivityType>
    {
	    string dbms;
        public CustomerActivityTypeMap()
        { 
			  this.ToTable("CustomerActivityTypes", "Customs");
