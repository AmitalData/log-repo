...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CargoSplitRequestStatusMap : EntityTypeConfiguration<CargoSplitRequestStatus>
    {
	    string dbms;
        public CargoSplitRequestStatusMap()
        { 
			  this.ToTable("CargoSplitRequestStatuses", "Customs");
