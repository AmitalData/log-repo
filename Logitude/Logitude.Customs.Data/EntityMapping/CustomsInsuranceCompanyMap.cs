...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class CustomsInsuranceCompanyMap : EntityTypeConfiguration<CustomsInsuranceCompany>
    {
	    string dbms;
        public CustomsInsuranceCompanyMap()
        { 
			  this.ToTable("CustomsInsuranceCompanies", "Customs");
