...
namespace Logitude.Customs.Data.EntityMapping
{
    ...
    public class SalesTaxExemptionTypeMap : EntityTypeConfiguration<SalesTaxExemptionType>
    {
	    string dbms;
        public SalesTaxExemptionTypeMap()
        { 
			  this.ToTable("SalesTaxExemptionTypes", "Customs");
