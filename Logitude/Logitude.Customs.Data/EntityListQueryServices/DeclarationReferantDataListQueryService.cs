    ...
    public partial class DeclarationReferantDataListQueryService
    {
        private IQueryable<DeclarationReferantDataList> GetIqueryableList(IQueryable<DeclarationReferantData> iQueryable)
        {
            var aWith = iQueryable
                ...
                .Include(x => x.ControllerUser.Contact)
                .Include(x => x.ForwarderCard)
                .Include(x => x.FclLclCodeTable)
                .Include(x => x.ReferantTeam)
                .Include(x => x.VesselCode)
            ...
            var dWith = context.Declarations
                ...
                .Include(x => x.GovernmentProcedureCurrent)
                .Include(x => x.PhysicalCheckCode)
            ...
            var query =
                ...
                select new DeclarationReferantDataList
                {
                    ...
                    VesselName = a.VesselCode != null
                        ? (a.VesselCode.LocalName != null ? a.VesselCode.LocalName : a.VesselCode.EnglishName)
                        : null,
                    ...
                    PaymentDate_Time = d.PaymentDate != null
                        ? DbFunctions.CreateTime(d.PaymentDate.Value.Hour, d.PaymentDate.Value.Minute, 0).Value.Hours.ToString()
                          + ":" +
                          DbFunctions.CreateTime(d.PaymentDate.Value.Hour, d.PaymentDate.Value.Minute, 0).Value.Minutes.ToString()
                        : "",
                    IsClose = d.IsClose,
                    ...
                    VendorId = a.VendorId,
                    FlightVoyageNumber = a.FlightVoyageNumber,
        ...
        private IQueryable<DeclarationReferantData> ApplyCustomFilters(QueryOperations queryOperations, IQueryable<DeclarationReferantData> iQueryable, int tenant)
        {
            ...
            if (OccuredStatusesFilter != null && !string.IsNullOrEmpty(OccuredStatusesFilter.FieldValue.ToString()))
            {
                ...
                iQueryable = iQueryable.Where(r => q.Contains(r.DeclarationId));
            }
        ...
        public DeclarationReferantDataSummary GetQueriesCounts(int tenant, List<string> refId, List<string> depId, string transportMode)
        {
            ...
            IQueryable<DeclarationReferantDataList> declarationReferantDatas =
                from a in context.DeclarationReferantDatas
                join d in context.Declarations on a.DeclarationIdToDisplay equals d.Id
