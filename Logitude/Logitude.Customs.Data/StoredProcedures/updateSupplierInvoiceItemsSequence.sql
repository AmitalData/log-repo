...
IF OBJECT_ID('[Customs].[usp_UpdateInvoiceItemsSequence]', 'P') IS NOT NULL
drop PROCEDURE [Customs].usp_UpdateInvoiceItemsSequence
GO

Create PROCEDURE [Customs].usp_UpdateInvoiceItemsSequence
(
...
BEGIN 
	...
	FOR
	SELECT LineNumber
	From Customs.SupplierInvoiceItems where DeclarationId=@DeclarationId and CounterKey=@CounterKey and Tenant=@Tenant and IsParent=0 order by OrderByLineNo
