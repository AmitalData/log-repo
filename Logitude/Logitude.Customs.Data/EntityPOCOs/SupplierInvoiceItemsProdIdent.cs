...
namespace Logitude.Customs.Data.EntityPOCOs
{
    ...
    public class SupplierInvoiceItemsProdIdent
    {
	 string dbms;
     ...
     [Key]
        ...
        [ForeignKey("ProductIdentificationType")]
        [Column("TypeCode")]
	    public string TypeCode { get; set; }
	      
        public virtual ProductIdentificationType ProductIdentificationType { get; set; }
