...
namespace Logitude.CargoTracking.Def.Validators
{
    public partial class CargoTrackingValidationClass : ICargoTrackingValidateContext
    {
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            Validators.CargoTrackingValidationClass temp = new Validators.CargoTrackingValidationClass(objectTableName, tenant);
    ...
    interface ICargoTrackingValidateContext
    {
