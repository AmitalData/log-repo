...
namespace Logitude.CargoTracking.Def.Validators
{
    public partial class CargoTrackingClassLevelValidator : ICargoTrackingClassLevelValidator
    {
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            Validators.CargoTrackingClassLevelValidator temp = new Validators.CargoTrackingClassLevelValidator(objectTableName, tenant);
    ...
    public interface ICargoTrackingClassLevelValidator
    {
