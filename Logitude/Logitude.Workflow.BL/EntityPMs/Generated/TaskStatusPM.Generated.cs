...
namespace Logitude.Workflow.BL.EntityPMs
{
   ...
   [DataContract]
   public partial class TaskStatusPM : EntityPM
   {
   	  private string id ;
       ...
       public bool Closed  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(closed != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="Closed",OldValue=closed,NewValue=value,PropertyType="bool"};
		    NotifyPropertyChanged(values);
		   closed=value;
		   }
