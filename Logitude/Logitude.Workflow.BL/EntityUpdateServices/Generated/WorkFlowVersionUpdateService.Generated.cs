...
{ 
   public partial class WorkFlowVersionUpdateService:EntityUpdateService<WorkFlowVersion,WorkFlowVersionPM,EntityPM>
   {
   
        WorkFlowVersionRepository entityRepository;
        public WorkFlowVersionUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public WorkFlowVersionUpdateService(int tenant)
        {
            currentContext = WorkflowContext.GetContext(tenant);
        }

        public WorkFlowVersionUpdateService(IWorkflowContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(WorkFlowVersionPM entityPM)
        {
            WorkFlowVersionKeys entityKeys = new WorkFlowVersionKeys() { Id = entityPM.Id };
            return entityKeys;
        }

		
		protected override void FillDefaultValuesOnCreate(WorkFlowVersionPM entityPM)
        {     
  
		
		    entityPM.Id = IdCounter.GetNumber("WorkFlowVersion", entityPM.Tenant); 
