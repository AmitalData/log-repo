...
namespace Logitude.Workflow.BL.EntityDataMappings
{
   ...
   public partial class TaskStatusDataMapping: IMapping<TaskStatusPM, TaskStatus>,IMappingEncodeBase64NVARCHARFields<TaskStatusPM>
   {
	    ...
	    public void PMToPOCO(TaskStatusPM entityPM, TaskStatus entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.Closed))
            {
				entityPOCO.Closed = entityPM.Closed;
			}
			
				BuildSearchFieldsGenerated(entityPM, entityPOCO, entityPM.ChangeSetOp == ChangeSetOperation.Insert);
		  }

		public void POCOToPM(TaskStatusPM entityPM, TaskStatus entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.Closed))
            {
					entityPM.Closed = entityPOCO.Closed;
            }

		}

		public void PMToOldPM(TaskStatusPM entityPM, TaskStatusPM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.Closed))
            {
                oldEntityPM.Closed = entityPM.Closed;
            }
			
		}

	    public void EncodeBase64NVARCHARFields(TaskStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TaskStatusPM entityPM, TaskStatus entityPOCO, bool isNewEntity)
        {
