...
namespace Logitude.Workflow.BL.EntityDataMappings
{
   ...
   public partial class TaskPriorityDataMapping: IMapping<TaskPriorityPM, TaskPriority>,IMappingEncodeBase64NVARCHARFields<TaskPriorityPM>
   {
	    ...
	    public void PMToPOCO(TaskPriorityPM entityPM, TaskPriority entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.DisplayOrder))
            {
				entityPOCO.DisplayOrder = entityPM.DisplayOrder;
			}
			
				BuildSearchFieldsGenerated(entityPM, entityPOCO, entityPM.ChangeSetOp == ChangeSetOperation.Insert);
		  }

		public void POCOToPM(TaskPriorityPM entityPM, TaskPriority entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.DisplayOrder))
            {
					entityPM.DisplayOrder = entityPOCO.DisplayOrder;
            }

		}

		public void PMToOldPM(TaskPriorityPM entityPM, TaskPriorityPM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.DisplayOrder))
            {
                oldEntityPM.DisplayOrder = entityPM.DisplayOrder;
            }
			
		}

	    public void EncodeBase64NVARCHARFields(TaskPriorityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TaskPriorityPM entityPM, TaskPriority entityPOCO, bool isNewEntity)
        {
