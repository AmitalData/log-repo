...
namespace Logitude.Workflow.BL.EntityDataMappings
{
   ...
   public partial class WorkFlowInstanceVariableDataMapping: IMapping<WorkFlowInstanceVariablePM, WorkFlowInstanceVariable>,IMappingEncodeBase64NVARCHARFields<WorkFlowInstanceVariablePM>
   {
	    ...
	    public void PMToPOCO(WorkFlowInstanceVariablePM entityPM, WorkFlowInstanceVariable entityPOCO)
        {
		...
		public void POCOToPM(WorkFlowInstanceVariablePM entityPM, WorkFlowInstanceVariable entityPOCO)
        {
		...
		public void PMToOldPM(WorkFlowInstanceVariablePM entityPM, WorkFlowInstanceVariablePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(WorkFlowInstanceVariablePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(WorkFlowInstanceVariablePM entityPM, WorkFlowInstanceVariable entityPOCO, bool isNewEntity)
        {
