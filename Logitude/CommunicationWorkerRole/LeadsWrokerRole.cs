...
{
    class LeadsWrokerRole : WorkerEntryPoint
    {
        public override void Run()
        {
            ...
            while (IsRunning)
            {
                if (!General.IsUpdating())
                {
                    ...
                    LogitudeLead lead = leadRepository.GetFirstNotCompletedLogitudeLead();
                    ...
                    if (lead != null)
                    {
                        ...
                        catch (System.Data.Entity.Validation.DbEntityValidationException e)
                        {
                            ...
                            ExceptionHandler.HandleException(e, DateTime.Now, 0, "", "WorkerRole", "LeadsWorkerRole : Run() Method" + Environment.NewLine + Error, null);
                        ...
                        {
                            ExceptionHandler.HandleException(e, DateTime.Now, 0, "", "WorkerRole", "LeadsWorkerRole : Run() Method", null);
        ...
        //private void BliudTr(StringBuilder HtmlTemplate, string text, string value)
        //{
        //    HtmlTemplate.Append("<tr><td>" + text + " </td><td>" + value + "</td></tr>");
