...
namespace Logitude.Update
{
    public partial class MappUnifreightTables : Form
    {
        ...
        void SetClases()
        {
            ...
            this.classes[0, 1] = @"..\..\..\Unifreight.Data\AmitalModel\EntityKeys"; // file location
            this.classes[1, 0] = "Repository";
            this.classes[1, 1] = @"..\..\..\Unifreight.Data\AmitalModel\Repsitories";
            this.classes[2, 0] = "DataMapping";
            this.classes[2, 1] = @"..\..\..\Unifreight.BL\EntityDataMappings";
            this.classes[3, 0] = "PM";
            this.classes[3, 1] = @"..\..\..\Unifreight.BL\EntityPMs\UGenerated";
            this.classes[4, 0] = "QueryService";
            this.classes[4, 1] = @"..\..\..\Unifreight.BL\EntityQueryServices";
        }
