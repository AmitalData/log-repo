...
namespace Logitude.BookingLib.BL.Validators
{
    public partial class BookingClassLevelValidator : IBookingClassLevelValidator
    {
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            Validators.BookingClassLevelValidator temp = new Validators.BookingClassLevelValidator(objectTableName, tenant);
    ...
    public interface IBookingClassLevelValidator
    {
