...
{
    [TestClass]
    public class PickUpDeliveryTypeTests
    {
        [TestMethod]
        public void GetSinglePickUpDeliveryTypePMTest()
        {
            ...
            PickUpDeliveryTypePM entityPM = shipmentsDomainService.GetSinglePickUpDeliveryTypePM("PUD", 1);
            Assert.AreEqual("PUD", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePickUpDeliveryTypePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePickUpDeliveryFromToTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            PickUpDeliveryTypePM entityPM = shipmentsDomainService.GetSinglePickUpDeliveryTypePM("PUD", 2);

        }

        [TestMethod]
        public void GetPickUpDeliveryTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "PickUpDeliveryType";
            ...
            IQueryable<PickUpDeliveryTypeList> list = shipmentsDomainService.GetPickUpDeliveryTypeFilters(bytearray, 1);
