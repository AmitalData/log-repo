...
{
    [TestClass]
    public class AWBSpecialHandlingCodeTests
    {
        [TestMethod]
        public void GetSingleAWBSpecialHandlingCodePMTest()
        {
            ...
            AWBSpecialHandlingCodePM entityPM = shipmentsDomainService.GetSingleAWBSpecialHandlingCode("AWB", 1);
            Assert.AreEqual("AWB", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAWBSpecialHandlingCodePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAWBSpecialHandlingCodePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            AWBSpecialHandlingCodePM entityPM = shipmentsDomainService.GetSingleAWBSpecialHandlingCode("AWB", 2);

        }

        [TestMethod]
        public void GetAWBSpecialHandlingCodeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "AWBSpecialHandlingCode";
            ...
            IQueryable<AWBSpecialHandlingCodeList> list = shipmentsDomainService.GetAWBSpecialHandlingCodeFilters(bytearray, 1);
