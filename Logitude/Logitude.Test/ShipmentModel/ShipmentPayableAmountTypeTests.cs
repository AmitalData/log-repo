...
{
    [TestClass]
    public class ShipmentPayableAmountTypeTests
    {
        [TestMethod]
        public void GetSingleShipmentPayableAmountTypePMTest()
        {
            ...
            ShipmentPayableAmountTypePM entityPM = shipmentsDomainService.GetSingleShipmentPayableAmountTypePM("SPAT", 1);
            Assert.AreEqual("SPAT", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentPayableAmountTypePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentPayableAmountTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            ShipmentPayableAmountTypePM entityPM = shipmentsDomainService.GetSingleShipmentPayableAmountTypePM("SPAT", 2);

        }

        [TestMethod]
        public void GetShipmentPayableAmountTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "ShipmentPayableAmountType";
            ...
            IQueryable<ShipmentPayableAmountTypeList> list = shipmentsDomainService.GetShipmentPayableAmountTypeFilters(bytearray, 1);
