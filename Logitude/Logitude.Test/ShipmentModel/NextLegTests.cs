...
{
    [TestClass]
    public class NextLegTests
    {
        [TestMethod]
        public void GetSingleNextLegPMTest()
        {
            ...
            NextLegPM entityPM = shipmentsDomainService.GetSingleNextLegPM("NL", 1);
            Assert.AreEqual("NL", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleNextLegPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleNextLegPMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            NextLegPM entityPM = shipmentsDomainService.GetSingleNextLegPM("NL", 2);

        }

        [TestMethod]
        public void GetNextLegFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "NextLeg";
            ...
            IQueryable<NextLegList> list = shipmentsDomainService.GetNextLegFilters(bytearray, 1);
