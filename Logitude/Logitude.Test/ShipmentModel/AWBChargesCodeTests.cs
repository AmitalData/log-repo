...
{
    [TestClass]
    public class AWBChargesCodeTests
    {

        [TestMethod]
        public void GetSingleAWBChargesCodePMTest()
        {
            ...
            AWBChargesCodePM entityPM = shipmentsDomainService.GetSingleAWBChargeCode("AWB", 1);
            Assert.AreEqual("AWB", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAWBChargesCodePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAWBChargesCodePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            AWBChargesCodePM entityPM = shipmentsDomainService.GetSingleAWBChargeCode("AWB", 2);

        }


        [TestMethod]
        public void GetAWBChargeCodeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "AWBChargeCode";
            ...
            IQueryable<AWBChargesCodeList> list = shipmentsDomainService.GetAWBChargeCodeFilters(bytearray, 1);
