...
{
    [TestClass]
    public class ShipmentPayableStatusTests
    {
        [TestMethod]
        public void GetSingleShipmentPayableStatusPMTest()
        {
            ...
            ShipmentPayableStatusPM entityPM = shipmentsDomainService.GetSingleShipmentPayableStatus("SPS", 1);
            Assert.AreEqual("SPS", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentPayableStatusPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentPayableStatusPMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            ShipmentPayableStatusPM entityPM = shipmentsDomainService.GetSingleShipmentPayableStatus("SPS", 2);
       
        }

        [TestMethod]
        public void GetShipmentPayableStatusFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "ShipmentPayableStatus";
            ...
            IQueryable<ShipmentPayableStatusList> list = shipmentsDomainService.GetShipmentPayableStatusFilters(bytearray, 1);
