...
{
    [TestClass]
    public class ShipmentLevelTests
    {
        [TestMethod]
        public void GetSingleShipmentLevelPMTest()
        {
            ...
            ShipmentLevelPM entityPM = shipmentsDomainService.GetSingleShipmentLevelPM("SL", 1);
            Assert.AreEqual("SL", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentLevelPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentLevelPMFromAnoterTenantTest()
        {
            CacheManager.CacheWrapper = new MockCacheWrapper();
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            ShipmentLevelPM entityPM = shipmentsDomainService.GetSingleShipmentLevelPM("SL", 2);
        
        }


        [TestMethod]
        public void GetShipmentLevelFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "ShipmentLevel";
            ...
            IQueryable<ShipmentLevelList> list = shipmentsDomainService.GetShipmentLevelFilters(bytearray, 1);
