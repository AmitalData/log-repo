...
{
    [TestClass]
    public class ShipmentTypeTests
    {
        [TestMethod]
        public void GetSingleShipmentTypePMTest()
        {
            ...
            ShipmentTypePM entityPM = shipmentsDomainService.GetSingleShipmentType("1-1", 1);
            Assert.AreEqual("1-1", entityPM.Id);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentTypePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleShipmentTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            ShipmentTypePM entityPM = shipmentsDomainService.GetSingleShipmentType("1-1", 2);
        
        }
        [TestMethod]
        public void GetShipmentTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "ShipmentType";
            ...
            IQueryable<ShipmentTypeList> list = shipmentsDomainService.GetShipmentTypeFilters(bytearray, 1);
