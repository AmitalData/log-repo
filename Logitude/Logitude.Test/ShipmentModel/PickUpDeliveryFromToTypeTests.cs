...
{
    [TestClass]
    public class PickUpDeliveryFromToTypeTests
    {
        [TestMethod]
        public void GetSinglePickUpDeliveryFromToTypePMTest()
        {
            ...
            PickUpDeliveryFromToTypePM entityPM = shipmentsDomainService.GetSinglePickUpDeliveryFromToTypePM("PUP", 1);
            Assert.AreEqual("PUP", entityPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePickUpDeliveryFromToTypePMWithAuthenticationOnTenantTest()
        {
        ...
        public void GetSinglePickUpDeliveryFromToTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            PickUpDeliveryFromToTypePM entityPM = shipmentsDomainService.GetSinglePickUpDeliveryFromToTypePM("PUP", 2);

        }

        [TestMethod]
        public void GetPickUpDeliveryFromToTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "PickUpDeliveryFromToType";
            ...
            IQueryable<PickUpDeliveryFromToTypeList> list = shipmentsDomainService.GetPickUpDeliveryFromToTypeFilters(bytearray, 1);
