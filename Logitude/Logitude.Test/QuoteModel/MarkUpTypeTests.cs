...
{
    [TestClass]
    public class MarkUpTypeTests
    {
        [TestMethod]
        public void GetSingleMarkUpTypeTest()
        {
            ...
            MarkUpType markUpType = qouteDomainService.GetSingleMarkUpType("MK", 2);
            Assert.AreEqual("MK", markUpType.Code);
        }
        ...
        public void GetSingleMarkUpTypePMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            MarkUpType markUpType = qouteDomainService.GetSingleMarkUpType("MK", 1);
        ...
        [TestMethod]
        public void GetMarkUpTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "MarkUpType";
            ...
            IQueryable<MarkUpTypeList> list = qouteDomainService.GetMarkUpTypeFilters(bytearray, 1);
