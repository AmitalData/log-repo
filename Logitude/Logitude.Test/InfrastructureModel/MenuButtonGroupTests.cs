...
{
    [TestClass]
    public class MenuButtonGroupTests
    {
        [TestMethod]
        public void GetSingleMenuButtonGroupPMTest()
        {
            ...
            MenuButtonGroupPM menuButtonGroupPM = generalDomainService.GetSingleMenuButtonGroupByObjectTable("1-1", 1);
            Assert.AreEqual("1-1", menuButtonGroupPM.ObjectTableId);
        }



        [TestMethod]
        public void CreateMenuButtonGroupTest()
        {
            ...
            MenuButtonGroupPM newMenuButtonGroup = new MenuButtonGroupPM()
            {
                Id = "1-5",
                Tenant = tenant,
            ...
            generalDomainService.InsertMenuButtonGroup(newMenuButtonGroup);
            MenuButtonGroup menuButtonGroup = webContext.MenuButtonGroups.Where(d => d.Id == "1-5").FirstOrDefault();
            Assert.AreNotEqual(menuButtonGroup, null);


        }

        [TestMethod]
        public void UpdateMenuButtonGroupTest()
        {
            GeneralMocking.MockHttpContext("user1@fnarsoft.com");
            MockCommonContext commonContext = new MockCommonContext();
            GeneralDomainService generalDomainService = new GeneralDomainService();
            ...
            menuButtonGroupPM.Name = "Edited Name";
            generalDomainService.UpdateMenuButtonGroup(menuButtonGroupPM);

            MenuButtonGroup menuButtonGroup = webContext.MenuButtonGroups.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("Edited Name", menuButtonGroup.Name);
