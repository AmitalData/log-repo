...
{
    [TestClass]
    public class TarrifTypeTests
    {

        [TestMethod]
        public void GetSingleTarrifTypePMTest()
        {
            ...
            TarrifTypePM tarrifTypePM = partnerDomainService.GetSingleTarrifTypePM("1-1", 1);
            Assert.AreEqual("1-1", tarrifTypePM.Code);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleTarrifTypePMWithAutenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleTarrifTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            TarrifTypePM tarrifTypePM = partnerDomainService.GetSingleTarrifTypePM("1-1",2);
         
        }

        [TestMethod]
        public void GetTarrifTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "TarrifType";
            ...
            IQueryable<TarrifTypeList> list = partnerDomainService.GetTarrifTypeFilters(bytearray, 1);
