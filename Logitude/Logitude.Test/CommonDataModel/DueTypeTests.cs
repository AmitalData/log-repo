...
{
    [TestClass]
    public class DueTypeTests
    {
        [TestMethod]
        public void GetSingleDueTypePMTest()
        {
            ...
            DueTypePM dueTypePM = commonDomainService.GetSingleDueType("AB", 1);
            Assert.AreEqual("AB", dueTypePM.Code);
        ...
        public void GetSingleDueTypePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleDueTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            DueTypePM dueTypePM = commonDomainService.GetSingleDueType("AB", 2);
          
        }

        [TestMethod]
        public void GetDueTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "DueType";
            ...
            IQueryable<DueTypeList> list = commonDomainService.GetDueTypeFilters(bytearray, 1);
