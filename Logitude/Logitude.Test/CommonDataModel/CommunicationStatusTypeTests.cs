...
{
    [TestClass]
    public class CommunicationStatusTypeTests
    {
        [TestMethod]
        public void GetSingleCommunicationStatusTypePMTest()
        {
            ...
            CommunicationStatusTypePM communicationStatusTypePM = commonDomainService.GetSingleCommunicationStatusType("CS", 1);
            Assert.AreEqual("CS", communicationStatusTypePM.Code);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCommunicationStatusTypePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCommunicationStatusTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            CommunicationStatusTypePM communicationStatusTypePM = commonDomainService.GetSingleCommunicationStatusType("CS", 2);
          
        }

        [TestMethod]
        public void GetCommunicationStatusTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "CommunicationStatusType";
            ...
            IQueryable<CommunicationStatusTypeList> list = commonDomainService.GetCommunicationStatusTypeFilters(bytearray, 1);
