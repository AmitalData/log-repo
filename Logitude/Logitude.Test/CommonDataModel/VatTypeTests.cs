...
{
    [TestClass]
    public class VatTypeTests
    {
        [TestMethod]
        public void GetSingleVatTypePMTest()
        {
            ...
            VatTypePM vatTypePM = commonDomainService.GetSingleVatType("1-1",1);
            Assert.AreEqual("1-1", vatTypePM.Id);
        ...
        public void GetSingleVatTypePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleVatTypePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            VatTypePM vatTypePM = commonDomainService.GetSingleVatType("1-2", 2);
          
        }

        [TestMethod]
        public void CreateVatTypeTest()
        {
            ...
            VatTypePM newVatType = new VatTypePM()
            {
                Id = "1-5",
                AddedManually = true,
                Code = "PS",
            ...
            commonDomainService.InsertVatType(newVatType);
            VatType vatType = commonContext.VatTypes.Where(d => d.Id == "1-5").FirstOrDefault(); 
            Assert.AreNotEqual(vatType, null);
        }



        [TestMethod]
        public void UpdateVatTypeTest()
        {
            MockCommonContext commonContext = new MockCommonContext();
            CommonDataDomainService commonDomainService = new CommonDataDomainService();
            CacheManager.CacheWrapper = new MockCacheWrapper();
            ...
            vatTypePM.EnglishName = "entity";
            commonDomainService.UpdateVatType(vatTypePM);

            VatType vatType = commonContext.VatTypes.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("entity", vatType.EnglishName);

        }

        [TestMethod]
        public void GetVatTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "VatType";
            ...
            IQueryable<VatTypeList> list = commonDomainService.GetVatTypeFilters(bytearray, 1);
