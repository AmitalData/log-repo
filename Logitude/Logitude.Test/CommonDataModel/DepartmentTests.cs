...
namespace Logitude.Test.CommonDataModel
{
    ...
    public class DepartmentTests
    {
        ...
        [TestMethod]
        public void GetSingleDepartmentPMTest()
        {
            ...
            DepartmentPM departmentPM = commonDomainService.GetSingleDepartment("1-2", 2);
            Assert.AreEqual("1-2", departmentPM.Id);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleDepartmentPMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            DepartmentPM departmentPM = commonDomainService.GetSingleDepartment("1-1", 1);
           
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleDepartmentPMFromAnoterTenantTest()
        {
        ...
        public void CreateDepartmentTest()
        {
            ...
            CacheManager.CacheWrapper = new MockCacheWrapper();
            DepartmentPM newDepartment = new DepartmentPM()
            {
            ...
            commonDomainService.InsertDepartment(newDepartment);
            Department department = commonContext.Departments.Where(d => d.Id == "1-9").FirstOrDefault();
            Assert.AreNotEqual(department, null);
        ...
        public void UpdateDepartmentTest()
        {
            ...
            DepartmentPM cepartmentPM = commonDomainService.GetSingleDepartment("1-1", 1);

            cepartmentPM.EnglishName = "Edited Name";
            commonDomainService.UpdateDepartment(cepartmentPM);

            Department department = commonContext.Departments.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("Edited Name", department.EnglishName);

        }


        [TestMethod]
        public void GetDepartmentFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "Department";
            ...
            IQueryable<DepartmentList> list = commonDomainService.GetDepartmentFilters(bytearray, 1);
