...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSingleWarehousePMTest()
        {
            ...
            WarehousePM warehousePM = partnerDomainService.GetSingleWarehouse("1-1", 1);
            Assert.AreEqual("1-1", warehousePM.Id);
        ...
        public void GetSingleWarehousePMWithAutenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleWarehousePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            WarehousePM warehousePM = partnerDomainService.GetSingleWarehouse("1-2",2);
        ...
        public void CreateWarehouseTest()
        {
            ...
            CacheManager.CacheWrapper = new MockCacheWrapper();
            PartnersDomainService partnerDomainService = new PartnersDomainService();
            WarehouseRepository warehouseRepository = new WarehouseRepository(commonContext);
            CacheManager.CacheWrapper = new MockCacheWrapper();
            WarehousePM newWarehouse = new WarehousePM()
            {
                Id = "1-9",
                Tenant = tenant,
            ...
            partnerDomainService.InsertWarehouse(newWarehouse);
            Warehouse warehouse = commonContext.Warehouses.Where(d => d.Id == "1-9").FirstOrDefault();
            Assert.AreNotEqual(warehouse, null);
        }
        ...
        public void UpdateWarehouseTest()
        {
            ...
            warehousePM.AddedManually = false;
            partnerDomainService.UpdateWarehouse(warehousePM);

            Warehouse warehouse = commonContext.Warehouses.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual(false, warehouse.AddedManually);

        }

        [TestMethod]
        public void GetWarehouseFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "Warehouse";
            ...
            IQueryable<WarehouseList> list = partnerDomainService.GetWarehouseFilters(bytearray, 1);
