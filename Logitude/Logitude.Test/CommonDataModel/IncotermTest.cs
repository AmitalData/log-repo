...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSingleIncotermPMTest()
        {
            ...
            IncotermPM incotermPM = commonDomainService.GetSingleIncoterm("1-2", 2);
            Assert.AreEqual("1-2", incotermPM.Id);
        }
        ...
        public void GetSingleIncotermPMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            IncotermPM incotermPM = commonDomainService.GetSingleIncoterm("1-1",1);
         
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleIncotermPMFromAnoterTenantTest()
        {
        ...
        [TestMethod]
        public void CreateIncotermTest()
        {
            ...
            CacheManager.CacheWrapper = new MockCacheWrapper();
            IncotermPM newIncoterm = new IncotermPM()
            {
            ...
            commonDomainService.InsertIncoterm(newIncoterm);
            Incoterm incoterm = commonContext.Incoterms.Where(d => d.Id == "1-9").FirstOrDefault(); 
            Assert.AreNotEqual(incoterm, null);
        }


        [TestMethod]
        public void UpdateIncotermTest()
        {
            MockCommonContext commonContext = new MockCommonContext();
            CacheManager.CacheWrapper = new MockCacheWrapper();
            ...
            incotermPM.Notes = "Edited Note";
            commonDomainService.UpdateIncoterm(incotermPM);

            Incoterm incoterm = commonContext.Incoterms.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("Edited Note", incoterm.Notes);

        }

        [TestMethod]
        public void GetIncotermFiltersTest()
        {
            ...
            IQueryable<IncotermList> list = commonDomainService.GetIncotermFilters(bytearray, 1);
