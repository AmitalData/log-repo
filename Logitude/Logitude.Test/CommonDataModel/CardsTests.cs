...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSingleCardsPMTest()
        {
            ...
            CardPM cardPM = partnerDomainService.GetSingleCard("1-1", 1);
            Assert.AreEqual("1-1", cardPM.Id);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCardsPMWithAutenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCardsPMFromAnoterTenantTest()
        {
           ...
           Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
           CardPM cardPM = partnerDomainService.GetSingleCard("1-1", 2);
        ...
        public void CreateCardsTest()
        {
            ...
            partnerDomainService.InsertCard(newCard);
            Card card = commonContext.Cards.Where(d => d.Id == "1-9").FirstOrDefault();
        ...
        public void UpdateCardTest()
        {
            ...
            CardPM cardPM = partnerDomainServic.GetSingleCard("1-1", 1);

            cardPM.EnglishName = "Edited Name";
            partnerDomainServic.UpdateCard(cardPM);

            Card card = commonContext.Cards.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("Edited Name", card.EnglishName);

        }

        [TestMethod]
        public void GetCardFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "Card";
            ...
            List<CardList> list = partnerDomainService.GetCardFilters(bytearray, 1);
