...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSingleTemplateFormatPMTest()
        {
            ...
            TemplateFormatPM templateFormatPM = commonDomainService.GetSingleTemplateFormat("HT", 2);
            Assert.AreEqual("HT", templateFormatPM.Code);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleTemplateFormatPMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            TemplateFormatPM templateFormatPM = commonDomainService.GetSingleTemplateFormat("HT", 1);
           
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleTemplateFormatPMFromAnoterTenantTest()
        {
        ...
        [TestMethod]
        public void GetTemplateFormatFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "TemplateFormat";
            ...
            IQueryable<TemplateFormatList> list = commonDomainService.GetTemplateFormatFilters(bytearray, 1);
