...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSingleAirLinePMTest()
        {
            ...
            AirlinePM airLinePM = partnerDomainService.GetAirlineById("1-1", 1);
            Assert.AreEqual("1-1", airLinePM.Id);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAirLinePMWithAutenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAirLinePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            AirlinePM airLinePM = partnerDomainService.GetAirlineById("1-2", 2);
        ...
        public void CreateAirLineTest()
        {
            ...
            CacheManager.CacheWrapper = new MockCacheWrapper();
            AirlinePM newAirline = new AirlinePM()
            {
            ...
            partnerDomainService.InsertAirline(newAirline);
            Airline airline = commonContext.Airlines.Where(d => d.Id == "1-9").FirstOrDefault();
        ...
        public void UpdateAirlineTest()
        {
            ...
            GeneralMocking.MockHttpContext("user1@fnarsoft.com");
            airlinePM.Prefix = "AL";
            partnerDomainService.UpdateAirline(airlinePM);

            Airline airline = commonContext.Airlines.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("AL", airline.Prefix);

        }

        [TestMethod]
        public void GetAirlineFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "Airline";
            queryoperations.PageIndex = 0;
            queryoperations.PageSize = 10;
            queryoperations.QueryFilterItems = new List<QueryFilterItem>();
            queryoperations.QueryFilterItems.Add(new QueryFilterItem() { DisplayInList = true, FieldName = "AddedManually", FieldValue = false, Operator = "Equals" });
            ...
            IQueryable<AirlineList> list = partnerDomainService.GetAirlineFilters(bytearray, 1);
