...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSingleWeightUnitPMTest()
        {
            ...
            WeightUnitPM weightUnitPM = commonDomainService.GetSingleWeightUnit("1-1", 2);
            Assert.AreEqual("1-1", weightUnitPM.Code);
         
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleWeightUnitPMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            WeightUnitPM weightUnitPM = commonDomainService.GetSingleWeightUnit("1-1", 1);
          
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleWeightUnitPMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            WeightUnitPM weightUnitPM = commonDomainService.GetSingleWeightUnit("1-2", 2);
          
        }


        [TestMethod]
        public void GetWeightUnitFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "WeightUnit";
            ...
            IQueryable<WeightUnitList> list = commonDomainService.GetWeightUnitFilters(bytearray, 1);
