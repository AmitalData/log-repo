...
{
    [TestClass]
    public class CommunicationLogTypeTests
    {
        [TestMethod]
        public void GetSingleCommunicationLogTypePMTest()
        {
            ...
            CommunicationLogTypePM communicationLogTypePM = commonDomainService.GetSingleCommunicationLogType("BB", 2);
            Assert.AreEqual("BB", communicationLogTypePM.Code);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCommunicationLogTypePMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            CommunicationLogTypePM communicationLogTypePM = commonDomainService.GetSingleCommunicationLogType("BB", 1);
         
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCommunicationLogTypePMFromAnoterTenantTest()
        {
        ...
        [TestMethod]
        public void GetCommunicationLogTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "CommunicationLogType";
            ...
            IQueryable<CommunicationLogTypeList> list = commonDomainService.GetCommunicationLogTypeFilters(bytearray, 1);
