...
{
    [TestClass]
    public class GlobalZoneTests
    {
        [TestMethod]
       
        public void GetSingleGlobalZonePMTest()
        {
            ...
            GlobalZonePM globalZonePM = commonDomainService.GetSingleGlobalZone("1-1", 1);
            Assert.AreEqual("1-1", globalZonePM.Id);
        ...
        public void GetSingleGlobalZonePMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleGlobalZonePMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            GlobalZonePM globalZonePM = commonDomainService.GetSingleGlobalZone("1-2", 2);
         
        }

        [TestMethod]
        public void CreateGlobalZoneTest()
        {
            ...
            CacheManager.CacheWrapper = new MockCacheWrapper();
            GlobalZonePM newGlobalZone = new GlobalZonePM()
            {
            ...
            commonDomainService.InsertGlobalZone(newGlobalZone);
            GlobalZone globalZone = commonContext.GlobalZones.Where(d => d.Id == "1-9").FirstOrDefault(); 
            Assert.AreNotEqual(globalZone, null);
        }

        [TestMethod]
        public void UpdateGlobalZoneTest()
        {
            MockCommonContext commonContext = new MockCommonContext();
            CacheManager.CacheWrapper = new MockCacheWrapper();
            ...
            globalZonePM.Notes = "Edited Note";
            commonDomainService.UpdateGlobalZone(globalZonePM);

            GlobalZone globalZone = commonContext.GlobalZones.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("Edited Note", globalZone.Notes);

        }

        [TestMethod]
        public void GetGlobalZoneFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "GlobalZone";
            ...
            IQueryable<GlobalZoneList> list = commonDomainService.GetGlobalZoneFilters(bytearray, 1);
