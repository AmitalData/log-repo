...
{
    [TestClass]
    public class PasswordPoliciesTests
    {
        [TestMethod]
        public void GetSinglePasswordPoliciesPMTest()
        {
            ...
            PasswordPolicyPM passwordPolicyPM = commonDomainService.GetSinglePasswordPolicy("MEDU", 1);
            Assert.AreEqual("MEDU", passwordPolicyPM.Code);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePasswordPoliciesPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePasswordPoliciesPMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            PasswordPolicyPM passwordPolicyPM = commonDomainService.GetSinglePasswordPolicy("MEDU", 2);
          
        }

        [TestMethod]
        public void GetPasswordPolicyFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "PasswordPolicy";
            ...
            IQueryable<PasswordPolicyList> list = commonDomainService.GetPasswordPolicyFilters(bytearray, 1);
