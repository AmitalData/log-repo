...
{
    [TestClass]
    public class DimensionsUnitTests
    {

        [TestMethod]
        public void GetSingleDimensionsUnitPMTest()
        {
            ...
            DimensionsUnitPM dimensionsUnitPM = commonDomainService.GetSingleDimensionsUnit("TY", 1);
            Assert.AreEqual("TY", dimensionsUnitPM.Code);
        }

        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleDimensionsUnitPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleDimensionsUnitPMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            DimensionsUnitPM dimensionsUnitPM = commonDomainService.GetSingleDimensionsUnit("TY", 2);
          
        }

        [TestMethod]
        public void GetDimensionsUnitFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "DimensionsUnit";
            ...
            IQueryable<DimensionsUnitList> list = commonDomainService.GetDimensionsUnitFilters(bytearray, 1);
