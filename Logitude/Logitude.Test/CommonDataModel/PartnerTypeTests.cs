...
namespace Logitude.Test.CommonDataModel
{
    ...
    {
        [TestMethod]
        public void GetSinglePartnerTypePMTest()
        {
            ...
            PartnerTypePM partnerTypePM = commonDomainService.GetSinglePartnerType("1-1", 2);
            Assert.AreEqual("1-1", partnerTypePM.Id);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePartnerTypePMWithAuthenticationOnTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            PartnerTypePM partnerTypePM = commonDomainService.GetSinglePartnerType("1-1", 1);
       
        }
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSinglePartnerTypePMFromAnoterTenantTest()
        {
        ...
        [TestMethod]
        public void GetPartnerTypeFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "PartnerType";
            queryoperations.PageIndex = 0;
            queryoperations.PageSize = 10;
            queryoperations.QueryFilterItems = new List<QueryFilterItem>();
            queryoperations.QueryFilterItems.Add(new QueryFilterItem() { DisplayInList = true, FieldName = "Name", Operator = "Equals" });
            ...
            IQueryable<PartnerTypeList> list = commonDomainService.GetPartnerTypeFilters(bytearray, 1);
