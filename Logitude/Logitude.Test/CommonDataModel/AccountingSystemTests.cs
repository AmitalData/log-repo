...
{
    [TestClass]
    public class AccountingSystemTests
    {
        [TestMethod]
        public void GetSingleAccountingSystemPMTest()
        {
            ...
            AccountingSystemPM accountingSystemPM = commonDomainService.GetSingleAccountingSystem("DF", 2);
            Assert.AreEqual("DF", accountingSystemPM.Code);
        }


        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAccountingSystemPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleAccountingSystemPMFromAnoterTenantTest()
        {
        ...
        [TestMethod]
        public void GetAccountingSystemFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "AccountingSystem";
            queryoperations.PageIndex = 0;
            queryoperations.PageSize = 10;
            queryoperations.QueryFilterItems = new List<QueryFilterItem>();
            queryoperations.QueryFilterItems.Add(new QueryFilterItem() { DisplayInList = false, FieldName = "Code", FieldValue = "New", Operator = "Equals" });
            ...
            IQueryable<AccountingSystemList> list = commonDomainService.GetAccountingSystemFilters(bytearray, 1);
