...
namespace Logitude.Test.CommonDataModel
{
    ...
    public class CountryTests
    {
        ...
        [TestMethod]
        public void GetSingleCounteryPMTest()
        {
            ...
            CountryPM countryPM = commonDomainService.GetSingleCountryPM("1-1", 1);
            Assert.AreEqual("1-1", countryPM.Id);
        ...
        public void GetSingleCountryPMWithAuthenticationOnTenantTest()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AutenticationException))]
        public void GetSingleCountryPMFromAnoterTenantTest()
        {
            ...
            Mock.Arrange(() => SecurityUtility.CheckContactFeature(Arg.IsAny<string>(), Arg.IsAny<string>(), Arg.IsAny<int>())).DoNothing();
            CountryPM countryPM = commonDomainService.GetSingleCountryPM("1-2",2);
        ...
        public void CreateCountryTest()
        {
            ...
            commonDomainService.InsertCountry(newCountry);
            Country country = commonContext.Countries.Where(d => d.Id == "1-9").FirstOrDefault(); 
        ...
        public void UpdateCountryTest()
        {
            ...
            countryPM.EnglishName = "Edited Name";
            commonDomainService.UpdateCountry(countryPM);

            Country country = commonContext.Countries.Where(d => d.Id == "1-1").FirstOrDefault();

            Assert.AreEqual("Edited Name", country.EnglishName);

        }

        [TestMethod]
        public void GetCountryFiltersTest()
        {
            ...
            queryoperations.ObjectTableName = "Country";
            ...
            IQueryable<CountryList> list = commonDomainService.GetCountryFilters(bytearray, 1);
