namespace Simplog.Global.Data.Migrations
{
    ...
    public partial class missinnnnnnnng : DbMigration
    {
        public override void Up()
        {
            DropIndex("dbo.TenantManagements", "IX_BluesnapContractId");
            DropForeignKey("dbo.TenantManagements", "FK_dbo.TenantManagements_dbo.BluesnapContracts_BluesnapContractId");
