...
{ 
   public partial class BluesnapContractTypeQueryService: BaseEntityQueryService<IGlobalContext,POCO.BluesnapContractType,BluesnapContractTypeKeys<string>,BluesnapContractTypePM,BluesnapContractTypeList,string>
   {
        ...
        public BluesnapContractTypeQueryService(IGlobalContext context) : this(new Repository<POCO.BluesnapContractType>(context)) {}
		public BluesnapContractTypeQueryService(IRepository<POCO.BluesnapContractType> repository) : base(repository,  new BluesnapContractTypeDataMapping()) { }
