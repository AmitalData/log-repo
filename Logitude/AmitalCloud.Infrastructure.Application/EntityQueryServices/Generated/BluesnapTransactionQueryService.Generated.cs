...
{ 
   public partial class BluesnapTransactionQueryService: BaseEntityQueryService<IGlobalContext,POCO.BluesnapTransaction,BluesnapTransactionKeys<string>,BluesnapTransactionPM,BluesnapTransactionList,string>
   {
        ...
        public BluesnapTransactionQueryService(IGlobalContext context) : this(new Repository<POCO.BluesnapTransaction>(context)) {}
		public BluesnapTransactionQueryService(IRepository<POCO.BluesnapTransaction> repository) : base(repository,  new BluesnapTransactionDataMapping()) { }
