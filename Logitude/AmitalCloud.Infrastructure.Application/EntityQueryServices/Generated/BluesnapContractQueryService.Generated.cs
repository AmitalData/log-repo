...
{ 
   public partial class BluesnapContractQueryService: BaseEntityQueryService<IGlobalContext,POCO.BluesnapContract,BluesnapContractKeys<string>,BluesnapContractPM,BluesnapContractList,string>
   {
        ...
        public BluesnapContractQueryService(IGlobalContext context) : this(new Repository<POCO.BluesnapContract>(context)) {}
		public BluesnapContractQueryService(IRepository<POCO.BluesnapContract> repository) : base(repository,  new BluesnapContractDataMapping()) { }
