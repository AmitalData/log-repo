...
{ 
   public partial class AnalyzeQueueQueryService: BaseEntityQueryService<IGlobalContext,POCO.AnalyzeQueue,AnalyzeQueueKeys<string>,AnalyzeQueuePM,AnalyzeQueueList,string>
   {
        ...
        public AnalyzeQueueQueryService(IGlobalContext context) : this(new Repository<POCO.AnalyzeQueue>(context)) {}
		public AnalyzeQueueQueryService(IRepository<POCO.AnalyzeQueue> repository) : base(repository,  new AnalyzeQueueDataMapping()) { }
