...
{ 
   public partial class PaymentMethodQueryService: BaseEntityQueryService<IGlobalContext,POCO.PaymentMethod,PaymentMethodKeys<string>,PaymentMethodPM,PaymentMethodList,string>
   {
        ...
        public PaymentMethodQueryService(IGlobalContext context) : this(new Repository<POCO.PaymentMethod>(context)) {}
		public PaymentMethodQueryService(IRepository<POCO.PaymentMethod> repository) : base(repository,  new PaymentMethodDataMapping()) { }
