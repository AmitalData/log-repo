...
{ 
   public partial class FollowUpQueryService: BaseEntityQueryService<IAmitalCloudContext,POCO.FollowUp,FollowUpKeys<string>,FollowUpPM,FollowUpList,string>
   {
        ...
        public FollowUpQueryService(IAmitalCloudContext context) : this(new Repository<POCO.FollowUp>(context)) {}
		public FollowUpQueryService(IRepository<POCO.FollowUp> repository) : base(repository,  new FollowUpDataMapping()) { }
