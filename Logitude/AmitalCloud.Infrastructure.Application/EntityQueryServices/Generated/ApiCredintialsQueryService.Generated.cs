...
{ 
   public partial class ApiCredintialsQueryService: BaseEntityQueryService<IGlobalContext,POCO.ApiCredintials,ApiCredintialsKeys<string>,ApiCredintialsPM,ApiCredintialsList,string>
   {
        ...
        public ApiCredintialsQueryService(IGlobalContext context) : this(new Repository<POCO.ApiCredintials>(context)) {}
		public ApiCredintialsQueryService(IRepository<POCO.ApiCredintials> repository) : base(repository,  new ApiCredintialsDataMapping()) { }
