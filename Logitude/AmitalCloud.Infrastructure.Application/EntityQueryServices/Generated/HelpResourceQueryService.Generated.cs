...
{ 
   public partial class HelpResourceQueryService: BaseEntityQueryService<IGlobalContext,POCO.HelpResource,HelpResourceKeys<string>,HelpResourcePM,HelpResourceList,string>
   {
        ...
        public HelpResourceQueryService(IGlobalContext context) : this(new Repository<POCO.HelpResource>(context)) {}
		public HelpResourceQueryService(IRepository<POCO.HelpResource> repository) : base(repository,  new HelpResourceDataMapping()) { }
