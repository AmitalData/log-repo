...
{ 
   public partial class FeatureToggleUpdateService:BaseEntityUpdateService<Domain.Interfaces.IAmitalCloudContext,POCO.FeatureToggle,FeatureTogglePM,IEntityPM,FeatureToggleList,string>
   {
   			
        public FeatureToggleUpdateService(Domain.Interfaces.IAmitalCloudContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public FeatureToggleUpdateService(Domain.Interfaces.IAmitalCloudContext context) :  this(context, null, 0) {}
