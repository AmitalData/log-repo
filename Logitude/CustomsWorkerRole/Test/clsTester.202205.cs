...
namespace CustomsWorkerRole.Test
{
    public partial class clsTester
    {
        ...
        public static void Check_Poco2PM(int tenant)
        {
            var res = new DeclarationQueryService(1)
                .GetAllDeclarationPOCOs(1, "91340176");
            var res1 =(new Logitude.Customs.Data.Repsitories.CourierMasterRepository(3)).GetPrefixMAWBByDeclarationId("1-1702747", 3);
