...
namespace Amital.QuoteOPM.BL.EntityDataMappings
{
   ...
   public partial class QuoteOPClosingReasonDataMapping: IMapping<QuoteOPClosingReasonPM, QuoteOPClosingReason>,IMappingEncodeBase64NVARCHARFields<QuoteOPClosingReasonPM>
   {
	    ...
	    public void PMToPOCO(QuoteOPClosingReasonPM entityPM, QuoteOPClosingReason entityPOCO)
        {
		...
		public void POCOToPM(QuoteOPClosingReasonPM entityPM, QuoteOPClosingReason entityPOCO)
        {
		...
		public void PMToOldPM(QuoteOPClosingReasonPM entityPM, QuoteOPClosingReasonPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(QuoteOPClosingReasonPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(QuoteOPClosingReasonPM entityPM, QuoteOPClosingReason entityPOCO, bool isNewEntity)
        {
