...
{
   public partial class ShipmentOrderModuleClassLevelValidator : IShipmentOrderClassLevelValidator
    {
        int tenant;
        ...
        public ShipmentOrderModuleClassLevelValidator(string objectTableName, int tenant)
        {
            ...
            foreach (ObjectField objectfeildprop in objectFieldList)
            {
                ...
                if (propertyInf != null)
                {
                    ...
                    if (objectfeildprop.IsRequiered)
                    {
                        if (propertyValue == null)
                        {
                            requiredError = requiredError + "," + ShipmentOrderModuleTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", objectfeildprop.FullNameTextCode.Code, null, null, objectfeildprop.Tenant);
                        }
                    ...
                    if (objectfeildprop.DataTypeCode == "Text" || objectfeildprop.DataTypeCode == "nText")
                    {
                        ...
                        if (propertyValue != null)
                        {
                            if (!objectfeildprop.IsMaxLength)
                            {
                                if (propertyValue.ToString().Length > objectfeildprop.MaxLength || propertyValue.ToString().Length < objectfeildprop.MinLength)
                                {
                                    stringLengthError = stringLengthError + "," + ShipmentOrderModuleTranslateTextsClass.GetTranslation("General.M.MinMax", objectfeildprop.FullNameTextCode.Code, objectfeildprop.MinLength.ToString(), objectfeildprop.MaxLength.ToString(), objectfeildprop.Tenant);
