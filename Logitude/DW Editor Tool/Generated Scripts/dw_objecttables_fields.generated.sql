...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ARInvoicesUnitPriceNewId,0,'Fact_ARInvoices','[Unit Price]','Unit Price','Decimal','false',0,0,'false','false','true','InvoiceLines','false','false','false','ARInvoiceLine.UnitPrice','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ARInvoicesQuantityNewId,0,'Fact_ARInvoices','[Quantity]','Quantity','Decimal','false',0,0,'false','false','true','InvoiceLines','false','false','false','ARInvoiceLine.Quantity','false','false')  
