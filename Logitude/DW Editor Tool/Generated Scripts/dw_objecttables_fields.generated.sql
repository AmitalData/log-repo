...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection,RecordType) Values(@DIM_PartnersCustomerRankNewId,0,'DIM_Partners','[Customer Rank]','Customer Rank','Text','false',0,40,'false','false','true','false','false','false','false','false','Customer')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection,RecordType) Values(@DIM_PartnersCustomerSizeNewId,0,'DIM_Partners','[Customer Size]','Customer Size','nText','false',0,60,'false','false','true','false','false','false','false','false','Customer')  
...
declare @Fact_ChargesRecordTypeNewId varchar(15)
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsContainersNumbersandTypesArrayNewId,0,'Fact_Shipments','[Containers Numbers and Types Array]','Containers Numbers and Types Array','nText','false',1000,1000,'false','false','true','packages','false','false','false','ShipmentComputedFields.ContainersNumbersandTypesArray','false','false')  
declare @Fact_ShipmentsRecordTypeNewId varchar(15)
execute usp_GetNextTableIdValue @Fact_ShipmentsRecordTypeNewId OUTPUT,'DWObjectField' 
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsRecordTypeNewId,0,'Fact_Shipments','[Record Type]','Record Type','Text','false',0,100,'false','false','false','false','false','false','true','false')  
