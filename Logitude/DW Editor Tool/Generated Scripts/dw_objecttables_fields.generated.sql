...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesOpenReceivablesInLocalNewId,0,'Fact_Charges','[Houses Open Receivables In Local]','Open Receivables from houses only (Local)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesOpenReceivablesInLocal','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesACCTReceivablesInLocalNewId,0,'Fact_Charges','[Houses ACCT Receivables In Local]','Accounted Receivables from houses only (Local)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesACCTReceivablesInLocal','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesOpenPayablesInLocalNewId,0,'Fact_Charges','[Houses Open Payables In Local]','Open Payables from houses only (Local)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesOpenPayablesInLocal','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesACCTPayablesInLocalNewId,0,'Fact_Charges','[Houses ACCT Payables In Local]','Accounted Payables from houses only (Local)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesACCTPayablesInLocal','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesOpenReceivablesInProfitNewId,0,'Fact_Charges','[Houses Open Receivables In Profit]','Open Receivables from houses only (Profit)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesOpenReceivablesInProfit','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesACCTReceivablesInProfitNewId,0,'Fact_Charges','[Houses ACCT Receivables In Profit]','Accounted Receivables from houses only (Profit)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesACCTReceivablesInProfit','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesOpenPayablesInProfitNewId,0,'Fact_Charges','[Houses Open Payables In Profit]','Open Payables from houses only (Profit)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesOpenPayablesInProfit','false','true','Master')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ChargesHousesACCTPayablesInProfitNewId,0,'Fact_Charges','[Houses ACCT Payables In Profit]','Accounted Payables from houses only (Profit)','Decimal','false',0,0,'false','true','SUM','true','Charges','false','false','false','Shipment.HousesACCTPayablesInProfit','false','true','Master')  
------------------------------------------------------------------------------------
