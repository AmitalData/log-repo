...
declare @Fact_ShipmentsShipmentSubTypeNewId varchar(15)
execute usp_GetNextTableIdValue @Fact_ShipmentsShipmentSubTypeNewId OUTPUT,'DWObjectField' 
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,DimensionTableCode,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection,RecordType) Values(@Fact_ShipmentsShipmentSubTypeNewId,0,'Fact_Shipments','[Shipment Sub Type]','Shipment Sub Type','Dimension','false',0,15,'DIM_ShipmentSubTypes','false','false','true','General','false','false','false','Shipment.ShipmentSubTypeId','false','false','ARInvoicesFact')  
