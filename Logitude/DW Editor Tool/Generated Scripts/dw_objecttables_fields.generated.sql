...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,Category2,HideTree,CannotFilter,HelpText,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsTransshipment2ATDNewId,0,'Fact_Shipments','[Transshipment 2 ATD]','Transshipment 2 ATD','DateTime','false',0,0,'false','false','true','Routings','Dates','false','false','Master.Transshipment2ATD','false','false','false')  
