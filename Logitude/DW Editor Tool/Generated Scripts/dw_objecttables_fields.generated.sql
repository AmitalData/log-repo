...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsBookingConfirmationSentNewId,0,'Fact_Shipments','[Booking Confirmation Sent]','Booking Confirmation Sent Date','DateTime','false',0,0,'false','false','true','KPI','false','false','false','ShipmentComputedFields.BookingConfirmationSent','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsPreAlertSentNewId,0,'Fact_Shipments','[Pre Alert Sent]','Pre-Alert Sent Date','DateTime','false',0,0,'false','false','true','KPI','false','false','false','ShipmentComputedFields.PreAlertSent','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsExpectedArrivalNoticeSentNewId,0,'Fact_Shipments','[Expected Arrival Notice Sent]','Expected Arrival Notice Sent Date','DateTime','false',0,0,'false','false','true','KPI','false','false','false','ShipmentComputedFields.ExpectedArrivalNoticeSent','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsT1ReceivedNewId,0,'Fact_Shipments','[T1 Received]','T1 Received Date','DateTime','false',0,0,'false','false','true','KPI','false','false','false','ShipmentComputedFields.T1Received','false','false')  
