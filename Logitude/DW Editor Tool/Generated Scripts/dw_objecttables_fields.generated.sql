...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesInvoiceChargeLineDescriptionNewId,0,'Fact_Charges','[Invoice Charge Line Description]','Invoice Charge Line Description','nText','false',0,500,'false','false','true','Charges','false','false','false','false','false')  
