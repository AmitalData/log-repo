...
insert into DWObjectTables(Id,Tenant,IndexesXml,Code,Name,TypeCode,IsClosed,DataViewName,HasPivotColumn,PivotFieldCode,AdditionalFactCode,AdditionalFactForeignKey,RecordType,DisplayName,ObjectTableName,HasCustomFields,MaxNumberOfCustomFields) Values(@Fact_ChargesNewId,0,'<ArrayOfIndexItem xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><IndexItem> <Columns>[Source Tenant],[Shipment Create Date]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[Shipment Create Date Time]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[Invoice Date]</Columns></IndexItem></ArrayOfIndexItem>','Fact_Charges','Fact_Charges','Fact','false','factCharges','true','DIM_ChargesTypes','Fact_Shipments','[Shipment Id]','Shipment','Shipment Charges','Shipment','false',0)  
--Fields --
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,DimensionTableCode,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesLocalCurrencyNewId,0,'Fact_Quotes','[Local Currency]','Local Currency','Dimension','false',0,0,'DIM_Currencies','false','false','false','Money','false','false','false','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesPickupFromNewId,0,'Fact_Quotes','[Pickup From]','Pickup From','nText','false',0,250,'false','false','false','Routings','false','false','false','Quote.PickUpAddress','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesConnectedtoTicketNewId,0,'Fact_Quotes','[Connected to Ticket]','Connected to Ticket','Boolean','false',0,0,'false','false','false','General','false','false','false','Quote.IsCreatedFromTicket','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesConnectedtoShipmentNewId,0,'Fact_Quotes','[Connected to Shipment]','Connected to Shipment ','Boolean','false',0,0,'false','false','false','General','false','false','false','Quote.AcceptedWithoutShipments','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,DimensionTableCode,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesFromPortCountryNewId,0,'Fact_Quotes','[From Port Country]','From Port Country','Dimension','false',0,120,'DIM_Countries','false','false','true','Routings','false','false','false','Quote.FromPortCountry','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesEstimatedPayablesinSalesCurrencyNewId,0,'Fact_Quotes','[Estimated Payables in Sales Currency]','Estimated Payables in Sales Currency','Decimal','false',0,0,'false','false','false','Money','false','false','false','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesEstimatedReceivablesinLocalCurrencyNewId,0,'Fact_Quotes','[Estimated Receivables in Local Currency]','Estimated Receivables in Local Currency','Decimal','false',0,0,'false','false','false','Money','false','false','false','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesEstimatedReceivablesinSalesCurrencyNewId,0,'Fact_Quotes','[Estimated Receivables in Sales Currency]','Estimated Receivables in Sales Currency','Decimal','false',0,0,'false','false','false','Money','false','false','false','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesEstimatedProfitinSalesCurrencyNewId,0,'Fact_Quotes','[Estimated Profit in Sales Currency]','Estimated Profit in Sales Currency','Decimal','false',0,0,'false','false','false','Money','false','false','false','true','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesEstimatedPayablesinLocalCurrencyNewId,0,'Fact_Quotes','[Estimated Payables in Local Currency]','Estimated Payables in Local Currency','Decimal','false',0,0,'false','false','false','Money','false','false','false','true','false')  
