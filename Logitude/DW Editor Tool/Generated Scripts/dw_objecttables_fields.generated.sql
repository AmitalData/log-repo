...
insert into DWObjectTables(Id,Tenant,IndexesXml,Code,Name,TypeCode,IsClosed,DataViewName,HasPivotColumn,ParentFactCode,RecordType,DisplayName,ObjectTableName,HasCustomFields,MaxNumberOfCustomFields) Values(@Fact_InlandDomesticShipmentsNewId,0,'','Fact_InlandDomesticShipments','Fact_InlandDomesticShipments','Fact','false','factInlandDomesticShipments','false','Fact_Shipments','Shipment','Inland Domestic Shipments','Shipment','false',0)  
--Fields --
------------------------------------------------------------------------------------
...
insert into DWObjectTables(Id,Tenant,IndexesXml,Code,Name,TypeCode,IsClosed,DataViewName,HasPivotColumn,RecordType,DisplayName,ObjectTableName,HasCustomFields,MaxNumberOfCustomFields) Values(@Fact_ShipmentsNewId,0,'<ArrayOfIndexItem xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><IndexItem> <Columns>[Source Tenant],[Create Date]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[Create Date Time]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[DirectHouse]</Columns></IndexItem><IndexItem> <Columns>[Operationally Closed], [Parent Tenant], [First Operational Close Date]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant], [Operationally Closed]</Columns></IndexItem></ArrayOfIndexItem>','Fact_Shipments','Fact_Shipments','Fact','false','factShipments','false','Shipment','Shipments','Shipment','true',40)  
--Fields --
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,HideTree,CannotFilter,IsCustom,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsIsStandalonePickupDeliveryNewId,0,'Fact_Shipments','[IsStandalonePickupDelivery]','IsStandalonePickupDelivery','Boolean','false',0,0,'false','false','false','false','false','false','true','false')  
