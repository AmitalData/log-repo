...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,DimensionTableCode,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsMainCarriageLeg1FromPortNewId,0,'Fact_Shipments','[Main Carriage Leg 1 From Port]','Main Carriage Leg 1 From Port','Dimension','false',0,0,'DIM_Ports','false','false','true','Routings','false','false','false','Master.MainCarriageFromPortId','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,DimensionTableCode,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ShipmentsMainCarriageLeg1ToPortNewId,0,'Fact_Shipments','[Main Carriage Leg 1 To Port]','Main Carriage Leg 1 To Port','Dimension','false',0,0,'DIM_Ports','false','false','true','Routings','false','false','false','Master.MainCarriageToPortId','false','false')  
