...
insert into DWObjectTables(Id,Tenant,IndexesXml,Code,Name,TypeCode,IsClosed,DataViewName,HasPivotColumn,RecordType,DisplayName,ObjectTableName,HasCustomFields,MaxNumberOfCustomFields) Values(@Fact_ShipmentsNewId,0,'<ArrayOfIndexItem xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><IndexItem> <Columns>[Source Tenant],[Create Date]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[Create Date Time]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[DirectHouse]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant], [Operationally Closed]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[DirectHouse], [IsInland Domestic Shipment]</Columns></IndexItem><IndexItem> <Columns>[Parent Tenant],[Create Date]</Columns></IndexItem><IndexItem> <Columns>[Parent Tenant],[Create Date Time]</Columns></IndexItem><IndexItem> <Columns>[Parent Tenant],[DirectHouse]</Columns></IndexItem><IndexItem> <Columns>[Parent Tenant],[DirectHouse], [IsInland Domestic Shipment]</Columns></IndexItem><IndexItem> <Columns>[Operationally Closed], [Parent Tenant], [First Operational Close Date]</Columns></IndexItem></ArrayOfIndexItem>','Fact_Shipments','Fact_Shipments','Fact','false','factShipments','false','Shipment','Shipments','Shipment','true',40)  
--Fields --
