...
insert into DWObjectTables(Id,Tenant,IndexesXml,Code,Name,TypeCode,IsClosed,DataViewName,HasPivotColumn,RecordType,DisplayName) Values(@Fact_QuotesNewId,0,'<ArrayOfIndexItem xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><IndexItem> <Columns>[Source Tenant]</Columns></IndexItem><IndexItem> <Columns>[Parent Tenant]</Columns></IndexItem><IndexItem> <Columns>[Id]</Columns></IndexItem><IndexItem> <Columns>[Source Tenant],[Open Date]</Columns></IndexItem></ArrayOfIndexItem>','Fact_Quotes','Fact_Quotes','Fact','false','factQuotes','false','Quotes','Quotes')  
--Fields --
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,ViewFieldDisplayName,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesFromNewId,0,'Fact_Quotes','[From]','From','Text','false',0,100,'false','false','true','Routings','false','false','false','Quote.FromLocation','[From]','false','false')  
declare @Fact_QuotesToNewId varchar(15)
execute usp_GetNextTableIdValue @Fact_QuotesToNewId OUTPUT,'DWObjectField' 
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,ViewFieldDisplayName,DontDisplayInView,IsMultipleSelection) Values(@Fact_QuotesToNewId,0,'Fact_Quotes','[To]','To','Text','false',0,100,'false','false','true','Routings','false','false','false','Quote.ToLocation','[To]','false','false')  
