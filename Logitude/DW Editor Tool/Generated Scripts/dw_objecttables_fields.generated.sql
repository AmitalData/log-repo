...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,DisplayInQueryBuilder,Category1,HideTree,CannotFilter) Values(@Fact_ShipmentsField1NewId,0,'Fact_Shipments','[Field1]','Field1','SqlVariant','false',0,0,'false','false','false','CustomFields','false','false')  
