...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesOrderGrossWeightNewId,0,'Fact_Charges','[Order Gross Weight]','Order Gross Weight','Text','false',0,40,'false','true','SUM','true','Packages','false','false','false','Shipment.OrderGrossWeight','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesOrderGrossWeightinTonNewId,0,'Fact_Charges','[Order Gross Weight in Ton]','Order Gross Weight in Ton','Decimal','false',0,0,'false','true','SUM','true','Packages','false','false','false','Shipment.GrossWeightPerTon','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesOrderVolumeNewId,0,'Fact_Charges','[Order Volume]','Order Volume','Text','false',0,40,'false','true','SUM','true','Packages','false','false','false','Shipment.BookingVolume','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesTotalVolumeCBMNewId,0,'Fact_Charges','[Total Volume (CBM)]','Total Volume (CBM)','Decimal','false',0,0,'false','true','SUM','true','Packages','false','false','false','Shipment.VolumeInCBM','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesVolumetricWeightNewId,0,'Fact_Charges','[Volumetric Weight]','Volumetric Weight','Text','false',0,40,'false','true','SUM','true','Packages','false','false','false','Shipment.VolumetricWeight','false','false')  
...
insert into DWObjectFields(Id,Tenant,DWObjectTableCode,Code,Name,DataTypeCode,IsRequired,MinLength,MaxLength,IsPrimaryKey,IsMeasurement,AggregationTypeCode,DisplayInQueryBuilder,Category1,HideTree,CannotFilter,IsCustom,OriginalObjectFieldCode,DontDisplayInView,IsMultipleSelection) Values(@Fact_ChargesNumberofPackagesNewId,0,'Fact_Charges','[Number of Packages]','Number of Packages','Integer','false',0,0,'false','true','SUM','true','Packages','false','false','false','Shipment.NumberOfPackages','false','false')  
