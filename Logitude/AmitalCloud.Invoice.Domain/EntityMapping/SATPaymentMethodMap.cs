...
namespace AmitalCloud.Invoice.Domain.EntityMapping
{
    ...
    public class SATPaymentMethodMap : EntityTypeConfiguration<POCO.SATPaymentMethod>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.LocalName).HasColumnName("LocalName").IsRequired().HasMaxLength(100).IsUnicode(false);
        }
    }
}
