...
namespace AmitalCloud.Invoice.Domain.EntityMapping
{
    ...
    public class SATInterfaceMap : EntityTypeConfiguration<POCO.SATInterface>
    {
	    string dbms;
        ...
        { 
            ...
            this.Property(t => t.Name).HasColumnName("Name").IsRequired().HasMaxLength(120).IsUnicode(false);
