...
namespace AmitalCloud.Invoice.Domain.EntityMapping
{
    ...
    public class AccountingTransferTypeMap : EntityTypeConfiguration<POCO.AccountingTransferType>
    {
	    string dbms;
        public AccountingTransferTypeMap()
        { 
				this.ToTable("AccountingTransferTypes");
