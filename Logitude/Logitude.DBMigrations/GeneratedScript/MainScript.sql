...
EXEC('EXEC sys.sp_addextendedproperty @name=N''MS_DiagramPane1'', @value=N''[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
...
End
End
'' , @level0type=N''SCHEMA'',@level0name=N''dbo'', @level1type=N''VIEW'',@level1name=N''AgingReportInvoiceDataView''');
EXEC('EXEC sys.sp_addextendedproperty @name=N''MS_DiagramPaneCount'', @value=1 , @level0type=N''SCHEMA'',@level0name=N''dbo'', @level1type=N''VIEW'',@level1name=N''AgingReportInvoiceDataView''');


-- Procedure Script From UpdateTenantCustomersActualData.dxml
