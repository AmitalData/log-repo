...
INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('caa08bfa-b5b6-42af-a112-2b85dd016e6a', 'LedgerTransaction.dxml', 'LedgerTransactions', 'Notes', 'Alter Column Size', GETDATE(), '-- Change Size From 150 To 2000 For Column NotesALTER TABLE [dbo].[LedgerTransactions] ALTER COLUMN [Notes] NVARCHAR(2000);');
...
INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('3e2a87d7-5f0f-4132-ab6e-c3092c64f0d1', 'BatchTaskExecution.dxml', 'BatchTaskExecutions', 'ProgressMessage', 'Alter Column Size', GETDATE(), '-- Change Size From 120 To 4000 For Column ProgressMessageALTER TABLE [dbo].[BatchTaskExecutions] ALTER COLUMN [ProgressMessage] NVARCHAR(4000);');
