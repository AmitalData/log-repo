...
ALTER TABLE "OBJECTFIELDS" MODIFY "FIELDCODE" NOT NULL;'; INSERT INTO "DBMIGRATIONSHISTORY"("ID", "DXMLFILENAME", "TABLENAME", "COLUMNNAME", "MIGRATIONTYPE", "EXECUTIONDATE", "MIGRATIONSCRIPT")VALUES('eafeb409-2deb-4702-add7-98074efbb818', 'ObjectField.dxml', 'OBJECTFIELDS', 'FIELDCODE', 'Unset Column Nullable', SYSDATE, ScriptText); END;
...
CREATE INDEX "IX_OBJECTFIELDS_FIELDCODE" ON "OBJECTFIELDS"("FIELDCODE");'; INSERT INTO "DBMIGRATIONSHISTORY"("ID", "DXMLFILENAME", "TABLENAME", "COLUMNNAME", "MIGRATIONTYPE", "EXECUTIONDATE", "MIGRATIONSCRIPT")VALUES('fe973afb-1b35-466b-937d-9b1cf9552ca5', 'ObjectField.dxml', 'OBJECTFIELDS', 'FIELDCODE', 'Create Index', SYSDATE, ScriptText); END;


-- Create Unique Constraint On OBJECTFIELDS Table
ALTER TABLE "OBJECTFIELDS" ADD CONSTRAINT "UQ_OBJECTFIELDS_TENANT_C_WR8UP" UNIQUE("TENANT","CODE","OBJECTTABLEID");

DECLARE ScriptText NCLOB; BEGIN ScriptText := '-- Create Unique Constraint On OBJECTFIELDS Table
ALTER TABLE "OBJECTFIELDS" ADD CONSTRAINT "UQ_OBJECTFIELDS_TENANT_C_WR8UP" UNIQUE("TENANT","CODE","OBJECTTABLEID");'; INSERT INTO "DBMIGRATIONSHISTORY"("ID", "DXMLFILENAME", "TABLENAME", "COLUMNNAME", "MIGRATIONTYPE", "EXECUTIONDATE", "MIGRATIONSCRIPT")VALUES('9f08ff20-764d-4a70-bae0-c7beea174fc4', 'ObjectField.dxml', 'OBJECTFIELDS', 'TENANT,CODE,OBJECTTABLEID', 'Create Unique Constraint', SYSDATE, ScriptText); END;
