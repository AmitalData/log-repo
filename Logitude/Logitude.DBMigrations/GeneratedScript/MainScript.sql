...
INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('c23f623f-89c2-48d0-a18d-ec99923c9dff', 'InterestReportsConnectedInvoice.dxml', 'InterestReportsConnectInvoices', NULL, 'Create Table', GETDATE(), '-- Create New Table With Name InterestReportsConnectInvoicesCREATE TABLE [dbo].[InterestReportsConnectInvoices]([Id] VARCHAR(15) NOT NULL,[Tenant] INT NOT NULL,[ReportId] VARCHAR(15) NULL,[InvoiceId] VARCHAR(15) NULL,CONSTRAINT [PK_InterestReportsConnectInvoices] PRIMARY KEY([Id]));');

-- Create Unique Constraint On InterestReportsConnectInvoices Table
EXEC('ALTER TABLE [dbo].[InterestReportsConnectInvoices] ADD CONSTRAINT [UQ_InterestReportsConnectInvoices_ReportId_Tenant] UNIQUE([ReportId],[Tenant])');

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('ea23cc58-b290-448e-95d2-241502b67f32', 'InterestReportsConnectedInvoice.dxml', 'InterestReportsConnectInvoices', 'ReportId,Tenant', 'Create Unique Constraint', GETDATE(), '-- Create Unique Constraint On InterestReportsConnectInvoices TableEXEC(''ALTER TABLE [dbo].[InterestReportsConnectInvoices] ADD CONSTRAINT [UQ_InterestReportsConnectInvoices_ReportId_Tenant] UNIQUE([ReportId],[Tenant])'');');


-- Change Size From 150 To 2000 For Column Notes
ALTER TABLE [dbo].[LedgerTransactions] ALTER COLUMN [Notes] NVARCHAR(2000);

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('fd897e7a-20fd-4a83-9601-11efb642327d', 'LedgerTransaction.dxml', 'LedgerTransactions', 'Notes', 'Alter Column Size', GETDATE(), '-- Change Size From 150 To 2000 For Column NotesALTER TABLE [dbo].[LedgerTransactions] ALTER COLUMN [Notes] NVARCHAR(2000);');


-- Add New Column With Name UploadingUniqueKey
ALTER TABLE [dbo].[Cards] ADD [UploadingUniqueKey] VARCHAR(70) NULL;

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('40d322cf-79c2-4cb0-97e1-a2c76b391009', 'Card.dxml', 'Cards', 'UploadingUniqueKey', 'Add Column', GETDATE(), '-- Add New Column With Name UploadingUniqueKeyALTER TABLE [dbo].[Cards] ADD [UploadingUniqueKey] VARCHAR(70) NULL;');


-- Drop Unique Constraint UQ_Tenant_Code_EntityStatus From Table EntityStatus
EXEC('IF (OBJECT_ID(''[dbo].[UQ_Tenant_Code_EntityStatus]'', ''UQ'') IS NOT NULL) BEGIN ALTER TABLE [dbo].[EntityStatus] DROP CONSTRAINT [UQ_Tenant_Code_EntityStatus] END');

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('a8103dfa-270d-47ff-83dc-4e16c6c33934', 'EntityStatus.dxml', 'EntityStatus', NULL, 'Drop Unique Constraint', GETDATE(), '-- Drop Unique Constraint UQ_Tenant_Code_EntityStatus From Table EntityStatusEXEC(''IF (OBJECT_ID(''''[dbo].[UQ_Tenant_Code_EntityStatus]'''', ''''UQ'''') IS NOT NULL) BEGIN ALTER TABLE [dbo].[EntityStatus] DROP CONSTRAINT [UQ_Tenant_Code_EntityStatus] END'');');


-- Add New Column With Name DeliveryDate
ALTER TABLE [dbo].[ShipmentComputedFields] ADD [DeliveryDate] DATETIME NULL;

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('45202d0d-0f6b-4cba-94c2-82bd5918e87f', 'ShipmentComputedFields.dxml', 'ShipmentComputedFields', 'DeliveryDate', 'Add Column', GETDATE(), '-- Add New Column With Name DeliveryDateALTER TABLE [dbo].[ShipmentComputedFields] ADD [DeliveryDate] DATETIME NULL;');

-- Add New Column With Name OnHandDate
ALTER TABLE [dbo].[ShipmentComputedFields] ADD [OnHandDate] DATETIME NULL;

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('03db888a-79da-49c6-8132-2a627053efdd', 'ShipmentComputedFields.dxml', 'ShipmentComputedFields', 'OnHandDate', 'Add Column', GETDATE(), '-- Add New Column With Name OnHandDateALTER TABLE [dbo].[ShipmentComputedFields] ADD [OnHandDate] DATETIME NULL;');

-- Add New Column With Name PODDate
ALTER TABLE [dbo].[ShipmentComputedFields] ADD [PODDate] DATETIME NULL;

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('6a9a9a15-1bbc-4a57-8514-08b1cd518e15', 'ShipmentComputedFields.dxml', 'ShipmentComputedFields', 'PODDate', 'Add Column', GETDATE(), '-- Add New Column With Name PODDateALTER TABLE [dbo].[ShipmentComputedFields] ADD [PODDate] DATETIME NULL;');


-- Add New Column With Name ShipmentPackageId
ALTER TABLE [dbo].[WarehouseEntryPackages] ADD [ShipmentPackageId] VARCHAR(15) NULL;

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('ce8e3c0e-0a99-4e61-93e4-486874287178', 'WarehouseEntryPackage.dxml', 'WarehouseEntryPackages', 'ShipmentPackageId', 'Add Column', GETDATE(), '-- Add New Column With Name ShipmentPackageIdALTER TABLE [dbo].[WarehouseEntryPackages] ADD [ShipmentPackageId] VARCHAR(15) NULL;');


-- Add New Column With Name ChildEntityReference
ALTER TABLE [dbo].[WarehouseReleases] ADD [ChildEntityReference] VARCHAR(25) NULL;

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('33b53f50-c2a1-4178-85d9-b214bbc96660', 'WarehouseRelease.dxml', 'WarehouseReleases', 'ChildEntityReference', 'Add Column', GETDATE(), '-- Add New Column With Name ChildEntityReferenceALTER TABLE [dbo].[WarehouseReleases] ADD [ChildEntityReference] VARCHAR(25) NULL;');
...
EXEC('IF (OBJECT_ID(''[dbo].[FK_dbo.DocumentsFilings_dbo.Documents_DocumentId]'', ''F'') IS NOT NULL) BEGIN ALTER TABLE [dbo].[DocumentsFilings] DROP CONSTRAINT [FK_dbo.DocumentsFilings_dbo.Documents_DocumentId] END');

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('438ad2f7-b24d-4e0c-9296-127590294853', 'DocumentsFiling.dxml', 'DocumentsFilings', NULL, 'Drop Relation', GETDATE(), '-- Drop Foreign Key Constraint For Column DocumentId In Table DocumentsFilings That Reference To Column Id In Table DocumentsEXEC(''IF (OBJECT_ID(''''[dbo].[FK_dbo.DocumentsFilings_dbo.Documents_DocumentId]'''', ''''F'''') IS NOT NULL) BEGIN ALTER TABLE [dbo].[DocumentsFilings] DROP CONSTRAINT [FK_dbo.DocumentsFilings_dbo.Documents_DocumentId] END'');');

-- Drop Index IX_DocumentId From Table DocumentsFilings
EXEC('IF EXISTS (SELECT * FROM sys.indexes WHERE name=''IX_DocumentId'' AND object_id = OBJECT_ID(''[dbo].[DocumentsFilings]'', ''U'')) BEGIN DROP INDEX [IX_DocumentId] ON [dbo].[DocumentsFilings] END');

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('05b5307a-d086-47d6-ab39-ca3a1962a854', 'DocumentsFiling.dxml', 'DocumentsFilings', NULL, 'Drop Index', GETDATE(), '-- Drop Index IX_DocumentId From Table DocumentsFilingsEXEC(''IF EXISTS (SELECT * FROM sys.indexes WHERE name=''''IX_DocumentId'''' AND object_id = OBJECT_ID(''''[dbo].[DocumentsFilings]'''', ''''U'''')) BEGIN DROP INDEX [IX_DocumentId] ON [dbo].[DocumentsFilings] END'');');


-- Drop Foreign Key Constraint For Column Id In Table APILogsData That Reference To Column Id In Table APILogs
EXEC('IF (OBJECT_ID(''[dbo].[FK_dbo.APILogsData_dbo.APILogs_Id]'', ''F'') IS NOT NULL) BEGIN ALTER TABLE [dbo].[APILogsData] DROP CONSTRAINT [FK_dbo.APILogsData_dbo.APILogs_Id] END');

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('77678e1b-d23a-4cb2-a1fd-b71b446f79aa', 'APILogsData.dxml', 'APILogsData', NULL, 'Drop Relation', GETDATE(), '-- Drop Foreign Key Constraint For Column Id In Table APILogsData That Reference To Column Id In Table APILogsEXEC(''IF (OBJECT_ID(''''[dbo].[FK_dbo.APILogsData_dbo.APILogs_Id]'''', ''''F'''') IS NOT NULL) BEGIN ALTER TABLE [dbo].[APILogsData] DROP CONSTRAINT [FK_dbo.APILogsData_dbo.APILogs_Id] END'');');

-- Drop Index IX_Id From Table APILogsData
EXEC('IF EXISTS (SELECT * FROM sys.indexes WHERE name=''IX_Id'' AND object_id = OBJECT_ID(''[dbo].[APILogsData]'', ''U'')) BEGIN DROP INDEX [IX_Id] ON [dbo].[APILogsData] END');

INSERT INTO [dbo].[DBMigrationsHistory]([Id], [DxmlFileName], [TableName], [ColumnName], [MigrationType], [ExecutionDate], [MigrationScript])VALUES('ea53bf9e-af30-45d8-899a-032cd43d36aa', 'APILogsData.dxml', 'APILogsData', NULL, 'Drop Index', GETDATE(), '-- Drop Index IX_Id From Table APILogsDataEXEC(''IF EXISTS (SELECT * FROM sys.indexes WHERE name=''''IX_Id'''' AND object_id = OBJECT_ID(''''[dbo].[APILogsData]'''', ''''U'''')) BEGIN DROP INDEX [IX_Id] ON [dbo].[APILogsData] END'');');
...
SELECT @EndTime = GETDATE()
UPDATE [dbo].[DBScriptsHistory] SET [ExecutionDate] = GETDATE(), [ScriptBody] = '-- not used, run manually', [ElapsedTimeInMs] = DATEDIFF(MS,@StartTime,@EndTime), [HashValue] = '9c7d4b76a39e0183af6d3eaef3c13a20', [Version] = 2 WHERE [SxmlFileName] = '202006291330_FillPaidDateOfInvoices.sxml';
COMMIT TRAN
END TRY
BEGIN CATCH
IF @@TRANCOUNT > 0
