...
where code='901';
if n = 0 then
INSERT INTO EXCEPTIONREASONS VALUES ('901',1,'','נדרש תצהיר יבואן',1,null,'נדרש תצהיר יבואן,901');commit;
end if;
end;
END;
...
UPDATE "DBSCRIPTSHISTORY" SET "EXECUTIONDATE" = SYSDATE, "SCRIPTBODY" = ScriptBody, "ELAPSEDTIMEINMS" = EXTRACT(DAY FROM(EndTime - StartTime) * 24 * 60 * 60 * 1000), "HASHVALUE" = 'c5ee283898fbf2d29232bee2606ab88a', "VERSION" = 5 WHERE "SXMLFILENAME" = '202006031027_AddReferantException901.sxml';
END;
END;
EXCEPTION
WHEN OTHERS THEN
