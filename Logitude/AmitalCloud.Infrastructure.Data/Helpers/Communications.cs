...
namespace AmitalCloud.Infrastructure.Data.Helpers
{
    public class Communications
    {
        ...
        //         try
        //         {
        //             if (!AmitalCloudSettings.IsCostomsDeploy &&   AmitalCloudSettings.DeploymentStage != "amitaloracletk1")//Islam //(AmitalCloudSettings.QueueServiceMode != "db")
        //             {
        ...
        //                 var queueService = new CustomDbQueueService(queueName, 0);
        ...
        //                 cmd.CommandText = DBHelpers.DbContextBaseUtil.GetStoredProcedureName("usp_UpdateQueueCommunicationLo", Enums.AmitalCloudDBSchema.LOGITUDE_MAIN, cmd.Connection.ConnectionString);
