...
{
   public partial class CustomerSizeDataMapping: IMapping<CustomerSizePM, POCO.CustomerSize  ,CustomerSizeList >,IMappingEncodeBase64NVARCHARFields<CustomerSizePM>
   {
	    ...
	    public void PMToPOCO(CustomerSizePM entityPM, POCO.CustomerSize entityPOCO)
        {
		...
		public void POCOToPM(CustomerSizePM entityPM, POCO.CustomerSize entityPOCO)
        {
		...
		public void PMToOldPM(CustomerSizePM entityPM, CustomerSizePM oldEntityPM)
        {
		...
		public void POCOToList(POCO.CustomerSize entityPOCO, CustomerSizeList entityList)
        {
            //entityList.Code = entityPOCO.Code;
            //entityList.Name = entityPOCO.Name;
            //entityList.SearchFields = entityPOCO.SearchFields;
        }
		public IQueryable<CustomerSizeList> GetIqueryableList(IQueryable<POCO.CustomerSize> iQueryable)
		{
			IQueryable<CustomerSizeList> query = (from a in iQueryable
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerSizePM entityPM)
        {
        ...
        public void AddPMPropertyName(PMPropertyNames pocoPropertyName)
        {
            CustomMappedPMProperties.Add(pocoPropertyName);
				...
				private void BuildSearchFieldsGenerated(CustomerSizePM entityPM, POCO.CustomerSize entityPOCO, bool isNewEntity)
        {
