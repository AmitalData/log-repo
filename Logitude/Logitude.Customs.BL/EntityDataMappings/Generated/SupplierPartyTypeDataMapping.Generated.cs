...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SupplierPartyTypeDataMapping: IMapping<SupplierPartyTypePM, SupplierPartyType>,IMappingEncodeBase64NVARCHARFields<SupplierPartyTypePM>
   {
	    ...
	    public void PMToPOCO(SupplierPartyTypePM entityPM, SupplierPartyType entityPOCO)
        {
		...
		public void POCOToPM(SupplierPartyTypePM entityPM, SupplierPartyType entityPOCO)
        {
		...
		public void PMToOldPM(SupplierPartyTypePM entityPM, SupplierPartyTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SupplierPartyTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SupplierPartyTypePM entityPM, SupplierPartyType entityPOCO, bool isNewEntity)
        {
