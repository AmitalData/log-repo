...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class NotificationDefinitionDataMapping: IMapping<NotificationDefinitionPM, NotificationDefinition>,IMappingEncodeBase64NVARCHARFields<NotificationDefinitionPM>
   {
	    ...
	    public void PMToPOCO(NotificationDefinitionPM entityPM, NotificationDefinition entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.AssigneeNotificationTypeCode))
            {
				entityPOCO.AssigneeNotificationTypeCode = entityPM.AssigneeNotificationTypeCode;
			}
		...
		public void POCOToPM(NotificationDefinitionPM entityPM, NotificationDefinition entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.AssigneeNotificationTypeCode))
            {
					entityPM.AssigneeNotificationTypeCode = entityPOCO.AssigneeNotificationTypeCode;
            }
		...
		public void PMToOldPM(NotificationDefinitionPM entityPM, NotificationDefinitionPM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.AssigneeNotificationTypeCode))
            {
                oldEntityPM.AssigneeNotificationTypeCode = entityPM.AssigneeNotificationTypeCode;
            }
	    ...
	    public void EncodeBase64NVARCHARFields(NotificationDefinitionPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(NotificationDefinitionPM entityPM, NotificationDefinition entityPOCO, bool isNewEntity)
        {
