...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CheckTypeLookupDataMapping: IMapping<CheckTypeLookupPM, CheckTypeLookup>,IMappingEncodeBase64NVARCHARFields<CheckTypeLookupPM>
   {
	    ...
	    public void PMToPOCO(CheckTypeLookupPM entityPM, CheckTypeLookup entityPOCO)
        {
		...
		public void POCOToPM(CheckTypeLookupPM entityPM, CheckTypeLookup entityPOCO)
        {
		...
		public void PMToOldPM(CheckTypeLookupPM entityPM, CheckTypeLookupPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CheckTypeLookupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CheckTypeLookupPM entityPM, CheckTypeLookup entityPOCO, bool isNewEntity)
        {
