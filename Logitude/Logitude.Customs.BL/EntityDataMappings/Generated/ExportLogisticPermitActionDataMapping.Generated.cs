...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ExportLogisticPermitActionDataMapping: IMapping<ExportLogisticPermitActionPM, ExportLogisticPermitAction>,IMappingEncodeBase64NVARCHARFields<ExportLogisticPermitActionPM>
   {
	    ...
	    public void PMToPOCO(ExportLogisticPermitActionPM entityPM, ExportLogisticPermitAction entityPOCO)
        {
		...
		public void POCOToPM(ExportLogisticPermitActionPM entityPM, ExportLogisticPermitAction entityPOCO)
        {
		...
		public void PMToOldPM(ExportLogisticPermitActionPM entityPM, ExportLogisticPermitActionPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ExportLogisticPermitActionPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ExportLogisticPermitActionPM entityPM, ExportLogisticPermitAction entityPOCO, bool isNewEntity)
        {
