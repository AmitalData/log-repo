...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProceduralFaultInSourceTypeDataMapping: IMapping<ProceduralFaultInSourceTypePM, ProceduralFaultInSourceType>,IMappingEncodeBase64NVARCHARFields<ProceduralFaultInSourceTypePM>
   {
	    ...
	    public void PMToPOCO(ProceduralFaultInSourceTypePM entityPM, ProceduralFaultInSourceType entityPOCO)
        {
		...
		public void POCOToPM(ProceduralFaultInSourceTypePM entityPM, ProceduralFaultInSourceType entityPOCO)
        {
		...
		public void PMToOldPM(ProceduralFaultInSourceTypePM entityPM, ProceduralFaultInSourceTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ProceduralFaultInSourceTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ProceduralFaultInSourceTypePM entityPM, ProceduralFaultInSourceType entityPOCO, bool isNewEntity)
        {
