...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsEnvoirmentTypeDataMapping: IMapping<CustomsEnvoirmentTypePM, CustomsEnvoirmentType>,IMappingEncodeBase64NVARCHARFields<CustomsEnvoirmentTypePM>
   {
	    ...
	    public void PMToPOCO(CustomsEnvoirmentTypePM entityPM, CustomsEnvoirmentType entityPOCO)
        {
		...
		public void POCOToPM(CustomsEnvoirmentTypePM entityPM, CustomsEnvoirmentType entityPOCO)
        {
		...
		public void PMToOldPM(CustomsEnvoirmentTypePM entityPM, CustomsEnvoirmentTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsEnvoirmentTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsEnvoirmentTypePM entityPM, CustomsEnvoirmentType entityPOCO, bool isNewEntity)
        {
