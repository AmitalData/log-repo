...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DocumentRejectTypeDataMapping: IMapping<DocumentRejectTypePM, DocumentRejectType>,IMappingEncodeBase64NVARCHARFields<DocumentRejectTypePM>
   {
	    ...
	    public void PMToPOCO(DocumentRejectTypePM entityPM, DocumentRejectType entityPOCO)
        {
		...
		public void POCOToPM(DocumentRejectTypePM entityPM, DocumentRejectType entityPOCO)
        {
		...
		public void PMToOldPM(DocumentRejectTypePM entityPM, DocumentRejectTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DocumentRejectTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DocumentRejectTypePM entityPM, DocumentRejectType entityPOCO, bool isNewEntity)
        {
