...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PayerActivityTypeDataMapping: IMapping<PayerActivityTypePM, PayerActivityType>,IMappingEncodeBase64NVARCHARFields<PayerActivityTypePM>
   {
	    ...
	    public void PMToPOCO(PayerActivityTypePM entityPM, PayerActivityType entityPOCO)
        {
		...
		public void POCOToPM(PayerActivityTypePM entityPM, PayerActivityType entityPOCO)
        {
		...
		public void PMToOldPM(PayerActivityTypePM entityPM, PayerActivityTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PayerActivityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PayerActivityTypePM entityPM, PayerActivityType entityPOCO, bool isNewEntity)
        {
