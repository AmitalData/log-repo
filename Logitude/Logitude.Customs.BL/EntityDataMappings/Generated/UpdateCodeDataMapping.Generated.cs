...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class UpdateCodeDataMapping: IMapping<UpdateCodePM, UpdateCode>,IMappingEncodeBase64NVARCHARFields<UpdateCodePM>
   {
	    ...
	    public void PMToPOCO(UpdateCodePM entityPM, UpdateCode entityPOCO)
        {
		...
		public void POCOToPM(UpdateCodePM entityPM, UpdateCode entityPOCO)
        {
		...
		public void PMToOldPM(UpdateCodePM entityPM, UpdateCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(UpdateCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(UpdateCodePM entityPM, UpdateCode entityPOCO, bool isNewEntity)
        {
