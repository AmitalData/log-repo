...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class NotificationTypeDataMapping: IMapping<NotificationTypePM, NotificationType>,IMappingEncodeBase64NVARCHARFields<NotificationTypePM>
   {
	    ...
	    public void PMToPOCO(NotificationTypePM entityPM, NotificationType entityPOCO)
        {
		...
		public void POCOToPM(NotificationTypePM entityPM, NotificationType entityPOCO)
        {
		...
		public void PMToOldPM(NotificationTypePM entityPM, NotificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(NotificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(NotificationTypePM entityPM, NotificationType entityPOCO, bool isNewEntity)
        {
