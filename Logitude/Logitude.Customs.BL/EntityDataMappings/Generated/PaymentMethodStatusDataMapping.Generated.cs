...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentMethodStatusDataMapping: IMapping<PaymentMethodStatusPM, PaymentMethodStatus>,IMappingEncodeBase64NVARCHARFields<PaymentMethodStatusPM>
   {
	    ...
	    public void PMToPOCO(PaymentMethodStatusPM entityPM, PaymentMethodStatus entityPOCO)
        {
		...
		public void POCOToPM(PaymentMethodStatusPM entityPM, PaymentMethodStatus entityPOCO)
        {
		...
		public void PMToOldPM(PaymentMethodStatusPM entityPM, PaymentMethodStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentMethodStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentMethodStatusPM entityPM, PaymentMethodStatus entityPOCO, bool isNewEntity)
        {
