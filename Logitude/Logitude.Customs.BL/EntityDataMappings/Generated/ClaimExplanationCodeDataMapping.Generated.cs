...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ClaimExplanationCodeDataMapping: IMapping<ClaimExplanationCodePM, ClaimExplanationCode>,IMappingEncodeBase64NVARCHARFields<ClaimExplanationCodePM>
   {
	    ...
	    public void PMToPOCO(ClaimExplanationCodePM entityPM, ClaimExplanationCode entityPOCO)
        {
		...
		public void POCOToPM(ClaimExplanationCodePM entityPM, ClaimExplanationCode entityPOCO)
        {
		...
		public void PMToOldPM(ClaimExplanationCodePM entityPM, ClaimExplanationCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ClaimExplanationCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ClaimExplanationCodePM entityPM, ClaimExplanationCode entityPOCO, bool isNewEntity)
        {
