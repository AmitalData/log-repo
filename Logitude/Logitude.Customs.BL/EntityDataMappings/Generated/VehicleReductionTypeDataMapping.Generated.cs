...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleReductionTypeDataMapping: IMapping<VehicleReductionTypePM, VehicleReductionType>,IMappingEncodeBase64NVARCHARFields<VehicleReductionTypePM>
   {
	    ...
	    public void PMToPOCO(VehicleReductionTypePM entityPM, VehicleReductionType entityPOCO)
        {
		...
		public void POCOToPM(VehicleReductionTypePM entityPM, VehicleReductionType entityPOCO)
        {
		...
		public void PMToOldPM(VehicleReductionTypePM entityPM, VehicleReductionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleReductionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleReductionTypePM entityPM, VehicleReductionType entityPOCO, bool isNewEntity)
        {
