...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class MamanStatusDataMapping: IMapping<MamanStatusPM, MamanStatus>,IMappingEncodeBase64NVARCHARFields<MamanStatusPM>
   {
	    ...
	    public void PMToPOCO(MamanStatusPM entityPM, MamanStatus entityPOCO)
        {
		...
		public void POCOToPM(MamanStatusPM entityPM, MamanStatus entityPOCO)
        {
		...
		public void PMToOldPM(MamanStatusPM entityPM, MamanStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MamanStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MamanStatusPM entityPM, MamanStatus entityPOCO, bool isNewEntity)
        {
