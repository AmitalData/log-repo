...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleSafeAccessoryInstlTypeDataMapping: IMapping<VehicleSafeAccessoryInstlTypePM, VehicleSafeAccessoryInstlType>,IMappingEncodeBase64NVARCHARFields<VehicleSafeAccessoryInstlTypePM>
   {
	    ...
	    public void PMToPOCO(VehicleSafeAccessoryInstlTypePM entityPM, VehicleSafeAccessoryInstlType entityPOCO)
        {
		...
		public void POCOToPM(VehicleSafeAccessoryInstlTypePM entityPM, VehicleSafeAccessoryInstlType entityPOCO)
        {
		...
		public void PMToOldPM(VehicleSafeAccessoryInstlTypePM entityPM, VehicleSafeAccessoryInstlTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleSafeAccessoryInstlTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleSafeAccessoryInstlTypePM entityPM, VehicleSafeAccessoryInstlType entityPOCO, bool isNewEntity)
        {
