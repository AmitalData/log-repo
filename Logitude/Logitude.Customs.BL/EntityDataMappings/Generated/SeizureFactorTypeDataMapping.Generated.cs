...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SeizureFactorTypeDataMapping: IMapping<SeizureFactorTypePM, SeizureFactorType>,IMappingEncodeBase64NVARCHARFields<SeizureFactorTypePM>
   {
	    ...
	    public void PMToPOCO(SeizureFactorTypePM entityPM, SeizureFactorType entityPOCO)
        {
		...
		public void POCOToPM(SeizureFactorTypePM entityPM, SeizureFactorType entityPOCO)
        {
		...
		public void PMToOldPM(SeizureFactorTypePM entityPM, SeizureFactorTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SeizureFactorTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SeizureFactorTypePM entityPM, SeizureFactorType entityPOCO, bool isNewEntity)
        {
