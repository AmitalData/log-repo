...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PackageMeasureQualifierDataMapping: IMapping<PackageMeasureQualifierPM, PackageMeasureQualifier>,IMappingEncodeBase64NVARCHARFields<PackageMeasureQualifierPM>
   {
	    ...
	    public void PMToPOCO(PackageMeasureQualifierPM entityPM, PackageMeasureQualifier entityPOCO)
        {
		...
		public void POCOToPM(PackageMeasureQualifierPM entityPM, PackageMeasureQualifier entityPOCO)
        {
		...
		public void PMToOldPM(PackageMeasureQualifierPM entityPM, PackageMeasureQualifierPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PackageMeasureQualifierPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PackageMeasureQualifierPM entityPM, PackageMeasureQualifier entityPOCO, bool isNewEntity)
        {
