...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CourierManifestStatusDataMapping: IMapping<CourierManifestStatusPM, CourierManifestStatus>,IMappingEncodeBase64NVARCHARFields<CourierManifestStatusPM>
   {
	    ...
	    public void PMToPOCO(CourierManifestStatusPM entityPM, CourierManifestStatus entityPOCO)
        {
		...
		public void POCOToPM(CourierManifestStatusPM entityPM, CourierManifestStatus entityPOCO)
        {
		...
		public void PMToOldPM(CourierManifestStatusPM entityPM, CourierManifestStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CourierManifestStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CourierManifestStatusPM entityPM, CourierManifestStatus entityPOCO, bool isNewEntity)
        {
