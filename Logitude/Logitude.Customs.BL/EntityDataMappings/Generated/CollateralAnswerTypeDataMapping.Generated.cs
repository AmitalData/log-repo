...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CollateralAnswerTypeDataMapping: IMapping<CollateralAnswerTypePM, CollateralAnswerType>,IMappingEncodeBase64NVARCHARFields<CollateralAnswerTypePM>
   {
	    ...
	    public void PMToPOCO(CollateralAnswerTypePM entityPM, CollateralAnswerType entityPOCO)
        {
		...
		public void POCOToPM(CollateralAnswerTypePM entityPM, CollateralAnswerType entityPOCO)
        {
		...
		public void PMToOldPM(CollateralAnswerTypePM entityPM, CollateralAnswerTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CollateralAnswerTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CollateralAnswerTypePM entityPM, CollateralAnswerType entityPOCO, bool isNewEntity)
        {
