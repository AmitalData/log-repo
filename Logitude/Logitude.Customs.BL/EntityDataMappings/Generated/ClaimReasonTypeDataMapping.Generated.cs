...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ClaimReasonTypeDataMapping: IMapping<ClaimReasonTypePM, ClaimReasonType>,IMappingEncodeBase64NVARCHARFields<ClaimReasonTypePM>
   {
	    ...
	    public void PMToPOCO(ClaimReasonTypePM entityPM, ClaimReasonType entityPOCO)
        {
		...
		public void POCOToPM(ClaimReasonTypePM entityPM, ClaimReasonType entityPOCO)
        {
		...
		public void PMToOldPM(ClaimReasonTypePM entityPM, ClaimReasonTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ClaimReasonTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ClaimReasonTypePM entityPM, ClaimReasonType entityPOCO, bool isNewEntity)
        {
