...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DecisionTypeDataMapping: IMapping<DecisionTypePM, DecisionType>,IMappingEncodeBase64NVARCHARFields<DecisionTypePM>
   {
	    ...
	    public void PMToPOCO(DecisionTypePM entityPM, DecisionType entityPOCO)
        {
		...
		public void POCOToPM(DecisionTypePM entityPM, DecisionType entityPOCO)
        {
		...
		public void PMToOldPM(DecisionTypePM entityPM, DecisionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DecisionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DecisionTypePM entityPM, DecisionType entityPOCO, bool isNewEntity)
        {
