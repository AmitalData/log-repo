...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CheckEssenceLookupDataMapping: IMapping<CheckEssenceLookupPM, CheckEssenceLookup>,IMappingEncodeBase64NVARCHARFields<CheckEssenceLookupPM>
   {
	    ...
	    public void PMToPOCO(CheckEssenceLookupPM entityPM, CheckEssenceLookup entityPOCO)
        {
		...
		public void POCOToPM(CheckEssenceLookupPM entityPM, CheckEssenceLookup entityPOCO)
        {
		...
		public void PMToOldPM(CheckEssenceLookupPM entityPM, CheckEssenceLookupPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CheckEssenceLookupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CheckEssenceLookupPM entityPM, CheckEssenceLookup entityPOCO, bool isNewEntity)
        {
