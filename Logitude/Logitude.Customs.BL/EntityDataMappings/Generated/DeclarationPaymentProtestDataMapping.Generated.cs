...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DeclarationPaymentProtestDataMapping: IMapping<DeclarationPaymentProtestPM, DeclarationPaymentProtest>,IMappingEncodeBase64NVARCHARFields<DeclarationPaymentProtestPM>
   {
	    ...
	    public void PMToPOCO(DeclarationPaymentProtestPM entityPM, DeclarationPaymentProtest entityPOCO)
        {
		...
		public void POCOToPM(DeclarationPaymentProtestPM entityPM, DeclarationPaymentProtest entityPOCO)
        {
		...
		public void PMToOldPM(DeclarationPaymentProtestPM entityPM, DeclarationPaymentProtestPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DeclarationPaymentProtestPM entityPM)
        {
