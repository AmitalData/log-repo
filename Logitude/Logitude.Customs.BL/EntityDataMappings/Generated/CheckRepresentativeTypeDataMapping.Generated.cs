...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CheckRepresentativeTypeDataMapping: IMapping<CheckRepresentativeTypePM, CheckRepresentativeType>,IMappingEncodeBase64NVARCHARFields<CheckRepresentativeTypePM>
   {
	    ...
	    public void PMToPOCO(CheckRepresentativeTypePM entityPM, CheckRepresentativeType entityPOCO)
        {
		...
		public void POCOToPM(CheckRepresentativeTypePM entityPM, CheckRepresentativeType entityPOCO)
        {
		...
		public void PMToOldPM(CheckRepresentativeTypePM entityPM, CheckRepresentativeTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CheckRepresentativeTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CheckRepresentativeTypePM entityPM, CheckRepresentativeType entityPOCO, bool isNewEntity)
        {
