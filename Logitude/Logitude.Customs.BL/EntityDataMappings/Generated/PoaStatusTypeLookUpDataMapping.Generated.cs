...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PoaStatusTypeLookUpDataMapping: IMapping<PoaStatusTypeLookUpPM, PoaStatusTypeLookUp>,IMappingEncodeBase64NVARCHARFields<PoaStatusTypeLookUpPM>
   {
	    ...
	    public void PMToPOCO(PoaStatusTypeLookUpPM entityPM, PoaStatusTypeLookUp entityPOCO)
        {
		...
		public void POCOToPM(PoaStatusTypeLookUpPM entityPM, PoaStatusTypeLookUp entityPOCO)
        {
		...
		public void PMToOldPM(PoaStatusTypeLookUpPM entityPM, PoaStatusTypeLookUpPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PoaStatusTypeLookUpPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PoaStatusTypeLookUpPM entityPM, PoaStatusTypeLookUp entityPOCO, bool isNewEntity)
        {
