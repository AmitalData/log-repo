...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsTransportModeDataMapping: IMapping<CustomsTransportModePM, CustomsTransportMode>,IMappingEncodeBase64NVARCHARFields<CustomsTransportModePM>
   {
	    ...
	    public void PMToPOCO(CustomsTransportModePM entityPM, CustomsTransportMode entityPOCO)
        {
		...
		public void POCOToPM(CustomsTransportModePM entityPM, CustomsTransportMode entityPOCO)
        {
		...
		public void PMToOldPM(CustomsTransportModePM entityPM, CustomsTransportModePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsTransportModePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsTransportModePM entityPM, CustomsTransportMode entityPOCO, bool isNewEntity)
        {
