...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class MAWBTypeDataMapping: IMapping<MAWBTypePM, MAWBType>,IMappingEncodeBase64NVARCHARFields<MAWBTypePM>
   {
	    ...
	    public void PMToPOCO(MAWBTypePM entityPM, MAWBType entityPOCO)
        {
		...
		public void POCOToPM(MAWBTypePM entityPM, MAWBType entityPOCO)
        {
		...
		public void PMToOldPM(MAWBTypePM entityPM, MAWBTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MAWBTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MAWBTypePM entityPM, MAWBType entityPOCO, bool isNewEntity)
        {
