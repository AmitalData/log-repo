...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AgentTalkBackTypeDataMapping: IMapping<AgentTalkBackTypePM, AgentTalkBackType>,IMappingEncodeBase64NVARCHARFields<AgentTalkBackTypePM>
   {
	    ...
	    public void PMToPOCO(AgentTalkBackTypePM entityPM, AgentTalkBackType entityPOCO)
        {
		...
		public void POCOToPM(AgentTalkBackTypePM entityPM, AgentTalkBackType entityPOCO)
        {
		...
		public void PMToOldPM(AgentTalkBackTypePM entityPM, AgentTalkBackTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AgentTalkBackTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AgentTalkBackTypePM entityPM, AgentTalkBackType entityPOCO, bool isNewEntity)
        {
