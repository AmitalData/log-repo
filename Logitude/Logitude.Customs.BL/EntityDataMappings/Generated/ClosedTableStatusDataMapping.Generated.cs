...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ClosedTableStatusDataMapping: IMapping<ClosedTableStatusPM, ClosedTableStatus>,IMappingEncodeBase64NVARCHARFields<ClosedTableStatusPM>
   {
	    ...
	    public void PMToPOCO(ClosedTableStatusPM entityPM, ClosedTableStatus entityPOCO)
        {
		...
		public void POCOToPM(ClosedTableStatusPM entityPM, ClosedTableStatus entityPOCO)
        {
		...
		public void PMToOldPM(ClosedTableStatusPM entityPM, ClosedTableStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ClosedTableStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ClosedTableStatusPM entityPM, ClosedTableStatus entityPOCO, bool isNewEntity)
        {
