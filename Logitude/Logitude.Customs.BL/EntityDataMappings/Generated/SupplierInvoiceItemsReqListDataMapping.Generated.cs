...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SupplierInvoiceItemsReqListDataMapping: IMapping<SupplierInvoiceItemsReqListPM, SupplierInvoiceItemsReqList>,IMappingEncodeBase64NVARCHARFields<SupplierInvoiceItemsReqListPM>
   {
	    ...
	    public void PMToPOCO(SupplierInvoiceItemsReqListPM entityPM, SupplierInvoiceItemsReqList entityPOCO)
        {
		...
		public void POCOToPM(SupplierInvoiceItemsReqListPM entityPM, SupplierInvoiceItemsReqList entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(SupplierInvoiceItemsReqListPM entityPM, SupplierInvoiceItemsReqList entityPOCO, bool isNewEntity)
        {
