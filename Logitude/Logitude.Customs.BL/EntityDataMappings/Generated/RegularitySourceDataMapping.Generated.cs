...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RegularitySourceDataMapping: IMapping<RegularitySourcePM, RegularitySource>,IMappingEncodeBase64NVARCHARFields<RegularitySourcePM>
   {
	    ...
	    public void PMToPOCO(RegularitySourcePM entityPM, RegularitySource entityPOCO)
        {
		...
		public void POCOToPM(RegularitySourcePM entityPM, RegularitySource entityPOCO)
        {
		...
		public void PMToOldPM(RegularitySourcePM entityPM, RegularitySourcePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RegularitySourcePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RegularitySourcePM entityPM, RegularitySource entityPOCO, bool isNewEntity)
        {
