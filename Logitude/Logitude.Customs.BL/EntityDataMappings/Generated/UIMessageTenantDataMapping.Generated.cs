...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class UIMessageTenantDataMapping: IMapping<UIMessageTenantPM, UIMessageTenant>,IMappingEncodeBase64NVARCHARFields<UIMessageTenantPM>
   {
	    ...
	    public void PMToPOCO(UIMessageTenantPM entityPM, UIMessageTenant entityPOCO)
        {
		...
		public void POCOToPM(UIMessageTenantPM entityPM, UIMessageTenant entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(UIMessageTenantPM entityPM, UIMessageTenant entityPOCO, bool isNewEntity)
        {
