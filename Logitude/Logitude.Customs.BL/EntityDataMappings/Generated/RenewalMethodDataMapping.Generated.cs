...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RenewalMethodDataMapping: IMapping<RenewalMethodPM, RenewalMethod>,IMappingEncodeBase64NVARCHARFields<RenewalMethodPM>
   {
	    ...
	    public void PMToPOCO(RenewalMethodPM entityPM, RenewalMethod entityPOCO)
        {
		...
		public void POCOToPM(RenewalMethodPM entityPM, RenewalMethod entityPOCO)
        {
		...
		public void PMToOldPM(RenewalMethodPM entityPM, RenewalMethodPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RenewalMethodPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RenewalMethodPM entityPM, RenewalMethod entityPOCO, bool isNewEntity)
        {
