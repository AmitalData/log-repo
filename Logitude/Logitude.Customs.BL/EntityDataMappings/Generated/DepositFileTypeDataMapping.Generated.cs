...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DepositFileTypeDataMapping: IMapping<DepositFileTypePM, DepositFileType>,IMappingEncodeBase64NVARCHARFields<DepositFileTypePM>
   {
	    ...
	    public void PMToPOCO(DepositFileTypePM entityPM, DepositFileType entityPOCO)
        {
		...
		public void POCOToPM(DepositFileTypePM entityPM, DepositFileType entityPOCO)
        {
		...
		public void PMToOldPM(DepositFileTypePM entityPM, DepositFileTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DepositFileTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DepositFileTypePM entityPM, DepositFileType entityPOCO, bool isNewEntity)
        {
