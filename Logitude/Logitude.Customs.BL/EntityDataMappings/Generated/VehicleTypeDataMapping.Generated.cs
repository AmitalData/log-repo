...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleTypeDataMapping: IMapping<VehicleTypePM, VehicleType>,IMappingEncodeBase64NVARCHARFields<VehicleTypePM>
   {
	    ...
	    public void PMToPOCO(VehicleTypePM entityPM, VehicleType entityPOCO)
        {
		...
		public void POCOToPM(VehicleTypePM entityPM, VehicleType entityPOCO)
        {
		...
		public void PMToOldPM(VehicleTypePM entityPM, VehicleTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleTypePM entityPM, VehicleType entityPOCO, bool isNewEntity)
        {
