...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TreatmentWayDataMapping: IMapping<TreatmentWayPM, TreatmentWay>,IMappingEncodeBase64NVARCHARFields<TreatmentWayPM>
   {
	    ...
	    public void PMToPOCO(TreatmentWayPM entityPM, TreatmentWay entityPOCO)
        {
		...
		public void POCOToPM(TreatmentWayPM entityPM, TreatmentWay entityPOCO)
        {
		...
		public void PMToOldPM(TreatmentWayPM entityPM, TreatmentWayPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TreatmentWayPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TreatmentWayPM entityPM, TreatmentWay entityPOCO, bool isNewEntity)
        {
