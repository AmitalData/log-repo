...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsItemGroupDataMapping: IMapping<CustomsItemGroupPM, CustomsItemGroup>,IMappingEncodeBase64NVARCHARFields<CustomsItemGroupPM>
   {
	    ...
	    public void PMToPOCO(CustomsItemGroupPM entityPM, CustomsItemGroup entityPOCO)
        {
		...
		public void POCOToPM(CustomsItemGroupPM entityPM, CustomsItemGroup entityPOCO)
        {
		...
		public void PMToOldPM(CustomsItemGroupPM entityPM, CustomsItemGroupPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsItemGroupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsItemGroupPM entityPM, CustomsItemGroup entityPOCO, bool isNewEntity)
        {
