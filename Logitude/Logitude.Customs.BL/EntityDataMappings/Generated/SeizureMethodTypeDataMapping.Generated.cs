...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SeizureMethodTypeDataMapping: IMapping<SeizureMethodTypePM, SeizureMethodType>,IMappingEncodeBase64NVARCHARFields<SeizureMethodTypePM>
   {
	    ...
	    public void PMToPOCO(SeizureMethodTypePM entityPM, SeizureMethodType entityPOCO)
        {
		...
		public void POCOToPM(SeizureMethodTypePM entityPM, SeizureMethodType entityPOCO)
        {
		...
		public void PMToOldPM(SeizureMethodTypePM entityPM, SeizureMethodTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SeizureMethodTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SeizureMethodTypePM entityPM, SeizureMethodType entityPOCO, bool isNewEntity)
        {
