...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InterConditionsRelationshipDataMapping: IMapping<InterConditionsRelationshipPM, InterConditionsRelationship>,IMappingEncodeBase64NVARCHARFields<InterConditionsRelationshipPM>
   {
	    ...
	    public void PMToPOCO(InterConditionsRelationshipPM entityPM, InterConditionsRelationship entityPOCO)
        {
		...
		public void POCOToPM(InterConditionsRelationshipPM entityPM, InterConditionsRelationship entityPOCO)
        {
		...
		public void PMToOldPM(InterConditionsRelationshipPM entityPM, InterConditionsRelationshipPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InterConditionsRelationshipPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InterConditionsRelationshipPM entityPM, InterConditionsRelationship entityPOCO, bool isNewEntity)
        {
