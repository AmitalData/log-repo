...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ReturnConditionDataMapping: IMapping<ReturnConditionPM, ReturnCondition>,IMappingEncodeBase64NVARCHARFields<ReturnConditionPM>
   {
	    ...
	    public void PMToPOCO(ReturnConditionPM entityPM, ReturnCondition entityPOCO)
        {
		...
		public void POCOToPM(ReturnConditionPM entityPM, ReturnCondition entityPOCO)
        {
		...
		public void PMToOldPM(ReturnConditionPM entityPM, ReturnConditionPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ReturnConditionPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ReturnConditionPM entityPM, ReturnCondition entityPOCO, bool isNewEntity)
        {
