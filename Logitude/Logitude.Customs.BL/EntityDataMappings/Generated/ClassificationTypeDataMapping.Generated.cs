...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ClassificationTypeDataMapping: IMapping<ClassificationTypePM, ClassificationType>,IMappingEncodeBase64NVARCHARFields<ClassificationTypePM>
   {
	    ...
	    public void PMToPOCO(ClassificationTypePM entityPM, ClassificationType entityPOCO)
        {
		...
		public void POCOToPM(ClassificationTypePM entityPM, ClassificationType entityPOCO)
        {
		...
		public void PMToOldPM(ClassificationTypePM entityPM, ClassificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ClassificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ClassificationTypePM entityPM, ClassificationType entityPOCO, bool isNewEntity)
        {
