...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DepositEssenceTypeDataMapping: IMapping<DepositEssenceTypePM, DepositEssenceType>,IMappingEncodeBase64NVARCHARFields<DepositEssenceTypePM>
   {
	    ...
	    public void PMToPOCO(DepositEssenceTypePM entityPM, DepositEssenceType entityPOCO)
        {
		...
		public void POCOToPM(DepositEssenceTypePM entityPM, DepositEssenceType entityPOCO)
        {
		...
		public void PMToOldPM(DepositEssenceTypePM entityPM, DepositEssenceTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DepositEssenceTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DepositEssenceTypePM entityPM, DepositEssenceType entityPOCO, bool isNewEntity)
        {
