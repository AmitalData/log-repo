...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentOrderStatusDataMapping: IMapping<PaymentOrderStatusPM, PaymentOrderStatus>,IMappingEncodeBase64NVARCHARFields<PaymentOrderStatusPM>
   {
	    ...
	    public void PMToPOCO(PaymentOrderStatusPM entityPM, PaymentOrderStatus entityPOCO)
        {
		...
		public void POCOToPM(PaymentOrderStatusPM entityPM, PaymentOrderStatus entityPOCO)
        {
		...
		public void PMToOldPM(PaymentOrderStatusPM entityPM, PaymentOrderStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentOrderStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentOrderStatusPM entityPM, PaymentOrderStatus entityPOCO, bool isNewEntity)
        {
