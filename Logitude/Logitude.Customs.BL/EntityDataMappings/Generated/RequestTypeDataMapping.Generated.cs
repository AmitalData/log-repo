...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RequestTypeDataMapping: IMapping<RequestTypePM, RequestType>,IMappingEncodeBase64NVARCHARFields<RequestTypePM>
   {
	    ...
	    public void PMToPOCO(RequestTypePM entityPM, RequestType entityPOCO)
        {
		...
		public void POCOToPM(RequestTypePM entityPM, RequestType entityPOCO)
        {
		...
		public void PMToOldPM(RequestTypePM entityPM, RequestTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RequestTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RequestTypePM entityPM, RequestType entityPOCO, bool isNewEntity)
        {
