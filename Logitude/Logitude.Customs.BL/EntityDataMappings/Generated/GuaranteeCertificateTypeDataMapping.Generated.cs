...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class GuaranteeCertificateTypeDataMapping: IMapping<GuaranteeCertificateTypePM, GuaranteeCertificateType>,IMappingEncodeBase64NVARCHARFields<GuaranteeCertificateTypePM>
   {
	    ...
	    public void PMToPOCO(GuaranteeCertificateTypePM entityPM, GuaranteeCertificateType entityPOCO)
        {
		...
		public void POCOToPM(GuaranteeCertificateTypePM entityPM, GuaranteeCertificateType entityPOCO)
        {
		...
		public void PMToOldPM(GuaranteeCertificateTypePM entityPM, GuaranteeCertificateTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(GuaranteeCertificateTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(GuaranteeCertificateTypePM entityPM, GuaranteeCertificateType entityPOCO, bool isNewEntity)
        {
