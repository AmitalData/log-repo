...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class FullnessCodeDataMapping: IMapping<FullnessCodePM, FullnessCode>,IMappingEncodeBase64NVARCHARFields<FullnessCodePM>
   {
	    ...
	    public void PMToPOCO(FullnessCodePM entityPM, FullnessCode entityPOCO)
        {
		...
		public void POCOToPM(FullnessCodePM entityPM, FullnessCode entityPOCO)
        {
		...
		public void PMToOldPM(FullnessCodePM entityPM, FullnessCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(FullnessCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(FullnessCodePM entityPM, FullnessCode entityPOCO, bool isNewEntity)
        {
