...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProceduralFaultInProcessTypeDataMapping: IMapping<ProceduralFaultInProcessTypePM, ProceduralFaultInProcessType>,IMappingEncodeBase64NVARCHARFields<ProceduralFaultInProcessTypePM>
   {
	    ...
	    public void PMToPOCO(ProceduralFaultInProcessTypePM entityPM, ProceduralFaultInProcessType entityPOCO)
        {
		...
		public void POCOToPM(ProceduralFaultInProcessTypePM entityPM, ProceduralFaultInProcessType entityPOCO)
        {
		...
		public void PMToOldPM(ProceduralFaultInProcessTypePM entityPM, ProceduralFaultInProcessTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ProceduralFaultInProcessTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ProceduralFaultInProcessTypePM entityPM, ProceduralFaultInProcessType entityPOCO, bool isNewEntity)
        {
