...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AmendmentRequestStatusDataMapping: IMapping<AmendmentRequestStatusPM, AmendmentRequestStatus>,IMappingEncodeBase64NVARCHARFields<AmendmentRequestStatusPM>
   {
	    ...
	    public void PMToPOCO(AmendmentRequestStatusPM entityPM, AmendmentRequestStatus entityPOCO)
        {
		...
		public void POCOToPM(AmendmentRequestStatusPM entityPM, AmendmentRequestStatus entityPOCO)
        {
		...
		public void PMToOldPM(AmendmentRequestStatusPM entityPM, AmendmentRequestStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AmendmentRequestStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AmendmentRequestStatusPM entityPM, AmendmentRequestStatus entityPOCO, bool isNewEntity)
        {
