...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ContainerTypeDataMapping: IMapping<ContainerTypePM, ContainerType>,IMappingEncodeBase64NVARCHARFields<ContainerTypePM>
   {
	    ...
	    public void PMToPOCO(ContainerTypePM entityPM, ContainerType entityPOCO)
        {
		...
		public void POCOToPM(ContainerTypePM entityPM, ContainerType entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ContainerTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ContainerTypePM entityPM, ContainerType entityPOCO, bool isNewEntity)
        {
