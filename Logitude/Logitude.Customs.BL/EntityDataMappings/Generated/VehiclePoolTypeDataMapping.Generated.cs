...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehiclePoolTypeDataMapping: IMapping<VehiclePoolTypePM, VehiclePoolType>,IMappingEncodeBase64NVARCHARFields<VehiclePoolTypePM>
   {
	    ...
	    public void PMToPOCO(VehiclePoolTypePM entityPM, VehiclePoolType entityPOCO)
        {
		...
		public void POCOToPM(VehiclePoolTypePM entityPM, VehiclePoolType entityPOCO)
        {
		...
		public void PMToOldPM(VehiclePoolTypePM entityPM, VehiclePoolTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehiclePoolTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehiclePoolTypePM entityPM, VehiclePoolType entityPOCO, bool isNewEntity)
        {
