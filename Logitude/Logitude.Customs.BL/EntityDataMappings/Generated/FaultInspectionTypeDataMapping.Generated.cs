...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class FaultInspectionTypeDataMapping: IMapping<FaultInspectionTypePM, FaultInspectionType>,IMappingEncodeBase64NVARCHARFields<FaultInspectionTypePM>
   {
	    ...
	    public void PMToPOCO(FaultInspectionTypePM entityPM, FaultInspectionType entityPOCO)
        {
		...
		public void POCOToPM(FaultInspectionTypePM entityPM, FaultInspectionType entityPOCO)
        {
		...
		public void PMToOldPM(FaultInspectionTypePM entityPM, FaultInspectionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(FaultInspectionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(FaultInspectionTypePM entityPM, FaultInspectionType entityPOCO, bool isNewEntity)
        {
