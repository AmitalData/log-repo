...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class MeasurmentUnitDataMapping: IMapping<MeasurmentUnitPM, MeasurmentUnit>,IMappingEncodeBase64NVARCHARFields<MeasurmentUnitPM>
   {
	    ...
	    public void PMToPOCO(MeasurmentUnitPM entityPM, MeasurmentUnit entityPOCO)
        {
		...
		public void POCOToPM(MeasurmentUnitPM entityPM, MeasurmentUnit entityPOCO)
        {
		...
		public void PMToOldPM(MeasurmentUnitPM entityPM, MeasurmentUnitPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MeasurmentUnitPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MeasurmentUnitPM entityPM, MeasurmentUnit entityPOCO, bool isNewEntity)
        {
