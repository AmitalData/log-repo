...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsDocumentUploadDataMapping: IMapping<CustomsDocumentUploadPM, CustomsDocumentUpload>,IMappingEncodeBase64NVARCHARFields<CustomsDocumentUploadPM>
   {
	    ...
	    public void PMToPOCO(CustomsDocumentUploadPM entityPM, CustomsDocumentUpload entityPOCO)
        {
		...
		public void POCOToPM(CustomsDocumentUploadPM entityPM, CustomsDocumentUpload entityPOCO)
        {
		...
		public void PMToOldPM(CustomsDocumentUploadPM entityPM, CustomsDocumentUploadPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsDocumentUploadPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsDocumentUploadPM entityPM, CustomsDocumentUpload entityPOCO, bool isNewEntity)
        {
