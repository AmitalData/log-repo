...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AmountTypeDataMapping: IMapping<AmountTypePM, AmountType>,IMappingEncodeBase64NVARCHARFields<AmountTypePM>
   {
	    ...
	    public void PMToPOCO(AmountTypePM entityPM, AmountType entityPOCO)
        {
		...
		public void POCOToPM(AmountTypePM entityPM, AmountType entityPOCO)
        {
		...
		public void PMToOldPM(AmountTypePM entityPM, AmountTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AmountTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AmountTypePM entityPM, AmountType entityPOCO, bool isNewEntity)
        {
