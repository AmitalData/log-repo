...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RequestHandlingAuthorityDataMapping: IMapping<RequestHandlingAuthorityPM, RequestHandlingAuthority>,IMappingEncodeBase64NVARCHARFields<RequestHandlingAuthorityPM>
   {
	    ...
	    public void PMToPOCO(RequestHandlingAuthorityPM entityPM, RequestHandlingAuthority entityPOCO)
        {
		...
		public void POCOToPM(RequestHandlingAuthorityPM entityPM, RequestHandlingAuthority entityPOCO)
        {
		...
		public void PMToOldPM(RequestHandlingAuthorityPM entityPM, RequestHandlingAuthorityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RequestHandlingAuthorityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RequestHandlingAuthorityPM entityPM, RequestHandlingAuthority entityPOCO, bool isNewEntity)
        {
