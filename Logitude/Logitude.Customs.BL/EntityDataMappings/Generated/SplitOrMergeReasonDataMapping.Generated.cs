...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SplitOrMergeReasonDataMapping: IMapping<SplitOrMergeReasonPM, SplitOrMergeReason>,IMappingEncodeBase64NVARCHARFields<SplitOrMergeReasonPM>
   {
	    ...
	    public void PMToPOCO(SplitOrMergeReasonPM entityPM, SplitOrMergeReason entityPOCO)
        {
		...
		public void POCOToPM(SplitOrMergeReasonPM entityPM, SplitOrMergeReason entityPOCO)
        {
		...
		public void PMToOldPM(SplitOrMergeReasonPM entityPM, SplitOrMergeReasonPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SplitOrMergeReasonPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SplitOrMergeReasonPM entityPM, SplitOrMergeReason entityPOCO, bool isNewEntity)
        {
