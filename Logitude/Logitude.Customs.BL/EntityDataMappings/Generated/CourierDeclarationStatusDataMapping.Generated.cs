...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CourierDeclarationStatusDataMapping: IMapping<CourierDeclarationStatusPM, CourierDeclarationStatus>,IMappingEncodeBase64NVARCHARFields<CourierDeclarationStatusPM>
   {
	    ...
	    public void PMToPOCO(CourierDeclarationStatusPM entityPM, CourierDeclarationStatus entityPOCO)
        {
		...
		public void POCOToPM(CourierDeclarationStatusPM entityPM, CourierDeclarationStatus entityPOCO)
        {
		...
		public void PMToOldPM(CourierDeclarationStatusPM entityPM, CourierDeclarationStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CourierDeclarationStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CourierDeclarationStatusPM entityPM, CourierDeclarationStatus entityPOCO, bool isNewEntity)
        {
