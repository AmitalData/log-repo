...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleTecnologyTypeDataMapping: IMapping<VehicleTecnologyTypePM, VehicleTecnologyType>,IMappingEncodeBase64NVARCHARFields<VehicleTecnologyTypePM>
   {
	    ...
	    public void PMToPOCO(VehicleTecnologyTypePM entityPM, VehicleTecnologyType entityPOCO)
        {
		...
		public void POCOToPM(VehicleTecnologyTypePM entityPM, VehicleTecnologyType entityPOCO)
        {
		...
		public void PMToOldPM(VehicleTecnologyTypePM entityPM, VehicleTecnologyTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleTecnologyTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleTecnologyTypePM entityPM, VehicleTecnologyType entityPOCO, bool isNewEntity)
        {
