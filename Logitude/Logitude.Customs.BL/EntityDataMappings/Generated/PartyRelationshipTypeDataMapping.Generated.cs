...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PartyRelationshipTypeDataMapping: IMapping<PartyRelationshipTypePM, PartyRelationshipType>,IMappingEncodeBase64NVARCHARFields<PartyRelationshipTypePM>
   {
	    ...
	    public void PMToPOCO(PartyRelationshipTypePM entityPM, PartyRelationshipType entityPOCO)
        {
		...
		public void POCOToPM(PartyRelationshipTypePM entityPM, PartyRelationshipType entityPOCO)
        {
		...
		public void PMToOldPM(PartyRelationshipTypePM entityPM, PartyRelationshipTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PartyRelationshipTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PartyRelationshipTypePM entityPM, PartyRelationshipType entityPOCO, bool isNewEntity)
        {
