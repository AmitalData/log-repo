...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProceduralFaultStatusDataMapping: IMapping<ProceduralFaultStatusPM, ProceduralFaultStatus>,IMappingEncodeBase64NVARCHARFields<ProceduralFaultStatusPM>
   {
	    ...
	    public void PMToPOCO(ProceduralFaultStatusPM entityPM, ProceduralFaultStatus entityPOCO)
        {
		...
		public void POCOToPM(ProceduralFaultStatusPM entityPM, ProceduralFaultStatus entityPOCO)
        {
		...
		public void PMToOldPM(ProceduralFaultStatusPM entityPM, ProceduralFaultStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ProceduralFaultStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ProceduralFaultStatusPM entityPM, ProceduralFaultStatus entityPOCO, bool isNewEntity)
        {
