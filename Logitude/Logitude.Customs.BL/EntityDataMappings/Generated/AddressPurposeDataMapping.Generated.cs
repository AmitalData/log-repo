...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AddressPurposeDataMapping: IMapping<AddressPurposePM, AddressPurpose>,IMappingEncodeBase64NVARCHARFields<AddressPurposePM>
   {
	    ...
	    public void PMToPOCO(AddressPurposePM entityPM, AddressPurpose entityPOCO)
        {
		...
		public void POCOToPM(AddressPurposePM entityPM, AddressPurpose entityPOCO)
        {
		...
		public void PMToOldPM(AddressPurposePM entityPM, AddressPurposePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AddressPurposePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AddressPurposePM entityPM, AddressPurpose entityPOCO, bool isNewEntity)
        {
