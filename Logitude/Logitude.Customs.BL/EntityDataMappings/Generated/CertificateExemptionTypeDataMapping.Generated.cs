...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CertificateExemptionTypeDataMapping: IMapping<CertificateExemptionTypePM, CertificateExemptionType>,IMappingEncodeBase64NVARCHARFields<CertificateExemptionTypePM>
   {
	    ...
	    public void PMToPOCO(CertificateExemptionTypePM entityPM, CertificateExemptionType entityPOCO)
        {
		...
		public void POCOToPM(CertificateExemptionTypePM entityPM, CertificateExemptionType entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CertificateExemptionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CertificateExemptionTypePM entityPM, CertificateExemptionType entityPOCO, bool isNewEntity)
        {
