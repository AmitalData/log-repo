...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SecurityClearenceTypeCodeDataMapping: IMapping<SecurityClearenceTypeCodePM, SecurityClearenceTypeCode>,IMappingEncodeBase64NVARCHARFields<SecurityClearenceTypeCodePM>
   {
	    ...
	    public void PMToPOCO(SecurityClearenceTypeCodePM entityPM, SecurityClearenceTypeCode entityPOCO)
        {
		...
		public void POCOToPM(SecurityClearenceTypeCodePM entityPM, SecurityClearenceTypeCode entityPOCO)
        {
		...
		public void PMToOldPM(SecurityClearenceTypeCodePM entityPM, SecurityClearenceTypeCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SecurityClearenceTypeCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SecurityClearenceTypeCodePM entityPM, SecurityClearenceTypeCode entityPOCO, bool isNewEntity)
        {
