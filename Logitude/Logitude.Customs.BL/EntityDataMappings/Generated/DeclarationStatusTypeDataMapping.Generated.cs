...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DeclarationStatusTypeDataMapping: IMapping<DeclarationStatusTypePM, DeclarationStatusType>,IMappingEncodeBase64NVARCHARFields<DeclarationStatusTypePM>
   {
	    ...
	    public void PMToPOCO(DeclarationStatusTypePM entityPM, DeclarationStatusType entityPOCO)
        {
		...
		public void POCOToPM(DeclarationStatusTypePM entityPM, DeclarationStatusType entityPOCO)
        {
		...
		public void PMToOldPM(DeclarationStatusTypePM entityPM, DeclarationStatusTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DeclarationStatusTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DeclarationStatusTypePM entityPM, DeclarationStatusType entityPOCO, bool isNewEntity)
        {
