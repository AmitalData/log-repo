...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class OrganizationUnitTypeDataMapping: IMapping<OrganizationUnitTypePM, OrganizationUnitType>,IMappingEncodeBase64NVARCHARFields<OrganizationUnitTypePM>
   {
	    ...
	    public void PMToPOCO(OrganizationUnitTypePM entityPM, OrganizationUnitType entityPOCO)
        {
		...
		public void POCOToPM(OrganizationUnitTypePM entityPM, OrganizationUnitType entityPOCO)
        {
		...
		public void PMToOldPM(OrganizationUnitTypePM entityPM, OrganizationUnitTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(OrganizationUnitTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(OrganizationUnitTypePM entityPM, OrganizationUnitType entityPOCO, bool isNewEntity)
        {
