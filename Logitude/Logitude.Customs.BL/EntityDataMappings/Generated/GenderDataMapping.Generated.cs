...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class GenderDataMapping: IMapping<GenderPM, Gender>,IMappingEncodeBase64NVARCHARFields<GenderPM>
   {
	    ...
	    public void PMToPOCO(GenderPM entityPM, Gender entityPOCO)
        {
		...
		public void POCOToPM(GenderPM entityPM, Gender entityPOCO)
        {
		...
		public void PMToOldPM(GenderPM entityPM, GenderPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(GenderPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(GenderPM entityPM, Gender entityPOCO, bool isNewEntity)
        {
