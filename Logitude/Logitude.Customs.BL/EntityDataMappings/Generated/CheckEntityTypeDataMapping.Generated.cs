...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CheckEntityTypeDataMapping: IMapping<CheckEntityTypePM, CheckEntityType>,IMappingEncodeBase64NVARCHARFields<CheckEntityTypePM>
   {
	    ...
	    public void PMToPOCO(CheckEntityTypePM entityPM, CheckEntityType entityPOCO)
        {
		...
		public void POCOToPM(CheckEntityTypePM entityPM, CheckEntityType entityPOCO)
        {
		...
		public void PMToOldPM(CheckEntityTypePM entityPM, CheckEntityTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CheckEntityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CheckEntityTypePM entityPM, CheckEntityType entityPOCO, bool isNewEntity)
        {
