...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SealTypeDataMapping: IMapping<SealTypePM, SealType>,IMappingEncodeBase64NVARCHARFields<SealTypePM>
   {
	    ...
	    public void PMToPOCO(SealTypePM entityPM, SealType entityPOCO)
        {
		...
		public void POCOToPM(SealTypePM entityPM, SealType entityPOCO)
        {
		...
		public void PMToOldPM(SealTypePM entityPM, SealTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SealTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SealTypePM entityPM, SealType entityPOCO, bool isNewEntity)
        {
