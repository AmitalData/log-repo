...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InternationalSiteDataMapping: IMapping<InternationalSitePM, InternationalSite>,IMappingEncodeBase64NVARCHARFields<InternationalSitePM>
   {
	    ...
	    public void PMToPOCO(InternationalSitePM entityPM, InternationalSite entityPOCO)
        {
		...
		public void POCOToPM(InternationalSitePM entityPM, InternationalSite entityPOCO)
        {
		...
		public void PMToOldPM(InternationalSitePM entityPM, InternationalSitePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InternationalSitePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InternationalSitePM entityPM, InternationalSite entityPOCO, bool isNewEntity)
        {
