...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RequestToAdvanceAQueueDataMapping: IMapping<RequestToAdvanceAQueuePM, RequestToAdvanceAQueue>,IMappingEncodeBase64NVARCHARFields<RequestToAdvanceAQueuePM>
   {
	    ...
	    public void PMToPOCO(RequestToAdvanceAQueuePM entityPM, RequestToAdvanceAQueue entityPOCO)
        {
		...
		public void POCOToPM(RequestToAdvanceAQueuePM entityPM, RequestToAdvanceAQueue entityPOCO)
        {
		...
		public void PMToOldPM(RequestToAdvanceAQueuePM entityPM, RequestToAdvanceAQueuePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RequestToAdvanceAQueuePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RequestToAdvanceAQueuePM entityPM, RequestToAdvanceAQueue entityPOCO, bool isNewEntity)
        {
