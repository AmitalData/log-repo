...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CommercialSaleDataMapping: IMapping<CommercialSalePM, CommercialSale>,IMappingEncodeBase64NVARCHARFields<CommercialSalePM>
   {
	    ...
	    public void PMToPOCO(CommercialSalePM entityPM, CommercialSale entityPOCO)
        {
		...
		public void POCOToPM(CommercialSalePM entityPM, CommercialSale entityPOCO)
        {
		...
		public void PMToOldPM(CommercialSalePM entityPM, CommercialSalePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CommercialSalePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CommercialSalePM entityPM, CommercialSale entityPOCO, bool isNewEntity)
        {
