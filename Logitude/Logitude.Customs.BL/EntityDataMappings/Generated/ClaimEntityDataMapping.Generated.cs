...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ClaimEntityDataMapping: IMapping<ClaimEntityPM, ClaimEntity>,IMappingEncodeBase64NVARCHARFields<ClaimEntityPM>
   {
	    ...
	    public void PMToPOCO(ClaimEntityPM entityPM, ClaimEntity entityPOCO)
        {
		...
		public void POCOToPM(ClaimEntityPM entityPM, ClaimEntity entityPOCO)
        {
		...
		public void PMToOldPM(ClaimEntityPM entityPM, ClaimEntityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ClaimEntityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ClaimEntityPM entityPM, ClaimEntity entityPOCO, bool isNewEntity)
        {
