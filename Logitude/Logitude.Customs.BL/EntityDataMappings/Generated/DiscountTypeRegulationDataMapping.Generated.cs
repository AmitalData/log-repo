...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DiscountTypeRegulationDataMapping: IMapping<DiscountTypeRegulationPM, DiscountTypeRegulation>,IMappingEncodeBase64NVARCHARFields<DiscountTypeRegulationPM>
   {
	    ...
	    public void PMToPOCO(DiscountTypeRegulationPM entityPM, DiscountTypeRegulation entityPOCO)
        {
		...
		public void POCOToPM(DiscountTypeRegulationPM entityPM, DiscountTypeRegulation entityPOCO)
        {
		...
		public void PMToOldPM(DiscountTypeRegulationPM entityPM, DiscountTypeRegulationPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DiscountTypeRegulationPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DiscountTypeRegulationPM entityPM, DiscountTypeRegulation entityPOCO, bool isNewEntity)
        {
