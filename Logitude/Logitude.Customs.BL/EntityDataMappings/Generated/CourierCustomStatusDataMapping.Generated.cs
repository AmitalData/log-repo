...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CourierCustomStatusDataMapping: IMapping<CourierCustomStatusPM, CourierCustomStatus>,IMappingEncodeBase64NVARCHARFields<CourierCustomStatusPM>
   {
	    ...
	    public void PMToPOCO(CourierCustomStatusPM entityPM, CourierCustomStatus entityPOCO)
        {
		...
		public void POCOToPM(CourierCustomStatusPM entityPM, CourierCustomStatus entityPOCO)
        {
		...
		public void PMToOldPM(CourierCustomStatusPM entityPM, CourierCustomStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CourierCustomStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CourierCustomStatusPM entityPM, CourierCustomStatus entityPOCO, bool isNewEntity)
        {
