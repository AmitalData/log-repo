...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SiteTypeDataMapping: IMapping<SiteTypePM, SiteType>,IMappingEncodeBase64NVARCHARFields<SiteTypePM>
   {
	    ...
	    public void PMToPOCO(SiteTypePM entityPM, SiteType entityPOCO)
        {
		...
		public void POCOToPM(SiteTypePM entityPM, SiteType entityPOCO)
        {
		...
		public void PMToOldPM(SiteTypePM entityPM, SiteTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SiteTypePM entityPM, SiteType entityPOCO, bool isNewEntity)
        {
