...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SiteLookupDataMapping: IMapping<SiteLookupPM, SiteLookup>,IMappingEncodeBase64NVARCHARFields<SiteLookupPM>
   {
	    ...
	    public void PMToPOCO(SiteLookupPM entityPM, SiteLookup entityPOCO)
        {
			 
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.SiteTypeCode))
            {
				entityPOCO.SiteTypeCode = entityPM.SiteTypeCode;
			}
		...
		public void POCOToPM(SiteLookupPM entityPM, SiteLookup entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.SiteTypeCode))
            {
					entityPM.SiteTypeCode = entityPOCO.SiteTypeCode;
            }
		...
		public void PMToOldPM(SiteLookupPM entityPM, SiteLookupPM oldEntityPM)
        {
		     oldEntityPM.ChangedProperties.Clear();
			 
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.SiteTypeCode))
            {
                oldEntityPM.SiteTypeCode = entityPM.SiteTypeCode;
            }
	    ...
	    public void EncodeBase64NVARCHARFields(SiteLookupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SiteLookupPM entityPM, SiteLookup entityPOCO, bool isNewEntity)
        {
