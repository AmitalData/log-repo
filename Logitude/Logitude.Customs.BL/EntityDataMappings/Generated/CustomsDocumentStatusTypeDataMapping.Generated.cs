...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsDocumentStatusTypeDataMapping: IMapping<CustomsDocumentStatusTypePM, CustomsDocumentStatusType>,IMappingEncodeBase64NVARCHARFields<CustomsDocumentStatusTypePM>
   {
	    ...
	    public void PMToPOCO(CustomsDocumentStatusTypePM entityPM, CustomsDocumentStatusType entityPOCO)
        {
		...
		public void POCOToPM(CustomsDocumentStatusTypePM entityPM, CustomsDocumentStatusType entityPOCO)
        {
		...
		public void PMToOldPM(CustomsDocumentStatusTypePM entityPM, CustomsDocumentStatusTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsDocumentStatusTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsDocumentStatusTypePM entityPM, CustomsDocumentStatusType entityPOCO, bool isNewEntity)
        {
