...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CancellationRequestStatusDataMapping: IMapping<CancellationRequestStatusPM, CancellationRequestStatus>,IMappingEncodeBase64NVARCHARFields<CancellationRequestStatusPM>
   {
	    ...
	    public void PMToPOCO(CancellationRequestStatusPM entityPM, CancellationRequestStatus entityPOCO)
        {
		...
		public void POCOToPM(CancellationRequestStatusPM entityPM, CancellationRequestStatus entityPOCO)
        {
		...
		public void PMToOldPM(CancellationRequestStatusPM entityPM, CancellationRequestStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CancellationRequestStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CancellationRequestStatusPM entityPM, CancellationRequestStatus entityPOCO, bool isNewEntity)
        {
