...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SubCountryDataMapping: IMapping<SubCountryPM, SubCountry>,IMappingEncodeBase64NVARCHARFields<SubCountryPM>
   {
	    ...
	    public void PMToPOCO(SubCountryPM entityPM, SubCountry entityPOCO)
        {
		...
		public void POCOToPM(SubCountryPM entityPM, SubCountry entityPOCO)
        {
		...
		public void PMToOldPM(SubCountryPM entityPM, SubCountryPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SubCountryPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SubCountryPM entityPM, SubCountry entityPOCO, bool isNewEntity)
        {
