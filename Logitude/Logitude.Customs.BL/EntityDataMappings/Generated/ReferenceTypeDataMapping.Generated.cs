...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ReferenceTypeDataMapping: IMapping<ReferenceTypePM, ReferenceType>,IMappingEncodeBase64NVARCHARFields<ReferenceTypePM>
   {
	    ...
	    public void PMToPOCO(ReferenceTypePM entityPM, ReferenceType entityPOCO)
        {
		...
		public void POCOToPM(ReferenceTypePM entityPM, ReferenceType entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ReferenceTypePM entityPM, ReferenceType entityPOCO, bool isNewEntity)
        {
