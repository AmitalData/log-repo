...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class MorningMessageTypeDataMapping: IMapping<MorningMessageTypePM, MorningMessageType>,IMappingEncodeBase64NVARCHARFields<MorningMessageTypePM>
   {
	    ...
	    public void PMToPOCO(MorningMessageTypePM entityPM, MorningMessageType entityPOCO)
        {
		...
		public void POCOToPM(MorningMessageTypePM entityPM, MorningMessageType entityPOCO)
        {
		...
		public void PMToOldPM(MorningMessageTypePM entityPM, MorningMessageTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MorningMessageTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MorningMessageTypePM entityPM, MorningMessageType entityPOCO, bool isNewEntity)
        {
