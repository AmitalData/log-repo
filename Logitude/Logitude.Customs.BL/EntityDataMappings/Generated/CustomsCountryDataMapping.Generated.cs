...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsCountryDataMapping: IMapping<CustomsCountryPM, CustomsCountry>,IMappingEncodeBase64NVARCHARFields<CustomsCountryPM>
   {
	    ...
	    public void PMToPOCO(CustomsCountryPM entityPM, CustomsCountry entityPOCO)
        {
		...
		public void POCOToPM(CustomsCountryPM entityPM, CustomsCountry entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsCountryPM entityPM, CustomsCountry entityPOCO, bool isNewEntity)
        {
