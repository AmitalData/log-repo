...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ReferenceInputTypeDataMapping: IMapping<ReferenceInputTypePM, ReferenceInputType>,IMappingEncodeBase64NVARCHARFields<ReferenceInputTypePM>
   {
	    ...
	    public void PMToPOCO(ReferenceInputTypePM entityPM, ReferenceInputType entityPOCO)
        {
		...
		public void POCOToPM(ReferenceInputTypePM entityPM, ReferenceInputType entityPOCO)
        {
		...
		public void PMToOldPM(ReferenceInputTypePM entityPM, ReferenceInputTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ReferenceInputTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ReferenceInputTypePM entityPM, ReferenceInputType entityPOCO, bool isNewEntity)
        {
