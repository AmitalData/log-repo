...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerClassificationTypeDataMapping: IMapping<CustomerClassificationTypePM, CustomerClassificationType>,IMappingEncodeBase64NVARCHARFields<CustomerClassificationTypePM>
   {
	    ...
	    public void PMToPOCO(CustomerClassificationTypePM entityPM, CustomerClassificationType entityPOCO)
        {
		...
		public void POCOToPM(CustomerClassificationTypePM entityPM, CustomerClassificationType entityPOCO)
        {
		...
		public void PMToOldPM(CustomerClassificationTypePM entityPM, CustomerClassificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerClassificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerClassificationTypePM entityPM, CustomerClassificationType entityPOCO, bool isNewEntity)
        {
