...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PhysicalCheckStatusMessageDataMapping: IMapping<PhysicalCheckStatusMessagePM, PhysicalCheckStatusMessage>,IMappingEncodeBase64NVARCHARFields<PhysicalCheckStatusMessagePM>
   {
	    ...
	    public void PMToPOCO(PhysicalCheckStatusMessagePM entityPM, PhysicalCheckStatusMessage entityPOCO)
        {
		...
		public void POCOToPM(PhysicalCheckStatusMessagePM entityPM, PhysicalCheckStatusMessage entityPOCO)
        {
		...
		public void PMToOldPM(PhysicalCheckStatusMessagePM entityPM, PhysicalCheckStatusMessagePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PhysicalCheckStatusMessagePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PhysicalCheckStatusMessagePM entityPM, PhysicalCheckStatusMessage entityPOCO, bool isNewEntity)
        {
