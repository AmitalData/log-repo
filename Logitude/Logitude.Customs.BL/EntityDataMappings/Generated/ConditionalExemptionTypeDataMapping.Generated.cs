...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConditionalExemptionTypeDataMapping: IMapping<ConditionalExemptionTypePM, ConditionalExemptionType>,IMappingEncodeBase64NVARCHARFields<ConditionalExemptionTypePM>
   {
	    ...
	    public void PMToPOCO(ConditionalExemptionTypePM entityPM, ConditionalExemptionType entityPOCO)
        {
		...
		public void POCOToPM(ConditionalExemptionTypePM entityPM, ConditionalExemptionType entityPOCO)
        {
		...
		public void PMToOldPM(ConditionalExemptionTypePM entityPM, ConditionalExemptionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ConditionalExemptionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ConditionalExemptionTypePM entityPM, ConditionalExemptionType entityPOCO, bool isNewEntity)
        {
