...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TradeAgreementProtocolDataMapping: IMapping<TradeAgreementProtocolPM, TradeAgreementProtocol>,IMappingEncodeBase64NVARCHARFields<TradeAgreementProtocolPM>
   {
	    ...
	    public void PMToPOCO(TradeAgreementProtocolPM entityPM, TradeAgreementProtocol entityPOCO)
        {
		...
		public void POCOToPM(TradeAgreementProtocolPM entityPM, TradeAgreementProtocol entityPOCO)
        {
		...
		public void PMToOldPM(TradeAgreementProtocolPM entityPM, TradeAgreementProtocolPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TradeAgreementProtocolPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TradeAgreementProtocolPM entityPM, TradeAgreementProtocol entityPOCO, bool isNewEntity)
        {
