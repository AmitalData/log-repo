...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConstraintStatusDataMapping: IMapping<ConstraintStatusPM, ConstraintStatus>,IMappingEncodeBase64NVARCHARFields<ConstraintStatusPM>
   {
	    ...
	    public void PMToPOCO(ConstraintStatusPM entityPM, ConstraintStatus entityPOCO)
        {
		...
		public void POCOToPM(ConstraintStatusPM entityPM, ConstraintStatus entityPOCO)
        {
		...
		public void PMToOldPM(ConstraintStatusPM entityPM, ConstraintStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ConstraintStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ConstraintStatusPM entityPM, ConstraintStatus entityPOCO, bool isNewEntity)
        {
