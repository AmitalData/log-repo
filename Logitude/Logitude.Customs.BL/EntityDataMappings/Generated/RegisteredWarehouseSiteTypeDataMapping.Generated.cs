...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RegisteredWarehouseSiteTypeDataMapping: IMapping<RegisteredWarehouseSiteTypePM, RegisteredWarehouseSiteType>,IMappingEncodeBase64NVARCHARFields<RegisteredWarehouseSiteTypePM>
   {
	    ...
	    public void PMToPOCO(RegisteredWarehouseSiteTypePM entityPM, RegisteredWarehouseSiteType entityPOCO)
        {
		...
		public void POCOToPM(RegisteredWarehouseSiteTypePM entityPM, RegisteredWarehouseSiteType entityPOCO)
        {
		...
		public void PMToOldPM(RegisteredWarehouseSiteTypePM entityPM, RegisteredWarehouseSiteTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RegisteredWarehouseSiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RegisteredWarehouseSiteTypePM entityPM, RegisteredWarehouseSiteType entityPOCO, bool isNewEntity)
        {
