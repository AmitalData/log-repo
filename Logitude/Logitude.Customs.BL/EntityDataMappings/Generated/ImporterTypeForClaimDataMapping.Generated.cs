...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ImporterTypeForClaimDataMapping: IMapping<ImporterTypeForClaimPM, ImporterTypeForClaim>,IMappingEncodeBase64NVARCHARFields<ImporterTypeForClaimPM>
   {
	    ...
	    public void PMToPOCO(ImporterTypeForClaimPM entityPM, ImporterTypeForClaim entityPOCO)
        {
		...
		public void POCOToPM(ImporterTypeForClaimPM entityPM, ImporterTypeForClaim entityPOCO)
        {
		...
		public void PMToOldPM(ImporterTypeForClaimPM entityPM, ImporterTypeForClaimPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ImporterTypeForClaimPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ImporterTypeForClaimPM entityPM, ImporterTypeForClaim entityPOCO, bool isNewEntity)
        {
