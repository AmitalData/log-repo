...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RegularityPublicationDataMapping: IMapping<RegularityPublicationPM, RegularityPublication>,IMappingEncodeBase64NVARCHARFields<RegularityPublicationPM>
   {
	    ...
	    public void PMToPOCO(RegularityPublicationPM entityPM, RegularityPublication entityPOCO)
        {
		...
		public void POCOToPM(RegularityPublicationPM entityPM, RegularityPublication entityPOCO)
        {
		...
		public void PMToOldPM(RegularityPublicationPM entityPM, RegularityPublicationPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RegularityPublicationPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RegularityPublicationPM entityPM, RegularityPublication entityPOCO, bool isNewEntity)
        {
