...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TradeAgreementDataMapping: IMapping<TradeAgreementPM, TradeAgreement>,IMappingEncodeBase64NVARCHARFields<TradeAgreementPM>
   {
	    ...
	    public void PMToPOCO(TradeAgreementPM entityPM, TradeAgreement entityPOCO)
        {
		...
		public void POCOToPM(TradeAgreementPM entityPM, TradeAgreement entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TradeAgreementPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TradeAgreementPM entityPM, TradeAgreement entityPOCO, bool isNewEntity)
        {
