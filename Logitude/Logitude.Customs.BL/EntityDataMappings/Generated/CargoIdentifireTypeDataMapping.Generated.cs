...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CargoIdentifireTypeDataMapping: IMapping<CargoIdentifireTypePM, CargoIdentifireType>,IMappingEncodeBase64NVARCHARFields<CargoIdentifireTypePM>
   {
	    ...
	    public void PMToPOCO(CargoIdentifireTypePM entityPM, CargoIdentifireType entityPOCO)
        {
		...
		public void POCOToPM(CargoIdentifireTypePM entityPM, CargoIdentifireType entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(CargoIdentifireTypePM entityPM, CargoIdentifireType entityPOCO, bool isNewEntity)
        {
