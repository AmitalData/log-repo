...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProductNameTypeDataMapping: IMapping<ProductNameTypePM, ProductNameType>,IMappingEncodeBase64NVARCHARFields<ProductNameTypePM>
   {
	    ...
	    public void PMToPOCO(ProductNameTypePM entityPM, ProductNameType entityPOCO)
        {
		...
		public void POCOToPM(ProductNameTypePM entityPM, ProductNameType entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ProductNameTypePM entityPM, ProductNameType entityPOCO, bool isNewEntity)
        {
