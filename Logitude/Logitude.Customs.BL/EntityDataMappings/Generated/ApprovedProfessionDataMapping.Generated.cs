...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ApprovedProfessionDataMapping: IMapping<ApprovedProfessionPM, ApprovedProfession>,IMappingEncodeBase64NVARCHARFields<ApprovedProfessionPM>
   {
	    ...
	    public void PMToPOCO(ApprovedProfessionPM entityPM, ApprovedProfession entityPOCO)
        {
		...
		public void POCOToPM(ApprovedProfessionPM entityPM, ApprovedProfession entityPOCO)
        {
		...
		public void PMToOldPM(ApprovedProfessionPM entityPM, ApprovedProfessionPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ApprovedProfessionPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ApprovedProfessionPM entityPM, ApprovedProfession entityPOCO, bool isNewEntity)
        {
