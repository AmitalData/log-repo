...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PerYearFrequencyDataMapping: IMapping<PerYearFrequencyPM, PerYearFrequency>,IMappingEncodeBase64NVARCHARFields<PerYearFrequencyPM>
   {
	    ...
	    public void PMToPOCO(PerYearFrequencyPM entityPM, PerYearFrequency entityPOCO)
        {
		...
		public void POCOToPM(PerYearFrequencyPM entityPM, PerYearFrequency entityPOCO)
        {
		...
		public void PMToOldPM(PerYearFrequencyPM entityPM, PerYearFrequencyPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PerYearFrequencyPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PerYearFrequencyPM entityPM, PerYearFrequency entityPOCO, bool isNewEntity)
        {
