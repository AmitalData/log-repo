...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AuthorityDataMapping: IMapping<AuthorityPM, Authority>,IMappingEncodeBase64NVARCHARFields<AuthorityPM>
   {
	    ...
	    public void PMToPOCO(AuthorityPM entityPM, Authority entityPOCO)
        {
		...
		public void POCOToPM(AuthorityPM entityPM, Authority entityPOCO)
        {
		...
		public void PMToOldPM(AuthorityPM entityPM, AuthorityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AuthorityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AuthorityPM entityPM, Authority entityPOCO, bool isNewEntity)
        {
