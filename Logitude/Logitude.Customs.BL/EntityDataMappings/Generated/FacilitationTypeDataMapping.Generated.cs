...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class FacilitationTypeDataMapping: IMapping<FacilitationTypePM, FacilitationType>,IMappingEncodeBase64NVARCHARFields<FacilitationTypePM>
   {
	    ...
	    public void PMToPOCO(FacilitationTypePM entityPM, FacilitationType entityPOCO)
        {
		...
		public void POCOToPM(FacilitationTypePM entityPM, FacilitationType entityPOCO)
        {
		...
		public void PMToOldPM(FacilitationTypePM entityPM, FacilitationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(FacilitationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(FacilitationTypePM entityPM, FacilitationType entityPOCO, bool isNewEntity)
        {
