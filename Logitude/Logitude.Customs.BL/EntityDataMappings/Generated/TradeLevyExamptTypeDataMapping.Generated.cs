...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TradeLevyExamptTypeDataMapping: IMapping<TradeLevyExamptTypePM, TradeLevyExamptType>,IMappingEncodeBase64NVARCHARFields<TradeLevyExamptTypePM>
   {
	    ...
	    public void PMToPOCO(TradeLevyExamptTypePM entityPM, TradeLevyExamptType entityPOCO)
        {
		...
		public void POCOToPM(TradeLevyExamptTypePM entityPM, TradeLevyExamptType entityPOCO)
        {
		...
		public void PMToOldPM(TradeLevyExamptTypePM entityPM, TradeLevyExamptTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TradeLevyExamptTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TradeLevyExamptTypePM entityPM, TradeLevyExamptType entityPOCO, bool isNewEntity)
        {
