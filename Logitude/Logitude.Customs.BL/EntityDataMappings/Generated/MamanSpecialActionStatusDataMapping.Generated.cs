...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class MamanSpecialActionStatusDataMapping: IMapping<MamanSpecialActionStatusPM, MamanSpecialActionStatus>,IMappingEncodeBase64NVARCHARFields<MamanSpecialActionStatusPM>
   {
	    ...
	    public void PMToPOCO(MamanSpecialActionStatusPM entityPM, MamanSpecialActionStatus entityPOCO)
        {
		...
		public void POCOToPM(MamanSpecialActionStatusPM entityPM, MamanSpecialActionStatus entityPOCO)
        {
		...
		public void PMToOldPM(MamanSpecialActionStatusPM entityPM, MamanSpecialActionStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MamanSpecialActionStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MamanSpecialActionStatusPM entityPM, MamanSpecialActionStatus entityPOCO, bool isNewEntity)
        {
