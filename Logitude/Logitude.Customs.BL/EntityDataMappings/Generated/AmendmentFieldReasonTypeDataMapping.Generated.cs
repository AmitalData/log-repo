...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AmendmentFieldReasonTypeDataMapping: IMapping<AmendmentFieldReasonTypePM, AmendmentFieldReasonType>,IMappingEncodeBase64NVARCHARFields<AmendmentFieldReasonTypePM>
   {
	    ...
	    public void PMToPOCO(AmendmentFieldReasonTypePM entityPM, AmendmentFieldReasonType entityPOCO)
        {
		...
		public void POCOToPM(AmendmentFieldReasonTypePM entityPM, AmendmentFieldReasonType entityPOCO)
        {
		...
		public void PMToOldPM(AmendmentFieldReasonTypePM entityPM, AmendmentFieldReasonTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AmendmentFieldReasonTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AmendmentFieldReasonTypePM entityPM, AmendmentFieldReasonType entityPOCO, bool isNewEntity)
        {
