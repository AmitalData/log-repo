...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsInsuranceCompanyDataMapping: IMapping<CustomsInsuranceCompanyPM, CustomsInsuranceCompany>,IMappingEncodeBase64NVARCHARFields<CustomsInsuranceCompanyPM>
   {
	    ...
	    public void PMToPOCO(CustomsInsuranceCompanyPM entityPM, CustomsInsuranceCompany entityPOCO)
        {
		...
		public void POCOToPM(CustomsInsuranceCompanyPM entityPM, CustomsInsuranceCompany entityPOCO)
        {
		...
		public void PMToOldPM(CustomsInsuranceCompanyPM entityPM, CustomsInsuranceCompanyPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsInsuranceCompanyPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsInsuranceCompanyPM entityPM, CustomsInsuranceCompany entityPOCO, bool isNewEntity)
        {
