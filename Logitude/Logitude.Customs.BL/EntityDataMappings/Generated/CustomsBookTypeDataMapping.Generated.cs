...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsBookTypeDataMapping: IMapping<CustomsBookTypePM, CustomsBookType>,IMappingEncodeBase64NVARCHARFields<CustomsBookTypePM>
   {
	    ...
	    public void PMToPOCO(CustomsBookTypePM entityPM, CustomsBookType entityPOCO)
        {
		...
		public void POCOToPM(CustomsBookTypePM entityPM, CustomsBookType entityPOCO)
        {
		...
		public void PMToOldPM(CustomsBookTypePM entityPM, CustomsBookTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsBookTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsBookTypePM entityPM, CustomsBookType entityPOCO, bool isNewEntity)
        {
