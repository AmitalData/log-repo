...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AmendmentTypeDataMapping: IMapping<AmendmentTypePM, AmendmentType>,IMappingEncodeBase64NVARCHARFields<AmendmentTypePM>
   {
	    ...
	    public void PMToPOCO(AmendmentTypePM entityPM, AmendmentType entityPOCO)
        {
		...
		public void POCOToPM(AmendmentTypePM entityPM, AmendmentType entityPOCO)
        {
		...
		public void PMToOldPM(AmendmentTypePM entityPM, AmendmentTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AmendmentTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AmendmentTypePM entityPM, AmendmentType entityPOCO, bool isNewEntity)
        {
