...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SalesTaxExemptionTypeDataMapping: IMapping<SalesTaxExemptionTypePM, SalesTaxExemptionType>,IMappingEncodeBase64NVARCHARFields<SalesTaxExemptionTypePM>
   {
	    ...
	    public void PMToPOCO(SalesTaxExemptionTypePM entityPM, SalesTaxExemptionType entityPOCO)
        {
		...
		public void POCOToPM(SalesTaxExemptionTypePM entityPM, SalesTaxExemptionType entityPOCO)
        {
		...
		public void PMToOldPM(SalesTaxExemptionTypePM entityPM, SalesTaxExemptionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SalesTaxExemptionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SalesTaxExemptionTypePM entityPM, SalesTaxExemptionType entityPOCO, bool isNewEntity)
        {
