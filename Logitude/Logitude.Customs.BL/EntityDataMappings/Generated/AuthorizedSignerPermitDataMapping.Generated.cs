...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AuthorizedSignerPermitDataMapping: IMapping<AuthorizedSignerPermitPM, AuthorizedSignerPermit>,IMappingEncodeBase64NVARCHARFields<AuthorizedSignerPermitPM>
   {
	    ...
	    public void PMToPOCO(AuthorizedSignerPermitPM entityPM, AuthorizedSignerPermit entityPOCO)
        {
		...
		public void POCOToPM(AuthorizedSignerPermitPM entityPM, AuthorizedSignerPermit entityPOCO)
        {
		...
		public void PMToOldPM(AuthorizedSignerPermitPM entityPM, AuthorizedSignerPermitPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AuthorizedSignerPermitPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AuthorizedSignerPermitPM entityPM, AuthorizedSignerPermit entityPOCO, bool isNewEntity)
        {
