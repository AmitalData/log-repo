...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerIndicationTypeDataMapping: IMapping<CustomerIndicationTypePM, CustomerIndicationType>,IMappingEncodeBase64NVARCHARFields<CustomerIndicationTypePM>
   {
	    ...
	    public void PMToPOCO(CustomerIndicationTypePM entityPM, CustomerIndicationType entityPOCO)
        {
		...
		public void POCOToPM(CustomerIndicationTypePM entityPM, CustomerIndicationType entityPOCO)
        {
		...
		public void PMToOldPM(CustomerIndicationTypePM entityPM, CustomerIndicationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerIndicationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerIndicationTypePM entityPM, CustomerIndicationType entityPOCO, bool isNewEntity)
        {
