...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TransferCargoMethodTypeDataMapping: IMapping<TransferCargoMethodTypePM, TransferCargoMethodType>,IMappingEncodeBase64NVARCHARFields<TransferCargoMethodTypePM>
   {
	    ...
	    public void PMToPOCO(TransferCargoMethodTypePM entityPM, TransferCargoMethodType entityPOCO)
        {
		...
		public void POCOToPM(TransferCargoMethodTypePM entityPM, TransferCargoMethodType entityPOCO)
        {
		...
		public void PMToOldPM(TransferCargoMethodTypePM entityPM, TransferCargoMethodTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TransferCargoMethodTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TransferCargoMethodTypePM entityPM, TransferCargoMethodType entityPOCO, bool isNewEntity)
        {
