...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CommunicationTypeDataMapping: IMapping<CommunicationTypePM, CommunicationType>,IMappingEncodeBase64NVARCHARFields<CommunicationTypePM>
   {
	    ...
	    public void PMToPOCO(CommunicationTypePM entityPM, CommunicationType entityPOCO)
        {
		...
		public void POCOToPM(CommunicationTypePM entityPM, CommunicationType entityPOCO)
        {
		...
		public void PMToOldPM(CommunicationTypePM entityPM, CommunicationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CommunicationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CommunicationTypePM entityPM, CommunicationType entityPOCO, bool isNewEntity)
        {
