...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PackingTypeDataMapping: IMapping<PackingTypePM, PackingType>,IMappingEncodeBase64NVARCHARFields<PackingTypePM>
   {
	    ...
	    public void PMToPOCO(PackingTypePM entityPM, PackingType entityPOCO)
        {
		...
		public void POCOToPM(PackingTypePM entityPM, PackingType entityPOCO)
        {
		...
		public void PMToOldPM(PackingTypePM entityPM, PackingTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PackingTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PackingTypePM entityPM, PackingType entityPOCO, bool isNewEntity)
        {
