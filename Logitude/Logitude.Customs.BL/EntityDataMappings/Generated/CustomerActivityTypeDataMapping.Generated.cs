...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerActivityTypeDataMapping: IMapping<CustomerActivityTypePM, CustomerActivityType>,IMappingEncodeBase64NVARCHARFields<CustomerActivityTypePM>
   {
	    ...
	    public void PMToPOCO(CustomerActivityTypePM entityPM, CustomerActivityType entityPOCO)
        {
		...
		public void POCOToPM(CustomerActivityTypePM entityPM, CustomerActivityType entityPOCO)
        {
		...
		public void PMToOldPM(CustomerActivityTypePM entityPM, CustomerActivityTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerActivityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerActivityTypePM entityPM, CustomerActivityType entityPOCO, bool isNewEntity)
        {
