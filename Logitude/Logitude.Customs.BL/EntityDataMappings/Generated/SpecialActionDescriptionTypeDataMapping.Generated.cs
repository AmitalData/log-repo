...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SpecialActionDescriptionTypeDataMapping: IMapping<SpecialActionDescriptionTypePM, SpecialActionDescriptionType>,IMappingEncodeBase64NVARCHARFields<SpecialActionDescriptionTypePM>
   {
	    ...
	    public void PMToPOCO(SpecialActionDescriptionTypePM entityPM, SpecialActionDescriptionType entityPOCO)
        {
		...
		public void POCOToPM(SpecialActionDescriptionTypePM entityPM, SpecialActionDescriptionType entityPOCO)
        {
		...
		public void PMToOldPM(SpecialActionDescriptionTypePM entityPM, SpecialActionDescriptionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SpecialActionDescriptionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SpecialActionDescriptionTypePM entityPM, SpecialActionDescriptionType entityPOCO, bool isNewEntity)
        {
