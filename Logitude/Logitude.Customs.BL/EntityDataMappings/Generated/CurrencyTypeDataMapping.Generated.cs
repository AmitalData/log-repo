...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CurrencyTypeDataMapping: IMapping<CurrencyTypePM, CurrencyType>,IMappingEncodeBase64NVARCHARFields<CurrencyTypePM>
   {
	    ...
	    public void PMToPOCO(CurrencyTypePM entityPM, CurrencyType entityPOCO)
        {
		...
		public void POCOToPM(CurrencyTypePM entityPM, CurrencyType entityPOCO)
        {
		...
		public void PMToOldPM(CurrencyTypePM entityPM, CurrencyTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CurrencyTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CurrencyTypePM entityPM, CurrencyType entityPOCO, bool isNewEntity)
        {
