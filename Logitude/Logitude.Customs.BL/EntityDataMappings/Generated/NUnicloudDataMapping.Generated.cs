...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class NUnicloudDataMapping: IMapping<NUnicloudPM, NUnicloud>,IMappingEncodeBase64NVARCHARFields<NUnicloudPM>
   {
	    ...
	    public void PMToPOCO(NUnicloudPM entityPM, NUnicloud entityPOCO)
        {
		...
		public void POCOToPM(NUnicloudPM entityPM, NUnicloud entityPOCO)
        {
		...
		public void PMToOldPM(NUnicloudPM entityPM, NUnicloudPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(NUnicloudPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(NUnicloudPM entityPM, NUnicloud entityPOCO, bool isNewEntity)
        {
