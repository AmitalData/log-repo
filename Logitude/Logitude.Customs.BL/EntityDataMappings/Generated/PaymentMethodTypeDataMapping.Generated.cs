...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentMethodTypeDataMapping: IMapping<PaymentMethodTypePM, PaymentMethodType>,IMappingEncodeBase64NVARCHARFields<PaymentMethodTypePM>
   {
	    ...
	    public void PMToPOCO(PaymentMethodTypePM entityPM, PaymentMethodType entityPOCO)
        {
		...
		public void POCOToPM(PaymentMethodTypePM entityPM, PaymentMethodType entityPOCO)
        {
		...
		public void PMToOldPM(PaymentMethodTypePM entityPM, PaymentMethodTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentMethodTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentMethodTypePM entityPM, PaymentMethodType entityPOCO, bool isNewEntity)
        {
