...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DangerousGoodsPackingReqDataMapping: IMapping<DangerousGoodsPackingReqPM, DangerousGoodsPackingReq>,IMappingEncodeBase64NVARCHARFields<DangerousGoodsPackingReqPM>
   {
	    ...
	    public void PMToPOCO(DangerousGoodsPackingReqPM entityPM, DangerousGoodsPackingReq entityPOCO)
        {
		...
		public void POCOToPM(DangerousGoodsPackingReqPM entityPM, DangerousGoodsPackingReq entityPOCO)
        {
		...
		public void PMToOldPM(DangerousGoodsPackingReqPM entityPM, DangerousGoodsPackingReqPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DangerousGoodsPackingReqPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DangerousGoodsPackingReqPM entityPM, DangerousGoodsPackingReq entityPOCO, bool isNewEntity)
        {
