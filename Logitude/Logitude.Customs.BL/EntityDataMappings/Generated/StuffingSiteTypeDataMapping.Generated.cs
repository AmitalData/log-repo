...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class StuffingSiteTypeDataMapping: IMapping<StuffingSiteTypePM, StuffingSiteType>,IMappingEncodeBase64NVARCHARFields<StuffingSiteTypePM>
   {
	    ...
	    public void PMToPOCO(StuffingSiteTypePM entityPM, StuffingSiteType entityPOCO)
        {
		...
		public void POCOToPM(StuffingSiteTypePM entityPM, StuffingSiteType entityPOCO)
        {
		...
		public void PMToOldPM(StuffingSiteTypePM entityPM, StuffingSiteTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(StuffingSiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(StuffingSiteTypePM entityPM, StuffingSiteType entityPOCO, bool isNewEntity)
        {
