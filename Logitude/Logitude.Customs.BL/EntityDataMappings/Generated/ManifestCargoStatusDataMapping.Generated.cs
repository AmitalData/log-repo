...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ManifestCargoStatusDataMapping: IMapping<ManifestCargoStatusPM, ManifestCargoStatus>,IMappingEncodeBase64NVARCHARFields<ManifestCargoStatusPM>
   {
	    ...
	    public void PMToPOCO(ManifestCargoStatusPM entityPM, ManifestCargoStatus entityPOCO)
        {
		...
		public void POCOToPM(ManifestCargoStatusPM entityPM, ManifestCargoStatus entityPOCO)
        {
		...
		public void PMToOldPM(ManifestCargoStatusPM entityPM, ManifestCargoStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ManifestCargoStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ManifestCargoStatusPM entityPM, ManifestCargoStatus entityPOCO, bool isNewEntity)
        {
