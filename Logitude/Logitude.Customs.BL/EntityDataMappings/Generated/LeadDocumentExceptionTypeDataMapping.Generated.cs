...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LeadDocumentExceptionTypeDataMapping: IMapping<LeadDocumentExceptionTypePM, LeadDocumentExceptionType>,IMappingEncodeBase64NVARCHARFields<LeadDocumentExceptionTypePM>
   {
	    ...
	    public void PMToPOCO(LeadDocumentExceptionTypePM entityPM, LeadDocumentExceptionType entityPOCO)
        {
		...
		public void POCOToPM(LeadDocumentExceptionTypePM entityPM, LeadDocumentExceptionType entityPOCO)
        {
		...
		public void PMToOldPM(LeadDocumentExceptionTypePM entityPM, LeadDocumentExceptionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LeadDocumentExceptionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LeadDocumentExceptionTypePM entityPM, LeadDocumentExceptionType entityPOCO, bool isNewEntity)
        {
