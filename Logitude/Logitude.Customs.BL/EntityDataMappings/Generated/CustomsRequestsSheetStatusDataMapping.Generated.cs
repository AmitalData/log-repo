...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsRequestsSheetStatusDataMapping: IMapping<CustomsRequestsSheetStatusPM, CustomsRequestsSheetStatus>,IMappingEncodeBase64NVARCHARFields<CustomsRequestsSheetStatusPM>
   {
	    ...
	    public void PMToPOCO(CustomsRequestsSheetStatusPM entityPM, CustomsRequestsSheetStatus entityPOCO)
        {
		...
		public void POCOToPM(CustomsRequestsSheetStatusPM entityPM, CustomsRequestsSheetStatus entityPOCO)
        {
		...
		public void PMToOldPM(CustomsRequestsSheetStatusPM entityPM, CustomsRequestsSheetStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsRequestsSheetStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsRequestsSheetStatusPM entityPM, CustomsRequestsSheetStatus entityPOCO, bool isNewEntity)
        {
