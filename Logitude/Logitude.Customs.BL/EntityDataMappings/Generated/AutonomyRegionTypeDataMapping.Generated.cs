...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AutonomyRegionTypeDataMapping: IMapping<AutonomyRegionTypePM, AutonomyRegionType>,IMappingEncodeBase64NVARCHARFields<AutonomyRegionTypePM>
   {
	    ...
	    public void PMToPOCO(AutonomyRegionTypePM entityPM, AutonomyRegionType entityPOCO)
        {
		...
		public void POCOToPM(AutonomyRegionTypePM entityPM, AutonomyRegionType entityPOCO)
        {
		...
		public void PMToOldPM(AutonomyRegionTypePM entityPM, AutonomyRegionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AutonomyRegionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AutonomyRegionTypePM entityPM, AutonomyRegionType entityPOCO, bool isNewEntity)
        {
