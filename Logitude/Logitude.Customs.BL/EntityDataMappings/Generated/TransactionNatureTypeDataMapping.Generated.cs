...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TransactionNatureTypeDataMapping: IMapping<TransactionNatureTypePM, TransactionNatureType>,IMappingEncodeBase64NVARCHARFields<TransactionNatureTypePM>
   {
	    ...
	    public void PMToPOCO(TransactionNatureTypePM entityPM, TransactionNatureType entityPOCO)
        {
		...
		public void POCOToPM(TransactionNatureTypePM entityPM, TransactionNatureType entityPOCO)
        {
		...
		public void PMToOldPM(TransactionNatureTypePM entityPM, TransactionNatureTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TransactionNatureTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TransactionNatureTypePM entityPM, TransactionNatureType entityPOCO, bool isNewEntity)
        {
