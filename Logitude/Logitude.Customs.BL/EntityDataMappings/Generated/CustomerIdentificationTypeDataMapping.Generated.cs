...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerIdentificationTypeDataMapping: IMapping<CustomerIdentificationTypePM, CustomerIdentificationType>,IMappingEncodeBase64NVARCHARFields<CustomerIdentificationTypePM>
   {
	    ...
	    public void PMToPOCO(CustomerIdentificationTypePM entityPM, CustomerIdentificationType entityPOCO)
        {
		...
		public void POCOToPM(CustomerIdentificationTypePM entityPM, CustomerIdentificationType entityPOCO)
        {
		...
		public void PMToOldPM(CustomerIdentificationTypePM entityPM, CustomerIdentificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerIdentificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerIdentificationTypePM entityPM, CustomerIdentificationType entityPOCO, bool isNewEntity)
        {
