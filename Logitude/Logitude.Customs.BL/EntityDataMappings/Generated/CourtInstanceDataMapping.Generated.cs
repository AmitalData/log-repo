...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CourtInstanceDataMapping: IMapping<CourtInstancePM, CourtInstance>,IMappingEncodeBase64NVARCHARFields<CourtInstancePM>
   {
	    ...
	    public void PMToPOCO(CourtInstancePM entityPM, CourtInstance entityPOCO)
        {
		...
		public void POCOToPM(CourtInstancePM entityPM, CourtInstance entityPOCO)
        {
		...
		public void PMToOldPM(CourtInstancePM entityPM, CourtInstancePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CourtInstancePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CourtInstancePM entityPM, CourtInstance entityPOCO, bool isNewEntity)
        {
