...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsVerificationStatusTypeDataMapping: IMapping<CustomsVerificationStatusTypePM, CustomsVerificationStatusType>,IMappingEncodeBase64NVARCHARFields<CustomsVerificationStatusTypePM>
   {
	    ...
	    public void PMToPOCO(CustomsVerificationStatusTypePM entityPM, CustomsVerificationStatusType entityPOCO)
        {
		...
		public void POCOToPM(CustomsVerificationStatusTypePM entityPM, CustomsVerificationStatusType entityPOCO)
        {
		...
		public void PMToOldPM(CustomsVerificationStatusTypePM entityPM, CustomsVerificationStatusTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsVerificationStatusTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsVerificationStatusTypePM entityPM, CustomsVerificationStatusType entityPOCO, bool isNewEntity)
        {
