...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CountryGroupDataMapping: IMapping<CountryGroupPM, CountryGroup>,IMappingEncodeBase64NVARCHARFields<CountryGroupPM>
   {
	    ...
	    public void PMToPOCO(CountryGroupPM entityPM, CountryGroup entityPOCO)
        {
		...
		public void POCOToPM(CountryGroupPM entityPM, CountryGroup entityPOCO)
        {
		...
		public void PMToOldPM(CountryGroupPM entityPM, CountryGroupPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CountryGroupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CountryGroupPM entityPM, CountryGroup entityPOCO, bool isNewEntity)
        {
