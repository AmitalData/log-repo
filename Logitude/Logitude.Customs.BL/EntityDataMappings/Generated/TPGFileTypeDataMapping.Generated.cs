...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TPGFileTypeDataMapping: IMapping<TPGFileTypePM, TPGFileType>,IMappingEncodeBase64NVARCHARFields<TPGFileTypePM>
   {
	    ...
	    public void PMToPOCO(TPGFileTypePM entityPM, TPGFileType entityPOCO)
        {
		...
		public void POCOToPM(TPGFileTypePM entityPM, TPGFileType entityPOCO)
        {
		...
		public void PMToOldPM(TPGFileTypePM entityPM, TPGFileTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TPGFileTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TPGFileTypePM entityPM, TPGFileType entityPOCO, bool isNewEntity)
        {
