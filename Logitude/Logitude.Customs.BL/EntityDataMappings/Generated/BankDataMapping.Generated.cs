...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class BankDataMapping: IMapping<BankPM, Bank>,IMappingEncodeBase64NVARCHARFields<BankPM>
   {
	    ...
	    public void PMToPOCO(BankPM entityPM, Bank entityPOCO)
        {
		...
		public void POCOToPM(BankPM entityPM, Bank entityPOCO)
        {
		...
		public void PMToOldPM(BankPM entityPM, BankPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(BankPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(BankPM entityPM, Bank entityPOCO, bool isNewEntity)
        {
