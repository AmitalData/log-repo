...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CollateralRequestStatusDataMapping: IMapping<CollateralRequestStatusPM, CollateralRequestStatus>,IMappingEncodeBase64NVARCHARFields<CollateralRequestStatusPM>
   {
	    ...
	    public void PMToPOCO(CollateralRequestStatusPM entityPM, CollateralRequestStatus entityPOCO)
        {
		...
		public void POCOToPM(CollateralRequestStatusPM entityPM, CollateralRequestStatus entityPOCO)
        {
		...
		public void PMToOldPM(CollateralRequestStatusPM entityPM, CollateralRequestStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CollateralRequestStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CollateralRequestStatusPM entityPM, CollateralRequestStatus entityPOCO, bool isNewEntity)
        {
