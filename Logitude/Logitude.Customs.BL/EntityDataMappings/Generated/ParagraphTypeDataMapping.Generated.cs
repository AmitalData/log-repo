...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ParagraphTypeDataMapping: IMapping<ParagraphTypePM, ParagraphType>,IMappingEncodeBase64NVARCHARFields<ParagraphTypePM>
   {
	    ...
	    public void PMToPOCO(ParagraphTypePM entityPM, ParagraphType entityPOCO)
        {
		...
		public void POCOToPM(ParagraphTypePM entityPM, ParagraphType entityPOCO)
        {
		...
		public void PMToOldPM(ParagraphTypePM entityPM, ParagraphTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ParagraphTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ParagraphTypePM entityPM, ParagraphType entityPOCO, bool isNewEntity)
        {
