...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CarEngineVolumeDataMapping: IMapping<CarEngineVolumePM, CarEngineVolume>,IMappingEncodeBase64NVARCHARFields<CarEngineVolumePM>
   {
	    ...
	    public void PMToPOCO(CarEngineVolumePM entityPM, CarEngineVolume entityPOCO)
        {
		...
		public void POCOToPM(CarEngineVolumePM entityPM, CarEngineVolume entityPOCO)
        {
		...
		public void PMToOldPM(CarEngineVolumePM entityPM, CarEngineVolumePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CarEngineVolumePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CarEngineVolumePM entityPM, CarEngineVolume entityPOCO, bool isNewEntity)
        {
