...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class UIMessageDataMapping: IMapping<UIMessagePM, UIMessage>,IMappingEncodeBase64NVARCHARFields<UIMessagePM>
   {
	    ...
	    public void PMToPOCO(UIMessagePM entityPM, UIMessage entityPOCO)
        {
		...
		public void POCOToPM(UIMessagePM entityPM, UIMessage entityPOCO)
        {
		...
		public void PMToOldPM(UIMessagePM entityPM, UIMessagePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(UIMessagePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(UIMessagePM entityPM, UIMessage entityPOCO, bool isNewEntity)
        {
