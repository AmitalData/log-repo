...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InternalBorderSiteTypeDataMapping: IMapping<InternalBorderSiteTypePM, InternalBorderSiteType>,IMappingEncodeBase64NVARCHARFields<InternalBorderSiteTypePM>
   {
	    ...
	    public void PMToPOCO(InternalBorderSiteTypePM entityPM, InternalBorderSiteType entityPOCO)
        {
		...
		public void POCOToPM(InternalBorderSiteTypePM entityPM, InternalBorderSiteType entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InternalBorderSiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InternalBorderSiteTypePM entityPM, InternalBorderSiteType entityPOCO, bool isNewEntity)
        {
