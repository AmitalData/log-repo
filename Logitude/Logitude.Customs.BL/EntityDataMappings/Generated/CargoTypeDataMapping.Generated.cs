...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CargoTypeDataMapping: IMapping<CargoTypePM, CargoType>,IMappingEncodeBase64NVARCHARFields<CargoTypePM>
   {
	    ...
	    public void PMToPOCO(CargoTypePM entityPM, CargoType entityPOCO)
        {
		...
		public void POCOToPM(CargoTypePM entityPM, CargoType entityPOCO)
        {
		...
		public void PMToOldPM(CargoTypePM entityPM, CargoTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CargoTypePM entityPM, CargoType entityPOCO, bool isNewEntity)
        {
