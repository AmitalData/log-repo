...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleManufacturerDataMapping: IMapping<VehicleManufacturerPM, VehicleManufacturer>,IMappingEncodeBase64NVARCHARFields<VehicleManufacturerPM>
   {
	    ...
	    public void PMToPOCO(VehicleManufacturerPM entityPM, VehicleManufacturer entityPOCO)
        {
		...
		public void POCOToPM(VehicleManufacturerPM entityPM, VehicleManufacturer entityPOCO)
        {
		...
		public void PMToOldPM(VehicleManufacturerPM entityPM, VehicleManufacturerPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleManufacturerPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleManufacturerPM entityPM, VehicleManufacturer entityPOCO, bool isNewEntity)
        {
