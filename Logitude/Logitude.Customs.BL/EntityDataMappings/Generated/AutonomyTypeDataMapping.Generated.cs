...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AutonomyTypeDataMapping: IMapping<AutonomyTypePM, AutonomyType>,IMappingEncodeBase64NVARCHARFields<AutonomyTypePM>
   {
	    ...
	    public void PMToPOCO(AutonomyTypePM entityPM, AutonomyType entityPOCO)
        {
		...
		public void POCOToPM(AutonomyTypePM entityPM, AutonomyType entityPOCO)
        {
		...
		public void PMToOldPM(AutonomyTypePM entityPM, AutonomyTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AutonomyTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AutonomyTypePM entityPM, AutonomyType entityPOCO, bool isNewEntity)
        {
