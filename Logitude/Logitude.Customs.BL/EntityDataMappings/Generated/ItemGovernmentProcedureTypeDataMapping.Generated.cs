...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ItemGovernmentProcedureTypeDataMapping: IMapping<ItemGovernmentProcedureTypePM, ItemGovernmentProcedureType>,IMappingEncodeBase64NVARCHARFields<ItemGovernmentProcedureTypePM>
   {
	    ...
	    public void PMToPOCO(ItemGovernmentProcedureTypePM entityPM, ItemGovernmentProcedureType entityPOCO)
        {
		...
		public void POCOToPM(ItemGovernmentProcedureTypePM entityPM, ItemGovernmentProcedureType entityPOCO)
        {
		...
		public void PMToOldPM(ItemGovernmentProcedureTypePM entityPM, ItemGovernmentProcedureTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ItemGovernmentProcedureTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ItemGovernmentProcedureTypePM entityPM, ItemGovernmentProcedureType entityPOCO, bool isNewEntity)
        {
