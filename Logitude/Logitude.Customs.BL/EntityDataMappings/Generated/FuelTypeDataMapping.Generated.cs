...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class FuelTypeDataMapping: IMapping<FuelTypePM, FuelType>,IMappingEncodeBase64NVARCHARFields<FuelTypePM>
   {
	    ...
	    public void PMToPOCO(FuelTypePM entityPM, FuelType entityPOCO)
        {
		...
		public void POCOToPM(FuelTypePM entityPM, FuelType entityPOCO)
        {
		...
		public void PMToOldPM(FuelTypePM entityPM, FuelTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(FuelTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(FuelTypePM entityPM, FuelType entityPOCO, bool isNewEntity)
        {
