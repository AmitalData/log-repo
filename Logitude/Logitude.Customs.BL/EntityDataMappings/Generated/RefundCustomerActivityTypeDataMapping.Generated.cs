...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RefundCustomerActivityTypeDataMapping: IMapping<RefundCustomerActivityTypePM, RefundCustomerActivityType>,IMappingEncodeBase64NVARCHARFields<RefundCustomerActivityTypePM>
   {
	    ...
	    public void PMToPOCO(RefundCustomerActivityTypePM entityPM, RefundCustomerActivityType entityPOCO)
        {
		...
		public void POCOToPM(RefundCustomerActivityTypePM entityPM, RefundCustomerActivityType entityPOCO)
        {
		...
		public void PMToOldPM(RefundCustomerActivityTypePM entityPM, RefundCustomerActivityTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RefundCustomerActivityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RefundCustomerActivityTypePM entityPM, RefundCustomerActivityType entityPOCO, bool isNewEntity)
        {
