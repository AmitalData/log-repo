...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CertificatesStatusDataMapping: IMapping<CertificatesStatusPM, CertificatesStatus>,IMappingEncodeBase64NVARCHARFields<CertificatesStatusPM>
   {
	    ...
	    public void PMToPOCO(CertificatesStatusPM entityPM, CertificatesStatus entityPOCO)
        {
		...
		public void POCOToPM(CertificatesStatusPM entityPM, CertificatesStatus entityPOCO)
        {
		...
		public void PMToOldPM(CertificatesStatusPM entityPM, CertificatesStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CertificatesStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CertificatesStatusPM entityPM, CertificatesStatus entityPOCO, bool isNewEntity)
        {
