...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProceduralFaultTypeDataMapping: IMapping<ProceduralFaultTypePM, ProceduralFaultType>,IMappingEncodeBase64NVARCHARFields<ProceduralFaultTypePM>
   {
	    ...
	    public void PMToPOCO(ProceduralFaultTypePM entityPM, ProceduralFaultType entityPOCO)
        {
		...
		public void POCOToPM(ProceduralFaultTypePM entityPM, ProceduralFaultType entityPOCO)
        {
		...
		public void PMToOldPM(ProceduralFaultTypePM entityPM, ProceduralFaultTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ProceduralFaultTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ProceduralFaultTypePM entityPM, ProceduralFaultType entityPOCO, bool isNewEntity)
        {
