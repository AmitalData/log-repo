...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class GuaranteeCustomerActivityDataMapping: IMapping<GuaranteeCustomerActivityPM, GuaranteeCustomerActivity>,IMappingEncodeBase64NVARCHARFields<GuaranteeCustomerActivityPM>
   {
	    ...
	    public void PMToPOCO(GuaranteeCustomerActivityPM entityPM, GuaranteeCustomerActivity entityPOCO)
        {
		...
		public void POCOToPM(GuaranteeCustomerActivityPM entityPM, GuaranteeCustomerActivity entityPOCO)
        {
		...
		public void PMToOldPM(GuaranteeCustomerActivityPM entityPM, GuaranteeCustomerActivityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(GuaranteeCustomerActivityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(GuaranteeCustomerActivityPM entityPM, GuaranteeCustomerActivity entityPOCO, bool isNewEntity)
        {
