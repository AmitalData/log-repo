...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConstraintTypeDataMapping: IMapping<ConstraintTypePM, ConstraintType>,IMappingEncodeBase64NVARCHARFields<ConstraintTypePM>
   {
	    ...
	    public void PMToPOCO(ConstraintTypePM entityPM, ConstraintType entityPOCO)
        {
		...
		public void POCOToPM(ConstraintTypePM entityPM, ConstraintType entityPOCO)
        {
		...
		public void PMToOldPM(ConstraintTypePM entityPM, ConstraintTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ConstraintTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ConstraintTypePM entityPM, ConstraintType entityPOCO, bool isNewEntity)
        {
