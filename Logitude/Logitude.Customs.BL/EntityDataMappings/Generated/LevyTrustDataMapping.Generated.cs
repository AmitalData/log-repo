...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LevyTrustDataMapping: IMapping<LevyTrustPM, LevyTrust>,IMappingEncodeBase64NVARCHARFields<LevyTrustPM>
   {
	    ...
	    public void PMToPOCO(LevyTrustPM entityPM, LevyTrust entityPOCO)
        {
		...
		public void POCOToPM(LevyTrustPM entityPM, LevyTrust entityPOCO)
        {
		...
		public void PMToOldPM(LevyTrustPM entityPM, LevyTrustPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LevyTrustPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LevyTrustPM entityPM, LevyTrust entityPOCO, bool isNewEntity)
        {
