...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConstraintProcessTypeDataMapping: IMapping<ConstraintProcessTypePM, ConstraintProcessType>,IMappingEncodeBase64NVARCHARFields<ConstraintProcessTypePM>
   {
	    ...
	    public void PMToPOCO(ConstraintProcessTypePM entityPM, ConstraintProcessType entityPOCO)
        {
		...
		public void POCOToPM(ConstraintProcessTypePM entityPM, ConstraintProcessType entityPOCO)
        {
		...
		public void PMToOldPM(ConstraintProcessTypePM entityPM, ConstraintProcessTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ConstraintProcessTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ConstraintProcessTypePM entityPM, ConstraintProcessType entityPOCO, bool isNewEntity)
        {
