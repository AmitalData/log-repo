...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AcceptanceStatusDataMapping: IMapping<AcceptanceStatusPM, AcceptanceStatus>,IMappingEncodeBase64NVARCHARFields<AcceptanceStatusPM>
   {
	    ...
	    public void PMToPOCO(AcceptanceStatusPM entityPM, AcceptanceStatus entityPOCO)
        {
		...
		public void POCOToPM(AcceptanceStatusPM entityPM, AcceptanceStatus entityPOCO)
        {
		...
		public void PMToOldPM(AcceptanceStatusPM entityPM, AcceptanceStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AcceptanceStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AcceptanceStatusPM entityPM, AcceptanceStatus entityPOCO, bool isNewEntity)
        {
