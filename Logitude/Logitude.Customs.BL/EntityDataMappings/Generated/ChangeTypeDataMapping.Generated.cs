...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ChangeTypeDataMapping: IMapping<ChangeTypePM, ChangeType>,IMappingEncodeBase64NVARCHARFields<ChangeTypePM>
   {
	    ...
	    public void PMToPOCO(ChangeTypePM entityPM, ChangeType entityPOCO)
        {
		...
		public void POCOToPM(ChangeTypePM entityPM, ChangeType entityPOCO)
        {
		...
		public void PMToOldPM(ChangeTypePM entityPM, ChangeTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ChangeTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ChangeTypePM entityPM, ChangeType entityPOCO, bool isNewEntity)
        {
