...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsEntityStatusDataMapping: IMapping<CustomsEntityStatusPM, CustomsEntityStatus>,IMappingEncodeBase64NVARCHARFields<CustomsEntityStatusPM>
   {
	    ...
	    public void PMToPOCO(CustomsEntityStatusPM entityPM, CustomsEntityStatus entityPOCO)
        {
		...
		public void POCOToPM(CustomsEntityStatusPM entityPM, CustomsEntityStatus entityPOCO)
        {
		...
		public void PMToOldPM(CustomsEntityStatusPM entityPM, CustomsEntityStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsEntityStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsEntityStatusPM entityPM, CustomsEntityStatus entityPOCO, bool isNewEntity)
        {
