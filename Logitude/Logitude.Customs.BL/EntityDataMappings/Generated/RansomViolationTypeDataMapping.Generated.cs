...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RansomViolationTypeDataMapping: IMapping<RansomViolationTypePM, RansomViolationType>,IMappingEncodeBase64NVARCHARFields<RansomViolationTypePM>
   {
	    ...
	    public void PMToPOCO(RansomViolationTypePM entityPM, RansomViolationType entityPOCO)
        {
		...
		public void POCOToPM(RansomViolationTypePM entityPM, RansomViolationType entityPOCO)
        {
		...
		public void PMToOldPM(RansomViolationTypePM entityPM, RansomViolationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RansomViolationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RansomViolationTypePM entityPM, RansomViolationType entityPOCO, bool isNewEntity)
        {
