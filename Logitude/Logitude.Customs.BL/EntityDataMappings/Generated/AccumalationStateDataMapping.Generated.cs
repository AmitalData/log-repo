...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AccumalationStateDataMapping: IMapping<AccumalationStatePM, AccumalationState>,IMappingEncodeBase64NVARCHARFields<AccumalationStatePM>
   {
	    ...
	    public void PMToPOCO(AccumalationStatePM entityPM, AccumalationState entityPOCO)
        {
		...
		public void POCOToPM(AccumalationStatePM entityPM, AccumalationState entityPOCO)
        {
		...
		public void PMToOldPM(AccumalationStatePM entityPM, AccumalationStatePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AccumalationStatePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AccumalationStatePM entityPM, AccumalationState entityPOCO, bool isNewEntity)
        {
