...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class OcrStatusDataMapping: IMapping<OcrStatusPM, OcrStatus>,IMappingEncodeBase64NVARCHARFields<OcrStatusPM>
   {
	    ...
	    public void PMToPOCO(OcrStatusPM entityPM, OcrStatus entityPOCO)
        {
		...
		public void POCOToPM(OcrStatusPM entityPM, OcrStatus entityPOCO)
        {
		...
		public void PMToOldPM(OcrStatusPM entityPM, OcrStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(OcrStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(OcrStatusPM entityPM, OcrStatus entityPOCO, bool isNewEntity)
        {
