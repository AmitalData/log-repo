...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsBranchDataMapping: IMapping<CustomsBranchPM, CustomsBranch>,IMappingEncodeBase64NVARCHARFields<CustomsBranchPM>
   {
	    ...
	    public void PMToPOCO(CustomsBranchPM entityPM, CustomsBranch entityPOCO)
        {
		...
		public void POCOToPM(CustomsBranchPM entityPM, CustomsBranch entityPOCO)
        {
		...
		public void PMToOldPM(CustomsBranchPM entityPM, CustomsBranchPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsBranchPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsBranchPM entityPM, CustomsBranch entityPOCO, bool isNewEntity)
        {
