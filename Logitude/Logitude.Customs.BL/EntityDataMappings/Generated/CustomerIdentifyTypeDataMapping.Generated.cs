...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerIdentifyTypeDataMapping: IMapping<CustomerIdentifyTypePM, CustomerIdentifyType>,IMappingEncodeBase64NVARCHARFields<CustomerIdentifyTypePM>
   {
	    ...
	    public void PMToPOCO(CustomerIdentifyTypePM entityPM, CustomerIdentifyType entityPOCO)
        {
		...
		public void POCOToPM(CustomerIdentifyTypePM entityPM, CustomerIdentifyType entityPOCO)
        {
		...
		public void PMToOldPM(CustomerIdentifyTypePM entityPM, CustomerIdentifyTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerIdentifyTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerIdentifyTypePM entityPM, CustomerIdentifyType entityPOCO, bool isNewEntity)
        {
