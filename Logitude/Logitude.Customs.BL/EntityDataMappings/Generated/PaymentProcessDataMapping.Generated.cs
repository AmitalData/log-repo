...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentProcessDataMapping: IMapping<PaymentProcessPM, PaymentProcess>,IMappingEncodeBase64NVARCHARFields<PaymentProcessPM>
   {
	    ...
	    public void PMToPOCO(PaymentProcessPM entityPM, PaymentProcess entityPOCO)
        {
		...
		public void POCOToPM(PaymentProcessPM entityPM, PaymentProcess entityPOCO)
        {
		...
		public void PMToOldPM(PaymentProcessPM entityPM, PaymentProcessPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentProcessPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentProcessPM entityPM, PaymentProcess entityPOCO, bool isNewEntity)
        {
