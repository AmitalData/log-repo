...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CancelRequestRejectReasonTypeDataMapping: IMapping<CancelRequestRejectReasonTypePM, CancelRequestRejectReasonType>,IMappingEncodeBase64NVARCHARFields<CancelRequestRejectReasonTypePM>
   {
	    ...
	    public void PMToPOCO(CancelRequestRejectReasonTypePM entityPM, CancelRequestRejectReasonType entityPOCO)
        {
		...
		public void POCOToPM(CancelRequestRejectReasonTypePM entityPM, CancelRequestRejectReasonType entityPOCO)
        {
		...
		public void PMToOldPM(CancelRequestRejectReasonTypePM entityPM, CancelRequestRejectReasonTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CancelRequestRejectReasonTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CancelRequestRejectReasonTypePM entityPM, CancelRequestRejectReasonType entityPOCO, bool isNewEntity)
        {
