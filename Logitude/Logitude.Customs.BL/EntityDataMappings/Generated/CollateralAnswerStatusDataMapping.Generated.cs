...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CollateralAnswerStatusDataMapping: IMapping<CollateralAnswerStatusPM, CollateralAnswerStatus>,IMappingEncodeBase64NVARCHARFields<CollateralAnswerStatusPM>
   {
	    ...
	    public void PMToPOCO(CollateralAnswerStatusPM entityPM, CollateralAnswerStatus entityPOCO)
        {
		...
		public void POCOToPM(CollateralAnswerStatusPM entityPM, CollateralAnswerStatus entityPOCO)
        {
		...
		public void PMToOldPM(CollateralAnswerStatusPM entityPM, CollateralAnswerStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CollateralAnswerStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CollateralAnswerStatusPM entityPM, CollateralAnswerStatus entityPOCO, bool isNewEntity)
        {
