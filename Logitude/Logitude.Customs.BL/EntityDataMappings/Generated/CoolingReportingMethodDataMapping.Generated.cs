...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CoolingReportingMethodDataMapping: IMapping<CoolingReportingMethodPM, CoolingReportingMethod>,IMappingEncodeBase64NVARCHARFields<CoolingReportingMethodPM>
   {
	    ...
	    public void PMToPOCO(CoolingReportingMethodPM entityPM, CoolingReportingMethod entityPOCO)
        {
		...
		public void POCOToPM(CoolingReportingMethodPM entityPM, CoolingReportingMethod entityPOCO)
        {
		...
		public void PMToOldPM(CoolingReportingMethodPM entityPM, CoolingReportingMethodPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CoolingReportingMethodPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CoolingReportingMethodPM entityPM, CoolingReportingMethod entityPOCO, bool isNewEntity)
        {
