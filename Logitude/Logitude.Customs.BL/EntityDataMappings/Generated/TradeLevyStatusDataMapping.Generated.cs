...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TradeLevyStatusDataMapping: IMapping<TradeLevyStatusPM, TradeLevyStatus>,IMappingEncodeBase64NVARCHARFields<TradeLevyStatusPM>
   {
	    ...
	    public void PMToPOCO(TradeLevyStatusPM entityPM, TradeLevyStatus entityPOCO)
        {
		...
		public void POCOToPM(TradeLevyStatusPM entityPM, TradeLevyStatus entityPOCO)
        {
		...
		public void PMToOldPM(TradeLevyStatusPM entityPM, TradeLevyStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TradeLevyStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TradeLevyStatusPM entityPM, TradeLevyStatus entityPOCO, bool isNewEntity)
        {
