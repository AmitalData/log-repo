...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InvoiceTypeDataMapping: IMapping<InvoiceTypePM, InvoiceType>,IMappingEncodeBase64NVARCHARFields<InvoiceTypePM>
   {
	    ...
	    public void PMToPOCO(InvoiceTypePM entityPM, InvoiceType entityPOCO)
        {
		...
		public void POCOToPM(InvoiceTypePM entityPM, InvoiceType entityPOCO)
        {
		...
		public void PMToOldPM(InvoiceTypePM entityPM, InvoiceTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InvoiceTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InvoiceTypePM entityPM, InvoiceType entityPOCO, bool isNewEntity)
        {
