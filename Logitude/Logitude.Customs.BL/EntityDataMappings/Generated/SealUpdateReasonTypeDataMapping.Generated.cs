...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SealUpdateReasonTypeDataMapping: IMapping<SealUpdateReasonTypePM, SealUpdateReasonType>,IMappingEncodeBase64NVARCHARFields<SealUpdateReasonTypePM>
   {
		...
		public void POCOToPM(SealUpdateReasonTypePM entityPM, SealUpdateReasonType entityPOCO)
        {
		...
		public void PMToOldPM(SealUpdateReasonTypePM entityPM, SealUpdateReasonTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SealUpdateReasonTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SealUpdateReasonTypePM entityPM, SealUpdateReasonType entityPOCO, bool isNewEntity)
        {
