...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LastReleaseFromWarehouseDataMapping: IMapping<LastReleaseFromWarehousePM, LastReleaseFromWarehouse>,IMappingEncodeBase64NVARCHARFields<LastReleaseFromWarehousePM>
   {
	    ...
	    public void PMToPOCO(LastReleaseFromWarehousePM entityPM, LastReleaseFromWarehouse entityPOCO)
        {
		...
		public void POCOToPM(LastReleaseFromWarehousePM entityPM, LastReleaseFromWarehouse entityPOCO)
        {
		...
		public void PMToOldPM(LastReleaseFromWarehousePM entityPM, LastReleaseFromWarehousePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LastReleaseFromWarehousePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LastReleaseFromWarehousePM entityPM, LastReleaseFromWarehouse entityPOCO, bool isNewEntity)
        {
