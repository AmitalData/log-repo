...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InterfaceSendOptionDataMapping: IMapping<InterfaceSendOptionPM, InterfaceSendOption>,IMappingEncodeBase64NVARCHARFields<InterfaceSendOptionPM>
   {
	    ...
	    public void PMToPOCO(InterfaceSendOptionPM entityPM, InterfaceSendOption entityPOCO)
        {
		...
		public void POCOToPM(InterfaceSendOptionPM entityPM, InterfaceSendOption entityPOCO)
        {
		...
		public void PMToOldPM(InterfaceSendOptionPM entityPM, InterfaceSendOptionPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InterfaceSendOptionPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InterfaceSendOptionPM entityPM, InterfaceSendOption entityPOCO, bool isNewEntity)
        {
