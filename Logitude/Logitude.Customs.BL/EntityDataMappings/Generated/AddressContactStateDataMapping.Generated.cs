...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AddressContactStateDataMapping: IMapping<AddressContactStatePM, AddressContactState>,IMappingEncodeBase64NVARCHARFields<AddressContactStatePM>
   {
	    ...
	    public void PMToPOCO(AddressContactStatePM entityPM, AddressContactState entityPOCO)
        {
		...
		public void POCOToPM(AddressContactStatePM entityPM, AddressContactState entityPOCO)
        {
		...
		public void PMToOldPM(AddressContactStatePM entityPM, AddressContactStatePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AddressContactStatePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AddressContactStatePM entityPM, AddressContactState entityPOCO, bool isNewEntity)
        {
