...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehiclePriceListTypeDataMapping: IMapping<VehiclePriceListTypePM, VehiclePriceListType>,IMappingEncodeBase64NVARCHARFields<VehiclePriceListTypePM>
   {
	    ...
	    public void PMToPOCO(VehiclePriceListTypePM entityPM, VehiclePriceListType entityPOCO)
        {
		...
		public void POCOToPM(VehiclePriceListTypePM entityPM, VehiclePriceListType entityPOCO)
        {
		...
		public void PMToOldPM(VehiclePriceListTypePM entityPM, VehiclePriceListTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehiclePriceListTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehiclePriceListTypePM entityPM, VehiclePriceListType entityPOCO, bool isNewEntity)
        {
