...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class NbcDeclarationTypeDataMapping: IMapping<NbcDeclarationTypePM, NbcDeclarationType>,IMappingEncodeBase64NVARCHARFields<NbcDeclarationTypePM>
   {
	    ...
	    public void PMToPOCO(NbcDeclarationTypePM entityPM, NbcDeclarationType entityPOCO)
        {
		...
		public void POCOToPM(NbcDeclarationTypePM entityPM, NbcDeclarationType entityPOCO)
        {
		...
		public void PMToOldPM(NbcDeclarationTypePM entityPM, NbcDeclarationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(NbcDeclarationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(NbcDeclarationTypePM entityPM, NbcDeclarationType entityPOCO, bool isNewEntity)
        {
