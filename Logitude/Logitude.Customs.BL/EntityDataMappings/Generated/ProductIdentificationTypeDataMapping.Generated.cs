...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProductIdentificationTypeDataMapping: IMapping<ProductIdentificationTypePM, ProductIdentificationType>,IMappingEncodeBase64NVARCHARFields<ProductIdentificationTypePM>
   {
	    ...
	    public void PMToPOCO(ProductIdentificationTypePM entityPM, ProductIdentificationType entityPOCO)
        {
		...
		public void POCOToPM(ProductIdentificationTypePM entityPM, ProductIdentificationType entityPOCO)
        {
		...
		public void PMToOldPM(ProductIdentificationTypePM entityPM, ProductIdentificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ProductIdentificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ProductIdentificationTypePM entityPM, ProductIdentificationType entityPOCO, bool isNewEntity)
        {
