...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CourierStatusDataMapping: IMapping<CourierStatusPM, CourierStatus>,IMappingEncodeBase64NVARCHARFields<CourierStatusPM>
   {
	    ...
	    public void PMToPOCO(CourierStatusPM entityPM, CourierStatus entityPOCO)
        {
		...
		public void POCOToPM(CourierStatusPM entityPM, CourierStatus entityPOCO)
        {
		...
		public void PMToOldPM(CourierStatusPM entityPM, CourierStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CourierStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CourierStatusPM entityPM, CourierStatus entityPOCO, bool isNewEntity)
        {
