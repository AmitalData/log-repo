...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DeliverySiteTypeDataMapping: IMapping<DeliverySiteTypePM, DeliverySiteType>,IMappingEncodeBase64NVARCHARFields<DeliverySiteTypePM>
   {
	    ...
	    public void PMToPOCO(DeliverySiteTypePM entityPM, DeliverySiteType entityPOCO)
        {
		...
		public void POCOToPM(DeliverySiteTypePM entityPM, DeliverySiteType entityPOCO)
        {
		...
		public void PMToOldPM(DeliverySiteTypePM entityPM, DeliverySiteTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DeliverySiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DeliverySiteTypePM entityPM, DeliverySiteType entityPOCO, bool isNewEntity)
        {
