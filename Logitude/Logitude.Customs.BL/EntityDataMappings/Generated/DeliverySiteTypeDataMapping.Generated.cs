...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DeliverySiteTypeDataMapping: IMapping<DeliverySiteTypePM, POCO.DeliverySiteType>,IMappingEncodeBase64NVARCHARFields<DeliverySiteTypePM>
   {
	    ...
	    public void PMToPOCO(DeliverySiteTypePM entityPM, POCO.DeliverySiteType entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.CityId))
            {
		...
		public void POCOToPM(DeliverySiteTypePM entityPM, POCO.DeliverySiteType entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.CityId))
            {
					entityPM.CityId = entityPOCO.CityId;
            }
		...
		public void PMToOldPM(DeliverySiteTypePM entityPM, DeliverySiteTypePM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.CityId))
            {
                oldEntityPM.CityId = entityPM.CityId;
            }
		...
		private void BuildSearchFieldsGenerated(DeliverySiteTypePM entityPM, POCO.DeliverySiteType entityPOCO, bool isNewEntity)
        {
