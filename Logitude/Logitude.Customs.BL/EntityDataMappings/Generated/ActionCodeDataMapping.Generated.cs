...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ActionCodeDataMapping: IMapping<ActionCodePM, ActionCode>,IMappingEncodeBase64NVARCHARFields<ActionCodePM>
   {
	    ...
	    public void PMToPOCO(ActionCodePM entityPM, ActionCode entityPOCO)
        {
		...
		public void POCOToPM(ActionCodePM entityPM, ActionCode entityPOCO)
        {
		...
		public void PMToOldPM(ActionCodePM entityPM, ActionCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ActionCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ActionCodePM entityPM, ActionCode entityPOCO, bool isNewEntity)
        {
