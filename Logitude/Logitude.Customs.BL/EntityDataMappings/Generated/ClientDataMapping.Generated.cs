...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ClientDataMapping: IMapping<ClientPM, POCO.Client>,IMappingEncodeBase64NVARCHARFields<ClientPM>
   {
	    ...
	    public void PMToPOCO(ClientPM entityPM, POCO.Client entityPOCO)
        {
		...
		public void POCOToPM(ClientPM entityPM, POCO.Client entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ClientPM entityPM, POCO.Client entityPOCO, bool isNewEntity)
        {
