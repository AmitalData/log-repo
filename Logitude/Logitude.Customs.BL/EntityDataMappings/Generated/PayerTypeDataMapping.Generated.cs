...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PayerTypeDataMapping: IMapping<PayerTypePM, PayerType>,IMappingEncodeBase64NVARCHARFields<PayerTypePM>
   {
	    ...
	    public void PMToPOCO(PayerTypePM entityPM, PayerType entityPOCO)
        {
		...
		public void POCOToPM(PayerTypePM entityPM, PayerType entityPOCO)
        {
		...
		public void PMToOldPM(PayerTypePM entityPM, PayerTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PayerTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PayerTypePM entityPM, PayerType entityPOCO, bool isNewEntity)
        {
