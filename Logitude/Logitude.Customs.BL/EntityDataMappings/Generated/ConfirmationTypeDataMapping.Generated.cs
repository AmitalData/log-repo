...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConfirmationTypeDataMapping: IMapping<ConfirmationTypePM, ConfirmationType>,IMappingEncodeBase64NVARCHARFields<ConfirmationTypePM>
   {
	    ...
	    public void PMToPOCO(ConfirmationTypePM entityPM, ConfirmationType entityPOCO)
        {
		...
		public void POCOToPM(ConfirmationTypePM entityPM, ConfirmationType entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ConfirmationTypePM entityPM, ConfirmationType entityPOCO, bool isNewEntity)
        {
