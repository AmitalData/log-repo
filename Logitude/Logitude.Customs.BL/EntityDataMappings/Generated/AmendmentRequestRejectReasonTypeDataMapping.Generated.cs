...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AmendRequestRejectReasonTypeDataMapping: IMapping<AmendRequestRejectReasonTypePM, AmendRequestRejectReasonType>,IMappingEncodeBase64NVARCHARFields<AmendRequestRejectReasonTypePM>
   {
	    ...
	    public void PMToPOCO(AmendRequestRejectReasonTypePM entityPM, AmendRequestRejectReasonType entityPOCO)
        {
		...
		public void POCOToPM(AmendRequestRejectReasonTypePM entityPM, AmendRequestRejectReasonType entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(AmendRequestRejectReasonTypePM entityPM, AmendRequestRejectReasonType entityPOCO, bool isNewEntity)
        {
