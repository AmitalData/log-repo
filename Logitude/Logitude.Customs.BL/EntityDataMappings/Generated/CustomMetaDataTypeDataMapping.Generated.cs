...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomMetaDataTypeDataMapping: IMapping<CustomMetaDataTypePM, CustomMetaDataType>,IMappingEncodeBase64NVARCHARFields<CustomMetaDataTypePM>
   {
	    ...
	    public void PMToPOCO(CustomMetaDataTypePM entityPM, CustomMetaDataType entityPOCO)
        {
		...
		public void POCOToPM(CustomMetaDataTypePM entityPM, CustomMetaDataType entityPOCO)
        {
		...
		public void PMToOldPM(CustomMetaDataTypePM entityPM, CustomMetaDataTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomMetaDataTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomMetaDataTypePM entityPM, CustomMetaDataType entityPOCO, bool isNewEntity)
        {
