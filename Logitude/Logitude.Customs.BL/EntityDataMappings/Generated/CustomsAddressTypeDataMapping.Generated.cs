...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsAddressTypeDataMapping: IMapping<CustomsAddressTypePM, CustomsAddressType>,IMappingEncodeBase64NVARCHARFields<CustomsAddressTypePM>
   {
	    ...
	    public void PMToPOCO(CustomsAddressTypePM entityPM, CustomsAddressType entityPOCO)
        {
		...
		public void POCOToPM(CustomsAddressTypePM entityPM, CustomsAddressType entityPOCO)
        {
		...
		public void PMToOldPM(CustomsAddressTypePM entityPM, CustomsAddressTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsAddressTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsAddressTypePM entityPM, CustomsAddressType entityPOCO, bool isNewEntity)
        {
