...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AttachmentTypeDataMapping: IMapping<AttachmentTypePM, AttachmentType>,IMappingEncodeBase64NVARCHARFields<AttachmentTypePM>
   {
	    ...
	    public void PMToPOCO(AttachmentTypePM entityPM, AttachmentType entityPOCO)
        {
		...
		public void POCOToPM(AttachmentTypePM entityPM, AttachmentType entityPOCO)
        {
		...
		public void PMToOldPM(AttachmentTypePM entityPM, AttachmentTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AttachmentTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AttachmentTypePM entityPM, AttachmentType entityPOCO, bool isNewEntity)
        {
