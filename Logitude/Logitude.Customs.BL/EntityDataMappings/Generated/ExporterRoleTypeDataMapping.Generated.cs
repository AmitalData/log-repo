...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ExporterRoleTypeDataMapping: IMapping<ExporterRoleTypePM, ExporterRoleType>,IMappingEncodeBase64NVARCHARFields<ExporterRoleTypePM>
   {
	    ...
	    public void PMToPOCO(ExporterRoleTypePM entityPM, ExporterRoleType entityPOCO)
        {
		...
		public void POCOToPM(ExporterRoleTypePM entityPM, ExporterRoleType entityPOCO)
        {
		...
		public void PMToOldPM(ExporterRoleTypePM entityPM, ExporterRoleTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ExporterRoleTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ExporterRoleTypePM entityPM, ExporterRoleType entityPOCO, bool isNewEntity)
        {
