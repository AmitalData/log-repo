...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConverterTypeDataMapping: IMapping<ConverterTypePM, ConverterType>,IMappingEncodeBase64NVARCHARFields<ConverterTypePM>
   {
	    ...
	    public void PMToPOCO(ConverterTypePM entityPM, ConverterType entityPOCO)
        {
		...
		public void POCOToPM(ConverterTypePM entityPM, ConverterType entityPOCO)
        {
		...
		public void PMToOldPM(ConverterTypePM entityPM, ConverterTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ConverterTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ConverterTypePM entityPM, ConverterType entityPOCO, bool isNewEntity)
        {
