...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TransportMeansTypeDataMapping: IMapping<TransportMeansTypePM, TransportMeansType>,IMappingEncodeBase64NVARCHARFields<TransportMeansTypePM>
   {
	    ...
	    public void PMToPOCO(TransportMeansTypePM entityPM, TransportMeansType entityPOCO)
        {
		...
		public void POCOToPM(TransportMeansTypePM entityPM, TransportMeansType entityPOCO)
        {
		...
		public void PMToOldPM(TransportMeansTypePM entityPM, TransportMeansTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TransportMeansTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TransportMeansTypePM entityPM, TransportMeansType entityPOCO, bool isNewEntity)
        {
