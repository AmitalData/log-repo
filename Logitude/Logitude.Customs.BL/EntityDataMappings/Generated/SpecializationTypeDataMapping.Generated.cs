...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SpecializationTypeDataMapping: IMapping<SpecializationTypePM, SpecializationType>,IMappingEncodeBase64NVARCHARFields<SpecializationTypePM>
   {
	    ...
	    public void PMToPOCO(SpecializationTypePM entityPM, SpecializationType entityPOCO)
        {
		...
		public void POCOToPM(SpecializationTypePM entityPM, SpecializationType entityPOCO)
        {
		...
		public void PMToOldPM(SpecializationTypePM entityPM, SpecializationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SpecializationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SpecializationTypePM entityPM, SpecializationType entityPOCO, bool isNewEntity)
        {
