...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TermsOfSaleTypeDataMapping: IMapping<TermsOfSaleTypePM, TermsOfSaleType>,IMappingEncodeBase64NVARCHARFields<TermsOfSaleTypePM>
   {
	    ...
	    public void PMToPOCO(TermsOfSaleTypePM entityPM, TermsOfSaleType entityPOCO)
        {
		...
		public void POCOToPM(TermsOfSaleTypePM entityPM, TermsOfSaleType entityPOCO)
        {
		...
		public void PMToOldPM(TermsOfSaleTypePM entityPM, TermsOfSaleTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TermsOfSaleTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TermsOfSaleTypePM entityPM, TermsOfSaleType entityPOCO, bool isNewEntity)
        {
