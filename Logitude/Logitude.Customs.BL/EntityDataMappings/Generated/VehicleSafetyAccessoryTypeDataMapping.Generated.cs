...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleSafetyAccessoryTypeDataMapping: IMapping<VehicleSafetyAccessoryTypePM, VehicleSafetyAccessoryType>,IMappingEncodeBase64NVARCHARFields<VehicleSafetyAccessoryTypePM>
   {
	    ...
	    public void PMToPOCO(VehicleSafetyAccessoryTypePM entityPM, VehicleSafetyAccessoryType entityPOCO)
        {
		...
		public void POCOToPM(VehicleSafetyAccessoryTypePM entityPM, VehicleSafetyAccessoryType entityPOCO)
        {
		...
		public void PMToOldPM(VehicleSafetyAccessoryTypePM entityPM, VehicleSafetyAccessoryTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleSafetyAccessoryTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleSafetyAccessoryTypePM entityPM, VehicleSafetyAccessoryType entityPOCO, bool isNewEntity)
        {
