...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InceptionCodeDataMapping: IMapping<InceptionCodePM, InceptionCode>,IMappingEncodeBase64NVARCHARFields<InceptionCodePM>
   {
	    ...
	    public void PMToPOCO(InceptionCodePM entityPM, InceptionCode entityPOCO)
        {
		...
		public void POCOToPM(InceptionCodePM entityPM, InceptionCode entityPOCO)
        {
		...
		public void PMToOldPM(InceptionCodePM entityPM, InceptionCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InceptionCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InceptionCodePM entityPM, InceptionCode entityPOCO, bool isNewEntity)
        {
