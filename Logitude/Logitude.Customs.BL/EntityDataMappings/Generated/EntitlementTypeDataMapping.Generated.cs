...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class EntitlementTypeDataMapping: IMapping<EntitlementTypePM, EntitlementType>,IMappingEncodeBase64NVARCHARFields<EntitlementTypePM>
   {
	    ...
	    public void PMToPOCO(EntitlementTypePM entityPM, EntitlementType entityPOCO)
        {
		...
		public void POCOToPM(EntitlementTypePM entityPM, EntitlementType entityPOCO)
        {
		...
		public void PMToOldPM(EntitlementTypePM entityPM, EntitlementTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(EntitlementTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(EntitlementTypePM entityPM, EntitlementType entityPOCO, bool isNewEntity)
        {
