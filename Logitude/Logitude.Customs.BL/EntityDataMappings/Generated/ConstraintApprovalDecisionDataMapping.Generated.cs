...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ConstraintApprovalDecisionDataMapping: IMapping<ConstraintApprovalDecisionPM, ConstraintApprovalDecision>,IMappingEncodeBase64NVARCHARFields<ConstraintApprovalDecisionPM>
   {
	    ...
	    public void PMToPOCO(ConstraintApprovalDecisionPM entityPM, ConstraintApprovalDecision entityPOCO)
        {
		...
		public void POCOToPM(ConstraintApprovalDecisionPM entityPM, ConstraintApprovalDecision entityPOCO)
        {
		...
		public void PMToOldPM(ConstraintApprovalDecisionPM entityPM, ConstraintApprovalDecisionPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ConstraintApprovalDecisionPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ConstraintApprovalDecisionPM entityPM, ConstraintApprovalDecision entityPOCO, bool isNewEntity)
        {
