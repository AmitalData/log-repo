...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AssigneeNotificationTypeDataMapping: IMapping<AssigneeNotificationTypePM, AssigneeNotificationType>,IMappingEncodeBase64NVARCHARFields<AssigneeNotificationTypePM>
   {
	    ...
	    public void PMToPOCO(AssigneeNotificationTypePM entityPM, AssigneeNotificationType entityPOCO)
        {
		...
		public void POCOToPM(AssigneeNotificationTypePM entityPM, AssigneeNotificationType entityPOCO)
        {
		...
		public void PMToOldPM(AssigneeNotificationTypePM entityPM, AssigneeNotificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AssigneeNotificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AssigneeNotificationTypePM entityPM, AssigneeNotificationType entityPOCO, bool isNewEntity)
        {
