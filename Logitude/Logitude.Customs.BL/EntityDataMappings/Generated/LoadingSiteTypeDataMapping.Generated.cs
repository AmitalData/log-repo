...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LoadingSiteTypeDataMapping: IMapping<LoadingSiteTypePM, LoadingSiteType>,IMappingEncodeBase64NVARCHARFields<LoadingSiteTypePM>
   {
	    ...
	    public void PMToPOCO(LoadingSiteTypePM entityPM, LoadingSiteType entityPOCO)
        {
		...
		public void POCOToPM(LoadingSiteTypePM entityPM, LoadingSiteType entityPOCO)
        {
		...
		public void PMToOldPM(LoadingSiteTypePM entityPM, LoadingSiteTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LoadingSiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LoadingSiteTypePM entityPM, LoadingSiteType entityPOCO, bool isNewEntity)
        {
