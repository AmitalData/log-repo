...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ReferenceStatusDataMapping: IMapping<ReferenceStatusPM, ReferenceStatus>,IMappingEncodeBase64NVARCHARFields<ReferenceStatusPM>
   {
	    ...
	    public void PMToPOCO(ReferenceStatusPM entityPM, ReferenceStatus entityPOCO)
        {
		...
		public void POCOToPM(ReferenceStatusPM entityPM, ReferenceStatus entityPOCO)
        {
		...
		public void PMToOldPM(ReferenceStatusPM entityPM, ReferenceStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ReferenceStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ReferenceStatusPM entityPM, ReferenceStatus entityPOCO, bool isNewEntity)
        {
