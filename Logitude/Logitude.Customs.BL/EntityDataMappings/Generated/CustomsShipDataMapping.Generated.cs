...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsShipDataMapping: IMapping<CustomsShipPM, CustomsShip>,IMappingEncodeBase64NVARCHARFields<CustomsShipPM>
   {
	    ...
	    public void PMToPOCO(CustomsShipPM entityPM, CustomsShip entityPOCO)
        {
		...
		public void POCOToPM(CustomsShipPM entityPM, CustomsShip entityPOCO)
        {
		...
		public void PMToOldPM(CustomsShipPM entityPM, CustomsShipPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsShipPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsShipPM entityPM, CustomsShip entityPOCO, bool isNewEntity)
        {
