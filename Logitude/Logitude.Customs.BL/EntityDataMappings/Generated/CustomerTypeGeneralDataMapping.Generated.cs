...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerTypeGeneralDataMapping: IMapping<CustomerTypeGeneralPM, CustomerTypeGeneral>,IMappingEncodeBase64NVARCHARFields<CustomerTypeGeneralPM>
   {
	    ...
	    public void PMToPOCO(CustomerTypeGeneralPM entityPM, CustomerTypeGeneral entityPOCO)
        {
		...
		public void POCOToPM(CustomerTypeGeneralPM entityPM, CustomerTypeGeneral entityPOCO)
        {
		...
		public void PMToOldPM(CustomerTypeGeneralPM entityPM, CustomerTypeGeneralPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerTypeGeneralPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerTypeGeneralPM entityPM, CustomerTypeGeneral entityPOCO, bool isNewEntity)
        {
