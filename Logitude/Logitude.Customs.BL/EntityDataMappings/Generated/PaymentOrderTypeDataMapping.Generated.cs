...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentOrderTypeDataMapping: IMapping<PaymentOrderTypePM, PaymentOrderType>,IMappingEncodeBase64NVARCHARFields<PaymentOrderTypePM>
   {
	    ...
	    public void PMToPOCO(PaymentOrderTypePM entityPM, PaymentOrderType entityPOCO)
        {
		...
		public void POCOToPM(PaymentOrderTypePM entityPM, PaymentOrderType entityPOCO)
        {
		...
		public void PMToOldPM(PaymentOrderTypePM entityPM, PaymentOrderTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentOrderTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentOrderTypePM entityPM, PaymentOrderType entityPOCO, bool isNewEntity)
        {
