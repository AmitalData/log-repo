...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DepositCustomerActivityDataMapping: IMapping<DepositCustomerActivityPM, DepositCustomerActivity>,IMappingEncodeBase64NVARCHARFields<DepositCustomerActivityPM>
   {
	    ...
	    public void PMToPOCO(DepositCustomerActivityPM entityPM, DepositCustomerActivity entityPOCO)
        {
		...
		public void POCOToPM(DepositCustomerActivityPM entityPM, DepositCustomerActivity entityPOCO)
        {
		...
		public void PMToOldPM(DepositCustomerActivityPM entityPM, DepositCustomerActivityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DepositCustomerActivityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DepositCustomerActivityPM entityPM, DepositCustomerActivity entityPOCO, bool isNewEntity)
        {
