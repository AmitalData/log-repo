...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class AmendCancellRequestInitiatorDataMapping: IMapping<AmendCancellRequestInitiatorPM, AmendCancellRequestInitiator>,IMappingEncodeBase64NVARCHARFields<AmendCancellRequestInitiatorPM>
   {
	    ...
	    public void PMToPOCO(AmendCancellRequestInitiatorPM entityPM, AmendCancellRequestInitiator entityPOCO)
        {
		...
		public void POCOToPM(AmendCancellRequestInitiatorPM entityPM, AmendCancellRequestInitiator entityPOCO)
        {
		...
		public void PMToOldPM(AmendCancellRequestInitiatorPM entityPM, AmendCancellRequestInitiatorPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AmendCancellRequestInitiatorPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AmendCancellRequestInitiatorPM entityPM, AmendCancellRequestInitiator entityPOCO, bool isNewEntity)
        {
