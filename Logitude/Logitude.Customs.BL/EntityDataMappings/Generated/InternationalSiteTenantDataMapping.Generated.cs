...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class InternationalSiteTenantDataMapping: IMapping<InternationalSiteTenantPM, InternationalSiteTenant>,IMappingEncodeBase64NVARCHARFields<InternationalSiteTenantPM>
   {
	    ...
	    public void PMToPOCO(InternationalSiteTenantPM entityPM, InternationalSiteTenant entityPOCO)
        {
		...
		public void POCOToPM(InternationalSiteTenantPM entityPM, InternationalSiteTenant entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(InternationalSiteTenantPM entityPM, InternationalSiteTenant entityPOCO, bool isNewEntity)
        {
