...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CargoStatusDataMapping: IMapping<CargoStatusPM, CargoStatus>,IMappingEncodeBase64NVARCHARFields<CargoStatusPM>
   {
	    ...
	    public void PMToPOCO(CargoStatusPM entityPM, CargoStatus entityPOCO)
        {
		...
		public void POCOToPM(CargoStatusPM entityPM, CargoStatus entityPOCO)
        {
		...
		public void PMToOldPM(CargoStatusPM entityPM, CargoStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CargoStatusPM entityPM, CargoStatus entityPOCO, bool isNewEntity)
        {
