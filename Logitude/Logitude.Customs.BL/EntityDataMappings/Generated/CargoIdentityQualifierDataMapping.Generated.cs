...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CargoIdentityQualifierDataMapping: IMapping<CargoIdentityQualifierPM, CargoIdentityQualifier>,IMappingEncodeBase64NVARCHARFields<CargoIdentityQualifierPM>
   {
	    ...
	    public void PMToPOCO(CargoIdentityQualifierPM entityPM, CargoIdentityQualifier entityPOCO)
        {
		...
		public void POCOToPM(CargoIdentityQualifierPM entityPM, CargoIdentityQualifier entityPOCO)
        {
		...
		public void PMToOldPM(CargoIdentityQualifierPM entityPM, CargoIdentityQualifierPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoIdentityQualifierPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CargoIdentityQualifierPM entityPM, CargoIdentityQualifier entityPOCO, bool isNewEntity)
        {
