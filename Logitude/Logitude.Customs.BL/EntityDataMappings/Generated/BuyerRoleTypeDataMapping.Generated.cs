...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class BuyerRoleTypeDataMapping: IMapping<BuyerRoleTypePM, BuyerRoleType>,IMappingEncodeBase64NVARCHARFields<BuyerRoleTypePM>
   {
	    ...
	    public void PMToPOCO(BuyerRoleTypePM entityPM, BuyerRoleType entityPOCO)
        {
		...
		public void POCOToPM(BuyerRoleTypePM entityPM, BuyerRoleType entityPOCO)
        {
		...
		public void PMToOldPM(BuyerRoleTypePM entityPM, BuyerRoleTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(BuyerRoleTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(BuyerRoleTypePM entityPM, BuyerRoleType entityPOCO, bool isNewEntity)
        {
