...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CityDataMapping: IMapping<CityPM, City>,IMappingEncodeBase64NVARCHARFields<CityPM>
   {
	    ...
	    public void PMToPOCO(CityPM entityPM, City entityPOCO)
        {
		...
		public void POCOToPM(CityPM entityPM, City entityPOCO)
        {
		...
		public void PMToOldPM(CityPM entityPM, CityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CityPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CityPM entityPM, City entityPOCO, bool isNewEntity)
        {
