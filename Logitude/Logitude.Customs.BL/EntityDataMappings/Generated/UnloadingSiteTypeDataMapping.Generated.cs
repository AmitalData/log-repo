...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class UnloadingSiteTypeDataMapping: IMapping<UnloadingSiteTypePM, UnloadingSiteType>,IMappingEncodeBase64NVARCHARFields<UnloadingSiteTypePM>
   {
	    ...
	    public void PMToPOCO(UnloadingSiteTypePM entityPM, UnloadingSiteType entityPOCO)
        {
		...
		public void POCOToPM(UnloadingSiteTypePM entityPM, UnloadingSiteType entityPOCO)
        {
		...
		public void PMToOldPM(UnloadingSiteTypePM entityPM, UnloadingSiteTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(UnloadingSiteTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(UnloadingSiteTypePM entityPM, UnloadingSiteType entityPOCO, bool isNewEntity)
        {
