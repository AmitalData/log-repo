...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ProcessingReasonDataMapping: IMapping<ProcessingReasonPM, ProcessingReason>,IMappingEncodeBase64NVARCHARFields<ProcessingReasonPM>
   {
	    ...
	    public void PMToPOCO(ProcessingReasonPM entityPM, ProcessingReason entityPOCO)
        {
		...
		public void POCOToPM(ProcessingReasonPM entityPM, ProcessingReason entityPOCO)
        {
		...
		public void PMToOldPM(ProcessingReasonPM entityPM, ProcessingReasonPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ProcessingReasonPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ProcessingReasonPM entityPM, ProcessingReason entityPOCO, bool isNewEntity)
        {
