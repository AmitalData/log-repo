...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CheckQueueTypeDataMapping: IMapping<CheckQueueTypePM, CheckQueueType>,IMappingEncodeBase64NVARCHARFields<CheckQueueTypePM>
   {
	    ...
	    public void PMToPOCO(CheckQueueTypePM entityPM, CheckQueueType entityPOCO)
        {
		...
		public void POCOToPM(CheckQueueTypePM entityPM, CheckQueueType entityPOCO)
        {
		...
		public void PMToOldPM(CheckQueueTypePM entityPM, CheckQueueTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CheckQueueTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CheckQueueTypePM entityPM, CheckQueueType entityPOCO, bool isNewEntity)
        {
