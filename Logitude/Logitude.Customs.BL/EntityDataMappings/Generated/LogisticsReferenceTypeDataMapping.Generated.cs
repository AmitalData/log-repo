...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LogisticsReferenceTypeDataMapping: IMapping<LogisticsReferenceTypePM, LogisticsReferenceType>,IMappingEncodeBase64NVARCHARFields<LogisticsReferenceTypePM>
   {
	    ...
	    public void PMToPOCO(LogisticsReferenceTypePM entityPM, LogisticsReferenceType entityPOCO)
        {
		...
		public void POCOToPM(LogisticsReferenceTypePM entityPM, LogisticsReferenceType entityPOCO)
        {
		...
		public void PMToOldPM(LogisticsReferenceTypePM entityPM, LogisticsReferenceTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LogisticsReferenceTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LogisticsReferenceTypePM entityPM, LogisticsReferenceType entityPOCO, bool isNewEntity)
        {
