...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsHouseTypeDataMapping: IMapping<CustomsHouseTypePM, CustomsHouseType>,IMappingEncodeBase64NVARCHARFields<CustomsHouseTypePM>
   {
	    ...
	    public void PMToPOCO(CustomsHouseTypePM entityPM, CustomsHouseType entityPOCO)
        {
		...
		public void POCOToPM(CustomsHouseTypePM entityPM, CustomsHouseType entityPOCO)
        {
		...
		public void PMToOldPM(CustomsHouseTypePM entityPM, CustomsHouseTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsHouseTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsHouseTypePM entityPM, CustomsHouseType entityPOCO, bool isNewEntity)
        {
