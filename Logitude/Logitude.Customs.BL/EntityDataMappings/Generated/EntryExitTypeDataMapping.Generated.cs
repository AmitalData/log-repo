...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class EntryExitTypeDataMapping: IMapping<EntryExitTypePM, EntryExitType>,IMappingEncodeBase64NVARCHARFields<EntryExitTypePM>
   {
	    ...
	    public void PMToPOCO(EntryExitTypePM entityPM, EntryExitType entityPOCO)
        {
		...
		public void POCOToPM(EntryExitTypePM entityPM, EntryExitType entityPOCO)
        {
		...
		public void PMToOldPM(EntryExitTypePM entityPM, EntryExitTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(EntryExitTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(EntryExitTypePM entityPM, EntryExitType entityPOCO, bool isNewEntity)
        {
