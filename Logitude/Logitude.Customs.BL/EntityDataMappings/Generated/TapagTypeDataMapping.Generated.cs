...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TapagTypeDataMapping: IMapping<TapagTypePM, TapagType>,IMappingEncodeBase64NVARCHARFields<TapagTypePM>
   {
	    ...
	    public void PMToPOCO(TapagTypePM entityPM, TapagType entityPOCO)
        {
		...
		public void POCOToPM(TapagTypePM entityPM, TapagType entityPOCO)
        {
		...
		public void PMToOldPM(TapagTypePM entityPM, TapagTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TapagTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TapagTypePM entityPM, TapagType entityPOCO, bool isNewEntity)
        {
