...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomerRoleTypeDataMapping: IMapping<CustomerRoleTypePM, CustomerRoleType>,IMappingEncodeBase64NVARCHARFields<CustomerRoleTypePM>
   {
	    ...
	    public void PMToPOCO(CustomerRoleTypePM entityPM, CustomerRoleType entityPOCO)
        {
		...
		public void POCOToPM(CustomerRoleTypePM entityPM, CustomerRoleType entityPOCO)
        {
		...
		public void PMToOldPM(CustomerRoleTypePM entityPM, CustomerRoleTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomerRoleTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomerRoleTypePM entityPM, CustomerRoleType entityPOCO, bool isNewEntity)
        {
