...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class FreightPaymentMethodDataMapping: IMapping<FreightPaymentMethodPM, FreightPaymentMethod>,IMappingEncodeBase64NVARCHARFields<FreightPaymentMethodPM>
   {
	    ...
	    public void PMToPOCO(FreightPaymentMethodPM entityPM, FreightPaymentMethod entityPOCO)
        {
		...
		public void POCOToPM(FreightPaymentMethodPM entityPM, FreightPaymentMethod entityPOCO)
        {
		...
		public void PMToOldPM(FreightPaymentMethodPM entityPM, FreightPaymentMethodPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(FreightPaymentMethodPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(FreightPaymentMethodPM entityPM, FreightPaymentMethod entityPOCO, bool isNewEntity)
        {
