...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsPaymentTermDataMapping: IMapping<CustomsPaymentTermPM, CustomsPaymentTerm>,IMappingEncodeBase64NVARCHARFields<CustomsPaymentTermPM>
   {
	    ...
	    public void PMToPOCO(CustomsPaymentTermPM entityPM, CustomsPaymentTerm entityPOCO)
        {
		...
		public void POCOToPM(CustomsPaymentTermPM entityPM, CustomsPaymentTerm entityPOCO)
        {
		...
		public void PMToOldPM(CustomsPaymentTermPM entityPM, CustomsPaymentTermPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsPaymentTermPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsPaymentTermPM entityPM, CustomsPaymentTerm entityPOCO, bool isNewEntity)
        {
