...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RequestStatusDataMapping: IMapping<RequestStatusPM, RequestStatus>,IMappingEncodeBase64NVARCHARFields<RequestStatusPM>
   {
	    ...
	    public void PMToPOCO(RequestStatusPM entityPM, RequestStatus entityPOCO)
        {
		...
		public void POCOToPM(RequestStatusPM entityPM, RequestStatus entityPOCO)
        {
		...
		public void PMToOldPM(RequestStatusPM entityPM, RequestStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RequestStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RequestStatusPM entityPM, RequestStatus entityPOCO, bool isNewEntity)
        {
