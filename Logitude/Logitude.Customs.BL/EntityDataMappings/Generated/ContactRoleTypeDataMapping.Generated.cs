...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ContactRoleTypeDataMapping: IMapping<ContactRoleTypePM, ContactRoleType>,IMappingEncodeBase64NVARCHARFields<ContactRoleTypePM>
   {
	    ...
	    public void PMToPOCO(ContactRoleTypePM entityPM, ContactRoleType entityPOCO)
        {
		...
		public void POCOToPM(ContactRoleTypePM entityPM, ContactRoleType entityPOCO)
        {
		...
		public void PMToOldPM(ContactRoleTypePM entityPM, ContactRoleTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ContactRoleTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ContactRoleTypePM entityPM, ContactRoleType entityPOCO, bool isNewEntity)
        {
