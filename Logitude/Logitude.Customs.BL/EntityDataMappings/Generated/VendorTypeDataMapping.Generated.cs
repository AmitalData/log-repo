...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VendorTypeDataMapping: IMapping<VendorTypePM, VendorType>,IMappingEncodeBase64NVARCHARFields<VendorTypePM>
   {
	    ...
	    public void PMToPOCO(VendorTypePM entityPM, VendorType entityPOCO)
        {
		...
		public void POCOToPM(VendorTypePM entityPM, VendorType entityPOCO)
        {
		...
		public void PMToOldPM(VendorTypePM entityPM, VendorTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VendorTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VendorTypePM entityPM, VendorType entityPOCO, bool isNewEntity)
        {
