...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RegularityRequirementWarningDataMapping: IMapping<RegularityRequirementWarningPM, RegularityRequirementWarning>,IMappingEncodeBase64NVARCHARFields<RegularityRequirementWarningPM>
   {
	    ...
	    public void PMToPOCO(RegularityRequirementWarningPM entityPM, RegularityRequirementWarning entityPOCO)
        {
		...
		public void POCOToPM(RegularityRequirementWarningPM entityPM, RegularityRequirementWarning entityPOCO)
        {
		...
		public void PMToOldPM(RegularityRequirementWarningPM entityPM, RegularityRequirementWarningPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RegularityRequirementWarningPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RegularityRequirementWarningPM entityPM, RegularityRequirementWarning entityPOCO, bool isNewEntity)
        {
