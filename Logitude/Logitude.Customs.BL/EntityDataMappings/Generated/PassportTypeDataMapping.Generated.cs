...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PassportTypeDataMapping: IMapping<PassportTypePM, PassportType>,IMappingEncodeBase64NVARCHARFields<PassportTypePM>
   {
	    ...
	    public void PMToPOCO(PassportTypePM entityPM, PassportType entityPOCO)
        {
		...
		public void POCOToPM(PassportTypePM entityPM, PassportType entityPOCO)
        {
		...
		public void PMToOldPM(PassportTypePM entityPM, PassportTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PassportTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PassportTypePM entityPM, PassportType entityPOCO, bool isNewEntity)
        {
