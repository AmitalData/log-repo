...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ImporterPeriodicDeclarStatusDataMapping: IMapping<ImporterPeriodicDeclarStatusPM, ImporterPeriodicDeclarStatus>,IMappingEncodeBase64NVARCHARFields<ImporterPeriodicDeclarStatusPM>
   {
	    ...
	    public void PMToPOCO(ImporterPeriodicDeclarStatusPM entityPM, ImporterPeriodicDeclarStatus entityPOCO)
        {
		...
		public void POCOToPM(ImporterPeriodicDeclarStatusPM entityPM, ImporterPeriodicDeclarStatus entityPOCO)
        {
		...
		public void PMToOldPM(ImporterPeriodicDeclarStatusPM entityPM, ImporterPeriodicDeclarStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ImporterPeriodicDeclarStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ImporterPeriodicDeclarStatusPM entityPM, ImporterPeriodicDeclarStatus entityPOCO, bool isNewEntity)
        {
