...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentProtestTypeDataMapping: IMapping<PaymentProtestTypePM, PaymentProtestType>,IMappingEncodeBase64NVARCHARFields<PaymentProtestTypePM>
   {
	    ...
	    public void PMToPOCO(PaymentProtestTypePM entityPM, PaymentProtestType entityPOCO)
        {
		...
		public void POCOToPM(PaymentProtestTypePM entityPM, PaymentProtestType entityPOCO)
        {
		...
		public void PMToOldPM(PaymentProtestTypePM entityPM, PaymentProtestTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentProtestTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentProtestTypePM entityPM, PaymentProtestType entityPOCO, bool isNewEntity)
        {
