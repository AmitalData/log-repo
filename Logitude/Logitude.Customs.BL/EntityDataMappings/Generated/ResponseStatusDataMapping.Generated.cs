...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CargoSplitRequestStatusDataMapping: IMapping<CargoSplitRequestStatusPM, CargoSplitRequestStatus>,IMappingEncodeBase64NVARCHARFields<CargoSplitRequestStatusPM>
   {
	    ...
	    public void PMToPOCO(CargoSplitRequestStatusPM entityPM, CargoSplitRequestStatus entityPOCO)
        {
		...
		public void POCOToPM(CargoSplitRequestStatusPM entityPM, CargoSplitRequestStatus entityPOCO)
        {
		...
		public void PMToOldPM(CargoSplitRequestStatusPM entityPM, CargoSplitRequestStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoSplitRequestStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CargoSplitRequestStatusPM entityPM, CargoSplitRequestStatus entityPOCO, bool isNewEntity)
        {
