...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SIIDocumentTypeDataMapping: IMapping<SIIDocumentTypePM, SIIDocumentType>,IMappingEncodeBase64NVARCHARFields<SIIDocumentTypePM>
   {
	    ...
	    public void PMToPOCO(SIIDocumentTypePM entityPM, SIIDocumentType entityPOCO)
        {
		...
		public void POCOToPM(SIIDocumentTypePM entityPM, SIIDocumentType entityPOCO)
        {
		...
		public void PMToOldPM(SIIDocumentTypePM entityPM, SIIDocumentTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SIIDocumentTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SIIDocumentTypePM entityPM, SIIDocumentType entityPOCO, bool isNewEntity)
        {
