...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PhysicalCheckOperationDataMapping: IMapping<PhysicalCheckOperationPM, PhysicalCheckOperation>,IMappingEncodeBase64NVARCHARFields<PhysicalCheckOperationPM>
   {
	    ...
	    public void PMToPOCO(PhysicalCheckOperationPM entityPM, PhysicalCheckOperation entityPOCO)
        {
		...
		public void POCOToPM(PhysicalCheckOperationPM entityPM, PhysicalCheckOperation entityPOCO)
        {
		...
		public void PMToOldPM(PhysicalCheckOperationPM entityPM, PhysicalCheckOperationPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PhysicalCheckOperationPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PhysicalCheckOperationPM entityPM, PhysicalCheckOperation entityPOCO, bool isNewEntity)
        {
