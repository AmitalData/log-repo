...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DemanderTypeDataMapping: IMapping<DemanderTypePM, DemanderType>,IMappingEncodeBase64NVARCHARFields<DemanderTypePM>
   {
	    ...
	    public void PMToPOCO(DemanderTypePM entityPM, DemanderType entityPOCO)
        {
		...
		public void POCOToPM(DemanderTypePM entityPM, DemanderType entityPOCO)
        {
		...
		public void PMToOldPM(DemanderTypePM entityPM, DemanderTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DemanderTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DemanderTypePM entityPM, DemanderType entityPOCO, bool isNewEntity)
        {
