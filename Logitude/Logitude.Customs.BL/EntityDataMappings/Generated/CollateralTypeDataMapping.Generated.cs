...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CollateralTypeDataMapping: IMapping<CollateralTypePM, CollateralType>,IMappingEncodeBase64NVARCHARFields<CollateralTypePM>
   {
	    ...
	    public void PMToPOCO(CollateralTypePM entityPM, CollateralType entityPOCO)
        {
		...
		public void POCOToPM(CollateralTypePM entityPM, CollateralType entityPOCO)
        {
		...
		public void PMToOldPM(CollateralTypePM entityPM, CollateralTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CollateralTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CollateralTypePM entityPM, CollateralType entityPOCO, bool isNewEntity)
        {
