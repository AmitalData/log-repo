...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VehicleStatusDataMapping: IMapping<VehicleStatusPM, VehicleStatus>,IMappingEncodeBase64NVARCHARFields<VehicleStatusPM>
   {
	    ...
	    public void PMToPOCO(VehicleStatusPM entityPM, VehicleStatus entityPOCO)
        {
		...
		public void POCOToPM(VehicleStatusPM entityPM, VehicleStatus entityPOCO)
        {
		...
		public void PMToOldPM(VehicleStatusPM entityPM, VehicleStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VehicleStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VehicleStatusPM entityPM, VehicleStatus entityPOCO, bool isNewEntity)
        {
