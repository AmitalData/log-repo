...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SignatureTypeDataMapping: IMapping<SignatureTypePM, SignatureType>,IMappingEncodeBase64NVARCHARFields<SignatureTypePM>
   {
	    ...
	    public void PMToPOCO(SignatureTypePM entityPM, SignatureType entityPOCO)
        {
		...
		public void POCOToPM(SignatureTypePM entityPM, SignatureType entityPOCO)
        {
		...
		public void PMToOldPM(SignatureTypePM entityPM, SignatureTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SignatureTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SignatureTypePM entityPM, SignatureType entityPOCO, bool isNewEntity)
        {
