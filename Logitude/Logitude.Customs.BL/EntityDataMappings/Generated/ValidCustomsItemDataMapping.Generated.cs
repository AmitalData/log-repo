...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ValidCustomsItemDataMapping: IMapping<ValidCustomsItemPM, ValidCustomsItem>,IMappingEncodeBase64NVARCHARFields<ValidCustomsItemPM>
   {
	    ...
	    public void PMToPOCO(ValidCustomsItemPM entityPM, ValidCustomsItem entityPOCO)
        {
		...
		public void POCOToPM(ValidCustomsItemPM entityPM, ValidCustomsItem entityPOCO)
        {
		...
		public void PMToOldPM(ValidCustomsItemPM entityPM, ValidCustomsItemPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ValidCustomsItemPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ValidCustomsItemPM entityPM, ValidCustomsItem entityPOCO, bool isNewEntity)
        {
