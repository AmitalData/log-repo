...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LeadDocumentTypeDataMapping: IMapping<LeadDocumentTypePM, LeadDocumentType>,IMappingEncodeBase64NVARCHARFields<LeadDocumentTypePM>
   {
	    ...
	    public void PMToPOCO(LeadDocumentTypePM entityPM, LeadDocumentType entityPOCO)
        {
		...
		public void POCOToPM(LeadDocumentTypePM entityPM, LeadDocumentType entityPOCO)
        {
		...
		public void PMToOldPM(LeadDocumentTypePM entityPM, LeadDocumentTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LeadDocumentTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LeadDocumentTypePM entityPM, LeadDocumentType entityPOCO, bool isNewEntity)
        {
