...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ReferantTeamDataMapping: IMapping<ReferantTeamPM, ReferantTeam>,IMappingEncodeBase64NVARCHARFields<ReferantTeamPM>
   {
	    ...
	    public void PMToPOCO(ReferantTeamPM entityPM, ReferantTeam entityPOCO)
        {
		...
		public void POCOToPM(ReferantTeamPM entityPM, ReferantTeam entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ReferantTeamPM entityPM, ReferantTeam entityPOCO, bool isNewEntity)
        {
