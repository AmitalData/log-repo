...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class HandingCodeDataMapping: IMapping<HandingCodePM, HandingCode>,IMappingEncodeBase64NVARCHARFields<HandingCodePM>
   {
	    ...
	    public void PMToPOCO(HandingCodePM entityPM, HandingCode entityPOCO)
        {
		...
		public void POCOToPM(HandingCodePM entityPM, HandingCode entityPOCO)
        {
		...
		public void PMToOldPM(HandingCodePM entityPM, HandingCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(HandingCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(HandingCodePM entityPM, HandingCode entityPOCO, bool isNewEntity)
        {
