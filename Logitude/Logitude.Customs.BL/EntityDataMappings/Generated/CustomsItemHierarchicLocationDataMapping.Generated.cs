...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsItemHierarchicLocationDataMapping: IMapping<CustomsItemHierarchicLocationPM, CustomsItemHierarchicLocation>,IMappingEncodeBase64NVARCHARFields<CustomsItemHierarchicLocationPM>
   {
	    ...
	    public void PMToPOCO(CustomsItemHierarchicLocationPM entityPM, CustomsItemHierarchicLocation entityPOCO)
        {
		...
		public void POCOToPM(CustomsItemHierarchicLocationPM entityPM, CustomsItemHierarchicLocation entityPOCO)
        {
		...
		public void PMToOldPM(CustomsItemHierarchicLocationPM entityPM, CustomsItemHierarchicLocationPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsItemHierarchicLocationPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsItemHierarchicLocationPM entityPM, CustomsItemHierarchicLocation entityPOCO, bool isNewEntity)
        {
