...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class StorageMessageTypeDataMapping: IMapping<StorageMessageTypePM, StorageMessageType>,IMappingEncodeBase64NVARCHARFields<StorageMessageTypePM>
   {
	    ...
	    public void PMToPOCO(StorageMessageTypePM entityPM, StorageMessageType entityPOCO)
        {
		...
		public void POCOToPM(StorageMessageTypePM entityPM, StorageMessageType entityPOCO)
        {
		...
		public void PMToOldPM(StorageMessageTypePM entityPM, StorageMessageTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(StorageMessageTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(StorageMessageTypePM entityPM, StorageMessageType entityPOCO, bool isNewEntity)
        {
