...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CourierPaymentStatusDataMapping: IMapping<CourierPaymentStatusPM, CourierPaymentStatus>,IMappingEncodeBase64NVARCHARFields<CourierPaymentStatusPM>
   {
	    ...
	    public void PMToPOCO(CourierPaymentStatusPM entityPM, CourierPaymentStatus entityPOCO)
        {
		...
		public void POCOToPM(CourierPaymentStatusPM entityPM, CourierPaymentStatus entityPOCO)
        {
		...
		public void PMToOldPM(CourierPaymentStatusPM entityPM, CourierPaymentStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CourierPaymentStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CourierPaymentStatusPM entityPM, CourierPaymentStatus entityPOCO, bool isNewEntity)
        {
