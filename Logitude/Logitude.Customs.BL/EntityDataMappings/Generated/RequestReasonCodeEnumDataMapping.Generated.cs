...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class RequestReasonCodeEnumDataMapping: IMapping<RequestReasonCodeEnumPM, RequestReasonCodeEnum>,IMappingEncodeBase64NVARCHARFields<RequestReasonCodeEnumPM>
   {
	    ...
	    public void PMToPOCO(RequestReasonCodeEnumPM entityPM, RequestReasonCodeEnum entityPOCO)
        {
		...
		public void POCOToPM(RequestReasonCodeEnumPM entityPM, RequestReasonCodeEnum entityPOCO)
        {
		...
		public void PMToOldPM(RequestReasonCodeEnumPM entityPM, RequestReasonCodeEnumPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RequestReasonCodeEnumPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RequestReasonCodeEnumPM entityPM, RequestReasonCodeEnum entityPOCO, bool isNewEntity)
        {
