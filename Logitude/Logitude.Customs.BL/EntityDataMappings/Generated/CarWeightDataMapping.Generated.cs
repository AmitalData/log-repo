...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CarWeightDataMapping: IMapping<CarWeightPM, CarWeight>,IMappingEncodeBase64NVARCHARFields<CarWeightPM>
   {
	    ...
	    public void PMToPOCO(CarWeightPM entityPM, CarWeight entityPOCO)
        {
		...
		public void POCOToPM(CarWeightPM entityPM, CarWeight entityPOCO)
        {
		...
		public void PMToOldPM(CarWeightPM entityPM, CarWeightPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CarWeightPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CarWeightPM entityPM, CarWeight entityPOCO, bool isNewEntity)
        {
