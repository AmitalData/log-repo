...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SealCompletenesDataMapping: IMapping<SealCompletenesPM, SealCompletenes>,IMappingEncodeBase64NVARCHARFields<SealCompletenesPM>
   {
	    ...
	    public void PMToPOCO(SealCompletenesPM entityPM, SealCompletenes entityPOCO)
        {
		...
		public void POCOToPM(SealCompletenesPM entityPM, SealCompletenes entityPOCO)
        {
		...
		public void PMToOldPM(SealCompletenesPM entityPM, SealCompletenesPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(SealCompletenesPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(SealCompletenesPM entityPM, SealCompletenes entityPOCO, bool isNewEntity)
        {
