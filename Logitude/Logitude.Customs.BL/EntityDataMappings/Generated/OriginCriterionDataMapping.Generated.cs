...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class OriginCriterionDataMapping: IMapping<OriginCriterionPM, OriginCriterion>,IMappingEncodeBase64NVARCHARFields<OriginCriterionPM>
   {
	    ...
	    public void PMToPOCO(OriginCriterionPM entityPM, OriginCriterion entityPOCO)
        {
		...
		public void POCOToPM(OriginCriterionPM entityPM, OriginCriterion entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(OriginCriterionPM entityPM, OriginCriterion entityPOCO, bool isNewEntity)
        {
