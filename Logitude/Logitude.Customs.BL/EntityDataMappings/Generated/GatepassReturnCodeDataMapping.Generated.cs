...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class GatepassReturnCodeDataMapping: IMapping<GatepassReturnCodePM, GatepassReturnCode>,IMappingEncodeBase64NVARCHARFields<GatepassReturnCodePM>
   {
	    ...
	    public void PMToPOCO(GatepassReturnCodePM entityPM, GatepassReturnCode entityPOCO)
        {
		...
		public void POCOToPM(GatepassReturnCodePM entityPM, GatepassReturnCode entityPOCO)
        {
		...
		public void PMToOldPM(GatepassReturnCodePM entityPM, GatepassReturnCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(GatepassReturnCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(GatepassReturnCodePM entityPM, GatepassReturnCode entityPOCO, bool isNewEntity)
        {
