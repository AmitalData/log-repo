...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CancellationReasonRequestTypeDataMapping: IMapping<CancellationReasonRequestTypePM, CancellationReasonRequestType>,IMappingEncodeBase64NVARCHARFields<CancellationReasonRequestTypePM>
   {
	    ...
	    public void PMToPOCO(CancellationReasonRequestTypePM entityPM, CancellationReasonRequestType entityPOCO)
        {
		...
		public void POCOToPM(CancellationReasonRequestTypePM entityPM, CancellationReasonRequestType entityPOCO)
        {
		...
		public void PMToOldPM(CancellationReasonRequestTypePM entityPM, CancellationReasonRequestTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CancellationReasonRequestTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CancellationReasonRequestTypePM entityPM, CancellationReasonRequestType entityPOCO, bool isNewEntity)
        {
