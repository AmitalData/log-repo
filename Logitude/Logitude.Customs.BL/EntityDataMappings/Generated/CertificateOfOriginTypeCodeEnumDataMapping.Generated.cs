...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CertificateOfOriginTypeCodeEnumDataMapping: IMapping<CertificateOfOriginTypeCodeEnumPM, CertificateOfOriginTypeCodeEnum>,IMappingEncodeBase64NVARCHARFields<CertificateOfOriginTypeCodeEnumPM>
   {
	    ...
	    public void PMToPOCO(CertificateOfOriginTypeCodeEnumPM entityPM, CertificateOfOriginTypeCodeEnum entityPOCO)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.IsCustomApprovalRequired))
            {
				entityPOCO.IsCustomApprovalRequired = entityPM.IsCustomApprovalRequired;
			}
		...
		public void POCOToPM(CertificateOfOriginTypeCodeEnumPM entityPM, CertificateOfOriginTypeCodeEnum entityPOCO)
        {
			...
			if (!CustomMappedPMProperties.Contains(PMPropertyNames.IsCustomApprovalRequired))
            {
					entityPM.IsCustomApprovalRequired = entityPOCO.IsCustomApprovalRequired;
            }

			if (!CustomMappedPMProperties.Contains(PMPropertyNames.IsCriterionMandatory))
            {
		...
		public void PMToOldPM(CertificateOfOriginTypeCodeEnumPM entityPM, CertificateOfOriginTypeCodeEnumPM oldEntityPM)
        {
			...
			if (!CustomMappedPOCOProperties.Contains(POCOPropertyNames.IsCustomApprovalRequired))
            {
                oldEntityPM.IsCustomApprovalRequired = entityPM.IsCustomApprovalRequired;
            }
	    ...
	    public void EncodeBase64NVARCHARFields(CertificateOfOriginTypeCodeEnumPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CertificateOfOriginTypeCodeEnumPM entityPM, CertificateOfOriginTypeCodeEnum entityPOCO, bool isNewEntity)
        {
