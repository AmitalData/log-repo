...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ReleaseMessageTypeDataMapping: IMapping<ReleaseMessageTypePM, ReleaseMessageType>,IMappingEncodeBase64NVARCHARFields<ReleaseMessageTypePM>
   {
	    ...
	    public void PMToPOCO(ReleaseMessageTypePM entityPM, ReleaseMessageType entityPOCO)
        {
		...
		public void POCOToPM(ReleaseMessageTypePM entityPM, ReleaseMessageType entityPOCO)
        {
		...
		public void PMToOldPM(ReleaseMessageTypePM entityPM, ReleaseMessageTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ReleaseMessageTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ReleaseMessageTypePM entityPM, ReleaseMessageType entityPOCO, bool isNewEntity)
        {
