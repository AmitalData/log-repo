...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class MeasureQualifierDataMapping: IMapping<MeasureQualifierPM, MeasureQualifier>,IMappingEncodeBase64NVARCHARFields<MeasureQualifierPM>
   {
	    ...
	    public void PMToPOCO(MeasureQualifierPM entityPM, MeasureQualifier entityPOCO)
        {
		...
		public void POCOToPM(MeasureQualifierPM entityPM, MeasureQualifier entityPOCO)
        {
		...
		public void PMToOldPM(MeasureQualifierPM entityPM, MeasureQualifierPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MeasureQualifierPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MeasureQualifierPM entityPM, MeasureQualifier entityPOCO, bool isNewEntity)
        {
