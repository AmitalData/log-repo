...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ContinuousMessagesTypeCodeDataMapping: IMapping<ContinuousMessagesTypeCodePM, ContinuousMessagesTypeCode>,IMappingEncodeBase64NVARCHARFields<ContinuousMessagesTypeCodePM>
   {
	    ...
	    public void PMToPOCO(ContinuousMessagesTypeCodePM entityPM, ContinuousMessagesTypeCode entityPOCO)
        {
		...
		public void POCOToPM(ContinuousMessagesTypeCodePM entityPM, ContinuousMessagesTypeCode entityPOCO)
        {
		...
		public void PMToOldPM(ContinuousMessagesTypeCodePM entityPM, ContinuousMessagesTypeCodePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ContinuousMessagesTypeCodePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ContinuousMessagesTypeCodePM entityPM, ContinuousMessagesTypeCode entityPOCO, bool isNewEntity)
        {
