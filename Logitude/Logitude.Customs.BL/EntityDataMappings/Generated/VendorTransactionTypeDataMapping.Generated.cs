...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VendorTransactionTypeDataMapping: IMapping<VendorTransactionTypePM, VendorTransactionType>,IMappingEncodeBase64NVARCHARFields<VendorTransactionTypePM>
   {
	    ...
	    public void PMToPOCO(VendorTransactionTypePM entityPM, VendorTransactionType entityPOCO)
        {
		...
		public void POCOToPM(VendorTransactionTypePM entityPM, VendorTransactionType entityPOCO)
        {
		...
		public void PMToOldPM(VendorTransactionTypePM entityPM, VendorTransactionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VendorTransactionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VendorTransactionTypePM entityPM, VendorTransactionType entityPOCO, bool isNewEntity)
        {
