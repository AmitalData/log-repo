...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class EntityTypeLookupDataMapping: IMapping<EntityTypeLookupPM, EntityTypeLookup>,IMappingEncodeBase64NVARCHARFields<EntityTypeLookupPM>
   {
	    ...
	    public void PMToPOCO(EntityTypeLookupPM entityPM, EntityTypeLookup entityPOCO)
        {
		...
		public void POCOToPM(EntityTypeLookupPM entityPM, EntityTypeLookup entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(EntityTypeLookupPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(EntityTypeLookupPM entityPM, EntityTypeLookup entityPOCO, bool isNewEntity)
        {
