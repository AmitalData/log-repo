...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class QuotaComputationBasisDataMapping: IMapping<QuotaComputationBasisPM, QuotaComputationBasis>,IMappingEncodeBase64NVARCHARFields<QuotaComputationBasisPM>
   {
	    ...
	    public void PMToPOCO(QuotaComputationBasisPM entityPM, QuotaComputationBasis entityPOCO)
        {
		...
		public void POCOToPM(QuotaComputationBasisPM entityPM, QuotaComputationBasis entityPOCO)
        {
		...
		public void PMToOldPM(QuotaComputationBasisPM entityPM, QuotaComputationBasisPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(QuotaComputationBasisPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(QuotaComputationBasisPM entityPM, QuotaComputationBasis entityPOCO, bool isNewEntity)
        {
