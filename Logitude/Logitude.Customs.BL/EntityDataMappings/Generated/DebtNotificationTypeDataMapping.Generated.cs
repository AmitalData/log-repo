...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DebtNotificationTypeDataMapping: IMapping<DebtNotificationTypePM, DebtNotificationType>,IMappingEncodeBase64NVARCHARFields<DebtNotificationTypePM>
   {
	    ...
	    public void PMToPOCO(DebtNotificationTypePM entityPM, DebtNotificationType entityPOCO)
        {
		...
		public void POCOToPM(DebtNotificationTypePM entityPM, DebtNotificationType entityPOCO)
        {
		...
		public void PMToOldPM(DebtNotificationTypePM entityPM, DebtNotificationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DebtNotificationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DebtNotificationTypePM entityPM, DebtNotificationType entityPOCO, bool isNewEntity)
        {
