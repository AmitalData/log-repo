...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class TarifRelatedToQuotaDataMapping: IMapping<TarifRelatedToQuotaPM, TarifRelatedToQuota>,IMappingEncodeBase64NVARCHARFields<TarifRelatedToQuotaPM>
   {
	    ...
	    public void PMToPOCO(TarifRelatedToQuotaPM entityPM, TarifRelatedToQuota entityPOCO)
        {
		...
		public void POCOToPM(TarifRelatedToQuotaPM entityPM, TarifRelatedToQuota entityPOCO)
        {
		...
		public void PMToOldPM(TarifRelatedToQuotaPM entityPM, TarifRelatedToQuotaPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TarifRelatedToQuotaPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TarifRelatedToQuotaPM entityPM, TarifRelatedToQuota entityPOCO, bool isNewEntity)
        {
