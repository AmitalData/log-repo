...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ContinuousRequestTypeDataMapping: IMapping<ContinuousRequestTypePM, ContinuousRequestType>,IMappingEncodeBase64NVARCHARFields<ContinuousRequestTypePM>
   {
	    ...
	    public void PMToPOCO(ContinuousRequestTypePM entityPM, ContinuousRequestType entityPOCO)
        {
		...
		public void POCOToPM(ContinuousRequestTypePM entityPM, ContinuousRequestType entityPOCO)
        {
		...
		public void PMToOldPM(ContinuousRequestTypePM entityPM, ContinuousRequestTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ContinuousRequestTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ContinuousRequestTypePM entityPM, ContinuousRequestType entityPOCO, bool isNewEntity)
        {
