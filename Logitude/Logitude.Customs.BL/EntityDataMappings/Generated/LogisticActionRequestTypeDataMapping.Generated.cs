...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class LogisticActionRequestTypeDataMapping: IMapping<LogisticActionRequestTypePM, LogisticActionRequestType>,IMappingEncodeBase64NVARCHARFields<LogisticActionRequestTypePM>
   {
	    ...
	    public void PMToPOCO(LogisticActionRequestTypePM entityPM, LogisticActionRequestType entityPOCO)
        {
		...
		public void POCOToPM(LogisticActionRequestTypePM entityPM, LogisticActionRequestType entityPOCO)
        {
		...
		public void PMToOldPM(LogisticActionRequestTypePM entityPM, LogisticActionRequestTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(LogisticActionRequestTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(LogisticActionRequestTypePM entityPM, LogisticActionRequestType entityPOCO, bool isNewEntity)
        {
