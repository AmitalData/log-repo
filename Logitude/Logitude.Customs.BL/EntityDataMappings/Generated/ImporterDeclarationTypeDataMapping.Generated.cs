...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ImporterDeclarationTypeDataMapping: IMapping<ImporterDeclarationTypePM, ImporterDeclarationType>,IMappingEncodeBase64NVARCHARFields<ImporterDeclarationTypePM>
   {
	    ...
	    public void PMToPOCO(ImporterDeclarationTypePM entityPM, ImporterDeclarationType entityPOCO)
        {
		...
		public void POCOToPM(ImporterDeclarationTypePM entityPM, ImporterDeclarationType entityPOCO)
        {
		...
		public void PMToOldPM(ImporterDeclarationTypePM entityPM, ImporterDeclarationTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ImporterDeclarationTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ImporterDeclarationTypePM entityPM, ImporterDeclarationType entityPOCO, bool isNewEntity)
        {
