...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class QuotaIncrementDataMapping: IMapping<QuotaIncrementPM, QuotaIncrement>,IMappingEncodeBase64NVARCHARFields<QuotaIncrementPM>
   {
	    ...
	    public void PMToPOCO(QuotaIncrementPM entityPM, QuotaIncrement entityPOCO)
        {
		...
		public void POCOToPM(QuotaIncrementPM entityPM, QuotaIncrement entityPOCO)
        {
		...
		public void PMToOldPM(QuotaIncrementPM entityPM, QuotaIncrementPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(QuotaIncrementPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(QuotaIncrementPM entityPM, QuotaIncrement entityPOCO, bool isNewEntity)
        {
