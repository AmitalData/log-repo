...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PendingErrorPlaceDataMapping: IMapping<PendingErrorPlacePM, PendingErrorPlace>,IMappingEncodeBase64NVARCHARFields<PendingErrorPlacePM>
   {
	    ...
	    public void PMToPOCO(PendingErrorPlacePM entityPM, PendingErrorPlace entityPOCO)
        {
		...
		public void POCOToPM(PendingErrorPlacePM entityPM, PendingErrorPlace entityPOCO)
        {
		...
		public void PMToOldPM(PendingErrorPlacePM entityPM, PendingErrorPlacePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PendingErrorPlacePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PendingErrorPlacePM entityPM, PendingErrorPlace entityPOCO, bool isNewEntity)
        {
