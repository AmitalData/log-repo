...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class ComputationMethodDataMapping: IMapping<ComputationMethodPM, ComputationMethod>,IMappingEncodeBase64NVARCHARFields<ComputationMethodPM>
   {
	    ...
	    public void PMToPOCO(ComputationMethodPM entityPM, ComputationMethod entityPOCO)
        {
		...
		public void POCOToPM(ComputationMethodPM entityPM, ComputationMethod entityPOCO)
        {
		...
		public void PMToOldPM(ComputationMethodPM entityPM, ComputationMethodPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ComputationMethodPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ComputationMethodPM entityPM, ComputationMethod entityPOCO, bool isNewEntity)
        {
