...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DeliveryTypeDataMapping: IMapping<DeliveryTypePM, DeliveryType>,IMappingEncodeBase64NVARCHARFields<DeliveryTypePM>
   {
	    ...
	    public void PMToPOCO(DeliveryTypePM entityPM, DeliveryType entityPOCO)
        {
		...
		public void POCOToPM(DeliveryTypePM entityPM, DeliveryType entityPOCO)
        {
		...
		public void PMToOldPM(DeliveryTypePM entityPM, DeliveryTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DeliveryTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DeliveryTypePM entityPM, DeliveryType entityPOCO, bool isNewEntity)
        {
