...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class VendorStatusDataMapping: IMapping<VendorStatusPM, VendorStatus>,IMappingEncodeBase64NVARCHARFields<VendorStatusPM>
   {
	    ...
	    public void PMToPOCO(VendorStatusPM entityPM, VendorStatus entityPOCO)
        {
		...
		public void POCOToPM(VendorStatusPM entityPM, VendorStatus entityPOCO)
        {
		...
		public void PMToOldPM(VendorStatusPM entityPM, VendorStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VendorStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VendorStatusPM entityPM, VendorStatus entityPOCO, bool isNewEntity)
        {
