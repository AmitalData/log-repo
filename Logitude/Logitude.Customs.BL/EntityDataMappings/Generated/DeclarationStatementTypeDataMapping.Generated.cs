...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class DeclarationStatementTypeDataMapping: IMapping<DeclarationStatementTypePM, DeclarationStatementType>,IMappingEncodeBase64NVARCHARFields<DeclarationStatementTypePM>
   {
	    ...
	    public void PMToPOCO(DeclarationStatementTypePM entityPM, DeclarationStatementType entityPOCO)
        {
		...
		public void POCOToPM(DeclarationStatementTypePM entityPM, DeclarationStatementType entityPOCO)
        {
		...
		public void PMToOldPM(DeclarationStatementTypePM entityPM, DeclarationStatementTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(DeclarationStatementTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(DeclarationStatementTypePM entityPM, DeclarationStatementType entityPOCO, bool isNewEntity)
        {
