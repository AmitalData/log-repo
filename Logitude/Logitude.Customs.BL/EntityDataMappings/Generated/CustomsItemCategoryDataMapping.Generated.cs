...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class CustomsItemCategoryDataMapping: IMapping<CustomsItemCategoryPM, CustomsItemCategory>,IMappingEncodeBase64NVARCHARFields<CustomsItemCategoryPM>
   {
	    ...
	    public void PMToPOCO(CustomsItemCategoryPM entityPM, CustomsItemCategory entityPOCO)
        {
		...
		public void POCOToPM(CustomsItemCategoryPM entityPM, CustomsItemCategory entityPOCO)
        {
		...
		public void PMToOldPM(CustomsItemCategoryPM entityPM, CustomsItemCategoryPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CustomsItemCategoryPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CustomsItemCategoryPM entityPM, CustomsItemCategory entityPOCO, bool isNewEntity)
        {
