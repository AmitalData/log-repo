...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class PaymentTypeDataMapping: IMapping<PaymentTypePM, PaymentType>,IMappingEncodeBase64NVARCHARFields<PaymentTypePM>
   {
	    ...
	    public void PMToPOCO(PaymentTypePM entityPM, PaymentType entityPOCO)
        {
		...
		public void POCOToPM(PaymentTypePM entityPM, PaymentType entityPOCO)
        {
		...
		public void PMToOldPM(PaymentTypePM entityPM, PaymentTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PaymentTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PaymentTypePM entityPM, PaymentType entityPOCO, bool isNewEntity)
        {
