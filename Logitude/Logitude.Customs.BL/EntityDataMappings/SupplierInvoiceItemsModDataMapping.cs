...
namespace Logitude.Customs.BL.EntityDataMappings
{
   ...
   public partial class SupplierInvoiceItemsModDataMapping: IMapping<SupplierInvoiceItemsModPM, SupplierInvoiceItemsMod>
   {

        public void CustomPMToPOCO(SupplierInvoiceItemsModPM entityPM, SupplierInvoiceItemsMod entityPOCO)
        {
        ...
        public void CustomPOCOToPM(SupplierInvoiceItemsModPM entityPM, SupplierInvoiceItemsMod entityPOCO)
        {
