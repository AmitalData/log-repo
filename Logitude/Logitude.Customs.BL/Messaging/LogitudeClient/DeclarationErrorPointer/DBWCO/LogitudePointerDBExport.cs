...
namespace Logitude.Customs.BL.Messaging.LogitudeClient.DeclarationErrorPointer.DBWCO
{
    public class LogitudePointerDBExport : List<LogitudePointerModel>
    {
        ...
        LogitudePointerDBExport()
        {
            ...
            this.Add(new LogitudePointerModel(267, "006", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "SequenceNumeric"));
            this.Add(new LogitudePointerModel(409, "30B", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, ""));
            this.Add(new LogitudePointerModel(410, "D023", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "ManifestNumber"));
            this.Add(new LogitudePointerModel(411, "D024", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "CargoTypeCode"));
            this.Add(new LogitudePointerModel(1080, "01L", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "DMExtensions"));
            this.Add(new LogitudePointerModel(1081, "I11", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "SecondCargoID"));
            this.Add(new LogitudePointerModel(1082, "I12", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "ThirdCargoID"));
            this.Add(new LogitudePointerModel(380, "83A", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, ""));
            this.Add(new LogitudePointerModel(382, "L010", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "ExportLoadingPortCode"));
            this.Add(new LogitudePointerModel(434, "38B", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, ""));
            this.Add(new LogitudePointerModel(435, "L013", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "ExportUnloadPortCode"));
            this.Add(new LogitudePointerModel(1084, "01L", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "DMExtensions"));
            this.Add(new LogitudePointerModel(2039, "I111", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "IsDangerousGoods"));
            this.Add(new LogitudePointerModel(1086, "138", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "CargoDescription"));
            this.Add(new LogitudePointerModel(1178, "L013", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "FinalDestinationPortCode"));
            this.Add(new LogitudePointerModel(2097, "T006", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "ShipCode"));
            ...
            this.Add(new LogitudePointerModel(2063, "006", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "SequenceNumeric"));
            this.Add(new LogitudePointerModel(2065, "138", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "CargoDescription"));
            this.Add(new LogitudePointerModel(2066, "I05", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "IsLastReleaseFromWarehous"));
            this.Add(new LogitudePointerModel(2067, "062", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "OriginalCountryCode"));
            this.Add(new LogitudePointerModel(2099, "01L", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "DMExtensions"));
            this.Add(new LogitudePointerModel(2069, "006", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "SequenceNumeric"));
            this.Add(new LogitudePointerModel(2071, "146", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "PackageMeasureQualifierCode"));
            this.Add(new LogitudePointerModel(2072, "126", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "GrossMassMeasure"));
            this.Add(new LogitudePointerModel(2073, "141", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "PackageTypeCode"));
            this.Add(new LogitudePointerModel(2074, "142", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "MarksNumbers"));
            this.Add(new LogitudePointerModel(2082, "D032", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "MamifestNumber"));
            this.Add(new LogitudePointerModel(2083, "D024", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "CargoTypeCode"));
            this.Add(new LogitudePointerModel(2086, "I11", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "SecondCargoID"));
            this.Add(new LogitudePointerModel(2087, "I12", WCOErrorPointerModel.LogitudeEntityEnum.Consignment, "ThirdCargoID"));
