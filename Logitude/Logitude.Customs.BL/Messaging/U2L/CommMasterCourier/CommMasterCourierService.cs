...
//        private void CheckCourierDeclarationToInsert(List<string> declarationIds)
//        {
...
//                AppendLogLine("try to Update CourierDeclaration ");
//                try
//                {
//                    int? sequenceNumericMax = myCourierDeclarationQueryService.GetCourierMasterMaxSequenceNumeric(_CourierMasterPM.Id, _CourierMasterPM.Tenant);
...
//        private void UpdateDeclarationCourierStatus(List<string> deletedDeclarationIds)
//        {
//            try
//            {
...
//                var sts = messagingService.CreateCRS(tenant, null, new DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse()
//                {
...
//            catch (Exception ex)
//            {
//                AppendLogLine("ProccessRequest():Exception " + ex.ToString() + Environment.NewLine + "---------------------------------------------");
//                return;
//            }
//        }
