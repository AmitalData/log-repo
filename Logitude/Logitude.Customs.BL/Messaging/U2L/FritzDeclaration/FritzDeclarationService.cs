...
{
    public class FritzDeclarationService : UnifreightGenericService
    {
        ...
        public const string UpsertActionConst = "Logitude.Customs.BL.Messaging.U2L.FritzDeclaration.FritzDeclarationService.Upsert()";
        private DeclarationPM _MyDeclarationPM;
        private Stopwatch _Stopwatch;

        public FritzDeclarationService()
            : base(
            "1.000.000001",
              ...
              out string MessageOut)
        {
            ...
            MyCommunicationsParams.Subject = "FritzDeclarationService ";
            ...
            FritzDeclarationMapping fritzDeclaration = new FritzDeclarationMapping();
            var xml = fritzDeclaration.GetXml(this._MyDeclarationPM);
            ...
            MyGenericResponseObj.Stage = "Get FritzDeclaration Xml Done ";
        ...
        private void DeserilazeObject(string xmlLOGITSRUFA)
        {
            ...
            AppendLogLine("FritzDeclarationService.ProccessRequest");
            ...
            {
                throw new BusinessErrorException("_LOGITSRUFA.FritzDeclaration.Length != 1");
            }
