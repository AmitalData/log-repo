...
{
    public class CourierSWSStatusAvailabilityQService : CustomAnalyzerQueueBase
    {
        private DeclarationPM _DeclarationPM;

        public CourierSWSStatusAvailabilityQService(InterfaceDetails MyInterfaceDetails)
