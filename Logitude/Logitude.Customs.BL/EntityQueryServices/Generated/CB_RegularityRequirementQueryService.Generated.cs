...
{ 
   public partial class CB_RegularityRequirementQueryService: EntityQueryService<CB_RegularityRequirement,CB_RegularityRequirementKeys,CB_RegularityRequirementPM,object,CB_RegularityRequirementKeys>
   {
		...
		public  CB_RegularityRequirementPM GetSingle(string id,bool getComposition, bool getFromCache)
        {
             EntityKeys = new CB_RegularityRequirementKeys(){ ID = id };
        ...
        {
            CB_RegularityRequirementKeys entityKeys = new CB_RegularityRequirementKeys() { ID = entityPOCO.ID,  };
            return entityKeys;
        }
