...
{ 
   public partial class AmountTypeQueryService: EntityQueryService<POCO.AmountType,AmountTypeKeys,AmountTypePM,object,AmountTypeKeys>
   {
	    ...
	    protected override EntityKeyFields GetKeys(POCO.AmountType entityPOCO)
        {
