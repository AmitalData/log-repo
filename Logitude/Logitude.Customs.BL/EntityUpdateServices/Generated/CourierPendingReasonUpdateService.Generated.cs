...
{ 
   public partial class CourierPendingReasonUpdateService:EntityUpdateService<CourierPendingReason,CourierPendingReasonPM,EntityPM>
   {
   
        CourierPendingReasonRepository entityRepository;
        public CourierPendingReasonUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public CourierPendingReasonUpdateService(int tenant)
        {
            currentContext = CustomContext.GetContext(tenant);
        }

        public CourierPendingReasonUpdateService(ICustomContext context)
        {
