...
{ 
   public partial class DeficitDecisionUpdateService:EntityUpdateService<DeficitDecision,DeficitDecisionPM,DeficitPM>
   {
        ...
        public DeficitDecisionUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public DeficitDecisionUpdateService(int tenant)
        {
            currentContext = CustomContext.GetContext(tenant);
        }

        public DeficitDecisionUpdateService(ICustomContext context)
        {
		...
		protected override void FillDefaultValuesOnCreate(DeficitDecisionPM entityPM)
        {     
  
		
	    }
        
		protected override void FillDefaultValuesOnUpdate(DeficitDecisionPM entityPM)
        {       
