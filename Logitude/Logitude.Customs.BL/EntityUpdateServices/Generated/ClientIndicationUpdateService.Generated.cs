...
{ 
   public partial class ClientIndicationUpdateService:EntityUpdateService<ClientIndication,ClientIndicationPM,ClientPM>
   {
        ...
        public ClientIndicationUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public ClientIndicationUpdateService(int tenant)
        {
            currentContext = CustomContext.GetContext(tenant);
        }

        public ClientIndicationUpdateService(ICustomContext context)
        {
		...
		protected override void FillDefaultValuesOnCreate(ClientIndicationPM entityPM)
        {     
  
		
	    }
        
		protected override void FillDefaultValuesOnUpdate(ClientIndicationPM entityPM)
        {       
