...
{ 
   public partial class SupplierInvoiceFreightAmountUpdateService:EntityUpdateService<SupplierInvoiceFreightAmount,SupplierInvoiceFreightAmountPM,SupplierInvoicePM>
   {
        ...
        SupplierInvoiceFreightAmountRepository entityRepository;
        public SupplierInvoiceFreightAmountUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public SupplierInvoiceFreightAmountUpdateService(int tenant)
        {
            currentContext = CustomContext.GetContext(tenant);
        }

        public SupplierInvoiceFreightAmountUpdateService(ICustomContext context)
        {
	    ...
	    protected override void FillDefaultValuesOnCreate(SupplierInvoiceFreightAmountPM entityPM)
        {
 
		}
		protected override void FillDefaultValuesOnUpdate(SupplierInvoiceFreightAmountPM entityPM)
		{
