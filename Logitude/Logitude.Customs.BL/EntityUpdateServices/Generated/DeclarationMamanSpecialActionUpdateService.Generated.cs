...
{ 
   public partial class DeclarationMamanSpecialActionUpdateService:EntityUpdateService<DeclarationMamanSpecialAction,DeclarationMamanSpecialActionPM,EntityPM>
   {
        ...
        DeclarationMamanSpecialActionRepository entityRepository;
        public DeclarationMamanSpecialActionUpdateService(IContext mainContext,Dictionary<string,IContext> additionalContexts, int tenant)
        ...
        public DeclarationMamanSpecialActionUpdateService(int tenant)
        {
            currentContext = CustomContext.GetContext(tenant);
        }

        public DeclarationMamanSpecialActionUpdateService(ICustomContext context)
        {
		...
		protected override void FillDefaultValuesOnCreate(DeclarationMamanSpecialActionPM entityPM)
        {     
  
		
	    }
        
		protected override void FillDefaultValuesOnUpdate(DeclarationMamanSpecialActionPM entityPM)
        {       
