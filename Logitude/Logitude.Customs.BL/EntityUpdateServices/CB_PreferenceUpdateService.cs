...
{
    public partial class CB_PreferenceUpdateService
    {

        protected override void OnCreating(CB_PreferencePM entityPM, EntityPM entityParentPM)
        {
