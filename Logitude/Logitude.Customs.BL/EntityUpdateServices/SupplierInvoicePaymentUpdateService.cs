...
namespace Logitude.Customs.BL.EntityUpdateServices
{
...

    {
        ...
        protected override void OnCreating(SupplierInvoicePaymentPM entityPM, SupplierInvoicePM entityParentPM)
        {
        ...
        protected override void AfterUpdating(SupplierInvoicePaymentPM entityPM, SupplierInvoicePM entityParentPM)
        {
