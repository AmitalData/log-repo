...
namespace Logitude.LogboxIntegrationTest
{
    class ShipmentWcfFactory
    {
        readonly private static ShipmentPM shipmentPM = new ShipmentPM()
        {
            ...
            ShipperId = "70001",//"10013949",//CloudVariables.CustomerCodeIntegration,
            ConsigneeId = "70001",//"10013949",//CloudVariables.CustomerCodeIntegration,
            CustomerId = "70001",//"10013949",//CloudVariables.CustomerCodeIntegration,
