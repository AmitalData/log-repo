...
namespace Logitude.CargoTracking.Data.EntityMapping
{
    ...
    public class CargoReferencesSyncQueueMap : EntityTypeConfiguration<CargoReferencesSyncQueue>
    {
        ...
        { 
            ...
            this.Property(t => t.ShipmentId).HasColumnName("ShipmentId").IsRequired().HasMaxLength(30).IsUnicode(false);

            this.Property(t => t.ShipmentType).HasColumnName("ShipmentType").IsRequired().HasMaxLength(1).IsUnicode(false);

            this.Property(t => t.Tenant).HasColumnName("Tenant");

            this.Property(t => t.SyncTo).HasColumnName("SyncTo").IsRequired().HasMaxLength(30).IsUnicode(false);
        }
    }
}
