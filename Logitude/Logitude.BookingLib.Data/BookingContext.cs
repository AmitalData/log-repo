...
{
   public class BookingContext: DbContextBase, IBookingContext
    {
        ...
        public BookingContext(DbConnection conn)
            : base(conn,true)
        {
        ...
        public static IBookingContext GetContext(int tenant)
        {           
            GlobalDB currentDb;
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
			...
			modelBuilder.Entity<Booking>().Property(x => x.GrossWeight).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.Volume).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.VolumetricWeight).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.ChargeableWeight).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.GrossWeightInKG).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.ChargeableWeightInKG).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.Ratio).HasPrecision(18, 3);
				
			modelBuilder.Entity<Booking>().Property(x => x.DimFactor).HasPrecision(18, 3);
				
			modelBuilder.Entity<BookingAnswer>().Property(x => x.Weight).HasPrecision(18, 2);
			...
			modelBuilder.Entity<FlightsSchedulesRequest>().Property(x => x.Volume).HasPrecision(18, 3);
				
			modelBuilder.Entity<FlightsSchedulesRequest>().Property(x => x.GrossWeight).HasPrecision(18, 3);
	 ...
	 public IDbSet<Booking> Bookings 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingAnswer> BookingAnswers 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingAnswerStatus> BookingAnswerStatus 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingLastRequest> BookingLastRequests 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingLevel> BookingLevels 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingPackage> BookingPackages 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingProduct> BookingProducts 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingSpaceAllocation> BookingSpaceAllocations 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<BookingStatus> BookingStatus 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<FFRStatus> FFRStatus 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<FlightsSchedulesRequest> FlightsSchedulesRequests 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<FlightsSchedulesRequestStatus> FlightsSchedulesRequestStatus 
	 {
	      get; set;
	 
	 }
	
	 public IDbSet<FlightsSchedulesResponse> FlightsSchedulesResponses 
	 {
	      get; set;
