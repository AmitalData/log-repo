...
namespace Logitude.CRM.Data.EntityMapping
{
    ...
    public class ActivityNoteMap : EntityTypeConfiguration<ActivityNote>
    {
	    string dbms;
        public ActivityNoteMap()
        { 
				this.ToTable("ActivityNotes");
            ...
            this.Property(t => t.Notes).HasColumnName("Notes").IsRequired().HasMaxLength(500).IsUnicode(true);
