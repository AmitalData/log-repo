...
namespace Logitude.CRM.Data.EntityMapping
{
    ...
    public class SupportMailboxMap : EntityTypeConfiguration<SupportMailbox>
    {
	    string dbms;
        public SupportMailboxMap()
        { 
				this.ToTable("SupportMailboxes");
            ...
            this.Property(t => t.Mailbox).HasColumnName("Mailbox").IsRequired().HasMaxLength(100).IsUnicode(false);
