...
namespace Logitude.CRM.Data.EntityMapping
{
    ...
    public class ActivityEmailRecipientMap : EntityTypeConfiguration<ActivityEmailRecipient>
    {
	    string dbms;
        public ActivityEmailRecipientMap()
        { 
				this.ToTable("ActivityEmailRecipients");
            ...
            this.Property(t => t.RecipientTypeCode).HasColumnName("RecipientTypeCode").IsRequired().HasMaxLength(3).IsUnicode(false);
