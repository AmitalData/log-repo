...
{
    public class TicketBusinessUnitFilter
    {
        private int myCurrentTenant;
        private string loggedUserEmail;
        private User loggedUser;

        public TicketBusinessUnitFilter(int tenant)
        {
        ...
        public IQueryable<Ticket> RunFilter(IQueryable<Ticket> iQueryableData)
        {
        ...
        public IQueryable<TicketList> RunFilter(IQueryable<TicketList> iQueryableData)
        {
            List<RoleFeature> myFeatureRoles = this.GetFeaturesRoles();
