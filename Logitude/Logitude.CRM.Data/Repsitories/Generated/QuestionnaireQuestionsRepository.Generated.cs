...
namespace Logitude.CRM.Data.Repsitories
{
   public partial class QuestionnaireQuestionRepository:IRepository<QuestionnaireQuestion>
   {
		...
		public  QuestionnaireQuestion GetSingle(string questioneerid, int version, int questionnumber, int tenant)
        {
            return (from a in context.QuestionnaireQuestions
                    where a.QuestioneerId == questioneerid && a.VersionNumber == version && a.QuestionNumber == questionnumber && a.Tenant == tenant
