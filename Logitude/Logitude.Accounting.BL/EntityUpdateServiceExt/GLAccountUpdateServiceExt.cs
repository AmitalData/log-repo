...
namespace Logitude.Accounting.BL.EntityUpdateServiceExt
{
    public class GLAccountUpdateServiceExt : IGLAccountUpdateServiceExt
    {
        ...
        public void UpdateGLAccountWithAdditionalData(string accountId,int tenant, string excludeId)
        {
            ...
            service.UpdateGLAccountWithAdditionalData(accountId, tenant,excludeId);
        }
    }
}
