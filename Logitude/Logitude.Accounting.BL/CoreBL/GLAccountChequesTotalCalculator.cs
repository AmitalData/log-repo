    ...
    class GLAccountChequesTotalCalculator
    {
        ...
        public void RecalculateChequesTotalForBillToAccount(string billToAccountId)
        {
            ...
            foreach (var glMoreData in _glaccountMoreDatas) {
                var totalOpenChequesInLocalCur = transactionsQuery.GetTotalOpenChequesLocalAmount(glMoreData.AccountId);
                var totFutureOpenChequesInLocalCur = transactionsQuery.GetTotFutureOpenChequesLocalAmount(glMoreData.AccountId, endOfTodayDate);
