...
namespace Logitude.Accounting.BL.CoreBL.InterestReport
{
    public class InterestReportDataCalculations
    {
        ...
        private decimal? GetInterestReportOpenBalance()
        {
            ...
            decimal interestReportOpenBalance = interestReportQueryService.GetInterestReportOpenBalance(interestReportPM.InterestCalculationDate,tenant, interestReportPM.GLAccountId);
