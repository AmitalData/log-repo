        ...
        public override void RunCode()
        {
            ...
            try
            {
                ...
                using (var scope = TransactionFactory.GetTransaction(TimeSpan.FromMinutes(600)))
                {
                    ...
                    reconciliationStageCBatch.RunReconciliationStageC(parameterArgs);
            ...
            catch (Exception ex)
            {
                ...
                LogitudeSettings.HandleLogMe(ex.ToString(), true, "BatchReconciliationStageCTask", new DateTime(2019, 10, 1));
                throw;
