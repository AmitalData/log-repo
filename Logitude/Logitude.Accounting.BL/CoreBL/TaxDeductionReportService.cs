   ...
   public  class TaxDeductionReportService
    {
        ...
        public static DocumentsFilingPM Create856File(string taxDeductionReportId, int tenant)
        {
            ...
            TaxDeductionReportPM taxDeductionReportPM = taxDeductionReportQueryService.GetSingle(taxDeductionReportId, false, false);
                ...
                if (item.DisplayNumber != null)
                    ...
                    if (item.DeductionFileTypeCode == "08")
                    {
                        if (item.EnglishName != null)
                        {
                            ...
                            myStringBuilder.Append( item.EnglishName.ToUpper().PadLeft(22, ' '));
                        }
                    }
                    else
                    {
                ...
                myStringBuilder.Append( item.SumOfAmountInLocalCurrency.Value.ToString().PadLeft(11, '0'));
                    myStringBuilder.Append(item.SumOfTaxDeductionLocalAmount.Value.ToString().PadLeft(9, '0'));
            ...
            if (taxDeductionReportPM.Email != null)
                ...
                else
                {
                    ...
                    if (item.TotalPaymentsWithoutDivided != null)
                    {
                        ...
                        myStringBuilder.Append(item.TotalPaymentsWithoutDivided.Value.ToString().PadLeft(12, '0'));
                    }
                    ...
                    if (item.TotalDeductionsWithoutDivided != null)
                    {
                        ...
                        myStringBuilder.Append( item.TotalDeductionsWithoutDivided.Value.ToString().PadLeft(12, '0'));
                    }
                    ...
                    if (item.TotalDivided != null)
                    {
                        ...
                        myStringBuilder.Append( item.TotalDivided.Value.ToString().PadLeft(12, '0'));
                    }
                    ...
                    if (item.TotalDeductionsFromDivided != null)
                    {
                        ...
                        myStringBuilder.Append(item.TotalDeductionsFromDivided.Value.ToString().PadLeft(12, '0'));
                    }
