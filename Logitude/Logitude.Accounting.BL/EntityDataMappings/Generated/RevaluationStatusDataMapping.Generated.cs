...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class RevaluationStatusDataMapping: IMapping<RevaluationStatusPM, RevaluationStatus>,IMappingEncodeBase64NVARCHARFields<RevaluationStatusPM>
   {
	    ...
	    public void PMToPOCO(RevaluationStatusPM entityPM, RevaluationStatus entityPOCO)
        {
		...
		public void POCOToPM(RevaluationStatusPM entityPM, RevaluationStatus entityPOCO)
        {
		...
		public void PMToOldPM(RevaluationStatusPM entityPM, RevaluationStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(RevaluationStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(RevaluationStatusPM entityPM, RevaluationStatus entityPOCO, bool isNewEntity)
        {
