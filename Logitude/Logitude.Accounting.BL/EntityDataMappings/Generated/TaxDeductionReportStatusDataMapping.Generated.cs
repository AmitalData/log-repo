...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class TaxDeductionReportStatusDataMapping: IMapping<TaxDeductionReportStatusPM, TaxDeductionReportStatus>,IMappingEncodeBase64NVARCHARFields<TaxDeductionReportStatusPM>
   {
	    ...
	    public void PMToPOCO(TaxDeductionReportStatusPM entityPM, TaxDeductionReportStatus entityPOCO)
        {
		...
		public void POCOToPM(TaxDeductionReportStatusPM entityPM, TaxDeductionReportStatus entityPOCO)
        {
		...
		public void PMToOldPM(TaxDeductionReportStatusPM entityPM, TaxDeductionReportStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TaxDeductionReportStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TaxDeductionReportStatusPM entityPM, TaxDeductionReportStatus entityPOCO, bool isNewEntity)
        {
