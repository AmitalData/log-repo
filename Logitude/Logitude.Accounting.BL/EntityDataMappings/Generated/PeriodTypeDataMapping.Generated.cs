...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class PeriodTypeDataMapping: IMapping<PeriodTypePM, PeriodType>,IMappingEncodeBase64NVARCHARFields<PeriodTypePM>
   {
	    ...
	    public void PMToPOCO(PeriodTypePM entityPM, PeriodType entityPOCO)
        {
		...
		public void POCOToPM(PeriodTypePM entityPM, PeriodType entityPOCO)
        {
		...
		public void PMToOldPM(PeriodTypePM entityPM, PeriodTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(PeriodTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(PeriodTypePM entityPM, PeriodType entityPOCO, bool isNewEntity)
        {
