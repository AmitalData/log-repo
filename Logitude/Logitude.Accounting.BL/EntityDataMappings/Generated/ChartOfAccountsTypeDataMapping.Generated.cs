...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class ChartOfAccountsTypeDataMapping: IMapping<ChartOfAccountsTypePM, ChartOfAccountsType>,IMappingEncodeBase64NVARCHARFields<ChartOfAccountsTypePM>
   {
	    ...
	    public void PMToPOCO(ChartOfAccountsTypePM entityPM, ChartOfAccountsType entityPOCO)
        {
		...
		public void POCOToPM(ChartOfAccountsTypePM entityPM, ChartOfAccountsType entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ChartOfAccountsTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ChartOfAccountsTypePM entityPM, ChartOfAccountsType entityPOCO, bool isNewEntity)
        {
