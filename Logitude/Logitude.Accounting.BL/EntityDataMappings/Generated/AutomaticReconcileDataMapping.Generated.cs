...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class AutomaticReconcileDataMapping: IMapping<AutomaticReconcilePM, AutomaticReconcile>,IMappingEncodeBase64NVARCHARFields<AutomaticReconcilePM>
   {
	    ...
	    public void PMToPOCO(AutomaticReconcilePM entityPM, AutomaticReconcile entityPOCO)
        {
		...
		public void POCOToPM(AutomaticReconcilePM entityPM, AutomaticReconcile entityPOCO)
        {
		...
		public void PMToOldPM(AutomaticReconcilePM entityPM, AutomaticReconcilePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AutomaticReconcilePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AutomaticReconcilePM entityPM, AutomaticReconcile entityPOCO, bool isNewEntity)
        {
