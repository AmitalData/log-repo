...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class InvoiceApiCommunicationLogDataMapping: IMapping<InvoiceApiCommunicationLogPM, InvoiceApiCommunicationLog>,IMappingEncodeBase64NVARCHARFields<InvoiceApiCommunicationLogPM>
   {
	    ...
	    public void PMToPOCO(InvoiceApiCommunicationLogPM entityPM, InvoiceApiCommunicationLog entityPOCO)
        {
		...
		public void POCOToPM(InvoiceApiCommunicationLogPM entityPM, InvoiceApiCommunicationLog entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(InvoiceApiCommunicationLogPM entityPM, InvoiceApiCommunicationLog entityPOCO, bool isNewEntity)
        {
