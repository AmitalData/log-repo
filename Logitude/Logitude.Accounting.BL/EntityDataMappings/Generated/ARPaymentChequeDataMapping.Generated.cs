...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class ARPaymentChequeDataMapping: IMapping<ARPaymentChequePM, ARPaymentCheque>,IMappingEncodeBase64NVARCHARFields<ARPaymentChequePM>
   {
	    ...
	    public void PMToPOCO(ARPaymentChequePM entityPM, ARPaymentCheque entityPOCO)
        {
		...
		public void POCOToPM(ARPaymentChequePM entityPM, ARPaymentCheque entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ARPaymentChequePM entityPM, ARPaymentCheque entityPOCO, bool isNewEntity)
        {
