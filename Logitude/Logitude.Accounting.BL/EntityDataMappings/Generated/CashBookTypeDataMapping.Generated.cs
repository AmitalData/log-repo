...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class CashBookTypeDataMapping: IMapping<CashBookTypePM, CashBookType>,IMappingEncodeBase64NVARCHARFields<CashBookTypePM>
   {
	    ...
	    public void PMToPOCO(CashBookTypePM entityPM, CashBookType entityPOCO)
        {
		...
		public void POCOToPM(CashBookTypePM entityPM, CashBookType entityPOCO)
        {
		...
		public void PMToOldPM(CashBookTypePM entityPM, CashBookTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CashBookTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CashBookTypePM entityPM, CashBookType entityPOCO, bool isNewEntity)
        {
