...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class CalculatedChartsLineTypeDataMapping: IMapping<CalculatedChartsLineTypePM, CalculatedChartsLineType>,IMappingEncodeBase64NVARCHARFields<CalculatedChartsLineTypePM>
   {
	    ...
	    public void PMToPOCO(CalculatedChartsLineTypePM entityPM, CalculatedChartsLineType entityPOCO)
        {
		...
		public void POCOToPM(CalculatedChartsLineTypePM entityPM, CalculatedChartsLineType entityPOCO)
        {
		...
		public void PMToOldPM(CalculatedChartsLineTypePM entityPM, CalculatedChartsLineTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CalculatedChartsLineTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CalculatedChartsLineTypePM entityPM, CalculatedChartsLineType entityPOCO, bool isNewEntity)
        {
