...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class TaxReportLineStatusDataMapping: IMapping<TaxReportLineStatusPM, TaxReportLineStatus>,IMappingEncodeBase64NVARCHARFields<TaxReportLineStatusPM>
   {
	    ...
	    public void PMToPOCO(TaxReportLineStatusPM entityPM, TaxReportLineStatus entityPOCO)
        {
		...
		public void POCOToPM(TaxReportLineStatusPM entityPM, TaxReportLineStatus entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(TaxReportLineStatusPM entityPM, TaxReportLineStatus entityPOCO, bool isNewEntity)
        {
