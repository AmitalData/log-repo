...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class ARPaymentChequeStatusDataMapping: IMapping<ARPaymentChequeStatusPM, ARPaymentChequeStatus>,IMappingEncodeBase64NVARCHARFields<ARPaymentChequeStatusPM>
   {
	    ...
	    public void PMToPOCO(ARPaymentChequeStatusPM entityPM, ARPaymentChequeStatus entityPOCO)
        {
		...
		public void POCOToPM(ARPaymentChequeStatusPM entityPM, ARPaymentChequeStatus entityPOCO)
        {
		...
		public void PMToOldPM(ARPaymentChequeStatusPM entityPM, ARPaymentChequeStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ARPaymentChequeStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ARPaymentChequeStatusPM entityPM, ARPaymentChequeStatus entityPOCO, bool isNewEntity)
        {
