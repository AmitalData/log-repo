...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class OpenFormatDateTypeDataMapping: IMapping<OpenFormatDateTypePM, OpenFormatDateType>,IMappingEncodeBase64NVARCHARFields<OpenFormatDateTypePM>
   {
	    ...
	    public void PMToPOCO(OpenFormatDateTypePM entityPM, OpenFormatDateType entityPOCO)
        {
		...
		public void POCOToPM(OpenFormatDateTypePM entityPM, OpenFormatDateType entityPOCO)
        {
		...
		public void PMToOldPM(OpenFormatDateTypePM entityPM, OpenFormatDateTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(OpenFormatDateTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(OpenFormatDateTypePM entityPM, OpenFormatDateType entityPOCO, bool isNewEntity)
        {
