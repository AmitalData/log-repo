...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class ReconcileCurrencyTypeDataMapping: IMapping<ReconcileCurrencyTypePM, ReconcileCurrencyType>,IMappingEncodeBase64NVARCHARFields<ReconcileCurrencyTypePM>
   {
	    ...
	    public void PMToPOCO(ReconcileCurrencyTypePM entityPM, ReconcileCurrencyType entityPOCO)
        {
		...
		public void POCOToPM(ReconcileCurrencyTypePM entityPM, ReconcileCurrencyType entityPOCO)
        {
		...
		public void PMToOldPM(ReconcileCurrencyTypePM entityPM, ReconcileCurrencyTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ReconcileCurrencyTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ReconcileCurrencyTypePM entityPM, ReconcileCurrencyType entityPOCO, bool isNewEntity)
        {
