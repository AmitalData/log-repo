...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class VatReportStatusDataMapping: IMapping<VatReportStatusPM, VatReportStatus>,IMappingEncodeBase64NVARCHARFields<VatReportStatusPM>
   {
	    ...
	    public void PMToPOCO(VatReportStatusPM entityPM, VatReportStatus entityPOCO)
        {
		...
		public void POCOToPM(VatReportStatusPM entityPM, VatReportStatus entityPOCO)
        {
		...
		public void PMToOldPM(VatReportStatusPM entityPM, VatReportStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(VatReportStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(VatReportStatusPM entityPM, VatReportStatus entityPOCO, bool isNewEntity)
        {
