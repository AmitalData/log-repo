...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class TaxWithholdingAssessOfficeDataMapping: IMapping<TaxWithholdingAssessOfficePM, TaxWithholdingAssessOffice>,IMappingEncodeBase64NVARCHARFields<TaxWithholdingAssessOfficePM>
   {
	    ...
	    public void PMToPOCO(TaxWithholdingAssessOfficePM entityPM, TaxWithholdingAssessOffice entityPOCO)
        {
		...
		public void POCOToPM(TaxWithholdingAssessOfficePM entityPM, TaxWithholdingAssessOffice entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(TaxWithholdingAssessOfficePM entityPM, TaxWithholdingAssessOffice entityPOCO, bool isNewEntity)
        {
