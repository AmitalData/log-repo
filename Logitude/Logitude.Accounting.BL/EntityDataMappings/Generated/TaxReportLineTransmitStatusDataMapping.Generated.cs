...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class TaxReportLineTransmitStatusDataMapping: IMapping<TaxReportLineTransmitStatusPM, TaxReportLineTransmitStatus>,IMappingEncodeBase64NVARCHARFields<TaxReportLineTransmitStatusPM>
   {
	    ...
	    public void PMToPOCO(TaxReportLineTransmitStatusPM entityPM, TaxReportLineTransmitStatus entityPOCO)
        {
		...
		public void POCOToPM(TaxReportLineTransmitStatusPM entityPM, TaxReportLineTransmitStatus entityPOCO)
        {
		...
		public void PMToOldPM(TaxReportLineTransmitStatusPM entityPM, TaxReportLineTransmitStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TaxReportLineTransmitStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TaxReportLineTransmitStatusPM entityPM, TaxReportLineTransmitStatus entityPOCO, bool isNewEntity)
        {
