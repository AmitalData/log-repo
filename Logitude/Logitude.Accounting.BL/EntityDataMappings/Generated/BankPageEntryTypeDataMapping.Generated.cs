...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class BankPageEntryTypeDataMapping: IMapping<BankPageEntryTypePM, BankPageEntryType>,IMappingEncodeBase64NVARCHARFields<BankPageEntryTypePM>
   {
	    ...
	    public void PMToPOCO(BankPageEntryTypePM entityPM, BankPageEntryType entityPOCO)
        {
		...
		public void POCOToPM(BankPageEntryTypePM entityPM, BankPageEntryType entityPOCO)
        {
		...
		public void PMToOldPM(BankPageEntryTypePM entityPM, BankPageEntryTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(BankPageEntryTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(BankPageEntryTypePM entityPM, BankPageEntryType entityPOCO, bool isNewEntity)
        {
