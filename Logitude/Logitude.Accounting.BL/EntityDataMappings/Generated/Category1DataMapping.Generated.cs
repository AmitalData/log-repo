...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class Category1DataMapping: IMapping<Category1PM, Category1>,IMappingEncodeBase64NVARCHARFields<Category1PM>
   {
	    ...
	    public void PMToPOCO(Category1PM entityPM, Category1 entityPOCO)
        {
		...
		public void POCOToPM(Category1PM entityPM, Category1 entityPOCO)
        {
		...
		public void PMToOldPM(Category1PM entityPM, Category1PM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(Category1PM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(Category1PM entityPM, Category1 entityPOCO, bool isNewEntity)
        {
