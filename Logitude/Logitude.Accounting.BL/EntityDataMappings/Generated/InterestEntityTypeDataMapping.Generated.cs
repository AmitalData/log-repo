...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class InterestEntityTypeDataMapping: IMapping<InterestEntityTypePM, InterestEntityType>,IMappingEncodeBase64NVARCHARFields<InterestEntityTypePM>
   {
	    ...
	    public void PMToPOCO(InterestEntityTypePM entityPM, InterestEntityType entityPOCO)
        {
		...
		public void POCOToPM(InterestEntityTypePM entityPM, InterestEntityType entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(InterestEntityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(InterestEntityTypePM entityPM, InterestEntityType entityPOCO, bool isNewEntity)
        {
