...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class AdditionalCurrencyRateDataMapping: IMapping<AdditionalCurrencyRatePM, AdditionalCurrencyRate>,IMappingEncodeBase64NVARCHARFields<AdditionalCurrencyRatePM>
   {
	    ...
	    public void PMToPOCO(AdditionalCurrencyRatePM entityPM, AdditionalCurrencyRate entityPOCO)
        {
		...
		public void POCOToPM(AdditionalCurrencyRatePM entityPM, AdditionalCurrencyRate entityPOCO)
        {
		...
		public void PMToOldPM(AdditionalCurrencyRatePM entityPM, AdditionalCurrencyRatePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AdditionalCurrencyRatePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(AdditionalCurrencyRatePM entityPM, AdditionalCurrencyRate entityPOCO, bool isNewEntity)
        {
