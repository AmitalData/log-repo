...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class Category2DataMapping: IMapping<Category2PM, Category2>,IMappingEncodeBase64NVARCHARFields<Category2PM>
   {
	    ...
	    public void PMToPOCO(Category2PM entityPM, Category2 entityPOCO)
        {
		...
		public void POCOToPM(Category2PM entityPM, Category2 entityPOCO)
        {
		...
		public void PMToOldPM(Category2PM entityPM, Category2PM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(Category2PM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(Category2PM entityPM, Category2 entityPOCO, bool isNewEntity)
        {
