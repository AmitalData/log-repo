...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class AccountingEntityDataMapping: IMapping<AccountingEntityPM, AccountingEntity>,IMappingEncodeBase64NVARCHARFields<AccountingEntityPM>
   {
	    ...
	    public void PMToPOCO(AccountingEntityPM entityPM, AccountingEntity entityPOCO)
        {
		...
		public void POCOToPM(AccountingEntityPM entityPM, AccountingEntity entityPOCO)
        {
		...
		public void PMToOldPM(AccountingEntityPM entityPM, AccountingEntityPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(AccountingEntityPM entityPM)
        {
