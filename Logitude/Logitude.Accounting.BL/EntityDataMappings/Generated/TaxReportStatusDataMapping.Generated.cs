...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class TaxReportStatusDataMapping: IMapping<TaxReportStatusPM, TaxReportStatus>,IMappingEncodeBase64NVARCHARFields<TaxReportStatusPM>
   {
	    ...
	    public void PMToPOCO(TaxReportStatusPM entityPM, TaxReportStatus entityPOCO)
        {
		...
		public void POCOToPM(TaxReportStatusPM entityPM, TaxReportStatus entityPOCO)
        {
		...
		public void PMToOldPM(TaxReportStatusPM entityPM, TaxReportStatusPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TaxReportStatusPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TaxReportStatusPM entityPM, TaxReportStatus entityPOCO, bool isNewEntity)
        {
