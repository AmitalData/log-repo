...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class Category4DataMapping: IMapping<Category4PM, Category4>,IMappingEncodeBase64NVARCHARFields<Category4PM>
   {
	    ...
	    public void PMToPOCO(Category4PM entityPM, Category4 entityPOCO)
        {
		...
		public void POCOToPM(Category4PM entityPM, Category4 entityPOCO)
        {
		...
		public void PMToOldPM(Category4PM entityPM, Category4PM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(Category4PM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(Category4PM entityPM, Category4 entityPOCO, bool isNewEntity)
        {
