...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class WithholdingTaxDeductionTypeDataMapping: IMapping<WithholdingTaxDeductionTypePM, WithholdingTaxDeductionType>,IMappingEncodeBase64NVARCHARFields<WithholdingTaxDeductionTypePM>
   {
	    ...
	    public void PMToPOCO(WithholdingTaxDeductionTypePM entityPM, WithholdingTaxDeductionType entityPOCO)
        {
		...
		public void POCOToPM(WithholdingTaxDeductionTypePM entityPM, WithholdingTaxDeductionType entityPOCO)
        {
		...
		public void PMToOldPM(WithholdingTaxDeductionTypePM entityPM, WithholdingTaxDeductionTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(WithholdingTaxDeductionTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(WithholdingTaxDeductionTypePM entityPM, WithholdingTaxDeductionType entityPOCO, bool isNewEntity)
        {
