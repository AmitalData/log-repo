...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class JournalActionTypeDataMapping: IMapping<JournalActionTypePM, JournalActionType>,IMappingEncodeBase64NVARCHARFields<JournalActionTypePM>
   {
	    ...
	    public void PMToPOCO(JournalActionTypePM entityPM, JournalActionType entityPOCO)
        {
		...
		public void POCOToPM(JournalActionTypePM entityPM, JournalActionType entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(JournalActionTypePM entityPM, JournalActionType entityPOCO, bool isNewEntity)
        {
