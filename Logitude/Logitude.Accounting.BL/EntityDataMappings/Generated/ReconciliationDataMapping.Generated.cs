...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class ReconciliationDataMapping: IMapping<ReconciliationPM, Reconciliation>,IMappingEncodeBase64NVARCHARFields<ReconciliationPM>
   {
	    ...
	    public void PMToPOCO(ReconciliationPM entityPM, Reconciliation entityPOCO)
        {
		...
		public void POCOToPM(ReconciliationPM entityPM, Reconciliation entityPOCO)
        {
		...
		private void BuildSearchFieldsGenerated(ReconciliationPM entityPM, Reconciliation entityPOCO, bool isNewEntity)
        {
