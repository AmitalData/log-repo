...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class MagayaCommunicationLogDataMapping: IMapping<MagayaCommunicationLogPM, MagayaCommunicationLog>,IMappingEncodeBase64NVARCHARFields<MagayaCommunicationLogPM>
   {
	    ...
	    public void PMToPOCO(MagayaCommunicationLogPM entityPM, MagayaCommunicationLog entityPOCO)
        {
		...
		public void POCOToPM(MagayaCommunicationLogPM entityPM, MagayaCommunicationLog entityPOCO)
        {
		...
		public void PMToOldPM(MagayaCommunicationLogPM entityPM, MagayaCommunicationLogPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(MagayaCommunicationLogPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(MagayaCommunicationLogPM entityPM, MagayaCommunicationLog entityPOCO, bool isNewEntity)
        {
