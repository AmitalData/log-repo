...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class ReconcileMethodDataMapping: IMapping<ReconcileMethodPM, ReconcileMethod>,IMappingEncodeBase64NVARCHARFields<ReconcileMethodPM>
   {
	    ...
	    public void PMToPOCO(ReconcileMethodPM entityPM, ReconcileMethod entityPOCO)
        {
		...
		public void POCOToPM(ReconcileMethodPM entityPM, ReconcileMethod entityPOCO)
        {
		...
		public void PMToOldPM(ReconcileMethodPM entityPM, ReconcileMethodPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(ReconcileMethodPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(ReconcileMethodPM entityPM, ReconcileMethod entityPOCO, bool isNewEntity)
        {
