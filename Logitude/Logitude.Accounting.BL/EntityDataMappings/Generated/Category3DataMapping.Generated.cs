...
namespace Logitude.Accounting.BL.EntityDataMappings
{
   ...
   public partial class Category3DataMapping: IMapping<Category3PM, Category3>,IMappingEncodeBase64NVARCHARFields<Category3PM>
   {
	    ...
	    public void PMToPOCO(Category3PM entityPM, Category3 entityPOCO)
        {
		...
		public void POCOToPM(Category3PM entityPM, Category3 entityPOCO)
        {
		...
		public void PMToOldPM(Category3PM entityPM, Category3PM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(Category3PM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(Category3PM entityPM, Category3 entityPOCO, bool isNewEntity)
        {
