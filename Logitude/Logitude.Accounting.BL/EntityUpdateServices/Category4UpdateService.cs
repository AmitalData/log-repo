...
namespace Logitude.Accounting.BL.EntityUpdateServices
{
    ...
    {
        protected override void OnCreating(Category4PM entityPM, EntityPM entityParentPM)
        {
            entityPM.Id = IdCounter.GetNumber("Category4", entityPM.Tenant);
            entityPM.SearchFields = entityPM.EnglishName + "," + entityPM.LocalName;
        }
        protected override void OnUpdating(Category4PM entityPM)
        {
            entityPM.SearchFields = entityPM.EnglishName + "," + entityPM.LocalName;
        }
        protected override void Trace(Category4PM entityPM, Category4 entityPOCO, string changesXml)
        {
