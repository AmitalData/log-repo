...
{ 
   public partial class EventRemarkUpdateService:EntityUpdateService<EventRemark,EventRemarkPM,EntityPM>
   {
   
        EventRemarkRepository entityRepository;
        ...
        public EventRemarkUpdateService(int tenant)
        {
            currentContext = AccountingContext.GetContext(tenant);
        }

        public EventRemarkUpdateService(IAccountingContext context)
        {
            currentContext = context;
        }

		
		protected override EntityKeyFields GetKeys(EventRemarkPM entityPM)
        {
            EventRemarkKeys entityKeys = new EventRemarkKeys() { Id = entityPM.Id };
            return entityKeys;
        }
