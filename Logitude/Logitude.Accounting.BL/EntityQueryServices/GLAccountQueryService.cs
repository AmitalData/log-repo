...
namespace Logitude.Accounting.BL.EntityQueryServices
{
    ...
    bool IncludeChildAccounts, string ChartOfAccountsTypeCode, string salesmanId, bool includeControlAccount, bool useSecurityLevel, string collectorId,List<string> listGLAccounts,string fromGLAccountId , string toGLAccountId)
        {
            ...
            if (!String.IsNullOrWhiteSpace(cat1) || !String.IsNullOrWhiteSpace(cat2) || !String.IsNullOrWhiteSpace(cat3) || !String.IsNullOrWhiteSpace(cat4)
                ...
                || !String.IsNullOrWhiteSpace(salesmanId) || !String.IsNullOrWhiteSpace(collectorId) || (listGLAccounts != null && listGLAccounts.Count > 0 || (!String.IsNullOrWhiteSpace(fromGLAccountId)  && !String.IsNullOrWhiteSpace(toGLAccountId)))
                )
            {
                   ...
                   allIdAccounts = repository.GetQAccIdByAcountIdTypeCategories(tenant, GLAccountId, cat1, cat2, cat3, cat4, cat5, gLAccountType, chartOfAccountsId, ChartOfAccountsTypeCode, salesmanId, includeControlAccount, collectorId, securityLevel, listGLAccounts,fromGLAccountId,toGLAccountId);
