...
{
    public class DCAInUCBSendDelayForm_MsgMessagingService : MessagingServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        SYSTBL_NG_9000_MSG_SystemTableRequest,
        DCAInUCBDelayFormWithResponseContentHeader,
        DCAInCustomReturnNullRequestService,
        UniCourierBatchSendDelayForm_MsgResponseService, RequestHeader>
    {
        ...
        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCBDelayFormWithResponseContentHeader customsResponse)
        {
        ...
        protected override DCAInUCBDelayFormWithResponseContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
        ...
        public string CreateCRS(int tenant, string LoggingUserId, SendALLDelayFormParams mySendALLDelayFormParams)
        {
            ...
            var myDCAInUCBDelayFormWithResponseContentHeader = new DCAInUCBDelayFormWithResponseContentHeader()
            {
                CourierMasterId = mySendALLDelayFormParams.CourierMasterId,
                LoggingUserId = LoggingUserId,
                master = mySendALLDelayFormParams.HAWB,
                ClientFilterDeclarationsList = mySendALLDelayFormParams.Declarations,
                tenant = tenant,
                MyMoreParams = "",
            ...
            var body = XmlGenericUtil<DCAInUCBDelayFormWithResponseContentHeader>.SerializeObject(myDCAInUCBDelayFormWithResponseContentHeader);
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCBDelayFormWithResponseContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCBDelayFormWithResponseContentHeader")]
    public class DCAInUCBDelayFormWithResponseContentHeader : IINF_MSG_Generic
    {
