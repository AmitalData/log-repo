...
{
    public class DCAInUCBCreateSupplierInvoiceFromFile_MsgMessagingService : MessagingServiceBase<
      GenericRequestParams,
      INF_MSG_GenericResponseData,
      SYSTBL_NG_9000_MSG_SystemTableRequest,
      DCAInUCBCreateSupplierInvoiceWithResponseContentHeader,
      DCAInCustomReturnNullRequestService,
      CreateSupplierInvoiceFromFileBatchUCB_MsgResponseService, RequestHeader>
    {
        ...
        protected override DCAInUCBCreateSupplierInvoiceWithResponseContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
            throw new NotImplementedException();
        }

        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCBCreateSupplierInvoiceWithResponseContentHeader customsResponse)
        {
            ...
            if (customsResponse.Declarationid != null)
            {
                ...
                genericRequestParams.RequestName = $" {customsResponse.Declarationid} קליטת חשבון ספק מקובץ בהצהרה ";
            }
        ...
        public string CreateCRS(int tenant, string clientId, string partnerId,string declarationid, string decodedString)
        {
            ...
            LogMessagingUtil.Instance.AppendLine("Build !!!Requestsheet  with Interface Type  = DCACSIFF  !!!");

            string uniComm = null;
            string fileName = null;
            var transmitionDateTime = DateTime.Now;
            string xmlESBResponseXmlClass = null;
            var myDCAInUCBCreateSupplierInvoiceWithResponseContentHeader = new DCAInUCBCreateSupplierInvoiceWithResponseContentHeader()
            {
            ...
            var body = XmlGenericUtil<DCAInUCBCreateSupplierInvoiceWithResponseContentHeader>.SerializeObject(myDCAInUCBCreateSupplierInvoiceWithResponseContentHeader);
            ...
            using (var trans = TransactionFactory.GetNewTransaction())
            {
                ...
                catch (CustomsRequestsSheetDomainModelServiceException myCustomsRequestsSheetServiceException)
                {
                    ...
                    {
                        Logitude.Server.Tools.Helpers.LogMessagingUtil.Instance.AppendLine(" DCACSIFF SameRequestInProgress!! " + myCustomsRequestsSheetServiceException.Message);
                    }
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCBCreateSupplierInvoiceWithResponseContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCBCreateSupplierInvoiceWithResponseContentHeader")]
    public class DCAInUCBCreateSupplierInvoiceWithResponseContentHeader : IINF_MSG_Generic
    {
