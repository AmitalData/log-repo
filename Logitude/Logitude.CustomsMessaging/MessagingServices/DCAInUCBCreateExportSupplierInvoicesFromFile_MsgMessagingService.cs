...
{
    public class DCAInUCBCreateExportSupplierInvoicesFromFile_MsgMessagingService : MessagingServiceBase<
      GenericRequestParams,
      INF_MSG_GenericResponseData,
      SYSTBL_NG_9000_MSG_SystemTableRequest,
      DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader,
      DCAInCustomReturnNullRequestService,
      CreateExportSupplierInvoicesFromFileBatchUCB_MsgResponseService, RequestHeader>
    {

        public override string MainInterfaceCode
        {
            get { return "DCACESIFF"; }
        }

        protected override DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
            throw new NotImplementedException();
        }

        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader customsResponse)
        {
            ...
            if (customsResponse.Declarationid != null)
            {
                ...
                genericRequestParams.RequestName = $" {customsResponse.Declarationid} קליטת חשבונות יצואן מקובץ בהצהרה ";
            }
            
            return genericRequestParams;
        }

        public string CreateCRS(int tenant, string declarationid, string decodedString)
        {
            ...
            LogMessagingUtil.Instance.AppendLine("Build !!!Requestsheet  with Interface Type  = DCACESIFF  !!!");

            string uniComm = null;
            string fileName = null;
            var transmitionDateTime = DateTime.Now;
            string xmlESBResponseXmlClass = null;
            var myDCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader = new DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader()
            {
            ...
            var body = XmlGenericUtil<DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader>.SerializeObject(myDCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader);
            ...
            using (var trans = TransactionFactory.GetNewTransaction())
            {
                ...
                catch (CustomsRequestsSheetDomainModelServiceException myCustomsRequestsSheetServiceException)
                {
                    ...
                    {
                        Logitude.Server.Tools.Helpers.LogMessagingUtil.Instance.AppendLine(" DCACESIFF SameRequestInProgress!! " + myCustomsRequestsSheetServiceException.Message);
                    }
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader")]
    public class DCAInUCBCreateExportSupplierInvoicesWithResponseContentHeader : IINF_MSG_Generic
    {
