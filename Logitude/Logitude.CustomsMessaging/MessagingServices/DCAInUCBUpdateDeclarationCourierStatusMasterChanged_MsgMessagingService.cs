...
{
    public class DCAInUCBUpdateDeclarationCourierStatusMasterChanged_MsgMessagingService
        : MessagingServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        SYSTBL_NG_9000_MSG_SystemTableRequest,
        DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse,
        DCAInCustomReturnNullRequestService,
        UniCourierBatchUpdateDeclarationCourierStatusMasterChanged_MsgResponseService, RequestHeader>

    {

        public override string MainInterfaceCode
        {
            get { return "UCBUDCSMC"; }
        }

        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse customsResponse)
        {
            ...
            var genericRequestParams = new GenericRequestParams()
            {
                ...
                RequestName = $"עדכון שטרי מטען בלדר בקישור לטיסה " + customsResponse.master
            };
        ...
        protected override DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
            throw new NotImplementedException();
        }


        protected override bool? IsOurEnvironment(DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse customsResponse, GenericRequestParams RequestParams)
        {
            return false;
        }


        public string CreateCRS(int tenant, string LoggingUserId, string courierMasterId, string master, List<string> declarationsList = null)
            
        {
            ...
            LogMessagingUtil.Instance.AppendLine("Build !!!Requestsheet  with Interface Type  = UCBUDCSMC  !!!");
            string uniComm = null;
            string fileName = null;
            var transmitionDateTime = DateTime.Now;
            string xmlESBResponseXmlClass = null;

            var myDCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse = new DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse()
            {
            ...
            var body = XmlGenericUtil<DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse>.SerializeObject(myDCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse);
            //
            ...
            using (var trans = TransactionFactory.GetNewTransaction())
            {
                ...
                catch (CustomsRequestsSheetDomainModelServiceException myCustomsRequestsSheetServiceException)
                {
                    ...
                    {
                        Logitude.Server.Tools.Helpers.LogMessagingUtil.Instance.AppendLine(" UCBUDCSMC SameRequestInProgress!! " + myCustomsRequestsSheetServiceException.Message);
                    }
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse")]
    public class DCAInUCBUpdateDeclarationCourierStatusMasterChangedResponse : IINF_MSG_Generic
    {
