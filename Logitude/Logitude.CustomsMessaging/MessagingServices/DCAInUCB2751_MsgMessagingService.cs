...
{
    public class DCAInUCB2751_MsgMessagingService
        : MessagingServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        SYSTBL_NG_9000_MSG_SystemTableRequest,
        DCAInUCB2751WithResponseContentHeader,
        DCAInCustomReturnNullRequestService,
        UniExportBatchSend2751_MsgResponseService, RequestHeader>

    {
        ...
        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCB2751WithResponseContentHeader customsResponse)
        {
        ...
        protected override DCAInUCB2751WithResponseContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
        ...
        public string CreateCRS(int tenant, List<string> DeclarationsIds, string LoggingUserId, out string RequestInProgressListOut)
        {
            ...
            */
            LogMessagingUtil.Instance.AppendLine("Build !!!Requestsheet  with Interface Type  = UCB2751  !!!");
            ...
            using (var trans = TransactionFactory.GetNewTransaction())
            {
                ...
                catch (CustomsRequestsSheetDomainModelServiceException myCustomsRequestsSheetServiceException)
                {
                    ...
                    {
                        Logitude.Server.Tools.Helpers.LogMessagingUtil.Instance.AppendLine("UCB2751 SameRequestInProgress!! " + myCustomsRequestsSheetServiceException.Message);
                    }
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCB2751WithResponseContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCB2751WithResponseContentHeader")]
    public class DCAInUCB2751WithResponseContentHeader : IINF_MSG_Generic
    {
