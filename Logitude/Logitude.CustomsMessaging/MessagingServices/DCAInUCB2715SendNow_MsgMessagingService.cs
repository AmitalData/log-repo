...
{
    public class DCAInUCB2715SendNow_MsgMessagingService : MessagingServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        SYSTBL_NG_9000_MSG_SystemTableRequest,
        DCAInUCB2715SendNowWithResponseContentHeader,
        DCAInCustomReturnNullRequestService,
        UniCourierBatchSend2715SendNow_MsgResponseService, RequestHeader>
    {

        public override string MainInterfaceCode
        {
            get { return "UCB2715SendNow"; }
        }

        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCB2715SendNowWithResponseContentHeader customsResponse)
        {
            ...
            var genericRequestParams = new GenericRequestParams()
            {
                ...
                RequestName = $" שידור מסמכים ממתינים בתור ,טיסה" + customsResponse.CourierMaster + " "
            };
            if (customsResponse.ServerSplitDocumentList == null || (customsResponse.ServerSplitDocumentList != null && customsResponse.ServerSplitDocumentList.Count == 0))
        ...
        protected override DCAInUCB2715SendNowWithResponseContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
            throw new NotImplementedException();
        }

        public string CreateCRS(int tenant, string LoggingUserId, string courierMasterId, string MAWB, out string RequestInProgressListOut)
        {
            ...
            LogMessagingUtil.Instance.AppendLine("Build !!!Requestsheet  with Interface Type  = UCB2715SendNow  !!!");
            ...
            var myDCAInUCB2715SendNowWithResponseContentHeader = new DCAInUCB2715SendNowWithResponseContentHeader()
            {
            ...
            var body = XmlGenericUtil<DCAInUCB2715SendNowWithResponseContentHeader>.SerializeObject(myDCAInUCB2715SendNowWithResponseContentHeader);
            ...
            using (var trans = TransactionFactory.GetNewTransaction())
            {
                ...
                catch (CustomsRequestsSheetDomainModelServiceException myCustomsRequestsSheetServiceException)
                {
                    ...
                    {
                        Logitude.Server.Tools.Helpers.LogMessagingUtil.Instance.AppendLine(" UCB2715SendNow SameRequestInProgress!! " + myCustomsRequestsSheetServiceException.Message);
                    }
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCB2715SendNowWithResponseContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCB2715SendNowWithResponseContentHeader")]
    public class DCAInUCB2715SendNowWithResponseContentHeader : IINF_MSG_Generic
    {
        ...
        public List<string> ServerSplitDocumentList { get; set; }
