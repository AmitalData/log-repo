...
{
    public class DCAInUCBCreateCertificateForInvoiceItems_MsgMessagingService : MessagingServiceBase<
      GenericRequestParams,
      INF_MSG_GenericResponseData,
      SYSTBL_NG_9000_MSG_SystemTableRequest,
      DCAInUCBCreateCertificateForInvoiceItemsContentHeader,
      DCAInCustomReturnNullRequestService,
      CreateCertificateForInvoiceItemsBatchUCB_MsgResponseService, RequestHeader>
    {
        ...
        protected override DCAInUCBCreateCertificateForInvoiceItemsContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
            throw new NotImplementedException();
        }

        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCBCreateCertificateForInvoiceItemsContentHeader customsResponse)
        {
            ...
            genericRequestParams.RequestName = $" {customsResponse.CustomFileNo} יצירת אישור לפרטי מכס בהצהרה";
            ...
            string reqConfirmationTypeCode, string resConfirmationTypeCode, string certificateNumber,string certificateExemptionTypeCode, string selectedInvoiceItemsKeys, out string RequestInProgressListOut)
        {
            ...
            var myDCAInUCBMultiUpdateWithResponseContentHeader = new DCAInUCBCreateCertificateForInvoiceItemsContentHeader()
            {
            ...
            var body = XmlGenericUtil<DCAInUCBCreateCertificateForInvoiceItemsContentHeader>.SerializeObject(myDCAInUCBMultiUpdateWithResponseContentHeader);
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCBCreateCertificateForInvoiceItemsContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCBCreateCertificateForInvoiceItemsContentHeader")]
    public class DCAInUCBCreateCertificateForInvoiceItemsContentHeader : IINF_MSG_Generic
    {
