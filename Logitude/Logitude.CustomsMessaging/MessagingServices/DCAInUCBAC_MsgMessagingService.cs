...
{
    public class DCAInUCBAC_MsgMessagingService
        : MessagingServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        SYSTBL_NG_9000_MSG_SystemTableRequest,
        DCAInUCBACWithResponseContentHeader,
        DCAInCustomReturnNullRequestService,
        UniCourierBatchSendAC_MsgResponseService, RequestHeader>

    {
        ...
        protected override GenericRequestParams CreateDefaultRequestParamsFromCustomsResponse(DCAInUCBACWithResponseContentHeader customsResponse)
        {
        ...
        protected override DCAInUCBACWithResponseContentHeader CallWS(SYSTBL_NG_9000_MSG_SystemTableRequest customRequest, GenericRequestParams requestParams, out string exceptionMessage)
        {
            throw new NotImplementedException();
        }


        protected override bool? IsOurEnvironment(DCAInUCBACWithResponseContentHeader customsResponse, GenericRequestParams RequestParams)
        {
            return false;
        }
        ...
        public string CreateCRS(int tenant, string LoggingUserId, SendALLCorrectRequestParams requestParamsData)
        {
            ...
            var myDCAInUCBACWithResponseContentHeader = new DCAInUCBACWithResponseContentHeader()
            {
            ...
            var body = XmlGenericUtil<DCAInUCBACWithResponseContentHeader>.SerializeObject(myDCAInUCBACWithResponseContentHeader);
            //
    ...
    [XmlRoot(Namespace = "http://amital.com/customs/Prod/DCAInUCBACWithResponseContentHeader", IsNullable = false)]
    [XmlType(AnonymousType = true, Namespace = "http://amital.com/customs/Prod/DCAInUCBACWithResponseContentHeader")]
    public class DCAInUCBACWithResponseContentHeader : IINF_MSG_Generic
    {
