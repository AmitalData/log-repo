...
namespace Logitude.CustomsMessaging.MessagingServices
{
...

    {
        ...
        public string CreateCRS(int tenant, string LoggingUserId, string CourierMasterId, string master,string InternalBankId, Boolean IsWorkSheetFromExcel, List<string> DeclarationsList = null)
        {
            ...
            var RequestInProgressList = customsRequestsSheetQS.GetRequestInProgress(tenant, this.MainInterfaceCode, objectTableId, CourierMasterId, null, null, null, true, IsWorkSheetFromExcel, LoggingUserId);
