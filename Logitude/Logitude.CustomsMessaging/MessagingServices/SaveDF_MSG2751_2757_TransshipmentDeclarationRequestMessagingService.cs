...
{
    public class SaveDF_MSG2751_2757_TransshipmentDeclarationRequestMessagingService
        : MessagingServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        DF_NG_2751_MSG10000_ExportDeclaration,
        DF_NG_2757_MSG10004_ExportDeclarationResponse,
        SaveDF_MSG2751_2757_TransshipmentDeclarationRequestRequestService,
        SaveDF_MSG2751_2757_TransshipmentDeclarationRequestResponseService, RequestHeader>
    {
            ...
            byte[] customRequestSignedByteArry, GenericRequestParams requestParams, out string exceptionMessage)
        {
            ...
            {
                _ResponseHeader = uifreightSdkGateway.GetChannel<ITransshipmentDeclarationRequestOperation>()
                    .TransshipmentDeclarationRequestSign(
            ...
            out string exceptionMessage)
        {
            ...
            {
                _ResponseHeader = uifreightSdkGateway.GetChannel<ITransshipmentDeclarationRequestOperation>()
                    .TransshipmentDeclarationRequest(
                    this.RequestsSheetExternalId,
                    base.CustomsSetting.CustomsAgentId,
                    customRequest,
                    ref this._IIGGatewayMoreParams,
