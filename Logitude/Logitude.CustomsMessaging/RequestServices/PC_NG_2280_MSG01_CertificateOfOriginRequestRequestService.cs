    ...
    public class PC_NG_2280_MSG01_CertificateOfOriginRequestRequestService : RequestServiceBase<PC_NG_2280_MSG01_CertificateOfOriginRequest, CertificateOfOriginRequestRequestParams>
    {
        ...
        public override PC_NG_2280_MSG01_CertificateOfOriginRequest GetRequest(CertificateOfOriginRequestRequestParams requestParams)
        {
           ...
           var certificateOfOrigin =  certificateOfOriginQueryService.GetSingle(requestParams.CertificateOfOriginId,true,false);
			...
			myMsg.CertificateOfOrigin.CertificateOfOriginRequestInvoiceDetail = GetCertificateOfOriginRequestInvoiceDetail(certificateOfOrigin.CertificateOriginInvoiceItems);
            ...
            this.MyRequestSheetParam.ObjectTableId1 = ObjectTableRepository.GetObjectTableByName("Customs.CertificateOfOrigin");
            this.MyRequestSheetParam.EntityId1 = requestParams.CertificateOfOriginId;
            this.MyRequestSheetParam.CustomFileNo = requestParams.CustomFileNo;
            this.MyRequestSheetParam.RequestDescription = "בקשת תעודת מקור : ";
			return myMsg;
		}
		...
		public PC_NG_2280_MSG01_CertificateOfOriginRequestCertificateOfOriginCertificateOfOriginRequestInvoiceDetail[] GetCertificateOfOriginRequestInvoiceDetail(List<CertificateOfOriginInvoicePM> CertificateOfOriginInvoices)
        {
			...
			foreach (var item in CertificateOfOriginInvoices)
			{
                ...
                foreach (var item1 in item.CertificateOriginItemItems)
                {
