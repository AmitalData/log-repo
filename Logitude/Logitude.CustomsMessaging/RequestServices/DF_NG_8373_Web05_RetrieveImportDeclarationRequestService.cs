...
{
    public class DF_NG_8373_Web05_RetrieveImportDeclarationRequestService
        : RequestServiceBase<DF_NG_8373_Web05_RetrieveImportDeclaration_Request, DeclarationRestoreRequestParams>
    {
        //        public override DF_NG_8373_Web05_RetrieveImportDeclaration_Request GetRequest(CargoQueryRequestParams requestParams)
        public override DF_NG_8373_Web05_RetrieveImportDeclaration_Request GetRequest(DeclarationRestoreRequestParams requestParams)
        {
            var myDF_NG_8373_Web05_RetrieveImportDeclaration_Request = new DF_NG_8373_Web05_RetrieveImportDeclaration_Request();

            myDF_NG_8373_Web05_RetrieveImportDeclaration_Request.QueryDetails = new DF_NG_8373_Web05_RetrieveImportDeclaration_RequestQueryDetails()
            {
