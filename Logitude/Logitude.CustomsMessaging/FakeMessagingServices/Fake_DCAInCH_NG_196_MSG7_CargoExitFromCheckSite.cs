...
namespace Logitude.CustomsMessaging.FakeMessagingServices
{
    class Fake_DCAInCH_NG_196_MSG7_CargoExitFromCheckSite
    {
        ...
        internal CH_NG_196_MSG7_CargoExitFromCheckSite GetFakeCustomsResponse(GenericRequestParams requestParamsData)
        {
            ...
            _phy = physicalCheckQueryService.GetPhysicalCheck(requestParamsData.AppicationId);
        ...
        public void GetGeneralDetails()
        {
            ...
            {
                _generalDetails.declarationID = _phy.DeclarationId;
            }
            if (_phy.CheckSiteName != null)
            {
                _generalDetails.checkSiteNumber = _phy.CheckSiteName;
            }
        ...
        public void GetCheckEntity()
        {
            ...
            {
                _checkEntity.cargoIdentifier.cargoIdentifierType = int.Parse(_phy.CargoTypeCode);
            }
