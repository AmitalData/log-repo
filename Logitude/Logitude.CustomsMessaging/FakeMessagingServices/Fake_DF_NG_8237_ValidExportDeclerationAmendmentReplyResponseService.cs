...
{
    public class Fake_DF_NG_8237_ValidExportDeclerationAmendmentReplyResponseService
    {
        GenericRequestParams genericRequestParams;
        public Fake_DF_NG_8237_ValidExportDeclerationAmendmentReplyResponseService(GenericRequestParams requestParams)  {
