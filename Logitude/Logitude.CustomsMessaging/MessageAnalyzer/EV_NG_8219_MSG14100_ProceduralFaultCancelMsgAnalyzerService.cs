...
{
    class EV_NG_8219_MSG14100_ProceduralFaultCancelMsgAnalyzerService: MessageAnalyzerServiceBase<
        GenericRequestParams,
        INF_MSG_GenericResponseData,
        EV_NG_8219_MSG14100_ProceduralFaultCancelMsg,
        EV_NG_8219_MSG14100_ProceduralFaultCancelMsgResponseService>, IMessageAnalyzerService
    {
        ...
        {
            return _CustomResponse.ProceduralFaultCancelMsg[0].proceduralFaultNumber.ToString(); // to check what to do? to take the first one?
        }

        public EV_NG_8219_MSG14100_ProceduralFaultCancelMsgAnalyzerService()
            : base("UnifreightIIG.Common.MessageLib.Fault.EV_NG_8219_MSG14100_ProceduralFaultCancelMsg.xsd")
        {}

        public override INF_MSG_GenericResponseData AnalyzeToOverride()
        {
            EV_NG_8219_MSG14100_ProceduralFaultCancelMsg ProceduralFaultMessage = _CustomResponse;
            ...
            EV_NG_8219_MSG14100_ProceduralFaultCancelMsgResponseService customResponseService = new EV_NG_8219_MSG14100_ProceduralFaultCancelMsgResponseService();
