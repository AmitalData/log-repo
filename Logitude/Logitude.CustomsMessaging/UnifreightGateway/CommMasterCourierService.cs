              ...
              out string MessageOut)
        {
            ...
            try
            {
                ...
                */
                ...
                {
                    this._CourierMasterPM = new Customs.Def.EntityPMs.CourierMasterPM();
        ...
        */
        ...
        private void UpdateDeclarationCourierStatus(List<string> deletedDeclarationIds)
        {
            try
            {
                ...
                var sts = messagingService.CreateCRS(tenant, null, _CourierMasterPM.Id, _CourierMasterPM.MAWB, deletedDeclarationIds);
            }
