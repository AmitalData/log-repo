...
{
    public class UServerSetResponseService: UnifreightGatewayProxy
    {
       

        public UServerSetResponseService()
            :base(
            "1.000.000001",
            ...
            )
        {
            ...
            try
            {
                AppendLogLine("UServerSetResponse.ProccessRequest");
                
                //DataOut1 =serializeReference;
                //DataOut2 = xmlRequest;
                string serializeReference=DataIn1;
                string xmlResponse =DataIn2;

                

                   
                var myUServerQueueManager = new UServerQueueManager();
                myUServerQueueManager.UnifreightSetResponse(serializeReference, xmlResponse);
