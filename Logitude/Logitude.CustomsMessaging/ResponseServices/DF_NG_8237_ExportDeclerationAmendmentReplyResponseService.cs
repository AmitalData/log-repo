...
using Declaration = UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.Declaration;
using System.Diagnostics;
using Response = UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.Response;
using Logitude.Customs.Data.EntityKeys;
using Logitude.Customs.BL.Messaging.LogitudeClient.DeclarationErrorPointer.DBWCO;
using Unifreight.Data.AmitalModel;
using Unifreight.BL.EntityQueryServices;
using ResponseError = UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.ResponseError;
using DeclarationGoodsShipment = UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.DeclarationGoodsShipment;
...
{
    public class DF_NG_8237_ExportDeclerationAmendmentReplyResponseService : ResponseServiceBase<INF_MSG_GenericResponseData, DF_NG_8237_MSG14003_ExportDeclarationAmendmentReplyMsg, GenericRequestParams>
    {
        ...
        public override void Update(DF_NG_8237_MSG14003_ExportDeclarationAmendmentReplyMsg customResponse, GenericRequestParams requestParams)
        {
            ...
            FeatureQuery featureQuery = new FeatureQuery();
                ...
                {
                    var ProceduralFaultDetailsXml_5117 = XmlGenericUtil<UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.ProceduralFaultDetails[]>
                ...
                foreach (var additionalInformation in customResponse.Response.AdditionalInformation)
                                        ...
                                        switch (additionalInformation.Content.Value)
                                        {
                                            ...
                                            case "4":
                                                ...
                                                List<string> currentXmlVersionId = myDeclarationCorrectionsPointerService.GetVersionIdFromCorrectionXML(this._MyDeclarationPM.CorrectionsXml);
                                                    ...
                                                    var customResponseResponseXml = XmlGenericUtil<UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.Response>
                                                        .SerializeObject(customResponse.Response);

                                                    var importDeclarationServiceReferenceResponse = XmlGenericUtil<UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.Response>
                    ...
                    if(_MyDeclarationPM.AmendmentStatus == "3"  || _MyDeclarationPM.AmendmentStatus == "6")
                    {
                        ...
                        if (customResponse.CollateralRequests != null)
                        {
                            ...
                            var requestXml = XmlGenericUtil<UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.CollateralRequestMsg[]>.SerializeObject(customResponse.CollateralRequests);
        ...
        //            if (_MyDeclarationPM.DepositionStatusCode == "R") _MyDeclarationPM.DepositionStatusCode = null;
        //        }
        public UnifreightIIG.Common.ExportDeclarationServiceReference.ResponseStatus CastStatus(UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.ResponseStatus declaration)
        {
        ...
        public UnifreightIIG.Common.ExportDeclarationServiceReference.Declaration CastDeclaration(UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.Declaration declaration )
        {
        ...
        public UnifreightIIG.Common.ExportDeclarationServiceReference.ResponseError[] CastError(UnifreightIIG.Common.TransshipmenDeclarationAmendmentRequestMsgRequestServiceReference.ResponseError[] responseError)
        {
        ...
        public override INF_MSG_GenericResponseData GetResponse(DF_NG_8237_MSG14003_ExportDeclarationAmendmentReplyMsg customResponse, GenericRequestParams requestParams)
        {
            return this.MyResponseData;
        }
