    ...
    public class DF_NG_8237_ExportDeclerationAmendmentReplyResponseService : ResponseServiceBase<ExportDeclarationAmendmentResponseData, DF_NG_8237_MSG14003_ExportDeclarationAmendmentReplyMsg, AmendmentRequestParams>
    {
        ...
        public override void Update(DF_NG_8237_MSG14003_ExportDeclarationAmendmentReplyMsg customResponse, AmendmentRequestParams requestParams)
        {
            ...
            try
            {
                ...
                IGlobalContext myContextCommon = GlobalContext.GetContext(requestParams.Tenant);
                                    ...
                                    switch (additionalInformation.Content.Value)
                                    {
                                        case "1":
                                            if (!isExportClose)
                                            {
                                                ...
                                                AmitalEventTracer.CreateTraceEvent(amitalEventTracerModel, iscustomUser: true, isExport: true);
                                        ...
                                        case "4":
                                            ...
                                            if (!isExportClose)
                                            {
                                                ...
                                                AmitalEventTracer.CreateTraceEvent(myAmitalEventTracerModel2, iscustomUser: true, isExport: true);
                                                myUpdateEventContextTagModel = new EventContextTagModel()
                                                {
                                                    CallProccessID = EventContextTagModel.ProccessEnum.DF_NG_5117_ImportDeclerationAmendmentReplyResponseService,
                                                    EventCode = "DMD",
                                        ...
                                        case "2":
                                            ...
                                            if (!isExportClose)
                                            {
                                                ...
                                                AmitalEventTracer.CreateTraceEvent(myAmitalEventTracerModel4, iscustomUser: true, isExport: true);
                                                myUpdateEventContextTagModel = new EventContextTagModel()
                                                {
                                                    CallProccessID = EventContextTagModel.ProccessEnum.DF_NG_5117_ImportDeclerationAmendmentReplyResponseService,
                                                    EventCode = "DMP",
                                        ...
                                        case "6":
                                            ...
                                            if (!isExportClose)
                                            {
                                                ...
                                                AmitalEventTracer.CreateTraceEvent(myAmitalEventTracerModel5, iscustomUser: true, isExport: true);
                                                myUpdateEventContextTagModel = new EventContextTagModel()
                                                {
                                                    CallProccessID = EventContextTagModel.ProccessEnum.DF_NG_5117_ImportDeclerationAmendmentReplyResponseService,
                                                    EventCode = "DWR",
                ...
                if ((!isExportClose && (_MyDeclarationPM.AmendmentStatus == "1" || _MyDeclarationPM.AmendmentStatus == "2")) || MyResponseData.IsExportCloseApprove)
                {
                    ...
                    if (fromMehes)
                    {
                        ...
                        AmitalEventTracer.CreateTraceEvent(myAmitalEventTracerModel, iscustomUser: true,isExport:true);
                    ...
                    if (!isExportClose)
                    {
                        ...
                        myDeclarationUpdateService.IsFromApproveAmend = true;
