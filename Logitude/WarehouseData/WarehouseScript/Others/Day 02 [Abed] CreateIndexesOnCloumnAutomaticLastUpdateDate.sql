...
ON [dbo].[ShipmentComputedFields]([AutomaticLastUpdateDate])
 ...
 --____________________________________ Fact Charge_____________________________________
 		  		   ...
 		  		   --ShipmentPayables
				   		  ...
				   		  IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_ShipmentPayables_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[ShipmentPayables]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_ShipmentPayables_AutomaticLastUpdateDate]
ON [dbo].[ShipmentPayables]([AutomaticLastUpdateDate])
	...
	IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_APInvoiceLines_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[APInvoiceLines]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_APInvoiceLines_AutomaticLastUpdateDate]
ON [dbo].[APInvoiceLines]([AutomaticLastUpdateDate])
  end   


		   		  		   --APInvoices

 IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_APInvoices_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[APInvoices]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_APInvoices_AutomaticLastUpdateDate]
ON [dbo].[APInvoices]([AutomaticLastUpdateDate])
  end   

		   		  		   --ShipmentReceivables

						   
	 IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_ShipmentReceivables_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[ShipmentReceivables]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_ShipmentReceivables_AutomaticLastUpdateDate]
ON [dbo].[ShipmentReceivables]([AutomaticLastUpdateDate])
  end   


		  	  		   --ARInvoiceLines

	IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_ARInvoiceLines_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[ARInvoiceLines]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_ARInvoiceLines_AutomaticLastUpdateDate]
ON [dbo].[ARInvoiceLines]([AutomaticLastUpdateDate])
  end   


		   		  		   --ARInvoices

	IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_ARInvoices_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[ARInvoices]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_ARInvoices_AutomaticLastUpdateDate]
ON [dbo].[ARInvoices]([AutomaticLastUpdateDate])
  end   

	 --ChargesTypes	   
	IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_ChargesTypes_AutomaticLastUpdateDate' 
    AND object_id = OBJECT_ID('[dbo].[ChargesTypes]'))
  begin
    CREATE NONCLUSTERED INDEX [IX_ChargesTypes_AutomaticLastUpdateDate]
...
--  	IF not EXISTS (SELECT *  FROM sys.indexes  WHERE name='IX_ChargesGroups_AutomaticLastUpdateDate' 
--    AND object_id = OBJECT_ID('[dbo].[ChargesGroups]'))
--  begin
