...
if(@DataTypeCode = ''Decimal'' or @DataTypeCode = ''UnsDecimal''or @DataTypeCode = ''Double'' or @DataTypeCode = ''SigDouble'')
begin


if CHARINDEX('','',@FieldValue) > 0 begin set @FieldValue = null end
end
