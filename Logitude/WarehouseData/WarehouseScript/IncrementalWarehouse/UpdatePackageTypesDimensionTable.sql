 ...
 begin
   ...
   declare @PrintAs as varchar(20)
	...
	@TEU, @ContainerSize, @IsContainer, @Volume, @PrintAs); end
	...
	[TEU] = @TEU, [Container Size] = @ContainerSize, [Is Container] = @IsContainer, [Volume] = @Volume, [Print As] = @PrintAs Where Id = @Id; end
