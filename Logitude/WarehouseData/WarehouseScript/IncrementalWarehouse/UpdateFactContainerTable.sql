 ...
 --@[DeclareCustomFieldsVariable]
  ...
  From dw_Containers
	...
	inner JOIN DIM_Partners shipmentDeliveryTrucker ON dw_Containers.ShipmentDeliveryTruckerId = shipmentDeliveryTrucker.Id
	...
	BEGIN
	 ...
	 @ShipmentPickupFrom, @ShipmentPickupFrom, dbo.GetDateFormateAsNumber(@ShipmentPickupETA), dbo.GetDateFormateAsNumber(@ShipmentPickupATA), dbo.GetDateFormateAsNumber(@ShipmentPickupETD), dbo.GetDateFormateAsNumber(@ShipmentPickupATD), @ShipmentDeliveryFrom,
