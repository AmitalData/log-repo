 ...
 declare @UnNumber as varchar(4)
   ...
   declare @ShipmentLevelCode as varchar(1)
	...
	dw_ShipmentMasterDatas.BookingConfirmationNumber , dw_ShipmentMasterDatas.MainCarriageFinalDestinationATA , dw_ShipmentMasterDatas.MAWBOBLDate , dw_Shipments.CustomsDeclarationNumber  , dw_Shipments.FirstOperationalCloseDate,
	 dw_Shipments.EstimatedFinalArrivalDate , dw_Shipments.ActualFinalArrivalDate,  dw_Shipments.Routing , dw_Shipments.DescriptionOfGoods , dw_ShipmentMasterDatas.PreCarriageETD , dw_ShipmentMasterDatas.MainCarriageFinalDestinationETA , dw_Shipments.IsCancelled , DIM_MoveTypes.Id_Number ,  DIM_Vessels.Id_Number ,  DIM_SpecialServicesTypes.Id_Number,
