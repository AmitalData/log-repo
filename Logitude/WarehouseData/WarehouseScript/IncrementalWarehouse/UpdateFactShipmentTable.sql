...
--declare @FirstPickupETA as datetime
 ...
 --declare @MasterShipmentNumber as varchar(20)
   ...
   declare @IsCancelled as bit
	...
	dw_Shipments.GrossWeightPerTon , dw_Shipments.EstimatedFinalArrivalDate , dw_Shipments.ActualFinalArrivalDate,  dw_Shipments.Routing , dw_Shipments.DescriptionOfGoods , dw_Shipments.PreCarriageETD , dw_ShipmentMasterDatas.MainCarriageETA , dw_Shipments.IsCancelled , DIM_MoveTypes.Id_Number
	...
	@BookingConfirmationNumber, @MainCarriageATA, @MAWBOBLDate, @StatusDate, @CustomsDeclarationNumber, @CancelledDate, @FirstOperationalCloseDate, @GrossWeightPerTon, @EstimatedFinalArrivalDate, @ActualFinalArrivalDate, @Routing, @DescriptionOfGoods, @PreCarriageETD, @MainCarriageETA , @IsCancelled , @MoveType
