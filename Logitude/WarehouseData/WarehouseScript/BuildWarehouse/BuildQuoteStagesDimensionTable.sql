   ...
   declare @AutomaticLastUpdateDate as datetime
	...
	FOR
	SELECT Id, Name, Code, dw_DWHSettings.Tenant, dw_QuoteStages.AutomaticLastUpdateDate
	From dw_QuoteStages
    ...
    insert into #DIM_QuoteStagesTemp (Id, Name, Code,[Tenant], [Automatic Last Update Date]) values (@Id ,@Name, @Code, @Tenant, @AutomaticLastUpdateDate)
