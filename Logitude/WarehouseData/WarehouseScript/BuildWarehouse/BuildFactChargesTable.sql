   ...
   declare @ShipmentPayableParentId as varchar(15)
	...
	ShipmentPayableParentId from(
		...
		dw_ShipmentPayables.ShipmentPayableParentId as ShipmentPayableParentId
		from dw_shipments 
	  ...
	  null as ShipmentPayableParentId
	  from dw_shipments 
   ...
   PayableProratedAmount.ProratedAmountInLocalCurrency,PayableProratedAmount.ProratedAmountInProfitCurrency,dw_Shipments.ShipmentLevelCode,dw_Shipments.MasterShipmentDataId,ShipmentPayablesReceivables.ShipmentPayableParentId
 ...
 --   inner JOIN NewDIM_Partners billToPartners ON ShipmentPayablesReceivables.BillTo = billToPartners.Id
    ...
    @ProratedAmountInLocalCurrency, @ProratedAmountInProfitCurrency,@ShipmentLevelCode,@MasterShipmentDataId,@ShipmentPayableParentId
...
END CATCH  
 ...
 @TotalVolumeInCBM, @VolumetricWeight,@NumberOfPackages, @BookingNumberOfPackages, @ChargeableWeightUnitCode, @GrossWeightUnitCode, @VolumeUnitCode, @ProratedAmountInLocalCurrency, @ProratedAmountInProfitCurrency,@ShipmentLevelCode,@MasterShipmentDataId,@ShipmentPayableParentId
		End
