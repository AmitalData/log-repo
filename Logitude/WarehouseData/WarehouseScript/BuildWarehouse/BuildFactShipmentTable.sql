  ...
  SET @FinalRatio = '1:' +  CAST(CAST(@Ratio AS FLOAT(20)) AS VARCHAR(100))  ;
	 ...
	 BEGIN TRY  
	  ...
	  ,[Un Number],
	   ...
	   [Transshipment 2 Carrier], [Transshipment 3 Carrier], [Connected Quote], [Main Carriage Leg 1 From Port],  [Main Carriage Leg 1 To Port]
	  ) 
	  ...
	  @Transshipment2Carrier,@Transshipment3Carrier, @QuoteNumber, @MainCarriageFromPort, @MainCarriageToPortId
	  	  )
	END TRY 
BEGIN CATCH  
