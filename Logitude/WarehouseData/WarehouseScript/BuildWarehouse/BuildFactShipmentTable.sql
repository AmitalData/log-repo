 ...
 declare @UnNumber as  VARCHAR(4) 
	...
	@BookingConfirmationNumber, @MainCarriageATA, @MAWBOBLDate, @CustomsDeclarationNumber, @FirstOperationalCloseDate, @EstimatedFinalArrivalDate, @ActualFinalArrivalDate, @Routing, @DescriptionOfGoods, @PreCarriageETD, @PreCarriageETA, @PreCarriageATD, @MainCarriageETA,@MoveType,@Vessel , @SpecialServices,
