  ...
  declare @PreForwardingTransportMode as varchar(13)
   ...
   inner JOIN NewDIM_TransportModes  PreForwardingTransportModes ON dw_Shipments.PreForwardingTransportModeId = PreForwardingTransportModes.Code
	...
	,@ComputedStatus , @ComputedStatusDate, @UnNumber,
	  ...
	  @PreForwardingCarrierNumber, @PreForwardingCarrier, @PreForwardingFromPort, @PreForwardingToPort, @PreForwardingTransportMode, @MainCarriageFromPort
  ...
  SET @FinalRatio = '1:' +  CAST(CAST(@Ratio AS FLOAT(20)) AS VARCHAR(100))  ;
	 ...
	 BEGIN TRY  
	  ...
	  ,[Un Number],
	   ...
	   [Transshipment 2 Carrier], [Transshipment 3 Carrier], [Connected Quote], [Main Carriage Leg 1 From Port]
	  ) 
	  ...
	  @Transshipment2Carrier,@Transshipment3Carrier, @QuoteNumber, @MainCarriageFromPort
	  	  )
	END TRY 
BEGIN CATCH  
