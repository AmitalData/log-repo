 ...
 declare @UnNumber as  VARCHAR(4) 
	...
	,NewDIM_ShipmentStatuses.Id_Number , dw_Shipments.ComputedStatusDate, dw_Shipments.DangerousUnNumber, dw_Shipments.PreCarriageCarrierNumber, dw_Shipments.OnCarriageCarrierNumber
    ...
    @Transshipment1AdditionalMAWBOBLBL,  @Transshipment2AdditionalMAWBOBLBL,  @Transshipment3AdditionalMAWBOBLBL, @FirstPickupLocation,@ContainersNumbers,@Ratio,@VolumetricWeight,
	...
	,@ComputedStatus , @ComputedStatusDate, @UnNumber, @PreCarriageCarrierNumber, @OnCarriageCarrierNumber
  ...
  SET @FinalRatio = '1:' +  CAST(CAST(@Ratio AS FLOAT(20)) AS VARCHAR(100))  ;
	 ...
	 BEGIN TRY  
	  ...
	  ,[Transshipment 1 Vessel] ,[Transshipment 1 Carrier],[Transshipment 2 Carrier], [Transshipment 3 Carrier],[Includes Customs],[Declaration Number], [Declaration Date],[Customs Clearance Date],[Terminal Available],[Warehouse Last free Date],[First Pickup ATD],[First Pickup ATA],[Final Delivery ETD],[Final Delivery ETA],[Final Delivery ATD],[Final Delivery ATA],[Transshipment 1 ETA],[Transshipment 1 ETD],[Transshipment 1 ATA], [Transshipment 1 ATD], [Transshipment 2 ATA], [Transshipment 3 ATA], [Transshipment 2 ETA], [Transshipment 3 ETA], [Transshipment 2 ATD], [Transshipment 3 ATD], [Transshipment 2 ETD], [Transshipment 3 ETD], [Transshipment 1 Master],[Transshipment 2 Master], [Transshipment 3 Master],[First Pickup Location],[ContainersNumbers Array],[Ratio],[Volumetric Weight],[Warehouse Entry Date],[Warehouse Release Date] , [Order Gross Weight],[Order Volume],[Order Number of Packages],[Order Chargeable Weight],[Estimated Profit (Profit)],[Estimated Profit (Local)]
	  ,[Consignee Not Importer],[Issuing Carrier Agent],[On Carriage Transport Mode], [Pre Carriage Transport Mode],[First AR Invoice Approval Date],[Order Confirmation Notes],[Order Confirmed By]
	  ...
	  ,[Un Number], [Pre Carriage Carrier Number], [On Carriage Carrier Number]
	  ) 
