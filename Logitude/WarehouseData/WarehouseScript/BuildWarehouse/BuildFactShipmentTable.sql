...
--declare @FirstPickupETA as datetime
 ...
 --declare @MasterShipmentNumber as varchar(20)
   ...
   declare @SpecialServices as int
	...
	@BookingConfirmationNumber, @MainCarriageATA, @MAWBOBLDate, @StatusDate, @CustomsDeclarationNumber, @CancelledDate, @FirstOperationalCloseDate, @GrossWeightPerTon, @EstimatedFinalArrivalDate, @ActualFinalArrivalDate, @Routing, @DescriptionOfGoods, @PreCarriageETD, @MainCarriageETA,@MoveType,@Vessel , @SpecialServices
