  ...
  declare @PreForwardingTransportMode as varchar(13)
   ...
   inner JOIN NewDIM_Users HandlerUser ON dw_Shipments.HandlerUserId = HandlerUser.Id
	...
	,@ComputedStatus , @ComputedStatusDate, @UnNumber,
	  ...
	  @MainCarriageToPortId, @MasterOnCarriageATA, @MasterOnCarriageATD,@MasterOnCarriageETD,@MasterOnCarriageETA, @PlannedCargoReadyDate,@ApprovedCargoReadyDate,@Notify1Reference2, @HandlerUser
  ...
  SET @FinalRatio = '1:' +  CAST(CAST(@Ratio AS FLOAT(20)) AS VARCHAR(100))  ;
	 ...
	 BEGIN TRY  
	  ...
	  ,[Un Number],
	   ...
	   [Approved Cargo Ready Date], [Notify 1 Ref2],[Handler]
	  ) 
