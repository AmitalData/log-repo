  ...
  --@[DeclareCustomFieldsVariable]
	...
	ProfitCurrency.Id_Number, NewDIM_ChargesTypes.Id_Number,NewDIM_ARInvoiceTransferStatus.Name
	...
	inner JOIN NewDIM_ARInvoiceTransferStatus ON dw_ARInvoices.TransferStatusCode = NewDIM_ARInvoiceTransferStatus.Code
