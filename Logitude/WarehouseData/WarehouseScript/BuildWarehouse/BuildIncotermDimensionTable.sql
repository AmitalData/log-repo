   ...
   declare @AutomaticLastUpdateDate as datetime
    ...
    insert into #DIM_IncotermsTemp (Id,Name,[Local Name],Code,[Source Tenant],[Parent Tenant],[Automatic Last Update Date]) values(@Id,@Name,@LocalName,@Code ,@SourceTenant , @ParentTenant, @AutomaticLastUpdateDate)
