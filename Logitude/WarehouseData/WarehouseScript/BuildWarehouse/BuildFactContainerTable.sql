 ...
 DECLARE ContainersCursor CURSOR READ_ONLY
	...
	dw_Containers.EstimatedLIFArrival, dw_Containers.CreateDate, createdByUser.Id_Number, dw_Containers.UpdateDate, updatedByUser.Id_Number, dw_Containers.CurrentStatus, dw_Containers.CurrentStatusDate, dw_Containers.ClosedDate, dw_Containers.IsClosed, status.Id_Number
  ...
  From dw_Containers
	...
	@CreateDate, @createdByUser, @UpdateDate, @updatedByUser, @CurrentStatus, @CurrentStatusDate, @ClosedDate, @IsClosed, @status
	...
	BEGIN
	 ...
	 insert into #Fact_ContainersTemp  ([Id], [Source Tenant], [Parent Tenant], [Actual Empty Pickup Date], [Empty Pickup Location Port], [Estimated Empty Pickup Date], [Pre Carriage Location Port], [POL Location Port], [Estimated POL Arrival],
	 ...
	 [Create Date], [Created By], [Update Date], [Updated By], [Current Status], [Current Status Date], [Closed Date], [Is Closed], [Status])
