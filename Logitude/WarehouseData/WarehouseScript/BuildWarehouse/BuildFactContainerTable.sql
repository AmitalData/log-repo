 ...
 DECLARE ContainersCursor CURSOR READ_ONLY
  ...
  From dw_Containers
	...
	inner JOIN NewDIM_Ports availabilityLocationPort ON dw_Containers.AvailabilityLocationPortId = availabilityLocationPort.Id
	...
	@CursorCustomFieldsVariable, @GateIn, @AvailabilityDate, @AvailabilityLocationPort, @OnCarriageGateOut, @PreCarriageGateIn
