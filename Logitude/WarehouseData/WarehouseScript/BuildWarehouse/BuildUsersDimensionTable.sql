   ...
   declare @InActive as bit
	...
	insert into #DIM_UsersTemp (Id,Name,[Local Name],Email, Department ,Branch,  [Source Tenant],[Parent Tenant],[Automatic Last Update Date],[InActive]) values(@Id,@Name,@LocalName ,@Email,@Department, @Branch, @SourceTenant , @ParentTenant, @AutomaticLastUpdateDate, @InActive)
