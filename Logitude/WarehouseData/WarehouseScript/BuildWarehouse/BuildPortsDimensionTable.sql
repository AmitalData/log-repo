   ...
   declare @AutomaticLastUpdateDate as datetime
	...
	insert into #DIM_PortsTemp  (Id,Name,Code,[Local Name],[UN Loc Code] ,Country,[State Name],  [Source Tenant],[Parent Tenant],[Automatic Last Update Date])  values(@Id,@Name,@Code,@LocalName ,@CombinedCode, @Country, @State , @SourceTenant , @ParentTenant, @AutomaticLastUpdateDate)
