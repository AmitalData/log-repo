...
namespace Logitude.CargoTracking.BL.EntityDataMappings
{
   ...
   public partial class CargoTrackingCardDataMapping: IMapping<CargoTrackingCardPM, CargoTrackingCard>,IMappingEncodeBase64NVARCHARFields<CargoTrackingCardPM>
   {
	    ...
	    public void PMToPOCO(CargoTrackingCardPM entityPM, CargoTrackingCard entityPOCO)
        {
		...
		public void POCOToPM(CargoTrackingCardPM entityPM, CargoTrackingCard entityPOCO)
        {
		...
		public void PMToOldPM(CargoTrackingCardPM entityPM, CargoTrackingCardPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoTrackingCardPM entityPM)
        {
