...
namespace Logitude.CargoTracking.BL.EntityDataMappings
{
   ...
   public partial class CargoTrackingCountryDataMapping: IMapping<CargoTrackingCountryPM, CargoTrackingCountry>,IMappingEncodeBase64NVARCHARFields<CargoTrackingCountryPM>
   {
		...
		public void POCOToPM(CargoTrackingCountryPM entityPM, CargoTrackingCountry entityPOCO)
        {
		...
		public void PMToOldPM(CargoTrackingCountryPM entityPM, CargoTrackingCountryPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoTrackingCountryPM entityPM)
        {
