...
namespace Logitude.CargoTracking.BL.EntityDataMappings
{
   ...
   public partial class CargoTrackingHeaderEntityTypeDataMapping: IMapping<CargoTrackingHeaderEntityTypePM, CargoTrackingHeaderEntityType>,IMappingEncodeBase64NVARCHARFields<CargoTrackingHeaderEntityTypePM>
   {
	    ...
	    public void PMToPOCO(CargoTrackingHeaderEntityTypePM entityPM, CargoTrackingHeaderEntityType entityPOCO)
        {
		...
		public void POCOToPM(CargoTrackingHeaderEntityTypePM entityPM, CargoTrackingHeaderEntityType entityPOCO)
        {
		...
		public void PMToOldPM(CargoTrackingHeaderEntityTypePM entityPM, CargoTrackingHeaderEntityTypePM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(CargoTrackingHeaderEntityTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(CargoTrackingHeaderEntityTypePM entityPM, CargoTrackingHeaderEntityType entityPOCO, bool isNewEntity)
        {
