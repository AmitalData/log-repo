...
namespace Logitude.Accounting.Def.Validators
{
    public partial class AccountingClassLevelValidator : IAccountingClassLevelValidator
    {
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            Validators.AccountingClassLevelValidator temp = new Validators.AccountingClassLevelValidator(objectTableName, tenant);
    ...
    public interface IAccountingClassLevelValidator
    {
