...
{
    public partial class AccountingClassLevelValidator : IAccountingClassLevelValidator
    {
        int tenant;
        ...
        public AccountingClassLevelValidator(string objectTableName, int tenant)
        {
            ...
            foreach (ObjectField objectfeildprop in objectFieldList)
            {
                ...
                if (propertyInf != null)
                {
                    ...
                    if (objectfeildprop.IsRequiered)
                    {
                        if (propertyValue == null)
                        {
                            requiredError = requiredError + "," + AccountingTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", objectfeildprop.FullNameTextCode.Code, null, null, objectfeildprop.Tenant);
                        }
