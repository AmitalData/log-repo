...
namespace Logitude.Accounting.Def.EntityPMs
{
   ...
   public partial class InvoiceApiStepPM : EntityPM
   {
	  ...
	  private bool isAllowResend ;
	  	  
       
	   [CustomValidation(typeof(AccountingValidationClass), "ValidateClass")]
	   [DataMember]
       public bool IsAllowResend  
	   {
	    
	     get
		{
		   return isAllowResend;
		 }
		 set
		 {
		   if(isAllowResend != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="IsAllowResend",OldValue=isAllowResend,NewValue=value,PropertyType="bool"};
		    NotifyPropertyChanged(values);
		   isAllowResend=value;
		   }
