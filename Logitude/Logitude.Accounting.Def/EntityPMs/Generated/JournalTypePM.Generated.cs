...
namespace Logitude.Accounting.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class JournalTypePM : EntityPM
   {
       ...
       public string JournalTypeID  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(journalTypeID != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="JournalTypeID",OldValue=journalTypeID,NewValue=value,PropertyType="string"};
