...
namespace Logitude.Accounting.Def.EntityPMs
{
   ...
   [DataContract]
   public partial class BankCodePM : EntityPM
   {
   	  private string code ;
       ...
       public string LogoId  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(logoId != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="LogoId",OldValue=logoId,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   logoId=value;
		   }
