...
namespace Logitude.Accounting.Def.EntityPMs
{
   ...
   {
   	  private string journalStatusID ;
       ...
       public string JournalStatusID  
	   {
	     ...
	     get
		{
		 ...
		 set
		 {
		   if(journalStatusID != value)
		  {
		    NotifyPropertyChangeValues values=new NotifyPropertyChangeValues(){PropertyName="JournalStatusID",OldValue=journalStatusID,NewValue=value,PropertyType="string"};
		    NotifyPropertyChanged(values);
		   journalStatusID=value;
		   }
