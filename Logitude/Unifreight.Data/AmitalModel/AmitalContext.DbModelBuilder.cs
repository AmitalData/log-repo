...
namespace Unifreight.Data.AmitalModel
{
    public partial class AmitalContext 
    {
        ...
        public AmitalContext(int tenantSeed,DbConnection connection, DbCompiledModel model)
        ...
        public static AmitalContext Create(int tenantSeed, DbConnection connection)
        {
            ...
            var compiledModel = _ModelCache.GetOrAdd(
                ...
                t =>
                {
                    ...
                    var ConnSchemaUserId = DbContextBaseUtil.GetSchemaAMITAL_DB(tenantSeed);
            ...
            return new AmitalContext(tenantSeed,connection, compiledModel);
        }
        /// <summary>
