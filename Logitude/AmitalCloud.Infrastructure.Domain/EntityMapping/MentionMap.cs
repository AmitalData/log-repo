...
namespace AmitalCloud.Infrastructure.Domain.EntityMapping
{
    ...
    public class MentionMap : EntityTypeConfiguration<POCO.Mention>
    {
	    string dbms;
        public MentionMap()
        { 
            ...
            this.Property(t => t.Description).HasColumnName("Description").IsRequired().IsMaxLength().IsUnicode(true);
