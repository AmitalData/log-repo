...
{
   public class TenantKeys<T> : BaseEntityKeyFields<EntityPOCOs.Tenant,T> 
   {
		public TenantKeys() : base() {}
        public TenantKeys(IEnumerable<KeyValuePair<string, string>> paramList) : base(paramList) {}
