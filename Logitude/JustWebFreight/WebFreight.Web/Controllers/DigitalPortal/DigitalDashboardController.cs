...
namespace WebFreight.Web.Controllers.DigitalPortal
{
    ...
    {
        [HttpGet]
        [Route("DigitalDashboardController/GetInvoicesGroupedByDueDate")]
        public IHttpActionResult GetInvoicesGroupedByDueDate()
        {
            try
            {
        ...
        public IHttpActionResult GetInvoicesGroupedByPaidStatus()
        {
            try
            {
        ...
        public IHttpActionResult GetShipmentsGroupedByStatus(GeneralFilters newFilters)
        {
            try
            {
                ...
                var shipments = GetShipmentList(newFilters, authToken.Tenant);
                Dictionary<string, int> shipmentsGroupedByStatus = shipments.GroupBy(r => r.StatusCode).ToDictionary(t => t.Key, t => t.Count());
        ...
        private IQueryable<DigitalShipmentList> GetShipmentList(GeneralFilters newFilters, int tenant)
        {
