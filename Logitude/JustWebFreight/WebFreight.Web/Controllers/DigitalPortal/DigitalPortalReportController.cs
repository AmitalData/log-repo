    ...
    public class DigitalPortalReportController : ApiController
    {
        ...
        public IHttpActionResult ExportShipmentDataToExcelFile(GeneralFilters newFilters)
        {
            try
            {
                ...
                var data = GetByShipmentsByFilter(newFilters, authToken.Tenant);
                ExportToExcelArgs excelArgs = BuildExportToExcelArguments(data, newFilters.QueryCode, authToken.Tenant);
