...
namespace WebFreight.Web.Controllers.AccountingModel
{
    ...
    public class BanksCCExternalRecoController : ApiController
    {
        ...
        public HttpResponseMessage GetBanksCCExternalReco(int tenant, string accountId, string toAccountingDate, string batch)
        {
            try
            {
        ...
        private bool CreateArgs(int tenant, string accountId, string toAccountingDate, string batch, ref BanksCCExternalRecoArg args, string message)
        {
