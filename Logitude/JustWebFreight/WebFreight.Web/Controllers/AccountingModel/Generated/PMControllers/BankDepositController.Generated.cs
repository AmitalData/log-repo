...
{ 
    ...
    public partial class BankDepositsController : ApiController
    {
		  ...
		  try
            {
                ...
                SecurityUtility.CheckContactFeature("BankDeposit", "READ", authToken.Tenant);
	                
                IAccountingContext MyContext = AccountingContext.GetContext(authToken.Tenant);
                BankDepositQueryService bankDepositQuery = new BankDepositQueryService(MyContext);
				bankDepositQuery.InitializeSettings();
	   ...
	   public HttpResponseMessage Post(BankDepositPM entityPM)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        AuthenticationToken authToken = AuthenticationTokenRepository.GetSingleTokenFromCache(token);
                        SecurityUtility.AuthenticationOnTenant(authToken.Tenant);
                        SecurityUtility.CheckContactFeature("BankDeposit", "UPDATE", authToken.Tenant);
	                        SecurityUtility.AuthenticationOnEntityTenant("BankDeposit", entityPM.Tenant, authToken.Tenant);
