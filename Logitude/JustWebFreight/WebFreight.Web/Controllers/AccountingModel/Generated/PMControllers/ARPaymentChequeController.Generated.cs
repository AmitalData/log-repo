...
{ 
    ...
    public partial class ARPaymentChequesController : ApiController
    {
		  ...
		  try
            {
                ...
                ARPaymentChequePM aRPaymentChequePM = aRPaymentChequeQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, aRPaymentChequePM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(ARPaymentChequePM entityPM)
        {
        ...
        public HttpResponseMessage Put(ARPaymentChequePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
