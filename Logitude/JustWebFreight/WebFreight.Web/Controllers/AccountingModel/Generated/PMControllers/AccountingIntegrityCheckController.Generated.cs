...
{ 
    ...
    public partial class AccountingIntegrityChecksController : ApiController
    {
		  ...
		  try
            {
                ...
                AccountingIntegrityCheckQueryService accountingIntegrityCheckQuery = new AccountingIntegrityCheckQueryService(MyContext);
                ...
                return Request.CreateResponse(HttpStatusCode.OK, accountingIntegrityCheckPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(AccountingIntegrityCheckPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("AccountingIntegrityCheck", 0, true);
        ...
        public HttpResponseMessage Put(AccountingIntegrityCheckPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
