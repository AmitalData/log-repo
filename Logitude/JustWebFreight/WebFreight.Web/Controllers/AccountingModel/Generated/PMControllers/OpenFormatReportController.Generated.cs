...
{ 
    ...
    public partial class OpenFormatReportsController : ApiController
    {
		  ...
		  try
            {
                ...
                OpenFormatReportPM openFormatReportPM = openFormatReportQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, openFormatReportPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(OpenFormatReportPM entityPM)
        {
                ...
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        SecurityUtility.CheckContactFeature("OpenFormatReport", "NEW", authToken.Tenant);
	                        SecurityUtility.AuthenticationOnEntityTenant("OpenFormatReport", entityPM.Tenant, authToken.Tenant);
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("OpenFormatReport", 0, true);
        ...
        public HttpResponseMessage Put(OpenFormatReportPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
