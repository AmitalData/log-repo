...
{ 
    ...
    public partial class ReconciliationsController : ApiController
    {
		  ...
		  try
            {
                ...
                ReconciliationPM reconciliationPM = reconciliationQuery.GetSingle(id,true,false);
	   ...
	   public HttpResponseMessage Post(ReconciliationPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("Reconciliation", 0, true);
        ...
        public HttpResponseMessage Put(ReconciliationPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
