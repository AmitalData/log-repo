...
{ 
    ...
    public partial class JournalsController : ApiController
    {
		  ...
		  try
            {
				...
				journalQuery.InitializeSettings();
                JournalPM journalPM = journalQuery.GetSingle(id,true,false);
	   ...
	   public HttpResponseMessage Post(JournalPM entityPM)
        {
        ...
        public HttpResponseMessage Put(JournalPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
