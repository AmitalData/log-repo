...
{ 
    ...
    public partial class VehiclesController : ApiController
    {
		  ...
		  try
            {
                ...
                VehicleQueryService vehicleQuery = new VehicleQueryService(MyContext);
				vehicleQuery.InitializeSettings();
                VehiclePM vehiclePM = vehicleQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, vehiclePM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(VehiclePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("Vehicle", 0, true);
        ...
        public HttpResponseMessage Put(VehiclePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
