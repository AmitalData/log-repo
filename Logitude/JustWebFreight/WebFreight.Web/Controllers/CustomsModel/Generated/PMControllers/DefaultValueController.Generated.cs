...
{ 
    ...
    public partial class DefaultValuesController : ApiController
    {
		  ...
		  try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, defaultValuePM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(DefaultValuePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        DefaultValueUpdateService service = new DefaultValueUpdateService(MyContext, new Dictionary<string, IContext>(), entityPM.Tenant);
                        entityPM.ChangeSetOp = Simplog.Server.Infrastructure.ChangeSetOperation.Insert;
                        service.Update(entityPM, true);

                        //ObjectTableRepository objectTabelRepository = new ObjectTableRepository(entityPM.Tenant);
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("DefaultValue", 0, true);
        ...
        public HttpResponseMessage Put(DefaultValuePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
