...
{ 
    ...
    public partial class ExportDeclarationClosingDatasController : ApiController
    {
		  ...
		  try
            {
                ...
                ExportDeclarationClosingDataPM exportDeclarationClosingDataPM = exportDeclarationClosingDataQuery.GetSingle(declarationid,true,false);
	   ...
	   public HttpResponseMessage Post(ExportDeclarationClosingDataPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("ExportDeclarationClosingData", 0, true);
        ...
        public HttpResponseMessage Put(ExportDeclarationClosingDataPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
