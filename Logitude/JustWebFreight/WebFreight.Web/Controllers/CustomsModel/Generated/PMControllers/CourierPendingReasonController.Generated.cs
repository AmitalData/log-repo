...
{ 
    ...
    public partial class CourierPendingReasonsController : ApiController
    {
	   ...
	   public HttpResponseMessage Post(CourierPendingReasonPM entityPM)
        {
        ...
        public HttpResponseMessage Put(CourierPendingReasonPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
