...
{ 
    ...
    public partial class CertificateOfOriginInvoicesController : ApiController
    {
		  ...
		  try
            {
                ...
                CertificateOfOriginInvoicePM certificateOfOriginInvoicePM = certificateOfOriginInvoiceQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, certificateOfOriginInvoicePM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(CertificateOfOriginInvoicePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("CertificateOfOriginInvoice", 0, true);
        ...
        public HttpResponseMessage Put(CertificateOfOriginInvoicePM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
