...
{ 
    ...
    public partial class SIIRequestsController : ApiController
    {
		  ...
		  try
            {
                ...
                SIIRequestPM sIIRequestPM = sIIRequestQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, sIIRequestPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(SIIRequestPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("SIIRequest", 0, true);
        ...
        public HttpResponseMessage Put(SIIRequestPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
