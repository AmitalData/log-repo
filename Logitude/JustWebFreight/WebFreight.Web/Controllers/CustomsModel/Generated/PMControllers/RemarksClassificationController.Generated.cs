...
{ 
    ...
    public partial class RemarksClassificationsController : ApiController
    {
		  ...
		  try
            {
                ...
                RemarksClassificationPM remarksClassificationPM = remarksClassificationQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, remarksClassificationPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(RemarksClassificationPM entityPM)
        {
        ...
        public HttpResponseMessage Put(RemarksClassificationPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
