...
{ 
    ...
    public partial class DeclarationReferantDatasController : ApiController
    {
		  ...
		  try
            {
                ...
                DeclarationReferantDataPM declarationReferantDataPM = declarationReferantDataQuery.GetSingle(declarationid,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, declarationReferantDataPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(DeclarationReferantDataPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("DeclarationReferantData", 0, true);
        ...
        public HttpResponseMessage Put(DeclarationReferantDataPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
