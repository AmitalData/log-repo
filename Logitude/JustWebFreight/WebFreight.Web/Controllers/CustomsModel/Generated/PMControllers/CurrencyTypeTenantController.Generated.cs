...
{ 
    ...
    public partial class CurrencyTypeTenantsController : ApiController
    {
		  ...
		  try
            {
                ...
                CurrencyTypeTenantPM currencyTypeTenantPM = currencyTypeTenantQuery.GetSingle(id,true,false);

				PerformanceLogger.AddServerExecutionTimeHeader(logKey);
            
                return Request.CreateResponse(HttpStatusCode.OK, currencyTypeTenantPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(CurrencyTypeTenantPM entityPM)
        {
        ...
        public HttpResponseMessage Put(CurrencyTypeTenantPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
