...
{ 
    ...
    public partial class ClientIndicationsController : ApiController
    {
		  ...
		  try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, clientIndicationPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(ClientIndicationPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("ClientIndication", 0, true);
        ...
        public HttpResponseMessage Put(ClientIndicationPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
