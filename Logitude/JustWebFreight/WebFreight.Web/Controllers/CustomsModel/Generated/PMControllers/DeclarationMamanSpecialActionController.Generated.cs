...
{ 
    ...
    public partial class DeclarationMamanSpecialActionsController : ApiController
    {
		  ...
		  try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, declarationMamanSpecialActionPM);
			 }
            catch (Exception ex)
            {
	   ...
	   public HttpResponseMessage Post(DeclarationMamanSpecialActionPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    using (TransactionScope scope = TransactionFactory.GetTransaction())
                    {
                        ...
                        DeclarationMamanSpecialActionUpdateService service = new DeclarationMamanSpecialActionUpdateService(MyContext, new Dictionary<string, IContext>(), entityPM.Tenant);
                        entityPM.ChangeSetOp = Simplog.Server.Infrastructure.ChangeSetOperation.Insert;
                        service.Update(entityPM, true);

                        //ObjectTableRepository objectTabelRepository = new ObjectTableRepository(entityPM.Tenant);
                        //ObjectTable objectTable = objectTabelRepository.GetObjectTableByName("DeclarationMamanSpecialAction", 0, true);
        ...
        public HttpResponseMessage Put(DeclarationMamanSpecialActionPM entityPM)
        {
            if (ModelState.IsValid)
            {
                try
