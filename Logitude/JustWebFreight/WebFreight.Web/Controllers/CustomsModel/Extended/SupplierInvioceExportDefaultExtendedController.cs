...
{
    public class SupplierInvioceExportDefaultExtendedController : ApiController
    {

        public HttpResponseMessage GetSupplierInvioceExportDefaultByTenant(int tenant)
        {
            try
            {
