...
{
    public class ChargesExternalAccountsByProductViewsController : ApiController
    {
        public HttpResponseMessage GetSingle(string id)
        {
            try
            {
                ...
                if (entityPoco != null)
                {
                    ...
                    ChargesExternalAccountsByProductQuery chargeExternalAccountsByProductQuery = new ChargesExternalAccountsByProductQuery(chargesExternalAccountsByProductRepository);
                    IQueryable<ChargesExternalAccountsByProduct> iQueryable = singleEntityList.AsQueryable();
                    IQueryable<ChargesExternalAccountsByProductList> iQueryableEntityList = chargeExternalAccountsByProductQuery.GetIQueryableEntityList(iQueryable);
        ...
        public HttpResponseMessage GetAll()
        {
            try
            {
                ...
                List<ChargesExternalAccountsByProductList> listResult = entityLists.ToList();
                PerformanceLogger.AddServerExecutionTimeHeader(logKey);
        ...
        public HttpResponseMessage GetByFilters([FromUri] ApiQueryFilters filters)
        {
            try
            {
                ...
                List<ObjectField> ChargesExternalAccountsByProductObjectFields = ObjectFieldRepository.GetObjectFieldsByObjectTableName("ChargesExternalAccountsByProduct", tenant);
                ...
                for (int i = 1; i <= 10; i++)
                {
                    ...
                    if (filterNameProp != null)
                    {
                        ...
                        ObjectField field = ChargesExternalAccountsByProductObjectFields.FirstOrDefault(f => f.FieldName == filterName);
                        if (field != null)
                        {
                ...
                if (!string.IsNullOrEmpty(filters.AdditionalFilters))
                {
                    ...
                    {
                        ObjectField field = ChargesExternalAccountsByProductObjectFields.FirstOrDefault(f => f.FieldName == filter.FieldName);
                        if (field != null)
                        {
                ...
                entityPocos = genericFilter.GetFilteredQuery<ChargesExternalAccountsByProduct>(nonListQueryOperation, entityPocos);
                int skippedEntities = queryOperations.PageIndex;
                IQueryable<ChargesExternalAccountsByProductList> entityLists = chargesExternalAccountsByProductQuery.GetIQueryableEntityList(entityPocos);

                entityLists = genericFilter.GetFilteredQuery<ChargesExternalAccountsByProductList>(listQueryOperation, entityLists);


                if (!string.IsNullOrEmpty(queryOperations.SortByColumnName) && !string.IsNullOrEmpty(queryOperations.SortDirectin))
                {
                    PropertyInfo propInfo = typeof(ChargesExternalAccountsByProductList).GetProperty(queryOperations.SortByColumnName);


                    ObjectField objectField = (from a in ChargesExternalAccountsByProductObjectFields
                    ...
                    if (objectField != null)
                    {
                        ...
                        {
                            entityLists = sortClass.GetSorterQuery<ChargesExternalAccountsByProductList, string>(queryOperations, entityLists);
                        }
                        else
                        {
                            switch (objectField.DataTypeCode.ToLower())
                            {
                                ...
                                case "double":
                                    {
                                        entityLists = sortClass.GetSorterQuery<ChargesExternalAccountsByProductList, double>(queryOperations, entityLists);
                                        break;
                                    }
                                case "date":
                                case "datetime":
                                    {
                                        entityLists = sortClass.GetSorterQuery<ChargesExternalAccountsByProductList, DateTime>(queryOperations, entityLists);
                                        break;
                                    }
                                case "unsinteger":
                                case "integer":
                                    {
                                        entityLists = sortClass.GetSorterQuery<ChargesExternalAccountsByProductList, int>(queryOperations, entityLists);
                                        break;
                                    }
                                case "boolean":
                                    {
                                        entityLists = sortClass.GetSorterQuery<ChargesExternalAccountsByProductList, bool>(queryOperations, entityLists);
                                        break;
                                    }
                                case "unsdecimal":
                                case "decimal":
                                    {
                                        entityLists = sortClass.GetSorterQuery<ChargesExternalAccountsByProductList, decimal>(queryOperations, entityLists);
                                        break;
                                    }
                                default:
                                    {
