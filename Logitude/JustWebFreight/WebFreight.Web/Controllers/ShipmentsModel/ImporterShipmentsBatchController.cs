...
{
    public class ImporterShipmentsBatchController : ApiController
    {
        ...
        private APIException MapEntityAMToEntityPM(ShipmentAM entityAM, ShipmentPM entityPM)
        {
            ...
            if (currentLBtenant.AutoArchiveOnInvoice == true && entityAM.StatusCode == "INPR" && entityAM.CustomsClearanceDate != null && entityAM.IsOperationalClosed == false)
            {
