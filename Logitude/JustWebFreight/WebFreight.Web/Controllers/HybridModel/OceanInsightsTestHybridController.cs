...
{
    public class OceanInsightsTestHybridController : ApiController
    {
        ...
        public Response Insert([FromBody] object[] t)//(int Tenant, string ScacCode, string ReferenceNo, string Type)
        {
            ...
            OceanInsightsTestWcfService OceanInsightsTestWcfService = new OceanInsightsTestWcfService();
            Response response = OceanInsightsTestWcfService.Insert(Tenant, ScacCode, ReferenceNo, Type);
            return response;
        }
        ...
        public Response GetStatus([FromBody] object[] t)//(string RequestId, string Type)
        {
            ...
            OceanInsightsTestWcfService OceanInsightsTestWcfService = new OceanInsightsTestWcfService();
            Response response = OceanInsightsTestWcfService.GetStatus(RequestId, Type);
            return response;
        }
    }
}
