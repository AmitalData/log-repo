...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "TruckerWcfService" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select TruckerWcfService.svc or TruckerWcfService.svc.cs at the Solution Explorer and start debugging.
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class TruckerWcfService : ITruckerWcfService
    {
        public Response Upsert(TruckerPM entityPM, bool batch)
        {
            ...
            try
            {
                ...
                using (TransactionScope scope = TransactionFactory.GetTransaction())
                {
                    ...
                    TruckerService service = new TruckerService(commoncontext, entityPM.Tenant);
                    ...
                    Trucker entity = TruckerRepository.GetSingleTruckerByCode(entityPM.Code, entityPM.Tenant);
                    if (entity == null)
                    {
        ...
        public TruckerPM GetTruckerPM(string code, int tenant, ref Response response)
        {

            try
            {
                TruckerPM entityPM = null;
                SecurityUtility.AuthenticationOnTenant(tenant);
                SecurityUtility.CheckContactFeature("Trucker", "READ", tenant);//UPDATE//READ
                if (CacheManager.CacheWrapper == null)
                {
                    CacheManager.CacheWrapper = new MockCacheWrapper();
                }
                ...
                TruckerQuery query = new TruckerQuery(tenant);
