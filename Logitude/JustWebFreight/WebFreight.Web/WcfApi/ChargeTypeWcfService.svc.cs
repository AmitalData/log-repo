...
namespace WebFreight.Web.WcfApi
{
    ...
    public class ChargeTypeWcfService : IChargeTypeWcfService
    {
        public List<ChargesTypeList> GetChargesTypes(int tenant, int skip, int take, ref Response response)
        {
            ...
            try
            {
                ...
                List<ChargesTypeList> result = chargesTypeQuery.GetChargesTypeLists(tenant, skip, take).ToList();
