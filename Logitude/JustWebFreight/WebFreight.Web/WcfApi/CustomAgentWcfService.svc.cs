...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "CustomAgentHypredService" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select CustomAgentHypredService.svc or CustomAgentHypredService.svc.cs at the Solution Explorer and start debugging.
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class CustomAgentWcfService : ICustomAgentWcfService
    {
        public Response Upsert(CustomAgentPM entityPM,bool batch)
        {
            ...
            try
            {
                ...
                SecurityUtility.CheckContactFeature("CustomAgent", "UPDATE", entityPM.Tenant);//UPDATE//READ
                using (TransactionScope scope = TransactionFactory.GetTransaction())
                {
                   
                    ClassLevelValidator validationClass = new ClassLevelValidator("CustomAgent", entityPM.Tenant) { IsHybrid = true };
                    ...
                    CustomAgentRepository customAgentRepository = new CustomAgentRepository(objectContext);
                    ...
                    CustomAgent entity = customAgentRepository.GetSingleCustomAgentByCode(entityPM.Tenant, entityPM.Code);
                    if (entity == null)
                    {
