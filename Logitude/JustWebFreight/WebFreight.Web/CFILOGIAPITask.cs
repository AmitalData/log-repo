...
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT LoadingFactor FROM Customs.declarations WHERE CUSTOMFILENO = @CUSTOMFILENO AND TENANT = @Tenant</DAT>
...
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'> SELECT COUNT(*) FROM  SUPPLIERINVOICEITEMS WHERE  SUPPLIERINVOICEITEMS.DECLARATIONID='1-6286' AND SUPPLIERINVOICEITEMS.TAXEXEMPTCODE IS NULL
 AND TENANT='1'</DAT>
<DAT name=""EXAMPLE_RESULT"">1</DAT>
</OCC>
<OCC>
...
<DAT name=""PARAMETERS"">DECLARATIONS.ID=True</DAT>
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT DECLARATIONS.TRANSFERIMPORTERCODE FROM DECLARATIONS WHERE DECLARATIONS.ID='1-7297'
 AND TENANT='1'</DAT>
...
<DAT name=""REFERENCE"">CFIFFORMS.Lp_TransferImporter</DAT>
<DAT name=""PARAMETERS"">CUSTOMFILENO=True</DAT>
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT DECLARATIONS.TRANSFERIMPORTERID FROM DECLARATIONS WHERE CUSTOMFILENO='5312'
 AND TENANT='1'</DAT>
...
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT DECLARATIONTAXES.TOTALAMOUNT FROM  DECLARATIONTAXES WHERE  DECLARATIONTAXES.DECLARATIONID='1-6271' AND DECLARATIONTAXES.TAXTYPECODE ='16'
 AND TENANT='1'</DAT>
...
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT DECLARATIONS.ID FROM DECLARATIONS WHERE DECLARATIONS.CUSTOMFILENO='5312'
 AND TENANT='1'</DAT>
...
FROM Customs.DECLARATIONS, Customs.CLIENTS WHERE (DECLARATIONS.ImporterId = CLIENTS.ID AND DECLARATIONS.CustomFileNo = @CustomFileNo) and TENANT=@Tenant</DAT>
...
<DAT name=""PARAMETERS"">CUSTOMSCOLLATERALS.DECLARATIONID=True</DAT>
...
<DAT name=""PARAMETERS"">D.ID=True</DAT>
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT   D.ID,  SI.InvoiceNumber,  SI.VendorId,  SI.InvoiceAmount,  SI.InvoiceCurrencyTypeCode,  CUSTOMSVENDORS.VendorName FROM DECLARATIONS D, SupplierInvoices SI ,  CUSTOMSVENDORS WHERE D.ID = SI.DECLARATIONID(+) AND  SI.VendorId = CUSTOMSVENDORS.ID(+) AND  D.ID='1-101193'
 AND D.TENANT='1' AND SI.TENANT='1' AND CUSTOMSVENDORS.TENANT='1'</DAT>
...
<DAT name=""PARAMETERS"">ID=True</DAT>
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT VERSIONID FROM DECLARATIONS WHERE ID='1-202' AND TENANT='1'</DAT>
...
<DAT name=""PARAMETERS"">ID=True</DAT>
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT ISCHANGED FROM DECLARATIONS WHERE ID='1-100533' AND TENANT='1'</DAT>
<DAT name=""EXAMPLE_RESULT"">1</DAT>
</OCC>
<OCC>
...
<DAT name=""PARAMETERS"">ID=True</DAT>
<DAT name=""EXAMPLE_SQL"" xml:space='preserve'>SELECT IMPORTERID FROM DECLARATIONS WHERE ID='1-100533' AND TENANT='1'</DAT>
