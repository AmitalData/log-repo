...
{
    public partial class BluesnapPaymentAmital : System.Web.UI.Page
    {
        int Tenant = 0;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception errorInfo)
           {
                ...
                AzureLog.SaveLogsInStorage("Bluesnap payment amital error  " + Environment.NewLine + errorMessage, "E", DateTime.Now, errorInfo.Message, errorInfo.StackTrace, 0, null, null, null);
            }
        }
        ...
        private void InsertNewAnalyzeQueue(string xmlfileText)
        {
            ...
            AnalyzeQueue analyzeQueue = new AnalyzeQueue()
            {
                ...
                Tenant = Tenant,
                Subject= "Bluesnap Payment - Amital"
