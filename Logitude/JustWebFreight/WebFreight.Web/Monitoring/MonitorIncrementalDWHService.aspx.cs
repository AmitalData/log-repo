    ...
    public partial class MonitorIncrementalDWHService : System.Web.UI.Page
    {
        ...
        private static bool CheckIfIncrementalDWUpdateFailed()
        {
            ...
            bool incrementalDWUpdateFailed = (from d in commonDataContext.DWHBuildStatus
                             where (d.LastIncrementalDWUpdateDate == null || (EntityFunctions.DiffMinutes(d.LastIncrementalDWUpdateDate, todayDateTime) > 3)) && (!d.IsFullBuildDWRunning || (d.IsFullBuildDWRunning && EntityFunctions.DiffHours(d.LastIncrementalDWUpdateDate, todayDateTime) > 5))
                                              select d).Any();
