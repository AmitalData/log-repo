...
{
    public partial class CommunicationWaitingStatus : System.Web.UI.Page
    {
                ...
                if (!string.IsNullOrEmpty(myTarget))
                {
                    ...
                    if (!string.IsNullOrEmpty(toParameter))
                    {
                        ...
                        using (TransactionScope scope = TransactionFactory.GetNewTransaction())
                        {
                            ...
                            {
                                ExceptionHandler.HandleException(errorInfo, todayDateTime, 0, "", "CommunicationWaitingStatus", "Bug in AnyWaitingStatus Method : globaldbRep.All()", null);
                            }
                        ...
                        foreach (GlobalDB db in GlobalDatabases)
                        {
                            ...
                            try
                            {
                                isWaiting = (from a in Context.CommunicationLogs
                                             ...
                                             && a.CommunicationStatusTypeCode == "W" && a.To == toParameter
                            ...
                            {
                                ExceptionHandler.HandleException(errorInfo, todayDateTime, 0, "", "CommunicationWaitingStatus", "Bug in AnyWaitingStatus Method : IsFaild = (from a in Context.CommunicationLogs [" + toParameter + "] ...", null);
                            }
