...
{
    public partial class CheckFailedJournals : System.Web.UI.Page
    {
        ...
        private bool AnyFailedJournal()
        {
            ...
            try
            {
                ...
                isFaild = journalQueryService.GetFailedJournlsForToday();
            }
            catch (Exception errorInfo)
            {
                ExceptionHandler.HandleException(errorInfo, DateTime.Now, 0, "", "CheckJournals", "Bug in AnyFailedJournal Method...", null);
            }
            return isFaild;
        }
    }
