...
{
    public partial class AutomationMonitoring : System.Web.UI.Page
    {
        ...
        private bool AnyFailedStatus()
        {
            ...
            using (TransactionScope scope = TransactionFactory.GetNewTransaction())
            {
                ...
                {
                    ExceptionHandler.HandleException(errorInfo, DateTime.Now, 0, "", "AutomationQueue", "Bug in AutomationQueue Monitoring ", null);
                }
                scope.Complete();
            }
            return isFailed;
        ...
        private static bool CheckIfAnyCommunicationLogsFailed()
        {
            ...
            return (from a in context.QueueMessages
                    ...
                    && a.QueueDefinitionCode == "AutomationQueue" && ((a.Status == 0
