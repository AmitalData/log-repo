...
{
    public partial class LogBoxShipmentQueue : System.Web.UI.Page
    {
        ...
        private bool AnyFailedStatus()
        {
            ...
            try
            {
                ...
                IsFaild = (from a in Context.QueueMessages
                                  where (a.QueueDefinitionCode.Contains("ImportersShipmentQueue") || a.QueueDefinitionCode.Contains("ImportersShipmentsBatchQueue")) && a.Status == -1 
