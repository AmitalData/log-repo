<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpportunityPage.aspx.cs" Inherits="WebFreight.Web.CustomersHTML.OpportunityPage" %>
...
<div id="Page">       
            ...
            <div style="display:table-cell; width:100%; border-top: 1px solid #DADADA; border-left: 1px solid #DADADA; border-right: 1px solid #DADADA; background: #F7F7F7;">
                <table id="HeaderData" style="border-collapse:collapse; text-space-collapse:collapse; border:none; width:100%; display:none;">
                    <tr style="height:30px;">
                        ...
                        <td class="HeaderLable" style="width:65px;">Topic:</td>
                        <td class="HeaderValue" id="Topic"></td>

                        <td class="HeaderLable" style="width:110px;">Stage:</td>
                        <td class="HeaderValue" id="Stage"></td>

                        <td class="HeaderLable" style="width:70px;">Value:</td>
                        <td class="HeaderValue" id="Value"></td>

                        <td style="width:10px;"></td>
                    </tr>
                    <tr style="height:30px;">
                        <td style="width:10px;"></td>
                        <td class="HeaderLable" style="width:65px;">Owner:</td>
                        <td class="HeaderValue" id="Owner"></td>

                        <td class="HeaderLable" style="width:110px;">Customer Age:</td>
                        <td class="HeaderValue" id="CustomerAge"></td>

                        <td class="HeaderLable" style="width:70px;">Est. Closing Date:</td>
                        <td class="HeaderValue" id="ClosingDate"></td>
            ...
            <div style="display:table; table-layout:fixed; width:100%;">
                ...
                <div style="display:table-cell; vertical-align:top; width:143px; border-radius: 5px 0 0 0; -moz-border-radius: 5px 0 0 0; -webkit-border-radius: 5px 0 0 0; padding:0; background: url('images/QueryArea.png') repeat-y;">                                                 
                    <div style="vertical-align:top; margin-top:5px; border-top:1px solid #CCCCCC; border-bottom:1px solid #CCCCCC; background:url(images/Queries.png) repeat-y;">
                        ...
                        <div class="HyperLinkQuery" id="GENE"><div style="display:table-cell; vertical-align:middle;">General</div></div>
                        <div class="HyperLinkQuery" id="PROD"><div style="display:table-cell; vertical-align:middle;">Products</div></div>
                    </div>                                      
                </div>
                ...
                <div style="display:table-cell; vertical-align:top; padding:0px;">
                    ...
                    <!-- Overview -->
                    <div class="TabPage" id="OVER_Page" style="width:100%;">
                    ...
                    <!-- General -->
                    <div class="TabPage" id="GENE_Page" style="width:100%;">
                        <div style="display:table; table-layout:fixed; width:100%; height:35px;">
                    ...
                    <!-- Products -->
                    <div class="TabPage" id="PROD_Page" style="width:100%;">
                        <div style="display:table; table-layout:fixed; width:100%; height:35px;">
                            <div style="display:table-cell; vertical-align:middle;" class="TabHeader">Products</div>
                        </div>
                        ...
                        <div class="BusyIndicator" id="ProductsTabBusyIndicator"></div>
                    </div>
    ...
    <script type="text/javascript" src="OpportunityPageViewModel.js"></script>
</html>
