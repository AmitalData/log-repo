...
namespace WebFreight.Web.MetaDataUpdate
{
    public partial class MetaDataUpdateClass
    {
        public void LoadEntityStatus()
        {
            ...
            AddEntityStatus.AddEntityStatu(new EntityStatusDetails() { Code = "PSHP", StatusWeight = 10, Name = "Partially Pick Up", ObjectTableId = shipmentObject.Id, Tenant = 0, DisplayName = "Partially Picked Up", EntityStatusTypeCode = "P" }, EntityStatusRepository, tenantEntityStatus);
