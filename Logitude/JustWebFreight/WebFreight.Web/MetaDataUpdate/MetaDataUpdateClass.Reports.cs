...
namespace WebFreight.Web.MetaDataUpdate
{
    public partial class MetaDataUpdateClass
    {
        ...
        private void LoadReports_Accounting(ReportGroup accountingGroup, List<Feature> tenantFeatures, ReportRepository reportRepository, Dictionary<string, Report> tenantReports)
        {
            ...
            AddReports.AddReport(new ReportDetails() { Code = "DSCA", Description = "Detailed Shipment Charges Analysis", Name = "Detailed Shipment Charges Analysis", FilterControlName = "DetailedShipmentChargesAnalysisFilterControl", Tenant = 0, ReportGroupId = accountingGroup.Id, FeatureId = feature_DetailedShipmentCharges.Id, FilterHtmlComponentUrl = "./Report/Components/FiltersComponent/Accounting/DetailedShipmentChargesAnalysisComponent" }, reportRepository, tenantReports);
        }
