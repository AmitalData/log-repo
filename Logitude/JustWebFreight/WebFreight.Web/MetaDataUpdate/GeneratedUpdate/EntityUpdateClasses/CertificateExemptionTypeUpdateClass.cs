...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "c7973a95cb5df469a36830413436ba2b";
	    ...
	    {  
	        ...
	        QueryGroup CertificateExemptionTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CEET", Name = "Customs.CertificateExemptionType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CertificateExemptionTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "56ca", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
