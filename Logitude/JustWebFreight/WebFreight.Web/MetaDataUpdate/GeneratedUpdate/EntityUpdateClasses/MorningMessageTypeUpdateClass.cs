   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn MorningMessageTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = MorningMessageTypeQuery.Id,QueryCode = MorningMessageTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.MorningMessageType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn MorningMessageTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = MorningMessageTypeQuery.Id,QueryCode = MorningMessageTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.MorningMessageType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn MorningMessageTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = MorningMessageTypeQuery.Id,QueryCode = MorningMessageTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.MorningMessageType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn MorningMessageTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = MorningMessageTypeQuery.Id,QueryCode = MorningMessageTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.MorningMessageType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
