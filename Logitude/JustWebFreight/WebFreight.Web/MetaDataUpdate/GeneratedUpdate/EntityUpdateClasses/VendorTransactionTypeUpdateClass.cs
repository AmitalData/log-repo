...
{
   public class VendorTransactionTypeUpdateClass
   {  		
		public const string HashString = "8fc40406449a378969c819dc4f5a09ad";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.VendorTransactionType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.VendorTransactionTypes",
			      				    ObjectTableSingular =  "VendorTransactionType",
			      				    ObjectTablePlural =  "VendorTransactionTypes",
			      				    ...
			      				    LocalDefaultText =  "סוג פעילות על ספק",
			      				    DefaultText =  "Vendor Transaction Type",
			      				    Code =  "VTQG",
			      				    Name =  "Customs.VendorTransactionType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  VendorTransactionTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.VendorTransactionType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup VendorTransactionTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "VTQG", Name = "Customs.VendorTransactionType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup VendorTransactionTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "e3fa", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> VendorTransactionTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.VendorTransactionType").ToList();
	         ...
	         Screen VendorTransactionTypeCustomsVendorTransactionTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "VendorTransactionType.HeaderScreen", Name = "Customs.VendorTransactionTypeHeaderScreen", ObjectTableId = VendorTransactionTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    VendorTransactionTypeObjectTable.HeaderScreenId = VendorTransactionTypeCustomsVendorTransactionTypeHeaderScreenScreen0.Id;
		    VendorTransactionTypeObjectTable.HeaderScreenCode = VendorTransactionTypeCustomsVendorTransactionTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = VendorTransactionTypeObjectTable.Id,
