   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> VendorTransactionTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.VendorTransactionType").ToList();
	         ...
	         Screen VendorTransactionTypeCustomsVendorTransactionTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "VendorTransactionType.HeaderScreen", Name = "Customs.VendorTransactionTypeHeaderScreen", ObjectTableId = VendorTransactionTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
