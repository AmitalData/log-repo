   ...
   {  
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						FullLocalDefaultText =  "מספר הפקדה / המחםה",
					  						ListFieldLable =  "SearchFieldsListLable",
					  						ListLableDefaultText =  "Deposit No. / Cheque No.",
					  						ListLocalDefaultText =  "מספר הפקדה / המחםה",
					  						IsMaxLength =  true,
					  						IsFixedLength =  false,
	    ...
	    {  
	        ...
	        List<ObjectField> BankDepositObjectFields = objectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BankDeposit").ToList();   
			   ...
			   TextCode BankDepositTextCode_3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BankDeposit.Q.chequeDeposit", DefaultText = @"Cheque Deposit",LocalDefaultText = "הפקדות המחםות", ObjectTableId = BankDepositObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, TextCodeRepository, textCodes);
	    ...
	    {   
		   ...
		   List<ObjectField> BankDepositObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BankDeposit").ToList();
            ...
            ScreenField BankDepositBankDepositBankDepositDetailsScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = BankDepositObjectFields.Where(d => d.FieldName == "DepositNumber").FirstOrDefault().Id, ScreenId = BankDepositBankDepositDetailsScreenScreen0.Id,ScreenCode = BankDepositBankDepositDetailsScreenScreen0.Code, ObjectFieldCode = BankDepositObjectFields.Where(d => d.FieldName == "DepositNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
			   ...
			   TextCode BankDepositEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BankDeposit.TH.Events", DefaultText = "Events",LocalDefaultText = "םירועים", ObjectTableId = BankDepositObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes);
