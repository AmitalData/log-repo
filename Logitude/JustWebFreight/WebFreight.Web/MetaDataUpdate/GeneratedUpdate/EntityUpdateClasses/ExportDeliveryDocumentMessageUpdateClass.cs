   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ExportDeliveryDocumentMessageTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ExportDeliveryDocumentMessage.Q.EDDM", DefaultText = @"ExportDeliveryDocumentMessageSenderCode",LocalDefaultText = "ExportDeliveryDocumentMessageSenderCode", ObjectTableId = ExportDeliveryDocumentMessageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ExportDeliveryDocumentMessageFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ExportDeliveryDocumentMessage.Q.EDDM", ObjectTableId = ExportDeliveryDocumentMessageObjectTable.Id, Tenant = 0, NameTextCodeCode = "ExportDeliveryDocumentMessageFeatures.EDDM", NameTextCodeDefaultText = "EDDM", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ExportDeliveryDocumentMessageObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query EDDMQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ExportDeliveryDocumentMessageTextCode_0.Id, NameTextCodeCode = ExportDeliveryDocumentMessageTextCode_0.Code, ObjectTableName = "Customs.ExportDeliveryDocumentMessage", Code = "EDDM",  QueryGroupCode = "EDCM", IndexOrder = 0, Tenant = 0, ObjectTableId = ExportDeliveryDocumentMessageObjectTable.Id, QuerySection = "Customs.ExportDeliveryDocumentMessage", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ExportDeliveryDocumentMessageFeature_0.Id,FeatureUniqeCode= ExportDeliveryDocumentMessageFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn EDDMQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = EDDMQuery.Id,QueryCode = EDDMQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ExportDeliveryDocumentMessage.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn EDDMQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = EDDMQuery.Id,QueryCode = EDDMQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ExportDeliveryDocumentMessage.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn EDDMQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = EDDMQuery.Id,QueryCode = EDDMQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ExportDeliveryDocumentMessage.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn EDDMQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = EDDMQuery.Id,QueryCode = EDDMQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ExportDeliveryDocumentMessage.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
