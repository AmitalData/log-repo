   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ImporterDeclarationTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ImporterDeclarationType.Q.ImporterDeclarationType", DefaultText = @"ImporterDeclarationTypeQuery",LocalDefaultText = null, ObjectTableId = ImporterDeclarationTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ImporterDeclarationTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ImporterDeclarationType").ToList();
	         ...
	         Screen ImporterDeclarationTypeCustomsImporterDeclarationTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ImporterDeclarationType.HeaderScreen", Name = "Customs.ImporterDeclarationTypeHeaderScreen", ObjectTableId = ImporterDeclarationTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
