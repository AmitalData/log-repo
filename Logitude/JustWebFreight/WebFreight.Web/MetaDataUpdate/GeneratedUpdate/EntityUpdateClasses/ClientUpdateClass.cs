...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "296f158135e52824df53cd674f4df13f";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ClientTypeSpecificCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "CustomerTypeGeneral",
					  						NavigationPropertyName =  "CustomerTypeGeneral",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "GenderCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "Gender",
					  						NavigationPropertyName =  "Gender",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "FacilitationTypeCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "FacilitationType",
					  						NavigationPropertyName =  "FacilitationType",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ClientTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.Q.ClientQuery", DefaultText = @"Clients",LocalDefaultText = "לקוחות", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query ClientsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ClientTextCode_0.Id, NameTextCodeCode = ClientTextCode_0.Code, ObjectTableName = "Customs.Client", Code = "Clients",  EditWizardName = "Logitude.Customs.Views.Tabs.ClientEditControl",
			   QueryGroupCode = "CLNT", IndexOrder = 0, Tenant = 0, ObjectTableId = ClientObjectTable.Id, QuerySection = "Customs.Client", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = ClientFeature_0.Id,FeatureUniqeCode= ClientFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ClientsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClientsQuery.Id,QueryCode = ClientsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.Client.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClientsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClientsQuery.Id,QueryCode = ClientsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.Client.FullName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClientsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClientsQuery.Id,QueryCode = ClientsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.Client.PassportTypeCode" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClientsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClientsQuery.Id,QueryCode = ClientsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.Client.PassportNumber" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClientsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClientsQuery.Id,QueryCode = ClientsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.Client.PassportCountryCode" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClientsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClientsQuery.Id,QueryCode = ClientsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.Client.IsExportPoaActive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ClientObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.Client").ToList();
	         ...
	         Screen ClientCustomsClientHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Client.HeaderScreen", Name = "Customs.ClientHeaderScreen", ObjectTableId = ClientObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode ClientGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature ClientGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = ClientObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.Client.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,ClientObjectTable,contextTenant);
 
                 
			   TextCode ClientEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.TH.Events", DefaultText = "Events",LocalDefaultText = "אירועים", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ClientRequestSheetsTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.TH.RequestSheets", DefaultText = "Request Sheets",LocalDefaultText = "גיליון בקשה", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode ClientTextCode_CustomsClientOClients = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.Clients", DefaultText = "Clients",LocalDefaultText = @"יבואנים/יצואנים", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOSend = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.Send", DefaultText = "Send",LocalDefaultText = @"לשלוח", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOGeneral = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.General", DefaultText = "General",LocalDefaultText = @"כללי", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOEditClient = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.EditClient", DefaultText = "Edit Client",LocalDefaultText = @"ערוך לקוח", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOEnglish = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.English", DefaultText = "English",LocalDefaultText = @"אנגלית", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOHebrew = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.Hebrew", DefaultText = "Hebrew",LocalDefaultText = @"עברית", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ClientTextCode_CustomsClientOBuildClient = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.BuildClient", DefaultText = "Build Client",LocalDefaultText = @"הקמת לקוח", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOSearchClient = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.SearchClient", DefaultText = "Search Client",LocalDefaultText = @"לקוח חיפוש", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOCodeRequired = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.CodeRequired", DefaultText = "Code Field is Required",LocalDefaultText = @"הקוד נדרש", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOPassportRequired = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.PassportRequired", DefaultText = "Passport Number Field is Required",LocalDefaultText = @"דרכון מספר שדה הוא חובה", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOCodeExists = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.CodeExists", DefaultText = "This Code is already exists",LocalDefaultText = @"קוד זה כבר קיים", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientONewClient = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.NewClient", DefaultText = "New Client",LocalDefaultText = @"לקוח חדש", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientONewClientSucceeded = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.NewClientSucceeded", DefaultText = "Create New Client Succeeded",LocalDefaultText = @"לקוח חדש הוקם בהצלחה", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientNewButton = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.NewButton", DefaultText = "New Client",LocalDefaultText = @"לקוח חדש", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientAuthorizationLetters = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.AuthorizationLetters", DefaultText = "Authorization Letters",LocalDefaultText = @"שליפת כתבי הרשאה", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ClientTextCode_CustomsClientItems = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.Items", DefaultText = "Items",LocalDefaultText = @"פריטים", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ClientTextCode_CustomsClientOItemOrClassificationSearch = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.ItemOrClassificationSearch", DefaultText = "Item Or Classification Search",LocalDefaultText = @"פרט / פריט / תאור", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
