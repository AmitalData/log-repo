...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    {                
			   ...
			   TextCode ClientEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.TH.Events", DefaultText = "Events",LocalDefaultText = "םירועים", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode ClientTextCode_CustomsClientOClients = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.Clients", DefaultText = "Clients",LocalDefaultText = @"יבוםנים/יצוםנים", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ClientTextCode_CustomsClientOEnglish = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.English", DefaultText = "English",LocalDefaultText = @"םנגלית", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ClientTextCode_CustomsClientOPassportRequired = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.PassportRequired", DefaultText = "Passport Number Field is Required",LocalDefaultText = @"דרכון מספר שדה הום חובה", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ClientTextCode_CustomsClientOItemOrClassificationSearch = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Client.O.ItemOrClassificationSearch", DefaultText = "Item Or Classification Search",LocalDefaultText = @"פרט / פריט / תםור", ObjectTableId = ClientObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
