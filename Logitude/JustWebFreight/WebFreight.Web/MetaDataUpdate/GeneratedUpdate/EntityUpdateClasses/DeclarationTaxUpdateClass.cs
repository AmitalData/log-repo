   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DeclarationTaxObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DeclarationTax").ToList();
	         ...
	         Screen DeclarationTaxCustomsDeclarationTaxHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DeclarationTax.HeaderScreen", Name = "Customs.DeclarationTaxHeaderScreen", ObjectTableId = DeclarationTaxObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
