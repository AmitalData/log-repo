...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "713ed15b9a9fd6ed768232bccf987d9f";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "TicketEscalation",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  TicketEscalationUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						DefaultText =  "Search Escalation / Recepients",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
	    ...
	    {  
	        ...
	        QueryGroup TicketEscalationQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "TEQG", Name = "TicketEscalation" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup TicketEscalationQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "6e37", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> TicketEscalationObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "TicketEscalation").ToList();
	         ...
	         Screen TicketEscalationTicketEscalationHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TicketEscalation.HeaderScreen", Name = "TicketEscalationHeaderScreen", ObjectTableId = TicketEscalationObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    TicketEscalationObjectTable.HeaderScreenId = TicketEscalationTicketEscalationHeaderScreenScreen0.Id;
		    TicketEscalationObjectTable.HeaderScreenCode = TicketEscalationTicketEscalationHeaderScreenScreen0.Code;
