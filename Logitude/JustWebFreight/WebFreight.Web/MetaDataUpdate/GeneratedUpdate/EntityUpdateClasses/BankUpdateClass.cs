   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode BankTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Bank.Q.BankQuery", DefaultText = @"Banks",LocalDefaultText = "בנק", ObjectTableId = BankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature BankFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "BANKS", ObjectTableId = BankObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.Bank.Features.Banks", NameTextCodeDefaultText = "Banks", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,BankObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn BankQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankQuery.Id,QueryCode = BankQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.Bank.Code" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn BankQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankQuery.Id,QueryCode = BankQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.Bank.EnglishName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn BankQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankQuery.Id,QueryCode = BankQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.Bank.LocalName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn BankQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankQuery.Id,QueryCode = BankQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.Bank.Inactive" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> BankObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.Bank").ToList();
	         ...
	         Screen BankCustomsBankHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Bank.HeaderScreen", Name = "Customs.BankHeaderScreen", ObjectTableId = BankObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
