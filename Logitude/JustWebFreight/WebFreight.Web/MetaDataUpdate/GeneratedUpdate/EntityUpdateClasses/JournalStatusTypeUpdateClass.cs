...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "f22595bccb88f3bb504ff63716d95350";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "JournalStatusType",
			      				    ...
			      				    LocalDefaultTextBack_up =  "סטטוס פקודה",
			      				    LocalDefaultText =  "BS64:Iteh15jXmNeV16Eg16TXp9eV15PXlCI=",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "JournalStatusID",
					  						...
					  						FullLocalDefaultTextBack_up =  "קוד סטטוס פקודה",
					  						FullLocalDefaultText =  "BS64:Iten15XXkyDXodeY15jXldehINek16fXldeT15Qi",
					  						ListFieldLable =  "JournalStatusIDListLable",
					  						ListLableDefaultText =  "Journal Status ID",
					  						ListLocalDefaultTextBack_up =  "קוד סטטוס פקודה",
					  						ListLocalDefaultText =  "BS64:Iten15XXkyDXodeY15jXldehINek16fXldeT15Qi",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
	    ...
	    {   
		   ...
		   //List<ObjectField> JournalStatusTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "JournalStatusType").ToList();
	         ...
	         Screen JournalStatusTypeJournalStatusTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "JournalStatusType.HeaderScreen", Name = "JournalStatusTypeHeaderScreen", ObjectTableId = JournalStatusTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillJournalStatusType(int contextTenant)
        { 
            var repo = new JournalStatusTypeRepository(contextTenant);
