...
{
   public class ConstraintApprovalDecisionUpdateClass
   {  		
		public const string HashString = "3a6b589ee69ba77d746247b1bb30796a";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.ConstraintApprovalDecision",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.ConstraintApprovalDecisions",
			      				    ObjectTableSingular =  "ConstraintApprovalDecision",
			      				    ObjectTablePlural =  "ConstraintApprovalDecisions",
			      				    ...
			      				    LocalDefaultText =  "סוג החלטה באילוץ",
			      				    DefaultText =  "Constraint Approval Decision ",
			      				    Code =  "CADG",
			      				    Name =  "Customs.ConstraintApprovalDecisions",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ConstraintApprovalDecisionUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.ConstraintApprovalDecision",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup ConstraintApprovalDecisionQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CADG", Name = "Customs.ConstraintApprovalDecisions" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ConstraintApprovalDecisionQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "e022", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> ConstraintApprovalDecisionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ConstraintApprovalDecision").ToList();
	         ...
	         Screen ConstraintApprovalDecisionCustomsConstraintApprovalDecisionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ConstraintApprovalDecision.HeaderScreen", Name = "Customs.ConstraintApprovalDecisionHeaderScreen", ObjectTableId = ConstraintApprovalDecisionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ConstraintApprovalDecisionObjectTable.HeaderScreenId = ConstraintApprovalDecisionCustomsConstraintApprovalDecisionHeaderScreenScreen0.Id;
		    ConstraintApprovalDecisionObjectTable.HeaderScreenCode = ConstraintApprovalDecisionCustomsConstraintApprovalDecisionHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ConstraintApprovalDecisionObjectTable.Id,
