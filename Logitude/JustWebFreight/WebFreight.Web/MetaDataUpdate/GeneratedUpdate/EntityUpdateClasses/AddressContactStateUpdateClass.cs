...
{
   public class AddressContactStateUpdateClass
   {  		
		public const string HashString = "0bcee02a97b448c8f6a793cde0f02467";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.AddressContactState",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.AddressContactStates",
			      				    ObjectTableSingular =  "Customs.AddressContactState",
			      				    ObjectTablePlural =  "Customs.AddressContactStates",
			      				    ...
			      				    LocalDefaultText =  "מדינה לטפל קשר",
			      				    DefaultText =  "Address Contact State",
			      				    Code =  "ADCS",
			      				    Name =  "Customs.AddressContactState",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  AddressContactStateUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.AddressContactState",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup AddressContactStateQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "ADCS", Name = "Customs.AddressContactState" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup AddressContactStateQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "e5cb", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> AddressContactStateObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AddressContactState").ToList();
	         ...
	         Screen AddressContactStateCustomsAddressContactStateHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AddressContactState.HeaderScreen", Name = "Customs.AddressContactStateHeaderScreen", ObjectTableId = AddressContactStateObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    AddressContactStateObjectTable.HeaderScreenId = AddressContactStateCustomsAddressContactStateHeaderScreenScreen0.Id;
		    AddressContactStateObjectTable.HeaderScreenCode = AddressContactStateCustomsAddressContactStateHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = AddressContactStateObjectTable.Id,
