...
{
   public class PaymentMethodStatusUpdateClass
   {  		
		public const string HashString = "faf772e7d4c6d8baa0a9bfafbb26636d";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.PaymentMethodStatus",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.PaymentMethodStatus",
			      				    ObjectTableSingular =  "Payment Method Status",
			      				    ObjectTablePlural =  "Payment Method Status",
			      				    ...
			      				    DefaultText =  "Payment Method Status",
			      				    Code =  "PAMS",
			      				    Name =  "Customs.PaymentMethodStatus",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  PaymentMethodStatusUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.PaymentMethodStatus",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup PaymentMethodStatusQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "PAMS", Name = "Customs.PaymentMethodStatus" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup PaymentMethodStatusQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "55cf", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> PaymentMethodStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PaymentMethodStatus").ToList();
	         ...
	         Screen PaymentMethodStatusCustomsPaymentMethodStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PaymentMethodStatus.HeaderScreen", Name = "Customs.PaymentMethodStatusHeaderScreen", ObjectTableId = PaymentMethodStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    PaymentMethodStatusObjectTable.HeaderScreenId = PaymentMethodStatusCustomsPaymentMethodStatusHeaderScreenScreen0.Id;
		    PaymentMethodStatusObjectTable.HeaderScreenCode = PaymentMethodStatusCustomsPaymentMethodStatusHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = PaymentMethodStatusObjectTable.Id,
