   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "OpenFormatReport",
			      				    ...
			      				    LocalDefaultText =  "דוחות מבנה םחיד",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ToDate",
					  						...
					  						DefaultText =  "To ",
					  						FullLocalDefaultText =  "עד תםריך",
					  						ListFieldLable =  "ToDateListLable",
					  						ListLableDefaultText =  "To",
					  						ListLocalDefaultText =  "עד תםריך",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllOpenFormatsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOpenFormatsQuery.Id,QueryCode = AllOpenFormatsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "OpenFormatReport.CreateDate" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllOpenFormatsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOpenFormatsQuery.Id,QueryCode = AllOpenFormatsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "OpenFormatReport.ReportNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllOpenFormatsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOpenFormatsQuery.Id,QueryCode = AllOpenFormatsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "OpenFormatReport.CreatedByUserName" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllOpenFormatsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOpenFormatsQuery.Id,QueryCode = AllOpenFormatsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "OpenFormatReport.Status" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> OpenFormatReportObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "OpenFormatReport").ToList();
		    ...
		    OpenFormatReportObjectTable.HeaderScreenCode = OpenFormatReportOpenFormatReportHeaderScreenScreen0.Code;
	         ...
	         Screen OpenFormatReportGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "OpenFormatReport.GeneralTabScreen", Name = "GeneralTabScreen", ObjectTableId = OpenFormatReportObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField OpenFormatReportGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = OpenFormatReportGeneralTabScreenScreen1.Id,ScreenCode = OpenFormatReportGeneralTabScreenScreen1.Code, ObjectFieldCode = "OpenFormatReport.FromDate", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField OpenFormatReportGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = OpenFormatReportGeneralTabScreenScreen1.Id,ScreenCode = OpenFormatReportGeneralTabScreenScreen1.Code, ObjectFieldCode = "OpenFormatReport.ToDate", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
