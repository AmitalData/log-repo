...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "6224a41edd2b497b5fd3a8c53c6b587a";
	    ...
	    {   
		   ...
		   //List<ObjectField> CourierStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CourierStatus").ToList();
	         ...
	         Screen CourierStatusCustomsCourierStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CourierStatus.HeaderScreen", Name = "Customs.CourierStatusHeaderScreen", ObjectTableId = CourierStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
