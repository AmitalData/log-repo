   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CourierStatusQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CourierStatusQuery.Id, IndexOrder = 1, ObjectFieldId = CourierStatusObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CourierStatusObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CourierStatusQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CourierStatusQuery.Id, IndexOrder = 2, ObjectFieldId = CourierStatusObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CourierStatusObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
