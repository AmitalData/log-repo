   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SealTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "SealType.Q.SealType", DefaultText = @"SealTypeQuery",LocalDefaultText = "סוג סגר", ObjectTableId = SealTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query SealTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = SealTypeTextCode_0.Id, NameTextCodeCode = SealTypeTextCode_0.Code, ObjectTableName = "Customs.SealType", Code = "SealType",  QueryGroupCode = "a866", IndexOrder = 0, Tenant = 0, ObjectTableId = SealTypeObjectTable.Id, QuerySection = "Customs.SealType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = SealTypeFeature_0.Id,FeatureUniqeCode= SealTypeFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn SealTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealTypeQuery.Id,QueryCode = SealTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.SealType.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn SealTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealTypeQuery.Id,QueryCode = SealTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.SealType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SealTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealTypeQuery.Id,QueryCode = SealTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.SealType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SealTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealTypeQuery.Id,QueryCode = SealTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.SealType.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> SealTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SealType").ToList();
	         ...
	         Screen SealTypeCustomsSealTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SealType.HeaderScreen", Name = "Customs.SealTypeHeaderScreen", ObjectTableId = SealTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
