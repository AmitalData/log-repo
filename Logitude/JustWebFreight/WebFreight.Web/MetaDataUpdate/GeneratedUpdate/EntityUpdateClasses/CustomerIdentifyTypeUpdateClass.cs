   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomerIdentifyTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomerIdentifyType").ToList();
	         ...
	         Screen CustomerIdentifyTypeCustomsCustomerIdentifyTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerIdentifyType.HeaderScreen", Name = "Customs.CustomerIdentifyTypeHeaderScreen", ObjectTableId = CustomerIdentifyTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
