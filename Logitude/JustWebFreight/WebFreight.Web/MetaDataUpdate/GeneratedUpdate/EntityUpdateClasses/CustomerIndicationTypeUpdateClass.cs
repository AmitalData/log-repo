   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   Feature CustomerIndicationTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomerIndicationTypeQUERY", ObjectTableId = CustomerIndicationTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.CustomerIndicationType.Features.CustomerIndicationType", NameTextCodeDefaultText = "Morning Message Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CustomerIndicationTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query CustomerIndicationTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomerIndicationTypeTextCode_0.Id, NameTextCodeCode = CustomerIndicationTypeTextCode_0.Code, ObjectTableName = "Customs.CustomerIndicationType", Code = "CustomerIndicationType",  QueryGroupCode = "MMTG", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomerIndicationTypeObjectTable.Id, QuerySection = "Customs.CustomerIndicationType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CustomerIndicationTypeFeature_0.Id,FeatureUniqeCode= CustomerIndicationTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CustomerIndicationTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerIndicationTypeQuery.Id,QueryCode = CustomerIndicationTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomerIndicationType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerIndicationTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerIndicationTypeQuery.Id,QueryCode = CustomerIndicationTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomerIndicationType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerIndicationTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerIndicationTypeQuery.Id,QueryCode = CustomerIndicationTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomerIndicationType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerIndicationTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerIndicationTypeQuery.Id,QueryCode = CustomerIndicationTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomerIndicationType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
