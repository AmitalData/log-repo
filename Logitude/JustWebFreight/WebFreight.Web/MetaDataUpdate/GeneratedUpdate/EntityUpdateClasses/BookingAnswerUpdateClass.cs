...
{
   public class BookingAnswerUpdateClass
   {  		
		public const string HashString = "524007c258ffd4e16d275cb03d0636aa";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "BookingAnswer",
			      				    IsNew =  false,
			      				    DBTableName =  "BookingAnswers",
			      				    ObjectTableSingular =  "Booking Answer",
			      				    ObjectTablePlural =  "Booking Answers",
			      				    ...
			      				    DefaultText =  "Booking Answer",
			      				    Code =  "5451",
			      				    Name =  "BookingAnswer Query Group",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  BookingAnswerUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "StatusCode",
					  						ObjectTableName =  "BookingAnswer",
					  						FieldsDataType =  "LookUp",
					  						LookUpTableName =  "BookingAnswerStatus",
					  						MinLength =  0,
					  						MaxLength =  3,
					  						IsRequired =  true,
					  						CopyToDW =  false,
					  						...
					  						DependencyFilter2IsList =  false,
					  						DependencyFilter3IsList =  false,
					  						ValidForQuerySection1 =  "BookingAnswer",
					  						IsRestrictable =  false,
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "BookingAnswerStatus",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "BookingSpaceAllocationCode",
					  						ObjectTableName =  "BookingAnswer",
					  						FieldsDataType =  "LookUp",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "BookingSpaceAllocationCode",
					  						ListPropertyPath =  "BookingSpaceAllocationCode",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "BookingSpaceAllocationCode",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "NumberOfPieces",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "NumberOfPieces",
					  						ListPropertyPath =  "NumberOfPieces",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "NumberOfPieces",
					  						DefaultText =  "Number Of Pieces",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "WeightUnitCode",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "WeightUnitCode",
					  						ListPropertyPath =  "WeightUnitCode",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "WeightUnitCode",
					  						DefaultText =  "Weight Unit Code",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DestinationCountryCode",
					  						...
					  						DefaultText =  "DestinationCountryCode",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DestinationCountryName",
					  						...
					  						DefaultText =  "DestinationCountryName",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
	    ...
	    {   
		   ...
		   ObjectTable BookingAnswerObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "BookingAnswer" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> BookingAnswerObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BookingAnswer").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = BookingAnswerObjectTable.Id,
