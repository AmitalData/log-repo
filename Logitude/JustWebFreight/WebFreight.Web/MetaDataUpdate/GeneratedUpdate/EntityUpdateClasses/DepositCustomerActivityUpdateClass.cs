   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn DepositCustomerActivityQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DepositCustomerActivityQuery.Id,QueryCode = DepositCustomerActivityQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.DepositCustomerActivity.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> DepositCustomerActivityObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DepositCustomerActivity").ToList();
	         ...
	         Screen DepositCustomerActivityCustomsDepositCustomerActivityHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DepositCustomerActivity.HeaderScreen", Name = "Customs.DepositCustomerActivityHeaderScreen", ObjectTableId = DepositCustomerActivityObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
