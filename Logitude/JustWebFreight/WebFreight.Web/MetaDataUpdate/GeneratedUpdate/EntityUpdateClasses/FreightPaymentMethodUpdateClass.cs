   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode FreightPaymentMethodTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "FreightPaymentMethod.Q.FreightPaymentMethod", DefaultText = @"FreightPaymentMethodQuery",LocalDefaultText = null, ObjectTableId = FreightPaymentMethodObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn FreightPaymentMethodQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FreightPaymentMethodQuery.Id,QueryCode = FreightPaymentMethodQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.FreightPaymentMethod.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn FreightPaymentMethodQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FreightPaymentMethodQuery.Id,QueryCode = FreightPaymentMethodQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.FreightPaymentMethod.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn FreightPaymentMethodQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FreightPaymentMethodQuery.Id,QueryCode = FreightPaymentMethodQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.FreightPaymentMethod.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> FreightPaymentMethodObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.FreightPaymentMethod").ToList();
	         ...
	         Screen FreightPaymentMethodCustomsFreightPaymentMethodHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "FreightPaymentMethod.HeaderScreen", Name = "Customs.FreightPaymentMethodHeaderScreen", ObjectTableId = FreightPaymentMethodObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
