   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ComputationMethodTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ComputationMethod.Q.ComputationMethod", DefaultText = @"Computation Method",LocalDefaultText = "שיטת חישוב", ObjectTableId = ComputationMethodObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ComputationMethodQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ComputationMethodQuery.Id,QueryCode = ComputationMethodQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ComputationMethod.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn ComputationMethodQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ComputationMethodQuery.Id,QueryCode = ComputationMethodQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ComputationMethod.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ComputationMethodQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ComputationMethodQuery.Id,QueryCode = ComputationMethodQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ComputationMethod.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ComputationMethodQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ComputationMethodQuery.Id,QueryCode = ComputationMethodQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ComputationMethod.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ComputationMethodObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ComputationMethod").ToList();
	         ...
	         Screen ComputationMethodCustomsComputationMethodHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ComputationMethod.HeaderScreen", Name = "Customs.ComputationMethodHeaderScreen", ObjectTableId = ComputationMethodObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
