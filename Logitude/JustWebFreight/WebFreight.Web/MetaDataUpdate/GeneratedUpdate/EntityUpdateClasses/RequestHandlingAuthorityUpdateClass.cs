...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "97c8bde444962c659da68fb16a594f3d";
	    ...
	    {   
		   ...
		   //List<ObjectField> RequestHandlingAuthorityObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.RequestHandlingAuthority").ToList();
	         ...
	         Screen RequestHandlingAuthorityCustomsRequestHandlingAuthorityHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "RequestHandlingAuthority.HeaderScreen", Name = "Customs.RequestHandlingAuthorityHeaderScreen", ObjectTableId = RequestHandlingAuthorityObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
