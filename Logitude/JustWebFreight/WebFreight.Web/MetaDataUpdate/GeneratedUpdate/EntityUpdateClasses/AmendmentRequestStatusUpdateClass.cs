...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "ac859305527b3661ba52be00e1690ff5";
	    ...
	    {  
	        ...
	        QueryGroup AmendmentRequestStatusQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "ARQG", Name = "Customs.AmendmentRequestStatus" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup AmendmentRequestStatusQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "05e6", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
