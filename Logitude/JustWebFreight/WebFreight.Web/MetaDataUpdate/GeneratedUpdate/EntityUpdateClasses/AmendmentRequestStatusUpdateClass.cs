...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "a07e11525ecd26aedb501b5393d0c769";
	    ...
	    {   
		   ...
		   //List<ObjectField> AmendmentRequestStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AmendmentRequestStatus").ToList();
	         ...
	         Screen AmendmentRequestStatusCustomsAmendmentRequestStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AmendmentRequestStatus.HeaderScreen", Name = "Customs.AmendmentRequestStatusHeaderScreen", ObjectTableId = AmendmentRequestStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
