   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AccumalationStateObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AccumalationState").ToList();
	         ...
	         Screen AccumalationStateCustomsAccumalationStateHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AccumalationState.HeaderScreen", Name = "Customs.AccumalationStateHeaderScreen", ObjectTableId = AccumalationStateObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
