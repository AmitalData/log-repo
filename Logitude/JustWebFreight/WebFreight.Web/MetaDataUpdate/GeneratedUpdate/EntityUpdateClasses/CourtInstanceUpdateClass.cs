   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CourtInstanceTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CourtInstance.Q.CourtInstance", DefaultText = @"CourtInstanceQuery",LocalDefaultText = null, ObjectTableId = CourtInstanceObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query CourtInstanceQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CourtInstanceTextCode_0.Id, NameTextCodeCode = CourtInstanceTextCode_0.Code, ObjectTableName = "Customs.CourtInstance", Code = "CourtInstance",  QueryGroupCode = "269e", IndexOrder = 0, Tenant = 0, ObjectTableId = CourtInstanceObjectTable.Id, QuerySection = "Customs.CourtInstance", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CourtInstanceFeature_0.Id,FeatureUniqeCode= CourtInstanceFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CourtInstanceQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CourtInstanceQuery.Id,QueryCode = CourtInstanceQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CourtInstance.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn CourtInstanceQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CourtInstanceQuery.Id,QueryCode = CourtInstanceQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CourtInstance.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CourtInstanceQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CourtInstanceQuery.Id,QueryCode = CourtInstanceQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CourtInstance.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
