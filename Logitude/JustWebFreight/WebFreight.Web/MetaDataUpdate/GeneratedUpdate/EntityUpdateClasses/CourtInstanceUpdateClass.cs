...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "ed96c12dba931734ac6670ef3bc98370";
	    ...
	    {  
	        ...
	        QueryGroup CourtInstanceQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "269e", Name = "Customs.CourtInstance Query Group" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CourtInstanceQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "3218", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CourtInstanceObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CourtInstance").ToList();
	         ...
	         Screen CourtInstanceCustomsCourtInstanceHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CourtInstance.HeaderScreen", Name = "Customs.CourtInstanceHeaderScreen", ObjectTableId = CourtInstanceObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CourtInstanceObjectTable.HeaderScreenId = CourtInstanceCustomsCourtInstanceHeaderScreenScreen0.Id;
		    CourtInstanceObjectTable.HeaderScreenCode = CourtInstanceCustomsCourtInstanceHeaderScreenScreen0.Code;
