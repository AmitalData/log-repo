   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SiteLookupTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SiteLookup.Q.SiteLookupQuery", DefaultText = @"Site Lookups",LocalDefaultText = "אתר לתצוגה", ObjectTableId = SiteLookupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature SiteLookupFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SITELOOKUP", ObjectTableId = SiteLookupObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.SiteLookup.Features.SiteLookups", NameTextCodeDefaultText = "Site Lookups", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,SiteLookupObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query SiteLookupQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = SiteLookupTextCode_0.Id, NameTextCodeCode = SiteLookupTextCode_0.Code, ObjectTableName = "Customs.SiteLookup", Code = "SiteLookup",  QueryGroupCode = "SITL", IndexOrder = 0, Tenant = 0, ObjectTableId = SiteLookupObjectTable.Id, QuerySection = "Customs.SiteLookup", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = SiteLookupFeature_0.Id,FeatureUniqeCode= SiteLookupFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn SiteLookupQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteLookupQuery.Id,QueryCode = SiteLookupQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.SiteLookup.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SiteLookupQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteLookupQuery.Id,QueryCode = SiteLookupQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.SiteLookup.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SiteLookupQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteLookupQuery.Id,QueryCode = SiteLookupQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.SiteLookup.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SiteLookupQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteLookupQuery.Id,QueryCode = SiteLookupQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.SiteLookup.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> SiteLookupObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SiteLookup").ToList();
	         ...
	         Screen SiteLookupCustomsSiteLookupHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SiteLookup.HeaderScreen", Name = "Customs.SiteLookupHeaderScreen", ObjectTableId = SiteLookupObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
