   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode VendorStatusTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.VendorStatus.Q.VendorStatusQuery", DefaultText = @"Vendor Status",LocalDefaultText = "סטטוס ספק", ObjectTableId = VendorStatusObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature VendorStatusFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "VENDORSTATUS", ObjectTableId = VendorStatusObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.VendorStatus.Features.VendorStatus", NameTextCodeDefaultText = "Vendor Status", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,VendorStatusObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query VendorStatusQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = VendorStatusTextCode_0.Id, NameTextCodeCode = VendorStatusTextCode_0.Code, ObjectTableName = "Customs.VendorStatus", Code = "VendorStatus",  QueryGroupCode = "VSQG", IndexOrder = 0, Tenant = 0, ObjectTableId = VendorStatusObjectTable.Id, QuerySection = "Customs.VendorStatus", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = VendorStatusFeature_0.Id,FeatureUniqeCode= VendorStatusFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn VendorStatusQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VendorStatusQuery.Id,QueryCode = VendorStatusQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.VendorStatus.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn VendorStatusQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VendorStatusQuery.Id,QueryCode = VendorStatusQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.VendorStatus.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn VendorStatusQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VendorStatusQuery.Id,QueryCode = VendorStatusQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.VendorStatus.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn VendorStatusQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VendorStatusQuery.Id,QueryCode = VendorStatusQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.VendorStatus.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
