...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "5111e46820fe1a084faf020a1db5b621";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CustomsPartnersItem",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CustomsPartnersItemUpdateClass.HashString,
	    ...
	    {  
	        ...
	        QueryGroup CustomsPartnersItemQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "ITQG", Name = "Customs.CustomsPartnersItem" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CustomsPartnersItemQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "b010", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
				        queryGroupRepository.SubmitChanges();
	        ObjectTable CustomsPartnersItemObjectTable = objectTables.ContainsKey("Customs.CustomsPartnersItem") ? objectTables["Customs.CustomsPartnersItem"] : null;
            if (CustomsPartnersItemObjectTable == null)
            {
                IWebFreightContext objectContext = WebFreightContext.GetContext(0);  

                CustomsPartnersItemObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.CustomsPartnersItem" && d.Tenant == 0).FirstOrDefault();
            }
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomsPartnersItemTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomsPartnersItem.Q.ItemQuery", DefaultText = @"Customs Partners Items",LocalDefaultText = "טבלת פריטים", ObjectTableId = CustomsPartnersItemObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature CustomsPartnersItemFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomsPartnersItem.Q.CustomsPartnersItem", ObjectTableId = CustomsPartnersItemObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsPartnersItemFeatures.CustomsPartnersItem", NameTextCodeDefaultText = "CustomsPartnersItem", FeatureTypeCode = "QUER", Packagable = false }, TenantFeatures, textCodes,CustomsPartnersItemObjectTable, addedFeatures, addedTextCodes);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CustomsPartnersItemQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPartnersItemQuery.Id,QueryCode = CustomsPartnersItemQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomsPartnersItem.ClassificationCode" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CustomsPartnersItemQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPartnersItemQuery.Id,QueryCode = CustomsPartnersItemQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomsPartnersItem.ItemCode" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CustomsPartnersItemQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPartnersItemQuery.Id,QueryCode = CustomsPartnersItemQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomsPartnersItem.Name" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CustomsPartnersItemQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPartnersItemQuery.Id,QueryCode = CustomsPartnersItemQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomsPartnersItem.CustomerName" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CustomsPartnersItemQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPartnersItemQuery.Id,QueryCode = CustomsPartnersItemQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.CustomsPartnersItem.VendorName" , ColumnWidth = 130 }, addedQueryColumns);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsPartnersItemObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsPartnersItem").ToList();
	         ...
	         Screen CustomsPartnersItemHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Customs.CustomsPartnersItem.HeaderScreen", Name = "Header Screen", ObjectTableId = CustomsPartnersItemObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomsPartnersItemHeaderScreenScreen0.Id,ScreenCode = CustomsPartnersItemHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.ItemCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	          
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CustomsPartnersItemHeaderScreenScreen0.Id,ScreenCode = CustomsPartnersItemHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.Name", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
		    ...
		    CustomsPartnersItemObjectTable.HeaderScreenCode = CustomsPartnersItemHeaderScreenScreen0.Code;
	         ...
	         Screen CustomsPartnersItemGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Customs.CustomsPartnersItem.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = CustomsPartnersItemObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens);
      
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomsPartnersItemGeneralTabScreenScreen1.Id,ScreenCode = CustomsPartnersItemGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.ItemCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	          
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomsPartnersItemGeneralTabScreenScreen1.Id,ScreenCode = CustomsPartnersItemGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.ClassificationCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	          
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CustomsPartnersItemGeneralTabScreenScreen1.Id,ScreenCode = CustomsPartnersItemGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.Name", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	          
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CustomsPartnersItemGeneralTabScreenScreen1.Id,ScreenCode = CustomsPartnersItemGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.VendorId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	          
             ScreenField CustomsCustomsPartnersItemCustomsCustomsPartnersItemGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CustomsPartnersItemGeneralTabScreenScreen1.Id,ScreenCode = CustomsPartnersItemGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsPartnersItem.CustomerId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CITE",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = CustomsPartnersItemEventsFeature_TH1.Id,FeatureUniqeCode = CustomsPartnersItemEventsFeature_TH1.FeatureUniqeCode, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = CustomsPartnersItemObjectTable.Id, TabNameTextCodeId = CustomsPartnersItemEventsTextCode_TH1.Id, TabNameTextCodeCode = CustomsPartnersItemEventsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
