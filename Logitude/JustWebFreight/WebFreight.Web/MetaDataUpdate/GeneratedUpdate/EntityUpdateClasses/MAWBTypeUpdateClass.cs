   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> MAWBTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.MAWBType").ToList();
	         ...
	         Screen MAWBTypeCustomsMAWBTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "MAWBType.HeaderScreen", Name = "Customs.MAWBTypeHeaderScreen", ObjectTableId = MAWBTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
