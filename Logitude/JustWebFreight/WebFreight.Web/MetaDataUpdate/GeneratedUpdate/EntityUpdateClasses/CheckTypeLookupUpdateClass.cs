   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CheckTypeLookupTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CheckTypeLookup.Q.CheckTypeLookupQuery", DefaultText = @"CheckTypeLookup",LocalDefaultText = "סוג בדיקה", ObjectTableId = CheckTypeLookupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query CheckTypeLookupQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CheckTypeLookupTextCode_0.Id, NameTextCodeCode = CheckTypeLookupTextCode_0.Code, ObjectTableName = "Customs.CheckTypeLookup", Code = "CheckTypeLookup",  QueryGroupCode = "CLQG", IndexOrder = 0, Tenant = 0, ObjectTableId = CheckTypeLookupObjectTable.Id, QuerySection = "Customs.CheckTypeLookup", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CheckTypeLookupFeature_0.Id,FeatureUniqeCode= CheckTypeLookupFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CheckTypeLookupQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckTypeLookupQuery.Id,QueryCode = CheckTypeLookupQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CheckTypeLookup.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CheckTypeLookupQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckTypeLookupQuery.Id,QueryCode = CheckTypeLookupQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CheckTypeLookup.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CheckTypeLookupQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckTypeLookupQuery.Id,QueryCode = CheckTypeLookupQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CheckTypeLookup.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CheckTypeLookupQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckTypeLookupQuery.Id,QueryCode = CheckTypeLookupQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CheckTypeLookup.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
