   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ContinuousRequestTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ContinuousRequestType.Q.ContinuousRequestType", DefaultText = @"ContinuousRequestTypeQuery",LocalDefaultText = null, ObjectTableId = ContinuousRequestTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ContinuousRequestTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ContinuousRequestType").ToList();
	         ...
	         Screen ContinuousRequestTypeCustomsContinuousRequestTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ContinuousRequestType.HeaderScreen", Name = "Customs.ContinuousRequestTypeHeaderScreen", ObjectTableId = ContinuousRequestTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
