...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "989d62e1e65ce70ad8c99822ae30a28f";
	    ...
	    {   
		   ...
		   //List<ObjectField> InterestTransactionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "InterestTransaction").ToList();
	         ...
	         Screen InterestTransactionInterestTransactionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "InterestTransaction.HeaderScreen", Name = "InterestTransactionHeaderScreen", ObjectTableId = InterestTransactionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode InterestTransactionTextCode_InterestTransactionOTotalLocalAmount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "InterestTransaction.O.TotalLocalAmount", DefaultText = "Total",LocalDefaultText = @"סה''כ", ObjectTableId = InterestTransactionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode InterestTransactionTextCode_InterestTransactionsCSVOLine = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "InterestTransactionsCSV.O.Line", DefaultText = "Line",LocalDefaultText = @"שורה", ObjectTableId = InterestTransactionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode InterestTransactionTextCode_InterestTransactionsCSVOJExternalNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "InterestTransactionsCSV.O.JExternalNumber", DefaultText = "External Journal Number",LocalDefaultText = @"מספר פקודת יומן חיצוני", ObjectTableId = InterestTransactionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode InterestTransactionTextCode_InterestTransactionsCSVOJournal = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "InterestTransactionsCSV.O.Journal", DefaultText = "Journal",LocalDefaultText = @"פקודת יומן", ObjectTableId = InterestTransactionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode InterestTransactionTextCode_InterestTransactionsCSVOJournalLine = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "InterestTransactionsCSV.O.JournalLine", DefaultText = "Journal Line",LocalDefaultText = @"שורת פקודת יומן", ObjectTableId = InterestTransactionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode InterestTransactionTextCode_InterestTransactionsCSVOTransactionLine = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "InterestTransactionsCSV.O.TransactionLine", DefaultText = "Transaction Line",LocalDefaultText = @"שורת תנועת ריבית", ObjectTableId = InterestTransactionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
