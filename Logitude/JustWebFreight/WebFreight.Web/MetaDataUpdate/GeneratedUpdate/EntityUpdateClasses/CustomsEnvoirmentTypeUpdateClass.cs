   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsEnvoirmentTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsEnvoirmentType").ToList();
	         ...
	         Screen CustomsEnvoirmentTypeCustomsCustomsEnvoirmentTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsEnvoirmentType.HeaderScreen", Name = "Customs.CustomsEnvoirmentTypeHeaderScreen", ObjectTableId = CustomsEnvoirmentTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
