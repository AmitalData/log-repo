   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> PhysicalCheckStatusMessageObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PhysicalCheckStatusMessage").ToList();
	         ...
	         Screen PhysicalCheckStatusMessageCustomsPhysicalCheckStatusMessageHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PhysicalCheckStatusMessage.HeaderScreen", Name = "Customs.PhysicalCheckStatusMessageHeaderScreen", ObjectTableId = PhysicalCheckStatusMessageObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
