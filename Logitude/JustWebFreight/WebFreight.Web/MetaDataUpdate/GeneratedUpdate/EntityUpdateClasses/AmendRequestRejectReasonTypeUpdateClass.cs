...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.AmendRequestRejectReasonType",
			      				    IsNew =  true,
			      				    DBTableName =  "Customs.AmendRequestRejectReasonTypes",
			      				    ObjectTableSingular =  "Customs.AmendRequestRejectReasonType",
			      				    ObjectTablePlural =  "Customs.AmendRequestRejectReasonTypes",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  AmendRequestRejectReasonTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.AmendRequestRejectReasonType",
					  						IsRestrictable =  false,
	    ...
	    {  
            ...
            if (AmendRequestRejectReasonTypeObjectTable == null)
            {
                IWebFreightContext objectContext = WebFreightContext.GetContext(0);  

                AmendRequestRejectReasonTypeObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.AmendRequestRejectReasonType" && d.Tenant == 0).FirstOrDefault();
            }
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AmendRequestRejectReasonTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AmendRequestRejectReasonType.Q.AmendRequestRejectReasonType", DefaultText = @"Amendment Request Reject Reason Type",LocalDefaultText = "סיבות דחיה לתיקון הצהרה", ObjectTableId = AmendRequestRejectReasonTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature AmendRequestRejectReasonTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AmendRequestRejectReasonType.Q.AmendRequestRejectReasonType", ObjectTableId = AmendRequestRejectReasonTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "AmendRequestRejectReasonTypeFeatures.AmendRequestRejectReasonType", NameTextCodeDefaultText = "AmendRequestRejectReasonType", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,AmendRequestRejectReasonTypeObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = AmendRequestRejectReasonTypeObjectTable.Id,
