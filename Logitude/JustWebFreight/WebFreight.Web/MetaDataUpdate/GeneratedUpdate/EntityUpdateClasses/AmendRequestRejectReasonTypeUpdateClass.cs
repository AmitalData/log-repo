   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AmendRequestRejectReasonTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AmendRequestRejectReasonType").ToList();
	         ...
	         Screen AmendRequestRejectReasonTypeCustomsAmendRequestRejectReasonTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AmendRequestRejectReasonType.HeaderScreen", Name = "Customs.AmendRequestRejectReasonTypeHeaderScreen", ObjectTableId = AmendRequestRejectReasonTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
