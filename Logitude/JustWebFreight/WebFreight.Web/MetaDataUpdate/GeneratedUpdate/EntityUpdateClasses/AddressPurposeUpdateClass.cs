   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AddressPurposeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.AddressPurpose.Q.AddressPurposeQuery", DefaultText = @"Address Purposes",LocalDefaultText = "מטרת כתובת", ObjectTableId = AddressPurposeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AddressPurposeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AddressPurposeQuery.Id,QueryCode = AddressPurposeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.AddressPurpose.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AddressPurposeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AddressPurposeQuery.Id,QueryCode = AddressPurposeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.AddressPurpose.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AddressPurposeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AddressPurposeQuery.Id,QueryCode = AddressPurposeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.AddressPurpose.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AddressPurposeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AddressPurposeQuery.Id,QueryCode = AddressPurposeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.AddressPurpose.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> AddressPurposeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AddressPurpose").ToList();
	         ...
	         Screen AddressPurposeCustomsAddressPurposeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AddressPurpose.HeaderScreen", Name = "Customs.AddressPurposeHeaderScreen", ObjectTableId = AddressPurposeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
