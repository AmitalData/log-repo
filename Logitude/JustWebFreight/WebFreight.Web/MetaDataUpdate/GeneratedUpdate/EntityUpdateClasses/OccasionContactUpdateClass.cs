...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
    public class OccasionContactUpdateClass
    {
        ...
        public void AddTableQueries(Dictionary<string, Query> tenantQueries, Dictionary<string, QueryColumn> tenantQueryColumns, Dictionary<string, TextCode> textCodes, QueryGroupRepository queryGroupRepository, QueryRepository queriesRepository, QueryColumnRepository queryColumnsRepository, TextCodeRepository TextCodeRepository, FeatureRepository FeaturesRepository, Dictionary<string, Feature> TenantFeatures, AdvancedQueryFilterRepository advancedQueryFiltersRepository, Dictionary<string, AdvancedQueryFilter> tenantAdvancedFilters)
        {
            ...
            QueryColumn OCCASIONCONTACTSQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OCCASIONCONTACTSQuery.Id, IndexOrder = 4, ObjectFieldId = OccasionContactObjectFields.Where(d => d.FieldName == "Customers" && d.ObjectTableId == OccasionContactObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
            QueryColumn OCCASIONCONTACTSQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OCCASIONCONTACTSQuery.Id, IndexOrder = 5, ObjectFieldId = OccasionContactObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == OccasionContactObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
            QueryColumn OCCASIONCONTACTSQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OCCASIONCONTACTSQuery.Id, IndexOrder = 6, ObjectFieldId = OccasionContactObjectFields.Where(d => d.FieldName == "Invited" && d.ObjectTableId == OccasionContactObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
            QueryColumn OCCASIONCONTACTSQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OCCASIONCONTACTSQuery.Id, IndexOrder = 7, ObjectFieldId = OccasionContactObjectFields.Where(d => d.FieldName == "Participated" && d.ObjectTableId == OccasionContactObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
        }
