   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DeclarationStatusTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DeclarationStatusType").ToList();
	         ...
	         Screen DeclarationStatusTypeCustomsDeclarationStatusTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DeclarationStatusType.HeaderScreen", Name = "Customs.DeclarationStatusTypeHeaderScreen", ObjectTableId = DeclarationStatusTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
