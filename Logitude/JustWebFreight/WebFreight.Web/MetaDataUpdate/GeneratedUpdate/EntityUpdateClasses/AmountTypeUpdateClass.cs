...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {  
	        ...
	        QueryGroup AmountTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "c984", Name = "Customs.CustomerRoleType Query Group" }, queryGroupRepository);
	        ...
	        List<ObjectField> AmountTypeObjectFields = objectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AmountType").ToList();   
			   ...
			   TextCode AmountTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AmountType.Q.AmountType", DefaultText = "Amount Types",LocalDefaultText = "קודי סוג מחיר", ObjectTableId = AmountTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, TextCodeRepository, textCodes);
			   Feature AmountTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AmountType.Q.AmountType", ObjectTableId = AmountTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "AmountType.Features.AmountType", NameTextCodeDefaultText = "AmountType", FeatureTypeCode = "QUER", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes);

	        TextCodeRepository.SubmitChanges();
	        FeaturesRepository.SubmitChanges();    
	      

			  Query AmountTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AmountTypeTextCode_0.Id, Code = "AmountType",  QueryGroupCode = "c984", IndexOrder = 0, Tenant = 0, ObjectTableId = AmountTypeObjectTable.Id, QuerySection = "Customs.AmountType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AmountTypeFeature_0.Id, DefaultSortName = "LocalName", DefaultSortDirection = "Ascending" }, queriesRepository, tenantQueries);
