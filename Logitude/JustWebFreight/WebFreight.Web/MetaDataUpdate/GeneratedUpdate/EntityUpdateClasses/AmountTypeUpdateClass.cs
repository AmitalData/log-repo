   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AmountTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AmountType.Q.AmountType", DefaultText = @"Amount Types",LocalDefaultText = "קודי סוג מחיר", ObjectTableId = AmountTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature AmountTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AmountType.Q.AmountType", ObjectTableId = AmountTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "AmountTypeFeatures.AmountType", NameTextCodeDefaultText = "AmountType", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,AmountTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AmountTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AmountTypeQuery.Id,QueryCode = AmountTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.AmountType.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AmountTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AmountTypeQuery.Id,QueryCode = AmountTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.AmountType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AmountTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AmountTypeQuery.Id,QueryCode = AmountTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.AmountType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AmountTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AmountTypeQuery.Id,QueryCode = AmountTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.AmountType.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> AmountTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AmountType").ToList();
	         ...
	         Screen AmountTypeCustomsAmountTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AmountType.HeaderScreen", Name = "Customs.AmountTypeHeaderScreen", ObjectTableId = AmountTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
