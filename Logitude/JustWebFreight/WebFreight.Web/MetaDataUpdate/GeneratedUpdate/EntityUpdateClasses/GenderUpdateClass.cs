   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode GenderTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Gender.Q.GenderQuery", DefaultText = @"Gender",LocalDefaultText = "מין", ObjectTableId = GenderObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature GenderFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENDER", ObjectTableId = GenderObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.Gender.Features.Genders", NameTextCodeDefaultText = "Gender", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,GenderObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn GenderQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GenderQuery.Id,QueryCode = GenderQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.Gender.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn GenderQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GenderQuery.Id,QueryCode = GenderQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.Gender.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn GenderQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GenderQuery.Id,QueryCode = GenderQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.Gender.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn GenderQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GenderQuery.Id,QueryCode = GenderQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.Gender.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> GenderObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.Gender").ToList();
	         ...
	         Screen GenderCustomsGenderHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Gender.HeaderScreen", Name = "Customs.GenderHeaderScreen", ObjectTableId = GenderObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
