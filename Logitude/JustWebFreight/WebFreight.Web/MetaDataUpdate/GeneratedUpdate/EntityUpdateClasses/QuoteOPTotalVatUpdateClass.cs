...
{
   public class QuoteOPTotalVATUpdateClass
   {  		
		public const string HashString = "823b2127dd9ae07204450e4a42ced4a4";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuoteOPTotalVAT",
			      				    IsNew =  false,
			      				    DBTableName =  "QuoteOPTotalVATs",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "QuoteOPTotalVAT,QuoteOPTotalVATs,,Id,",
			      				    HashString =  QuoteOPTotalVATUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "QuoteCurrencyVATAmount",
					  						...
					  						ValidForQuerySection1 =  "QuoteOPTotalVAT",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "VatOPTypeId",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "VatOPTypeId",
					  						ListPropertyPath =  "VatOPTypeId",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
	    ...
	    {   
		   ...
		   ObjectTable QuoteOPTotalVATObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "QuoteOPTotalVAT" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> QuoteOPTotalVATObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "QuoteOPTotalVAT").ToList();
		       
	      

	         Screen QuoteOPTotalVATQuoteOPTotalVATHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "QuoteOPTotalVAT.HeaderScreen", Name = "QuoteOPTotalVATHeaderScreen", ObjectTableId = QuoteOPTotalVATObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    QuoteOPTotalVATObjectTable.HeaderScreenId = QuoteOPTotalVATQuoteOPTotalVATHeaderScreenScreen0.Id;
		    QuoteOPTotalVATObjectTable.HeaderScreenCode = QuoteOPTotalVATQuoteOPTotalVATHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = QuoteOPTotalVATObjectTable.Id,
