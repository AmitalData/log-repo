   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CourierManifestStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CourierManifestStatus").ToList();
	         ...
	         Screen CourierManifestStatusCustomsCourierManifestStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CourierManifestStatus.HeaderScreen", Name = "Customs.CourierManifestStatusHeaderScreen", ObjectTableId = CourierManifestStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
