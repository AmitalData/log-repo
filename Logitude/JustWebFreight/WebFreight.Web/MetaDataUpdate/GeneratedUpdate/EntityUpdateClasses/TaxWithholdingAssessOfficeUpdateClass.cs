   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ALLTAXOFFICESQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id,QueryCode = ALLTAXOFFICESQuery.Code, IndexOrder = 0, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTAXOFFICESQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id,QueryCode = ALLTAXOFFICESQuery.Code, IndexOrder = 1, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTAXOFFICESQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id,QueryCode = ALLTAXOFFICESQuery.Code, IndexOrder = 2, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTAXOFFICESQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id,QueryCode = ALLTAXOFFICESQuery.Code, IndexOrder = 3, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
