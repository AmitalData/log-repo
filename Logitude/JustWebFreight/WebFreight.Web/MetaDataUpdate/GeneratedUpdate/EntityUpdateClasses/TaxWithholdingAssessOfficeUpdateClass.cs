   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ALLTAXOFFICESQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id, IndexOrder = 1, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTAXOFFICESQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id, IndexOrder = 2, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTAXOFFICESQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTAXOFFICESQuery.Id, IndexOrder = 3, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == TaxWithholdingAssessOfficeObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> TaxWithholdingAssessOfficeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "TaxWithholdingAssessOffice").ToList();
            ...
            ScreenField TaxWithholdingAssessOfficeTaxWithholdingAssessOfficeGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = TaxWithholdingAssessOfficeGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField TaxWithholdingAssessOfficeTaxWithholdingAssessOfficeGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = TaxWithholdingAssessOfficeGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField TaxWithholdingAssessOfficeTaxWithholdingAssessOfficeGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = TaxWithholdingAssessOfficeObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().Id, ScreenId = TaxWithholdingAssessOfficeGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
