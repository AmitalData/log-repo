   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode LoadingSiteTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "LoadingSiteType.Q.LoadingSiteTypes", DefaultText = @"Loading Site Types",LocalDefaultText = "אתרי טעינה", ObjectTableId = LoadingSiteTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature LoadingSiteTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "LoadingSiteType.Q.LoadingSiteTypes", ObjectTableId = LoadingSiteTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "LoadingSiteTypeFeatures.LoadingSiteTypes", NameTextCodeDefaultText = "LoadingSiteTypes", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,LoadingSiteTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn LoadingSiteTypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = LoadingSiteTypesQuery.Id,QueryCode = LoadingSiteTypesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.LoadingSiteType.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn LoadingSiteTypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = LoadingSiteTypesQuery.Id,QueryCode = LoadingSiteTypesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.LoadingSiteType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn LoadingSiteTypesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = LoadingSiteTypesQuery.Id,QueryCode = LoadingSiteTypesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.LoadingSiteType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn LoadingSiteTypesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = LoadingSiteTypesQuery.Id,QueryCode = LoadingSiteTypesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.LoadingSiteType.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> LoadingSiteTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.LoadingSiteType").ToList();
	         ...
	         Screen LoadingSiteTypeCustomsLoadingSiteTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "LoadingSiteType.HeaderScreen", Name = "Customs.LoadingSiteTypeHeaderScreen", ObjectTableId = LoadingSiteTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
