...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CancellationRequestStatus",
			      				    IsNew =  true,
			      				    DBTableName =  "Customs.CancellationRequestStatuses",
			      				    ObjectTableSingular =  "Customs.CancellationRequestStatus",
			      				    ObjectTablePlural =  "Customs.CancellationRequestStatuses",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CancellationRequestStatusUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CancellationRequestStatus",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   ObjectTable CancellationRequestStatusObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "Customs.CancellationRequestStatus" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> CancellationRequestStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CancellationRequestStatus").ToList();
		       
	      

	         Screen CancellationRequestStatusCustomsCancellationRequestStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CancellationRequestStatus.HeaderScreen", Name = "Customs.CancellationRequestStatusHeaderScreen", ObjectTableId = CancellationRequestStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CancellationRequestStatusObjectTable.HeaderScreenId = CancellationRequestStatusCustomsCancellationRequestStatusHeaderScreenScreen0.Id;
		    CancellationRequestStatusObjectTable.HeaderScreenCode = CancellationRequestStatusCustomsCancellationRequestStatusHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CancellationRequestStatusObjectTable.Id,
