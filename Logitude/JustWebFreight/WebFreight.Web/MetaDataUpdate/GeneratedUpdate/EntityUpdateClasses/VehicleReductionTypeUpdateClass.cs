   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> VehicleReductionTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.VehicleReductionType").ToList();
	         ...
	         Screen VehicleReductionTypeCustomsVehicleReductionTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "VehicleReductionType.HeaderScreen", Name = "Customs.VehicleReductionTypeHeaderScreen", ObjectTableId = VehicleReductionTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
