...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    {  
	        ...
	        QueryGroup SealCompletenesQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "bc45", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup SealCompletenesQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "d052", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SealCompletenesTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "SealCompletenes.Q.SealCompletenes", DefaultText = @"SealCompletenesQuery",LocalDefaultText = null, ObjectTableId = SealCompletenesObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature SealCompletenesFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SealCompletenes.Q.SealCompletenes", ObjectTableId = SealCompletenesObjectTable.Id, Tenant = 0, NameTextCodeCode = "SealCompletenes.Features.SealCompletenes", NameTextCodeDefaultText = "SealCompletenes", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,SealCompletenesObjectTable, addedFeatures, addedTextCodes);
