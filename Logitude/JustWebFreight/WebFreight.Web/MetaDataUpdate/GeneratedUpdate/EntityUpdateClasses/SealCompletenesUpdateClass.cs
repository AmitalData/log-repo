   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SealCompletenesTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "SealCompletenes.Q.SealCompletenes", DefaultText = @"SealCompletenesQuery",LocalDefaultText = null, ObjectTableId = SealCompletenesObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query SealCompletenesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = SealCompletenesTextCode_0.Id, NameTextCodeCode = SealCompletenesTextCode_0.Code, ObjectTableName = "Customs.SealCompletenes", Code = "SealCompletenes",  QueryGroupCode = "bc45", IndexOrder = 0, Tenant = 0, ObjectTableId = SealCompletenesObjectTable.Id, QuerySection = "Customs.SealCompletenes", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = SealCompletenesFeature_0.Id,FeatureUniqeCode= SealCompletenesFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn SealCompletenesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealCompletenesQuery.Id,QueryCode = SealCompletenesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.SealCompletenes.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn SealCompletenesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealCompletenesQuery.Id,QueryCode = SealCompletenesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.SealCompletenes.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SealCompletenesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealCompletenesQuery.Id,QueryCode = SealCompletenesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.SealCompletenes.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SealCompletenesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SealCompletenesQuery.Id,QueryCode = SealCompletenesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.SealCompletenes.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
