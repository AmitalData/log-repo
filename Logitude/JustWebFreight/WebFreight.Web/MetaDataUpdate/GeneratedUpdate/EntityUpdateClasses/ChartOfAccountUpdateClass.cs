   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ChartofAccountsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChartofAccountsQuery.Id,QueryCode = ChartofAccountsQuery.Code, IndexOrder = 0, ObjectFieldId = ChartOfAccountObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ChartOfAccountObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 80 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ChartofAccountsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChartofAccountsQuery.Id,QueryCode = ChartofAccountsQuery.Code, IndexOrder = 1, ObjectFieldId = ChartOfAccountObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ChartOfAccountObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 160 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ChartofAccountsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChartofAccountsQuery.Id,QueryCode = ChartofAccountsQuery.Code, IndexOrder = 2, ObjectFieldId = ChartOfAccountObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ChartOfAccountObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 160 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ChartofAccountsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChartofAccountsQuery.Id,QueryCode = ChartofAccountsQuery.Code, IndexOrder = 3, ObjectFieldId = ChartOfAccountObjectFields.Where(d => d.FieldName == "ParentName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ChartOfAccountObjectFields.Where(d => d.FieldName == "ParentName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 160 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ChartofAccountsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChartofAccountsQuery.Id,QueryCode = ChartofAccountsQuery.Code, IndexOrder = 4, ObjectFieldId = ChartOfAccountObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ChartOfAccountObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 160 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ChartofAccountsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChartofAccountsQuery.Id,QueryCode = ChartofAccountsQuery.Code, IndexOrder = 5, ObjectFieldId = ChartOfAccountObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ChartOfAccountObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == ChartOfAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 60 }, queryColumnsRepository, tenantQueryColumns);
