...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "5433df90393d216b9b7d69724e51042c";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "TMDayOffType",
			      				    IsNew =  true,
			      				    DBTableName =  "TMDayOffTypes",
			      				    ObjectTableSingular =  "TMDayOffType",
			      				    ObjectTablePlural =  "TMDayOffTypes",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  TMDayOffTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "TMDayOffType",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   ObjectTable TMDayOffTypeObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "TMDayOffType" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> TMDayOffTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "TMDayOffType").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = TMDayOffTypeObjectTable.Id,
	    ...
	    public void FillTMDayOffType()
        { 
            var repo = new TMDayOffTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                TMDayOffType,
                                TMDayOffTypeDetails,
                                TMDayOffTypeRepository>(repo, dic);
        }
