   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn allcategories5QueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories5Query.Id,QueryCode = allcategories5Query.Code, IndexOrder = 0, ObjectFieldId = Category5ObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == Category5ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category5ObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == Category5ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories5QueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories5Query.Id,QueryCode = allcategories5Query.Code, IndexOrder = 1, ObjectFieldId = Category5ObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == Category5ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category5ObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == Category5ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories5QueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories5Query.Id,QueryCode = allcategories5Query.Code, IndexOrder = 2, ObjectFieldId = Category5ObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == Category5ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category5ObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == Category5ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
