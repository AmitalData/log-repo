   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DecCargoSplitCargoIdentifierObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DecCargoSplitCargoIdentifier").ToList();
	         ...
	         Screen DecCargoSplitCargoIdentifierCustomsDecCargoSplitCargoIdentifierHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DecCargoSplitCargoIdentifier.HeaderScreen", Name = "Customs.DecCargoSplitCargoIdentifierHeaderScreen", ObjectTableId = DecCargoSplitCargoIdentifierObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
