...
{
   public class ReconcileExternalPageLineUpdateClass
   {  		
		public const string HashString = "6f56691fe62e1653eead88914014ef81";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ReconcileExternalPageLine",
			      				    IsNew =  false,
			      				    DBTableName =  "ReconcileExternalPageLines",
			      				    OldDBTableName =  "ReconcileExternalPageLines",
			      				    ObjectTableSingular =  "Reconcile External Page Line",
			      				    ObjectTablePlural =  "Reconcile External Page Lines",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ReconcileExternalPageLineUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ReconcileExternalPageId",
					  						OldFieldName =  "ReconcileExternalPageId",
					  						ObjectTableName =  "ReconcileExternalPageLine",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  15,
					  						...
					  						PMPropertyPath =  "ReconcileExternalPageId",
					  						ListPropertyPath =  "ReconcileExternalPageId",
					  						...
					  						ValidForQuerySection1 =  "ReconcileExternalPageLine",
					  						IsRestrictable =  false,
					  						...
					  						FullFieldLable =  "ReconcileExternalPageId",
					  						DefaultText =  "Reconcile External Page Id",
					  						FullLocalDefaultText =  "מזהה התאמה",
					  						ListFieldLable =  "ReconcileExternalPageIdListLable",
					  						ListLableDefaultText =  "Reconciliation Id",
					  						IsForeignKey =  true,
					  						ForeignEntity =  "ReconcileExternalPage",
					  						NavigationPropertyName =  "ReconcileExternalPage",
					  						IsMaxLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DebitAmount",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "DebitAmount",
					  						ListPropertyPath =  "DebitAmount",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "DebitAmount",
					  						DefaultText =  "Debit Amount",
					  						FullLocalDefaultText =  "סכום חובה",
					  						ListFieldLable =  "DebitAmountListLable",
					  						ListLableDefaultText =  "Debit Amount",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						DefaultText =  "Referene, Remarks",
					  						ListFieldLable =  "SearchFieldsListLable",
					  						ListLableDefaultText =  "Referene, Remarks",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "GroupHash",
					  						...
					  						DefaultText =  "Group Hash",
					  						ListFieldLable =  "GroupHashListLable",
					  						ListLableDefaultText =  "Group Hash",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ReconciliationNumber",
					  						...
					  						DefaultText =  "Reconciliation Number",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CreditAmount",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "CreditAmount",
					  						ListPropertyPath =  "CreditAmount",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "CreditAmount",
					  						DefaultText =  "Credit Amount",
					  						FullLocalDefaultText =  "סכום זכות",
					  						ListFieldLable =  "CreditAmountListLable",
					  						ListLableDefaultText =  "Credit Amount",
					  						ListLocalDefaultText =  "סכום זכות",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ReconcileExternalPageLineObjectTable.Id,
