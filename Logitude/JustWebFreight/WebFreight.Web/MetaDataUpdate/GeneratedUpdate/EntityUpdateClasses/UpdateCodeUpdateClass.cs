   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode UpdateCodeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UpdateCode.Q.UpdateCode", DefaultText = @"UpdateCodeQuery",LocalDefaultText = "עדכון בקשת העברה", ObjectTableId = UpdateCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature UpdateCodeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UpdateCode.Q.UpdateCode", ObjectTableId = UpdateCodeObjectTable.Id, Tenant = 0, NameTextCodeCode = "UpdateCode.Features.UpdateCode", NameTextCodeDefaultText = "UpdateCode", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,UpdateCodeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query UpdateCodeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = UpdateCodeTextCode_0.Id, NameTextCodeCode = UpdateCodeTextCode_0.Code, ObjectTableName = "Customs.UpdateCode", Code = "UpdateCode",  QueryGroupCode = "c8e2", IndexOrder = 0, Tenant = 0, ObjectTableId = UpdateCodeObjectTable.Id, QuerySection = "Customs.UpdateCode", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = UpdateCodeFeature_0.Id,FeatureUniqeCode= UpdateCodeFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn UpdateCodeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UpdateCodeQuery.Id,QueryCode = UpdateCodeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.UpdateCode.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn UpdateCodeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UpdateCodeQuery.Id,QueryCode = UpdateCodeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.UpdateCode.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn UpdateCodeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UpdateCodeQuery.Id,QueryCode = UpdateCodeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.UpdateCode.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn UpdateCodeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UpdateCodeQuery.Id,QueryCode = UpdateCodeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.UpdateCode.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
