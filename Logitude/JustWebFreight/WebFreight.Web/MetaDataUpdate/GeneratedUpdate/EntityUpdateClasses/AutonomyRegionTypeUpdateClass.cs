   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AutonomyRegionTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.AutonomyRegionType.Q.AutonomyRegionTypeQuery", DefaultText = @"Autonomy Region Types",LocalDefaultText = "סוגי אזור אוטונומיה", ObjectTableId = AutonomyRegionTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature AutonomyRegionTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AutonomyRegionType", ObjectTableId = AutonomyRegionTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.AutonomyRegionType.Features.AutonomyRegionTypes", NameTextCodeDefaultText = "Autonomy Region Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,AutonomyRegionTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query AutonomyRegionTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AutonomyRegionTypeTextCode_0.Id, NameTextCodeCode = AutonomyRegionTypeTextCode_0.Code, ObjectTableName = "Customs.AutonomyRegionType", Code = "AutonomyRegionType",  QueryGroupCode = "AUTT", IndexOrder = 0, Tenant = 0, ObjectTableId = AutonomyRegionTypeObjectTable.Id, QuerySection = "Customs.AutonomyRegionType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AutonomyRegionTypeFeature_0.Id,FeatureUniqeCode= AutonomyRegionTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AutonomyRegionTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AutonomyRegionTypeQuery.Id,QueryCode = AutonomyRegionTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.AutonomyRegionType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AutonomyRegionTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AutonomyRegionTypeQuery.Id,QueryCode = AutonomyRegionTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.AutonomyRegionType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AutonomyRegionTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AutonomyRegionTypeQuery.Id,QueryCode = AutonomyRegionTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.AutonomyRegionType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AutonomyRegionTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AutonomyRegionTypeQuery.Id,QueryCode = AutonomyRegionTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.AutonomyRegionType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
