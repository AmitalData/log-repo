...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "554bb9697919cf38e68c230deb7d7149";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.DeclarationPayment",
			      				    ...
			      				    OldDBTableName =  "Customs.DeclarationPayments",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  DeclarationPaymentUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SignatoryIdentification",
					  						OldFieldName =  "SignatoryIdentification",
					  						ObjectTableName =  "Customs.DeclarationPayment",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  17,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ProcessADescription",
					  						OldFieldName =  "ProcessADescription",
					  						ObjectTableName =  "Customs.DeclarationPayment",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DeclarationPaymentProtests",
					  						OldFieldName =  "DeclarationPaymentProtests",
					  						ObjectTableName =  "Customs.DeclarationPayment",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DeclarationPaymentMethods",
					  						OldFieldName =  "DeclarationPaymentMethods",
					  						ObjectTableName =  "Customs.DeclarationPayment",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PaymentMethodLastLineNumber",
					  						OldFieldName =  "PaymentMethodLastLineNumber",
					  						ObjectTableName =  "Customs.DeclarationPayment",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PaymentProtestLastLineNumber",
					  						OldFieldName =  "PaymentProtestLastLineNumber",
					  						ObjectTableName =  "Customs.DeclarationPayment",
					  						FieldsDataType =  "Integer",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CustomsAgentExplanationDefault",
					  						OldFieldName =  "CustomsAgentExplanationDefault",
					  						ObjectTableName =  "Customs.DeclarationPayment",
					  						FieldsDataType =  "nText",
					  						MinLength =  0,
					  						MaxLength =  512,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "FuturePaymentDateTime",
					  						OldFieldName =  "FuturePaymentDateTime",
					  						ObjectTableName =  "Customs.DeclarationPayment",
					  						FieldsDataType =  "DateTime",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AutomaticPayment",
					  						...
					  						FullLocalDefaultText =  "תשלום בזמינות",
					  						ListFieldLable =  "AutomaticPaymentListLable",
					  						ListLableDefaultText =  "Automatic Payment",
					  						ListLocalDefaultText =  "תשלום בזמינות",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
	    ...
	    {  
		   ...
		   Feature DeclarationPaymentFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = true, ObjectTableId = DeclarationPaymentObjectTable.Id, Tenant = 0, NameTextCodeCode = "DeclarationPayment.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,DeclarationPaymentObjectTable);
		   Feature DeclarationPaymentFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = true, ObjectTableId = DeclarationPaymentObjectTable.Id, Tenant = 0, NameTextCodeCode = "DeclarationPayment.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,DeclarationPaymentObjectTable);
		   Feature DeclarationPaymentFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = true, ObjectTableId = DeclarationPaymentObjectTable.Id, Tenant = 0, NameTextCodeCode = "DeclarationPayment.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,DeclarationPaymentObjectTable);
		   Feature DeclarationPaymentFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = true, ObjectTableId = DeclarationPaymentObjectTable.Id, Tenant = 0, NameTextCodeCode = "DeclarationPayment.Features.PackageFeature", NameTextCodeDefaultText = "DeclarationPayment Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,DeclarationPaymentObjectTable);    
