   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DeclarationPaymentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DeclarationPayment").ToList();
	         ...
	         Screen DeclarationPaymentCustomsDeclarationPaymentHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DeclarationPayment.HeaderScreen", Name = "Customs.DeclarationPaymentHeaderScreen", ObjectTableId = DeclarationPaymentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
