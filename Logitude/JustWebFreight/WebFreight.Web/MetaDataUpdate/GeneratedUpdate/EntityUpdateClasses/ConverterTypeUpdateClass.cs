   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ConverterTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ConverterType.Q.ConverterTypeQuery", DefaultText = @"Converter Type",LocalDefaultText = "סוג ממיר", ObjectTableId = ConverterTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query ConverterTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ConverterTypeTextCode_0.Id, NameTextCodeCode = ConverterTypeTextCode_0.Code, ObjectTableName = "Customs.ConverterType", Code = "ConverterType",  QueryGroupCode = "CTQG", IndexOrder = 0, Tenant = 0, ObjectTableId = ConverterTypeObjectTable.Id, QuerySection = "Customs.ConverterType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ConverterTypeFeature_0.Id,FeatureUniqeCode= ConverterTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ConverterTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConverterTypeQuery.Id,QueryCode = ConverterTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ConverterType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ConverterTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConverterTypeQuery.Id,QueryCode = ConverterTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ConverterType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ConverterTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConverterTypeQuery.Id,QueryCode = ConverterTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ConverterType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ConverterTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConverterTypeQuery.Id,QueryCode = ConverterTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ConverterType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ConverterTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ConverterType").ToList();
	         ...
	         Screen ConverterTypeCustomsConverterTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ConverterType.HeaderScreen", Name = "Customs.ConverterTypeHeaderScreen", ObjectTableId = ConverterTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
