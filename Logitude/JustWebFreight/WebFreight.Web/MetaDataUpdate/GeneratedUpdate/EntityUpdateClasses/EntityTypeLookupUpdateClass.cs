...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "5342585321464ced8f49f0f6b297ff60";
	    ...
	    {  
	        ...
	        QueryGroup EntityTypeLookupQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "ENTL", Name = "Customs.EntityTypeLookup" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup EntityTypeLookupQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "86bf", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
