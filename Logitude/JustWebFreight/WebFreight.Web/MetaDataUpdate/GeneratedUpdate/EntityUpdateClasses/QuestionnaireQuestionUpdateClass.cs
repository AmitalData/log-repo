...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "67256a381f68004a9c2ea4bd9dd4fc82";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuestionnaireQuestion",
			      				    DBTableName =  "QuestionnaireQuestions",
			      				    ObjectTableSingular =  "QuestionnaireQuestion",
			      				    ObjectTablePlural =  "QuestionnaireQuestions",
			      				    HasCustomFilter =  false,
			      				    IsEditable =  false,
			      				    IsNewWizard =  false,
			      				    KeyPropertyPath =  "QuestioneerId",
			      				    ...
			      				    SortingByObjectField =  "QuestioneerId",
			      				    InActive =  false,
			      				    ...
			      				    DefaultText =  "Questionnaire Question",
			      				    Code =  "f2c8",
			      				    Name =  "QuestionnaireQuestion Query Group",
			      				    GenerateDomainService =  false,
			      				    HasMenuButtons =  false,
			      				    HashString =  QuestionnaireQuestionUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "QuestioneerId",
					  						...
					  						ValidForQuerySection1 =  "QuestionnaireQuestion",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Question",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "Question",
					  						ListPropertyPath =  "Question",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "QuestionTypeCode",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "QuestionTypeCode",
					  						ListPropertyPath =  "QuestionTypeCode",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PickListCode",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "PickListCode",
					  						ListPropertyPath =  "PickListCode",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsAddOther",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "IsAddOther",
					  						ListPropertyPath =  "IsAddOther",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
	    ...
	    {   
			ObjectTable QuestionnaireQuestionObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "QuestionnaireQuestion" && d.Tenant == 0).FirstOrDefault(); 
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = QuestionnaireQuestionObjectTable.Id,
