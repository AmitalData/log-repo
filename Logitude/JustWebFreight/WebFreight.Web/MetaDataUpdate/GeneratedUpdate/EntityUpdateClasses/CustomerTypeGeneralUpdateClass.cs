   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CustomerTypeGeneralQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerTypeGeneralQuery.Id,QueryCode = CustomerTypeGeneralQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomerTypeGeneral.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerTypeGeneralQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerTypeGeneralQuery.Id,QueryCode = CustomerTypeGeneralQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomerTypeGeneral.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerTypeGeneralQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerTypeGeneralQuery.Id,QueryCode = CustomerTypeGeneralQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomerTypeGeneral.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerTypeGeneralQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerTypeGeneralQuery.Id,QueryCode = CustomerTypeGeneralQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomerTypeGeneral.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
