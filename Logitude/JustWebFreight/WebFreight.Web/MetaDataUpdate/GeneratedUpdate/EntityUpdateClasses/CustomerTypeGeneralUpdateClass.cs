...
{
   public class CustomerTypeGeneralUpdateClass
   {  		
		public const string HashString = "6ceb90d37dd964211eff96598123cf0e";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CustomerTypeGeneral",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CustomerTypeGenerals",
			      				    ObjectTableSingular =  "Customs.CustomerTypeGeneral",
			      				    ObjectTablePlural =  "Customs.CustomerTypeGenerals",
			      				    ...
			      				    DefaultText =  "Customer Type General",
			      				    Code =  "CUTG",
			      				    Name =  "Customs.CustomerTypeGeneral",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CustomerTypeGeneralUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CustomerTypeGeneral",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CustomerTypeGeneralQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CUTG", Name = "Customs.CustomerTypeGeneral" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CustomerTypeGeneralQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "f1aa", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomerTypeGeneralObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomerTypeGeneral").ToList();
	         ...
	         Screen CustomerTypeGeneralCustomsCustomerTypeGeneralHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerTypeGeneral.HeaderScreen", Name = "Customs.CustomerTypeGeneralHeaderScreen", ObjectTableId = CustomerTypeGeneralObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CustomerTypeGeneralObjectTable.HeaderScreenId = CustomerTypeGeneralCustomsCustomerTypeGeneralHeaderScreenScreen0.Id;
		    CustomerTypeGeneralObjectTable.HeaderScreenCode = CustomerTypeGeneralCustomsCustomerTypeGeneralHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomerTypeGeneralObjectTable.Id,
