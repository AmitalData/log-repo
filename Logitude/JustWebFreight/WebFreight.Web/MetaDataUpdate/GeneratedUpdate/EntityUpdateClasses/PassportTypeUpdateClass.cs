   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PassportTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.PassportType.Q.PassportTypeQuery", DefaultText = @"Passport Types",LocalDefaultText = "דרכון", ObjectTableId = PassportTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query PassportTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = PassportTypeTextCode_0.Id, NameTextCodeCode = PassportTypeTextCode_0.Code, ObjectTableName = "Customs.PassportType", Code = "PassportType",  QueryGroupCode = "PAST", IndexOrder = 0, Tenant = 0, ObjectTableId = PassportTypeObjectTable.Id, QuerySection = "Customs.PassportType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = PassportTypeFeature_0.Id,FeatureUniqeCode= PassportTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn PassportTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PassportTypeQuery.Id,QueryCode = PassportTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.PassportType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PassportTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PassportTypeQuery.Id,QueryCode = PassportTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.PassportType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PassportTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PassportTypeQuery.Id,QueryCode = PassportTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.PassportType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PassportTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PassportTypeQuery.Id,QueryCode = PassportTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.PassportType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PassportTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PassportType").ToList();
	         ...
	         Screen PassportTypeCustomsPassportTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PassportType.HeaderScreen", Name = "Customs.PassportTypeHeaderScreen", ObjectTableId = PassportTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
