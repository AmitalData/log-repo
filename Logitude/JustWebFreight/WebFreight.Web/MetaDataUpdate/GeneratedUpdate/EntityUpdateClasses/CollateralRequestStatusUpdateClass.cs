...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "4e2ce7f6bcba18ec7aa4b49d156dea40";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CollateralRequestStatus",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CollateralRequestStatus",
			      				    ObjectTableSingular =  "Collateral Request Status",
			      				    ObjectTablePlural =  "Collateral Request Status",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CollateralRequestStatusUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CollateralRequestStatus",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CollateralRequestStatusQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CORS", Name = "Customs.CollateralRequestStatus" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CollateralRequestStatusQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "0d99", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CollateralRequestStatusQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CollateralRequestStatusQuery.Id,QueryCode = CollateralRequestStatusQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CollateralRequestStatus.Code" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CollateralRequestStatusQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CollateralRequestStatusQuery.Id,QueryCode = CollateralRequestStatusQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CollateralRequestStatus.EnglishName" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CollateralRequestStatusQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CollateralRequestStatusQuery.Id,QueryCode = CollateralRequestStatusQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CollateralRequestStatus.LocalName" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn CollateralRequestStatusQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CollateralRequestStatusQuery.Id,QueryCode = CollateralRequestStatusQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CollateralRequestStatus.Inactive" , ColumnWidth = 130 }, addedQueryColumns);
	    ...
	    {   
		   ...
		   //List<ObjectField> CollateralRequestStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CollateralRequestStatus").ToList();
	         ...
	         Screen CollateralRequestStatusCustomsCollateralRequestStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CollateralRequestStatus.HeaderScreen", Name = "Customs.CollateralRequestStatusHeaderScreen", ObjectTableId = CollateralRequestStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CollateralRequestStatusObjectTable.HeaderScreenId = CollateralRequestStatusCustomsCollateralRequestStatusHeaderScreenScreen0.Id;
		    CollateralRequestStatusObjectTable.HeaderScreenCode = CollateralRequestStatusCustomsCollateralRequestStatusHeaderScreenScreen0.Code;
