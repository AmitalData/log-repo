   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode StorageMessageTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.StorageMessageType.Q.StorageMessageTypeQuery", DefaultText = @"Storage Message Type",LocalDefaultText = "סוג מסר", ObjectTableId = StorageMessageTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature StorageMessageTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "STORAGEMESSAGETYPE", ObjectTableId = StorageMessageTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.StorageMessageType.Features.StorageMessageType", NameTextCodeDefaultText = "Storage Message Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,StorageMessageTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query StorageMessageTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = StorageMessageTypeTextCode_0.Id, NameTextCodeCode = StorageMessageTypeTextCode_0.Code, ObjectTableName = "Customs.StorageMessageType", Code = "StorageMessageType",  QueryGroupCode = "SMQG", IndexOrder = 0, Tenant = 0, ObjectTableId = StorageMessageTypeObjectTable.Id, QuerySection = "Customs.StorageMessageType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = StorageMessageTypeFeature_0.Id,FeatureUniqeCode= StorageMessageTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn StorageMessageTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StorageMessageTypeQuery.Id,QueryCode = StorageMessageTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.StorageMessageType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn StorageMessageTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StorageMessageTypeQuery.Id,QueryCode = StorageMessageTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.StorageMessageType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn StorageMessageTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StorageMessageTypeQuery.Id,QueryCode = StorageMessageTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.StorageMessageType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn StorageMessageTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StorageMessageTypeQuery.Id,QueryCode = StorageMessageTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.StorageMessageType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
