   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> SupplierInvoiceItemsModObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SupplierInvoiceItemsMod").ToList();
	         ...
	         Screen SupplierInvoiceItemsModCustomsSupplierInvoiceItemsModHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SupplierInvoiceItemsMod.HeaderScreen", Name = "Customs.SupplierInvoiceItemsModHeaderScreen", ObjectTableId = SupplierInvoiceItemsModObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
