   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> SupplierInvoiceItemProcesTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SupplierInvoiceItemProcesType").ToList();
	         ...
	         Screen SupplierInvoiceItemProcesTypeCustomsSupplierInvoiceItemProcesTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SupplierInvoiceItemProcesType.HeaderScreen", Name = "Customs.SupplierInvoiceItemProcesTypeHeaderScreen", ObjectTableId = SupplierInvoiceItemProcesTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
