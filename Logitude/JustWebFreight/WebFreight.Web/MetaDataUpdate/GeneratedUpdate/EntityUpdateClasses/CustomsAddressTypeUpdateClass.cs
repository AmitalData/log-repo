   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomsAddressTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomsAddressType.Q.CustomsAddressTypeQuery", DefaultText = @"Address Types",LocalDefaultText = "סוג כתובת", ObjectTableId = CustomsAddressTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CustomsAddressTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMSADDRESSTYPE", ObjectTableId = CustomsAddressTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.CustomsAddressType.Features.CustomsAddressTypes", NameTextCodeDefaultText = "Customs Address Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CustomsAddressTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query CustomsAddressTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomsAddressTypeTextCode_0.Id, NameTextCodeCode = CustomsAddressTypeTextCode_0.Code, ObjectTableName = "Customs.CustomsAddressType", Code = "CustomsAddressType",  QueryGroupCode = "CUAT", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomsAddressTypeObjectTable.Id, QuerySection = "Customs.CustomsAddressType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CustomsAddressTypeFeature_0.Id,FeatureUniqeCode= CustomsAddressTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CustomsAddressTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsAddressTypeQuery.Id,QueryCode = CustomsAddressTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomsAddressType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomsAddressTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsAddressTypeQuery.Id,QueryCode = CustomsAddressTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomsAddressType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomsAddressTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsAddressTypeQuery.Id,QueryCode = CustomsAddressTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomsAddressType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomsAddressTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsAddressTypeQuery.Id,QueryCode = CustomsAddressTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomsAddressType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
