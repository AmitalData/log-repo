   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AutomaticExternalRconcilMthodObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AutomaticExternalRconcilMthod").ToList();
	         ...
	         Screen AutomaticExternalRconcilMthodAutomaticExternalRconcilMthodHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AutomaticExternalRconcilMthod.HeaderScreen", Name = "AutomaticExternalRconcilMthodHeaderScreen", ObjectTableId = AutomaticExternalRconcilMthodObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillAutomaticExternalRconcilMthod(int contextTenant)
        { 
            var repo = new AutomaticExternalRconcilMthodRepository(contextTenant);
