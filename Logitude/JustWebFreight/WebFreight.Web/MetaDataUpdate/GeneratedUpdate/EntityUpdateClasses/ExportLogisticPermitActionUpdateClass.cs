...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "e16fff06fe388e5e44433af3e4aaafb2";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.ExportLogisticPermitAction",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ExportLogisticPermitActionUpdateClass.HashString,
	    ...
	    {  
            ...
            if (ExportLogisticPermitActionObjectTable == null)
            {
                ...
                ExportLogisticPermitActionObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.ExportLogisticPermitAction" && d.Tenant == 0).FirstOrDefault();
            }
	    ...
	    {   
		   ...
		   ObjectTable ExportLogisticPermitActionObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "Customs.ExportLogisticPermitAction" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> ExportLogisticPermitActionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ExportLogisticPermitAction").ToList();
		       
	      

	         Screen ExportLogisticPermitActionCustomsExportLogisticPermitActionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ExportLogisticPermitAction.HeaderScreen", Name = "Customs.ExportLogisticPermitActionHeaderScreen", ObjectTableId = ExportLogisticPermitActionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ExportLogisticPermitActionObjectTable.HeaderScreenId = ExportLogisticPermitActionCustomsExportLogisticPermitActionHeaderScreenScreen0.Id;
		    ExportLogisticPermitActionObjectTable.HeaderScreenCode = ExportLogisticPermitActionCustomsExportLogisticPermitActionHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ExportLogisticPermitActionObjectTable.Id,
