   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn allcategories4QueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.Code, IndexOrder = 0, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories4QueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.Code, IndexOrder = 1, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories4QueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.Code, IndexOrder = 2, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
