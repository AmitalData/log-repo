   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn allcategories4QueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.UniqueCode, IndexOrder = 0, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories4QueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.UniqueCode, IndexOrder = 1, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories4QueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.UniqueCode, IndexOrder = 2, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == Category4ObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> Category4ObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Category4").ToList();
            ...
            ScreenField Category4Category4HeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = Category4HeaderScreenScreen0.Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField Category4Category4HeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = Category4HeaderScreenScreen0.Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField Category4Category4HeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().Id, ScreenId = Category4HeaderScreenScreen0.Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
            ...
            ScreenField Category4Category4GeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = Category4GeneralTabScreenScreen1.Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField Category4Category4GeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = Category4GeneralTabScreenScreen1.Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField Category4Category4GeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = Category4ObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().Id, ScreenId = Category4GeneralTabScreenScreen1.Id, ObjectFieldCode = Category4ObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
