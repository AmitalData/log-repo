   ...
   {  		
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn allcategories4QueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Category4.EnglishName" , ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories4QueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Category4.LocalName" , ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn allcategories4QueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories4Query.Id,QueryCode = allcategories4Query.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Category4.Inactive" , ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
