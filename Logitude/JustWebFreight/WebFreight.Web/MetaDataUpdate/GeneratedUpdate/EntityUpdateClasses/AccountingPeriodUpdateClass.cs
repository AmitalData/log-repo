...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "APEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = AccountingPeriodEventsFeature_TH1.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = AccountingPeriodObjectTable.Id, TabNameTextCodeId = AccountingPeriodEventsTextCode_TH1.Id, TabNameTextCodeCode = AccountingPeriodEventsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
