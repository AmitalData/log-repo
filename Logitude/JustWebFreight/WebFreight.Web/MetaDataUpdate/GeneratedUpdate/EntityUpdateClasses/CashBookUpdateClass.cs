   ...
   {  
	    ...
	    {   
		   ...
		   List<ObjectField> CashBookObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CashBook").ToList();
            ...
            ScreenField CashBookCashBookGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CashBookTypeCode").FirstOrDefault().Id, ScreenId = CashBookGeneralTabScreenScreen1.Id, ObjectFieldCode = CashBookObjectFields.Where(d => d.FieldName == "CashBookTypeCode").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CashBookCashBookGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = CashBookGeneralTabScreenScreen1.Id, ObjectFieldCode = CashBookObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CashBookCashBookGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = CashBookGeneralTabScreenScreen1.Id, ObjectFieldCode = CashBookObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CashBookCashBookGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CurrencyCode").FirstOrDefault().Id, ScreenId = CashBookGeneralTabScreenScreen1.Id, ObjectFieldCode = CashBookObjectFields.Where(d => d.FieldName == "CurrencyCode").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CashBookCashBookGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "AccountNumber").FirstOrDefault().Id, ScreenId = CashBookGeneralTabScreenScreen1.Id, ObjectFieldCode = CashBookObjectFields.Where(d => d.FieldName == "AccountNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
