   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query CashBooksQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CashBookTextCode_0.Id, Code = "CashBooks",  QueryGroupCode = "e691", IndexOrder = 0, Tenant = 0, ObjectTableId = CashBookObjectTable.Id, QuerySection = "CashBook", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CashBookFeature_0.Id, DefaultSortName = "EnglishName", DefaultSortDirection = "Ascending" }, queriesRepository, tenantQueries);
	
			 QueryColumn CashBooksQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashBooksQuery.Id, IndexOrder = 0, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 270 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashBooksQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashBooksQuery.Id, IndexOrder = 1, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "BranchName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 141 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashBooksQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashBooksQuery.Id, IndexOrder = 2, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 270 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashBooksQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashBooksQuery.Id, IndexOrder = 3, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CashBookTypeName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 170 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashBooksQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashBooksQuery.Id, IndexOrder = 4, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CurrencyCode" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 157 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashBooksQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashBooksQuery.Id, IndexOrder = 5, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "TotalAmount" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 140 }, queryColumnsRepository, tenantQueryColumns);
  
	      

			  Query CashbookCashQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CashBookTextCode_1.Id, Code = "CashbookCash",  QueryGroupCode = "e691", IndexOrder = 1, Tenant = 0, ObjectTableId = CashBookObjectTable.Id, QuerySection = "CashBook", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CashBookFeature_1.Id, DefaultSortName = "CreateDate", DefaultSortDirection = "Desending" }, queriesRepository, tenantQueries);
	
			 QueryColumn CashbookCashQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookCashQuery.Id, IndexOrder = 0, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 261 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookCashQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookCashQuery.Id, IndexOrder = 1, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "BranchName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 140 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookCashQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookCashQuery.Id, IndexOrder = 2, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 293 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookCashQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookCashQuery.Id, IndexOrder = 3, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CashBookTypeName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 183 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookCashQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookCashQuery.Id, IndexOrder = 4, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CurrencyCode" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 153 }, queryColumnsRepository, tenantQueryColumns);
             ...
             AdvancedQueryFilter CashbookCashQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CashBookTypeCode" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, PredefinedValue = "1",PredefinedValue2 = null, QueryId = CashbookCashQuery.Id, Tenant = 0 }, advancedQueryFiltersRepository, tenantAdvancedFilters);
			  ...
			  Query CashbookChequeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CashBookTextCode_2.Id, Code = "CashbookCheque",  QueryGroupCode = "e691", IndexOrder = 2, Tenant = 0, ObjectTableId = CashBookObjectTable.Id, QuerySection = "CashBook", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CashBookFeature_2.Id, DefaultSortName = "CreateDate", DefaultSortDirection = "Desending" }, queriesRepository, tenantQueries);
	
			 QueryColumn CashbookChequeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookChequeQuery.Id, IndexOrder = 0, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 291 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookChequeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookChequeQuery.Id, IndexOrder = 1, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "BranchName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 140 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookChequeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookChequeQuery.Id, IndexOrder = 2, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 276 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookChequeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookChequeQuery.Id, IndexOrder = 3, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CurrencyCode" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 155 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CashbookChequeQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CashbookChequeQuery.Id, IndexOrder = 4, ObjectFieldId = CashBookObjectFields.Where(d => d.FieldName == "CashBookTypeCode" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 165 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {    
			 ObjectTable CashBookObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "CashBook" && d.Tenant == 0).FirstOrDefault();  
			   ...
			   TextCode CashBookGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CashBook.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = CashBookObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes);
			   Feature CashBookGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CashBook.Tab.General", ObjectTableId = CashBookObjectTable.Id, Tenant = 0, NameTextCodeCode = "CashBook.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes);
 
                 
			   TextCode CashBookDetailsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CashBook.TH.Details", DefaultText = "Details",LocalDefaultText = "פרטים", ObjectTableId = CashBookObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes);
			   Feature CashBookDetailsFeature_TH1 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DETAILS", ObjectTableId = CashBookObjectTable.Id, Tenant = 0, NameTextCodeCode = "CashBook.Features.Details", NameTextCodeDefaultText = "Details", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes);
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CSHG",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = tenantFeatures.Where(d => d.Code == "CashBook.Tab.General" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ControlPath = "Simplog.Infrastructure.GeneralControls.GeneralTabControl", ObjectTableId = CashBookObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "CashBook.TH.General" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CBDT",HtmlComponentName = "CashBookDetailsTabComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/CashBook/CashBookDetailsTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "DETAILS" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ControlPath = "Logitude.Accounting.Views.Tabs.CSHB.CashBookDetailsTabComponent", ObjectTableId = CashBookObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "CashBook.TH.Details" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CBMD",HtmlComponentName = "CashBookManageDepoTabComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/CashBook/CashBookManageDepoTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "MNGDEPO" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ControlPath = "Logitude.Accounting.Views.Tabs.CSHB.CashBookManageDepoTabComponent", ObjectTableId = CashBookObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "CashBook.TH.ManageDepo" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CSHE",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = tenantFeatures.Where(d => d.Code == "CashBook.Tab.Events" && d.ObjectTableId == CashBookObjectTable.Id).FirstOrDefault().Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = CashBookObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "CashBook.TH.Events" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 3 }, objectTableTabsRepository, TenantObjectTableTabs);
