   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> SupplierInvoiceUCRObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SupplierInvoiceUCR").ToList();
	         ...
	         Screen SupplierInvoiceUCRCustomsSupplierInvoiceUCRHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SupplierInvoiceUCR.HeaderScreen", Name = "Customs.SupplierInvoiceUCRHeaderScreen", ObjectTableId = SupplierInvoiceUCRObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
