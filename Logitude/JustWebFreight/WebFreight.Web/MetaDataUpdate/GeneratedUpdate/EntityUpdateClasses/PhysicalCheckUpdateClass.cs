...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "c46aba2a72a5fce9142a9bd8cb84a0fb";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchResult",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "PhysicalCheckSearchResultType",
					  						NavigationPropertyName =  "SearchResultType",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CheckAuthorityAttenderTypeID",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "Authority",
					  						NavigationPropertyName =  "CheckAuthorityAttenderType",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "MyCloseCheckBox",
					  						...
					  						DefaultText =  "Mark for bulk closure",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IntegratorName",
					  						...
					  						ListLableDefaultText =  "Integrator",
					  						ListLocalDefaultText =  "שם אינטגרטור",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchResultName",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "SearchResultName",
					  						ListPropertyPath =  "SearchResultName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "SearchResultName",
					  						DefaultText =  "Search Result Name",
					  						FullLocalDefaultText =  "תוצאות הבדיקה",
					  						ListFieldLable =  "SearchResultNameListLable",
					  						ListLableDefaultText =  "Search Result Name",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "RequestToAdvanceAQueue",
					  						ObjectTableName =  "Customs.PhysicalCheck",
					  						FieldsDataType =  "LookUp",
					  						LookUpTableName =  "Customs.RequestToAdvanceAQueue",
					  						MinLength =  0,
					  						MaxLength =  8,
					  						IsRequired =  false,
					  						CopyToDW =  false,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "RequestToAdvanceAQueue",
					  						ListPropertyPath =  "RequestToAdvanceAQueue",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "RequestToAdvanceAQueue",
					  						DefaultText =  "Request To Advance A Queue",
					  						FullLocalDefaultText =  "סיבת הקדמת תור",
					  						ListFieldLable =  "RequestToAdvanceAQueueListLable",
					  						ListLableDefaultText =  "Request To Advance A Queue",
					  						ListLocalDefaultText =  "סיבת הקדמת תור",
					  						IsForeignKey =  true,
					  						ForeignEntity =  "RequestToAdvanceAQueue",
					  						NavigationPropertyName =  "RequestToAdvanceQueue",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "RequestDetails",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "RequestDetails",
					  						ListPropertyPath =  "RequestDetails",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "RequestDetails",
					  						DefaultText =  "Request Details",
					  						FullLocalDefaultText =  "פירוט הבקשה",
					  						ListFieldLable =  "RequestDetailsListLable",
					  						ListLableDefaultText =  "Request Details",
					  						ListLocalDefaultText =  "פירוט הבקשה",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "BringQueueForwardIndicatorS",
					  						ObjectTableName =  "Customs.PhysicalCheck",
					  						FieldsDataType =  "nText",
					  						MinLength =  0,
					  						MaxLength =  3,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "BringQueueForwardIndicatorS",
					  						ListPropertyPath =  "BringQueueForwardIndicatorS",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "BringQueueForwardIndicatorS",
					  						DefaultText =  "Bring Queue Forward Indicator Status",
					  						FullLocalDefaultText =  "סטטוס בקשה להקדמת תור",
					  						ListFieldLable =  "BringQueueForwardIndicatorSListLable",
					  						ListLableDefaultText =  "Bring Queue Forward Indicator Status",
					  						ListLocalDefaultText =  "סטטוס בקשה להקדמת תור",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
	    ...
	    {  
		   ...
		   Feature PhysicalCheckFeature_EarlierDateFeature = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "EarlierDateFeature", FeatureTypeCode = "ACT", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = PhysicalCheckObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.PhysicalCheck.Features.EarlierDateFeature", NameTextCodeDefaultText = @"Earlier Date Feature" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,PhysicalCheckObjectTable);
	    ...
	    {  
 		   ...
 		   TextCode PhysicalCheckTextCode_CustomsPhysicalCheckORequestToAdvanceAQueue = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.PhysicalCheck.O.RequestToAdvanceAQueue", DefaultText = "Request To Advance A Queue",LocalDefaultText = @"סיבת הקדמת תור", ObjectTableId = PhysicalCheckObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode PhysicalCheckTextCode_CustomsPhysicalCheckORequestDetails = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.PhysicalCheck.O.RequestDetails", DefaultText = "Request Details",LocalDefaultText = @"פירוט הבקשה", ObjectTableId = PhysicalCheckObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
