   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SiteTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SiteType.Q.SiteTypeQuery", DefaultText = @"Site Types",LocalDefaultText = "סוג אתר", ObjectTableId = SiteTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature SiteTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SITETYPE", ObjectTableId = SiteTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.SiteType.Features.SiteTypes", NameTextCodeDefaultText = "Site Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,SiteTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query SiteTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = SiteTypeTextCode_0.Id, NameTextCodeCode = SiteTypeTextCode_0.Code, ObjectTableName = "Customs.SiteType", Code = "SiteType",  QueryGroupCode = "SITT", IndexOrder = 0, Tenant = 0, ObjectTableId = SiteTypeObjectTable.Id, QuerySection = "Customs.SiteType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = SiteTypeFeature_0.Id,FeatureUniqeCode= SiteTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn SiteTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteTypeQuery.Id,QueryCode = SiteTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.SiteType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SiteTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteTypeQuery.Id,QueryCode = SiteTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.SiteType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SiteTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteTypeQuery.Id,QueryCode = SiteTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.SiteType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SiteTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SiteTypeQuery.Id,QueryCode = SiteTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.SiteType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> SiteTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SiteType").ToList();
	         ...
	         Screen SiteTypeCustomsSiteTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SiteType.HeaderScreen", Name = "Customs.SiteTypeHeaderScreen", ObjectTableId = SiteTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
