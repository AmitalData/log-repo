...
{
   public class GuaranteeCertificateTypeUpdateClass
   {  		
		public const string HashString = "cf35b2c684bb7604540d368984fec7a9";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.GuaranteeCertificateType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.GuaranteeCertificateTypes",
			      				    ObjectTableSingular =  "GuaranteeCertificateType",
			      				    ObjectTablePlural =  "GuaranteeCertificateTypes",
			      				    ...
			      				    DefaultText =  "Guarantee Certificate Type",
			      				    Code =  "GCQG",
			      				    Name =  "Customs.GuaranteeCertificateType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  GuaranteeCertificateTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.GuaranteeCertificateType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup GuaranteeCertificateTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "GCQG", Name = "Customs.GuaranteeCertificateType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup GuaranteeCertificateTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "a467", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn GuaranteeCertificateTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GuaranteeCertificateTypeQuery.Id,QueryCode = GuaranteeCertificateTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.GuaranteeCertificateType.Code" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn GuaranteeCertificateTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GuaranteeCertificateTypeQuery.Id,QueryCode = GuaranteeCertificateTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.GuaranteeCertificateType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn GuaranteeCertificateTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GuaranteeCertificateTypeQuery.Id,QueryCode = GuaranteeCertificateTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.GuaranteeCertificateType.LocalName" , ColumnWidth = 130 }, addedQueryColumns);

			 QueryColumn GuaranteeCertificateTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GuaranteeCertificateTypeQuery.Id,QueryCode = GuaranteeCertificateTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.GuaranteeCertificateType.Inactive" , ColumnWidth = 130 }, addedQueryColumns);
	    ...
	    {   
		   ...
		   //List<ObjectField> GuaranteeCertificateTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.GuaranteeCertificateType").ToList();
	         ...
	         Screen GuaranteeCertificateTypeCustomsGuaranteeCertificateTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "GuaranteeCertificateType.HeaderScreen", Name = "Customs.GuaranteeCertificateTypeHeaderScreen", ObjectTableId = GuaranteeCertificateTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    GuaranteeCertificateTypeObjectTable.HeaderScreenId = GuaranteeCertificateTypeCustomsGuaranteeCertificateTypeHeaderScreenScreen0.Id;
		    GuaranteeCertificateTypeObjectTable.HeaderScreenCode = GuaranteeCertificateTypeCustomsGuaranteeCertificateTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = GuaranteeCertificateTypeObjectTable.Id,
