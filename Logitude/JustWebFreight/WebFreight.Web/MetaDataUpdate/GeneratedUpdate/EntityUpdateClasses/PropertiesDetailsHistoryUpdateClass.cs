   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> PropertiesDetailsHistoryObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PropertiesDetailsHistory").ToList();
	         ...
	         Screen PropertiesDetailsHistoryCustomsPropertiesDetailsHistoryHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PropertiesDetailsHistory.HeaderScreen", Name = "Customs.PropertiesDetailsHistoryHeaderScreen", ObjectTableId = PropertiesDetailsHistoryObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
