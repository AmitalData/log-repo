   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> PhysicalCheckSearchResultTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PhysicalCheckSearchResultType").ToList();
	         ...
	         Screen PhysicalCheckSearchResultTypeCustomsPhysicalCheckSearchResultTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PhysicalCheckSearchResultType.HeaderScreen", Name = "Customs.PhysicalCheckSearchResultTypeHeaderScreen", ObjectTableId = PhysicalCheckSearchResultTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
