   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   Feature NDMessageActionCodeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NDMessageActionCodeS", ObjectTableId = NDMessageActionCodeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.NDMessageActionCode.Features.NDMessageActionCodes", NameTextCodeDefaultText = "NDMessageActionCodes", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,NDMessageActionCodeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query NDMessageActionCodeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = NDMessageActionCodeTextCode_0.Id, NameTextCodeCode = NDMessageActionCodeTextCode_0.Code, ObjectTableName = "Customs.NDMessageActionCode", Code = "NDMessageActionCode",  QueryGroupCode = "NDA1", IndexOrder = 0, Tenant = 0, ObjectTableId = NDMessageActionCodeObjectTable.Id, QuerySection = "Customs.NDMessageActionCode", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = NDMessageActionCodeFeature_0.Id,FeatureUniqeCode= NDMessageActionCodeFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn NDMessageActionCodeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.NDMessageActionCode.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn NDMessageActionCodeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.NDMessageActionCode.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn NDMessageActionCodeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.NDMessageActionCode.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn NDMessageActionCodeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.NDMessageActionCode.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn NDMessageActionCodeQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.NDMessageActionCode.StartDate" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn NDMessageActionCodeQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.NDMessageActionCode.EndDate" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
