...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "a39d0559959a8fbd6cde88b0e40f6ca4";
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn NDMessageActionCodeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.NDMessageActionCode.Code" , ColumnWidth = 70 }, addedQueryColumns);

			 QueryColumn NDMessageActionCodeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.NDMessageActionCode.EnglishName" , ColumnWidth = 250 }, addedQueryColumns);

			 QueryColumn NDMessageActionCodeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.NDMessageActionCode.LocalName" , ColumnWidth = 250 }, addedQueryColumns);

			 QueryColumn NDMessageActionCodeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = NDMessageActionCodeQuery.Id,QueryCode = NDMessageActionCodeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.NDMessageActionCode.Inactive" , ColumnWidth = 250 }, addedQueryColumns);
