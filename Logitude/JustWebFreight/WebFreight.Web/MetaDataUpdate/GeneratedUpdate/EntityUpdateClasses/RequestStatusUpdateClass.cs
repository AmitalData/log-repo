   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode RequestStatusTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.RequestStatus.Q.RequestStatusQuery", DefaultText = @"Request Status",LocalDefaultText = "סטאטוס בקשה לערבות", ObjectTableId = RequestStatusObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query RequestStatusQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = RequestStatusTextCode_0.Id, NameTextCodeCode = RequestStatusTextCode_0.Code, ObjectTableName = "Customs.RequestStatus", Code = "RequestStatus",  QueryGroupCode = "RSQG", IndexOrder = 0, Tenant = 0, ObjectTableId = RequestStatusObjectTable.Id, QuerySection = "Customs.RequestStatus", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = RequestStatusFeature_0.Id,FeatureUniqeCode= RequestStatusFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn RequestStatusQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestStatusQuery.Id,QueryCode = RequestStatusQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.RequestStatus.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn RequestStatusQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestStatusQuery.Id,QueryCode = RequestStatusQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.RequestStatus.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn RequestStatusQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestStatusQuery.Id,QueryCode = RequestStatusQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.RequestStatus.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn RequestStatusQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestStatusQuery.Id,QueryCode = RequestStatusQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.RequestStatus.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> RequestStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.RequestStatus").ToList();
	         ...
	         Screen RequestStatusCustomsRequestStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "RequestStatus.HeaderScreen", Name = "Customs.RequestStatusHeaderScreen", ObjectTableId = RequestStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
