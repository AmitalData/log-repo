...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "de5fcc2d4d72818a93f535123acda359";
	    ...
	    {  
	        ...
	        QueryGroup RequestStatusQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "RSQG", Name = "Customs.RequestStatus" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup RequestStatusQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "2172", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode RequestStatusTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.RequestStatus.Q.RequestStatusQuery", DefaultText = @"Request Status",LocalDefaultText = "סטאטוס בקשה לערבות", ObjectTableId = RequestStatusObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature RequestStatusFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "REQUESTSTATUS", ObjectTableId = RequestStatusObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.RequestStatus.Features.RequestStatus", NameTextCodeDefaultText = "Request Status", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,RequestStatusObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> RequestStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.RequestStatus").ToList();
	         ...
	         Screen RequestStatusCustomsRequestStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "RequestStatus.HeaderScreen", Name = "Customs.RequestStatusHeaderScreen", ObjectTableId = RequestStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    RequestStatusObjectTable.HeaderScreenId = RequestStatusCustomsRequestStatusHeaderScreenScreen0.Id;
		    RequestStatusObjectTable.HeaderScreenCode = RequestStatusCustomsRequestStatusHeaderScreenScreen0.Code;
