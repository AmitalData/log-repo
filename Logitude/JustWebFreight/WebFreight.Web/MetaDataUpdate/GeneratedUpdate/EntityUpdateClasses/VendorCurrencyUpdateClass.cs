   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.VendorCurrency",
			      				    IsNew =  true,
			      				    DBTableName =  "Customs.VendorCurrencies",
			      				    ObjectTableSingular =  "VendorCurrency",
			      				    ObjectTablePlural =  "VendorCurrencies",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  VendorCurrencyUpdateClass.HashString,
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = VendorCurrencyObjectTable.Id,
