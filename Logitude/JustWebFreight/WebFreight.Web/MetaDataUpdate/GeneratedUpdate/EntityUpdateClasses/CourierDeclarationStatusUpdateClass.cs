   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CourierDeclarationStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CourierDeclarationStatus").ToList();
	         ...
	         Screen CourierDeclarationStatusCustomsCourierDeclarationStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CourierDeclarationStatus.HeaderScreen", Name = "Customs.CourierDeclarationStatusHeaderScreen", ObjectTableId = CourierDeclarationStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
