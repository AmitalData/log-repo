   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode BusinessProcessQueueTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BusinessProcessQueue.Q.AllQueues", DefaultText = @"Queues",LocalDefaultText = "Queues", ObjectTableId = BusinessProcessQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllQueuesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = BusinessProcessQueueTextCode_0.Id, NameTextCodeCode = BusinessProcessQueueTextCode_0.Code, ObjectTableName = "BusinessProcessQueue", Code = "All Queues",  QueryGroupCode = "aa2e", IndexOrder = 0, Tenant = 0, ObjectTableId = BusinessProcessQueueObjectTable.Id, QuerySection = "BusinessProcessQueue", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = BusinessProcessQueueFeature_0.Id,FeatureUniqeCode= BusinessProcessQueueFeature_0.FeatureUniqeCode, DefaultSortName = "CreateDate", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllQueuesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id,QueryCode = AllQueuesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "BusinessProcessQueue.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllQueuesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id,QueryCode = AllQueuesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "BusinessProcessQueue.LocalName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllQueuesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id,QueryCode = AllQueuesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "BusinessProcessQueue.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllQueuesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id,QueryCode = AllQueuesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "BusinessProcessQueue.EntityName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllQueuesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id,QueryCode = AllQueuesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "BusinessProcessQueue.BusinessRoleName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> BusinessProcessQueueObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BusinessProcessQueue").ToList();
             ...
             ScreenField BusinessProcessQueueGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = BusinessProcessQueueGeneralTabScreenScreen0.Id,ScreenCode = BusinessProcessQueueGeneralTabScreenScreen0.Code, ObjectFieldCode = "BusinessProcessQueue.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BusinessProcessQueueGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = BusinessProcessQueueGeneralTabScreenScreen0.Id,ScreenCode = BusinessProcessQueueGeneralTabScreenScreen0.Code, ObjectFieldCode = "BusinessProcessQueue.BusinessRoleId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BusinessProcessQueueGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = BusinessProcessQueueGeneralTabScreenScreen0.Id,ScreenCode = BusinessProcessQueueGeneralTabScreenScreen0.Code, ObjectFieldCode = "BusinessProcessQueue.ObjectTableId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BusinessProcessQueueGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = BusinessProcessQueueGeneralTabScreenScreen0.Id,ScreenCode = BusinessProcessQueueGeneralTabScreenScreen0.Code, ObjectFieldCode = "BusinessProcessQueue.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BusinessProcessQueueGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = BusinessProcessQueueGeneralTabScreenScreen0.Id,ScreenCode = BusinessProcessQueueGeneralTabScreenScreen0.Code, ObjectFieldCode = "BusinessProcessQueue.Notes", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen BusinessProcessQueueHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "BusinessProcessQueue.HeaderScreen.HeaderScreen", Name = "Header Screen", ObjectTableId = BusinessProcessQueueObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode BusinessProcessQueueGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BusinessProcessQueue.TH.General", DefaultText = "General",LocalDefaultText = "General", ObjectTableId = BusinessProcessQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode BusinessProcessQueueEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BusinessProcessQueue.TH.Events", DefaultText = "Events",LocalDefaultText = "Events", ObjectTableId = BusinessProcessQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
