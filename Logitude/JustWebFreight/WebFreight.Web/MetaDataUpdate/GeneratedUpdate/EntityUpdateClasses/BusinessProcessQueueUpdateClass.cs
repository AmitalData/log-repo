   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllQueuesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id, IndexOrder = 0, ObjectFieldId = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllQueuesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id, IndexOrder = 1, ObjectFieldId = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
			 ...
			 QueryColumn AllQueuesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id, IndexOrder = 3, ObjectFieldId = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "EntityName" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "EntityName" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllQueuesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllQueuesQuery.Id, IndexOrder = 4, ObjectFieldId = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "BusinessRoleName" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BusinessProcessQueueObjectFields.Where(d => d.FieldName == "BusinessRoleName" && d.ObjectTableId == BusinessProcessQueueObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
