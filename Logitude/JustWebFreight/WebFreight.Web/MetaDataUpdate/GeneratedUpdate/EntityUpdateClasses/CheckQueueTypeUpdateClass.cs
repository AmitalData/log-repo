   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CheckQueueTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CheckQueueType.Q.CheckQueueTypeQuery", DefaultText = @"Check Queue Types",LocalDefaultText = "סוג תור", ObjectTableId = CheckQueueTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query CheckQueueTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CheckQueueTypeTextCode_0.Id, NameTextCodeCode = CheckQueueTypeTextCode_0.Code, ObjectTableName = "Customs.CheckQueueType", Code = "CheckQueueType",  QueryGroupCode = "CHQT", IndexOrder = 0, Tenant = 0, ObjectTableId = CheckQueueTypeObjectTable.Id, QuerySection = "Customs.CheckQueueType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CheckQueueTypeFeature_0.Id,FeatureUniqeCode= CheckQueueTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CheckQueueTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckQueueTypeQuery.Id,QueryCode = CheckQueueTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CheckQueueType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CheckQueueTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckQueueTypeQuery.Id,QueryCode = CheckQueueTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CheckQueueType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CheckQueueTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckQueueTypeQuery.Id,QueryCode = CheckQueueTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CheckQueueType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CheckQueueTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CheckQueueTypeQuery.Id,QueryCode = CheckQueueTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CheckQueueType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
