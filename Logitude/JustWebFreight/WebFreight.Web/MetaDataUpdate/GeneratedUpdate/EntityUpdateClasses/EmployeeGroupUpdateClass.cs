   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllEmployeeGroupsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllEmployeeGroupsQuery.Id, IndexOrder = 2, ObjectFieldId = EmployeeGroupObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == EmployeeGroupObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = EmployeeGroupObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == EmployeeGroupObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);
