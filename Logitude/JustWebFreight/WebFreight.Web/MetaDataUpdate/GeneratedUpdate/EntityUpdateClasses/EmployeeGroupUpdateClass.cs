   ...
   {  
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "EmployeeGroupLines",
					  						OldFieldName =  "EmployeeGroupLines",
					  						ObjectTableName =  "EmployeeGroup",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllEmployeeGroupsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllEmployeeGroupsQuery.Id, IndexOrder = 1, ObjectFieldId = EmployeeGroupObjectFields.Where(d => d.FieldName == "Description" && d.ObjectTableId == EmployeeGroupObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllEmployeeGroupsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllEmployeeGroupsQuery.Id, IndexOrder = 2, ObjectFieldId = EmployeeGroupObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == EmployeeGroupObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> EmployeeGroupObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "EmployeeGroup").ToList();
            ...
            ScreenField EmployeeGroupEmployeeGroupEmployeeGroupHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = EmployeeGroupObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = EmployeeGroupEmployeeGroupHeaderScreenScreen0.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
