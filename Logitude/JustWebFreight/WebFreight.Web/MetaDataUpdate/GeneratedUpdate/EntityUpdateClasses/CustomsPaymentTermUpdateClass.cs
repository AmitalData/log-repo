...
{
   public class CustomsPaymentTermUpdateClass
   {  		
		public const string HashString = "1fca77b4fe0b1710dabcfa486ab216be";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CustomsPaymentTerm",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CustomsPaymentTerms",
			      				    ...
			      				    Code =  "CUPT",
			      				    Name =  "Customs.CustomsPaymentTerm",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CustomsPaymentTermUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CustomsPaymentTerm",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CustomsPaymentTermQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CUPT", Name = "Customs.CustomsPaymentTerm" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CustomsPaymentTermQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "c423", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsPaymentTermObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsPaymentTerm").ToList();
	         ...
	         Screen CustomsPaymentTermCustomsCustomsPaymentTermHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsPaymentTerm.HeaderScreen", Name = "Customs.CustomsPaymentTermHeaderScreen", ObjectTableId = CustomsPaymentTermObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CustomsPaymentTermObjectTable.HeaderScreenId = CustomsPaymentTermCustomsCustomsPaymentTermHeaderScreenScreen0.Id;
		    CustomsPaymentTermObjectTable.HeaderScreenCode = CustomsPaymentTermCustomsCustomsPaymentTermHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomsPaymentTermObjectTable.Id,
