   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomsPaymentTermTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomsPaymentTerm.Q.CustomsPaymentTermQuery", DefaultText = @"Payment Terms",LocalDefaultText = "תנאי תשלום", ObjectTableId = CustomsPaymentTermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query CustomsPaymentTermQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomsPaymentTermTextCode_0.Id, NameTextCodeCode = CustomsPaymentTermTextCode_0.Code, ObjectTableName = "Customs.CustomsPaymentTerm", Code = "CustomsPaymentTerm",  QueryGroupCode = "CUPT", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomsPaymentTermObjectTable.Id, QuerySection = "Customs.CustomsPaymentTerm", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CustomsPaymentTermFeature_0.Id,FeatureUniqeCode= CustomsPaymentTermFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CustomsPaymentTermQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPaymentTermQuery.Id,QueryCode = CustomsPaymentTermQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomsPaymentTerm.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomsPaymentTermQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPaymentTermQuery.Id,QueryCode = CustomsPaymentTermQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomsPaymentTerm.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomsPaymentTermQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPaymentTermQuery.Id,QueryCode = CustomsPaymentTermQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomsPaymentTerm.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomsPaymentTermQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomsPaymentTermQuery.Id,QueryCode = CustomsPaymentTermQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomsPaymentTerm.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsPaymentTermObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsPaymentTerm").ToList();
	         ...
	         Screen CustomsPaymentTermCustomsCustomsPaymentTermHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsPaymentTerm.HeaderScreen", Name = "Customs.CustomsPaymentTermHeaderScreen", ObjectTableId = CustomsPaymentTermObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
