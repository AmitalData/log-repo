   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn GovernmentProcedureTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GovernmentProcedureTypeQuery.Id,QueryCode = GovernmentProcedureTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.GovernmentProcedureType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn GovernmentProcedureTypeQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GovernmentProcedureTypeQuery.Id,QueryCode = GovernmentProcedureTypeQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.GovernmentProcedureType.IsImport" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn GovernmentProcedureTypeQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = GovernmentProcedureTypeQuery.Id,QueryCode = GovernmentProcedureTypeQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.GovernmentProcedureType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> GovernmentProcedureTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.GovernmentProcedureType").ToList();
	         ...
	         Screen GovernmentProcedureTypeGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "GovernmentProcedureType.GeneralTabScreen", Name = "GeneralTabScreen", ObjectTableId = GovernmentProcedureTypeObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 5, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsGovernmentProcedureTypeGovernmentProcedureTypeGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = GovernmentProcedureTypeGeneralTabScreenScreen0.Id,ScreenCode = GovernmentProcedureTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsGovernmentProcedureTypeGovernmentProcedureTypeGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = GovernmentProcedureTypeGeneralTabScreenScreen0.Id,ScreenCode = GovernmentProcedureTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsGovernmentProcedureTypeGovernmentProcedureTypeGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = GovernmentProcedureTypeGeneralTabScreenScreen0.Id,ScreenCode = GovernmentProcedureTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.IsImport", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsGovernmentProcedureTypeGovernmentProcedureTypeGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = GovernmentProcedureTypeGeneralTabScreenScreen0.Id,ScreenCode = GovernmentProcedureTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.IndexOrder", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsGovernmentProcedureTypeGovernmentProcedureTypeGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = GovernmentProcedureTypeGeneralTabScreenScreen0.Id,ScreenCode = GovernmentProcedureTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.ShortProcedure", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen GovernmentProcedureTypeHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Customs.GovernmentProcedureType.HeaderScreen", Name = "Header Screen", ObjectTableId = GovernmentProcedureTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsGovernmentProcedureTypeCustomsGovernmentProcedureTypeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = GovernmentProcedureTypeHeaderScreenScreen1.Id,ScreenCode = GovernmentProcedureTypeHeaderScreenScreen1.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsGovernmentProcedureTypeCustomsGovernmentProcedureTypeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = GovernmentProcedureTypeHeaderScreenScreen1.Id,ScreenCode = GovernmentProcedureTypeHeaderScreenScreen1.Code, ObjectFieldCode = "Customs.GovernmentProcedureType.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode GovernmentProcedureTypeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.GovernmentProcedureType.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = GovernmentProcedureTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature GovernmentProcedureTypeGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = GovernmentProcedureTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.GovernmentProcedureType.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,GovernmentProcedureTypeObjectTable,contextTenant);
 
                 
			   TextCode GovernmentProcedureTypeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.GovernmentProcedureType.TH.Events", DefaultText = "Events",LocalDefaultText = "אירועים", ObjectTableId = GovernmentProcedureTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
