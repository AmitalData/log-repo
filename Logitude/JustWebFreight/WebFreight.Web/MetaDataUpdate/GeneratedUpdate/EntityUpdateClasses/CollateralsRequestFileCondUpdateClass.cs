...
{
   public class CollateralsRequestFileCondUpdateClass
   {  		
		public const string HashString = "b1a3abf97ba701523e199b79eb405ff5";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CollateralsRequestFileCond",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CollateralsRequestFileConds",
			      				    ...
			      				    Code =  "c7d3",
			      				    Name =  "Customs.CollateralsRequestFileCond Query Group",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CollateralsRequestFileCondUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CustomsCollateralId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "CustomsCollateralsAnswer",
					  						NavigationPropertyName =  "CustomsCollateralsAnswer",
					  						IsMaxLength =  false,
	    ...
	    {   
		   ...
		   ObjectTable CollateralsRequestFileCondObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "Customs.CollateralsRequestFileCond" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> CollateralsRequestFileCondObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CollateralsRequestFileCond").ToList();
		       
	      

	         Screen CollateralsRequestFileCondCustomsCollateralsRequestFileCondHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CollateralsRequestFileCond.HeaderScreen", Name = "Customs.CollateralsRequestFileCondHeaderScreen", ObjectTableId = CollateralsRequestFileCondObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CollateralsRequestFileCondObjectTable.HeaderScreenId = CollateralsRequestFileCondCustomsCollateralsRequestFileCondHeaderScreenScreen0.Id;
		    CollateralsRequestFileCondObjectTable.HeaderScreenCode = CollateralsRequestFileCondCustomsCollateralsRequestFileCondHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CollateralsRequestFileCondObjectTable.Id,
