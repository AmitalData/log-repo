   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode InvoiceTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.InvoiceType.Q.InvoiceTypeQuery", DefaultText = @"Invoice Types",LocalDefaultText = "סוג חשבון", ObjectTableId = InvoiceTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature InvoiceTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "INVOICETYPE", ObjectTableId = InvoiceTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.InvoiceType.Features.InvoiceTypes", NameTextCodeDefaultText = "Invoice Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,InvoiceTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query InvoiceTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = InvoiceTypeTextCode_0.Id, NameTextCodeCode = InvoiceTypeTextCode_0.Code, ObjectTableName = "Customs.InvoiceType", Code = "InvoiceType",  QueryGroupCode = "INVT", IndexOrder = 0, Tenant = 0, ObjectTableId = InvoiceTypeObjectTable.Id, QuerySection = "Customs.InvoiceType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = InvoiceTypeFeature_0.Id,FeatureUniqeCode= InvoiceTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn InvoiceTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InvoiceTypeQuery.Id,QueryCode = InvoiceTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.InvoiceType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn InvoiceTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InvoiceTypeQuery.Id,QueryCode = InvoiceTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.InvoiceType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn InvoiceTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InvoiceTypeQuery.Id,QueryCode = InvoiceTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.InvoiceType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn InvoiceTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InvoiceTypeQuery.Id,QueryCode = InvoiceTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.InvoiceType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> InvoiceTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.InvoiceType").ToList();
	         ...
	         Screen InvoiceTypeCustomsInvoiceTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "InvoiceType.HeaderScreen", Name = "Customs.InvoiceTypeHeaderScreen", ObjectTableId = InvoiceTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
