...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "3b6fb2fd6351483ddedc86b0aa91118b";
	    ...
	    {  
	        ...
	        QueryGroup CheckEssenceLookupQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CEQG", Name = "Customs.CheckEssenceLookup" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CheckEssenceLookupQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "4123", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CheckEssenceLookupObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CheckEssenceLookup").ToList();
	         ...
	         Screen CheckEssenceLookupCustomsCheckEssenceLookupHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CheckEssenceLookup.HeaderScreen", Name = "Customs.CheckEssenceLookupHeaderScreen", ObjectTableId = CheckEssenceLookupObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CheckEssenceLookupObjectTable.HeaderScreenId = CheckEssenceLookupCustomsCheckEssenceLookupHeaderScreenScreen0.Id;
		    CheckEssenceLookupObjectTable.HeaderScreenCode = CheckEssenceLookupCustomsCheckEssenceLookupHeaderScreenScreen0.Code;
