   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode TermsOfSaleTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.TermsOfSaleType.Q.TermsOfSaleTypeQuery", DefaultText = @"Terms Of Sale Types",LocalDefaultText = "תנאי מכר", ObjectTableId = TermsOfSaleTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature TermsOfSaleTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TERMSOFSALETYPE", ObjectTableId = TermsOfSaleTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.TermsOfSaleType.Features.TermsOfSaleTypes", NameTextCodeDefaultText = "Terms Of Sale Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,TermsOfSaleTypeObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> TermsOfSaleTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.TermsOfSaleType").ToList();
	         ...
	         Screen TermsOfSaleTypeCustomsTermsOfSaleTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TermsOfSaleType.HeaderScreen", Name = "Customs.TermsOfSaleTypeHeaderScreen", ObjectTableId = TermsOfSaleTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
