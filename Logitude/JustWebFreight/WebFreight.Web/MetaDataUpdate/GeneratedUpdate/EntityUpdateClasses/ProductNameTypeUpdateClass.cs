...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "bfc8b9cc77bfae1595f4099c1ae0861e";
	    ...
	    {  
	        ...
	        QueryGroup ProductNameTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "PRNT", Name = "Customs.ProductNameType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ProductNameTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "288f", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> ProductNameTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ProductNameType").ToList();
	         ...
	         Screen ProductNameTypeCustomsProductNameTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ProductNameType.HeaderScreen", Name = "Customs.ProductNameTypeHeaderScreen", ObjectTableId = ProductNameTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ProductNameTypeObjectTable.HeaderScreenId = ProductNameTypeCustomsProductNameTypeHeaderScreenScreen0.Id;
		    ProductNameTypeObjectTable.HeaderScreenCode = ProductNameTypeCustomsProductNameTypeHeaderScreenScreen0.Code;
