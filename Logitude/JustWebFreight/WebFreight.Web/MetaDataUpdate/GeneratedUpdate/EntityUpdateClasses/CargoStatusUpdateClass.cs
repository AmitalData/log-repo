   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CargoStatusTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CargoStatus.Q.CargoStatus", DefaultText = @"Cargo Statuses",LocalDefaultText = "סטאטוס מטען", ObjectTableId = CargoStatusObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CargoStatusFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CargoStatus.Q.CargoStatus", ObjectTableId = CargoStatusObjectTable.Id, Tenant = 0, NameTextCodeCode = "CargoStatus.Features.CargoStatus", NameTextCodeDefaultText = "CargoStatus", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CargoStatusObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query CargoStatusQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CargoStatusTextCode_0.Id, NameTextCodeCode = CargoStatusTextCode_0.Code, ObjectTableName = "Customs.CargoStatus", Code = "CargoStatus",  QueryGroupCode = "1362", IndexOrder = 0, Tenant = 0, ObjectTableId = CargoStatusObjectTable.Id, QuerySection = "Customs.CargoStatus", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CargoStatusFeature_0.Id,FeatureUniqeCode= CargoStatusFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CargoStatusQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CargoStatusQuery.Id,QueryCode = CargoStatusQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CargoStatus.Code" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn CargoStatusQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CargoStatusQuery.Id,QueryCode = CargoStatusQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CargoStatus.Name" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn CargoStatusQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CargoStatusQuery.Id,QueryCode = CargoStatusQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CargoStatus.LocalName" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn CargoStatusQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CargoStatusQuery.Id,QueryCode = CargoStatusQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CargoStatus.Inactive" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CargoStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CargoStatus").ToList();
	         ...
	         Screen CargoStatusCustomsCargoStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CargoStatus.HeaderScreen", Name = "Customs.CargoStatusHeaderScreen", ObjectTableId = CargoStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
