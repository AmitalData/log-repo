   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AgentTalkBackTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AgentTalkBackType.Q.AgentTalkBackType", DefaultText = @"AgentTalkBackTypeQuery",LocalDefaultText = null, ObjectTableId = AgentTalkBackTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature AgentTalkBackTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AgentTalkBackType.Q.AgentTalkBackType", ObjectTableId = AgentTalkBackTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "AgentTalkBackType.Features.AgentTalkBackType", NameTextCodeDefaultText = "AgentTalkBackType", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,AgentTalkBackTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AgentTalkBackTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentTalkBackTypeQuery.Id,QueryCode = AgentTalkBackTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.AgentTalkBackType.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentTalkBackTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentTalkBackTypeQuery.Id,QueryCode = AgentTalkBackTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.AgentTalkBackType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentTalkBackTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentTalkBackTypeQuery.Id,QueryCode = AgentTalkBackTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.AgentTalkBackType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> AgentTalkBackTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AgentTalkBackType").ToList();
	         ...
	         Screen AgentTalkBackTypeCustomsAgentTalkBackTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AgentTalkBackType.HeaderScreen", Name = "Customs.AgentTalkBackTypeHeaderScreen", ObjectTableId = AgentTalkBackTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
