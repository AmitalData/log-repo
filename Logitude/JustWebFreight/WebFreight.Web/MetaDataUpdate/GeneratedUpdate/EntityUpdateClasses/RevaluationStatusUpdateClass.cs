...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "fe6b9c7e05d6101eb2c99dbe9c28532f";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "RevaluationStatus",
			      				    IsNew =  false,
			      				    DBTableName =  "RevaluationStatuses",
			      				    ObjectTableSingular =  "Revaluation Status",
			      				    ObjectTablePlural =  "Revaluation Statuses",
			      				    ...
			      				    DefaultText =  "Revaluation Status",
			      				    Code =  "4a6e",
			      				    Name =  "RevaluationStatus Query Group",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  RevaluationStatusUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "RevaluationStatus",
					  						IsRestrictable =  false,
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = RevaluationStatusObjectTable.Id,
	    ...
	    public void FillRevaluationStatus()
        { 
            var repo = new RevaluationStatusRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                RevaluationStatus,
                                RevaluationStatusDetails,
                                RevaluationStatusRepository>(repo, dic);
        }
