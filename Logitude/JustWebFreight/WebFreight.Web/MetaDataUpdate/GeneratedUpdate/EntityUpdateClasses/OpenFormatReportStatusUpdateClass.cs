   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> OpenFormatReportStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "OpenFormatReportStatus").ToList();
	         ...
	         Screen OpenFormatReportStatusOpenFormatReportStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "OpenFormatReportStatus.HeaderScreen", Name = "OpenFormatReportStatusHeaderScreen", ObjectTableId = OpenFormatReportStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillOpenFormatReportStatus(int contextTenant)
        { 
            var repo = new OpenFormatReportStatusRepository(contextTenant);
