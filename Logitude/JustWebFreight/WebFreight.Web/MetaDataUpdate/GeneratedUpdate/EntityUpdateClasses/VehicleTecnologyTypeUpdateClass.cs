...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "d36c3b299c79c3cf1fb0936cc0494b0c";
	    ...
	    {  
	        ...
	        QueryGroup VehicleTecnologyTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "VGQG", Name = "Customs.VehicleTecnologyType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup VehicleTecnologyTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "d680", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
