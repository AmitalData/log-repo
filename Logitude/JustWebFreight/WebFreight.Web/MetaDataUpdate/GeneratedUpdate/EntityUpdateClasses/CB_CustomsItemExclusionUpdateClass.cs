   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CB_CustomsItemExclusionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CB_CustomsItemExclusion").ToList();
	         ...
	         Screen CB_CustomsItemExclusionCustomsCB_CustomsItemExclusionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CB_CustomsItemExclusion.HeaderScreen", Name = "Customs.CB_CustomsItemExclusionHeaderScreen", ObjectTableId = CB_CustomsItemExclusionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
