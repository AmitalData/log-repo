...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "a03a5c424fd002e3e9492d96595b45f6";
	    ...
	    {  
	        ...
	        QueryGroup InternalBorderSiteTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "IBST", Name = "Customs.InternalBorderSiteType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup InternalBorderSiteTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "fef3", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
