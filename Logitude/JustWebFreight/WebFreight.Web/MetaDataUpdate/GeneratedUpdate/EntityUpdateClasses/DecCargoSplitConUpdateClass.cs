...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    {  
 		   ...
 		   TextCode DecCargoSplitConTextCode_CustomsDecCargoSplitConODisplayOnly = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DecCargoSplitCon.O.DisplayOnly", DefaultText = "Display Only",LocalDefaultText = @"לתצוגה בלבד - ", ObjectTableId = DecCargoSplitConObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
