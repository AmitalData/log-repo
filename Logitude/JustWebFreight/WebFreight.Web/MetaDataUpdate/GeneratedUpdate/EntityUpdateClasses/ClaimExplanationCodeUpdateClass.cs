...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "2cc40712bbc9812dfc32c25caac7ffcb";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.ClaimExplanationCode",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.ClaimExplanationCodes",
			      				    ObjectTableSingular =  "Customs.ClaimExplanationCode",
			      				    ObjectTablePlural =  "Customs.ClaimExplanationCodes",
			      				    ...
			      				    LocalDefaultText =  "נימוק רלוונטי לסיבת עיבוד",
			      				    DefaultText =  "Claim Explanation Codes",
			      				    Code =  "f29d",
			      				    Name =  "Customs.ClaimExplanationCode Query Group",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ClaimExplanationCodeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.ClaimExplanationCode",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup ClaimExplanationCodeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "f29d", Name = "Customs.ClaimExplanationCode Query Group" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ClaimExplanationCodeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "b323", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> ClaimExplanationCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ClaimExplanationCode").ToList();
	         ...
	         Screen ClaimExplanationCodeCustomsClaimExplanationCodeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ClaimExplanationCode.HeaderScreen", Name = "Customs.ClaimExplanationCodeHeaderScreen", ObjectTableId = ClaimExplanationCodeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ClaimExplanationCodeObjectTable.HeaderScreenId = ClaimExplanationCodeCustomsClaimExplanationCodeHeaderScreenScreen0.Id;
		    ClaimExplanationCodeObjectTable.HeaderScreenCode = ClaimExplanationCodeCustomsClaimExplanationCodeHeaderScreenScreen0.Code;
