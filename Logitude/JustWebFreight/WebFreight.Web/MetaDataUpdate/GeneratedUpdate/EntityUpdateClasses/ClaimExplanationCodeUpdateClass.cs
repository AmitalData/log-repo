   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ClaimExplanationCodeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ClaimExplanationCode.Q.ClaimExplanation", DefaultText = @"ClaimExplanationQuery",LocalDefaultText = null, ObjectTableId = ClaimExplanationCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ClaimExplanationQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClaimExplanationQuery.Id,QueryCode = ClaimExplanationQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ClaimExplanationCode.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn ClaimExplanationQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClaimExplanationQuery.Id,QueryCode = ClaimExplanationQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ClaimExplanationCode.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ClaimExplanationQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClaimExplanationQuery.Id,QueryCode = ClaimExplanationQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ClaimExplanationCode.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ClaimExplanationCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ClaimExplanationCode").ToList();
	         ...
	         Screen ClaimExplanationCodeCustomsClaimExplanationCodeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ClaimExplanationCode.HeaderScreen", Name = "Customs.ClaimExplanationCodeHeaderScreen", ObjectTableId = ClaimExplanationCodeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
