   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode BankCodeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BankCode.Q.BankCodes", DefaultText = @"All Bank Codes",LocalDefaultText = null, ObjectTableId = BankCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query BankCodesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = BankCodeTextCode_0.Id, NameTextCodeCode = BankCodeTextCode_0.Code, ObjectTableName = "BankCode", Code = "BankCodes",  QueryGroupCode = "99b6", IndexOrder = 0, Tenant = 0, ObjectTableId = BankCodeObjectTable.Id, QuerySection = "BankCode", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = BankCodeFeature_0.Id,FeatureUniqeCode= BankCodeFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn BankCodesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "BankCode.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn BankCodesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "BankCode.LocalName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn BankCodesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "BankCode.EnglishName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn BankCodesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "BankCode.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> BankCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BankCode").ToList();
	         ...
	         Screen BankCodeGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "BankCode.GeneralTabScreen", Name = "GeneralTabScreen", ObjectTableId = BankCodeObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 4, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField BankCodeBankCodeGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = BankCodeGeneralTabScreenScreen0.Id,ScreenCode = BankCodeGeneralTabScreenScreen0.Code, ObjectFieldCode = "BankCode.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BankCodeBankCodeGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = BankCodeGeneralTabScreenScreen0.Id,ScreenCode = BankCodeGeneralTabScreenScreen0.Code, ObjectFieldCode = "BankCode.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BankCodeBankCodeGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = BankCodeGeneralTabScreenScreen0.Id,ScreenCode = BankCodeGeneralTabScreenScreen0.Code, ObjectFieldCode = "BankCode.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BankCodeBankCodeGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = BankCodeGeneralTabScreenScreen0.Id,ScreenCode = BankCodeGeneralTabScreenScreen0.Code, ObjectFieldCode = "BankCode.Inactive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen BankCodeBankCodeHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "BankCode.BankCodeHeaderScreen", Name = "BankCodeHeaderScreen", ObjectTableId = BankCodeObjectTable.Id, NumberOfColumns = 4, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField BankCodeBankCodeBankCodeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = BankCodeBankCodeHeaderScreenScreen1.Id,ScreenCode = BankCodeBankCodeHeaderScreenScreen1.Code, ObjectFieldCode = "BankCode.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BankCodeBankCodeBankCodeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = BankCodeBankCodeHeaderScreenScreen1.Id,ScreenCode = BankCodeBankCodeHeaderScreenScreen1.Code, ObjectFieldCode = "BankCode.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BankCodeBankCodeBankCodeHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ScreenId = BankCodeBankCodeHeaderScreenScreen1.Id,ScreenCode = BankCodeBankCodeHeaderScreenScreen1.Code, ObjectFieldCode = "BankCode.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BankCodeBankCodeBankCodeHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ScreenId = BankCodeBankCodeHeaderScreenScreen1.Id,ScreenCode = BankCodeBankCodeHeaderScreenScreen1.Code, ObjectFieldCode = "BankCode.Inactive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode BankCodeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BankCode.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = BankCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode BankCodeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BankCode.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = BankCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode BankCodeTextCode_GeneralMCACCBankCodes = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.ACC.BankCodes", DefaultText = "Bank Codes",LocalDefaultText = @"קודי בנקים", ObjectTableId = BankCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
