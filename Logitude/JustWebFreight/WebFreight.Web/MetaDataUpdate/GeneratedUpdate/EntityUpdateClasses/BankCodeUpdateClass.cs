   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn BankCodesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.Code, IndexOrder = 0, ObjectFieldId = BankCodeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankCodeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn BankCodesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.Code, IndexOrder = 1, ObjectFieldId = BankCodeObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankCodeObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 250 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn BankCodesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.Code, IndexOrder = 2, ObjectFieldId = BankCodeObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankCodeObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 250 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn BankCodesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BankCodesQuery.Id,QueryCode = BankCodesQuery.Code, IndexOrder = 3, ObjectFieldId = BankCodeObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankCodeObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == BankCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
