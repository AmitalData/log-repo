...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "21ddc13dd1a143360dcff9cab711b740";
	    ...
	    {  
	        ...
	        QueryGroup CityQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CITY", Name = "Customs.Cities" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CityQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "cc22", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
