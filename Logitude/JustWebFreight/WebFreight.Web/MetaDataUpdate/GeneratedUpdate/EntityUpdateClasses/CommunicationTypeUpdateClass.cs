   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CommunicationTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CommunicationType.Q.CommunicationTypeQuery", DefaultText = @"Communication Types",LocalDefaultText = "סוג תקשורת", ObjectTableId = CommunicationTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CommunicationTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommunicationTypeQuery.Id,QueryCode = CommunicationTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CommunicationType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CommunicationTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommunicationTypeQuery.Id,QueryCode = CommunicationTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CommunicationType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CommunicationTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommunicationTypeQuery.Id,QueryCode = CommunicationTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CommunicationType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CommunicationTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommunicationTypeQuery.Id,QueryCode = CommunicationTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CommunicationType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
