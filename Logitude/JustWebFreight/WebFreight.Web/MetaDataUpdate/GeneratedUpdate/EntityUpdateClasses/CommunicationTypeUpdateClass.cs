...
{
   public class CommunicationTypeUpdateClass
   {  		
		public const string HashString = "da6e8ef4f6922edd13e02b39f4d20a20";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CommunicationType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CommunicationTypes",
			      				    ObjectTableSingular =  "Customs.CommunicationType",
			      				    ObjectTablePlural =  "Customs.CommunicationTypes",
			      				    ...
			      				    Code =  "COMT",
			      				    Name =  "Customs.CommunicationType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CommunicationTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CommunicationType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CommunicationTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "COMT", Name = "Customs.CommunicationType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CommunicationTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "10e0", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CommunicationTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CommunicationType").ToList();
	         ...
	         Screen CommunicationTypeCustomsCommunicationTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CommunicationType.HeaderScreen", Name = "Customs.CommunicationTypeHeaderScreen", ObjectTableId = CommunicationTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CommunicationTypeObjectTable.HeaderScreenId = CommunicationTypeCustomsCommunicationTypeHeaderScreenScreen0.Id;
		    CommunicationTypeObjectTable.HeaderScreenCode = CommunicationTypeCustomsCommunicationTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CommunicationTypeObjectTable.Id,
