...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "96c73a94c523d010c6d95407ccbe6d25";
	    ...
	    {   
		   ...
		   //List<ObjectField> UserDefinedReportObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "UserDefinedReport").ToList();
	         ...
	         Screen UserDefinedReportUserDefinedReportHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "UserDefinedReport.HeaderScreen", Name = "UserDefinedReportHeaderScreen", ObjectTableId = UserDefinedReportObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
