   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode UserDefinedReportTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.Q.UserDefinedReports", DefaultText = @"User Defined Reports",LocalDefaultText = "קבוצות מאזן מחושבות", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query UserDefinedReportsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = UserDefinedReportTextCode_0.Id, NameTextCodeCode = UserDefinedReportTextCode_0.Code, ObjectTableName = "UserDefinedReport", Code = "User Defined Reports",  QueryGroupCode = "c4c8", IndexOrder = 0, Tenant = 0, ObjectTableId = UserDefinedReportObjectTable.Id, QuerySection = "UserDefinedReport", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = UserDefinedReportFeature_0.Id,FeatureUniqeCode= UserDefinedReportFeature_0.FeatureUniqeCode, DefaultSortName = "CreateDateTime", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn UserDefinedReportsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "UserDefinedReport.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UserDefinedReportsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "UserDefinedReport.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UserDefinedReportsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "UserDefinedReport.CreateDateTime" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UserDefinedReportsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "UserDefinedReport.CreatedByName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UserDefinedReportsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "UserDefinedReport.UpdatedDateTime" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UserDefinedReportsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "UserDefinedReport.UpdatedByName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UserDefinedReportsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UserDefinedReportsQuery.Id,QueryCode = UserDefinedReportsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "UserDefinedReport.IsCancelled" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> UserDefinedReportObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "UserDefinedReport").ToList();
	         ...
	         Screen UserDefinedReportUserDefinedReportHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "UserDefinedReportHeaderScreen", Name = "UserDefinedReportHeaderScreen", ObjectTableId = UserDefinedReportObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField UserDefinedReportUserDefinedReportHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = UserDefinedReportUserDefinedReportHeaderScreenScreen0.Id,ScreenCode = UserDefinedReportUserDefinedReportHeaderScreenScreen0.Code, ObjectFieldCode = "UserDefinedReport.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField UserDefinedReportUserDefinedReportHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = UserDefinedReportUserDefinedReportHeaderScreenScreen0.Id,ScreenCode = UserDefinedReportUserDefinedReportHeaderScreenScreen0.Code, ObjectFieldCode = "UserDefinedReport.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode UserDefinedReportGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode UserDefinedReportEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.TH.Events", DefaultText = "Events",LocalDefaultText = "אירועים", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode UserDefinedReportTextCode_UserDefinedReportONewUserDefinedReport = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.NewUserDefinedReport", DefaultText = "New User Defined Report",LocalDefaultText = "הוגדר מחדש ע''י", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOCantUpdateTheChartofAccountType = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.CantUpdateTheChartofAccountType", DefaultText = "Can't update the chart of account type when there are lines connected to this calculated chart of account.",LocalDefaultText = @"לא ניתן להגדיר סוג קבוצת מאזן כאשר קימות שורות מקושרות לקבוצת המאזן המחושבת", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOCantSaveTheCalculatedChartofAccount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.CantSaveTheCalculatedChartofAccount", DefaultText = "Can't save the calculated chart of account. There are errors on line",LocalDefaultText = @"לא ניתן לשמור את קבוצת המאזן המחושבת ישנה הודעת שגיאה בשורות", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOCalculatedChartofAccount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.CalculatedChartofAccount", DefaultText = "Calculated Chart of Account",LocalDefaultText = @"קבוצת המאזן המחושבת", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportODontHaveAnyLinesInThem = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.DontHaveAnyLinesInThem.", DefaultText = "don't have any line",LocalDefaultText = @"הוגדרה ללא שורות , יש להגדיר לפחות שורה אחת", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOTheTeportNeedsAtLeastOne = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.TheTeportNeedsAtLeastOne", DefaultText = "The report needs at least one calculated chart of account.",LocalDefaultText = @"יש להגדיר לפחות קבוצת מאזן אחת", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOChildGLAccountsAlreadyIncluded = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.ChildGLAccountsAlreadyIncluded", DefaultText = "This Chart of Account or one of its child GLAccounts is already included in this report under calculated chart of account line",LocalDefaultText = @"כרטיס מטבעי זה מקושר לכרטיס מולטי שכבר הוגדר בדוח זה תחת קבוצת מאזן מחושבת בשורה", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOAndCantBeAddedAgain = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.AndCantBeAddedAgain.", DefaultText = "and can't be added again.",LocalDefaultText = @" .ולכן לא ניתן להוסיפו בשנית", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode UserDefinedReportTextCode_UserDefinedReportOChartOfAccountTypeforthislinediffersfromtheChartofAccount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.ChartOfAccountTypeforthislinediffersfromtheChartofAccount", DefaultText = "Chart Of Account Type for this line differs from the Chart of Account Type for this calculated chart of account, please choose another GLAccount or Charts of Accounts.",LocalDefaultText = @"סוג קבוצת המאזן בשורה זאת שונה מהגדרת הסוג של קבוצת המאזן שנבחרה", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOPeriod1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.Period1", DefaultText = "Period 1",LocalDefaultText = @"תקופה 1", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOPeriod2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.Period2", DefaultText = "Period 2",LocalDefaultText = @"תקופה 2", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOFromToDates = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.FromToDates", DefaultText = "From/To Dates",LocalDefaultText = @"מתאריך\עד תאריך", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOIncludeOpeningBalance = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.IncludeOpeningBalance", DefaultText = "Include Opening Balance",LocalDefaultText = @"כולל יתרת פתיחה", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOReport = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.Report", DefaultText = "Report",LocalDefaultText = "דו''ח", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode UserDefinedReportTextCode_UserDefinedReportOAtLeastOnePeriodIsRequired = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.AtLeastOnePeriodIsRequired", DefaultText = "At least one period is required",LocalDefaultText = @"חובה להקליד לפחות תקופה אחת ", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode UserDefinedReportTextCode_UserDefinedReportOZeroCloseBalanceLabel = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "UserDefinedReport.O.ZeroCloseBalanceLabel", DefaultText = "Exclude GLAccount with Close Balance 0",LocalDefaultText = @"לא לכלול כרטיסים ללא תנועות עם יתרה 0", ObjectTableId = UserDefinedReportObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
