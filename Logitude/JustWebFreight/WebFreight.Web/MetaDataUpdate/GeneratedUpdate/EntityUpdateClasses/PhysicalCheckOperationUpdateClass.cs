   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> PhysicalCheckOperationObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PhysicalCheckOperation").ToList();
	         ...
	         Screen PhysicalCheckOperationCustomsPhysicalCheckOperationHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PhysicalCheckOperation.HeaderScreen", Name = "Customs.PhysicalCheckOperationHeaderScreen", ObjectTableId = PhysicalCheckOperationObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
