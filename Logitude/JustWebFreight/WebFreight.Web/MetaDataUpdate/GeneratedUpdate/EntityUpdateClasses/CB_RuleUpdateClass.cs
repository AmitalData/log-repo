   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CB_RuleObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CB_Rule").ToList();
	         ...
	         Screen CB_RuleCustomsCB_RuleHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CB_Rule.HeaderScreen", Name = "Customs.CB_RuleHeaderScreen", ObjectTableId = CB_RuleObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
