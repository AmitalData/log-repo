...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "b1f35340ad0ced6eb8d5c31afb9aac93";
	    ...
	    {  
 		   ...
 		   TextCode SIIRequestTextCode_CustomsSIIRequestOLevel = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.Level", DefaultText = "Level",LocalDefaultText = @"BS64:Iteo157XlCI=", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestODeclaration = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.Declaration", DefaultText = "Declaration",LocalDefaultText = @"BS64:IteU16bXlNeo15Qi", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOSupplierInvoice = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.SupplierInvoice", DefaultText = "SupplierInvoice",LocalDefaultText = @"BS64:IteX16nXkdeV158i", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode SIIRequestTextCode_CustomsSIIRequestOInvoiceNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.InvoiceNumber", DefaultText = "Invoice Number",LocalDefaultText = @"BS64:Itee16HXpNeoINeX16nXkdeV158i", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOLineNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.LineNumber", DefaultText = "LineNumber",LocalDefaultText = @"BS64:Itep15XXqNeUIg==", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode SIIRequestTextCode_CustomsSIIRequestOInvoiceQuantity = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.InvoiceQuantity", DefaultText = "Quantity",LocalDefaultText = @"BS64:Iteb157XldeqIg==", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOItemPrice = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.ItemPrice", DefaultText = "Item Price",LocalDefaultText = @"BS64:Itei16jXmiDXodeX15XXqNeUIg==", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOItemPriceCurrencyCode = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.ItemPriceCurrencyCode", DefaultText = "Item Price Currency Code",LocalDefaultText = @"BS64:Itee15jXkdeiIg==", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOOriginCountryCode = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.OriginCountryCode", DefaultText = "Origin Country",LocalDefaultText = @"BS64:IteQ16jXpSDXnten15XXqCI=", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOConfirm = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.Confirm", DefaultText = "Confirm",LocalDefaultText = @"BS64:IteQ15nXqdeV16gi", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode SIIRequestTextCode_CustomsSIIRequestOCancel = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SIIRequest.O.Cancel", DefaultText = "Cancel",LocalDefaultText = @"BS64:IteR15nXmNeV15wi", ObjectTableId = SIIRequestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
