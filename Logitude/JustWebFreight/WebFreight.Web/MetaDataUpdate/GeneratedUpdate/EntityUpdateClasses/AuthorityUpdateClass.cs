   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AuthorityTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Authority.Q.AuthorityQuery", DefaultText = @"Authority",LocalDefaultText = "גורם מאשר", ObjectTableId = AuthorityObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AuthorityQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AuthorityTextCode_0.Id, NameTextCodeCode = AuthorityTextCode_0.Code, ObjectTableName = "Customs.Authority", Code = "Authority",  QueryGroupCode = "ATQG", IndexOrder = 0, Tenant = 0, ObjectTableId = AuthorityObjectTable.Id, QuerySection = "Customs.Authority", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AuthorityFeature_0.Id,FeatureUniqeCode= AuthorityFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AuthorityQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AuthorityQuery.Id,QueryCode = AuthorityQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.Authority.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AuthorityQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AuthorityQuery.Id,QueryCode = AuthorityQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.Authority.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AuthorityQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AuthorityQuery.Id,QueryCode = AuthorityQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.Authority.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AuthorityQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AuthorityQuery.Id,QueryCode = AuthorityQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.Authority.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> AuthorityObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.Authority").ToList();
	         ...
	         Screen AuthorityCustomsAuthorityHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Authority.HeaderScreen", Name = "Customs.AuthorityHeaderScreen", ObjectTableId = AuthorityObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
