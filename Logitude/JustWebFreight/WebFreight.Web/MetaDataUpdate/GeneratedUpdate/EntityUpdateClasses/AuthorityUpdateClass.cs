...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "d9643920cdba77ebb36976acc4c9ef01";
	    ...
	    {  
	        ...
	        QueryGroup AuthorityQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "ATQG", Name = "Customs.Authority" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup AuthorityQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "1558", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
