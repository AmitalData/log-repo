   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PaymentProcessTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.PaymentProcess.Q.PaymentProcessQuery", DefaultText = @"Payment Processes",LocalDefaultText = "תהליך תשלום", ObjectTableId = PaymentProcessObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query PaymentProcessQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = PaymentProcessTextCode_0.Id, NameTextCodeCode = PaymentProcessTextCode_0.Code, ObjectTableName = "Customs.PaymentProcess", Code = "PaymentProcess",  QueryGroupCode = "PAPR", IndexOrder = 0, Tenant = 0, ObjectTableId = PaymentProcessObjectTable.Id, QuerySection = "Customs.PaymentProcess", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = PaymentProcessFeature_0.Id,FeatureUniqeCode= PaymentProcessFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn PaymentProcessQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymentProcessQuery.Id,QueryCode = PaymentProcessQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.PaymentProcess.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymentProcessQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymentProcessQuery.Id,QueryCode = PaymentProcessQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.PaymentProcess.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymentProcessQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymentProcessQuery.Id,QueryCode = PaymentProcessQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.PaymentProcess.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymentProcessQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymentProcessQuery.Id,QueryCode = PaymentProcessQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.PaymentProcess.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PaymentProcessObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PaymentProcess").ToList();
	         ...
	         Screen PaymentProcessCustomsPaymentProcessHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PaymentProcess.HeaderScreen", Name = "Customs.PaymentProcessHeaderScreen", ObjectTableId = PaymentProcessObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
