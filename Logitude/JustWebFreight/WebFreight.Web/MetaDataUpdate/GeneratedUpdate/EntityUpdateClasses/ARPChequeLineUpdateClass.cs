...
{
   public class ARPChequeLineUpdateClass
   {  
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ARPChequeLine",
			      				    DBTableName =  "ARPChequeLines",
			      				    ObjectTableSingular =  "ARPChequeLine",
			      				    ObjectTablePlural =  "ARPChequeLines",
			      				    ...
			      				    SortingByObjectField =  "PaymentId",
			      				    InActive =  false,
			      				    ...
			      				    Code =  "cbd6",
			      				    Name =  "ARPChequeLine Query Group",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldsRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						ValidForQuerySection1 =  "ARPChequeLine",
	    ...
	    {  
		   ObjectTable ARPChequeLineObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "ARPChequeLine" && d.Tenant == 0).FirstOrDefault(); 
		   Feature ARPChequeLineFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = ARPChequeLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ARPChequeLine.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);
		   Feature ARPChequeLineFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = ARPChequeLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ARPChequeLine.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);
		   Feature ARPChequeLineFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = ARPChequeLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ARPChequeLine.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);
		   Feature ARPChequeLineFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", ObjectTableId = ARPChequeLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ARPChequeLine.Features.PackageFeature", NameTextCodeDefaultText = "ARPChequeLine Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);    
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
				...
				IsManualEntry = false,
                LocalName = "Created",
                ObjectTableId = ARPChequeLineObjectTable.Id,
                ShortView = true,
