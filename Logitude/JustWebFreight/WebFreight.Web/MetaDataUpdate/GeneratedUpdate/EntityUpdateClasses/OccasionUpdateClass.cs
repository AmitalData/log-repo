   ...
   {  
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "OccasionStatusName",
					  						OldFieldName =  "OccasionStatusName",
					  						ObjectTableName =  "Occasion",
					  						FieldsDataType =  "nText",
					  						MinLength =  0,
					  						MaxLength =  100,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ParticipatedCustomers",
					  						OldFieldName =  "ParticipatedCustomers",
					  						ObjectTableName =  "Occasion",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ParticipatedContacts",
					  						OldFieldName =  "ParticipatedContacts",
					  						ObjectTableName =  "Occasion",
					  						FieldsDataType =  "Integer",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "RemovedOccasionInvitees",
					  						OldFieldName =  "removedOccasionInvitees",
					  						ObjectTableName =  "Occasion",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllOccasionsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 1, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 2, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "IndustryName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "IndustryName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 3, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "OccasionStatusName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "OccasionStatusName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 4, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "OwnerName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "OwnerName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 5, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "StartDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "StartDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 6, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "EndDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "EndDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 7, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 8, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 9, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "Location" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "Location" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id, IndexOrder = 10, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "Goal" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "Goal" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
