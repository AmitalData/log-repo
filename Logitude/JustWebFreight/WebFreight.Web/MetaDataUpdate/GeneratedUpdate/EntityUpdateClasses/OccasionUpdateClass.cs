   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllOccasionsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 0, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 250 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 1, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 2, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "IndustryName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "IndustryName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 3, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "OccasionStatusName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "OccasionStatusName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 4, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "OwnerName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "OwnerName" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 5, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "StartDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "StartDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 6, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "EndDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "EndDateTime" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 7, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 8, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 9, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "Location" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "Location" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllOccasionsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllOccasionsQuery.Id,QueryCode = AllOccasionsQuery.Code, IndexOrder = 10, ObjectFieldId = OccasionObjectFields.Where(d => d.FieldName == "Goal" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = OccasionObjectFields.Where(d => d.FieldName == "Goal" && d.ObjectTableId == OccasionObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "OCDI",HtmlComponentName = "",HtmlComponentUrl = "./CRMModules/CRMOccasion/Components/EditTabs/OccasionDocsInTabComponent", FeatureId = OccasionDocsInFeature_TH2.Id, ControlPath = "./CRMModules/CRMOccasion/Components/EditTabs/OccasionDocsInTabComponent", ObjectTableId = OccasionObjectTable.Id, TabNameTextCodeId = OccasionDocsInTextCode_TH2.Id, TabNameTextCodeCode = OccasionDocsInTextCode_TH2.Code, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "OCEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = OccasionEventsFeature_TH3.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = OccasionObjectTable.Id, TabNameTextCodeId = OccasionEventsTextCode_TH3.Id, TabNameTextCodeCode = OccasionEventsTextCode_TH3.Code, Tenant = 0, IndexOrder = 3 }, objectTableTabsRepository, TenantObjectTableTabs);
