   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllRevaluationsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id, IndexOrder = 1, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id, IndexOrder = 2, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id, IndexOrder = 3, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationEnabled" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id, IndexOrder = 4, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "ChartOfAccountsName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 170 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id, IndexOrder = 5, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "GLAccountName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
