   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllRevaluationsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id,QueryCode = AllRevaluationsQuery.Code, IndexOrder = 0, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationNumber" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationNumber" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id,QueryCode = AllRevaluationsQuery.Code, IndexOrder = 1, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id,QueryCode = AllRevaluationsQuery.Code, IndexOrder = 2, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id,QueryCode = AllRevaluationsQuery.Code, IndexOrder = 3, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationEnabled" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationEnabled" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id,QueryCode = AllRevaluationsQuery.Code, IndexOrder = 4, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "ChartOfAccountsName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "ChartOfAccountsName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 170 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllRevaluationsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRevaluationsQuery.Id,QueryCode = AllRevaluationsQuery.Code, IndexOrder = 5, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "GLAccountName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "GLAccountName" && d.ObjectTableId == RevaluationObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> RevaluationObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Revaluation").ToList();
            ...
            ScreenField RevaluationRevaluationRevaluationDetailsScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationNumber").FirstOrDefault().Id, ScreenId = RevaluationRevaluationDetailsScreenScreen0.Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField RevaluationRevaluationRevaluationDetailsScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationDate").FirstOrDefault().Id, ScreenId = RevaluationRevaluationDetailsScreenScreen0.Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField RevaluationRevaluationRevaluationDetailsScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationEnabled").FirstOrDefault().Id, ScreenId = RevaluationRevaluationDetailsScreenScreen0.Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "RevaluationEnabled").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField RevaluationRevaluationRevaluationDetailsScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "ChartOfAccountsId").FirstOrDefault().Id, ScreenId = RevaluationRevaluationDetailsScreenScreen0.Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "ChartOfAccountsId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField RevaluationRevaluationRevaluationDetailsScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = RevaluationObjectFields.Where(d => d.FieldName == "GLAccountId").FirstOrDefault().Id, ScreenId = RevaluationRevaluationDetailsScreenScreen0.Id, ObjectFieldCode = RevaluationObjectFields.Where(d => d.FieldName == "GLAccountId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "REVD",HtmlComponentName = "RevaluationDetailsComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/Revaluation/RevaluationDetailsComponent", FeatureId = RevaluationDetailsFeature_TH0.Id, ControlPath = "Logitude.Accounting.ViewModels.Tabs.REV.RevaluationDetailsTabControl", ObjectTableId = RevaluationObjectTable.Id, TabNameTextCodeId = RevaluationDetailsTextCode_TH0.Id, TabNameTextCodeCode = RevaluationDetailsTextCode_TH0.Code, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "RVEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = RevaluationEventsFeature_TH1.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = RevaluationObjectTable.Id, TabNameTextCodeId = RevaluationEventsTextCode_TH1.Id, TabNameTextCodeCode = RevaluationEventsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
