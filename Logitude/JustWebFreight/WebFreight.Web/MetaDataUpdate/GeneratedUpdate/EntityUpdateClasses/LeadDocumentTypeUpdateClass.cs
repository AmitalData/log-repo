...
{
   public class LeadDocumentTypeUpdateClass
   {  		
		public const string HashString = "070155667c180191895b2d44f327d99b";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.LeadDocumentType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.LeadDocumentTypes",
			      				    ObjectTableSingular =  "Customs.LeadDocumentType",
			      				    ObjectTablePlural =  "Customs.LeadDocumentTypes",
			      				    ...
			      				    DefaultText =  "Lead Document Type",
			      				    Code =  "LEDT",
			      				    Name =  "Customs.LeadDocumentType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  LeadDocumentTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.LeadDocumentType",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						DependencyFilter3IsList =  false,
					  						ValidForQuerySection1 =  "Customs.LeadDocumentType",
					  						ValidForQuerySection2 =  "Customs.LeadDocumentTypeFollowUp",
					  						IsRestrictable =  false,
					  						DisplayInEntityVariables =  true,
					  						AllowedInCustomerFieldsSettings =  false,
					  						DisplayInSearchWindowFilters =  false,
	    ...
	    {  
	        ...
	        QueryGroup LeadDocumentTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "LEDT", Name = "Customs.LeadDocumentType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup LeadDocumentTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "459a", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> LeadDocumentTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.LeadDocumentType").ToList();
	         ...
	         Screen LeadDocumentTypeCustomsLeadDocumentTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "LeadDocumentType.HeaderScreen", Name = "Customs.LeadDocumentTypeHeaderScreen", ObjectTableId = LeadDocumentTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    LeadDocumentTypeObjectTable.HeaderScreenId = LeadDocumentTypeCustomsLeadDocumentTypeHeaderScreenScreen0.Id;
		    LeadDocumentTypeObjectTable.HeaderScreenCode = LeadDocumentTypeCustomsLeadDocumentTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = LeadDocumentTypeObjectTable.Id,
