...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "c20074832925423e423ecef03ef17f71";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CommercialSale",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CommercialSaleUpdateClass.HashString,
	    ...
	    {  
	        ...
	        QueryGroup CommercialSaleQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "2177", Name = "Customs.CommercialSale Query Group" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CommercialSaleQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "7cbd", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
				        queryGroupRepository.SubmitChanges();
	        ObjectTable CommercialSaleObjectTable = objectTables.ContainsKey("Customs.CommercialSale") ? objectTables["Customs.CommercialSale"] : null;
            if (CommercialSaleObjectTable == null)
            {
                IWebFreightContext objectContext = WebFreightContext.GetContext(0);  

                CommercialSaleObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.CommercialSale" && d.Tenant == 0).FirstOrDefault();
            }
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CommercialSaleTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommercialSale.Q.CommercialSale", DefaultText = @"CommercialSaleQuery",LocalDefaultText = null, ObjectTableId = CommercialSaleObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature CommercialSaleFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CommercialSale.Q.CommercialSale", ObjectTableId = CommercialSaleObjectTable.Id, Tenant = 0, NameTextCodeCode = "CommercialSale.Features.CommercialSale", NameTextCodeDefaultText = "CommercialSale", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CommercialSaleObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> CommercialSaleObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CommercialSale").ToList();
	         ...
	         Screen CommercialSaleCustomsCommercialSaleHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CommercialSale.HeaderScreen", Name = "Customs.CommercialSaleHeaderScreen", ObjectTableId = CommercialSaleObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CommercialSaleObjectTable.HeaderScreenId = CommercialSaleCustomsCommercialSaleHeaderScreenScreen0.Id;
		    CommercialSaleObjectTable.HeaderScreenCode = CommercialSaleCustomsCommercialSaleHeaderScreenScreen0.Code;
