   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CommercialSaleTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommercialSale.Q.CommercialSale", DefaultText = @"CommercialSaleQuery",LocalDefaultText = null, ObjectTableId = CommercialSaleObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CommercialSaleFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CommercialSale.Q.CommercialSale", ObjectTableId = CommercialSaleObjectTable.Id, Tenant = 0, NameTextCodeCode = "CommercialSale.Features.CommercialSale", NameTextCodeDefaultText = "CommercialSale", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CommercialSaleObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query CommercialSaleQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CommercialSaleTextCode_0.Id, NameTextCodeCode = CommercialSaleTextCode_0.Code, ObjectTableName = "Customs.CommercialSale", Code = "CommercialSale",  QueryGroupCode = "2177", IndexOrder = 0, Tenant = 0, ObjectTableId = CommercialSaleObjectTable.Id, QuerySection = "Customs.CommercialSale", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CommercialSaleFeature_0.Id,FeatureUniqeCode= CommercialSaleFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CommercialSaleQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommercialSaleQuery.Id,QueryCode = CommercialSaleQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CommercialSale.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn CommercialSaleQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommercialSaleQuery.Id,QueryCode = CommercialSaleQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CommercialSale.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CommercialSaleQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CommercialSaleQuery.Id,QueryCode = CommercialSaleQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CommercialSale.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
