...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "0d5b303b94726435002889906d665ada";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "PaymentCheque",
			      				    ...
			      				    LocalDefaultText =  "המחםה",
			      				    DefaultText =  "Payment Cheque",
			      				    NewButtonLocalDefaultText =  "המחםה",
			      				    Code =  "d25b",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PayToGLAccountId",
					  						...
					  						NavigationPropertyName =  "PayToGLAccount",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "BankAccountGLAccountId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "GLAccount",
					  						NavigationPropertyName =  "BankAccountGLAccount",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CancelledByUserId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "User",
					  						NavigationPropertyName =  "CancelledByUser",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PaymentChequeStatusCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "PaymentChequeStatus",
					  						NavigationPropertyName =  "PaymentChequeStatus",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PaymentChequeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentCheque.Q.AllPaymentCheques", DefaultText = @"Payment Cheques",LocalDefaultText = "המחםות לתשלום", ObjectTableId = PaymentChequeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature PaymentChequeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "PaymentCheque.Q.AllPaymentCheques", ObjectTableId = PaymentChequeObjectTable.Id, Tenant = 0, NameTextCodeCode = "PaymentCheque.Features.AllPaymentCheques", NameTextCodeDefaultText = "AllPaymentCheques", FeatureTypeCode = "QUER", Packagable = false }, TenantFeatures, textCodes,PaymentChequeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query AllPaymentChequesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = PaymentChequeTextCode_0.Id, NameTextCodeCode = PaymentChequeTextCode_0.Code, ObjectTableName = "PaymentCheque", Code = "AllPaymentCheques",  QueryGroupCode = "d25b", IndexOrder = 0, Tenant = 0, ObjectTableId = PaymentChequeObjectTable.Id, QuerySection = "PaymentCheque", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = PaymentChequeFeature_0.Id,FeatureUniqeCode= PaymentChequeFeature_0.FeatureUniqeCode, DefaultSortName = "CreateDate", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllPaymentChequesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "PaymentCheque.CreateDate" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "PaymentCheque.APPaymentNo" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "PaymentCheque.ChequeNumber" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "PaymentCheque.GLAccountNumber" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "PaymentCheque.PayToName" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "PaymentCheque.BankAccountName" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "PaymentCheque.LocalAmount" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "PaymentCheque.InternalNumber" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPaymentChequesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "PaymentCheque.PaymentChequeStatusName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PaymentChequeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PaymentCheque").ToList();
	         ...
	         Screen PaymentChequePaymentChequeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PaymentCheque.PaymentChequeHeaderScreen", Name = "PaymentChequeHeaderScreen", ObjectTableId = PaymentChequeObjectTable.Id, NumberOfColumns = 5, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField PaymentChequePaymentChequePaymentChequeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = PaymentChequePaymentChequeHeaderScreenScreen0.Id,ScreenCode = PaymentChequePaymentChequeHeaderScreenScreen0.Code, ObjectFieldCode = "PaymentCheque.ChequeNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PaymentChequePaymentChequePaymentChequeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = PaymentChequePaymentChequeHeaderScreenScreen0.Id,ScreenCode = PaymentChequePaymentChequeHeaderScreenScreen0.Code, ObjectFieldCode = "PaymentCheque.GLAccountName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PaymentChequePaymentChequePaymentChequeHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ScreenId = PaymentChequePaymentChequeHeaderScreenScreen0.Id,ScreenCode = PaymentChequePaymentChequeHeaderScreenScreen0.Code, ObjectFieldCode = "PaymentCheque.PaymentChequeStatusCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PaymentChequePaymentChequePaymentChequeHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ScreenId = PaymentChequePaymentChequeHeaderScreenScreen0.Id,ScreenCode = PaymentChequePaymentChequeHeaderScreenScreen0.Code, ObjectFieldCode = "PaymentCheque.JournalId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode PaymentChequeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentCheque.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = PaymentChequeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature PaymentChequeGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "PaymentCheque.Tab.General", ObjectTableId = PaymentChequeObjectTable.Id, Tenant = 0, NameTextCodeCode = "PaymentCheque.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,PaymentChequeObjectTable,contextTenant);
 
                 
			   TextCode PaymentChequeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentCheque.TH.Events", DefaultText = "Events",LocalDefaultText = "םירועים", ObjectTableId = PaymentChequeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
