   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllPaymentChequesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 0, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 1, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "ChequeNumber" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "ChequeNumber" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 2, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "GLAccountNumber" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "GLAccountNumber" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 3, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "PayToName" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "PayToName" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 4, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "BankAccountName" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "BankAccountName" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 5, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "LocalAmount" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "LocalAmount" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 6, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "InternalNumber" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "InternalNumber" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPaymentChequesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPaymentChequesQuery.Id,QueryCode = AllPaymentChequesQuery.Code, IndexOrder = 7, ObjectFieldId = PaymentChequeObjectFields.Where(d => d.FieldName == "PaymentChequeStatusName" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PaymentChequeObjectFields.Where(d => d.FieldName == "PaymentChequeStatusName" && d.ObjectTableId == PaymentChequeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
