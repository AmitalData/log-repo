   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode FaultInspectionTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.FaultInspectionType.Q.FaultInspectionTypeQuery", DefaultText = @"Fault Inspection Type",LocalDefaultText = "סוג בקורת בליקוי", ObjectTableId = FaultInspectionTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature FaultInspectionTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "FAULTINSPECTIONTYPE", ObjectTableId = FaultInspectionTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.FaultInspectionType.Features.FaultInspectionType", NameTextCodeDefaultText = "Fault Inspection Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,FaultInspectionTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query FaultInspectionTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = FaultInspectionTypeTextCode_0.Id, NameTextCodeCode = FaultInspectionTypeTextCode_0.Code, ObjectTableName = "Customs.FaultInspectionType", Code = "FaultInspectionType",  QueryGroupCode = "FIQG", IndexOrder = 0, Tenant = 0, ObjectTableId = FaultInspectionTypeObjectTable.Id, QuerySection = "Customs.FaultInspectionType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = FaultInspectionTypeFeature_0.Id,FeatureUniqeCode= FaultInspectionTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn FaultInspectionTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FaultInspectionTypeQuery.Id,QueryCode = FaultInspectionTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.FaultInspectionType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn FaultInspectionTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FaultInspectionTypeQuery.Id,QueryCode = FaultInspectionTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.FaultInspectionType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn FaultInspectionTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FaultInspectionTypeQuery.Id,QueryCode = FaultInspectionTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.FaultInspectionType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn FaultInspectionTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = FaultInspectionTypeQuery.Id,QueryCode = FaultInspectionTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.FaultInspectionType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
