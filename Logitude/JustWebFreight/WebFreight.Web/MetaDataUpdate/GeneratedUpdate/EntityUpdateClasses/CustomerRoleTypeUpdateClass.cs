   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomerRoleTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomerRoleType.Q.CUSTOMERROLETYPE", DefaultText = @"CustomerRoleType",LocalDefaultText = "Customer Role Types", ObjectTableId = CustomerRoleTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CustomerRoleTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomerRoleType.Q.CUSTOMERROLETYPE", ObjectTableId = CustomerRoleTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomerRoleTypeFeatures.CUSTOMERROLETYPE", NameTextCodeDefaultText = "CUSTOMERROLETYPE", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CustomerRoleTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query CUSTOMERROLETYPEQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomerRoleTypeTextCode_0.Id, NameTextCodeCode = CustomerRoleTypeTextCode_0.Code, ObjectTableName = "Customs.CustomerRoleType", Code = "CUSTOMERROLETYPE",  QueryGroupCode = "5e88", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomerRoleTypeObjectTable.Id, QuerySection = "Customs.CustomerRoleType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CustomerRoleTypeFeature_0.Id,FeatureUniqeCode= CustomerRoleTypeFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CUSTOMERROLETYPEQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CUSTOMERROLETYPEQuery.Id,QueryCode = CUSTOMERROLETYPEQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomerRoleType.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CUSTOMERROLETYPEQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CUSTOMERROLETYPEQuery.Id,QueryCode = CUSTOMERROLETYPEQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomerRoleType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CUSTOMERROLETYPEQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CUSTOMERROLETYPEQuery.Id,QueryCode = CUSTOMERROLETYPEQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomerRoleType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CUSTOMERROLETYPEQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CUSTOMERROLETYPEQuery.Id,QueryCode = CUSTOMERROLETYPEQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomerRoleType.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
