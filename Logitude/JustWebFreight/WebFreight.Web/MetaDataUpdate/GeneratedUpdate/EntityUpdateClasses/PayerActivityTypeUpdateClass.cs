   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> PayerActivityTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PayerActivityType").ToList();
	         ...
	         Screen PayerActivityTypeCustomsPayerActivityTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PayerActivityType.HeaderScreen", Name = "Customs.PayerActivityTypeHeaderScreen", ObjectTableId = PayerActivityTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
