   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ContactRoleTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ContactRoleType.Q.ContactRoleTypeQuery", DefaultText = @"Contact Role Types",LocalDefaultText = "איש קשר - תפקיד", ObjectTableId = ContactRoleTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query ContactRoleTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ContactRoleTypeTextCode_0.Id, NameTextCodeCode = ContactRoleTypeTextCode_0.Code, ObjectTableName = "Customs.ContactRoleType", Code = "ContactRoleType",  QueryGroupCode = "CORT", IndexOrder = 0, Tenant = 0, ObjectTableId = ContactRoleTypeObjectTable.Id, QuerySection = "Customs.ContactRoleType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ContactRoleTypeFeature_0.Id,FeatureUniqeCode= ContactRoleTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ContactRoleTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ContactRoleTypeQuery.Id,QueryCode = ContactRoleTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ContactRoleType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ContactRoleTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ContactRoleTypeQuery.Id,QueryCode = ContactRoleTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ContactRoleType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ContactRoleTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ContactRoleTypeQuery.Id,QueryCode = ContactRoleTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ContactRoleType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ContactRoleTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ContactRoleTypeQuery.Id,QueryCode = ContactRoleTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ContactRoleType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ContactRoleTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ContactRoleType").ToList();
	         ...
	         Screen ContactRoleTypeCustomsContactRoleTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ContactRoleType.HeaderScreen", Name = "Customs.ContactRoleTypeHeaderScreen", ObjectTableId = ContactRoleTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
