   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SubCountryTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SubCountry.Q.SubCountryQuery", DefaultText = @"Sub Countries",LocalDefaultText = "תת מדינה", ObjectTableId = SubCountryObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature SubCountryFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SUBCOUNTRY", ObjectTableId = SubCountryObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.SubCountry.Features.SubCountries", NameTextCodeDefaultText = "Sub Countries", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,SubCountryObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query SubCountryQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = SubCountryTextCode_0.Id, NameTextCodeCode = SubCountryTextCode_0.Code, ObjectTableName = "Customs.SubCountry", Code = "SubCountry",  QueryGroupCode = "SUCO", IndexOrder = 0, Tenant = 0, ObjectTableId = SubCountryObjectTable.Id, QuerySection = "Customs.SubCountry", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = SubCountryFeature_0.Id,FeatureUniqeCode= SubCountryFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn SubCountryQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SubCountryQuery.Id,QueryCode = SubCountryQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.SubCountry.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SubCountryQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SubCountryQuery.Id,QueryCode = SubCountryQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.SubCountry.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SubCountryQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SubCountryQuery.Id,QueryCode = SubCountryQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.SubCountry.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn SubCountryQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SubCountryQuery.Id,QueryCode = SubCountryQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.SubCountry.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> SubCountryObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SubCountry").ToList();
	         ...
	         Screen SubCountryCustomsSubCountryHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SubCountry.HeaderScreen", Name = "Customs.SubCountryHeaderScreen", ObjectTableId = SubCountryObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
