...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "298076c3419ac9de0f6d20e8ba9c0cea";
	    ...
	    {  
	        ...
	        QueryGroup SubCountryQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "SUCO", Name = "Customs.SubCountry" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup SubCountryQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "96c5", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SubCountryTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.SubCountry.Q.SubCountryQuery", DefaultText = @"Sub Countries",LocalDefaultText = "תת מדינה", ObjectTableId = SubCountryObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature SubCountryFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SUBCOUNTRY", ObjectTableId = SubCountryObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.SubCountry.Features.SubCountries", NameTextCodeDefaultText = "Sub Countries", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,SubCountryObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> SubCountryObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SubCountry").ToList();
	         ...
	         Screen SubCountryCustomsSubCountryHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SubCountry.HeaderScreen", Name = "Customs.SubCountryHeaderScreen", ObjectTableId = SubCountryObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    SubCountryObjectTable.HeaderScreenId = SubCountryCustomsSubCountryHeaderScreenScreen0.Id;
		    SubCountryObjectTable.HeaderScreenCode = SubCountryCustomsSubCountryHeaderScreenScreen0.Code;
