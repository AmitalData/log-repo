   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn RequestReasonCodeEnumQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestReasonCodeEnumQuery.Id,QueryCode = RequestReasonCodeEnumQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.RequestReasonCodeEnum.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn RequestReasonCodeEnumQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestReasonCodeEnumQuery.Id,QueryCode = RequestReasonCodeEnumQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.RequestReasonCodeEnum.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn RequestReasonCodeEnumQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestReasonCodeEnumQuery.Id,QueryCode = RequestReasonCodeEnumQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.RequestReasonCodeEnum.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn RequestReasonCodeEnumQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = RequestReasonCodeEnumQuery.Id,QueryCode = RequestReasonCodeEnumQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.RequestReasonCodeEnum.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
