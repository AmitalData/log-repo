...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "b0661e2cfa83a7d4c590caa4bb9ed8cc";
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CheckEntityTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CheckEntityTypes.Q.CheckEntityTypesQuery", DefaultText = @"Check Entity Types",LocalDefaultText = "בדקו סוגי ישות", ObjectTableId = CheckEntityTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature CheckEntityTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CHECKENTITYTYPE", ObjectTableId = CheckEntityTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.CheckEntityType.Features.Read", NameTextCodeDefaultText = "Check Entity Type", FeatureTypeCode = "QUER", Packagable = false }, TenantFeatures, textCodes,CheckEntityTypeObjectTable, addedFeatures, addedTextCodes);
