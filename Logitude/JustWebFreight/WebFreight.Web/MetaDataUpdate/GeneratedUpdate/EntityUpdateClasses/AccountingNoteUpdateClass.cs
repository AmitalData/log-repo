   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllNotesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AccountingNoteTextCode_0.Id, NameTextCodeCode = AccountingNoteTextCode_0.Code, Code = "AllNotes",  QueryGroupCode = "9417", IndexOrder = 0, Tenant = 0, ObjectTableId = AccountingNoteObjectTable.Id, QuerySection = "AccountingNote", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AccountingNoteFeature_0.Id, DefaultSortName = "CreateDate", DefaultSortDirection = "Desending", Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllNotesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id,QueryCode = AllNotesQuery.Code, IndexOrder = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 143 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllNotesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id,QueryCode = AllNotesQuery.Code, IndexOrder = 1, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 154 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllNotesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id,QueryCode = AllNotesQuery.Code, IndexOrder = 2, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 454 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> AccountingNoteObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AccountingNote").ToList();
            ...
            ScreenField AccountingNoteAccountingNoteHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().Id, ScreenId = AccountingNoteAccountingNoteHeaderScreenScreen0.Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingNoteAccountingNoteHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate").FirstOrDefault().Id, ScreenId = AccountingNoteAccountingNoteHeaderScreenScreen0.Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingNoteAccountingNoteHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "CreatedByUserId").FirstOrDefault().Id, ScreenId = AccountingNoteAccountingNoteHeaderScreenScreen0.Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "CreatedByUserId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
