...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "450689882b399712bce2d360c77a9b23";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "AccountingNote",
			      				    ...
			      				    OldDBTableName =  "AccountingNotes",
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllNotesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id,QueryCode = AllNotesQuery.UniqueCode, IndexOrder = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 143 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllNotesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id,QueryCode = AllNotesQuery.UniqueCode, IndexOrder = 1, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 154 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllNotesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id,QueryCode = AllNotesQuery.UniqueCode, IndexOrder = 2, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 454 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> AccountingNoteObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AccountingNote").ToList();
            ...
            ScreenField AccountingNoteAccountingNoteHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().Id, ScreenId = AccountingNoteAccountingNoteHeaderScreenScreen0.Id,ScreenCode = AccountingNoteAccountingNoteHeaderScreenScreen0.Code, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingNoteAccountingNoteHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate").FirstOrDefault().Id, ScreenId = AccountingNoteAccountingNoteHeaderScreenScreen0.Id,ScreenCode = AccountingNoteAccountingNoteHeaderScreenScreen0.Code, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
