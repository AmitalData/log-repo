   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllNotesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id, IndexOrder = 0, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 143 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllNotesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id, IndexOrder = 1, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 154 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllNotesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllNotesQuery.Id, IndexOrder = 2, ObjectFieldId = AccountingNoteObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingNoteObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingNoteObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 454 }, queryColumnsRepository, tenantQueryColumns);
