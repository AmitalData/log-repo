...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "bd527673de0f590a95d20d8fc083ea5a";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuoteOPProperties",
			      				    IsNew =  true,
			      				    DBTableName =  "QuoteOPPropertiess",
			      				    ObjectTableSingular =  "QuoteOPProperties",
			      				    ObjectTablePlural =  "QuoteOPPropertiess",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  QuoteOPPropertiesUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						ValidForQuerySection1 =  "QuoteOPProperties",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "QuoteID",
					  						...
					  						DependencyFilter2IsList =  false,
					  						DependencyFilter3IsList =  false,
					  						ValidForQuerySection1 =  "QuoteProperties",
					  						IsRestrictable =  false,
					  						DisplayInEntityVariables =  false,
					  						AllowedInCustomerFieldsSettings =  false,
					  						DisplayInSearchWindowFilters =  false,
					  						...
					  						DefaultText =  "Quote ID",
					  						ListFieldLable =  "QuoteIDListLable",
					  						ListLableDefaultText =  "Quote ID",
					  						ListLocalDefaultText =  "Quote ID",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "FromPortId",
					  						...
					  						FullLocalDefaultText =  "Gateway / Loading Port",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ToPortId",
					  						...
					  						DefaultText =  "To Port",
					  						FullLocalDefaultText =  "Destination / Discharge Port",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IncotermId",
					  						...
					  						DefaultText =  "Incoterms",
					  						FullLocalDefaultText =  "Incoterms",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SpecialServiceID",
					  						...
					  						FullLocalDefaultText =  "Special Service",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "MainCarriageCarrierId",
					  						...
					  						FullLocalDefaultText =  "Airline / Shipping Line",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
	    ...
	    {   
		   ...
		   //List<ObjectField> QuoteOPPropertiesObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "QuoteOPProperties").ToList();
		       
	      

	         Screen QuoteOPPropertiesQuoteOPPropertiesHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "QuoteOPProperties.HeaderScreen", Name = "QuoteOPPropertiesHeaderScreen", ObjectTableId = QuoteOPPropertiesObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    QuoteOPPropertiesObjectTable.HeaderScreenId = QuoteOPPropertiesQuoteOPPropertiesHeaderScreenScreen0.Id;
		    QuoteOPPropertiesObjectTable.HeaderScreenCode = QuoteOPPropertiesQuoteOPPropertiesHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = QuoteOPPropertiesObjectTable.Id,
