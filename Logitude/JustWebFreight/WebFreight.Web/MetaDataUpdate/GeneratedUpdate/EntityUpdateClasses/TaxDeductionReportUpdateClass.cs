   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ALLTaxDeductionReportsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTaxDeductionReportsQuery.Id,QueryCode = ALLTaxDeductionReportsQuery.Code, IndexOrder = 0, ObjectFieldId = TaxDeductionReportObjectFields.Where(d => d.FieldName == "TaxYear" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxDeductionReportObjectFields.Where(d => d.FieldName == "TaxYear" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTaxDeductionReportsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTaxDeductionReportsQuery.Id,QueryCode = ALLTaxDeductionReportsQuery.Code, IndexOrder = 1, ObjectFieldId = TaxDeductionReportObjectFields.Where(d => d.FieldName == "CreatedByUser" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxDeductionReportObjectFields.Where(d => d.FieldName == "CreatedByUser" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTaxDeductionReportsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTaxDeductionReportsQuery.Id,QueryCode = ALLTaxDeductionReportsQuery.Code, IndexOrder = 2, ObjectFieldId = TaxDeductionReportObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxDeductionReportObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ALLTaxDeductionReportsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLTaxDeductionReportsQuery.Id,QueryCode = ALLTaxDeductionReportsQuery.Code, IndexOrder = 3, ObjectFieldId = TaxDeductionReportObjectFields.Where(d => d.FieldName == "Status" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TaxDeductionReportObjectFields.Where(d => d.FieldName == "Status" && d.ObjectTableId == TaxDeductionReportObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);
