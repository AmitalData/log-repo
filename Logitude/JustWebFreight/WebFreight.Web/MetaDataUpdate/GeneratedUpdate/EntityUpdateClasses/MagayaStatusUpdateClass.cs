   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "MagayaStatus",
			      				    IsNew =  true,
			      				    DBTableName =  "MagayaStatuses",
			      				    ObjectTableSingular =  "MagayaStatus",
			      				    ObjectTablePlural =  "MagayaStatuses",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  MagayaStatusUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "StatusCode",
					  						...
					  						ValidForQuerySection1 =  "MagayaStatus",
					  						IsRestrictable =  false,
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = MagayaStatusObjectTable.Id,
	    ...
	    public void FillMagayaStatus()
        { 
            var repo = new MagayaStatusRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.StatusCode, rec => rec);
            new FillCloseTables().FillCloseTable<
                                MagayaStatus,
                                MagayaStatusDetails,
                                MagayaStatusRepository>(repo, dic);
        }
