...
{
   public class OpportunityAdditionalServiceUpdateClass
   {  		
		public const string HashString = "b8f425c7ebd5a9352b8c6f6a1432d842";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "OpportunityAdditionalService",
			      				    DBTableName =  "OpportunityAdditionalServices",
			      				    ObjectTableSingular =  "Opportunity Additional Service",
			      				    ObjectTablePlural =  "Opportunity Additional Services",
			      				    ...
			      				    DefaultText =  "Opportunity Additional Service",
			      				    Code =  "7ba7",
			      				    Name =  "OpportunityAdditionalService Query Group",
			      				    GenerateDomainService =  false,
			      				    HashString =  OpportunityAdditionalServiceUpdateClass.HashString,
	    ...
	    {   
			ObjectTable OpportunityAdditionalServiceObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "OpportunityAdditionalService" && d.Tenant == 0).FirstOrDefault(); 
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = OpportunityAdditionalServiceObjectTable.Id,
