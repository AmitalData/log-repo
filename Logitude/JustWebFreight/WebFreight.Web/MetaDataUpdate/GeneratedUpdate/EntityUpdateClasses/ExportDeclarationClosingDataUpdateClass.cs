   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> ExportDeclarationClosingDataObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ExportDeclarationClosingData").ToList();
	         ...
	         Screen ExportDeclarationClosingDataCustomsExportDeclarationClosingDataHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ExportDeclarationClosingData.HeaderScreen", Name = "Customs.ExportDeclarationClosingDataHeaderScreen", ObjectTableId = ExportDeclarationClosingDataObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
