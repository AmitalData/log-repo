...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "b83432a8eb4762643db20959d089ae48";
	    ...
	    {  
	        ...
	        QueryGroup OrganizationUnitTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "ORUT", Name = "Customs.OrganizationUnitType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup OrganizationUnitTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "024e", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> OrganizationUnitTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.OrganizationUnitType").ToList();
	         ...
	         Screen OrganizationUnitTypeCustomsOrganizationUnitTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "OrganizationUnitType.HeaderScreen", Name = "Customs.OrganizationUnitTypeHeaderScreen", ObjectTableId = OrganizationUnitTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    OrganizationUnitTypeObjectTable.HeaderScreenId = OrganizationUnitTypeCustomsOrganizationUnitTypeHeaderScreenScreen0.Id;
		    OrganizationUnitTypeObjectTable.HeaderScreenCode = OrganizationUnitTypeCustomsOrganizationUnitTypeHeaderScreenScreen0.Code;
