   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CountryGroupTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CountryGroup.Q.CountryGroupQuery", DefaultText = @"Country Groups",LocalDefaultText = "קבוצות מדינה", ObjectTableId = CountryGroupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query CountryGroupQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CountryGroupTextCode_0.Id, NameTextCodeCode = CountryGroupTextCode_0.Code, ObjectTableName = "Customs.CountryGroup", Code = "CountryGroup",  QueryGroupCode = "COGR", IndexOrder = 0, Tenant = 0, ObjectTableId = CountryGroupObjectTable.Id, QuerySection = "Customs.CountryGroup", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CountryGroupFeature_0.Id,FeatureUniqeCode= CountryGroupFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CountryGroupQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryGroupQuery.Id,QueryCode = CountryGroupQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CountryGroup.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CountryGroupQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryGroupQuery.Id,QueryCode = CountryGroupQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CountryGroup.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CountryGroupQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryGroupQuery.Id,QueryCode = CountryGroupQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CountryGroup.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CountryGroupQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryGroupQuery.Id,QueryCode = CountryGroupQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CountryGroup.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CountryGroupObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CountryGroup").ToList();
	         ...
	         Screen CountryGroupCustomsCountryGroupHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CountryGroup.HeaderScreen", Name = "Customs.CountryGroupHeaderScreen", ObjectTableId = CountryGroupObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
