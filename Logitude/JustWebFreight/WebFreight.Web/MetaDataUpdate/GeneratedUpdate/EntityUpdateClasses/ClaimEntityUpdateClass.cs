   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ClaimEntityTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ClaimEntity.Q.ClaimEntity", DefaultText = @"ClaimEntityQuery",LocalDefaultText = null, ObjectTableId = ClaimEntityObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ClaimEntityFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ClaimEntity.Q.ClaimEntity", ObjectTableId = ClaimEntityObjectTable.Id, Tenant = 0, NameTextCodeCode = "ClaimEntity.Features.ClaimEntity", NameTextCodeDefaultText = "ClaimEntity", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ClaimEntityObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ClaimEntityQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClaimEntityQuery.Id,QueryCode = ClaimEntityQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ClaimEntity.Code" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn ClaimEntityQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClaimEntityQuery.Id,QueryCode = ClaimEntityQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ClaimEntity.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ClaimEntityQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClaimEntityQuery.Id,QueryCode = ClaimEntityQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ClaimEntity.Inactive" , ColumnWidth = 20 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ClaimEntityObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ClaimEntity").ToList();
	         ...
	         Screen ClaimEntityCustomsClaimEntityHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ClaimEntity.HeaderScreen", Name = "Customs.ClaimEntityHeaderScreen", ObjectTableId = ClaimEntityObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
