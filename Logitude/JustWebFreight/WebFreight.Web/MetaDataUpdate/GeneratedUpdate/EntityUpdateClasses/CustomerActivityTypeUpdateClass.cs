   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CustomerActivityTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerActivityTypeQuery.Id,QueryCode = CustomerActivityTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomerActivityType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerActivityTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerActivityTypeQuery.Id,QueryCode = CustomerActivityTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomerActivityType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerActivityTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerActivityTypeQuery.Id,QueryCode = CustomerActivityTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomerActivityType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomerActivityTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomerActivityTypeQuery.Id,QueryCode = CustomerActivityTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomerActivityType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
