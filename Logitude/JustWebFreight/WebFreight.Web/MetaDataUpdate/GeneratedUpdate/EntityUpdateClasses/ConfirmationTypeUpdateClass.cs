...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "8a15ad513bc22994b4e79f8e8e400f3c";
	    ...
	    {  
	        ...
	        QueryGroup ConfirmationTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CONT", Name = "Customs.ConfirmationType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ConfirmationTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "a398", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
