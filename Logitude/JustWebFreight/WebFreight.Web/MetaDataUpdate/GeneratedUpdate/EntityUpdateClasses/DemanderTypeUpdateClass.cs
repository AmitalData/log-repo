...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "e59a40100d23e2caaa4b63c38b47d676";
	    ...
	    {  
	        ...
	        QueryGroup DemanderTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "DTQG", Name = "Customs.DemanderType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup DemanderTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "c6c6", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode DemanderTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DemanderType.Q.DemanderTypeQuery", DefaultText = @"Demander Type",LocalDefaultText = "סוגי דורשים", ObjectTableId = DemanderTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature DemanderTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DEMANDERTYPE", ObjectTableId = DemanderTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.DemanderType.Features.DemanderType", NameTextCodeDefaultText = "Demander Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,DemanderTypeObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> DemanderTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DemanderType").ToList();
	         ...
	         Screen DemanderTypeCustomsDemanderTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DemanderType.HeaderScreen", Name = "Customs.DemanderTypeHeaderScreen", ObjectTableId = DemanderTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    DemanderTypeObjectTable.HeaderScreenId = DemanderTypeCustomsDemanderTypeHeaderScreenScreen0.Id;
		    DemanderTypeObjectTable.HeaderScreenCode = DemanderTypeCustomsDemanderTypeHeaderScreenScreen0.Code;
