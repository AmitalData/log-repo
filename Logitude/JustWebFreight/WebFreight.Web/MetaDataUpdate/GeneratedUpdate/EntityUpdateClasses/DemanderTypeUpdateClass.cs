   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode DemanderTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DemanderType.Q.DemanderTypeQuery", DefaultText = @"Demander Type",LocalDefaultText = "סוגי דורשים", ObjectTableId = DemanderTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature DemanderTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DEMANDERTYPE", ObjectTableId = DemanderTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.DemanderType.Features.DemanderType", NameTextCodeDefaultText = "Demander Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,DemanderTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query DemanderTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = DemanderTypeTextCode_0.Id, NameTextCodeCode = DemanderTypeTextCode_0.Code, ObjectTableName = "Customs.DemanderType", Code = "DemanderType",  QueryGroupCode = "DTQG", IndexOrder = 0, Tenant = 0, ObjectTableId = DemanderTypeObjectTable.Id, QuerySection = "Customs.DemanderType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = DemanderTypeFeature_0.Id,FeatureUniqeCode= DemanderTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn DemanderTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DemanderTypeQuery.Id,QueryCode = DemanderTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.DemanderType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn DemanderTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DemanderTypeQuery.Id,QueryCode = DemanderTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.DemanderType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn DemanderTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DemanderTypeQuery.Id,QueryCode = DemanderTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.DemanderType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn DemanderTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DemanderTypeQuery.Id,QueryCode = DemanderTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.DemanderType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> DemanderTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DemanderType").ToList();
	         ...
	         Screen DemanderTypeCustomsDemanderTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DemanderType.HeaderScreen", Name = "Customs.DemanderTypeHeaderScreen", ObjectTableId = DemanderTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
