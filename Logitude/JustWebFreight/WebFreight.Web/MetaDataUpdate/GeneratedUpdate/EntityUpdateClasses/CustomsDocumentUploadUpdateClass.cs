   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsDocumentUploadObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsDocumentUpload").ToList();
	         ...
	         Screen CustomsDocumentUploadCustomsCustomsDocumentUploadHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsDocumentUpload.HeaderScreen", Name = "Customs.CustomsDocumentUploadHeaderScreen", ObjectTableId = CustomsDocumentUploadObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
