   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CustomDocumentTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomDocumentTypeQuery.Id,QueryCode = CustomDocumentTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomDocumentType.EnglishName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomDocumentTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomDocumentTypeQuery.Id,QueryCode = CustomDocumentTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomDocumentType.LocalName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomDocumentTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomDocumentTypeQuery.Id,QueryCode = CustomDocumentTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomDocumentType.Inactive" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomDocumentTypeQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomDocumentTypeQuery.Id,QueryCode = CustomDocumentTypeQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.CustomDocumentType.PointerLevelName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomDocumentTypeQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomDocumentTypeQuery.Id,QueryCode = CustomDocumentTypeQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.CustomDocumentType.AutoSetOriginalDocumentTrue" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomDocumentTypeQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomDocumentTypeQuery.Id,QueryCode = CustomDocumentTypeQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Customs.CustomDocumentType.IsCourierManadatory" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomDocumentTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomDocumentType").ToList();
	         ...
	         Screen CustomDocumentTypeGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomDocumentType.GeneralTabScreen", Name = "GeneralTabScreen", ObjectTableId = CustomDocumentTypeObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 7, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.PointerLevel", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.AutoSetOriginalDocumentTrue", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.IsCourierManadatory", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.IsDiamondManadatory", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomDocumentTypeCustomDocumentTypeGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ScreenId = CustomDocumentTypeGeneralTabScreenScreen0.Id,ScreenCode = CustomDocumentTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "Customs.CustomDocumentType.CustomsDocumentUpload", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CustomDocumentTypeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomDocumentType.TH.Events", DefaultText = "Events",LocalDefaultText = "םירועים", ObjectTableId = CustomDocumentTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
