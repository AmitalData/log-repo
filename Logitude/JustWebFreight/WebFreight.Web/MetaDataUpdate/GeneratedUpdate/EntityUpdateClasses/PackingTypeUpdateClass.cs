   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PackingTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.PackingType.Q.PackingTypeQuery", DefaultText = @"Packing Types",LocalDefaultText = "BS64:Iten15XXkyDXodeV15Ig15DXqNeZ15bXlCI=", ObjectTableId = PackingTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query PackingTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = PackingTypeTextCode_0.Id, NameTextCodeCode = PackingTypeTextCode_0.Code, ObjectTableName = "Customs.PackingType", Code = "PackingType",  QueryGroupCode = "PAKT", IndexOrder = 0, Tenant = 0, ObjectTableId = PackingTypeObjectTable.Id, QuerySection = "Customs.PackingType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = PackingTypeFeature_0.Id,FeatureUniqeCode= PackingTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn PackingTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackingTypeQuery.Id,QueryCode = PackingTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.PackingType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PackingTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackingTypeQuery.Id,QueryCode = PackingTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.PackingType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PackingTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackingTypeQuery.Id,QueryCode = PackingTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.PackingType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn PackingTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackingTypeQuery.Id,QueryCode = PackingTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.PackingType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PackingTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.PackingType").ToList();
	         ...
	         Screen PackingTypeCustomsPackingTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PackingType.HeaderScreen", Name = "Customs.PackingTypeHeaderScreen", ObjectTableId = PackingTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
