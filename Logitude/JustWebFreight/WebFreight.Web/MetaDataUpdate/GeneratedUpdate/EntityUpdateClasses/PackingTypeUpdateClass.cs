...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "96e93787592a6b3ad1644ee5698c0369";
	    ...
	    {  
	        ...
	        QueryGroup PackingTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "PAKT", Name = "Customs.PackingType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup PackingTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "b586", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
