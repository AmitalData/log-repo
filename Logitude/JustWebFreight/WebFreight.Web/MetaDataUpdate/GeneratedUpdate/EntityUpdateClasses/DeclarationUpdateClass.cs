...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "1a922737cae7228a12282d2dc055a528";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsExporterConfirmation",
					  						OldFieldName =  "IsExporterConfirmation",
					  						ObjectTableName =  "Customs.Declaration",
					  						FieldsDataType =  "Boolean",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DestinationCountryName",
					  						OldFieldName =  "DestinationCountryName",
					  						ObjectTableName =  "Customs.Declaration",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  300,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DeclarationExportRecipients",
					  						OldFieldName =  "DeclarationExportRecipients",
					  						ObjectTableName =  "Customs.Declaration",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DestinationCountryCode",
					  						OldFieldName =  "DestinationCountryCode",
					  						ObjectTableName =  "Customs.Declaration",
					  						FieldsDataType =  "LookUp",
					  						LookUpTableName =  "Customs.CustomsCountry",
					  						MinLength =  0,
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
             ...
             AdvancedQueryFilter PaidDeclarationQueryFilter_3 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Customs.Declaration.DeclarationDocumentTypeCode", PredefinedValue = "2",PredefinedValue2 = null, QueryId = PaidDeclarationQuery.Id,QueryCode = PaidDeclarationQuery.UniqueCode, Tenant = 0,Operator = "NotEqual"}, addedQueryFilters);
