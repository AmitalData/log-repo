   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode UnloadingSiteTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.UnloadingSiteType.Q.UnloadingSiteTypeQuery", DefaultText = @"Unloading Site Type",LocalDefaultText = "סוג האתר פריקה", ObjectTableId = UnloadingSiteTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature UnloadingSiteTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UNLOADINGSITETYPEQUERY", ObjectTableId = UnloadingSiteTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.UnloadingSiteType.Features.UnloadingSiteTypes", NameTextCodeDefaultText = "Unloading Site Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,UnloadingSiteTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query UnloadingSiteTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = UnloadingSiteTypeTextCode_0.Id, NameTextCodeCode = UnloadingSiteTypeTextCode_0.Code, ObjectTableName = "Customs.UnloadingSiteType", Code = "UnloadingSiteType",  QueryGroupCode = "USTG", IndexOrder = 0, Tenant = 0, ObjectTableId = UnloadingSiteTypeObjectTable.Id, QuerySection = "Customs.UnloadingSiteType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = UnloadingSiteTypeFeature_0.Id,FeatureUniqeCode= UnloadingSiteTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn UnloadingSiteTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UnloadingSiteTypeQuery.Id,QueryCode = UnloadingSiteTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.UnloadingSiteType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UnloadingSiteTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UnloadingSiteTypeQuery.Id,QueryCode = UnloadingSiteTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.UnloadingSiteType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UnloadingSiteTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UnloadingSiteTypeQuery.Id,QueryCode = UnloadingSiteTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.UnloadingSiteType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn UnloadingSiteTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = UnloadingSiteTypeQuery.Id,QueryCode = UnloadingSiteTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.UnloadingSiteType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
