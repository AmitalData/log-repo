...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "5926f410e7503a4ca5079e29786913b8";
	    ...
	    {  
	        ...
	        QueryGroup UnloadingSiteTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "USTG", Name = "Customs.UnloadingSiteTypes" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup UnloadingSiteTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "21df", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
