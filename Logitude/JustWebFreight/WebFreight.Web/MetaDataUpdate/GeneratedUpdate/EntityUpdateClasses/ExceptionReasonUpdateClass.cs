   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ExceptionReasonTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ExceptionReason.Q.AllReferantException", DefaultText = @"All Referant Exception",LocalDefaultText = "חריגות", ObjectTableId = ExceptionReasonObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ExceptionReasonFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ExceptionReason.Q.AllReferantException", ObjectTableId = ExceptionReasonObjectTable.Id, Tenant = 0, NameTextCodeCode = "ExceptionReasonFeatures.AllReferantException", NameTextCodeDefaultText = "AllReferantException", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ExceptionReasonObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllReferantExceptionQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllReferantExceptionQuery.Id,QueryCode = AllReferantExceptionQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ExceptionReason.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllReferantExceptionQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllReferantExceptionQuery.Id,QueryCode = AllReferantExceptionQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ExceptionReason.EnglishName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllReferantExceptionQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllReferantExceptionQuery.Id,QueryCode = AllReferantExceptionQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ExceptionReason.LocalName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllReferantExceptionQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllReferantExceptionQuery.Id,QueryCode = AllReferantExceptionQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ExceptionReason.IsActive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn AllReferantExceptionQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllReferantExceptionQuery.Id,QueryCode = AllReferantExceptionQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.ExceptionReason.UnifreightStatusCode" , ColumnWidth = 167 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ExceptionReasonObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ExceptionReason").ToList();
             ...
             ScreenField CustomsExceptionReasonCustomsExceptionReasonHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ExceptionReasonCustomsExceptionReasonHeaderScreenScreen0.Id,ScreenCode = ExceptionReasonCustomsExceptionReasonHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.ExceptionReason.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsExceptionReasonCustomsExceptionReasonHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = ExceptionReasonCustomsExceptionReasonHeaderScreenScreen0.Id,ScreenCode = ExceptionReasonCustomsExceptionReasonHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.ExceptionReason.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode ExceptionReasonGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ExceptionReason.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = ExceptionReasonObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature ExceptionReasonGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ExceptionReason.Tab.General", ObjectTableId = ExceptionReasonObjectTable.Id, Tenant = 0, NameTextCodeCode = "ExceptionReasonFeatures.ERGT", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,ExceptionReasonObjectTable,contextTenant);
 
                 
			   TextCode ExceptionReasonEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ExceptionReason.TH.Events", DefaultText = "Events",LocalDefaultText = "אירועים", ObjectTableId = ExceptionReasonObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
