...
{
   public class SalesTaxExemptionTypeUpdateClass
   {  		
		public const string HashString = "ef5b0935f264ad5145483bb5b235dcdd";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.SalesTaxExemptionType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.SalesTaxExemptionTypes",
			      				    ObjectTableSingular =  "Customs.SalesTaxExemptionType",
			      				    ObjectTablePlural =  "Customs.SalesTaxExemptionTypes",
			      				    ...
			      				    Code =  "STET",
			      				    Name =  "Customs.SalesTaxExemptionType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  SalesTaxExemptionTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.SalesTaxExemptionType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup SalesTaxExemptionTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "STET", Name = "Customs.SalesTaxExemptionType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup SalesTaxExemptionTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "3859", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> SalesTaxExemptionTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SalesTaxExemptionType").ToList();
	         ...
	         Screen SalesTaxExemptionTypeCustomsSalesTaxExemptionTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SalesTaxExemptionType.HeaderScreen", Name = "Customs.SalesTaxExemptionTypeHeaderScreen", ObjectTableId = SalesTaxExemptionTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    SalesTaxExemptionTypeObjectTable.HeaderScreenId = SalesTaxExemptionTypeCustomsSalesTaxExemptionTypeHeaderScreenScreen0.Id;
		    SalesTaxExemptionTypeObjectTable.HeaderScreenCode = SalesTaxExemptionTypeCustomsSalesTaxExemptionTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = SalesTaxExemptionTypeObjectTable.Id,
