...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "3d6fe08e1d46e0cae0f485ba4bee40d1";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CollateralAnswerType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CollateralAnswerTypes",
			      				    ObjectTableSingular =  "Collateral Answer Type",
			      				    ObjectTablePlural =  "Collateral Answer Types",
			      				    ...
			      				    DefaultText =  "Collateral Answer Type",
			      				    Code =  "COAT",
			      				    Name =  "Customs.CollateralAnswerType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CollateralAnswerTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CollateralAnswerType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CollateralAnswerTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "COAT", Name = "Customs.CollateralAnswerType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CollateralAnswerTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "d151", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CollateralAnswerTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CollateralAnswerType").ToList();
	         ...
	         Screen CollateralAnswerTypeCustomsCollateralAnswerTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CollateralAnswerType.HeaderScreen", Name = "Customs.CollateralAnswerTypeHeaderScreen", ObjectTableId = CollateralAnswerTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CollateralAnswerTypeObjectTable.HeaderScreenId = CollateralAnswerTypeCustomsCollateralAnswerTypeHeaderScreenScreen0.Id;
		    CollateralAnswerTypeObjectTable.HeaderScreenCode = CollateralAnswerTypeCustomsCollateralAnswerTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CollateralAnswerTypeObjectTable.Id,
