   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CollateralAnswerTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CollateralAnswerType").ToList();
	         ...
	         Screen CollateralAnswerTypeCustomsCollateralAnswerTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CollateralAnswerType.HeaderScreen", Name = "Customs.CollateralAnswerTypeHeaderScreen", ObjectTableId = CollateralAnswerTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
