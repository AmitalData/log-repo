   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AmedmentTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AmedmentType").ToList();
	         ...
	         Screen AmedmentTypeCustomsAmedmentTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AmedmentType.HeaderScreen", Name = "Customs.AmedmentTypeHeaderScreen", ObjectTableId = AmedmentTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
