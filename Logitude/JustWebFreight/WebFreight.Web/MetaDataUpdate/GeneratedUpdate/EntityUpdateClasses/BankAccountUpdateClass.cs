   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllBankAccountsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 0, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 1, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "AccountNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "AccountNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 120 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 2, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "BankId" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "BankId" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 3, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "GLAccountNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "GLAccountNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 142 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 4, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "DeferedGLAccountNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "DeferedGLAccountNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 174 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 5, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "BankCode" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "BankCode" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 6, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "BranchNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "BranchNumber" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 136 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 7, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "DeferredGLAccountId" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "DeferredGLAccountId" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 8, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "BranchAddress" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "BranchAddress" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllBankAccountsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBankAccountsQuery.Id,QueryCode = AllBankAccountsQuery.Code, IndexOrder = 9, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> BankAccountObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BankAccount").ToList();
            ...
            ScreenField BankAccountHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "AccountNumber").FirstOrDefault().Id, ScreenId = BankAccountHeaderScreenScreen1.Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "AccountNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField BankAccountHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "BankId").FirstOrDefault().Id, ScreenId = BankAccountHeaderScreenScreen1.Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "BankId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField BankAccountHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "GLAccountNumber").FirstOrDefault().Id, ScreenId = BankAccountHeaderScreenScreen1.Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "GLAccountNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField BankAccountHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ObjectFieldId = BankAccountObjectFields.Where(d => d.FieldName == "DeferedGLAccountNumber").FirstOrDefault().Id, ScreenId = BankAccountHeaderScreenScreen1.Id, ObjectFieldCode = BankAccountObjectFields.Where(d => d.FieldName == "DeferedGLAccountNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
