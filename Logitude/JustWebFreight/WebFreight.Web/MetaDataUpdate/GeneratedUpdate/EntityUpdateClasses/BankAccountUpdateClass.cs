...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {    
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "BAGN",HtmlComponentName = "BankAccountGeneralTabComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/BankAccount/BankAccountGeneralTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "BankAccount.Tab.General" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ControlPath = "./Accounting/Components/EditTabs/BankAccount/BankAccountGeneralTabComponent", ObjectTableId = BankAccountObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "BankAccount.TH.General" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "BABP",HtmlComponentName = "BankPagesTabComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/BankAccount/BankPagesTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "BankAccount.Tab.BankPages" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ControlPath = "./Accounting/Components/EditTabs/BankAccount/BankPagesTabComponent", ObjectTableId = BankAccountObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "BankAccount.TH.BankPages" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "BAMR",HtmlComponentName = "ManageRecoTabComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/BankAccount/ManageRecoTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "BankAccount.Tab.ManageReco" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ControlPath = "./Accounting/Components/EditTabs/BankAccount/ManageRecoTabComponent", ObjectTableId = BankAccountObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "BankAccount.TH.ManageReco" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "BAEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = tenantFeatures.Where(d => d.Code == "BankAccount.Tab.Event" && d.ObjectTableId == BankAccountObjectTable.Id).FirstOrDefault().Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = BankAccountObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "BankAccount.TH.Events" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 3 }, objectTableTabsRepository, TenantObjectTableTabs);
