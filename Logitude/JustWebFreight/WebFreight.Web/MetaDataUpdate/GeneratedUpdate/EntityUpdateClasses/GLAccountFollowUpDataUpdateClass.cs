   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> GLAccountFollowUpDataObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "GLAccountFollowUpData").ToList();
	         ...
	         Screen GLAccountFollowUpDataGLAccountFollowUpDataHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "GLAccountFollowUpData.HeaderScreen", Name = "GLAccountFollowUpDataHeaderScreen", ObjectTableId = GLAccountFollowUpDataObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
