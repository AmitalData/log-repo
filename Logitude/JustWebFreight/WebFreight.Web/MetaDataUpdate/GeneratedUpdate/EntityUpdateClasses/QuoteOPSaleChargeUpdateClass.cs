...
{
   public class QuoteOPSaleChargeUpdateClass
   {  		
		public const string HashString = "5013270df2eb4e0c5d81849c03b1e589";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuoteOPSaleCharge",
			      				    IsNew =  false,
			      				    DBTableName =  "NONE",
			      				    ObjectTableSingular =  "Quote Sales Charge",
			      				    ObjectTablePlural =  "QuoteOPSaleCharges",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "QuoteOPSaleCharge,,,Id,",
			      				    HashString =  QuoteOPSaleChargeUpdateClass.HashString,
	    ...
	    {   
		   ...
		   ObjectTable QuoteOPSaleChargeObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "QuoteOPSaleCharge" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> QuoteOPSaleChargeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "QuoteOPSaleCharge").ToList();
		       
	      

	         Screen QuoteOPSaleChargeQuoteOPSaleChargeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "QuoteOPSaleCharge.HeaderScreen", Name = "QuoteOPSaleChargeHeaderScreen", ObjectTableId = QuoteOPSaleChargeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    QuoteOPSaleChargeObjectTable.HeaderScreenId = QuoteOPSaleChargeQuoteOPSaleChargeHeaderScreenScreen0.Id;
		    QuoteOPSaleChargeObjectTable.HeaderScreenCode = QuoteOPSaleChargeQuoteOPSaleChargeHeaderScreenScreen0.Code;
	    ...
	    {  
		   ...
		   Feature QuoteOPSaleChargeFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPSaleChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPSaleCharge.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPSaleChargeObjectTable);
		   Feature QuoteOPSaleChargeFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPSaleChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPSaleCharge.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPSaleChargeObjectTable);
		   Feature QuoteOPSaleChargeFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPSaleChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPSaleCharge.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPSaleChargeObjectTable);
		   Feature QuoteOPSaleChargeFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPSaleChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPSaleCharge.Features.PackageFeature", NameTextCodeDefaultText = "QuoteOPSaleCharge Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPSaleChargeObjectTable);    
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = QuoteOPSaleChargeObjectTable.Id,
