   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AuthorizedSignerPermitTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.AuthorizedSignerPermit.Q.AuthorizedSignerPermitQuery", DefaultText = @"Authorized Signer Permits",LocalDefaultText = "סוגי הרשאה למורשה חתימה", ObjectTableId = AuthorizedSignerPermitObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
