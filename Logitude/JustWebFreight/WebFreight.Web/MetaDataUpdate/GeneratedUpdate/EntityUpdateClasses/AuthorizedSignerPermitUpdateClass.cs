...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "25874d4c481b60e9bb8f9790be12b796";
	    ...
	    {  
	        ...
	        QueryGroup AuthorizedSignerPermitQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "AUSP", Name = "Customs.AuthorizedSignerPermit" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup AuthorizedSignerPermitQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "24d7", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> AuthorizedSignerPermitObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AuthorizedSignerPermit").ToList();
	         ...
	         Screen AuthorizedSignerPermitCustomsAuthorizedSignerPermitHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AuthorizedSignerPermit.HeaderScreen", Name = "Customs.AuthorizedSignerPermitHeaderScreen", ObjectTableId = AuthorizedSignerPermitObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    AuthorizedSignerPermitObjectTable.HeaderScreenId = AuthorizedSignerPermitCustomsAuthorizedSignerPermitHeaderScreenScreen0.Id;
		    AuthorizedSignerPermitObjectTable.HeaderScreenCode = AuthorizedSignerPermitCustomsAuthorizedSignerPermitHeaderScreenScreen0.Code;
