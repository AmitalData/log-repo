...
{
   public class DangerousGoodsPackingReqUpdateClass
   {  		
		public const string HashString = "a8b91c463b1f624358ea292a78b14b5a";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.DangerousGoodsPackingReq",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.DangerousGoodsPackingReqs",
			      				    ObjectTableSingular =  "Customs.DangerousGoodsPackingReq",
			      				    ObjectTablePlural =  "Customs.DangerousGoodsPackingReqs",
			      				    ...
			      				    DefaultText =  "Dangerous Goods Packing Req",
			      				    Code =  "DGPR",
			      				    Name =  "Customs.DangerousGoodsPackingReq",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  DangerousGoodsPackingReqUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.DangerousGoodsPackingReq",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup DangerousGoodsPackingReqQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "DGPR", Name = "Customs.DangerousGoodsPackingReq" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup DangerousGoodsPackingReqQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "fc50", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> DangerousGoodsPackingReqObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DangerousGoodsPackingReq").ToList();
	         ...
	         Screen DangerousGoodsPackingReqCustomsDangerousGoodsPackingReqHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DangerousGoodsPackingReq.HeaderScreen", Name = "Customs.DangerousGoodsPackingReqHeaderScreen", ObjectTableId = DangerousGoodsPackingReqObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    DangerousGoodsPackingReqObjectTable.HeaderScreenId = DangerousGoodsPackingReqCustomsDangerousGoodsPackingReqHeaderScreenScreen0.Id;
		    DangerousGoodsPackingReqObjectTable.HeaderScreenCode = DangerousGoodsPackingReqCustomsDangerousGoodsPackingReqHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = DangerousGoodsPackingReqObjectTable.Id,
