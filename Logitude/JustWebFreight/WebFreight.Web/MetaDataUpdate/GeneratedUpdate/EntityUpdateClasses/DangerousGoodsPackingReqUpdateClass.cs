   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode DangerousGoodsPackingReqTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DangerousGoodsPackingReq.Q.DangerousGoodsPackingReqQuery", DefaultText = @"Dangerous Goods Packing Reqs",LocalDefaultText = "רמת סיכון חומר מסוכן במטען", ObjectTableId = DangerousGoodsPackingReqObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> DangerousGoodsPackingReqObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DangerousGoodsPackingReq").ToList();
	         ...
	         Screen DangerousGoodsPackingReqCustomsDangerousGoodsPackingReqHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DangerousGoodsPackingReq.HeaderScreen", Name = "Customs.DangerousGoodsPackingReqHeaderScreen", ObjectTableId = DangerousGoodsPackingReqObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
