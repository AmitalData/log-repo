...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "001d814d0440ec2e0d2f1d86a54c5e88";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "CalculatedChartsOfAccount",
			      				    IsNew =  true,
			      				    DBTableName =  "CalculatedChartsOfAccounts",
			      				    ObjectTableSingular =  "CalculatedChartsOfAccount",
			      				    ObjectTablePlural =  "CalculatedChartsOfAccounts",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CalculatedChartsOfAccountUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Id",
					  						...
					  						ValidForQuerySection1 =  "CalculatedChartsOfAccount",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "UserDefinedReportId",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "UserDefinedReportId",
					  						ListPropertyPath =  "UserDefinedReportId",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "UserDefinedReportId",
					  						DefaultText =  "User Defined Report",
					  						IsForeignKey =  true,
					  						ForeignEntity =  "UserDefinedReport",
					  						NavigationPropertyName =  "UserDefinedReport",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CalculatedChartsOfAccountLines",
					  						ObjectTableName =  "CalculatedChartsOfAccount",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "CalculatedChartsOfAccountLines",
					  						ListPropertyPath =  "CalculatedChartsOfAccountLines",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						IsMulti =  true,
					  						MultiTableName =  "CalculatedChartsOfAccountsLine",
					  						DependencyFilter1IsList =  false,
					  						DependencyFilter2IsList =  false,
					  						DependencyFilter3IsList =  false,
					  						IsRestrictable =  false,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "CalculatedChartsOfAccountLines",
					  						DefaultText =  "Calculated Charts Of Accounts Lines",
					  						IsForeignKey =  false,
					  						ThisKey =  "Id",
					  						OtherKey =  "CalculatedChartsOfAccountsId",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CretedByLocalNameName",
					  						ObjectTableName =  "CalculatedChartsOfAccount",
					  						FieldsDataType =  "nText",
					  						MinLength =  0,
					  						MaxLength =  100,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "CretedByLocalNameName",
					  						ListPropertyPath =  "CretedByLocalNameName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "CretedByLocalNameName",
					  						DefaultText =  "Created By",
					  						FullLocalDefaultText =  "נוצר ע”י",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ChartOfAccountTypeEnglishName",
					  						ObjectTableName =  "CalculatedChartsOfAccount",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  60,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "ChartOfAccountTypeEnglishName",
					  						ListPropertyPath =  "ChartOfAccountTypeEnglishName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "ChartOfAccountTypeEnglishName",
					  						DefaultText =  "Chart Of Account Type",
					  						FullLocalDefaultText =  "סוג כרטיס",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ChartOfAccountTypeLocalName",
					  						ObjectTableName =  "CalculatedChartsOfAccount",
					  						FieldsDataType =  "nText",
					  						MinLength =  0,
					  						MaxLength =  30,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "ChartOfAccountTypeLocalName",
					  						ListPropertyPath =  "ChartOfAccountTypeLocalName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "ChartOfAccountTypeLocalName",
					  						DefaultText =  "Chart Of Account Type",
					  						FullLocalDefaultText =  "סוג כרטיס",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
	    ...
	    {   
		   ...
		   ObjectTable CalculatedChartsOfAccountObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "CalculatedChartsOfAccount" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> CalculatedChartsOfAccountObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CalculatedChartsOfAccount").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CalculatedChartsOfAccountObjectTable.Id,
