...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "792ea23d416d209fcf23f51656931952";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.StorageStatus",
			      				    ...
			      				    Code =  "4b30",
			      				    Name =  "Customs.StorageStatus Query Group",
			      				    CloseTableCode =  "Code",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "StorageStatus",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   //List<ObjectField> StorageStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.StorageStatus").ToList();
	         ...
	         Screen StorageStatusCustomsStorageStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "StorageStatus.HeaderScreen", Name = "Customs.StorageStatusHeaderScreen", ObjectTableId = StorageStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    StorageStatusObjectTable.HeaderScreenId = StorageStatusCustomsStorageStatusHeaderScreenScreen0.Id;
		    StorageStatusObjectTable.HeaderScreenCode = StorageStatusCustomsStorageStatusHeaderScreenScreen0.Code;
