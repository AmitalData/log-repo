   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> SupplierInvoiceItemsDescriptObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SupplierInvoiceItemsDescript").ToList();
	         ...
	         Screen SupplierInvoiceItemsDescriptCustomsSupplierInvoiceItemsDescriptHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SupplierInvoiceItemsDescript.HeaderScreen", Name = "Customs.SupplierInvoiceItemsDescriptHeaderScreen", ObjectTableId = SupplierInvoiceItemsDescriptObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
