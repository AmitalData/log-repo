...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    public void FillTaxReportStatus(int contextTenant)
        { 
            var repo = new TaxReportStatusRepository(contextTenant);
