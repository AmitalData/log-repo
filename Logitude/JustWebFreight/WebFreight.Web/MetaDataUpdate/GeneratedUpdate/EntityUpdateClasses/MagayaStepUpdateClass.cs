   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> MagayaStepObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "MagayaStep").ToList();
	         ...
	         Screen MagayaStepMagayaStepHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "MagayaStep.HeaderScreen", Name = "MagayaStepHeaderScreen", ObjectTableId = MagayaStepObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillMagayaStep(int contextTenant)
        { 
            var repo = new MagayaStepRepository(contextTenant);
