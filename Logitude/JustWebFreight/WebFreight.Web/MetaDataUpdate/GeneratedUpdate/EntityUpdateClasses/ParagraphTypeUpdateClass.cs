...
{
   public class ParagraphTypeUpdateClass
   {  		
		public const string HashString = "14f86cfa58c26ad5eac4e98fb53b5ed7";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.ParagraphType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.ParagraphTypes",
			      				    ObjectTableSingular =  "Customs.ParagraphType",
			      				    ObjectTablePlural =  "Customs.ParagraphTypes",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ParagraphTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.ParagraphType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup ParagraphTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "PART", Name = "Customs.ParagraphType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ParagraphTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "27f0", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> ParagraphTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ParagraphType").ToList();
	         ...
	         Screen ParagraphTypeCustomsParagraphTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ParagraphType.HeaderScreen", Name = "Customs.ParagraphTypeHeaderScreen", ObjectTableId = ParagraphTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ParagraphTypeObjectTable.HeaderScreenId = ParagraphTypeCustomsParagraphTypeHeaderScreenScreen0.Id;
		    ParagraphTypeObjectTable.HeaderScreenCode = ParagraphTypeCustomsParagraphTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ParagraphTypeObjectTable.Id,
