   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode DeclarationCargoSplitTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DeclarationCargoSplit.Q.OpenCargoSplits", DefaultText = @"Open Cargo Splits",LocalDefaultText = "בקשות פיצול מטען פתוחות", ObjectTableId = DeclarationCargoSplitObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   ...
			   TextCode DeclarationCargoSplitTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DeclarationCargoSplit.Q.ClosedCargoSplits", DefaultText = @"Closed Cargo Splits",LocalDefaultText = "בקשות פיצול מטען סגורות", ObjectTableId = DeclarationCargoSplitObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   ...
			   TextCode DeclarationCargoSplitTextCode_2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.DeclarationCargoSplit.Q.AllCargoSplits", DefaultText = @"All Cargo Splits",LocalDefaultText = "הכל", ObjectTableId = DeclarationCargoSplitObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query OpenCargoSplitsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = DeclarationCargoSplitTextCode_0.Id, NameTextCodeCode = DeclarationCargoSplitTextCode_0.Code, ObjectTableName = "Customs.DeclarationCargoSplit", Code = "OpenCargoSplits",  EditWizardName = "Logitude.Customs.Views.DeclarationCargoSplit.DeclarationCargoSplitControl",
			   QueryGroupCode = "DECS", IndexOrder = 0, Tenant = 0, ObjectTableId = DeclarationCargoSplitObjectTable.Id, QuerySection = "Customs.DeclarationCargoSplit", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = DeclarationCargoSplitFeature_0.Id,FeatureUniqeCode= DeclarationCargoSplitFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn OpenCargoSplitsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestNumber" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestDate" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.DeclarationCargoSplit.ManifestNumber" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.DeclarationCargoSplit.SecondCargoID" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.DeclarationCargoSplit.ThirdCargoID" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.DeclarationCargoSplit.ActionTypeName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestReasonName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Customs.DeclarationCargoSplit.CustomFileNo" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "Customs.DeclarationCargoSplit.Direction" , ColumnWidth = 30 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "Customs.DeclarationCargoSplit.TransportModeId" , ColumnWidth = 60 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "Customs.DeclarationCargoSplit.ResponseStatusName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn OpenCargoSplitsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "Customs.DeclarationCargoSplit.IsClosed" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter OpenCargoSplitsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Customs.DeclarationCargoSplit.IsClosed", PredefinedValue = "false",PredefinedValue2 = null, CustomPredefined = false, QueryId = OpenCargoSplitsQuery.Id,QueryCode = OpenCargoSplitsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
			  ...
			  Query ClosedCargoSplitsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = DeclarationCargoSplitTextCode_1.Id, NameTextCodeCode = DeclarationCargoSplitTextCode_1.Code, ObjectTableName = "Customs.DeclarationCargoSplit", Code = "ClosedCargoSplits",  EditWizardName = "Logitude.Customs.Views.DeclarationCargoSplit.DeclarationCargoSplitControl",
			   QueryGroupCode = "DECS", IndexOrder = 1, Tenant = 0, ObjectTableId = DeclarationCargoSplitObjectTable.Id, QuerySection = "Customs.DeclarationCargoSplit", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = DeclarationCargoSplitFeature_1.Id,FeatureUniqeCode= DeclarationCargoSplitFeature_1.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ClosedCargoSplitsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestNumber" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestDate" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.DeclarationCargoSplit.ManifestNumber" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.DeclarationCargoSplit.SecondCargoID" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.DeclarationCargoSplit.ThirdCargoID" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.DeclarationCargoSplit.ActionTypeName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestReasonName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Customs.DeclarationCargoSplit.CustomFileNo" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "Customs.DeclarationCargoSplit.Direction" , ColumnWidth = 30 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "Customs.DeclarationCargoSplit.TransportModeId" , ColumnWidth = 60 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "Customs.DeclarationCargoSplit.ResponseStatusName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ClosedCargoSplitsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "Customs.DeclarationCargoSplit.IsClosed" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter ClosedCargoSplitsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Customs.DeclarationCargoSplit.IsClosed", PredefinedValue = "true",PredefinedValue2 = null, CustomPredefined = false, QueryId = ClosedCargoSplitsQuery.Id,QueryCode = ClosedCargoSplitsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
			 ...
			 QueryColumn AllCargoSplitsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestNumber" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestDate" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.DeclarationCargoSplit.ManifestNumber" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.DeclarationCargoSplit.SecondCargoID" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.DeclarationCargoSplit.ThirdCargoID" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.DeclarationCargoSplit.ActionTypeName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Customs.DeclarationCargoSplit.RequestReasonName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Customs.DeclarationCargoSplit.CustomFileNo" , ColumnWidth = 110 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "Customs.DeclarationCargoSplit.Direction" , ColumnWidth = 30 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "Customs.DeclarationCargoSplit.TransportModeId" , ColumnWidth = 60 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "Customs.DeclarationCargoSplit.ResponseStatusName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCargoSplitsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCargoSplitsQuery.Id,QueryCode = AllCargoSplitsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "Customs.DeclarationCargoSplit.IsClosed" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> DeclarationCargoSplitObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DeclarationCargoSplit").ToList();
	         ...
	         Screen DeclarationCargoSplitCustomsDeclarationCargoSplitHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DeclarationCargoSplit.HeaderScreen", Name = "Customs.DeclarationCargoSplitHeaderScreen", ObjectTableId = DeclarationCargoSplitObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
