...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "af31fadbb3636fd622ba8a5646b58a8e";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.ApprovedProfession",
			      				    IsNew =  true,
			      				    DBTableName =  "Customs.ApprovedProfessions",
			      				    ObjectTableSingular =  "ApprovedProfession",
			      				    ObjectTablePlural =  "ApprovedProfessions",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ApprovedProfessionUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.ApprovedProfession",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup ApprovedProfessionQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "29af", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ApprovedProfessionQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "85d4", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
				        queryGroupRepository.SubmitChanges();
	        ObjectTable ApprovedProfessionObjectTable = objectTables.ContainsKey("Customs.ApprovedProfession") ? objectTables["Customs.ApprovedProfession"] : null;
            if (ApprovedProfessionObjectTable == null)
            {
                IWebFreightContext objectContext = WebFreightContext.GetContext(0);  

                ApprovedProfessionObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.ApprovedProfession" && d.Tenant == 0).FirstOrDefault();
            }
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ApprovedProfessionTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ApprovedProfession.Q.ApprovedProfession", DefaultText = @"ApprovedProfessionQuery",LocalDefaultText = null, ObjectTableId = ApprovedProfessionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature ApprovedProfessionFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ApprovedProfession.Q.ApprovedProfession", ObjectTableId = ApprovedProfessionObjectTable.Id, Tenant = 0, NameTextCodeCode = "ApprovedProfession.Features.ApprovedProfession", NameTextCodeDefaultText = "ApprovedProfession", FeatureTypeCode = "QUER", Packagable = false }, TenantFeatures, textCodes,ApprovedProfessionObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> ApprovedProfessionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ApprovedProfession").ToList();
	         ...
	         Screen ApprovedProfessionCustomsApprovedProfessionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ApprovedProfession.HeaderScreen", Name = "Customs.ApprovedProfessionHeaderScreen", ObjectTableId = ApprovedProfessionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ApprovedProfessionObjectTable.HeaderScreenId = ApprovedProfessionCustomsApprovedProfessionHeaderScreenScreen0.Id;
		    ApprovedProfessionObjectTable.HeaderScreenCode = ApprovedProfessionCustomsApprovedProfessionHeaderScreenScreen0.Code;
