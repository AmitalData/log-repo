   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode Category3TextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Category3.Q.allcategories3", DefaultText = @"Categories 3",LocalDefaultText = null, ObjectTableId = Category3ObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature Category3Feature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Category3.Q.allcategories3", ObjectTableId = Category3ObjectTable.Id, Tenant = 0, NameTextCodeCode = "Category3.Features.allcategories3", NameTextCodeDefaultText = "allcategories3", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,Category3ObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query allcategories3Query = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = Category3TextCode_0.Id, NameTextCodeCode = Category3TextCode_0.Code, ObjectTableName = "Category3", Code = "allcategories3",  QueryGroupCode = "77cf", IndexOrder = 0, Tenant = 0, ObjectTableId = Category3ObjectTable.Id, QuerySection = "Category3", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = Category3Feature_0.Id,FeatureUniqeCode= Category3Feature_0.FeatureUniqeCode, DefaultSortName = "EnglishName", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn allcategories3QueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories3Query.Id,QueryCode = allcategories3Query.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Category3.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn allcategories3QueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories3Query.Id,QueryCode = allcategories3Query.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Category3.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn allcategories3QueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allcategories3Query.Id,QueryCode = allcategories3Query.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Category3.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> Category3ObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Category3").ToList();
	         ...
	         Screen Category3HeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Category3.HeaderScreen", Name = "HeaderScreen", ObjectTableId = Category3ObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField Category3Category3HeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = Category3HeaderScreenScreen0.Id,ScreenCode = Category3HeaderScreenScreen0.Code, ObjectFieldCode = "Category3.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField Category3Category3HeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = Category3HeaderScreenScreen0.Id,ScreenCode = Category3HeaderScreenScreen0.Code, ObjectFieldCode = "Category3.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField Category3Category3HeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = Category3HeaderScreenScreen0.Id,ScreenCode = Category3HeaderScreenScreen0.Code, ObjectFieldCode = "Category3.Inactive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    Category3ObjectTable.HeaderScreenCode = Category3HeaderScreenScreen0.Code;
	         ...
	         Screen Category3GeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Category3.GeneralTabScreen", Name = "GeneralTabScreen", ObjectTableId = Category3ObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField Category3Category3GeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = Category3GeneralTabScreenScreen1.Id,ScreenCode = Category3GeneralTabScreenScreen1.Code, ObjectFieldCode = "Category3.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField Category3Category3GeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = Category3GeneralTabScreenScreen1.Id,ScreenCode = Category3GeneralTabScreenScreen1.Code, ObjectFieldCode = "Category3.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField Category3Category3GeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = Category3GeneralTabScreenScreen1.Id,ScreenCode = Category3GeneralTabScreenScreen1.Code, ObjectFieldCode = "Category3.Inactive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode Category3GeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Category3.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = Category3ObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature Category3GeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Category3.Tab.General", ObjectTableId = Category3ObjectTable.Id, Tenant = 0, NameTextCodeCode = "Category3.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,Category3ObjectTable,contextTenant);
 
                 
			   TextCode Category3EventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Category3.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = Category3ObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
