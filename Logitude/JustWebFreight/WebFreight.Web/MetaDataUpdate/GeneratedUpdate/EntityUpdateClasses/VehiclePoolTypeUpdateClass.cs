   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode VehiclePoolTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.VehiclePoolType.Q.VehiclePoolTypeQuery", DefaultText = @"Vehicle Pool Type",LocalDefaultText = "סוג מאגר רכב", ObjectTableId = VehiclePoolTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature VehiclePoolTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "VEHICLEPOOLTYPE", ObjectTableId = VehiclePoolTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.VehiclePoolType.Features.VehiclePoolType", NameTextCodeDefaultText = "Vehicle Pool Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,VehiclePoolTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn VehiclePoolTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VehiclePoolTypeQuery.Id,QueryCode = VehiclePoolTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.VehiclePoolType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn VehiclePoolTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VehiclePoolTypeQuery.Id,QueryCode = VehiclePoolTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.VehiclePoolType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn VehiclePoolTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VehiclePoolTypeQuery.Id,QueryCode = VehiclePoolTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.VehiclePoolType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn VehiclePoolTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = VehiclePoolTypeQuery.Id,QueryCode = VehiclePoolTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.VehiclePoolType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
