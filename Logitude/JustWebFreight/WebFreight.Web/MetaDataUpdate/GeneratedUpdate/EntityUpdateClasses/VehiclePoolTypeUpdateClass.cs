...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "cd2ccf5bbc2c3727e65e343ef5e8b3cd";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.VehiclePoolType",
			      				    DBTableName =  "Customs.VehiclePoolTypes",
			      				    ObjectTableSingular =  "VehiclePoolType",
			      				    ObjectTablePlural =  "VehiclePoolTypes",
			      				    ...
			      				    HashString =  VehiclePoolTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.VehiclePoolType",
	    ...
	    {  
	        ...
	        QueryGroup VehiclePoolTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "VPQG", Name = "Customs.VehiclePoolType" }, queryGroupRepository,tenantQueryGroups);
				        queryGroupRepository.SubmitChanges();
	        ObjectTable VehiclePoolTypeObjectTable = objectTables.ContainsKey("Customs.VehiclePoolType") ? objectTables["Customs.VehiclePoolType"] : null;
            if (VehiclePoolTypeObjectTable == null)
            {
                IWebFreightContext objectContext = WebFreightContext.GetContext(0);  

                VehiclePoolTypeObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.VehiclePoolType" && d.Tenant == 0).FirstOrDefault();
            }
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode VehiclePoolTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.VehiclePoolType.Q.VehiclePoolTypeQuery", DefaultText = @"Vehicle Pool Type",LocalDefaultText = "סוג מאגר רכב", ObjectTableId = VehiclePoolTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature VehiclePoolTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "VEHICLEPOOLTYPE", ObjectTableId = VehiclePoolTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.VehiclePoolType.Features.VehiclePoolType", NameTextCodeDefaultText = "Vehicle Pool Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,VehiclePoolTypeObjectTable, addedFeatures, addedTextCodes);
