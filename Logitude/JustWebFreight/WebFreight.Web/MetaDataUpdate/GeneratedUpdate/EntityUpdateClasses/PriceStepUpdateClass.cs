   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllPricesStepsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.Code, IndexOrder = 1, ObjectFieldId = PriceStepObjectFields.Where(d => d.FieldName == "Steps" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PriceStepObjectFields.Where(d => d.FieldName == "Steps" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 300 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPricesStepsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.Code, IndexOrder = 2, ObjectFieldId = PriceStepObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PriceStepObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPricesStepsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.Code, IndexOrder = 3, ObjectFieldId = PriceStepObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PriceStepObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPricesStepsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.Code, IndexOrder = 4, ObjectFieldId = PriceStepObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PriceStepObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPricesStepsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.Code, IndexOrder = 5, ObjectFieldId = PriceStepObjectFields.Where(d => d.FieldName == "UpdatedByUserName" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PriceStepObjectFields.Where(d => d.FieldName == "UpdatedByUserName" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllPricesStepsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.Code, IndexOrder = 6, ObjectFieldId = PriceStepObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PriceStepObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == PriceStepObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
