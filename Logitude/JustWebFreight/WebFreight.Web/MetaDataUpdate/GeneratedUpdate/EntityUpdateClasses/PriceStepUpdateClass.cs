   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PriceStepTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PriceStep.Q.AllPricesSteps", DefaultText = @"All Prices Steps",LocalDefaultText = "All Prices Steps", ObjectTableId = PriceStepObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature PriceStepFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "PriceStep.Q.AllPricesSteps", ObjectTableId = PriceStepObjectTable.Id, Tenant = 0, NameTextCodeCode = "PriceStepFeatures.AllPricesSteps", NameTextCodeDefaultText = "AllPricesSteps", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,PriceStepObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllPricesStepsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "PriceStep.Name" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPricesStepsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "PriceStep.Steps" , ColumnWidth = 300 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPricesStepsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "PriceStep.CreateDate" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPricesStepsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "PriceStep.CreatedByUserName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPricesStepsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "PriceStep.UpdateDate" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPricesStepsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "PriceStep.UpdatedByUserName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn AllPricesStepsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllPricesStepsQuery.Id,QueryCode = AllPricesStepsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "PriceStep.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PriceStepObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PriceStep").ToList();
	         ...
	         Screen PriceStepPriceStepsHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PriceSteps.HeaderScreen", Name = "PriceStepsHeaderScreen", ObjectTableId = PriceStepObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
             ...
             ScreenField PriceStepPriceStepsHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = PriceStepPriceStepsHeaderScreenScreen0.Id,ScreenCode = PriceStepPriceStepsHeaderScreenScreen0.Code, ObjectFieldCode = "PriceStep.Steps", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode PriceStepGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PriceStep.TH.General", DefaultText = "General",LocalDefaultText = "General", ObjectTableId = PriceStepObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature PriceStepGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "PriceStep.Tab.General", ObjectTableId = PriceStepObjectTable.Id, Tenant = 0, NameTextCodeCode = "PriceStepFeatures.PSGN", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,PriceStepObjectTable,contextTenant);
 
                 
			   TextCode PriceStepEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PriceStep.TH.Events", DefaultText = "Events",LocalDefaultText = "Events", ObjectTableId = PriceStepObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
