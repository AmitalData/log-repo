...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "33f2027ea45e7bb387b650897d112eb8";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CargoIdentityQualifier",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CargoIdentityQualifiers",
			      				    ObjectTableSingular =  "CargoIdentityQualifier",
			      				    ObjectTablePlural =  "CargoIdentityQualifiers",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CargoIdentityQualifierUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CargoIdentityQualifier",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CargoIdentityQualifierQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CQQG", Name = "Customs.CargoIdentityQualifier" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CargoIdentityQualifierQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "83b7", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
				        queryGroupRepository.SubmitChanges();
	        ObjectTable CargoIdentityQualifierObjectTable = objectTables.ContainsKey("Customs.CargoIdentityQualifier") ? objectTables["Customs.CargoIdentityQualifier"] : null;
            if (CargoIdentityQualifierObjectTable == null)
            {
                IWebFreightContext objectContext = WebFreightContext.GetContext(0);  

                CargoIdentityQualifierObjectTable = objectContext.ObjectTables.Where(d => d.Name == "Customs.CargoIdentityQualifier" && d.Tenant == 0).FirstOrDefault();
            }
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CargoIdentityQualifierTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CargoIdentityQualifier.Q.CargoIdentityQualifierQuery", DefaultText = @"CargoIdentity Qualifier",LocalDefaultText = "סוג מזהה רכב", ObjectTableId = CargoIdentityQualifierObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature CargoIdentityQualifierFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CARGOQUALIFIRE", ObjectTableId = CargoIdentityQualifierObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.CargoIdentityQualifier.Features.CargoIdentityQualifier", NameTextCodeDefaultText = "CargoIdentity Qualifier", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CargoIdentityQualifierObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> CargoIdentityQualifierObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CargoIdentityQualifier").ToList();
	         ...
	         Screen CargoIdentityQualifierCustomsCargoIdentityQualifierHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CargoIdentityQualifier.HeaderScreen", Name = "Customs.CargoIdentityQualifierHeaderScreen", ObjectTableId = CargoIdentityQualifierObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CargoIdentityQualifierObjectTable.HeaderScreenId = CargoIdentityQualifierCustomsCargoIdentityQualifierHeaderScreenScreen0.Id;
		    CargoIdentityQualifierObjectTable.HeaderScreenCode = CargoIdentityQualifierCustomsCargoIdentityQualifierHeaderScreenScreen0.Code;
