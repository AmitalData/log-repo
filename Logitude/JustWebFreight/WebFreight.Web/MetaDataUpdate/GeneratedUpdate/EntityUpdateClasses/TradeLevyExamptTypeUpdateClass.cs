...
{
   public class TradeLevyExamptTypeUpdateClass
   {  		
		public const string HashString = "cbba8702a04e933af408232823aa6590";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.TradeLevyExamptType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.TradeLevyExamptTypes",
			      				    ObjectTableSingular =  "TradeLevyExamptType",
			      				    ObjectTablePlural =  "TradeLevyExamptTypes",
			      				    ...
			      				    LocalDefaultText =  "סוג פטור מהיטל",
			      				    DefaultText =  "Trade Levy Exampt Type",
			      				    Code =  "TLQG",
			      				    Name =  "Customs.TradeLevyExamptType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  TradeLevyExamptTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.TradeLevyExamptType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup TradeLevyExamptTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "TLQG", Name = "Customs.TradeLevyExamptType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup TradeLevyExamptTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "27b4", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> TradeLevyExamptTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.TradeLevyExamptType").ToList();
	         ...
	         Screen TradeLevyExamptTypeCustomsTradeLevyExamptTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TradeLevyExamptType.HeaderScreen", Name = "Customs.TradeLevyExamptTypeHeaderScreen", ObjectTableId = TradeLevyExamptTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    TradeLevyExamptTypeObjectTable.HeaderScreenId = TradeLevyExamptTypeCustomsTradeLevyExamptTypeHeaderScreenScreen0.Id;
		    TradeLevyExamptTypeObjectTable.HeaderScreenCode = TradeLevyExamptTypeCustomsTradeLevyExamptTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = TradeLevyExamptTypeObjectTable.Id,
