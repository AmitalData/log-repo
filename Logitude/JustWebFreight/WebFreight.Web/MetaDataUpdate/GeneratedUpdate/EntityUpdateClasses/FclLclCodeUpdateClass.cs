   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> FclLclCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.FclLclCode").ToList();
	         ...
	         Screen FclLclCodeCustomsFclLclCodeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "FclLclCode.HeaderScreen", Name = "Customs.FclLclCodeHeaderScreen", ObjectTableId = FclLclCodeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
