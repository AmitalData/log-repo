   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> ReconcileExternalPageObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ReconcileExternalPage").ToList();
	         ...
	         Screen ReconcileExternalPageReconcileExternalPageHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ReconcileExternalPage.ReconcileExternalPageHeaderScreen", Name = "ReconcileExternalPageHeaderScreen", ObjectTableId = ReconcileExternalPageObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
             ...
             ScreenField ReconcileExternalPageReconcileExternalPageReconcileExternalPageHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = ReconcileExternalPageReconcileExternalPageHeaderScreenScreen0.Id,ScreenCode = ReconcileExternalPageReconcileExternalPageHeaderScreenScreen0.Code, ObjectFieldCode = "ReconcileExternalPage.PageNo", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageONoCreditAndDebit = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.NoCreditAndDebit", DefaultText = "In line #lineNo, you can not enter an amount either on the credit side and on the debit side",LocalDefaultText = @"בשורה #lineNo לא ניתן להזין סכום גם בצד הזכות וגם בצד החובה", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOPreviuosBankPage = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.PreviuosBankPage", DefaultText = "Previuos page",LocalDefaultText = @"דף קודם", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOCantNewBankPageDraft = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.CantNewBankPageDraft", DefaultText = "Can’t create new bank page, The previous page is not approved",LocalDefaultText = @"לא ניתן ליצור דף בנק חדש, הדף הקודם עדיין בסטטוס טיוטה", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOToDateShouldBiggerFromDate = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.ToDateShouldBiggerFromDate", DefaultText = "To date should bigger/equal to from date",LocalDefaultText = @" עד תאריך חייב להיות גדול/שווה מ-תאריך", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOPageApprovedCantCancel = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.PageApprovedCantCancel", DefaultText = "The bank page is approved and can’t be cancelled",LocalDefaultText = @"דף הבנק בסטטוס מאושר ולא ניתן לבטל אותו", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageORefDateShouldBiggerOrSmaller = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.RefDateShouldBiggerOrSmaller", DefaultText = "The reference date should be bigger or equal than start date and smaller or equal than end date",LocalDefaultText = @"תאריך האסמכתא חייב להיות גדול/שווה לתאריך התחלה של הדף וקטן/שווה לתאריך סיום של הדף", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOStartBalanceNotEqualEndBalance = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.StartBalanceNotEqualEndBalance", DefaultText = "Start balance + lines doesn't equal to End Balance",LocalDefaultText = @"סכום יתרת פתיחה + שורות לא תואם ליתרת סגירה", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOTransactions = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.Transactions", DefaultText = "Transactions",LocalDefaultText = @"תנועות הכרטיס", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOBankAccountTransactions = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.BankAccountTransactions", DefaultText = "Bank Account Transactions",LocalDefaultText = @"תנועות הבנק", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOSumOfXRowsSelected = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.SumOfXRowsSelected", DefaultText = "Total of %Number rows selected",LocalDefaultText = @"סה”כ %Number שורות נבחרות", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageODifference = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.Difference", DefaultText = "Difference",LocalDefaultText = @"הפרש", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ReconcileExternalPageTextCode_ReconcileExternalPageOSum = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReconcileExternalPage.O.Sum", DefaultText = "Sum",LocalDefaultText = @"סכום", ObjectTableId = ReconcileExternalPageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
