...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "96f5304c9c4c87e1471ebf0f71c07216";
	    ...
	    {  
	        ...
	        QueryGroup DeliverySiteTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "DLST", Name = "Customs.DeliverySiteType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup DeliverySiteTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "dc01", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
