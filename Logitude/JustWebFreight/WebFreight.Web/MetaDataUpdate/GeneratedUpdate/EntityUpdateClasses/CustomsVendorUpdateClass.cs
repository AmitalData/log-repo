...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "40caf4c45937de53f2656d76bd8a3fc5";
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
             ...
             AdvancedQueryFilter ActiveVendorsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Customs.CustomsVendor.InActive", PredefinedValue = "false",PredefinedValue2 = null, CustomPredefined = false, QueryId = ActiveVendorsQuery.Id,QueryCode = ActiveVendorsQuery.UniqueCode, Tenant = 0}, addedQueryFilters);
