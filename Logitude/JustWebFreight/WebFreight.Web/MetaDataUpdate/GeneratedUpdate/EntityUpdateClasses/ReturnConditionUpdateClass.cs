...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "3f3b723e89205915111eb95d1302f363";
	    ...
	    {  
	        ...
	        QueryGroup ReturnConditionQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "RETC", Name = "Customs.ReturnCondition" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ReturnConditionQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "e3e2", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ReturnConditionTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ReturnCondition.Q.ReturnConditionQuery", DefaultText = @"Return Conditions",LocalDefaultText = "תנאי להחזר", ObjectTableId = ReturnConditionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature ReturnConditionFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "RETURNCONDITION", ObjectTableId = ReturnConditionObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.ReturnCondition.Features.ReturnConditions", NameTextCodeDefaultText = "Return Conditions", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ReturnConditionObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> ReturnConditionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ReturnCondition").ToList();
	         ...
	         Screen ReturnConditionCustomsReturnConditionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ReturnCondition.HeaderScreen", Name = "Customs.ReturnConditionHeaderScreen", ObjectTableId = ReturnConditionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ReturnConditionObjectTable.HeaderScreenId = ReturnConditionCustomsReturnConditionHeaderScreenScreen0.Id;
		    ReturnConditionObjectTable.HeaderScreenCode = ReturnConditionCustomsReturnConditionHeaderScreenScreen0.Code;
