   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ReturnConditionTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ReturnCondition.Q.ReturnConditionQuery", DefaultText = @"Return Conditions",LocalDefaultText = "תנאי להחזר", ObjectTableId = ReturnConditionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ReturnConditionFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "RETURNCONDITION", ObjectTableId = ReturnConditionObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.ReturnCondition.Features.ReturnConditions", NameTextCodeDefaultText = "Return Conditions", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ReturnConditionObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query ReturnConditionQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ReturnConditionTextCode_0.Id, NameTextCodeCode = ReturnConditionTextCode_0.Code, ObjectTableName = "Customs.ReturnCondition", Code = "ReturnCondition",  QueryGroupCode = "RETC", IndexOrder = 0, Tenant = 0, ObjectTableId = ReturnConditionObjectTable.Id, QuerySection = "Customs.ReturnCondition", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ReturnConditionFeature_0.Id,FeatureUniqeCode= ReturnConditionFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ReturnConditionQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ReturnConditionQuery.Id,QueryCode = ReturnConditionQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ReturnCondition.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ReturnConditionQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ReturnConditionQuery.Id,QueryCode = ReturnConditionQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ReturnCondition.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ReturnConditionQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ReturnConditionQuery.Id,QueryCode = ReturnConditionQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ReturnCondition.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ReturnConditionQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ReturnConditionQuery.Id,QueryCode = ReturnConditionQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ReturnCondition.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ReturnConditionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ReturnCondition").ToList();
	         ...
	         Screen ReturnConditionCustomsReturnConditionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ReturnCondition.HeaderScreen", Name = "Customs.ReturnConditionHeaderScreen", ObjectTableId = ReturnConditionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
