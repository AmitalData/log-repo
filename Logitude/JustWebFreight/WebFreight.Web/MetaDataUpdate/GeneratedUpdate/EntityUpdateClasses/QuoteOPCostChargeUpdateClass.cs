   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuoteOPCostCharge",
			      				    IsNew =  false,
			      				    DBTableName =  "NONE",
			      				    ObjectTableSingular =  "Quote Cost Charge",
			      				    ObjectTablePlural =  "QuoteOPCostCharges",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "QuoteOPCostCharge,,,Id,",
			      				    HashString =  QuoteOPCostChargeUpdateClass.HashString,
	    ...
	    {   
		   ...
		   ObjectTable QuoteOPCostChargeObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "QuoteOPCostCharge" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> QuoteOPCostChargeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "QuoteOPCostCharge").ToList();
		       
	      

	         Screen QuoteOPCostChargeQuoteOPCostChargeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "QuoteOPCostCharge.HeaderScreen", Name = "QuoteOPCostChargeHeaderScreen", ObjectTableId = QuoteOPCostChargeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    QuoteOPCostChargeObjectTable.HeaderScreenId = QuoteOPCostChargeQuoteOPCostChargeHeaderScreenScreen0.Id;
		    QuoteOPCostChargeObjectTable.HeaderScreenCode = QuoteOPCostChargeQuoteOPCostChargeHeaderScreenScreen0.Code;
	    ...
	    {  
		   ...
		   Feature QuoteOPCostChargeFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPCostChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPCostCharge.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPCostChargeObjectTable);
		   Feature QuoteOPCostChargeFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPCostChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPCostCharge.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPCostChargeObjectTable);
		   Feature QuoteOPCostChargeFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPCostChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPCostCharge.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPCostChargeObjectTable);
		   Feature QuoteOPCostChargeFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = false, ObjectTableId = QuoteOPCostChargeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteOPCostCharge.Features.PackageFeature", NameTextCodeDefaultText = "QuoteOPCostCharge Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteOPCostChargeObjectTable);    
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = QuoteOPCostChargeObjectTable.Id,
