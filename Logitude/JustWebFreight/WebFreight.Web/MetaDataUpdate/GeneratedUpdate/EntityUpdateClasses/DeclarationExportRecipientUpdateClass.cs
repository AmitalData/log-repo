   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DeclarationExportRecipientObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DeclarationExportRecipient").ToList();
	         ...
	         Screen DeclarationExportRecipientCustomsDeclarationExportRecipientHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DeclarationExportRecipient.HeaderScreen", Name = "Customs.DeclarationExportRecipientHeaderScreen", ObjectTableId = DeclarationExportRecipientObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
