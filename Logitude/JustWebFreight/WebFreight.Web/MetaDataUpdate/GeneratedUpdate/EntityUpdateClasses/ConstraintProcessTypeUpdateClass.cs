   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ConstraintProcessTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ConstraintProcessType.Q.ConstraintProcessTypeQuery", DefaultText = @"Constraint Process Types",LocalDefaultText = "סוג תהליך אילוץ", ObjectTableId = ConstraintProcessTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ConstraintProcessTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CONSTRAINTPROCESSTYPEQUERY", ObjectTableId = ConstraintProcessTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.ConstraintProcessType.Features.ConstraintProcesses", NameTextCodeDefaultText = "Constraint Process Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ConstraintProcessTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ConstraintProcessTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ConstraintProcessType").ToList();
	         ...
	         Screen ConstraintProcessTypeCustomsConstraintProcessTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ConstraintProcessType.HeaderScreen", Name = "Customs.ConstraintProcessTypeHeaderScreen", ObjectTableId = ConstraintProcessTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
