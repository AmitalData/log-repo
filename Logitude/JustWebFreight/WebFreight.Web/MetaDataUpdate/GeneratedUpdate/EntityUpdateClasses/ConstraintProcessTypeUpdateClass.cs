...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "e8225a9f4c62f4f37699ad1c7f09e4e1";
	    ...
	    {  
	        ...
	        QueryGroup ConstraintProcessTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CTPT", Name = "Customs.ConstraintProcessTypes" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ConstraintProcessTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "0e50", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ConstraintProcessTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ConstraintProcessType.Q.ConstraintProcessTypeQuery", DefaultText = @"Constraint Process Types",LocalDefaultText = "סוג תהליך אילוץ", ObjectTableId = ConstraintProcessTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   Feature ConstraintProcessTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CONSTRAINTPROCESSTYPEQUERY", ObjectTableId = ConstraintProcessTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.ConstraintProcessType.Features.ConstraintProcesses", NameTextCodeDefaultText = "Constraint Process Types", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ConstraintProcessTypeObjectTable, addedFeatures, addedTextCodes);
	    ...
	    {   
		   ...
		   //List<ObjectField> ConstraintProcessTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ConstraintProcessType").ToList();
	         ...
	         Screen ConstraintProcessTypeCustomsConstraintProcessTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ConstraintProcessType.HeaderScreen", Name = "Customs.ConstraintProcessTypeHeaderScreen", ObjectTableId = ConstraintProcessTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ConstraintProcessTypeObjectTable.HeaderScreenId = ConstraintProcessTypeCustomsConstraintProcessTypeHeaderScreenScreen0.Id;
		    ConstraintProcessTypeObjectTable.HeaderScreenCode = ConstraintProcessTypeCustomsConstraintProcessTypeHeaderScreenScreen0.Code;
