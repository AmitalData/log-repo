   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> ConsignmentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.Consignment").ToList();
	         ...
	         Screen ConsignmentCustomsConsignmentHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Consignment.HeaderScreen", Name = "Customs.ConsignmentHeaderScreen", ObjectTableId = ConsignmentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode ConsignmentTextCode_CustomsConsignmentOEnterTransactionID = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Consignment.O.EnterTransactionID", DefaultText = "Enter Transaction ID",LocalDefaultText = @"הזן מזהה עסקה", ObjectTableId = ConsignmentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ConsignmentTextCode_CustomsConsignmentOEnterYear = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Consignment.O.EnterYear", DefaultText = "Enter Year",LocalDefaultText = @"הזן שנה", ObjectTableId = ConsignmentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ConsignmentTextCode_CustomsConsignmentOEnterMAIBOL = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.Consignment.O.EnterMAIBOL", DefaultText = "Enter Main And Internal BOL",LocalDefaultText = @"הזן שמ”ר / שמ”פ", ObjectTableId = ConsignmentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
