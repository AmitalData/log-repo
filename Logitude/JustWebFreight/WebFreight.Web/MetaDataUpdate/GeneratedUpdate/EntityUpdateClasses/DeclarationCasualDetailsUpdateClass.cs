   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DeclarationCasualDetailsObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.DeclarationCasualDetails").ToList();
	         ...
	         Screen DeclarationCasualDetailsCustomsDeclarationCasualDetailsHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DeclarationCasualDetails.HeaderScreen", Name = "Customs.DeclarationCasualDetailsHeaderScreen", ObjectTableId = DeclarationCasualDetailsObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
