...
{
   public class CustomsBookTypeUpdateClass
   {  		
		public const string HashString = "632a832eb95209987f3cf74fdb5d7de6";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CustomsBookType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CustomsBookTypes",
			      				    ObjectTableSingular =  "Customs.CustomsBookType",
			      				    ObjectTablePlural =  "Customs.CustomsBookTypes",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CustomsBookTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CustomsBookType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CustomsBookTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CUBT", Name = "Customs.CustomsBookType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CustomsBookTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "0071", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsBookTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsBookType").ToList();
	         ...
	         Screen CustomsBookTypeCustomsCustomsBookTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsBookType.HeaderScreen", Name = "Customs.CustomsBookTypeHeaderScreen", ObjectTableId = CustomsBookTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CustomsBookTypeObjectTable.HeaderScreenId = CustomsBookTypeCustomsCustomsBookTypeHeaderScreenScreen0.Id;
		    CustomsBookTypeObjectTable.HeaderScreenCode = CustomsBookTypeCustomsCustomsBookTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomsBookTypeObjectTable.Id,
