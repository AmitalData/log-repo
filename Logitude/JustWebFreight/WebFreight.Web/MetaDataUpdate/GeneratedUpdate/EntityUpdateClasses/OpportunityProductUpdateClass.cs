...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "bfa8a9c131bec55856174c60f19bd265";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "OpportunityProduct",
			      				    DBTableName =  "OpportunityProducts",
			      				    ObjectTableSingular =  "Opportunity Product",
			      				    ObjectTablePlural =  "Opportunity Products",
			      				    ...
			      				    DefaultText =  "Opportunity Product",
			      				    Code =  "4933",
			      				    Name =  "OpportunityProduct Query Group",
			      				    GenerateDomainService =  false,
			      				    HashString =  OpportunityProductUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "OpportunityId",
					  						...
					  						ValidForQuerySection1 =  "OpportunityProduct",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "OpportunityProductTypeName",
					  						ObjectTableName =  "OpportunityProduct",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  60,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "OpportunityProductTypeName",
					  						ListPropertyPath =  "OpportunityProductTypeName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "OpportunityProductLocations",
					  						ObjectTableName =  "OpportunityProduct",
					  						FieldsDataType =  "List",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "OpportunityProductLocations",
					  						ListPropertyPath =  "OpportunityProductLocations",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						IsMulti =  true,
					  						MultiTableName =  "OpportunityProductLocation",
					  						DependencyFilter1IsList =  false,
					  						DependencyFilter2IsList =  false,
					  						DisplayInEntityVariables =  false,
					  						InActive =  false,
					  						...
					  						IsForeignKey =  false,
					  						ThisKey =  "OpportunityId,OpportunityProductTypeCode",
					  						OtherKey =  "OpportunityId,OpportunityProductTypeCode",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
	    ...
	    {   
			ObjectTable OpportunityProductObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "OpportunityProduct" && d.Tenant == 0).FirstOrDefault(); 
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = OpportunityProductObjectTable.Id,
