   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> GLAccountMoreDataObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "GLAccountMoreData").ToList();
	         ...
	         Screen GLAccountMoreDataGLAccountMoreDataHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "GLAccountMoreData.HeaderScreen", Name = "GLAccountMoreDataHeaderScreen", ObjectTableId = GLAccountMoreDataObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
