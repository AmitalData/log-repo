...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "4600999c4ff6169ea2008b7160e0dbab";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ShipperId",
					  						...
					  						DefaultText =  "Shipper",
					  						ListFieldLable =  "ShipperIdListLable",
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
             ...
             AdvancedQueryFilter NotConnectedEntriesQueryQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "WarehouseEntry.ConnectedToShipment", PredefinedValue = "false",PredefinedValue2 = null, CustomPredefined = false, QueryId = NotConnectedEntriesQueryQuery.Id,QueryCode = NotConnectedEntriesQueryQuery.UniqueCode, Tenant = 0}, addedQueryFilters);
	    ...
	    {   
            ...
            {
                Code =  "OVMA",
                EnglishName =  "Over Manifest",
                LocalName =  "Over Manifest",
                IsManualEntry =  false,
                ShortView =  false,
                IsAgentView =  false,
                IsCustomerView =  false,
