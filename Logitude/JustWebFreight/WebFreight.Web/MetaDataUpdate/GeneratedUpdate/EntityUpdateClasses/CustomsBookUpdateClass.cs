   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsBookObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsBook").ToList();
	         ...
	         Screen CustomsBookCustomsCustomsBookHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsBook.HeaderScreen", Name = "Customs.CustomsBookHeaderScreen", ObjectTableId = CustomsBookObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
