   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   Feature ExternalFieldMappingFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ExternalFieldMapping.Q.AllExternalFieldMapping", ObjectTableId = ExternalFieldMappingObjectTable.Id, Tenant = 0, NameTextCodeCode = "ExternalFieldMappingFeatures.AllExternalFieldMapping", NameTextCodeDefaultText = "AllExternalFieldMapping", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ExternalFieldMappingObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query AllExternalFieldMappingQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ExternalFieldMappingTextCode_0.Id, NameTextCodeCode = ExternalFieldMappingTextCode_0.Code, ObjectTableName = "Customs.ExternalFieldMapping", Code = "AllExternalFieldMapping",  QueryGroupCode = "300e", IndexOrder = 0, Tenant = 0, ObjectTableId = ExternalFieldMappingObjectTable.Id, QuerySection = "Customs.ExternalFieldMapping", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = ExternalFieldMappingFeature_0.Id,FeatureUniqeCode= ExternalFieldMappingFeature_0.FeatureUniqeCode, DefaultSortName = "Field", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllExternalFieldMappingQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalFieldMappingQuery.Id,QueryCode = AllExternalFieldMappingQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ExternalFieldMapping.Field" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllExternalFieldMappingQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalFieldMappingQuery.Id,QueryCode = AllExternalFieldMappingQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ExternalFieldMapping.StatusCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
			 ...
			 QueryColumn AllExternalFieldMappingQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalFieldMappingQuery.Id,QueryCode = AllExternalFieldMappingQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ExternalFieldMapping.StatusName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllExternalFieldMappingQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalFieldMappingQuery.Id,QueryCode = AllExternalFieldMappingQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.ExternalFieldMapping.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
