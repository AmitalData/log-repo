...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "6bbac87888525eac88d03ab7df0a3656";
	    ...
	    {  
	        ...
	        QueryGroup VehicleManufacturerQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "VMQG", Name = "Customs.VehicleManufacturer" }, queryGroupRepository,tenantQueryGroups);
