...
{
   public class CustomMetaDataTypeUpdateClass
   {  		
		public const string HashString = "ee00a229b676b6804e92df270f0bfcbe";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.CustomMetaDataType",
			      				    IsNew =  false,
			      				    DBTableName =  "Customs.CustomMetaDataTypes",
			      				    ObjectTableSingular =  "CustomMetaDataType",
			      				    ObjectTablePlural =  "CustomMetaDataTypes",
			      				    ...
			      				    DefaultText =  "Custom MetaData Type",
			      				    Code =  "CMDT",
			      				    Name =  "Customs.CustomMetaDataType",
			      				    CloseTableCode =  "Code",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CustomMetaDataTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "Customs.CustomMetaDataType",
					  						IsRestrictable =  false,
	    ...
	    {  
	        ...
	        QueryGroup CustomMetaDataTypeQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "CMDT", Name = "Customs.CustomMetaDataType" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CustomMetaDataTypeQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "b801", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomMetaDataTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomMetaDataType").ToList();
	         ...
	         Screen CustomMetaDataTypeCustomsCustomMetaDataTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomMetaDataType.HeaderScreen", Name = "Customs.CustomMetaDataTypeHeaderScreen", ObjectTableId = CustomMetaDataTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CustomMetaDataTypeObjectTable.HeaderScreenId = CustomMetaDataTypeCustomsCustomMetaDataTypeHeaderScreenScreen0.Id;
		    CustomMetaDataTypeObjectTable.HeaderScreenCode = CustomMetaDataTypeCustomsCustomMetaDataTypeHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomMetaDataTypeObjectTable.Id,
