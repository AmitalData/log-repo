...
{
   public class GLAccountWithholdingTaxUpdateClass
   {  		
		public const string HashString = "9f059177c6b09e69f2e705d3da9e4244";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "GLAccountWithholdingTax",
			      				    DBTableName =  "GLAccountWithholdingTax",
			      				    ObjectTableSingular =  "GLAccount Withholding Tax",
			      				    ObjectTablePlural =  "GLAccount Withholding Taxes",
			      				    ...
			      				    DefaultText =  "GLAccount Withholding Tax",
			      				    Code =  "1068",
			      				    Name =  "GLAccountWithholdingTax Query Group",
			      				    GenerateDomainService =  false,
			      				    ClientModuleName =  "Accounting",
			      				    ServerModuleName =  "Accounting",
			      				    NoTS =  false,
			      				    HasMenuButtons =  false,
			      				    HashString =  GLAccountWithholdingTaxUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Id",
					  						...
					  						ValidForQuerySection1 =  "GLAccountWithholdingTax",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Changed",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "Changed",
					  						ListPropertyPath =  "Changed",
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						IsMulti =  false,
	    ...
	    {   
			ObjectTable GLAccountWithholdingTaxObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "GLAccountWithholdingTax" && d.Tenant == 0).FirstOrDefault(); 
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = GLAccountWithholdingTaxObjectTable.Id,
