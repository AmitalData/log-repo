...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "7a2dd45255119a18e79d30b4fda374bc";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.ReferantTeam",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ReferantTeamUpdateClass.HashString,
	    ...
	    {   
		   ...
		   //List<ObjectField> ReferantTeamObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ReferantTeam").ToList();
		       
	      

	         Screen ReferantTeamCustomsTeamHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ReferantTeam.HeaderScreen", Name = "Customs.TeamHeaderScreen", ObjectTableId = ReferantTeamObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    ReferantTeamObjectTable.HeaderScreenId = ReferantTeamCustomsTeamHeaderScreenScreen0.Id;
	    ...
	    {  
		   ...
		   Feature ReferantTeamFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = true, ObjectTableId = ReferantTeamObjectTable.Id, Tenant = 0, NameTextCodeCode = "ReferantTeam.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,ReferantTeamObjectTable);
		   Feature ReferantTeamFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = true, ObjectTableId = ReferantTeamObjectTable.Id, Tenant = 0, NameTextCodeCode = "ReferantTeam.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,ReferantTeamObjectTable);
		   Feature ReferantTeamFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = true, ObjectTableId = ReferantTeamObjectTable.Id, Tenant = 0, NameTextCodeCode = "ReferantTeam.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,ReferantTeamObjectTable);
		   Feature ReferantTeamFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = true, ObjectTableId = ReferantTeamObjectTable.Id, Tenant = 0, NameTextCodeCode = "ReferantTeam.Features.PackageFeature", NameTextCodeDefaultText = "ReferantTeam Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,ReferantTeamObjectTable);    
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ReferantTeamObjectTable.Id,
