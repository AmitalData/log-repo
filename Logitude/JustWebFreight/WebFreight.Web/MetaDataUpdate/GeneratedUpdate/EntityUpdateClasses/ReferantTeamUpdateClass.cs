   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ReferantTeamTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ReferantTeam.Q.OperationalTeams", DefaultText = @"Operational teams",LocalDefaultText = "צוותים תפעוליים", ObjectTableId = ReferantTeamObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ReferantTeamFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ReferantTeam.Q.OperationalTeams", ObjectTableId = ReferantTeamObjectTable.Id, Tenant = 0, NameTextCodeCode = "ReferantTeamFeatures.OperationalTeams", NameTextCodeDefaultText = "OperationalTeams", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ReferantTeamObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query OperationalTeamsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ReferantTeamTextCode_0.Id, NameTextCodeCode = ReferantTeamTextCode_0.Code, ObjectTableName = "Customs.ReferantTeam", Code = "OperationalTeams",  QueryGroupCode = "475a", IndexOrder = 0, Tenant = 0, ObjectTableId = ReferantTeamObjectTable.Id, QuerySection = "Customs.ReferantTeam", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = ReferantTeamFeature_0.Id,FeatureUniqeCode= ReferantTeamFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn OperationalTeamsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OperationalTeamsQuery.Id,QueryCode = OperationalTeamsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ReferantTeam.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn OperationalTeamsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OperationalTeamsQuery.Id,QueryCode = OperationalTeamsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ReferantTeam.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn OperationalTeamsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OperationalTeamsQuery.Id,QueryCode = OperationalTeamsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ReferantTeam.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ReferantTeamObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.ReferantTeam").ToList();
	         ...
	         Screen ReferantTeamCustomsTeamHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ReferantTeam.HeaderScreen", Name = "Customs.TeamHeaderScreen", ObjectTableId = ReferantTeamObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
		    ...
		    ReferantTeamObjectTable.HeaderScreenCode = ReferantTeamCustomsTeamHeaderScreenScreen0.Code;
	         ...
	         Screen ReferantTeamGeneralTabScreenReferantScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ReferantTeam.GeneralTabScreen", Name = "General Tab ScreenReferant", ObjectTableId = ReferantTeamObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsReferantTeamReferantTeamGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ReferantTeamGeneralTabScreenReferantScreen1.Id,ScreenCode = ReferantTeamGeneralTabScreenReferantScreen1.Code, ObjectFieldCode = "Customs.ReferantTeam.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField CustomsReferantTeamReferantTeamGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = ReferantTeamGeneralTabScreenReferantScreen1.Id,ScreenCode = ReferantTeamGeneralTabScreenReferantScreen1.Code, ObjectFieldCode = "Customs.ReferantTeam.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
