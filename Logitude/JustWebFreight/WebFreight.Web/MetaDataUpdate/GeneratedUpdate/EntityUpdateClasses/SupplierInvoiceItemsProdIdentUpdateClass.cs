   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> SupplierInvoiceItemsProdIdentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.SupplierInvoiceItemsProdIdent").ToList();
	         ...
	         Screen SupplierInvoiceItemsProdIdentCustomsSupplierInvoiceItemsProdIdentHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "SupplierInvoiceItemsProdIdent.HeaderScreen", Name = "Customs.SupplierInvoiceItemsProdIdentHeaderScreen", ObjectTableId = SupplierInvoiceItemsProdIdentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
