   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomBanksCardObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomBanksCard").ToList();
	         ...
	         Screen CustomBanksCardCustomsCustomBanksCardHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomBanksCard.HeaderScreen", Name = "Customs.CustomBanksCardHeaderScreen", ObjectTableId = CustomBanksCardObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
