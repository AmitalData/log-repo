   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomBankTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomBank.Q.CustomBankQuery", DefaultText = @"Custom Banks",LocalDefaultText = "BS64:IteR16DXp9eZ150g157Xldeq15DXnteZ150g15DXmdep15nXqiI=", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CustomBankFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMBANKS", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.CustomBank.Features.CustomBanks", NameTextCodeDefaultText = "Custom Banks", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CustomBankObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CustomBanksQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomBank.Id" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomBank.Tenant" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomBank.InternalCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomBank.BankCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.CustomBank.BranchCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.CustomBank.AccountNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Customs.CustomBank.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Customs.CustomBank.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "Customs.CustomBank.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "Customs.CustomBank.PayerTypeCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "Customs.CustomBank.BankAddress" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "Customs.CustomBank.PayerTypeName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 12, ObjectFieldCode = "Customs.CustomBank.ClientBank" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_13 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 13, ObjectFieldCode = "Customs.CustomBank.BankName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_14 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 14, ObjectFieldCode = "Customs.CustomBank.BranchName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomBanksQueryColumn_15 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomBanksQuery.Id,QueryCode = CustomBanksQuery.UniqueCode, IndexOrder = 15, ObjectFieldCode = "Customs.CustomBank.Name" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomBankObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomBank").ToList();
	         ...
	         Screen CustomBankHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Customs.CustomBank.HeaderScreen", Name = "Header Screen", ObjectTableId = CustomBankObjectTable.Id, NumberOfColumns = 3, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsCustomBankCustomsCustomBankHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomBankHeaderScreenScreen0.Id,ScreenCode = CustomBankHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.CustomBank.InternalCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CustomBankHeaderScreenScreen0.Id,ScreenCode = CustomBankHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.CustomBank.BankCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ScreenId = CustomBankHeaderScreenScreen0.Id,ScreenCode = CustomBankHeaderScreenScreen0.Code, ObjectFieldCode = "Customs.CustomBank.BranchCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    CustomBankObjectTable.HeaderScreenCode = CustomBankHeaderScreenScreen0.Code;
	         ...
	         Screen CustomBankGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Customs.CustomBank.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = CustomBankObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsCustomBankCustomsCustomBankGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomBankGeneralTabScreenScreen1.Id,ScreenCode = CustomBankGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomBank.InternalCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomBankGeneralTabScreenScreen1.Id,ScreenCode = CustomBankGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomBank.BankCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CustomBankGeneralTabScreenScreen1.Id,ScreenCode = CustomBankGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomBank.BranchCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CustomBankGeneralTabScreenScreen1.Id,ScreenCode = CustomBankGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomBank.AccountNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CustomBankGeneralTabScreenScreen1.Id,ScreenCode = CustomBankGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomBank.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomBankCustomsCustomBankGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CustomBankGeneralTabScreenScreen1.Id,ScreenCode = CustomBankGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomBank.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CustomBankGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomBank.TH.General", DefaultText = "General",LocalDefaultText = "BS64:Iteb15zXnNeZIg==", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CustomBankGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.CustomBank.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CustomBankObjectTable,contextTenant);
 
                 
			   TextCode CustomBankEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomBank.TH.Events", DefaultText = "Events",LocalDefaultText = "BS64:IteQ15nXqNeV16LXmdedIg==", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode CustomBankTextCode_CustomsCustomBankORequired = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomBank.O.Required", DefaultText = "Related Client value is required",LocalDefaultText = @"BS64:Itei16jXmiDXnNen15XXlyDXp9ep15XXqCDXoNeT16jXqSI=", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CustomBankTextCode_CustomsCustomBankOExist = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomBank.O.Exist", DefaultText = "Sorry you can't choose an existing client",LocalDefaultText = @"BS64:Itec15Ag16DXmdeq158g15zXkdeX15XXqCDXp9eV15Mg15zXp9eV15cg16fXmdeZ150i", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CustomBankTextCode_CustomsCustomBankOBankNotConnectedToCustomer = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomBank.O.BankNotConnectedToCustomer", DefaultText = "This bank is not connected to this customer",LocalDefaultText = @"BS64:IteR16DXpyDXlteUINec15Ag157Xp9eV16nXqCDXnNec16fXldeXIC0g15zXkCDXoNeZ16rXnyDXnNeR15fXldeoIg==", ObjectTableId = CustomBankObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
