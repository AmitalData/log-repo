   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ConstraintTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ConstraintType.Q.ConstraintTypeQuery", DefaultText = @"Constraint Types",LocalDefaultText = "סוג אילוץ", ObjectTableId = ConstraintTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ConstraintTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CONSTRAINTTYPE", ObjectTableId = ConstraintTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.ConstraintType.Features.ConstraintTypes", NameTextCodeDefaultText = "Constraint Type", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ConstraintTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query ConstraintTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ConstraintTypeTextCode_0.Id, NameTextCodeCode = ConstraintTypeTextCode_0.Code, ObjectTableName = "Customs.ConstraintType", Code = "ConstraintType",  QueryGroupCode = "CONT", IndexOrder = 0, Tenant = 0, ObjectTableId = ConstraintTypeObjectTable.Id, QuerySection = "Customs.ConstraintType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ConstraintTypeFeature_0.Id,FeatureUniqeCode= ConstraintTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ConstraintTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConstraintTypeQuery.Id,QueryCode = ConstraintTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.ConstraintType.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ConstraintTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConstraintTypeQuery.Id,QueryCode = ConstraintTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.ConstraintType.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ConstraintTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConstraintTypeQuery.Id,QueryCode = ConstraintTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.ConstraintType.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn ConstraintTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ConstraintTypeQuery.Id,QueryCode = ConstraintTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.ConstraintType.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
