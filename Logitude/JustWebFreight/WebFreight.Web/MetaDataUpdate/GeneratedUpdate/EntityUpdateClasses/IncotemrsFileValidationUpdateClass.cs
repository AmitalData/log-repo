   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode IncotemrsFileValidationTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.IncotemrsFileValidation.Q.IncotemrsFileValidationQuery", DefaultText = @"IncotemrsFileValidations",LocalDefaultText = "תנאי מכר המחיבים הזנת ערך בהצהרה", ObjectTableId = IncotemrsFileValidationObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature IncotemrsFileValidationFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "IncotemrsFileValidationS", ObjectTableId = IncotemrsFileValidationObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.IncotemrsFileValidation.Features.IncotemrsFileValidations", NameTextCodeDefaultText = "IncotemrsFileValidations", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,IncotemrsFileValidationObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query IncotemrsFileValidationQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = IncotemrsFileValidationTextCode_0.Id, NameTextCodeCode = IncotemrsFileValidationTextCode_0.Code, ObjectTableName = "Customs.IncotemrsFileValidation", Code = "IncotemrsFileValidation",  QueryGroupCode = "IFVQ", IndexOrder = 0, Tenant = 0, ObjectTableId = IncotemrsFileValidationObjectTable.Id, QuerySection = "Customs.IncotemrsFileValidation", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = IncotemrsFileValidationFeature_0.Id,FeatureUniqeCode= IncotemrsFileValidationFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn IncotemrsFileValidationQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotemrsFileValidationQuery.Id,QueryCode = IncotemrsFileValidationQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.IncotemrsFileValidation.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> IncotemrsFileValidationObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.IncotemrsFileValidation").ToList();
	         ...
	         Screen IncotemrsFileValidationCustomsIncotemrsFileValidationHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "IncotemrsFileValidation.HeaderScreen", Name = "Customs.IncotemrsFileValidationHeaderScreen", ObjectTableId = IncotemrsFileValidationObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
