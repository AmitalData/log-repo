...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "9baa8880114751b336cbb3bf02817c54";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "InterestReportStatuse",
			      				    IsNew =  true,
			      				    DBTableName =  "InterestReportStatuses",
			      				    OldDBTableName =  "InterestReportStatuses",
			      				    ObjectTableSingular =  "InterestReportStatuse",
			      				    ObjectTablePlural =  "InterestReportStatuses",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  InterestReportStatuseUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "InterestReportStatuse",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   ObjectTable InterestReportStatuseObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "InterestReportStatuse" && d.Tenant == 0).FirstOrDefault();
		   List<ObjectField> InterestReportStatuseObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "InterestReportStatuse").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = InterestReportStatuseObjectTable.Id,
	    ...
	    public void FillInterestReportStatuse()
        { 
            var repo = new InterestReportStatuseRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                InterestReportStatuse,
                                InterestReportStatuseDetails,
                                InterestReportStatuseRepository>(repo, dic);
        }
