   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode HandingCodeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.HandingCode.Q.HandingCodeQuery", DefaultText = @"HandingCodes",LocalDefaultText = "HandingCode", ObjectTableId = HandingCodeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature HandingCodeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "HandingCodeS", ObjectTableId = HandingCodeObjectTable.Id, Tenant = 0, NameTextCodeCode = "Customs.HandingCode.Features.HandingCodes", NameTextCodeDefaultText = "HandingCodes", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,HandingCodeObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn HandingCodeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HandingCodeQuery.Id,QueryCode = HandingCodeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.HandingCode.Code" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn HandingCodeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HandingCodeQuery.Id,QueryCode = HandingCodeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.HandingCode.EnglishName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn HandingCodeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HandingCodeQuery.Id,QueryCode = HandingCodeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.HandingCode.LocalName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn HandingCodeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HandingCodeQuery.Id,QueryCode = HandingCodeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.HandingCode.Inactive" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> HandingCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.HandingCode").ToList();
	         ...
	         Screen HandingCodeCustomsHandingCodeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "HandingCode.HeaderScreen", Name = "Customs.HandingCodeHeaderScreen", ObjectTableId = HandingCodeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
