   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PoaAuthorizationTypeLookupTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PoaAuthorizationTypeLookup.Q.PoaAuthorizationTypeLookup", DefaultText = @"PoaAuthorizationTypeLookupQuery",LocalDefaultText = "סוג הרשאה בכתב הרשאה", ObjectTableId = PoaAuthorizationTypeLookupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
