...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "e02beda512bc4fa5b5eb39799ef95e78";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "Customs.OcrDocument",
			      				    IsNew =  true,
			      				    DBTableName =  "Customs.OcrDocuments",
			      				    ObjectTableSingular =  "Customs.OcrDocument",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  OcrDocumentUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Process",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "Process",
					  						ListPropertyPath =  "Process",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Score",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "Score",
					  						ListPropertyPath =  "Score",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "JsonTif",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "JsonTif",
					  						ListPropertyPath =  "JsonTif",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "JsonTif",
					  						DefaultText =  "Json Tif",
					  						ListFieldLable =  "JsonTifListLable",
					  						ListLableDefaultText =  "Json Tif",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ErrorMsg",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "ErrorMsg",
					  						ListPropertyPath =  "ErrorMsg",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "StatusCode",
					  						...
					  						LookUpTableName =  "Customs.OcrStatus",
					  						MinLength =  0,
					  						MaxLength =  3,
					  						IsRequired =  false,
					  						CopyToDW =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "OcrId",
					  						...
					  						DefaultText =  "Ocr Id",
					  						ListFieldLable =  "OcrIdListLable",
					  						ListLableDefaultText =  "Ocr id",
					  						ListLocalDefaultText =  "Ocr Id",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DocId",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "DocId",
					  						ListPropertyPath =  "DocId",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "DocId",
					  						DefaultText =  "Document Id",
					  						ListFieldLable =  "DocIdListLable",
					  						ListLableDefaultText =  "Document Id",
					  						IsForeignKey =  true,
	    ...
	    {   
		   ...
		   //List<ObjectField> OcrDocumentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.OcrDocument").ToList();
		       
	      

	         Screen OcrDocumentCustomsOcrDocumentHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "OcrDocument.HeaderScreen", Name = "Customs.OcrDocumentHeaderScreen", ObjectTableId = OcrDocumentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    OcrDocumentObjectTable.HeaderScreenId = OcrDocumentCustomsOcrDocumentHeaderScreenScreen0.Id;
		    OcrDocumentObjectTable.HeaderScreenCode = OcrDocumentCustomsOcrDocumentHeaderScreenScreen0.Code;
	    ...
	    {  
		   ...
		   Feature OcrDocumentFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = OcrDocumentObjectTable.Id, Tenant = 0, NameTextCodeCode = "OcrDocument.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,OcrDocumentObjectTable);
		   Feature OcrDocumentFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = OcrDocumentObjectTable.Id, Tenant = 0, NameTextCodeCode = "OcrDocument.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,OcrDocumentObjectTable);
		   Feature OcrDocumentFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = OcrDocumentObjectTable.Id, Tenant = 0, NameTextCodeCode = "OcrDocument.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,OcrDocumentObjectTable);
		   Feature OcrDocumentFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = false, ObjectTableId = OcrDocumentObjectTable.Id, Tenant = 0, NameTextCodeCode = "OcrDocument.Features.PackageFeature", NameTextCodeDefaultText = "OcrDocument Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,OcrDocumentObjectTable);    
