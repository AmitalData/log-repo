   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> OcrDocumentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.OcrDocument").ToList();
	         ...
	         Screen OcrDocumentCustomsOcrDocumentHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "OcrDocument.HeaderScreen", Name = "Customs.OcrDocumentHeaderScreen", ObjectTableId = OcrDocumentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
