...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "ad9aba8040e2a94c382ca79470a50b82";
	    ...
	    {   
		   ...
		   //List<ObjectField> AmendmentStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AmendmentStatus").ToList();
	         ...
	         Screen AmendmentStatusCustomsAmendmentStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AmendmentStatus.HeaderScreen", Name = "Customs.AmendmentStatusHeaderScreen", ObjectTableId = AmendmentStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
