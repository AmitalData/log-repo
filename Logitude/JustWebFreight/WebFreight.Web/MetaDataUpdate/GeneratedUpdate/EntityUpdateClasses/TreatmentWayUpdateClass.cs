   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode TreatmentWayTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "TreatmentWay.Q.TreatmentWay", DefaultText = @"TreatmentWayQuery",LocalDefaultText = null, ObjectTableId = TreatmentWayObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature TreatmentWayFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TreatmentWay.Q.TreatmentWay", ObjectTableId = TreatmentWayObjectTable.Id, Tenant = 0, NameTextCodeCode = "TreatmentWay.Features.TreatmentWay", NameTextCodeDefaultText = "TreatmentWay", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,TreatmentWayObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query TreatmentWayQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = TreatmentWayTextCode_0.Id, NameTextCodeCode = TreatmentWayTextCode_0.Code, ObjectTableName = "Customs.TreatmentWay", Code = "TreatmentWay",  QueryGroupCode = "2ea0", IndexOrder = 0, Tenant = 0, ObjectTableId = TreatmentWayObjectTable.Id, QuerySection = "Customs.ActionCode", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = TreatmentWayFeature_0.Id,FeatureUniqeCode= TreatmentWayFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn TreatmentWayQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TreatmentWayQuery.Id,QueryCode = TreatmentWayQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.TreatmentWay.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn TreatmentWayQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TreatmentWayQuery.Id,QueryCode = TreatmentWayQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.TreatmentWay.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn TreatmentWayQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TreatmentWayQuery.Id,QueryCode = TreatmentWayQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.TreatmentWay.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn TreatmentWayQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TreatmentWayQuery.Id,QueryCode = TreatmentWayQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.TreatmentWay.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
