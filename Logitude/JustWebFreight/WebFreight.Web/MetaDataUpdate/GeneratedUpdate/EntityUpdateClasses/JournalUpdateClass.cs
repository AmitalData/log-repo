...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {  
	        ...
	        QueryGroup JournalQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "JNAC", Name = "Journal Query Group" }, queryGroupRepository);
						QueryGroup JournalQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "cbc2", Name = " Query Group" }, queryGroupRepository);
	        ...
	        List<ObjectField> JournalObjectFields = objectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Journal").ToList();   
			   ...
			   TextCode JournalTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Journal.Q.AllJournals", DefaultText = @"All Journal",LocalDefaultText = "כל פקודות היומן", ObjectTableId = JournalObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, TextCodeRepository, textCodes);
			   ...
			   TextCode JournalTextCode_2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Journal.Q.ApprovedJournals", DefaultText = @"Approved Journals",LocalDefaultText = "פקודות יומן מאושרות", ObjectTableId = JournalObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, TextCodeRepository, textCodes);
			   ...
			   TextCode JournalTextCode_3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Journal.Q.DraftJournals", DefaultText = @"Draft Journals",LocalDefaultText = "פקודות יומן בסטטוס טיוטה", ObjectTableId = JournalObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, TextCodeRepository, textCodes);
			   ...
			   TextCode JournalTextCode_4 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Journal.Q.SavedJournals", DefaultText = @"Waiting for Approval Journals",LocalDefaultText = "פקודות יומן שממתינות לאישור", ObjectTableId = JournalObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, TextCodeRepository, textCodes);
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ExternalJournalsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ExternalJournalsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ExternalJournalsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 3, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 110 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ExternalJournalsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 4, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ExternalJournalsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 5, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ExternalJournalsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 6, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ExternalJournalsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, IndexOrder = 7, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter ExternalJournalsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "ExternalSystem" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "ExternalSystem" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "1",PredefinedValue2 = null, QueryId = ExternalJournalsQuery.Id,QueryCode = ExternalJournalsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
			 ...
			 QueryColumn AllJournalsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllJournalsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllJournalsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 3, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 110 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllJournalsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 4, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllJournalsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 5, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllJournalsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 6, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllJournalsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllJournalsQuery.Id,QueryCode = AllJournalsQuery.Code, IndexOrder = 7, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);
			 ...
			 QueryColumn ApprovedJournalsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ApprovedJournalsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ApprovedJournalsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 3, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 110 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ApprovedJournalsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 4, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ApprovedJournalsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 5, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ApprovedJournalsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 6, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ApprovedJournalsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, IndexOrder = 7, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter ApprovedJournalsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "2",PredefinedValue2 = null, QueryId = ApprovedJournalsQuery.Id,QueryCode = ApprovedJournalsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
			 ...
			 QueryColumn DraftJournalsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DraftJournalsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DraftJournalsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 3, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 110 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DraftJournalsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 4, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DraftJournalsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 5, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DraftJournalsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 6, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DraftJournalsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, IndexOrder = 7, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter DraftJournalsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "0",PredefinedValue2 = null, QueryId = DraftJournalsQuery.Id,QueryCode = DraftJournalsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
			 ...
			 QueryColumn SavedJournalsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SavedJournalsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SavedJournalsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 3, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingDate" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 110 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SavedJournalsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 4, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SavedJournalsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 5, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "TypeName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SavedJournalsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 6, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SavedJournalsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SavedJournalsQuery.Id,QueryCode = SavedJournalsQuery.Code, IndexOrder = 7, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference" && d.ObjectTableId == JournalObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> JournalObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Journal").ToList();
            ...
            ScreenField JournalGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().Id, ScreenId = JournalGeneralTabScreenScreen0.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "UpdateDate").FirstOrDefault().Id, ScreenId = JournalGeneralTabScreenScreen0.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "UpdateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "ApproveDate").FirstOrDefault().Id, ScreenId = JournalGeneralTabScreenScreen0.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "ApproveDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserId").FirstOrDefault().Id, ScreenId = JournalGeneralTabScreenScreen0.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "UpdatedByUserId").FirstOrDefault().Id, ScreenId = JournalGeneralTabScreenScreen0.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "UpdatedByUserId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "ApprovedByUserId").FirstOrDefault().Id, ScreenId = JournalGeneralTabScreenScreen0.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "ApprovedByUserId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
            ...
            ScreenField JournalHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "JournalNumber").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "JournalNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreateDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "StatusName").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "StatusName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "CreatedByUserName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "OriginalJournalName").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "OriginalJournalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "ApproveDate").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "ApproveDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityReference").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "AccountingEntityName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 4, Row = 0, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "ExternalNo").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "ExternalNo").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField JournalHeaderScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 4, Row = 1, ObjectFieldId = JournalObjectFields.Where(d => d.FieldName == "ExternalSystem").FirstOrDefault().Id, ScreenId = JournalHeaderScreenScreen1.Id, ObjectFieldCode = JournalObjectFields.Where(d => d.FieldName == "ExternalSystem").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "JNDT",HtmlComponentName = "JournalDetailsTabComponent",HtmlComponentUrl = "./Accounting/Components/EditTabs/Journal/JournalDetailsTabComponent", FeatureId = JournalDetailsFeature_TH0.Id, ControlPath = "Logitude.Accounting.Views.Tabs.JRNL.JournalDetailsTabControl", ObjectTableId = JournalObjectTable.Id, TabNameTextCodeId = JournalDetailsTextCode_TH0.Id, TabNameTextCodeCode = JournalDetailsTextCode_TH0.Code, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "JNEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = JournalEventsFeature_TH1.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = JournalObjectTable.Id, TabNameTextCodeId = JournalEventsTextCode_TH1.Id, TabNameTextCodeCode = JournalEventsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
