...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "dc07a9f5d91b43f3fa50f4848862517a";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "RevenueExpenseType",
			      				    IsNew =  false,
			      				    DBTableName =  "RevenueExpenseTypes",
			      				    ObjectTableSingular =  "RevenueExpenseType",
			      				    ObjectTablePlural =  "RevenueExpenseTypes",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  RevenueExpenseTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "RevenueExpenseType",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   ObjectTable RevenueExpenseTypeObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "RevenueExpenseType" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> RevenueExpenseTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "RevenueExpenseType").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = RevenueExpenseTypeObjectTable.Id,
	    ...
	    public void FillRevenueExpenseType()
        { 
            var repo = new RevenueExpenseTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                RevenueExpenseType,
                                RevenueExpenseTypeDetails,
                                RevenueExpenseTypeRepository>(repo, dic);
        }
