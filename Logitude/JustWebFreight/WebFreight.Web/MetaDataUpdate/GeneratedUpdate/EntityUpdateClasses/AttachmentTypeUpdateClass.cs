   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AttachmentTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.AttachmentType").ToList();
	         ...
	         Screen AttachmentTypeCustomsAttachmentTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AttachmentType.HeaderScreen", Name = "Customs.AttachmentTypeHeaderScreen", ObjectTableId = AttachmentTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
