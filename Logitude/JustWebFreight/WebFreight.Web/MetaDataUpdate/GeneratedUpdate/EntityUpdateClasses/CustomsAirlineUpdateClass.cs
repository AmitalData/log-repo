   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomsAirlineTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomsAirline.Q.AllCustomsAirlines", DefaultText = @"All Customs Airlines",LocalDefaultText = "חברות תעופה", ObjectTableId = CustomsAirlineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CustomsAirlineFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomsAirline.Q.AllCustomsAirlines", ObjectTableId = CustomsAirlineObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsAirline.Features.AllCustomsAirlines", NameTextCodeDefaultText = "AllCustomsAirlines", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CustomsAirlineObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query AllCustomsAirlinesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomsAirlineTextCode_0.Id, NameTextCodeCode = CustomsAirlineTextCode_0.Code, ObjectTableName = "Customs.CustomsAirline", Code = "AllCustomsAirlines",  QueryGroupCode = "6e9e", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomsAirlineObjectTable.Id, QuerySection = "Customs.CustomsAirline", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CustomsAirlineFeature_0.Id,FeatureUniqeCode= CustomsAirlineFeature_0.FeatureUniqeCode, DefaultSortName = "EnglishName", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllCustomsAirlinesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomsAirlinesQuery.Id,QueryCode = AllCustomsAirlinesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CustomsAirline.AirlineCode" , ColumnWidth = 80 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomsAirlinesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomsAirlinesQuery.Id,QueryCode = AllCustomsAirlinesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CustomsAirline.UnloadPortCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomsAirlinesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomsAirlinesQuery.Id,QueryCode = AllCustomsAirlinesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CustomsAirline.AirlinePrefix" , ColumnWidth = 80 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomsAirlinesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomsAirlinesQuery.Id,QueryCode = AllCustomsAirlinesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CustomsAirline.LocalName" , ColumnWidth = 240 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomsAirlinesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomsAirlinesQuery.Id,QueryCode = AllCustomsAirlinesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.CustomsAirline.EnglishName" , ColumnWidth = 220 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomsAirlinesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomsAirlinesQuery.Id,QueryCode = AllCustomsAirlinesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.CustomsAirline.InActive" , ColumnWidth = 80 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomsAirlineObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.CustomsAirline").ToList();
		    ...
		    CustomsAirlineObjectTable.HeaderScreenCode = CustomsAirlineCustomsCustomsAirlineHeaderScreenScreen0.Code;
	         ...
	         Screen CustomsAirlineGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomsAirline.GeneralTabScreen", Name = "GeneralTabScreen", ObjectTableId = CustomsAirlineObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomsCustomsAirlineCustomsAirlineGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomsAirlineGeneralTabScreenScreen1.Id,ScreenCode = CustomsAirlineGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsAirline.AirlineCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomsAirlineCustomsAirlineGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomsAirlineGeneralTabScreenScreen1.Id,ScreenCode = CustomsAirlineGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsAirline.AirlinePrefix", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomsAirlineCustomsAirlineGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CustomsAirlineGeneralTabScreenScreen1.Id,ScreenCode = CustomsAirlineGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsAirline.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomsAirlineCustomsAirlineGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CustomsAirlineGeneralTabScreenScreen1.Id,ScreenCode = CustomsAirlineGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsAirline.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomsCustomsAirlineCustomsAirlineGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CustomsAirlineGeneralTabScreenScreen1.Id,ScreenCode = CustomsAirlineGeneralTabScreenScreen1.Code, ObjectFieldCode = "Customs.CustomsAirline.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CustomsAirlineGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomsAirline.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = CustomsAirlineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CustomsAirlineGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomsAirline.Tab.General", ObjectTableId = CustomsAirlineObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsAirline.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CustomsAirlineObjectTable,contextTenant);
 
                 
			   TextCode CustomsAirlineEventTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CustomsAirline.TH.Event", DefaultText = "Event",LocalDefaultText = "אירועים", ObjectTableId = CustomsAirlineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CustomsAirlineEventFeature_TH1 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomsAirline.Tab.Event", ObjectTableId = CustomsAirlineObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsAirline.Features.Event", NameTextCodeDefaultText = "Event", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CustomsAirlineObjectTable,contextTenant);
			 TextCodeRepository.SubmitChanges();
			 FeaturesRepository.SubmitChanges();
