   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllCouriersPendingQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CourierPendingReasonTextCode_0.Id, NameTextCodeCode = CourierPendingReasonTextCode_0.Code, ObjectTableName = "Customs.CourierPendingReason", Code = "AllCouriersPending",  QueryGroupCode = "aef0", IndexOrder = 0, Tenant = 0, ObjectTableId = CourierPendingReasonObjectTable.Id, QuerySection = "Customs.CourierPendingReason", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CourierPendingReasonFeature_0.Id,FeatureUniqeCode= CourierPendingReasonFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllCouriersPendingQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.CourierPendingReason.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.CourierPendingReason.LocalName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.CourierPendingReason.EnglishName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.CourierPendingReason.ErrorPlaceName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.CourierPendingReason.UnifreightStatusCode" , ColumnWidth = 167 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.CourierPendingReason.Inactive" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Customs.CourierPendingReason.MamanSuspendedCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Customs.CourierPendingReason.SwissportSuspendedCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCouriersPendingQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCouriersPendingQuery.Id,QueryCode = AllCouriersPendingQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "Customs.CourierPendingReason.OverseasSuspendedCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CourierPendingReasonGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CourierPendingReason.TH.General", DefaultText = "General",LocalDefaultText = "כללי", ObjectTableId = CourierPendingReasonObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CourierPendingReasonEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.CourierPendingReason.TH.Events", DefaultText = "Events",LocalDefaultText = "אירועים", ObjectTableId = CourierPendingReasonObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
