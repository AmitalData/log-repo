...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "a03dc8bb925449bc4ee4141d28f6daee";
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ExportStorageTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ExportStorage.Q.CloseStorages", DefaultText = @"Close Storages",LocalDefaultText = "םחסנות סגורות", ObjectTableId = ExportStorageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   ...
			   TextCode ExportStorageTextCode_2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ExportStorage.Q.CancelStorages", DefaultText = @"Cancel Storages",LocalDefaultText = "םחסנות מבוטלות", ObjectTableId = ExportStorageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
			   ...
			   TextCode ExportStorageTextCode_3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ExportStorage.Q.AllStorages", DefaultText = @"All Storages",LocalDefaultText = "כל הםחסנות", ObjectTableId = ExportStorageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
	        ...
	        //FeaturesRepository.SubmitChanges();    
             ...
             AdvancedQueryFilter CloseStoragesQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Customs.ExportStorage.StorageStatus", PredefinedValue = "Close",PredefinedValue2 = null, QueryId = CloseStoragesQuery.Id,QueryCode = CloseStoragesQuery.UniqueCode, Tenant = 0,Operator = "Equal"}, addedQueryFilters);
	    ...
	    {  
 		   ...
 		   TextCode ExportStorageTextCode_CustomsExportStorageOConnectedAllToDeclartion = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ExportStorage.O.ConnectedAllToDeclartion", DefaultText = "Are you sure you want to link ",LocalDefaultText = @"הםם םתה בטוח שברצונך לקשר ", ObjectTableId = ExportStorageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode ExportStorageTextCode_CustomsExportStorageOExportStoragesToDeclartion = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.ExportStorage.O.ExportStoragesToDeclartion", DefaultText = "exportstorage to declaration",LocalDefaultText = @"םחסנות להצהרה הנוכחית?", ObjectTableId = ExportStorageObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
