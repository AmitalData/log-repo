   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode TradeAgreementTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Customs.TradeAgreement.Q.TradeAgreementQuery", DefaultText = @"Trade Agreement Type Views",LocalDefaultText = "סוג הסכם סחר", ObjectTableId = TradeAgreementObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query TradeAgreementQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = TradeAgreementTextCode_0.Id, NameTextCodeCode = TradeAgreementTextCode_0.Code, ObjectTableName = "Customs.TradeAgreement", Code = "TradeAgreement",  QueryGroupCode = "TRAG", IndexOrder = 0, Tenant = 0, ObjectTableId = TradeAgreementObjectTable.Id, QuerySection = "Customs.TradeAgreement", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = TradeAgreementFeature_0.Id,FeatureUniqeCode= TradeAgreementFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn TradeAgreementQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TradeAgreementQuery.Id,QueryCode = TradeAgreementQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.TradeAgreement.Code" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TradeAgreementQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TradeAgreementQuery.Id,QueryCode = TradeAgreementQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.TradeAgreement.CountryGroupID" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn TradeAgreementQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TradeAgreementQuery.Id,QueryCode = TradeAgreementQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.TradeAgreement.CustomsBookTypeID" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn TradeAgreementQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TradeAgreementQuery.Id,QueryCode = TradeAgreementQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.TradeAgreement.EnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TradeAgreementQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TradeAgreementQuery.Id,QueryCode = TradeAgreementQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Customs.TradeAgreement.LocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TradeAgreementQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TradeAgreementQuery.Id,QueryCode = TradeAgreementQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Customs.TradeAgreement.Inactive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> TradeAgreementObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Customs.TradeAgreement").ToList();
	         ...
	         Screen TradeAgreementCustomsTradeAgreementHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TradeAgreement.HeaderScreen", Name = "Customs.TradeAgreementHeaderScreen", ObjectTableId = TradeAgreementObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
