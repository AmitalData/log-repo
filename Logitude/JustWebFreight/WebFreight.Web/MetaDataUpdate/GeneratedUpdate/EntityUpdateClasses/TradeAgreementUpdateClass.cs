...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "0c0c653c7ca83317bce6333bed495560";
	    ...
	    {  
	        ...
	        QueryGroup TradeAgreementQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "TRAG", Name = "Customs.TradeAgreement" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup TradeAgreementQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "c574", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
