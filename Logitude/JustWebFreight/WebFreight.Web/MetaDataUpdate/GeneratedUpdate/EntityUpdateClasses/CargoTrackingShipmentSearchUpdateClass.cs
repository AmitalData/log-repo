...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.EntityUpdateClasses
{
   ...
   {  		
		...
		public const string HashString = "ab5a03a43db9572ceb3a5dccbccfb0f6";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "CargoTrackingShipmentSearch",
			      				    IsNew =  true,
			      				    DBTableName =  "CargoTrackingShipmentSearches",
			      				    ObjectTableSingular =  "CargoTrackingShipmentSearch",
			      				    ObjectTablePlural =  "CargoTrackingShipmentSearches",
			      				    ...
			      				    SortingByObjectField =  "ShipmentDate",
			      				    InActive =  false,
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  CargoTrackingShipmentSearchUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						ValidForQuerySection1 =  "CargoTrackingShipmentSearch",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ShipmentDate",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "ShipmentDate",
					  						ListPropertyPath =  "ShipmentDate",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "ShipmentDate",
					  						DefaultText =  "Shipment Date",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsPublic",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "IsPublic",
					  						ListPropertyPath =  "IsPublic",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "IsPublic",
					  						DefaultText =  "Is Public",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ReferenceFromShipmentId",
					  						ObjectTableName =  "CargoTrackingShipmentSearch",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  30,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "ReferenceFromShipmentId",
					  						ListPropertyPath =  "ReferenceFromShipmentId",
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						IsMulti =  false,
					  						...
					  						DependencyFilter2IsList =  false,
					  						DependencyFilter3IsList =  false,
					  						ValidForQuerySection1 =  "ReferenceFromShipmentId",
					  						IsRestrictable =  false,
					  						DisplayInEntityVariables =  false,
					  						AllowedInCustomerFieldsSettings =  false,
					  						DisplayInSearchWindowFilters =  false,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "ReferenceFromShipmentId",
					  						DefaultText =  "ReferenceFromShipmentId",
					  						ListFieldLable =  "ReferenceFromShipmentIdListLable",
					  						ListLableDefaultText =  "ReferenceFromShipmentId",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
	    ...
	    {   
		   ...
		   //List<ObjectField> CargoTrackingShipmentSearchObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CargoTrackingShipmentSearch").ToList();
		       
	      

	         Screen CargoTrackingShipmentSearchCargoTrackingShipmentSearchHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CargoTrackingShipmentSearch.HeaderScreen", Name = "CargoTrackingShipmentSearchHeaderScreen", ObjectTableId = CargoTrackingShipmentSearchObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CargoTrackingShipmentSearchObjectTable.HeaderScreenId = CargoTrackingShipmentSearchCargoTrackingShipmentSearchHeaderScreenScreen0.Id;
		    CargoTrackingShipmentSearchObjectTable.HeaderScreenCode = CargoTrackingShipmentSearchCargoTrackingShipmentSearchHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CargoTrackingShipmentSearchObjectTable.Id,
