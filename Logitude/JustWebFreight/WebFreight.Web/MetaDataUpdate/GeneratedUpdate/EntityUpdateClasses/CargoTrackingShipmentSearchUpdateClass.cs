   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CargoTrackingShipmentSearchObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CargoTrackingShipmentSearch").ToList();
	         ...
	         Screen CargoTrackingShipmentSearchCargoTrackingShipmentSearchHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CargoTrackingShipmentSearch.HeaderScreen", Name = "CargoTrackingShipmentSearchHeaderScreen", ObjectTableId = CargoTrackingShipmentSearchObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
