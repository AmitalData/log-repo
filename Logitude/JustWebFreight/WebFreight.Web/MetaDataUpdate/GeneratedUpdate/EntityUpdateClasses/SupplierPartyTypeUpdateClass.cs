   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode SupplierPartyTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "SupplierPartyType.Q.SupplierPartyType", DefaultText = @"SupplierPartyType",LocalDefaultText = "אופן הספקת ציוד ההובלה", ObjectTableId = SupplierPartyTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature SupplierPartyTypeFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SupplierPartyType.Q.SupplierPartyType", ObjectTableId = SupplierPartyTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "SupplierPartyTypeFeatures.SupplierPartyType", NameTextCodeDefaultText = "SupplierPartyType", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,SupplierPartyTypeObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query SupplierPartyTypeQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = SupplierPartyTypeTextCode_0.Id, NameTextCodeCode = SupplierPartyTypeTextCode_0.Code, ObjectTableName = "Customs.SupplierPartyType", Code = "SupplierPartyType",  QueryGroupCode = "SPTQ", IndexOrder = 0, Tenant = 0, ObjectTableId = SupplierPartyTypeObjectTable.Id, QuerySection = "Customs.SupplierPartyType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = SupplierPartyTypeFeature_0.Id,FeatureUniqeCode= SupplierPartyTypeFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Ascending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn SupplierPartyTypeQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SupplierPartyTypeQuery.Id,QueryCode = SupplierPartyTypeQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Customs.SupplierPartyType.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SupplierPartyTypeQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SupplierPartyTypeQuery.Id,QueryCode = SupplierPartyTypeQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Customs.SupplierPartyType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SupplierPartyTypeQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SupplierPartyTypeQuery.Id,QueryCode = SupplierPartyTypeQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Customs.SupplierPartyType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SupplierPartyTypeQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SupplierPartyTypeQuery.Id,QueryCode = SupplierPartyTypeQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Customs.SupplierPartyType.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
