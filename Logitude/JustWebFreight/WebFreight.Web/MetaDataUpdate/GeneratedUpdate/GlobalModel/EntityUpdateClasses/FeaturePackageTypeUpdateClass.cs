...
{
   public class FeaturePackageTypeUpdateClass
   {  		
		public const string HashString = "2cce1b532b5705453b4c93e0a4b3982f";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "FeaturePackageType",
			      				    ...
			      				    OldDBTableName =  "FeaturePackageTypes",
			      				    ...
			      				    IsLookUp =  true,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "FeaturePackageType,FeaturePackageTypes,,Code,",
			      				    HashString =  FeaturePackageTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Code",
					  						...
					  						ValidForQuerySection1 =  "FeaturePackageType",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   ObjectTable FeaturePackageTypeObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "FeaturePackageType" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> FeaturePackageTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "FeaturePackageType").ToList();
		       
	      

	         Screen FeaturePackageTypeFeaturePackageTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "FeaturePackageType.HeaderScreen", Name = "FeaturePackageTypeHeaderScreen", ObjectTableId = FeaturePackageTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = FeaturePackageTypeObjectTable.Id,
	    ...
	    public void FillFeaturePackageType(int contextTenant)
        { 
            var repo = new FeaturePackageTypeRepository();
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                FeaturePackageType,
                                Logitude.BL.CommonDataModel.FeaturePackageTypeDetails,
                                FeaturePackageTypeRepository>(repo, dic);
        }
