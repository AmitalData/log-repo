   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ApiCredintialsTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ApiCredintials.Q.ApiCredintials", DefaultText = @"All API Credentials",LocalDefaultText = null, ObjectTableId = ApiCredintialsObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ApiCredintialsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "ApiCredintials.UsedFor" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "ApiCredintials.maskedPrimaryAccessKey" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "ApiCredintials.maskedSeconderyAccessKey" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "ApiCredintials.AllowedIPs" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "ApiCredintials.CreateDate" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "ApiCredintials.UpdateDate" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "ApiCredintials.CreatedBy" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn ApiCredintialsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ApiCredintialsQuery.Id,QueryCode = ApiCredintialsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "ApiCredintials.UpdatedBy" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ApiCredintialsObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ApiCredintials").ToList();
	         ...
	         Screen ApiCredintialsApiCredintialsHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ApiCredintials.HeaderScreen", Name = "ApiCredintialsHeaderScreen", ObjectTableId = ApiCredintialsObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
