   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> PaymentMethodObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PaymentMethod").ToList();
	         ...
	         Screen PaymentMethodPaymentMethodHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PaymentMethod.HeaderScreen", Name = "PaymentMethodHeaderScreen", ObjectTableId = PaymentMethodObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillPaymentMethod(int contextTenant)
        { 
            var repo = new PaymentMethodRepository(contextTenant);
