   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AnalyzeQueueTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue.Q.TodayAnalyzeQueues", DefaultText = @"Today",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature AnalyzeQueueFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TODAYANALYZEQUS", ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, NameTextCodeCode = "AnalyzeQueueObjectTable.Features.TodayAnalyzeQueues", NameTextCodeDefaultText = "Today Analyze Queues", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,AnalyzeQueueObjectTable, addedFeatures, addedTextCodes,contextTenant);
 

			   TextCode AnalyzeQueueTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue.Q.AllAnalyzeQueues", DefaultText = @"All Analyze Queues",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query TodayAnalyzeQueuesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AnalyzeQueueTextCode_0.Id, NameTextCodeCode = AnalyzeQueueTextCode_0.Code, ObjectTableName = "AnalyzeQueue", Code = "Today Analyze Queues",  QueryGroupCode = "ANQU", IndexOrder = 0, Tenant = 0, ObjectTableId = AnalyzeQueueObjectTable.Id, QuerySection = "AnalyzeQueue", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AnalyzeQueueFeature_0.Id,FeatureUniqeCode= AnalyzeQueueFeature_0.FeatureUniqeCode, DefaultSortName = "CreateDate", DefaultSortDirection = "Descending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn TodayAnalyzeQueuesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "AnalyzeQueue.Id" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "AnalyzeQueue.From" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "AnalyzeQueue.EntityReference" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "AnalyzeQueue.CreateDate" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "AnalyzeQueue.FileSize" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "AnalyzeQueue.Status" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "AnalyzeQueue.ErrorMessage" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "AnalyzeQueue.Subject" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "AnalyzeQueue.Retries" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "AnalyzeQueue.ConnectedToTenant" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "AnalyzeQueue.ConnectedToEntity" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayAnalyzeQueuesQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "AnalyzeQueue.DoneDate" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter TodayAnalyzeQueuesQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AnalyzeQueue.CreateDate", PredefinedValue = "Today",PredefinedValue2 = null, CustomPredefined = false, QueryId = TodayAnalyzeQueuesQuery.Id,QueryCode = TodayAnalyzeQueuesQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
			 ...
			 QueryColumn AllAnalyzeQueuesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "AnalyzeQueue.Id" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "AnalyzeQueue.From" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "AnalyzeQueue.EntityReference" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "AnalyzeQueue.CreateDate" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "AnalyzeQueue.FileSize" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "AnalyzeQueue.Status" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "AnalyzeQueue.ErrorMessage" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "AnalyzeQueue.Subject" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "AnalyzeQueue.Retries" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "AnalyzeQueue.ConnectedToTenant" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "AnalyzeQueue.ConnectedToEntity" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllAnalyzeQueuesQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAnalyzeQueuesQuery.Id,QueryCode = AllAnalyzeQueuesQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "AnalyzeQueue.DoneDate" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> AnalyzeQueueObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AnalyzeQueue").ToList();
	         ...
	         Screen AnalyzeQueueHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AnalyzeQueue.HeaderScreen", Name = "Header Screen", ObjectTableId = AnalyzeQueueObjectTable.Id, NumberOfColumns = 4, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField AnalyzeQueueAnalyzeQueueHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = AnalyzeQueueHeaderScreenScreen0.Id,ScreenCode = AnalyzeQueueHeaderScreenScreen0.Code, ObjectFieldCode = "AnalyzeQueue.Id", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AnalyzeQueueAnalyzeQueueHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = AnalyzeQueueHeaderScreenScreen0.Id,ScreenCode = AnalyzeQueueHeaderScreenScreen0.Code, ObjectFieldCode = "AnalyzeQueue.From", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AnalyzeQueueAnalyzeQueueHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ScreenId = AnalyzeQueueHeaderScreenScreen0.Id,ScreenCode = AnalyzeQueueHeaderScreenScreen0.Code, ObjectFieldCode = "AnalyzeQueue.CreateDate", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AnalyzeQueueAnalyzeQueueHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ScreenId = AnalyzeQueueHeaderScreenScreen0.Id,ScreenCode = AnalyzeQueueHeaderScreenScreen0.Code, ObjectFieldCode = "AnalyzeQueue.Subject", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode AnalyzeQueueMessageBodyTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue.TH.MessageBody", DefaultText = "Message Body",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature AnalyzeQueueMessageBodyFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MESSAGEBODY", ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, NameTextCodeCode = "AnalyzeQueueObjectTable.Features.MessageBody", NameTextCodeDefaultText = "Message Body", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,AnalyzeQueueObjectTable,contextTenant);
 
                 
			   TextCode AnalyzeQueueGeneralTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AnalyzeQueueErrorsTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue.TH.AnalyzeQueueErrors", DefaultText = "Errors",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
 
                 
			   TextCode AnalyzeQueueEventsTextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
