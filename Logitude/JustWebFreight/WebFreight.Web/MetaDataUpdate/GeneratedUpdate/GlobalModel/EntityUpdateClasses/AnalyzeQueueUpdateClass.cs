...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.GlobalModel.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {  
 		   ...
 		   TextCode AnalyzeQueueTextCode_AnalyzeQueue = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AnalyzeQueue", DefaultText = "Analyze Queue",LocalDefaultText = null, ObjectTableId = AnalyzeQueueObjectTable.Id, Tenant = 0, TextCodeTypeCode = "T", IsSpellChecked = false }, TextCodeRepository, TextCodes);
