   ...
   {  
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "LogitudeLead",
			      				    ...
			      				    OldDBTableName =  "LogitudeLeads",
			      				    ObjectTableSingular =  "Logitude Leads",
			      				    ...
			      				    IsLookUp =  true,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "LogitudeLead,LogitudeLeads,,Id,",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PackageCode",
					  						...
					  						DefaultText =  "Package Code",
					  						ListFieldLable =  "PackageCodeListLable",
					  						ListLableDefaultText =  "Package Code",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "LeadSource",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "LeadSource",
					  						ListPropertyPath =  "LeadSource",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "LeadSource",
					  						DefaultText =  "Lead Source",
					  						ListFieldLable =  "LeadSourceListLable",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "NumberOfBranches",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "NumberOfBranches",
					  						ListPropertyPath =  "NumberOfBranches",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "NumberOfBranches",
					  						DefaultText =  "Number Of Branches",
					  						ListFieldLable =  "NumberOfBranchesListLable",
					  						ListLableDefaultText =  "Number Of Branches",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsEmailVerified",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "IsEmailVerified",
					  						ListPropertyPath =  "IsEmailVerified",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "IsEmailVerified",
					  						DefaultText =  "Is Email Verified",
					  						ListFieldLable =  "IsEmailVerifiedListLable",
					  						ListLableDefaultText =  "Is Email Verified",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsSentToCustomer",
					  						OldFieldName =  "IsSentToCustomer",
					  						ObjectTableName =  "LogitudeLead",
					  						FieldsDataType =  "Boolean",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "IsSentToCustomer",
					  						ListPropertyPath =  "IsSentToCustomer",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "IsSentToCustomer",
					  						DefaultText =  "Is Sent To Customer",
					  						ListFieldLable =  "IsSentToCustomerListLable",
					  						ListLableDefaultText =  "Is Sent To Customer",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Street",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "Street",
					  						ListPropertyPath =  "Street",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "Street",
					  						DefaultText =  "Street",
					  						ListFieldLable =  "StreetListLable",
					  						ListLableDefaultText =  "Street",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsUserOpened",
					  						OldFieldName =  "IsUserOpened",
					  						ObjectTableName =  "LogitudeLead",
					  						FieldsDataType =  "Boolean",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "IsUserOpened",
					  						ListPropertyPath =  "IsUserOpened",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "IsUserOpened",
					  						DefaultText =  "Is User Opened",
					  						ListFieldLable =  "IsUserOpenedListLable",
					  						ListLableDefaultText =  "Is User Opened",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
	    ...
	    {   
		   ...
		   List<ObjectField> LogitudeLeadObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "LogitudeLead").ToList();
            ...
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "PhoneNumber").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "PhoneNumber").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "CompanyName").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "CompanyName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "ContactName").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "ContactName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "NumberOfBranches").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "NumberOfBranches").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "Email").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "Email").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "NumberOfUsers").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "NumberOfUsers").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "Comments").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "Comments").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 7, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "IsEmailVerified").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "IsEmailVerified").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 8, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "IsSentToCustomer").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "IsSentToCustomer").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField LogitudeLeadLogitudeLeadGeneralTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 9, ObjectFieldId = LogitudeLeadObjectFields.Where(d => d.FieldName == "RequestType").FirstOrDefault().Id, ScreenId = LogitudeLeadGeneralTabScreenScreen1.Id, ObjectFieldCode = LogitudeLeadObjectFields.Where(d => d.FieldName == "RequestType").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = LogitudeLeadObjectTable.Id,
