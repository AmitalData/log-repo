   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn PrivateLabelsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.Code, IndexOrder = 0, ObjectFieldId = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "PrivateLabelName" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "PrivateLabelName" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.Code, IndexOrder = 1, ObjectFieldId = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "PrivateLabelShortName" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "PrivateLabelShortName" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.Code, IndexOrder = 2, ObjectFieldId = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "PrivateLabelUrl" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "PrivateLabelUrl" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.Code, IndexOrder = 3, ObjectFieldId = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "ContactUsEmail" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "ContactUsEmail" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.Code, IndexOrder = 4, ObjectFieldId = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "ReceiveAllStatuses" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "ReceiveAllStatuses" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 70 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.Code, IndexOrder = 5, ObjectFieldId = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = TenantManagmentPrivateLabelsObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == TenantManagmentPrivateLabelsObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 70 }, queryColumnsRepository, tenantQueryColumns);
