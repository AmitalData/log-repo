   ...
   {  		
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn PrivateLabelsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "TenantManagmentPrivateLabels.PrivateLabelName" , ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "TenantManagmentPrivateLabels.PrivateLabelShortName" , ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "TenantManagmentPrivateLabels.PrivateLabelUrl" , ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "TenantManagmentPrivateLabels.ContactUsEmail" , ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "TenantManagmentPrivateLabels.ReceiveAllStatuses" , ColumnWidth = 70 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PrivateLabelsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PrivateLabelsQuery.Id,QueryCode = PrivateLabelsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "TenantManagmentPrivateLabels.InActive" , ColumnWidth = 70 }, queryColumnsRepository, tenantQueryColumns);
