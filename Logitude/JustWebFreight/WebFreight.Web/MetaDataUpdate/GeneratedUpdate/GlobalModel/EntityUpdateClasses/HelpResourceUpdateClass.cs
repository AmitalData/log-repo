   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode HelpResourceTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "HelpResource.Q.AllHelpResources", DefaultText = @"Help Resources",LocalDefaultText = "Help Resources", ObjectTableId = HelpResourceObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllHelpResourcesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "HelpResource.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "HelpResource.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "HelpResource.CreateDate" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "HelpResource.UpdateDate" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "HelpResource.Language" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "HelpResource.FileName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "HelpResource.TypeName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "HelpResource.CategoryName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllHelpResourcesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllHelpResourcesQuery.Id,QueryCode = AllHelpResourcesQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "HelpResource.IsNew" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> HelpResourceObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "HelpResource").ToList();
	         ...
	         Screen HelpResourceHelpResourceHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "HelpResource.HeaderScreen", Name = "HelpResourceHeaderScreen", ObjectTableId = HelpResourceObjectTable.Id, NumberOfColumns = 3, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode HelpResourceGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "HelpResource.TH.General", DefaultText = "General",LocalDefaultText = "General", ObjectTableId = HelpResourceObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode HelpResourceEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "HelpResource.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = HelpResourceObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
