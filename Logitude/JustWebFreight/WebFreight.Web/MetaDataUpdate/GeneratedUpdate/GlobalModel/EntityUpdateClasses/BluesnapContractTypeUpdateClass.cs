   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> BluesnapContractTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BluesnapContractType").ToList();
	         ...
	         Screen BluesnapContractTypeBluesnapContractTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "BluesnapContractType.HeaderScreen", Name = "BluesnapContractTypeHeaderScreen", ObjectTableId = BluesnapContractTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillBluesnapContractType(int contextTenant)
        { 
            var repo = new BluesnapContractTypeRepository(contextTenant);
