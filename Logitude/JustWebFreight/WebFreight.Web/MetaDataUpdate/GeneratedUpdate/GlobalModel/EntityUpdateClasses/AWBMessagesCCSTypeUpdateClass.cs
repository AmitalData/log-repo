...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.GlobalModel.EntityUpdateClasses
{
   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "AWBMessagesCCSType",
			      				    ...
			      				    InActive =  false,
			      				    SearchFields =  "AWBMessagesCCSType,AWBMessagesCCSTypes,,Code,Name",
			      				    ...
			      				    CloseTableCode =  "Code",
			      				    CloseTableName =  "Name",
			      				    HashString =  AWBMessagesCCSTypeUpdateClass.HashString,
	    ...
	    public void FillAWBMessagesCCSType()
        { 
            var repo = new AWBMessagesCCSTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                AWBMessagesCCSType,
                                Logitude.BL.GlobalModel.AWBMessagesCCSTypeDetails,
                                AWBMessagesCCSTypeRepository>(repo, dic);
        }
