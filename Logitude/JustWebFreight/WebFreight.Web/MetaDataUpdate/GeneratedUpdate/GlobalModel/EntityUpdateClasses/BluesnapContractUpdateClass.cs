   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode BluesnapContractTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BluesnapContract.Q.AllBluesnapContracts", DefaultText = @"Bluesnap Contracts",LocalDefaultText = null, ObjectTableId = BluesnapContractObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllBluesnapContractQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBluesnapContractQuery.Id,QueryCode = AllBluesnapContractQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "BluesnapContract.Code" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllBluesnapContractQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBluesnapContractQuery.Id,QueryCode = AllBluesnapContractQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "BluesnapContract.BluesnapContractTypeName" , ColumnWidth = 127 }, addedQueryColumns,contextTenant);

			 QueryColumn AllBluesnapContractQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBluesnapContractQuery.Id,QueryCode = AllBluesnapContractQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "BluesnapContract.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllBluesnapContractQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBluesnapContractQuery.Id,QueryCode = AllBluesnapContractQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "BluesnapContract.ContractId" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllBluesnapContractQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllBluesnapContractQuery.Id,QueryCode = AllBluesnapContractQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "BluesnapContract.InActive" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> BluesnapContractObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "BluesnapContract").ToList();
	         ...
	         Screen BluesnapContractHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "BluesnapContract.HeaderScreen", Name = "Header Screen", ObjectTableId = BluesnapContractObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField BluesnapContractBluesnapContractHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = BluesnapContractHeaderScreenScreen0.Id,ScreenCode = BluesnapContractHeaderScreenScreen0.Code, ObjectFieldCode = "BluesnapContract.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    BluesnapContractObjectTable.HeaderScreenCode = BluesnapContractHeaderScreenScreen0.Code;
	         ...
	         Screen BluesnapContractGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "BluesnapContract.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = BluesnapContractObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField BluesnapContractBluesnapContractGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = BluesnapContractGeneralTabScreenScreen1.Id,ScreenCode = BluesnapContractGeneralTabScreenScreen1.Code, ObjectFieldCode = "BluesnapContract.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField BluesnapContractBluesnapContractGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = BluesnapContractGeneralTabScreenScreen1.Id,ScreenCode = BluesnapContractGeneralTabScreenScreen1.Code, ObjectFieldCode = "BluesnapContract.ContractId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BluesnapContractBluesnapContractGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = BluesnapContractGeneralTabScreenScreen1.Id,ScreenCode = BluesnapContractGeneralTabScreenScreen1.Code, ObjectFieldCode = "BluesnapContract.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField BluesnapContractBluesnapContractGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = BluesnapContractGeneralTabScreenScreen1.Id,ScreenCode = BluesnapContractGeneralTabScreenScreen1.Code, ObjectFieldCode = "BluesnapContract.BluesnapContractTypeCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode BluesnapContractGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BluesnapContract.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = BluesnapContractObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature BluesnapContractGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "BluesnapContract.Tab.General", ObjectTableId = BluesnapContractObjectTable.Id, Tenant = 0, NameTextCodeCode = "BluesnapContract.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,BluesnapContractObjectTable,contextTenant);
 
                 
			   TextCode BluesnapContractEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "BluesnapContract.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = BluesnapContractObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
