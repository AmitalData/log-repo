   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ChildEntitiesCustomField",
			      				    IsNew =  true,
			      				    DBTableName =  "ChildEntitiesCustomFields",
			      				    ObjectTableSingular =  "Child Entities Custom Field",
			      				    ObjectTablePlural =  "Child Entities Custom Fields",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  ChildEntitiesCustomFieldUpdateClass.HashString,
	    ...
	    {   
		   ...
		   ObjectTable ChildEntitiesCustomFieldObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "ChildEntitiesCustomField" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> ChildEntitiesCustomFieldObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ChildEntitiesCustomField").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ChildEntitiesCustomFieldObjectTable.Id,
