...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InfrastructureModel.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {  
 		   ...
 		   TextCode GeneralTextCode_GeneralMHCustomers = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MH.Customers", DefaultText = "Customers",LocalDefaultText = @"לקוחות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MH", IsSpellChecked = false }, TextCodeRepository, TextCodes);
            ...
            TextCode GeneralTextCode_GeneralMCTablesReceiptCertificateFromFile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.Tables.ReceiptCertificateFromFile", DefaultText = "Receipt Certificates From File", LocalDefaultText = @"קליטת קובץ אישורים מאיקאה להצהרה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);
