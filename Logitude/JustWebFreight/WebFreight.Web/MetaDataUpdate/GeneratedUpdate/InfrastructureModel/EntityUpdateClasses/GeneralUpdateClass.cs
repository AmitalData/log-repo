...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InfrastructureModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "7c4fd00f62f62e155a5c4df74b706c8f";
	    ...
	    {  
		   ...
		   Feature GeneralFeature_SHAAMTOKEN = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHAAMTOKEN", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SHAAMTOKEN", NameTextCodeDefaultText = @"שעם טוקן" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
