...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InfrastructureModel.EntityUpdateClasses
{
   ...
   {  		
        ...
        public const string HashString = "74e4fc30359325a73706ead435048790";
	    ...
	    {  
		   ...
		   Feature GeneralFeature_DASHBOARD = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DASHBOARD", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Dashboard", NameTextCodeDefaultText = @"Dashboard" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_USERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "USERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Users", NameTextCodeDefaultText = @"Users" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_QUOTES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "QUOTES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Quotes", NameTextCodeDefaultText = @"Quotes" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_ARINVOICES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ARINVOICES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.ARInvoices", NameTextCodeDefaultText = @"Accounting" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SHIPMENTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHIPMENTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Shipments", NameTextCodeDefaultText = @"Shipments" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_MASTERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MASTERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Masters", NameTextCodeDefaultText = @"Masters" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_MAINTENANCE = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MAINTENANCE", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Maintenance", NameTextCodeDefaultText = @"Maintenance" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CONTACTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CONTACTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Contacts", NameTextCodeDefaultText = @"Contacts" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CUSTOMERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Customers", NameTextCodeDefaultText = @"Customers" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_CUSTOMAGENTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMAGENTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CustomAgents", NameTextCodeDefaultText = @"CustomAgents" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SHIPPINGAGENTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHIPPINGAGENTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.ShippingAgents", NameTextCodeDefaultText = @"Shipping Agents" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_AIRLINES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AIRLINES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Airlines", NameTextCodeDefaultText = @"Airlines" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_COUNTRIES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "COUNTRIES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Countries", NameTextCodeDefaultText = @"Countries" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_POTENTIALCUSTOMERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "POTENTIALCUSTOMERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.PotentialCustomers", NameTextCodeDefaultText = @"PotentialCustomers" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_APINVOICES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "APINVOICES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.APInvoices", NameTextCodeDefaultText = @"A/P Invoices" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_GETTINGSTARTED = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GETTINGSTARTED", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.GettingStarted", NameTextCodeDefaultText = @"Getting Started" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_EVENTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "EVENTS", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Events", NameTextCodeDefaultText = @"Events" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_DOCSIN = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DOCSIN", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.DocsIn", NameTextCodeDefaultText = @"DocsIn" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_BUILDQUERIES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "BUILDQUERIES", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.BuildQueries", NameTextCodeDefaultText = @"Build Queries" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_Customization = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.Customization", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Customization", NameTextCodeDefaultText = @"Customization" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_PERSONALSETTINGS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "PERSONALSETTINGS", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.PersonalSettings", NameTextCodeDefaultText = @"Personal Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SYSTEMSETTINGS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SYSTEMSETTINGS", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SystemSettings", NameTextCodeDefaultText = @"System Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_HOWTOACCOUNTINGSETTINGS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "HOWTOACCOUNTINGSETTINGS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.HOWTOACCOUNTINGSETTINGS", NameTextCodeDefaultText = @"Accounting Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CREDITCARDTYPES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CREDITCARDTYPES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CreditCardTypes", NameTextCodeDefaultText = @"Credit Card Types" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SHAREDLOGISTICSMENU = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHAREDLOGISTICSMENU", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SharedLogistics", NameTextCodeDefaultText = @"Shared Logistics" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_MOVETYPES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MOVETYPES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.MoveTypes", NameTextCodeDefaultText = @"Move Types" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_REPORTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "REPORTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Report", NameTextCodeDefaultText = @"Report" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CHAMP = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CHAMP", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Champ", NameTextCodeDefaultText = @"Champ Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_COMPETITORS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "COMPETITORS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Competitors", NameTextCodeDefaultText = @"Competitors" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_STAGES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "STAGES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Stages", NameTextCodeDefaultText = @"Stages" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_CRM = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CRM", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CRM", NameTextCodeDefaultText = @"CRM" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_OPERATIONS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "OPERATIONS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Operations", NameTextCodeDefaultText = @"Operations" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_INDUSTRIES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "INDUSTRIES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Industries", NameTextCodeDefaultText = @"Industries" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CUSTOMBANK = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMBANK", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CustomBank", NameTextCodeDefaultText = @"Custom Bank" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SOCIAL = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SOCIAL", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Social", NameTextCodeDefaultText = @"Social" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_QUOTETMPLATES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "QUOTETMPLATES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.QuoteTemplate", NameTextCodeDefaultText = @"Quote Template" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_COUNTERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "COUNTERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Counters", NameTextCodeDefaultText = @"Counters" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_CompanyAddress = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.CompanyAddress", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CompanyAddress", NameTextCodeDefaultText = @"Company Address Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_SPECIALSERVICESTYPES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SPECIALSERVICESTYPES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SpecialServicesType", NameTextCodeDefaultText = @"Special Service Types" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_REGIONS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "REGIONS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Region", NameTextCodeDefaultText = @"Regions" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_LOGITUDELEADS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "LOGITUDELEADS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.LogitudeLead", NameTextCodeDefaultText = @"Logitude Lead" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CUSTOMERSIZES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMERSIZES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CustomerSizes", NameTextCodeDefaultText = @"Customer Sizes" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CLOSINGREASONS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CLOSINGREASONS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.ClosingReasons", NameTextCodeDefaultText = @"Closing Reasons" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_QUESTIONNAIRE = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "QUESTIONNAIRE", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Questionnaire", NameTextCodeDefaultText = @"Questionnaire" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_QUESTIONNAIREGENERAL = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "QUESTIONNAIREGENERAL", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.QuestionnaireGeneral", NameTextCodeDefaultText = @"Questionnaire" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_TenantManagement = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.TenantManagement", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.TenantManagement", NameTextCodeDefaultText = @"Tenant Management" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CountryCity_M_Cities = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CountryCity.M.Cities", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Cities", NameTextCodeDefaultText = @"Cities" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_General_Features_CustomFieldsEdit = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.CustomFieldsEdit", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CustomFieldsEdit", NameTextCodeDefaultText = @"Custom Fields Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_DOCUMENTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DOCUMENTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Documents", NameTextCodeDefaultText = @"Documents" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_MAINCUSTOMERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MAINCUSTOMERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.MaintenanceCustomers", NameTextCodeDefaultText = @"Maintenance Customers" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CUSTOMIZATION = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMIZATION", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Customization1", NameTextCodeDefaultText = @"Customization" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_BluesnapContract = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.BluesnapContract", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.BluesnapContract", NameTextCodeDefaultText = @"Bluesnap Contract" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_BLUESNAPS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "BLUESNAPS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.BluesnapContracts", NameTextCodeDefaultText = @"Bluesnap Contracts" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_DOCUMENTFOLDERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DOCUMENTFOLDERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.DocumentFolder", NameTextCodeDefaultText = @"Document Folder" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_MOBILE = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MOBILE", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Mobile", NameTextCodeDefaultText = @"Mobile" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_TENANTTOTANGO = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TENANTTOTANGO", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Totango", NameTextCodeDefaultText = @"Totango" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_ACCOUNTINGSYSTEMS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ACCOUNTINGSYSTEMS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.AccountingSystems", NameTextCodeDefaultText = @"Accounting Systems" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Menu_AWBAdditionalHandlingInfo = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Menu.AWBAdditionalHandlingInfo", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Menu.AWBAdditionalHandlingInfo", NameTextCodeDefaultText = @"AWB Additional Handling Info" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_IMPORTER = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "IMPORTER", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Importers", NameTextCodeDefaultText = @"Importers" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CUSTOMERTENANTACCESSES = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMERTENANTACCESSES", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CustomerTenantAccesses", NameTextCodeDefaultText = @"Customer Tenant Accesses" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_CUSTOMERTENANTACCESSREQUESTS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMERTENANTACCESSREQUESTS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CustomerTenantAccessRequests", NameTextCodeDefaultText = @"Customer Tenant Access Requests" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_HYBRIDPARTNERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "HYBRIDPARTNERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.HybridPartners", NameTextCodeDefaultText = @"Hybrid Partners" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_EMPLOYEEGROUPS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "EMPLOYEEGROUPS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.EmployeeGroups", NameTextCodeDefaultText = @"Employee Groups" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SLAHEADER = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SLAHEADER", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SLAHeader", NameTextCodeDefaultText = @"SLA" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_HYBRIDTENANTSTATE = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "HYBRIDTENANTSTATE", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.HybridTenantStates", NameTextCodeDefaultText = @"Hybrid Tenant State" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_AirlineSettings = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.AirlineSettings", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.AirlineSettings", NameTextCodeDefaultText = @"Airline Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_FlightsSchedules = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "FlightsSchedules", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.FlightsSchedules", NameTextCodeDefaultText = @"Flights Schedules" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_Automations = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.Automations", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Automations", NameTextCodeDefaultText = @"Automations" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_TICKET = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TICKET", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Ticket", NameTextCodeDefaultText = @"Tickets" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_TRANSMISSIONLOG = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TRANSMISSIONLOG", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.LogitudeMessagesTransmissionLogs", NameTextCodeDefaultText = @"Logitude Messages Transmission Logs" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_AIRLINEDASHBOARD = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AIRLINEDASHBOARD", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.AirlineDashboard", NameTextCodeDefaultText = @"Airline Dashboard" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_OUTLOOKCONNETION = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "OUTLOOKCONNETION", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.OutLookConnection", NameTextCodeDefaultText = @"OutLook Connection" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_ACCOUNTINGS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ACCOUNTINGS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Accounting", NameTextCodeDefaultText = @"Accounting" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_General_Features_Category2 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.Category2", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.Category2", NameTextCodeDefaultText = @"Category 2" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_WAREHOUSEMANAGEMENT = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "WAREHOUSEMANAGEMENT", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.WarehouseManagement", NameTextCodeDefaultText = @"Warehouse Management" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_EXPORTEXCEL = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "EXPORTEXCEL", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.EXCEL", NameTextCodeDefaultText = @"Download to Excel" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_DROPBOX = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DROPBOX", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.DropBox", NameTextCodeDefaultText = @"DropBox" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_DROPBOXTESTFILE = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "DROPBOXTESTFILE", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.DropBoxTestFile", NameTextCodeDefaultText = @"DropBoxTestFile" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SATINTERFACE = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SATINTERFACE", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SATInterface", NameTextCodeDefaultText = @"SAT Interface" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_LBDS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "LBDS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.LBDS", NameTextCodeDefaultText = @"LB Digital signature" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_FBLSTOCKS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "FBLSTOCKS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.FBLStocks", NameTextCodeDefaultText = @"FBL Stock" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_MOBILELOGO = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MOBILELOGO", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.MobileLogo", NameTextCodeDefaultText = @"Mobile Logo" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SHAREDLOGISTICSLOGO = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHAREDLOGISTICSLOGO", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.sharedLogisticsLogo", NameTextCodeDefaultText = @"Shared Logistics Logo" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_General_Features_ContainerSettings = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.ContainerSettings", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.General.Features.ContainerSettings", NameTextCodeDefaultText = @"Container Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_CustomizationSettings = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.CustomizationSettings", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.General.Features.CustomizationSettings", NameTextCodeDefaultText = @"Customization Settings" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_ENTITYSTATUS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ENTITYSTATUS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.ENTITYSTATUS", NameTextCodeDefaultText = @"Entity Status" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_QUOTECHARGESGROUP = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "QUOTECHARGESGROUP", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.QUOTECHARGESGROUP", NameTextCodeDefaultText = @"Quote Charges Types" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_General_Features_CustomerTeam = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "General.Features.CustomerTeam", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.General.Features.CustomerTeam", NameTextCodeDefaultText = @"Customer Teams" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_SHLOGCARGOTRACKING = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHLOGCARGOTRACKING", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.SHLOGCARGOTRACKING", NameTextCodeDefaultText = @"Shared Logistic Cargo Tracking" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_ScreenLayoutCustomization = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ScreenLayoutCustomization", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.ScreenLayoutCustomization", NameTextCodeDefaultText = @"Screen Layout Customization" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_RulesCustomization = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "RulesCustomization", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.RulesCustomization", NameTextCodeDefaultText = @"Rules Customization" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_TabsCustomization = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TabsCustomization", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.TabsCustomization", NameTextCodeDefaultText = @"Tabs Customization" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
		   ...
		   Feature GeneralFeature_CONTAINERS = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CONTAINERS", FeatureTypeCode = "MENU", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.CONTAINERS", NameTextCodeDefaultText = @"Containers" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);

		   Feature GeneralFeature_PendingApprovalDocuments = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "PendingApprovalDocuments", FeatureTypeCode = "OTH", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, NameTextCodeCode = "General.Features.PendingApprovalDocuments", NameTextCodeDefaultText = @"Pending Approval Documents" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,GeneralObjectTable);
	    ...
	    {  
 		   ...
 		   TextCode GeneralTextCode_GeneralMAddingIsNotAvailable = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.M.AddingIsNotAvailable", DefaultText = "Adding new %Entity is not available at this moment please send the requested %Entity by email to: support@amital.co.il",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "M", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralODueDate = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.DueDate", DefaultText = "Due Date",LocalDefaultText = @"תאריך פרעון", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOOriginalAmount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.OriginalAmount", DefaultText = "Original Amount",LocalDefaultText = @"סכום מקורי", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOGeneralInvoice = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.GeneralInvoice", DefaultText = "General Invoice",LocalDefaultText = @"חשבוניות לקוח", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOPayments = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.Payments", DefaultText = "Payments",LocalDefaultText = @"קבלות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
           ...
           TextCode GeneralTextCode_AccountingGeneralOBankQueries = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.BankQueries", DefaultText = "Bank Queries",LocalDefaultText = @"שאילתות בנקים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOcashbookDetails = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.cashbookDetails", DefaultText = "Cashbook details",LocalDefaultText = @"כללי", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralBNew = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.B.New", DefaultText = "New",LocalDefaultText = @"חדש", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingONoautorecofoundbymethodchangemethod = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.Noautorecofoundbymethodchangemethod", DefaultText = "No automatic reconcile found by this method, Please change method or select lines manually",LocalDefaultText = @"לא נמצאו תנועות להתאמה, יש לשנות שיטת התאמה או להתאים ידנית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralOShowNewRelease = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.O.ShowNewRelease", DefaultText = "Read what is new in the latest release",LocalDefaultText = @"גרסה חדשה עלתה לאוויר - לפירוט השינויים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralBInvoiceNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.B.InvoiceNumber", DefaultText = "The Invoice Number",LocalDefaultText = @"מספר חשבונית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralBAlreadyExist = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.B.AlreadyExist", DefaultText = "already exist in another invoice",LocalDefaultText = @" כבר קיים בחשבונית אחרת", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOJournalNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.JournalNumber", DefaultText = "Journal No.",LocalDefaultText = @"פקודת יומן מספר", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOMiscQueries = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.MiscQueries", DefaultText = "Misc Queries",LocalDefaultText = @"שאילתות שונות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralONewOpenFormatReport = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.NewOpenFormatReport", DefaultText = "New Open Format Report",LocalDefaultText = @"דוח מבנה אחיד חדש", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOARInvoices = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ARInvoices", DefaultText = "AR Invoices",LocalDefaultText = @"חשבוניות לקוח", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOARPayments = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ARPayments", DefaultText = "AR Payments",LocalDefaultText = @"קבלות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOAPPayments = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.APPayments", DefaultText = "AP Payments",LocalDefaultText = @"תשלום לספקים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralODraftInvoices = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.DraftInvoices", DefaultText = "Draft Invoices",LocalDefaultText = @"חשבוניות בסטטוס טיוטה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOApprovedInvoices = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ApprovedInvoices", DefaultText = "Approved Invoices",LocalDefaultText = @"חשבוניות מאושרות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOApprovedPayments = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ApprovedPayments", DefaultText = "Approved Payments",LocalDefaultText = @"תשלומים מאושרים ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOClosedMonth = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ClosedMonth", DefaultText = "Closed Month",LocalDefaultText = @"חודש סגור", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOPaymentCheques = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.PaymentCheques", DefaultText = "Payment Cheques",LocalDefaultText = @"המחאות תשלום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOAllPaymentCheques = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.AllPaymentCheques", DefaultText = "All Payment Cheques",LocalDefaultText = @"כל המחאות התשלום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingOWithholdingBlocked = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.WithholdingBlocked", DefaultText = "Line : The Vendor does not have a certificate according to the 1000 System",LocalDefaultText = @"שורה מספר : לספק לא קיים אישור על פי מערכת 1000", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOWithholdingLineDisabled = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.WithholdingLineDisabled", DefaultText = "Line : A new line was entered with the same date by the 1000 System",LocalDefaultText = @"שורה מספר : נקלטה שורה חדשה עם תאריך זהה על ידי מערכת 1000", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOWithholdingLineCreated = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.WithholdingLineCreated", DefaultText = "Line : New Withholding tax line wtitten by the 1000 System",LocalDefaultText = @"שורה מספר : הוגדרה שורת שיעור ניכוי מס חדשה על ידי מערכת 1000", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOAccountingPeriodClosed = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.AccountingPeriodClosed", DefaultText = "The accounting period for recording the Journal is closed",LocalDefaultText = @"התקופה החשבונאית לרישום פקודת היומן סגורה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOYearTransferredAlready = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.YearTransferredAlready", DefaultText = "The chosen year is transferred already, In order to transfer it again, you must void Journal ",LocalDefaultText = @"השנה שנבחרה הועברה כבר, ע”מ להעביר אותה בשנית, יש לבטל את פקודת יומן ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOYearNotYetTransferred = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.YearNotYetTransferred", DefaultText = "The chosen year is not yet transferred",LocalDefaultText = @"השנה שנבחרה טרם הועברה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOTheYearTransferJournal = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.TheYearTransferJournal", DefaultText = "The Year Transfer Journal ",LocalDefaultText = @"פקודת יומן ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingOClientActivationBTN = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ClientActivationBTN", DefaultText = "Activate",LocalDefaultText = @"הפעל כעת", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOMultiRecoCreated = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.MultiRecoCreated", DefaultText = "Reconciliations created successfully",LocalDefaultText = @"התאמות בוצעו בהצלחה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingORedeemedChequeMSG = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.RedeemedChequeMSG", DefaultText = "The cheque is redeemed and can’t be out of deposit, cancel the external reconcilaition in order to return the cheque to the cashbook",LocalDefaultText = @"לא ניתן להוציא את ההמחאה מההפקדה משום שהיא בסטטוס נפרע, יש לבטל את ההתאמה החיצונית ע”מ להחזיר את ההמחאה לקופה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingOCustomersNotes = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.CustomersNotes", DefaultText = "Customer's Notes",LocalDefaultText = @"הערות לקוח", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingONewAccountingNote = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.NewAccountingNote", DefaultText = "New Accounting Note",LocalDefaultText = @"הזן הערה חדש", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOCompletedReportExist = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.CompletedReportExist", DefaultText = "Can’t create tax report for the the chosen month, there is no tax report for the previous month",LocalDefaultText = @"לא ניתן להפיק דוח מעמ לחודש הנבחר משום שלא הופק דוח מעמ לחודש הקודם", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingONotCompletedReportExist = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.NotCompletedReportExist", DefaultText = "Can’t create tax report for the chosen month, the report of the previous month is not completed",LocalDefaultText = @"לא ניתן להפיק דוח לחודש הנבחר, הדוח של החודש הקודם לא הושלם", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPInvoiceNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.InvoiceNumber", DefaultText = "Invoice Number",LocalDefaultText = @"מספר חשבונית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPInvoiceAmount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.InvoiceAmount", DefaultText = "Invoice Amount",LocalDefaultText = @"סכום חשבונית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPDuedate = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.Duedate", DefaultText = "Due date",LocalDefaultText = @"תאריך פרעון", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPStatus = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.Status", DefaultText = "Status",LocalDefaultText = @"סטטוס", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPReconciliationNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.ReconciliationNumber", DefaultText = "Reco. Number",LocalDefaultText = @"מספר התאמה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPOpen = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.Open", DefaultText = "Open",LocalDefaultText = @"פתוח", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPClosed = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.Closed", DefaultText = "Closed",LocalDefaultText = @"סגור", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPpartiallyOpened = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.partiallyOpened", DefaultText = "Partially open",LocalDefaultText = @"פתוח חלקית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPselectedinvoicesishigherthanpayamount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.selectedinvoicesishigherthanpayamount", DefaultText = "The amount of the selected invoices is higher than the payment amount",LocalDefaultText = @"סכום החשבוניות שנבחרו גבוה מסכום הקבלה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPReconciledAmount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.ReconciledAmount", DefaultText = "Amount adjusted",LocalDefaultText = @"סכום שהותאם", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPinvoiceAmount2reconcileMSG = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.invoiceAmount2reconcileMSG", DefaultText = "The amount to reconcile in the invoice is higher than the invoice open amount",LocalDefaultText = @"הסכום להתאמה גדול מהסכום הפתוח בחשבונית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPpaymentAmount2reconcileMSG = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.paymentAmount2reconcileMSG", DefaultText = "The amount to reconcile in the invoices is higher than the payment open amount",LocalDefaultText = @"הסכום להתאמה גדול מהסכום הפתוח בקבלה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPPaymentAmount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.PaymentAmount", DefaultText = "Payment amount",LocalDefaultText = @"סכום הקבלה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOARPAmount2Reconcile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ARP.Amount2Reconcile", DefaultText = "Amount to reconcile",LocalDefaultText = @"סכום להתאמה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingODocumentTypeNotFound = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.DocumentTypeNotFound", DefaultText = "Document type X not found",LocalDefaultText = @"סוג מסמך X לא נמצא", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingODeductionFileNumberNotFound = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.DeductionFileNumberNotFound", DefaultText = "Deduction file number not found",LocalDefaultText = @"לא הוקלד מספר תיק ניכויים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingORebuild = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.Rebuild", DefaultText = "Rebuild",LocalDefaultText = @"בניה מחדש", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOBuilding = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.Building", DefaultText = "Building...",LocalDefaultText = @"...בניין", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOAuthoritiesReports = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.AuthoritiesReports", DefaultText = "Authorities Reports",LocalDefaultText = @"דוחות לרשויות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralO856Report = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.856Report", DefaultText = "856 Report",LocalDefaultText = @"דוח 856", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOOpenFormat = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.OpenFormat", DefaultText = "Open Format",LocalDefaultText = @"דוח מבנה אחיד", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOVendorsGLAccount = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.VendorsGLAccount", DefaultText = "Internal Cheques can be created only from APPayment for vendors GLAccount",LocalDefaultText = @"ניתן להפיק המחאה לכרטיס ספק רק באמצעות הוראת תשלום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOFutureDateNotAllowed = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.FutureDateNotAllowed", DefaultText = "Can not enter future date",LocalDefaultText = @"לא ניתן להקליד תאריך עתידי", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOOlderThan180Days = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.OlderThan180Days", DefaultText = "Do not type a value date older than 180 days",LocalDefaultText = @"אין להקליד תאריך ערך יותר מ- 180 ימים אחורה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOGenerate1000 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.Generate1000", DefaultText = "Generate a vendor file for the system 1000",LocalDefaultText = @"הפקת קובץ ספקים למערכת 1000", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOReceiving1000 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.Receiving1000", DefaultText = "Receiving file withholding tax system 1000",LocalDefaultText = @"קליטת קובץ ניכוי מס מערכת 1000", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOAccountingPeriodsDefinition = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.AccountingPeriodsDefinition", DefaultText = "Accounting Periods Definition",LocalDefaultText = @"הגדרת תקופות חשבונאיות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOFix = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.Fix", DefaultText = "Fix",LocalDefaultText = @"תקן", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOGLAccounts = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.GLAccounts", DefaultText = "GL Accounts",LocalDefaultText = @"כרטיסים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOShipmentsAndMasters = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.ShipmentsAndMasters", DefaultText = "Shipments & Masters",LocalDefaultText = @"תיקים וגו’בים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOYearTransfer = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.YearTransfer", DefaultText = "Year Transfer",LocalDefaultText = @"העברת שנה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingOCancelYearTransfer = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.O.CancelYearTransfer", DefaultText = "Cancel Year Transfer",LocalDefaultText = @"ביטול העברת שנה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOTaxReport = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.TaxReport", DefaultText = "Tax Report",LocalDefaultText = @"דוח מעמ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOAPPaymentDueDate = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.APPaymentDueDate", DefaultText = "Due Date",LocalDefaultText = @"תאריך פרעון", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOLoadBankPage = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.LoadBankPage", DefaultText = "Load Bank Page",LocalDefaultText = @"טען דפי בנק מקובץ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOYouDontHavePermission = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.YouDontHavePermission", DefaultText = "Sorry! you have no permission to do this operation on ",LocalDefaultText = @" אין לך הרשאה להכנת המחאה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOPaymentChequeManualOption = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.PaymentChequeManualOption", DefaultText = "Manual entry",LocalDefaultText = @"המחאה ידנית", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOReconciledLinesExist = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ReconciledLinesExist", DefaultText = "There are reconciled lines",LocalDefaultText = @"לא ניתן לבטל כי חלק מהשורות הותאמו", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOEdit = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.Edit", DefaultText = "Edit",LocalDefaultText = @"עריכה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOMoreData = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.MoreData", DefaultText = "More Data",LocalDefaultText = @"פרטים נוספים", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOFieldMustBeNumeric = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.FieldMustBeNumeric", DefaultText = "The field , must be numeric",LocalDefaultText = @"השדה , חייב להיות מספרי", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOFillPayToName = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.FillPayToName", DefaultText = "This vendor requires to fill in the pay to name",LocalDefaultText = @"עבור ספק זה נדרש למלא את שם הספק בהמחאה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralOUpdateFailed = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.O.UpdateFailed", DefaultText = "Update failed",LocalDefaultText = @"עידכון נכשל", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralMHShipmentOrders = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MH.ShipmentOrders", DefaultText = "Shipment Orders",LocalDefaultText = @"Shipment Orders", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MH", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMHTasksApp = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MH.TasksApp", DefaultText = "Tasks App",LocalDefaultText = @"Tasks App", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MH", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMHAutomations = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MH.Automations", DefaultText = "Automations",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MH", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMCOthersEntityStatus = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.Others.EntityStatus", DefaultText = "Entity Status",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMCCustomerTeam = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.CustomerTeam", DefaultText = "Customer Teams",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralOWrongVatNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.O.WrongVatNumber", DefaultText = "Wrong Vat Number",LocalDefaultText = @"חפ שגוי", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_AccountingGeneralOLocal = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.Local", DefaultText = "Local",LocalDefaultText = @"מקומ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralGDescription = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.Description", DefaultText = "Description",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralGPhoneNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.PhoneNumber", DefaultText = "Phone",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralGContact = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.Contact", DefaultText = "Contact",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralGDownload = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.Download", DefaultText = "Download",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralGDownloadDataPreparing = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.DownloadDataPreparing ", DefaultText = "Preparing data...",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralGLoginBtn = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.LoginBtn", DefaultText = "Login",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_ContactGSaveChangesBtn = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Contact.G.SaveChangesBtn", DefaultText = "Save changes",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ContactGChangePassword = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Contact.G.ChangePassword", DefaultText = "Change password",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ContactGLogoutBtn = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Contact.G.LogoutBtn", DefaultText = "Logout",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ContactGConfirmLogoutBtn = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Contact.G.ConfirmLogoutBtn", DefaultText = "Confirm logout",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralGEmailPlaceholder = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.EmailPlaceholder", DefaultText = "email@example.com",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralGPasswordPlaceholder = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.PasswordPlaceholder", DefaultText = "password",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralGResetPassword = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.ResetPassword", DefaultText = "Reset Password",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralGCreatePassword = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.G.CreatePassword", DefaultText = "Create password",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "G", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralMCTasksTasks = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.Tasks.Tasks", DefaultText = "Tasks",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMCTasksTaskTypes = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.Tasks.TaskTypes", DefaultText = "Task Types",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMCTasksTaskPriorities = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.Tasks.TaskPriorities", DefaultText = "Task Priorities",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMCTasksTaskStatuses = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.Tasks.TaskStatuses", DefaultText = "Task Statuses",LocalDefaultText = null, ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_GeneralMCACCConsolidatedTaxReport = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MC.ACC.ConsolidatedTaxReport", DefaultText = "Consolidated Tax Report",LocalDefaultText = @"דיווח מס מרוכז", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_ConsolidatedTaxReportODeductionFileNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.DeductionFileNumber", DefaultText = "Deduction File Number is undefined.",LocalDefaultText = @"מספר תיק ניכויים אינו מוגדר.", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOFinishingRowType = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.FinishingRowType", DefaultText = "Finishing Row Type",LocalDefaultText = @"רשומת סיכום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_ConsolidatedTaxReportODoesntStartWithRowType = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.DoesntStartWithRowType", DefaultText = "does not start with a Line Row Type",LocalDefaultText = @"לא מתחיל בסוג רשומה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportONotEncountered = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.NotEncountered", DefaultText = "not encountered",LocalDefaultText = @"לא זוהתה עד כה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportODiffersFrom = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.DiffersFrom", DefaultText = "differs from ",LocalDefaultText = @"לא זהה ל", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOIsMissing = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.IsMissing", DefaultText = "is missing",LocalDefaultText = @"חסר", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOIsEmpty = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.IsEmpty", DefaultText = "is empty",LocalDefaultText = @"ריק", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportONotFound = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.NotFound", DefaultText = "not found",LocalDefaultText = @"לא נמצא", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOStatusError = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.StatusError", DefaultText = " - cannot update a report that was transmitted or cancelled",LocalDefaultText = @"לא ניתן לקלוט שורות לדוח ששודר או בוטל", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOAppearsBefore = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.AppearsBefore", DefaultText = "Appears Before",LocalDefaultText = @"מופיעה לפני", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOStartingRowDeductionFile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.StartingRowDeductionFile", DefaultText = "Starting Row Deduction File",LocalDefaultText = @"תיק ניכויים ברשומת הפתיחה", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOFinishingRowDeductionFile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.FinishingRowDeductionFile", DefaultText = "Finishing Row Deduction File",LocalDefaultText = @"תיק ניכויים ברשומת הסיכום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOOurDeductionFile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.OurDeductionFile", DefaultText = "Our Deduction File Number",LocalDefaultText = @"מספר תיק הניכויים שלנו", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOFinishingRowTotals = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.FinishingRowTotals", DefaultText = "Finishing Row totals do not sum up together",LocalDefaultText = @"כמויות לא מתחברות יחד ברשימת הסיכום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOTaxLineNo = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.TaxLineNo", DefaultText = "Tax Line #",LocalDefaultText = @"שורת תנועה מס' ", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOTaxReportId = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.TaxReportId", DefaultText = "Tax Report Id",LocalDefaultText = "מזהה דו\''ח מס", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOOppositeVatNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.OppositeVatNumber", DefaultText = "Opposite VAT #",LocalDefaultText = @"מספר תיק של צד נגדי", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOLocatedDeductionFile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.LocatedDeductionFile", DefaultText = "Located Deduction File",LocalDefaultText = @"תיק ניכויים שאותר", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOLocatedVATNumber = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.LocatedVATNumber", DefaultText = "Located VAT Number",LocalDefaultText = @"מספר עוסק מורשה שאותר", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOReferenceDate = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.ReferenceDate", DefaultText = "Reference Date",LocalDefaultText = @"תאריך אסמכתא", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOReference = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.Reference", DefaultText = "Reference #",LocalDefaultText = @"מספר אסמכתא", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOEndDate = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.EndDate", DefaultText = "End Date",LocalDefaultText = @"תאריך סיום", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportOFailedWhilePerforming = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.FailedWhilePerforming", DefaultText = "failed while performing",LocalDefaultText = @"תקלה בביצוע", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_ConsolidatedTaxReportONoLinesProcessed = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ConsolidatedTaxReport.O.NoLinesProcessed", DefaultText = "No Lines Processed",LocalDefaultText = @"אין שורות לעיבוד", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOARPaymentCheques = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ARPaymentCheques", DefaultText = "ARPayment Cheques",LocalDefaultText = @"כל השקים מהלקוחות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOUnRedeemedCheques = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.UnRedeemedCheques", DefaultText = "UnRedeemed Cheques",LocalDefaultText = @"המחאות שלא נפרעו", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode GeneralTextCode_AccountingGeneralOAllCheques = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.AllCheques", DefaultText = "All Cheques",LocalDefaultText = @"כל ההמחאות", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
           ...
           TextCode GeneralTextCode_GeneralMHCustomsShipments = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.MH.CustomsShipments", DefaultText = "Customs Shipments", LocalDefaultText = @"עמילות מכס", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "MH", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode GeneralTextCode_GeneralOContinue = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "General.O.Continue", DefaultText = "Continue",LocalDefaultText = @"BS64:IteU157XqdeaIg==", ObjectTableId = GeneralObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
