   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ALESQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "EntityStatus.StatusLocalWeight" , ColumnWidth = 120 }, addedQueryColumns);

			 QueryColumn ALESQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "EntityStatus.EntityStatusTypeCode" , ColumnWidth = 120 }, addedQueryColumns);
