   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode EntityStatusTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "EntityStatus.Q.ALES", DefaultText = @"All Entity Status",LocalDefaultText = null, ObjectTableId = EntityStatusObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query ALESQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = EntityStatusTextCode_0.Id, NameTextCodeCode = EntityStatusTextCode_0.Code, ObjectTableName = "EntityStatus", Code = "ALES",  QueryGroupCode = "7cfc", IndexOrder = 0, Tenant = 0, ObjectTableId = EntityStatusObjectTable.Id, QuerySection = "EntityStatus", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = EntityStatusFeature_0.Id,FeatureUniqeCode= EntityStatusFeature_0.FeatureUniqeCode, DefaultSortName = "StatusWeight", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ALESQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "EntityStatus.ObjectTableName" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn ALESQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "EntityStatus.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ALESQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "EntityStatus.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn ALESQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "EntityStatus.DisplayName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn ALESQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "EntityStatus.StatusWeight" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn ALESQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "EntityStatus.StatusLocalWeight" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn ALESQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALESQuery.Id,QueryCode = ALESQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "EntityStatus.EntityStatusTypeCode" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> EntityStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "EntityStatus").ToList();
	         ...
	         Screen EntityStatusEntityStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "EntityStatus.HeaderScreen", Name = "EntityStatusHeaderScreen", ObjectTableId = EntityStatusObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField EntityStatusEntityStatusHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = EntityStatusEntityStatusHeaderScreenScreen0.Id,ScreenCode = EntityStatusEntityStatusHeaderScreenScreen0.Code, ObjectFieldCode = "EntityStatus.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    EntityStatusObjectTable.HeaderScreenCode = EntityStatusEntityStatusHeaderScreenScreen0.Code;
	         ...
	         Screen EntityStatusGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "EntityStatus.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = EntityStatusObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 8, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.DisplayName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.ObjectTableName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.EntityStatusTypeCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.StatusWeight", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.StatusLocalWeight", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField EntityStatusEntityStatusGeneralTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 7, ScreenId = EntityStatusGeneralTabScreenScreen1.Id,ScreenCode = EntityStatusGeneralTabScreenScreen1.Code, ObjectFieldCode = "EntityStatus.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode EntityStatusGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "EntityStatus.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = EntityStatusObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
