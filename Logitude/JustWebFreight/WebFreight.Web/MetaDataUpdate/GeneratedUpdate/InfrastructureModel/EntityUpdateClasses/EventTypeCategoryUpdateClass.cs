   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> EventTypeCategoryObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "EventTypeCategory").ToList();
	         ...
	         Screen EventTypeCategoryEventTypeCategoryHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "EventTypeCategory.HeaderScreen", Name = "EventTypeCategoryHeaderScreen", ObjectTableId = EventTypeCategoryObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
        ...
        { 
            var repo = new EventTypeCategoryRepository(contextTenant);
