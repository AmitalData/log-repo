   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn allratesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = allratesQuery.Id,QueryCode = allratesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "AdditionalCurrencyRate.UpdateDate" , ColumnWidth = 100 }, addedQueryColumns);
