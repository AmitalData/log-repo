...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InfrastructureModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "7edb4596a3dc0212a69c3d93322eae83";
	    ...
	    {   
		   ...
		   //List<ObjectField> EmailAlertSettingObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "EmailAlertSetting").ToList();
	         ...
	         Screen EmailAlertSettingEmailAlertSettingHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "EmailAlertSetting.HeaderScreen", Name = "EmailAlertSettingHeaderScreen", ObjectTableId = EmailAlertSettingObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
