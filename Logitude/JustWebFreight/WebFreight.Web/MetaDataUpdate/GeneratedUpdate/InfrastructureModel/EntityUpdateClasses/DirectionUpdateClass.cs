   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> DirectionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Direction").ToList();
	         ...
	         Screen DirectionDirectionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Direction.HeaderScreen", Name = "DirectionHeaderScreen", ObjectTableId = DirectionObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
