   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllMoveTypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.Code, IndexOrder = 0, ObjectFieldId = MoveTypeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = MoveTypeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllMoveTypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.Code, IndexOrder = 1, ObjectFieldId = MoveTypeObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = MoveTypeObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 70 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllMoveTypesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.Code, IndexOrder = 2, ObjectFieldId = MoveTypeObjectFields.Where(d => d.FieldName == "MoveTypeEnglishName" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = MoveTypeObjectFields.Where(d => d.FieldName == "MoveTypeEnglishName" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllMoveTypesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.Code, IndexOrder = 3, ObjectFieldId = MoveTypeObjectFields.Where(d => d.FieldName == "MoveTypeLocalName" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = MoveTypeObjectFields.Where(d => d.FieldName == "MoveTypeLocalName" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllMoveTypesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.Code, IndexOrder = 4, ObjectFieldId = MoveTypeObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = MoveTypeObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllMoveTypesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.Code, IndexOrder = 5, ObjectFieldId = MoveTypeObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = MoveTypeObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == MoveTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);
