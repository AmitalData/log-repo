   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode MoveTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "MoveType.Q.AllMoveTypes", DefaultText = @"All Move Types",LocalDefaultText = null, ObjectTableId = MoveTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllMoveTypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "MoveType.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMoveTypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "MoveType.TransportModeId" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMoveTypesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "MoveType.MoveTypeEnglishName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMoveTypesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "MoveType.MoveTypeLocalName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMoveTypesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "MoveType.AddedManually" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMoveTypesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMoveTypesQuery.Id,QueryCode = AllMoveTypesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "MoveType.InActive" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> MoveTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "MoveType").ToList();
	         ...
	         Screen MoveTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "MoveType.HeaderScreen", Name = "Header Screen", ObjectTableId = MoveTypeObjectTable.Id, NumberOfColumns = 3, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField MoveTypeMoveTypeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = MoveTypeHeaderScreenScreen0.Id,ScreenCode = MoveTypeHeaderScreenScreen0.Code, ObjectFieldCode = "MoveType.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField MoveTypeMoveTypeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = MoveTypeHeaderScreenScreen0.Id,ScreenCode = MoveTypeHeaderScreenScreen0.Code, ObjectFieldCode = "MoveType.MoveTypeEnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField MoveTypeMoveTypeHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ScreenId = MoveTypeHeaderScreenScreen0.Id,ScreenCode = MoveTypeHeaderScreenScreen0.Code, ObjectFieldCode = "MoveType.TransportModeId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode MoveTypeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "MoveType.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = MoveTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode MoveTypeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "MoveType.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = MoveTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
