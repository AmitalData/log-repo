...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InfrastructureModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "688c82b2c1a86b2d65b282a11eff53a0";
	    ...
	    public void FillVolumeUnit()
        { 
            var repo = new VolumeUnitRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                VolumeUnit,
                                Logitude.BL.InfrastructureModel.VolumeUnitDetails,
                                VolumeUnitRepository>(repo, dic);
        }
