   ...
   {  
	    ...
	    {   
		   ...
		   List<ObjectField> ErrorLogObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ErrorLog").ToList();
            ...
            ScreenField ErrorLogErrorLogHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = ErrorLogObjectFields.Where(d => d.FieldName == "UserName").FirstOrDefault().Id, ScreenId = ErrorLogHeaderScreenScreen0.Id, ObjectFieldCode = ErrorLogObjectFields.Where(d => d.FieldName == "UserName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ErrorLogErrorLogHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = ErrorLogObjectFields.Where(d => d.FieldName == "LogDate").FirstOrDefault().Id, ScreenId = ErrorLogHeaderScreenScreen0.Id, ObjectFieldCode = ErrorLogObjectFields.Where(d => d.FieldName == "LogDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ErrorLogErrorLogHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ObjectFieldId = ErrorLogObjectFields.Where(d => d.FieldName == "Tier").FirstOrDefault().Id, ScreenId = ErrorLogHeaderScreenScreen0.Id, ObjectFieldCode = ErrorLogObjectFields.Where(d => d.FieldName == "Tier").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ErrorLogErrorLogHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ObjectFieldId = ErrorLogObjectFields.Where(d => d.FieldName == "ClientDate").FirstOrDefault().Id, ScreenId = ErrorLogHeaderScreenScreen0.Id, ObjectFieldCode = ErrorLogObjectFields.Where(d => d.FieldName == "ClientDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
