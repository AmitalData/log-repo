   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomAgentTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.Q.CustomAgents", DefaultText = @"Custom Agents",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CustomAgentFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CUSTOMAGENT", ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomAgent.Features.CustomAgents", NameTextCodeDefaultText = "Custom Agents", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CustomAgentObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        //TextCodeRepository.SubmitChanges();
	        //FeaturesRepository.SubmitChanges();    
	      

			  Query CustomagentsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomAgentTextCode_0.Id, NameTextCodeCode = CustomAgentTextCode_0.Code, ObjectTableName = "CustomAgent", Code = "Custom agents",  QueryGroupCode = "CAGT", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomAgentObjectTable.Id, QuerySection = "CustomAgent", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CustomAgentFeature_0.Id,FeatureUniqeCode= CustomAgentFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Descending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn CustomagentsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "CustomAgent.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "CustomAgent.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "CustomAgent.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "CustomAgent.VatNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "CustomAgent.ReceivablesAccountingCard" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "CustomAgent.PaymentTermEnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "CustomAgent.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CustomagentsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CustomagentsQuery.Id,QueryCode = CustomagentsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "CustomAgent.Notes" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomAgentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CustomAgent").ToList();
	         ...
	         Screen CustomAgentGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomAgent.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = CustomAgentObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 6, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomAgentCustomAgentGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomAgentGeneralTabScreenScreen0.Id,ScreenCode = CustomAgentGeneralTabScreenScreen0.Code, ObjectFieldCode = "CustomAgent.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomAgentGeneralTabScreenScreen0.Id,ScreenCode = CustomAgentGeneralTabScreenScreen0.Code, ObjectFieldCode = "CustomAgent.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CustomAgentGeneralTabScreenScreen0.Id,ScreenCode = CustomAgentGeneralTabScreenScreen0.Code, ObjectFieldCode = "CustomAgent.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CustomAgentGeneralTabScreenScreen0.Id,ScreenCode = CustomAgentGeneralTabScreenScreen0.Code, ObjectFieldCode = "CustomAgent.Website", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CustomAgentGeneralTabScreenScreen0.Id,ScreenCode = CustomAgentGeneralTabScreenScreen0.Code, ObjectFieldCode = "CustomAgent.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = CustomAgentGeneralTabScreenScreen0.Id,ScreenCode = CustomAgentGeneralTabScreenScreen0.Code, ObjectFieldCode = "CustomAgent.Notes", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen CustomAgentHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomAgent.HeaderScreen", Name = "Header Screen", ObjectTableId = CustomAgentObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomAgentCustomAgentHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomAgentHeaderScreenScreen1.Id,ScreenCode = CustomAgentHeaderScreenScreen1.Code, ObjectFieldCode = "CustomAgent.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomAgentHeaderScreenScreen1.Id,ScreenCode = CustomAgentHeaderScreenScreen1.Code, ObjectFieldCode = "CustomAgent.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    CustomAgentObjectTable.HeaderScreenCode = CustomAgentHeaderScreenScreen1.Code;
	         ...
	         Screen CustomAgentBillingTabScreenScreen2 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomAgent.BillingTabScreen", Name = "Billing Tab Screen", ObjectTableId = CustomAgentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.VatNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.PaymentTermId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.InvoiceCurrencyId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.VatTypeId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.EnableConsolidationInvoices", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.BankName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.BankAddress", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.Swift", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 3, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.AccountNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentBillingTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 4, ScreenId = CustomAgentBillingTabScreenScreen2.Id,ScreenCode = CustomAgentBillingTabScreenScreen2.Code, ObjectFieldCode = "CustomAgent.IBANNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen CustomAgentAccountingTabScreenScreen3 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomAgent.AccountingTabScreen", Name = "Accounting Tab Screen", ObjectTableId = CustomAgentObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CustomAgentCustomAgentAccountingTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CustomAgentAccountingTabScreenScreen3.Id,ScreenCode = CustomAgentAccountingTabScreenScreen3.Code, ObjectFieldCode = "CustomAgent.ReceivablesAccountingCard", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CustomAgentCustomAgentAccountingTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CustomAgentAccountingTabScreenScreen3.Id,ScreenCode = CustomAgentAccountingTabScreenScreen3.Code, ObjectFieldCode = "CustomAgent.PayablesAccountingCard", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CustomAgentGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CustomAgentGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomAgent.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CustomAgentObjectTable,contextTenant);
 
                 
			   TextCode CustomAgentBillingTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.Billing", DefaultText = "Billing",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CustomAgentAccountingTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.Accounting", DefaultText = "Accounting",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CustomAgentAddressesTextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.Addresses", DefaultText = "Addresses",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CustomAgentContactsTextCode_TH4 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.Contacts", DefaultText = "Contacts",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CustomAgentTariffsTextCode_TH5 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.Tariffs", DefaultText = "Tariffs",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CustomAgentTariffsFeature_TH5 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "CustomAgent.Tab.Tariffs", ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomAgentFeatures.TRCA", NameTextCodeDefaultText = "Tariffs", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CustomAgentObjectTable,contextTenant);
 
                 
			   TextCode CustomAgentDocsInTextCode_TH6 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.DocsIn", DefaultText = "Docs In",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CustomAgentEventsTextCode_TH7 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomAgent.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = CustomAgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
