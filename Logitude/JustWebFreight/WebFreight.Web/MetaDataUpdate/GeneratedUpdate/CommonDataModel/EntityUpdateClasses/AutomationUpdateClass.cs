...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "aba560fdeeb02cda8c480189cea5c2e6";
	    ...
	    {  
		   ...
		   Feature AutomationFeature_AutomationEventCreation = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AutomationEventCreation", FeatureTypeCode = "AREA", Packagable = true, IsBusinessUnitEnabled = false, IsOld = false, IsCoreFeature = false, ObjectTableId = AutomationObjectTable.Id, Tenant = 0, NameTextCodeCode = "Automation.Features.AutomationEventCreation", NameTextCodeDefaultText = @"Automation Event Creation" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,AutomationObjectTable);
