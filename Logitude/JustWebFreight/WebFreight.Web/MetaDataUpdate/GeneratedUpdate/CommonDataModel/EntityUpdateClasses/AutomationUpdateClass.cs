   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AutomationObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Automation").ToList();
	         ...
	         Screen AutomationAutomationHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Automation.HeaderScreen", Name = "AutomationHeaderScreen", ObjectTableId = AutomationObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode AutomationTextCode_AutomationTHEvents = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Automation.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = AutomationObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
