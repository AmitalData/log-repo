   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode StateTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "State.Q.States", DefaultText = @"States",LocalDefaultText = null, ObjectTableId = StateObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query StatesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = StateTextCode_0.Id, NameTextCodeCode = StateTextCode_0.Code, ObjectTableName = "State", Code = "States",  QueryGroupCode = "STAT", IndexOrder = 0, Tenant = 0, ObjectTableId = StateObjectTable.Id, QuerySection = "State", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = StateFeature_0.Id,FeatureUniqeCode= StateFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn StatesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "State.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn StatesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "State.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn StatesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "State.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn StatesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "State.CountryEnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn StatesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "State.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn StatesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "State.AddedManually" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> StateObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "State").ToList();
	         ...
	         Screen StateGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "State.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = StateObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 6, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField StateStateGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = StateGeneralTabScreenScreen0.Id,ScreenCode = StateGeneralTabScreenScreen0.Code, ObjectFieldCode = "State.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = StateGeneralTabScreenScreen0.Id,ScreenCode = StateGeneralTabScreenScreen0.Code, ObjectFieldCode = "State.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = StateGeneralTabScreenScreen0.Id,ScreenCode = StateGeneralTabScreenScreen0.Code, ObjectFieldCode = "State.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = StateGeneralTabScreenScreen0.Id,ScreenCode = StateGeneralTabScreenScreen0.Code, ObjectFieldCode = "State.CountryId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = StateGeneralTabScreenScreen0.Id,ScreenCode = StateGeneralTabScreenScreen0.Code, ObjectFieldCode = "State.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = StateGeneralTabScreenScreen0.Id,ScreenCode = StateGeneralTabScreenScreen0.Code, ObjectFieldCode = "State.Notes", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen StateHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "State.HeaderScreen", Name = "Header Screen", ObjectTableId = StateObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField StateStateHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = StateHeaderScreenScreen1.Id,ScreenCode = StateHeaderScreenScreen1.Code, ObjectFieldCode = "State.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = StateHeaderScreenScreen1.Id,ScreenCode = StateHeaderScreenScreen1.Code, ObjectFieldCode = "State.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField StateStateHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = StateHeaderScreenScreen1.Id,ScreenCode = StateHeaderScreenScreen1.Code, ObjectFieldCode = "State.AddedManually", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode StateGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "State.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = StateObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode StateEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "State.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = StateObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
