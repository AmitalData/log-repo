   ...
   {  
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CountryEnglishName",
					  						OldFieldName =  "CountryEnglishName",
					  						ObjectTableName =  "State",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  120,
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn StatesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.Code, IndexOrder = 0, ObjectFieldId = StateObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = StateObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn StatesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.Code, IndexOrder = 1, ObjectFieldId = StateObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = StateObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn StatesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.Code, IndexOrder = 2, ObjectFieldId = StateObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = StateObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn StatesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.Code, IndexOrder = 3, ObjectFieldId = StateObjectFields.Where(d => d.FieldName == "CountryEnglishName" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = StateObjectFields.Where(d => d.FieldName == "CountryEnglishName" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn StatesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.Code, IndexOrder = 4, ObjectFieldId = StateObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = StateObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn StatesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = StatesQuery.Id,QueryCode = StatesQuery.Code, IndexOrder = 5, ObjectFieldId = StateObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = StateObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == StateObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
