...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "d11234b2d5f0b7139cb1abd27b86e854";
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CustomerSizeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomerSize.Q.AllCustomerSizes", DefaultText = @"Customer Sizes",LocalDefaultText = null, ObjectTableId = CustomerSizeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllCustomerSizesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CustomerSizeTextCode_0.Id, NameTextCodeCode = CustomerSizeTextCode_0.Code, ObjectTableName = "CustomerSize", Code = "All Customer Sizes",  QueryGroupCode = "CUSS", IndexOrder = 0, Tenant = 0, ObjectTableId = CustomerSizeObjectTable.Id, QuerySection = "CustomerSize", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = CustomerSizeFeature_0.Id,FeatureUniqeCode= CustomerSizeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllCustomerSizesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomerSizesQuery.Id,QueryCode = AllCustomerSizesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "CustomerSize.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomerSizesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomerSizesQuery.Id,QueryCode = AllCustomerSizesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "CustomerSize.Order" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCustomerSizesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCustomerSizesQuery.Id,QueryCode = AllCustomerSizesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "CustomerSize.InActive" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomerSizeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CustomerSize").ToList();
	         ...
	         Screen CustomerSizeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerSize.HeaderScreen", Name = "Header Screen", ObjectTableId = CustomerSizeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
             ...
             ScreenField CustomerSizeCustomerSizeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CustomerSizeHeaderScreenScreen0.Id,ScreenCode = CustomerSizeHeaderScreenScreen0.Code, ObjectFieldCode = "CustomerSize.Order", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    CustomerSizeObjectTable.HeaderScreenCode = CustomerSizeHeaderScreenScreen0.Code;
	         ...
	         Screen CustomerSizeGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerSize.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = CustomerSizeObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CustomerSizeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomerSize.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = CustomerSizeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CustomerSizeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CustomerSize.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = CustomerSizeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
