   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> TemperatureUnitObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "TemperatureUnit").ToList();
	         ...
	         Screen TemperatureUnitTemperatureUnitHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TemperatureUnit.HeaderScreen", Name = "TemperatureUnitHeaderScreen", ObjectTableId = TemperatureUnitObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillTemperatureUnit(int contextTenant)
        { 
            var repo = new TemperatureUnitRepository(contextTenant);
