...
{
   public class CustomerProductActualDataUpdateClass
   {  		
		public const string HashString = "6730c521e62d1ff100cd838da8e68cd9";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "CustomerProductActualData",
			      				    ...
			      				    OldDBTableName =  "CustomerProductActualDatas",
			      				    ...
			      				    Code =  "67a6",
			      				    Name =  "CustomerProductActualData",
			      				    ...
			      				    IsLookUp =  true,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "CustomerProductActualData,CustomerProductActualDatas,,CustomerId,CustomerId",
			      				    HashString =  CustomerProductActualDataUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Tenant",
					  						...
					  						ValidForQuerySection1 =  "CustomerProductActualData",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "MonthCode",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "MonthCode",
					  						ListPropertyPath =  "MonthCode",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "MonthCode",
					  						DefaultText =  "MonthCode",
					  						FullLocalDefaultText =  "MonthCode",
					  						ListFieldLable =  "MonthCodeListLable",
					  						ListLableDefaultText =  "MonthCode",
					  						ListLocalDefaultText =  "MonthCode",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ProductLocations",
					  						...
					  						DisplayInSearchWindowListIndex =  0,
					  						IsMulti =  true,
					  						MultiTableName =  "CustomerProductLocationActualData",
					  						DependencyFilter1IsList =  false,
					  						DependencyFilter2IsList =  false,
					  						DependencyFilter3IsList =  false,
					  						ValidForQuerySection1 =  "CustomerProductActualData",
					  						...
					  						IsForeignKey =  false,
					  						ThisKey =  "CustomerId,ProductTypeCode,Year,Month",
					  						OtherKey =  "CustomerId,ProductTypeCode,Year,Month",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
	    ...
	    {   
		   ...
		   ObjectTable CustomerProductActualDataObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "CustomerProductActualData" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> CustomerProductActualDataObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CustomerProductActualData").ToList();
		       
	      

	         Screen CustomerProductActualDataCustomerProductActualDataHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerProductActualData.HeaderScreen", Name = "CustomerProductActualDataHeaderScreen", ObjectTableId = CustomerProductActualDataObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CustomerProductActualDataObjectTable.HeaderScreenId = CustomerProductActualDataCustomerProductActualDataHeaderScreenScreen0.Id;
		    CustomerProductActualDataObjectTable.HeaderScreenCode = CustomerProductActualDataCustomerProductActualDataHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomerProductActualDataObjectTable.Id,
