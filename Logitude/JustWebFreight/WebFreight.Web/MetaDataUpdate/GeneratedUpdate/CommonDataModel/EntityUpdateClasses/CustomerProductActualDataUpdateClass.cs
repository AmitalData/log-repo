   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> CustomerProductActualDataObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CustomerProductActualData").ToList();
	         ...
	         Screen CustomerProductActualDataCustomerProductActualDataHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerProductActualData.HeaderScreen", Name = "CustomerProductActualDataHeaderScreen", ObjectTableId = CustomerProductActualDataObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
