   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AccountingPartnersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 0, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 1, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 2, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 3, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 4, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 5, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 6, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id,QueryCode = AccountingPartnersQuery.Code, IndexOrder = 7, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPartnerObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
