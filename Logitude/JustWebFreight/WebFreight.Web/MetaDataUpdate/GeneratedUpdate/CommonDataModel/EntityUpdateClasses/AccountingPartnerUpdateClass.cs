...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "AccountingPartner",
			      				    ...
			      				    ObjectTableSingular =  "AccountingPartner",
			      				    ObjectTablePlural =  "AccountingPartners",
	    ...
	    {  
	        ...
	        QueryGroup AccountingPartnerQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "VNDR", Name = "AccountingPartners" }, queryGroupRepository);
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AccountingPartnersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 0, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 1, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 2, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 3, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 4, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 5, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 6, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AccountingPartnersQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AccountingPartnersQuery.Id, IndexOrder = 7, ObjectFieldId = AccountingPartnerObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AccountingPartnerObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
