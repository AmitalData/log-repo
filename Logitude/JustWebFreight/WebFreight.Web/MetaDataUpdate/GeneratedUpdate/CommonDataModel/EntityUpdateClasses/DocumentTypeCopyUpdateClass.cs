...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    {  
 		   ...
 		   TextCode DocumentTypeCopyTextCode_DocumentTypeCopyOCode = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "DocumentTypeCopy.O.Code", DefaultText = "Code",LocalDefaultText = null, ObjectTableId = DocumentTypeCopyObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode DocumentTypeCopyTextCode_DocumentTypeCopyOName = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "DocumentTypeCopy.O.Name", DefaultText = "Name",LocalDefaultText = null, ObjectTableId = DocumentTypeCopyObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
