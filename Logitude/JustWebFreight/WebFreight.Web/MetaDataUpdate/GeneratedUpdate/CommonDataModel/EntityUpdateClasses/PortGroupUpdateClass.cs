   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PortGroupTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PortGroup.Q.ALLGroups", DefaultText = @"All Port Groups",LocalDefaultText = "All Port Groups", ObjectTableId = PortGroupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ALLGroupsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLGroupsQuery.Id,QueryCode = ALLGroupsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "PortGroup.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ALLGroupsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLGroupsQuery.Id,QueryCode = ALLGroupsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "PortGroup.Name" , ColumnWidth = 120 }, addedQueryColumns,contextTenant);

			 QueryColumn ALLGroupsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ALLGroupsQuery.Id,QueryCode = ALLGroupsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "PortGroup.Inactive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PortGroupObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PortGroup").ToList();
	         ...
	         Screen PortGroupGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PortGroup.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = PortGroupObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	         ...
	         Screen PortGroupHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PortGroup.HeaderScreen", Name = "Header Screen", ObjectTableId = PortGroupObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField PortGroupPortGroupHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = PortGroupHeaderScreenScreen1.Id,ScreenCode = PortGroupHeaderScreenScreen1.Code, ObjectFieldCode = "PortGroup.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode PortGroupGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PortGroup.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = PortGroupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode PortGroupEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PortGroup.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = PortGroupObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
