...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "d435986c8d8517ce8c20e2f3f8dbbfe2";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ChargeTypeAccounting",
			      				    ...
			      				    InActive =  false,
			      				    SearchFields =  "ChargeTypeAccounting,ChargeTypeAccountings,,Id,",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsEditable =  true,
			      				    HashString =  ChargeTypeAccountingUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Id",
					  						...
					  						ValidForQuerySection1 =  "ChargeTypeAccounting",
					  						IsRequired =  false,
					  						DisplayInList =  true,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ChargeTypeId",
					  						...
					  						DisplayInSearchWindowList =  false,
					  						DisplayInSearchWindowFilters =  false,
					  						PMPropertyPath =  "ChargeTypeId",
					  						ListPropertyPath =  "ChargeTypeId",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						NavigationPropertyName =  "ChargeType",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldsDataType =  "Text",
					  						...
					  						PMPropertyPath =  "ChargeTypeName",
					  						ListPropertyPath =  "ChargeTypeName",
					  						FullFieldLable =  "ChargeTypeName",
					  						DefaultText =  "ChargeTypeName",
					  						FullLocalDefaultText =  "ChargeTypeName",
					  						ListFieldLable =  "ChargeTypeNameListLable",
					  						ListLableDefaultText =  "ChargeTypeName",
					  						ListLocalDefaultText =  "ChargeTypeName",
					  						ObjectTableName =  "ChargeTypeAccounting",
					  						ValidForQuerySection1 =  "ChargeTypeAccounting",
					  						NoMetaDataField =  true,
