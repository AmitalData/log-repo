   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode HybridPartnerTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "HybridPartner.Q.HybridPartners", DefaultText = @"Hybrid Partner",LocalDefaultText = null, ObjectTableId = HybridPartnerObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn HybridPartnersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HybridPartnersQuery.Id,QueryCode = HybridPartnersQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "HybridPartner.Name" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn HybridPartnersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HybridPartnersQuery.Id,QueryCode = HybridPartnersQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "HybridPartner.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn HybridPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = HybridPartnersQuery.Id,QueryCode = HybridPartnersQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "HybridPartner.PartnerTenant" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> HybridPartnerObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "HybridPartner").ToList();
	         ...
	         Screen HybridPartnerHybridPartnerHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "HybridPartner.HeaderScreen", Name = "HybridPartnerHeaderScreen", ObjectTableId = HybridPartnerObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode HybridPartnerGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "HybridPartner.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = HybridPartnerObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode HybridPartnerPermissionsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "HybridPartner.TH.Permissions", DefaultText = "Permissions",LocalDefaultText = null, ObjectTableId = HybridPartnerObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
