...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "e5c302d33b9e71f6e363b905a8cb9aa4";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "DueType",
			      				    ...
			      				    OldDBTableName =  "DueTypes",
			      				    ObjectTableSingular =  "Due Type",
			      				    ObjectTablePlural =  "DueTypes",
			      				    ...
			      				    IsLookUp =  true,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "DueType,DueTypes,,Code,",
			      				    HashString =  DueTypeUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						ValidForQuerySection1 =  "DueType",
					  						ValidForQuerySection2 =  "DueTypeFollowUp",
					  						IsRestrictable =  false,
	    ...
	    {   
		   ...
		   //List<ObjectField> DueTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "DueType").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = DueTypeObjectTable.Id,
	    ...
	    public void FillDueType()
        { 
            var repo = new DueTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                DueType,
                                Logitude.BL.CommonDataModel.DueTypeDetails,
                                DueTypeRepository>(repo, dic);
        }
