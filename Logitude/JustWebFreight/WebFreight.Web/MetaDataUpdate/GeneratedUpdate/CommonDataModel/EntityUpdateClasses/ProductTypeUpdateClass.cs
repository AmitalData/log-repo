   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllActiveProductTypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllActiveProductTypesQuery.Id, IndexOrder = 0, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllActiveProductTypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllActiveProductTypesQuery.Id, IndexOrder = 1, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PRGN",HtmlComponentName = "ProductTypeGeneralTabComponent",HtmlComponentUrl = "./CommonModules/CommonOthers/Components/ProductType/EditTabs/ProductTypeGeneralTabComponent", FeatureId = ProductTypeGeneralFeature_TH0.Id, ControlPath = "Simplog.Infrastructure.GeneralControls.GeneralTabControl", ObjectTableId = ProductTypeObjectTable.Id, TabNameTextCodeId = ProductTypeGeneralTextCode_TH0.Id, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PREV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = ProductTypeEventsFeature_TH1.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = ProductTypeObjectTable.Id, TabNameTextCodeId = ProductTypeEventsTextCode_TH1.Id, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
