   ...
   {  
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "RoutingRQuoteDefaultTemplateId",
					  						OldFieldName =  "RatesDefaultTemplateId",
					  						ObjectTableName =  "ProductType",
					  						FieldsDataType =  "LookUp",
					  						LookUpTableName =  "QuoteTemplate",
					  						MinLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "RoutingRQuoteDefaultTemplate",
					  						OldFieldName =  "RoutingRQuoteDefaultTemplate",
					  						ObjectTableName =  "ProductType",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  60,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "RoutingRQuoteDefaultTemplate",
					  						ListPropertyPath =  "RoutingRQuoteDefaultTemplate",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "RoutingRQuoteDefaultTemplate",
					  						DefaultText =  "Routing Rates Quotation Default Template",
					  						ListFieldLable =  "RoutingRQuoteDefaultTemplateListLable",
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllActiveProductTypesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ProductTypeTextCode_0.Id, NameTextCodeCode = ProductTypeTextCode_0.Code, Code = "All Active Product Types",  QueryGroupCode = "PRTP", IndexOrder = 0, Tenant = 0, ObjectTableId = ProductTypeObjectTable.Id, QuerySection = "ProductType", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ProductTypeFeature_0.Id, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllActiveProductTypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllActiveProductTypesQuery.Id,QueryCode = AllActiveProductTypesQuery.Code, IndexOrder = 0, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllActiveProductTypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllActiveProductTypesQuery.Id,QueryCode = AllActiveProductTypesQuery.Code, IndexOrder = 1, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllActiveProductTypesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllActiveProductTypesQuery.Id,QueryCode = AllActiveProductTypesQuery.Code, IndexOrder = 2, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == ProductTypeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> ProductTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ProductType").ToList();
            ...
            ScreenField ProductTypeProductTypeGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = ProductTypeGeneralTabScreenScreen1.Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ProductTypeProductTypeGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = ProductTypeGeneralTabScreenScreen1.Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ProductTypeProductTypeGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "InActive").FirstOrDefault().Id, ScreenId = ProductTypeGeneralTabScreenScreen1.Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "InActive").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ProductTypeProductTypeGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "QuotationDefaultTemplateId").FirstOrDefault().Id, ScreenId = ProductTypeGeneralTabScreenScreen1.Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "QuotationDefaultTemplateId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ProductTypeProductTypeGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = ProductTypeObjectFields.Where(d => d.FieldName == "RoutingRQuoteDefaultTemplateId").FirstOrDefault().Id, ScreenId = ProductTypeGeneralTabScreenScreen1.Id, ObjectFieldCode = ProductTypeObjectFields.Where(d => d.FieldName == "RoutingRQuoteDefaultTemplateId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PRGN",HtmlComponentName = "ProductTypeGeneralTabComponent",HtmlComponentUrl = "./CommonModules/CommonOthers/Components/ProductType/EditTabs/ProductTypeGeneralTabComponent", FeatureId = ProductTypeGeneralFeature_TH0.Id, ControlPath = "Simplog.Infrastructure.GeneralControls.GeneralTabControl", ObjectTableId = ProductTypeObjectTable.Id, TabNameTextCodeId = ProductTypeGeneralTextCode_TH0.Id, TabNameTextCodeCode = ProductTypeGeneralTextCode_TH0.Code, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PREV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = ProductTypeEventsFeature_TH1.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = ProductTypeObjectTable.Id, TabNameTextCodeId = ProductTypeEventsTextCode_TH1.Id, TabNameTextCodeCode = ProductTypeEventsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
