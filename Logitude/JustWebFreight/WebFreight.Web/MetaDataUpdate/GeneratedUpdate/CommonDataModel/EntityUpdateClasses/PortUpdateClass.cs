   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn PortsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 0, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 1, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 2, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "IsAir" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "IsAir" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 3, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "IsOcean" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "IsOcean" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 4, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "IsInland" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "IsInland" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 5, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 6, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "CountryName" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "CountryName" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn PortsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PortsQuery.Id,QueryCode = PortsQuery.Code, IndexOrder = 7, ObjectFieldId = PortObjectFields.Where(d => d.FieldName == "Remark" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = PortObjectFields.Where(d => d.FieldName == "Remark" && d.ObjectTableId == PortObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
