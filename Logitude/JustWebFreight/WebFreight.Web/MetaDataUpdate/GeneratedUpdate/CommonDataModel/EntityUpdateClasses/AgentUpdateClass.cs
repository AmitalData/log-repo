...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "bc049dd081d092dfc3adc5731520dcaf";
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AgentTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.Q.Agents", DefaultText = @"Agents",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   ...
			   TextCode AgentTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.Q.SharedLogisticsAgents", DefaultText = @"Shared Logistics Agents",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AgentsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AgentTextCode_0.Id, NameTextCodeCode = AgentTextCode_0.Code, ObjectTableName = "Agent", Code = "Agents",  QueryGroupCode = "AGNT", IndexOrder = 0, Tenant = 0, ObjectTableId = AgentObjectTable.Id, QuerySection = "Agent", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = AgentFeature_0.Id,FeatureUniqeCode= AgentFeature_0.FeatureUniqeCode, DefaultSortName = "Code", DefaultSortDirection = "Descending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AgentsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Agent.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Agent.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Agent.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Agent.VatNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Agent.ReceivablesAccountingCard" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Agent.PaymentTermEnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Agent.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Agent.Notes" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
			 ...
			 QueryColumn SharedLogisticsAgentsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Agent.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SharedLogisticsAgentsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Agent.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SharedLogisticsAgentsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Agent.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SharedLogisticsAgentsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Agent.ReceivablesAccountingCard" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn SharedLogisticsAgentsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Agent.LastLoginDate" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> AgentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Agent").ToList();
		    ...
		    AgentObjectTable.HeaderScreenCode = AgentHeaderScreenScreen1.Code;
	         ...
	         Screen AgentBillingTabScreenScreen2 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Agent.BillingTabScreen", Name = "Billing Tab Screen", ObjectTableId = AgentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField AgentAgentBillingTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.VatNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.PaymentTermId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.InvoiceCurrencyId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.VatTypeId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.EnableConsolidationInvoices", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.BankName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.BankAddress", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.Swift", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 3, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.AccountNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField AgentAgentBillingTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 4, ScreenId = AgentBillingTabScreenScreen2.Id,ScreenCode = AgentBillingTabScreenScreen2.Code, ObjectFieldCode = "Agent.IBANNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen AgentAdditionalFieldsScreen3 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Agent.AdditionalFields", Name = "Additional Fields", ObjectTableId = AgentObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode AgentGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentBillingTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.Billing", DefaultText = "Billing",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentAccountingTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.Accounting", DefaultText = "Accounting",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentAddressesTextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.Addresses", DefaultText = "Addresses",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentContactsTextCode_TH4 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.Contacts", DefaultText = "Contacts",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentSharedLogisticsTextCode_TH5 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.SharedLogistics", DefaultText = "Shared Logistics",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentTariffsTextCode_TH6 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.Tariffs", DefaultText = "Tariffs",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature AgentTariffsFeature_TH6 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Agent.Tab.Tariffs", ObjectTableId = AgentObjectTable.Id, Tenant = 0, NameTextCodeCode = "AgentFeatures.AGTR", NameTextCodeDefaultText = "Tariffs", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,AgentObjectTable,contextTenant);
 
                 
			   TextCode AgentDocsOutTextCode_TH7 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.DocsOut", DefaultText = "Docs Out",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentDocsInTextCode_TH8 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.DocsIn", DefaultText = "Docs In",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode AgentEventsTextCode_TH9 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Agent.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = AgentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature AgentEventsFeature_TH9 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "EVENTS", ObjectTableId = AgentObjectTable.Id, Tenant = 0, NameTextCodeCode = "Agent.Features.Events", NameTextCodeDefaultText = "Events", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,AgentObjectTable,contextTenant);
			 TextCodeRepository.SubmitChanges();
			 FeaturesRepository.SubmitChanges();
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "AGTR",HtmlComponentName = "",HtmlComponentUrl = "./Common/Components/TariffsTab/TariffsTabComponent", FeatureId = AgentTariffsFeature_TH6.Id,FeatureUniqeCode = AgentTariffsFeature_TH6.FeatureUniqeCode, ControlPath = "./Common/Components/TariffsTab/TariffsTabComponent", ObjectTableId = AgentObjectTable.Id, TabNameTextCodeId = AgentTariffsTextCode_TH6.Id, TabNameTextCodeCode = AgentTariffsTextCode_TH6.Code, Tenant = 0, IndexOrder = 5 }, objectTableTabsRepository, TenantObjectTableTabs,contextTenant);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "AGDO",HtmlComponentName = "",HtmlComponentUrl = "./CommonModules/CommonAgent/Components/EditTabs/AgentDocsOutTabComponent", FeatureId = AgentDocsOutFeature_TH7.Id,FeatureUniqeCode = AgentDocsOutFeature_TH7.FeatureUniqeCode, ControlPath = "", ObjectTableId = AgentObjectTable.Id, TabNameTextCodeId = AgentDocsOutTextCode_TH7.Id, TabNameTextCodeCode = AgentDocsOutTextCode_TH7.Code, Tenant = 0, IndexOrder = 6 }, objectTableTabsRepository, TenantObjectTableTabs,contextTenant);
