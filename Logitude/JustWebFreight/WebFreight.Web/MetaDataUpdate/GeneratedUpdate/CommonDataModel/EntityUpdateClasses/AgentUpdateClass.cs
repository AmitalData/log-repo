   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AgentsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AgentTextCode_0.Id, NameTextCodeCode = AgentTextCode_0.Code, Code = "Agents",  QueryGroupCode = "AGNT", IndexOrder = 0, Tenant = 0, ObjectTableId = AgentObjectTable.Id, QuerySection = "Agent", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = AgentFeature_0.Id, DefaultSortName = "Code", DefaultSortDirection = "Descending", Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AgentsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 0, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 1, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 2, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 3, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 4, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 5, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 6, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentsQuery.Id,QueryCode = AgentsQuery.Code, IndexOrder = 7, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
  
	      

			  Query SharedLogisticsAgentsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AgentTextCode_1.Id, NameTextCodeCode = AgentTextCode_1.Code, Code = "Shared Logistics Agents",  QueryGroupCode = "AGNT", IndexOrder = 1, Tenant = 0, ObjectTableId = AgentObjectTable.Id, QuerySection = "Agent", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AgentFeature_1.Id, DefaultSortName = "SharedLogisticsInvitationStatusName", DefaultSortDirection = "Descending", Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn SharedLogisticsAgentsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, IndexOrder = 0, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "SharedLogisticsInvitationStatusName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "SharedLogisticsInvitationStatusName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SharedLogisticsAgentsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, IndexOrder = 1, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SharedLogisticsAgentsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, IndexOrder = 2, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SharedLogisticsAgentsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, IndexOrder = 3, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SharedLogisticsAgentsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, IndexOrder = 4, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn SharedLogisticsAgentsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, IndexOrder = 5, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "LastLoginDate" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "LastLoginDate" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter SharedLogisticsAgentsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AgentObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "false",PredefinedValue2 = null, QueryId = SharedLogisticsAgentsQuery.Id,QueryCode = SharedLogisticsAgentsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
	    ...
	    {   
		   ...
		   List<ObjectField> AgentObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Agent").ToList();
            ...
            ScreenField AgentAgentHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = AgentHeaderScreenScreen1.Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AgentAgentHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = AgentObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = AgentHeaderScreenScreen1.Id, ObjectFieldCode = AgentObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "AGSL",HtmlComponentName = "AgentSharedLogisticsTabComponent",HtmlComponentUrl = "./CommonModules/CommonAgent/Components/EditTabs/AgentSharedLogisticsTabComponent", FeatureId = AgentSharedLogisticsFeature_TH5.Id, ControlPath = "Simplog.FreightLib.Views.PartnersTabs.AgentSharedLogisticsTabControl", ObjectTableId = AgentObjectTable.Id, TabNameTextCodeId = AgentSharedLogisticsTextCode_TH5.Id, TabNameTextCodeCode = AgentSharedLogisticsTextCode_TH5.Code, Tenant = 0, IndexOrder = 5 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "AGDO",HtmlComponentName = "",HtmlComponentUrl = "./CommonModules/CommonAgent/Components/EditTabs/AgentDocsOutTabComponent", FeatureId = AgentDocsOutFeature_TH6.Id, ControlPath = "", ObjectTableId = AgentObjectTable.Id, TabNameTextCodeId = AgentDocsOutTextCode_TH6.Id, TabNameTextCodeCode = AgentDocsOutTextCode_TH6.Code, Tenant = 0, IndexOrder = 6 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "AGDI",HtmlComponentName = "",HtmlComponentUrl = "./CommonModules/CommonAgent/Components/EditTabs/AgentDocsInTabComponent", FeatureId = AgentDocsInFeature_TH7.Id, ControlPath = "", ObjectTableId = AgentObjectTable.Id, TabNameTextCodeId = AgentDocsInTextCode_TH7.Id, TabNameTextCodeCode = AgentDocsInTextCode_TH7.Code, Tenant = 0, IndexOrder = 7 }, objectTableTabsRepository, TenantObjectTableTabs);
