   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode IncotermTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Incoterm.Q.Incoterms", DefaultText = @"Incoterms",LocalDefaultText = null, ObjectTableId = IncotermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query IncotermsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = IncotermTextCode_0.Id, NameTextCodeCode = IncotermTextCode_0.Code, ObjectTableName = "Incoterm", Code = "Incoterms",  QueryGroupCode = "INCO", IndexOrder = 0, Tenant = 0, ObjectTableId = IncotermObjectTable.Id, QuerySection = "Incoterm", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = IncotermFeature_0.Id,FeatureUniqeCode= IncotermFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn IncotermsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Incoterm.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn IncotermsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Incoterm.Name" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn IncotermsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Incoterm.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn IncotermsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Incoterm.Freight" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn IncotermsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Incoterm.OtherCharges" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn IncotermsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Incoterm.AddedManually" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn IncotermsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = IncotermsQuery.Id,QueryCode = IncotermsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Incoterm.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> IncotermObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Incoterm").ToList();
	         ...
	         Screen IncotermGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Incoterm.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = IncotermObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField IncotermIncotermGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = IncotermGeneralTabScreenScreen0.Id,ScreenCode = IncotermGeneralTabScreenScreen0.Code, ObjectFieldCode = "Incoterm.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField IncotermIncotermGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = IncotermGeneralTabScreenScreen0.Id,ScreenCode = IncotermGeneralTabScreenScreen0.Code, ObjectFieldCode = "Incoterm.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField IncotermIncotermGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = IncotermGeneralTabScreenScreen0.Id,ScreenCode = IncotermGeneralTabScreenScreen0.Code, ObjectFieldCode = "Incoterm.Freight", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField IncotermIncotermGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = IncotermGeneralTabScreenScreen0.Id,ScreenCode = IncotermGeneralTabScreenScreen0.Code, ObjectFieldCode = "Incoterm.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField IncotermIncotermGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = IncotermGeneralTabScreenScreen0.Id,ScreenCode = IncotermGeneralTabScreenScreen0.Code, ObjectFieldCode = "Incoterm.OtherCharges", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen IncotermHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Incoterm.HeaderScreen", Name = "Header Screen", ObjectTableId = IncotermObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField IncotermIncotermHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = IncotermHeaderScreenScreen1.Id,ScreenCode = IncotermHeaderScreenScreen1.Code, ObjectFieldCode = "Incoterm.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField IncotermIncotermHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = IncotermHeaderScreenScreen1.Id,ScreenCode = IncotermHeaderScreenScreen1.Code, ObjectFieldCode = "Incoterm.Name", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField IncotermIncotermHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = IncotermHeaderScreenScreen1.Id,ScreenCode = IncotermHeaderScreenScreen1.Code, ObjectFieldCode = "Incoterm.AddedManually", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode IncotermGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Incoterm.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = IncotermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode IncotermEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Incoterm.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = IncotermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
