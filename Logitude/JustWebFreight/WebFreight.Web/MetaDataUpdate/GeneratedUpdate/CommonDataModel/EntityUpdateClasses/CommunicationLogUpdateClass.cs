   ...
   {  		
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						FullLocalDefaultText =  "חיפוש דוא\"ל / נושא",
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CommunicationLogTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.Q.TodayCommunicationLogs", DefaultText = @"Today",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CommunicationLogFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "TODAYCOMMLOGS", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, NameTextCodeCode = "CommunicationLog.Features.TodayCommunicationLogs", NameTextCodeDefaultText = "Today Communication Logs", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CommunicationLogObjectTable, addedFeatures, addedTextCodes,contextTenant);
 

			   TextCode CommunicationLogTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.Q.AllCommunicationLogs", DefaultText = @"All Communication Logs",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn TodayCommunicationLogsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "CommunicationLog.CreateDate" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "CommunicationLog.CreatedByUserName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "CommunicationLog.InOut" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "CommunicationLog.CommunicationStatusTypeName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
			 ...
			 QueryColumn TodayCommunicationLogsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "CommunicationLog.EntityReference" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "CommunicationLog.From" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "CommunicationLog.To" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "CommunicationLog.Subject" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn TodayCommunicationLogsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "CommunicationLog.Retries" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter TodayCommunicationLogsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "CommunicationLog.CreateDate", PredefinedValue = "Today",PredefinedValue2 = null, CustomPredefined = false, QueryId = TodayCommunicationLogsQuery.Id,QueryCode = TodayCommunicationLogsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);

  
	      

			  Query AllCommunicationLogsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CommunicationLogTextCode_1.Id, NameTextCodeCode = CommunicationLogTextCode_1.Code, ObjectTableName = "CommunicationLog", Code = "All Communication Logs",  QueryGroupCode = "COLG", IndexOrder = 1, Tenant = 0, ObjectTableId = CommunicationLogObjectTable.Id, QuerySection = "CommunicationLog", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CommunicationLogFeature_1.Id,FeatureUniqeCode= CommunicationLogFeature_1.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllCommunicationLogsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "CommunicationLog.CreateDate" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "CommunicationLog.CreatedByUserName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "CommunicationLog.InOut" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);
			 ...
			 QueryColumn AllCommunicationLogsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "CommunicationLog.ObjectTableName" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "CommunicationLog.EntityReference" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "CommunicationLog.From" , ColumnWidth = 130 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "CommunicationLog.To" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "CommunicationLog.Subject" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCommunicationLogsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCommunicationLogsQuery.Id,QueryCode = AllCommunicationLogsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "CommunicationLog.Retries" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CommunicationLogObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CommunicationLog").ToList();
	         ...
	         Screen CommunicationLogHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CommunicationLog.HeaderScreen", Name = "Header Screen", ObjectTableId = CommunicationLogObjectTable.Id, NumberOfColumns = 4, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CommunicationLogCommunicationLogHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CommunicationLogHeaderScreenScreen0.Id,ScreenCode = CommunicationLogHeaderScreenScreen0.Code, ObjectFieldCode = "CommunicationLog.From", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CommunicationLogHeaderScreenScreen0.Id,ScreenCode = CommunicationLogHeaderScreenScreen0.Code, ObjectFieldCode = "CommunicationLog.To", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ScreenId = CommunicationLogHeaderScreenScreen0.Id,ScreenCode = CommunicationLogHeaderScreenScreen0.Code, ObjectFieldCode = "CommunicationLog.CommunicationStatusTypeCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogHeaderScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 3, Row = 0, ScreenId = CommunicationLogHeaderScreenScreen0.Id,ScreenCode = CommunicationLogHeaderScreenScreen0.Code, ObjectFieldCode = "CommunicationLog.CommunicationLogTypeCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    CommunicationLogObjectTable.HeaderScreenCode = CommunicationLogHeaderScreenScreen0.Code;
	         ...
	         Screen CommunicationLogGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CommunicationLog.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = CommunicationLogObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 8, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.Id", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.From", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.To", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.CC", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.BCC", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.Subject", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.Retries", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 7, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.InOut", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.ObjectTableId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.CommunicationStatusTypeCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField10 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.CommunicationLogTypeCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField11 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 3, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.TenantName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField CommunicationLogCommunicationLogGeneralTabScreenScreenField12 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 4, ScreenId = CommunicationLogGeneralTabScreenScreen1.Id,ScreenCode = CommunicationLogGeneralTabScreenScreen1.Code, ObjectFieldCode = "CommunicationLog.AWBNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CommunicationLogGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CommunicationLogGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, NameTextCodeCode = "CommunicationLog.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CommunicationLogObjectTable,contextTenant);
 
                 
			   TextCode CommunicationLogMessageBodyTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.TH.MessageBody", DefaultText = "Message Body",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CommunicationLogMessageBodyFeature_TH1 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "MESSAGEBODY", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, NameTextCodeCode = "CommunicationLog.Features.MessageBody", NameTextCodeDefaultText = "Message Body", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CommunicationLogObjectTable,contextTenant);
 
                 
			   TextCode CommunicationLogErrorTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.TH.Error", DefaultText = "Error",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CommunicationLogStepsTextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.TH.Steps", DefaultText = "Steps",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode CommunicationLogEventsTextCode_TH4 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode CommunicationLogTextCode_CommunicationLogBDetails = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.B.Details", DefaultText = "Details",LocalDefaultText = @"פרטים", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CommunicationLogTextCode_CommunicationLogOLogs = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.O.Logs", DefaultText = "Logs",LocalDefaultText = @"לוג", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CommunicationLogTextCode_CommunicationLogOCorrelationID = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.O.CorrelationID", DefaultText = "Correlation ID",LocalDefaultText = @"מתאם", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CommunicationLogTextCode_CommunicationLogOMoreDetails = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.O.MoreDetails", DefaultText = "More Details",LocalDefaultText = @"פרטים נוספים", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CommunicationLogTextCode_CommunicationLogBView = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.B.View", DefaultText = "View",LocalDefaultText = @"לצפות", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode CommunicationLogTextCode_CommunicationLogOError = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLog.O.Error", DefaultText = "Error",LocalDefaultText = @"שגיאה", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CommunicationLogTextCode_CommunicationLogStepsOLog = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLogSteps.O.Log", DefaultText = "Log",LocalDefaultText = @"לוג", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode CommunicationLogTextCode_CommunicationLogStepsOShowResponse = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "CommunicationLogSteps.O.ShowResponse", DefaultText = "Response",LocalDefaultText = @"תשובה", ObjectTableId = CommunicationLogObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
