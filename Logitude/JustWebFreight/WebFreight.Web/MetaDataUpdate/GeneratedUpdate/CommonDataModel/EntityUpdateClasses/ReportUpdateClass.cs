...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
 		...
 		public const string HashString = "4d84980c3a9c0732ba9f72297a7cc4bb";
	    ...
	    {   
		   ...
		   //List<ObjectField> ReportObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Report").ToList();
		    ...
		    ReportObjectTable.HeaderScreenCode = ReportHeaderScreenScreen0.Code;
 	         ...
 	         Screen ReportGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Report.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = ReportObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
