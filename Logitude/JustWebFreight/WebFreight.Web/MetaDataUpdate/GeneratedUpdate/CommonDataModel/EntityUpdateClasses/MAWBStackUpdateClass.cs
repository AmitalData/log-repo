	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AssignedToId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "Card",
					  						NavigationPropertyName =  "AssignedToCard",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AssignedToShipperName",
					  						ObjectTableName =  "MAWBStack",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "AssignedToShipperName",
					  						ListPropertyPath =  "AssignedToShipperName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "AssignedToShipperName",
					  						DefaultText =  "AssignedToShipperName",
					  						FullLocalDefaultText =  "AssignedToShipperName",
					  						ListFieldLable =  "AssignedToShipperNameListLable",
					  						ListLableDefaultText =  "AssignedToShipperName",
					  						ListLocalDefaultText =  "AssignedToShipperName",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AirlineName",
					  						...
					  						FullLocalDefaultText =  "AirlineName",
					  						ListFieldLable =  "AirlineNameListLable",
					  						ListLableDefaultText =  "AirlineName",
					  						ListLocalDefaultText =  "AirlineName",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
