   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ShippingagentsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 0, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 1, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 2, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 3, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 4, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 5, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "PaymentTermEnglishName" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 6, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippingagentsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippingagentsQuery.Id,QueryCode = ShippingagentsQuery.Code, IndexOrder = 7, ObjectFieldId = ShippingAgentObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingAgentObjectFields.Where(d => d.FieldName == "Notes" && d.ObjectTableId == ShippingAgentObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
