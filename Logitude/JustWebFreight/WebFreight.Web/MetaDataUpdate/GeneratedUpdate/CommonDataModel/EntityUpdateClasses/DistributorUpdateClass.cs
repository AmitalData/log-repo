...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "DSTN",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = DistributorTenantsFeature_TH1.Id,FeatureUniqeCode = DistributorTenantsFeature_TH1.FeatureUniqeCode, ControlPath = "Simplog.FreightLib.Views.Distributor.DistributorTenantsControl", ObjectTableId = DistributorObjectTable.Id, TabNameTextCodeId = DistributorTenantsTextCode_TH1.Id, TabNameTextCodeCode = DistributorTenantsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "DSEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = DistributorEventsFeature_TH2.Id,FeatureUniqeCode = DistributorEventsFeature_TH2.FeatureUniqeCode, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = DistributorObjectTable.Id, TabNameTextCodeId = DistributorEventsTextCode_TH2.Id, TabNameTextCodeCode = DistributorEventsTextCode_TH2.Code, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
