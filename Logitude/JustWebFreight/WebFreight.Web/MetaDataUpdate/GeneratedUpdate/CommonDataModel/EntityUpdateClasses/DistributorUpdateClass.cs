   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllDistributorsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllDistributorsQuery.Id, IndexOrder = 0, ObjectFieldId = DistributorObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == DistributorObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DistributorObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == DistributorObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllDistributorsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllDistributorsQuery.Id, IndexOrder = 1, ObjectFieldId = DistributorObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == DistributorObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DistributorObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == DistributorObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllDistributorsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllDistributorsQuery.Id, IndexOrder = 2, ObjectFieldId = DistributorObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == DistributorObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DistributorObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == DistributorObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> DistributorObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Distributor").ToList();
            ...
            ScreenField DistributorDistributorGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = DistributorObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = DistributorGeneralTabScreenScreen0.Id, ObjectFieldCode = DistributorObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField DistributorDistributorGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = DistributorObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = DistributorGeneralTabScreenScreen0.Id, ObjectFieldCode = DistributorObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField DistributorDistributorGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = DistributorObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = DistributorGeneralTabScreenScreen0.Id, ObjectFieldCode = DistributorObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "DSTN",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = DistributorTenantsFeature_TH1.Id, ControlPath = "Simplog.FreightLib.Views.Distributor.DistributorTenantsControl", ObjectTableId = DistributorObjectTable.Id, TabNameTextCodeId = DistributorTenantsTextCode_TH1.Id, TabNameTextCodeCode = DistributorTenantsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "DSEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = DistributorEventsFeature_TH2.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = DistributorObjectTable.Id, TabNameTextCodeId = DistributorEventsTextCode_TH2.Id, TabNameTextCodeCode = DistributorEventsTextCode_TH2.Code, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
