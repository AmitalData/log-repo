   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode DistributorTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Distributor.Q.AllDistributors", DefaultText = @"All Distributors",LocalDefaultText = null, ObjectTableId = DistributorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllDistributorsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = DistributorTextCode_0.Id, NameTextCodeCode = DistributorTextCode_0.Code, ObjectTableName = "Distributor", Code = "All Distributors",  QueryGroupCode = "DIST", IndexOrder = 0, Tenant = 0, ObjectTableId = DistributorObjectTable.Id, QuerySection = "Distributor", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = DistributorFeature_0.Id,FeatureUniqeCode= DistributorFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllDistributorsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllDistributorsQuery.Id,QueryCode = AllDistributorsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Distributor.Code" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllDistributorsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllDistributorsQuery.Id,QueryCode = AllDistributorsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Distributor.EnglishName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllDistributorsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllDistributorsQuery.Id,QueryCode = AllDistributorsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Distributor.LocalName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> DistributorObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Distributor").ToList();
	         ...
	         Screen DistributorGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Distributor.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = DistributorObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 4, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode DistributorGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Distributor.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = DistributorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode DistributorTenantsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Distributor.TH.Tenants", DefaultText = "Tenants",LocalDefaultText = null, ObjectTableId = DistributorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode DistributorEventsTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Distributor.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = DistributorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
