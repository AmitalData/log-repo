   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PackageTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PackageType.Q.PackageTypes", DefaultText = @"Package Types",LocalDefaultText = null, ObjectTableId = PackageTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query PackageTypesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = PackageTypeTextCode_0.Id, NameTextCodeCode = PackageTypeTextCode_0.Code, ObjectTableName = "PackageType", Code = "Package Types",  QueryGroupCode = "PCKT", IndexOrder = 0, Tenant = 0, ObjectTableId = PackageTypeObjectTable.Id, QuerySection = "PackageType", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = PackageTypeFeature_0.Id,FeatureUniqeCode= PackageTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn PackageTypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "PackageType.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "PackageType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "PackageType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "PackageType.IsAir" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "PackageType.IsOcean" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "PackageType.IsInland" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "PackageType.AddedManually" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "PackageType.IsContainer" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PackageTypesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PackageTypesQuery.Id,QueryCode = PackageTypesQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "PackageType.Notes" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PackageTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PackageType").ToList();
	         ...
	         Screen PackageTypeGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PackageType.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = PackageTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 8, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.TEU", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.ContainerSize", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.Volume", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.PrintAs", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.IsContainer", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.IsRefrigerated", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField10 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.IsVehicle", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField11 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 3, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.IsAir", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField13 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 5, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.IsInland", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeGeneralTabScreenScreenField14 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 6, ScreenId = PackageTypeGeneralTabScreenScreen0.Id,ScreenCode = PackageTypeGeneralTabScreenScreen0.Code, ObjectFieldCode = "PackageType.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen PackageTypeHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PackageType.HeaderScreen", Name = "Header Screen", ObjectTableId = PackageTypeObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField PackageTypePackageTypeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = PackageTypeHeaderScreenScreen1.Id,ScreenCode = PackageTypeHeaderScreenScreen1.Code, ObjectFieldCode = "PackageType.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = PackageTypeHeaderScreenScreen1.Id,ScreenCode = PackageTypeHeaderScreenScreen1.Code, ObjectFieldCode = "PackageType.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField PackageTypePackageTypeHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = PackageTypeHeaderScreenScreen1.Id,ScreenCode = PackageTypeHeaderScreenScreen1.Code, ObjectFieldCode = "PackageType.AddedManually", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode PackageTypeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PackageType.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = PackageTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode PackageTypeEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PackageType.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = PackageTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
