...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "4a043ff28fd2cdbc956c87bb494a07e3";
	    ...
	    public void FillPaymentTermDateType()
        { 
            var repo = new PaymentTermDateTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                PaymentTermDateType,
                                Logitude.BL.CommonDataModel.PaymentTermDateTypeDetails,
                                PaymentTermDateTypeRepository>(repo, dic);
        }
