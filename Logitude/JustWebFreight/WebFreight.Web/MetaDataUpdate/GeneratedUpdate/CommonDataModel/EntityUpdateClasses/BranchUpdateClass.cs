   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn BranchesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BranchesQuery.Id,QueryCode = BranchesQuery.Code, IndexOrder = 0, ObjectFieldId = BranchObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == BranchObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BranchObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == BranchObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn BranchesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BranchesQuery.Id,QueryCode = BranchesQuery.Code, IndexOrder = 1, ObjectFieldId = BranchObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == BranchObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BranchObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == BranchObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn BranchesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = BranchesQuery.Id,QueryCode = BranchesQuery.Code, IndexOrder = 2, ObjectFieldId = BranchObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == BranchObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = BranchObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == BranchObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
