   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> UsoCFDIObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "UsoCFDI").ToList();
	         ...
	         Screen UsoCFDIUsoCFDIHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "UsoCFDI.HeaderScreen", Name = "UsoCFDIHeaderScreen", ObjectTableId = UsoCFDIObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
        ...
        { 
            var repo = new UsoCFDIRepository(contextTenant);
