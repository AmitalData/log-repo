   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AddressTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AddressType").ToList();
	         ...
	         Screen AddressTypeAddressTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AddressType.HeaderScreen", Name = "AddressTypeHeaderScreen", ObjectTableId = AddressTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
        ...
        { 
            var repo = new AddressTypeRepository(contextTenant);
