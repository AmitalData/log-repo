...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "71138f8593d660b425329c267012d36c";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "BankBranch",
					  						...
					  						FullLocalDefaultTextBack_up =  "מספר סניף",
					  						FullLocalDefaultText =  "BS64:Itee16HXpNeoINeh16DXmdejIg==",
					  						ListFieldLable =  "BankBranchListLable",
					  						ListLableDefaultText =  "BankBranch",
					  						ListLocalDefaultTextBack_up =  "מספר סניף",
					  						ListLocalDefaultText =  "BS64:Itee16HXpNeoINeh16DXmdejIg==",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "BankCodeId",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "BankCodeId",
					  						ListPropertyPath =  "BankCodeId",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "BankCodeId",
					  						DefaultText =  "Bank Code",
					  						ListFieldLable =  "BankCodeIdListLable",
					  						ListLableDefaultText =  "Bank Code",
					  						ListLocalDefaultTextBack_up =  "קוד בנק",
					  						ListLocalDefaultText =  "BS64:Iten15XXkyDXkdeg16ci",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CardTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Card.Q.CToolPartners", DefaultText = @"CTool Partners",LocalDefaultText = null, ObjectTableId = CardObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   ...
			   TextCode CardTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Card.Q.AllCards", DefaultText = @"All Cards",LocalDefaultText = "BS64:Iteb15wg15TXm9eo15jXmdeh15nXnSI=", ObjectTableId = CardObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CardFeature_1 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Card.Q.AllCards", ObjectTableId = CardObjectTable.Id, Tenant = 0, NameTextCodeCode = "CardFeatures.AllCards", NameTextCodeDefaultText = "All Cards", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CardObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CToolPartnersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Card.SharedLogisticsInvitationStatusName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Card.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Card.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Card.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Card.PartnerTypeName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);
             ...
             AdvancedQueryFilter CToolPartnersQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Card.PartnerTypeId", PredefinedValue = "CS",PredefinedValue2 = null, CustomPredefined = false, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, Tenant = 0,Operator = "NotEqual"}, addedQueryFilters,contextTenant);
			  ...
			  Query AllCardsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CardTextCode_1.Id, NameTextCodeCode = CardTextCode_1.Code, ObjectTableName = "Card", Code = "All Cards",  QueryGroupCode = "1561", IndexOrder = 1, Tenant = 0, ObjectTableId = CardObjectTable.Id, QuerySection = "Card", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CardFeature_1.Id,FeatureUniqeCode= CardFeature_1.FeatureUniqeCode, DefaultSortName = "EnglishName", DefaultSortDirection = "Desending", Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllCardsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCardsQuery.Id,QueryCode = AllCardsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Card.Code" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCardsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCardsQuery.Id,QueryCode = AllCardsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Card.EnglishName" , ColumnWidth = 250 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCardsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCardsQuery.Id,QueryCode = AllCardsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Card.CityName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCardsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCardsQuery.Id,QueryCode = AllCardsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Card.CountryName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter AllCardsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Card.PartnerTypeId", PredefinedValue = "CO",PredefinedValue2 = null, CustomPredefined = false, QueryId = AllCardsQuery.Id,QueryCode = AllCardsQuery.UniqueCode, Tenant = 0,Operator = "NotEqual"}, addedQueryFilters,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CardObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Card").ToList();
	         ...
	         Screen CardCardHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Card.HeaderScreen", Name = "CardHeaderScreen", ObjectTableId = CardObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
