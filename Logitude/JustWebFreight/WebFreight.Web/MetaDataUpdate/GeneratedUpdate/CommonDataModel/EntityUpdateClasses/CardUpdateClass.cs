   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CardTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Card.Q.AllCards", DefaultText = @"All Cards",LocalDefaultText = "כל הכרטיסים", ObjectTableId = CardObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes);
	        ...
	        //FeaturesRepository.SubmitChanges();    
             ...
             AdvancedQueryFilter CToolPartnersQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Card.PartnerTypeId", PredefinedValue = "CS",PredefinedValue2 = null, CustomPredefined = false, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, Tenant = 0,Operator = "NotEqual"}, addedQueryFilters);
			  ...
			  Query AllCardsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = CardTextCode_1.Id, NameTextCodeCode = CardTextCode_1.Code, ObjectTableName = "Card", Code = "All Cards",  QueryGroupCode = "1561", IndexOrder = 1, Tenant = 0, ObjectTableId = CardObjectTable.Id, QuerySection = "Card", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CardFeature_1.Id,FeatureUniqeCode= CardFeature_1.FeatureUniqeCode, DefaultSortName = "EnglishName", DefaultSortDirection = "Desending", Perspective = null }, addedQueries);
	
			 QueryColumn AllCardsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCardsQuery.Id,QueryCode = AllCardsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Card.Code" , ColumnWidth = 150 }, addedQueryColumns);
