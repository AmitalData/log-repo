   ...
   {  
	    ...
	    {   
		   ...
		   List<ObjectField> WarehouseObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Warehouse").ToList();
            ...
            ScreenField WarehouseWarehouseBillingTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = WarehouseObjectFields.Where(d => d.FieldName == "EnableConsolidationInvoices").FirstOrDefault().Id, ScreenId = WarehouseBillingTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
