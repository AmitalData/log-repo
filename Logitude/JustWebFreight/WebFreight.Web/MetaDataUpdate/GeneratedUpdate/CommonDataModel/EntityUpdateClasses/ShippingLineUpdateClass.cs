   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ShippinglinesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 1, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 2, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 3, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "ShippingAgentEnglishName" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "ShippingAgentEnglishName" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 4, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "ReceivablesAccountingCard" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 5, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 6, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 7, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "OurCreditNumber" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "OurCreditNumber" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 8, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "VatNumber" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn ShippinglinesQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.Code, IndexOrder = 9, ObjectFieldId = ShippingLineObjectFields.Where(d => d.FieldName == "Remark" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ShippingLineObjectFields.Where(d => d.FieldName == "Remark" && d.ObjectTableId == ShippingLineObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
