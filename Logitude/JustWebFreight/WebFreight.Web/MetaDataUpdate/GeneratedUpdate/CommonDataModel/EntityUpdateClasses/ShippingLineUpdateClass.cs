   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ShippingLineTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.Q.ShippingLines", DefaultText = @"Shipping Lines",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature ShippingLineFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "SHIPPINGLINE", ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ShippingLine.Features.Shippinglines", NameTextCodeDefaultText = "Shipping lines", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,ShippingLineObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ShippinglinesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "ShippingLine.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "ShippingLine.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "ShippingLine.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "ShippingLine.ShippingAgentEnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "ShippingLine.ReceivablesAccountingCard" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "ShippingLine.AddedManually" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "ShippingLine.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "ShippingLine.OurCreditNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "ShippingLine.VatNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ShippinglinesQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ShippinglinesQuery.Id,QueryCode = ShippinglinesQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "ShippingLine.Remark" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ShippingLineObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ShippingLine").ToList();
	         ...
	         Screen ShippingLineGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ShippingLine.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = ShippingLineObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 10, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.SCACCode", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.CBSA", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.CAAT", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.ShippingAgentId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 7, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.Website", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 8, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineGeneralTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 9, ScreenId = ShippingLineGeneralTabScreenScreen0.Id,ScreenCode = ShippingLineGeneralTabScreenScreen0.Code, ObjectFieldCode = "ShippingLine.Remark", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen ShippingLineHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ShippingLine.HeaderScreen", Name = "Header Screen", ObjectTableId = ShippingLineObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
		    ...
		    ShippingLineObjectTable.HeaderScreenCode = ShippingLineHeaderScreenScreen1.Code;
	         ...
	         Screen ShippingLineAccountingTabScreenScreen3 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ShippingLine.AccountingTabScreen", Name = "Accounting Tab Screen", ObjectTableId = ShippingLineObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField ShippingLineShippingLineAccountingTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ShippingLineAccountingTabScreenScreen3.Id,ScreenCode = ShippingLineAccountingTabScreenScreen3.Code, ObjectFieldCode = "ShippingLine.ReceivablesAccountingCard", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ShippingLineShippingLineAccountingTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = ShippingLineAccountingTabScreenScreen3.Id,ScreenCode = ShippingLineAccountingTabScreenScreen3.Code, ObjectFieldCode = "ShippingLine.PayablesAccountingCard", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode ShippingLineGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature ShippingLineGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ShippingLine.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,ShippingLineObjectTable,contextTenant);
 
                 
			   TextCode ShippingLineBillingTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Billing", DefaultText = "Billing",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineAccountingTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Accounting", DefaultText = "Accounting",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineINTTRATextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.INTTRA", DefaultText = "INTTRA",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineAddressesTextCode_TH4 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Addresses", DefaultText = "Addresses",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineContactsTextCode_TH5 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Contacts", DefaultText = "Contacts",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineAreasTextCode_TH6 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Areas", DefaultText = "Areas",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature ShippingLineAreasFeature_TH6 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ShippingLine.Tab.Areas", ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, NameTextCodeCode = "ShippingLineFeatures.SLAR", NameTextCodeDefaultText = "Areas", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,ShippingLineObjectTable,contextTenant);
 
                 
			   TextCode ShippingLineTariffTranslationsTextCode_TH7 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.TariffTranslations", DefaultText = "Tariff Translations",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineServiceLinesTextCode_TH8 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.ServiceLines", DefaultText = "Service Lines",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineTariffsTextCode_TH9 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Tariffs", DefaultText = "Tariffs",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineDocsInTextCode_TH10 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.DocsIn", DefaultText = "Docs In",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ShippingLineEventsTextCode_TH11 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ShippingLine.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = ShippingLineObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
