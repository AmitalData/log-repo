   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> RankObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Rank").ToList();
	         ...
	         Screen RankRankHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Rank.HeaderScreen", Name = "RankHeaderScreen", ObjectTableId = RankObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
