   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> TarrifChargeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "TarrifCharge").ToList();
	         ...
	         Screen TarrifChargeTarrifChargeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TarrifCharge.HeaderScreen", Name = "TarrifChargeHeaderScreen", ObjectTableId = TarrifChargeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
