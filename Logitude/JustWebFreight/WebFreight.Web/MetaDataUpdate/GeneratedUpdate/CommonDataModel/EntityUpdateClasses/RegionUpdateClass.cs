   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode RegionTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Region.Q.AllRegions", DefaultText = @"All Regions",LocalDefaultText = "All Regions", ObjectTableId = RegionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllRegionsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = RegionTextCode_0.Id, NameTextCodeCode = RegionTextCode_0.Code, ObjectTableName = "Region", Code = "All Regions",  QueryGroupCode = "RGQG", IndexOrder = 0, Tenant = 0, ObjectTableId = RegionObjectTable.Id, QuerySection = "Region", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = RegionFeature_0.Id,FeatureUniqeCode= RegionFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn AllRegionsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRegionsQuery.Id,QueryCode = AllRegionsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Region.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllRegionsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllRegionsQuery.Id,QueryCode = AllRegionsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Region.LocalName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> RegionObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Region").ToList();
	         ...
	         Screen RegionHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Region.HeaderScreen", Name = "Header Screen", ObjectTableId = RegionObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField RegionRegionHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = RegionHeaderScreenScreen0.Id,ScreenCode = RegionHeaderScreenScreen0.Code, ObjectFieldCode = "Region.Name", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    RegionObjectTable.HeaderScreenCode = RegionHeaderScreenScreen0.Code;
	         ...
	         Screen RegionGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Region.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = RegionObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 3, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField RegionRegionGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = RegionGeneralTabScreenScreen1.Id,ScreenCode = RegionGeneralTabScreenScreen1.Code, ObjectFieldCode = "Region.Name", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField RegionRegionGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = RegionGeneralTabScreenScreen1.Id,ScreenCode = RegionGeneralTabScreenScreen1.Code, ObjectFieldCode = "Region.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField RegionRegionGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = RegionGeneralTabScreenScreen1.Id,ScreenCode = RegionGeneralTabScreenScreen1.Code, ObjectFieldCode = "Region.InActive", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode RegionGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Region.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = RegionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode RegionEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Region.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = RegionObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
