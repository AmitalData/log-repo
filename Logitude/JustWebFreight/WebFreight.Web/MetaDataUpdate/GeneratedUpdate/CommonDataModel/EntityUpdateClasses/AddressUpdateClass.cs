...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>AUTO GENERATED BY CONFLICT EXTENSION>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> vladi_amital_main_tenant_zero_fix
...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "5dd471cf0e7e6d24834f5e3a5a69b7f8";
	    ...
	    {  
 		   ...
 		   TextCode AddressTextCode_AddressBNewAddress = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Address.B.NewAddress", DefaultText = "New Address",LocalDefaultText = @"BS64:Iteb16rXldeR16og15fXk9ep15Qi", ObjectTableId = AddressObjectTable.Id, Tenant = 0, TextCodeTypeCode = "B", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode AddressTextCode_AddressOAddAddress = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Address.O.AddAddress", DefaultText = "Add Address",LocalDefaultText = @"BS64:IteU15XXodejINeb16rXldeR16oi", ObjectTableId = AddressObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode AddressTextCode_AddressOEditAddress = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Address.O.EditAddress", DefaultText = "Edit Address",LocalDefaultText = @"BS64:Itec16LXqNeV15og15DXqiDXlNeb16rXldeR16oi", ObjectTableId = AddressObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);

 		   TextCode AddressTextCode_AddressOAddresses = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Address.O.Addresses", DefaultText = "Addresses",LocalDefaultText = @"BS64:Iteb16rXldeR15XXqiI=", ObjectTableId = AddressObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes);
