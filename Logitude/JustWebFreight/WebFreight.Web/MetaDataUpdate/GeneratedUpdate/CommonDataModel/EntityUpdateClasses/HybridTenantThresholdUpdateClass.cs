...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {  
		   ...
		   Feature HybridTenantThresholdFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = HybridTenantThresholdObjectTable.Id, Tenant = 0, NameTextCodeCode = "HybridTenantThreshold.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);
		   Feature HybridTenantThresholdFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = HybridTenantThresholdObjectTable.Id, Tenant = 0, NameTextCodeCode = "HybridTenantThreshold.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);
		   Feature HybridTenantThresholdFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = HybridTenantThresholdObjectTable.Id, Tenant = 0, NameTextCodeCode = "HybridTenantThreshold.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);
		   Feature HybridTenantThresholdFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", ObjectTableId = HybridTenantThresholdObjectTable.Id, Tenant = 0, NameTextCodeCode = "HybridTenantThreshold.Features.PackageFeature", NameTextCodeDefaultText = "HybridTenantThreshold Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes);    
