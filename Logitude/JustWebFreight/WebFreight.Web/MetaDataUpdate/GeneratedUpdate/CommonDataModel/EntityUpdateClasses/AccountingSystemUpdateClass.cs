...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "d9a5d997644939736e6e486ff80cb570";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AllowPositiveAmountsCreditNote",
					  						ObjectTableName =  "AccountingSystem",
					  						FieldsDataType =  "Boolean",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "AllowPositiveAmountsCreditNote",
					  						ListPropertyPath =  "AllowPositiveAmountsCreditNote",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						IsRestrictable =  false,
					  						DisplayInEntityVariables =  true,
					  						Code =  "AllowPositiveAmountsCreditNote",
					  						AllowedInCustomerFieldsSetting =  false,
					  						DisplayInSearchWindowFilters =  false,
					  						DisplayInSearchWindowFilterInx =  0,
					  						DisplayInDocumentReferences =  false,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "AllowPositiveAmountsCreditNote",
					  						DefaultText =  "Allow Positive Amounts in Credit Note",
					  						ListFieldLable =  "AllowPositiveAmountsCreditNoteListLable",
					  						...
					  						HasTemplate =  false,
					  						IsCustom =  false,
					  						HelpTextCode =  "AllowPositiveAmountsCreditNote",
					  						EnableFullscreenTextBox =  false,
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllAccountingSystemsQueryColumn_13 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.UniqueCode, IndexOrder = 13, ObjectFieldCode = "AccountingSystem.AllowPositiveAmountsCreditNote" , ColumnWidth = 150 }, addedQueryColumns);
