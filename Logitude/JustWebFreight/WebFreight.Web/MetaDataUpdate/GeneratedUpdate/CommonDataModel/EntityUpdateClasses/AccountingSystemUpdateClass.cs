   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllAccountingSystemsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AccountingSystemTextCode_0.Id, NameTextCodeCode = AccountingSystemTextCode_0.Code, Code = "All Accounting Systems",  QueryGroupCode = "ACCS", IndexOrder = 0, Tenant = 0, ObjectTableId = AccountingSystemObjectTable.Id, QuerySection = "AccountingSystem", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AccountingSystemFeature_0.Id, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllAccountingSystemsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 0, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 1, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 2, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsExternalCodesFromTable" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsExternalCodesFromTable" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 3, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsExternalCodesSyncEnabled" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsExternalCodesSyncEnabled" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 4, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsSingleTaxPerInvoice" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsSingleTaxPerInvoice" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 5, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsSingleCurrencyAccount" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsSingleCurrencyAccount" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 6, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowManuallyDueDate" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowManuallyDueDate" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 7, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsJournalMode" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsJournalMode" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 8, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsTaxItemManaged" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsTaxItemManaged" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 9, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowMinusInvoiceLines" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowMinusInvoiceLines" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 10, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "ShowDownloadScreen" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "ShowDownloadScreen" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 11, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowARInvoicesTransfer" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowARInvoicesTransfer" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 12, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowAPInvoicesTransfer" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowAPInvoicesTransfer" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_13 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 13, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowPositiveAmountsInTheCreditNote" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "AllowPositiveAmountsInTheCreditNote" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_14 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 14, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingSystemsQueryColumn_15 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingSystemsQuery.Id,QueryCode = AllAccountingSystemsQuery.Code, IndexOrder = 15, ObjectFieldId = AccountingSystemObjectFields.Where(d => d.FieldName == "IsExternalCodesFromAPI" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingSystemObjectFields.Where(d => d.FieldName == "IsExternalCodesFromAPI" && d.ObjectTableId == AccountingSystemObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
