   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllComputingPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllComputingPartnersQuery.Id, IndexOrder = 2, ObjectFieldId = ComputingPartnerObjectFields.Where(d => d.FieldName == "UpdatedByUserName" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ComputingPartnerObjectFields.Where(d => d.FieldName == "UpdatedByUserName" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 350 }, queryColumnsRepository, tenantQueryColumns);
