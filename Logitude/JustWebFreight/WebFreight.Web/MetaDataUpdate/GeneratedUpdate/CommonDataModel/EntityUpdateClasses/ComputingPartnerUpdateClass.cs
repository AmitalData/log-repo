   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllComputingPartnersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllComputingPartnersQuery.Id,QueryCode = AllComputingPartnersQuery.Code, IndexOrder = 0, ObjectFieldId = ComputingPartnerObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ComputingPartnerObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 200 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllComputingPartnersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllComputingPartnersQuery.Id,QueryCode = AllComputingPartnersQuery.Code, IndexOrder = 1, ObjectFieldId = ComputingPartnerObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ComputingPartnerObjectFields.Where(d => d.FieldName == "CreatedByUserName" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 350 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllComputingPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllComputingPartnersQuery.Id,QueryCode = AllComputingPartnersQuery.Code, IndexOrder = 2, ObjectFieldId = ComputingPartnerObjectFields.Where(d => d.FieldName == "UpdatedByUserName" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ComputingPartnerObjectFields.Where(d => d.FieldName == "UpdatedByUserName" && d.ObjectTableId == ComputingPartnerObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 350 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CPGN",HtmlComponentName = "",HtmlComponentUrl = "./InfrastructureModules/InfrastructureComputingPartner/Components/ComputingPartnerGeneralTabComponent", FeatureId = ComputingPartnerGeneralFeature_TH0.Id, ControlPath = "Simplog.Infrastructure.Views.ComputingPartners.ComputingPartnerGeneralTabControl", ObjectTableId = ComputingPartnerObjectTable.Id, TabNameTextCodeId = ComputingPartnerGeneralTextCode_TH0.Id, TabNameTextCodeCode = ComputingPartnerGeneralTextCode_TH0.Code, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "CPEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = ComputingPartnerEventsFeature_TH1.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = ComputingPartnerObjectTable.Id, TabNameTextCodeId = ComputingPartnerEventsTextCode_TH1.Id, TabNameTextCodeCode = ComputingPartnerEventsTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
