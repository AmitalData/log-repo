   ...
   {  		
	    ...
	    {  
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn ExternalLinkQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalLinkQuery.Id,QueryCode = ExternalLinkQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "ExternalLink.Ref" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ExternalLinkQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalLinkQuery.Id,QueryCode = ExternalLinkQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "ExternalLink.ExpirationDate" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

			 QueryColumn ExternalLinkQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalLinkQuery.Id,QueryCode = ExternalLinkQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "ExternalLink.ActivityLog" , ColumnWidth = 50 }, addedQueryColumns,contextTenant);

			 QueryColumn ExternalLinkQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ExternalLinkQuery.Id,QueryCode = ExternalLinkQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "ExternalLink.Params" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {                
			   ...
			   TextCode ExternalLinkEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ExternalLink.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = ExternalLinkObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
