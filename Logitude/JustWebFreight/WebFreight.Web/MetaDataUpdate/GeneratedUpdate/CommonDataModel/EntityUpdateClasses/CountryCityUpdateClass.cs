   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CountryCitiesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.UniqueCode, IndexOrder = 0, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 70 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.UniqueCode, IndexOrder = 1, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.UniqueCode, IndexOrder = 2, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.UniqueCode, IndexOrder = 3, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "CountryEnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "CountryEnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 350 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.UniqueCode, IndexOrder = 4, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.UniqueCode, IndexOrder = 5, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> CountryCityObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CountryCity").ToList();
            ...
            ScreenField CountryCityCountryCityGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = CountryCityGeneralTabScreenScreen0.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CountryCityCountryCityGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = CountryCityGeneralTabScreenScreen0.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CountryCityCountryCityGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = CountryCityGeneralTabScreenScreen0.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CountryCityCountryCityGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "CountryId").FirstOrDefault().Id, ScreenId = CountryCityGeneralTabScreenScreen0.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "CountryId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CountryCityCountryCityGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "InActive").FirstOrDefault().Id, ScreenId = CountryCityGeneralTabScreenScreen0.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "InActive").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CountryCityCountryCityGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "Notes").FirstOrDefault().Id, ScreenId = CountryCityGeneralTabScreenScreen0.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "Notes").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
            ...
            ScreenField CountryCityCountryCityHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = CountryCityHeaderScreenScreen1.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CountryCityCountryCityHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "AddedManually").FirstOrDefault().Id, ScreenId = CountryCityHeaderScreenScreen1.Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "AddedManually").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
