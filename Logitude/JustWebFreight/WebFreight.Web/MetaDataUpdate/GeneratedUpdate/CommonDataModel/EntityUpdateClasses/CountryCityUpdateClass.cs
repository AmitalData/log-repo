   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn CountryCitiesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.Code, IndexOrder = 1, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.Code, IndexOrder = 2, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.Code, IndexOrder = 3, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "CountryEnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "CountryEnglishName" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 350 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.Code, IndexOrder = 4, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CountryCitiesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CountryCitiesQuery.Id,QueryCode = CountryCitiesQuery.Code, IndexOrder = 5, ObjectFieldId = CountryCityObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CountryCityObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == CountryCityObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
