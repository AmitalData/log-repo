...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "ce3a198070464744cb4ce9d933ac4460";
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PayableDebitAccount",
					  						...
					  						FullLocalDefaultTextBack_up =  "חשבון נגדי לקליטת הוצאות",
					  						FullLocalDefaultText =  "BS64:IteX16nXkdeV158g16DXkteT15kg15zXp9ec15nXmNeqINeU15XXpteQ15XXqiI=",
					  						ListFieldLable =  "PayableDebitAccountListLable",
					  						ListLableDefaultText =  "Payable Debit Account",
					  						ListLocalDefaultTextBack_up =  "חשבון נגדי לקליטת הוצאות",
					  						ListLocalDefaultText =  "BS64:IteX16nXkdeV158g16DXkteT15kg15zXp9ec15nXmNeqINeU15XXpteQ15XXqiI=",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ReceivableCreditAccount",
					  						...
					  						FullLocalDefaultTextBack_up =  "חשבון נגדי לרישום הכנסות",
					  						FullLocalDefaultText =  "BS64:IteX16nXkdeV158g16DXkteT15kg15zXqNeZ16nXldedINeU15vXoNeh15XXqiI=",
					  						ListFieldLable =  "ReceivableCreditAccountListLable",
					  						ListLableDefaultText =  "Receivable Credit Account",
					  						ListLocalDefaultTextBack_up =  "חשבון נגדי לרישום הכנסות",
					  						ListLocalDefaultText =  "BS64:IteX16nXkdeV158g16DXkteT15kg15zXqNeZ16nXldedINeU15vXoNeh15XXqiI=",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ReceivablesChargesTypeExternalCode",
					  						ShortName =  "ReceivablesChargesTypeExtCode",
					  						ObjectTableName =  "ChargesType",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  25,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PayablesChargesTypeExternalCode",
					  						ShortName =  "PayablesChargesTypeExtCode",
					  						ObjectTableName =  "ChargesType",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  25,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ViewOrder",
					  						...
					  						FullLocalDefaultTextBack_up =  "סדר תצוגה בחשבונית",
					  						FullLocalDefaultText =  "BS64:Iteh15PXqCDXqtem15XXkteUINeR15fXqdeR15XXoNeZ16oi",
					  						ListFieldLable =  "ViewOrderListLable",
					  						ListLableDefaultText =  "View Order",
					  						ListLocalDefaultTextBack_up =  "סדר תצוגה בחשבונית",
					  						ListLocalDefaultText =  "BS64:Iteh15PXqCDXqtem15XXkteUINeR15fXqdeR15XXoNeZ16oi",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						FullLocalDefaultTextBack_up =  "חיפוש קודים/ שמות",
					  						FullLocalDefaultText =  "BS64:IteX15nXpNeV16kg16fXldeT15nXnS8g16nXnteV16oi",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "VatTypeId",
					  						...
					  						ListLocalDefaultText =  "BS64:Iteh15XXkiDXnteiIteeIg==",
					  						IsForeignKey =  true,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ChargesGroupCode",
					  						...
					  						FullLocalDefaultTextBack_up =  "קוד קבוצה",
					  						FullLocalDefaultText =  "BS64:Iten15XXkyDXp9eR15XXpteUIg==",
					  						ListFieldLable =  "ChargesGroupCodeListLable",
					  						ListLableDefaultText =  "Group Code",
					  						ListLocalDefaultTextBack_up =  "קוד קבוצה",
					  						ListLocalDefaultText =  "BS64:Iten15XXkyDXp9eR15XXpteUIg==",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsReceivable",
					  						...
					  						FullLocalDefaultTextBack_up =  "לשימוש בחשבוניות לקוח",
					  						FullLocalDefaultText =  "BS64:Itec16nXmdee15XXqSDXkdeX16nXkdeV16DXmdeV16og15zXp9eV15ci",
					  						ListFieldLable =  "IsReceivableListLable",
					  						ListLableDefaultText =  "Receivable",
					  						ListLocalDefaultTextBack_up =  "לשימוש בחשבוניות לקוח",
					  						ListLocalDefaultText =  "BS64:Itec16nXmdee15XXqSDXkdeX16nXkdeV16DXmdeV16og15zXp9eV15ci",
					  						ShortFieldLable =  "IsReceivable",
					  						ShortFieldLableDefaultText =  "For use in ARInvoice",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsPayable",
					  						...
					  						FullLocalDefaultTextBack_up =  "לשימוש בחשבוניות ספק",
					  						FullLocalDefaultText =  "BS64:Itec16nXmdee15XXqSDXkdeX16nXkdeV16DXmdeV16og16HXpNenIg==",
					  						ListFieldLable =  "IsPayableListLable",
					  						ListLableDefaultText =  "Payable",
					  						ListLocalDefaultTextBack_up =  "לשימוש בחשבוניות ספק",
					  						ListLocalDefaultText =  "BS64:Itec16nXmdee15XXqSDXkdeX16nXkdeV16DXmdeV16og16HXpNenIg==",
					  						ShortFieldLable =  "IsPayable",
					  						ShortFieldLableDefaultText =  "For use in APInvoice",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "IsExpense",
					  						...
					  						FullLocalDefaultTextBack_up =  "סוג הוצאות\\לא מדווח בדוח מעמ 874",
					  						FullLocalDefaultText =  "BS64:Iteh15XXkiDXlNeV16bXkNeV16pc15zXkCDXnteT15XXldeXINeR15PXldeXINee16LXniA4NzQi",
					  						ListFieldLable =  "IsExpenseListLable",
					  						ListLableDefaultText =  "Expense Charge",
					  						ListLocalDefaultTextBack_up =  "סוג הוצאות\\לא מדווח בדוח מעמ 874",
					  						ListLocalDefaultText =  "BS64:Iteh15XXkiDXlNeV16bXkNeV16pc15zXkCDXnteT15XXldeXINeR15PXldeXINee16LXniA4NzQi",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "RecCreditGLAcountLocalName",
					  						...
					  						FullLocalDefaultTextBack_up =  "שם כרטיס הכנסות",
					  						FullLocalDefaultText =  "BS64:Itep150g15vXqNeY15nXoSDXlNeb16DXodeV16oi",
					  						ListFieldLable =  "RecCreditGLAcountLocalNameListLable",
					  						ListLableDefaultText =  "Receivable Credit GLAcount Local Name",
					  						ListLocalDefaultTextBack_up =  "שם כרטיס הכנסות",
					  						ListLocalDefaultText =  "BS64:Itep150g15vXqNeY15nXoSDXlNeb16DXodeV16oi",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PayDebitGLAcountLocalName",
					  						...
					  						FullLocalDefaultTextBack_up =  "שם כרטיס הוצאות",
					  						FullLocalDefaultText =  "BS64:Itep150g15vXqNeY15nXoSDXlNeV16bXkNeV16oi",
					  						ListFieldLable =  "PayDebitGLAcountLocalNameListLable",
					  						ListLableDefaultText =  "Payable Debit GLAcount Local Name",
					  						ListLocalDefaultTextBack_up =  "שם כרטיס הוצאות",
					  						ListLocalDefaultText =  "BS64:Itep150g15vXqNeY15nXoSDXlNeV16bXkNeV16oi",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ChargesTypeTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.Q.ChargesTypes", DefaultText = @"Charges Types",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query ChargestypesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ChargesTypeTextCode_0.Id, NameTextCodeCode = ChargesTypeTextCode_0.Code, ObjectTableName = "ChargesType", Code = "Charges types",  QueryGroupCode = "CHTP", IndexOrder = 0, Tenant = 0, ObjectTableId = ChargesTypeObjectTable.Id, QuerySection = "ChargesType", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = ChargesTypeFeature_0.Id,FeatureUniqeCode= ChargesTypeFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ChargestypesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "ChargesType.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ChargestypesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "ChargesType.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ChargestypesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "ChargesType.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ChargestypesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "ChargesType.MeasurementCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ChargestypesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "ChargesType.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ChargestypesQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "ChargesType.AddedManually" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ChargestypesQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ChargestypesQuery.Id,QueryCode = ChargestypesQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "ChargesType.ViewOrder" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ChargesTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ChargesType").ToList();
	         ...
	         Screen ChargesTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ChargesType.HeaderScreen", Name = "Header Screen", ObjectTableId = ChargesTypeObjectTable.Id, NumberOfColumns = 3, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField ChargesTypeChargesTypeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ChargesTypeHeaderScreenScreen0.Id,ScreenCode = ChargesTypeHeaderScreenScreen0.Code, ObjectFieldCode = "ChargesType.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ChargesTypeChargesTypeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = ChargesTypeHeaderScreenScreen0.Id,ScreenCode = ChargesTypeHeaderScreenScreen0.Code, ObjectFieldCode = "ChargesType.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
		    ...
		    ChargesTypeObjectTable.HeaderScreenCode = ChargesTypeHeaderScreenScreen0.Code;
	         ...
	         Screen ChargesTypeGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "ChargesType.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = ChargesTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode ChargesTypeGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.TH.EditChargesType", DefaultText = "General",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature ChargesTypeGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "GENERAL", ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "ChargesType.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,ChargesTypeObjectTable,contextTenant);
 
                 
			   TextCode ChargesTypeAccountingTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.TH.Accounting", DefaultText = "Accounting",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ChargesTypeQuotationsTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.TH.Quotations", DefaultText = "Quotations",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ChargesTypeEventsTextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode ChargesTypeTextCode_ChargesTypeOTransport = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.Transport", DefaultText = "Transport",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ChargesTypeTextCode_ChargesTypeOUsedIn = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.UsedIn", DefaultText = "This charge type is used in",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ChargesTypeTextCode_ChargesTypeOAutoDisplay = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.AutoDisplay", DefaultText = "Auto Display",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ChargesTypeTextCode_ChargesTypeOAWBSettings = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.AWBSettings", DefaultText = "AWB settings",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ChargesTypeTextCode_ChargesTypeOBilling = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.Billing", DefaultText = "Billing",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ChargesTypeTextCode_ChargesTypeOUsedInRP = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.UsedInRP", DefaultText = "Used In",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ChargesTypeTextCode_ChargesTypeOActiveIn = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.ActiveIn", DefaultText = "Active in",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
 		   ...
 		   TextCode ChargesTypeTextCode_ChargesTypeODirection = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.Direction", DefaultText = "Direction",LocalDefaultText = null, ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ChargesTypeTextCode_ChargesTypeONewChargeType = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ChargesType.O.NewChargeType", DefaultText = "New Charge Type",LocalDefaultText = @"BS64:Iteh16LXmdejINeX15nXldeRINeX15PXqSI=", ObjectTableId = ChargesTypeObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
