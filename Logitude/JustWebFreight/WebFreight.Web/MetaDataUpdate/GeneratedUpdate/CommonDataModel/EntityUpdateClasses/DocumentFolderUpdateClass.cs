   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn DocumentFoldersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.Code, IndexOrder = 0, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DocumentFoldersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.Code, IndexOrder = 1, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "EnglishName" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DocumentFoldersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.Code, IndexOrder = 2, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "LocalName" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DocumentFoldersQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.Code, IndexOrder = 3, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "IsExternalFolder" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "IsExternalFolder" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn DocumentFoldersQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.Code, IndexOrder = 4, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "ParentFolderId" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "ParentFolderId" && d.ObjectTableId == DocumentFolderObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> DocumentFolderObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "DocumentFolder").ToList();
            ...
            ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().Id, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "LocalName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "ParentFolderId").FirstOrDefault().Id, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "ParentFolderId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = DocumentFolderObjectFields.Where(d => d.FieldName == "IsExternalFolder").FirstOrDefault().Id, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id, ObjectFieldCode = DocumentFolderObjectFields.Where(d => d.FieldName == "IsExternalFolder").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
