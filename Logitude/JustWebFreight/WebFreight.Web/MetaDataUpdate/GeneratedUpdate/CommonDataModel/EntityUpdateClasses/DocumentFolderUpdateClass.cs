   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode DocumentFolderTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "DocumentFolder.Q.DocumentFolders", DefaultText = @"Document Folders",LocalDefaultText = null, ObjectTableId = DocumentFolderObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn DocumentFoldersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "DocumentFolder.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn DocumentFoldersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "DocumentFolder.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn DocumentFoldersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "DocumentFolder.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn DocumentFoldersQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "DocumentFolder.IsExternalFolder" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn DocumentFoldersQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = DocumentFoldersQuery.Id,QueryCode = DocumentFoldersQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "DocumentFolder.ParentFolderId" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> DocumentFolderObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "DocumentFolder").ToList();
	         ...
	         Screen DocumentFolderGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DocumentFolder.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = DocumentFolderObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 4, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id,ScreenCode = DocumentFolderGeneralTabScreenScreen0.Code, ObjectFieldCode = "DocumentFolder.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id,ScreenCode = DocumentFolderGeneralTabScreenScreen0.Code, ObjectFieldCode = "DocumentFolder.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id,ScreenCode = DocumentFolderGeneralTabScreenScreen0.Code, ObjectFieldCode = "DocumentFolder.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id,ScreenCode = DocumentFolderGeneralTabScreenScreen0.Code, ObjectFieldCode = "DocumentFolder.ParentFolderId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField DocumentFolderDocumentFolderGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = DocumentFolderGeneralTabScreenScreen0.Id,ScreenCode = DocumentFolderGeneralTabScreenScreen0.Code, ObjectFieldCode = "DocumentFolder.IsExternalFolder", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	            
	      

	         Screen DocumentFolderHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "DocumentFolder.HeaderScreen", Name = "Header Screen", ObjectTableId = DocumentFolderObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
