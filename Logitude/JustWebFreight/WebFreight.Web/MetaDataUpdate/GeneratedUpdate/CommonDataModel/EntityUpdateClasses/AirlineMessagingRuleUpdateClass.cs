   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> AirlineMessagingRuleObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AirlineMessagingRule").ToList();
	         ...
	         Screen AirlineMessagingRuleAirlineMessagingRuleHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "AirlineMessagingRule.HeaderScreen", Name = "AirlineMessagingRuleHeaderScreen", ObjectTableId = AirlineMessagingRuleObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
