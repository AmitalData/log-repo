   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> VendorObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Vendor").ToList();
	         ...
	         Screen VendorBillingTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Vendor.BillingTabScreen", Name = "Billing Tab Screen", ObjectTableId = VendorObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 7, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
             ...
             ScreenField VendorVendorBillingTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = VendorBillingTabScreenScreen0.Id,ScreenCode = VendorBillingTabScreenScreen0.Code, ObjectFieldCode = "Vendor.IBANNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {  
 		   ...
 		   TextCode VendorTextCode_VendorONewVendor = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Vendor.O.NewVendor", DefaultText = "New Vendor",LocalDefaultText = @"BS64:IteU15XXodejINeh16TXpyI=", ObjectTableId = VendorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
