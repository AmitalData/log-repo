...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "35d8dfe5698f3cf87d74f333bd0adf5e";
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode ParticipantTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.Q.Participants", DefaultText = @"Participants",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query ParticipantsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ParticipantTextCode_0.Id, NameTextCodeCode = ParticipantTextCode_0.Code, ObjectTableName = "Participant", Code = "Participants",  QueryGroupCode = "PPCT", IndexOrder = 0, Tenant = 0, ObjectTableId = ParticipantObjectTable.Id, QuerySection = "Participant", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ParticipantFeature_0.Id,FeatureUniqeCode= ParticipantFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn ParticipantsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Participant.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Participant.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Participant.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Participant.ForwarderTenant" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Participant.TTY" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "Participant.VatNumber" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "Participant.ReceivablesAccountingCard" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "Participant.PaymentTermEnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "Participant.Registered" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "Participant.RegistrationRequested" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "Participant.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn ParticipantsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = ParticipantsQuery.Id,QueryCode = ParticipantsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "Participant.Notes" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> ParticipantObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Participant").ToList();
	         ...
	         Screen ParticipantHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Participant.HeaderScreen", Name = "Header Screen", ObjectTableId = ParticipantObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
		    ...
		    ParticipantObjectTable.HeaderScreenCode = ParticipantHeaderScreenScreen0.Code;
	         ...
	         Screen ParticipantGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Participant.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = ParticipantObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField ParticipantParticipantGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ParticipantGeneralTabScreenScreen1.Id,ScreenCode = ParticipantGeneralTabScreenScreen1.Code, ObjectFieldCode = "Participant.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ScreenId = ParticipantGeneralTabScreenScreen1.Id,ScreenCode = ParticipantGeneralTabScreenScreen1.Code, ObjectFieldCode = "Participant.EnglishName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = ParticipantGeneralTabScreenScreen1.Id,ScreenCode = ParticipantGeneralTabScreenScreen1.Code, ObjectFieldCode = "Participant.LocalName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = ParticipantGeneralTabScreenScreen1.Id,ScreenCode = ParticipantGeneralTabScreenScreen1.Code, ObjectFieldCode = "Participant.TTY", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ScreenId = ParticipantGeneralTabScreenScreen1.Id,ScreenCode = ParticipantGeneralTabScreenScreen1.Code, ObjectFieldCode = "Participant.Website", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = ParticipantGeneralTabScreenScreen1.Id,ScreenCode = ParticipantGeneralTabScreenScreen1.Code, ObjectFieldCode = "Participant.Registered", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	         ...
	         Screen ParticipantBillingTabScreenScreen2 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Participant.BillingTabScreen", Name = "Billing Tab Screen", ObjectTableId = ParticipantObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 5, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField ParticipantParticipantBillingTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.VatNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
             ...
             ScreenField ParticipantParticipantBillingTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.InvoiceCurrencyId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantBillingTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.VatTypeId", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantBillingTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.BankName", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantBillingTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.BankAddress", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantBillingTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.Swift", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	          
             ScreenField ParticipantParticipantBillingTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 3, ScreenId = ParticipantBillingTabScreenScreen2.Id,ScreenCode = ParticipantBillingTabScreenScreen2.Code, ObjectFieldCode = "Participant.AccountNumber", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	         ...
	         Screen ParticipantAdditionalFieldsScreen3 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Participant.AdditionalFields", Name = "Additional Fields", ObjectTableId = ParticipantObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode ParticipantGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ParticipantBillingTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.Billing", DefaultText = "Billing",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ParticipantAccountingTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.Accounting", DefaultText = "Accounting",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ParticipantAddressesTextCode_TH3 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.Addresses", DefaultText = "Addresses",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ParticipantContactsTextCode_TH4 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.Contacts", DefaultText = "Contacts",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ParticipantNotifyTextCode_TH5 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.Notify", DefaultText = "Notify",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode ParticipantDocsInTextCode_TH6 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Participant.TH.DocsIn", DefaultText = "Docs In",LocalDefaultText = null, ObjectTableId = ParticipantObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
