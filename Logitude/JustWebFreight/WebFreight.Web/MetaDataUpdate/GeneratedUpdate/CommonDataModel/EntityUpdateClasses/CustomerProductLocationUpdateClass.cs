...
{
   public class CustomerProductLocationUpdateClass
   {  		
		public const string HashString = "d1ece7b9e8e45f686dc35c9301a17f29";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "CustomerProductLocation",
			      				    ...
			      				    OldDBTableName =  "CustomerProductLocations",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "CustomerProductLocation,CustomerProductLocations,,CustomerId,CustomerId",
			      				    HashString =  CustomerProductLocationUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Tenant",
					  						...
					  						ValidForQuerySection1 =  "CustomerProductLocation",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PotentialChargeableWeight",
					  						OldFieldName =  "PotentialChargeableWeight",
					  						ObjectTableName =  "CustomerProductLocation",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CommitmentChargeableWeight",
					  						OldFieldName =  "CommitmentChargeableWeight",
					  						ObjectTableName =  "CustomerProductLocation",
					  						FieldsDataType =  "Decimal",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "PotentialNumberOfShipments",
					  						OldFieldName =  "PotentialNumberOfShipments",
					  						ObjectTableName =  "CustomerProductLocation",
					  						FieldsDataType =  "Integer",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CommitmentNumberOfShipments",
					  						OldFieldName =  "CommitmentNumberOfShipments",
					  						ObjectTableName =  "CustomerProductLocation",
					  						FieldsDataType =  "Integer",
					  						MinLength =  0,
					  						MaxLength =  0,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CommitmentRevenue",
					  						OldFieldName =  "CommitmentRevenue",
					  						ObjectTableName =  "CustomerProductLocation",
					  						FieldsDataType =  "Decimal",
					  						MinLength =  0,
					  						MaxLength =  0,
	    ...
	    {   
		   ...
		   ObjectTable CustomerProductLocationObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "CustomerProductLocation" && d.Tenant == 0).FirstOrDefault();
		   //List<ObjectField> CustomerProductLocationObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "CustomerProductLocation").ToList();
		       
	      

	         Screen CustomerProductLocationCustomerProductLocationHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "CustomerProductLocation.HeaderScreen", Name = "CustomerProductLocationHeaderScreen", ObjectTableId = CustomerProductLocationObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    CustomerProductLocationObjectTable.HeaderScreenId = CustomerProductLocationCustomerProductLocationHeaderScreenScreen0.Id;
		    CustomerProductLocationObjectTable.HeaderScreenCode = CustomerProductLocationCustomerProductLocationHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomerProductLocationObjectTable.Id,
