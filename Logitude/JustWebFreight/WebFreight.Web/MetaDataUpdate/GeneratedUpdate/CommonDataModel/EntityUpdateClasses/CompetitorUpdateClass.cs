   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllCompetitorsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCompetitorsQuery.Id,QueryCode = AllCompetitorsQuery.Code, IndexOrder = 0, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == CompetitorObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == CompetitorObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllCompetitorsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCompetitorsQuery.Id,QueryCode = AllCompetitorsQuery.Code, IndexOrder = 1, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Website" && d.ObjectTableId == CompetitorObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Website" && d.ObjectTableId == CompetitorObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllCompetitorsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCompetitorsQuery.Id,QueryCode = AllCompetitorsQuery.Code, IndexOrder = 2, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == CompetitorObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "InActive" && d.ObjectTableId == CompetitorObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> CompetitorObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Competitor").ToList();
            ...
            ScreenField CompetitorCompetitorHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = CompetitorHeaderScreenScreen0.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Website").FirstOrDefault().Id, ScreenId = CompetitorHeaderScreenScreen0.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Website").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
            ...
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Website").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Website").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Address1").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Address1").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Address2").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Address2").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Strengths").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Strengths").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField5 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 5, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Opportunity").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Opportunity").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField6 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 6, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "InActive").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "InActive").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField7 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "ZipCode").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "ZipCode").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField8 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 1, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "City").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "City").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField9 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 2, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "CountryId").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "CountryId").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField10 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 4, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Weaknesses").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Weaknesses").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField CompetitorCompetitorGeneralTabScreenScreenField11 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 5, ObjectFieldId = CompetitorObjectFields.Where(d => d.FieldName == "Threat").FirstOrDefault().Id, ScreenId = CompetitorGeneralTabScreenScreen1.Id, ObjectFieldCode = CompetitorObjectFields.Where(d => d.FieldName == "Threat").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
