   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CompetitorTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Competitor.Q.AllCompetitors", DefaultText = @"Competitors",LocalDefaultText = null, ObjectTableId = CompetitorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CompetitorFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "ALLCOMPETITORS", ObjectTableId = CompetitorObjectTable.Id, Tenant = 0, NameTextCodeCode = "Competitor.Features.AllCompetitors", NameTextCodeDefaultText = "All Competitors", FeatureTypeCode = "QUER", Packagable = false }, TenantFeatures, textCodes,CompetitorObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllCompetitorsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCompetitorsQuery.Id,QueryCode = AllCompetitorsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Competitor.Name" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCompetitorsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCompetitorsQuery.Id,QueryCode = AllCompetitorsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Competitor.Website" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AllCompetitorsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllCompetitorsQuery.Id,QueryCode = AllCompetitorsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Competitor.InActive" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CompetitorObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Competitor").ToList();
	         ...
	         Screen CompetitorHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Competitor.HeaderScreen", Name = "Header Screen", ObjectTableId = CompetitorObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
		    ...
		    CompetitorObjectTable.HeaderScreenCode = CompetitorHeaderScreenScreen0.Code;
	         ...
	         Screen CompetitorGeneralTabScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Competitor.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = CompetitorObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 7, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode CompetitorGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Competitor.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = CompetitorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature CompetitorGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Competitor.Tab.General", ObjectTableId = CompetitorObjectTable.Id, Tenant = 0, NameTextCodeCode = "Competitor.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = false }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,CompetitorObjectTable,contextTenant);
 
                 
			   TextCode CompetitorEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Competitor.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = CompetitorObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
