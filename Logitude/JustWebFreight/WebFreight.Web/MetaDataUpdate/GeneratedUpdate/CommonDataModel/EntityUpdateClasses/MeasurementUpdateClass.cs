   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode MeasurementTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Measurement.Q.Measurements", DefaultText = @"Measurements",LocalDefaultText = null, ObjectTableId = MeasurementObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature MeasurementFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Measurement.Q.AllQuery", ObjectTableId = MeasurementObjectTable.Id, Tenant = 0, NameTextCodeCode = "Measurement.Features.AllMeasurements", NameTextCodeDefaultText = "All Measurements", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,MeasurementObjectTable, addedFeatures, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllMeasurementsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMeasurementsQuery.Id,QueryCode = AllMeasurementsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Measurement.Code" , ColumnWidth = 70 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMeasurementsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMeasurementsQuery.Id,QueryCode = AllMeasurementsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Measurement.Name" , ColumnWidth = 350 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMeasurementsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMeasurementsQuery.Id,QueryCode = AllMeasurementsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Measurement.LocalName" , ColumnWidth = 350 }, addedQueryColumns,contextTenant);

			 QueryColumn AllMeasurementsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllMeasurementsQuery.Id,QueryCode = AllMeasurementsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Measurement.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter AllMeasurementsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "Measurement.IsContainer", PredefinedValue = "false",PredefinedValue2 = null, CustomPredefined = false, QueryId = AllMeasurementsQuery.Id,QueryCode = AllMeasurementsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> MeasurementObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Measurement").ToList();
	         ...
	         Screen MeasurementHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "Measurement.HeaderScreen", Name = "Header Screen", ObjectTableId = MeasurementObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      
             ScreenField MeasurementMeasurementHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ScreenId = MeasurementHeaderScreenScreen0.Id,ScreenCode = MeasurementHeaderScreenScreen0.Code, ObjectFieldCode = "Measurement.Code", Tenant = 0, }, screenFieldsRepository, tenantScreenFields,contextTenant);
	    ...
	    {                
			   ...
			   TextCode MeasurementGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Measurement.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = MeasurementObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   Feature MeasurementGeneralFeature_TH0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Measurement.Tab.General", ObjectTableId = MeasurementObjectTable.Id, Tenant = 0, NameTextCodeCode = "Measurement.Features.General", NameTextCodeDefaultText = "General", FeatureTypeCode = "AREA", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, textCodes,MeasurementObjectTable,contextTenant);
 
                 
			   TextCode MeasurementEventsTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Measurement.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = MeasurementObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
