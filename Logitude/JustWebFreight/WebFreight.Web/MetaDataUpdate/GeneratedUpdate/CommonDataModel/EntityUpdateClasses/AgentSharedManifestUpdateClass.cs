   ...
   {  		
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AgentSharedManifestsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "AgentSharedManifest.StatusName" , ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentSharedManifestsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "AgentSharedManifest.TEU" , ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentSharedManifestsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 12, ObjectFieldCode = "AgentSharedManifest.CreateDate" , ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AgentSharedManifestsQueryColumn_13 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 13, ObjectFieldCode = "AgentSharedManifest.UpdateDate" , ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
             ...
             AdvancedQueryFilter OceanAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.TransportModeId", PredefinedValue = "O",PredefinedValue2 = null, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);


             AdvancedQueryFilter OceanAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "WAIT",PredefinedValue2 = null, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
             ...
             AdvancedQueryFilter InlandAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.TransportModeId", PredefinedValue = "I",PredefinedValue2 = null, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);


             AdvancedQueryFilter InlandAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "WAIT",PredefinedValue2 = null, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.UniqueCode, Tenant = 0,Operator = "Equal"}, advancedQueryFiltersRepository, tenantAdvancedFilters);
             ...
             AdvancedQueryFilter CancelledAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "CANC",PredefinedValue2 = null, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
