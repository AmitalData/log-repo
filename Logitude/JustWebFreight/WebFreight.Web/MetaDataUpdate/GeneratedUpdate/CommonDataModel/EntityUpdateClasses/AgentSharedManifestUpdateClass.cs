   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn OceanAgentSharedManifestsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 0, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "DirectionId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "DirectionId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 25 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 1, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 25 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 2, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Master" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Master" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 3, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 4, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Routing" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Routing" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 5, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentReference" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentReference" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 6, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentLevelName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentLevelName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 7, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "GrossWeight" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "GrossWeight" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 8, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentlevelCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentlevelCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 8, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "PackagesQuantity" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "PackagesQuantity" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 9, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TEU" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TEU" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 10, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn OceanAgentSharedManifestsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, IndexOrder = 11, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter OceanAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "O",PredefinedValue2 = null, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);


             AdvancedQueryFilter OceanAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "WAIT",PredefinedValue2 = null, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
			 ...
			 QueryColumn InlandAgentSharedManifestsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 0, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "DirectionId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "DirectionId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 25 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 1, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 25 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 2, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Master" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Master" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 3, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 4, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Routing" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Routing" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 5, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentReference" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentReference" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 6, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentLevelName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentLevelName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 7, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "GrossWeight" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "GrossWeight" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 8, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentlevelCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentlevelCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 8, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "PackagesQuantity" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "PackagesQuantity" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 9, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TEU" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TEU" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 10, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn InlandAgentSharedManifestsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, IndexOrder = 11, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter InlandAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "I",PredefinedValue2 = null, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);


             AdvancedQueryFilter InlandAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "WAIT",PredefinedValue2 = null, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.Code, Tenant = 0,Operator = "Equal"}, advancedQueryFiltersRepository, tenantAdvancedFilters);
			 ...
			 QueryColumn CancelledAgentSharedManifestsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 0, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "DirectionId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "DirectionId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 25 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 1, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TransportModeId" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 25 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 2, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Master" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Master" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 3, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 4, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Routing" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "Routing" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 5, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentReference" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "AgentReference" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 6, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentLevelName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentLevelName" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 7, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "GrossWeight" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "GrossWeight" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 8, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentlevelCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "ShipmentlevelCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 8, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "PackagesQuantity" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "PackagesQuantity" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 9, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TEU" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "TEU" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 100 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 10, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "CreateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn CancelledAgentSharedManifestsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, IndexOrder = 11, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "UpdateDate" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

             AdvancedQueryFilter CancelledAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldId = AgentSharedManifestObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AgentSharedManifestObjectFields.Where(d => d.FieldName == "StatusCode" && d.ObjectTableId == AgentSharedManifestObjectTable.Id).FirstOrDefault().FieldCode, PredefinedValue = "CANC",PredefinedValue2 = null, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.Code, Tenant = 0}, advancedQueryFiltersRepository, tenantAdvancedFilters);
