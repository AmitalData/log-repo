   ...
   {  		
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode AgentSharedManifestTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AgentSharedManifest.Q.AgentSharedManifests", DefaultText = @"All Agent Shared Manifests",LocalDefaultText = null, ObjectTableId = AgentSharedManifestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature AgentSharedManifestFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "AgentSharedManifestQ", ObjectTableId = AgentSharedManifestObjectTable.Id, Tenant = 0, NameTextCodeCode = "AgentSharedManifest.Features.AgentSharedManifestS", NameTextCodeDefaultText = "All Agent Shared Manifests", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,AgentSharedManifestObjectTable, addedFeatures, addedTextCodes,contextTenant);
 

			   TextCode AgentSharedManifestTextCode_1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AgentSharedManifest.Q.AirAgentSharedManifests", DefaultText = @"Air Agent Shared Manifests",LocalDefaultText = null, ObjectTableId = AgentSharedManifestObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AgentSharedManifestsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "AgentSharedManifest.DirectionId" , ColumnWidth = 25 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "AgentSharedManifest.TransportModeId" , ColumnWidth = 25 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "AgentSharedManifest.Master" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "AgentSharedManifest.AgentName" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "AgentSharedManifest.Routing" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 5, ObjectFieldCode = "AgentSharedManifest.AgentReference" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_6 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 6, ObjectFieldCode = "AgentSharedManifest.ShipmentLevelName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_7 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 7, ObjectFieldCode = "AgentSharedManifest.GrossWeight" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_8 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 8, ObjectFieldCode = "AgentSharedManifest.ShipmentlevelCode" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_9 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 9, ObjectFieldCode = "AgentSharedManifest.PackagesQuantity" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "AgentSharedManifest.StatusName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "AgentSharedManifest.TEU" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 12, ObjectFieldCode = "AgentSharedManifest.CreateDate" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AgentSharedManifestsQueryColumn_13 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AgentSharedManifestsQuery.Id,QueryCode = AgentSharedManifestsQuery.UniqueCode, IndexOrder = 13, ObjectFieldCode = "AgentSharedManifest.UpdateDate" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
			  ...
			  Query AirAgentSharedManifestsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AgentSharedManifestTextCode_1.Id, NameTextCodeCode = AgentSharedManifestTextCode_1.Code, ObjectTableName = "AgentSharedManifest", Code = "AirAgentSharedManifests",  EditWizardName = "./Common/Components/SharedManifest/SharedManifestComponent",
			   QueryGroupCode = "AASM", IndexOrder = 1, Tenant = 0, ObjectTableId = AgentSharedManifestObjectTable.Id, QuerySection = "AgentSharedManifest", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AgentSharedManifestFeature_1.Id,FeatureUniqeCode= AgentSharedManifestFeature_1.FeatureUniqeCode, DefaultSortName = "CreateDate", DefaultSortDirection = "Descending", Perspective = null }, addedQueries,contextTenant);
			 ...
			 QueryColumn AirAgentSharedManifestsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AirAgentSharedManifestsQuery.Id,QueryCode = AirAgentSharedManifestsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "AgentSharedManifest.Master" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
			 ...
			 QueryColumn AirAgentSharedManifestsQueryColumn_10 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AirAgentSharedManifestsQuery.Id,QueryCode = AirAgentSharedManifestsQuery.UniqueCode, IndexOrder = 10, ObjectFieldCode = "AgentSharedManifest.TEU" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn AirAgentSharedManifestsQueryColumn_11 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AirAgentSharedManifestsQuery.Id,QueryCode = AirAgentSharedManifestsQuery.UniqueCode, IndexOrder = 11, ObjectFieldCode = "AgentSharedManifest.CreateDate" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);

			 QueryColumn AirAgentSharedManifestsQueryColumn_12 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AirAgentSharedManifestsQuery.Id,QueryCode = AirAgentSharedManifestsQuery.UniqueCode, IndexOrder = 12, ObjectFieldCode = "AgentSharedManifest.UpdateDate" , ColumnWidth = 150 }, addedQueryColumns,contextTenant);
             ...
             AdvancedQueryFilter AirAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "WAIT",PredefinedValue2 = null, CustomPredefined = false, QueryId = AirAgentSharedManifestsQuery.Id,QueryCode = AirAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
			  ...
			  Query OceanAgentSharedManifestsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AgentSharedManifestTextCode_2.Id, NameTextCodeCode = AgentSharedManifestTextCode_2.Code, ObjectTableName = "AgentSharedManifest", Code = "OceanAgentSharedManifests",  EditWizardName = "./Common/Components/SharedManifest/SharedManifestComponent",
			   QueryGroupCode = "OASM", IndexOrder = 2, Tenant = 0, ObjectTableId = AgentSharedManifestObjectTable.Id, QuerySection = "AgentSharedManifest", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = AgentSharedManifestFeature_2.Id,FeatureUniqeCode= AgentSharedManifestFeature_2.FeatureUniqeCode, DefaultSortName = "CreateDate", DefaultSortDirection = "Descending", Perspective = null }, addedQueries,contextTenant);
             ...
             AdvancedQueryFilter OceanAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.TransportModeId", PredefinedValue = "O",PredefinedValue2 = null, CustomPredefined = false, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);


             AdvancedQueryFilter OceanAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "WAIT",PredefinedValue2 = null, CustomPredefined = false, QueryId = OceanAgentSharedManifestsQuery.Id,QueryCode = OceanAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
             ...
             AdvancedQueryFilter InlandAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.TransportModeId", PredefinedValue = "I",PredefinedValue2 = null, CustomPredefined = false, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);


             AdvancedQueryFilter InlandAgentSharedManifestsQueryFilter_1 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "WAIT",PredefinedValue2 = null, CustomPredefined = false, QueryId = InlandAgentSharedManifestsQuery.Id,QueryCode = InlandAgentSharedManifestsQuery.UniqueCode, Tenant = 0,Operator = "Equal"}, addedQueryFilters,contextTenant);
             ...
             AdvancedQueryFilter CancelledAgentSharedManifestsQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedFilterDetails() { IsPredefined = true, ObjectFieldCode = "AgentSharedManifest.StatusCode", PredefinedValue = "CANC",PredefinedValue2 = null, CustomPredefined = false, QueryId = CancelledAgentSharedManifestsQuery.Id,QueryCode = CancelledAgentSharedManifestsQuery.UniqueCode, Tenant = 0}, addedQueryFilters,contextTenant);
