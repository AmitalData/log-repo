   ...
   {  
	    ...
	    {   
		   ...
		   List<ObjectField> PaymentTermObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PaymentTerm").ToList();
            ...
            ScreenField PaymentTermPaymentTermHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = PaymentTermObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().Id, ScreenId = PaymentTermHeaderScreenScreen1.Id, ObjectFieldCode = PaymentTermObjectFields.Where(d => d.FieldName == "EnglishName").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField PaymentTermPaymentTermHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = PaymentTermObjectFields.Where(d => d.FieldName == "AddedManually").FirstOrDefault().Id, ScreenId = PaymentTermHeaderScreenScreen1.Id, ObjectFieldCode = PaymentTermObjectFields.Where(d => d.FieldName == "AddedManually").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {                
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PTAC",HtmlComponentName = "",HtmlComponentUrl = "./Common/Components/AccountingTab/AccountingTabComponent", FeatureId = PaymentTermAccountingFeature_TH1.Id, ControlPath = "Simplog.FreightLib.Views.PartnersTabs.PartnersAccountingTab.PaymentTermAccountingTabControl", ObjectTableId = PaymentTermObjectTable.Id, TabNameTextCodeId = PaymentTermAccountingTextCode_TH1.Id, TabNameTextCodeCode = PaymentTermAccountingTextCode_TH1.Code, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PTEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = PaymentTermEventsFeature_TH2.Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = PaymentTermObjectTable.Id, TabNameTextCodeId = PaymentTermEventsTextCode_TH2.Id, TabNameTextCodeCode = PaymentTermEventsTextCode_TH2.Code, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
