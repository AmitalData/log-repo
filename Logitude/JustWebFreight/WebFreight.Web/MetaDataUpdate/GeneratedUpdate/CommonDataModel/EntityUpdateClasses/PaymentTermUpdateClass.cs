...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "ef60b2e48163ec9752863ee23c0b6823";
	    ...
	    {  
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode PaymentTermTextCode_0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentTerm.Q.PaymentTerms", DefaultText = @"Payment terms",LocalDefaultText = null, ObjectTableId = PaymentTermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
	        ...
	        //FeaturesRepository.SubmitChanges();    
			  ...
			  Query PaymenttermsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = PaymentTermTextCode_0.Id, NameTextCodeCode = PaymentTermTextCode_0.Code, ObjectTableName = "PaymentTerm", Code = "Payment terms",  QueryGroupCode = "PMTR", IndexOrder = 0, Tenant = 0, ObjectTableId = PaymentTermObjectTable.Id, QuerySection = "PaymentTerm", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = PaymentTermFeature_0.Id,FeatureUniqeCode= PaymentTermFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, addedQueries,contextTenant);
	
			 QueryColumn PaymenttermsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymenttermsQuery.Id,QueryCode = PaymenttermsQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "PaymentTerm.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymenttermsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymenttermsQuery.Id,QueryCode = PaymenttermsQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "PaymentTerm.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymenttermsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymenttermsQuery.Id,QueryCode = PaymenttermsQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "PaymentTerm.AddedManually" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymenttermsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymenttermsQuery.Id,QueryCode = PaymenttermsQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "PaymentTerm.Days" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn PaymenttermsQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = PaymenttermsQuery.Id,QueryCode = PaymenttermsQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "PaymentTerm.InActive" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> PaymentTermObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "PaymentTerm").ToList();
	         ...
	         Screen PaymentTermGeneralTabScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PaymentTerm.GeneralTabScreen", Name = "General Tab Screen", ObjectTableId = PaymentTermObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 8, IsReadOnly = false }, screensRepository, tenantScreens,contextTenant);
	         ...
	         Screen PaymentTermHeaderScreenScreen1 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "PaymentTerm.HeaderScreen", Name = "Header Screen", ObjectTableId = PaymentTermObjectTable.Id, NumberOfColumns = 1, NumberOfRows = 2, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {                
			   ...
			   TextCode PaymentTermGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentTerm.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = PaymentTermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode PaymentTermAccountingTextCode_TH1 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentTerm.TH.Accounting", DefaultText = "Accounting",LocalDefaultText = null, ObjectTableId = PaymentTermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
			   ...
			   TextCode PaymentTermEventsTextCode_TH2 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "PaymentTerm.TH.Events", DefaultText = "Events",LocalDefaultText = null, ObjectTableId = PaymentTermObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
