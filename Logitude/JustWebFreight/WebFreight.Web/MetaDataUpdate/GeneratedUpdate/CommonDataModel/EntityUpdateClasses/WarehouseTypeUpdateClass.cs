...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "e83993437e5ba4d9cac0fc8a1a64c8a3";
	    ...
	    {   
		   ...
		   //List<ObjectField> WarehouseTypeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "WarehouseType").ToList();
	         ...
	         Screen WarehouseTypeWarehouseTypeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "WarehouseType.HeaderScreen", Name = "WarehouseTypeHeaderScreen", ObjectTableId = WarehouseTypeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    public void FillWarehouseType(int contextTenant)
        { 
            var repo = new WarehouseTypeRepository(contextTenant);
