...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.CommonDataModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "79c6ed6bc2ffffab466e03e239f0f922";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "AgentSharedDocument",
			      				    ...
			      				    OldDBTableName =  "AgentSharedDocuments",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    SearchFields =  "AgentSharedDocument,AgentSharedDocuments,,Id,CreateDate",
			      				    HashString =  AgentSharedDocumentUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Id",
					  						...
					  						ValidForQuerySection1 =  "AgentSharedDocument",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AgentSharedManifestRef",
					  						OldFieldName =  "AgentSharedManifestRef",
					  						ObjectTableName =  "AgentSharedDocument",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  20,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "AgentSharedManifestRef",
					  						ListPropertyPath =  "AgentSharedManifestRef",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "AgentSharedManifestRef",
					  						DefaultText =  "AgentSharedManifestRef",
					  						FullLocalDefaultText =  "AgentSharedManifestRef",
					  						ListFieldLable =  "AgentSharedManifestRefListLable",
					  						ListLableDefaultText =  "AgentSharedManifestRef",
					  						ListLocalDefaultText =  "AgentSharedManifestRef",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DocumentXML",
					  						OldFieldName =  "DocumentXML",
					  						ObjectTableName =  "AgentSharedDocument",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "DocumentXML",
					  						ListPropertyPath =  "DocumentXML",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "DocumentXML",
					  						DefaultText =  "DocumentXML",
					  						FullLocalDefaultText =  "DocumentXML",
					  						ListFieldLable =  "DocumentXMLListLable",
					  						ListLableDefaultText =  "DocumentXML",
					  						ListLocalDefaultText =  "DocumentXML",
					  						IsForeignKey =  false,
					  						IsMaxLength =  true,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ShipmentLevelCode",
					  						...
					  						FullLocalDefaultText =  "ShipmentLevelCode",
					  						ListFieldLable =  "ShipmentLevelCodeListLable",
					  						ListLableDefaultText =  "ShipmentLevelCode",
					  						ListLocalDefaultText =  "ShipmentLevelCode",
					  						IsForeignKey =  true,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "DocumentSL",
					  						OldFieldName =  "DocumentSL",
					  						ObjectTableName =  "AgentSharedDocument",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  0,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "DocumentSL",
					  						ListPropertyPath =  "DocumentSL",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "DocumentSL",
					  						DefaultText =  "DocumentSL",
					  						FullLocalDefaultText =  "DocumentSL",
					  						ListFieldLable =  "DocumentSLListLable",
					  						ListLableDefaultText =  "DocumentSL",
					  						ListLocalDefaultText =  "DocumentSL",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = AgentSharedDocumentObjectTable.Id,
