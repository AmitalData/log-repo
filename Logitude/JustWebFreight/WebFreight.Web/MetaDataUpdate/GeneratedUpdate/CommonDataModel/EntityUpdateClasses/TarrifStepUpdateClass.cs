   ...
   {  		
	    ...
	    {   
		   ...
		   //List<ObjectField> TarrifStepObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "TarrifStep").ToList();
	         ...
	         Screen TarrifStepTarrifStepHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "TarrifStep.HeaderScreen", Name = "TarrifStepHeaderScreen", ObjectTableId = TarrifStepObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
