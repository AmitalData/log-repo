...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.ShipmentsModel.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    {                
			   ...
			   TextCode ContainerTrackingProviderGeneralTextCode_TH0 = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ContainerTrackingProvider.TH.General", DefaultText = "General",LocalDefaultText = null, ObjectTableId = ContainerTrackingProviderObjectTable.Id, Tenant = 0, TextCodeTypeCode = "TH", }, TextCodeRepository, textCodes,contextTenant);
