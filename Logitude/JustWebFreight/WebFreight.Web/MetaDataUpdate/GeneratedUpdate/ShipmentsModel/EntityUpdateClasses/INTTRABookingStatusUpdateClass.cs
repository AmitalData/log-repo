...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.ShipmentsModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "0cd11d2af71bf98783e3ed0134c2cea5";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "INTTRABookingStatus",
			      				    ...
			      				    IsLookUp =  false,
			      				    IsTabsHidden =  false,
			      				    HashString =  "0cd11d2af71bf98783e3ed0134c2cea5",
	    ...
	    public void FillINTTRABookingStatus()
        { 
            var repo = new INTTRABookingStatusRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                INTTRABookingStatus,
                                Logitude.BL.ShipmentsModel.INTTRABookingStatusDetails,
                                INTTRABookingStatusRepository>(repo, dic);
        }
