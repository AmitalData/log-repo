...
{
   public class ManifestStatusUpdateClass
   {  		
		public const string HashString = "b2ccca957bd29d15c6e26f7518c32b7b";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ManifestStatus",
			      				    ...
			      				    InActive =  false,
			      				    SearchFields =  "ManifestStatus,ManifestStatus,,Code,Name",
			      				    ...
			      				    CloseTableCode =  "Code",
			      				    CloseTableName =  "Name",
			      				    HashString =  ManifestStatusUpdateClass.HashString,
	    ...
	    public void FillManifestStatus()
        { 
            var repo = new ManifestStatusRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                ManifestStatus,
                                Logitude.BL.ShipmentsModel.ManifestStatusDetails,
                                ManifestStatusRepository>(repo, dic);
        }
