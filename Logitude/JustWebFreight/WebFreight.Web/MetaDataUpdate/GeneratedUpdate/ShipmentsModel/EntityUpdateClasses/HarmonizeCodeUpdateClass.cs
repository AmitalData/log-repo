...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.ShipmentsModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "8d4b705b19f449c630c808c442c820fe";
	    ...
	    {   
		   ...
		   //List<ObjectField> HarmonizeCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "HarmonizeCode").ToList();
		       
	      

	         Screen HarmonizeCodeHarmonizeCodeHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "HarmonizeCode.HeaderScreen", Name = "HarmonizeCodeHeaderScreen", ObjectTableId = HarmonizeCodeObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens);
      	
		    HarmonizeCodeObjectTable.HeaderScreenId = HarmonizeCodeHarmonizeCodeHeaderScreenScreen0.Id;
		    HarmonizeCodeObjectTable.HeaderScreenCode = HarmonizeCodeHarmonizeCodeHeaderScreenScreen0.Code;
        ...
        { 
            var repo = new HarmonizeCodeRepository(contextTenant);
