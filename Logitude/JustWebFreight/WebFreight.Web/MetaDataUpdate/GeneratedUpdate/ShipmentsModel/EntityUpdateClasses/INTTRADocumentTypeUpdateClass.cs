...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.ShipmentsModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "4b670d9f673826d51026875bacb1fb6a";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "INTTRADocumentType",
			      				    ...
			      				    CloseTableCode =  "Code",
			      				    CloseTableName =  "Name",
			      				    HashString =  "4b670d9f673826d51026875bacb1fb6a",
	    ...
	    public void FillINTTRADocumentType()
        { 
            var repo = new INTTRADocumentTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                INTTRADocumentType,
                                Logitude.BL.ShipmentsModel.INTTRADocumentTypeDetails,
                                INTTRADocumentTypeRepository>(repo, dic);
        }
