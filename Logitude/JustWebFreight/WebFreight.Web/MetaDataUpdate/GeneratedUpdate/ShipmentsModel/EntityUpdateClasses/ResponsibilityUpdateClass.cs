...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.ShipmentsModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "a5e8234b8175e2ea56e138afa61bb9ee";
	    ...
	    {  
	        ...
	        QueryGroup ResponsibilityQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "COGR", Name = "Responsibility" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup ResponsibilityQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupDetails() { Code = "c7b8", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
        ...
        { 
            ...
            new FillCloseTables().FillCloseTable<
                                Responsibility,
                                Logitude.BL.ShipmentsModel.ResponsibilityDetails,
