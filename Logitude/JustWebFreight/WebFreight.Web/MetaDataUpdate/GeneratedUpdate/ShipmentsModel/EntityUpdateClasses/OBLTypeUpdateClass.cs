...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.ShipmentsModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "0d73b84c8ed48022d2c6b306be14a404";
	    ...
	    public void FillOBLType()
        { 
            var repo = new OBLTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                OBLType,
                                Logitude.BL.ShipmentsModel.OBLTypeDetails,
                                OBLTypeRepository>(repo, dic);
        }
