   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllAccountingPaymentMethodsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AccountingPaymentMethodTextCode_0.Id, Code = "All Accounting Payment Methods",  QueryGroupCode = "RPYM", IndexOrder = 0, Tenant = 0, ObjectTableId = AccountingPaymentMethodObjectTable.Id, QuerySection = "AccountingPaymentMethod", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = AccountingPaymentMethodFeature_0.Id, DefaultSortName = null, DefaultSortDirection = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllAccountingPaymentMethodsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id, IndexOrder = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingPaymentMethodsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id, IndexOrder = 1, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingPaymentMethodsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id, IndexOrder = 2, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingPaymentMethodsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id, IndexOrder = 3, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> AccountingPaymentMethodObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AccountingPaymentMethod").ToList();
            ...
            ScreenField AccountingPaymentMethodAccountingPaymentMethodHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodHeaderScreenScreen0.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodHeaderScreenScreen0.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
            ...
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "IsAR").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "IsAP").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
	    ...
	    {    
            ...
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PMGN",HtmlComponentName = "GeneralTabComponent",HtmlComponentUrl = "./Infrastructure/GenericComponents/GeneralTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "AccountingPaymentMethod.Tab.General" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ControlPath = "Simplog.Infrastructure.GeneralControls.GeneralTabControl", ObjectTableId = AccountingPaymentMethodObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "AccountingPaymentMethod.TH.General" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 0 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PMAC",HtmlComponentName = "",HtmlComponentUrl = "./Common/Components/AccountingTab/AccountingTabComponent", FeatureId = tenantFeatures.Where(d => d.Code == "AccountingPaymentMethod.Tab.Accounting" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ControlPath = "Simplog.Infrastructure.Views.Events.AccountingControl", ObjectTableId = AccountingPaymentMethodObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "AccountingPaymentMethod.TH.Accounting" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 1 }, objectTableTabsRepository, TenantObjectTableTabs);
   
            AddObjectTableTabs.AddObjectTableTab(new ObjectTableTabDetails() { Code = "PMEV",HtmlComponentName = "",HtmlComponentUrl = "", FeatureId = tenantFeatures.Where(d => d.Code == "AccountingPaymentMethod.Tab.Events" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ControlPath = "Simplog.Infrastructure.Views.Events.EventsControl", ObjectTableId = AccountingPaymentMethodObjectTable.Id, TabNameTextCodeId = tenantTextCodes.Where(d => d.Code == "AccountingPaymentMethod.TH.Events" && d.Tenant == 0).FirstOrDefault().Id, Tenant = 0, IndexOrder = 2 }, objectTableTabsRepository, TenantObjectTableTabs);
	    ...
	    {  
 		   ...
 		   TextCode AccountingPaymentMethodTextCode_AccountingPaymentMethod = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "AccountingPaymentMethod", DefaultText = "Accounting Payment Method",LocalDefaultText = null, ObjectTableId = AccountingPaymentMethodObjectTable.Id, Tenant = 0, TextCodeTypeCode = "T", IsSpellChecked = false }, TextCodeRepository, TextCodes);
