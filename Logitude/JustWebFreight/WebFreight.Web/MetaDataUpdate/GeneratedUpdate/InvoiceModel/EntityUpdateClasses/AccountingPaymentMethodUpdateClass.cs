   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllAccountingPaymentMethodsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AccountingPaymentMethodTextCode_0.Id, NameTextCodeCode = AccountingPaymentMethodTextCode_0.Code, Code = "All Accounting Payment Methods",  QueryGroupCode = "RPYM", IndexOrder = 0, Tenant = 0, ObjectTableId = AccountingPaymentMethodObjectTable.Id, QuerySection = "AccountingPaymentMethod", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = AccountingPaymentMethodFeature_0.Id, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllAccountingPaymentMethodsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id,QueryCode = AllAccountingPaymentMethodsQuery.Code, IndexOrder = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingPaymentMethodsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id,QueryCode = AllAccountingPaymentMethodsQuery.Code, IndexOrder = 1, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingPaymentMethodsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id,QueryCode = AllAccountingPaymentMethodsQuery.Code, IndexOrder = 2, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountingPaymentMethodsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountingPaymentMethodsQuery.Id,QueryCode = AllAccountingPaymentMethodsQuery.Code, IndexOrder = 3, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == AccountingPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> AccountingPaymentMethodObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AccountingPaymentMethod").ToList();
            ...
            ScreenField AccountingPaymentMethodAccountingPaymentMethodHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodHeaderScreenScreen0.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodHeaderScreenScreen0.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
            ...
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 1, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 2, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField3 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 3, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "IsAR").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "IsAR").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField AccountingPaymentMethodAccountingPaymentMethodGeneralTabScreenScreenField4 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 4, ObjectFieldId = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "IsAP").FirstOrDefault().Id, ScreenId = AccountingPaymentMethodGeneralTabScreenScreen1.Id, ObjectFieldCode = AccountingPaymentMethodObjectFields.Where(d => d.FieldName == "IsAP").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
