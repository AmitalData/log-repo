...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InvoiceModel.EntityUpdateClasses
{
   ...
   {  		
	    ...
	    {  
 		   ...
 		   TextCode ARPaymentTextCode_ARPaymentOInvoiceAmount2reconcileMSGLower = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ARPayment.O.InvoiceAmount2reconcileMSGLower", DefaultText = "The invoice is in multiple currencies and therefore cannot be reconciled from the receipt. Please reconcile transactions.", LocalDefaultText = @"BS64:IteU15fXqdeR15XXoNeZ16og15TXmdeQINeo15Eg157XmNeR16LXmdeqINeV15zXm9efINec15Ag16DXmdeq158g15zXkdem16Ig15TXqteQ157XlCDXnteU16fXkdec15QuINeg15Ag15zXkdem16Ig15TXqteQ157XqiDXqteg15XXoteV16ouIg==", ObjectTableId = ARPaymentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);

 		   TextCode ARPaymentTextCode_ARPaymentOCanNotReconcile = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "ARPayment.O.CanNotReconcile", DefaultText = "The amount to reconcile in the invoice is lower than the invoice open amount",LocalDefaultText = @"BS64:IteU16HXm9eV150g15zXlNeq15DXnteUINen15jXnyDXnteU16HXm9eV150g15TXpNeq15XXlyDXkdeX16nXkdeV16DXmdeqIg==", ObjectTableId = ARPaymentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "O", IsSpellChecked = false }, TextCodeRepository, TextCodes,contextTenant);
