	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "TipoCadenaPago",
					  						...
					  						HelpTextDefaultText =  "-Clave del tipo de cadena de pago que genera la entidad receptora de pago%n-Payment Transfer Way",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CertPago",
					  						...
					  						HelpTextDefaultText =  "-Certificado que corresponde al pago%n-The certificate that corresponds to the payment. It is a text chain of 64 base format",
					  						IsMaxLength =  true,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CadPago",
					  						...
					  						HelpTextDefaultText =  "-Cadena Original del Comprobante de Pago generado por la entidad emisora de la cuenta beneficiaria%n-Payment original chain sent by the beneficiary's bank institution",
					  						IsMaxLength =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "SelloPago",
					  						...
					  						HelpTextDefaultText =  "-Sello digital que se asocie el pago%n-The digital seal associates the payment. It is a text chain of 64 base format",
					  						IsMaxLength =  true,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
					  						IncludeInSearchField =  false,
