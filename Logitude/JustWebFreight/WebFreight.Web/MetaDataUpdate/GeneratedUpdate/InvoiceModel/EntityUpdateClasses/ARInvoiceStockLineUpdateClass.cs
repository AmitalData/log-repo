...
{
   public class ARInvoiceStockLineUpdateClass
   {  		
		public const string HashString = "25d49a752af6c84bd90b8ad2fe5436eb";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ARInvoiceStockLine",
			      				    IsNew =  true,
			      				    DBTableName =  "ARInvoiceStockLines",
			      				    OldDBTableName =  "ARInvoiceStockLines",
			      				    ObjectTableSingular =  "A/R Invoice Stock Line",
			      				    ObjectTablePlural =  "A/R Invoice Stock Lines",
			      				    ...
			      				    DefaultText =  "A/R Invoice Stock Line",
			      				    Code =  "c608",
			      				    Name =  " Query Group",
			      				    ...
			      				    HasDocuments =  false,
			      				    IsLookUp =  false,
			      				    HashString =  ARInvoiceStockLineUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "Id",
					  						...
					  						ValidForQuerySection1 =  "ARInvoiceStockLine",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ARInvoiceStockId",
					  						...
					  						LookUpTableName =  "ARInvoiceStock",
					  						MinLength =  0,
					  						MaxLength =  15,
					  						IsRequired =  true,
					  						CopyToDW =  false,
					  						...
					  						DefaultText =  "A/R Invoice Stock Id",
					  						IsForeignKey =  true,
					  						ForeignEntity =  "ARInvoiceStock",
					  						NavigationPropertyName =  "ARInvoiceStock",
					  						IsMaxLength =  false,
	    ...
	    {   
			ObjectTable ARInvoiceStockLineObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "ARInvoiceStockLine" && d.Tenant == 0).FirstOrDefault(); 
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ARInvoiceStockLineObjectTable.Id,
