...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InvoiceModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "8c21d0cc17708e0440df166093a17c58";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "AccountingSystemsSyncStatus",
			      				    ...
			      				    OldDBTableName =  "AccountingSystemsSyncStatuses",
			      				    ...
			      				    HashString =  AccountingSystemsSyncStatusUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "LastErrorDate",
					  						OldFieldName =  "LastErrorDate",
					  						ObjectTableName =  "AccountingSystemsSyncStatus",
					  						...
					  						PMPropertyPath =  "LastErrorDate",
					  						ListPropertyPath =  "LastErrorDate",
					  						...
					  						FullFieldLable =  "LastErrorDate",
					  						DefaultText =  "LastErrorDate",
					  						FullLocalDefaultText =  "LastErrorDate",
					  						ListFieldLable =  "LastErrorDateListLable",
					  						ListLableDefaultText =  "LastErrorDate",
					  						ListLocalDefaultText =  "LastErrorDate",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "ExternalCodesLastUpdate",
					  						OldFieldName =  "ExternalCodesLastUpdate",
					  						ObjectTableName =  "AccountingSystemsSyncStatus",
					  						FieldsDataType =  "DateTime",
					  						MinLength =  0,
					  						MaxLength =  0,
	    ...
	    {   
		   ...
		   //List<ObjectField> AccountingSystemsSyncStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AccountingSystemsSyncStatus").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = AccountingSystemsSyncStatusObjectTable.Id,
