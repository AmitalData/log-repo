...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InvoiceModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "b182923362230e3dc8b2e9f67402661d";
	    ...
	    {   
		   ...
		   //List<ObjectField> APPaymentStatusObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "APPaymentStatus").ToList();
		       
	      

	         Screen APPaymentStatusAPPaymentStatusHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenDetails() { Code = "APPaymentStatus.HeaderScreen", Name = "APPaymentStatusHeaderScreen", ObjectTableId = APPaymentStatusObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
      	
		    APPaymentStatusObjectTable.HeaderScreenId = APPaymentStatusAPPaymentStatusHeaderScreenScreen0.Id;
		    APPaymentStatusObjectTable.HeaderScreenCode = APPaymentStatusAPPaymentStatusHeaderScreenScreen0.Code;
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = APPaymentStatusObjectTable.Id,
	    ...
	    public void FillAPPaymentStatus(int contextTenant)
        { 
            var repo = new APPaymentStatusRepository(contextTenant);
