...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.InvoiceModel.EntityUpdateClasses
{
   ...
   {  
	    ...
	    {  
 		   ...
 		   TextCode APPaymentTextCode_APPaymentPaymentMethodIdHelpText = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "APPayment.PaymentMethodIdHelpText", DefaultText = "",LocalDefaultText = null, ObjectTableId = APPaymentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "H", IsSpellChecked = false }, TextCodeRepository, TextCodes);
 		   ...
 		   TextCode APPaymentTextCode_APPaymentPaymentDateHelpText = AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "APPayment.PaymentDateHelpText", DefaultText = "",LocalDefaultText = null, ObjectTableId = APPaymentObjectTable.Id, Tenant = 0, TextCodeTypeCode = "H", IsSpellChecked = false }, TextCodeRepository, TextCodes);
