...
{
   public class ARPaymentChequeStatusReplicaUpdateClass
   {  
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "ARPaymentChequeStatusReplica",
			      				    IsNew =  true,
			      				    DBTableName =  "ARPaymentChequeStatusReplicas",
			      				    OldDBTableName =  "ARPaymentChequeStatusReplicas",
			      				    ObjectTableSingular =  "ARPaymentChequeStatusReplica",
			      				    ObjectTablePlural =  "ARPaymentChequeStatusReplicas",
			      				    ...
			      				    DefaultText =  "ARPaymentChequeStatusReplica",
			      				    Code =  "c077",
			      				    Name =  " Query Group",
	    ...
	    {   
			ObjectTable ARPaymentChequeStatusReplicaObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "ARPaymentChequeStatusReplica" && d.Tenant == 0).FirstOrDefault(); 
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ARPaymentChequeStatusReplicaObjectTable.Id,
