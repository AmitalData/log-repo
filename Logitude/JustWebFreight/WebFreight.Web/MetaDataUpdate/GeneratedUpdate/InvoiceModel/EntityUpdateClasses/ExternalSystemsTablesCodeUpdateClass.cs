   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllExternalTablesCodesQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = ExternalSystemsTablesCodeTextCode_0.Id, NameTextCodeCode = ExternalSystemsTablesCodeTextCode_0.Code, Code = "All External Tables Codes",  QueryGroupCode = "ESTC", IndexOrder = 0, Tenant = 0, ObjectTableId = ExternalSystemsTablesCodeObjectTable.Id, QuerySection = "ExternalSystemsTablesCode", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = ExternalSystemsTablesCodeFeature_0.Id, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllExternalTablesCodesQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalTablesCodesQuery.Id,QueryCode = AllExternalTablesCodesQuery.Code, IndexOrder = 0, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllExternalTablesCodesQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalTablesCodesQuery.Id,QueryCode = AllExternalTablesCodesQuery.Code, IndexOrder = 1, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllExternalTablesCodesQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalTablesCodesQuery.Id,QueryCode = AllExternalTablesCodesQuery.Code, IndexOrder = 2, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "LogitudeTable" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "LogitudeTable" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllExternalTablesCodesQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalTablesCodesQuery.Id,QueryCode = AllExternalTablesCodesQuery.Code, IndexOrder = 3, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "CreatedDate" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "CreatedDate" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllExternalTablesCodesQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllExternalTablesCodesQuery.Id,QueryCode = AllExternalTablesCodesQuery.Code, IndexOrder = 4, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "UpdatedDate" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "UpdatedDate" && d.ObjectTableId == ExternalSystemsTablesCodeObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 130 }, queryColumnsRepository, tenantQueryColumns);
	    ...
	    {   
		   ...
		   List<ObjectField> ExternalSystemsTablesCodeObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "ExternalSystemsTablesCode").ToList();
            ...
            ScreenField ExternalSystemsTablesCodeExternalSystemsTablesCodeHeaderScreenScreenField0 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 0, Row = 0, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().Id, ScreenId = ExternalSystemsTablesCodeHeaderScreenScreen0.Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Code").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ExternalSystemsTablesCodeExternalSystemsTablesCodeHeaderScreenScreenField1 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 1, Row = 0, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().Id, ScreenId = ExternalSystemsTablesCodeHeaderScreenScreen0.Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "Name").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
         
            ScreenField ExternalSystemsTablesCodeExternalSystemsTablesCodeHeaderScreenScreenField2 = AddScreensAndScreenFields.AddScreenField(new ScreenFieldDetails() { Column = 2, Row = 0, ObjectFieldId = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "CreatedDate").FirstOrDefault().Id, ScreenId = ExternalSystemsTablesCodeHeaderScreenScreen0.Id, ObjectFieldCode = ExternalSystemsTablesCodeObjectFields.Where(d => d.FieldName == "CreatedDate").FirstOrDefault().FieldCode, Tenant = 0, }, screenFieldsRepository, tenantScreenFields);
