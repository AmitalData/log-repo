   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			 ...
			 QueryColumn AllAPPaymentMethodsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAPPaymentMethodsQuery.Id,QueryCode = AllAPPaymentMethodsQuery.Code, IndexOrder = 0, ObjectFieldId = APPaymentMethodObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = APPaymentMethodObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAPPaymentMethodsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAPPaymentMethodsQuery.Id,QueryCode = AllAPPaymentMethodsQuery.Code, IndexOrder = 1, ObjectFieldId = APPaymentMethodObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = APPaymentMethodObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAPPaymentMethodsQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAPPaymentMethodsQuery.Id,QueryCode = AllAPPaymentMethodsQuery.Code, IndexOrder = 2, ObjectFieldId = APPaymentMethodObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = APPaymentMethodObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAPPaymentMethodsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAPPaymentMethodsQuery.Id,QueryCode = AllAPPaymentMethodsQuery.Code, IndexOrder = 3, ObjectFieldId = APPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = APPaymentMethodObjectFields.Where(d => d.FieldName == "Inactive" && d.ObjectTableId == APPaymentMethodObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 150 }, queryColumnsRepository, tenantQueryColumns);
