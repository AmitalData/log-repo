   ...
   {  
	    ...
	    {  
	        ...
	        FeaturesRepository.SubmitChanges();    
			  ...
			  Query AllAccountsQuery = AddQueries.AddQuery(new QueryDetails() { NameTextCodeId = AccountTextCode_0.Id, NameTextCodeCode = AccountTextCode_0.Code, Code = "All Accounts",  QueryGroupCode = "ACCT", IndexOrder = 0, Tenant = 0, ObjectTableId = AccountObjectTable.Id, QuerySection = "Account", SystemLevel = true, IsAddNewEntityEnabled = true, FeatureId = AccountFeature_0.Id,FeatureUniqeCode= AccountFeature_0.FeatureUniqeCode, DefaultSortName = null, DefaultSortDirection = null, Perspective = null }, queriesRepository, tenantQueries);
	
			 QueryColumn AllAccountsQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountsQuery.Id, IndexOrder = 0, ObjectFieldId = AccountObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountObjectFields.Where(d => d.FieldName == "Code" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 90 }, queryColumnsRepository, tenantQueryColumns);

			 QueryColumn AllAccountsQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountsQuery.Id, IndexOrder = 1, ObjectFieldId = AccountObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountObjectFields.Where(d => d.FieldName == "Name" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 127 }, queryColumnsRepository, tenantQueryColumns);
			 ...
			 QueryColumn AllAccountsQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountsQuery.Id, IndexOrder = 3, ObjectFieldId = AccountObjectFields.Where(d => d.FieldName == "ExternalAccountingCard" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountObjectFields.Where(d => d.FieldName == "ExternalAccountingCard" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 50 }, queryColumnsRepository, tenantQueryColumns);
			 ...
			 QueryColumn AllAccountsQueryColumn_5 = AddQueries.AddQueryColumn(new QueryColumnDetails { Tenant = 0, QueryId = AllAccountsQuery.Id, IndexOrder = 5, ObjectFieldId = AccountObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().Id, ObjectFieldCode = AccountObjectFields.Where(d => d.FieldName == "AddedManually" && d.ObjectTableId == AccountObjectTable.Id).FirstOrDefault().FieldCode, ColumnWidth = 50 }, queryColumnsRepository, tenantQueryColumns);
