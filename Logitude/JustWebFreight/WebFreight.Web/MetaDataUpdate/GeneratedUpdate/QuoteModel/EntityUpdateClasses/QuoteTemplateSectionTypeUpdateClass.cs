...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.QuoteModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "4a6bd1c03a299f2f10c14a5ae2c91dcf";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuoteTemplateSectionType",
			      				    ...
			      				    HashString =  QuoteTemplateSectionTypeUpdateClass.HashString,
	    ...
	    {  
		   ...
		   Feature QuoteTemplateSectionTypeFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = QuoteTemplateSectionTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteTemplateSectionType.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteTemplateSectionTypeObjectTable);
		   Feature QuoteTemplateSectionTypeFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = QuoteTemplateSectionTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteTemplateSectionType.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteTemplateSectionTypeObjectTable);
		   Feature QuoteTemplateSectionTypeFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = QuoteTemplateSectionTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteTemplateSectionType.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteTemplateSectionTypeObjectTable);
		   Feature QuoteTemplateSectionTypeFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeatureDetails() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = false, ObjectTableId = QuoteTemplateSectionTypeObjectTable.Id, Tenant = 0, NameTextCodeCode = "QuoteTemplateSectionType.Features.PackageFeature", NameTextCodeDefaultText = "QuoteTemplateSectionType Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,QuoteTemplateSectionTypeObjectTable);    
