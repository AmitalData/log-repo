...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate.QuoteModel.EntityUpdateClasses
{
   ...
   {  		
		public const string HashString = "a3a1c4a1c160467ed5b9e0fb5a6ca9b2";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "QuoteSetting",
			      				    ...
			      				    HashString =  QuoteSettingUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,ObjectFieldRepository ObjectFieldsRepository,TextCodeRepository TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CopyExchangeRates",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "CopyExchangeRates",
					  						ListPropertyPath =  "CopyExchangeRates",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "CopyExchangeRates",
					  						DefaultText =  "CopyExchangeRates",
					  						FullLocalDefaultText =  "CopyExchangeRates",
					  						ListFieldLable =  "CopyExchangeRatesListLable",
					  						ListLableDefaultText =  "CopyExchangeRates",
					  						ListLocalDefaultText =  "CopyExchangeRates",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "AutomaticallyCloseDays",
					  						...
					  						DefaultText =  "AutomaticallyCloseDays",
					  						FullLocalDefaultText =  "AutomaticallyCloseDays",
					  						ListFieldLable =  "AutomaticallyCloseDaysListLable",
					  						ListLableDefaultText =  "AutomaticallyCloseDays",
					  						ListLocalDefaultText =  "AutomaticallyCloseDays",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  true,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldsDetails() 
			   {
					 						...
					 						FieldName =  "CostChargesMust",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "CostChargesMust",
					  						ListPropertyPath =  "CostChargesMust",
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						IsMulti =  false,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "CostChargesMust",
					  						DefaultText =  "Cost Charges Must",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
	    ...
	    {   
		   ...
		   //List<ObjectField> QuoteSettingObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "QuoteSetting").ToList();
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypeDetails()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = QuoteSettingObjectTable.Id,
