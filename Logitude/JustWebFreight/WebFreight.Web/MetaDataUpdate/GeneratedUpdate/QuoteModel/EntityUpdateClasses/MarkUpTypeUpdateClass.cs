...
{
   public class MarkUpTypeUpdateClass
   {  		
		public const string HashString = "4845cd20e6710eb4b0d1e50bd2d00377";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTableDetails()
            {
	             				    ...
	             				    ObjectTableName =  "MarkUpType",
			      				    ...
			      				    InActive =  false,
			      				    SearchFields =  "MarkUpType,MarkUpTypes,,Code,",
			      				    ...
			      				    CloseTableCode =  "Code",
			      				    CloseTableName =  "Name",
			      				    HashString =  MarkUpTypeUpdateClass.HashString,
	    ...
	    public void FillMarkUpType()
        { 
            var repo = new MarkUpTypeRepository(0);
            var dic =repo.GetAll().ToDictionary(rec => rec.Code, rec => rec);
            new FillCloseTables().FillCloseTable<
                                MarkUpType,
                                Logitude.BL.QuoteModel.MarkUpTypeDetails,
                                MarkUpTypeRepository>(repo, dic);
        }
