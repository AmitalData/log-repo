...
namespace WebFreight.Web.MetaDataUpdate
{
    public partial class MetaDataUpdateClass
    {
        ...
        private void CreateShipmentRules(Dictionary<string, ObjectTableRule> TenantObjectTableRule, Dictionary<string, ObjectTableRuleField> TenantObjectTableRuleFields, List<ObjectFieldValidation> TenantObjectFieldValidations, Dictionary<string, RuleConditionField> TenantRuleConditionFields)
        {
            ...
            RuleConditionField IsOperationalClosed_OPAE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Shipment_OpClosed_Req_AE.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField TransportModeId_OPAE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Shipment_OpClosed_Req_AE.Id, Operator = "Equals", Value = "A", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField IsOperationalClosed_OPOE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Shipment_OpClosed_Req_OE.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField TransportModeId_OPOE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Shipment_OpClosed_Req_OE.Id, Operator = "Equals", Value = "O", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField IsOperationalClosed_OPIE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Shipment_OpClosed_Req_IE.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField TransportModeId_OPIE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Shipment_OpClosed_Req_IE.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField IsOperationalClosed_OPAI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Shipment_OpClosed_Req_AI.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField TransportModeId_OPAI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Shipment_OpClosed_Req_AI.Id, Operator = "Equals", Value = "A", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField IsOperationalClosed_OPOI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Shipment_OpClosed_Req_OI.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField TransportModeId_OPOI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Shipment_OpClosed_Req_OI.Id, Operator = "Equals", Value = "O", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField IsOperationalClosed_OPII = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Shipment_OpClosed_Req_II.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField TransportModeId_OPII = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Shipment_OpClosed_Req_II.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPAE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_AE.Id, Operator = "Equals", Value = "A", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPAE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_AE.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPAE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_AE.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPAED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_AE_D.Id, Operator = "Equals", Value = "A", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPAED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_AE_D.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPAED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_AE_D.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPOE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_OE.Id, Operator = "Equals", Value = "O", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPOE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_OE.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPOE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_OE.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPOED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_OED.Id, Operator = "Equals", Value = "O", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPOED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_OED.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPOED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_OED.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPAI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_AI.Id, Operator = "Equals", Value = "A", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPAI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_AI.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPAID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_AID.Id, Operator = "Equals", Value = "A", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPAID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_AID.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPOI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_OI.Id, Operator = "Equals", Value = "O", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPOI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_OI.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPOI = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_OI.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPOID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_OID.Id, Operator = "Equals", Value = "O", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPOID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_OID.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPOID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_OID.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPII = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_II.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPII = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_II.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPII = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_II.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPIID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_IID.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPIID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_IID.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPIID = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_IID.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPIE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_IE.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPIE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_IE.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPIE = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_IE.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField TransportModeId_MOPIED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = TransportModeId.Id, ObjectTableRuleId = Master_OpClosed_Req_IE_D.Id, Operator = "Equals", Value = "I", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField Direction_MOPIED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = Master_OpClosed_Req_IE_D.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            RuleConditionField IsOperationalClosed_MOPIED = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = IsOperationalClosed.Id, ObjectTableRuleId = Master_OpClosed_Req_IE_D.Id, Operator = "Equals", Value = "True", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
            ...
            RuleConditionField IncotermRule_Driection = AddObjectTableRules.AddRuleConditionField(new RuleConditionFieldDetails() { ObjectFieldId = DirectionId.Id, ObjectTableRuleId = IncotermRule.Id, Operator = "Equals", Value = "E", Tenant = 0 }, RuleConditionFieldRepository, TenantRuleConditionFields);
