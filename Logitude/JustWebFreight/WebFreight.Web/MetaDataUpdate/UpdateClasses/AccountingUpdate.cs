...
namespace WebFreight.Web.MetaDataUpdate.GeneratedUpdate
{
    public class AccountingUpdate
    {
        ...
        private void LoadTextCodes_General(Dictionary<string, TextCode> textcodes)
        {
            ...
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "Accounting.General.O.ChildAdded", DefaultText = "The GLAccount- was added as a child ", LocalDefaultText = "הכרטיס - נוסף ככרטיס בן", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "O", }, textCodeRepository, textcodes);
        ...
        private void LoadTextCodes_GLAccounts(Dictionary<string, TextCode> textcodes)
        {
            ...
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "GLAccounts.O.CreditDetails", DefaultText = "Credit Details", LocalDefaultText = "נתוני אשראי בש”ח", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "O", }, textCodeRepository, textcodes);
            ...
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "GLAccounts.O.AccountingBalance", DefaultText = "Accounting Balance", LocalDefaultText = "יתרה חשבונאית", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "O", }, textCodeRepository, textcodes);
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "GLAccounts.O.CardIndex", DefaultText = "Card Index", LocalDefaultText = " הצג תכרטסת", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "O", }, textCodeRepository, textcodes);
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "GLAccounts.O.FutureChequesToday", DefaultText = "Future Cheques until Today", LocalDefaultText = "המחאות עתידיות עד היום", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "O", }, textCodeRepository, textcodes);
            ...
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "GLAccounts.O.FutureCheques", DefaultText = "Future Cheques", LocalDefaultText = "המחאות עתידיות", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "O", }, textCodeRepository, textcodes);
            ...
            AddTextCodes.AddTextCode(new TextCodeDetails() { Code = "GLAccounts.Q.InactiveCustomers", DefaultText = "Inactive Customers", LocalDefaultText = "לקוחות חסומים", ObjectTableId = objectTable.Id, Tenant = 0, TextCodeTypeCode = "MC", }, textCodeRepository, textcodes);
