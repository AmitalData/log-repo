...
namespace WebFreight.Web.ReportsWebServices.LogitudeReports.Accounting
{
    public class TaxDeductionReportPerVendorService
    {
        ...
        public byte[] GetData()
        {
            ...
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(TaxDeductionReportData));
        ...
        private TaxDeductionReportData BuildDataProvider()
        {
            ...
            TaxDeductionReportDataProvider deductionReportDataProvider = new TaxDeductionReportDataProvider(null, tenant, taxDeductionPerVendorReportParameters);
