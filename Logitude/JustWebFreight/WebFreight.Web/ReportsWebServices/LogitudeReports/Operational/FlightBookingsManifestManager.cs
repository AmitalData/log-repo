        ...
        private FlightBookingsManifestDataProvider LoadDataProvider()
        {
            ...
            if (filteredShipmentPackageList != null && filteredShipmentPackageList.Count > 0)
            {
                ...
                foreach (ShipmentJoinPackageList shipmentPackage in filteredShipmentPackageList)
                {
                    ...
                    myDataRecord.Transshipment1FromPortName = shipmentPackage.MainCarriageFromPortName;
                    myDataRecord.Transshipment1ToPortName = shipmentPackage.MainCarriageToPortName;
                    myDataRecord.Transshipment2FromPortName = shipmentPackage.MainCarriageFromPortName;
                    myDataRecord.Transshipment2ToPortName = shipmentPackage.MainCarriageToPortName;
                    myDataRecord.Transshipment3FromPortName = shipmentPackage.MainCarriageFromPortName;
                    myDataRecord.Transshipment3ToPortName = shipmentPackage.MainCarriageToPortName;
