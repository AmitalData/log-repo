/// <reference path="../Views/ShipmentViews/Documents.html" />
(function (jQuery) {
    ...
    jQuery.CurrentShipmentsList = null;
    jQuery.LogoSource = null;
        ...
        $.ajax({
            ...
            success: function (userdata) {
                ...
                if (!userdata.HasError) {
                    ...
                    $.Application.navigate("views/ShipmentsQueryView.html");
