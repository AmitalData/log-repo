                    ...
                    if (CacheManager.CacheWrapper.Get(entityName) == null)
                    {
                        entity = (from a in repository.context.Cards.Include("Customer").Include("Customer.SalesmanUser").Include("PartnerType").Include("SharedLogisticsInvitationStatus")
                                  ...
                                  select new CardPM()
                                  {
                                      ...
                                      Field1 = a.Customer !=null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field1" } : null,
                                      Field2 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field2" } : null,
                                      Field3 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field3" } : null,
                                      Field4 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field4" } : null,
                                      Field5 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field5" } : null,
                                      Field6 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field6" } : null,
                                      Field7 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field7" } : null,
                                      Field8 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field8" } : null,
                                      Field9 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field9" } : null,
                                      Field10 = a.Customer != null ? new CustomFieldClass { TableName = "Customer", FieldName = "Field10" } : null,
