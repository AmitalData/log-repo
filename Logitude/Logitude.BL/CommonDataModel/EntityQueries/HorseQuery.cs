...
namespace Logitude.BL.CommonDataModel.EntityQueries
{
    public class HorseQuery
    {
        ...
        {
            HorsePM horse = (from a in repository.context.Horses
        ...
        {
            IQueryable<HorsePM> ports = (from a in repository.context.Horses
        ...
        {
            IQueryable<HorseList> result = from a in iQueryable.Include("CountryOfBirth").Include("CreatedByUser").Include("CreatedByUser.Contact").Include("UpdatedByUser").Include("UpdatedByUser.Contact")
