    ...
    public class TenantQuery
    {
        ...
        public IQueryable<TenantPM> GetTenantPMs()
        {
            IQueryable<TenantPM> tenants = (from a in repository.context.Tenants.Include("Address").Include("PaymentTerm").Include("OtherChargesCurrency").Include("QuoteSaleCurrency").Include("AgentCard").Include("Currency").Include("ProfitCurrency").Include("FreightCurrency").Include("PasswordPolicy").Include("Address.Country").Include("LogBoxTenantSetting")
                                            select new TenantPM()
                                            {
                                                ...
                                                MasterExpFreigPrepaidCollectId = a.MasterExpFreigPrepaidCollectId,
                                                MasterImpFreiPrepaidCollectId = a.MasterImpFreiPrepaidCollectId,
                                                MasterExpOtherPrepaidCollectId = a.MasterExpOtherPrepaidCollectId,
                                                MasterImpOtherPrepaidCollectId = a.MasterImpOtherPrepaidCollectId,
                                                ...
                                                VatMandatoryForPotentialCust = a.VatMandatoryForPotentialCust,
                                                ...
                                                IsCorrespondRightToLeftEnabled = a.IsCorrespondRightToLeftEnabled,
                                                ...
                                                SCACCode = a.SCACCode,
                                                ExportQuotationsoIntegratedSys = a.ExportQuotationsoIntegratedSys,
                                                ...
                                                TransferQuotationsToUnfTrigger = a.TransferQuotationsToUnfTrigger,
                                                ...
                                                FTLRatio = a.FTLRatio,
                                                LTLRatio = a.LTLRatio,
                                                IsQuoteRequestActivateInShared = a.IsQuoteRequestActivateInShared,
            ...
            if (true)//HttpContext.Current != null)
            {
                if (CacheManager.CacheWrapper.Get(entityName) == null || !useCache)
                {
                    ...
                    TenantPM tenant = new TenantPM()
                    {
                        ...
                        MasterExpFreigPrepaidCollectId = tt.MasterExpFreigPrepaidCollectId,
                        MasterImpFreiPrepaidCollectId = tt.MasterImpFreiPrepaidCollectId,
                        MasterExpOtherPrepaidCollectId = tt.MasterExpOtherPrepaidCollectId,
                        MasterImpOtherPrepaidCollectId = tt.MasterImpOtherPrepaidCollectId,
                        ...
                        VatMandatoryForPotentialCust = tt.VatMandatoryForPotentialCust,
                        ...
                        IsCorrespondRightToLeftEnabled = tt.IsCorrespondRightToLeftEnabled,
                        ...
                        ExportQuotationsoIntegratedSys = tt.ExportQuotationsoIntegratedSys,
                        ...
                        TransferQuotationsToUnfTrigger = tt.TransferQuotationsToUnfTrigger,
                        ...
                        IsQuoteRequestActivateInShared = tt.IsQuoteRequestActivateInShared,
        ...
        public TenantPM GetTenantFromDB(int tenant)
        {
            ...
            if (myPOCO != null)
            {
                entityPM = new TenantPM()
                {
                    ...
                    MasterExpFreigPrepaidCollectId = myPOCO.MasterExpFreigPrepaidCollectId,
                    MasterImpFreiPrepaidCollectId = myPOCO.MasterImpFreiPrepaidCollectId,
                    MasterExpOtherPrepaidCollectId = myPOCO.MasterExpOtherPrepaidCollectId,
                    MasterImpOtherPrepaidCollectId = myPOCO.MasterImpOtherPrepaidCollectId,
                    ...
                    VatMandatoryForPotentialCust = myPOCO.VatMandatoryForPotentialCust,
                    ...
                    IsCorrespondRightToLeftEnabled = myPOCO.IsCorrespondRightToLeftEnabled,
                    ...
                    ExportQuotationsoIntegratedSys = myPOCO.ExportQuotationsoIntegratedSys,
                    ...
                    TransferQuotationsToUnfTrigger = myPOCO.TransferQuotationsToUnfTrigger,
                    ...
                    IsQuoteRequestActivateInShared = myPOCO.IsQuoteRequestActivateInShared,
        ...
        public void CopyFromTenant0(int tenant, int tenatToCopy)
        {
            ...
            foreach (var item in pocos)
            {
                ...
                myTenant.VatMandatoryForPotentialCust = item.VatMandatoryForPotentialCust;
