...
{
    public class AccountingPartnerValidating
    {
        public static void Validate(EntityPMs.AccountingPartnerPM entityPM, Card Card, ICommonDataContext myContext, bool isNewEntity)
        {
        ...
        private static void ValidateVatNumber(AccountingPartnerPM entityPM)
        {
