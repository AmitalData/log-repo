...
namespace Logitude.BL.CommonDataModel.Tools.Validating
{
    ...
    {
        public static void Validate(EntityPMs.CustomAgentPM entityPM, Card Card, ICommonDataContext myContext, bool isNewEntity)
        {
        ...
        private static void ValidateVatNumber(CustomAgentPM entityPM)
        {
