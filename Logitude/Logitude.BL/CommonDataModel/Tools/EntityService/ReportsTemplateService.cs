...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class ReportsTemplateService
    {
        bool isNewEntity;
        private int tenant;
        public ReportsTemplate Poco { get; set; }
        ...
        private ReportsTemplatePM entityPm;
        private ICommonDataContext objectContext;
        private ReportsTemplateRepository entityRepository;

        private ContactRepository contactRepository;

        private Contact loggedContact;
        public ReportsTemplateService(ICommonDataContext objectContext, int tenant)
        {
            this.tenant = tenant;
            this.ObjectContext = objectContext;
            this.entityRepository = new ReportsTemplateRepository(objectContext);
        ...
        public void Create(ReportsTemplatePM entityPM)
        {
            ...
            this.Poco = new ReportsTemplate();

            ReportsTemplateMapping.MapEntity(entityPM, Poco, isNewEntity);
            entityRepository.Add(Poco);
            entityRepository.SubmitChanges();
        }

        public void Update(ReportsTemplatePM entityPM)
        {
            ...
            this.Poco = entityRepository.GetSingleReportsTemplate(entityPM.Id, entityPm.Tenant);
            ReportsTemplateMapping.MapEntity(entityPM, Poco, isNewEntity);
