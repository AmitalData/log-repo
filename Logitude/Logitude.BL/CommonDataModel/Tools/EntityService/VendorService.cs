...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class VendorService
    {
        ...
        public void Create(VendorPM entityPM)
        {
            ...
            new EntityCustomFieldService(new EntityCustomFieldServiceArgs() { ObjectTableName = "Card", EntityId = entityPM.Id, Tenant = entityPM.Tenant, Type = "PM", Entities = new List<VendorPM> { entityPM }.Cast<object>().ToList() }).Update();
