...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class VendorService
    {
        bool isNewEntity;
        private int tenant;
        public Vendor entityPOCO { get; set; }
        private Card entityCard;
        private VendorPM entityPM;
        private Contact loggedContact;
        private CardRepository cardRepository;
        private VendorRepository entityRepository;
        ...
        public VendorService(ICommonDataContext objectContext,int tenant)
        {
            ...
            this.entityRepository = new VendorRepository(objectContext);
        ...
        public VendorService(ICommonDataContext objectContext, VendorPM entityPM, string loggedContactId)
        {
        ...
        public void Create(VendorPM entityPM)
        {
            this.entityPM = entityPM;
            ...
            {
                VendorTracing.Trace(entityPM, entityPOCO, isNewEntity);
            }

            VendorMapping.MapEntity(entityPM, entityPOCO, isNewEntity, entityCard);
            VendorValidating.Validate(entityPM, this.entityCard, objectContext, isNewEntity);

            cardRepository.Add(entityCard);
            entityRepository.Add(entityPOCO);
            entityRepository.SubmitChanges();
            new EntityCustomFieldService(new EntityCustomFieldServiceArgs() { ObjectTableName = "Vendor", EntityId = entityPM.Id, Tenant = entityPM.Tenant, Type = "PM", Entities = new List<VendorPM> { entityPM }.Cast<object>().ToList() }).Update();
        ...
        public void Update(VendorPM entityPM, bool mapComposition = false)
        {
            ...
            this.entityPOCO = entityRepository.GetSingleVendor(tenant, entityPM.Id);
            ...
            entityName = "Vendor" + entityPM.Id + entityPM.Tenant;
            entityPmName = "VendorPM" + entityPM.Id + entityPM.Tenant;
        ...
        private void InitializeComponent()
        {
            if (isNewEntity)
            {
                ...
                {
                    entityPM.Code = TableCounter.DoesCounterDefinitionExist("CADC", tenant, "VD")  ? TableCounter.GetNumber(tenant, "CADC", "VD", null, null, true) : CodeCounter.GetNumber("Vendor", tenant).ToString();
                }
        ...
        private void UpdateGLAccount(VendorPM entityPM, Vendor entityPOCO)
        {
