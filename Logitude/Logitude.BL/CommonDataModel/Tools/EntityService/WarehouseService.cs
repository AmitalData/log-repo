...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class WarehouseService
    {
        bool isNewEntity;
        private int tenant;
        public Warehouse entityPOCO { get; set; }
        private Card entityCard;
        private WarehousePM entityPM;
        private Contact loggedContact;
        private CardRepository cardRepository;
        private WarehouseRepository entityRepository;
        ...
        public WarehouseService(ICommonDataContext objectContext,int tenant)
        {
            ...
            this.entityRepository = new WarehouseRepository(objectContext);
        ...
        public WarehouseService(ICommonDataContext objectContext, WarehousePM entityPM, string loggedContactId)
        {
        ...
        public void Update(WarehousePM entityPM, bool mapComposition = false)
        {
            ...
            this.entityPOCO = entityRepository.GetSingleWarehouse(entityPM.Id);
