...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class AgentService
    {
        ...
        public void Create(AgentPM entityPM)
        {
            ...
            new EntityCustomFieldService(new EntityCustomFieldServiceArgs() { ObjectTableName = "Card", EntityId = entityPM.Id, Tenant = entityPM.Tenant, Type = "PM", Entities = new List<AgentPM> { entityPM }.Cast<object>().ToList() }).Update();
