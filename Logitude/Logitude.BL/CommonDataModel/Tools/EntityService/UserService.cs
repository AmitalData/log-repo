...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class UserService
    {
        ...
        public UserService(ICommonDataContext objectContext, int tenant)
        {
			...
			this.globalContext = GlobalContext.GetContext();
        ...
        public void Create(UserPM entityPM)
        {
            ...
            roleRepository = new RoleRepository(globalContext);
        ...
        private void UpdateRolePM(UserPM entityPM)
        {
            if (entityPM.RolePMLists != null && entityPM.RolePMLists.Count > 0)
            {
                ...
                {
                    IGlobalContext MyContext = GlobalContext.GetContext(entityPM.Tenant);
        ...
        private string GetUserRoles_Update()
        {
            ...
            if (contacttenant != null)
            {
                ...
                {
                    Role role = this.globalContext.Roles.Where(a => a.Id == contacttenantrole.RoleId && (a.Tenant == tenant || a.Tenant == 0)).FirstOrDefault();
