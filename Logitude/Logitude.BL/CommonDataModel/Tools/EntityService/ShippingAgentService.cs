...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class ShippingAgentService
    {
        bool isNewEntity;
        private int tenant;
        public ShippingAgent entityPOCO { get; set; }
        private Card entityCard;
        private ShippingAgentPM entityPM;
        private Contact loggedContact;
        private CardRepository cardRepository;
        private ShippingAgentRepository entityRepository;
        ...
        public void Create(ShippingAgentPM entityPM)
        {
            this.entityPM = entityPM;
            ...
            {
                ShippingAgentTracing.Trace(entityPM, entityPOCO, isNewEntity);
            }
        ...
        public void Update(ShippingAgentPM entityPM, bool mapComposition = false)
        {
            ...
            this.entityPOCO = entityRepository.GetSingleShippingAgent(tenant, entityPM.Id);
        ...
        private void InitializeComponent()
        {
            if (isNewEntity)
            {
                ...
                if (!entityPM.IsHybrid)
                {
                    ...
                    entityPM.Code = TableCounter.DoesCounterDefinitionExist("CADC", tenant, "SG") ? TableCounter.GetNumber(tenant, "CADC", "SG", null, counterAdditionalParameters, true) : CodeCounter.GetNumber("ShippingAgent", tenant).ToString();
                }
            }
