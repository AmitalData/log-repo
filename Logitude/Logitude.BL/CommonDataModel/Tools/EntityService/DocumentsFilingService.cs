...
namespace Logitude.BL.CommonDataModel.Tools.EntityService
{
    public class DocumentsFilingService
    {
        ...
        public void Create(DocumentsFilingPM theEntityPm, byte[] fileData = null, string loggedUserId = null, bool FromService = false, string documentId = null, bool isFromCloudDoc = false)
        {
            ...
            {
                AddToTasksQueue(theEntityPm, isNewEntity, loggedUserId, isFromCloudDoc);
            }
            foreach (DocumentsFilingMetaDataValuePM itemPM in entityPM.DocumentsFilingMetaDataValues)
            {
        ...
        public void AddToTasksQueue(DocumentsFilingPM extDocPM, bool isnew, string loggedUserId, bool isFromCloudDoc = false)
        {
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                bool sendHybridM = true;
                                 ...
                                 if (extDocPM.ExternalEntityName == "CFIFILEM" && !extDocPM.IsFromCloud && isConnectedToUniFreight && !isFromCloudDoc)
                                {
                                    sendHybridM = false;
