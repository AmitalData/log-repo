...
{
    public class ShippingLineCustomFilter
    {        
        public ShippingLineCustomFilter(int tenant)
        {
            this.Tenant = tenant;
        }
        ...
        public IQueryable<ShippingLine> GetFilteredQuery(QueryOperations operations, IQueryable<ShippingLine> queryableData)
        {
