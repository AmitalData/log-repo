...
{
    public class VendorCustomFilter
    {
        private int tenant;
         public VendorCustomFilter(int tenant)
        {
            this.Tenant = tenant;
        }
        ...
        public IQueryable<Vendor> GetFilteredQuery(QueryOperations operations, IQueryable<Vendor> queryableData)
        {
