        ...
        public static IQueryable<EntityLists.CardList> GetFilteredQuery(object compactSeachvalue, QueryOperations queryOperations, GenericFilter filter, IQueryable<EntityLists.CardList> entityLists, int tenant)
        {
            if (compactSeachvalue != null)
            {
                ...
                { 
                    ...
                    entityLists =  cardSearchFilter.GetFilteredQuery(new CardSearchFilterArgs() { SeachText = compactSeachvalue != null ? compactSeachvalue.ToString() : "", Tenant = tenant, QueryOperations = queryOperations, EntityLists = entityLists , Filter = filter ,SortByRecordDate = true});
                }
