...
{
    public class AccountingPartnerCustomFilter
    {
        private int tenant;
         public AccountingPartnerCustomFilter(int tenant)
        {
            this.Tenant = tenant;
        }
        ...
        public IQueryable<AccountingPartner> GetFilteredQuery(QueryOperations operations, IQueryable<AccountingPartner> queryableData)
        {
