...
{
    public class ShippingAgentCustomFilter
    {        
        public ShippingAgentCustomFilter(int tenant)
        {
            this.Tenant = tenant;
        }
        ...
        public IQueryable<ShippingAgent> GetFilteredQuery(QueryOperations operations, IQueryable<ShippingAgent> queryableData)
        {
            List<QueryFilterItem> queryFilters = operations.QueryFilterItems;
            List<ShippingAgent> result = new List<ShippingAgent>();
