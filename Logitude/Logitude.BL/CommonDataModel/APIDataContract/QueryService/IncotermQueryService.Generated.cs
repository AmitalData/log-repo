...
{ 
   public partial class IncotermQueryService
   {
		...
		public Incoterm GetIncotermById(string Id,int Tenant)
        { 
		    try
            {
				...
				return IncotermDataMapping(temp,Tenant);
			}
            catch (Exception ex)
            {
		...
		public IncotermPM IncotermDataMappingAndValidatin(Incoterm MyEntity,int Tenant,string ComputingPartnerName = "")
        {
		    try
            {
