...
{ 
   public partial class PackageTypeQueryService
   {
		...
		public PackageType GetPackageTypeById(string Id,int Tenant)
        { 
		    try
            {
				...
				return PackageTypeDataMapping(temp,Tenant);
			}
            catch (Exception ex)
            {
		...
		public PackageType GetPackageTypeByCode(string Code,int Tenant)
        { 
		    try
            {
		...
		public PackageTypePM PackageTypeDataMappingAndValidatin(PackageType MyEntity,int Tenant,string ComputingPartnerName = "")
        {
		    try
            {
