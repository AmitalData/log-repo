...
{ 
   public partial class WeightUnitQueryService
   {
   
		WeightUnitQuery query; 

        public WeightUnitQueryService(int tenant)
        {
		
			query = new WeightUnitQuery(tenant);
        }
		...
		public WeightUnit WeightUnitDataMapping(WeightUnitPM MyEntityPM,int Tenant,string ComputingPartnerName = "")
        {
		    try
            {
				   
				   var temp = new WeightUnit(); 
