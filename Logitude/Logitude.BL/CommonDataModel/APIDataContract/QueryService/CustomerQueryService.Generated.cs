    ...
    public partial class CustomerQueryService
    {
        ...
        public Customer CustomerDataMapping(CardPM MyEntityPM, int Tenant, string ComputingPartnerName = "")
        {
            try
            {
                ...
                //{
                //    IGLAccountQueryServiceExt GLAccountService2 = ContainerAccessor.Container.Resolve(typeof(IGLAccountQueryServiceExt), "GLAccountQueryServiceExt", new ParameterOverride("", 1)) as IGLAccountQueryServiceExt;
                //    temp.GLAccount = GLAccountService2.GetSingleGLAccountPM(MyEntityPM.GLAccountId, Tenant);
