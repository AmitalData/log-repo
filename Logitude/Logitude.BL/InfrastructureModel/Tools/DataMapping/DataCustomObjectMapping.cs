...
namespace Logitude.BL.InfrastructureModel.Tools.DataMapping
{
    public class DataCustomObjectMapping
    {
        ...
        public static void MapEntity(DataCustomObjectPM entityPM, DataCustomObject entityPOCO, bool isNewState)
        {
            if (isNewState)
            {
        ...
        private static void MapCustomFieldValue( string fieldName, DataCustomObjectPM entityPM, DataCustomObject entityPOCO)
        {
