...
namespace Logitude.BL.InfrastructureModel.EntityPMs
{
    ...
    public class ObjectFieldPM
    {
        ...
        public string ListTextCodeDefaultText { get; set; }
        public string HelpTextCodeDefaultText { get; set; }
        ...
        public bool TenantZeroIsRequired { get; set; }
        public int TenantZeroMaxLength { get; set; }
        public int TenantZeroMinLength { get; set; }
        public bool RestorDefault { get; set; }
        ...
        public string ShortNameTextCodeDefaultText { get; set; }
        ...
        public string FullLabelTranslatedText { get; set; }
        public string ShortLabelTranslatedText { get; set; }
        public string ListHeaderLabelTranslatedText { get; set; }
        public string HelpTextTranslatedText { get; set; }

        public string FullLabelFieldTranslationId { get; set; }
        public string ShortLabelFieldTranslationId { get; set; }
        public string ListHeaderLabelFieldTranslationId { get; set; }
