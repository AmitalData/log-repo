...
namespace Logitude.BL.InfrastructureModel.EntityQueries
{
    public class MultiEntityUpdateLogQuery
    {
        ...
        {
            MultiEntityUpdateLogPM multiEntityUpdateLogPM = (from a in repository.context.MultiEntityUpdateLogs
            ...
            if(multiEntityUpdateLogPM != null && !string.IsNullOrEmpty(multiEntityUpdateLogPM.XMLData))
                multiEntityUpdateLogPM.MultiEntityUpdateData = LogitudeXmlSerializer.DeserializeObject<MultiEntityUpdateData>(multiEntityUpdateLogPM.XMLData);
