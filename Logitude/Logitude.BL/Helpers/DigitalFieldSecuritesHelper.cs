...
namespace Logitude.BL.Helpers
{
    public class DigitalFieldSecuritesHelper
    {
        public List<DigitalTextCodeObject> GetDigitalTextCodeObjects(int tenant, string objectTableId, string profileCode, bool isTranslation)
        {
            ...
            var defaultTextCode = digitalTextCodeRepository.GetDigitalTextCodes(0, objectTableId, profileCode).FirstOrDefault();
            ...
            if (tenant != 0)
            {
                var customTextCodes = digitalTextCodeRepository.GetDigitalTextCodes(tenant, objectTableId, profileCode).FirstOrDefault();
