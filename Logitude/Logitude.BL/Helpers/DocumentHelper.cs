...
namespace Logitude.BL.Helpers
{
    public class DocumentHelper
    {
               ...
               TenantRepository tenantRepository = new TenantRepository(tenant);
                ...
                if (document != null)
                {
                    ...
                    if (signBytes != null)
                    {
                        ...
                        this.HSMSignatureSucceeded(invoice, repository, contactEmail, document, myDocumentFilings.Id);
        ...
        private void HSMSignatureSucceeded(ARInvoice invoice, ARInvoiceRepository repository,string contactEmail,Document document,string  DocumentFilingId )
        {
            ...
            this.SendToEmailContact(contactEmail, invoice, document, DocumentFilingId, repository, invoice.Tenant);
...
,
        ...
        private void SendToEmailContact(string email, ARInvoice arinvoice, Document document,string DocumentFilingId, ARInvoiceRepository repository,int tenant)
        {
            ...
            try {
                ...
                string documentId=this.SendHtmlDocument(bytedata, DocumentFilingId, null, tenant, email, "חשבונית חתומה", null, null, userId, arinvoice.Id, LoggingObjectTableId, document.Id+","+ documentInterestReportId, null, null, null);
