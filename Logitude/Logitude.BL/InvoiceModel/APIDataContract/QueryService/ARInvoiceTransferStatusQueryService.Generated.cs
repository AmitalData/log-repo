...
{ 
   public partial class ARInvoiceTransferStatusQueryService
   {
		...
		public ARInvoiceTransferStatusPM ARInvoiceTransferStatusDataMappingAndValidatin(ARInvoiceTransferStatus MyEntity,int Tenant,string ComputingPartnerName = "")
        {
		    try
            {
