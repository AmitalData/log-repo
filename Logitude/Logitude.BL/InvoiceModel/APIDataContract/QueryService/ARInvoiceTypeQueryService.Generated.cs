...
{ 
   public partial class ARInvoiceTypeQueryService
   {
   
		ARInvoiceTypeQuery query; 

        public ARInvoiceTypeQueryService(int tenant)
        {
		
			query = new ARInvoiceTypeQuery(tenant);
        }
		...
		public ARInvoiceType ARInvoiceTypeDataMapping(ARInvoiceTypePM MyEntityPM,int Tenant,string ComputingPartnerName = "")
        {
		    try
            {
				   
				   var temp = new ARInvoiceType(); 
