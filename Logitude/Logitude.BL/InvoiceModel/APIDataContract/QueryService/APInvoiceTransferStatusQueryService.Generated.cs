...
{ 
   public partial class APInvoiceTransferStatusQueryService
   {
		...
		public APInvoiceTransferStatus GetAPInvoiceTransferStatusByCode(string Code,int Tenant)
        { 
		    try
            {
				...
				return APInvoiceTransferStatusDataMapping(temp,Tenant);
			}
            catch (Exception ex)
            {
		...
		public APInvoiceTransferStatusPM APInvoiceTransferStatusDataMappingAndValidatin(APInvoiceTransferStatus MyEntity,int Tenant,string ComputingPartnerName = "")
        {
		    try
            {
