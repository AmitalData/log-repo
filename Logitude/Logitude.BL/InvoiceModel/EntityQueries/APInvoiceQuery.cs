...
namespace Logitude.BL.InvoiceModel.EntityQueries
{
    public class APInvoiceQuery
    {
        ...
        {
            APInvoicePM entityPM = (from a in repository.context.APInvoices
        ...
        public IQueryable<APInvoiceList> GetIQueryableEntityList(IQueryable<APInvoice> iQueryable)
        {
            ...
            var result = from a in iQueryable.Include("Status").Include("LocalCurrency").Include("InvoiceCurrency").Include("ProfitCurrency").Include("VendorCard").Include("PaymentTerm").Include("TransferStatus").Include("CreatedByUser").Include("CreatedByUser.Contact").Include("UpdatedByUser").Include("UpdatedByUser.Contact").Include("ApprovedByUser").Include("ApprovedByUser.Contact")
        ...
        public IQueryable<APInvoiceList> GetUnpaidAPInvoices(int tenant)
        {
            ...
            var query = from a in repository.context.APInvoices.Include("InvoiceCurrency").Include("LocalCurrency").Include("TransferStatus").Include("ApprovedByUser").Include("ApprovedByUser.Contact")
