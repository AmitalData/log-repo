...
{
    public class MasavBatchTransmissionTask : BatchTaskExecutionsService
    {
        public MasavBatchTransmissionTask(BatchTaskExecutionPM batchTaskExecution) : base(batchTaskExecution) { }
        ...
        public override void RunCode()
        {
            try
            {
                ...
                using (TransactionScope scope = TransactionFactory.GetTransaction())
                {
                    ...
                    masavInterfaceService.Transmit(args.MasavInterfaceId, args.Tenant);
                    scope.Complete();
                }
            }
            catch (Exception ex)
    ...
    public class MasavBatchTransmissionTaskArgs
    {
