    ...
    {               
        ...
        private void UpdateCashBook(APPaymentPM theEntityPm)
        {
            if (theEntityPm.PaymentMethodCode == "CA")
            {
                ...
                if (cashBook != null)
                {
                    if(cashBook.TotalAmount >= ((decimal)theEntityPm.AmountInPaymentCurrency - (decimal)theEntityPm.TaxDeductionLocalAmount))
                    {
                        // Update Total Amount
                        ...
                        cashBook.TotalAmount -= ((decimal)theEntityPm.AmountInPaymentCurrency - (decimal)theEntityPm.TaxDeductionLocalAmount);
