...
namespace Logitude.BL.InvoiceModel.Tools.DataMapping
{
    public class APInvoiceMapping
    {
        ...
        public static void MapInvoiceLine(APInvoiceLinePM entityPM, APInvoiceLine entity, bool isNewState)
        {
            ...
            double? LocalAmountWithVatRecognized = (entityPM.VatRecognizedPercentage == null || entityPM.VatRecognizedPercentage == 0) ? entityPM.VatPercentage==null? entityPM.LocalCurrencyAmount : entityPM.LocalCurrencyAmount + ((entityPM.VatPercentage / 100) * entityPM.LocalCurrencyAmount) : (entityPM.LocalCurrencyAmount + ((entityPM.VatPercentage / 100) * ((1 - entityPM.VatRecognizedPercentage) * entityPM.LocalCurrencyAmount)));
