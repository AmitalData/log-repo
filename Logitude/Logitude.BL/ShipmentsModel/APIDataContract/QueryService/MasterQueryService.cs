...
namespace Logitude.BL.ShipmentsModel.APIDataContract.ApiV1
{
    ...
    {
        public ShipmentPM MasterCustomDataMappingAndValidatin(Master MyEntity, int Tenant, string ComputingPartnerCode = "")
        {
            try
            {
                ...
                ShipmentPM temp = MasterDataMappingAndValidatin(MyEntity, Tenant, ComputingPartnerCode);
