        ...
        public ShipmentPM DirectDataMappingAndValidatin(Direct MyEntity, int Tenant, string ComputingPartnerName = "")
        {
            try
            {
                ...
                if (MyEntity.Deliveries != null && MyEntity.Deliveries.Count > 0)
                {
                    ...
                    temp.ShipmentDeliveries = DeliveryService29.DeliveryDataMappingAndValidatin(MyEntity.Deliveries, Tenant, ComputingPartnerName);
                }
                ...
                if (MyEntity.PickUps != null && MyEntity.PickUps.Count > 0)
                {
                    ...
                    temp.ShipmentPickUps = PickUpService29.PickUpDataMappingAndValidatin(MyEntity.PickUps, Tenant, ComputingPartnerName);
                }
                ...
                if (MyEntity.Receivables != null && MyEntity.Receivables.Count > 0)
                {
                    ...
                    temp.ShipmentReceivables = ReceivableService29.ReceivableDataMappingAndValidatin(MyEntity.Receivables, Tenant, ComputingPartnerName);
                }
                ...
                if (MyEntity.Payables != null && MyEntity.Payables.Count > 0)
                {
                    ...
                    temp.ShipmentPayables = PayableService29.PayableDataMappingAndValidatin(MyEntity.Payables, Tenant, ComputingPartnerName);
                }
