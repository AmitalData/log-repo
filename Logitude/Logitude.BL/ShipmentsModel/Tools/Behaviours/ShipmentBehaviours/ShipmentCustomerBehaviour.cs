...
namespace Logitude.BL.ShipmentsModel.Tools.Behaviours.ShipmentBehaviours
{
    public class ShipmentCustomerBehaviour : IServiceBehaviour
    {
        ...
        public void Handle(IServiceInitializer initializer)
        {
            ...
            this.entityPOCO = this.initializer.EntityPOCO;
        ...
        private void MapShipper()
        {
            if (!entityPM.IsImporterShipment)
            {
                ...
                entityPM.CustomerReference2 = entityPM.IsHybrid ? entityPOCO?.CustomerReference2 : entityPM.ShipperReference2;
        ...
        private void MapConsignee()
        {
            ...
            entityPM.CustomerReference2 = entityPM.IsHybrid ? entityPOCO?.CustomerReference2 : entityPM.ConsigneeReference2;
        ...
        private void MapAgent()
        {
            ...
            entityPM.CustomerReference2 = entityPM.IsHybrid ? entityPOCO?.CustomerReference2 : entityPM.AgentReference2;
        ...
        private void MapNotify1()
        {
            ...
            entityPM.CustomerReference2 = entityPM.IsHybrid ? entityPOCO?.CustomerReference2 : entityPM.Notify1Reference2;
            //entityPM.CustomerReference3 = null;
        }
        ...
        private void MapShipperNotExporter()
        {
            ...
            entityPM.CustomerReference2 = entityPM.IsHybrid ? entityPOCO?.CustomerReference2 : entityPM.ShipperNotExporterReference2;
            //entityPM.CustomerReference3 = null;
        }
