...
namespace Logitude.BL.ShipmentsModel.Tools.DataMapping
{
    public partial class ShipmentMapping
    {
        ...
        public static void MapEntityForUpdate(ShipmentPM entityPM, Shipment entityPoco, List<FieldChange> fieldChanges)
        {
            entityPoco.ShipmentNumber = entityPM.ShipmentNumber;
            ...
            if (string.IsNullOrEmpty(entityPoco.House))
            {
                FieldChange.Add(entityPoco.House, entityPM.House, nameof(entityPM.House), fieldChanges);
                entityPoco.House = entityPM.House;
            }
            ...
            if (string.IsNullOrEmpty(entityPoco.IskaNumber))
            {
                FieldChange.Add(entityPoco.IskaNumber, entityPM.IskaNumber, nameof(entityPM.IskaNumber), fieldChanges);
                entityPoco.IskaNumber = entityPM.IskaNumber;
            }
            ...
            if (entityPoco.GrossWeight == null)
            {
                FieldChange.Add(entityPoco.GrossWeight, entityPM.GrossWeight, nameof(entityPM.GrossWeight), fieldChanges);
            ...
            if (entityPoco.ChargeableWeight == null)
            {
                FieldChange.Add(entityPoco.ChargeableWeight, entityPM.ChargeableWeight, nameof(entityPM.ChargeableWeight), fieldChanges);
            ...
            entityPM.VolumeUnitCode = "CBM";
            if (entityPoco.Volume == null && entityPM.Volume != null)
            {
                FieldChange.Add(entityPoco.Volume, entityPM.Volume, nameof(entityPM.Volume), fieldChanges);
                entityPoco.Volume = entityPM.Volume;
                ...
                entityPM.VolumetricWeight = entityPM.Volume / 1000;
                FieldChange.Add(entityPoco.VolumetricWeight, entityPM.VolumetricWeight, nameof(entityPM.VolumetricWeight), fieldChanges);
                entityPoco.VolumetricWeight = entityPM.VolumetricWeight;
            }
            else
            ...
            if (entityPoco.NumberOfPackages == null)
            {
                FieldChange.Add(entityPoco.NumberOfPackages, entityPM.NumberOfPackages, nameof(entityPM.NumberOfPackages), fieldChanges);
                entityPoco.NumberOfPackages = entityPM.NumberOfPackages;
            }
            else
            {
            ...
            if (string.IsNullOrEmpty(entityPoco.FreightForwarderId))
            {
                FieldChange.Add(entityPoco.FreightForwarderId, entityPM.FreightForwarderId, nameof(entityPM.FreightForwarderId), fieldChanges);
                entityPoco.FreightForwarderId = entityPM.FreightForwarderId;
            }
