...
namespace Logitude.BL.ShipmentsModel.Tools.DataMapping
{
    public partial class ShipmentMapping
    {
        public static void MapContainer(ContainerPM containerPM, Container container, bool isNewEntity)
        {
            ...
            container.ShipmentPreCarriageFrom = containerPM.ShipmentPreCarriageFrom;
            container.ShipmentPreCarriageTo = containerPM.ShipmentPreCarriageTo;
            container.ShipmentMainCarriageFrom = containerPM.ShipmentMainCarriageFrom;
            container.ShipmentMainCarriageTo = containerPM.ShipmentMainCarriageTo;
            container.ShipmentTransshipment1From = containerPM.ShipmentTransshipment1From;
            container.ShipmentTransshipment1To = containerPM.ShipmentTransshipment1To;
            container.ShipmentTransshipment2From = containerPM.ShipmentTransshipment2From;
            container.ShipmentTransshipment2To = containerPM.ShipmentTransshipment2To;
            container.ShipmentTransshipment3From = containerPM.ShipmentTransshipment3From;
            container.ShipmentTransshipment3To = containerPM.ShipmentTransshipment3To;
            container.ShipmentOnCarriageFrom = containerPM.ShipmentOnCarriageFrom;
