    ...
    public class QuoteQuery
    {
        ...
        private QuoteSaleChargePM MapChargePMToSaleChargePM(QuoteChargePM item)
        {
            QuoteSaleChargePM saleChargePM = new QuoteSaleChargePM()
            {
                ...
                ChargesGroupCode = item.ChargesGroupCode,
                CurrencyId = item.CostMeasurementShortName != "Fixed" ? item.CostCurrencyId : item.SaleCurrencyId,
                CurrencyCode = item.CostMeasurementShortName != "Fixed" ? item.CostCurrencyCode : item.SaleCurrencyCode,
                SaleExchangeRate = item.CostMeasurementShortName != "Fixed" ? item.CostExchangeRate : item.SaleExchangeRate,
                MarkUpTypeCode = item.MarkUpTypeCode,
                MarkUpValue = item.MarkUpValue,
                ...
                ContainerType4MarkUpValue = item.ContainerType4MarkUpValue,
                ContainerType5MarkUpValue = item.ContainerType5MarkUpValue,
                SaleMeasurementId = item.CostMeasurementShortName != "Fixed" ? item.CostMeasurementId : item.SaleMeasurementId,
                SaleMeasurementCode = item.CostMeasurementShortName != "Fixed" ? item.CostMeasurementCode : item.SaleMeasurementCode,
                SaleMeasurementShortName = item.CostMeasurementShortName != "Fixed" ? item.CostMeasurementShortName : item.SaleMeasurementShortName,
                SaleMeasurementLocalName = item.SaleMeasurementLocalName,
                SaleQuantity = item.CostMeasurementShortName != "Fixed" ? item.CostQuantity : item.SaleQuantity,
                SaleUnitPrice = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPrice : item.SaleUnitPrice,
                SaleTotalAmount = item.CostMeasurementShortName != "Fixed" ? item.CostTotalAmount : item.SaleTotalAmount,
                SaleTotalAmountLocal = item.CostMeasurementShortName != "Fixed" ? item.CostTotalAmountLocal : item.SaleTotalAmountLocal,
                SaleContainerType1UnitPrice = item.CostMeasurementShortName != "Fixed" ? item.CostContainerType1UnitPrice : item.SaleContainerType1UnitPrice,
                SaleContainerType2UnitPrice = item.CostMeasurementShortName != "Fixed" ? item.CostContainerType2UnitPrice : item.SaleContainerType2UnitPrice,
                SaleContainerType3UnitPrice = item.CostMeasurementShortName != "Fixed" ? item.CostContainerType3UnitPrice : item.SaleContainerType3UnitPrice,
                SaleContainerType4UnitPrice = item.CostMeasurementShortName != "Fixed" ? item.CostContainerType4UnitPrice : item.SaleContainerType4UnitPrice,
                SaleContainerType5UnitPrice = item.CostMeasurementShortName != "Fixed" ? item.CostContainerType5UnitPrice : item.SaleContainerType5UnitPrice,
                VatTypeId = item.VatTypeId,
                VatPercentage = item.VatPercentage,
                VatTypeName = item.VatTypeName,
                VatAmount = item.VatAmount,
                UOMPercentage = item.CostMeasurementShortName != "Fixed" ? (item.CostMeasurementCode == "PRVL" || item.CostMeasurementCode == "PRFR" ? "%" : "" ): (item.SaleMeasurementCode == "PRVL" || item.SaleMeasurementCode == "PRFR" ? "%" : ""),
                SaleUnitPriceInSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPriceInSaleCurrency : item.SaleUnitPriceInSaleCurrency,
                SaleUnitPrice1InSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPrice1InSaleCurrency : item.SaleUnitPrice1InSaleCurrency,
                SaleUnitPrice2InSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPrice2InSaleCurrency : item.SaleUnitPrice2InSaleCurrency,
                SaleUnitPrice3InSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPrice3InSaleCurrency : item.SaleUnitPrice3InSaleCurrency,
                SaleUnitPrice4InSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPrice4InSaleCurrency : item.SaleUnitPrice4InSaleCurrency,
                SaleUnitPrice5InSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostUnitPrice5InSaleCurrency : item.SaleUnitPrice5InSaleCurrency,
                SaleAmountInSaleCurrency = item.CostMeasurementShortName != "Fixed" ? item.CostAmountInSaleCurrency : item.SaleAmountInSaleCurrency,
                CostMinAmount = item.CostMinAmount,
                CostMaxAmount = item.CostMaxAmount,
                SaleMinAmount = item.CostMeasurementShortName != "Fixed" ? item.CostMinAmount : item.SaleMinAmount,
                SaleMaxAmount = item.CostMeasurementShortName != "Fixed" ? item.CostMaxAmount : item.SaleMaxAmount,
                IsRegionalTax = item.IsRegionalTax,
                MarkUpText = this.GetMarkUpText(item.MarkUpValue, item.MarkUpTypeCode),
                ContainerType1MarkUpText = this.GetMarkUpText(item.ContainerType1MarkUpValue, item.ContainerType1MarkUpTypeCode),
                ContainerType2MarkUpText = this.GetMarkUpText(item.ContainerType2MarkUpValue, item.ContainerType2MarkUpTypeCode),
                ...
                SalesWithVATAmount = (item.CostMeasurementShortName != "Fixed" ? item.CostTotalAmount : item.SaleTotalAmount) + item.VatAmount,
            };
            return saleChargePM;
        }
    }
