        ...
        public QuoteTemplateSettingPM GetSinglePM(string id, int tenant)
        {
            ...
            entity = (from a in repository.quotesContext.QuoteTemplateSettings
                      ...
                      select new QuoteTemplateSettingPM()
                      {
                          ...
                          ShowUnitsContainers = a.ShowUnitsContainers,
                          ...
                          XMLData = a.XMLData,
                          ShowSaleIncludingVATContainers = a.ShowSaleIncludingVATContainers,
                          ShowSaleIncludingVATPackages = a.ShowSaleIncludingVATPackages,
                          ShowLocalSaleIncludingVATContainers = a.ShowLocalSaleIncludingVATContainers,
                          ShowLocalSaleIncludingVATPackages = a.ShowLocalSaleIncludingVATPackages,
                      }).FirstOrDefault();
            entity.QuoteTemplateSettingData = LogitudeXmlSerializer.DeserializeObject<QuoteTemplateSettingData>(entity.XMLData);
            entity.QuoteTemplateSettingData = new QuoteTemplateSettingDataBuilder(entity).UpdateQuoteTemplateSettingData(entity.QuoteTemplateSettingData);
            return entity;
        }
        ...
        public IQueryable<QuoteTemplateSettingList> GetIQueryableEntityList(IQueryable<QuoteTemplateSetting> iQueryable)
        {
            IQueryable<QuoteTemplateSettingList> result = from quoteTemplateSetting in iQueryable
                                                          select new QuoteTemplateSettingList()
                                                          {
                                                              ...
                                                              ShowSaleIncludingVATContainers = quoteTemplateSetting.ShowSaleIncludingVATContainers,
                                                              ShowSaleIncludingVATPackages = quoteTemplateSetting.ShowSaleIncludingVATPackages,
                                                              ShowLocalSaleIncludingVATContainers = quoteTemplateSetting.ShowLocalSaleIncludingVATContainers,
                                                              ShowLocalSaleIncludingVATPackages = quoteTemplateSetting.ShowLocalSaleIncludingVATPackages,
                                                          };
            return result;
        }
