                ...
                if (CacheManager.CacheWrapper.Get(entityName) == null)
                {
                    TenantManagementPM tenant = (from a in repository.context.TenantManagements.Include("GlobalTenant").Include("BluesnapContract")
                                                 ...
                                                 select new TenantManagementPM()
                                                 {
                                                     ...
                                                     AgentSharedLogStatistiLastDate = a.AgentSharedLogStatistiLastDate,
                                                     AgentSharedLogisticsLastWeek = a.AgentSharedLogisticsLastWeek,
                                                     AgentSharedLogStatistLastMonth = a.AgentSharedLogStatistLastMonth,
        ...
        public TenantManagementList MapSingleList(TenantManagement entity)
        {
            ...
            if (entity != null)
            {
                myResult = new TenantManagementList()
                {
                    ...
                    AgentSharedLogStatistiLastDate = entity.AgentSharedLogStatistiLastDate,
                    AgentSharedLogisticsLastWeek = entity.AgentSharedLogisticsLastWeek,
                    AgentSharedLogStatistLastMonth = entity.AgentSharedLogStatistLastMonth,
