...
namespace Logitude.Server.Tools.Helpers
{
    public static class IQueryableExtensions
    {
        ...
        {
            NetCommonHelper.Logger.DevLog.Instance.WriteTrace(string.Format("{0} Query \r\n {1} ", funcOrQueryName, query.ToTraceQuery()));
            ...
            NetCommonHelper.Logger.DevLog.Instance.WriteTrace(string.Format("{0} SUM duration {1} seconds ",funcOrQueryName, (DateTime.Now - start).TotalSeconds));
