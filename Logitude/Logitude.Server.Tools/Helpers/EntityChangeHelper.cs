...
namespace Logitude.Server.Tools.Helpers
{
    public class EntityChangeHelper
    {
        ...
        {
            bool result = false;
            if (SettingUtil.DeploymentStage.IsDBStage(SettingUtil.DeploymentStage.Development) || SettingUtil.DeploymentStage.IsDBStage(SettingUtil.DeploymentStage.Logbox) || LogitudeSettings.LogitudeURL == "http://localhost:9996")
            {
                result = true;
            }
            return result;
