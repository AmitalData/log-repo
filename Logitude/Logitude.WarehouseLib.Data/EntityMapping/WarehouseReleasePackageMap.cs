...
namespace Logitude.WarehouseLib.Data.EntityMapping
{
    ...
    public class WarehouseReleasePackageMap : EntityTypeConfiguration<WarehouseReleasePackage>
    {
	    string dbms;
        public WarehouseReleasePackageMap()
        { 
				this.ToTable("WarehouseReleasePackages");
            ...
            this.Property(t => t.WarehouseReleaseId).HasColumnName("WarehouseReleaseId").IsRequired().HasMaxLength(15).IsUnicode(false);
