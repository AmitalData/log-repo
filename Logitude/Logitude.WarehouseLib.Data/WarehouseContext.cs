...
{
   public class WarehouseContext: DbContextBase, IWarehouseContext
    {
        ...
        public WarehouseContext(DbConnection conn)
            : base(conn,true)
        {
        ...
        public static IWarehouseContext GetContext(int tenant)
        {           
            GlobalDB currentDb;
