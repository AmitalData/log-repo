...
{
   public partial class ShipmentOrderValidationClass : IShipmentOrderValidateContext
    {
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            Validators.ShipmentOrderValidationClass temp = new Validators.ShipmentOrderValidationClass(objectTableName, tenant);
