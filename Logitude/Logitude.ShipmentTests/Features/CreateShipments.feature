...
Scenario: Create a master shipment
	Given A master shipment fields
		| NewConcurrencyGUID       | DirectionId | TransportModeId | ShipmentLevelCode | BranchId | DepartmentId | FreightPrepaidCollectId | OtherPrepaidCollectId | CreatedByUserId | UpdatedByUserId | MainCarriageToPortId | MainCarriageFromPortId |
		| Guid.NewGuid().ToString()| E           | A               | C                 | 1-1102   | 1-2988       | P                       | C                     | 1-108265        | 1-108265        | 1-300930             |1-303023                |
