...
export class CargoTrackingShipmentMappedPM {
    ...
    // additional fields:
    public CustomsBrokerReference: string;
    public CustomsData: ShipmentCustomsData;
    ...
    public ForwardingMaster: string;
    public Milestones: Milestone[] = [];

    public IncotermName: string;
    public FutureMilstoneCode: string;
    public FutureMilstoneDate: Date;
    ...
    public RouteToPortName: string;
    public RouteFromPortName: string;
