...
@Component({
    ...
    styleUrls: [
        './dashboard-shipments.component.css',
        './dashboard-shipments.component.mobile.css',
        './dashboard-shipments.component.tablet.css'
    ],
...
export class ShipmentDataSource extends DataSource<any | undefined> {
    ...
    constructor(
        ...
        private parent: DashboardShipmentsComponent,
