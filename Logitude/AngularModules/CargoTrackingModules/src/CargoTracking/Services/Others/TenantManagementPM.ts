export class TenantManagementPM {
	...
	private tenantManagementLicenses: any[];
    ...
    set  TenantManagementLicenses(newValue: any[]) {
        if (this.tenantManagementLicenses != newValue) {
            this.tenantManagementLicenses = newValue;
        }
    }
    public AddTenantManagementLicensePM(item: any) {
        if (item != null) {
    ...
    public RemoveTenantManagementLicensePM(item: any) {
        if (item != null) {
            var index = this.TenantManagementLicenses.indexOf(item);
            if (index > -1) {
    ...
    set  AddOns(newValue: any[]) {
        if (this.addOns != newValue) {
            this.addOns = newValue;
        }
    }
    public AddTenantAddOnPM(item: any) {
        if (item != null) {
    ...
    public RemoveTenantAddOnPM(item: any) {
        if (item != null) {
            var index = this.AddOns.indexOf(item);
            if (index > -1) {
