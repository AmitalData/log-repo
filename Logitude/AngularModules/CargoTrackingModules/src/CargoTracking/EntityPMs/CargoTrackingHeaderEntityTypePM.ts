...
export class CargoTrackingHeaderEntityTypePM {
    ...
    public OldEntityPM: CargoTrackingHeaderEntityTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CargoTrackingHeaderEntityType");
           
        }
       }
    }

    private MyClone: CargoTrackingHeaderEntityTypePM;
