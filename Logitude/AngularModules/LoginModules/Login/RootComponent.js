...
var RootComponent = /** @class */ (function () {
    ...
    function RootComponent(compiler, resolver, http) {
        ...
        DynamicLoaderTSC_1.DynamicLoaderTSC.Compiler = compiler;
        DynamicLoaderTSC_1.DynamicLoaderTSC.Resolver = resolver;
        Tools_1.Tools.DynamicLoader = DynamicLoaderTSC_1.DynamicLoaderTSC;
    ...
    RootComponent.prototype.LoadLoginPage = function () {
        ...
        if (!this.isDSV) {
            if (this.ResetPWD == "true") {
                DynamicLoaderTSC_1.DynamicLoaderTSC.Load("./Login/Components/ChangePasswordComponent", this.location)
            ...
            if (this.ResetPWD == "true") {
                DynamicLoaderTSC_1.DynamicLoaderTSC.Load("./Login/Components/DSVChangePasswordComponent", this.location)
                    .then(function (cmpRef) {
                    window.sessionStorage.setItem("ResetPWD", "false");
                });
            }
    ...
    RootComponent.prototype.LoadDSVMobileLoginPage = function () {
        DynamicLoaderTSC_1.DynamicLoaderTSC.Load("./Login/Components/DSVMobileLoginComponent", this.location)
            .then(function (cmpRef) { });
    };
    __decorate([
