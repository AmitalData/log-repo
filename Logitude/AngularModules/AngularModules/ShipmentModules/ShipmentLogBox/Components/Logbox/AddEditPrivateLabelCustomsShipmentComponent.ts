...
@Component({
    ...
    templateUrl: './AddEditPrivateLabelCustomsShipmentComponent.html',
    selector: 'AddEditPrivateLabelShipment',
    //providers: [Http, ServiceArgs, EntityListService]
})

export class AddEditPrivateLabelCustomsShipmentComponent extends BaseComponent implements OnInit, AfterViewInit {
    private myShipmentDomainService: ShipmentDomainService;
    EntityPM: ShipmentPM = new ShipmentPM();
    DataContext: AddEditPrivateLabelCustomsShipmentComponent = this;
