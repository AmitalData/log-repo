...
export class ConnectionsTabComponent implements OnInit, OnDestroy {
    ...
    DisconnectQuote() {
        ...
        if (isPayablesConnectedToInvoice || isReceivablesConnectedToInvoice) {
            ...
            messageWindow.Show("You cannot disconnecting a quote to this shipment while some Receivables/Payables generated from a different quote are connected to an invoice.");
        }
        else {
