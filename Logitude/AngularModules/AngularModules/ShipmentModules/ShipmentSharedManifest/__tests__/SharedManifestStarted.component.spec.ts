...
describe('SharedManifestStarted', () => {
    ...
    it('collects validation errors when mandatory partners missing', () => {
    ...
    it('enables sharing when agent status is active', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
        const shipment = createShipment();
        component.UpdateAgent = jest.fn();
    ...
    it('shows wait message when status is W', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
        const shipment = createShipment();
    ...
    it('handles inactive status I as error', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
        const shipment = createShipment();
    ...
    it('starts sharing manifest and logs activity', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
    ...
    it('captures share errors', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
        component.EntityPM = createShipment() as any;
        manifestService.ShareAgentManifest.mockReturnValue(
            of(createServiceResponse(null, true, ['failed']))
        );

        component.StartSharingManifest(true);

        expect(component.HasError).toBe(true);
        expect(component.ValidationErrorsList).toContain('failed');
    });

    it('requests save when entity is dirty', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
    ...
    it('shares immediately when entity is clean', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
    ...
    it('shows edit area when invoked from edit component', () => {
        const component = new SharedManifestStarted(manifestService, keyService);
