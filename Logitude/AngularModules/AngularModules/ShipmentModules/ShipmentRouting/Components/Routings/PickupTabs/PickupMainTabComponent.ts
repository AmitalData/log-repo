...
export class PickupMainTabComponent extends BaseComponent {
    ...
    SetUIProperties_EmptyContainer() {
        ...
        if (this.IsFCLEntity) {
            if (this.ShipmentPM.DirectionId != "I") {
                ...
                var list: ShipmentPickUpPM[] = this.ShipmentPM.ShipmentPickUps.sort(function (a, b) { return a.PickUpDeliveryNumber.toLowerCase() == b.PickUpDeliveryNumber.toLowerCase() ? 0 : a.PickUpDeliveryNumber.toLowerCase() < b.PickUpDeliveryNumber.toLowerCase() ? -1 : 1; });
    ...
    get EmptyPickupContainerPartnerId() { return this.EntityPM.EmptyPickupContainerPartnerId; }
    set EmptyPickupContainerPartnerId(value: string) {
        if (this.EntityPM.EmptyPickupContainerPartnerId != value) {
            this.EntityPM.EmptyPickupContainerPartnerId = value;
        }
    }

    get EmptyPickupDepotReference() { return this.EntityPM.EmptyPickupDepotReference; }
    set EmptyPickupDepotReference(value: string) {
