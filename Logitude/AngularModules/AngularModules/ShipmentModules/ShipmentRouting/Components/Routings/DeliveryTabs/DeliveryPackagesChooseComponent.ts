...
export class DeliveryPackagesChooseComponent {
    ...
    public SelectedItem: DeliveryPackagesChooseItem = null;
    ...
    BuildItemsSource() {
        ...
        this.ShipmentPM.ShipmentPackages.forEach(item => {
            ...
            this.ItemsSource.push(new DeliveryPackagesChooseItem(item, null, this));

            item.InsideShipmentPackages.forEach(insideItem => {
                this.ItemsSource.push(new DeliveryPackagesChooseItem(item, insideItem, this));
            });
        });
