...
import { CommodityPackageItem } from './AWBPackagesTabComponent';
import { CommodityPackagePM } from '../../../../../Shipment/EntityPMs/CommodityPackagePM';
import { AppTool } from '../../../../../Infrastructure/Tools';
import { Cloner } from '../../../../../Infrastructure/Utilities/Cloner';

@Component({
    templateUrl: './AWBAddEditCommodityPackageComponent.html',
})

export class AWBAddEditCommodityPackageComponent {
    public EntityPM: CommodityPackagePM;
    public ObjectTableName: string;
    public DataContext: CommodityPackageItem;
    ...
    SetDataContext(dataContext: CommodityPackageItem) {
    ...
    OkButtonClicked() {
        ...
        if (this.ValidationErrorsList.length == 0) {
            ...
            if (this.DataContext.IsNewEntity) {
                ...
                this.DataContext.CommodityPM.AddCommodityPackagePM(this.EntityPM);
                this.DataContext.IsNewEntity = false;
                this.DataContext.IsWindowMode = false;

                this.DataContext.fatherComponent.ComputeTotals();
                this.DataContext.fatherComponent.fatherComponent.BuildData();
                this.DataContext.fatherComponent.fatherComponent.SetUIProperties();
            }
