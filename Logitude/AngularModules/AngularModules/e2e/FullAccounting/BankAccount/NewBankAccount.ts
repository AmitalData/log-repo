...
export class NewBankAccount {
    ...
    CreateNewBankAccount(Name: string, Name1: string, Name2: string, Name3: string) {
        ...
        this.Helper.WaitByCssAndClick_FromTagInsideListWithCheck('.DropDownListItem', 0, 'BankAccount_BankId', 'Leumi');
        ...
        this.Helper.WaitByCssAndClick_FromTagInsideListWithCheck('.DropDownListItem', 0, 'BankAccount_DeferredGLAccountId', Name2);
        this.Helper.WaitBusyIndicator();
        ...
        this.Helper.WaitByCssAndClick_FromTagInsideListWithCheck('.DropDownListItem', 0, 'BankAccount_TransferGLAcccountId', Name3);
        this.Helper.WaitBusyIndicator();
