...
var ModuleCRMActivity = /** @class */ (function () {
    function ModuleCRMActivity() {
    }
    ModuleCRMActivity.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMActivity = __decorate([
        core_1.NgModule({
    ...
    return ModuleCRMActivity;
}());
exports.ModuleCRMActivity = ModuleCRMActivity;
//# sourceMappingURL=ModuleCRMActivity.js.map