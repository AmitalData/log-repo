...
var ModuleCRMOccasion = /** @class */ (function () {
    function ModuleCRMOccasion() {
    }
    ModuleCRMOccasion.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMOccasion = __decorate([
        core_1.NgModule({
    ...
    return ModuleCRMOccasion;
}());
exports.ModuleCRMOccasion = ModuleCRMOccasion;
//# sourceMappingURL=ModuleCRMOccasion.js.map