...
var ModuleCRMTickets = /** @class */ (function () {
    function ModuleCRMTickets() {
    }
    ModuleCRMTickets.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMTickets = __decorate([
        core_1.NgModule({
    ...
    return ModuleCRMTickets;
}());
exports.ModuleCRMTickets = ModuleCRMTickets;
//# sourceMappingURL=ModuleCRMTickets.js.map