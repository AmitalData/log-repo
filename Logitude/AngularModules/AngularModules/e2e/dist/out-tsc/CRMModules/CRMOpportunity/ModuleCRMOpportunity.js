...
var ModuleCRMOpportunity = /** @class */ (function () {
    function ModuleCRMOpportunity() {
    }
    ModuleCRMOpportunity.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMOpportunity = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCRMOpportunity);
    return ModuleCRMOpportunity;
}());
exports.ModuleCRMOpportunity = ModuleCRMOpportunity;
//# sourceMappingURL=ModuleCRMOpportunity.js.map