...
var ModuleCRMInboundEmail = /** @class */ (function () {
    function ModuleCRMInboundEmail() {
    }
    ModuleCRMInboundEmail.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMInboundEmail = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCRMInboundEmail);
    return ModuleCRMInboundEmail;
}());
exports.ModuleCRMInboundEmail = ModuleCRMInboundEmail;
//# sourceMappingURL=ModuleCRMInboundEmail.js.map