...
var ModuleCRMStages = /** @class */ (function () {
    function ModuleCRMStages() {
    }
    ModuleCRMStages.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMStages = __decorate([
        core_1.NgModule({
    ...
    return ModuleCRMStages;
}());
exports.ModuleCRMStages = ModuleCRMStages;
//# sourceMappingURL=ModuleCRMStages.js.map