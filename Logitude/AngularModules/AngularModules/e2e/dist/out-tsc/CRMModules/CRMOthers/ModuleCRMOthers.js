...
var ModuleCRMOthers = /** @class */ (function () {
    function ModuleCRMOthers() {
    }
    ModuleCRMOthers.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCRMOthers = __decorate([
        core_1.NgModule({
    ...
    return ModuleCRMOthers;
}());
exports.ModuleCRMOthers = ModuleCRMOthers;
//# sourceMappingURL=ModuleCRMOthers.js.map