...
var EmployeeGroupPMInitService = /** @class */ (function () {
    function EmployeeGroupPMInitService() {
    }
    EmployeeGroupPMInitService.InitValues = function (entityPM, isNew) {
        if (isNew) {
    ...
    EmployeeGroupPMInitService.ApplyUIPoperties = function (entityPM, isNew) {
    };
    return EmployeeGroupPMInitService;
}());
exports.EmployeeGroupPMInitService = EmployeeGroupPMInitService;
//# sourceMappingURL=EmployeeGroupPMInitService.js.map