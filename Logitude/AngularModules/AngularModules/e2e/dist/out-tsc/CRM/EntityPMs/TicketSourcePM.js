...
var TicketSourcePM = /** @class */ (function () {
    function TicketSourcePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TicketSourcePM.prototype, "Code", {
    ...
    Object.defineProperty(TicketSourcePM.prototype, "Name", {
    ...
    Object.defineProperty(TicketSourcePM.prototype, "SearchFields", {
    ...
    TicketSourcePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TicketSource");
        }
    };
    TicketSourcePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TicketSourcePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TicketSourcePM.prototype, "PropertyChanged", void 0);
    return TicketSourcePM;
}());
exports.TicketSourcePM = TicketSourcePM;
//# sourceMappingURL=TicketSourcePM.js.map