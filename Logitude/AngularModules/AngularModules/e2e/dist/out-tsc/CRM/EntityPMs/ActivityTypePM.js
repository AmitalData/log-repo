...
var ActivityTypePM = /** @class */ (function () {
    function ActivityTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ActivityTypePM.prototype, "Code", {
    ...
    Object.defineProperty(ActivityTypePM.prototype, "Name", {
    ...
    Object.defineProperty(ActivityTypePM.prototype, "SearchFields", {
    ...
    ActivityTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ActivityType");
        }
    };
    ActivityTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ActivityTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ActivityTypePM.prototype, "PropertyChanged", void 0);
    return ActivityTypePM;
}());
exports.ActivityTypePM = ActivityTypePM;
//# sourceMappingURL=ActivityTypePM.js.map