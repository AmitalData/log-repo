...
var TimeUnitPM = /** @class */ (function () {
    ...
    Object.defineProperty(TimeUnitPM.prototype, "Name", {
    ...
    Object.defineProperty(TimeUnitPM.prototype, "SearchFields", {
    ...
    TimeUnitPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TimeUnit");
        }
    };
    TimeUnitPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TimeUnitPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TimeUnitPM.prototype, "PropertyChanged", void 0);
    return TimeUnitPM;
}());
exports.TimeUnitPM = TimeUnitPM;
//# sourceMappingURL=TimeUnitPM.js.map