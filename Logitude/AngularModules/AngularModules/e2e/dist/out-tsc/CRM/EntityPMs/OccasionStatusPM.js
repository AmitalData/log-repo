...
var OccasionStatusPM = /** @class */ (function () {
    function OccasionStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(OccasionStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(OccasionStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(OccasionStatusPM.prototype, "SearchFields", {
    ...
    OccasionStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "OccasionStatus");
        }
    };
    OccasionStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    OccasionStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], OccasionStatusPM.prototype, "PropertyChanged", void 0);
    return OccasionStatusPM;
}());
exports.OccasionStatusPM = OccasionStatusPM;
//# sourceMappingURL=OccasionStatusPM.js.map