...
var EscalationPreDefinitionPM = /** @class */ (function () {
    function EscalationPreDefinitionPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(EscalationPreDefinitionPM.prototype, "Code", {
    ...
    Object.defineProperty(EscalationPreDefinitionPM.prototype, "Name", {
    ...
    Object.defineProperty(EscalationPreDefinitionPM.prototype, "SearchFields", {
    ...
    EscalationPreDefinitionPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "EscalationPreDefinition");
        }
    };
    EscalationPreDefinitionPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    EscalationPreDefinitionPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], EscalationPreDefinitionPM.prototype, "PropertyChanged", void 0);
    return EscalationPreDefinitionPM;
}());
exports.EscalationPreDefinitionPM = EscalationPreDefinitionPM;
//# sourceMappingURL=EscalationPreDefinitionPM.js.map