...
var CallTypePM = /** @class */ (function () {
    ...
    Object.defineProperty(CallTypePM.prototype, "Name", {
    ...
    Object.defineProperty(CallTypePM.prototype, "SearchFields", {
    ...
    CallTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CallType");
        }
    };
    CallTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CallTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CallTypePM.prototype, "PropertyChanged", void 0);
    return CallTypePM;
}());
exports.CallTypePM = CallTypePM;
//# sourceMappingURL=CallTypePM.js.map