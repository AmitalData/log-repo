...
var ActivityStatusPM = /** @class */ (function () {
    function ActivityStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ActivityStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(ActivityStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(ActivityStatusPM.prototype, "SearchFields", {
    ...
    ActivityStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ActivityStatus");
        }
    };
    ActivityStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ActivityStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ActivityStatusPM.prototype, "PropertyChanged", void 0);
    return ActivityStatusPM;
}());
exports.ActivityStatusPM = ActivityStatusPM;
//# sourceMappingURL=ActivityStatusPM.js.map