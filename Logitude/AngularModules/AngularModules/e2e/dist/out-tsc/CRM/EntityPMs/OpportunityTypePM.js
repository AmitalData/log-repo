...
var OpportunityTypePM = /** @class */ (function () {
    function OpportunityTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(OpportunityTypePM.prototype, "Code", {
    ...
    Object.defineProperty(OpportunityTypePM.prototype, "Name", {
    ...
    Object.defineProperty(OpportunityTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(OpportunityTypePM.prototype, "Id", {
    ...
    Object.defineProperty(OpportunityTypePM.prototype, "Tenant", {
    ...
    Object.defineProperty(OpportunityTypePM.prototype, "InActive", {
    ...
    OpportunityTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "OpportunityType");
        }
    };
    OpportunityTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    OpportunityTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], OpportunityTypePM.prototype, "PropertyChanged", void 0);
    return OpportunityTypePM;
}());
exports.OpportunityTypePM = OpportunityTypePM;
//# sourceMappingURL=OpportunityTypePM.js.map