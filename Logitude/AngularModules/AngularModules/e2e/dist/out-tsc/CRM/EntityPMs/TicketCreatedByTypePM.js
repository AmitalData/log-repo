...
var TicketCreatedByTypePM = /** @class */ (function () {
    function TicketCreatedByTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TicketCreatedByTypePM.prototype, "Code", {
    ...
    Object.defineProperty(TicketCreatedByTypePM.prototype, "Name", {
    ...
    Object.defineProperty(TicketCreatedByTypePM.prototype, "SearchFields", {
    ...
    TicketCreatedByTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TicketCreatedByType");
        }
    };
    TicketCreatedByTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TicketCreatedByTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TicketCreatedByTypePM.prototype, "PropertyChanged", void 0);
    return TicketCreatedByTypePM;
}());
exports.TicketCreatedByTypePM = TicketCreatedByTypePM;
//# sourceMappingURL=TicketCreatedByTypePM.js.map