...
var ActivityPriorityPM = /** @class */ (function () {
    function ActivityPriorityPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ActivityPriorityPM.prototype, "Code", {
    ...
    Object.defineProperty(ActivityPriorityPM.prototype, "Name", {
    ...
    Object.defineProperty(ActivityPriorityPM.prototype, "SearchFields", {
    ...
    ActivityPriorityPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ActivityPriority");
        }
    };
    ActivityPriorityPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ActivityPriorityPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ActivityPriorityPM.prototype, "PropertyChanged", void 0);
    return ActivityPriorityPM;
}());
exports.ActivityPriorityPM = ActivityPriorityPM;
//# sourceMappingURL=ActivityPriorityPM.js.map