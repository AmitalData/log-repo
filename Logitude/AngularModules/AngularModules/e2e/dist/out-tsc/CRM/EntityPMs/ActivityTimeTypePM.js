...
var ActivityTimeTypePM = /** @class */ (function () {
    function ActivityTimeTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ActivityTimeTypePM.prototype, "Code", {
    ...
    Object.defineProperty(ActivityTimeTypePM.prototype, "Name", {
    ...
    Object.defineProperty(ActivityTimeTypePM.prototype, "SearchFields", {
    ...
    ActivityTimeTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ActivityTimeType");
        }
    };
    ActivityTimeTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ActivityTimeTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ActivityTimeTypePM.prototype, "PropertyChanged", void 0);
    return ActivityTimeTypePM;
}());
exports.ActivityTimeTypePM = ActivityTimeTypePM;
//# sourceMappingURL=ActivityTimeTypePM.js.map