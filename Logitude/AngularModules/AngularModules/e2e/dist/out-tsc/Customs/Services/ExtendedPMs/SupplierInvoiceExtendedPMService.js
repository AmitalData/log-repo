...
var SupplierInvoiceExtendedPMService = /** @class */ (function () {
    function SupplierInvoiceExtendedPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/DeclarationSupplierInvoices';
    }
    SupplierInvoiceExtendedPMService.prototype.GetSupplierInvoicesPMsForDeclaration = function (declarationId) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        var url = this._apiUrl + '/GetSupplierInvoicesPMsForDeclaration';
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetSupplierInvoicesPMsForDeclaration/?' + 'declarationId=' + declarationId, { headers: authHeader }).map(function (response) {
    ...
    SupplierInvoiceExtendedPMService.prototype.delete = function (declarationId, counterKey) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
            ...
            return _this._http.delete(_this._apiUrl + '/Delete/?' + 'declarationId=' + declarationId + '&counterKey=' + counterKey, { headers: authHeader }).map(function (response) {
    ...
    SupplierInvoiceExtendedPMService.prototype.GetInvoiceItemsWithTradeAgreementCount = function (declarationId) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        var url = this._apiUrl + '/GetInvoiceItemsWithTradeAgreementCount';
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetInvoiceItemsWithTradeAgreementCount/?' + 'declarationId=' + declarationId, { headers: authHeader }).map(function (response) {
                var serviceResponse = new ServiceResponse_1.ServiceResponse();
                serviceResponse.Result = response.json();
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
    ...
    SupplierInvoiceExtendedPMService.prototype.GetSupplierInvoicesPMsForDeclarationWithTradeAgreementCount = function (declarationId) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        var url = this._apiUrl + '/GetSupplierInvoicesPMsForDeclarationWithTradeAgreementCount';
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetSupplierInvoicesPMsForDeclarationWithTradeAgreementCount/?' + 'declarationId=' + declarationId, { headers: authHeader }).map(function (response) {
                var serviceResponse = new ServiceResponse_1.ServiceResponse();
    ...
    SupplierInvoiceExtendedPMService.prototype.GetSingleSupplierInvoicePMWithLimitedItems = function (declarationId, counterkey, skip, take, type) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetSingleSupplierInvoicePMWithLimitedItems?' + 'declarationId=' + declarationId + '&' + 'counterkey=' + counterkey + '&' + 'skip=' + skip + '&' + 'take=' + take + '&' + 'type=' + type, {
                headers: authHeader
    ...
    SupplierInvoiceExtendedPMService.prototype.GetImporterDespositionStatus = function (vendorId, importerId) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        var serviceResponse;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetImporterDepositions?' + 'vendorId=' + vendorId + '&importerId=' + importerId, { headers: authHeader }).map(function (response) {
                var pm = response.json();
                if (pm) {
                    var mappedResult;
                    mappedResult = _this.MapJsonToImporterDesposition(pm, true, mappedResult);
                    serviceResponse.Result = mappedResult;
                }
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
    ...
    SupplierInvoiceExtendedPMService.prototype.GetDocumentFilingIdForForInvoice = function (declarationId, counterkey) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetDocumentFilingIdForForInvoice?'
    ...
    SupplierInvoiceExtendedPMService.prototype.PutSupplierInvoicePercentage = function (invoice) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
            ...
            var serviceResponse;
            serviceResponse = new ServiceResponse_1.ServiceResponse();
            return _this._http.put(_this._apiUrl + '/UpdateInvoiceVendorCommision/', JSON.stringify(invoice), { headers: authHeader }).map(function (res) {
                var pm = res.json();
                if (pm) {
    ...
    // --------------------------------- Mapping --------------------------------------------------------------------------------
    SupplierInvoiceExtendedPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItems = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemTaxes = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemsConDeclars = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvioceItemCertificats = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemsMods = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemsSerialNums = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemsDescripts = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemsProdIdents = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemProcesTypes = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemLevies = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemVehicles = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemVehicleMods = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemVehicleAdds = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceItemModVehicles = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceModifications = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.MapSupplierInvoiceFreightAmounts = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    SupplierInvoiceExtendedPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new SupplierInvoicePM_1.SupplierInvoicePM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    SupplierInvoiceExtendedPMService.prototype.MapJsonToImporterDesposition = function (json, mapParent, entity) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    SupplierInvoiceExtendedPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], SupplierInvoiceExtendedPMService);
    return SupplierInvoiceExtendedPMService;
}());
exports.SupplierInvoiceExtendedPMService = SupplierInvoiceExtendedPMService;
//# sourceMappingURL=SupplierInvoiceExtendedPMService.js.map