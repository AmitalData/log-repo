...
var NotificationTypePM = /** @class */ (function () {
    function NotificationTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(NotificationTypePM.prototype, "Code", {
    ...
    Object.defineProperty(NotificationTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(NotificationTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(NotificationTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(NotificationTypePM.prototype, "Inactive", {
    ...
    NotificationTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.NotificationType");
        }
    };
    NotificationTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    NotificationTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], NotificationTypePM.prototype, "PropertyChanged", void 0);
    return NotificationTypePM;
}());
exports.NotificationTypePM = NotificationTypePM;
//# sourceMappingURL=NotificationTypePM.js.map