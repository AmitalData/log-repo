...
var ConstraintTypePM = /** @class */ (function () {
    function ConstraintTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ConstraintTypePM.prototype, "Code", {
    ...
    Object.defineProperty(ConstraintTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(ConstraintTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ConstraintTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ConstraintTypePM.prototype, "Inactive", {
    ...
    ConstraintTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ConstraintType");
        }
    };
    ConstraintTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ConstraintTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ConstraintTypePM.prototype, "PropertyChanged", void 0);
    return ConstraintTypePM;
}());
exports.ConstraintTypePM = ConstraintTypePM;
//# sourceMappingURL=ConstraintTypePM.js.map