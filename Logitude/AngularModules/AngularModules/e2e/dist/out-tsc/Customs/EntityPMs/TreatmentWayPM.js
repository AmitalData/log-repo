...
var TreatmentWayPM = /** @class */ (function () {
    function TreatmentWayPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TreatmentWayPM.prototype, "Code", {
    ...
    Object.defineProperty(TreatmentWayPM.prototype, "LocalName", {
    ...
    Object.defineProperty(TreatmentWayPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(TreatmentWayPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(TreatmentWayPM.prototype, "Inactive", {
    ...
    TreatmentWayPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.TreatmentWay");
        }
    };
    TreatmentWayPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TreatmentWayPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TreatmentWayPM.prototype, "PropertyChanged", void 0);
    return TreatmentWayPM;
}());
exports.TreatmentWayPM = TreatmentWayPM;
//# sourceMappingURL=TreatmentWayPM.js.map