...
var PointerLevelPM = /** @class */ (function () {
    function PointerLevelPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PointerLevelPM.prototype, "Code", {
    ...
    Object.defineProperty(PointerLevelPM.prototype, "LocalName", {
    ...
    Object.defineProperty(PointerLevelPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PointerLevelPM.prototype, "EnglishName", {
    ...
    PointerLevelPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PointerLevel");
        }
    };
    PointerLevelPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PointerLevelPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PointerLevelPM.prototype, "PropertyChanged", void 0);
    return PointerLevelPM;
}());
exports.PointerLevelPM = PointerLevelPM;
//# sourceMappingURL=PointerLevelPM.js.map