...
var ParagraphTypePM = /** @class */ (function () {
    function ParagraphTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ParagraphTypePM.prototype, "Code", {
    ...
    Object.defineProperty(ParagraphTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ParagraphTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(ParagraphTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ParagraphTypePM.prototype, "Inactive", {
    ...
    ParagraphTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ParagraphType");
        }
    };
    ParagraphTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ParagraphTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ParagraphTypePM.prototype, "PropertyChanged", void 0);
    return ParagraphTypePM;
}());
exports.ParagraphTypePM = ParagraphTypePM;
//# sourceMappingURL=ParagraphTypePM.js.map