...
var FacilitationTypePM = /** @class */ (function () {
    function FacilitationTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(FacilitationTypePM.prototype, "Code", {
    ...
    Object.defineProperty(FacilitationTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(FacilitationTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(FacilitationTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(FacilitationTypePM.prototype, "Inactive", {
    ...
    FacilitationTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.FacilitationType");
        }
    };
    FacilitationTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    FacilitationTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], FacilitationTypePM.prototype, "PropertyChanged", void 0);
    return FacilitationTypePM;
}());
exports.FacilitationTypePM = FacilitationTypePM;
//# sourceMappingURL=FacilitationTypePM.js.map