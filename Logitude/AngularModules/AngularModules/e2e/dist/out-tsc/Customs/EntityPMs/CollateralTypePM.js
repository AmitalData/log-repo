...
var CollateralTypePM = /** @class */ (function () {
    function CollateralTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CollateralTypePM.prototype, "Code", {
    ...
    Object.defineProperty(CollateralTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CollateralTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(CollateralTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CollateralTypePM.prototype, "Inactive", {
    ...
    CollateralTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CollateralType");
        }
    };
    CollateralTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CollateralTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CollateralTypePM.prototype, "PropertyChanged", void 0);
    return CollateralTypePM;
}());
exports.CollateralTypePM = CollateralTypePM;
//# sourceMappingURL=CollateralTypePM.js.map