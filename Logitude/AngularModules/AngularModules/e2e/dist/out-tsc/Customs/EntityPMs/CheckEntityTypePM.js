...
var CheckEntityTypePM = /** @class */ (function () {
    function CheckEntityTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CheckEntityTypePM.prototype, "Code", {
    ...
    Object.defineProperty(CheckEntityTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(CheckEntityTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CheckEntityTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CheckEntityTypePM.prototype, "Inactive", {
    ...
    CheckEntityTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CheckEntityType");
        }
    };
    CheckEntityTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CheckEntityTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CheckEntityTypePM.prototype, "PropertyChanged", void 0);
    return CheckEntityTypePM;
}());
exports.CheckEntityTypePM = CheckEntityTypePM;
//# sourceMappingURL=CheckEntityTypePM.js.map