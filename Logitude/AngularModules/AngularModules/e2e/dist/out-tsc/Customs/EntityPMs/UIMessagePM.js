...
var UIMessagePM = /** @class */ (function () {
    function UIMessagePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(UIMessagePM.prototype, "Code", {
    ...
    Object.defineProperty(UIMessagePM.prototype, "LocalName", {
    ...
    Object.defineProperty(UIMessagePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(UIMessagePM.prototype, "Inactive", {
    ...
    Object.defineProperty(UIMessagePM.prototype, "Sort", {
        get: function () { return this.sort; },
        set: function (newValue) { if (this.sort != newValue) {
            this.sort = newValue;
            this.MarkAsDirty("Sort");
        } },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UIMessagePM.prototype, "SearchFields", {
    ...
    UIMessagePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.UIMessage");
        }
    };
    UIMessagePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    UIMessagePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], UIMessagePM.prototype, "PropertyChanged", void 0);
    return UIMessagePM;
}());
exports.UIMessagePM = UIMessagePM;
//# sourceMappingURL=UIMessagePM.js.map