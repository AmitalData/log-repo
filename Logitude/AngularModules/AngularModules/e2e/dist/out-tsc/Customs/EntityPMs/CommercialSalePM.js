...
var CommercialSalePM = /** @class */ (function () {
    function CommercialSalePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CommercialSalePM.prototype, "Code", {
    ...
    Object.defineProperty(CommercialSalePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CommercialSalePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CommercialSalePM.prototype, "Inactive", {
    ...
    Object.defineProperty(CommercialSalePM.prototype, "LocalName", {
    ...
    CommercialSalePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CommercialSale");
        }
    };
    CommercialSalePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CommercialSalePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CommercialSalePM.prototype, "PropertyChanged", void 0);
    return CommercialSalePM;
}());
exports.CommercialSalePM = CommercialSalePM;
//# sourceMappingURL=CommercialSalePM.js.map