...
var VendorStatusPM = /** @class */ (function () {
    function VendorStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(VendorStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(VendorStatusPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(VendorStatusPM.prototype, "LocalName", {
    ...
    Object.defineProperty(VendorStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(VendorStatusPM.prototype, "Inactive", {
    ...
    VendorStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VendorStatus");
        }
    };
    VendorStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    VendorStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], VendorStatusPM.prototype, "PropertyChanged", void 0);
    return VendorStatusPM;
}());
exports.VendorStatusPM = VendorStatusPM;
//# sourceMappingURL=VendorStatusPM.js.map