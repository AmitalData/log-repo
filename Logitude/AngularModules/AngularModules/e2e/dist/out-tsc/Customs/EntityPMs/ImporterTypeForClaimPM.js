...
var ImporterTypeForClaimPM = /** @class */ (function () {
    function ImporterTypeForClaimPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ImporterTypeForClaimPM.prototype, "Code", {
    ...
    Object.defineProperty(ImporterTypeForClaimPM.prototype, "LocalName", {
    ...
    Object.defineProperty(ImporterTypeForClaimPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ImporterTypeForClaimPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ImporterTypeForClaimPM.prototype, "Inactive", {
    ...
    ImporterTypeForClaimPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ImporterTypeForClaim");
        }
    };
    ImporterTypeForClaimPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ImporterTypeForClaimPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ImporterTypeForClaimPM.prototype, "PropertyChanged", void 0);
    return ImporterTypeForClaimPM;
}());
exports.ImporterTypeForClaimPM = ImporterTypeForClaimPM;
//# sourceMappingURL=ImporterTypeForClaimPM.js.map