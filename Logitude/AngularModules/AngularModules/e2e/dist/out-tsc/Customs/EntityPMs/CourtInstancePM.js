...
var CourtInstancePM = /** @class */ (function () {
    function CourtInstancePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CourtInstancePM.prototype, "Code", {
    ...
    Object.defineProperty(CourtInstancePM.prototype, "LocalName", {
    ...
    Object.defineProperty(CourtInstancePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CourtInstancePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CourtInstancePM.prototype, "Inactive", {
    ...
    CourtInstancePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CourtInstance");
        }
    };
    CourtInstancePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CourtInstancePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CourtInstancePM.prototype, "PropertyChanged", void 0);
    return CourtInstancePM;
}());
exports.CourtInstancePM = CourtInstancePM;
//# sourceMappingURL=CourtInstancePM.js.map