...
var LeadDocumentTypePM = /** @class */ (function () {
    function LeadDocumentTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(LeadDocumentTypePM.prototype, "Code", {
    ...
    Object.defineProperty(LeadDocumentTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(LeadDocumentTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(LeadDocumentTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(LeadDocumentTypePM.prototype, "Inactive", {
    ...
    LeadDocumentTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.LeadDocumentType");
        }
    };
    LeadDocumentTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    LeadDocumentTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], LeadDocumentTypePM.prototype, "PropertyChanged", void 0);
    return LeadDocumentTypePM;
}());
exports.LeadDocumentTypePM = LeadDocumentTypePM;
//# sourceMappingURL=LeadDocumentTypePM.js.map