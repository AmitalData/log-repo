...
var AttachmentTypePM = /** @class */ (function () {
    function AttachmentTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(AttachmentTypePM.prototype, "Code", {
    ...
    Object.defineProperty(AttachmentTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(AttachmentTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(AttachmentTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(AttachmentTypePM.prototype, "Inactive", {
    ...
    AttachmentTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AttachmentType");
        }
    };
    AttachmentTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    AttachmentTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], AttachmentTypePM.prototype, "PropertyChanged", void 0);
    return AttachmentTypePM;
}());
exports.AttachmentTypePM = AttachmentTypePM;
//# sourceMappingURL=AttachmentTypePM.js.map