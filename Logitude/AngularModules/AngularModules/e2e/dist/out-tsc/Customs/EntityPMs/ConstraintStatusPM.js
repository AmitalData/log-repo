...
var ConstraintStatusPM = /** @class */ (function () {
    function ConstraintStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ConstraintStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(ConstraintStatusPM.prototype, "LocalName", {
    ...
    Object.defineProperty(ConstraintStatusPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ConstraintStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ConstraintStatusPM.prototype, "Inactive", {
    ...
    ConstraintStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ConstraintStatus");
        }
    };
    ConstraintStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ConstraintStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ConstraintStatusPM.prototype, "PropertyChanged", void 0);
    return ConstraintStatusPM;
}());
exports.ConstraintStatusPM = ConstraintStatusPM;
//# sourceMappingURL=ConstraintStatusPM.js.map