...
var DepositFileTypePM = /** @class */ (function () {
    function DepositFileTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(DepositFileTypePM.prototype, "Code", {
    ...
    Object.defineProperty(DepositFileTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(DepositFileTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(DepositFileTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(DepositFileTypePM.prototype, "Inactive", {
    ...
    DepositFileTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DepositFileType");
        }
    };
    DepositFileTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    DepositFileTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DepositFileTypePM.prototype, "PropertyChanged", void 0);
    return DepositFileTypePM;
}());
exports.DepositFileTypePM = DepositFileTypePM;
//# sourceMappingURL=DepositFileTypePM.js.map