...
var CheckQueueTypePM = /** @class */ (function () {
    function CheckQueueTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CheckQueueTypePM.prototype, "Code", {
    ...
    Object.defineProperty(CheckQueueTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(CheckQueueTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CheckQueueTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CheckQueueTypePM.prototype, "Inactive", {
    ...
    CheckQueueTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CheckQueueType");
        }
    };
    CheckQueueTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CheckQueueTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CheckQueueTypePM.prototype, "PropertyChanged", void 0);
    return CheckQueueTypePM;
}());
exports.CheckQueueTypePM = CheckQueueTypePM;
//# sourceMappingURL=CheckQueueTypePM.js.map