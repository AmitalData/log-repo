...
var CurrencyTypePM = /** @class */ (function () {
    function CurrencyTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CurrencyTypePM.prototype, "Code", {
    ...
    Object.defineProperty(CurrencyTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CurrencyTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(CurrencyTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CurrencyTypePM.prototype, "Inactive", {
    ...
    CurrencyTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CurrencyType");
        }
    };
    CurrencyTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CurrencyTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CurrencyTypePM.prototype, "PropertyChanged", void 0);
    return CurrencyTypePM;
}());
exports.CurrencyTypePM = CurrencyTypePM;
//# sourceMappingURL=CurrencyTypePM.js.map