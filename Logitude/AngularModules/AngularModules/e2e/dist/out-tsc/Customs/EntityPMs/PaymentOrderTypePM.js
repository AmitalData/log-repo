...
var PaymentOrderTypePM = /** @class */ (function () {
    function PaymentOrderTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PaymentOrderTypePM.prototype, "Code", {
    ...
    Object.defineProperty(PaymentOrderTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(PaymentOrderTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(PaymentOrderTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PaymentOrderTypePM.prototype, "Inactive", {
    ...
    PaymentOrderTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentOrderType");
        }
    };
    PaymentOrderTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PaymentOrderTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PaymentOrderTypePM.prototype, "PropertyChanged", void 0);
    return PaymentOrderTypePM;
}());
exports.PaymentOrderTypePM = PaymentOrderTypePM;
//# sourceMappingURL=PaymentOrderTypePM.js.map