...
var AutonomyTypePM = /** @class */ (function () {
    function AutonomyTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(AutonomyTypePM.prototype, "Code", {
    ...
    Object.defineProperty(AutonomyTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(AutonomyTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(AutonomyTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(AutonomyTypePM.prototype, "Inactive", {
    ...
    AutonomyTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AutonomyType");
        }
    };
    AutonomyTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    AutonomyTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], AutonomyTypePM.prototype, "PropertyChanged", void 0);
    return AutonomyTypePM;
}());
exports.AutonomyTypePM = AutonomyTypePM;
//# sourceMappingURL=AutonomyTypePM.js.map