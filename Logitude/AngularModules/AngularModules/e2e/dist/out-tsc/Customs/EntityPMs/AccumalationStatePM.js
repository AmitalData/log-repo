...
var AccumalationStatePM = /** @class */ (function () {
    function AccumalationStatePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(AccumalationStatePM.prototype, "Code", {
    ...
    Object.defineProperty(AccumalationStatePM.prototype, "Name", {
    ...
    Object.defineProperty(AccumalationStatePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(AccumalationStatePM.prototype, "LocalName", {
    ...
    AccumalationStatePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AccumalationState");
        }
    };
    AccumalationStatePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    AccumalationStatePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], AccumalationStatePM.prototype, "PropertyChanged", void 0);
    return AccumalationStatePM;
}());
exports.AccumalationStatePM = AccumalationStatePM;
//# sourceMappingURL=AccumalationStatePM.js.map