...
var SignatureTypePM = /** @class */ (function () {
    function SignatureTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(SignatureTypePM.prototype, "Code", {
    ...
    Object.defineProperty(SignatureTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(SignatureTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(SignatureTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(SignatureTypePM.prototype, "Inactive", {
    ...
    SignatureTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SignatureType");
        }
    };
    SignatureTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    SignatureTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], SignatureTypePM.prototype, "PropertyChanged", void 0);
    return SignatureTypePM;
}());
exports.SignatureTypePM = SignatureTypePM;
//# sourceMappingURL=SignatureTypePM.js.map