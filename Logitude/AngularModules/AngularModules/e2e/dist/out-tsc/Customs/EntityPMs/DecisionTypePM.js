...
var DecisionTypePM = /** @class */ (function () {
    function DecisionTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(DecisionTypePM.prototype, "Code", {
    ...
    Object.defineProperty(DecisionTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(DecisionTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(DecisionTypePM.prototype, "Inactive", {
    ...
    Object.defineProperty(DecisionTypePM.prototype, "SearchFields", {
    ...
    DecisionTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DecisionType");
        }
    };
    DecisionTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    DecisionTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DecisionTypePM.prototype, "PropertyChanged", void 0);
    return DecisionTypePM;
}());
exports.DecisionTypePM = DecisionTypePM;
//# sourceMappingURL=DecisionTypePM.js.map