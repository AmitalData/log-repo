...
var VehicleTypePM = /** @class */ (function () {
    function VehicleTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(VehicleTypePM.prototype, "Code", {
    ...
    Object.defineProperty(VehicleTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(VehicleTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(VehicleTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(VehicleTypePM.prototype, "Inactive", {
    ...
    VehicleTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleType");
        }
    };
    VehicleTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    VehicleTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], VehicleTypePM.prototype, "PropertyChanged", void 0);
    return VehicleTypePM;
}());
exports.VehicleTypePM = VehicleTypePM;
//# sourceMappingURL=VehicleTypePM.js.map