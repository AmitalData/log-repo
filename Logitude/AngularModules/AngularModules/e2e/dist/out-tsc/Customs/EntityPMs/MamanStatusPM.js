...
var MamanStatusPM = /** @class */ (function () {
    function MamanStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(MamanStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(MamanStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(MamanStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(MamanStatusPM.prototype, "LocalName", {
    ...
    MamanStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.MamanStatus");
        }
    };
    MamanStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    MamanStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], MamanStatusPM.prototype, "PropertyChanged", void 0);
    return MamanStatusPM;
}());
exports.MamanStatusPM = MamanStatusPM;
//# sourceMappingURL=MamanStatusPM.js.map