...
var CheckTypeLookupPM = /** @class */ (function () {
    function CheckTypeLookupPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CheckTypeLookupPM.prototype, "Code", {
    ...
    Object.defineProperty(CheckTypeLookupPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CheckTypeLookupPM.prototype, "LocalName", {
    ...
    Object.defineProperty(CheckTypeLookupPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CheckTypeLookupPM.prototype, "Inactive", {
    ...
    CheckTypeLookupPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CheckTypeLookup");
        }
    };
    CheckTypeLookupPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CheckTypeLookupPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CheckTypeLookupPM.prototype, "PropertyChanged", void 0);
    return CheckTypeLookupPM;
}());
exports.CheckTypeLookupPM = CheckTypeLookupPM;
//# sourceMappingURL=CheckTypeLookupPM.js.map