...
var ContactRoleTypePM = /** @class */ (function () {
    function ContactRoleTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ContactRoleTypePM.prototype, "Code", {
    ...
    Object.defineProperty(ContactRoleTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ContactRoleTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(ContactRoleTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ContactRoleTypePM.prototype, "Inactive", {
    ...
    ContactRoleTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ContactRoleType");
        }
    };
    ContactRoleTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ContactRoleTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ContactRoleTypePM.prototype, "PropertyChanged", void 0);
    return ContactRoleTypePM;
}());
exports.ContactRoleTypePM = ContactRoleTypePM;
//# sourceMappingURL=ContactRoleTypePM.js.map