...
var InvoiceTypePM = /** @class */ (function () {
    function InvoiceTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(InvoiceTypePM.prototype, "Code", {
    ...
    Object.defineProperty(InvoiceTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(InvoiceTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(InvoiceTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(InvoiceTypePM.prototype, "Inactive", {
    ...
    InvoiceTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.InvoiceType");
        }
    };
    InvoiceTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    InvoiceTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], InvoiceTypePM.prototype, "PropertyChanged", void 0);
    return InvoiceTypePM;
}());
exports.InvoiceTypePM = InvoiceTypePM;
//# sourceMappingURL=InvoiceTypePM.js.map