...
var SubCountryPM = /** @class */ (function () {
    function SubCountryPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(SubCountryPM.prototype, "Code", {
    ...
    Object.defineProperty(SubCountryPM.prototype, "LocalName", {
    ...
    Object.defineProperty(SubCountryPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(SubCountryPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(SubCountryPM.prototype, "CountryCode", {
    ...
    Object.defineProperty(SubCountryPM.prototype, "Inactive", {
    ...
    SubCountryPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SubCountry");
        }
    };
    SubCountryPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    SubCountryPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], SubCountryPM.prototype, "PropertyChanged", void 0);
    return SubCountryPM;
}());
exports.SubCountryPM = SubCountryPM;
//# sourceMappingURL=SubCountryPM.js.map