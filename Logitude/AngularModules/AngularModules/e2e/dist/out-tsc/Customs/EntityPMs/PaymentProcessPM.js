...
var PaymentProcessPM = /** @class */ (function () {
    function PaymentProcessPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PaymentProcessPM.prototype, "Code", {
    ...
    Object.defineProperty(PaymentProcessPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(PaymentProcessPM.prototype, "LocalName", {
    ...
    Object.defineProperty(PaymentProcessPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PaymentProcessPM.prototype, "Inactive", {
    ...
    PaymentProcessPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentProcess");
        }
    };
    PaymentProcessPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PaymentProcessPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PaymentProcessPM.prototype, "PropertyChanged", void 0);
    return PaymentProcessPM;
}());
exports.PaymentProcessPM = PaymentProcessPM;
//# sourceMappingURL=PaymentProcessPM.js.map