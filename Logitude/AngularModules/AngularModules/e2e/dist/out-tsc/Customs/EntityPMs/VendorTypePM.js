...
var VendorTypePM = /** @class */ (function () {
    function VendorTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(VendorTypePM.prototype, "Code", {
    ...
    Object.defineProperty(VendorTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(VendorTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(VendorTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(VendorTypePM.prototype, "Inactive", {
    ...
    VendorTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VendorType");
        }
    };
    VendorTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    VendorTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], VendorTypePM.prototype, "PropertyChanged", void 0);
    return VendorTypePM;
}());
exports.VendorTypePM = VendorTypePM;
//# sourceMappingURL=VendorTypePM.js.map