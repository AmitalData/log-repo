...
var ManifestCargoStatusPM = /** @class */ (function () {
    function ManifestCargoStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ManifestCargoStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(ManifestCargoStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(ManifestCargoStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ManifestCargoStatusPM.prototype, "LocalName", {
    ...
    ManifestCargoStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ManifestCargoStatus");
        }
    };
    ManifestCargoStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ManifestCargoStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ManifestCargoStatusPM.prototype, "PropertyChanged", void 0);
    return ManifestCargoStatusPM;
}());
exports.ManifestCargoStatusPM = ManifestCargoStatusPM;
//# sourceMappingURL=ManifestCargoStatusPM.js.map