...
var CourierStatusPM = /** @class */ (function () {
    function CourierStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CourierStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(CourierStatusPM.prototype, "LocalName", {
    ...
    Object.defineProperty(CourierStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CourierStatusPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CourierStatusPM.prototype, "Inactive", {
    ...
    CourierStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CourierStatus");
        }
    };
    CourierStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CourierStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CourierStatusPM.prototype, "PropertyChanged", void 0);
    return CourierStatusPM;
}());
exports.CourierStatusPM = CourierStatusPM;
//# sourceMappingURL=CourierStatusPM.js.map