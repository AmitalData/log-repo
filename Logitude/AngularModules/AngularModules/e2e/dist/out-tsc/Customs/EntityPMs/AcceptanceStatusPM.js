...
var AcceptanceStatusPM = /** @class */ (function () {
    function AcceptanceStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(AcceptanceStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(AcceptanceStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(AcceptanceStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(AcceptanceStatusPM.prototype, "LocalName", {
    ...
    AcceptanceStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AcceptanceStatus");
        }
    };
    AcceptanceStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    AcceptanceStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], AcceptanceStatusPM.prototype, "PropertyChanged", void 0);
    return AcceptanceStatusPM;
}());
exports.AcceptanceStatusPM = AcceptanceStatusPM;
//# sourceMappingURL=AcceptanceStatusPM.js.map