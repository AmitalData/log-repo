...
var MeasureQualifierPM = /** @class */ (function () {
    function MeasureQualifierPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(MeasureQualifierPM.prototype, "Code", {
    ...
    Object.defineProperty(MeasureQualifierPM.prototype, "LocalName", {
    ...
    Object.defineProperty(MeasureQualifierPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(MeasureQualifierPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(MeasureQualifierPM.prototype, "Inactive", {
    ...
    MeasureQualifierPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.MeasureQualifier");
        }
    };
    MeasureQualifierPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    MeasureQualifierPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], MeasureQualifierPM.prototype, "PropertyChanged", void 0);
    return MeasureQualifierPM;
}());
exports.MeasureQualifierPM = MeasureQualifierPM;
//# sourceMappingURL=MeasureQualifierPM.js.map