...
var DemanderTypePM = /** @class */ (function () {
    function DemanderTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(DemanderTypePM.prototype, "Code", {
    ...
    Object.defineProperty(DemanderTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(DemanderTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(DemanderTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(DemanderTypePM.prototype, "Inactive", {
    ...
    DemanderTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DemanderType");
        }
    };
    DemanderTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    DemanderTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DemanderTypePM.prototype, "PropertyChanged", void 0);
    return DemanderTypePM;
}());
exports.DemanderTypePM = DemanderTypePM;
//# sourceMappingURL=DemanderTypePM.js.map