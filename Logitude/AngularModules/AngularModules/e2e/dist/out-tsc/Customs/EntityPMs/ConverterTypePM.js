...
var ConverterTypePM = /** @class */ (function () {
    function ConverterTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ConverterTypePM.prototype, "Code", {
    ...
    Object.defineProperty(ConverterTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ConverterTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(ConverterTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ConverterTypePM.prototype, "Inactive", {
    ...
    ConverterTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ConverterType");
        }
    };
    ConverterTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ConverterTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ConverterTypePM.prototype, "PropertyChanged", void 0);
    return ConverterTypePM;
}());
exports.ConverterTypePM = ConverterTypePM;
//# sourceMappingURL=ConverterTypePM.js.map