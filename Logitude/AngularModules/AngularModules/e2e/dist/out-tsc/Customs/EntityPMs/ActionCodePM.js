...
var ActionCodePM = /** @class */ (function () {
    function ActionCodePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(ActionCodePM.prototype, "Code", {
    ...
    Object.defineProperty(ActionCodePM.prototype, "LocalName", {
    ...
    Object.defineProperty(ActionCodePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(ActionCodePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(ActionCodePM.prototype, "Inactive", {
    ...
    ActionCodePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ActionCode");
        }
    };
    ActionCodePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    ActionCodePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ActionCodePM.prototype, "PropertyChanged", void 0);
    return ActionCodePM;
}());
exports.ActionCodePM = ActionCodePM;
//# sourceMappingURL=ActionCodePM.js.map