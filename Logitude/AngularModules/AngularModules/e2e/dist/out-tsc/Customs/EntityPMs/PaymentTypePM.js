...
var PaymentTypePM = /** @class */ (function () {
    function PaymentTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PaymentTypePM.prototype, "Code", {
    ...
    Object.defineProperty(PaymentTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(PaymentTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(PaymentTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PaymentTypePM.prototype, "Inactive", {
    ...
    PaymentTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentType");
        }
    };
    PaymentTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PaymentTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PaymentTypePM.prototype, "PropertyChanged", void 0);
    return PaymentTypePM;
}());
exports.PaymentTypePM = PaymentTypePM;
//# sourceMappingURL=PaymentTypePM.js.map