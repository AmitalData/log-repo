...
var PackingTypePM = /** @class */ (function () {
    function PackingTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PackingTypePM.prototype, "Code", {
    ...
    Object.defineProperty(PackingTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(PackingTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(PackingTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PackingTypePM.prototype, "Inactive", {
    ...
    PackingTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PackingType");
        }
    };
    PackingTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PackingTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PackingTypePM.prototype, "PropertyChanged", void 0);
    return PackingTypePM;
}());
exports.PackingTypePM = PackingTypePM;
//# sourceMappingURL=PackingTypePM.js.map