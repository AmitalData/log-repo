...
var VehiclePoolTypePM = /** @class */ (function () {
    function VehiclePoolTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(VehiclePoolTypePM.prototype, "Code", {
    ...
    Object.defineProperty(VehiclePoolTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(VehiclePoolTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(VehiclePoolTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(VehiclePoolTypePM.prototype, "Inactive", {
    ...
    VehiclePoolTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehiclePoolType");
        }
    };
    VehiclePoolTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    VehiclePoolTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], VehiclePoolTypePM.prototype, "PropertyChanged", void 0);
    return VehiclePoolTypePM;
}());
exports.VehiclePoolTypePM = VehiclePoolTypePM;
//# sourceMappingURL=VehiclePoolTypePM.js.map