...
var AddressPurposePM = /** @class */ (function () {
    function AddressPurposePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(AddressPurposePM.prototype, "Code", {
    ...
    Object.defineProperty(AddressPurposePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(AddressPurposePM.prototype, "LocalName", {
    ...
    Object.defineProperty(AddressPurposePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(AddressPurposePM.prototype, "Inactive", {
    ...
    AddressPurposePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AddressPurpose");
        }
    };
    AddressPurposePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    AddressPurposePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], AddressPurposePM.prototype, "PropertyChanged", void 0);
    return AddressPurposePM;
}());
exports.AddressPurposePM = AddressPurposePM;
//# sourceMappingURL=AddressPurposePM.js.map