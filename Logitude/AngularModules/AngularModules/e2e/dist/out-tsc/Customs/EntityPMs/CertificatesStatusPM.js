...
var CertificatesStatusPM = /** @class */ (function () {
    function CertificatesStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CertificatesStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(CertificatesStatusPM.prototype, "LocalName", {
    ...
    Object.defineProperty(CertificatesStatusPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CertificatesStatusPM.prototype, "SearchFields", {
    ...
    CertificatesStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CertificatesStatus");
        }
    };
    CertificatesStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CertificatesStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CertificatesStatusPM.prototype, "PropertyChanged", void 0);
    return CertificatesStatusPM;
}());
exports.CertificatesStatusPM = CertificatesStatusPM;
//# sourceMappingURL=CertificatesStatusPM.js.map