...
var EntityTypeLookupPM = /** @class */ (function () {
    function EntityTypeLookupPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(EntityTypeLookupPM.prototype, "Code", {
    ...
    Object.defineProperty(EntityTypeLookupPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(EntityTypeLookupPM.prototype, "LocalName", {
    ...
    Object.defineProperty(EntityTypeLookupPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(EntityTypeLookupPM.prototype, "Inactive", {
    ...
    EntityTypeLookupPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.EntityTypeLookup");
        }
    };
    EntityTypeLookupPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    EntityTypeLookupPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], EntityTypeLookupPM.prototype, "PropertyChanged", void 0);
    return EntityTypeLookupPM;
}());
exports.EntityTypeLookupPM = EntityTypeLookupPM;
//# sourceMappingURL=EntityTypeLookupPM.js.map