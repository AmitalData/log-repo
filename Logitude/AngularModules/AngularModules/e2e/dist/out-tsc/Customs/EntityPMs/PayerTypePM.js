...
var PayerTypePM = /** @class */ (function () {
    function PayerTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PayerTypePM.prototype, "Code", {
    ...
    Object.defineProperty(PayerTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(PayerTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(PayerTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PayerTypePM.prototype, "Inactive", {
    ...
    PayerTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PayerType");
        }
    };
    PayerTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PayerTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PayerTypePM.prototype, "PropertyChanged", void 0);
    return PayerTypePM;
}());
exports.PayerTypePM = PayerTypePM;
//# sourceMappingURL=PayerTypePM.js.map