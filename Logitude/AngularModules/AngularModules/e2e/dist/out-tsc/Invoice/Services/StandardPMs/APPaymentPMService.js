...
var APPaymentInvoicePM_1 = require("../../EntityPMs/APPaymentInvoicePM");
var APPaymentValidator_1 = require("../../Validators/APPaymentValidator");
var APPaymentPMService = /** @class */ (function () {
    function APPaymentPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/appayments';
    }
    APPaymentPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "APPayment", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    APPaymentPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            var customValidator = new APPaymentValidator_1.APPaymentValidator();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "APPayment", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    APPaymentPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    APPaymentPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        if (mapParent === void 0) { mapParent = true; }
        if (entityPM === void 0) { entityPM = null; }
        if (!entityPM) {
            entityPM = new APPaymentPM_1.APPaymentPM();
        }
        var customFields = [];
        for (var i = 1; i < 11; i++) {
        ...
        if (mapParent) {
            ...
            for (var item in entityPM.PaymentInvoices) {
                ...
                var newAPPaymentInvoicePM = this.clone(myAPPaymentInvoicePM);
    ...
    APPaymentPMService.prototype.MapPaymentInvoices = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
        ...
        for (var item in jsonPM.PaymentInvoices) {
            ...
            var newAPPaymentInvoicePM;
            if (mapParent) {
                newAPPaymentInvoicePM = new APPaymentInvoicePM_1.APPaymentInvoicePM(entityPM);
            }
            else {
                newAPPaymentInvoicePM = new APPaymentInvoicePM_1.APPaymentInvoicePM(null);
            }
            ...
            if (mapParent) {
                newAPPaymentInvoicePM.UniqueKey = Guid_1.Guid.newGuid();
            ...
            for (var itemKey in oldPaymentInvoices) {
                if (entityPM.PaymentInvoices.filter(function (p) { return p.UniqueKey === oldPaymentInvoices[itemKey].UniqueKey; }).length === 0) {
                    if (oldPaymentInvoices[itemKey]) {
                        ...
                        var deletedPM = new APPaymentInvoicePM_1.APPaymentInvoicePM(null);
    ...
    APPaymentPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    APPaymentPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new APPaymentPM_1.APPaymentPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    APPaymentPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], APPaymentPMService);
    return APPaymentPMService;
}());
exports.APPaymentPMService = APPaymentPMService;
//# sourceMappingURL=APPaymentPMService.js.map