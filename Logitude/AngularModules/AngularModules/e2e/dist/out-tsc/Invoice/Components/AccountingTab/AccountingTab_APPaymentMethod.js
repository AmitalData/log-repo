...
var AccountingTab_APPaymentMethod = /** @class */ (function (_super) {
    __extends(AccountingTab_APPaymentMethod, _super);
    function AccountingTab_APPaymentMethod(entityArgs) {
    ...
    AccountingTab_APPaymentMethod.prototype.Listen = function () {
        var _this = this;
    ...
    AccountingTab_APPaymentMethod.prototype.ngOnDestroy = function () {
        Tools_1.AppTool.KillEventEmitter(this.SaveCompletedEvent);
        Tools_1.AppTool.KillEventEmitter(this.LoadCompletedEvent);
    };
    Object.defineProperty(AccountingTab_APPaymentMethod.prototype, "AccountingExternalId", {
        get: function () { return this.EntityPM.AccountingExternalId; },
        set: function (value) {
    ...
    AccountingTab_APPaymentMethod = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return AccountingTab_APPaymentMethod;
}(BaseComponent_1.BaseComponent));
exports.AccountingTab_APPaymentMethod = AccountingTab_APPaymentMethod;
//# sourceMappingURL=AccountingTab_APPaymentMethod.js.map