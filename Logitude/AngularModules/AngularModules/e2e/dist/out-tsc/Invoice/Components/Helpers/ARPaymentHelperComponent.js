...
var ARPaymentHelperComponent = /** @class */ (function () {
    function ARPaymentHelperComponent(entityArgs) {
    ...
    ARPaymentHelperComponent.prototype.Listen = function () {
        var _this = this;
    ...
    ARPaymentHelperComponent.prototype.ngOnDestroy = function () {
        Tools_1.AppTool.KillEventEmitter(this.SaveCompletedEvent);
        Tools_1.AppTool.KillEventEmitter(this.LoadCompletedEvent);
    };
    ARPaymentHelperComponent.prototype.BuildComponent = function () {
    };
    Object.defineProperty(ARPaymentHelperComponent.prototype, "InternalNotes", {
    ...
    ARPaymentHelperComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return ARPaymentHelperComponent;
}());
exports.ARPaymentHelperComponent = ARPaymentHelperComponent;
//# sourceMappingURL=ARPaymentHelperComponent.js.map