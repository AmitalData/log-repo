...
var APInvoiceHelperComponent = /** @class */ (function () {
    function APInvoiceHelperComponent(entityArgs) {
    ...
    APInvoiceHelperComponent.prototype.Listen = function () {
        var _this = this;
    ...
    APInvoiceHelperComponent.prototype.ngOnDestroy = function () {
        Tools_1.AppTool.KillEventEmitter(this.SaveCompletedEvent);
        Tools_1.AppTool.KillEventEmitter(this.LoadCompletedEvent);
    };
    APInvoiceHelperComponent.prototype.BuildComponent = function () {
    };
    Object.defineProperty(APInvoiceHelperComponent.prototype, "InternalNotes", {
    ...
    APInvoiceHelperComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return APInvoiceHelperComponent;
}());
exports.APInvoiceHelperComponent = APInvoiceHelperComponent;
//# sourceMappingURL=APInvoiceHelperComponent.js.map