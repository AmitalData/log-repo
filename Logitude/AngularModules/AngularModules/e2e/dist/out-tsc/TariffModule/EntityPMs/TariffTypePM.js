...
var TariffTypePM = /** @class */ (function () {
    function TariffTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TariffTypePM.prototype, "Code", {
    ...
    Object.defineProperty(TariffTypePM.prototype, "Name", {
    ...
    Object.defineProperty(TariffTypePM.prototype, "SearchFields", {
    ...
    TariffTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TariffType");
        }
    };
    TariffTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TariffTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TariffTypePM.prototype, "PropertyChanged", void 0);
    return TariffTypePM;
}());
exports.TariffTypePM = TariffTypePM;
//# sourceMappingURL=TariffTypePM.js.map