...
var TimeManagementModule = /** @class */ (function () {
    function TimeManagementModule() {
    }
    TimeManagementModule.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    TimeManagementModule.GetInstance = function (name) {
        return ModuleProviders_1.ModuleProviders.GetInstance(name);
    };
    TimeManagementModule.Components = ModuleDeclarations_1.Components;
    TimeManagementModule = __decorate([
        core_1.NgModule({
...
//# sourceMappingURL=Module_TIME.js.map