...
var TMDayOffTypePM = /** @class */ (function () {
    function TMDayOffTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TMDayOffTypePM.prototype, "Code", {
    ...
    Object.defineProperty(TMDayOffTypePM.prototype, "Name", {
    ...
    Object.defineProperty(TMDayOffTypePM.prototype, "SearchFields", {
    ...
    TMDayOffTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TMDayOffType");
        }
    };
    TMDayOffTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TMDayOffTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TMDayOffTypePM.prototype, "PropertyChanged", void 0);
    return TMDayOffTypePM;
}());
exports.TMDayOffTypePM = TMDayOffTypePM;
//# sourceMappingURL=TMDayOffTypePM.js.map