...
var TMLocationPM = /** @class */ (function () {
    function TMLocationPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TMLocationPM.prototype, "Code", {
    ...
    Object.defineProperty(TMLocationPM.prototype, "Name", {
    ...
    Object.defineProperty(TMLocationPM.prototype, "SearchFields", {
    ...
    TMLocationPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TMLocation");
        }
    };
    TMLocationPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TMLocationPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TMLocationPM.prototype, "PropertyChanged", void 0);
    return TMLocationPM;
}());
exports.TMLocationPM = TMLocationPM;
//# sourceMappingURL=TMLocationPM.js.map