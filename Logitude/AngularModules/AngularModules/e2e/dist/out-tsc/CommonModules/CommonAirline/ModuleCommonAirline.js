...
var ModuleCommonAirline = /** @class */ (function () {
    function ModuleCommonAirline() {
    }
    ModuleCommonAirline.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCommonAirline = __decorate([
        core_1.NgModule({
    ...
    return ModuleCommonAirline;
}());
exports.ModuleCommonAirline = ModuleCommonAirline;
//# sourceMappingURL=ModuleCommonAirline.js.map