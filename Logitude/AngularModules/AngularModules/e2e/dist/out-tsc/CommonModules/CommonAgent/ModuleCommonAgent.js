...
var ModuleCommonAgent = /** @class */ (function () {
    function ModuleCommonAgent() {
    }
    ModuleCommonAgent.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCommonAgent = __decorate([
        core_1.NgModule({
    ...
    return ModuleCommonAgent;
}());
exports.ModuleCommonAgent = ModuleCommonAgent;
//# sourceMappingURL=ModuleCommonAgent.js.map