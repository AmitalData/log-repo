...
var ModuleCommonCustomer = /** @class */ (function () {
    function ModuleCommonCustomer() {
    }
    ModuleCommonCustomer.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCommonCustomer = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCommonCustomer);
    return ModuleCommonCustomer;
}());
exports.ModuleCommonCustomer = ModuleCommonCustomer;
//# sourceMappingURL=ModuleCommonCustomer.js.map