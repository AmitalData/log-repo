...
var EditProductCommitmentComponent = /** @class */ (function (_super) {
    __extends(EditProductCommitmentComponent, _super);
    function EditProductCommitmentComponent(CD) {
        ...
        _this.CommitmentTEUVisibility = true;
        ...
        _this.ToggledEntered = false;
        _this.oldLocations = [];
        _this.SearchTextId += _this.CurrentSession.GetNewId(_this.SearchTextId);
        _this.SearchDropButtonId += _this.CurrentSession.GetNewId(_this.SearchDropButtonId);
    ...
    Object.defineProperty(EditProductCommitmentComponent.prototype, "SearchText", {
    ...
    EditProductCommitmentComponent.prototype.OnDeleteValue = function () {
        var temp = document.getElementById(this.SearchTextId);
        temp.value = null;
        this.SearchText = null;
        temp.focus();
    };
    EditProductCommitmentComponent.prototype.ClearPlaceHolder = function () {
        var temp = document.getElementById(this.SearchTextId);
        temp.placeholder = "";
        this.SearchText = "";
    ...
    EditProductCommitmentComponent.prototype.FillPlaceHolder = function () {
        if (!this.SearchText) {
            var temp = document.getElementById(this.SearchTextId);
    ...
    EditProductCommitmentComponent.prototype.setToggleButtonMenuTemp = function () {
        var ToggleBTN = document.getElementById(this.SearchDropButtonId);
        ToggleBTN.className = "ToggleButtonMenuTemp";
    };
    EditProductCommitmentComponent.prototype.setToggleButtonMenu = function () {
        var ToggleBTN = document.getElementById(this.SearchDropButtonId);
        ToggleBTN.className = "ToggleButtonMenu";
        ToggleBTN.style.visibility = "none";
    };
    EditProductCommitmentComponent.prototype.SearchCountries = function () {
        var _this = this;
    ...
    EditProductCommitmentComponent.prototype.SetWindowArgs = function (args) {
        this.EntityPM = args;
        this.SetColumnVisibility();
        this.SearchCountries();
        this.Clone(this.EntityPM);
    };
    EditProductCommitmentComponent.prototype.CountyClicked = function (item, i) {
    ...
    EditProductCommitmentComponent.prototype.SetColumnVisibility = function () {
        if (this.EntityPM != null) {
    ...
    EditProductCommitmentComponent.prototype.CancelButtonClicked = function () {
        this.RejectChanges();
        this.CurrentSession.CloseCurrentWindowEmit("Cancel");
    };
    EditProductCommitmentComponent.prototype.OkButtonClicked = function () {
    ...
    EditProductCommitmentComponent.prototype.Clone = function (myDataContext) {
        var _this = this;
    ...
    EditProductCommitmentComponent.prototype.RejectChanges = function () {
        var _this = this;
        var addedItems = [];
        var removedItems = [];
    ...
    EditProductCommitmentComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return EditProductCommitmentComponent;
}(BaseComponent_1.BaseComponent));
exports.EditProductCommitmentComponent = EditProductCommitmentComponent;
//# sourceMappingURL=EditProductCommitmentComponent.js.map