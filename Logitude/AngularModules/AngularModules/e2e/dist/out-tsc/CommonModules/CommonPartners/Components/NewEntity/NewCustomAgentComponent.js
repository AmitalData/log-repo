...
var CustomAgentPM_1 = require("../../../../Common/EntityPMs/CustomAgentPM");
var EntityResourceService_1 = require("../../../../Infrastructure/Services/EntityResourceService");
var Tools_1 = require("../../../../Infrastructure/Tools");
var NewCustomAgentComponent = /** @class */ (function () {
    function NewCustomAgentComponent() {
        this.PartnerTypeId = "CG";
        this.ObjectTableName = "CustomAgent";
        this.ValidationErrorsList = [];
        this._entityResourceService = new EntityResourceService_1.EntityResourceService();
        this.CurrentSession = SessionLocator_1.SessionLocator.SelectedSession;
        this.Retries = 0;
        this.EntityPM = new CustomAgentPM_1.CustomAgentPM();
    ...
    NewCustomAgentComponent.prototype.SetWindowArgs = function (args) {
        if (args != null) {
            this.DefaultValues = args.DefaultValues;
        }
    };
    NewCustomAgentComponent.prototype.RunComponent = function () {
    ...
    NewCustomAgentComponent.prototype.RunComponentTimer = function () {
        var _this = this;
        this.Retries++;
        if (this.timerToken) {
    ...
    NewCustomAgentComponent.prototype.LoadChildComponent = function () {
        var _this = this;
    ...
    NewCustomAgentComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    NewCustomAgentComponent.prototype.OkButtonClicked = function () {
        var _this = this;
        ...
        if (errors.length == 0) {
            ...
            this.DomainService.PostPartnerAddress(args).subscribe(function (myResponse) {
                ...
                if (!myResponse.HasError) {
                    _this.EntityPM = myResponse.Result.CustomAgent;
    ...
    ], NewCustomAgentComponent.prototype, "viewContainerRef", void 0);
    NewCustomAgentComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return NewCustomAgentComponent;
}());
exports.NewCustomAgentComponent = NewCustomAgentComponent;
//# sourceMappingURL=NewCustomAgentComponent.js.map