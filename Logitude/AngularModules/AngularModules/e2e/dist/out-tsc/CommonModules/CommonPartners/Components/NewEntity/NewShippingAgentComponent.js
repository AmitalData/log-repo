...
var ShippingAgentPM_1 = require("../../../../Common/EntityPMs/ShippingAgentPM");
var EntityResourceService_1 = require("../../../../Infrastructure/Services/EntityResourceService");
var Tools_1 = require("../../../../Infrastructure/Tools");
var NewShippingAgentComponent = /** @class */ (function () {
    function NewShippingAgentComponent() {
        this.PartnerTypeId = "SG";
        this.ObjectTableName = "ShippingAgent";
        this.ValidationErrorsList = [];
        this._entityResourceService = new EntityResourceService_1.EntityResourceService();
        this.CurrentSession = SessionLocator_1.SessionLocator.SelectedSession;
        this.Retries = 0;
        this.EntityPM = new ShippingAgentPM_1.ShippingAgentPM();
    ...
    NewShippingAgentComponent.prototype.RunComponent = function () {
    ...
    NewShippingAgentComponent.prototype.RunComponentTimer = function () {
        var _this = this;
        this.Retries++;
        if (this.timerToken) {
    ...
    NewShippingAgentComponent.prototype.LoadChildComponent = function () {
        var _this = this;
    ...
    NewShippingAgentComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    NewShippingAgentComponent.prototype.OkButtonClicked = function () {
        var _this = this;
        ...
        if (errors.length == 0) {
            ...
            this.DomainService.PostPartnerAddress(args).subscribe(function (myResponse) {
                ...
                if (!myResponse.HasError) {
                    _this.EntityPM = myResponse.Result.ShippingAgent;
    ...
    ], NewShippingAgentComponent.prototype, "viewContainerRef", void 0);
    NewShippingAgentComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return NewShippingAgentComponent;
}());
exports.NewShippingAgentComponent = NewShippingAgentComponent;
//# sourceMappingURL=NewShippingAgentComponent.js.map