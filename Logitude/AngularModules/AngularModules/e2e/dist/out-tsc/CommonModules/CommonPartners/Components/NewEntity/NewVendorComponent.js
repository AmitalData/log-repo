...
var VendorPM_1 = require("../../../../Common/EntityPMs/VendorPM");
var EntityResourceService_1 = require("../../../../Infrastructure/Services/EntityResourceService");
var Tools_1 = require("../../../../Infrastructure/Tools");
var NewVendorComponent = /** @class */ (function () {
    function NewVendorComponent() {
        this.PartnerTypeId = "VD";
        this.ObjectTableName = "Vendor";
        this.ValidationErrorsList = [];
        this._entityResourceService = new EntityResourceService_1.EntityResourceService();
        this.CurrentSession = SessionLocator_1.SessionLocator.SelectedSession;
        this.Retries = 0;
        this.EntityPM = new VendorPM_1.VendorPM();
    ...
    NewVendorComponent.prototype.RunComponent = function () {
    ...
    NewVendorComponent.prototype.RunComponentTimer = function () {
        var _this = this;
        this.Retries++;
        if (this.timerToken) {
    ...
    NewVendorComponent.prototype.LoadChildComponent = function () {
        var _this = this;
    ...
    NewVendorComponent.prototype.OkButtonClicked = function () {
        var _this = this;
        ...
        if (errors.length == 0) {
            ...
            this.DomainService.PostPartnerAddress(args).subscribe(function (myResponse) {
                ...
                if (!myResponse.HasError) {
                    _this.EntityPM = myResponse.Result.Vendor;
    ...
    ], NewVendorComponent.prototype, "viewContainerRef", void 0);
