...
var ModuleCommonOthers = /** @class */ (function () {
    function ModuleCommonOthers() {
    }
    ModuleCommonOthers.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCommonOthers = __decorate([
        core_1.NgModule({
    ...
    return ModuleCommonOthers;
}());
exports.ModuleCommonOthers = ModuleCommonOthers;
//# sourceMappingURL=ModuleCommonOthers.js.map