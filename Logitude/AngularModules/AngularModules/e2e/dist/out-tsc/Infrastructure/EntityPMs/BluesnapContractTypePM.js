...
var BluesnapContractTypePM = /** @class */ (function () {
    function BluesnapContractTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(BluesnapContractTypePM.prototype, "Code", {
    ...
    Object.defineProperty(BluesnapContractTypePM.prototype, "Name", {
    ...
    Object.defineProperty(BluesnapContractTypePM.prototype, "SearchFields", {
    ...
    BluesnapContractTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BluesnapContractType");
        }
    };
    BluesnapContractTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    BluesnapContractTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BluesnapContractTypePM.prototype, "PropertyChanged", void 0);
    return BluesnapContractTypePM;
}());
exports.BluesnapContractTypePM = BluesnapContractTypePM;
//# sourceMappingURL=BluesnapContractTypePM.js.map