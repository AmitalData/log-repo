...
var BIReportsTypePM = /** @class */ (function () {
    function BIReportsTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(BIReportsTypePM.prototype, "Code", {
    ...
    Object.defineProperty(BIReportsTypePM.prototype, "Name", {
    ...
    Object.defineProperty(BIReportsTypePM.prototype, "SearchFields", {
    ...
    BIReportsTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BIReportsType");
        }
    };
    BIReportsTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    BIReportsTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BIReportsTypePM.prototype, "PropertyChanged", void 0);
    return BIReportsTypePM;
}());
exports.BIReportsTypePM = BIReportsTypePM;
//# sourceMappingURL=BIReportsTypePM.js.map