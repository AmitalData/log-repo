...
var TogglePM = /** @class */ (function () {
    ...
    Object.defineProperty(TogglePM.prototype, "Name", {
    ...
    Object.defineProperty(TogglePM.prototype, "SearchFields", {
    ...
    TogglePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Toggle");
        }
    };
    TogglePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TogglePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TogglePM.prototype, "PropertyChanged", void 0);
    return TogglePM;
}());
exports.TogglePM = TogglePM;
//# sourceMappingURL=TogglePM.js.map