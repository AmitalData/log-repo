...
var ErrorLogPMFileLoggerService = /** @class */ (function () {
    function ErrorLogPMFileLoggerService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/FileLogger';
    }
    ErrorLogPMFileLoggerService.prototype.get = function (id) {
        var _this = this;
        var authHeader = new http_1.Headers();
        authHeader.append('Token', SessionInfo_1.SessionInfo.Token);
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/GetSingle?' + 'appSettingKeyValueIsLogUntilDateyyyyMMdd=' + id, {
                headers: authHeader
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "ErrorLog", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    ErrorLogPMFileLoggerService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "ErrorLog", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    ErrorLogPMFileLoggerService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    ErrorLogPMFileLoggerService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ErrorLogPMFileLoggerService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ErrorLogPM_1.ErrorLogPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ErrorLogPMFileLoggerService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ErrorLogPMFileLoggerService);
    return ErrorLogPMFileLoggerService;
}());
exports.ErrorLogPMFileLoggerService = ErrorLogPMFileLoggerService;
//# sourceMappingURL=ErrorLogPMFileLoggerService.js.map