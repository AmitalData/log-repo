...
var BackUpService = /** @class */ (function () {
    function BackUpService() {
        ...
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/BackUp';
    }
    BackUpService.prototype.BackUpForClientData = function (tenant) {
        var s = true;
    ...
    BackUpService.prototype.SetDatabaseDataBackupNotReady = function (tenant) {
        var authHeader = new http_1.Headers();
        authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
        authHeader.append('Content-Type', 'application/json');
    ...
    BackUpService.prototype.CheckIfDatabaseBackupIsBuilt = function (tenant) {
        var authHeader = new http_1.Headers();
        authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
        authHeader.append('Content-Type', 'application/json');
