...
var InboundEmailPM_1 = require("../../EntityPMs/InboundEmailPM");
var InboundEmailLinePM_1 = require("../../EntityPMs/InboundEmailLinePM");
var InboundEmailPMService = /** @class */ (function () {
    function InboundEmailPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/inboundemails';
    }
    InboundEmailPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "InboundEmail", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    InboundEmailPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "InboundEmail", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    InboundEmailPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    InboundEmailPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        if (mapParent === void 0) { mapParent = true; }
        if (entityPM === void 0) { entityPM = null; }
        if (!entityPM) {
            entityPM = new InboundEmailPM_1.InboundEmailPM();
        }
        var customFields = [];
        for (var i = 1; i < 11; i++) {
        ...
        if (mapParent) {
            ...
            for (var item in entityPM.InboundEmailLines) {
                ...
                var newInboundEmailLinePM = this.clone(myInboundEmailLinePM);
    ...
    InboundEmailPMService.prototype.MapInboundEmailLines = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
        var oldInboundEmailLines = [];
        if (entityPM.OldEntityPM && !mapParent) {
            oldInboundEmailLines = entityPM.OldEntityPM.InboundEmailLines;
        }
        entityPM.InboundEmailLines = new Array();
        for (var item in jsonPM.InboundEmailLines) {
            var jItem = jsonPM.InboundEmailLines[item];
            if (mapParent && (jItem.ChangeSetOp == "Delete" || jItem.ChangeSetOp == 3)) {
                continue;
            }
            var newInboundEmailLinePM;
            if (mapParent) {
                newInboundEmailLinePM = new InboundEmailLinePM_1.InboundEmailLinePM(entityPM);
            }
            else {
                newInboundEmailLinePM = new InboundEmailLinePM_1.InboundEmailLinePM(null);
            }
            ...
            if (mapParent) {
                newInboundEmailLinePM.UniqueKey = Guid_1.Guid.newGuid();
        ...
        if (oldInboundEmailLines) {
            for (var itemKey in oldInboundEmailLines) {
                if (entityPM.InboundEmailLines.filter(function (p) { return p.UniqueKey === oldInboundEmailLines[itemKey].UniqueKey; }).length === 0) {
                    if (oldInboundEmailLines[itemKey]) {
                        ...
                        var deletedPM = new InboundEmailLinePM_1.InboundEmailLinePM(null);
    ...
    InboundEmailPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    InboundEmailPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new InboundEmailPM_1.InboundEmailPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    InboundEmailPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], InboundEmailPMService);
    return InboundEmailPMService;
}());
exports.InboundEmailPMService = InboundEmailPMService;
//# sourceMappingURL=InboundEmailPMService.js.map