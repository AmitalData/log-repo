...
var ErrorLogPMService = /** @class */ (function () {
    function ErrorLogPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/errorlogs';
    }
    ErrorLogPMService.prototype.get = function (id) {
        var _this = this;
    ...
    ErrorLogPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    ErrorLogPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    ErrorLogPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    ErrorLogPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ErrorLogPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ErrorLogPM_1.ErrorLogPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ErrorLogPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ErrorLogPMService);
    return ErrorLogPMService;
}());
exports.ErrorLogPMService = ErrorLogPMService;
//# sourceMappingURL=ErrorLogPMService.js.map