...
var ObjectFieldPMService = /** @class */ (function () {
    function ObjectFieldPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/objectfields';
    }
    ObjectFieldPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "ObjectField", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    ObjectFieldPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "ObjectField", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    ObjectFieldPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    ObjectFieldPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    ObjectFieldPMService.prototype.MapObjectFieldValidations = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    ObjectFieldPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ObjectFieldPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ObjectFieldPM_1.ObjectFieldPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ObjectFieldPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ObjectFieldPMService);
    return ObjectFieldPMService;
}());
exports.ObjectFieldPMService = ObjectFieldPMService;
//# sourceMappingURL=ObjectFieldPMService.js.map