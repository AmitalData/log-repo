...
var TasksSchedulerPMService = /** @class */ (function () {
    function TasksSchedulerPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/tasksscheduler';
    }
    TasksSchedulerPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "TasksScheduler", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    TasksSchedulerPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    TasksSchedulerPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    TasksSchedulerPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    TasksSchedulerPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    TasksSchedulerPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new TasksSchedulerPM_1.TasksSchedulerPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    TasksSchedulerPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], TasksSchedulerPMService);
    return TasksSchedulerPMService;
}());
exports.TasksSchedulerPMService = TasksSchedulerPMService;
//# sourceMappingURL=TasksSchedulerPMService.js.map