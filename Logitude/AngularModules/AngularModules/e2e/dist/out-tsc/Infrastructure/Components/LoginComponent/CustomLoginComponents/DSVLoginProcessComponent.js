...
var DSVLoginProcessComponent = /** @class */ (function (_super) {
    __extends(DSVLoginProcessComponent, _super);
    function DSVLoginProcessComponent(mylogitudeApplicationService, myloginService, myIndexedDbService, myentityResourceService, _myapplicationTimersManager, myentityListService, _myuserLastLoginPMService) {
    ...
    DSVLoginProcessComponent.prototype.ngOnInit = function () {
        this.StartLoginProcess();
    };
    DSVLoginProcessComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return DSVLoginProcessComponent;
}(LoginComponent_1.LoginComponent));
exports.DSVLoginProcessComponent = DSVLoginProcessComponent;
//# sourceMappingURL=DSVLoginProcessComponent.js.map