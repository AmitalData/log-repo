...
var InfraGenericFilter = /** @class */ (function () {
    function InfraGenericFilter() {
    }
    InfraGenericFilter.GetFilteredArray = function (dataArray, filters) {
        ...
        var dddd = dataArray.filter(function (d) { return d.Code === 'AR'; })[0];
        for (var k in filters.AdditionalFilters) {
            var filter = filters.AdditionalFilters[k];
            if (!filter.IsCustom) {
    ...
    InfraGenericFilter.FilterArray = function (dataArray, fieldName, operator, value1, value2) {
        switch (operator) {
            case "LargerThan":
                {
    ...
    InfraGenericFilter.GetUniqueArray = function (array) {
        var a = array.concat();
    ...
    return InfraGenericFilter;
}());
exports.InfraGenericFilter = InfraGenericFilter;
//# sourceMappingURL=InfraGenericFilter.js.map