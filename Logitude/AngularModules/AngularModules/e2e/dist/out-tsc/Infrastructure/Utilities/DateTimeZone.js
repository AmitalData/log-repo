...
var DateTimeZone = /** @class */ (function () {
    ...
    DateTimeZone.GetTimeZonesList = function () {
        if (DateTimeZone.TimeZonesList == null) {
            this.TimeZonesList = new Array();
        }
    ...
    DateTimeZone.GetDateTimeFormats = function () {
        var DateTimeFormatsList = new Array();
...
var TimeZoneInfoClass = /** @class */ (function () {
    function TimeZoneInfoClass(timeZoneName, baseUtcOffset) {
        this.timeZoneName = timeZoneName;
        this.baseUtcOffset = baseUtcOffset;
        this.BaseUtcOffset = baseUtcOffset;
        this.TimeZoneName = timeZoneName;
    }
    return TimeZoneInfoClass;
}());
exports.TimeZoneInfoClass = TimeZoneInfoClass;
var DateTimeFormat = /** @class */ (function () {
    function DateTimeFormat(format, displaname) {
        this.format = format;
