...
var DynamicLoader_Cust_1 = require("./Utilities/DynamicLoader_Cust");
...
var RootComponent_Cust = /** @class */ (function () {
    function RootComponent_Cust() {
    ...
    RootComponent_Cust.prototype.Boot = function (args) {
        ServiceHelper_1.ServiceHelper.Http = args["Http"];
        SessionLocator_1.SessionLocator.Http = args["Http"];
        DynamicLoader_Cust_1.DynamicLoader_Cust.Compiler = args["Compiler"];
        DynamicLoader_Cust_1.DynamicLoader_Cust.Resolver = args["Resolver"];
        DynamicLoader_Cust_1.DynamicLoader_Cust.Injector = args["Injector"];
        DynamicLoader_Cust_1.DynamicLoader_Cust.ModuleLoader = args["ModuleLoader"];
        SessionLocator_1.SessionLocator.DynamicLoader = DynamicLoader_Cust_1.DynamicLoader_Cust;
    ...
    RootComponent_Cust.prototype.ngOnInit = function () {
        this.isComponentInited = true;
        this.RunComponent();
    };
    RootComponent_Cust.prototype.RunComponent = function () {
    ...
    RootComponent_Cust.prototype.ClearLocation = function () {
        if (this.location) {
            this.location.clear();
        }
    };
    RootComponent_Cust.prototype.BuildExternalParams = function () {
    ...
    RootComponent_Cust.prototype.LoadLoginPage = function () {
        var _this = this;
        this.ClearLocation();
        //this.isDSV = true;
        if (this.isDSV == true) {
    ...
    RootComponent_Cust.prototype.LoadBlockingScreen = function () {
        var _this = this;
        this.ClearLocation();
    ...
    RootComponent_Cust.prototype.ViewHomeComponent = function () {
        var _this = this;
        this.ClearLocation();
    ...
    RootComponent_Cust.prototype.ViewDeclarationApprovalComponent = function () {
        this.ClearLocation();
    ...
    RootComponent_Cust.prototype.ViewEComercePaymentRequestComponent = function () {
        this.ClearLocation();
    ...
    RootComponent_Cust.prototype.OnLoginCompleted = function (Param) {
        var _this = this;
    ...
    RootComponent_Cust.prototype.SignOutCompleted = function () {
    ...
    ], RootComponent_Cust.prototype, "location", void 0);
    RootComponent_Cust = __decorate([
        core_1.Component({
    ...
    return RootComponent_Cust;
}());
exports.RootComponent_Cust = RootComponent_Cust;
//# sourceMappingURL=RootComponent_Cust.js.map