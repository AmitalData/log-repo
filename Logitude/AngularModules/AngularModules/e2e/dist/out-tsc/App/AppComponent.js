...
var AppComponent = /** @class */ (function () {
    function AppComponent(compiler, resolver, http, moduleLoader, injector) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { _this._FinishLogin = true; }, 30000);
        this.moduleLoader.load('Infrastructure/Module_INFR#InfrastructureModule').then(function (moduleFactory) {
            ...
            var Component = Module.GetComponent("RootComponent");
            if (Component) {
