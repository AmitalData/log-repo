...
var StatementFilterComponent = /** @class */ (function (_super) {
    __extends(StatementFilterComponent, _super);
    function StatementFilterComponent() {
    ...
    StatementFilterComponent.prototype.InitializeComponent = function (myReportsPreview) {
        this.ReportsPreview = myReportsPreview;
    };
    StatementFilterComponent.prototype.ngOnInit = function () {
    ...
    StatementFilterComponent.prototype.RunReport = function (isloading) {
    ...
    StatementFilterComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return StatementFilterComponent;
}(BaseComponent_1.BaseComponent));
exports.StatementFilterComponent = StatementFilterComponent;
//# sourceMappingURL=StatementFilterComponent.js.map