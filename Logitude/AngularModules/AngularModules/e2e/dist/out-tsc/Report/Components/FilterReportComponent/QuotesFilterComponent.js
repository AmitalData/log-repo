...
var QuotesFilterComponent = /** @class */ (function (_super) {
    __extends(QuotesFilterComponent, _super);
    function QuotesFilterComponent() {
    ...
    Object.defineProperty(QuotesFilterComponent.prototype, "CustomerId", {
        get: function () { return this.customerId; },
        set: function (value) { this.customerId = value; },
        enumerable: true,
        configurable: true
    });
    QuotesFilterComponent.prototype.InitializeComponent = function (myReportsPreview) {
    ...
    QuotesFilterComponent.prototype.daysInMonth = function (aDate) {
        return (new Date(aDate.getFullYear(), aDate.getMonth() + 1, 0)).getDate();
    };
    QuotesFilterComponent.prototype.SetDate = function (year, month, day) {
        var date = new Date();
    ...
    QuotesFilterComponent.prototype.RunReport = function (isloading) {
    ...
    QuotesFilterComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return QuotesFilterComponent;
}(BaseComponent_1.BaseComponent));
exports.QuotesFilterComponent = QuotesFilterComponent;
//# sourceMappingURL=QuotesFilterComponent.js.map