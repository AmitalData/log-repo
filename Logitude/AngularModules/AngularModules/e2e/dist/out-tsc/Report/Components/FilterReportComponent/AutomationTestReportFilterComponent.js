...
var AutomationTestReportFilterComponent = /** @class */ (function (_super) {
    __extends(AutomationTestReportFilterComponent, _super);
    function AutomationTestReportFilterComponent() {
    ...
    AutomationTestReportFilterComponent.prototype.InitializeComponent = function (myReportsPreview) {
        this.ReportsPreview = myReportsPreview;
    };
    AutomationTestReportFilterComponent.prototype.RunReport = function (isloading) {
    ...
    AutomationTestReportFilterComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return AutomationTestReportFilterComponent;
}(BaseComponent_1.BaseComponent));
exports.AutomationTestReportFilterComponent = AutomationTestReportFilterComponent;
//# sourceMappingURL=AutomationTestReportFilterComponent.js.map