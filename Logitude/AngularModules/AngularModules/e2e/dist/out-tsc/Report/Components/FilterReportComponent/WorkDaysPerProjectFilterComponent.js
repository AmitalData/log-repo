...
var WorkDaysPerProjectFilterComponent = /** @class */ (function (_super) {
    __extends(WorkDaysPerProjectFilterComponent, _super);
    function WorkDaysPerProjectFilterComponent() {
        var _this = _super.call(this) || this;
        _this.DataContext = _this;
        _this.AgentId = null;
        _this.ObjectTableName = "TMEmployeeTime";
        _this.includeInnerProject = true;
        return _this;
    }
    Object.defineProperty(WorkDaysPerProjectFilterComponent.prototype, "IncludeInnerProject", {
        get: function () { return this.includeInnerProject; },
        set: function (value) {
    ...
    WorkDaysPerProjectFilterComponent.prototype.InitializeComponent = function (myReportsPreview) {
    ...
    WorkDaysPerProjectFilterComponent.prototype.daysInMonth = function (aDate) {
        return (new Date(aDate.getFullYear(), aDate.getMonth() + 1, 0)).getDate();
    };
    WorkDaysPerProjectFilterComponent.prototype.SetDate = function (year, month, day) {
        var date = new Date();
    ...
    WorkDaysPerProjectFilterComponent.prototype.RunReport = function () {
    ...
    WorkDaysPerProjectFilterComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return WorkDaysPerProjectFilterComponent;
}(BaseComponent_1.BaseComponent));
exports.WorkDaysPerProjectFilterComponent = WorkDaysPerProjectFilterComponent;
//# sourceMappingURL=WorkDaysPerProjectFilterComponent.js.map