...
var BookingFilterComponent = /** @class */ (function (_super) {
    __extends(BookingFilterComponent, _super);
    function BookingFilterComponent() {
        var _this = _super.call(this) || this;
        _this.ObjectTableName = "Report";
        _this.DataContext = _this;
        return _this;
    }
    BookingFilterComponent.prototype.InitializeComponent = function (myReportsPreview) {
    ...
    BookingFilterComponent.prototype.GetTenants = function () {
        var _this = this;
        var service = new ReportsDomainService_1.ReportsDomainService();
        service.GetActivityStatus(this.TenantPM.Id).subscribe(function (result) {
            _this.UpdateTenantsList(result);
        });
    };
    BookingFilterComponent.prototype.UpdateTenantsList = function (result) {
        var _this = this;
    ...
    Object.defineProperty(BookingFilterComponent.prototype, "SelectedItemComboBox", {
    ...
    BookingFilterComponent.prototype.daysInMonth = function (aDate) {
        return (new Date(aDate.getFullYear(), aDate.getMonth() + 1, 0)).getDate();
    };
    BookingFilterComponent.prototype.RunReport = function (isloading) {
    ...
    BookingFilterComponent.prototype.SetDate = function (year, month, day) {
        var date = new Date();
    ...
    BookingFilterComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return BookingFilterComponent;
}(BaseComponent_1.BaseComponent));
exports.BookingFilterComponent = BookingFilterComponent;
//# sourceMappingURL=BookingFilterComponent.js.map