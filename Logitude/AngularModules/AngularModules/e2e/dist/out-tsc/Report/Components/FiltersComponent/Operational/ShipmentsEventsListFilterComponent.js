...
var ShipmentsEventsListFilterComponent = /** @class */ (function (_super) {
    __extends(ShipmentsEventsListFilterComponent, _super);
    function ShipmentsEventsListFilterComponent() {
        var _this = _super.call(this) || this;
        _this.ObjectTableName = "Report";
        _this.ManuallyAddedEventsOnly = true;
        _this.DataContext = _this;
        var month = new Date().getMonth();
        var Year = new Date().getFullYear();
        var daysofmonth = _this.daysInMonth(new Date());
        _this.FromDate = _this.SetDate(Year, month, 1);
        _this.ToDate = _this.SetDate(Year, month, daysofmonth);
        return _this;
    }
    ShipmentsEventsListFilterComponent.prototype.InitializeComponent = function (myReportsPreview) {
        this.ReportsPreview = myReportsPreview;
    };
    ShipmentsEventsListFilterComponent.prototype.Validate = function () {
    ...
    ShipmentsEventsListFilterComponent.prototype.daysInMonth = function (aDate) {
        return (new Date(aDate.getFullYear(), aDate.getMonth() + 1, 0)).getDate();
    };
    ShipmentsEventsListFilterComponent.prototype.SetDate = function (year, month, day) {
        var date = new Date();
    ...
    ShipmentsEventsListFilterComponent.prototype.RunReport = function (isloading) {
        this.Validate();
    ...
    ShipmentsEventsListFilterComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return ShipmentsEventsListFilterComponent;
}(BaseComponent_1.BaseComponent));
exports.ShipmentsEventsListFilterComponent = ShipmentsEventsListFilterComponent;
//# sourceMappingURL=ShipmentsEventsListFilterComponent.js.map