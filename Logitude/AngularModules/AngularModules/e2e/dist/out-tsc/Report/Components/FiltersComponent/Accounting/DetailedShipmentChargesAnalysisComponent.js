...
var DetailedShipmentChargesAnalysisComponent = /** @class */ (function (_super) {
    __extends(DetailedShipmentChargesAnalysisComponent, _super);
    function DetailedShipmentChargesAnalysisComponent() {
        ...
        _this.includeCancelledShipments = false;
    ...
    DetailedShipmentChargesAnalysisComponent.prototype.ngOnInit = function () {
        this.SetUIProperties();
        this.BuildDateFilter();
    };
    DetailedShipmentChargesAnalysisComponent.prototype.SetUIProperties = function () {
        this.UIProperties.SetRequired("FromDate", null, Tools_1.AppTool.IsNullOrEmpty(this.FromDate) ? true : false);
    };
    DetailedShipmentChargesAnalysisComponent.prototype.BuildDateFilter = function () {
        this.DateFilterList = [];
        ...
        this.DateFilterList.push(new CodeNameClass_1.CodeNameClass("REG", "Registry Date"));
        this.selectedDateFilter = this.DateFilterList.filter(function (d) { return d.Code == "OPE"; })[0];
    };
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "SelectedDateFilter", {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "FromDate", {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "ToDate", {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "SelectedCurrencyCode", {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "IncludeDraftInvoices", {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "IncludeEstimations", {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "IncludeCancelledShipments", {
        get: function () { return this.includeCancelledShipments; },
        set: function (value) {
    ...
    Object.defineProperty(DetailedShipmentChargesAnalysisComponent.prototype, "SplitByCharges", {
    ...
    DetailedShipmentChargesAnalysisComponent.prototype.RunButtonClicked = function () {
        this.SetUIProperties();
        var errors = [];
        ...
        if (errors.length == 0) {
            var myFilterItems = [];
            myFilterItems.push(new QueryFilterItem_1.QueryFilterItem("SelectedDateType", this.SelectedDateFilter.Code));
            ...
            myFilterItems.push(new QueryFilterItem_1.QueryFilterItem("IncludeCancelledShipments", this.IncludeCancelledShipments));
    ...
    ], DetailedShipmentChargesAnalysisComponent.prototype, "RunReportEvent", void 0);
    DetailedShipmentChargesAnalysisComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return DetailedShipmentChargesAnalysisComponent;
}(BaseComponent_1.BaseComponent));
exports.DetailedShipmentChargesAnalysisComponent = DetailedShipmentChargesAnalysisComponent;
//# sourceMappingURL=DetailedShipmentChargesAnalysisComponent.js.map