...
var InventoryReportFilterConmponent = /** @class */ (function (_super) {
    __extends(InventoryReportFilterConmponent, _super);
    function InventoryReportFilterConmponent(fb) {
    ...
    InventoryReportFilterConmponent.prototype.InitializeComponent = function (myReportsPreview) {
        this.ReportsPreview = myReportsPreview;
        this.RunReport(false);
    };
    InventoryReportFilterConmponent.prototype.ngOnInit = function () {
    };
    InventoryReportFilterConmponent.prototype.RunReport = function (isloading) {
        ...
        if (!Tools_1.AppTool.IsNullOrEmpty(this.WarehouseId)) {
            this.queryFilterItem = new QueryFilterItem_1.QueryFilterItem();
            this.queryFilterItem.DisplayInList = false;
        ...
        if (!Tools_1.AppTool.IsNullOrEmpty(this.ShipperConsigneeId)) {
            this.queryFilterItem = new QueryFilterItem_1.QueryFilterItem();
            this.queryFilterItem.DisplayInList = false;
    ...
    InventoryReportFilterConmponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return InventoryReportFilterConmponent;
}(BaseComponent_1.BaseComponent));
exports.InventoryReportFilterConmponent = InventoryReportFilterConmponent;
//# sourceMappingURL=InventoryReportFilterConmponent.js.map