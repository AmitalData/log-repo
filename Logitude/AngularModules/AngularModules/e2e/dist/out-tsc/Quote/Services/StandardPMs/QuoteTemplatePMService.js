...
var QuoteTemplatePMService = /** @class */ (function () {
    function QuoteTemplatePMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/quotetemplates';
    }
    QuoteTemplatePMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "QuoteTemplate", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    QuoteTemplatePMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    QuoteTemplatePMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    QuoteTemplatePMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    QuoteTemplatePMService.prototype.MapTemplateSections = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    QuoteTemplatePMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    QuoteTemplatePMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new QuoteTemplatePM_1.QuoteTemplatePM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    QuoteTemplatePMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], QuoteTemplatePMService);
    return QuoteTemplatePMService;
}());
exports.QuoteTemplatePMService = QuoteTemplatePMService;
//# sourceMappingURL=QuoteTemplatePMService.js.map