...
var NewQuoteAddEditAddressComponent = /** @class */ (function (_super) {
    __extends(NewQuoteAddEditAddressComponent, _super);
    function NewQuoteAddEditAddressComponent(entityResourceService) {
        ...
        _this.myService = new AddressPMService_1.AddressPMService();
        _this.myCardListService = new CardListService_1.CardListService();
        return _this;
    }
    NewQuoteAddEditAddressComponent.prototype.SetWindowArgs = function (args) {
        var _this = this;
        ...
        this.entityResourceService.getEntityResourceByTableName(this.ObjectTableName).subscribe(function (res) {
            ...
            _this.myCardListService.getSingle(myCardId).subscribe(function (myResponse1) {
                ...
                if (Tools_1.AppTool.IsNullOrEmpty(entityId)) {
                    ...
                    _this.myService.get(entityId).subscribe(function (myResponse2) {
    ...
    NewQuoteAddEditAddressComponent.prototype.SetUIProperties = function () {
        this.SetUIProperties_State();
        this.SetUIProperties_TelFax();
    };
    NewQuoteAddEditAddressComponent.prototype.SetUIProperties_State = function () {
        this.SetUIProperties_StateEnabled();
        this.SetUIProperties_StateRequired();
    };
    NewQuoteAddEditAddressComponent.prototype.SetUIProperties_StateEnabled = function () {
        var isEnabled = false;
    ...
    NewQuoteAddEditAddressComponent.prototype.SetUIProperties_StateRequired = function () {
    ...
    NewQuoteAddEditAddressComponent.prototype.SetUIProperties_TelFax = function () {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "Description", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "Name", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "Address1", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "Address2", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "ZipCode", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "City", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "Country", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "CountryId", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "CountryCode", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "CountryName", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "CountryEnglishName", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "State", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "StateId", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "StateCode", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "StateEnglishName", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "InActive", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "PhoneNumber", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "FaxNumber", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "ATTN", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "IsLocalLanguage", {
    ...
    Object.defineProperty(NewQuoteAddEditAddressComponent.prototype, "AddressTypeId", {
        get: function () { return this.EntityPM.AddressTypeId; },
        enumerable: true,
        configurable: true
    });
    NewQuoteAddEditAddressComponent.prototype.OnCountryChanged = function (list) {
        if (list == null) {
    ...
    NewQuoteAddEditAddressComponent.prototype.OnStateChanged = function (list) {
        if (list == null) {
            this.StateCode = null;
    ...
    NewQuoteAddEditAddressComponent.prototype.SelectCityCommand = function () {
        var _this = this;
    ...
    NewQuoteAddEditAddressComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    NewQuoteAddEditAddressComponent.prototype.OkButtonClicked = function () {
        var _this = this;
        var errors = [];
    ...
    NewQuoteAddEditAddressComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return NewQuoteAddEditAddressComponent;
}(BaseComponent_1.BaseComponent));
exports.NewQuoteAddEditAddressComponent = NewQuoteAddEditAddressComponent;
//# sourceMappingURL=NewQuoteAddEditAddressComponent.js.map