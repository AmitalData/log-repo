...
var QuoteUtilities = /** @class */ (function () {
    function QuoteUtilities() {
    }
    QuoteUtilities.IsQuoteEditEnabled = function (entityPM) {
        var myResult = true;
        if (entityPM != null) {
    ...
    QuoteUtilities.IsLCLQuote = function (entityPM) {
        var myResult = false;
        if (entityPM != null) {
    ...
    QuoteUtilities.IsInlandDomestic = function (entityPM) {
    ...
    QuoteUtilities.RecalculateQuoteFields = function (entityPM) {
        if (entityPM != null) {
            if (entityPM.Ratio == null) {
                entityPM.Ratio = Tools_1.AppTool.GetRatio(entityPM.DirectionId, entityPM.TransportModeId, entityPM.ShipmentTypeId, InfraSettings_1.InfraSettings.TenantPM.CountryCode);
            }
            entityPM.QuotePackages.forEach(function (item) {
                item.Volume = Tools_1.AppTool.ComputePackageVolume(item.Quantity, item.Width, item.Height, item.Length, item.GrossWeight, entityPM.Ratio, entityPM.DimensionsUnitCode, entityPM.VolumeUnitCode, entityPM.GrossWeightUnitCode);
                item.VolumetricWeight = Tools_1.AppTool.ComputePackageVolumetricWeight(item.Quantity, item.Width, item.Height, item.Length, item.Volume, item.GrossWeight, entityPM.Ratio, entityPM.DimensionsUnitCode, entityPM.VolumeUnitCode, entityPM.GrossWeightUnitCode, entityPM.ChargeableWeightUnitCode);
            });
            if (entityPM.QuotePackages.length == 0) {
                ...
                entityPM.ChargeableWeight = Tools_1.AppTool.CalculateChargeableWeight(entityPM.GrossWeight, entityPM.VolumetricWeight, entityPM.GrossWeightUnitCode, entityPM.ChargeableWeightUnitCode, entityPM.DirectionId, entityPM.TransportModeId);
            }
        }
    };
    QuoteUtilities.OnQuoteRatioChanged = function (entityPM) {
        if (entityPM) {
            if (entityPM.Ratio == null) {
                entityPM.Ratio = Tools_1.AppTool.GetRatio(entityPM.DirectionId, entityPM.TransportModeId, entityPM.ShipmentTypeId, InfraSettings_1.InfraSettings.TenantPM.CountryCode);
            }
            if (entityPM.QuotePackages.length == 0) {
                ...
                entityPM.QuotePackages.forEach(function (item) {
                    if (item.Volume) {
                        item.VolumetricWeight = Tools_1.AppTool.GetWeightFromVolume(entityPM.VolumeUnitCode, entityPM.ChargeableWeightUnitCode, item.Volume, entityPM.Ratio);
                    }
                });
                entityPM.VolumetricWeight = Tools_1.AppTool.Round(Tools_1.ArrayTool.Sum(entityPM.QuotePackages, "VolumetricWeight"), 3);
                entityPM.ChargeableWeight = Tools_1.AppTool.CalculateChargeableWeight(entityPM.GrossWeight, entityPM.VolumetricWeight, entityPM.GrossWeightUnitCode, entityPM.ChargeableWeightUnitCode, entityPM.DirectionId, entityPM.TransportModeId);
            }
        }
    };
    QuoteUtilities.CopyQuote = function (entityPM, copiedEntityPM) {
    ...
    QuoteUtilities.CopyQuotePackages = function (entityPM, copiedEntityPM) {
        copiedEntityPM.QuotePackages.forEach(function (item) {
            var newPackage = new QuotePackagePM_1.QuotePackagePM(null);
    ...
    QuoteUtilities.CopyQuoteCharges = function (entityPM, oldEntityPM, isCopySales, isCopyCost) {
        if (entityPM.QuoteCharges.length > 0) {
            entityPM.QuoteCharges.forEach(function (itemCharge) {
                itemCharge.QuoteChargePriceSteps.forEach(function (priceItem) {
        ...
        oldEntityPM.QuoteCharges.forEach(function (item) {
            var newChargePM = new QuoteChargePM_1.QuoteChargePM(null);
            ...
            if (item.IsChargeBySteps) {
                item.QuoteChargePriceSteps.forEach(function (step) {
                    var stepItem = new QuotePriceStepsPM_1.QuotePriceStepsPM(item);
    ...
    QuoteUtilities.ComputeChargeableWeight = function (entityPM) {
        var myResult = 0;
        myResult = Tools_1.AppTool.CalculateChargeableWeight(entityPM.GrossWeight, entityPM.VolumetricWeight, entityPM.GrossWeightUnitCode, entityPM.ChargeableWeightUnitCode, entityPM.DirectionId, entityPM.TransportModeId);
        return myResult;
    };
    QuoteUtilities.ComputeVolumetricWeight = function (entityPM) {
        var myResult = 0;
        if (entityPM.Volume != null) {
            myResult = Tools_1.AppTool.GetWeightFromVolume(entityPM.VolumeUnitCode, entityPM.ChargeableWeightUnitCode, entityPM.Volume, entityPM.Ratio);
        }
        else if (entityPM.GrossWeight != null) {
            myResult = Tools_1.AppTool.GetWeightFromWeight(entityPM.GrossWeightUnitCode, entityPM.ChargeableWeightUnitCode, entityPM.GrossWeight);
        }
        return myResult;
    };
    QuoteUtilities.ComputeQuoteTEU = function (entityPM) {
        var totalTEU = 0;
        var packageTypeService = new PackageTypeListService_1.PackageTypeListService();
        if (!Tools_1.AppTool.IsNullOrEmpty(entityPM.PackageType1Id) && entityPM.PackageType1Quantity != null) {
            packageTypeService.getSingleFromCache(entityPM.PackageType1Id).subscribe(function (myResponse) {
                if (myResponse != null) {
        ...
        if (!Tools_1.AppTool.IsNullOrEmpty(entityPM.PackageType2Id) && entityPM.PackageType2Quantity != null) {
            packageTypeService.getSingleFromCache(entityPM.PackageType2Id).subscribe(function (myResponse) {
                if (myResponse != null) {
                    var myPackageTypeList = myResponse.Result;
                    if (myPackageTypeList != null) {
        ...
        if (!Tools_1.AppTool.IsNullOrEmpty(entityPM.PackageType3Id) && entityPM.PackageType3Quantity != null) {
            packageTypeService.getSingleFromCache(entityPM.PackageType3Id).subscribe(function (myResponse) {
                if (myResponse != null) {
                    var myPackageTypeList = myResponse.Result;
                    if (myPackageTypeList != null) {
        ...
        if (!Tools_1.AppTool.IsNullOrEmpty(entityPM.PackageType4Id) && entityPM.PackageType4Quantity != null) {
            packageTypeService.getSingleFromCache(entityPM.PackageType4Id).subscribe(function (myResponse) {
                if (myResponse != null) {
                    var myPackageTypeList = myResponse.Result;
                    if (myPackageTypeList != null) {
        ...
        if (!Tools_1.AppTool.IsNullOrEmpty(entityPM.PackageType5Id) && entityPM.PackageType5Quantity != null) {
            packageTypeService.getSingleFromCache(entityPM.PackageType5Id).subscribe(function (myResponse) {
                if (myResponse != null) {
                    var myPackageTypeList = myResponse.Result;
                    if (myPackageTypeList != null) {
    ...
    QuoteUtilities.BuildShipment = function (entityPM) {
        var packageTypeService = new PackageTypeListService_1.PackageTypeListService();
        var shipmentPM = new ShipmentPM_1.ShipmentPM();
        shipmentPM.IsBuildFromQuote = true;
        shipmentPM.Tenant = SessionLocator_1.SessionLocator.Tenant;
        ...
        shipmentPM.ProfitCurrencyId = SessionLocator_1.SessionLocator.TenantPM.ProfitCurrencyId;
        shipmentPM.AWBCurrencyId = SessionLocator_1.SessionLocator.TenantPM.FreightCurrencyId;
        shipmentPM.FreightPrepaidCollectId = SessionLocator_1.SessionLocator.TenantPM.ExportFreightPrepaidCollectId;
        shipmentPM.OtherPrepaidCollectId = SessionLocator_1.SessionLocator.TenantPM.ExportOtherPrepaidCollectId;
        ...
        if (this.IsLCLQuote(entityPM)) {
            entityPM.QuotePackages.forEach(function (item) {
                ...
                packageTypeService.getSingleFromCache(item.PackageTypeId).subscribe(function (myResponse) {
                    if (myResponse != null) {
                        var myPackageTypeList = myResponse.Result;
                        if (myPackageTypeList != null) {
    ...
    return QuoteUtilities;
}());
exports.QuoteUtilities = QuoteUtilities;
//# sourceMappingURL=QuoteUtilities.js.map