...
var ModuleCustomsVendor = /** @class */ (function () {
    function ModuleCustomsVendor() {
    }
    ModuleCustomsVendor.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsVendor = __decorate([
        core_1.NgModule({
    ...
    return ModuleCustomsVendor;
}());
exports.ModuleCustomsVendor = ModuleCustomsVendor;
//# sourceMappingURL=ModuleCustomsVendor.js.map