...
var ModuleDeclarationOthers = /** @class */ (function () {
    function ModuleDeclarationOthers() {
    }
    ModuleDeclarationOthers.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleDeclarationOthers = __decorate([
        core_1.NgModule({
    ...
    ], ModuleDeclarationOthers);
    return ModuleDeclarationOthers;
}());
exports.ModuleDeclarationOthers = ModuleDeclarationOthers;
//# sourceMappingURL=ModuleDeclarationOthers.js.map