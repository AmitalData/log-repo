...
var ModuleDeclarationSupplierInvoice = /** @class */ (function () {
    function ModuleDeclarationSupplierInvoice() {
    }
    ModuleDeclarationSupplierInvoice.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleDeclarationSupplierInvoice = __decorate([
        core_1.NgModule({
    ...
    ], ModuleDeclarationSupplierInvoice);
    return ModuleDeclarationSupplierInvoice;
}());
exports.ModuleDeclarationSupplierInvoice = ModuleDeclarationSupplierInvoice;
//# sourceMappingURL=ModuleDeclarationSupplierInvoice.js.map