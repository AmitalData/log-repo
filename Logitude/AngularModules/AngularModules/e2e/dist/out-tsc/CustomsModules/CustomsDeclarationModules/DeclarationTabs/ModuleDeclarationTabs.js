...
var ModuleDeclarationTabs = /** @class */ (function () {
    function ModuleDeclarationTabs() {
    }
    ModuleDeclarationTabs.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleDeclarationTabs = __decorate([
        core_1.NgModule({
    ...
    ], ModuleDeclarationTabs);
    return ModuleDeclarationTabs;
}());
exports.ModuleDeclarationTabs = ModuleDeclarationTabs;
//# sourceMappingURL=ModuleDeclarationTabs.js.map