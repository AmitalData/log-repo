...
var ModuleCustomsPaymentOrder = /** @class */ (function () {
    function ModuleCustomsPaymentOrder() {
    }
    ModuleCustomsPaymentOrder.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsPaymentOrder = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsPaymentOrder);
    return ModuleCustomsPaymentOrder;
}());
exports.ModuleCustomsPaymentOrder = ModuleCustomsPaymentOrder;
//# sourceMappingURL=ModuleCustomsPaymentOrder.js.map