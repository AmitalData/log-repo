...
var RequestDetailsComponent = /** @class */ (function (_super) {
    __extends(RequestDetailsComponent, _super);
    function RequestDetailsComponent(entityArgs, cd) {
        ...
        _this.RequestDetailsList = [];
        return _this;
    }
    RequestDetailsComponent.prototype.ngOnInit = function () {
        console.log("t1");
    };
    RequestDetailsComponent.prototype.SetWindowArgs = function (accountingCustomFilesList) {
        var _this = this;
        accountingCustomFilesList.forEach(function (item) {
            _this.RequestDetailsList.push(item);
        });
    };
...
//# sourceMappingURL=RequestDetailsComponent.js.map