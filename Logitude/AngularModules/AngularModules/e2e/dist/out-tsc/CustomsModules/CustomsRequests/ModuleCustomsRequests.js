...
var ModuleCustomsRequests = /** @class */ (function () {
    function ModuleCustomsRequests() {
    }
    ModuleCustomsRequests.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsRequests = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsRequests);
    return ModuleCustomsRequests;
}());
exports.ModuleCustomsRequests = ModuleCustomsRequests;
//# sourceMappingURL=ModuleCustomsRequests.js.map