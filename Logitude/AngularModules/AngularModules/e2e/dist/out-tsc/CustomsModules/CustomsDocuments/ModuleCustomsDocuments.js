...
var ModuleCustomsDocuments = /** @class */ (function () {
    function ModuleCustomsDocuments() {
    }
    ModuleCustomsDocuments.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsDocuments = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsDocuments);
    return ModuleCustomsDocuments;
}());
exports.ModuleCustomsDocuments = ModuleCustomsDocuments;
//# sourceMappingURL=ModuleCustomsDocuments.js.map