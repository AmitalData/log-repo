...
var ModuleCustomsClaim = /** @class */ (function () {
    function ModuleCustomsClaim() {
    }
    ModuleCustomsClaim.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsClaim = __decorate([
        core_1.NgModule({
    ...
    return ModuleCustomsClaim;
}());
exports.ModuleCustomsClaim = ModuleCustomsClaim;
//# sourceMappingURL=ModuleCustomsClaim.js.map