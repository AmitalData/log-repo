...
var ModulePhysicalCheck = /** @class */ (function () {
    function ModulePhysicalCheck() {
    }
    ModulePhysicalCheck.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModulePhysicalCheck = __decorate([
        core_1.NgModule({
    ...
    return ModulePhysicalCheck;
}());
exports.ModulePhysicalCheck = ModulePhysicalCheck;
//# sourceMappingURL=ModulePhysicalCheck.js.map