...
var ModuleCustomsDeclarationCargoSplit = /** @class */ (function () {
    function ModuleCustomsDeclarationCargoSplit() {
    }
    ModuleCustomsDeclarationCargoSplit.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsDeclarationCargoSplit = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsDeclarationCargoSplit);
    return ModuleCustomsDeclarationCargoSplit;
}());
exports.ModuleCustomsDeclarationCargoSplit = ModuleCustomsDeclarationCargoSplit;
//# sourceMappingURL=ModuleCustomsDeclarationCargoSplit.js.map