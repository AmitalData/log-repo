...
var ModuleProceduralFault = /** @class */ (function () {
    function ModuleProceduralFault() {
    }
    ModuleProceduralFault.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleProceduralFault = __decorate([
        core_1.NgModule({
    ...
    ], ModuleProceduralFault);
    return ModuleProceduralFault;
}());
exports.ModuleProceduralFault = ModuleProceduralFault;
//# sourceMappingURL=ModuleProceduralFault.js.map