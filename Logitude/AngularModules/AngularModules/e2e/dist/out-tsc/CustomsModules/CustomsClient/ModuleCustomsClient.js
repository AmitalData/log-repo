...
var ModuleCustomsClient = /** @class */ (function () {
    function ModuleCustomsClient() {
    }
    ModuleCustomsClient.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsClient = __decorate([
        core_1.NgModule({
    ...
    return ModuleCustomsClient;
}());
exports.ModuleCustomsClient = ModuleCustomsClient;
//# sourceMappingURL=ModuleCustomsClient.js.map