...
var ModuleCustomsGeneralRequests = /** @class */ (function () {
    function ModuleCustomsGeneralRequests() {
    }
    ModuleCustomsGeneralRequests.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsGeneralRequests = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsGeneralRequests);
    return ModuleCustomsGeneralRequests;
}());
exports.ModuleCustomsGeneralRequests = ModuleCustomsGeneralRequests;
//# sourceMappingURL=ModuleCustomsGeneralRequests.js.map