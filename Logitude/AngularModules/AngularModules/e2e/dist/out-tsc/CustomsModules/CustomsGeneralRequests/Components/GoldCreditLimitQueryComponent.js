...
var GoldCreditLimitQueryComponent = /** @class */ (function (_super) {
    __extends(GoldCreditLimitQueryComponent, _super);
    function GoldCreditLimitQueryComponent() {
    ...
    GoldCreditLimitQueryComponent.prototype.ngAfterViewInit = function () {
    ...
    GoldCreditLimitQueryComponent.prototype.OnMassageDisplayMethod = function () {
        var _this = this;
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "AgentExternalID", {
        //#region Properties
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "AgentID", {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "StartDate", {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "EndDate", {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "ImporterCode", {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "CreationDate", {
        get: function () { return this.ResponseData ? this.ResponseData.CreationDate : null; },
        set: function (value) {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "RTGSDeposits", {
        get: function () { return this.ResponseData ? this.ResponseData.RTGSDeposits : null; },
        set: function (value) {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "RTGSUsed", {
        get: function () { return this.ResponseData ? this.ResponseData.RTGSUsed : null; },
        set: function (value) {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "RTGSCurrentBalance", {
        get: function () { return this.ResponseData ? this.ResponseData.RTGSCurrentBalance : null; },
        set: function (value) {
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "ActiveInd", {
        get: function () { return this.ResponseData ? this.ResponseData.RTGSUsed : null; },
        set: function (value) {
            if (this.ResponseData.RTGSUsed != value) {
                this.ResponseData.RTGSUsed = value;
    ...
    Object.defineProperty(GoldCreditLimitQueryComponent.prototype, "ImporterName", {
    ...
    GoldCreditLimitQueryComponent.prototype.ImporterClicked = function (client) {
        this.ImporterCode = client.Code;
        this.ImporterName = Tools_1.AppTool.IsNullOrEmpty(client) ? "" : client.FullName;
    };
    GoldCreditLimitQueryComponent.prototype.ImporterTextChanged = function (item) {
        if (item == "") {
    ...
    GoldCreditLimitQueryComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    GoldCreditLimitQueryComponent.prototype.OnCustomSendOptionsButtonClick = function (customSendOptionsArgs) {
        var _this = this;
        ...
        CustomMessageProgressComponent_1.CustomMessageProgressComponent
            .ShowProgressBar(currRequestParams.PBId, "שליחת שאילתא לנתוני העברת זהב", true)
            .then(function (res) {
    ...
    ], GoldCreditLimitQueryComponent.prototype, "SuperCustomMessageWrapperComponent", void 0);
    GoldCreditLimitQueryComponent = __decorate([
        core_1.Component({
    ...
    return GoldCreditLimitQueryComponent;
}(BaseRequestsSheetMassaging_1.BaseRequestsSheetMassaging));
exports.GoldCreditLimitQueryComponent = GoldCreditLimitQueryComponent;
//# sourceMappingURL=GoldCreditLimitQueryComponent.js.map