...
var ModuleCustomsCourier = /** @class */ (function () {
    function ModuleCustomsCourier() {
    }
    ModuleCustomsCourier.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsCourier = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsCourier);
    return ModuleCustomsCourier;
}());
exports.ModuleCustomsCourier = ModuleCustomsCourier;
//# sourceMappingURL=ModuleCustomsCourier.js.map