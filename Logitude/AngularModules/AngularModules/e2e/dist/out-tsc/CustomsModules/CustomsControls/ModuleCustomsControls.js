...
var ModuleCustomsControls = /** @class */ (function () {
    function ModuleCustomsControls() {
    }
    ModuleCustomsControls.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsControls = __decorate([
        core_1.NgModule({
            ...
            exports: ModuleDeclarations_1.Components.slice(),
        })
    ], ModuleCustomsControls);
    return ModuleCustomsControls;
}());
exports.ModuleCustomsControls = ModuleCustomsControls;
//# sourceMappingURL=ModuleCustomsControls.js.map