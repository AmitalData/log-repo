...
var ModuleCustomsMaintenance = /** @class */ (function () {
    function ModuleCustomsMaintenance() {
    }
    ModuleCustomsMaintenance.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleCustomsMaintenance = __decorate([
        core_1.NgModule({
    ...
    ], ModuleCustomsMaintenance);
    return ModuleCustomsMaintenance;
}());
exports.ModuleCustomsMaintenance = ModuleCustomsMaintenance;
//# sourceMappingURL=ModuleCustomsMaintenance.js.map