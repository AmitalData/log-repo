...
var CustomAgentPM_1 = require("../../EntityPMs/CustomAgentPM");
...
var CustomAgentPMService = /** @class */ (function () {
    function CustomAgentPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/customagents';
    }
    CustomAgentPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "CustomAgent", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    CustomAgentPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            var errorsArray = validator.Validate("CustomAgent", entityPM);
            var serviceResponse;
            serviceResponse = new ServiceResponse_1.ServiceResponse();
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "CustomAgent", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    CustomAgentPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    CustomAgentPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        if (mapParent === void 0) { mapParent = true; }
        if (entityPM === void 0) { entityPM = null; }
        if (!entityPM) {
            entityPM = new CustomAgentPM_1.CustomAgentPM();
        }
        var customFields = [];
        for (var i = 1; i < 11; i++) {
    ...
    CustomAgentPMService.prototype.MapAddresses = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    CustomAgentPMService.prototype.MapContacts = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    CustomAgentPMService.prototype.MapCardExternalCodeByCurrencies = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    CustomAgentPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    CustomAgentPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new CustomAgentPM_1.CustomAgentPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    CustomAgentPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], CustomAgentPMService);
    return CustomAgentPMService;
}());
exports.CustomAgentPMService = CustomAgentPMService;
//# sourceMappingURL=CustomAgentPMService.js.map