...
var TenantPMService = /** @class */ (function () {
    function TenantPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/tenants';
    }
    TenantPMService.prototype.get = function (id) {
        var _this = this;
    ...
    TenantPMService.prototype.insert = function (entityPM) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
    ...
    TenantPMService.prototype.update = function (entityPM) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
    ...
    TenantPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        if (mapParent === void 0) { mapParent = true; }
        if (entityPM === void 0) { entityPM = null; }
        if (!entityPM) {
            entityPM = new TenantPM_1.TenantPM();
        }
    ...
    TenantPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    TenantPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new TenantPM_1.TenantPM();
        return entityPM;
    };
    TenantPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], TenantPMService);
    return TenantPMService;
}());
exports.TenantPMService = TenantPMService;
//# sourceMappingURL=TenantPMService.js.map