...
var ParticipantPM_1 = require("../../EntityPMs/ParticipantPM");
var AddressPM_1 = require("../../EntityPMs/AddressPM");
var ContactPM_1 = require("../../EntityPMs/ContactPM");
var ParticipantPMService = /** @class */ (function () {
    function ParticipantPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/participants';
    }
    ParticipantPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "Participant", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    ParticipantPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "Participant", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    ParticipantPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    ParticipantPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        if (mapParent === void 0) { mapParent = true; }
        if (entityPM === void 0) { entityPM = null; }
        if (!entityPM) {
            entityPM = new ParticipantPM_1.ParticipantPM();
        }
        var customFields = [];
        for (var i = 1; i < 11; i++) {
    ...
    ParticipantPMService.prototype.MapAddresses = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    ParticipantPMService.prototype.MapContacts = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    ParticipantPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ParticipantPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ParticipantPM_1.ParticipantPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ParticipantPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ParticipantPMService);
    return ParticipantPMService;
}());
exports.ParticipantPMService = ParticipantPMService;
//# sourceMappingURL=ParticipantPMService.js.map