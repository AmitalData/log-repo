...
var ContactPMService = /** @class */ (function () {
    function ContactPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/contacts';
    }
    ContactPMService.prototype.get = function (id) {
        var _this = this;
    ...
    ContactPMService.prototype.insert = function (entityPM) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
    ...
    ContactPMService.prototype.update = function (entityPM) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
    ...
    ContactPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    ContactPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ContactPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ContactPM_1.ContactPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ContactPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ContactPMService);
    return ContactPMService;
}());
exports.ContactPMService = ContactPMService;
//# sourceMappingURL=ContactPMService.js.map