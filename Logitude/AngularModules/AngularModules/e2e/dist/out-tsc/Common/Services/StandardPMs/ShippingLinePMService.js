...
var ShippingLinePMService = /** @class */ (function () {
    function ShippingLinePMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/shippinglines';
    }
    ShippingLinePMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "ShippingLine", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    ShippingLinePMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "ShippingLine", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    ShippingLinePMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    ShippingLinePMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        if (mapParent === void 0) { mapParent = true; }
        if (entityPM === void 0) { entityPM = null; }
        if (!entityPM) {
            entityPM = new ShippingLinePM_1.ShippingLinePM();
        }
        var customFields = [];
        for (var i = 1; i < 11; i++) {
    ...
    ShippingLinePMService.prototype.MapCardExternalCodeByCurrencies = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    ShippingLinePMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ShippingLinePMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ShippingLinePM_1.ShippingLinePM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ShippingLinePMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ShippingLinePMService);
    return ShippingLinePMService;
}());
exports.ShippingLinePMService = ShippingLinePMService;
//# sourceMappingURL=ShippingLinePMService.js.map