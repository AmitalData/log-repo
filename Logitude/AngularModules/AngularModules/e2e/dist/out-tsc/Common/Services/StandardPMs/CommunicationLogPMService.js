...
var CommunicationLogPMService = /** @class */ (function () {
    function CommunicationLogPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/communicationlogs';
    }
    CommunicationLogPMService.prototype.get = function (id) {
        var _this = this;
    ...
    CommunicationLogPMService.prototype.insert = function (entityPM) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
    ...
    CommunicationLogPMService.prototype.update = function (entityPM) {
        var _this = this;
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            authHeader.append('Token', ServiceHelper_1.ServiceHelper.GetLoggedUserToken());
    ...
    CommunicationLogPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    CommunicationLogPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    CommunicationLogPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new CommunicationLogPM_1.CommunicationLogPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    CommunicationLogPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], CommunicationLogPMService);
    return CommunicationLogPMService;
}());
exports.CommunicationLogPMService = CommunicationLogPMService;
//# sourceMappingURL=CommunicationLogPMService.js.map