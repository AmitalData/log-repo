...
var AccountingTab_Branch = /** @class */ (function (_super) {
    __extends(AccountingTab_Branch, _super);
    function AccountingTab_Branch(entityArgs) {
    ...
    AccountingTab_Branch.prototype.Listen = function () {
        var _this = this;
    ...
    AccountingTab_Branch.prototype.ngOnDestroy = function () {
        Tools_1.AppTool.KillEventEmitter(this.SaveCompletedEvent);
        Tools_1.AppTool.KillEventEmitter(this.LoadCompletedEvent);
    };
    Object.defineProperty(AccountingTab_Branch.prototype, "ExternalId", {
    ...
    AccountingTab_Branch = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return AccountingTab_Branch;
}(BaseComponent_1.BaseComponent));
exports.AccountingTab_Branch = AccountingTab_Branch;
//# sourceMappingURL=AccountingTab_Branch.js.map