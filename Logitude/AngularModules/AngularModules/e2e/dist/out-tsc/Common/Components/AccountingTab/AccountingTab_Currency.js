...
var AccountingTab_Currency = /** @class */ (function (_super) {
    __extends(AccountingTab_Currency, _super);
    function AccountingTab_Currency(entityArgs) {
    ...
    AccountingTab_Currency.prototype.Listen = function () {
        var _this = this;
    ...
    AccountingTab_Currency.prototype.ngOnDestroy = function () {
        Tools_1.AppTool.KillEventEmitter(this.SaveCompletedEvent);
        Tools_1.AppTool.KillEventEmitter(this.LoadCompletedEvent);
    };
    Object.defineProperty(AccountingTab_Currency.prototype, "AccountingExternalCode", {
        get: function () { return this.EntityPM.AccountingExternalCode; },
        set: function (value) {
    ...
    AccountingTab_Currency = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return AccountingTab_Currency;
}(BaseComponent_1.BaseComponent));
exports.AccountingTab_Currency = AccountingTab_Currency;
//# sourceMappingURL=AccountingTab_Currency.js.map