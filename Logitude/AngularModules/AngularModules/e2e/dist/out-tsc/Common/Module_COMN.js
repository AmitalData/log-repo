...
var LogitudeCommonModule = /** @class */ (function () {
    function LogitudeCommonModule() {
    }
    LogitudeCommonModule.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    LogitudeCommonModule.GetInstance = function (name) {
        return ModuleProviders_1.ModuleProviders.GetInstance(name);
    };
    LogitudeCommonModule.Components = ModuleDeclarations_1.Components;
    LogitudeCommonModule = __decorate([
        core_1.NgModule({
    ...
    ], LogitudeCommonModule);
    return LogitudeCommonModule;
}());
exports.LogitudeCommonModule = LogitudeCommonModule;
//# sourceMappingURL=Module_COMN.js.map