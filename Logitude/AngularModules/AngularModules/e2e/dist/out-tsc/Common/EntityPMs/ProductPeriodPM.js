...
var ProductPeriodPM = /** @class */ (function () {
    function ProductPeriodPM() {
        this.UIProperties = new UIProperties_1.UIProperties;
        this.IsDirty = false;
    }
    Object.defineProperty(ProductPeriodPM.prototype, "Code", {
        get: function () { return this.code; },
        set: function (newValue) { this.code = newValue; this.MarkAsDirty(); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ProductPeriodPM.prototype, "Name", {
        get: function () { return this.name; },
        set: function (newValue) { this.name = newValue; this.MarkAsDirty(); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ProductPeriodPM.prototype, "SearchFields", {
        get: function () { return this.searchFields; },
        set: function (newValue) { this.searchFields = newValue; this.MarkAsDirty(); },
        enumerable: true,
        configurable: true
    });
    ProductPeriodPM.prototype.MarkAsDirty = function () {
        this.IsDirty = true;
    };
    return ProductPeriodPM;
}());
exports.ProductPeriodPM = ProductPeriodPM;
//# sourceMappingURL=ProductPeriodPM.js.map