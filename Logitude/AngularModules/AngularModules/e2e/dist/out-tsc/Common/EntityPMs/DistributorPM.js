...
var DistributorPM = /** @class */ (function () {
    function DistributorPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(DistributorPM.prototype, "Code", {
    ...
    Object.defineProperty(DistributorPM.prototype, "EnglishName", {
    ...
    Object.defineProperty(DistributorPM.prototype, "LocalName", {
    ...
    Object.defineProperty(DistributorPM.prototype, "SearchFields", {
    ...
    DistributorPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Distributor");
        }
    };
    DistributorPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    DistributorPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DistributorPM.prototype, "PropertyChanged", void 0);
    return DistributorPM;
}());
exports.DistributorPM = DistributorPM;
//# sourceMappingURL=DistributorPM.js.map