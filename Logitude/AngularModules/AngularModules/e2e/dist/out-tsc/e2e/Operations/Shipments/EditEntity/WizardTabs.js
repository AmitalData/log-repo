...
var WizardTabComponent = /** @class */ (function () {
    function WizardTabComponent() {
        this.Helper = new FieldsHelper_1.FieldsHelper();
    }
    WizardTabComponent.prototype.GeneralTab = function (LogitudeShipType) {
    };
    WizardTabComponent.prototype.FillPartnersTab = function (shipperRef1, LogitudeWizardType) {
    ...
    WizardTabComponent.prototype.FillRoutingTab = function (shipperRef1, LogitudeWizardType) {
        ...
        if (LogitudeWizardType == 'D') {
            ...
            protractor_1.browser.wait(EC.elementToBeClickable(protractor_1.element(protractor_1.by.css(".SimpleGridViewRow "))), 100000).then(function (a) {
            });
            protractor_1.element.all(protractor_1.by.css('.SimpleGridViewRow')).get(1).click();
    ...
    WizardTabComponent.prototype.FillPackagesTab = function (LogitudeWizardType) {
    ...
    WizardTabComponent.prototype.FillFreightChargesTab = function (LogitudeWizardType) {
    ...
    WizardTabComponent.prototype.FillOtherChargesTab = function (LogitudeWizardType) {
    ...
    WizardTabComponent.prototype.FillGeneralDetailsTab = function (LogitudeWizardType) {
    ...
    WizardTabComponent.prototype.FillOCITab = function (LogitudeWizardType) {
    ...
    WizardTabComponent.prototype.FillOtherPartnersTab = function (LogitudeWizardType) {
    ...
    return WizardTabComponent;
}());
exports.WizardTabComponent = WizardTabComponent;
