...
var RoutingTabComponent = /** @class */ (function () {
    function RoutingTabComponent() {
        this.Helper = new FieldsHelper_1.FieldsHelper();
    }
    RoutingTabComponent.prototype.RoutingTab = function (ShipmentLevelCode, ShipmentType, Direction) {
    ...
    RoutingTabComponent.prototype.EditMainCarriage = function (ShipmentLevelCode, Direction, ShipmentType) {
    ...
    RoutingTabComponent.prototype.AddPickup = function () {
        this.Helper.WaitByIdAndClick('Add-PickUp');
        // From Port Details 
        this.Helper.WaitByIdAndClick('ShipmentPickUpDelivery_CarrierId');
        var fromPortBtn = protractor_1.element(protractor_1.by.id('Port_FromRadio'));
        protractor_1.browser.executeScript("arguments[0].click();", fromPortBtn.getWebElement());
        this.Helper.WaitByIdAndFill('ShipmentPickUpDelivery_FromPortId', 'eze');
        this.Helper.WaitByCssAndClick_FromTagInsideList('.DropDownListItem', 0);
        //To Port Details 
        protractor_1.browser.executeScript("arguments[0].click();", protractor_1.element(protractor_1.by.id('Port_ToRadio')).getWebElement());
    ...
    RoutingTabComponent.prototype.AddPreCarriage = function (ShipmentType) {
    ...
    RoutingTabComponent.prototype.AddOnCarriage = function (ShipmentType) {
        this.Helper.WaitByIdAndClick('RoutingToggle');
    ...
    RoutingTabComponent.prototype.AddDelivery = function () {
    ...
    return RoutingTabComponent;
}());
exports.RoutingTabComponent = RoutingTabComponent;
//# sourceMappingURL=RoutingTab.js.map