...
var NewARInvoice = /** @class */ (function () {
    function NewARInvoice() {
        this.Helper = new FieldsHelper_1.FieldsHelper();
        this.gn = new GeneralFunctions_1.GeneralFunctions();
    }
    NewARInvoice.prototype.CreateNewARInvoice = function (BillToName) {
...
exports.NewARInvoice = NewARInvoice;
//  });
//  });
// this.Helper
//this.Helper.WaitBusyIndicator();
...
// this.Helper.WaitByIdAndClick('EditBackbutton');
//   browser.sleep(5000);
//# sourceMappingURL=NewARInvoice.js.map