...
var GLAccountCounterPM = /** @class */ (function () {
    function GLAccountCounterPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(GLAccountCounterPM.prototype, "Id", {
    ...
    Object.defineProperty(GLAccountCounterPM.prototype, "Tenant", {
    ...
    Object.defineProperty(GLAccountCounterPM.prototype, "Prefix", {
    ...
    Object.defineProperty(GLAccountCounterPM.prototype, "StartNumber", {
    ...
    Object.defineProperty(GLAccountCounterPM.prototype, "CurrentNumber", {
        get: function () { return this.currentNumber; },
        set: function (newValue) { if (this.currentNumber != newValue) {
            this.currentNumber = newValue;
            this.MarkAsDirty("CurrentNumber");
        } },
        enumerable: true,
        configurable: true
    });
    GLAccountCounterPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "GLAccountCounter");
        }
    };
    GLAccountCounterPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    GLAccountCounterPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], GLAccountCounterPM.prototype, "PropertyChanged", void 0);
    return GLAccountCounterPM;
}());
exports.GLAccountCounterPM = GLAccountCounterPM;
//# sourceMappingURL=GLAccountCounterPM.js.map