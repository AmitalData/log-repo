...
var PeriodTypePM = /** @class */ (function () {
    function PeriodTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(PeriodTypePM.prototype, "Code", {
    ...
    Object.defineProperty(PeriodTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(PeriodTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(PeriodTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(PeriodTypePM.prototype, "Inactive", {
    ...
    PeriodTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "PeriodType");
        }
    };
    PeriodTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    PeriodTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], PeriodTypePM.prototype, "PropertyChanged", void 0);
    return PeriodTypePM;
}());
exports.PeriodTypePM = PeriodTypePM;
//# sourceMappingURL=PeriodTypePM.js.map