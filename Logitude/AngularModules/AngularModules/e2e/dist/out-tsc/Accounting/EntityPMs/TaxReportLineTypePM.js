...
var TaxReportLineTypePM = /** @class */ (function () {
    function TaxReportLineTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TaxReportLineTypePM.prototype, "Code", {
    ...
    Object.defineProperty(TaxReportLineTypePM.prototype, "Name", {
    ...
    Object.defineProperty(TaxReportLineTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(TaxReportLineTypePM.prototype, "Inactive", {
    ...
    TaxReportLineTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaxReportLineType");
        }
    };
    TaxReportLineTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TaxReportLineTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TaxReportLineTypePM.prototype, "PropertyChanged", void 0);
    return TaxReportLineTypePM;
}());
exports.TaxReportLineTypePM = TaxReportLineTypePM;
//# sourceMappingURL=TaxReportLineTypePM.js.map