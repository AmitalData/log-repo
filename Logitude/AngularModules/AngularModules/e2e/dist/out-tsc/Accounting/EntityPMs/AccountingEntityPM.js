...
var AccountingEntityPM = /** @class */ (function () {
    function AccountingEntityPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(AccountingEntityPM.prototype, "Code", {
    ...
    Object.defineProperty(AccountingEntityPM.prototype, "LocalName", {
    ...
    Object.defineProperty(AccountingEntityPM.prototype, "EnglishName", {
    ...
    AccountingEntityPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AccountingEntity");
        }
    };
    AccountingEntityPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    AccountingEntityPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], AccountingEntityPM.prototype, "PropertyChanged", void 0);
    return AccountingEntityPM;
}());
exports.AccountingEntityPM = AccountingEntityPM;
//# sourceMappingURL=AccountingEntityPM.js.map