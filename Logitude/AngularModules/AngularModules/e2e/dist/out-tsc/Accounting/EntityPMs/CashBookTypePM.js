...
var CashBookTypePM = /** @class */ (function () {
    function CashBookTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(CashBookTypePM.prototype, "Code", {
    ...
    Object.defineProperty(CashBookTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(CashBookTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(CashBookTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(CashBookTypePM.prototype, "Inactive", {
    ...
    CashBookTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CashBookType");
        }
    };
    CashBookTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    CashBookTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], CashBookTypePM.prototype, "PropertyChanged", void 0);
    return CashBookTypePM;
}());
exports.CashBookTypePM = CashBookTypePM;
//# sourceMappingURL=CashBookTypePM.js.map