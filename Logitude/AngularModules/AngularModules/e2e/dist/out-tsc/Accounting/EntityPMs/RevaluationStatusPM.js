...
var RevaluationStatusPM = /** @class */ (function () {
    function RevaluationStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(RevaluationStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(RevaluationStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(RevaluationStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(RevaluationStatusPM.prototype, "LocalName", {
    ...
    RevaluationStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "RevaluationStatus");
        }
    };
    RevaluationStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    RevaluationStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], RevaluationStatusPM.prototype, "PropertyChanged", void 0);
    return RevaluationStatusPM;
}());
exports.RevaluationStatusPM = RevaluationStatusPM;
//# sourceMappingURL=RevaluationStatusPM.js.map