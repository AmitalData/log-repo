...
var TaxReportStatusPM = /** @class */ (function () {
    function TaxReportStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TaxReportStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(TaxReportStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(TaxReportStatusPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(TaxReportStatusPM.prototype, "LocalName", {
    ...
    Object.defineProperty(TaxReportStatusPM.prototype, "Inactive", {
    ...
    TaxReportStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaxReportStatus");
        }
    };
    TaxReportStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TaxReportStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TaxReportStatusPM.prototype, "PropertyChanged", void 0);
    return TaxReportStatusPM;
}());
exports.TaxReportStatusPM = TaxReportStatusPM;
//# sourceMappingURL=TaxReportStatusPM.js.map