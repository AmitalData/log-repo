...
var TestEntityPM = /** @class */ (function () {
    function TestEntityPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(TestEntityPM.prototype, "Id", {
    ...
    Object.defineProperty(TestEntityPM.prototype, "Tenant", {
    ...
    Object.defineProperty(TestEntityPM.prototype, "EnglishName", {
    ...
    TestEntityPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TestEntity");
        }
    };
    TestEntityPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    TestEntityPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], TestEntityPM.prototype, "PropertyChanged", void 0);
    return TestEntityPM;
}());
exports.TestEntityPM = TestEntityPM;
//# sourceMappingURL=TestEntityPM.js.map