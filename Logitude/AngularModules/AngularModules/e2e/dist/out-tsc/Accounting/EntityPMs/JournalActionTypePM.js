...
var JournalActionTypePM = /** @class */ (function () {
    function JournalActionTypePM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(JournalActionTypePM.prototype, "Id", {
    ...
    Object.defineProperty(JournalActionTypePM.prototype, "Tenant", {
    ...
    Object.defineProperty(JournalActionTypePM.prototype, "Code", {
    ...
    Object.defineProperty(JournalActionTypePM.prototype, "LocalName", {
    ...
    Object.defineProperty(JournalActionTypePM.prototype, "EnglishName", {
    ...
    Object.defineProperty(JournalActionTypePM.prototype, "SearchFields", {
    ...
    Object.defineProperty(JournalActionTypePM.prototype, "Inactive", {
    ...
    JournalActionTypePM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "JournalActionType");
        }
    };
    JournalActionTypePM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    JournalActionTypePM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], JournalActionTypePM.prototype, "PropertyChanged", void 0);
    return JournalActionTypePM;
}());
exports.JournalActionTypePM = JournalActionTypePM;
//# sourceMappingURL=JournalActionTypePM.js.map