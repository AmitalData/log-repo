...
var MainPageComponent = /** @class */ (function () {
    ...
    MainPageComponent.prototype.InitComponent = function () {
        this.LoadAllScreenData();
        this.SetQueriesVisibility();
    };
    MainPageComponent.prototype.RefreshButtonClicked = function () {
        this.LoadAllScreenData();
    };
    MainPageComponent.prototype.LoadAllScreenData = function () {
        this.LoadQueriesCounts();
        this.LoadRecentGLAccounts();
        this.ReloadUsersQuery();
    };
    MainPageComponent.prototype.SetQueriesVisibility = function () {
    ...
    MainPageComponent.prototype.ReloadUsersQuery = function () {
        this.ReloadUserQueries.emit();
    };
    MainPageComponent.prototype.onUserQueriesBackComplete = function (event) {
        this.LoadAllScreenData();
    };
    MainPageComponent.prototype.LoadQueriesCounts = function () {
        var _this = this;
    ...
    MainPageComponent.prototype.EditGLAccount = function (entity) {
        var _this = this;
        if (entity != null) {
    ...
    MainPageComponent.prototype.RunNewGLAccountWizard = function () {
        var _this = this;
    ...
    MainPageComponent.prototype.ViewAccountingQuery = function (myQueryCode) {
        var _this = this;
        if (myQueryCode != null) {
            var displayTitle = "";
    ...
    // Journals
    MainPageComponent.prototype.ViewJournalQuery = function (myQueryCode) {
        var _this = this;
        if (myQueryCode != null) {
            var displayTitle = "";
            var queryCode = myQueryCode;
    ...
    MainPageComponent.prototype.RunNewJournalWizard = function () {
        var _this = this;
    ...
    MainPageComponent.prototype.LoadRecentGLAccounts = function () {
        var _this = this;
    ...
    ], MainPageComponent.prototype, "ReloadUserQueries", void 0);
