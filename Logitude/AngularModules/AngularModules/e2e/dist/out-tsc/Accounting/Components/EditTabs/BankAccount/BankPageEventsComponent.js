...
var BankPageEventsComponent = /** @class */ (function (_super) {
    __extends(BankPageEventsComponent, _super);
    function BankPageEventsComponent(_entityResourceService, entityArgs) {
    ...
    BankPageEventsComponent.prototype.SetWindowArgs = function (args) {
    ...
    BankPageEventsComponent.prototype.OkButtonClicked = function () {
        this.CancelButtonClicked();
    };
    BankPageEventsComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    BankPageEventsComponent.prototype.ngAfterViewInit = function () {
        this.LoadEventsTab();
    };
    BankPageEventsComponent.prototype.LoadEventsTab = function () {
    ...
    ], BankPageEventsComponent.prototype, "AllLocations", void 0);
    BankPageEventsComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return BankPageEventsComponent;
}(BaseComponent_1.BaseComponent));
exports.BankPageEventsComponent = BankPageEventsComponent;
//# sourceMappingURL=BankPageEventsComponent.js.map