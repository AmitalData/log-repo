...
var AccountingFunctionalTestComponent = /** @class */ (function (_super) {
    __extends(AccountingFunctionalTestComponent, _super);
    function AccountingFunctionalTestComponent() {
    ...
    AccountingFunctionalTestComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    AccountingFunctionalTestComponent.prototype.OnKeyUp = function (key) {
    ...
    AccountingFunctionalTestComponent.prototype.FillErrors = function () {
    ...
    AccountingFunctionalTestComponent.prototype.OkButtonClicked = function () {
        var _this = this;
        this.FillErrors();
    ...
    //#region upload
    AccountingFunctionalTestComponent.prototype.ShowMessage = function (message) {
        var messageWindow = new MessageWindow_1.MessageWindow();
        messageWindow.Show(message);
    };
    AccountingFunctionalTestComponent.prototype.OpenUpLoadFile = function () {
        document.getElementById(this.UploadFileId).click();
    };
    AccountingFunctionalTestComponent.prototype.UploadFile = function (event) {
    ...
    AccountingFunctionalTestComponent.prototype.ArrayBufferToBase64 = function (file, viewmodel) {
    ...
    AccountingFunctionalTestComponent.prototype.TryParseLocally = function () {
    ...
    AccountingFunctionalTestComponent.prototype.IncreaseProgressBar = function (ProgressBarValue) {
    };
    AccountingFunctionalTestComponent.prototype.IncreaseProgressBarNOTINUSE = function (ProgressBarValue) {
    ...
    AccountingFunctionalTestComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return AccountingFunctionalTestComponent;
}(BaseComponent_1.BaseComponent));
exports.AccountingFunctionalTestComponent = AccountingFunctionalTestComponent;
//# sourceMappingURL=AccountingFunctionalTestComponent.js.map