...
var RevaluationDetailsComponent = /** @class */ (function (_super) {
    ...
    function RevaluationDetailsComponent(entityArgs) {
        ...
        _this.EntityPM = null;
        _this.journalExtendedListService = new JournalExtendedListService_1.JournalExtendedListService();
        _this.entityResourceService = new EntityResourceService_1.EntityResourceService();
        _this.SelectedRow = null;
        _this.entityResourceService.getEntityResourceByTableName("Journal").subscribe(function (response) {
            _this.entityResourceService.getEntityResourceByTableName("JournalLine").subscribe(function (response) {
                _this.entityResourceService.getEntityResourceByTableName("Revaluation").subscribe(function (response) {
                    _this.visible = true;
    ...
    RevaluationDetailsComponent.prototype.GetJournals = function () {
        var _this = this;
        this.journalExtendedListService.GetJournalsByAccountingEntityId(this.EntityPM.Id, "8").subscribe(function (myResponse) {
            if (myResponse) {
                if (myResponse.Result) {
                    _this.Journals.InsertCollection(myResponse.Result);
                    if (_this.Journals.Length > 0)
                        _this.OnRowSelected(_this.Journals.Collection[0]);
                }
            }
        });
    };
