...
var ReconciliationPMService = /** @class */ (function () {
    function ReconciliationPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/reconciliations';
    }
    ReconciliationPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "Reconciliation", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    ReconciliationPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "Reconciliation", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    ReconciliationPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    ReconciliationPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        ...
        if (mapParent) {
            ...
            for (var item in entityPM.ReconciliationLines) {
                ...
                var newReconciliationLinePM = this.clone(myReconciliationLinePM);
    ...
    ReconciliationPMService.prototype.MapReconciliationLines = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
            ...
            for (var itemKey in oldReconciliationLines) {
                if (entityPM.ReconciliationLines.filter(function (p) { return p.UniqueKey === oldReconciliationLines[itemKey].UniqueKey; }).length === 0) {
                    if (oldReconciliationLines[itemKey]) {
                        ...
                        var deletedPM = new ReconciliationLinePM_1.ReconciliationLinePM(null);
    ...
    ReconciliationPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    ReconciliationPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new ReconciliationPM_1.ReconciliationPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    ReconciliationPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], ReconciliationPMService);
    return ReconciliationPMService;
}());
exports.ReconciliationPMService = ReconciliationPMService;
//# sourceMappingURL=ReconciliationPMService.js.map