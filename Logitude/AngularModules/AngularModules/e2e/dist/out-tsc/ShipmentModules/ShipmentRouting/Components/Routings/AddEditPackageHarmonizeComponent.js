...
var AddEditPackageHarmonizeComponent = /** @class */ (function () {
    function AddEditPackageHarmonizeComponent(entityResourceService) {
        ...
        this.ItemsSource = [];
        this.ObjectTableName = "PickUpDeliveryPackageHarmonize";
    ...
    AddEditPackageHarmonizeComponent.prototype.SetWindowArgs = function (args) {
        ...
        this.entityResourceService.getEntityResourceByTableName(this.ObjectTableName, 0).subscribe(function (response) {
            if (args) {
                ...
                _this.EntityPM.PickUpDeliveryPackageHarmonizes.forEach(function (item) {
    ...
    AddEditPackageHarmonizeComponent.prototype.AddButtonClicked = function () {
        var item = new PickUpDeliveryPackageHarmonizePM_1.PickUpDeliveryPackageHarmonizePM(this.EntityPM);
    ...
    AddEditPackageHarmonizeComponent.prototype.OkButtonClicked = function () {
        ...
        if (errors.length == 0) {
            var allItemsPM = [];
            this.ItemsSource.forEach(function (item) {
                var index = _this.EntityPM.PickUpDeliveryPackageHarmonizes.indexOf(item.EntityPM);
                if (index > -1) {
                    var itemPM = _this.EntityPM.PickUpDeliveryPackageHarmonizes[index];
                    if (itemPM) {
                    ...
                    _this.EntityPM.PickUpDeliveryPackageHarmonizes.push(item.EntityPM);
                }
...
var HarmonizeItemClass = /** @class */ (function (_super) {
    ...
    function HarmonizeItemClass(item) {
        ...
        _this.Id = null;
        _this.ObjectTableName = "PickUpDeliveryPackageHarmonize";
        _this.OldValue = null;
        _this.Id = item.Id;
        _this.EntityPM = item;
