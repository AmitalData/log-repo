...
var PickupPackagesAddEditComponent = /** @class */ (function (_super) {
    __extends(PickupPackagesAddEditComponent, _super);
    function PickupPackagesAddEditComponent() {
    ...
    PickupPackagesAddEditComponent.prototype.SetDataContext = function (dataContext) {
    ...
    PickupPackagesAddEditComponent.prototype.SetLabels = function () {
    ...
    PickupPackagesAddEditComponent.prototype.CancelButtonClicked = function () {
        this.RejectChanges();
        this.CurrentSession.CloseCurrentWindow();
    };
    PickupPackagesAddEditComponent.prototype.OkButtonClicked = function () {
        var errors = [];
    ...
    PickupPackagesAddEditComponent.prototype.MultiHarmonizeClicked = function () {
        var _this = this;
    ...
    PickupPackagesAddEditComponent.prototype.ChooseHarmonizeClicked = function () {
        if (this.DataContext) {
    ...
    PickupPackagesAddEditComponent.prototype.Clone = function () {
    ...
    PickupPackagesAddEditComponent.prototype.RejectChanges = function () {
        this.myCloner.RejectChanges();
    };
    PickupPackagesAddEditComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return PickupPackagesAddEditComponent;
}(BaseComponent_1.BaseComponent));
exports.PickupPackagesAddEditComponent = PickupPackagesAddEditComponent;
//# sourceMappingURL=PickupPackagesAddEditComponent.js.map