...
var PickupDocsOutTabComponent = /** @class */ (function () {
    function PickupDocsOutTabComponent() {
        this.EntityPM = null;
        ...
        this.ChildObjectTableId = null;
        this.ChildEntityReference = null;
    }
    PickupDocsOutTabComponent.prototype.InitTab = function (myEntityPM, myShipmentPM) {
    ...
    PickupDocsOutTabComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return PickupDocsOutTabComponent;
}());
exports.PickupDocsOutTabComponent = PickupDocsOutTabComponent;
//# sourceMappingURL=PickupDocsOutTabComponent.js.map