...
var DeliveryDocsInTabComponent = /** @class */ (function () {
    function DeliveryDocsInTabComponent() {
        this.ObjectTableName = "ShipmentPickUpDelivery";
        this.DataContext = this;
    }
    DeliveryDocsInTabComponent.prototype.InitTab = function (myEntityPM, myShipmentPM) {
    ...
    DeliveryDocsInTabComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return DeliveryDocsInTabComponent;
}());
exports.DeliveryDocsInTabComponent = DeliveryDocsInTabComponent;
//# sourceMappingURL=DeliveryDocsInTabComponent.js.map