...
var ModuleShipmentRouting = /** @class */ (function () {
    function ModuleShipmentRouting() {
    }
    ModuleShipmentRouting.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentRouting = __decorate([
        core_1.NgModule({
    ...
    ], ModuleShipmentRouting);
    return ModuleShipmentRouting;
}());
exports.ModuleShipmentRouting = ModuleShipmentRouting;
//# sourceMappingURL=ModuleShipmentRouting.js.map