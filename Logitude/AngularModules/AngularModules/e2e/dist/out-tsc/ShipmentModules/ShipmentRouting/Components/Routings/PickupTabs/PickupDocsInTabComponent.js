...
var PickupDocsInTabComponent = /** @class */ (function () {
    function PickupDocsInTabComponent() {
        this.ObjectTableName = "ShipmentPickUpDelivery";
        this.DataContext = this;
    }
    PickupDocsInTabComponent.prototype.InitTab = function (myEntityPM, myShipmentPM) {
    ...
    PickupDocsInTabComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return PickupDocsInTabComponent;
}());
exports.PickupDocsInTabComponent = PickupDocsInTabComponent;
//# sourceMappingURL=PickupDocsInTabComponent.js.map