...
var ModuleShipmentTabs = /** @class */ (function () {
    function ModuleShipmentTabs() {
    }
    ModuleShipmentTabs.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentTabs = __decorate([
        core_1.NgModule({
    ...
    return ModuleShipmentTabs;
}());
exports.ModuleShipmentTabs = ModuleShipmentTabs;
//# sourceMappingURL=ModuleShipmentTabs.js.map