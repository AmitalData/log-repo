...
var ModuleShipmentINTTRA = /** @class */ (function () {
    function ModuleShipmentINTTRA() {
    }
    ModuleShipmentINTTRA.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentINTTRA = __decorate([
        core_1.NgModule({
    ...
    ], ModuleShipmentINTTRA);
    return ModuleShipmentINTTRA;
}());
exports.ModuleShipmentINTTRA = ModuleShipmentINTTRA;
//# sourceMappingURL=ModuleShipmentINTTRA.js.map