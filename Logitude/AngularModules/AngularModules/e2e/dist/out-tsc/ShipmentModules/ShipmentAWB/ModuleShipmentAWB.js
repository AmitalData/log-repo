...
var ModuleShipmentAWB = /** @class */ (function () {
    function ModuleShipmentAWB() {
    }
    ModuleShipmentAWB.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentAWB = __decorate([
        core_1.NgModule({
    ...
    return ModuleShipmentAWB;
}());
exports.ModuleShipmentAWB = ModuleShipmentAWB;
//# sourceMappingURL=ModuleShipmentAWB.js.map