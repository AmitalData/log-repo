...
var ModuleShipmentLogBox = /** @class */ (function () {
    function ModuleShipmentLogBox() {
    }
    ModuleShipmentLogBox.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentLogBox = __decorate([
        core_1.NgModule({
    ...
    ], ModuleShipmentLogBox);
    return ModuleShipmentLogBox;
}());
exports.ModuleShipmentLogBox = ModuleShipmentLogBox;
//# sourceMappingURL=ModuleShipmentLogBox.js.map