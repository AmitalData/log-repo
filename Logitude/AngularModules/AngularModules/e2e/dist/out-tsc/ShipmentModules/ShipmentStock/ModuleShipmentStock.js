...
var ModuleShipmentStock = /** @class */ (function () {
    function ModuleShipmentStock() {
    }
    ModuleShipmentStock.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentStock = __decorate([
        core_1.NgModule({
    ...
    return ModuleShipmentStock;
}());
exports.ModuleShipmentStock = ModuleShipmentStock;
//# sourceMappingURL=ModuleShipmentStock.js.map