...
var ModuleShipmentOthers = /** @class */ (function () {
    function ModuleShipmentOthers() {
    }
    ModuleShipmentOthers.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleShipmentOthers = __decorate([
        core_1.NgModule({
    ...
    ], ModuleShipmentOthers);
    return ModuleShipmentOthers;
}());
exports.ModuleShipmentOthers = ModuleShipmentOthers;
//# sourceMappingURL=ModuleShipmentOthers.js.map