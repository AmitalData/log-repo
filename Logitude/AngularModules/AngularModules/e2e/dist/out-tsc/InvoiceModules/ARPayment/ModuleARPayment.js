...
var ModuleARPayment = /** @class */ (function () {
    function ModuleARPayment() {
    }
    ModuleARPayment.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleARPayment = __decorate([
        core_1.NgModule({
    ...
    return ModuleARPayment;
}());
exports.ModuleARPayment = ModuleARPayment;
//# sourceMappingURL=ModuleARPayment.js.map