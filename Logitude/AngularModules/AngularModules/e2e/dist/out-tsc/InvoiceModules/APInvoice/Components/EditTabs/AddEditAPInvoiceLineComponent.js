...
var AddEditAPInvoiceLineComponent = /** @class */ (function () {
    function AddEditAPInvoiceLineComponent() {
        this.EntityPM = null;
    ...
    AddEditAPInvoiceLineComponent.prototype.SetDataContext = function (dataContext) {
        this.EntityPM = dataContext.EntityPM;
        this.DataContext = dataContext;
        this.EntityPM = dataContext.invoiceLinePM;
        this.Clone();
    };
    AddEditAPInvoiceLineComponent.prototype.CancelButtonClicked = function () {
        this.RejectChanges();
        this.CurrentSession.CloseCurrentWindow();
    };
    AddEditAPInvoiceLineComponent.prototype.OkButtonClicked = function () {
        var errors = [];
    ...
    AddEditAPInvoiceLineComponent.prototype.Clone = function () {
    ...
    AddEditAPInvoiceLineComponent.prototype.RejectChanges = function () {
        this.myCloner.RejectChanges();
    };
    AddEditAPInvoiceLineComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return AddEditAPInvoiceLineComponent;
}());
exports.AddEditAPInvoiceLineComponent = AddEditAPInvoiceLineComponent;
//# sourceMappingURL=AddEditAPInvoiceLineComponent.js.map