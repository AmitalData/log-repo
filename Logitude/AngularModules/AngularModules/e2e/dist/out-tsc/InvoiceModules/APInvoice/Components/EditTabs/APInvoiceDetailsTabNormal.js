...
var APInvoiceDetailsTabNormal = /** @class */ (function (_super) {
    __extends(APInvoiceDetailsTabNormal, _super);
    function APInvoiceDetailsTabNormal(entityArgs) {
    ...
    APInvoiceDetailsTabNormal.prototype.Listen = function () {
        var _this = this;
    ...
    APInvoiceDetailsTabNormal.prototype.ngOnDestroy = function () {
        Tools_1.AppTool.KillEventEmitter(this.SaveCompletedEvent);
        Tools_1.AppTool.KillEventEmitter(this.LoadCompletedEvent);
    };
    APInvoiceDetailsTabNormal.prototype.InitializeServices = function () {
    ...
    APInvoiceDetailsTabNormal.prototype.GetAllVatTypes = function () {
        var _this = this;
    ...
    APInvoiceDetailsTabNormal.prototype.SetUIProperties = function () {
    ...
    APInvoiceDetailsTabNormal.prototype.SetUIProperties_DueDate = function () {
    ...
    APInvoiceDetailsTabNormal.prototype.SetUIProperties_VATNumber = function () {
    ...
    APInvoiceDetailsTabNormal.prototype.SetUIProperties_ExchangeRate = function () {
        var isEnabled = false;
        if (this.IsScreenEnabled) {
    ...
    // Refresh Screen
    APInvoiceDetailsTabNormal.prototype.RefreshScreen = function () {
        this.SetUIProperties();
        this.BuildInvoiceLines();
    };
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "IsScreenEnabled", {
        get: function () {
            var result = true;
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "VatTypeFilterButtonIsEnabled", {
        get: function () {
            var result = true;
            if (this.EntityPM != null) {
                if (!this.IsScreenEnabled) {
    ...
    APInvoiceDetailsTabNormal.prototype.LoadData = function () {
        var _this = this;
    ...
    APInvoiceDetailsTabNormal.prototype.UpdateData = function () {
        var _this = this;
        this.CurrentSession.StartBusyIndicatorLoading();
        if (this.myCurrencyRatesService == null) {
            this.myCurrencyRatesService = new CurrencyRatesService_1.CurrencyRatesService();
    ...
    APInvoiceDetailsTabNormal.prototype.SetCurrencyRateData = function () {
        var _this = this;
        var myRate = null;
        var myRateDate = null;
    ...
    APInvoiceDetailsTabNormal.prototype.GetCurrencyRate = function (currencyId) {
        var myResult = null;
    ...
    APInvoiceDetailsTabNormal.prototype.GetCurrencyRateDate = function (currencyId) {
        var myResult = null;
        if (!Tools_1.AppTool.IsNullOrEmpty(currencyId)) {
            if (currencyId == SessionLocator_1.SessionLocator.TenantPM.CurrencyId) {
                myResult = null;
    ...
    APInvoiceDetailsTabNormal.prototype.GetVatTypePercentage = function (vatTypeId) {
        var myResult = null;
    ...
    APInvoiceDetailsTabNormal.prototype.UpdateCurrencyRateClicked = function () {
        var _this = this;
        var loadingDate = this.EntityPM.InvoiceDate;
        if (loadingDate == null) {
            loadingDate = Tools_1.DateTool.GetCurrentDateAsUtc();
    ...
    APInvoiceDetailsTabNormal.prototype.BuildScreenData = function () {
        if (Tools_1.AppTool.IsNullOrEmpty(this.EntityPM.StatusCode) || this.EntityPM.StatusCode == "WA") {
    ...
    APInvoiceDetailsTabNormal.prototype.BuildInvoiceLines = function () {
        var _this = this;
    ...
    APInvoiceDetailsTabNormal.prototype.LoadEntityOpenPayables = function () {
        var _this = this;
        this.CurrentSession.StartBusyIndicatorLoading();
        var myService = new ShipmentDomainService_1.ShipmentDomainService();
        myService.GetInvoiceOpenAmountPayables(this.EntityPM.MainEntityId).subscribe(function (myResponse) {
            if (!myResponse.HasError) {
                var openPayables = myResponse.Result.filter(function (d) { return d.ShipmentPayableParentId == null; });
                if (openPayables.length > 0) {
                    _this.GetAllVatTypes();
                    openPayables.forEach(function (payable) {
                        var alreadyExists = _this.EntityPM.InvoiceLines.filter(function (d) { return d.EntityPayableId == payable.Id; })[0];
                        if (!alreadyExists) {
                            var invoiceLine = new APInvoiceLinePM_1.APInvoiceLinePM(null);
                            ...
                            _this.ItemsSource.Insert(new APInvoiceLineItem(invoiceLine, _this, false));
                        }
                    });
                }
                _this.CurrentSession.StopBusyIndicator();
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "SummaryCurrencyButtonsVisibility", {
        // Totals
        get: function () {
            var myResult = false;
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "IsTotalInLocalCurrency", {
    ...
    APInvoiceDetailsTabNormal.prototype.ComputeTotals = function () {
        this.BuildTotalVATs();
    ...
    APInvoiceDetailsTabNormal.prototype.BuildTotalVATs = function () {
        var _this = this;
    ...
    APInvoiceDetailsTabNormal.prototype.BuildSummary = function () {
        var _this = this;
        this.SummaryItems = [];
    ...
    APInvoiceDetailsTabNormal.prototype.OnInvoiceDateChangedLoad = function () {
        this.UpdateData();
    };
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "SubTotalInLocalCurrency", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "SubTotalInInvoiceCurrency", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "AmountInInvoiceCurrency", {
        ...
        set: function (value) {
            ...
            if (this.EntityPM.AmountInInvoiceCurrency != setValue) {
                ...
                if (SessionLocator_1.SessionLocator.LocalCurrencyId == this.EntityPM.InvoiceCurrencyId) {
                    ...
                    this.EntityPM.AmountInLocalCurrency = Tools_1.AppTool.Round(setValue * this.InvoiceCurrencyExchangeRate, 2);
                }
                // Profit
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "AmountInLocalCurrency", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "AmountInProfitCurrency", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "AmountDue", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "AmountDueInLocalCurrency", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "AmountDueInProfitCurrency", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "VendorId", {
        get: function () {
            if (this.EntityPM == null) {
                return null;
            }
    ...
    APInvoiceDetailsTabNormal.prototype.GetCardProperties = function () {
        var _this = this;
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "VATNumber", {
        get: function () {
            if (this.EntityPM == null) {
                return null;
            }
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "InvoiceNumber", {
        get: function () {
            if (this.EntityPM == null) {
                return null;
            }
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "PaymentTermId", {
        get: function () {
            if (this.EntityPM == null) {
                return null;
            }
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "PaymentTermName", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "DueDate", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "InvoiceDate", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "InvoiceCurrencyId", {
        // Currency 
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "InvoiceCurrencyCode", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "InvoiceCurrencyExchangeRate", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "ExchangeRateDate", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "RelativeRateDate", {
    ...
    APInvoiceDetailsTabNormal.prototype.ComputeRelativeRateDate = function () {
        this.RelativeRateDate = Tools_1.DateTool.GetRelativeRateDate(this.InvoiceDate, this.ExchangeRateDate, "old");
    };
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "ProfitCurrencyId", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "ProfitCurrencyExchangeRate", {
    ...
    Object.defineProperty(APInvoiceDetailsTabNormal.prototype, "VatTypeId", {
    ...
    APInvoiceDetailsTabNormal.prototype.RunVatTypeFilterMethod = function () {
    ...
    APInvoiceDetailsTabNormal.prototype.RefreshLinesVat = function (vatId, vatPercentage) {
        if (this.ItemsSource != null) {
            this.ItemsSource.Collection.forEach(function (item) {
    ...
    APInvoiceDetailsTabNormal.prototype.AddButtonClicked = function () {
        var _this = this;
    ...
    APInvoiceDetailsTabNormal.prototype.EditLineClicked = function (item) {
    ...
    APInvoiceDetailsTabNormal = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return APInvoiceDetailsTabNormal;
}(BaseComponent_1.BaseComponent));
exports.APInvoiceDetailsTabNormal = APInvoiceDetailsTabNormal;
var APInvoiceLineItem = /** @class */ (function (_super) {
    ...
    APInvoiceLineItem.prototype.OnChargeTypeChanged = function () {
        ...
        if (Tools_1.AppTool.IsNullOrEmpty(this.ChargesTypeId)) {
            ...
            chargesTypeService.getSingleFromCache(this.ChargesTypeId).subscribe(function (myResponse) {
                if (!myResponse.HasError) {
                    var list = myResponse.Result;
                    if (list != null) {
...
//# sourceMappingURL=APInvoiceDetailsTabNormal.js.map