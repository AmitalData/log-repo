...
var APInvoiceDocsInTabComponent = /** @class */ (function () {
    function APInvoiceDocsInTabComponent(entityArgs) {
    ...
    APInvoiceDocsInTabComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    APInvoiceDocsInTabComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return APInvoiceDocsInTabComponent;
}());
exports.APInvoiceDocsInTabComponent = APInvoiceDocsInTabComponent;
//# sourceMappingURL=APInvoiceDocsInTabComponent.js.map