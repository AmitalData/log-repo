...
var ModuleAPInvoice = /** @class */ (function () {
    function ModuleAPInvoice() {
    }
    ModuleAPInvoice.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleAPInvoice = __decorate([
        core_1.NgModule({
    ...
    return ModuleAPInvoice;
}());
exports.ModuleAPInvoice = ModuleAPInvoice;
//# sourceMappingURL=ModuleAPInvoice.js.map