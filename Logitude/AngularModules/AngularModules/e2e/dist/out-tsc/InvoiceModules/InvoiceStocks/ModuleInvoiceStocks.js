...
var ModuleInvoiceStocks = /** @class */ (function () {
    function ModuleInvoiceStocks() {
    }
    ModuleInvoiceStocks.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleInvoiceStocks = __decorate([
        core_1.NgModule({
    ...
    return ModuleInvoiceStocks;
}());
exports.ModuleInvoiceStocks = ModuleInvoiceStocks;
//# sourceMappingURL=ModuleInvoiceStocks.js.map