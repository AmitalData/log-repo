...
var ModuleTransfer = /** @class */ (function () {
    function ModuleTransfer() {
    }
    ModuleTransfer.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleTransfer = __decorate([
        core_1.NgModule({
...
exports.ModuleTransfer = ModuleTransfer;
//# sourceMappingURL=ModuleTransfer.js.map