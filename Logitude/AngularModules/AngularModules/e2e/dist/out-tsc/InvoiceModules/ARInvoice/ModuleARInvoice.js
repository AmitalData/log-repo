...
var ModuleARInvoice = /** @class */ (function () {
    function ModuleARInvoice() {
    }
    ModuleARInvoice.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleARInvoice = __decorate([
        core_1.NgModule({
    ...
    return ModuleARInvoice;
}());
exports.ModuleARInvoice = ModuleARInvoice;
//# sourceMappingURL=ModuleARInvoice.js.map