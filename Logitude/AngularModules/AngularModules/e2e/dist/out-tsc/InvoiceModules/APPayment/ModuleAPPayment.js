...
var ModuleAPPayment = /** @class */ (function () {
    function ModuleAPPayment() {
    }
    ModuleAPPayment.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleAPPayment = __decorate([
        core_1.NgModule({
    ...
    return ModuleAPPayment;
}());
exports.ModuleAPPayment = ModuleAPPayment;
//# sourceMappingURL=ModuleAPPayment.js.map