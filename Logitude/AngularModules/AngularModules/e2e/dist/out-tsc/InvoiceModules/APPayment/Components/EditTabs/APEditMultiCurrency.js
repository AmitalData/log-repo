...
var APEditMultiCurrency = /** @class */ (function (_super) {
    __extends(APEditMultiCurrency, _super);
    function APEditMultiCurrency(entityResourceService) {
        var _this = _super.call(this) || this;
        _this.entityResourceService = entityResourceService;
        _this.EntityPM = null;
        _this.DataContext = _this;
        _this.ObjectTableName = "APInvoicePayment";
    ...
    APEditMultiCurrency.prototype.SetWindowArgs = function (myParam) {
        var _this = this;
    ...
    Object.defineProperty(APEditMultiCurrency.prototype, "PaymentAmount", {
    ...
    Object.defineProperty(APEditMultiCurrency.prototype, "ForeignAmount", {
    ...
    Object.defineProperty(APEditMultiCurrency.prototype, "ExchangeRate", {
    ...
    APEditMultiCurrency.prototype.CalculateForeignAmount = function () {
        var myResult = null;
    ...
    APEditMultiCurrency.prototype.GetConnectedAmount_PAY = function (invoiceAmount) {
        var myResult = 0;
    ...
    APEditMultiCurrency.prototype.ValidateForeignAmount = function () {
        var isValid = true;
        ...
        if (this.lineComponent.InvoiceAmount < 0) {
            if (inputEntry > 0) {
                isValid = false;
                isValidMessage = TextCodeTranslator_1.TextCodeTranslator.Translate("APPayment.M.OnlyMinusValue");
            }
            else if (inputEntry < allowedAmount) {
                isValid = false;
                isValidMessage = TextCodeTranslator_1.TextCodeTranslator.Translate("APPayment.M.AmountPaidNotLess") + " " + allowedAmount + " " + this.InvoiceCurrencyCode;
            }
        }
        else {
            if (inputEntry < 0) {
                isValid = false;
                isValidMessage = TextCodeTranslator_1.TextCodeTranslator.Translate("APPayment.M.CantPayMinusValue");
            }
            else if (inputEntry > allowedAmount) {
                isValid = false;
                isValidMessage = TextCodeTranslator_1.TextCodeTranslator.Translate("APPayment.M.AmountPaidLessOrEqual") + " " + allowedAmount + " " + this.InvoiceCurrencyCode;
            }
        }
    ...
    APEditMultiCurrency.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    APEditMultiCurrency.prototype.OkButtonClicked = function () {
        var errors = [];
    ...
    APEditMultiCurrency = __decorate([
        core_1.Component({
            moduleId: module.id,
            templateUrl: './APEditMultiCurrency.html',
        }),
        __metadata("design:paramtypes", [EntityResourceService_1.EntityResourceService])
    ], APEditMultiCurrency);
    return APEditMultiCurrency;
}(BaseComponent_1.BaseComponent));
exports.APEditMultiCurrency = APEditMultiCurrency;
//# sourceMappingURL=APEditMultiCurrency.js.map