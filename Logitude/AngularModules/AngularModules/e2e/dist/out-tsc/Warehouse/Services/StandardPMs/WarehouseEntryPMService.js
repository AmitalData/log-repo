...
var WarehouseEntryValidator_1 = require("../../Validators/WarehouseEntryValidator");
var WarehouseEntryPMService = /** @class */ (function () {
    function WarehouseEntryPMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/warehouseentries';
    }
    WarehouseEntryPMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "WarehouseEntry", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    WarehouseEntryPMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            var customValidator = new WarehouseEntryValidator_1.WarehouseEntryValidator();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "WarehouseEntry", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    WarehouseEntryPMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    WarehouseEntryPMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
    ...
    WarehouseEntryPMService.prototype.MapWarehouseEntryPackages = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
    ...
    WarehouseEntryPMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    WarehouseEntryPMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new WarehouseEntryPM_1.WarehouseEntryPM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    WarehouseEntryPMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], WarehouseEntryPMService);
    return WarehouseEntryPMService;
}());
exports.WarehouseEntryPMService = WarehouseEntryPMService;
//# sourceMappingURL=WarehouseEntryPMService.js.map