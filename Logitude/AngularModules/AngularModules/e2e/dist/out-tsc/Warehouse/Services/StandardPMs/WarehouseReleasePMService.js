...
var WarehouseReleasePMService = /** @class */ (function () {
    function WarehouseReleasePMService() {
        this._http = ServiceHelper_1.ServiceHelper.Http;
        this._apiUrl = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + 'api/warehousereleases';
    }
    WarehouseReleasePMService.prototype.get = function (id) {
        var _this = this;
        ...
        return Rx_1.Observable.defer(function () {
            return _this._http.get(_this._apiUrl + '/getsingle?' + 'id=' + id, {
                ...
                PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "WarehouseRelease", "GetSinglePM", 'id=' + id);
                return serviceResponse;
            }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
        });
    };
    WarehouseReleasePMService.prototype.insert = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
            ...
            var customValidator = new WarehouseReleaseValidator_1.WarehouseReleaseValidator();
            ...
            if (errorsArray.length == 0) {
                ...
                return _this._http.post(_this._apiUrl, JSON.stringify(mappedEntity), { headers: authHeader }).map(function (response) {
                    ...
                    var servertime = response.headers.get('ServerExecutionTime');
                    PerformanceLogger_1.PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "WarehouseRelease", "SaveChanges", "");
                    return serviceResponse;
                }).catch(ServiceHelper_1.ServiceHelper.HandleServiceError);
            }
            else {
    ...
    WarehouseReleasePMService.prototype.update = function (entityPM) {
        var _this = this;
        var callTime = new Date();
        return Rx_1.Observable.defer(function () {
            var authHeader = new http_1.Headers();
    ...
    WarehouseReleasePMService.prototype.MapJsonToEntityPM = function (jsonPM, mapParent, entityPM) {
        ...
        if (mapParent) {
            ...
            for (var item in entityPM.WarehouseReleasePackages) {
                ...
                var newWarehouseReleasePackagePM = this.clone(myWarehouseReleasePackagePM);
    ...
    WarehouseReleasePMService.prototype.MapWarehouseReleasePackages = function (entityPM, jsonPM, mapParent) {
        if (mapParent === void 0) { mapParent = true; }
            ...
            for (var itemKey in oldWarehouseReleasePackages) {
                if (entityPM.WarehouseReleasePackages.filter(function (p) { return p.UniqueKey === oldWarehouseReleasePackages[itemKey].UniqueKey; }).length === 0) {
                    if (oldWarehouseReleasePackages[itemKey]) {
                        ...
                        var deletedPM = new WarehouseReleasePackagePM_1.WarehouseReleasePackagePM(null);
    ...
    WarehouseReleasePMService.prototype.clone = function (jsonPM) {
        var entityPM;
        entityPM = {};
        var jsonPMKeys = Object.keys(jsonPM);
        for (var key in jsonPMKeys) {
    ...
    WarehouseReleasePMService.prototype.GetNewEntityPM = function () {
        var entityPM;
        entityPM = new WarehouseReleasePM_1.WarehouseReleasePM();
        entityPM.Tenant = InfraSettings_1.InfraSettings.TenantPM.Id;
        return entityPM;
    };
    WarehouseReleasePMService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], WarehouseReleasePMService);
    return WarehouseReleasePMService;
}());
exports.WarehouseReleasePMService = WarehouseReleasePMService;
//# sourceMappingURL=WarehouseReleasePMService.js.map