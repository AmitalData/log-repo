...
var WarehouseEntryStatusPM = /** @class */ (function () {
    function WarehouseEntryStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(WarehouseEntryStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(WarehouseEntryStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(WarehouseEntryStatusPM.prototype, "SearchFields", {
    ...
    WarehouseEntryStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "WarehouseEntryStatus");
        }
    };
    WarehouseEntryStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    WarehouseEntryStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], WarehouseEntryStatusPM.prototype, "PropertyChanged", void 0);
    return WarehouseEntryStatusPM;
}());
exports.WarehouseEntryStatusPM = WarehouseEntryStatusPM;
//# sourceMappingURL=WarehouseEntryStatusPM.js.map