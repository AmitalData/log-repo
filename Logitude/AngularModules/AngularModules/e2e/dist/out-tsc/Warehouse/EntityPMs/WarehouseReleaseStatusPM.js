...
var WarehouseReleaseStatusPM = /** @class */ (function () {
    function WarehouseReleaseStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(WarehouseReleaseStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(WarehouseReleaseStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(WarehouseReleaseStatusPM.prototype, "SearchFields", {
    ...
    WarehouseReleaseStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "WarehouseReleaseStatus");
        }
    };
    WarehouseReleaseStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    WarehouseReleaseStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], WarehouseReleaseStatusPM.prototype, "PropertyChanged", void 0);
    return WarehouseReleaseStatusPM;
}());
exports.WarehouseReleaseStatusPM = WarehouseReleaseStatusPM;
//# sourceMappingURL=WarehouseReleaseStatusPM.js.map