...
var ModuleQuoteOthers = /** @class */ (function () {
    function ModuleQuoteOthers() {
    }
    ModuleQuoteOthers.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleQuoteOthers = __decorate([
        core_1.NgModule({
    ...
    return ModuleQuoteOthers;
}());
exports.ModuleQuoteOthers = ModuleQuoteOthers;
//# sourceMappingURL=ModuleQuoteOthers.js.map