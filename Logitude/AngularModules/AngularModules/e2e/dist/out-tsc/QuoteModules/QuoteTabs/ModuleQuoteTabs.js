...
var ModuleQuoteTabs = /** @class */ (function () {
    function ModuleQuoteTabs() {
    }
    ModuleQuoteTabs.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleQuoteTabs = __decorate([
        core_1.NgModule({
    ...
    return ModuleQuoteTabs;
}());
exports.ModuleQuoteTabs = ModuleQuoteTabs;
//# sourceMappingURL=ModuleQuoteTabs.js.map