...
var QuoteUtilities_1 = require("../../../../Quote/../Quote/Utilities/QuoteUtilities");
...
var PartnersTabComponent = /** @class */ (function () {
    function PartnersTabComponent(entityArgs) {
        ...
        this.IsAddDisabled_NOTFY = false;
    ...
    PartnersTabComponent.prototype.Listen = function () {
        ...
        if (this.entityArgs.EditComponent) {
            ...
            this.TabChangedEvent = this.entityArgs.EditComponent.TabChanged.subscribe(function (tabCode) {
                _this.IsUpdateSalesmanVisible = false;
            });
        }
    };
    ...
    PartnersTabComponent.prototype.AddPartner = function (myCode) {
        ...
        var myWindowTitle = TextCodeTranslator_1.TextCodeTranslator.Translate("Quote.S.Partners.Add" + newPartnerItem.FullCode);
    ...
    PartnersTabComponent.prototype.EditPartner = function (myPartnerItem) {
        ...
        var myWindowTitle = TextCodeTranslator_1.TextCodeTranslator.Translate("Quote.S.Partners.Edit" + myPartnerItem.FullCode);
    ...
    PartnersTabComponent.prototype.DeletePartner = function (myPartnerItem) {
        ...
        if (myPartnerItem.IsEditingEnabled) {
            ...
            confirmWindow.Show(TextCodeTranslator_1.TextCodeTranslator.Translate("Quote.M.DeleteThisPartner"));
            confirmWindow.WindowClosed.subscribe(function (event) {
                if (confirmWindow.Yes) {
                    ...
                    _this.SetAddButtonsIsDisabled();
                    _this.CurrentSession.FireEvent("QuotePartnersChanged");
                }
            });
        }
    };
                    ...
                    if (list) {
                        if (list.SalesmanUserId != _this.EntityPM.SalesmanUserId) {
                            if (Tools_1.AppTool.IsNullOrEmpty(list.SalesmanUserId)) {
                                ...
                                _this.UpdateSalesmanText = "Customer changed, update the salesman to Empty ?";
                            }
                            else {
                                _this.UpdateSalesmanId = list.SalesmanUserId;
                                _this.UpdateSalesmanName = list.SalesmanUserEnglishName;
                                _this.UpdateSalesmanText = "Customer changed, update the salesman to " + list.SalesmanUserEnglishName + " ?";
                            }
                            _this.IsUpdateSalesmanVisible = true;
...
var PartnerItem = /** @class */ (function (_super) {
    ...
    PartnerItem.prototype.InitializeProperties = function () {
        switch (this.Code) {
            ...
            case "NOTFY": {
                this.PartnerIndex = 3;
                this.FullCode = "Notify";
                break;
            }
        }
        this.PartnerTypeName = TextCodeTranslator_1.TextCodeTranslator.Translate("Quote.F." + this.FullCode + "Id");
    };
    Object.defineProperty(PartnerItem.prototype, "PartnerName", {
        get: function () {
            switch (this.Code) {
                ...
                case "NOTFY": {
                    return this.EntityPM.NotifyName;
                }
                default: {
                    return null;
                }
    ...
    Object.defineProperty(PartnerItem.prototype, "Note", {
        get: function () {
            switch (this.Code) {
                ...
                case "NOTFY": {
                    return this.EntityPM.NotifyNote;
                }
                default: {
                    return null;
                }
    ...
    Object.defineProperty(PartnerItem.prototype, "NotifyId", {
        get: function () {
    ...
    Object.defineProperty(PartnerItem.prototype, "NotifyAddressId", {
        get: function () {
    ...
    Object.defineProperty(PartnerItem.prototype, "NotifyContactId", {
        get: function () {
                ...
                if (myResponse != null) {
                    if (!myResponse.HasError) {
                        ...
                        if (list) {
                            ...
                            _this.Note = list.Notes;
                            _this.ContactId = list.PrimaryContactId;
                            _this.AddressId = list.MainAddressId;
                            switch (_this.Code) {
                                case "SHIPR": {
                                    _this.EntityPM.ShipperPickAddressId = list.PickAddressId;
                                    if (list.PartnerTypeId == "PO") {
                                        _this.EntityPM.IsPotentialShipper = true;
                                    }
                                    if (_this.IsInlandDomestic) {
                                        _this.EntityPM.FromPartnerAddressId = _this.EntityPM.ShipperMainAddressId;
                                    }
                                    if (_this.EntityPM.IncludePickUp) {
                                        if (!Tools_1.AppTool.IsNullOrEmpty(_this.EntityPM.ShipperPickAddressId)) {
                                            _this.EntityPM.PickUpAddressId = _this.EntityPM.ShipperPickAddressId;
                                        }
                                        else {
                                            _this.EntityPM.PickUpAddressId = _this.EntityPM.ShipperMainAddressId;
                                        }
                                        if (!Tools_1.AppTool.IsNullOrEmpty(_this.EntityPM.PickUpAddressId)) {
                                            _this.EntityPM.FromAddressCity = null;
                                            _this.EntityPM.FromAddressZipCode = null;
                                            _this.EntityPM.FromAddressCountryId = null;
                                        }
                                    }
                                    break;
                                }
                                case "CONSI": {
                                    _this.EntityPM.ConsigneePickAddressId = list.PickAddressId;
                                    if (list.PartnerTypeId == "PO") {
                                        _this.EntityPM.IsPotentialConsignee = true;
                                    }
                                    if (_this.IsInlandDomestic) {
                                        _this.EntityPM.ToPartnerAddressId = _this.EntityPM.ConsigneeMainAddressId;
                                    }
                                    if (_this.EntityPM.IncludeDelivery) {
                                        if (!Tools_1.AppTool.IsNullOrEmpty(_this.EntityPM.ConsigneePickAddressId)) {
                                            _this.EntityPM.DeliveryAddressId = _this.EntityPM.ConsigneePickAddressId;
                                        }
                                        else {
                                            _this.EntityPM.DeliveryAddressId = _this.EntityPM.ConsigneeMainAddressId;
                                        }
                                        if (!Tools_1.AppTool.IsNullOrEmpty(_this.EntityPM.DeliveryAddressId)) {
                                            _this.EntityPM.ToAddressCity = null;
                                            _this.EntityPM.ToAddressZipCode = null;
                                            _this.EntityPM.ToAddressCountryId = null;
                                        }
                                    }
                                    break;
                                }
