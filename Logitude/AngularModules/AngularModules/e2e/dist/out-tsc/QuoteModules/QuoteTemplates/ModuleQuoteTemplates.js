...
var ModuleQuoteTemplates = /** @class */ (function () {
    function ModuleQuoteTemplates() {
    }
    ModuleQuoteTemplates.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleQuoteTemplates = __decorate([
        core_1.NgModule({
    ...
    ], ModuleQuoteTemplates);
    return ModuleQuoteTemplates;
}());
exports.ModuleQuoteTemplates = ModuleQuoteTemplates;
//# sourceMappingURL=ModuleQuoteTemplates.js.map