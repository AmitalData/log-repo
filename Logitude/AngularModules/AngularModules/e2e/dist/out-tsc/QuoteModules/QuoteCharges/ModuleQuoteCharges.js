...
var ModuleQuoteCharges = /** @class */ (function () {
    function ModuleQuoteCharges() {
    }
    ModuleQuoteCharges.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    ModuleQuoteCharges = __decorate([
        core_1.NgModule({
    ...
    return ModuleQuoteCharges;
}());
exports.ModuleQuoteCharges = ModuleQuoteCharges;
//# sourceMappingURL=ModuleQuoteCharges.js.map