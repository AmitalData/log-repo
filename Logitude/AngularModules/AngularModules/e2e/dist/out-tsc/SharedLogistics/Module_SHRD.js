...
var SharedLogisticsModule = /** @class */ (function () {
    function SharedLogisticsModule() {
    }
    SharedLogisticsModule.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    SharedLogisticsModule.GetInstance = function (name) {
        return ModuleProviders_1.ModuleProviders.GetInstance(name);
    };
    SharedLogisticsModule = __decorate([
        core_1.NgModule({
    ...
    return SharedLogisticsModule;
}());
exports.SharedLogisticsModule = SharedLogisticsModule;
//# sourceMappingURL=Module_SHRD.js.map