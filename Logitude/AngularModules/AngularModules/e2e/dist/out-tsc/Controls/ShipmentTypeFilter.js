...
var ShipmentTypeFilter = /** @class */ (function () {
    function ShipmentTypeFilter() {
        this.SelectedValue = "O";
        this.SelectedTypeValueChanged = new core_1.EventEmitter();
    }
    ShipmentTypeFilter.prototype.itemClicked = function (itemValue) {
    ...
    ShipmentTypeFilter.prototype.itemMouseOver = function (itemValue) {
        //if (this.SelectedValue != itemValue) {
        //    var img_A = document.getElementById("TransportFilter_A");
        //    var img_O = document.getElementById("TransportFilter_O");
        //    var img_I = document.getElementById("TransportFilter_I");
    ...
    ShipmentTypeFilter.prototype.itemMouseLeave = function (itemValue) {
        //if (this.SelectedValue != itemValue) {
        //    var img_A = document.getElementById("TransportFilter_A");
        //    var img_O = document.getElementById("TransportFilter_O");
        //    var img_I = document.getElementById("TransportFilter_I");
    ...
    ], ShipmentTypeFilter.prototype, "SelectedTypeValueChanged", void 0);
    ShipmentTypeFilter = __decorate([
        core_1.Component({
    ...
    return ShipmentTypeFilter;
}());
exports.ShipmentTypeFilter = ShipmentTypeFilter;
//# sourceMappingURL=ShipmentTypeFilter.js.map