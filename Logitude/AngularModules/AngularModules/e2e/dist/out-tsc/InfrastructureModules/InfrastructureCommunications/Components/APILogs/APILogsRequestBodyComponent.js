...
var APILogsRequestBodyComponent = /** @class */ (function (_super) {
    __extends(APILogsRequestBodyComponent, _super);
    function APILogsRequestBodyComponent(entityArgs, fb, _documentExtendedService, _imageLibraryService) {
    ...
    APILogsRequestBodyComponent.prototype.ngOnInit = function () {
        this.EntityPM = this.entityArgs.EntityPM;
        if (this.EntityPM) {
            this.MessageBody = this.EntityPM.RequestData;
        }
    };
    APILogsRequestBodyComponent.prototype.GetFileName = function () {
        var HeaderData = this.EntityPM.Id + "_Req"; // +"." + CurrentDocument.Extension;
        var token = ServiceHelper_1.ServiceHelper.GetLDocumentDownloadToken();
        var url = ServiceHelper_1.ServiceHelper.GetLogitudeURL() + "/WebPages/APILogsDownLoadPage.aspx?header=" + HeaderData + "&tempId=" + token;
        window.open(url);
    ...
    APILogsRequestBodyComponent.prototype.UpdateScreen = function (document) {
    ...
    APILogsRequestBodyComponent.prototype.ViewButtonClicked = function () {
        var HeaderData = this.EntityPM.Id + "_Req"; // +"." + CurrentDocument.Extension;
    ...
    APILogsRequestBodyComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return APILogsRequestBodyComponent;
}(BaseComponent_1.BaseComponent));
exports.APILogsRequestBodyComponent = APILogsRequestBodyComponent;
//# sourceMappingURL=APILogsRequestBodyComponent.js.map