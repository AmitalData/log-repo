...
var NewHybridPartnerComponent = /** @class */ (function (_super) {
    __extends(NewHybridPartnerComponent, _super);
    function NewHybridPartnerComponent() {
    ...
    NewHybridPartnerComponent.prototype.onIsMislakaActivated = function (event) {
    };
    NewHybridPartnerComponent.prototype.SaveChanges = function () {
        var _this = this;
    ...
    NewHybridPartnerComponent.prototype.CancelButtonClicked = function () {
        this.CurrentSession.CloseCurrentWindow();
    };
    NewHybridPartnerComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return NewHybridPartnerComponent;
}(BaseComponent_1.BaseComponent));
exports.NewHybridPartnerComponent = NewHybridPartnerComponent;
//# sourceMappingURL=NewHybridPartnerComponent.js.map