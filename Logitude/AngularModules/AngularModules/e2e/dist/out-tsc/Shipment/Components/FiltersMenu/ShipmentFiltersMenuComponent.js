...
var ShipmentFiltersMenuComponent = /** @class */ (function () {
    function ShipmentFiltersMenuComponent() {
        ...
        // Level
        this.LevelCodeSelectedValue = "All";
        ...
        if (FeatureLocator_1.FeatureLocator.HasFeaturePermession("Shipment", "IMPORTSHIPMETNS")) {
    ...
    ShipmentFiltersMenuComponent.prototype.ngAfterViewInit = function () {
        this.ApplyTransportSelectedStyle();
        this.ApplyDirectionSelectedStyle();
    };
    // Transport
    ShipmentFiltersMenuComponent.prototype.SetTransport = function (itemValue) {
        this.selectedValue = itemValue;
        this.ApplyTransportSelectedStyle();
    };
    Object.defineProperty(ShipmentFiltersMenuComponent.prototype, "SelectedValue", {
    ...
    ShipmentFiltersMenuComponent.prototype.itemClicked = function (itemValue) {
    ...
    ShipmentFiltersMenuComponent.prototype.itemMouseOver = function (itemValue) {
        if (this.SelectedValue != itemValue) {
    ...
    ShipmentFiltersMenuComponent.prototype.itemMouseLeave = function (itemValue) {
        if (this.SelectedValue != itemValue) {
            var img_A = document.getElementById(this.TransportFilter_A);
            var img_O = document.getElementById(this.TransportFilter_O);
            var img_I = document.getElementById(this.TransportFilter_I);
    ...
    ShipmentFiltersMenuComponent.prototype.ApplyTransportSelectedStyle = function () {
    ...
    // Direction
    ShipmentFiltersMenuComponent.prototype.SetDirection = function (itemValue) {
        this.selectedDirection = itemValue;
        this.ApplyDirectionSelectedStyle();
    };
    Object.defineProperty(ShipmentFiltersMenuComponent.prototype, "SelectedDirection", {
    ...
    ShipmentFiltersMenuComponent.prototype.DirectionitemClicked = function (itemValue) {
    ...
    ShipmentFiltersMenuComponent.prototype.DirectionitemMouseOver = function (itemValue) {
        if (this.SelectedDirection != itemValue) {
    ...
    ShipmentFiltersMenuComponent.prototype.DirectionitemMouseLeave = function (itemValue) {
        if (this.SelectedDirection != itemValue) {
            var img_E = document.getElementById(this.DirectionFilter_E);
            var img_I = document.getElementById(this.DirectionFilter_I);
            var img_R = document.getElementById(this.DirectionFilter_R);
    ...
    ShipmentFiltersMenuComponent.prototype.ApplyDirectionSelectedStyle = function () {
    ...
    ShipmentFiltersMenuComponent.prototype.LevelCodeitemClicked = function (itemValue) {
        if (this.LevelCodeSelectedValue != itemValue) {
            this.LevelCodeSelectedValue = itemValue;
            var RemoveFilter = false;
            if (this.apiQueryFilters.AdditionalFilters.length > 0) {
                this.apiQueryFilters.AdditionalFilters = this.apiQueryFilters.AdditionalFilters.filter(function (a) { return a.FieldName != "ShipmentLevelCode"; });
            }
    ...
    ShipmentFiltersMenuComponent.prototype.LevelCodeMouseOver = function (itemValue) {
        if (this.LevelCodeSelectedValue != itemValue) {
            //var img_E = document.getElementById(this.DirectionFilter_E);
            //var img_I = document.getElementById(this.DirectionFilter_I);
            //var img_R = document.getElementById(this.DirectionFilter_R);
    ...
    ShipmentFiltersMenuComponent.prototype.LevelCodeMouseLeave = function (itemValue) {
        if (this.LevelCodeSelectedValue != itemValue) {
            //var img_E = document.getElementById(this.DirectionFilter_E);
            //var img_I = document.getElementById(this.DirectionFilter_I);
            //var img_R = document.getElementById(this.DirectionFilter_R);
    ...
    ], ShipmentFiltersMenuComponent.prototype, "SelectedValueChanged", void 0);
    ShipmentFiltersMenuComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return ShipmentFiltersMenuComponent;
}());
exports.ShipmentFiltersMenuComponent = ShipmentFiltersMenuComponent;
//# sourceMappingURL=ShipmentFiltersMenuComponent.js.map