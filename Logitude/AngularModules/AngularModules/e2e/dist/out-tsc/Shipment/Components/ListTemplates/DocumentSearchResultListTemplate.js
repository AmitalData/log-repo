...
var DocumentSearchResultListTemplate = /** @class */ (function () {
    function DocumentSearchResultListTemplate() {
        this.DocumentsSearchFields = "";
        this.ResultFromDocument = false;
    }
    DocumentSearchResultListTemplate.prototype.setVariables = function (rowData, fieldName) {
    ...
    DocumentSearchResultListTemplate = __decorate([
        core_1.Component({
    ...
    return DocumentSearchResultListTemplate;
}());
exports.DocumentSearchResultListTemplate = DocumentSearchResultListTemplate;
//# sourceMappingURL=DocumentSearchResultListTemplate.js.map