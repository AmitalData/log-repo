...
var Shipment_Module = /** @class */ (function () {
    function Shipment_Module() {
    }
    Shipment_Module.GetComponent = function (name) {
        return ModuleDeclarations_1.ModuleDeclarations.Get(name);
    };
    Shipment_Module.GetInstance = function (name) {
        return ModuleProviders_1.ModuleProviders.GetInstance(name);
    };
    Shipment_Module = __decorate([
        core_1.NgModule({
    ...
    return Shipment_Module;
}());
exports.Shipment_Module = Shipment_Module;
//# sourceMappingURL=Module_SHIP.js.map