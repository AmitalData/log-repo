...
var FFRStatusPM = /** @class */ (function () {
    function FFRStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(FFRStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(FFRStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(FFRStatusPM.prototype, "SearchFields", {
    ...
    FFRStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "FFRStatus");
        }
    };
    FFRStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    FFRStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], FFRStatusPM.prototype, "PropertyChanged", void 0);
    return FFRStatusPM;
}());
exports.FFRStatusPM = FFRStatusPM;
//# sourceMappingURL=FFRStatusPM.js.map