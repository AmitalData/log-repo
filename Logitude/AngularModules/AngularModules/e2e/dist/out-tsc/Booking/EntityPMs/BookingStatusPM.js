...
var BookingStatusPM = /** @class */ (function () {
    function BookingStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(BookingStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(BookingStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(BookingStatusPM.prototype, "SearchFields", {
    ...
    BookingStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BookingStatus");
        }
    };
    BookingStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    BookingStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BookingStatusPM.prototype, "PropertyChanged", void 0);
    return BookingStatusPM;
}());
exports.BookingStatusPM = BookingStatusPM;
//# sourceMappingURL=BookingStatusPM.js.map