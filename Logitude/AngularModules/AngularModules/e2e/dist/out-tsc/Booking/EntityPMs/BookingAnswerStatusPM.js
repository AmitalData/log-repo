...
var BookingAnswerStatusPM = /** @class */ (function () {
    function BookingAnswerStatusPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(BookingAnswerStatusPM.prototype, "Code", {
    ...
    Object.defineProperty(BookingAnswerStatusPM.prototype, "Name", {
    ...
    Object.defineProperty(BookingAnswerStatusPM.prototype, "SearchFields", {
    ...
    BookingAnswerStatusPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BookingAnswerStatus");
        }
    };
    BookingAnswerStatusPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    BookingAnswerStatusPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BookingAnswerStatusPM.prototype, "PropertyChanged", void 0);
    return BookingAnswerStatusPM;
}());
exports.BookingAnswerStatusPM = BookingAnswerStatusPM;
//# sourceMappingURL=BookingAnswerStatusPM.js.map