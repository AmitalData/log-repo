...
var BookingLevelPM = /** @class */ (function () {
    function BookingLevelPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(BookingLevelPM.prototype, "Code", {
    ...
    Object.defineProperty(BookingLevelPM.prototype, "Name", {
    ...
    Object.defineProperty(BookingLevelPM.prototype, "SearchFields", {
    ...
    BookingLevelPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BookingLevel");
        }
    };
    BookingLevelPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    BookingLevelPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BookingLevelPM.prototype, "PropertyChanged", void 0);
    return BookingLevelPM;
}());
exports.BookingLevelPM = BookingLevelPM;
//# sourceMappingURL=BookingLevelPM.js.map