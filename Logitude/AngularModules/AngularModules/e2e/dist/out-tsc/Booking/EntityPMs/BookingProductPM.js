...
var BookingProductPM = /** @class */ (function () {
    function BookingProductPM() {
        this.PropertyChanged = new core_1.EventEmitter();
        this.UIProperties = new UIProperties_1.UIProperties(this);
        this.IsDirty = false;
    }
    Object.defineProperty(BookingProductPM.prototype, "Id", {
    ...
    Object.defineProperty(BookingProductPM.prototype, "Code", {
    ...
    Object.defineProperty(BookingProductPM.prototype, "Name", {
    ...
    Object.defineProperty(BookingProductPM.prototype, "SearchFields", {
    ...
    Object.defineProperty(BookingProductPM.prototype, "AirlineId", {
    ...
    Object.defineProperty(BookingProductPM.prototype, "InActive", {
    ...
    BookingProductPM.prototype.MarkAsDirty = function (propertyName) {
        if (propertyName === void 0) { propertyName = null; }
        this.IsDirty = true;
        if (propertyName != null) {
            this.PropertyChanged.emit(new PropertyChangedArgs_1.PropertyChangedArgs(propertyName, this));
            ServiceLocator_1.ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BookingProduct");
        }
    };
    BookingProductPM.prototype.CloneMe = function () {
        ServiceHelper_1.ServiceHelper.CloneEntityPM(this);
    };
    BookingProductPM.prototype.RejectChanges = function () {
        ServiceHelper_1.ServiceHelper.RejectEntityPMChanges(this);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BookingProductPM.prototype, "PropertyChanged", void 0);
    return BookingProductPM;
}());
exports.BookingProductPM = BookingProductPM;
//# sourceMappingURL=BookingProductPM.js.map