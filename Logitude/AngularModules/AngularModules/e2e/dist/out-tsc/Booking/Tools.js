...
var BookingTool = /** @class */ (function () {
    function BookingTool() {
    }
    BookingTool.IsEditingFieldsEnabled_MasterPorts = function (entityPM) {
        var myResult = true;
    ...
    BookingTool.IsEditingFieldsEnabled_Others = function (entityPM) {
        var myResult = true;
        if (entityPM.IsCancelled) {
            myResult = false;
        }
    ...
    BookingTool.CopyBooking = function (entityPM, copiedEntityPM) {
    ...
    BookingTool.CopyBookingPackages = function (entityPM, copiedEntityPM) {
        copiedEntityPM.BookingPackages.forEach(function (item) {
            var newItem = new BookingPackagePM_1.BookingPackagePM(entityPM);
    ...
    BookingTool.BuildShipment = function (entityPM) {
        ...
        shipmentPM.MAWBOBLDate = Tools_1.DateTool.GetCurrentDateTimeAsUtc();
        //Totals
        ...
        shipmentPM.ViaColoader = (entityPM.IssuingCarrierAgentId == InfraSettings_1.InfraSettings.TenantPM.AgentId) ? false : true;
        //AWB Fields
        ...
        //Packages
        entityPM.BookingPackages.forEach(function (item) {
...
exports.BookingTool = BookingTool;
