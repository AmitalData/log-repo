...
cmd /c call npm run e2e -- --params.Env="test" --params.Team="ayman" --params.CRM.CRMType="activity" --params.CRM.ActivityType="task" --suite=login,CRM > D:\E2ETeamAyman\prot.log 2>&1
CALL :CheckError "Task"

cmd /c call npm run e2e -- --params.Env="test" --params.Team="ayman" --params.CRM.CRMType="activity" --params.CRM.ActivityType="call" --suite=login,CRM > D:\E2ETeamAyman\prot.log 2>&1
CALL :CheckError "PhoneCall"

cmd /c call npm run e2e -- --params.Env="test" --params.Team="ayman" --params.CRM.CRMType="activity" --params.CRM.ActivityType="appoint" --suite=login,CRM >D:\E2ETeamAyman\prot.log 2>&1
