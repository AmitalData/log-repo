...
FOR /L %%A IN (1,1,1) DO (  
    ...
    cmd /c call npm run e2e -- --params.Env="test_staging" --params.Team="ayman" --params.QuoteParams.Direction="Domestic" --params.QuoteParams.TransportMode="I"  --params.QuoteParams.ShipmentType="LTL" --params.QuoteParams.QuoteType="SpotRate" --suite=login,NewQuote > D:\E2ETeamAyman\prot.log 2>&1
    ...
    cmd /c call npm run e2e -- --params.Env="test_staging" --params.Team="ayman" --params.QuoteParams.Direction="Drop" --params.QuoteParams.TransportMode="O"  --params.QuoteParams.ShipmentType="FCL" --params.QuoteParams.QuoteType="RoutingRate" --suite=login,NewQuote > D:\E2ETeamAyman\prot.log 2>&1
    CALL :CheckError "Drop-Ocean-FCL-RoutingRate" 

    --------------------------------------------------Activities-------------------------------------------------------------------------------------------------

    cmd /c call npm run e2e -- --params.Env="test_staging" --params.Team="ayman" --params.CRM.CRMType="activity" --params.CRM.ActivityType="task" --suite=login,CRM > D:\E2ETeamAyman\prot.log 2>&1
    CALL :CheckError "Task"

    cmd /c call npm run e2e -- --params.Env="test_staging" --params.Team="ayman" --params.CRM.CRMType="activity" --params.CRM.ActivityType="call" --suite=login,CRM > D:\E2ETeamAyman\prot.log 2>&1
    CALL :CheckError "PhoneCall"

    cmd /c call npm run e2e -- --params.Env="test_staging" --params.Team="ayman" --params.CRM.CRMType="activity" --params.CRM.ActivityType="appoint" --suite=login,CRM >D:\E2ETeamAyman\prot.log 2>&1
    CALL :CheckError "Appointment"

    -------------------------------------------------- Opportunities-------------------------------------------------------------------------------------------------

    cmd /c call npm run e2e -- --params.Env="test_staging" --params.Team="ayman" --params.CRM.CRMType="opportunity" --suite=login,CRM > D:\E2ETeamAyman\prot.log 2>&1
