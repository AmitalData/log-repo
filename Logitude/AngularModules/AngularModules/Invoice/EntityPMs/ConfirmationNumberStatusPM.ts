...
export class ConfirmationNumberStatusPM {
    ...
    public OldEntityPM: ConfirmationNumberStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ConfirmationNumberStatus");
           
        }
       }
    }

    private MyClone: ConfirmationNumberStatusPM;
