...
export class ARPaymentPM {
    ...
    private forceUsingBankTransferMethod: boolean;
    public get ForceUsingBankTransferMethod() { return this.forceUsingBankTransferMethod; }
    ...
    public get ReconcileExternalPagesIds() { return this.reconcileExternalPagesIds; }
    public set ReconcileExternalPagesIds(newValue: string) { if (this.reconcileExternalPagesIds != newValue) { this.reconcileExternalPagesIds = newValue; this.MarkAsDirty("ReconcileExternalPagesIds"); } }
