...
export class APPaymentMethodPM {
    ...
    private accountingExternalId: string;
    public get AccountingExternalId() { return this.accountingExternalId; }
    public set AccountingExternalId(newValue: string) { if (this.accountingExternalId != newValue) { this.accountingExternalId = newValue; this.MarkAsDirty("AccountingExternalId"); } }
       
	 

    public OldEntityPM: APPaymentMethodPM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "APPaymentMethod");
           
        }
    }
    private MyClone: APPaymentMethodPM;
