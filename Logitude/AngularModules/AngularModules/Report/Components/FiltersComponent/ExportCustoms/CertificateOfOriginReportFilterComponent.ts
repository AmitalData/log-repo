...
@Component({
    ...
    templateUrl: './CertificateOfOriginReportFilterComponent.html',
})

export class CertificateOfOriginReportFilterComponent extends BaseComponent {

    public ReportsPreview: ReportsPreviewComponent;
    reportFliter: ReportFliter;
    public ValidationErrorsList: string[];
    public ObjectTableName: string = "Customs.CertificateOfOrigin";
    public DataContext: CertificateOfOriginReportFilterComponent = this;
    ...
    public set DeclarationNumber(value: string) {
    ...
    public set CooTypeCode(value: string) {
        if (this.cooTypeCode != value) {
            this.cooTypeCode = value;
        }
    }

    private customFileNo: string;
    public get CustomFileNo() { return this.customFileNo; }
    public set CustomFileNo(value: string) {
        if (this.customFileNo != value) {
            this.customFileNo = value;
        }
    }

    private cOONumber: string;
    public get COONumber() { return this.cOONumber; }
    public set COONumber(value: string) {
        if (this.cOONumber != value) { 
            this.cOONumber = value;
        }
    }
    ...
    InitilaizeFilter() {
        ...
        //-----------------------------------------------------------------------------4
        if(!AppTool.IsNullOrEmpty(this.CooTypeCode)) {
            this.queryFilterItems.push(this.GetNewQueryFilterItem("CooTypeCode", this.CooTypeCode, null, "string"));
        }
        //-----------------------------------------------------------------------------5
         if(!AppTool.IsNullOrEmpty(this.COONumber)) {
            this.queryFilterItems.push(this.GetNewQueryFilterItem("COONumber", this.COONumber, null, "string"));
        }
        //-----------------------------------------------------------------------------3
        if(!AppTool.IsNullOrEmpty(this.declarationNumber)) {
            this.queryFilterItems.push(this.GetNewQueryFilterItem("DeclarationNumber", this.DeclarationNumber, null, "string"));
        }

        //-----------------------------------------------------------------------------6
        if(!AppTool.IsNullOrEmpty(this.CustomFileNo)) {
            this.queryFilterItems.push(this.GetNewQueryFilterItem("CustomFileNo", this.CustomFileNo, null, "string"));
        }
