...
export class TariffPMService {
        ...
        if (mapParent) {
            ...
            for (var item in entityPM.TariffVersions) {
                ...
                for (var k in myTariffVersionPM.TariffLines) {
                    ...
                    newTariffLinePM.ContainersPrices = [];

                    for (var k in myTariffLinePM.ContainersPrices) {
                        newTariffLinePM.ContainersPrices.push(this.clone(myTariffLinePM.ContainersPrices[k]));
                    }
    ...
    MapTariffLines(entityPM: TariffVersionPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.TariffLines) {
            ...
            if (mapParent) {
                ...
                this.MapTariffLineContainersPrices(newTariffLinePM, jItem, mapParent);
                newTariffLinePM.OldEntityPM.ContainersPrices = [];
                for (var k1 in newTariffLinePM.ContainersPrices) {
                    var clonedInside = this.clone(newTariffLinePM.ContainersPrices[k1]);
                    newTariffLinePM.OldEntityPM.ContainersPrices.push(clonedInside);
                }
            }
            ...
            for (var itemKey in oldTariffLines) {
                if (entityPM.TariffLines.filter(p => p.UniqueKey === oldTariffLines[itemKey].UniqueKey).length === 0) {
                    ...
                    if (oldTariffLines[itemKey]) {
                        ...
                        this.MapTariffLineContainersPrices(deletedPM, oldItemJson, mapParent);
    ...
    MapTariffLineContainersPrices(entityPM: TariffLinePM, jsonPM: any, mapParent: boolean = true) {

        var oldTariffLineContainersPrices: TariffLinesContainersPricePM[] = [];
        if (entityPM.OldEntityPM && !mapParent) {
            oldTariffLineContainersPrices = entityPM.OldEntityPM.ContainersPrices;
        }

        entityPM.ContainersPrices = new Array<TariffLinesContainersPricePM>();
        for (var item in jsonPM.ContainersPrices) {
            var jItem = jsonPM.ContainersPrices[item];
            if (mapParent && (jItem.ChangeSetOp == "Delete" || jItem.ChangeSetOp == 3)) {
                continue;
            }
            var newTariffLinesContainersPricePM: TariffLinesContainersPricePM;

            if (mapParent) {
                newTariffLinesContainersPricePM = new TariffLinesContainersPricePM(entityPM);
            }
            else {
                newTariffLinesContainersPricePM = new TariffLinesContainersPricePM(null);
            }
            ...
            for (var pmKey in pmKeysArray) {
                ...
                var pmProperty = pmKeysArray[pmKey];
                newTariffLinesContainersPricePM[pmProperty] = jItem[pmProperty];
            }


            if (mapParent) {
                newTariffLinesContainersPricePM.UniqueKey = Guid.newGuid();
                newTariffLinesContainersPricePM.ChangeSetOp = "None";
                jItem.ChangeSetOp = "None";
                newTariffLinesContainersPricePM.OldEntityPM = this.clone(newTariffLinesContainersPricePM);


            }
            else {
                if (entityPM.ChangeSetOp === "Delete") {
                    newTariffLinesContainersPricePM.ChangeSetOp = "Delete";
                }
                else {
                    if (newTariffLinesContainersPricePM.UniqueKey) {

                        if (jItem.IsDirty)
                            newTariffLinesContainersPricePM.ChangeSetOp = "Update";
                    }
                    else {
                        newTariffLinesContainersPricePM.ChangeSetOp = "Insert";
                    }
                }

                newTariffLinesContainersPricePM.OldEntityPM = null;
                newTariffLinesContainersPricePM.EntityParentPM = null;
            }

            newTariffLinesContainersPricePM.IsDirty = false;
            entityPM.ContainersPrices.push(newTariffLinesContainersPricePM);
        }
        if (oldTariffLineContainersPrices) {

            for (var itemKey in oldTariffLineContainersPrices) {
                if (entityPM.ContainersPrices.filter(p => p.UniqueKey === oldTariffLineContainersPrices[itemKey].UniqueKey).length === 0) {

                    if (oldTariffLineContainersPrices[itemKey]) {
                        var oldItemJson = oldTariffLineContainersPrices[itemKey];
                        var deletedPM: TariffLinesContainersPricePM = new TariffLinesContainersPricePM(null);
                        var pmKeys = Object.keys(oldItemJson);
                        for (var key in pmKeys) {
                        ...
                        deletedPM.OldEntityPM = null;
                        entityPM.ContainersPrices.push(deletedPM);
                    }
                }
            }
        }
