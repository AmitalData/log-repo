...
import {
    DeclarationDisplayOnlyChecks,
    DisplayOnlyCheckResult,
} from '../../../../../Customs/Utilities/DeclarationDisplayOnlyChecks';
...
export class DeclarationSupplierInvoiceTabComponent
    ...
    implements OnInit
{
    ...
    public declarationPMService: DeclarationPMService =
        new DeclarationPMService();
    ...
    @Output() DeclarationEventManager: DeclarationEventManager;
    ...
    constructor(
        ...
        this.customsDocumentPointerService =
            new CustomsDocumentPointerService();
        ...
        this.supplierInvoiceExtendedPMService =
            new SupplierInvoiceExtendedPMService();
    ...
    ngOnInit() {
        this.entityResourceService
            ...
            .subscribe((response: any) => {
                this.entityResourceService
                    .getEntityResourceByTableName('Customs.SupplierInvoice')
                    .subscribe((response: any) => {
                        this.entityResourceService
                            .getEntityResourceByTableName(
                                'Customs.SupplierInvoiceItem'
                            )
                            .subscribe((response: any) => {
                                this.entityResourceService
                                    .getEntityResourceByTableName(
                                        'Customs.SupplierInvoiceItemsMod'
                                    )
                                    .subscribe((response: any) => {
                                        this.entityResourceService
                                            .getEntityResourceByTableName(
                                                'Customs.SupplierInvoiceItemProcesType'
                                            )
                                            .subscribe((response: any) => {
                                                this.entityResourceService
                                                    .getEntityResourceByTableName(
                                                        'Customs.SupplierInvoiceItemsConDeclar'
                                                    )
                                                    .subscribe(
                                                        (response: any) => {
                                                            this.entityResourceService
                                                                .getEntityResourceByTableName(
                                                                    'Customs.SupplierInvoiceItemsDescript'
                                                                )
                                                                .subscribe(
                                                                    (
                                                                        response: any
                                                                        ...
                                                                        this.entityResourceService
                                                                            .getEntityResourceByTableName(
                                                                                'Customs.SupplierInvoiceItemsSerialNum'
                                                                            )
                                                                            .subscribe(
                                                                                (
                                                                                    response: any
                                                                                    ...
                                                                                    this.entityResourceService
                                                                                        .getEntityResourceByTableName(
                                                                                            'Customs.SupplierInvoiceItemsProdIdent'
                                                                                        )
                                                                                        .subscribe(
                                                                                            (
                                                                                                response: any
                                                                                                ...
                                                                                                this.entityResourceService
                                                                                                    .getEntityResourceByTableName(
                                                                                                        'Customs.SupplierInvoiceItemsLevy'
                                                                                                    )
                                                                                                    .subscribe(
                                                                                                        (
                                                                                                            response: any
                                                                                                            ...
                                                                                                            this.entityResourceService
                                                                                                                .getEntityResourceByTableName(
                                                                                                                    'Customs.SupplierInvioceItemCertificat'
                                                                                                                )
                                                                                                                .subscribe(
                                                                                                                    (
                                                                                                                        response: any
                                                                                                                            ...
                                                                                                                            .subscribe(
                                                                                                                                (
                                                                                                                                    ...
                                                                                                                                    this.supplierInvoicePMService =
                                                                                                                                        new SupplierInvoicePMService();
                                                                                                                                    this.ObjectTableName =
                                                                                                                                        this.entityArgs.ObjectTableName;
                                                                                                                                    //this.EntityPM = this.entityArgs.EntityPM;
                                                                                                                                    //this.getSupplierInvoices();
        ...
        this.showMultiUpdateWindowBtn = FeatureLocator.HasFeaturePermession(
            'Customs.Declaration',
            'MultiUpdateClassificationCodeWindow'
        );
        this.showUploadInvoicesFromCsvBtn = FeatureLocator.HasFeaturePermession(
            'Customs.Declaration',
            'UploadExportInvoicesFromCsv'
        );
    ...
    private Listen() {
        if (this.CurrentSession.CurrentEditComponent != null) {
            ...
            this.CurrentSession.CurrentEditComponent.SubscriptionAdd(
                this.CurrentSession.CurrentEditComponent.TabSelected.subscribe(
                    (tabCode: string) => {
                        if (
                            this.CurrentEditComponentId ==
                            this.CurrentSession.CurrentEditComponent.ComponentId
    ...
    ReloadMyScreen() {
        ///DSV - After Sending to Customs - Enter SUpplierInvoice and Getting Optimistic Concurancy error"
    ...
    BuildColumns() {
        ...
        this.columns.push({
            ...
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.SequenceNumeric'
            ),
            Styles: { width: '50px' },
        ...
        this.columns.push({
            ...
            DataTypeCode: 'String',
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.ItemCode'
            ),
            Styles: { width: '100px', direction: 'ltr' },
            HtmlListComponentName: 'DeclarationSupplierInvoiceListTemplate',
            HtmlListComponentUrl:
                './CustomsModules/CustomsListTemplates/Components/DeclarationSupplierInvoiceListTemplate',
            IsCustomTemplate: true,
        });
        this.columns.push({
            ...
            DataTypeCode: 'String',
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.ClassificationCode'
            ),
            Styles: { width: '100px' },
            IsCustomTemplate: true,
        });
        ...
        this.columns.push({
            ...
            DataTypeCode: 'String',
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.TradeAgreementName'
            ),
            Styles: { width: '100px' },
            IsCustomTemplate: true,
        });
        ...
        this.columns.push({
            ...
            DataTypeCode: 'Number',
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.InvoiceQuantity'
            ),
            Styles: { width: '100px' },
            HtmlListComponentName: 'DeclarationSupplierInvoiceListTemplate',
            HtmlListComponentUrl:
        ...
        this.columns.push({
            ...
            DataTypeCode: 'Number',
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.ItemPrice'
            ),
            Styles: { width: '100px' },
            HtmlListComponentName: 'DeclarationSupplierInvoiceListTemplate',
            HtmlListComponentUrl:
        ...
        this.columns.push({
            ...
            DataTypeCode: 'String',
            Display: TextCodeTranslator.Translate(
                'Customs.SupplierInvoiceItem.F.OriginCountryName'
            ),
            Styles: { width: '100px' },
            IsCustomTemplate: true,
        });
    ...
    getSupplierInvoices() {
        ...
        if (this.SelectedRowB4Refresh) {
            if (this.SelectedRowB4Refresh == this.lastDeletedItem) {
                //deleted item
                this.OnRowSelected(this.Invoices[0]);
            } else {
                var selectedInvoiceKey =
                    this.SelectedRowB4Refresh.InvoiceCounterKey;
                var selectedInvoice = this.Invoices.filter(
                    (d) => d.InvoiceCounterKey == selectedInvoiceKey
                )[0];
                this.OnRowSelected(selectedInvoice);
            }
        } else this.OnRowSelected(this.Invoices[0]);
    }
    ...
    OnRowSelected(itemComponent: SupplierInvoicePM) {
        ...
        if (itemComponent) {
            DeclarationEventManager.DeclarationSplitDocumentItemSelectionByInvoice.emit(
                itemComponent.InvoiceNumber
            );
            if (itemComponent.IsAccumalated) {
                this.IsAccumulated = true;
                this.IsAccumulatedMessageText = TextCodeTranslator.Translate(
                    'Customs.Declaration.O.IsAccumulated'
                );
            } else {
    ...
    getRows(
        ...
        if (this.SelectedRow) {
            ...
            filters.addAdditionalFilter(
                'DeclarationId',
                this.SelectedRow.DeclarationId,
                null,
                null,
                'Equals',
                false,
        ...
        return this._entityListService.getExtendedByFilters(
            'Customs.SupplierInvoiceItem',
            filters
        ); //this.ledgerTransactionListExtendedService.getByFilters(filters);
    }
    ...
    IsPrimarySupplierInvoiceChecked(checked: boolean, item: SupplierInvoicePM) {
        if (!checked) {
            if (
                this.EntityPM.PrimaryInvoiceCounterKey ==
                item.InvoiceCounterKey.toString()
            ) {
                this.timerToken = setTimeout(() => {
                    var invoice = this.EntityPM.SupplierInvoices.filter(
                        (d) => d.InvoiceCounterKey == item.InvoiceCounterKey
                    )[0];
            ...
            if (
                ...
                for (
                    var i = 0;
                    i < this.EntityPM.SupplierInvoices.length;
                    i++
                ) {
                    if (
                        this.EntityPM.SupplierInvoices[
                            i
                        ].InvoiceCounterKey.toString() !=
                        this.EntityPM.PrimaryInvoiceCounterKey
                    ) {
                        this.EntityPM.SupplierInvoices[
                            i
                        ].IsPrimarySupplierInvoice = false;
                    } else {
                        this.EntityPM.SupplierInvoices[
                            i
                        ].IsPrimarySupplierInvoice = true;
                    }
                }
            }
        }
    ...
    IsComprehensiveUpdateChecked(checked: boolean, item: SupplierInvoicePM) {
        if (checked) {
            ...
            this.SupplierInvoiceComprehensiveUpdate =
                this.SupplierInvoiceComprehensiveUpdate.filter(
    ...
    OpenOcrDefult() {
        ...
        this._entityResourceService
            .getEntityResourceByTableName(
                'Customs.SupplierInvioceExportDefault',
                0
            )
            .subscribe((response: any) => {
                var windowTitle = TextCodeTranslator.Translate(
                    'Customs.Consignment.O.ComprehensiveUpdate'
                );
                var logWindow = new LogitudeWindow();
                var args: any = {
                    EntityPM: this.EntityPM,
                    IsFromSupplierInvoice: true,
                    SupplierInvoiceComprehensiveUpdate:
                        this.SupplierInvoiceComprehensiveUpdate,
                };
    ...
    EditButtonClicked(item: SupplierInvoicePM) {
        ...
        for (let item of this.EntityPM.Consignments) {
            for (let line of item.ConsignmentPackages) {
                if (
                    line.MarksNumbers == null &&
                    line.PackageMeasureQualifierCode == null &&
                    line.PackageQuantity == null &&
                    line.PackageTypeCode == null &&
                    line.GrossMassMeasure == null
                ) {
                    var errorMessage = TextCodeTranslator.Translate(
                        'Customs.Declaration.O.EmptyConsignmentPackage'
                    );
    ...
    EditInvoice(item: SupplierInvoicePM) {
        ...
        this.supplierInvoiceExtendedPMService
            .GetSingleSupplierInvoicePMWithLimitedItems(
                this.EntityPM.Id,
                item.InvoiceCounterKey,
                0,
            ...
            .subscribe((response: any) => {
                ...
                if (
                    !AppTool.IsNullOrEmpty(item.InvoiceNumber) &&
                    !AppTool.IsNullOrEmpty(this.EntityPM.DeclarationNumber)
                ) {
                    windowArgs.WindowTitle =
                        TextCodeTranslator.Translate(textCodeTitle) +
                        ' ' +
                        item.InvoiceNumber +
                        '-' +
                        this.EntityPM.DeclarationNumber;
                } else if (
                    AppTool.IsNullOrEmpty(item.InvoiceNumber) &&
                    !AppTool.IsNullOrEmpty(this.EntityPM.DeclarationNumber)
                ) {
                ...
                logWindow.Show(
                    './CustomsModules/CustomsDeclarationModules/DeclarationSupplierInvoice/Components/SupplierInvoices/AddEditSupplierInvoiceComponent'
                );
                this.CurrentSession.StopBusyIndicator();
            });
    }
    ...
    DeleteButtonClicked(item: SupplierInvoicePM) {
        ...
        confirmWindow.Show(
            TextCodeTranslator.Translate('Customs.Declaration.O.DeleteInvoice')
        );
        confirmWindow.Title = TextCodeTranslator.Translate('General.O.Confirm');
        confirmWindow.WindowClosed.subscribe((event: any) => {
            if (confirmWindow.Yes) {
                if (this.EntityPM.Direction == 'E' && this.IsOcr) {
                    this.supplierInvoiceExtendedPMService
                        .GetDocumentFilingIdForForInvoice(
                            item.DeclarationId,
                            item.InvoiceCounterKey,
                            true
                        )
                        .subscribe((response) => {
                            ...
                            if (docId && count <= 1) {
                                var ocrDocumentExtendedListService: OcrDocumentExtendedListService =
                                    new OcrDocumentExtendedListService();

                                ocrDocumentExtendedListService
                                    .GetOcrDocumentByDocumentFilingId(
                                        SessionLocator.Tenant,
                                        docId
                                    )
                                    .subscribe((response) => {
                                        if (response?.Result?.NotConnect) {
                                            var ocrDocumentPM: OcrDocumentPM =
                                                response.Result;
                                            ocrDocumentPM.NotConnect = false;
                                            var ocrDocumentPMService: OcrDocumentPMService =
                                                new OcrDocumentPMService();
                                            ocrDocumentPMService
                                                .update(ocrDocumentPM)
                                                .subscribe(() => {
    ...
    DeleteSelected(item: SupplierInvoicePM) {
        ...
        var SaveCompletedEvent =
            this.CurrentSession.CurrentEditComponent.SaveCompleted.subscribe(
                (isSaveSuccess: boolean) => {
                    SaveCompletedEvent.unsubscribe();
                    this.supplierInvoiceExtendedPMService
                        .delete(item.DeclarationId, item.InvoiceCounterKey)
    ...
    OpenMultiUpdateWindow() {
        ...
        logWindow.Title = TextCodeTranslator.Translate(
            'Customs.Declaration.TH.MultiUpdate'
        );
        logWindow.WindowArgs = args;
        logWindow.ShowCloseButton = true;
        logWindow.Show(
            './CustomsModules/CustomsDeclarationModules/DeclarationSupplierInvoice/Components/SupplierInvoices/MultiUpdateComponent'
        );
        logWindow.WindowClosed.subscribe(($event: any) => {
            this.CurrentSession.CurrentEditComponent.ReloadEntityPM();
        });
    ...
    UploadFile(event: any) {
        ...
        if (file) {
            ...
            if (FileExtension && FileExtension.length > 10) {
                this.ShowMessage(
                    'File extension should be less than or equal 10 characters'
                );
            } else {
    ...
    CreateExportSupplierInviocesFromFile() {
        ...
        supplierInvoiceService
            .PutExportSupplierInviocesFromFileRequest(
                this.filterImageParameter,
                SessionLocator.Tenant,
                this.EntityPM.Id
            )
                ...
                this.declarationPMService
                    ...
                    .subscribe((response: ServiceResponse) => {
                        ...
                        if (!AppTool.IsNullOrEmpty(declaration))
                            ...
                            console.log(
                                '[!] No response for saving declaration, adding inice aborted.',
                                response
                            );
                    });
            } else {
    ...
    NewInvoice() {
        ...
        if (this.notToCheckFeature) {
            ...
            this.accumulationFeature = FeatureLocator.HasFeaturePermession(
                'Customs.Declaration',
                'ACCUMULATION'
            );
        ...
        // Show Window
        var windowTitle = TextCodeTranslator.Translate(
            'Customs.Declaration.O.NewInvoice'
        );
    ...
    DisplayOnlyCheck() {
        this.IsDisplayOnly =
            this.CurrentSession.CurrentEditComponent.EditComponentController.InDisplayMode;
        if (
            this.EntityPM.AmendmentMessage != null &&
            this.EntityPM.AmendmentMessage != ''
        ) {
            {
                ...
                if (this.EntityPM.IsAmendmentDisplayOnly)
                    this.IsDisplayOnly = this.EntityPM.IsAmendmentDisplayOnly;
            }
        } else if (this.IsDisplayOnly) {
            this.DisplayOnlyMessage =
                'לתצוגה בלבד - ' +
                this.CurrentSession.CurrentEditComponent.EditComponentController
                    .InDisplayModeMessage;
            ...
            if (this.EntityPM.SupplierInvoices != null) {
                for (
                    ...
                    this.EntityPM.SupplierInvoices[i].UIProperties.SetEnabled(
                        'IsPrimarySupplierInvoice',
                        'Customs.SupplierInvoice',
                        !this.IsDisplayOnly
                    );
                }
            }
            ...
            this.DisplayOnlyMessage =
                'בקשת אחסנה הועברה למחסן - סטטוס הבקשה' +
                ' ' +
                this.EntityPM.StorageStatusName;
        }
        var declarationDisplayOnlyChecks: DeclarationDisplayOnlyChecks =
            new DeclarationDisplayOnlyChecks();
        declarationDisplayOnlyChecks
            .DeclarationViewDisplayOnlyChecks(this.EntityPM)
            .subscribe((response: any) => {
                var displayOnlyCheckResult: DisplayOnlyCheckResult =
                    response.Result;
