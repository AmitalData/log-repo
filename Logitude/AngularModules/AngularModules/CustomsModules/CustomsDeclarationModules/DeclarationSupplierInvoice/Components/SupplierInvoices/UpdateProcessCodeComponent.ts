...
export class UpdateProcessCodeComponent extends BaseComponent {
...
export class SelectedItem extends BaseComponent {
    parent:  UpdateProcessCodeComponent;
    DataContext: any = this;
    constructor(number: number, Parent: UpdateProcessCodeComponent) {
        super();
        this.Number = number;
        this.parent = Parent;
    }
