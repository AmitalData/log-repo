...
export class DeclarationCancellationCustomsDocumentsController implements ICustomsDocumentsController {
    ...
    GetAutoGeneratedTickets(customsDocumentsTicketViewModels: CustomsDocumentTicketViewModel[],   CustomsDocumentsTickets: CustomsDocumentsTicketPM[]) {
        return defer(() => {
            ...
            if (!IL_81exists) {
                ...
                entityParams.ParentEntityCode = 'DeclarationCancellation';
                entityParams.ParentEntityId = this.declarationPM.Id;
                var otherModelTicket: CustomsDocumentsTicketPM = this.GetGeneratedCustomTicketAndPointer(entityParams, "IL_679");
    ...
    public GetGeneratedCustomTicketAndPointer(relatedEntityParams: RelatedEntityParams, documentTypeCode: string) {
        ...
        newCustomsDocumentPM.ParentEntityCode = "DeclarationCancellation";
    ...
    GetParentAndChildrenEntityCodesAndIds() {
        return { ParentEntityCode: 'DeclarationCancellation', ParentEntityId: this.declarationPM.Id, Child1EntityCode: this.ChildEntity1Code, Child1EntityId: this.childEntity1Id }
    }
