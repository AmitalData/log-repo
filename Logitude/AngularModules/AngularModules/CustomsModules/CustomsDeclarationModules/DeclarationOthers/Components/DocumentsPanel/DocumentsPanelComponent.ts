...
export class DocumentsPanelComponent {
    ...
    LoadDocuments() {
        ...
        this.custDocRelatedDocsWebService.GetDocumentsFilingsForRelatedDocuments(this.EntityPM.Id, null, objecttable.Id, "I", this.EntityPM.CustomFileNo, this.DocumentFilterSelectedValue, this.EntityPM.Direction , this.EntityPM.ExportFile, this.EntityPM.ForwarderFiles)
