...
export class DeclarationSplitComponent extends BaseComponent implements AfterViewInit, OnDestroy {
    ...
    LoadDocuments() {
        ...
        this.custDocRelatedDocsWebService.GetDocumentsFilingsForRelatedDocuments(this.DeclarationPM.Id, null, objecttable.Id, "I", this.DeclarationPM.CustomFileNo, this.DocumentFilterSelectedValue, this.DeclarationPM.Direction)
