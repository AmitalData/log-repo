...
export class SIIRequestCustomsDocumentsController implements ICustomsDocumentsController {
    ...
    GetAutoGeneratedTickets(customsDocumentsTicketViewModels: CustomsDocumentTicketViewModel[], CustomsDocumentsTickets: CustomsDocumentsTicketPM[], RelatedDocuments: RelatedDocumentViewModel[] = null) {
        ...
        return defer(() => {
            return supplierInvoiceService
                .GetSupplierInvoicesPMsForDeclarationWithTradeAgreementCount(this.declarationPM.Id)
                .pipe(
                    map((resp: ServiceResponse) => {
                        this.loadedSupplierInvoices =
                            resp && resp.Result && resp.Result.SupplierInvoices
                                ? resp.Result.SupplierInvoices
                                : [];
    ...
    public GetGeneratedCustomTicketAndPointer(relatedEntityParams: RelatedEntityParams, documentTypeCode: string) {
        ...
        newTicket.ConnectedInvoiceItemsSequences = relatedEntityParams.ChildEntity3Id;
        newTicket.ConnectedInvoicesSequences = relatedEntityParams.ChildEntity2Id;
