...
export class CollateralCustomsDocumentsController implements ICustomsDocumentsController {
    ...
    constructor(private customsCollateralPM: CustomsCollateralPM, private childEntity1Id: string, private ChildEntity1Code: string) {
    ...
    CheckRequestsInProgress(documentsFilingId: string) {
        ...
        var table = window.ObjectTables.filter(d => d.Name === "Customs.CustomsCollateral")[0];
        var table2 = window.ObjectTables.filter(d => d.Name === "Customs.CustomsDocument")[0];

        authHeader.append('Token', SessionInfo.Token);
      return defer(() => {
        return ServiceHelper.HttpClient.get(this.apiUrl + '/GetRequestInProgress/?' + 'tenant=' + this.customsCollateralPM.Tenant + '&interfaceTypeCode=2715' + '&objectTableId1=' + table.Id + '&entityId1=' + this.customsCollateralPM.Id + '&objectTableId2=' + table2.Id + '&entityId2=' + encodeURIComponent(documentsFilingId) + '&customFileNo=' + "" + '&displayOnlyMode= false', ServiceHelper.GetHttpHeaders()).pipe(map(response => {
