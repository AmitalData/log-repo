...
export class CollateralCustomsDocumentsController implements ICustomsDocumentsController {
    ...
    CheckRequestsInProgress(documentsFilingId: string) {
        ...
        return Observable.defer(() => {
            return this.http.get(this.apiUrl + '/GetRequestInProgress/?' + 'tenant=' + this.customsCollateralPM.Tenant + '&interfaceTypeCode=2715' + '&objectTableId1=' + table.Id + '&entityId1=' + this.customsCollateralPM.Id + '&objectTableId2=' + table2.Id + '&entityId2=' + encodeURIComponent(documentsFilingId) + '&customFileNo=' + "" + '&displayOnlyMode= false', { headers: authHeader }).map(response => {
