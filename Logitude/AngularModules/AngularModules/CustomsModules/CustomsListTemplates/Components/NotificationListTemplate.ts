...
export class NotificationListTemplate {
    ...
    setVariables(rowData: any, fieldName: string,additionalData:any) {
        ...
        if (this.rowData.NotificationDefinitionCode == "5101N" || this.rowData.NotificationDefinitionCode == "5101R" || this.rowData.NotificationDefinitionCode == "5101A" || this.rowData.NotificationDefinitionCode == "5101M") {
