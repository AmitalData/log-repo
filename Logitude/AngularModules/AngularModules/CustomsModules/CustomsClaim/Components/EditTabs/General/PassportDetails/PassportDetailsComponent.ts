...
export class PassportDetailsComponent extends BaseComponent {
    ...
    public set PassportTypeName(newValue: string) {
        this.EntityPM.PassportTypeName = newValue;

    }

    public get PassportCountryTypeCode() { return this.EntityPM.PassportCountryTypeCode; }
    public set PassportCountryTypeCode(newValue: string) { this.EntityPM.PassportCountryTypeCode = newValue; }

    get PassportNumber() { return this.EntityPM.PassportNumber; }
    set PassportNumber(value: string) { this.EntityPM.PassportNumber = value; }
