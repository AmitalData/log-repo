...
@Component({
    ...
    templateUrl: './CourierWorksheetNGTComponent.html',
    providers: [CourierWorksheetSharedDataService, CustomsAirlineListService],
})


export class CourierWorksheetNGTComponent extends BaseComponent implements OnDestroy {
    ...
    public ComponentRef: ComponentRef<CourierWorksheetNGTComponent>;
