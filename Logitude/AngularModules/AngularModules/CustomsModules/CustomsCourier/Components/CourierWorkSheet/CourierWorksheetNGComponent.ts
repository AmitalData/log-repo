...
export class CourierWorksheetNGComponent extends BaseComponent implements OnDestroy {
    ...
    public ComponentRef: ComponentRef<CourierWorksheetNGComponent>;
    ...
    */
    ...
    SelectedBOLValueClick(value: string) {
        ...
        if (this._SelectedBOLValue == "A" && this._SelectedTotalInvoiceValue == "A" && this._SelectedStatusValue == "A" && this._SelectedAvailableValue == "A" && this._SelectedFastIndividualProcessValue == 'A' && this._SelectedCustomStatusValue == 'A' && this._SelectedFinalReleaseValue == 'A') {
    ...
    loadLazy($event: LazyLoadEvent) {
        ...
        let filters = new ApiQueryFilters(false,true);

        filters.PageSize = $event.rows;
        filters.PageIndex = $event.first;
        filters.GetAll = false;
        filters.GetCount = this.TotalRecords == null;
        this.BuildFiltersForQuery(filters);
        filters.MapLazyEvent($event, this.TotalRecords);

        let json = JSON.stringify(filters.MyAmitalLazyLoadEvent);
        this.loading = true;
        this.oldEvent = $event;
