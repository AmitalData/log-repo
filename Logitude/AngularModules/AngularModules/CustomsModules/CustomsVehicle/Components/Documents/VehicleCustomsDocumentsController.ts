...
export class VehicleCustomsDocumentsController implements ICustomsDocumentsController {
  ...
  private http: HttpClient;
    ...
    CheckRequestsInProgress(documentsFilingId: string) {
      ...
      return defer(() => {
        return this.http.get(this.apiUrl + '/GetRequestInProgress/?' + 'tenant=' + this.vehiclePM.Tenant + '&interfaceTypeCode=2715' + '&objectTableId1=' + table.Id + '&entityId1=' + this.vehiclePM.Id + '&objectTableId2=' + table2.Id + '&entityId2=' + encodeURIComponent(documentsFilingId) + '&customFileNo=' + "" + '&displayOnlyMode= false', ServiceHelper.GetHttpHeaders()).pipe(map(response => {
