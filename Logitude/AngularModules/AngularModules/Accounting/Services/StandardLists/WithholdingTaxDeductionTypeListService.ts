...
import {WithholdingTaxDeductionTypeList} from '../../EntityLists/WithholdingTaxDeductionTypeList';

@Injectable()

export class WithholdingTaxDeductionTypeListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<WithholdingTaxDeductionTypeList> = [];
    constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/withholdingtaxdeductiontypeviews';  
    }
					...
					map((response: HttpResponse<any>) => {
						...
						if (allLists) {
							for (var key in allLists) {				
								var entity: WithholdingTaxDeductionTypeList = this.MapJsonToEntityList(allLists[key]);
	...
	getByFilters(filters: ApiQueryFilters) {
					...
					map((response: HttpResponse<any>) => {
						...
						if (serviceResponse.Result) {
							for (var key in serviceResponse.Result) {				
								var entity: WithholdingTaxDeductionTypeList = this.MapJsonToEntityList(serviceResponse.Result[key]);
								_mappedListsArray.push(entity);
							}
						}   
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: WithholdingTaxDeductionTypeList;
            entityList = new WithholdingTaxDeductionTypeList();
