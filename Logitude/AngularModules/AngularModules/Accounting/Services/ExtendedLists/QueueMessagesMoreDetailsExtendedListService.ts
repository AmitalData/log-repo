...
export class QueueMessagesMoreDetailsExtendedListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<QueueMessageMoreDetailsList> = [];
    constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/queuemessagemoredetailsviews';  // simon QueueMessageMoreDetailsViewsController
    }
			...
			return this._http.get(this._apiUrl + '/getsingle/?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(			
					map((response: HttpResponse<any>) => {
						...
						var entity: QueueMessageMoreDetailsList;
						if (list) {
			...
			return this._http.get(this._apiUrl + '/getall', ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						var _mappedListsArray: Array<QueueMessageMoreDetailsList> = [];
						if (allLists) {
							for (var key in allLists) {				
								var entity: QueueMessageMoreDetailsList = this.MapJsonToEntityList(allLists[key]);
					...
					map((response: HttpResponse<any>) => {
						...
						if (serviceResponse.Result) {
							for (var key in serviceResponse.Result) {				
								var entity: QueueMessageMoreDetailsList = this.MapJsonToEntityList(serviceResponse.Result[key]);
								_mappedListsArray.push(entity);
							}
						}   
	...
	getByFiltersForVirtualization(filters: ApiQueryFilters) {
        var servicelink = './Accounting/Services/ExtendedLists/QueueMessagesMoreDetailsExtendedListService';
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: QueueMessageMoreDetailsList;
            entityList = new QueueMessageMoreDetailsList();
