	...
	insert(entityPM: ReconcileExternalPagePM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: ReconcileExternalPagePM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: ReconcileExternalPagePM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapReconcileExternalPageLines(entityPM: ReconcileExternalPagePM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.ReconcileExternalPageLines) {
            ...
            else
            {
 			...
 			newReconcileExternalPageLinePM.DisableMarkAsDirty = true;
            ...
            if (mapParent) {
			 ...
			 newReconcileExternalPageLinePM.DisableMarkAsDirty = false;
