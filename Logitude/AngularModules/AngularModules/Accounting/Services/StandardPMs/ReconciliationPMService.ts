	...
	insert(entityPM: ReconciliationPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: ReconciliationPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: ReconciliationPM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapReconciliationLines(entityPM: ReconciliationPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.ReconciliationLines) {
            ...
            else
            {
 			...
 			newReconciliationLinePM.DisableMarkAsDirty = true;
            ...
            if (mapParent) {
			 ...
			 newReconciliationLinePM.DisableMarkAsDirty = false;
