 ...
 get(id: string) {
        ...
        var callTime = new Date();		
		 return Observable.defer(() => {
                return this._http.get(this._apiUrl+'/getsingle?'+'id=' + id, {
                    ...
                    var entity: InterestReportLinesByDatePM;
					if(pm)
					{
                ...
                PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "InterestReportLinesByDate", "GetSinglePM", 'id=' + id);
	 ...
	 insert(entityPM: InterestReportLinesByDatePM) {
        ...
        return Observable.defer(() => {
                ...
                var errorsArray = validator.Validate("InterestReportLinesByDate", entityPM);
				 ...
				 if (errorsArray.length == 0) {
				    ...
				    return this._http.post(this._apiUrl, JSON.stringify(mappedEntity),
                        { headers: authHeader }).map((response) => {
                            ...
                            var servertime = response.headers.get('ServerExecutionTime');
                            PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "InterestReportLinesByDate", "SaveChanges", "");                    
    ...
    update(entityPM: InterestReportLinesByDatePM) {
	  ...
	  MapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: InterestReportLinesByDatePM = null) {
