 ...
 constructor() {
	...
	get(taxreportid: string, line: number) {       
		...
		return Observable.defer(() => {
			return this._http.get(this._apiUrl + '/getsingle?' + 'taxreportid=' + taxreportid+'&'+'line=' + line, ServiceHelper.GetHttpFullHeaders())
				.pipe(
	...
	insert(entityPM: TaxReportLinePM) {
		...
		return Observable.defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: TaxReportLinePM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: TaxReportLinePM = this.MapJsonToEntityPM(pm, true, entityPM);
