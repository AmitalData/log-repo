 ...
 get(interestbasetypeid: string, linenumber: number) {
	 ...
	 insert(entityPM: InterestBasesPeriodPM) {
        ...
        return Observable.defer(() => {
                ...
                var errorsArray = validator.Validate("InterestBasesPeriod", entityPM);
				 ...
				 if (errorsArray.length == 0) {
				    ...
				    return this._http.post(this._apiUrl, JSON.stringify(mappedEntity),
                        { headers: authHeader }).map((response) => {
                            ...
                            var servertime = response.headers.get('ServerExecutionTime');
                            PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "InterestBasesPeriod", "SaveChanges", "");                    
    ...
    update(entityPM: InterestBasesPeriodPM) {
	  ...
	  MapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: InterestBasesPeriodPM = null) {
