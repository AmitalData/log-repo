...
export class MagayaCommunicationLogPM {
    ...
    public OldEntityPM: MagayaCommunicationLogPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "MagayaCommunicationLog");
           
        }
       }
    }

    private MyClone: MagayaCommunicationLogPM;
