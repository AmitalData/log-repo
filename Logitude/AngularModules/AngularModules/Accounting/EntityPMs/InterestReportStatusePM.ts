...
export class InterestReportStatusePM {
    ...
    public OldEntityPM: InterestReportStatusePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "InterestReportStatuse");
           
        }
    }

    private MyClone: InterestReportStatusePM;
