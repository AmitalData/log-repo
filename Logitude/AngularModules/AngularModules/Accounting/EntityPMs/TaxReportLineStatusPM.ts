...
export class TaxReportLineStatusPM {
    ...
    public OldEntityPM: TaxReportLineStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaxReportLineStatus");
           
        }
    }

    private MyClone: TaxReportLineStatusPM;
