...
export class ReconcileMethodPM {
    ...
    public OldEntityPM: ReconcileMethodPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ReconcileMethod");
           
        }
       }
    }

    private MyClone: ReconcileMethodPM;
