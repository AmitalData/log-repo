...
export class Category4PM {
    ...
    public OldEntityPM: Category4PM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Category4");
           
        }
       }
    }

    private MyClone: Category4PM;
