...
export class JournalTypePM {
    ...
    private journalTypeID: string;
    public get JournalTypeID() { return this.journalTypeID; }
    public set JournalTypeID(newValue: string) { if (this.journalTypeID != newValue) { this.journalTypeID = newValue; this.MarkAsDirty("JournalTypeID"); } }
    ...
    public OldEntityPM: JournalTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "JournalType");
           
        }
       }
    }

    private MyClone: JournalTypePM;
