...
export class TaxReportLineTransmitStatusPM {
    ...
    public OldEntityPM: TaxReportLineTransmitStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaxReportLineTransmitStatus");
           
        }
       }
    }

    private MyClone: TaxReportLineTransmitStatusPM;
