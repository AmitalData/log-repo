...
export class ARPaymentChequeStatusPM {
    ...
    public OldEntityPM: ARPaymentChequeStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARPaymentChequeStatus");
           
        }
       }
    }

    private MyClone: ARPaymentChequeStatusPM;
