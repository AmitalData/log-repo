...
export class AutomaticExternalRconcilMthodPM {
    ...
    public OldEntityPM: AutomaticExternalRconcilMthodPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AutomaticExternalRconcilMthod");
           
        }
       }
    }

    private MyClone: AutomaticExternalRconcilMthodPM;
