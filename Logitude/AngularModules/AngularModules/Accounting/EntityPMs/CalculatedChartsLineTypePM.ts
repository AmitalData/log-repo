...
export class CalculatedChartsLineTypePM {
    ...
    public OldEntityPM: CalculatedChartsLineTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CalculatedChartsLineType");
           
        }
    }

    private MyClone: CalculatedChartsLineTypePM;
