...
export class AutomaticReconcilePM {
    ...
    public OldEntityPM: AutomaticReconcilePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AutomaticReconcile");
           
        }
    }

    private MyClone: AutomaticReconcilePM;
