...
export class OpenFormatDateTypePM {
    ...
    public OldEntityPM: OpenFormatDateTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "OpenFormatDateType");
           
        }
    }

    private MyClone: OpenFormatDateTypePM;
