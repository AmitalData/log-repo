...
export class JournalMoreDataPM {
    ...
    private generalData: string;
    public get GeneralData() { return this.generalData; }
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "JournalMoreData");
           
        }
       }
    }

    private MyClone: JournalMoreDataPM;
