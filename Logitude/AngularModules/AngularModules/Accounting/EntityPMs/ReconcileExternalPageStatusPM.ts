...
export class ReconcileExternalPageStatusPM {
    ...
    public OldEntityPM: ReconcileExternalPageStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ReconcileExternalPageStatus");
           
        }
       }
    }

    private MyClone: ReconcileExternalPageStatusPM;
