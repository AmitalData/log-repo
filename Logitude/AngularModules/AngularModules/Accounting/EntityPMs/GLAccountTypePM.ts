...
export class GLAccountTypePM {
    ...
    public OldEntityPM: GLAccountTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "GLAccountType");
           
        }
    }

    private MyClone: GLAccountTypePM;
