...
export class TaxReportStatusPM {
    ...
    public OldEntityPM: TaxReportStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaxReportStatus");
           
        }
       }
    }

    private MyClone: TaxReportStatusPM;
