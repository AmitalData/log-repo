...
export class AccountingEntityJournalPM {
    ...
    public OldEntityPM: AccountingEntityJournalPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AccountingEntityJournal");
           
        }
       }
    }

    private MyClone: AccountingEntityJournalPM;
