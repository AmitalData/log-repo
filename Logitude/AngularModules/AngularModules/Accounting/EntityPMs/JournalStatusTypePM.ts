...
export class JournalStatusTypePM {
    ...
    private journalStatusID: string;
    public get JournalStatusID() { return this.journalStatusID; }
    public set JournalStatusID(newValue: string) { if (this.journalStatusID != newValue) { this.journalStatusID = newValue; this.MarkAsDirty("JournalStatusID"); } }
    ...
    public OldEntityPM: JournalStatusTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "JournalStatusType");
           
        }
    }

    private MyClone: JournalStatusTypePM;
