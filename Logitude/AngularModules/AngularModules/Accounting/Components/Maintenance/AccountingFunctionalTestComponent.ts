...
@Component({
    moduleId: module.id,
    templateUrl: './AccountingFunctionalTestComponent.html',
})

export class AccountingFunctionalTestComponent extends BaseComponent {
    public DataContext: AccountingFunctionalTestComponent = this;
    ...
    OkButtonClicked() {
        ...
        if (this.fileUploadParamerter != null && this.fileUploadParamerter.Base64String != null) {
            this._AccountingOpService.PutFunctionalTestXLS(this.fileUploadParamerter)
    ...
    ArrayBufferToBase64(file: any, viewmodel: AccountingFunctionalTestComponent) {
    ...
    IncreaseProgressBarNOTINUSE(ProgressBarValue: number) {
