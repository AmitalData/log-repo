...
export class GLAccountOverviewComponent extends BaseComponent {
    ...
    GetDefaultValues() {
        ...
        this._GLAccountMoreDataListService.getSingle(this.AccountPM.Id).subscribe((myResult:ServiceResponse) => {
        ...
        this._GLAccountExtendedListService.GetAccountOpenTransactionsCount(this.AccountPM.Id).subscribe((myResult:ServiceResponse) => {
        ...
        // Get connect card
        this._CardListService.getSingle(this.AccountPM.CardId).subscribe((myResult:ServiceResponse) => {
    ...
    GetNonReconciledTransactionsCount() {
        this.CurrentSession.StartBusyIndicatorLoading();
        this._GLAccountExtendedListService.GetAccountReconcilesCount(this.AccountPM.Id).subscribe((myResult:number) => {
