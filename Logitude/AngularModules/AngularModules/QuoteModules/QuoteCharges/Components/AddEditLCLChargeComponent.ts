...
export class AddEditLCLChargeComponent extends BaseComponent implements OnDestroy {
    ...
    OkButtonClicked() {
        ...
        if (this.DataContext.IsChargeBySteps) {
            this.StepsItemsSource.Collection.forEach(priceStep => {
                ...
                Validator.TryValidateObject(priceStep, this.QuotePriceObjectTableName, this.errors);
    ...
    private Clone() {
        ...
        this.myCloner.AddField('ContainerType1MarkUpCurrencyId');
        this.myCloner.AddField('ContainerType2MarkUpCurrencyId');
        this.myCloner.AddField('ContainerType3MarkUpCurrencyId');
        this.myCloner.AddField('ContainerType4MarkUpCurrencyId');
        this.myCloner.AddField('ContainerType5MarkUpCurrencyId');
