...
export class RoutingsAddEditAddressComponent extends BaseComponent {
    ...
    constructor(private entityResourceService: EntityResourceService) {
        ...
        this.myEntityPMService = new AddressPMService();
    }
        ...
        this.entityResourceService.getEntityResourceByTableName(this.ObjectTableName).subscribe((res: any) => {
            ...
            this.myCardListService.getSingle(myCardId).subscribe((myResponse1: ServiceResponse) => {
                ...
                if (AppTool.IsNullOrEmpty(entityId)) {
                    ...
                    this.myEntityPMService.get(entityId).subscribe((myResponse2: ServiceResponse) => {
                        if (myResponse2.HasError) {
                            this.ValidationErrorsList = myResponse2.ErrorsArray;
                        }

                        else {
                            this.EntityPM = myResponse2.Result;
                        }
