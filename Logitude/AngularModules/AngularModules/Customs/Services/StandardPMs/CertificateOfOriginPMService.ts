...
import {CertificateOfOriginValidator} from '../../Validators/CertificateOfOriginValidator';
 ...
 constructor() {
	...
	insert(entityPM: CertificateOfOriginPM) {
		...
		return defer(() => {
			...
			var customValidator :CertificateOfOriginValidator = new CertificateOfOriginValidator();
