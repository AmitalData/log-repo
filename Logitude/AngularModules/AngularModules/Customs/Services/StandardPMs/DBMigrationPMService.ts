	...
	insert(entityPM: DBMigrationPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: DBMigrationPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: DBMigrationPM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapDBMigrationLines(entityPM: DBMigrationPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.DBMigrationLines) {
            ...
            else
            {
 			...
 			newDBMigrationLinePM.DisableMarkAsDirty = true;
            ...
            if (mapParent) {
			 ...
			 newDBMigrationLinePM.DisableMarkAsDirty = false;
