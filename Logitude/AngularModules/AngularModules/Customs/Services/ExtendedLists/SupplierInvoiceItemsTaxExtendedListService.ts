...
import {SupplierInvoiceItemsTaxList} from '../../EntityLists/Extended/SupplierInvoiceItemsTaxList';
...
export class SupplierInvoiceItemsTaxExtendedListService {
    ...
    MapJsonToEntityList(jsonList: any) {
        ...
        var entityList: SupplierInvoiceItemsTaxList;
        entityList = new SupplierInvoiceItemsTaxList();
