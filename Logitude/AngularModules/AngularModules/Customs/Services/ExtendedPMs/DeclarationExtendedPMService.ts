...
export class DeclarationExtendedPMService {
    ...
    GetSingleFullData(id: string) {

        return defer(() => {
            return this._http.get(this._apiUrl + '/GetSingleFullData?' + 'id=' + id, ServiceHelper.GetHttpHeaders())
                .pipe(
                    map((response) => {
                        ...
                        if (pm) {
                            entity = this.CustomMapJsonToEntityPM(pm, false);
                        }
    ...
    //do not use this function for mapJsonToEntityPM
    CustomMapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: DeclarationPM = null) {
    ...
    MapSupplierInvoices(entityPM: DeclarationPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.SupplierInvoices) {
            ...
            this.MapSupplierInvoiceModifications(newSupplierInvoicePM, jItem, mapParent); // Call composition tables map methods
