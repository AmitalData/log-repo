...
import {HazardousSubstanceList} from '../../EntityLists/HazardousSubstanceList';
    ...
    getSingle(code: string) {
        ...
        return Observable.defer(() => {
            return this._http.get(this._apiUrl+'/getsingle/?'+'code=' + code, {
                ...
                var entity: HazardousSubstanceList;
				if(list)
				{
    ...
    getAll() {
       ...
       return Observable.defer(() => {
            return this._http.get(this._apiUrl+'/getall', {
              ...
              var _mappedListsArray: Array< HazardousSubstanceList> = [];
		      if(allLists)
			  {
    ...
    getByFilters(filters: ApiQueryFilters) {
	   ...
	   return Observable.defer(() => {
            return this._http.get(callUrl, {
		        ...
		        serviceResponse.CallTime = callTime;
			    var servertime = response.headers.get('ServerExecutionTime');
                PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "HazardousSubstance", "GetByFilters", "PageIndex:" +filters.PageIndex +", PageSize:"+filters.PageSize + ", GetAll:" + filters.GetAll); 
    ...
    getSingleFromCache(code: string) {
	   ...
	   var callTime = new Date(); 	    
        ...
        if (HazardousSubstanceListService.CachedData.length > 0) {
            ...
            return CachedDataManager.GetClosedTableData("Customs.HazardousSubstance").map(cachedJson=> {
                ...
                HazardousSubstanceListService.CachedData = _mappedListsArray;

                var filteredData = HazardousSubstanceListService.CachedData.filter(a => a.Code === code)[0];
				serviceResponse.Result = filteredData; 
				serviceResponse.CallTime = callTime;
			     
                PerformanceLogger.InsertPerformanceLog(callTime, new Date(), 0, "HazardousSubstance", "GetSingleListFromCache", 'code=' + code); 
 	 ...
 	 if (!SessionLocator.UseCachedData) {
        ...
        if (HazardousSubstanceListService.CachedData.length > 0) {
            ...
            return Observable.defer(() => {
				...
				{
					var filteredData = InfraGenericFilter.GetFilteredArray(HazardousSubstanceListService.CachedData, filters);
					serviceResponse.Result = filteredData; 
					serviceResponse.CallTime = callTime;
				}
                return Observable.of(serviceResponse);
            ...
            return CachedDataManager.GetClosedTableData("Customs.HazardousSubstance").map(cachedJson=> {
                ...
                PerformanceLogger.InsertPerformanceLog(callTime, new Date(), 0, "HazardousSubstance", "GetAllFromCache", "PageIndex:" +filters.PageIndex +", PageSize:"+filters.PageSize + ", GetAll:" + filters.GetAll); 
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: HazardousSubstanceList;
            entityList = new HazardousSubstanceList();
