...
import {CurrencyTypeList} from '../../EntityLists/CurrencyTypeList';

@Injectable()

export class CurrencyTypeListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<CurrencyTypeList> = [];
    constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/currencytypeviews';  
    }
    ...
    getAllFromCache(filters: ApiQueryFilters = new ApiQueryFilters(true)) {
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: CurrencyTypeList;
            entityList = new CurrencyTypeList();
