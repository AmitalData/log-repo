...
export class DocumentRejectTypePM {
    ...
    public OldEntityPM: DocumentRejectTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DocumentRejectType");
           
        }
       }
    }

    private MyClone: DocumentRejectTypePM;
