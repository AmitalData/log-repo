...
export class HandingCodePM {
    ...
    public OldEntityPM: HandingCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.HandingCode");
           
        }
       }
    }

    private MyClone: HandingCodePM;
