...
export class OrganizationUnitTypePM {
    ...
    public OldEntityPM: OrganizationUnitTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.OrganizationUnitType");
           
        }
       }
    }

    private MyClone: OrganizationUnitTypePM;
