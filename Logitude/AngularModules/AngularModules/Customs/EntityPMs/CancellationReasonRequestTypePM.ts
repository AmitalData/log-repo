...
export class CancellationReasonRequestTypePM {
    ...
    public OldEntityPM: CancellationReasonRequestTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CancellationReasonRequestType");
           
        }
       }
    }

    private MyClone: CancellationReasonRequestTypePM;
