...
export class CancelRequestRejectReasonTypePM {
    ...
    public OldEntityPM: CancelRequestRejectReasonTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CancelRequestRejectReasonType");
           
        }
       }
    }

    private MyClone: CancelRequestRejectReasonTypePM;
