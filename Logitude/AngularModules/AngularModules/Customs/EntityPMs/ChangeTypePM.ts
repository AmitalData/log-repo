...
export class ChangeTypePM {
    ...
    public OldEntityPM: ChangeTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ChangeType");
           
        }
       }
    }

    private MyClone: ChangeTypePM;
