...
export class PhysicalCheckStatusMessagePM {
    ...
    public OldEntityPM: PhysicalCheckStatusMessagePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PhysicalCheckStatusMessage");
           
        }
       }
    }

    private MyClone: PhysicalCheckStatusMessagePM;
