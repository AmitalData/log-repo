...
export class SupplierInvoiceItemsDescriptPM {
    ...
    public OldEntityPM: SupplierInvoiceItemsDescriptPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SupplierInvoiceItemsDescript");
           
        }
       }
    }

    private MyClone: SupplierInvoiceItemsDescriptPM;
