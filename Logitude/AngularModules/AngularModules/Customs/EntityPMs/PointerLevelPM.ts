...
export class PointerLevelPM {
    ...
    public OldEntityPM: PointerLevelPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PointerLevel");
           
        }
       }
    }

    private MyClone: PointerLevelPM;
