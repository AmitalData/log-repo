...
export class AmendmentRequestStatusPM {
    ...
    public OldEntityPM: AmendmentRequestStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AmendmentRequestStatus");
           
        }
       }
    }

    private MyClone: AmendmentRequestStatusPM;
