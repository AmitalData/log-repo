...
export class CargoIdentityQualifierPM {
    ...
    public OldEntityPM: CargoIdentityQualifierPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CargoIdentityQualifier");
           
        }
       }
    }

    private MyClone: CargoIdentityQualifierPM;
