...
export class CommercialSalePM {
    ...
    public OldEntityPM: CommercialSalePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CommercialSale");
           
        }
       }
    }

    private MyClone: CommercialSalePM;
