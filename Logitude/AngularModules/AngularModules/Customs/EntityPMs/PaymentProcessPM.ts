...
export class PaymentProcessPM {
    ...
    public OldEntityPM: PaymentProcessPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentProcess");
           
        }
       }
    }

    private MyClone: PaymentProcessPM;
