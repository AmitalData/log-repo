...
export class CertificateExemptionTypePM {
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CertificateExemptionType");
           
        }
       }
    }

    private MyClone: CertificateExemptionTypePM;
