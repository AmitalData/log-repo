...
export class InterfaceSendOptionPM {
    ...
    public OldEntityPM: InterfaceSendOptionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.InterfaceSendOption");
           
        }
       }
    }

    private MyClone: InterfaceSendOptionPM;
