...
export class RefundCustomerActivityTypePM {
    ...
    public OldEntityPM: RefundCustomerActivityTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RefundCustomerActivityType");
           
        }
       }
    }

    private MyClone: RefundCustomerActivityTypePM;
