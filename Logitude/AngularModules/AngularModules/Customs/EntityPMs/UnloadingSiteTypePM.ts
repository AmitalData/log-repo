...
export class UnloadingSiteTypePM {
    ...
    public OldEntityPM: UnloadingSiteTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.UnloadingSiteType");
           
        }
       }
    }

    private MyClone: UnloadingSiteTypePM;
