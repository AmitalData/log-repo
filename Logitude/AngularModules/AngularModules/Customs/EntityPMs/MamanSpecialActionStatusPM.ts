...
export class MamanSpecialActionStatusPM {
    ...
    public OldEntityPM: MamanSpecialActionStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.MamanSpecialActionStatus");
           
        }
       }
    }

    private MyClone: MamanSpecialActionStatusPM;
