...
export class CarWeightPM {
    ...
    public OldEntityPM: CarWeightPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CarWeight");
           
        }
       }
    }

    private MyClone: CarWeightPM;
