...
export class AddressContactStatePM {
    ...
    public OldEntityPM: AddressContactStatePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AddressContactState");
           
        }
       }
    }

    private MyClone: AddressContactStatePM;
