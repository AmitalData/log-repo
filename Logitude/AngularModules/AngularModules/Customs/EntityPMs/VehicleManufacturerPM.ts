...
export class VehicleManufacturerPM {
    ...
    public OldEntityPM: VehicleManufacturerPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleManufacturer");
           
        }
       }
    }

    private MyClone: VehicleManufacturerPM;
