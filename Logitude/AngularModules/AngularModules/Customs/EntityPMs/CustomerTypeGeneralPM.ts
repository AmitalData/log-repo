...
export class CustomerTypeGeneralPM {
    ...
    public OldEntityPM: CustomerTypeGeneralPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerTypeGeneral");
           
        }
       }
    }

    private MyClone: CustomerTypeGeneralPM;
