...
export class CheckTypeLookupPM {
    ...
    public OldEntityPM: CheckTypeLookupPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CheckTypeLookup");
           
        }
       }
    }

    private MyClone: CheckTypeLookupPM;
