...
export class ConstraintTypePM {
    ...
    public OldEntityPM: ConstraintTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ConstraintType");
           
        }
       }
    }

    private MyClone: ConstraintTypePM;
