...
export class StuffingSiteTypePM {
    ...
    public OldEntityPM: StuffingSiteTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.StuffingSiteType");
           
        }
       }
    }

    private MyClone: StuffingSiteTypePM;
