...
export class PackageMeasureQualifierPM {
    ...
    public OldEntityPM: PackageMeasureQualifierPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PackageMeasureQualifier");
           
        }
       }
    }

    private MyClone: PackageMeasureQualifierPM;
