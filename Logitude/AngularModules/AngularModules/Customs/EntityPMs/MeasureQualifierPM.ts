...
export class MeasureQualifierPM {
    ...
    public OldEntityPM: MeasureQualifierPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.MeasureQualifier");
           
        }
       }
    }

    private MyClone: MeasureQualifierPM;
