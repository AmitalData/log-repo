...
export class AmountTypePM {
    ...
    public OldEntityPM: AmountTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AmountType");
           
        }
       }
    }

    private MyClone: AmountTypePM;
