...
export class ReferenceStatusPM {
    ...
    public OldEntityPM: ReferenceStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ReferenceStatus");
           
        }
       }
    }

    private MyClone: ReferenceStatusPM;
