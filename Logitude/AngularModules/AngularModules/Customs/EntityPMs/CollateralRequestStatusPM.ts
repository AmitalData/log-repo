...
export class CollateralRequestStatusPM {
    ...
    public OldEntityPM: CollateralRequestStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CollateralRequestStatus");
           
        }
       }
    }

    private MyClone: CollateralRequestStatusPM;
