...
export class AuthorizedSignerPermitPM {
    ...
    public OldEntityPM: AuthorizedSignerPermitPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AuthorizedSignerPermit");
           
        }
       }
    }

    private MyClone: AuthorizedSignerPermitPM;
