...
export class VehicleTypePM {
    ...
    public OldEntityPM: VehicleTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleType");
           
        }
       }
    }

    private MyClone: VehicleTypePM;
