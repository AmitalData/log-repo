...
export class UIMessageTenantPM {
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.UIMessageTenant");
           
        }
       }
    }

    private MyClone: UIMessageTenantPM;
