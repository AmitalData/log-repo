...
export class BuyerRoleTypePM {
    ...
    public OldEntityPM: BuyerRoleTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.BuyerRoleType");
           
        }
       }
    }

    private MyClone: BuyerRoleTypePM;
