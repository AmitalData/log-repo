...
export class DangerousGoodsPackingReqPM {
    ...
    public OldEntityPM: DangerousGoodsPackingReqPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DangerousGoodsPackingReq");
           
        }
       }
    }

    private MyClone: DangerousGoodsPackingReqPM;
