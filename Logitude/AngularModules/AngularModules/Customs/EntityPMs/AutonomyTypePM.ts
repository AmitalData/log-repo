...
export class AutonomyTypePM {
    ...
    public OldEntityPM: AutonomyTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AutonomyType");
           
        }
       }
    }

    private MyClone: AutonomyTypePM;
