...
export class OriginCriterionPM {
    ...
    public OldEntityPM: OriginCriterionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.OriginCriterion");
           
        }
       }
    }

    private MyClone: OriginCriterionPM;
