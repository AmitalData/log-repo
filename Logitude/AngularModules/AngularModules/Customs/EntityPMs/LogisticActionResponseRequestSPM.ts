...
export class LogisticActionResponseRequestSPM {
    ...
    public OldEntityPM: LogisticActionResponseRequestSPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.LogisticActionResponseRequestS");
           
        }
       }
    }

    private MyClone: LogisticActionResponseRequestSPM;
