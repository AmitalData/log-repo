...
export class CustomerIdentificationTypePM {
    ...
    public OldEntityPM: CustomerIdentificationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerIdentificationType");
           
        }
       }
    }

    private MyClone: CustomerIdentificationTypePM;
