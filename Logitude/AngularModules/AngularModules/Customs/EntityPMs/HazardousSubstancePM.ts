...
export class HazardousSubstancePM {
    ...
    public OldEntityPM: HazardousSubstancePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.HazardousSubstance");
           
        }
       }
    }

    private MyClone: HazardousSubstancePM;
