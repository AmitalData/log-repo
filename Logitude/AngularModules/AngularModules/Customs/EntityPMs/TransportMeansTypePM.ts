...
export class TransportMeansTypePM {
    ...
    public OldEntityPM: TransportMeansTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.TransportMeansType");
           
        }
       }
    }

    private MyClone: TransportMeansTypePM;
