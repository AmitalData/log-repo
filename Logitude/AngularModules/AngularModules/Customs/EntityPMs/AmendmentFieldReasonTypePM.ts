...
export class AmendmentFieldReasonTypePM {
    ...
    public OldEntityPM: AmendmentFieldReasonTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AmendmentFieldReasonType");
           
        }
       }
    }

    private MyClone: AmendmentFieldReasonTypePM;
