...
export class DecisionTypePM {
    ...
    public OldEntityPM: DecisionTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DecisionType");
           
        }
       }
    }

    private MyClone: DecisionTypePM;
