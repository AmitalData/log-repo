...
export class PayerTypePM {
    ...
    public OldEntityPM: PayerTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PayerType");
           
        }
       }
    }

    private MyClone: PayerTypePM;
