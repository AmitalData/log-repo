...
export class SubCountryPM {
    ...
    public OldEntityPM: SubCountryPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SubCountry");
           
        }
       }
    }

    private MyClone: SubCountryPM;
