...
export class FaultInspectionTypePM {
    ...
    public OldEntityPM: FaultInspectionTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.FaultInspectionType");
           
        }
       }
    }

    private MyClone: FaultInspectionTypePM;
