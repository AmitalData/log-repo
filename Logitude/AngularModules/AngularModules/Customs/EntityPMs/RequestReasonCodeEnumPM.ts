...
export class RequestReasonCodeEnumPM {
    ...
    public OldEntityPM: RequestReasonCodeEnumPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RequestReasonCodeEnum");
           
        }
       }
    }

    private MyClone: RequestReasonCodeEnumPM;
