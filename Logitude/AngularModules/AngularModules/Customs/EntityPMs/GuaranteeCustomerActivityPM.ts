...
export class GuaranteeCustomerActivityPM {
    ...
    public OldEntityPM: GuaranteeCustomerActivityPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.GuaranteeCustomerActivity");
           
        }
       }
    }

    private MyClone: GuaranteeCustomerActivityPM;
