...
export class ClosedTableStatusPM {
    ...
    public OldEntityPM: ClosedTableStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ClosedTableStatus");
           
        }
       }
    }

    private MyClone: ClosedTableStatusPM;
