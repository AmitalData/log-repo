...
export class TransactionNatureTypePM {
    ...
    public OldEntityPM: TransactionNatureTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.TransactionNatureType");
           
        }
       }
    }

    private MyClone: TransactionNatureTypePM;
