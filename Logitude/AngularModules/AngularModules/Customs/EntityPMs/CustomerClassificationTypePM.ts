...
export class CustomerClassificationTypePM {
    ...
    public OldEntityPM: CustomerClassificationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerClassificationType");
           
        }
       }
    }

    private MyClone: CustomerClassificationTypePM;
