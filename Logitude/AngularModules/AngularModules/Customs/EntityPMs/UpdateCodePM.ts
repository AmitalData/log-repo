...
export class UpdateCodePM {
    ...
    public OldEntityPM: UpdateCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.UpdateCode");
           
        }
       }
    }

    private MyClone: UpdateCodePM;
