...
export class CustomsInsuranceCompanyPM {
    ...
    public OldEntityPM: CustomsInsuranceCompanyPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsInsuranceCompany");
           
        }
       }
    }

    private MyClone: CustomsInsuranceCompanyPM;
