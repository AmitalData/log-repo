...
export class CourierManifestStatusPM {
    ...
    public OldEntityPM: CourierManifestStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CourierManifestStatus");
           
        }
       }
    }

    private MyClone: CourierManifestStatusPM;
