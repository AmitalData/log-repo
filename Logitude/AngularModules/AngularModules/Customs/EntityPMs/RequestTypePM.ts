...
export class RequestTypePM {
    ...
    public OldEntityPM: RequestTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RequestType");
           
        }
       }
    }

    private MyClone: RequestTypePM;
