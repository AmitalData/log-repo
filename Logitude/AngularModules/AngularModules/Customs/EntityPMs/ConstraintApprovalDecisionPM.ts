...
export class ConstraintApprovalDecisionPM {
    ...
    public OldEntityPM: ConstraintApprovalDecisionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ConstraintApprovalDecision");
           
        }
       }
    }

    private MyClone: ConstraintApprovalDecisionPM;
