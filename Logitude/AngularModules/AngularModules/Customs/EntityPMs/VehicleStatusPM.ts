...
export class VehicleStatusPM {
    ...
    public OldEntityPM: VehicleStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleStatus");
           
        }
       }
    }

    private MyClone: VehicleStatusPM;
