...
export class NbcDeclarationTypePM {
    ...
    public OldEntityPM: NbcDeclarationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.NbcDeclarationType");
           
        }
       }
    }

    private MyClone: NbcDeclarationTypePM;
