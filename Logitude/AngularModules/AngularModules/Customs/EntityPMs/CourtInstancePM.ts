...
export class CourtInstancePM {
    ...
    public OldEntityPM: CourtInstancePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CourtInstance");
           
        }
       }
    }

    private MyClone: CourtInstancePM;
