...
export class LogisticActionResponseReqSPM {
    ...
    public OldEntityPM: LogisticActionResponseReqSPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.LogisticActionResponseReqS");
           
        }
       }
    }

    private MyClone: LogisticActionResponseReqSPM;
