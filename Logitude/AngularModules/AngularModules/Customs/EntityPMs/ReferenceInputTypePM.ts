...
export class ReferenceInputTypePM {
    ...
    public OldEntityPM: ReferenceInputTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ReferenceInputType");
           
        }
       }
    }

    private MyClone: ReferenceInputTypePM;
