...
export class PoaStatusTypeLookUpPM {
    ...
    public OldEntityPM: PoaStatusTypeLookUpPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PoaStatusTypeLookUp");
           
        }
       }
    }

    private MyClone: PoaStatusTypeLookUpPM;
