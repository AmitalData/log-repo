...
export class AddressPurposePM {
    ...
    public OldEntityPM: AddressPurposePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AddressPurpose");
           
        }
       }
    }

    private MyClone: AddressPurposePM;
