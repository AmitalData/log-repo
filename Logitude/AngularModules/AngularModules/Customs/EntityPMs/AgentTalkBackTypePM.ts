...
export class AgentTalkBackTypePM {
    ...
    public OldEntityPM: AgentTalkBackTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AgentTalkBackType");
           
        }
       }
    }

    private MyClone: AgentTalkBackTypePM;
