...
export class ClaimExplanationCodePM {
    ...
    public OldEntityPM: ClaimExplanationCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ClaimExplanationCode");
           
        }
       }
    }

    private MyClone: ClaimExplanationCodePM;
