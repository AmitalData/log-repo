...
export class VendorTransactionTypePM {
    ...
    public OldEntityPM: VendorTransactionTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VendorTransactionType");
           
        }
       }
    }

    private MyClone: VendorTransactionTypePM;
