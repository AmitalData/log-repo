...
export class SIIRequestLineStatusPM {
    ...
    public OldEntityPM: SIIRequestLineStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SIIRequestLineStatus");
           
        }
       }
    }

    private MyClone: SIIRequestLineStatusPM;
