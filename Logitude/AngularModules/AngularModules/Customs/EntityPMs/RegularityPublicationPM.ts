...
export class RegularityPublicationPM {
    ...
    public OldEntityPM: RegularityPublicationPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RegularityPublication");
           
        }
       }
    }

    private MyClone: RegularityPublicationPM;
