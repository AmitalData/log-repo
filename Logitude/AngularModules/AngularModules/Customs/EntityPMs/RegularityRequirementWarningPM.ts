...
export class RegularityRequirementWarningPM {
    ...
    public OldEntityPM: RegularityRequirementWarningPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RegularityRequirementWarning");
           
        }
       }
    }

    private MyClone: RegularityRequirementWarningPM;
