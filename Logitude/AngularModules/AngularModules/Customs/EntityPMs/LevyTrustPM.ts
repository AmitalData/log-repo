...
export class LevyTrustPM {
    ...
    public OldEntityPM: LevyTrustPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.LevyTrust");
           
        }
       }
    }

    private MyClone: LevyTrustPM;
