...
export class VehicleSafeAccessoryInstlTypePM {
    ...
    public OldEntityPM: VehicleSafeAccessoryInstlTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleSafeAccessoryInstlType");
           
        }
       }
    }

    private MyClone: VehicleSafeAccessoryInstlTypePM;
