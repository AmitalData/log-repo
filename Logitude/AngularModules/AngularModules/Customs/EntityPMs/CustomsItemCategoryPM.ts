...
export class CustomsItemCategoryPM {
    ...
    public OldEntityPM: CustomsItemCategoryPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsItemCategory");
           
        }
       }
    }

    private MyClone: CustomsItemCategoryPM;
