...
export class ValidCustomsItemPM {
    ...
    public OldEntityPM: ValidCustomsItemPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ValidCustomsItem");
           
        }
       }
    }

    private MyClone: ValidCustomsItemPM;
