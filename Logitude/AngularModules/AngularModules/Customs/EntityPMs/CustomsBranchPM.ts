...
export class CustomsBranchPM {
    ...
    public OldEntityPM: CustomsBranchPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsBranch");
           
        }
       }
    }

    private MyClone: CustomsBranchPM;
