...
export class ClassificationTypePM {
    ...
    public OldEntityPM: ClassificationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ClassificationType");
           
        }
       }
    }

    private MyClone: ClassificationTypePM;
