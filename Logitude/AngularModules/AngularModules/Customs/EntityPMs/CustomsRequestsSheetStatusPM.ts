...
export class CustomsRequestsSheetStatusPM {
    ...
    public OldEntityPM: CustomsRequestsSheetStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsRequestsSheetStatus");
           
        }
       }
    }

    private MyClone: CustomsRequestsSheetStatusPM;
