...
export class ImporterDeclarationTypePM {
    ...
    public OldEntityPM: ImporterDeclarationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ImporterDeclarationType");
           
        }
       }
    }

    private MyClone: ImporterDeclarationTypePM;
