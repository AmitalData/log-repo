...
export class AmendCancellRequestInitiatorPM {
    ...
    public OldEntityPM: AmendCancellRequestInitiatorPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AmendCancellRequestInitiator");
           
        }
       }
    }

    private MyClone: AmendCancellRequestInitiatorPM;
