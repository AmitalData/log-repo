...
export class CertificatesStatusPM {
    ...
    public OldEntityPM: CertificatesStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CertificatesStatus");
           
        }
       }
    }

    private MyClone: CertificatesStatusPM;
