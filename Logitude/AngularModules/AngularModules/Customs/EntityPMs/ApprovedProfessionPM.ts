...
export class ApprovedProfessionPM {
    ...
    public OldEntityPM: ApprovedProfessionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ApprovedProfession");
           
        }
       }
    }

    private MyClone: ApprovedProfessionPM;
