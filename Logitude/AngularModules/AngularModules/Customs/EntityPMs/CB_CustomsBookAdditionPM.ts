...
export class CB_CustomsBookAdditionPM {
    ...
    public OldEntityPM: CB_CustomsBookAdditionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CB_CustomsBookAddition");
           
        }
       }
    }

    private MyClone: CB_CustomsBookAdditionPM;
