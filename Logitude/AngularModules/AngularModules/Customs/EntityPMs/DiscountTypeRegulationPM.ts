...
export class DiscountTypeRegulationPM {
    ...
    public OldEntityPM: DiscountTypeRegulationPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DiscountTypeRegulation");
           
        }
       }
    }

    private MyClone: DiscountTypeRegulationPM;
