...
export class CustomsItemGroupPM {
    ...
    public OldEntityPM: CustomsItemGroupPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsItemGroup");
           
        }
       }
    }

    private MyClone: CustomsItemGroupPM;
