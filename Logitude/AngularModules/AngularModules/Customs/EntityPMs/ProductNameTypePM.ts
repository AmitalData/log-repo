...
export class ProductNameTypePM {
    ...
    public OldEntityPM: ProductNameTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ProductNameType");
           
        }
       }
    }

    private MyClone: ProductNameTypePM;
