...
export class PoaAuthorizationTypeLookupPM {
    ...
    public OldEntityPM: PoaAuthorizationTypeLookupPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PoaAuthorizationTypeLookup");
           
        }
       }
    }

    private MyClone: PoaAuthorizationTypeLookupPM;
