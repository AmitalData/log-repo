...
export class PaymentProtestTypePM {
    ...
    public OldEntityPM: PaymentProtestTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentProtestType");
           
        }
       }
    }

    private MyClone: PaymentProtestTypePM;
