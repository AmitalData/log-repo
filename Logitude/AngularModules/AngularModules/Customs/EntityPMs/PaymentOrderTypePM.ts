...
export class PaymentOrderTypePM {
    ...
    public OldEntityPM: PaymentOrderTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentOrderType");
           
        }
       }
    }

    private MyClone: PaymentOrderTypePM;
