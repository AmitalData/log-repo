...
export class DefaultTypePM {
    ...
    public OldEntityPM: DefaultTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DefaultType");
           
        }
       }
    }

    private MyClone: DefaultTypePM;
