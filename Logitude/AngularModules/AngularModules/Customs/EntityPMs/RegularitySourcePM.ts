...
export class RegularitySourcePM {
    ...
    public OldEntityPM: RegularitySourcePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RegularitySource");
           
        }
       }
    }

    private MyClone: RegularitySourcePM;
