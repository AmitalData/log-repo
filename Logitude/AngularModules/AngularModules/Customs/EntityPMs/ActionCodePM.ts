...
export class ActionCodePM {
    ...
    public OldEntityPM: ActionCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ActionCode");
           
        }
       }
    }

    private MyClone: ActionCodePM;
