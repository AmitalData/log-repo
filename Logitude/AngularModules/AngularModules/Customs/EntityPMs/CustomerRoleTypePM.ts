...
export class CustomerRoleTypePM {
    ...
    public OldEntityPM: CustomerRoleTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerRoleType");
           
        }
       }
    }

    private MyClone: CustomerRoleTypePM;
