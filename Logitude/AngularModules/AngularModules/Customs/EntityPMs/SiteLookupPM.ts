...
export class SiteLookupPM {
    ...
    private siteTypeCode: string;
    public get SiteTypeCode() { return this.siteTypeCode; }
    public set SiteTypeCode(newValue: string) { if (this.siteTypeCode != newValue) { this.siteTypeCode = newValue; this.MarkAsDirty("SiteTypeCode"); } }
    ...
    public OldEntityPM: SiteLookupPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SiteLookup");
           
        }
       }
    }

    private MyClone: SiteLookupPM;
