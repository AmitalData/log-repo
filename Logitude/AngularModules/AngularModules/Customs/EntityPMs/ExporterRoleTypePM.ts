...
export class ExporterRoleTypePM {
    ...
    public OldEntityPM: ExporterRoleTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ExporterRoleType");
           
        }
       }
    }

    private MyClone: ExporterRoleTypePM;
