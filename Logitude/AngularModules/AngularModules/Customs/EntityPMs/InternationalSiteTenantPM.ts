...
export class InternationalSiteTenantPM {
    ...
    private countryTypeCode: string;
    public get CountryTypeCode() { return this.countryTypeCode; }
    public set CountryTypeCode(newValue: string) { if (this.countryTypeCode != newValue) { this.countryTypeCode = newValue; this.MarkAsDirty("CountryTypeCode"); } }
       
	 
    private countryTypeName: string;
    public get CountryTypeName() { return this.countryTypeName; }
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.InternationalSiteTenant");
           
        }
       }
    }

    private MyClone: InternationalSiteTenantPM;
