...
export class CheckQueueTypePM {
    ...
    public OldEntityPM: CheckQueueTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CheckQueueType");
           
        }
       }
    }

    private MyClone: CheckQueueTypePM;
