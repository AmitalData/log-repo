...
export class SecurityClearenceTypeCodePM {
    ...
    public OldEntityPM: SecurityClearenceTypeCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SecurityClearenceTypeCode");
           
        }
       }
    }

    private MyClone: SecurityClearenceTypeCodePM;
