...
export class CollateralAnswerStatusPM {
    ...
    public OldEntityPM: CollateralAnswerStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CollateralAnswerStatus");
           
        }
       }
    }

    private MyClone: CollateralAnswerStatusPM;
