...
export class QuotaComputationBasisPM {
    ...
    public OldEntityPM: QuotaComputationBasisPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.QuotaComputationBasis");
           
        }
       }
    }

    private MyClone: QuotaComputationBasisPM;
