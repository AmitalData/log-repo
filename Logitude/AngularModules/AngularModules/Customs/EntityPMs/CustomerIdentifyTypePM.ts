...
export class CustomerIdentifyTypePM {
    ...
    public OldEntityPM: CustomerIdentifyTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerIdentifyType");
           
        }
       }
    }

    private MyClone: CustomerIdentifyTypePM;
