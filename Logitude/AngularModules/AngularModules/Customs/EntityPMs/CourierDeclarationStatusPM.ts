...
export class CourierDeclarationStatusPM {
    ...
    public OldEntityPM: CourierDeclarationStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CourierDeclarationStatus");
           
        }
       }
    }

    private MyClone: CourierDeclarationStatusPM;
