...
export class VendorTypePM {
    ...
    public OldEntityPM: VendorTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VendorType");
           
        }
       }
    }

    private MyClone: VendorTypePM;
