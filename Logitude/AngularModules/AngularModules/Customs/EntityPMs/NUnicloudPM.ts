...
export class NUnicloudPM {
    ...
    public OldEntityPM: NUnicloudPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.NUnicloud");
           
        }
       }
    }

    private MyClone: NUnicloudPM;
