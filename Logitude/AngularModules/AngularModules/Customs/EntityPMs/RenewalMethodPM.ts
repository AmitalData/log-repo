...
export class RenewalMethodPM {
    ...
    public OldEntityPM: RenewalMethodPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RenewalMethod");
           
        }
       }
    }

    private MyClone: RenewalMethodPM;
