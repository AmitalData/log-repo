...
export class CollateralAnswerTypePM {
    ...
    public OldEntityPM: CollateralAnswerTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CollateralAnswerType");
           
        }
       }
    }

    private MyClone: CollateralAnswerTypePM;
