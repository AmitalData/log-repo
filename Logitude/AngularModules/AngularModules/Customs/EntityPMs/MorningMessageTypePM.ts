...
export class MorningMessageTypePM {
    ...
    public OldEntityPM: MorningMessageTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.MorningMessageType");
           
        }
       }
    }

    private MyClone: MorningMessageTypePM;
