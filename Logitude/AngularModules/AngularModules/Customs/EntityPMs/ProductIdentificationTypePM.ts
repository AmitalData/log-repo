...
export class ProductIdentificationTypePM {
    ...
    public OldEntityPM: ProductIdentificationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ProductIdentificationType");
           
        }
       }
    }

    private MyClone: ProductIdentificationTypePM;
