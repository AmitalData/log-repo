...
export class SupplierInvoiceItemsProdIdentPM {
    ...
    public get Identification() { return this.identification; }
    public set Identification(newValue: string) { if (this.identification != newValue) { this.identification = newValue; this.MarkAsDirty("Identification"); } }
    ...
    public OldEntityPM: SupplierInvoiceItemsProdIdentPM;
