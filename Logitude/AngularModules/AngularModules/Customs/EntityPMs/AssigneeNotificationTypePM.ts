...
export class AssigneeNotificationTypePM {
    ...
    public OldEntityPM: AssigneeNotificationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.AssigneeNotificationType");
           
        }
       }
    }

    private MyClone: AssigneeNotificationTypePM;
