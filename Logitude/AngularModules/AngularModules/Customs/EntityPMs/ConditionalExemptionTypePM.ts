...
export class ConditionalExemptionTypePM {
    ...
    public OldEntityPM: ConditionalExemptionTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ConditionalExemptionType");
           
        }
       }
    }

    private MyClone: ConditionalExemptionTypePM;
