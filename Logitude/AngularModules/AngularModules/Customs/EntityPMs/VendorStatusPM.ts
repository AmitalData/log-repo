...
export class VendorStatusPM {
    ...
    public OldEntityPM: VendorStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VendorStatus");
           
        }
       }
    }

    private MyClone: VendorStatusPM;
