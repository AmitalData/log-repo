...
export class PaymentMethodStatusPM {
    ...
    public OldEntityPM: PaymentMethodStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.PaymentMethodStatus");
           
        }
       }
    }

    private MyClone: PaymentMethodStatusPM;
