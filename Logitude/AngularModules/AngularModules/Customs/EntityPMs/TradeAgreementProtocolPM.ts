...
export class TradeAgreementProtocolPM {
    ...
    public OldEntityPM: TradeAgreementProtocolPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.TradeAgreementProtocol");
           
        }
       }
    }

    private MyClone: TradeAgreementProtocolPM;
