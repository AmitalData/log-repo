...
export class LeadDocumentTypePM {
    ...
    public OldEntityPM: LeadDocumentTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.LeadDocumentType");
           
        }
       }
    }

    private MyClone: LeadDocumentTypePM;
