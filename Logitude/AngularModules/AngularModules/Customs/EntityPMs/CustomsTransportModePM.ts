...
export class CustomsTransportModePM {
    ...
    public OldEntityPM: CustomsTransportModePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsTransportMode");
           
        }
       }
    }

    private MyClone: CustomsTransportModePM;
