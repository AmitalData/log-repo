...
export class VehicleReductionTypePM {
    ...
    public OldEntityPM: VehicleReductionTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleReductionType");
           
        }
       }
    }

    private MyClone: VehicleReductionTypePM;
