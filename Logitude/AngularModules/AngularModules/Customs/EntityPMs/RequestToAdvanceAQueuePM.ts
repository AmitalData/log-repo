...
export class RequestToAdvanceAQueuePM {
    ...
    public OldEntityPM: RequestToAdvanceAQueuePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RequestToAdvanceAQueue");
           
        }
       }
    }

    private MyClone: RequestToAdvanceAQueuePM;
