...
export class SpecialActionDescriptionTypePM {
    ...
    public OldEntityPM: SpecialActionDescriptionTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SpecialActionDescriptionType");
           
        }
       }
    }

    private MyClone: SpecialActionDescriptionTypePM;
