...
export class CargoSplitRequestStatusPM {
    ...
    public OldEntityPM: CargoSplitRequestStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CargoSplitRequestStatus");
           
        }
       }
    }

    private MyClone: CargoSplitRequestStatusPM;
