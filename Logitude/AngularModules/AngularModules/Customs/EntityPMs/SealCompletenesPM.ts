...
export class SealCompletenesPM {
    ...
    public OldEntityPM: SealCompletenesPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SealCompletenes");
           
        }
       }
    }

    private MyClone: SealCompletenesPM;
