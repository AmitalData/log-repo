...
export class InterConditionsRelationshipPM {
    ...
    public OldEntityPM: InterConditionsRelationshipPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.InterConditionsRelationship");
           
        }
       }
    }

    private MyClone: InterConditionsRelationshipPM;
