...
export class SealUpdateReasonTypePM {
    ...
    public OldEntityPM: SealUpdateReasonTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SealUpdateReasonType");
           
        }
       }
    }

    private MyClone: SealUpdateReasonTypePM;
