...
export class ProceduralFaultStatusPM {
    ...
    public OldEntityPM: ProceduralFaultStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ProceduralFaultStatus");
           
        }
       }
    }

    private MyClone: ProceduralFaultStatusPM;
