...
export class CustomsItemHierarchicLocationPM {
    ...
    public OldEntityPM: CustomsItemHierarchicLocationPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsItemHierarchicLocation");
           
        }
       }
    }

    private MyClone: CustomsItemHierarchicLocationPM;
