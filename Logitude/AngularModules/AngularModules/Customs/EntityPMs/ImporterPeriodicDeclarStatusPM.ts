...
export class ImporterPeriodicDeclarStatusPM {
    ...
    public OldEntityPM: ImporterPeriodicDeclarStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ImporterPeriodicDeclarStatus");
           
        }
       }
    }

    private MyClone: ImporterPeriodicDeclarStatusPM;
