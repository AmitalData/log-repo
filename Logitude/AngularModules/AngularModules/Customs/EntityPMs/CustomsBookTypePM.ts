...
export class CustomsBookTypePM {
    ...
    public OldEntityPM: CustomsBookTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsBookType");
           
        }
       }
    }

    private MyClone: CustomsBookTypePM;
