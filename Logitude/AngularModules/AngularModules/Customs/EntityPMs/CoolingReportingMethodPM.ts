...
export class CoolingReportingMethodPM {
    ...
    public OldEntityPM: CoolingReportingMethodPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CoolingReportingMethod");
           
        }
       }
    }

    private MyClone: CoolingReportingMethodPM;
