...
export class RansomViolationTypePM {
    ...
    public OldEntityPM: RansomViolationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RansomViolationType");
           
        }
       }
    }

    private MyClone: RansomViolationTypePM;
