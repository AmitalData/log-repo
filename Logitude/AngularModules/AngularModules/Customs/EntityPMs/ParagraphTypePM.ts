...
export class ParagraphTypePM {
    ...
    public OldEntityPM: ParagraphTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ParagraphType");
           
        }
       }
    }

    private MyClone: ParagraphTypePM;
