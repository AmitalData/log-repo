...
export class CustomsDocumentStatusTypePM {
    ...
    public OldEntityPM: CustomsDocumentStatusTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsDocumentStatusType");
           
        }
       }
    }

    private MyClone: CustomsDocumentStatusTypePM;
