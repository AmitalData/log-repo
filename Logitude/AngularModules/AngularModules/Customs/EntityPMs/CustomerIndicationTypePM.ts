...
export class CustomerIndicationTypePM {
    ...
    public OldEntityPM: CustomerIndicationTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerIndicationType");
           
        }
       }
    }

    private MyClone: CustomerIndicationTypePM;
