...
export class RequestHandlingAuthorityPM {
    ...
    public OldEntityPM: RequestHandlingAuthorityPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RequestHandlingAuthority");
           
        }
       }
    }

    private MyClone: RequestHandlingAuthorityPM;
