...
export class ExportLogisticPermitActionPM {
    ...
    public OldEntityPM: ExportLogisticPermitActionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ExportLogisticPermitAction");
           
        }
       }
    }

    private MyClone: ExportLogisticPermitActionPM;
