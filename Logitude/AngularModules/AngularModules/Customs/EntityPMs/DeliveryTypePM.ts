...
export class DeliveryTypePM {
    ...
    public OldEntityPM: DeliveryTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.DeliveryType");
           
        }
       }
    }

    private MyClone: DeliveryTypePM;
