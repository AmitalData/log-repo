...
export class RegisteredWarehouseSiteTypePM {
    ...
    public OldEntityPM: RegisteredWarehouseSiteTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.RegisteredWarehouseSiteType");
           
        }
       }
    }

    private MyClone: RegisteredWarehouseSiteTypePM;
