...
export class ContactRoleTypePM {
    ...
    public OldEntityPM: ContactRoleTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ContactRoleType");
           
        }
       }
    }

    private MyClone: ContactRoleTypePM;
