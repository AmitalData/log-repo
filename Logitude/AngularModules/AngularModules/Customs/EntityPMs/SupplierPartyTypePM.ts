...
export class SupplierPartyTypePM {
    ...
    public OldEntityPM: SupplierPartyTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.SupplierPartyType");
           
        }
       }
    }

    private MyClone: SupplierPartyTypePM;
