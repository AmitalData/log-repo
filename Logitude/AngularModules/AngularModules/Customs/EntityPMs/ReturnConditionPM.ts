...
export class ReturnConditionPM {
    ...
    public OldEntityPM: ReturnConditionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ReturnCondition");
           
        }
       }
    }

    private MyClone: ReturnConditionPM;
