...
export class ContinuousRequestTypePM {
    ...
    public OldEntityPM: ContinuousRequestTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ContinuousRequestType");
           
        }
       }
    }

    private MyClone: ContinuousRequestTypePM;
