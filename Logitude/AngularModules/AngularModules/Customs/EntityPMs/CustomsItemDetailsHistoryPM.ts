...
export class CustomsItemDetailsHistoryPM {
    ...
    public OldEntityPM: CustomsItemDetailsHistoryPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomsItemDetailsHistory");
           
        }
       }
    }

    private MyClone: CustomsItemDetailsHistoryPM;
