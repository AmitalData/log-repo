...
export class LogisticActionResponseRequestStatusPM {
    ...
    public OldEntityPM: LogisticActionResponseRequestStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.LogisticActionResponseRequestStatus");
           
        }
       }
    }

    private MyClone: LogisticActionResponseRequestStatusPM;
