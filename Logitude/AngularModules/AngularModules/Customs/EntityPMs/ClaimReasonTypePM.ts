...
export class ClaimReasonTypePM {
    ...
    public OldEntityPM: ClaimReasonTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ClaimReasonType");
           
        }
       }
    }

    private MyClone: ClaimReasonTypePM;
