...
export class ProceduralFaultTypePM {
    ...
    public OldEntityPM: ProceduralFaultTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.ProceduralFaultType");
           
        }
       }
    }

    private MyClone: ProceduralFaultTypePM;
