...
export class TradeLevyExamptTypePM {
    ...
    public OldEntityPM: TradeLevyExamptTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.TradeLevyExamptType");
           
        }
       }
    }

    private MyClone: TradeLevyExamptTypePM;
