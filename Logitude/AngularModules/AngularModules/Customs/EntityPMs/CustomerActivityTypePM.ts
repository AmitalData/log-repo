...
export class CustomerActivityTypePM {
    ...
    public OldEntityPM: CustomerActivityTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.CustomerActivityType");
           
        }
       }
    }

    private MyClone: CustomerActivityTypePM;
