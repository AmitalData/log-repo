...
export class InceptionCodePM {
    ...
    public OldEntityPM: InceptionCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.InceptionCode");
           
        }
       }
    }

    private MyClone: InceptionCodePM;
