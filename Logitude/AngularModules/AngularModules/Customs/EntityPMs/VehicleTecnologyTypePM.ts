...
export class VehicleTecnologyTypePM {
    ...
    public OldEntityPM: VehicleTecnologyTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Customs.VehicleTecnologyType");
           
        }
       }
    }

    private MyClone: VehicleTecnologyTypePM;
