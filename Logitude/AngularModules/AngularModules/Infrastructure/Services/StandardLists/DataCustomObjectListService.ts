...
export class DataCustomObjectListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<DataCustomObjectList> = [];
    constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/datacustomobjectviews';  
    }
			...
			return this._http.get(this._apiUrl + '/getsingle/?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(			
					map((response: HttpResponse<any>) => {
						...
						var entity: DataCustomObjectList;
						if (list) {
						...
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "DataCustomObject", "GetSingleList", 'id=' + id); 
	...
	getByFilters(filters: ApiQueryFilters) {
					...
					map((response: HttpResponse<any>) => {
						...
						if (serviceResponse.Result) {
							for (var key in serviceResponse.Result) {				
								var entity: DataCustomObjectList = this.MapJsonToEntityList(serviceResponse.Result[key]);
								_mappedListsArray.push(entity);
							}
						}   
						...
						var servertime = response.headers.get('ServerExecutionTime');
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "DataCustomObject", "GetByFilters", "PageIndex:" +filters.PageIndex +", PageSize:"+filters.PageSize + ", GetAll:" + filters.GetAll);
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: DataCustomObjectList;
            entityList = new DataCustomObjectList();
