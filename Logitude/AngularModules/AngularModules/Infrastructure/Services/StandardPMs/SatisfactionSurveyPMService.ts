...
export class SatisfactionSurveyPMService {
 private _http: HttpClient;
 private _apiUrl: string;
 constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/satisfactionsurveys';      
    }
			...
			return this._http.get(this._apiUrl + '/getsingle?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						var entity: SatisfactionSurveyPM;
						if (pm) {
						...
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "SatisfactionSurvey", "GetSinglePM", 'id=' + id);
	...
	insert(entityPM: SatisfactionSurveyPM) {
		...
		return defer(() => {
			...
			var errorsArray = validator.Validate("SatisfactionSurvey", entityPM);
	...
	update(entityPM: SatisfactionSurveyPM) {
