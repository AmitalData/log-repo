//file not found! child composition EventRemark
//------------------------------------------------------------------------------
// <auto-generated>
//     Angular 9.1.1
 ...
 constructor() {
    ...
    MapEventRemarks(entityPM: EventTypePM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.EventRemarks) {
            ...
            if (mapParent) {
                newEventRemarkPM = new EventRemarkPM(entityPM);
            }
            else
            {
                newEventRemarkPM = new EventRemarkPM(null);
            }
            ...
            for (var itemKey in oldEventRemarks) {
                if (entityPM.EventRemarks.filter(p=> p.UniqueKey === oldEventRemarks[itemKey].UniqueKey).length === 0) {
                    ...
                    if (oldEventRemarks[itemKey]) {
                        ...
                        var deletedPM: EventRemarkPM = new EventRemarkPM(null);
...
//file not found! for child composition EventRemark
