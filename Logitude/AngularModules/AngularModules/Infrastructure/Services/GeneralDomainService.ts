...
export class FieldsTranslations {
    ...
    public get TranslatedText() { return this.translatedText; }
    public set TranslatedText(newValue: string) { if (this.translatedText != newValue) { this.translatedText = newValue; this.MarkAsDirty("TranslatedText"); } } 
    
    private translatedTextPlural: string;
    public get TranslatedTextPlural() { return this.translatedTextPlural; }
    public set TranslatedTextPlural(newValue: string) { if (this.translatedTextPlural != newValue) { this.translatedTextPlural = newValue; this.MarkAsDirty("TranslatedTextPlural"); } } 
