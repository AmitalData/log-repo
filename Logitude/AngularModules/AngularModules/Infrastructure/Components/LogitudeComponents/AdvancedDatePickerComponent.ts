...
export class AdvancedDatePickerComponent
    ...
    public set SelectedDateValue(newValue: any) {
        ...
        if (isOk) {
            ...
            if (this.selectedDateValue != newValue) {
                ...
                this.SelectedItemObject = this.SelectedItem;
                //this.selectedDateValue = newValue;
                //var selectedDateObj: any = {};
                //selectedDateObj.SelectedDate = newValue;
                ////this.OnSelectedCalendarDateChanged(selectedDateObj);
            }
        }
    }
    ...
    OnDropDownSelected(item: any, newValue: string = null) {
