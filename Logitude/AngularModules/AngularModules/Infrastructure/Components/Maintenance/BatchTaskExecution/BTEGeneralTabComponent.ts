...
export class BTEGeneralTabComponent extends BaseComponent {
    ...
    //#region Properties
    get ClassName() { return this.EntityPM.ClassName; }
    get StartDateTime() { return this.EntityPM.StartDateTime; }
    get DoneDateTime() { return this.EntityPM.DoneDateTime; }
    get ProgressMessage() { return this.EntityPM.ProgressMessage; }
    get ProgressPercentage() { return this.EntityPM.ProgressPercentage; }
