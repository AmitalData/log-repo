...
export class MaintenanceComponent {
    ...
    private SetEntityStatusToggle() {
        let entityStatusFeatureToggle = SessionLocator.FeatureToggles.filter(
            (d) => d.ToggleCode == 'EST'
        )[0];
    ...
    private CustomObjectTables: ObjectTablePM[] = window.ObjectTables.filter(
        (obj) => obj.ParentObjectTableId == null && obj.IsCustom == true
    );
    private IsCustomObjectsAdded(): boolean {
        if (this.CustomObjectTables.length > 0) return true;
        return false;
    }
    ...
    private BuildPagesMenu() {
        ...
        this.PagesMenu.push(
            new Menu(
                'PAR',
                TextCodeTranslator.Translate('General.MC.Partners.Partners')
            )
        );
        this.PagesMenu.push(
            new Menu(
                'BIL',
                TextCodeTranslator.Translate('General.MC.Billings.Billings')
            )
        );
        this.PagesMenu.push(
            new Menu(
                'LOC',
                TextCodeTranslator.Translate('General.MC.Locations.Locations')
            )
        );
        this.PagesMenu.push(
            new Menu(
                'OTH',
                TextCodeTranslator.Translate('General.MC.Others.Others')
            )
        );
        this.PagesMenu.push(
            new Menu(
                ...
                TextCodeTranslator.Translate(
                    'General.MC.PersonalSettings.PersonalSettings'
                )
            )
        );
        this.PagesMenu.push(
            new Menu(
                'CMS',
                TextCodeTranslator.Translate(
                    'General.MC.SystemSettings.SystemSettings'
                )
            )
        );
        ...
        if (SessionLocator.Tenant == 0) {
            this.PagesMenu.push(
                new Menu(
                    'MNG',
                    TextCodeTranslator.Translate(
                        'General.MC.Management.Management'
                    )
                )
            );
        }
        ...
        if (
            FeatureLocator.HasFeaturePermession('General', 'LEADSOURCES') ||
            ...
            this.PagesMenu.push(
                new Menu(
                    'CRM',
                    TextCodeTranslator.Translate('General.MC.CRM.CRM')
                )
            );
        }
        ...
        if (
            ...
            this.PagesMenu.push(
                new Menu(
                    'SHA',
                    TextCodeTranslator.Translate(
                        'General.MC.ShaamTokenManagement'
                    )
                )
            );
        ...
        if (FeatureLocator.HasFeaturePermession('CustomsGeneral', 'AmitalAPI'))
            this.PagesMenu.push(
                new Menu(
                    'AAP',
                    TextCodeTranslator.Translate(
                        'CustomsGeneral.Features.AmitalAPI'
                    )
                )
            );
        ...
        if (FeatureLocator.HasFeaturePermession('CustomsGeneral', 'CUSTOMS')) {
            this.PagesMenu.push(
                new Menu(
                    'CSM',
                    TextCodeTranslator.Translate('General.MC.Custom.Customs')
                )
            );
        }
        ...
        if (FeatureLocator.HasFeaturePermession('General', 'ACCOUNTINGS')) {
            this.PagesMenu.push(
                new Menu(
                    'ACC',
                    TextCodeTranslator.Translate(
                        'General.MC.Accounting.Accounting'
                    )
                )
            );
        }
        ...
        if (
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.InttraCommunicationSettings'
                )
            ) {
                this.isTransmissionsPageVisible = true;
            }
        ...
        if (
            FeatureLocator.HasFeaturePermession(
                'General',
                'General.Features.BusinessProcessQueue'
            ) ||
            FeatureLocator.HasFeaturePermession(
                'General',
                'General.Features.BusinessProcessTeam'
            ) ||
            FeatureLocator.HasFeaturePermession(
                'General',
                'General.Features.BusinessProcessBusinessRole'
            )
        ) {
            this.PagesMenu.push(
                new Menu(
                    'BUP',
                    TextCodeTranslator.Translate('General.MC.BusinessProcess')
                )
            );
        }
        ...
        this.PagesMenu.push(
            new Menu(
                'CUS',
                TextCodeTranslator.Translate(
                    'General.MC.Customization.Customization'
                )
            )
        );
        ...
        if (this.IsCustomObjectsAdded()) {
            this.PagesMenu.push(
                new Menu(
                    'CSO',
                    TextCodeTranslator.Translate(
                        'General.MC.CustomObjects.CustomObjects'
                    )
                )
            );
        }
        ...
        if (
            FeatureLocator.HasFeaturePermession('General', 'TASKTYPES') ||
            ...
            this.PagesMenu.push(
                new Menu(
                    'TSK',
                    TextCodeTranslator.Translate('General.MC.Tasks.Tasks')
                )
            );
        }
    }
    ...
    private BuildMaintenanceMenu() {
        ...
        var allMenusTables: MenusTablePM[] = window.MenusTables.filter(
            (x) => x.MenuTypeCode === 'MTC'
        ).sort((a, b) => {
            return a.IndexOfOrder - b.IndexOfOrder;
        });
        ...
        allMenusTables.forEach((item) => {
                ...
                if (item.Code == 'MTCB') {
                    ...
                    if (SessionLocator.Tenant == 0) {
                        if (
                            FeatureLocator.HasFeaturePermession(
                                'HelpResource',
                                'HelpResource.M.HelpResources'
                            )
                        ) {
                            this.AllMaintenanceMenu.push(
                                new MaintenanceMenuItem(item)
                            );
                        }
                    }
            ...
            if (item.Code == 'MTHT' || item.Code == 'POGP') {
                ...
                item.Code == 'DEPA' &&
                this.CheckDeploymentPackageFeatures()
            ) {
                this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
            }
        });
    ...
    CheckDeploymentPackageFeatures() {
        if (
            ...
            return false;
        return CustomizationPermissionService.HasFeaturePermession(
            'General',
            'Customization.DeploymentPackage'
        );
    }
    ...
    private BuildSystemSettings() {
        ...
        (item.ObjectTableName = 'Defaults'),
            (item.ObjectTableId = window.ObjectTables.filter(
                (d) => d.Name == 'DefaultAndConfiguration'
            )[0].Id);
        ...
        if (
            FeatureLocator.HasFeaturePermession('General', 'TERMOFUSERFEATUE')
        ) {
            var item2 = new MenusTablePM();
            item2.CategoryTypeCode = 'CMS';
            item2.Icon = 'Settings';
        ...
        if (FeatureLocator.HasFeaturePermession('General', 'SYSTEMSETTINGS')) {
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.CompanyAddress'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.TenantAdditionalData'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (SessionLocator.Tenant == 0) {
                ...
                item.ObjectTableId = window.ObjectTables.filter(
                    (d) => d.Name == 'TenantManagmentPrivateLabels'
                )[0].Id;
                this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
            }
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.SystemDefaults'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.SystemCurrencies'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.LocalSettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.InvoiceSettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.AirlineSettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.CustomerActivation'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.SupportManagement'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.OceanInsightsSettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                ...
                item.ObjectTableId = window.ObjectTables.filter(
                    (d) => d.Name == 'ContainerTrackingProvider'
                )[0].Id;
                this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
            }
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.SystemUserPassword'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.HybridTenantThreshold'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                ...
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.BluesnapContract'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
                ...
                item.ObjectTableId = window.ObjectTables.filter(
                    (d) => d.Name == 'BluesnapContract'
                )[0].Id;
                this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
            }
            if (
                FeatureLocator.HasFeaturePermession('General', 'ApiCredintials')
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
                item.Icon = 'List';
            ...
            if (
                ...
                item.ObjectTableId = window.ObjectTables.filter(
                    (d) => d.Name == 'CustomerFieldsUpdateSetting'
                )[0].Id;
                this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
            }
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.SecurityPolicySettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.QuoteSettings'
                )
            ) {
                var item = new MenusTablePM();
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.ContainerSettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            item3.ObjectTableId = window.ObjectTables.filter(
                (d) => d.Name == 'CommunicationLog'
            )[0].Id;
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.DocumentFilingEmailSettings'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'CMS';
            ...
            if (
                FeatureLocator.HasFeaturePermession('General', 'TICKET') &&
                FeatureLocator.HasFeaturePermession('General', 'TicketsSetting')
            ) {
                var item = new MenusTablePM();
            ...
            if (
                SessionInfo.LoggedUserPM.IsCustomerCare &&
                SessionLocator.FeatureToggles.filter(
                    (d) => d.ToggleCode == 'VIP'
                )[0] != null
            ) {
                var item = new MenusTablePM();
    ...
    private BuildPersonalSettings() {
        if (
            FeatureLocator.HasFeaturePermession('General', 'PERSONALSETTINGS')
        ) {
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.Signature'
                )
            ) {
                var item = new MenusTablePM();
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.ChangePassword'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'PRS';
    ...
    private BuildCustomsMenus() {
        if (
            window.ObjectTables.filter((d) => d.Name == 'Customs.Client')[0] !=
            null
        ) {
            if (
                FeatureLocator.HasFeaturePermession(
                ...
                this._entityResourceService
                    .getEntityResourceByTableName('Customs.Client', 0)
                    .subscribe((response: any) => {
                        ...
                        item.TranslatedName = TextCodeTranslator.Translate(
                            'Customs.Client.AuthorizationLetters'
                        );
                        item.ObjectTableName = 'Customs.Client';
                        item.ObjectTableId = window.ObjectTables.filter(
                            (d) => d.Name == 'Customs.Client'
                        )[0].Id;
                        this.AllMaintenanceMenu.push(
                            new MaintenanceMenuItem(item)
                        );
        ...
        if (FeatureLocator.HasFeaturePermession('Customs.Declaration', 'OCR')) {
            this._entityResourceService
                ...
                .subscribe((response: any) => {
                    ...
                    item.Icon = 'Table';
                    item.Code = 'DOCR';
                    item.TranslatedName = 'ברירות מחדל OCR - יצום';
                    item.ObjectTableName = 'Customs.Client';
                    item.ObjectTableId = window.ObjectTables.filter(
                        (d) => d.Name == 'Customs.Client'
                    )[0].Id;
        ...
        if (
            window.ObjectTables.filter(
                (d) => d.Name == 'Customs.CustomsRequiredField'
            )[0] != null
        ) {
            this._entityResourceService
                .getEntityResourceByTableName('Customs.CustomsRequiredField', 0)
                .subscribe((response: any) => {
                    if (
                        FeatureLocator.HasFeaturePermession(
                            'Customs.CustomsRequiredField',
                            'CSTMREQFIELDMTC'
                        )
                    ) {
                        var item = new MenusTablePM();
                        ...
                        item.TranslatedName = TextCodeTranslator.Translate(
                            'Customs.CustomsRequiredField.O.ImportRequiredFields'
                        );
                        item.ObjectTableId = window.ObjectTables.filter(
                            (d) => d.Name == 'Customs.CustomsRequiredField'
                        )[0].Id;
                    ...
                    if (
                        ...
                        item.Code = 'EXPR';
                        item.TranslatedName = TextCodeTranslator.Translate(
                            'Customs.CustomsRequiredField.O.ExportRequiredFields'
                        );
                        item.ObjectTableName = 'Customs.CustomsRequiredField';
                        item.ObjectTableId = window.ObjectTables.filter(
                            (d) => d.Name == 'Customs.CustomsRequiredField'
        ...
        if (
            yaronWantWithoutLogiUpdate ||
            (SessionLocator.Tenant == 0 &&
                !SessionLocator.LoggedUserPM.IsDistributor &&
                window.ObjectTables.filter(
                    (d) => d.Name == 'Customs.CustomsSetting'
                )[0] != null)
        ) {
            var item = new MenusTablePM();
            item.CategoryTypeCode = 'CSM';
        ...
        if (SessionLocator.LoggedUserPM.Email.includes('amital')) {
            ...
            item.Icon = 'Settings';
            item.Code = 'CSRA';
            item.ObjectTableName = TextCodeTranslator.Translate(
                'General.MC.Customs.ReAnalysis'
            );
            this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
        }
    }
    private BuildAccountingMenus() {
        if (FeatureLocator.HasFeaturePermession('General', 'ACCOUNTINGS')) {
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.FullAccountingSetting'
                )
            ) {
                var item = new MenusTablePM();
            ...
            if (
                FeatureLocator.HasFeaturePermession(
                    'General',
                    'General.Features.ChartOfAccountsTypesOrder'
                )
            ) {
                var item = new MenusTablePM();
                item.CategoryTypeCode = 'ACC';
    ...
    private BuildOtherMenus() {
        if (SessionLocator.Tenant == 0) {
            // && FeatureLocator.HasFeaturePermession("General", "HYBRIDPARTNERS")) {
            var item = new MenusTablePM();
        ...
        if (SessionLocator.Tenant == 0) {
            ...
            item.ObjectTableId = window.ObjectTables.filter(
                (d) => d.Name == 'BatchServicesLog'
            )[0].Id;
            this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
        } else {
            this.AllMaintenanceMenu = this.AllMaintenanceMenu.filter(
                (d) => d.Code != 'MTDS'
            );
        }
    }
    ...
    IsCustomizationMaintenanceMenuVisible(): boolean {
        ...
        if (
            CustomizationPermissionService.HasFeaturePermession(
                'General',
                'General.Features.CustomizationSettings'
            ) &&
            CustomizationPermissionService.HasToggleFeaturePermession('CUS')
        ) {
            return true;
        }
        return false;
    ...
    private BuildSingleCustomObjectMenu(objectTable: ObjectTablePM) {
        ...
        maintenanceMenuItem.DescriptionText =
    ...
    private BuildShaamTokenManagementMenu() {
        ...
        (item.ObjectTableName = 'ConfirmationNumberTokenLog'),
            (item.ObjectTableId = window.ObjectTables.filter(
                (d) => d.Name == 'Customs.ConfirmationNumberTokenLog'
            )[0].Id);
        ...
        (item.TranslatedName = 'Token Managment'),
            TextCodeTranslator.Translate('General.MC.TokenManagement');
        this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
        ...
        if (SessionLocator.LoggedUserPM.IsCustomerCare) {
            ...
            item.Icon = 'Settings';
            item.Code = 'CSSS';
            item.ObjectTableName =
                TextCodeTranslator.Translate(
                    'General.MC.Customs.ShaamSettings'
                ) || 'Shaam Settings';
            this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
        }
    }
    ...
    private BuildAmitalAPISettingsMenu() {
        ...
        (item.ObjectTableName =
            TextCodeTranslator.Translate('Customs.MC.General.APIRequests') ||
            'API Requests'),
            this.AllMaintenanceMenu.push(new MaintenanceMenuItem(item));
    }
    ...
    PageChanged(item: Menu) {
        ...
        if (item != null) {
            itemsSource = this.AllMaintenanceMenu.filter(
                (f) =>
                    f.CategoryTypeCode.toUpperCase() ==
                    this.SelectedMenu.Code.toUpperCase()
            );
        }
            ...
            switch (item.Code) {
                case 'CUSC': {
                    ...
                    logWindow.WindowArgs = {
                        windowInstance: logWindow,
                    } as CustomsCloudComponentArgs;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/CustomsCloud/CustomsCloudComponent'
                    );
                    break;
                }
                ...
                case 'CSSS': {
                    const logWindow = new LogitudeWindow();
                    logWindow.Title = TextCodeTranslator.Translate(
                        'General.MC.TokenManagement'
                    );
                    logWindow.IsShowCloseButton = true;
                    logWindow.WindowArgs = <ShaamSettingsArgs>{
                        windowInstance: logWindow,
                    };
                    logWindow.Width = 500;
                    logWindow.Height = 300;
                    logWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/ShaamSettings/ShaamSettingsComponent'
                    );
                    break;
                }
                ...
                case 'SHAAM_TOKEN': {
                    this._entityResourceService
                        .getEntityResourceByTableName(
                            'Customs.ConfirmationNumberTokenLog',
                            0
                        )
                        .subscribe((response: any) => {
                            const logWindow = new LogitudeWindow();
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureGettingStarted/Components/ShaamSettings/ShaamTokensComponent'
                            );
                        });
                    break;
                }
                ...
                case 'DFES': {
                    ...
                    logWindow.IsShowCloseButton = true;
                    logWindow.Show(
                        './Common/Components/Maintenance/DocumentFilingEmailSettings/DocumentFilingEmailSettingsComponent'
                    );
                    break;
                }
                ...
                case 'CODE': {
                    this._entityResourceService
                        .getEntityResourceByTableName('Tenant', 0)
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureGettingStarted/Components/SystemDefaults/SystemDefaultsComponent'
                            );
                        });
                    break;
                }
                case 'LBSE': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './Common/Components/Maintenance/LogBoxSettings'
                            );
                        });
                    break;
                }
                case 'LOSE': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureGettingStarted/Components/LocalSettings/LocalSettingsComponent'
                            );
                        });
                    break;
                }
                case 'CARGO': {
                    ...
                    logWindow.IsShowCloseButton = true;
                    logWindow.Show(
                        './Accounting/Components/Others/CargoTrackingService/CargoTrackingServiceComponent'
                    );
                ...
                case 'CSMN': {
                    ...
                    if (test) {
                        if (
                            ...
                            new Date(2017, 7, 20).valueOf()
                        ) {
                            strict = false;
                        }
                    }
                    let LoggedUserPMCode =
                        SessionLocator.LoggedUserPM.Code || '';
                    LoggedUserPMCode = LoggedUserPMCode.toLowerCase();
                    let allowed = false;
                    allowed =
                ...
                case 'CSRA': {
                    ...
                    let windowTitle = TextCodeTranslator.Translate(
                        'General.MC.Customs.ReAnalysis'
                    ); //"גליון בקשות - ניתוח מחדש"//"Customs Settings";
                    let logWindow = new LogitudeWindow();
                    ...
                    logWindow.Show(
                        './CustomsModules/CustomsControls/Components/CustomsRequestsSheetsComponent'
                    );
                ...
                case 'COAD': {
                    ...
                    logWindow.IsShowCloseButton = true;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureGettingStarted/Components/CompanyAddress/CompanyAddressSettingsComponent'
                    );
                    break;
                }
                case 'PAGD': {
                    ...
                    logWindow.IsShowCloseButton = true;
                    this._entityResourceService
                        .getEntityResourceByTableName('TenantAdditionalData')
                        .subscribe((response: any) => {
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureGettingStarted/Components/PaymentGateway/PaymentGatewayComponent'
                            );
                        });
                    break;
                }
                case 'SYCR': {
                    ...
                    logWindow.Title = windowTitle;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureGettingStarted/Components/SystemCurrencies/SystemCurrenciesComponent'
                    );
                    break;
                }
                case 'CHPA': {
                    ...
                    this._entityResourceService
                        .getEntityResourceByTableName('User')
                        .subscribe((response: any) => {
                            logitudeWindow.DataContext = this;
                            logitudeWindow.Show(
                                './InfrastructureModules/InfrastructureUser/Components/PersonalSettings/ChangePasswordComponent'
                            );
                        });
                ...
                case 'COLO': {
                    ...
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureGettingStarted/Components/UploadImage/UploadLogoComponent'
                    );
                    break;
                }
                case 'AUTO': {
                    ...
                    logitudeWindow.Show(
                        './Infrastructure/Components/Maintenance/Automation/MainMenuAutomationComponent'
                    );
                    break;
                }
                ...
                case 'CFMM': {
                    var {
                        logWindow,
                        windowArgs,
                    }: { logWindow: LogitudeWindow; windowArgs: any } =
                        this.ShowCustomizationCustomFieldsWindow(
                            logWindow,
                            windowArgs
                        );
                    break;
                ...
                case 'SYIN': {
                    this._entityResourceService
                        .getEntityResourceByTableName('TenantManagement', 0)
                        .subscribe((response: any) => {
                            this._entityResourceService
                                .getEntityResourceByTableName('Tenant', 0)
                                .subscribe((tenantResp) => {
                                    var logitudeWindow = new LogitudeWindow();
                                    ...
                                    logitudeWindow.Show(
                                        './InfrastructureModules/InfrastructureOthers/Components/CustomizeLogitude/SystemInfoComponent'
                                    );
                                });
                        });
                    break;
                ...
                case 'SIGN': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.WindowArgs = windowArgs;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureDocuments/Components/DocumentComponent/HtmlDocumentPreviewComponent'
                            );
                        });
                    break;
                }
                case 'TOUS': {
                    this._entityResourceService
                        .getEntityResourceByTableName('TermsofUseSignature', 0)
                        .subscribe((response: any) => {
                            var widthwindow = window.innerWidth;
                            var heighthwindow = window.innerHeight;
                            ...
                            logitudeWindow.Show(
                                './InfrastructureModules/InfrastructureOthers/Components/TermsOfUse/TermsofUseSignatureComponent'
                            );
                        });
                    break;
                }
                case 'ACSE': {
                    ...
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureGettingStarted/Components/AccountingSettings/AccountingSettingsComponent'
                    );
                    break;
                }
                case 'FACS': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logitudeWindow.Show(
                                './Accounting/Components/Maintenance/FullAccountingSettingsComponent'
                            );
                        });
                    break;
                }
                case 'COATO': {
                    this._entityResourceService
                        .getEntityResourceByTableName('ChartOfAccountsType', 0)
                        .subscribe((response: any) => {
                            var logitudeWindow = new LogitudeWindow();
                ...
                case 'ACYT': {
                    ...
                    this._entityResourceService
                        .getEntityResourceByTableName('AccountingPeriod', 0)
                        .subscribe((response: any) => {
                            var logitudeWindow = new LogitudeWindow();
                            logitudeWindow.Width = 500;
                            ...
                            logitudeWindow.Show(
                                './Accounting/Components/Maintenance/YearTransferComponent'
                            );
                        });
                    break;
                }
                case 'ACPD': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logitudeWindow.Height = 500;
                            logitudeWindow.Title = TextCodeTranslator.Translate(
                                'Accounting.O.AccountingPeriods'
                            );
                            logitudeWindow.Show(
                                './Accounting/Components/Maintenance/AccountingPeriodsComponent'
                            );
                        });
                    break;
                }
                case 'MTSV': {
                    this._entityResourceService
                        .getEntityResourceByTableName('SLAHeader', 0)
                        .subscribe((response: any) => {
                            this._entityResourceService
                                .getEntityResourceByTableName('SLALine', 0)
                                .subscribe((response: any) => {
                                    var logitudeWindow = new LogitudeWindow();
                                    logitudeWindow.Width = 950;
                                    logitudeWindow.Height = 640;
                                    ...
                                    logitudeWindow.ShowCloseButton = true;
                                    logitudeWindow.Show(
                                        './CRMModules/CRMOthers/Components/SLA/SLAMainWindowComponent'
                                    );
                                });
                        });
                    break;
                ...
                case 'MTUS': {
                    this._entityResourceService
                        .getEntityResourceByTableName('User', 0)
                        .subscribe((resp: any) => {
                            SessionLocator.DynamicLoader.Load(
                                './InfrastructureModules/InfrastructureUser/Components/UserWorkspaceComponent',
                                this.CurrentSession.SessionMenuLocation
                                    .viewContainerRef
                            ).then((cmpRef) => {
                ...
                case 'CRLM': {
                    ...
                    logitudeWindow.Show(
                        './Common/Components/Maintenance/CreditLimit/CreditLimitSettingsComponent'
                    );
                    break;
                }
                case 'MTBH': {
                    this._entityResourceService
                        .getEntityResourceByTableName('BusinessHour', 0)
                        .subscribe((response: any) => {
                            this._entityResourceService
                                .getEntityResourceByTableName(
                                ...
                                .subscribe((response: any) => {
                                    ...
                                    logitudeWindow.ShowCloseButton = true;
                                    logitudeWindow.Show(
                                        './CRMModules/CRMOthers/Components/BusinessHour/NewBusinessHourAndHolidaysComponent'
                                    );
                                });
                        });
                    break;
                ...
                case 'AIRS': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureGettingStarted/Components/AirlineSettings/AirlineSettingsComponent'
                            );
                        });
                    break;
                }
                case 'DRBO': {
                    ...
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/DropBox/DropBoxConnectionComponent'
                    );
                    break;
                }
                case 'MTEA': {
                    ...
                    logWindow.IsShowCloseButton = false;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/EmailNotifications/EmailNotificationsSettingsComponent'
                    );
                    break;
                }
                case 'MTIS': {
                    ...
                    logWindow.IsShowCloseButton = false;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/IntegrationSystemsSetting/IntegrationSystemsSetting'
                    );
                    break;
                }
                case 'USPC': {
                    ...
                    logWindow.IsShowCloseButton = false;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureUser/Components/Packages/UserPackagesComponent'
                    );
                    break;
                }
                case 'CUSA': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './Common/Components/Maintenance/CustomerActivationSettingsComponent'
                            );
                        });
                    break;
                }
                case 'VATS': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './Common/Components/Maintenance/VATSettingsComponent'
                            );
                        });
                    break;
                }
                case 'CISE': {
                    ...
                    logitudeWindow.Show(
                        './Common/Components/Maintenance/CustomsInterface/CustomsInterfaceSettingsComponent'
                    );
                    break;
                }
                case 'CFTP': {
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/Maintenance/CustomsPartnerFtpListComponent'
                    );
                    break;
                }
                case 'MTTC': {
                    this._entityResourceService
                        .getEntityResourceByTableName('TicketClassification', 0)
                        .subscribe((resp: any) => {
                            SessionLocator.DynamicLoader.Load(
                                './CRM/Components/Workspaces/TicketClassificationMaintenanceComponent',
                                this.CurrentSession.SessionMenuLocation
                                    .viewContainerRef
                            ).then((cmpRef) => {
                                cmpRef.instance.ComponentRef = cmpRef;
                ...
                case 'INVS': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureGettingStarted/Components/InvoiceSettings/InvoiceSettingsComponent'
                            );
                        });
                    break;
                }
                case 'MTFS': {
                    ...
                    logWindow.IsShowCloseButton = true;
                    logWindow.Show(
                        './ShipmentModules/ShipmentStock/Components/FBLStock/FBLStockMainComponent'
                    );
                    break;
                }
                case 'MTSE': {
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './CRMModules/CRMOthers/Components/TicketSettings/TicketSettingsComponent'
                            );
                        });
                    break;
                }
                case 'REFI': {
                    var logitudeWindow = new LogitudeWindow();
                    logitudeWindow.Title = TextCodeTranslator.Translate(
                        'Customs.General.O.RequiredFields'
                    );
                    logitudeWindow.ShowCloseButton = true;
                    logitudeWindow.Height = 525;
                    logitudeWindow.Width = 750;
                    logitudeWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/Maintenance/RequiredFields/RequiredFieldsComponent'
                    );
                    break;
                }
                case 'EXPR': {
                    ...
                    logitudeWindow.Width = 750;
                    logitudeWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/Maintenance/RequiredFields/ExportRequiredFieldsComponent'
                    );
                    break;
                }
                case 'SECP': {
                    this._entityResourceService
                        .getEntityResourceByTableName('TenantLoginPolicy', 0)
                        .subscribe((response: any) => {
                            var windowTitle =
                                TextCodeTranslator.Translate(
                                    'TenantLoginPolicy'
                            ...
                            logWindow.IsShowCloseButton = false;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureOthers/Components/TenantSecurityPolicy/TenantLoginPolicyComponent'
                            );
                        });
                    break;
                }
                case 'BSLG': {
                    ...
                    logWindow.IsShowCloseButton = true;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureBatchService/Components/BatchService/BatchServicesComponent'
                    );
                    break;
                }
                case 'COCO': {
                    ...
                    logitudeWindow.ShowCloseButton = true;
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureGettingStarted/Components/Counters/CountersComponent'
                    );
                    break;
                }
                case 'SUMN': {
                    ...
                    logitudeWindow.ShowCloseButton = true;
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureUser/Components/SupportManagementComponent'
                    );
                    break;
                }
                case 'OISG': {
                    ...
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/OceanInsightsSetting/OceanInsightsSettingsComponent'
                    );
                    break;
                }
                case 'HYTT': {
                    ...
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/CustomizeLogitude/HybridTenantThresholdComponent'
                    );
                    break;
                }
                ...
                case 'CRTE': {
                    ...
                    logitudeWindow.ShowCloseButton = false;
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/CreateTenant/CreateTenantComponent'
                    );
                    break;
                }
                ...
                case 'MASC': {
                    this._entityResourceService
                        .getEntityResourceByTableName('TasksScheduler', 0)
                        .subscribe((response: any) => {
                            var logWindow = new LogitudeWindow();
                            ...
                            logWindow.IsShowCloseButton = true;
                            logWindow.Show(
                                './InfrastructureModules/InfrastructureBatchService/Components/TaskScheduler/MainSchedulerComponent'
                            );
                        });
                    break;
                }
                case 'MTHT': {
                    ...
                    logWindow.Title = windowTitle;
                    logWindow.Show(
                        './InfrastructureModules/InfrastructureHybrid/Components/HybridTenantState/HybridTenantStateComponent'
                    );
                    break;
                }
                case 'MCSG': {
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/Maintenance/SignStationsComponent'
                    );
                    break;
                }
                case 'MRSG': {
                    var logitudeWindow = new LogitudeWindow();
                    logitudeWindow.Title = TextCodeTranslator.Translate(
                        'Customs.General.O.RecallSuppliersFromFile'
                    );
                    logitudeWindow.ShowCloseButton = true;
                    logitudeWindow.Height = 400;
                    logitudeWindow.Width = 500;
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsGeneralRequests/Components/RecallSuppliersFromFileComponent'
                    );
                    break;
                }
                case 'MRCF': {
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsGeneralRequests/Components/ReceiptCertificateFromFileComponent'
                    );
                    break;
                }
                case 'MTDD': {
                    var logitudeWindow = new LogitudeWindow();
                    logitudeWindow.Title = TextCodeTranslator.Translate(
                        'General.MC.Customs.DocumentsDefinition'
                    );
                    logitudeWindow.ShowCloseButton = true;
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/Maintenance/CustomsDocumentsDefinitionComponent'
                    );
                    break;
                }
                ...
                case 'LOTE': {
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsMaintenance/Components/Maintenance/LoadTestComponent'
                    );
                    break;
                }
                case 'MTRC': {
                    ...
                    confirmWindow.Title = TextCodeTranslator.Translate(
                        'General.MC.Customs.RecallClientsForCutoms'
                    );
                    confirmWindow.Width = 300;
                    confirmWindow.Height = 200;
                    confirmWindow.YesButtonText = TextCodeTranslator.Translate(
                        'Customs.General.B.OK'
                    );
                    confirmWindow.NoButtonText = TextCodeTranslator.Translate(
                        'Customs.General.B.Cancel'
                    );
                    ...
                    confirmWindow.WindowClosed.subscribe((event: any) => {
                        if (confirmWindow.Yes) {
                            var servicelink =
                                './Customs/CustomsGeneralRequests/Components/RecallClientsForCutoms';
                            ...
                            SessionLocator.DynamicLoader.GetInstance(
                                servicelink
                            ).then((service: any) => {
                                service.SendRecallMessageToServer();
                            });
                ...
                case 'QuoteSettings': {
                    ...
                    logitudeWindow.Show(
                        './QuoteModules/QuoteOthers/Components/Maintenance/QuoteSettingsComponent'
                    );
                    break;
                }
                ...
                case 'ContainerSettings': {
                    this._entityResourceService
                        .getEntityResourceByTableName('ContainerSetting')
                        .subscribe(() => {
                            var logitudeWindow = new LogitudeWindow();
                            logitudeWindow.ShowCloseButton = true;
                            ...
                            logitudeWindow.Show(
                                './ShipmentModules/ShipmentOthers/Components/ContainerSetting/ContainerSettingsComponent'
                            );
                        });
                    break;
                }
                case 'ReleaseSettings': {
                    ...
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureGettingStarted/Components/Workspaces/ReleaseSettingsComponent'
                    );
                    break;
                }
                ...
                case 'INTTRA_S': {
                    ...
                    logitudeWindow.Show(
                        './ShipmentModules/ShipmentINTTRA/Components/Maintenance/INTTRASettingsComponent'
                    );
                    break;
                }
                case 'INTTRA_CMS': {
                    ...
                    logitudeWindow.Show(
                        './ShipmentModules/ShipmentINTTRA/Components/Maintenance/INTTRACommunicationSettingsComponent'
                    );
                    break;
                }
                ...
                case 'SUPM': {
                    this._entityResourceService
                        .getEntityResourceByTableName('SupportMailbox', 0)
                        .subscribe((response: any) => {
                            var windowTitle = 'Support Mail Boxes';
                            var logWindow = new LogitudeWindow();
                            logWindow.Title = windowTitle;
                            logWindow.Show(
                                './CRMModules/CRMOthers/Components/SupportMailBox/SupportMailBoxComponent'
                            );
                        });
                    break;
                }
                ...
                case 'PAUP': {
                    ...
                    logWindow.IsShowCloseButton = false;
                    logWindow.Show(
                        './CommonModules/CommonPartners/Components/Maintenance/UploadPartnersComponent'
                    );
                    break;
                }
                case 'SAL': {
                    ...
                    let msg = TextCodeTranslator.Translate(
                        'Customs.Client.IsSelectAuthorizationLetters'
                    );
                    let confirmWindow = new ConfirmWindow();
                    confirmWindow.Title = TextCodeTranslator.Translate(
                        'General.MC.Customs.SelectAuthorizationLetters'
                    );
                ...
                case 'SAC': {
                    ...
                    let msg = 'הםם לבצע שליפה של כל הלקוחות במערכת?';
                    let confirmWindow = new ConfirmWindow();
                ...
                case 'VIZN': {
                    var logitudeWindow = new LogitudeWindow();
                    logitudeWindow.Title =
                        'Container Tracking - Pilot Customers';
                    logitudeWindow.Width = 1000;
                    logitudeWindow.Height = 600;
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/Vizion/VizionAutomaticRequestComponent'
                    );
                    break;
                }
                ...
                case 'TOU': {
                    ...
                    logitudeWindow.Show(
                        './InfrastructureModules/InfrastructureOthers/Components/TermsOfUse/TermsofUseComponent'
                    );
                    break;
                }
                    ...
                    this._entityResourceService
                        ...
                        .subscribe((response: any) => {
                            var windowTitle = TextCodeTranslator.Translate(
                                'Customs.SupplierInvioceExportDefault.O.OCRDefaults'
                            );
                            var logWindow = new LogitudeWindow();
                            logWindow.Width = 800;
                            logWindow.Height = 500;
                ...
                default: {
                    if (item.ObjectTableId) {
                        ...
                        if (allQueries.length == 0) {
                            ...
                            myConfirmWindow.Show(
                                'No Queries found for ' + item.TranslatedName
                            );
                        } else {
                            ...
                            if (listArgs.Perspective != null) {
                                if (
                                    item.ObjectTableName == 'ErrorLog' ||
                                    item.ObjectTableName == 'AnalyzeQueue' ||
                                    item.ObjectTableName == 'CommunicationLog'
                                ) {
                                    SelectedQuery = allQueries
                                        .filter(
                                            (f) =>
                                                ((f.UserId ==
                                                    SessionLocator.LoggedUserId &&
                            ...
                            var objectTablePM = window.ObjectTables.filter(
                            ...
                            this._entityResourceService
                                ...
                                .subscribe((response: any) => {
                                    listArgs.DisplayTitle =
                                        TextCodeTranslator.Translate(
                                            SelectedQuery.NameTextCodeCode
                                        );
                                    SessionLocator.DynamicLoader.Load(
    ...
    async navigateToExportCustoms(logitudeCommandId: string) {
        ...
        try {
            ...
            console.log(
                '******* error throw when try get login link to export',
                error
            );
    ...
    showErrorMessage(): Promise<void> {
        ...
        return new Promise<void>((res) =>
            msgWin.WindowClosed.subscribe(() => res())
        );
    }
    ...
    private ShowCustomizationCustomFieldsWindow(
        ...
        logWindow.IsShowCloseButton = false;
        logWindow.Show(
            './InfrastructureModules/InfrastructureCustomization/Components/Customization/CustomizationMainComponent'
        );
    ...
    private ShowTranslateLabelsWindow() {
        ...
        logWindow.Title = windowTitle;
        logWindow.Show(
            './InfrastructureModules/InfrastructureCustomization/Components/TranslationLabels/SelectLanguagesComponent'
        );
    }
    private ShowTranslationWindow() {
        ...
        logWindow.Show(
            './InfrastructureModules/InfrastructureCustomization/Components/Translations/TranslationComponent'
        );
    }
    ...
    DoJoker(text: string) {
        switch (text) {
            ...
            case 'jokerng1':
                {
                    ...
                    logWindow.Show(
                        './CustomsModules/CustomsCourier/Components/CourierWorkspaces/CourierWorksheetNGTComponent'
                    );
            ...
            case 'jokerng2':
                {
                    ...
                    logitudeWindow.Show(
                        './CustomsModules/CustomsCourier/Components/CourierWorkspaces/VirtualScrollNGScroll'
                    );
                    //logitudeWindow.Show('./CustomsModules/CustomsCourier/Components/CourierWorkspaces/VirtualScrollNG');
                }
                break;
            case 'jokerinv':
                {
                    ...
                    var json =
                        '{"UnifreightEntity"  :  "CFIFILEM" , "UnifreightEntityNumber"  :  "93320020" , "LogitudeEntity"  :  "Customs.Declaration" , "LogitudeEntityNumber"  :  "1-5415" , "LogitudeViewModel"  :  "UnifreightMassageHandler" , "LogitudeCommandId"  :  "CreateInvoiceCommand" , "formtitle"  :  "הצהרת יבום"}';
                    ...
                    AmitalGatewayUtil.Instance.UnifaceRequest(
                        objParams,
                        null,
                        null,
                        null
            ...
            case 'jokeraccfunctionaltest':
                {
                    ...
                    logitudeWindow.Show(
                        './Accounting/Components/Maintenance/AccountingFunctionalTestComponent'
                    );
                }
                break;
            case 'jokeracctest':
                {
                    ...
                    logitudeWindow.ShowCloseButton = true;
                    logitudeWindow.Show(
                        './Accounting/Components/Maintenance/Tester/AccountingMainTesterComponent'
                    );
                }
                break;
            case 'jokeraccloadtest':
                {
                    ...
                    logitudeWindow.Title = 'Accounting Load Test';
                    logitudeWindow.Show(
                        './Accounting/Components/Maintenance/AccountingLoadTestComponent'
                    );
                }
                break;
            case 'jokersign': {
            ...
            case 'jokerGetAmitalRestrictOwnerModel': {
                var servicelink =
                    '../../../Customs/Services/ExtendedLists/CustomsSettingExtendedListService';
                SessionLocator.DynamicLoader.GetInstance(servicelink).then(
                    (service: any) => {
                        service
                            .GetAmitalRestrictOwnerModel(false)
                            .subscribe((rsp) => {
            ...
            case 'jokerremark': {
                ...
                let EntityPM;
                var _declarationRemarksService: DeclarationRemarksService =
                    new DeclarationRemarksService();
                if (windowArgs.QueType == 2) {
                    _declarationRemarksService
                        .GetSVCOrSRVStatusList(1, '41100314')
                        .subscribe((response: any) => {
                            windowArgs.EntityPM = response.Result;
                            windowArgs.length = response.Result.length;
                            logitudeWindow.Title =
                                windowArgs.length + '  הערות מסווג  ';
                            logitudeWindow.WindowArgs = windowArgs;
                            logitudeWindow.Show(
                                './CustomsModules/CustomsMaintenance/Components/DeclarationRemarksComponent'
                            );
                        });
                } else {
                    _declarationRemarksService
                        .GetINCorINAtatusList(1, '41100314')
                        .subscribe((response: any) => {
                            windowArgs.EntityPM = response.Result;
    ...
    SearchTextChanged(text: string) {
        ...
        if (AppTool.IsNullOrEmpty(text)) {
            ...
            itemsSource = itemsSource.filter(
                (f) =>
                    f.TranslatedName.toUpperCase().indexOf(text.toUpperCase()) >
                    -1
            );
        }
        this.ItemsSource = itemsSource;
    ...
    CustomsClosedTablesMethod(item: MaintenanceMenuItem) {
        ...
        this._entityResourceService
            .getEntityResourceByTableName(item.ObjectTableName, 0)
            .subscribe((response: any) => {
                var listArgs = new ListComponentArgs();
                listArgs.DisplayTitle = item.TranslatedName; //TextCodeTranslator.Translate();
                SessionLocator.DynamicLoader.Load(
                    './CustomsModules/CustomsMaintenance/Components/Maintenance/CustomsClosedTablesComponent',
                    this.CurrentSession.SessionMenuLocation.viewContainerRef
                ).then((cmpRef) => {
                    cmpRef.instance.ComponentRef = cmpRef;
                    //cmpRef.instance.Run(listArgs);
    ...
    QueueMessages(item: MaintenanceMenuItem) {
        this._entityResourceService
            .getEntityResourceByTableName('ARInvoice', 0)
            .subscribe((response: any) => {
                var listArgs = new ListComponentArgs();
                listArgs.DisplayTitle = 'Queue Messages';
                SessionLocator.DynamicLoader.Load(
                    './Accounting/Components/Others/QueueMessagesServices/QueueMessagesStatistics',
                    this.CurrentSession.SessionMenuLocation.viewContainerRef
                ).then((cmpRef) => {
                    cmpRef.instance.ComponentRef = cmpRef;
                    this.CurrentSession.AddMenuReference(cmpRef);
    ...
    CustomsAutonomyKeywordMethod(item: MaintenanceMenuItem): any {
        this._entityResourceService
            ...
            .subscribe((response) => {
                ...
                //logitudeWindow.Show('./Customs/Components/CustomsRequests/GeneralRequests/RecallSuppliersFromFileComponent');
                logitudeWindow.Show(
                    './CustomsModules/CustomsCourier/Components/AutonomyKeywordComponent'
                );
            });
    }
    ...
    InterfaceManageentMethod(item: MaintenanceMenuItem) {
        ...
        this._entityResourceService
            ...
            .subscribe((response: any) => {
                ...
                listArgs.DisplayTitle = item.TranslatedName; //TextCodeTranslator.Translate();
                SessionLocator.DynamicLoader.Load(
                    './CustomsModules/CustomsMaintenance/Components/Maintenance/InterfaceManagementComponent',
                    this.CurrentSession.SessionMenuLocation.viewContainerRef
                ).then((cmpRef) => {
                    cmpRef.instance.ComponentRef = cmpRef;
                    //cmpRef.instance.Run(listArgs);
    ...
    private SetDescriptionText() {
        ...
        if (this.Code == 'CFMM' || this.Code == 'CUMM') {
            switch (this.Code) {
                case 'CUMM': {
                    myResult =
                        'Managing standard and Custom objects such ad Custom Fields, Screen Layout, Tabs, Rules ..';
                    break;
                }
                case 'CFMM': {
                    myResult =
                        'Managing Custom fields with Pick-list type, defining new Pick-list and adjusting the existing ones';
                    break;
                }
            }
        }
        ...
        if (
            this.CategoryTypeCode == 'PRS' ||
            this.CategoryTypeCode == 'CMS' ||
            this.CategoryTypeCode == 'MNG' ||
            this.Code == 'FACS' ||
            this.Code == 'COATO' ||
            this.Code == 'ACYT'
        ) {
            switch (this.Code) {
                ...
                case 'CARGO': {
                    myResult = 'Cargo Tracking';
                    break;
                }
                case 'QUEUEMSG': {
                    myResult = 'Queue Messages';
                    break;
                }
                case 'COAD': {
                ...
                case 'PAGD': {
                    myResult = 'Payment Gateway Definition';
                    break;
                }
                case 'CODE': {
                ...
                case 'CTPS': {
                    myResult = 'Container Tracking Settings';
                    break;
                }
                case 'MNGT': {
                    myResult = 'Error Logs';
                ...
                case 'COATO': {
                    myResult = 'Define your Chart Of Accounts Types Order';
                    break;
                }
            ...
            var ObjectTable = window.ObjectTables.filter(
                (d) => d.Id == this.item.ObjectTableId
            )[0];
            if (ObjectTable != null) {
                myResult = TextCodeTranslator.Translate(
                    ObjectTable.DescriptionTextCodeCode
                );
            }
        }
    ...
    private SetImageIconSource() {
        switch (this.item.Icon) {
            ...
            case 'PotentialCustomer.png': {
                this.ImageIconSource =
                    './Images/Maintenance/ShippersConsignee.png';
                break;
            }
