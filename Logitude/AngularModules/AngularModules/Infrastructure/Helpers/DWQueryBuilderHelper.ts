...
export class DWQueryBuilderHelper   {
    ...
    public RestoreFilters(Filters: any, SavedFilterItems: any = null) {
        ...
        var MyFilter = this.GetRestoreFilters(Filters, DWObjectField, SavedFilterItems);
        return MyFilter;
    }
    ...
    private GetRestoreFilters(BaseFilter: DWObjectFieldsDetails, MyFilter: DWObjectFieldsDetails, SavedFilterItems: DWObjectFieldsDetails[]) {
        ...
        BaseFilter.FilterItems.forEach((field) => {
            ...
            if (field.FilterItems.length == 0) {
                ...
                this.GetRestoreFilters(field, DWObjectField, SavedFilterItems);
