...
export class TeamPM {
    ...
    public get ManagerUserName() { return this.managerUserName; }
    public set ManagerUserName(newValue: string) { if (this.managerUserName != newValue) { this.managerUserName = newValue; this.MarkAsDirty("ManagerUserName"); } }
       
	 
    private notify: string;
    public get Notify() { return this.notify; }
    public set Notify(newValue: string) { if (this.notify != newValue) { this.notify = newValue; this.MarkAsDirty("Notify"); } }
