...
export class DigitalPreDefinedComponentPM {
    ...
    public OldEntityPM: DigitalPreDefinedComponentPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "DigitalPreDefinedComponent");
           
        }
       }
    }

    private MyClone: DigitalPreDefinedComponentPM;
