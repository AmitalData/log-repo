...
export class TipsVisibilityPM {
    ...
    public get TipCode() { return this.tipCode; }
    public set TipCode(newValue: string) { this.tipCode = newValue; this.MarkAsDirty(); }


    private isVisible: boolean;
    public get IsVisible() { return this.isVisible; }
    public set IsVisible(newValue: boolean) { this.isVisible = newValue; this.MarkAsDirty(); }
