...
export class TaskSchedulerHistoryPM {
    ...
    public get RunResult() { return this.runResult; }
    public set RunResult(newValue: string) { if (this.runResult != newValue) { this.runResult = newValue; this.MarkAsDirty("RunResult"); } }
       
	 
    private taskId: string;
    public get TaskId() { return this.taskId; }
    public set TaskId(newValue: string) { if (this.taskId != newValue) { this.taskId = newValue; this.MarkAsDirty("TaskId"); } }
       
	 
    private isError: boolean;
    public get IsError() { return this.isError; }
