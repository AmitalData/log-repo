...
export class CustomChildObjectPM {
    @Output() PropertyChanged: EventEmitter<PropertyChangedArgs> = new EventEmitter<PropertyChangedArgs>();
    public ObjectTableName: string;
    public UIProperties: UIProperties;
    constructor(objectTableName: string) {
    ...
    public get Field2() { if (!this.field2) { this.field2 = new CustomFieldClass(null, "Field2", this.ObjectTableName); } return this.field2; }
    public set Field2(newValue: CustomFieldClass) { this.field2 = newValue; this.MarkAsDirty("Field2"); }


    private field3: CustomFieldClass;
    public get Field3() { if (!this.field3) { this.field3 = new CustomFieldClass(null, "Field3", this.ObjectTableName); } return this.field3; }
    public set Field3(newValue: CustomFieldClass) { this.field3 = newValue; this.MarkAsDirty("Field3"); }


    private field4: CustomFieldClass;
    public get Field4() { if (!this.field4) { this.field4 = new CustomFieldClass(null, "Field4", this.ObjectTableName); } return this.field4; }
    public set Field4(newValue: CustomFieldClass) { this.field4 = newValue; this.MarkAsDirty("Field4"); }


    private field5: CustomFieldClass;
    public get Field5() { if (!this.field5) { this.field5 = new CustomFieldClass(null, "Field5", this.ObjectTableName); } return this.field5; }
    public set Field5(newValue: CustomFieldClass) { this.field5 = newValue; this.MarkAsDirty("Field5"); }


    private field6: CustomFieldClass;
    public get Field6() { if (!this.field6) { this.field6 = new CustomFieldClass(null, "Field6", this.ObjectTableName); } return this.field6; }
    public set Field6(newValue: CustomFieldClass) { this.field6 = newValue; this.MarkAsDirty("Field6"); }


    private field7: CustomFieldClass;
    public get Field7() { if (!this.field7) { this.field7 = new CustomFieldClass(null, "Field7", this.ObjectTableName); } return this.field7; }
    public set Field7(newValue: CustomFieldClass) { this.field7 = newValue; this.MarkAsDirty("Field7"); }


    private field8: CustomFieldClass;
    public get Field8() { if (!this.field8) { this.field8 = new CustomFieldClass(null, "Field8", this.ObjectTableName); } return this.field8; }
    public set Field8(newValue: CustomFieldClass) { this.field8 = newValue; this.MarkAsDirty("Field8"); }


    private field9: CustomFieldClass;
    public get Field9() { if (!this.field9) { this.field9 = new CustomFieldClass(null, "Field9", this.ObjectTableName); } return this.field9; }
    public set Field9(newValue: CustomFieldClass) { this.field9 = newValue; this.MarkAsDirty("Field9"); }


    private field10: CustomFieldClass;
    public get Field10() { if (!this.field10) { this.field10 = new CustomFieldClass(null, "Field10", this.ObjectTableName); } return this.field10; }
    ...
    public get Field11() { if (!this.field11) { this.field11 = new CustomFieldClass(null, "Field11", this.ObjectTableName); } return this.field11; }
    ...
    public get Field12() { if (!this.field12) { this.field12 = new CustomFieldClass(null, "Field12", this.ObjectTableName); } return this.field12; }
    ...
    public get Field13() { if (!this.field13) { this.field13 = new CustomFieldClass(null, "Field13", this.ObjectTableName); } return this.field13; }
    ...
    public get Field14() { if (!this.field14) { this.field14 = new CustomFieldClass(null, "Field14", this.ObjectTableName); } return this.field14; }
    ...
    public get Field15() { if (!this.field15) { this.field15 = new CustomFieldClass(null, "Field15", this.ObjectTableName); } return this.field15; }
    ...
    public get Field16() { if (!this.field16) { this.field16 = new CustomFieldClass(null, "Field16", this.ObjectTableName); } return this.field16; }
    ...
    public get Field17() { if (!this.field17) { this.field17 = new CustomFieldClass(null, "Field17", this.ObjectTableName); } return this.field17; }
    ...
    public get Field18() { if (!this.field18) { this.field18 = new CustomFieldClass(null, "Field18", this.ObjectTableName); } return this.field18; }
    ...
    public get Field19() { if (!this.field19) { this.field19 = new CustomFieldClass(null, "Field19", this.ObjectTableName); } return this.field19; }
    ...
    public get Field20() { if (!this.field20) { this.field20 = new CustomFieldClass(null, "Field20", this.ObjectTableName); } return this.field20; }
    ...
    public get Field21() { if (!this.field21) { this.field21 = new CustomFieldClass(null, "Field21", this.ObjectTableName); } return this.field21; }
    ...
    public get Field22() { if (!this.field22) { this.field22 = new CustomFieldClass(null, "Field22", this.ObjectTableName); } return this.field22; }
    ...
    public get Field23() { if (!this.field23) { this.field23 = new CustomFieldClass(null, "Field23", this.ObjectTableName); } return this.field23; }
    ...
    public get Field24() { if (!this.field24) { this.field24 = new CustomFieldClass(null, "Field24", this.ObjectTableName); } return this.field24; }
    ...
    public get Field25() { if (!this.field25) { this.field25 = new CustomFieldClass(null, "Field25", this.ObjectTableName); } return this.field25; }
    ...
    public get Field26() { if (!this.field26) { this.field26 = new CustomFieldClass(null, "Field26", this.ObjectTableName); } return this.field26; }
    ...
    public get Field27() { if (!this.field27) { this.field27 = new CustomFieldClass(null, "Field27", this.ObjectTableName); } return this.field27; }
    ...
    public get Field28() { if (!this.field28) { this.field28 = new CustomFieldClass(null, "Field28", this.ObjectTableName); } return this.field28; }
    ...
    public get Field29() { if (!this.field29) { this.field29 = new CustomFieldClass(null, "Field29", this.ObjectTableName); } return this.field29; }
    ...
    public get Field30() { if (!this.field30) { this.field30 = new CustomFieldClass(null, "Field30", this.ObjectTableName); } return this.field30; }
    ...
    public get Field31() { if (!this.field31) { this.field31 = new CustomFieldClass(null, "Field31", this.ObjectTableName); } return this.field31; }
    ...
    public get Field32() { if (!this.field32) { this.field32 = new CustomFieldClass(null, "Field32", this.ObjectTableName); } return this.field32; }
    ...
    public get Field33() { if (!this.field33) { this.field33 = new CustomFieldClass(null, "Field33", this.ObjectTableName); } return this.field33; }
    ...
    public get Field34() { if (!this.field34) { this.field34 = new CustomFieldClass(null, "Field34", this.ObjectTableName); } return this.field34; }
    ...
    public get Field35() { if (!this.field35) { this.field35 = new CustomFieldClass(null, "Field35", this.ObjectTableName); } return this.field35; }
    ...
    public get Field36() { if (!this.field36) { this.field36 = new CustomFieldClass(null, "Field36", this.ObjectTableName); } return this.field36; }
    ...
    public get Field37() { if (!this.field37) { this.field37 = new CustomFieldClass(null, "Field37", this.ObjectTableName); } return this.field37; }
    ...
    public get Field38() { if (!this.field38) { this.field38 = new CustomFieldClass(null, "Field38", this.ObjectTableName); } return this.field38; }
    ...
    public get Field39() { if (!this.field39) { this.field39 = new CustomFieldClass(null, "Field39", this.ObjectTableName); } return this.field39; }
    ...
    public get Field40() { if (!this.field40) { this.field40 = new CustomFieldClass(null, "Field40", this.ObjectTableName); } return this.field40; }
    ...
    public get Field41() { if (!this.field41) { this.field41 = new CustomFieldClass(null, "Field41", this.ObjectTableName); } return this.field41; }
    ...
    public get Field42() { if (!this.field42) { this.field42 = new CustomFieldClass(null, "Field42", this.ObjectTableName); } return this.field42; }
    ...
    public get Field43() { if (!this.field43) { this.field43 = new CustomFieldClass(null, "Field43", this.ObjectTableName); } return this.field43; }
    ...
    public get Field44() { if (!this.field44) { this.field44 = new CustomFieldClass(null, "Field44", this.ObjectTableName); } return this.field44; }
    ...
    public get Field45() { if (!this.field45) { this.field45 = new CustomFieldClass(null, "Field45", this.ObjectTableName); } return this.field45; }
    ...
    public get Field46() { if (!this.field46) { this.field46 = new CustomFieldClass(null, "Field46", this.ObjectTableName); } return this.field46; }
    ...
    public get Field47() { if (!this.field47) { this.field47 = new CustomFieldClass(null, "Field47", this.ObjectTableName); } return this.field47; }
    ...
    public get Field48() { if (!this.field48) { this.field48 = new CustomFieldClass(null, "Field48", this.ObjectTableName); } return this.field48; }
    ...
    public get Field49() { if (!this.field49) { this.field49 = new CustomFieldClass(null, "Field49", this.ObjectTableName); } return this.field49; }
    ...
    public CustomChildObjectsChangeSet: Array<CustomChildObjectPM> = [];
    public UniqueKey: string;

    public OldEntityPM: CustomChildObjectPM;
    ...
    MarkAsDirty(propertyName: string = null) {
        ...
        ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, this.ObjectTableName);
    }

    private MyClone: CustomChildObjectPM;
    public CloneMe() {
