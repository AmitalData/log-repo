...
export class MenuButtonGroupPM {
    ...
    public get MenuButtonGroupType() { return this.menuButtonGroupType; }
    public set MenuButtonGroupType(newValue: string) { this.menuButtonGroupType = newValue; this.MarkAsDirty(); }
