...
export class LBPTeamMemberPM {
    ...
    public get MemberUserId() { return this.memberUserId; }
    public set MemberUserId(newValue: string) { if (this.memberUserId != newValue) { this.memberUserId = newValue; this.MarkAsDirty("MemberUserId"); } }
    ...
    public get MemberTeamId() { return this.memberTeamId; }
    public set MemberTeamId(newValue: string) { if (this.memberTeamId != newValue) { this.memberTeamId = newValue; this.MarkAsDirty("MemberTeamId"); } }
