...
export class TraceEventPM {
    ...
    public get EventDateTime() { return this.eventDateTime; }
    public set EventDateTime(newValue: Date) { if (this.eventDateTime != newValue) { this.eventDateTime = newValue; this.MarkAsDirty("EventDateTime"); } }
    ...
    public set ContactEnglishFirstName(newValue: string) { if (this.contactEnglishFirstName != newValue) { this.contactEnglishFirstName = newValue; this.MarkAsDirty("ContactEnglishFirstName"); } }
       
	 
    private deleted: boolean;
    public get Deleted() { return this.deleted; }
    public set Deleted(newValue: boolean) { if (this.deleted != newValue) { this.deleted = newValue; this.MarkAsDirty("Deleted"); } }
       
	 
    private shortView: boolean;
    public get ShortView() { return this.shortView; }
    public set ShortView(newValue: boolean) { if (this.shortView != newValue) { this.shortView = newValue; this.MarkAsDirty("ShortView"); } }
       
	 
    private isManualEntry: boolean;
    public get IsManualEntry() { return this.isManualEntry; }
    public set IsManualEntry(newValue: boolean) { if (this.isManualEntry != newValue) { this.isManualEntry = newValue; this.MarkAsDirty("IsManualEntry"); } }
       
	 
    private eventTypeCode: string;
    public get EventTypeCode() { return this.eventTypeCode; }
    public set EventTypeCode(newValue: string) { if (this.eventTypeCode != newValue) { this.eventTypeCode = newValue; this.MarkAsDirty("EventTypeCode"); } }
    ...
    public get EventTypeCategoryCode() { return this.eventTypeCategoryCode; }
    ...
    public get IsAddedManually() { return this.isAddedManually; }
    public set IsAddedManually(newValue: boolean) { if (this.isAddedManually != newValue) { this.isAddedManually = newValue; this.MarkAsDirty("IsAddedManually"); } }
       
	 
    private customerCareUserEmail: string;
    public get CustomerCareUserEmail() { return this.customerCareUserEmail; }
    public set CustomerCareUserEmail(newValue: string) { if (this.customerCareUserEmail != newValue) { this.customerCareUserEmail = newValue; this.MarkAsDirty("CustomerCareUserEmail"); } }
