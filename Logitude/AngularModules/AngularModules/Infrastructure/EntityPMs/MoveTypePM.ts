...
export class MoveTypePM {
    ...
    public get MoveTypeEnglishName() { return this.moveTypeEnglishName; }
    public set MoveTypeEnglishName(newValue: string) { if (this.moveTypeEnglishName != newValue) { this.moveTypeEnglishName = newValue; this.MarkAsDirty("MoveTypeEnglishName"); } }
       
	 
    private moveTypeLocalName: string;
    public get MoveTypeLocalName() { return this.moveTypeLocalName; }
    public set MoveTypeLocalName(newValue: string) { if (this.moveTypeLocalName != newValue) { this.moveTypeLocalName = newValue; this.MarkAsDirty("MoveTypeLocalName"); } }
