...
export class FollowUpPM {
    ...
    public set JobId(newValue: string) { if (this.jobId != newValue) { this.jobId = newValue; this.MarkAsDirty("JobId"); } }
    ...
    public set ExternalDocumentId(newValue: string) { if (this.externalDocumentId != newValue) { this.externalDocumentId = newValue; this.MarkAsDirty("ExternalDocumentId"); } }
    ...
    public set DoneNote(newValue: string) { if (this.doneNote != newValue) { this.doneNote = newValue; this.MarkAsDirty("DoneNote"); } }
    ...
    public set Done(newValue: boolean) { if (this.done != newValue) { this.done = newValue; this.MarkAsDirty("Done"); } }
       
	 
    private internalDocumentId: string;
    public get InternalDocumentId() { return this.internalDocumentId; }
    public set InternalDocumentId(newValue: string) { if (this.internalDocumentId != newValue) { this.internalDocumentId = newValue; this.MarkAsDirty("InternalDocumentId"); } }
       
	 
    private legType: string;
    public get LegType() { return this.legType; }
    public set LegType(newValue: string) { if (this.legType != newValue) { this.legType = newValue; this.MarkAsDirty("LegType"); } }
    ...
    public set EntityDateId(newValue: string) { if (this.entityDateId != newValue) { this.entityDateId = newValue; this.MarkAsDirty("EntityDateId"); } }
    ...
    public set EventTypeFollowUpName(newValue: string) { if (this.eventTypeFollowUpName != newValue) { this.eventTypeFollowUpName = newValue; this.MarkAsDirty("EventTypeFollowUpName"); } }
       
	 
    private manualActivatedFollowUp: boolean;
    public get ManualActivatedFollowUp() { return this.manualActivatedFollowUp; }
    public set ManualActivatedFollowUp(newValue: boolean) { if (this.manualActivatedFollowUp != newValue) { this.manualActivatedFollowUp = newValue; this.MarkAsDirty("ManualActivatedFollowUp"); } }
       
	 
    private ownerUserId: string;
    public get OwnerUserId() { return this.ownerUserId; }
    public set OwnerUserId(newValue: string) { if (this.ownerUserId != newValue) { this.ownerUserId = newValue; this.MarkAsDirty("OwnerUserId"); } }
