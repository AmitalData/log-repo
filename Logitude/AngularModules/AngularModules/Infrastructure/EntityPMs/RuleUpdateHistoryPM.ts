...
export class RuleUpdateHistoryPM {
    ...
    public get RuleCode() { return this.ruleCode; }
    public set RuleCode(newValue: string) { if (this.ruleCode != newValue) { this.ruleCode = newValue; this.MarkAsDirty("RuleCode"); } }
       
	 
    private eventName: string;
    public get EventName() { return this.eventName; }
    public set EventName(newValue: string) { if (this.eventName != newValue) { this.eventName = newValue; this.MarkAsDirty("EventName"); } }
