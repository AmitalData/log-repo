...
export class BusinessProcessQueuePM {
    ...
    public get BusinessRoleId() { return this.businessRoleId; }
    public set BusinessRoleId(newValue: string) { if (this.businessRoleId != newValue) { this.businessRoleId = newValue; this.MarkAsDirty("BusinessRoleId"); } }
    ...
    public get EntityName() { return this.entityName; }
    public set EntityName(newValue: string) { if (this.entityName != newValue) { this.entityName = newValue; this.MarkAsDirty("EntityName"); } }
    ...
    public get BusinessRoleName() { return this.businessRoleName; }
    public set BusinessRoleName(newValue: string) { if (this.businessRoleName != newValue) { this.businessRoleName = newValue; this.MarkAsDirty("BusinessRoleName"); } }
