...
export class CustomPickListPM {
    ...
    public get IsMultipleChoice() { return this.isMultipleChoice; }
    public set IsMultipleChoice(newValue: boolean) { if (this.isMultipleChoice != newValue) { this.isMultipleChoice = newValue; this.MarkAsDirty("IsMultipleChoice"); } }
