...
export class InboundEmailLinePM {
    ...
    public get Recepient() { return this.recepient; }
    public set Recepient(newValue: string) { if (this.recepient != newValue) { this.recepient = newValue; this.MarkAsDirty("Recepient"); } }
    ...
    public get FullBody() { return this.fullBody; }
    public set FullBody(newValue: string) { if (this.fullBody != newValue) { this.fullBody = newValue; this.MarkAsDirty("FullBody"); } }
    ...
    public get InboundEmailId() { return this.inboundEmailId; }
    public set InboundEmailId(newValue: string) { if (this.inboundEmailId != newValue) { this.inboundEmailId = newValue; this.MarkAsDirty("InboundEmailId"); } }
    ...
    public get EntityLineId() { return this.entityLineId; }
