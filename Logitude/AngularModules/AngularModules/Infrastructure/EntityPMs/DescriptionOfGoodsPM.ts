...
export class DescriptionOfGoodsPM {
    ...
    public get DescriptionOfGood() { return this.descriptionOfGood; }
    public set DescriptionOfGood(newValue: string) { this.descriptionOfGood = newValue; this.MarkAsDirty(); }
       
	 
    private addedManually: boolean;
    public get AddedManually() { return this.addedManually; }
    public set AddedManually(newValue: boolean) { this.addedManually = newValue; this.MarkAsDirty(); }
