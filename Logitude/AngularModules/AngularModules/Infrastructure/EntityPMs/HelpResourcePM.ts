...
export class HelpResourcePM {
    ...
    public get VideoURL() { return this.videoURL; }
    public set VideoURL(newValue: string) { if (this.videoURL != newValue) { this.videoURL = newValue; this.MarkAsDirty("VideoURL"); } }
