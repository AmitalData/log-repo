...
export class QueueMessageMoreDetailsPM {
    ...
    public set Status(newValue: number) { if (this.status != newValue) { this.status = newValue; this.MarkAsDirty("Status"); } }
    ...
    public get NextRunDateTime() { return this.nextRunDateTime; }
    public set NextRunDateTime(newValue: Date) { if (this.nextRunDateTime != newValue) { this.nextRunDateTime = newValue; this.MarkAsDirty("NextRunDateTime"); } }
       
	 
    private processingDateTime: Date;
    public get ProcessingDateTime() { return this.processingDateTime; }
    public set ProcessingDateTime(newValue: Date) { if (this.processingDateTime != newValue) { this.processingDateTime = newValue; this.MarkAsDirty("ProcessingDateTime"); } }
       
	 
    private completeDateTime: Date;
    public get CompleteDateTime() { return this.completeDateTime; }
    public set CompleteDateTime(newValue: Date) { if (this.completeDateTime != newValue) { this.completeDateTime = newValue; this.MarkAsDirty("CompleteDateTime"); } }
