...
export class APILogsPM {
    ...
    public get LastUpdateDateUTC() { return this.lastUpdateDateUTC; }
    public set LastUpdateDateUTC(newValue: Date) { if (this.lastUpdateDateUTC != newValue) { this.lastUpdateDateUTC = newValue; this.MarkAsDirty("LastUpdateDateUTC"); } }
    ...
    public get Refrence() { return this.refrence; }
    public set Refrence(newValue: string) { if (this.refrence != newValue) { this.refrence = newValue; this.MarkAsDirty("Refrence"); } }
    ...
    public get LastExceptionMessage() { return this.lastExceptionMessage; }
    public set LastExceptionMessage(newValue: string) { if (this.lastExceptionMessage != newValue) { this.lastExceptionMessage = newValue; this.MarkAsDirty("LastExceptionMessage"); } }
    ...
    public get QueueMessageMoreDetailsId() { return this.queueMessageMoreDetailsId; }
    public set QueueMessageMoreDetailsId(newValue: string) { if (this.queueMessageMoreDetailsId != newValue) { this.queueMessageMoreDetailsId = newValue; this.MarkAsDirty("QueueMessageMoreDetailsId"); } }
    ...
    public get QueueMessage() { return this.queueMessage; }
    public set QueueMessage(newValue: string) { if (this.queueMessage != newValue) { this.queueMessage = newValue; this.MarkAsDirty("QueueMessage"); } }
