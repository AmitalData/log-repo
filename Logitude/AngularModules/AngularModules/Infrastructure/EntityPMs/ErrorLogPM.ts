...
export class ErrorLogPM {
    ...
    public get LogDate() { return this.logDate; }
    public set LogDate(newValue: Date) { if (this.logDate != newValue) { this.logDate = newValue; this.MarkAsDirty("LogDate"); } }
       
	 
    private clientDate: Date;
    public get ClientDate() { return this.clientDate; }
    public set ClientDate(newValue: Date) { if (this.clientDate != newValue) { this.clientDate = newValue; this.MarkAsDirty("ClientDate"); } }
       
	 
    private tier: string;
    public get Tier() { return this.tier; }
    public set Tier(newValue: string) { if (this.tier != newValue) { this.tier = newValue; this.MarkAsDirty("Tier"); } }
    ...
    public set IP(newValue: string) { if (this.iP != newValue) { this.iP = newValue; this.MarkAsDirty("IP"); } }
