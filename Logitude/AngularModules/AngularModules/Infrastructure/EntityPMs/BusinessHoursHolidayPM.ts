...
export class BusinessHoursHolidayPM {
    ...
    public set Day(newValue: number) { if (this.day != newValue) { this.day = newValue; this.MarkAsDirty("Day"); } }
    ...
    public get HolidayName() { return this.holidayName; }
    public set HolidayName(newValue: string) { if (this.holidayName != newValue) { this.holidayName = newValue; this.MarkAsDirty("HolidayName"); } }
    ...
    public get BusinessHourId() { return this.businessHourId; }
    public set BusinessHourId(newValue: string) { if (this.businessHourId != newValue) { this.businessHourId = newValue; this.MarkAsDirty("BusinessHourId"); } }
