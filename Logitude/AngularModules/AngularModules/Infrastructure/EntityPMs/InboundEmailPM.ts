...
export class InboundEmailPM {
    ...
    public get Uniquekey() { return this.uniquekey; }
    public set Uniquekey(newValue: string) { if (this.uniquekey != newValue) { this.uniquekey = newValue; this.MarkAsDirty("Uniquekey"); } }
    ...
    public get IsRejected() { return this.isRejected; }
    public set IsRejected(newValue: boolean) { if (this.isRejected != newValue) { this.isRejected = newValue; this.MarkAsDirty("IsRejected"); } }
