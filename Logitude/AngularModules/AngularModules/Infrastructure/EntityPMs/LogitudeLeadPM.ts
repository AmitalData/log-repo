...
export class LogitudeLeadPM {
    ...
    public get NumberOfBranches() { return this.numberOfBranches; }
    public set NumberOfBranches(newValue: number) { if (this.numberOfBranches != newValue) { this.numberOfBranches = newValue; this.MarkAsDirty("NumberOfBranches"); } }
       
	 
    private country: string;
    public get Country() { return this.country; }
    public set Country(newValue: string) { if (this.country != newValue) { this.country = newValue; this.MarkAsDirty("Country"); } }
    ...
    public get LeadSource() { return this.leadSource; }
    public set LeadSource(newValue: string) { if (this.leadSource != newValue) { this.leadSource = newValue; this.MarkAsDirty("LeadSource"); } }
    ...
    public get IsEmailVerified() { return this.isEmailVerified; }
    public set IsEmailVerified(newValue: boolean) { if (this.isEmailVerified != newValue) { this.isEmailVerified = newValue; this.MarkAsDirty("IsEmailVerified"); } }
    ...
    public get IsSentToCustomer() { return this.isSentToCustomer; }
    public set IsSentToCustomer(newValue: boolean) { if (this.isSentToCustomer != newValue) { this.isSentToCustomer = newValue; this.MarkAsDirty("IsSentToCustomer"); } }
    ...
    public get UnassignedCountry() { return this.unassignedCountry; }
    public set UnassignedCountry(newValue: boolean) { if (this.unassignedCountry != newValue) { this.unassignedCountry = newValue; this.MarkAsDirty("UnassignedCountry"); } }
    ...
    public get IsUserOpened() { return this.isUserOpened; }
    public set IsUserOpened(newValue: boolean) { if (this.isUserOpened != newValue) { this.isUserOpened = newValue; this.MarkAsDirty("IsUserOpened"); } }
    ...
    public set State(newValue: string) { if (this.state != newValue) { this.state = newValue; this.MarkAsDirty("State"); } }
    ...
    public set Street(newValue: string) { if (this.street != newValue) { this.street = newValue; this.MarkAsDirty("Street"); } }
    ...
    public get IsUserEmailSent() { return this.isUserEmailSent; }
