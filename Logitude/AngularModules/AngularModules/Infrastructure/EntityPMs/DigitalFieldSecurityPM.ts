...
export class DigitalFieldSecurityPM {
    ...
    public get DefaultSettings() { return this.defaultSettings; }
    public set DefaultSettings(newValue: string) { if (this.defaultSettings != newValue) { this.defaultSettings = newValue; this.MarkAsDirty("DefaultSettings"); } }
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "DigitalFieldSecurity");
           
        }
       }
    }

    private MyClone: DigitalFieldSecurityPM;
