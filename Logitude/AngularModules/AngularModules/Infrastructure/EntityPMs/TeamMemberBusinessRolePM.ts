...
export class TeamMemberBusinessRolePM {
    ...
    public get TeamMemberId() { return this.teamMemberId; }
    public set TeamMemberId(newValue: string) { if (this.teamMemberId != newValue) { this.teamMemberId = newValue; this.MarkAsDirty("TeamMemberId"); } }
    ...
    public get RoleName() { return this.roleName; }
    public set RoleName(newValue: string) { if (this.roleName != newValue) { this.roleName = newValue; this.MarkAsDirty("RoleName"); } }
