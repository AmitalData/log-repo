...
export class AdditionalCurrencyRatePM {
    ...
    private rateCoefficient: number;
    public get RateCoefficient() { return this.rateCoefficient; }
    public set RateCoefficient(newValue: number) { if (this.rateCoefficient != newValue) { this.rateCoefficient = newValue; this.MarkAsDirty("RateCoefficient"); } }
       
	 

    public OldEntityPM: AdditionalCurrencyRatePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AdditionalCurrencyRate");
           
        }
       }
    }

    private MyClone: AdditionalCurrencyRatePM;
