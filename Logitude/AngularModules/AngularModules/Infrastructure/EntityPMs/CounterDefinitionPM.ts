...
export class CounterDefinitionPM {
    ...
    public get Parameter1() { return this.parameter1; }
    public set Parameter1(newValue: string) { if (this.parameter1 != newValue) { this.parameter1 = newValue; this.MarkAsDirty("Parameter1"); } }
       
	 
    private parameter2: string;
    public get Parameter2() { return this.parameter2; }
    public set Parameter2(newValue: string) { if (this.parameter2 != newValue) { this.parameter2 = newValue; this.MarkAsDirty("Parameter2"); } }
    ...
    public get CounterId() { return this.counterId; }
    public set CounterId(newValue: string) { if (this.counterId != newValue) { this.counterId = newValue; this.MarkAsDirty("CounterId"); } }
    ...
    public get StartNumber_Old() { return this.startNumber_Old; }
    public set StartNumber_Old(newValue: number) { if (this.startNumber_Old != newValue) { this.startNumber_Old = newValue; this.MarkAsDirty("StartNumber_Old"); } }
