...
export class TenantManagementPM {
    ...
    public get LastLoginDateTime() { return this.lastLoginDateTime; }
    public set LastLoginDateTime(newValue: Date) { if (this.lastLoginDateTime != newValue) { this.lastLoginDateTime = newValue; this.MarkAsDirty("LastLoginDateTime"); } }
    ...
    public get PackageName() { return this.packageName; }
    public set PackageName(newValue: string) { if (this.packageName != newValue) { this.packageName = newValue; this.MarkAsDirty("PackageName"); } }
       
	 
    private trialStartDate: Date;
    public get TrialStartDate() { return this.trialStartDate; }
    public set TrialStartDate(newValue: Date) { if (this.trialStartDate != newValue) { this.trialStartDate = newValue; this.MarkAsDirty("TrialStartDate"); } }
       
	 
    private trialEndDate: Date;
    public get TrialEndDate() { return this.trialEndDate; }
    public set TrialEndDate(newValue: Date) { if (this.trialEndDate != newValue) { this.trialEndDate = newValue; this.MarkAsDirty("TrialEndDate"); } }
       
	 
    private firstPaymentDate: Date;
    public get FirstPaymentDate() { return this.firstPaymentDate; }
    public set FirstPaymentDate(newValue: Date) { if (this.firstPaymentDate != newValue) { this.firstPaymentDate = newValue; this.MarkAsDirty("FirstPaymentDate"); } }
       
	 
    private paidUntilDate: Date;
    public get PaidUntilDate() { return this.paidUntilDate; }
    public set PaidUntilDate(newValue: Date) { if (this.paidUntilDate != newValue) { this.paidUntilDate = newValue; this.MarkAsDirty("PaidUntilDate"); } }
    ...
    public get IsAWBStockPrepaid() { return this.isAWBStockPrepaid; }
    public set IsAWBStockPrepaid(newValue: boolean) { if (this.isAWBStockPrepaid != newValue) { this.isAWBStockPrepaid = newValue; this.MarkAsDirty("IsAWBStockPrepaid"); } }
    ...
    public get GlobalDBId() { return this.globalDBId; }
    public set GlobalDBId(newValue: string) { if (this.globalDBId != newValue) { this.globalDBId = newValue; this.MarkAsDirty("GlobalDBId"); } }
    ...
    public set IsRecurring(newValue: boolean) { if (this.isRecurring != newValue) { this.isRecurring = newValue; this.MarkAsDirty("IsRecurring"); } }
       
	 
    private recurringPeriodCode: string;
    public get RecurringPeriodCode() { return this.recurringPeriodCode; }
    public set RecurringPeriodCode(newValue: string) { if (this.recurringPeriodCode != newValue) { this.recurringPeriodCode = newValue; this.MarkAsDirty("RecurringPeriodCode"); } }
    ...
    public set PaymentFailure(newValue: boolean) { if (this.paymentFailure != newValue) { this.paymentFailure = newValue; this.MarkAsDirty("PaymentFailure"); } }
       
	 
    private suspendDate: Date;
    public get SuspendDate() { return this.suspendDate; }
    public set SuspendDate(newValue: Date) { if (this.suspendDate != newValue) { this.suspendDate = newValue; this.MarkAsDirty("SuspendDate"); } }
    ...
    public get BluesnapAccount() { return this.bluesnapAccount; }
    public set BluesnapAccount(newValue: string) { if (this.bluesnapAccount != newValue) { this.bluesnapAccount = newValue; this.MarkAsDirty("BluesnapAccount"); } }
       
	 
    private mainContract: string;
    public get MainContract() { return this.mainContract; }
    public set MainContract(newValue: string) { if (this.mainContract != newValue) { this.mainContract = newValue; this.MarkAsDirty("MainContract"); } }
       
	 
    private temporalPackageCode: string;
    public get TemporalPackageCode() { return this.temporalPackageCode; }
    public set TemporalPackageCode(newValue: string) { if (this.temporalPackageCode != newValue) { this.temporalPackageCode = newValue; this.MarkAsDirty("TemporalPackageCode"); } }
       
	 
    private temporalPackageName: string;
    public get TemporalPackageName() { return this.temporalPackageName; }
    public set TemporalPackageName(newValue: string) { if (this.temporalPackageName != newValue) { this.temporalPackageName = newValue; this.MarkAsDirty("TemporalPackageName"); } }
       
	 
    private temporalStartDate: Date;
    public get TemporalStartDate() { return this.temporalStartDate; }
    public set TemporalStartDate(newValue: Date) { if (this.temporalStartDate != newValue) { this.temporalStartDate = newValue; this.MarkAsDirty("TemporalStartDate"); } }
       
	 
    private temporalEndDate: Date;
    public get TemporalEndDate() { return this.temporalEndDate; }
    public set TemporalEndDate(newValue: Date) { if (this.temporalEndDate != newValue) { this.temporalEndDate = newValue; this.MarkAsDirty("TemporalEndDate"); } }
    ...
    public get PaymentChannelCode() { return this.paymentChannelCode; }
    public set PaymentChannelCode(newValue: string) { if (this.paymentChannelCode != newValue) { this.paymentChannelCode = newValue; this.MarkAsDirty("PaymentChannelCode"); } }
       
	 
    private licensePrice: number;
    public get LicensePrice() { return this.licensePrice; }
    public set LicensePrice(newValue: number) { if (this.licensePrice != newValue) { this.licensePrice = newValue; this.MarkAsDirty("LicensePrice"); } }
    ...
    public get LastFWBSentDate() { return this.lastFWBSentDate; }
    public set LastFWBSentDate(newValue: Date) { if (this.lastFWBSentDate != newValue) { this.lastFWBSentDate = newValue; this.MarkAsDirty("LastFWBSentDate"); } }
       
	 
    private lastFHLSentDate: Date;
    public get LastFHLSentDate() { return this.lastFHLSentDate; }
    public set LastFHLSentDate(newValue: Date) { if (this.lastFHLSentDate != newValue) { this.lastFHLSentDate = newValue; this.MarkAsDirty("LastFHLSentDate"); } }
       
	 
    private statisticsUpdateDate: Date;
    public get StatisticsUpdateDate() { return this.statisticsUpdateDate; }
    public set StatisticsUpdateDate(newValue: Date) { if (this.statisticsUpdateDate != newValue) { this.statisticsUpdateDate = newValue; this.MarkAsDirty("StatisticsUpdateDate"); } }
       
	 
    private shipmentLastDate: Date;
    public get ShipmentLastDate() { return this.shipmentLastDate; }
    public set ShipmentLastDate(newValue: Date) { if (this.shipmentLastDate != newValue) { this.shipmentLastDate = newValue; this.MarkAsDirty("ShipmentLastDate"); } }
       
	 
    private shipmentTotalLastWeek: number;
    public get ShipmentTotalLastWeek() { return this.shipmentTotalLastWeek; }
    public set ShipmentTotalLastWeek(newValue: number) { if (this.shipmentTotalLastWeek != newValue) { this.shipmentTotalLastWeek = newValue; this.MarkAsDirty("ShipmentTotalLastWeek"); } }
       
	 
    private shipmentTotalLastMonth: number;
    public get ShipmentTotalLastMonth() { return this.shipmentTotalLastMonth; }
    public set ShipmentTotalLastMonth(newValue: number) { if (this.shipmentTotalLastMonth != newValue) { this.shipmentTotalLastMonth = newValue; this.MarkAsDirty("ShipmentTotalLastMonth"); } }
       
	 
    private quoteLastDate: Date;
    public get QuoteLastDate() { return this.quoteLastDate; }
    public set QuoteLastDate(newValue: Date) { if (this.quoteLastDate != newValue) { this.quoteLastDate = newValue; this.MarkAsDirty("QuoteLastDate"); } }
       
	 
    private quoteTotalLastWeek: number;
    public get QuoteTotalLastWeek() { return this.quoteTotalLastWeek; }
    public set QuoteTotalLastWeek(newValue: number) { if (this.quoteTotalLastWeek != newValue) { this.quoteTotalLastWeek = newValue; this.MarkAsDirty("QuoteTotalLastWeek"); } }
       
	 
    private quoteTotalLastMonth: number;
    public get QuoteTotalLastMonth() { return this.quoteTotalLastMonth; }
    public set QuoteTotalLastMonth(newValue: number) { if (this.quoteTotalLastMonth != newValue) { this.quoteTotalLastMonth = newValue; this.MarkAsDirty("QuoteTotalLastMonth"); } }
       
	 
    private aRInvoiceLastDate: Date;
    public get ARInvoiceLastDate() { return this.aRInvoiceLastDate; }
    public set ARInvoiceLastDate(newValue: Date) { if (this.aRInvoiceLastDate != newValue) { this.aRInvoiceLastDate = newValue; this.MarkAsDirty("ARInvoiceLastDate"); } }
       
	 
    private aRInvoiceTotalLastWeek: number;
    public get ARInvoiceTotalLastWeek() { return this.aRInvoiceTotalLastWeek; }
    public set ARInvoiceTotalLastWeek(newValue: number) { if (this.aRInvoiceTotalLastWeek != newValue) { this.aRInvoiceTotalLastWeek = newValue; this.MarkAsDirty("ARInvoiceTotalLastWeek"); } }
       
	 
    private aRInvoiceTotalLastMonth: number;
    public get ARInvoiceTotalLastMonth() { return this.aRInvoiceTotalLastMonth; }
    public set ARInvoiceTotalLastMonth(newValue: number) { if (this.aRInvoiceTotalLastMonth != newValue) { this.aRInvoiceTotalLastMonth = newValue; this.MarkAsDirty("ARInvoiceTotalLastMonth"); } }
       
	 
    private aPInvoiceLastDate: Date;
    public get APInvoiceLastDate() { return this.aPInvoiceLastDate; }
    public set APInvoiceLastDate(newValue: Date) { if (this.aPInvoiceLastDate != newValue) { this.aPInvoiceLastDate = newValue; this.MarkAsDirty("APInvoiceLastDate"); } }
       
	 
    private aPInvoiceTotalLastWeek: number;
    public get APInvoiceTotalLastWeek() { return this.aPInvoiceTotalLastWeek; }
    public set APInvoiceTotalLastWeek(newValue: number) { if (this.aPInvoiceTotalLastWeek != newValue) { this.aPInvoiceTotalLastWeek = newValue; this.MarkAsDirty("APInvoiceTotalLastWeek"); } }
       
	 
    private aPInvoiceTotalLastMonth: number;
    public get APInvoiceTotalLastMonth() { return this.aPInvoiceTotalLastMonth; }
    public set APInvoiceTotalLastMonth(newValue: number) { if (this.aPInvoiceTotalLastMonth != newValue) { this.aPInvoiceTotalLastMonth = newValue; this.MarkAsDirty("APInvoiceTotalLastMonth"); } }
       
	 
    private customerLastDate: Date;
    public get CustomerLastDate() { return this.customerLastDate; }
    public set CustomerLastDate(newValue: Date) { if (this.customerLastDate != newValue) { this.customerLastDate = newValue; this.MarkAsDirty("CustomerLastDate"); } }
       
	 
    private customerTotalLastWeek: number;
    public get CustomerTotalLastWeek() { return this.customerTotalLastWeek; }
    public set CustomerTotalLastWeek(newValue: number) { if (this.customerTotalLastWeek != newValue) { this.customerTotalLastWeek = newValue; this.MarkAsDirty("CustomerTotalLastWeek"); } }
       
	 
    private customerTotalLastMonth: number;
    public get CustomerTotalLastMonth() { return this.customerTotalLastMonth; }
    public set CustomerTotalLastMonth(newValue: number) { if (this.customerTotalLastMonth != newValue) { this.customerTotalLastMonth = newValue; this.MarkAsDirty("CustomerTotalLastMonth"); } }
       
	 
    private mobileLastDate: Date;
    public get MobileLastDate() { return this.mobileLastDate; }
    public set MobileLastDate(newValue: Date) { if (this.mobileLastDate != newValue) { this.mobileLastDate = newValue; this.MarkAsDirty("MobileLastDate"); } }
       
	 
    private mobileTotalLastWeek: number;
    public get MobileTotalLastWeek() { return this.mobileTotalLastWeek; }
    public set MobileTotalLastWeek(newValue: number) { if (this.mobileTotalLastWeek != newValue) { this.mobileTotalLastWeek = newValue; this.MarkAsDirty("MobileTotalLastWeek"); } }
       
	 
    private mobileTotalLastMonth: number;
    public get MobileTotalLastMonth() { return this.mobileTotalLastMonth; }
    public set MobileTotalLastMonth(newValue: number) { if (this.mobileTotalLastMonth != newValue) { this.mobileTotalLastMonth = newValue; this.MarkAsDirty("MobileTotalLastMonth"); } }
       
	 
    private shardLogisticLastDate: Date;
    public get ShardLogisticLastDate() { return this.shardLogisticLastDate; }
    public set ShardLogisticLastDate(newValue: Date) { if (this.shardLogisticLastDate != newValue) { this.shardLogisticLastDate = newValue; this.MarkAsDirty("ShardLogisticLastDate"); } }
       
	 
    private shardLogisticTotalLastWeek: number;
    public get ShardLogisticTotalLastWeek() { return this.shardLogisticTotalLastWeek; }
    public set ShardLogisticTotalLastWeek(newValue: number) { if (this.shardLogisticTotalLastWeek != newValue) { this.shardLogisticTotalLastWeek = newValue; this.MarkAsDirty("ShardLogisticTotalLastWeek"); } }
       
	 
    private shardLogisticTotalLastMonth: number;
    public get ShardLogisticTotalLastMonth() { return this.shardLogisticTotalLastMonth; }
    public set ShardLogisticTotalLastMonth(newValue: number) { if (this.shardLogisticTotalLastMonth != newValue) { this.shardLogisticTotalLastMonth = newValue; this.MarkAsDirty("ShardLogisticTotalLastMonth"); } }
    ...
    public get BluesnapCRMContractId() { return this.bluesnapCRMContractId; }
    public set BluesnapCRMContractId(newValue: string) { if (this.bluesnapCRMContractId != newValue) { this.bluesnapCRMContractId = newValue; this.MarkAsDirty("BluesnapCRMContractId"); } }
       
	 
    private bluesnapEAWBContractId: string;
    public get BluesnapEAWBContractId() { return this.bluesnapEAWBContractId; }
    public set BluesnapEAWBContractId(newValue: string) { if (this.bluesnapEAWBContractId != newValue) { this.bluesnapEAWBContractId = newValue; this.MarkAsDirty("BluesnapEAWBContractId"); } }
       
	 
    private bluesnapEAWBSContractId: string;
    public get BluesnapEAWBSContractId() { return this.bluesnapEAWBSContractId; }
    ...
    private pIMA: string;
    public get PIMA() { return this.pIMA; }
    public set PIMA(newValue: string) { if (this.pIMA != newValue) { this.pIMA = newValue; this.MarkAsDirty("PIMA"); } }
       
	 
    private activityLastDate: Date;
    public get ActivityLastDate() { return this.activityLastDate; }
    public set ActivityLastDate(newValue: Date) { if (this.activityLastDate != newValue) { this.activityLastDate = newValue; this.MarkAsDirty("ActivityLastDate"); } }
       
	 
    private activityTotalLastWeek: number;
    public get ActivityTotalLastWeek() { return this.activityTotalLastWeek; }
    public set ActivityTotalLastWeek(newValue: number) { if (this.activityTotalLastWeek != newValue) { this.activityTotalLastWeek = newValue; this.MarkAsDirty("ActivityTotalLastWeek"); } }
       
	 
    private activityTotalLastMonth: number;
    public get ActivityTotalLastMonth() { return this.activityTotalLastMonth; }
    public set ActivityTotalLastMonth(newValue: number) { if (this.activityTotalLastMonth != newValue) { this.activityTotalLastMonth = newValue; this.MarkAsDirty("ActivityTotalLastMonth"); } }
       
	 
    private opportunityLastDate: Date;
    public get OpportunityLastDate() { return this.opportunityLastDate; }
    public set OpportunityLastDate(newValue: Date) { if (this.opportunityLastDate != newValue) { this.opportunityLastDate = newValue; this.MarkAsDirty("OpportunityLastDate"); } }
       
	 
    private opportunityTotalLastWeek: number;
    public get OpportunityTotalLastWeek() { return this.opportunityTotalLastWeek; }
    public set OpportunityTotalLastWeek(newValue: number) { if (this.opportunityTotalLastWeek != newValue) { this.opportunityTotalLastWeek = newValue; this.MarkAsDirty("OpportunityTotalLastWeek"); } }
       
	 
    private opportunityTotalLastMonth: number;
    public get OpportunityTotalLastMonth() { return this.opportunityTotalLastMonth; }
    public set OpportunityTotalLastMonth(newValue: number) { if (this.opportunityTotalLastMonth != newValue) { this.opportunityTotalLastMonth = newValue; this.MarkAsDirty("OpportunityTotalLastMonth"); } }
       
	 
    private manageLicencesPerUser: boolean;
    public get ManageLicencesPerUser() { return this.manageLicencesPerUser; }
    public set ManageLicencesPerUser(newValue: boolean) { if (this.manageLicencesPerUser != newValue) { this.manageLicencesPerUser = newValue; this.MarkAsDirty("ManageLicencesPerUser"); } }
       
	 
    private isSystemSupportEnabled: boolean;
    public get IsSystemSupportEnabled() { return this.isSystemSupportEnabled; }
    public set IsSystemSupportEnabled(newValue: boolean) { if (this.isSystemSupportEnabled != newValue) { this.isSystemSupportEnabled = newValue; this.MarkAsDirty("IsSystemSupportEnabled"); } }
       
	 
    private isDistributorSupportEnabled: boolean;
    public get IsDistributorSupportEnabled() { return this.isDistributorSupportEnabled; }
    public set IsDistributorSupportEnabled(newValue: boolean) { if (this.isDistributorSupportEnabled != newValue) { this.isDistributorSupportEnabled = newValue; this.MarkAsDirty("IsDistributorSupportEnabled"); } }
       
	 
    private doBlocking: boolean;
    public get DoBlocking() { return this.doBlocking; }
    public set DoBlocking(newValue: boolean) { if (this.doBlocking != newValue) { this.doBlocking = newValue; this.MarkAsDirty("DoBlocking"); } }
       
	 
    private trailDaysLeft: number;
    public get TrailDaysLeft() { return this.trailDaysLeft; }
    public set TrailDaysLeft(newValue: number) { if (this.trailDaysLeft != newValue) { this.trailDaysLeft = newValue; this.MarkAsDirty("TrailDaysLeft"); } }
       
	 
    private paidDaysLeft: number;
    public get PaidDaysLeft() { return this.paidDaysLeft; }
    public set PaidDaysLeft(newValue: number) { if (this.paidDaysLeft != newValue) { this.paidDaysLeft = newValue; this.MarkAsDirty("PaidDaysLeft"); } }
       
	 
    private isTrial: boolean;
    public get IsTrial() { return this.isTrial; }
    public set IsTrial(newValue: boolean) { if (this.isTrial != newValue) { this.isTrial = newValue; this.MarkAsDirty("IsTrial"); } }
    ...
    public get IsCargonautEnabled() { return this.isCargonautEnabled; }
    public set IsCargonautEnabled(newValue: boolean) { if (this.isCargonautEnabled != newValue) { this.isCargonautEnabled = newValue; this.MarkAsDirty("IsCargonautEnabled"); } }
       
	 
    private bluesnapContractQTY: number;
    public get BluesnapContractQTY() { return this.bluesnapContractQTY; }
    public set BluesnapContractQTY(newValue: number) { if (this.bluesnapContractQTY != newValue) { this.bluesnapContractQTY = newValue; this.MarkAsDirty("BluesnapContractQTY"); } }
       
	 
    private bluesnapCRMContractQTY: number;
    public get BluesnapCRMContractQTY() { return this.bluesnapCRMContractQTY; }
    public set BluesnapCRMContractQTY(newValue: number) { if (this.bluesnapCRMContractQTY != newValue) { this.bluesnapCRMContractQTY = newValue; this.MarkAsDirty("BluesnapCRMContractQTY"); } }
       
	 
    private bluesnapEAWBContractQTY: number;
    public get BluesnapEAWBContractQTY() { return this.bluesnapEAWBContractQTY; }
    public set BluesnapEAWBContractQTY(newValue: number) { if (this.bluesnapEAWBContractQTY != newValue) { this.bluesnapEAWBContractQTY = newValue; this.MarkAsDirty("BluesnapEAWBContractQTY"); } }
       
	 
    private bluesnapEAWBSContractQTY: number;
    public get BluesnapEAWBSContractQTY() { return this.bluesnapEAWBSContractQTY; }
    public set BluesnapEAWBSContractQTY(newValue: number) { if (this.bluesnapEAWBSContractQTY != newValue) { this.bluesnapEAWBSContractQTY = newValue; this.MarkAsDirty("BluesnapEAWBSContractQTY"); } }
    ...
    public get IsDEXXConnectionEnabled() { return this.isDEXXConnectionEnabled; }
    public set IsDEXXConnectionEnabled(newValue: boolean) { if (this.isDEXXConnectionEnabled != newValue) { this.isDEXXConnectionEnabled = newValue; this.MarkAsDirty("IsDEXXConnectionEnabled"); } }
       
	 
    private lastFWBCargonautSentDate: Date;
    public get LastFWBCargonautSentDate() { return this.lastFWBCargonautSentDate; }
    public set LastFWBCargonautSentDate(newValue: Date) { if (this.lastFWBCargonautSentDate != newValue) { this.lastFWBCargonautSentDate = newValue; this.MarkAsDirty("LastFWBCargonautSentDate"); } }
       
	 
    private lastFHLCargonautSentDate: Date;
    public get LastFHLCargonautSentDate() { return this.lastFHLCargonautSentDate; }
    public set LastFHLCargonautSentDate(newValue: Date) { if (this.lastFHLCargonautSentDate != newValue) { this.lastFHLCargonautSentDate = newValue; this.MarkAsDirty("LastFHLCargonautSentDate"); } }
       
	 
    private suspendDaysLeft: number;
    public get SuspendDaysLeft() { return this.suspendDaysLeft; }
    public set SuspendDaysLeft(newValue: number) { if (this.suspendDaysLeft != newValue) { this.suspendDaysLeft = newValue; this.MarkAsDirty("SuspendDaysLeft"); } }
       
	 
    private isEAWBOnlyDemo: boolean;
    public get IsEAWBOnlyDemo() { return this.isEAWBOnlyDemo; }
    public set IsEAWBOnlyDemo(newValue: boolean) { if (this.isEAWBOnlyDemo != newValue) { this.isEAWBOnlyDemo = newValue; this.MarkAsDirty("IsEAWBOnlyDemo"); } }
       
	 
    private isRestrictedByAirline: boolean;
    public get IsRestrictedByAirline() { return this.isRestrictedByAirline; }
    public set IsRestrictedByAirline(newValue: boolean) { if (this.isRestrictedByAirline != newValue) { this.isRestrictedByAirline = newValue; this.MarkAsDirty("IsRestrictedByAirline"); } }
       
	 
    private lastFFRSentDate: Date;
    public get LastFFRSentDate() { return this.lastFFRSentDate; }
    public set LastFFRSentDate(newValue: Date) { if (this.lastFFRSentDate != newValue) { this.lastFFRSentDate = newValue; this.MarkAsDirty("LastFFRSentDate"); } }
       
	 
    private managesRegisteredAgent: boolean;
    public get ManagesRegisteredAgent() { return this.managesRegisteredAgent; }
    public set ManagesRegisteredAgent(newValue: boolean) { if (this.managesRegisteredAgent != newValue) { this.managesRegisteredAgent = newValue; this.MarkAsDirty("ManagesRegisteredAgent"); } }
       
	 
    private fSULastReceivedDate: Date;
    public get FSULastReceivedDate() { return this.fSULastReceivedDate; }
    public set FSULastReceivedDate(newValue: Date) { if (this.fSULastReceivedDate != newValue) { this.fSULastReceivedDate = newValue; this.MarkAsDirty("FSULastReceivedDate"); } }
       
	 
    private fSALastReceivedDate: Date;
    public get FSALastReceivedDate() { return this.fSALastReceivedDate; }
    public set FSALastReceivedDate(newValue: Date) { if (this.fSALastReceivedDate != newValue) { this.fSALastReceivedDate = newValue; this.MarkAsDirty("FSALastReceivedDate"); } }
       
	 
    private fSRLastSentDate: Date;
    public get FSRLastSentDate() { return this.fSRLastSentDate; }
    public set FSRLastSentDate(newValue: Date) { if (this.fSRLastSentDate != newValue) { this.fSRLastSentDate = newValue; this.MarkAsDirty("FSRLastSentDate"); } }
       
	 
    private silverlightEndDate: Date;
    public get SilverlightEndDate() { return this.silverlightEndDate; }
    public set SilverlightEndDate(newValue: Date) { if (this.silverlightEndDate != newValue) { this.silverlightEndDate = newValue; this.MarkAsDirty("SilverlightEndDate"); } }
       
	 
    private billingByLogitude: boolean;
    public get BillingByLogitude() { return this.billingByLogitude; }
    public set BillingByLogitude(newValue: boolean) { if (this.billingByLogitude != newValue) { this.billingByLogitude = newValue; this.MarkAsDirty("BillingByLogitude"); } }
       
	 
    private resellerCommission: number;
    public get ResellerCommission() { return this.resellerCommission; }
    public set ResellerCommission(newValue: number) { if (this.resellerCommission != newValue) { this.resellerCommission = newValue; this.MarkAsDirty("ResellerCommission"); } }
       
	 
    private tenantTypeCode: string;
    public get TenantTypeCode() { return this.tenantTypeCode; }
    public set TenantTypeCode(newValue: string) { if (this.tenantTypeCode != newValue) { this.tenantTypeCode = newValue; this.MarkAsDirty("TenantTypeCode"); } }
       
	 
    private tenantConnectedToAirlineCode: string;
    public get TenantConnectedToAirlineCode() { return this.tenantConnectedToAirlineCode; }
    public set TenantConnectedToAirlineCode(newValue: string) { if (this.tenantConnectedToAirlineCode != newValue) { this.tenantConnectedToAirlineCode = newValue; this.MarkAsDirty("TenantConnectedToAirlineCode"); } }
       
	 
    private signupRequestRecipients: string;
    public get SignupRequestRecipients() { return this.signupRequestRecipients; }
    public set SignupRequestRecipients(newValue: string) { if (this.signupRequestRecipients != newValue) { this.signupRequestRecipients = newValue; this.MarkAsDirty("SignupRequestRecipients"); } }
       
	 
    private loginPageNotes: string;
    public get LoginPageNotes() { return this.loginPageNotes; }
    public set LoginPageNotes(newValue: string) { if (this.loginPageNotes != newValue) { this.loginPageNotes = newValue; this.MarkAsDirty("LoginPageNotes"); } }
    ...
    public get SupportActivated() { return this.supportActivated; }
    public set SupportActivated(newValue: boolean) { if (this.supportActivated != newValue) { this.supportActivated = newValue; this.MarkAsDirty("SupportActivated"); } }
       
	 
    private isMultiPackage: boolean;
    public get IsMultiPackage() { return this.isMultiPackage; }
    public set IsMultiPackage(newValue: boolean) { if (this.isMultiPackage != newValue) { this.isMultiPackage = newValue; this.MarkAsDirty("IsMultiPackage"); } }
       
	 
    private technology: string;
    public get Technology() { return this.technology; }
    public set Technology(newValue: string) { if (this.technology != newValue) { this.technology = newValue; this.MarkAsDirty("Technology"); } }
    ...
    public get HideSharedlogistics() { return this.hideSharedlogistics; }
    public set HideSharedlogistics(newValue: boolean) { if (this.hideSharedlogistics != newValue) { this.hideSharedlogistics = newValue; this.MarkAsDirty("HideSharedlogistics"); } }
    ...
    public get IsParentTenant() { return this.isParentTenant; }
    public set IsParentTenant(newValue: boolean) { if (this.isParentTenant != newValue) { this.isParentTenant = newValue; this.MarkAsDirty("IsParentTenant"); } }
       
	 
    private parentTenantId: number;
    public get ParentTenantId() { return this.parentTenantId; }
    ...
    public get ChangeHeaderColor() { return this.changeHeaderColor; }
    ...
    public get GlobalTenant() { return this.globalTenant; }
    public set GlobalTenant(newValue: string) { if (this.globalTenant != newValue) { this.globalTenant = newValue; this.MarkAsDirty("GlobalTenant"); } }
