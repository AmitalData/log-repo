...
export class ApiCredintialsPM {
    ...
    public get UsedFor() { return this.usedFor; }
    public set UsedFor(newValue: string) { if (this.usedFor != newValue) { this.usedFor = newValue; this.MarkAsDirty("UsedFor"); } }
       
	 
    private hashedPrimaryAccessKey: string;
    public get HashedPrimaryAccessKey() { return this.hashedPrimaryAccessKey; }
    public set HashedPrimaryAccessKey(newValue: string) { if (this.hashedPrimaryAccessKey != newValue) { this.hashedPrimaryAccessKey = newValue; this.MarkAsDirty("HashedPrimaryAccessKey"); } }
       
	 
    private hashedSeconderyAccessKey: string;
    public get HashedSeconderyAccessKey() { return this.hashedSeconderyAccessKey; }
    public set HashedSeconderyAccessKey(newValue: string) { if (this.hashedSeconderyAccessKey != newValue) { this.hashedSeconderyAccessKey = newValue; this.MarkAsDirty("HashedSeconderyAccessKey"); } }
    ...
    public get MaskedPrimaryAccessKey() { return this.maskedPrimaryAccessKey; }
    public set MaskedPrimaryAccessKey(newValue: string) { if (this.maskedPrimaryAccessKey != newValue) { this.maskedPrimaryAccessKey = newValue; this.MarkAsDirty("MaskedPrimaryAccessKey"); } }
       
	 
    private maskedSeconderyAccessKey: string;
    public get MaskedSeconderyAccessKey() { return this.maskedSeconderyAccessKey; }
