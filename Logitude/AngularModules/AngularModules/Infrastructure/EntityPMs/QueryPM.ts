...
export class QueryPM {
    ...
    public get NameTextCodeId() { return this.nameTextCodeId; }
    public set NameTextCodeId(newValue: string) { this.nameTextCodeId = newValue; }

    private nameTextCodeCode: string;
    public get NameTextCodeCode() { return this.nameTextCodeCode; }
    public set NameTextCodeCode(newValue: string) { this.nameTextCodeCode = newValue; }

    private defaultSortDirection: string;
    public get DefaultSortDirection() { return this.defaultSortDirection; }
    public set DefaultSortDirection(newValue: string) { this.defaultSortDirection = newValue; }

    private defaultSortColumn: string;
    public get DefaultSortColumn() { return this.defaultSortColumn; }
    public set DefaultSortColumn(newValue: string) { this.defaultSortColumn = newValue; }

    private spotlightDataTemplate: string;
    public get SpotlightDataTemplate() { return this.spotlightDataTemplate; }
    public set SpotlightDataTemplate(newValue: string) { this.spotlightDataTemplate = newValue; }

    private internal: boolean;
    public get Internal() { return this.internal; }
    public set Internal(newValue: boolean) { this.internal = newValue; }

    private customer: boolean;
    public get Customer() { return this.customer; }
    public set Customer(newValue: boolean) { this.customer = newValue; }

    private agent: boolean;
    public get Agent() { return this.agent; }
    public set Agent(newValue: boolean) { this.agent = newValue; }

    private isHiddenFromView: boolean;
    public get IsHiddenFromView() { return this.isHiddenFromView; }
    public set IsHiddenFromView(newValue: boolean) { this.isHiddenFromView = newValue; }

    private isNewFromTenantZeroOnly: boolean;
    public get IsNewFromTenantZeroOnly() { return this.isNewFromTenantZeroOnly; }
    public set IsNewFromTenantZeroOnly(newValue: boolean) { this.isNewFromTenantZeroOnly = newValue; }
    ...
    public get EditWizardName() { return this.editWizardName; }
    public set EditWizardName(newValue: string) { this.editWizardName = newValue; }

    private perspective: string;
    public get Perspective() { return this.perspective; }
    public set Perspective(newValue: string) { this.perspective = newValue; }

    private newViewName: string;
    public get NewViewName() { return this.newViewName; }
    public set NewViewName(newValue: string) { this.newViewName = newValue; } 

    private displayAsCustom: boolean;
    public get DisplayAsCustom() { return this.displayAsCustom; }
    public set DisplayAsCustom(newValue: boolean) { this.displayAsCustom = newValue; } 

    private isDummy: boolean;
    public get IsDummy() { return this.isDummy; }
    public set IsDummy(newValue: boolean) { this.isDummy = newValue; } 
