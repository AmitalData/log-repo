...
export class WebhookKeysPM {
    ...
    public get AccessKey() { return this.accessKey; }
    public set AccessKey(newValue: string) { if (this.accessKey != newValue) { this.accessKey = newValue; this.MarkAsDirty("AccessKey"); } }
