...
export class EventTypePM {
    ...
    public get EventGroupCode() { return this.eventGroupCode; }
    public set EventGroupCode(newValue: string) { if (this.eventGroupCode != newValue) { this.eventGroupCode = newValue; this.MarkAsDirty("EventGroupCode"); } }
    ...
    public get IsFollowUp() { return this.isFollowUp; }
    public set IsFollowUp(newValue: boolean) { if (this.isFollowUp != newValue) { this.isFollowUp = newValue; this.MarkAsDirty("IsFollowUp"); } }
       
	 
    private followUpEnglishName: string;
    public get FollowUpEnglishName() { return this.followUpEnglishName; }
    public set FollowUpEnglishName(newValue: string) { if (this.followUpEnglishName != newValue) { this.followUpEnglishName = newValue; this.MarkAsDirty("FollowUpEnglishName"); } }
       
	 
    private followUpLocalName: string;
    public get FollowUpLocalName() { return this.followUpLocalName; }
    public set FollowUpLocalName(newValue: string) { if (this.followUpLocalName != newValue) { this.followUpLocalName = newValue; this.MarkAsDirty("FollowUpLocalName"); } }
    ...
    public get IsSharedLogisticsEnabled() { return this.isSharedLogisticsEnabled; }
    public set IsSharedLogisticsEnabled(newValue: boolean) { if (this.isSharedLogisticsEnabled != newValue) { this.isSharedLogisticsEnabled = newValue; this.MarkAsDirty("IsSharedLogisticsEnabled"); } }
    ...
    public get AllowedInAutomation() { return this.allowedInAutomation; }
