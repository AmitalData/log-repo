...
export class WorkerRoleNamePM {
    ...
    private waitingStatus: number;
    public get WaitingStatus() { return this.waitingStatus; }
    public set WaitingStatus(newValue: number) { if (this.waitingStatus != newValue) { this.waitingStatus = newValue; this.MarkAsDirty("WaitingStatus"); } }
