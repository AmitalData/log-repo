...
export class BatchTaskExecutionPM {
    ...
    public set ClassName(newValue: string) { if (this.className != newValue) { this.className = newValue; this.MarkAsDirty("ClassName"); } }
       
	 
    private prametersXml: string;
    public get PrametersXml() { return this.prametersXml; }
    public set PrametersXml(newValue: string) { if (this.prametersXml != newValue) { this.prametersXml = newValue; this.MarkAsDirty("PrametersXml"); } }
    ...
    public set DoneDateTime(newValue: Date) { if (this.doneDateTime != newValue) { this.doneDateTime = newValue; this.MarkAsDirty("DoneDateTime"); } }
       
	 
    private progressMessage: string;
    public get ProgressMessage() { return this.progressMessage; }
    public set ProgressMessage(newValue: string) { if (this.progressMessage != newValue) { this.progressMessage = newValue; this.MarkAsDirty("ProgressMessage"); } }
       
	 
    private progressPercentage: number;
    public get ProgressPercentage() { return this.progressPercentage; }
    public set ProgressPercentage(newValue: number) { if (this.progressPercentage != newValue) { this.progressPercentage = newValue; this.MarkAsDirty("ProgressPercentage"); } }
