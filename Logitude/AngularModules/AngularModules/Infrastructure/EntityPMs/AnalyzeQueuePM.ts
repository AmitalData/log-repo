...
export class AnalyzeQueuePM {
    ...
    public get ConnectedToTenant() { return this.connectedToTenant; }
    public set ConnectedToTenant(newValue: boolean) { if (this.connectedToTenant != newValue) { this.connectedToTenant = newValue; this.MarkAsDirty("ConnectedToTenant"); } }
       
	 
    private connectedToEntity: boolean;
    public get ConnectedToEntity() { return this.connectedToEntity; }
    public set ConnectedToEntity(newValue: boolean) { if (this.connectedToEntity != newValue) { this.connectedToEntity = newValue; this.MarkAsDirty("ConnectedToEntity"); } }
    ...
    public get MessageBodyString() { return this.messageBodyString; }
    public set MessageBodyString(newValue: string) { if (this.messageBodyString != newValue) { this.messageBodyString = newValue; this.MarkAsDirty("MessageBodyString"); } }
    ...
    public get StackTrace() { return this.stackTrace; }
    public set StackTrace(newValue: string) { if (this.stackTrace != newValue) { this.stackTrace = newValue; this.MarkAsDirty("StackTrace"); } }
    ...
    public get AckReason() { return this.ackReason; }
    public set AckReason(newValue: string) { if (this.ackReason != newValue) { this.ackReason = newValue; this.MarkAsDirty("AckReason"); } }
    ...
    public get AnalyzeQueueStatus() { return this.analyzeQueueStatus; }
    public set AnalyzeQueueStatus(newValue: string) { if (this.analyzeQueueStatus != newValue) { this.analyzeQueueStatus = newValue; this.MarkAsDirty("AnalyzeQueueStatus"); } }
       
	 
    private tenantManagement: string;
    public get TenantManagement() { return this.tenantManagement; }
    public set TenantManagement(newValue: string) { if (this.tenantManagement != newValue) { this.tenantManagement = newValue; this.MarkAsDirty("TenantManagement"); } }
