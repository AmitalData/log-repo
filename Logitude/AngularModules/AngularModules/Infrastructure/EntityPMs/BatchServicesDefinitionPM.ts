...
export class BatchServicesDefinitionPM {
    ...
    public get NumberOfThreads() { return this.numberOfThreads; }
    public set NumberOfThreads(newValue: number) { if (this.numberOfThreads != newValue) { this.numberOfThreads = newValue; this.MarkAsDirty("NumberOfThreads"); } }
