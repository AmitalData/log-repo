    ...
    public static Get(name: string) {
        ...
        switch (name) {
            ...
            case 'DSVLoginProcessComponent': {
                myResult = DSVLoginProcessComponent;
                break;
            }
            case 'DSVMobileLoginProcessComponent': {
                myResult = DSVMobileLoginProcessComponent;
                break;
            }
            case 'BlockScreenComponent': {
                myResult = BlockScreenComponent;
                break;
            }
            case 'HomeComponent': {
                myResult = HomeComponent;
                break;
            }
            case 'NewChargifyAWBStockComponent': {
                myResult = NewChargifyAWBStockComponent;
                break;
            }
            case 'SessionComponent': {
                myResult = SessionComponent;
                break;
            }
            case 'MainMenuComponent': {
                myResult = MainMenuComponent;
                break;
            }
            case 'EditComponent': {
                myResult = EditComponent;
                break;
            }
            case 'EditTabComponent': {
                myResult = EditTabComponent;
                break;
            }
            case 'ListComponent': {
                myResult = ListComponent;
                break;
            }
            case 'MaintenanceComponent': {
                myResult = MaintenanceComponent;
                break;
            }
            case 'MenuButtonsComponent': {
                myResult = MenuButtonsComponent;
                break;
            }
            case 'MenuButtonsComponentLoader': {
                myResult = MenuButtonsComponentLoader;
                break;
            }
            case 'AdvanceSearchComponent': {
                myResult = AdvanceSearchComponent;
                break;
            }
            case 'QueryListComponent': {
                myResult = QueryListComponent;
                break;
            }
            case 'LogitudeListBoxComponent': {
                myResult = LogitudeListBoxComponent;
                break;
            }
            case 'GeneralTabComponent': {
                myResult = GeneralTabComponent;
                break;
            }
            case 'GeneratedComponent': {
                myResult = GeneratedComponent;
                break;
            }

            case 'ImageComponent': {
                myResult = ImageComponent;
                break;
            }
            case 'TextDesignComponent': {
                myResult = TextDesignComponent;
                break;
            }

            case 'MainMenuAutomationComponent': {
                myResult = MainMenuAutomationComponent;
                break;
            }
            case 'AutomationsSettingsComponent': {
                myResult = AutomationsSettingsComponent;
                break;
            }
            case 'AddEditAutomationsComponent': {
                myResult = AddEditAutomationsComponent;
                break;
            }
            case 'ChooseSpecificUserComponent': {
                myResult = ChooseSpecificUserComponent;
                break;
            }
            case 'DelayAutomationconditionsComponent': {
                myResult = DelayAutomationconditionsComponent;
                break;
            }
            case 'ViewAutomationHistoryComponent': {
                myResult = ViewAutomationHistoryComponent;
                break;
            }
            case 'AutomationConditionsDetailsComponent': {
                myResult = AutomationConditionsDetailsComponent;
                break;
            }
            case 'OnUpdateDocumentAutomationsSettingsComponent': {
                myResult = OnUpdateDocumentAutomationsSettingsComponent;
                break;
            }
            case 'DocumentAttachmentsComponent': {
                myResult = DocumentAttachmentsComponent;
                break;
            }

            case 'NewViewComponent': {
                myResult = NewViewComponent;
                break;
            }
            case 'Export2ExcelControl': {
                myResult = Export2ExcelControl;
                break;
            }
            case 'ExportBI2ExcelControl': {
                myResult = ExportBI2ExcelControl;
                break;
            }
            case 'QueryColumnsEditComponent': {
                myResult = QueryColumnsEditComponent;
                break;
            }
            case 'btnComponent': {
                myResult = btnComponent;
                break;
            }
            case 'btnUpdateComponent': {
                myResult = btnUpdateComponent;
                break;
            }
            case 'ToComponent': {
                myResult = ToComponent;
                break;
            }
            case 'DWLogSearchAddFieldsComponent': {
                myResult = DWLogSearchAddFieldsComponent;
                break;
            }

            case 'NewEntityComponent': {
                myResult = NewEntityComponent;
                break;
            }
            case 'LogSearchWindowComponent': {
                myResult = LogSearchWindowComponent;
                break;
            }
            case 'DWLogSearchWindowComponent': {
                myResult = DWLogSearchWindowComponent;
                break;
            }
            case 'StimulsoftViewerComponent': {
                myResult = StimulsoftViewerComponent;
                break;
            }
            case 'TipsComponent': {
                myResult = TipsComponent;
                break;
            }
            case 'CacheLogComponent': {
                myResult = CacheLogComponent;
                break;
            }
            case 'ChooseUserComponent': {
                myResult = ChooseUserComponent;
                break;
            }

            case 'ChooseDatesComponent': {
                myResult = ChooseDatesComponent;
                break;
            }
            case 'InfrastructureFieldTemplateComponent': {
                myResult = InfrastructureFieldTemplateComponent;
                break;
            }

            case 'GeneralSendComponent': {
                myResult = GeneralSendComponent;
                break;
            }
            case 'LogSearchWindowButtonsComponent': {
                myResult = LogSearchWindowButtonsComponent;
                break;
            }
            case 'DWLogSearchWindowFieldsComponent': {
                myResult = DWLogSearchWindowFieldsComponent;
                break;
            }
            case 'AddFollowupComponent': {
                myResult = AddFollowupComponent;
                break;
            }
            case 'AddDocumentFollowupComponent': {
                myResult = AddDocumentFollowupComponent;
                break;
            }
            case 'DropBoxLogin': {
                myResult = DropBoxLogin;
                break;
            }
            case 'StimulsoftDesigner': {
                myResult = StimulsoftDesigner;
                break;
            }

            case 'ObjectFieldComponent': {
                myResult = ObjectFieldComponent;
                break;
            }
            case 'ExportSettingAdvanceComponent': {
                myResult = ExportSettingAdvanceComponent;
                break;
            }
            case 'AuditAutomationTabComponent': {
                myResult = AuditAutomationTabComponent;
                break;
            }
            case 'SocialComponent': {
                myResult = SocialComponent;
                break;
            }
            case 'LogTabsComponent': {
                myResult = LogTabsComponent;
                break;
            }
            case 'LogWaterMarkComponent': {
                myResult = LogWaterMarkComponent;
                break;
            }

            case 'EntityFollowComponent': {
                myResult = EntityFollowComponent;
                break;
            }
            case 'WizardBaseComponent': {
                myResult = WizardBaseComponent;
                break;
            }
            case 'WizardAddressCompnent': {
                myResult = WizardAddressCompnent;
                break;
            }
            case 'WizardAccountingComponent': {
                myResult = WizardAccountingComponent;
                break;
            }
            case 'SelectDocumentTypesComponent': {
                myResult = SelectDocumentTypesComponent;
                break;
            }
            case 'StimulsoftDesignerComponent': {
                myResult = StimulsoftDesignerComponent;
                break;
            }
            case 'AutomationsConditionAreaComponent': {
                myResult = AutomationsConditionAreaComponent;
                break;
            }
            case 'AutomationsConditionAreaComponent': {
                myResult = AutomationsConditionsViewDetailsComponent;
                break;
            }

            case 'EraseTenantManagementDataComponent': {
                myResult = EraseTenantManagementDataComponent;
                break;
            }

            case 'FroalaEditorComponent': {
                myResult = FroalaEditorComponent;
                break;
            }
            case 'DocsInTabComponent': {
                myResult = DocsInTabComponent;
                break;
            }
            case 'DocsOutTabComponent': {
                myResult = DocsOutTabComponent;
                break;
            }
            case 'BTEGeneralTabComponent': {
                myResult = BTEGeneralTabComponent;
                break;
            }
            case 'BTELogTabComponent': {
                myResult = BTELogTabComponent;
                break;
            }
            case 'BTEParameterTabComponent': {
                myResult = BTEParameterTabComponent;
                break;
            }
            case 'LastSuccessfulLoginComponent': {
                myResult = LastSuccessfulLoginComponent;
                break;
            }
            case 'MultilineTextBoxWindow': {
                myResult = MultilineTextBoxWindow;
                break;
            }
            case 'ImageLibraryComponent': {
                myResult = ImageLibraryComponent;
                break;
            }
            case 'FTBSchedulerTemplateComponent': {
                myResult = FTBSchedulerTemplateComponent;
                break;
            }
            case 'SendInterfaceResultComponent': {
                myResult = SendInterfaceResultComponent;
                break;
            }
            case 'FTPAutomationDetailsComponent': {
                myResult = FTPAutomationDetailsComponent;
                break;
            }
            case 'SendDocumentResultComponent': {
                myResult = SendDocumentResultComponent;
                break;
            }
            case 'PrivateLabelLoginProcessComponent': {
                myResult = PrivateLabelLoginProcessComponent;
                break;
            }
            case 'CreateTaskResultComponent': {
                myResult = CreateTaskResultComponent;
                break;
            }
            case 'AdvancedAutomationSendInterfaceDetailsComponent': {
                myResult = AdvancedAutomationSendInterfaceDetailsComponent;
                break;
            }
            case 'WebHookAutomationDetailsComponent': {
                myResult = WebHookAutomationDetailsComponent;
                break;
            }
            case 'EventCreationResultComponent': {
                myResult = EventCreationResultComponent;
                break;
            }
            case 'OnUpdateDocumentResultComponent': {
                myResult = OnUpdateDocumentResultComponent;
                break;
            }

            case 'MultiUpdateComponent': {
                myResult = MultiUpdateComponent;
                break;
            }
            case 'MultiEntityUpdateBaseComponent': {
                myResult = MultiEntityUpdateBaseComponent;
                break;
            }
            case 'MultiEntityUpdateErrorHandlerComponent': {
                myResult = MultiEntityUpdateErrorHandlerComponent;
                break;
            }
            case 'MultiUpdateCheckTemplate': {
                myResult = MultiUpdateCheckTemplate;
                break;
            }
            case 'MultiUpdateCheckBoxComponent': {
                myResult = MultiUpdateCheckBoxComponent;
                break;
            }
            case 'MultiPrintMainComponent': {
                myResult = MultiPrintMainComponent;
                break;
            }
            case 'PrintComponent': {
                myResult = PrintComponent;
                break;
            }
            case 'MultiPrintErrorHandlerComponent': {
                myResult = MultiPrintErrorHandlerComponent;
                break;
            }
            case 'MultiPrintCheckBoxComponent': {
                myResult = MultiPrintCheckBoxComponent;
                break;
            }
            case 'MultiPrintCheckTemplate': {
                myResult = MultiPrintCheckTemplate;
                break;
            }
            case 'GridScreenSectionComponent': {
                myResult = GridScreenSectionComponent;
                break;
            }
            case 'AddEditChildEntityComponent': {
                myResult = AddEditChildEntityComponent;
                break;
            }
