...
export class DynamicLoader {
    ...
    private static GetModuleLoaderPath(moduleName: string) {
        ...
        switch (moduleName) {
            ...
            case "CRMModules/CRMActivity": { myResult = "CRMModules/CRMActivity/ModuleCRMActivity#ModuleCRMActivity"; break; }
            case "CRMModules/CRMEmployeeGroup": { myResult = "CRMModules/CRMEmployeeGroup/ModuleCRMEmployeeGroup#ModuleCRMEmployeeGroup"; break; }
            case "CRMModules/InboundEmail": { myResult = "CRMModules/InboundEmail/ModuleCRMInboundEmail#ModuleCRMInboundEmail"; break; }
            case "CRMModules/CRMOpportunity": { myResult = "CRMModules/CRMOpportunity/ModuleCRMOpportunity#ModuleCRMOpportunity"; break; }
