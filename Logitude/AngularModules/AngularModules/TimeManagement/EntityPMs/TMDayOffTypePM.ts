...
export class TMDayOffTypePM {
    ...
    public OldEntityPM: TMDayOffTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TMDayOffType");
           
        }
    }

    private MyClone: TMDayOffTypePM;
