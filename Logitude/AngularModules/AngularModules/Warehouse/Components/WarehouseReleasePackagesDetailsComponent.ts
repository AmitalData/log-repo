...
//            }
//            // ShipmentPackages
//            if (warehouseReleasePM.WarehouseEntryPackages.length == 0) {
...
//            else {
//                warehouseReleasePM.WarehouseEntryPackages.forEach((item) => {
//                    if (item.Volume) {
...
//        if (this.warehouseReleasePM && this.warehouseReleasePM.TotalGrossWeight) totalGrossWeight = this.warehouseReleasePM.TotalGrossWeight;
