...
export class WarehouseEntryFiltersMenuComponent implements AfterViewInit {
    ...
    constructor() {
        if (SessionLocator.CurrentSession == null) {
            ...
            var index_T = SessionLocator.CurrentSession.GetNewId("WarehouseEntryTransportFilterMenu");
            var index_D = SessionLocator.CurrentSession.GetNewId("WarehouseEntryDirectionFilterMenu");
