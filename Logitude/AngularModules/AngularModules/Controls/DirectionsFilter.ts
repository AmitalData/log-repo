...
@Component({
    ...
    inputs: ['SelectedValue','HideCustomsImport'],
    ...
    <ul class="FiltersMenu" [style.width.px]="DirectionWidth" style="display:block">
        ...
        <li (click)="itemClicked('I')" (mouseover)="itemMouseOver('I')" (mouseleave)="itemMouseLeave('I')" [class.SelectedFilter]="SelectedValue === 'I'" title="Import">
        ...
        <li (click)="itemClicked('D')" (mouseover)="itemMouseOver('D')" (mouseleave)="itemMouseLeave('D')" [class.SelectedFilter]="SelectedValue === 'D'" title="Domestic">
        ...
        <li *ngIf="itmImportShipments" (click)="itemClicked('C')" (mouseover)="itemMouseOver('C')" (mouseleave)="itemMouseLeave('C')" [class.SelectedFilter]="SelectedValue === 'C'" title="Customs Import">
