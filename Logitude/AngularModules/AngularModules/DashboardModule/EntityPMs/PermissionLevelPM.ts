...
export class PermissionLevelPM {
    ...
    public OldEntityPM: PermissionLevelPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "PermissionLevel");
           
        }
       }
    }

    private MyClone: PermissionLevelPM;
