...
export class AnalyticsFactsMetaDataPM {
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AnalyticsFactsMetaData");
           
        }
       }
    }

    private MyClone: AnalyticsFactsMetaDataPM;
