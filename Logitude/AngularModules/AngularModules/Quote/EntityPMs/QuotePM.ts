...
export class QuotePM {
    ...
    public AddQuoteChargePM(item: QuoteChargePM) {
        if (item != null) {
    ...
    public RemoveQuoteChargePM(item: QuoteChargePM) {
        if (item != null) {
            var index = this.QuoteCharges.indexOf(item);
            if (index > -1) {
	    ...
	    //public QuoteCharges: Array<QuoteChargePMPM>= [];
    ...
    public AddQuoteFollowUpPM(item: QuoteFollowUpPM) {
        if (item != null) {
    ...
    public RemoveQuoteFollowUpPM(item: QuoteFollowUpPM) {
        if (item != null) {
            var index = this.FollowUps.indexOf(item);
            if (index > -1) {
	    ...
	    //public FollowUps: Array<QuoteFollowUpPMPM>= [];
    ...
    public AddQuoteDocumentVersionPM(item: QuoteDocumentVersionPM) {
        if (item != null) {
    ...
    public RemoveQuoteDocumentVersionPM(item: QuoteDocumentVersionPM) {
        if (item != null) {
            var index = this.QuoteDocumentVersions.indexOf(item);
            if (index > -1) {
	    ...
	    //public QuoteDocumentVersions: Array<QuoteDocumentVersionPMPM>= [];
    ...
    //public QuoteSaleCharges: Array<QuoteSaleChargePMPM>= [];
    ...
    public AddQuotePackagePM(item: QuotePackagePM) {
        if (item != null) {
    ...
    public RemoveQuotePackagePM(item: QuotePackagePM) {
        if (item != null) {
            var index = this.QuotePackages.indexOf(item);
            if (index > -1) {
	    ...
	    //public QuotePackages: Array<QuotePackagePMPM>= [];
    ...
    //public QuoteSalesTotals: Array<QuoteSalesTotalPMPM>= [];
    ...
    //public TotalVATPerQuote: Array<QuoteVATsTotalPMPM>= [];
    ...
    public AddQuoteTotalVATPM(item: QuoteTotalVATPM) {
        if (item != null) {
    ...
    public RemoveQuoteTotalVATPM(item: QuoteTotalVATPM) {
        if (item != null) {
            var index = this.TotalVATs.indexOf(item);
            if (index > -1) {
