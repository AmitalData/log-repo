...
export class QuotesComponent extends BaseComponent {
    ...
    public QuickSearchItems: QuoteList[] = [];
    ...
    // Load Recent Data
    public RecentQuotesList: QuoteList[] = [];
    ...
    private LoadTopQuotes() {
        ...
        var myService: QuoteListService = new QuoteListService();
    ...
    private FillTopQuotesList(myList: QuoteList[]) {
        switch (this.SelectedTopQuotesItem.Code) {
            case "EX":
                {
...
export class TopQuoteItem {
    ...
    constructor(entityList: QuoteList, filter: CodeNameClass) {
