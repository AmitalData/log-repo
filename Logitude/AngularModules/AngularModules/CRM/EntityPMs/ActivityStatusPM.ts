...
export class ActivityStatusPM {
    ...
    public OldEntityPM: ActivityStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ActivityStatus");
           
        }
    }

    private MyClone: ActivityStatusPM;
