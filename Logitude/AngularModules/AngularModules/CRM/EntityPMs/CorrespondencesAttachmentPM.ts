...
export class CorrespondencesAttachmentPM {
    ...
    private correspondenceId: string;
    public get CorrespondenceId() { return this.correspondenceId; }
    public set CorrespondenceId(newValue: string) { if (this.correspondenceId != newValue) { this.correspondenceId = newValue; this.MarkAsDirty("CorrespondenceId"); } }
