...
export class TicketSeverityPM {
    ...
    public get Severity() { return this.severity; }
    public set Severity(newValue: number) { if (this.severity != newValue) { this.severity = newValue; this.MarkAsDirty("Severity"); } }
