...
import {QuestionnaireQuestionPM} from './QuestionnaireQuestionPM';
...
export class QuestionnairePM {
	...
	private questionnaireQuestions: QuestionnaireQuestionPM[];
    ...
    set  QuestionnaireQuestions(newValue: QuestionnaireQuestionPM[]) {
        if (this.questionnaireQuestions != newValue) {
            this.questionnaireQuestions = newValue;
        }
    }
    public AddQuestionnaireQuestion(item: QuestionnaireQuestionPM) {
        if (item != null) {
    ...
    public RemoveQuestionnaireQuestion(item: QuestionnaireQuestionPM) {
        if (item != null) {
            var index = this. QuestionnaireQuestions.indexOf(item);
            if (index > -1) {
    ...
    //public QuestionnaireQuestions: Array<QuestionnaireQuestionPM>= [];
