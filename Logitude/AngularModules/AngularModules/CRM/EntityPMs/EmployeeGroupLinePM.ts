...
import {EmployeeGroupPM} from './EmployeeGroupPM';
...
export class EmployeeGroupLinePM {
    ...
    private isDefaultOwner: boolean;
    public get IsDefaultOwner() { return this.isDefaultOwner; }
    public set IsDefaultOwner(newValue: boolean) { if (this.isDefaultOwner != newValue) { this.isDefaultOwner = newValue; this.MarkAsDirty("IsDefaultOwner"); } }
       
	 

    public OldEntityPM: EmployeeGroupLinePM;
