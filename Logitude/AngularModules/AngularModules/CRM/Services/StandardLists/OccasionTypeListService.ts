...
import {OccasionTypeList} from '../../EntityLists/OccasionTypeList';

@Injectable()

export class OccasionTypeListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<OccasionTypeList> = [];
    constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/occasiontypeviews';  
    }
					...
					map((response: HttpResponse<any>) => {
						...
						if (allLists) {
							for (var key in allLists) {				
								var entity: OccasionTypeList = this.MapJsonToEntityList(allLists[key]);
						...
						var servertime = response.headers.get('ServerExecutionTime');
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "OccasionType", "GetAllLists", ""); 
					...
					map((response: HttpResponse<any>) => {
						...
						if (serviceResponse.Result) {
							for (var key in serviceResponse.Result) {				
								var entity: OccasionTypeList = this.MapJsonToEntityList(serviceResponse.Result[key]);
								_mappedListsArray.push(entity);
							}
						}   
						...
						var servertime = response.headers.get('ServerExecutionTime');
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "OccasionType", "GetByFilters", "PageIndex:" +filters.PageIndex +", PageSize:"+filters.PageSize + ", GetAll:" + filters.GetAll);
			...
			return defer(() => {
                ...
                if (cachedString) {
                    ...
                    for (var key in cachedJson) {
                        var entity: OccasionTypeList = this.MapJsonToEntityList(cachedJson[key]);
                        _mappedListsArray.push(entity);
                    }
    ...
    getAllFromCache(filters: ApiQueryFilters = new ApiQueryFilters(true)) {
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: OccasionTypeList;
            entityList = new OccasionTypeList();
