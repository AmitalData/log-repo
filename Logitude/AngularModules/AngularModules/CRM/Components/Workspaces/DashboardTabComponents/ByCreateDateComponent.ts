...
export class ByCreateDateComponent extends BaseComponent {
    ...
    public DataContext: ByCreateDateComponent = this;   
    private  fieldCode :string= "C";
    ...
    OnNewOpportunityClick(e) {
        ...
        filterAgrs.addAdditionalFilter("ChartCreateDateFilter", ServiceHelper.GetDateString(this.FromDate), ServiceHelper.GetDateString(this.ToDate), null, "Equals", true, false, false, "String");
    ...
    OnNewCustomerClick(e) {
        ...
        var myCode = null;
        if (!AppTool.IsNullOrEmpty(this.NewCustomersYAxisFitlerd[e.target.columnIndex].label))
