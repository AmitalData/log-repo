...
export class QuotesConversionComponent implements OnInit {
    ...
    OnBarClick(e) {
        ...
        if (flag) {
            ...
            filterAgrs.addAdditionalFilter("QuoteConversionDateFilter", this.Wizard.FromDate, this.Wizard.ToDate, null, "Equals", true, false, false, "String");
            ...
            filterAgrs.addAdditionalFilter("BusinessUnitId", this.dashboardArgs.BusinessUnitId, null, null, "Equals", false, false, false, "string");
