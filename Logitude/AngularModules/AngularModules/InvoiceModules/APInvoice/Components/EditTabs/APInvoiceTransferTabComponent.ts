...
export class APInvoiceTransferTabComponent extends BaseComponent implements OnDestroy {
    ...
    LoadChildComponent() {
        SessionLocator.DynamicLoader.Load("./InvoiceModules/APInvoice/Components/NewEntity/APInvoiceTransferTemplate", this.viewContainerRef)
            .then(cmpRef => {
