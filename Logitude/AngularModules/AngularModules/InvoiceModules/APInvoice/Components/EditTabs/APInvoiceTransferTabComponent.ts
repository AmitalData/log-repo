...
import {APInvoiceTransferTemplate} from '../NewEntity/APInvoiceTransferTemplate';
...
export class APInvoiceTransferTabComponent extends BaseComponent implements AfterViewInit, OnDestroy {
  ...
  private InputTemplate: APInvoiceTransferTemplate;
  LoadChildComponent() {
    SessionLocator.DynamicLoader.Load("./InvoiceModules/APInvoice/Components/NewEntity/APInvoiceTransferTemplate", this.Child.Location)
      .then(cmpRef => {
