...
export class VendorMenuButtonsHandler {
    ...
    private DisconnectGLAccount() {
        ...
        this.cardExtendedPMService.DisconnectGLAccountFromCard(this.EntityPM.Id, "VD", "DIST").subscribe((myResponse: ServiceResponse) => {
