...
export class AccountingPartnerMenuButtonsHandler {
  ...
  private DisconnectGLAccount() {
    ...
    this.cardExtendedPMService.DisconnectGLAccountFromCard(this.EntityPM.Id, "AC", "ACDS").subscribe((myResponse: ServiceResponse) => {
