...
import { ManifestSL } from '../../DataContracts/ManifestSL';
...
export class SharedManifestAdditionalComponent extends BaseComponent implements OnInit {
    ...
    IsNoOtherPartnersToTransLation: boolean = true;
    ...
    IsNoNeedTransShipmentsDetailsArea: boolean = false;
    ...
    IsAgentDataNotNeededToTransLation: boolean = false;
    ...
    IsNoPackageNeedToTransLation: boolean;
    ...
    HidePackageTypeArea: boolean = true;
    ...
    HideOtherPartnersArea: boolean = true;
    HouseEntity: HouseSL;
                ...
                this.myIncotermListService.getSingle(newValue).subscribe((myResponse: ServiceResponse) => {
                    if (!myResponse.HasError) {
                        ...
                        if (myList) {
                            ...
                            this.EntityPM.IncotermName = myList.Code;
    ...
    FullShipmentProperites() {
        ...
        if (this.EntityPM) {
            ...
            if (this.HouseEntity) {
                this.EntityPM.HAWBDate = this.HouseEntity.HAWBDate;
                this.EntityPM.IsDangerous = this.HouseEntity.IsDangerous;
                this.EntityPM.MainCarriageCarrierNumber = this.HouseEntity.MainCarriageCarrierNumber;
                this.EntityPM.ShipperName = this.HouseEntity.ShipperName;
                this.EntityPM.ConsigneeReference1 = this.HouseEntity.ConsigneeReference1;
                this.EntityPM.ConsigneeReference2 = this.HouseEntity.ConsigneeReference2;
                this.EntityPM.ShipperReference1 = this.HouseEntity.ShipperReference1;
                this.EntityPM.ShipperReference2 = this.HouseEntity.ShipperReference2;
                ...
                //Houses
                this.EntityPM.AgentSharedManifestRef = this.HouseEntity.SharedManifestRef;
                this.EntityPM.ShipmentLevelCode = "H";
                this.EntityPM.House = this.HouseEntity.HouseNumber;
                this.EntityPM.MasterShipmentDataId = this.ManifestSL.EntityId;
                this.EntityPM.ShipmentPackages = this.HouseEntity.ShipmentPackages;
                this.EntityPM.DescriptionOfGoods = this.HouseEntity.GeneralDescriptionOfGoods;
                this.EntityPM.ChargeableWeight = this.HouseEntity.ChargeableWeight;
                this.EntityPM.GrossWeight = this.HouseEntity.GrossWeight;
                this.EntityPM.PackagesQuantity = this.HouseEntity.PackagesQuantity;
                this.EntityPM.TEU = this.HouseEntity.TEU;

                this.EntityPM.Volume = this.HouseEntity.Volume;
                this.EntityPM.VolumetricWeight = this.HouseEntity.VolumetricWeight;
                this.EntityPM.NumberOfContainers = this.HouseEntity.NumberOfContainers;
                this.EntityPM.NumberOfPackages = this.HouseEntity.NumberOfPackages;

                this.EntityPM.GrossWeightUnitCode = this.HouseEntity.GrossWeightUnitCode;
                this.EntityPM.ChargeableWeightUnitCode = this.HouseEntity.ChargeableWeightUnitCode;
                this.EntityPM.DimensionsUnitCode = this.HouseEntity.DimensionsUnitCode;
                this.EntityPM.VolumeUnitCode = this.HouseEntity.VolumeUnitCode;

                this.EntityPM.GrossWeightEdited = this.HouseEntity.GrossWeightEdited;
                //this.EntityPM.GrossWeightInKG = this.HouseEntity.GrossWeightInKG;
                //this.EntityPM.ChargeableWeightInKG = this.HouseEntity.ChargeableWeightInKG;
                this.EntityPM.ShipmentTypeId = this.HouseEntity.ShipmentTypeId;
                this.EntityPM.ShipmentTypeName = this.HouseEntity.ShipmentTypeName;
                this.EntityPM.OrderGrossWeight = this.HouseEntity.OrderGrossWeight;
                this.EntityPM.ValueOfGoods = this.HouseEntity.ValueOfGoods;
            }
            else {

                //Direct & concol
                this.EntityPM.HAWBDate = this.ManifestSL.HAWBDate;
                this.EntityPM.MAWBOBLDate = this.ManifestSL.MAWBOBLDate;
                this.EntityPM.IsDangerous = this.ManifestSL.IsDangerous;
                this.EntityPM.TruckNumber = this.ManifestSL.TruckNumber;
                this.EntityPM.TrailerNumber = this.ManifestSL.TrailerNumber;
                this.EntityPM.ShipperName = this.ManifestSL.ShipperName;
                this.EntityPM.ConsigneeReference1 = this.ManifestSL.ConsigneeReference1;
                this.EntityPM.ConsigneeReference2 = this.ManifestSL.ConsigneeReference2;
                this.EntityPM.ShipperReference1 = this.ManifestSL.ShipperReference1;
                this.EntityPM.ShipperReference2 = this.ManifestSL.ShipperReference2;

                this.EntityPM.ShipmentPackages = this.ManifestSL.ShipmentPackages;
                this.EntityPM.AgentSharedManifestRef = this.ManifestSL.SharedManifestRef;
                this.EntityPM.ShipmentLevelCode = this.ManifestSL.ShipmentLevelCode;
                this.EntityPM.DescriptionOfGoods = this.ManifestSL.GeneralDescriptionOfGoods;
                this.EntityPM.House = this.ManifestSL.HouseNumber;
                this.EntityPM.ChargeableWeight = this.ManifestSL.ChargeableWeight;
                this.EntityPM.GrossWeight = this.ManifestSL.GrossWeight;
                this.EntityPM.PackagesQuantity = this.ManifestSL.PackagesQuantity;
                this.EntityPM.TEU = this.ManifestSL.TEU;
                this.EntityPM.Volume = this.ManifestSL.Volume;
                this.EntityPM.VolumetricWeight = this.ManifestSL.VolumetricWeight;
                this.EntityPM.NumberOfContainers = this.ManifestSL.NumberOfContainers;
                this.EntityPM.NumberOfPackages = this.ManifestSL.NumberOfPackages;
                this.EntityPM.GrossWeightUnitCode = this.ManifestSL.GrossWeightUnitCode;
                this.EntityPM.ChargeableWeightUnitCode = this.ManifestSL.ChargeableWeightUnitCode;
                this.EntityPM.DimensionsUnitCode = this.ManifestSL.DimensionsUnitCode;
                this.EntityPM.VolumeUnitCode = this.ManifestSL.VolumeUnitCode;
                //this.EntityPM.ChargeableWeightInKG = this.ManifestSL.ChargeableWeightInKG;
                this.EntityPM.GrossWeightEdited = this.ManifestSL.GrossWeightEdited;
                //this.EntityPM.GrossWeightInKG = this.ManifestSL.GrossWeightInKG;
                this.EntityPM.ShipmentTypeId = this.ManifestSL.ShipmentTypeId;
                this.EntityPM.ShipmentTypeName = this.ManifestSL.ShipmentTypeName;
                this.EntityPM.OrderGrossWeight = this.ManifestSL.OrderGrossWeight;
            
                this.EntityPM.ValueOfGoods = this.ManifestSL.ValueOfGoods;


                //MainCarriage
                this.EntityPM.MainHarmonize = this.ManifestSL.MainHarmonize;
    ...
    BuildOurSide() {
       ...
       //     LableCreateButton
        ...
        if (!this.AgentSideData.IncotermAddedManually && !this.IsHideIncoterm) {
            this.IsHideIncoterm = true;
            if (!AppTool.IsNullOrEmpty(this.AgentSideData.IncotermId)) {
                this.IncotermId = this.AgentSideData.IncotermId;
                this.IncotermCode = this.AgentSideData.IncotermCode;
            }
        }

        if (!this.AgentSideData.CarrierAddedManually && !this.IsHideCarrier) {
            this.IsHideCarrier = true;
            if (!AppTool.IsNullOrEmpty(this.AgentSideData.CarrierId)) {
        ...
        if (!this.IsHideRoutingLeg1) {
            ...
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.Transshipment1CarrierCode)) {
                ...
                if (!this.ManifestSL.Transshipment1CarrierAddedManually) {
            ...
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.Transshipment1VesselCode) && this.EntityPM.TransportModeId == "O") {
                if (!this.ManifestSL.Transshipment1VesselAddedManually) {
        ...
        if (!this.IsHideRoutingLeg2) {
            ...
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.Transshipment2CarrierCode)) {
                ...
                if (!this.ManifestSL.Transshipment2CarrierAddedManually) {
            ...
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.Transshipment2VesselCode) && this.EntityPM.TransportModeId == "O") {
                if (!this.ManifestSL.Transshipment2VesselAddedManually) {
        ...
        if (!this.IsHideRoutingLeg3) {
            ...
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.Transshipment3CarrierCode)) {
                ...
                if (!this.ManifestSL.Transshipment3CarrierAddedManually) {
            ...
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.Transshipment3VesselCode) && this.EntityPM.TransportModeId == "O") {
                if (!this.ManifestSL.Transshipment3VesselAddedManually) {
        ...
        if (this.IsHideRoutingLeg1 && this.IsHideRoutingLeg2 && this.IsHideRoutingLeg3) {
            ...
            this.IsNoNeedTransShipmentsDetailsArea = true;
            
        }


        if (!this.IsHideMainCarriageVessel && this.ManifestSL && !this.ManifestSL.MainCarriageVesselAddedManually) {
            this.IsHideMainCarriageVessel = true;
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.MainCarriageVesselId)) {
        ...
        if (!this.IsHideMainInterline && this.ManifestSL && !this.ManifestSL.InterlineAddedManually) {
            this.IsHideMainInterline = true;
            if (!AppTool.IsNullOrEmpty(this.ManifestSL.InterlineId)) {
      ...
      //_______________________________ Carrier Translation  Start ____________________________________________
        ...
        // 2 shipment1Carrier
        if (!this.IsHideTransshipment1Carrier) {
        ...
        // 3 shipmen2Carrier
        if (!this.IsHideTransshipment2Carrier) {
          ...
          // 4 shipmen3Carrier
        if (!this.IsHideTransshipment3Carrier) {
       ...
       // 3 Transshipment2Vessel 
        ...
        if (this.AgentSideData.PackageTypes && this.AgentSideData.PackageTypes.length > 0) {
            this.HidePackageTypeArea = false;
            this.IsNoPackageNeedToTransLation = false;
            ...
            this.IsNoPackageNeedToTransLation = true;
            this.IsLoadedPackageTranslation = true;
        ...
        if (this.AgentSideData.Notify1 == null) {
            ...
            this.IsNoOtherPartnersToTransLation = true;
            ...
            if (this.AgentSideData.Notify1) {
                ...
                if (!AppTool.IsNullOrEmpty(this.AgentSideData.Notify1.Code)) {
                    ...
                    this.HideOtherPartnersArea = false;
                    this.IsNoOtherPartnersToTransLation = false;
                }
                else {
                    this.HideOtherPartnersArea = true;
                    this.IsNoOtherPartnersToTransLation = true;
        ...
        if (this.IsHideCarrier && this.IsHideIncoterm && this.IsHideMainCarriageVessel && this.IsHideMainInterline && this.IsConsolShipment) {
            this.IsAgentDataNotNeededToTransLation = true;
    ...
    ComputeHeightAgentDataTransLationArea() {
        ...
        if (this.IsHideIncoterm) height -= 20;
    ...
    IsLoadAdditionalScreen: boolean = true;
    ...
    AddPartnerClicked(myPartnerCode: string) {
        ...
        var pathComponent = "./Common/Components/Partners/NewEntity/NewCustomerComponent";
    ...
    OnCreate() {
        ...
        //IncotermCode
        if (this.AgentSideData.IncotermCode && !this.IsHideIncoterm && this.IncotermCode) {
            this.InsertAndUpdateTransLation(this.AgentSideData.IncotermCode, "Incoterm", this.IncotermCode);
        }


        //CarrierCode
        if (this.AgentSideData.CarrierCode && !this.IsHideCarrier && this.MainCarriageCarrierCode) {
        ...
        if (this.ManifestSL.Transshipment1CarrierCode && !this.IsHideTransshipment1Carrier && this.Transshipment1CarrierCode) {
        ...
        if (this.ManifestSL.Transshipment2CarrierCode && !this.IsHideTransshipment2Carrier && this.Transshipment2CarrierCode) {
        ...
        if (this.ManifestSL.Transshipment3CarrierCode && !this.IsHideTransshipment3Carrier && this.Transshipment3CarrierCode) {
        ...
        if (this.ManifestSL && this.ManifestSL.MainCarriageVesselCode && !this.IsHideMainCarriageVessel && this.MainCarriageVesselCode) {
        ...
        if (this.ManifestSL && this.ManifestSL.Transshipment1VesselCode && !this.IsHideTransshipment1Vessel && this.Transshipment1VesselCode) {
        ...
        if (this.ManifestSL && this.ManifestSL.Transshipment2VesselCode && !this.IsHideTransshipment2Vessel && this.Transshipment2VesselCode) {
        ...
        if (this.ManifestSL && this.ManifestSL.Transshipment3VesselCode && !this.IsHideTransshipment3Vessel && this.Transshipment3VesselCode) {
        ...
        //IsHideInterlineCode
        if (this.ManifestSL && this.ManifestSL.InterlineCode && !this.IsHideMainInterline && this.InterlineCode) {
        ...
        if (this.AgentSideData.PackageTypes && this.AgentSideData.PackageTypes.length > 0) {
            this.AgentSideData.PackageTypes.forEach((PackageType) => {
    ...
    LoadChildComponent() {
        ...
        if (!this.IsLoadSharedManifestheaderScreen) {
            ...
            if (mySharedManifestHeaderLocation != null) {
                SessionLocator.DynamicLoader.Load('./Common/Components/SharedManifest/SharedManifestHeaderComponent', mySharedManifestHeaderLocation.viewContainerRef)
                    .then(cmpRef => {
...
export class AgentSide {
    ...
    constructor(manifestSL: ManifestSL , houseSL: HouseSL ) {
        ...
        if (houseSL != null) {
            this.Shipper = houseSL.Shipper;
            this.Consignee = houseSL.Consignee;
            this.IncotermCode = houseSL.IncotermCode;
            this.IncotermName = !AppTool.IsNullOrEmpty(houseSL.IncotermName) ? houseSL.IncotermName : houseSL.IncotermCode;
            this.IncotermId = houseSL.IncotermId;
            this.IncotermAddedManually = houseSL.IncotermAddedManually;

            this.CarrierCode = houseSL.CarrierCode;
            this.CarrierName = !AppTool.IsNullOrEmpty(houseSL.CarrierName) ? houseSL.CarrierName : houseSL.CarrierCode;
            this.CarrierId = houseSL.CarrierId;
            this.CarrierAddedManually = houseSL.CarrierAddedManually;

            this.FreightPrepaidCollectId = houseSL.FreightPrepaidCollectId;
            this.Notify1 = houseSL.Notify1;
            this.Notify2 = houseSL.Notify2;

            this.OtherPrepaidCollectId = houseSL.OtherPrepaidCollectId;
            this.AgentName = houseSL.AgentName;
            this.Notify1 = houseSL.Notify1;
            this.Notify2 = houseSL.Notify2;
            shipmentPackagePM = houseSL.ShipmentPackages;
        }

        else if (manifestSL != null) {
            this.Shipper = manifestSL.Shipper;
            this.Consignee = manifestSL.Consignee;
            this.IncotermCode = manifestSL.IncotermCode;
            this.IncotermName = !AppTool.IsNullOrEmpty(manifestSL.IncotermName) ? manifestSL.IncotermName : manifestSL.IncotermCode;
            this.IncotermId = manifestSL.IncotermId;
            this.IncotermAddedManually = manifestSL.IncotermAddedManually;

            this.CarrierCode = manifestSL.CarrierCode;
            this.CarrierName = !AppTool.IsNullOrEmpty(manifestSL.CarrierName) ? manifestSL.CarrierName : manifestSL.CarrierCode;
            this.CarrierId = manifestSL.CarrierId;
            this.CarrierAddedManually = manifestSL.CarrierAddedManually;

            this.FreightPrepaidCollectId = manifestSL.FreightPrepaidCollectId;
            this.Notify1 = manifestSL.Notify1;
            this.Notify2 = manifestSL.Notify2;

            this.OtherPrepaidCollectId = manifestSL.OtherPrepaidCollectId;
            this.AgentName = manifestSL.AgentName;
            this.Notify1 = manifestSL.Notify1;
            this.Notify2 = manifestSL.Notify2;
            shipmentPackagePM = manifestSL.ShipmentPackages;
        }

        if (shipmentPackagePM && shipmentPackagePM.length > 0) {
            this.PackageTypes = [];
            shipmentPackagePM.filter(d => d.IsPackageAddedManually).forEach((shipmentPackage) => {
            ...
            shipmentPackagePM.filter(d => d.InsideShipmentPackages != null && d.InsideShipmentPackages.length > 0).forEach((shipmentPackage) => {
                shipmentPackage.InsideShipmentPackages.filter(d => d.IsPackageAddedManually).forEach((insideShipmentPackages) => {
