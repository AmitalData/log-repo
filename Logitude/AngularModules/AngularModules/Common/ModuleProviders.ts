...
import {AdditionalServiceListService} from './Services/StandardLists/AdditionalServiceListService';
...
import {CarrierListService} from './Services/StandardLists/CarrierListService';
import {ChargesTypeListService} from './Services/StandardLists/ChargesTypeListService';
import {CommodityListService} from './Services/StandardLists/CommodityListService';
import {CommunicationLogListService} from './Services/StandardLists/CommunicationLogListService';
import {CommunicationLogTypeListService} from './Services/StandardLists/CommunicationLogTypeListService';
import {CommunicationStatusTypeListService} from './Services/StandardLists/CommunicationStatusTypeListService';
import {CompetitorListService} from './Services/StandardLists/CompetitorListService';
import {ComputingPartnerListService} from './Services/StandardLists/ComputingPartnerListService';
import {ContactDoneMethodListService} from './Services/StandardLists/ContactDoneMethodListService';
import {ContactListService} from './Services/StandardLists/ContactListService';
import {CountryCityListService} from './Services/StandardLists/CountryCityListService';
...
import {CustomAgentListService} from './Services/StandardLists/CustomAgentListService';
...
import {DimensionsUnitListService} from './Services/StandardLists/DimensionsUnitListService';
import {DistributorListService} from './Services/StandardLists/DistributorListService';
import {DocumentFolderListService} from './Services/StandardLists/DocumentFolderListService';
import {DocumentsFilingListService} from './Services/StandardLists/DocumentsFilingListService';
import {DocumentTypeCategoryListService} from './Services/StandardLists/DocumentTypeCategoryListService';
import {DocumentTypeListService} from './Services/StandardLists/DocumentTypeListService';
import {DocumentTypeTemplateListService} from './Services/StandardLists/DocumentTypeTemplateListService';
...
import {LogitudeMessagesTransmissionLogListService} from './Services/StandardLists/LogitudeMessagesTransmissionLogListService';
import {MeasurementListService} from './Services/StandardLists/MeasurementListService';
import {PackageListService} from './Services/StandardLists/PackageListService';
import {PackageTypeListService} from './Services/StandardLists/PackageTypeListService';
import {ParticipantListService} from './Services/StandardLists/ParticipantListService';
...
import {ProductPeriodListService} from './Services/StandardLists/ProductPeriodListService';
import {ProductTypeListService} from './Services/StandardLists/ProductTypeListService';
import {RankListService} from './Services/StandardLists/RankListService';
...
import {VatUniqueTypeListService} from './Services/StandardLists/VatUniqueTypeListService';
import {VendorListService} from './Services/StandardLists/VendorListService';
import {VesselListService} from './Services/StandardLists/VesselListService';
import {WarehouseListService} from './Services/StandardLists/WarehouseListService';
...
import {AirlinePMService} from './Services/StandardPMs/AirlinePMService';
import {AirlineStatisticsPMService} from './Services/StandardPMs/AirlineStatisticsPMService';
import {AutomationPMService} from './Services/StandardPMs/AutomationPMService';
import {AutomationResultEmailRecipientPMService} from './Services/StandardPMs/AutomationResultEmailRecipientPMService';
import {BranchPMService} from './Services/StandardPMs/BranchPMService';
import {BusinessUnitPMService} from './Services/StandardPMs/BusinessUnitPMService';
import {CardPMService} from './Services/StandardPMs/CardPMService';
...
import {PortExtendedListService} from './Services/ExtendedLists/PortExtendedListService';

import {CustomerFieldsUpdateSettingListService} from './Services/StandardLists/CustomerFieldsUpdateSettingListService';
import {CustomerFieldsUpdateSettingPMService} from './Services/StandardPMs/CustomerFieldsUpdateSettingPMService';
import {TenantLoginPolicyPMService} from './Services/StandardPMs/TenantLoginPolicyPMService';
import {TwoFactorAuthenticationDeviceExtendedPMService} from './Services/ExtendedPMs/TwoFactorAuthenticationDeviceExtendedPMService';
import {FeaturePackageTypeListService} from './Services/StandardLists/FeaturePackageTypeListService';

import {ComputingPartnerPMService} from './Services/StandardPMs/ComputingPartnerPMService';
import {ComputingPartnerTranslationPMService} from './Services/StandardPMs/ComputingPartnerTranslationPMService';

import {TenantLoginPolicyListService} from './Services/StandardLists/TenantLoginPolicyListService';
import {RegistryDateTypeListService} from './Services/StandardLists/RegistryDateTypeListService';

import {WarehouseTypeListService} from './Services/StandardLists/WarehouseTypeListService';
import {TemperatureUnitListService} from './Services/StandardLists/TemperatureUnitListService';

import {DocumentFilingBackupSettingListService} from './Services/StandardLists/DocumentFilingBackupSettingListService';
import {DocumentFilingBackupBatchListService} from './Services/StandardLists/DocumentFilingBackupBatchListService';
...
export class ModuleProviders {
    public static GetInstance(name: string) {
        ...
        switch (name) {
            ...
            case "AccountingSystemListService": { myResult = new AccountingSystemListService(); break; }
            case "CustomsInterfaceSettingListService": { myResult = new CustomsInterfaceSettingListService(); break; }
            case "CustomsInterfaceListService": { myResult = new CustomsInterfaceListService(); break; }
            case "AdditionalServiceListService": { myResult = new AdditionalServiceListService(); break; }
            case "AddressListService": { myResult = new AddressListService(); break; }
            ...
            case "CardListService": { myResult = new CardListService(); break; }
            ...
            case "CommodityListService": { myResult = new CommodityListService(); break; }
            case "CommunicationLogListService": { myResult = new CommunicationLogListService(); break; }
            case "CommunicationLogTypeListService": { myResult = new CommunicationLogTypeListService(); break; }
            case "TemplateFormatListService": { myResult = new TemplateFormatListService(); break; }
            case "CommunicationStatusTypeListService": { myResult = new CommunicationStatusTypeListService(); break; }
            case "CompetitorListService": { myResult = new CompetitorListService(); break; }
            case "ComputingPartnerListService": { myResult = new ComputingPartnerListService(); break; }
            case "ContactDoneMethodListService": { myResult = new ContactDoneMethodListService(); break; }
            case "ContactListService": { myResult = new ContactListService(); break; }
            ...
            case "DimensionsUnitListService": { myResult = new DimensionsUnitListService(); break; }
            case "DistributorListService": { myResult = new DistributorListService(); break; }
            case "DocumentFolderListService": { myResult = new DocumentFolderListService(); break; }
            case "DocumentsFilingListService": { myResult = new DocumentsFilingListService(); break; }
            case "DocumentTypeCategoryListService": { myResult = new DocumentTypeCategoryListService(); break; }
            case "DocumentTypeListService": { myResult = new DocumentTypeListService(); break; }
            case "DocumentTypeTemplateListService": { myResult = new DocumentTypeTemplateListService(); break; }
            ...
            case "LogitudeMessagesTransmissionLogListService": { myResult = new LogitudeMessagesTransmissionLogListService(); break; }
            ...
            case "ProductPeriodListService": { myResult = new ProductPeriodListService(); break; }
            ...
            case "VatUniqueTypeListService": { myResult = new VatUniqueTypeListService(); break; }
            case "VendorListService": { myResult = new VendorListService(); break; }
            ...
            case "AirlinePMService": { myResult = new AirlinePMService(); break; }
            case "AirlineStatisticsPMService": { myResult = new AirlineStatisticsPMService(); break; }
            case "AutomationPMService": { myResult = new AutomationPMService(); break; }
            case "AutomationResultEmailRecipientPMService": { myResult = new AutomationResultEmailRecipientPMService(); break; }
            case "BranchPMService": { myResult = new BranchPMService(); break; }
            case "BusinessUnitPMService": { myResult = new BusinessUnitPMService(); break; }
            case "CardPMService": { myResult = new CardPMService(); break; }
