...
export class MeasurementPM {
    ...
    public get ShortName() { return this.shortName; }
    public set ShortName(newValue: string) { if (this.shortName != newValue) { this.shortName = newValue; this.MarkAsDirty("ShortName"); } }
    ...
    private isContainerMeasurement: boolean;
    public get IsContainerMeasurement() { return this.isContainerMeasurement; }
    public set IsContainerMeasurement(newValue: boolean) { if (this.isContainerMeasurement != newValue) { this.isContainerMeasurement = newValue; this.MarkAsDirty("IsContainerMeasurement"); } }
    ...
    public OldEntityPM: MeasurementPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Measurement");
           
        }
	 }
    }
    private MyClone: MeasurementPM;
