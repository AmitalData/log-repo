...
export class IncotermPM {
    ...
    public get Freight() { return this.freight; }
    public set Freight(newValue: string) { if (this.freight != newValue) { this.freight = newValue; this.MarkAsDirty("Freight"); } }
       
	 
    private otherCharges: string;
    public get OtherCharges() { return this.otherCharges; }
    public set OtherCharges(newValue: string) { if (this.otherCharges != newValue) { this.otherCharges = newValue; this.MarkAsDirty("OtherCharges"); } }
