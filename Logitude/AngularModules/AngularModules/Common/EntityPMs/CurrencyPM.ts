...
export class CurrencyPM {
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Currency");
           
        }
    }
    private MyClone: CurrencyPM;
