...
export class VesselPM {
    ...
    private iMOCode: string;
    public get IMOCode() { return this.iMOCode; }
    public set IMOCode(newValue: string) { if (this.iMOCode != newValue) { this.iMOCode = newValue; this.MarkAsDirty("IMOCode"); } }
