...
export class PortGroupPM {
    ...
    public OldEntityPM: PortGroupPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "PortGroup");
           
        }
	 }
    }
    private MyClone: PortGroupPM;
