...
export class DocumentFolderPM {
    ...
    private isExternalFolder: boolean;
    public get IsExternalFolder() { return this.isExternalFolder; }
    public set IsExternalFolder(newValue: boolean) { if (this.isExternalFolder != newValue) { this.isExternalFolder = newValue; this.MarkAsDirty("IsExternalFolder"); } }
       
	 
    private parentFolderId: string;
    public get ParentFolderId() { return this.parentFolderId; }
    public set ParentFolderId(newValue: string) { if (this.parentFolderId != newValue) { this.parentFolderId = newValue; this.MarkAsDirty("ParentFolderId"); } }
