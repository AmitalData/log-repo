...
export class TenantPM {
    ...
    public get IsQuoteSubjectEdited() { return this.isQuoteSubjectEdited; }
    public set IsQuoteSubjectEdited(newValue: boolean) { if (this.isQuoteSubjectEdited != newValue) { this.isQuoteSubjectEdited = newValue; this.MarkAsDirty("IsQuoteSubjectEdited"); } }
    ...
    public get DefaultQuestionnaireId() { return this.defaultQuestionnaireId; }
    public set DefaultQuestionnaireId(newValue: string) { if (this.defaultQuestionnaireId != newValue) { this.defaultQuestionnaireId = newValue; this.MarkAsDirty("DefaultQuestionnaireId"); } }
    ...
    public get AccountingCurrencyCode() { return this.accountingCurrencyCode; }
    public set AccountingCurrencyCode(newValue: string) { if (this.accountingCurrencyCode != newValue) { this.accountingCurrencyCode = newValue; this.MarkAsDirty("AccountingCurrencyCode"); } }
       
	 
    private accountingCurrencyName: string;
    public get AccountingCurrencyName() { return this.accountingCurrencyName; }
    public set AccountingCurrencyName(newValue: string) { if (this.accountingCurrencyName != newValue) { this.accountingCurrencyName = newValue; this.MarkAsDirty("AccountingCurrencyName"); } }
    ...
    public get ProfitCurrencyRate() { return this.profitCurrencyRate; }
    public set ProfitCurrencyRate(newValue: number) { if (this.profitCurrencyRate != newValue) { this.profitCurrencyRate = newValue; this.MarkAsDirty("ProfitCurrencyRate"); } }
       
	 
    private freightCurrencyId: string;
    public get FreightCurrencyId() { return this.freightCurrencyId; }
    public set FreightCurrencyId(newValue: string) { if (this.freightCurrencyId != newValue) { this.freightCurrencyId = newValue; this.MarkAsDirty("FreightCurrencyId"); } }
       
	 
    private freightCurrencyCode: string;
    public get FreightCurrencyCode() { return this.freightCurrencyCode; }
    public set FreightCurrencyCode(newValue: string) { if (this.freightCurrencyCode != newValue) { this.freightCurrencyCode = newValue; this.MarkAsDirty("FreightCurrencyCode"); } }
       
	 
    private otherChargesCurrencyId: string;
    public get OtherChargesCurrencyId() { return this.otherChargesCurrencyId; }
    public set OtherChargesCurrencyId(newValue: string) { if (this.otherChargesCurrencyId != newValue) { this.otherChargesCurrencyId = newValue; this.MarkAsDirty("OtherChargesCurrencyId"); } }
       
	 
    private otherChargesCurrencyCode: string;
    public get OtherChargesCurrencyCode() { return this.otherChargesCurrencyCode; }
    public set OtherChargesCurrencyCode(newValue: string) { if (this.otherChargesCurrencyCode != newValue) { this.otherChargesCurrencyCode = newValue; this.MarkAsDirty("OtherChargesCurrencyCode"); } }
       
	 
    private quoteSaleCurrencyId: string;
    public get QuoteSaleCurrencyId() { return this.quoteSaleCurrencyId; }
    public set QuoteSaleCurrencyId(newValue: string) { if (this.quoteSaleCurrencyId != newValue) { this.quoteSaleCurrencyId = newValue; this.MarkAsDirty("QuoteSaleCurrencyId"); } }
       
	 
    private quoteSaleCurrencyCode: string;
    public get QuoteSaleCurrencyCode() { return this.quoteSaleCurrencyCode; }
    public set QuoteSaleCurrencyCode(newValue: string) { if (this.quoteSaleCurrencyCode != newValue) { this.quoteSaleCurrencyCode = newValue; this.MarkAsDirty("QuoteSaleCurrencyCode"); } }
    ...
    public get WeightMeasurementUnitCode() { return this.weightMeasurementUnitCode; }
    public set WeightMeasurementUnitCode(newValue: string) { if (this.weightMeasurementUnitCode != newValue) { this.weightMeasurementUnitCode = newValue; this.MarkAsDirty("WeightMeasurementUnitCode"); } }
       
	 
    private exportFreightPrepaidCollectId: string;
    public get ExportFreightPrepaidCollectId() { return this.exportFreightPrepaidCollectId; }
    public set ExportFreightPrepaidCollectId(newValue: string) { if (this.exportFreightPrepaidCollectId != newValue) { this.exportFreightPrepaidCollectId = newValue; this.MarkAsDirty("ExportFreightPrepaidCollectId"); } }
       
	 
    private importFreightPrepaidCollectId: string;
    public get ImportFreightPrepaidCollectId() { return this.importFreightPrepaidCollectId; }
    public set ImportFreightPrepaidCollectId(newValue: string) { if (this.importFreightPrepaidCollectId != newValue) { this.importFreightPrepaidCollectId = newValue; this.MarkAsDirty("ImportFreightPrepaidCollectId"); } }
       
	 
    private exportOtherPrepaidCollectId: string;
    public get ExportOtherPrepaidCollectId() { return this.exportOtherPrepaidCollectId; }
    public set ExportOtherPrepaidCollectId(newValue: string) { if (this.exportOtherPrepaidCollectId != newValue) { this.exportOtherPrepaidCollectId = newValue; this.MarkAsDirty("ExportOtherPrepaidCollectId"); } }
       
	 
    private importOtherPrepaidCollectId: string;
    public get ImportOtherPrepaidCollectId() { return this.importOtherPrepaidCollectId; }
    ...
    public get STDVatPercentage() { return this.sTDVatPercentage; }
    public set STDVatPercentage(newValue: number) { if (this.sTDVatPercentage != newValue) { this.sTDVatPercentage = newValue; this.MarkAsDirty("STDVatPercentage"); } }
       
	 
    private timeZoneOffset: number;
    public get TimeZoneOffset() { return this.timeZoneOffset; }
    public set TimeZoneOffset(newValue: number) { if (this.timeZoneOffset != newValue) { this.timeZoneOffset = newValue; this.MarkAsDirty("TimeZoneOffset"); } }
    ...
    public get DateTimeFormat() { return this.dateTimeFormat; }
    public set DateTimeFormat(newValue: string) { if (this.dateTimeFormat != newValue) { this.dateTimeFormat = newValue; this.MarkAsDirty("DateTimeFormat"); } }
    ...
    public get DayLightOffset() { return this.dayLightOffset; }
    public set DayLightOffset(newValue: number) { if (this.dayLightOffset != newValue) { this.dayLightOffset = newValue; this.MarkAsDirty("DayLightOffset"); } }
       
	 
    private dayLightStartDate: Date;
    public get DayLightStartDate() { return this.dayLightStartDate; }
    public set DayLightStartDate(newValue: Date) { if (this.dayLightStartDate != newValue) { this.dayLightStartDate = newValue; this.MarkAsDirty("DayLightStartDate"); } }
       
	 
    private dayLightEndDate: Date;
    public get DayLightEndDate() { return this.dayLightEndDate; }
    public set DayLightEndDate(newValue: Date) { if (this.dayLightEndDate != newValue) { this.dayLightEndDate = newValue; this.MarkAsDirty("DayLightEndDate"); } }
       
	 
    private passwordPolicyCode: string;
    public get PasswordPolicyCode() { return this.passwordPolicyCode; }
    public set PasswordPolicyCode(newValue: string) { if (this.passwordPolicyCode != newValue) { this.passwordPolicyCode = newValue; this.MarkAsDirty("PasswordPolicyCode"); } }
       
	 
    private passwordStrength: string;
    public get PasswordStrength() { return this.passwordStrength; }
    public set PasswordStrength(newValue: string) { if (this.passwordStrength != newValue) { this.passwordStrength = newValue; this.MarkAsDirty("PasswordStrength"); } }
       
	 
    private isDataBackupBuilt: boolean;
    public get IsDataBackupBuilt() { return this.isDataBackupBuilt; }
    public set IsDataBackupBuilt(newValue: boolean) { if (this.isDataBackupBuilt != newValue) { this.isDataBackupBuilt = newValue; this.MarkAsDirty("IsDataBackupBuilt"); } }
    ...
    public get InvoiceSection1() { return this.invoiceSection1; }
    public set InvoiceSection1(newValue: string) { if (this.invoiceSection1 != newValue) { this.invoiceSection1 = newValue; this.MarkAsDirty("InvoiceSection1"); } }
       
	 
    private invoiceSection2: string;
    public get InvoiceSection2() { return this.invoiceSection2; }
    public set InvoiceSection2(newValue: string) { if (this.invoiceSection2 != newValue) { this.invoiceSection2 = newValue; this.MarkAsDirty("InvoiceSection2"); } }
       
	 
    private bankDetails: string;
    public get BankDetails() { return this.bankDetails; }
    public set BankDetails(newValue: string) { if (this.bankDetails != newValue) { this.bankDetails = newValue; this.MarkAsDirty("BankDetails"); } }
       
	 
    private isSharedLogisticsActivated: boolean;
    public get IsSharedLogisticsActivated() { return this.isSharedLogisticsActivated; }
    public set IsSharedLogisticsActivated(newValue: boolean) { if (this.isSharedLogisticsActivated != newValue) { this.isSharedLogisticsActivated = newValue; this.MarkAsDirty("IsSharedLogisticsActivated"); } }
       
	 
    private isWebAccessActivated: boolean;
    public get IsWebAccessActivated() { return this.isWebAccessActivated; }
    public set IsWebAccessActivated(newValue: boolean) { if (this.isWebAccessActivated != newValue) { this.isWebAccessActivated = newValue; this.MarkAsDirty("IsWebAccessActivated"); } }
       
	 
    private isMobileActivated: boolean;
    public get IsMobileActivated() { return this.isMobileActivated; }
    public set IsMobileActivated(newValue: boolean) { if (this.isMobileActivated != newValue) { this.isMobileActivated = newValue; this.MarkAsDirty("IsMobileActivated"); } }
       
	 
    private sharedLogisticsMessageLink: boolean;
    public get SharedLogisticsMessageLink() { return this.sharedLogisticsMessageLink; }
    public set SharedLogisticsMessageLink(newValue: boolean) { if (this.sharedLogisticsMessageLink != newValue) { this.sharedLogisticsMessageLink = newValue; this.MarkAsDirty("SharedLogisticsMessageLink"); } }
    ...
    public get VatUniqueTypeCode() { return this.vatUniqueTypeCode; }
    public set VatUniqueTypeCode(newValue: string) { if (this.vatUniqueTypeCode != newValue) { this.vatUniqueTypeCode = newValue; this.MarkAsDirty("VatUniqueTypeCode"); } }
       
	 
    private vatMandatoryTypeCode: string;
    public get VatMandatoryTypeCode() { return this.vatMandatoryTypeCode; }
    public set VatMandatoryTypeCode(newValue: string) { if (this.vatMandatoryTypeCode != newValue) { this.vatMandatoryTypeCode = newValue; this.MarkAsDirty("VatMandatoryTypeCode"); } }
       
	 
    private vatUniqueCountryId: string;
    public get VatUniqueCountryId() { return this.vatUniqueCountryId; }
    public set VatUniqueCountryId(newValue: string) { if (this.vatUniqueCountryId != newValue) { this.vatUniqueCountryId = newValue; this.MarkAsDirty("VatUniqueCountryId"); } }
       
	 
    private vatMandatoryCountryId: string;
    public get VatMandatoryCountryId() { return this.vatMandatoryCountryId; }
    ...
    public get IsCustomerTelRequired() { return this.isCustomerTelRequired; }
    public set IsCustomerTelRequired(newValue: boolean) { if (this.isCustomerTelRequired != newValue) { this.isCustomerTelRequired = newValue; this.MarkAsDirty("IsCustomerTelRequired"); } }
       
	 
    private isCustomerFaxRequired: boolean;
    public get IsCustomerFaxRequired() { return this.isCustomerFaxRequired; }
    public set IsCustomerFaxRequired(newValue: boolean) { if (this.isCustomerFaxRequired != newValue) { this.isCustomerFaxRequired = newValue; this.MarkAsDirty("IsCustomerFaxRequired"); } }
       
	 
    private isPickDelAdrsRequired: boolean;
    public get IsPickDelAdrsRequired() { return this.isPickDelAdrsRequired; }
    public set IsPickDelAdrsRequired(newValue: boolean) { if (this.isPickDelAdrsRequired != newValue) { this.isPickDelAdrsRequired = newValue; this.MarkAsDirty("IsPickDelAdrsRequired"); } }
       
	 
    private isCustomerAddress1Required: boolean;
    public get IsCustomerAddress1Required() { return this.isCustomerAddress1Required; }
    public set IsCustomerAddress1Required(newValue: boolean) { if (this.isCustomerAddress1Required != newValue) { this.isCustomerAddress1Required = newValue; this.MarkAsDirty("IsCustomerAddress1Required"); } }
       
	 
    private hasPrimaryContact: boolean;
    public get HasPrimaryContact() { return this.hasPrimaryContact; }
    public set HasPrimaryContact(newValue: boolean) { if (this.hasPrimaryContact != newValue) { this.hasPrimaryContact = newValue; this.MarkAsDirty("HasPrimaryContact"); } }
       
	 
    private allowEAWBMoreThanTenPackages: boolean;
    public get AllowEAWBMoreThanTenPackages() { return this.allowEAWBMoreThanTenPackages; }
    public set AllowEAWBMoreThanTenPackages(newValue: boolean) { if (this.allowEAWBMoreThanTenPackages != newValue) { this.allowEAWBMoreThanTenPackages = newValue; this.MarkAsDirty("AllowEAWBMoreThanTenPackages"); } }
       
	 
    private regulatedAgentNumber: string;
    public get RegulatedAgentNumber() { return this.regulatedAgentNumber; }
    public set RegulatedAgentNumber(newValue: string) { if (this.regulatedAgentNumber != newValue) { this.regulatedAgentNumber = newValue; this.MarkAsDirty("RegulatedAgentNumber"); } }
       
	 
    private regulatedAgentRegimeActivated: boolean;
    public get RegulatedAgentRegimeActivated() { return this.regulatedAgentRegimeActivated; }
    public set RegulatedAgentRegimeActivated(newValue: boolean) { if (this.regulatedAgentRegimeActivated != newValue) { this.regulatedAgentRegimeActivated = newValue; this.MarkAsDirty("RegulatedAgentRegimeActivated"); } }
    ...
    public get CustomerMobile() { return this.customerMobile; }
    public set CustomerMobile(newValue: string) { if (this.customerMobile != newValue) { this.customerMobile = newValue; this.MarkAsDirty("CustomerMobile"); } }
       
	 
    private customerPhone: string;
    public get CustomerPhone() { return this.customerPhone; }
    ...
    public get IsPotentialTelRequired() { return this.isPotentialTelRequired; }
    public set IsPotentialTelRequired(newValue: boolean) { if (this.isPotentialTelRequired != newValue) { this.isPotentialTelRequired = newValue; this.MarkAsDirty("IsPotentialTelRequired"); } }
       
	 
    private isPotentialFaxRequired: boolean;
    public get IsPotentialFaxRequired() { return this.isPotentialFaxRequired; }
    public set IsPotentialFaxRequired(newValue: boolean) { if (this.isPotentialFaxRequired != newValue) { this.isPotentialFaxRequired = newValue; this.MarkAsDirty("IsPotentialFaxRequired"); } }
       
	 
    private vatFormatTypeCode: string;
    public get VatFormatTypeCode() { return this.vatFormatTypeCode; }
    public set VatFormatTypeCode(newValue: string) { if (this.vatFormatTypeCode != newValue) { this.vatFormatTypeCode = newValue; this.MarkAsDirty("VatFormatTypeCode"); } }
       
	 
    private vatFormatCountryId: string;
    public get VatFormatCountryId() { return this.vatFormatCountryId; }
    public set VatFormatCountryId(newValue: string) { if (this.vatFormatCountryId != newValue) { this.vatFormatCountryId = newValue; this.MarkAsDirty("VatFormatCountryId"); } }
       
	 
    private isNumeric: boolean;
    public get IsNumeric() { return this.isNumeric; }
    public set IsNumeric(newValue: boolean) { if (this.isNumeric != newValue) { this.isNumeric = newValue; this.MarkAsDirty("IsNumeric"); } }
    ...
    public get CreateTenantFromSignUp() { return this.createTenantFromSignUp; }
    ...
    public get IsNotesRightToLeftEnabled() { return this.isNotesRightToLeftEnabled; }
    public set IsNotesRightToLeftEnabled(newValue: boolean) { if (this.isNotesRightToLeftEnabled != newValue) { this.isNotesRightToLeftEnabled = newValue; this.MarkAsDirty("IsNotesRightToLeftEnabled"); } }
    ...
    public get IsInternalTicketByDefault() { return this.isInternalTicketByDefault; }
    public set IsInternalTicketByDefault(newValue: boolean) { if (this.isInternalTicketByDefault != newValue) { this.isInternalTicketByDefault = newValue; this.MarkAsDirty("IsInternalTicketByDefault"); } }
       
	 
    private prorateMasterReceivables: boolean;
    public get ProrateMasterReceivables() { return this.prorateMasterReceivables; }
    ...
    public get FMCNumber() { return this.fMCNumber; }
    public set FMCNumber(newValue: string) { if (this.fMCNumber != newValue) { this.fMCNumber = newValue; this.MarkAsDirty("FMCNumber"); } }
       
	 
    private tenantVATManagement: boolean;
    public get TenantVATManagement() { return this.tenantVATManagement; }
