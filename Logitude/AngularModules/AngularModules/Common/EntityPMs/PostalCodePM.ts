...
export class PostalCodePM {
    ...
    public OldEntityPM: PostalCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "PostalCode");
           
        }
	 }
    }
    private MyClone: PostalCodePM;
