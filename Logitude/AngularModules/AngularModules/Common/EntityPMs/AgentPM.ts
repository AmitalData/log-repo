...
export class AgentPM {
    ...
    private regulatedAgentCode: string;
    public get RegulatedAgentCode() { return this.regulatedAgentCode; }
    public set RegulatedAgentCode(newValue: string) { if (this.regulatedAgentCode != newValue) { this.regulatedAgentCode = newValue; this.MarkAsDirty("RegulatedAgentCode"); } }
    ...
    private agentSharedLogisticsKey: string;
    public get AgentSharedLogisticsKey() { return this.agentSharedLogisticsKey; }
    public set AgentSharedLogisticsKey(newValue: string) { if (this.agentSharedLogisticsKey != newValue) { this.agentSharedLogisticsKey = newValue; this.MarkAsDirty("AgentSharedLogisticsKey"); } }
