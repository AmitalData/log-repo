...
export class RolePM {
    ...
    public get RoleTypeCode() { return this.roleTypeCode; }
    public set RoleTypeCode(newValue: string) { if (this.roleTypeCode != newValue) { this.roleTypeCode = newValue; this.MarkAsDirty("RoleTypeCode"); } }
    ...
    public get ParentRoleId() { return this.parentRoleId; }
    public set ParentRoleId(newValue: string) { if (this.parentRoleId != newValue) { this.parentRoleId = newValue; this.MarkAsDirty("ParentRoleId"); } }
    ...
    public get Added() { return this.added; }
    public set Added(newValue: boolean) { if (this.added != newValue) { this.added = newValue; this.MarkAsDirty("Added"); } }
       
	 
    private removed: boolean;
    public get Removed() { return this.removed; }
    public set Removed(newValue: boolean) { if (this.removed != newValue) { this.removed = newValue; this.MarkAsDirty("Removed"); } }
    ...
    public get CurrentTenant() { return this.currentTenant; }
    public set CurrentTenant(newValue: number) { if (this.currentTenant != newValue) { this.currentTenant = newValue; this.MarkAsDirty("CurrentTenant"); } }
