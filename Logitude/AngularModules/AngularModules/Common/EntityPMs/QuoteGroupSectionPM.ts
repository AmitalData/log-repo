...
export class QuoteGroupSectionPM {
    ...
    public OldEntityPM: QuoteGroupSectionPM;
    ...
    MarkAsDirty(propertyName: string = null) {
        if (!this.DisableMarkAsDirty) {
            ...
            if (propertyName != null) {
                ...
                ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QuoteGroupSectionPM");

            }
        }
    }

    private MyClone: QuoteGroupSectionPM;
