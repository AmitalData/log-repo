...
export class CustomerSalesNotePM {
    ...
    public get EventLabel() { return this.eventLabel; }
    public set EventLabel(newValue: string) { if (this.eventLabel != newValue) { this.eventLabel = newValue; this.MarkAsDirty("EventLabel"); } }
    ...
    public OldEntityPM: CustomerSalesNotePM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CustomerSalesNote");
           
        }
    }
    private MyClone: CustomerSalesNotePM;
