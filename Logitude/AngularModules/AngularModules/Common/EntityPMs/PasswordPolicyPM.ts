...
export class PasswordPolicyPM {
    ...
    public set PasswordStrength(newValue: string) { this.passwordStrength = newValue; this.MarkAsDirty(); }
    ...
    public OldEntityPM: PasswordPolicyPM;
