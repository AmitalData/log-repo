...
export class CustomerTeamPM {
    ...
    public OldEntityPM: CustomerTeamPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CustomerTeam");
           
        }
	 }
    }
    private MyClone: CustomerTeamPM;
