...
export class CargoTenantMilestoneDefinitionPM {
    ...
    public OldEntityPM: CargoTenantMilestoneDefinitionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CargoTenantMilestoneDefinition");
           
        }
	 }
    }
    private MyClone: CargoTenantMilestoneDefinitionPM;
