...
export class UserRolesPM {
    ...
    public set Exists(newValue: boolean) { this.exists = newValue; this.MarkAsDirty(); }

    private added: boolean;
    public get Added() { return this.added; }
    public set Added(newValue: boolean) { this.added = newValue; this.MarkAsDirty(); }

    private removed: boolean;
    public get Removed() { return this.removed; }
    public set Removed(newValue: boolean) { this.removed = newValue; this.MarkAsDirty(); }
