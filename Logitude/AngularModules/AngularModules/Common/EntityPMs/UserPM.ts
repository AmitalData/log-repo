...
export class UserPM {
    ...
    public get UserType() { return this.userType; }
    public set UserType(newValue: string) { if (this.userType != newValue) { this.userType = newValue; this.MarkAsDirty("UserType"); } }
       
	 
    private isSalesman: boolean;
    public get IsSalesman() { return this.isSalesman; }
    public set IsSalesman(newValue: boolean) { if (this.isSalesman != newValue) { this.isSalesman = newValue; this.MarkAsDirty("IsSalesman"); } }
       
	 
    private licencedUser: boolean;
    public get LicencedUser() { return this.licencedUser; }
    public set LicencedUser(newValue: boolean) { if (this.licencedUser != newValue) { this.licencedUser = newValue; this.MarkAsDirty("LicencedUser"); } }
    ...
    public get IsFreelancer() { return this.isFreelancer; }
    public set IsFreelancer(newValue: boolean) { if (this.isFreelancer != newValue) { this.isFreelancer = newValue; this.MarkAsDirty("IsFreelancer"); } }
    ...
    public get IsBranchRestricted() { return this.isBranchRestricted; }
    public set IsBranchRestricted(newValue: boolean) { if (this.isBranchRestricted != newValue) { this.isBranchRestricted = newValue; this.MarkAsDirty("IsBranchRestricted"); } }
    ...
    public set ExpirationDaysLeft(newValue: number) { if (this.expirationDaysLeft != newValue) { this.expirationDaysLeft = newValue; this.MarkAsDirty("ExpirationDaysLeft"); } }
       
	 
    private isProductRestricted: boolean;
    public get IsProductRestricted() { return this.isProductRestricted; }
    ...
    public get RoleCode() { return this.roleCode; }
    public set RoleCode(newValue: string) { if (this.roleCode != newValue) { this.roleCode = newValue; this.MarkAsDirty("RoleCode"); } }
    ...
    public get PersonalId() { return this.personalId; }
    ...
    public get IsDistributor() { return this.isDistributor; }
    public set IsDistributor(newValue: boolean) { if (this.isDistributor != newValue) { this.isDistributor = newValue; this.MarkAsDirty("IsDistributor"); } }
    ...
    public get EntityChanged() { return this.entityChanged; }
    public set EntityChanged(newValue: boolean) { if (this.entityChanged != newValue) { this.entityChanged = newValue; this.MarkAsDirty("EntityChanged"); } }
       
	 
    private activeModified: number;
    public get ActiveModified() { return this.activeModified; }
    public set ActiveModified(newValue: number) { if (this.activeModified != newValue) { this.activeModified = newValue; this.MarkAsDirty("ActiveModified"); } }
    ...
    public get IsCustomerCare() { return this.isCustomerCare; }
    public set IsCustomerCare(newValue: boolean) { if (this.isCustomerCare != newValue) { this.isCustomerCare = newValue; this.MarkAsDirty("IsCustomerCare"); } }
    ...
    public get UserRolesNamesList() { return this.userRolesNamesList; }
    public set UserRolesNamesList(newValue: string) { if (this.userRolesNamesList != newValue) { this.userRolesNamesList = newValue; this.MarkAsDirty("UserRolesNamesList"); } }
       
	 
    private userRolesNamesList_db: string;
    public get UserRolesNamesList_db() { return this.userRolesNamesList_db; }
    public set UserRolesNamesList_db(newValue: string) { if (this.userRolesNamesList_db != newValue) { this.userRolesNamesList_db = newValue; this.MarkAsDirty("UserRolesNamesList_db"); } }
       
	 
    private documentFilingInbox: string;
    public get DocumentFilingInbox() { return this.documentFilingInbox; }
    public set DocumentFilingInbox(newValue: string) { if (this.documentFilingInbox != newValue) { this.documentFilingInbox = newValue; this.MarkAsDirty("DocumentFilingInbox"); } }
       
	 
    private showLogBoxToolTip: boolean;
    public get ShowLogBoxToolTip() { return this.showLogBoxToolTip; }
    public set ShowLogBoxToolTip(newValue: boolean) { if (this.showLogBoxToolTip != newValue) { this.showLogBoxToolTip = newValue; this.MarkAsDirty("ShowLogBoxToolTip"); } }
       
	 
    private showInboxToolTip: boolean;
    public get ShowInboxToolTip() { return this.showInboxToolTip; }
