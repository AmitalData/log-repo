...
import {CustomerTenantAccessRequestPM} from '../../EntityPMs/CustomerTenantAccessRequestPM';
...
export class CustomerTenantAccessRequestExtendedPMService {
 ...
 insert(entityPM: CustomerTenantAccessRequestPM) {
    ...
    update(entityPM: CustomerTenantAccessRequestPM) {
	  ...
	  MapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: CustomerTenantAccessRequestPM = null) {

         
        if (!entityPM) {
            
            entityPM = new CustomerTenantAccessRequestPM();
        }
	  ...
	  public clone(jsonPM: any) {
        ...
        return entityPM;
		  ...
		  public GetNewEntityPM() {		 
		    var entityPM: CustomerTenantAccessRequestPM;
			entityPM = new CustomerTenantAccessRequestPM();
