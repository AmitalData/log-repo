...
import {HybridTenantThresholdList} from '../../EntityLists/HybridTenantThresholdList';

@Injectable()

export class HybridTenantThresholdListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<HybridTenantThresholdList> = [];
    constructor() {
			...
			return this._http.get(this._apiUrl + '/getsingle/?' + 'tenant=' + tenant, ServiceHelper.GetHttpFullHeaders())
				.pipe(			
					map((response: HttpResponse<any>) => {
						...
						var entity: HybridTenantThresholdList;
						if (list) {
			...
			return this._http.get(this._apiUrl + '/getall', ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						var _mappedListsArray: Array<HybridTenantThresholdList> = [];
						if (allLists) {
							for (var key in allLists) {				
								var entity: HybridTenantThresholdList = this.MapJsonToEntityList(allLists[key]);
						...
						var servertime = response.headers.get('ServerExecutionTime');
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "HybridTenantThreshold", "GetAllLists", ""); 
	...
	getByFilters(filters: ApiQueryFilters) {
					...
					map((response: HttpResponse<any>) => {
						...
						if (serviceResponse.Result) {
							for (var key in serviceResponse.Result) {				
								var entity: HybridTenantThresholdList = this.MapJsonToEntityList(serviceResponse.Result[key]);
								_mappedListsArray.push(entity);
							}
						}   
						...
						var servertime = response.headers.get('ServerExecutionTime');
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "HybridTenantThreshold", "GetByFilters", "PageIndex:" +filters.PageIndex +", PageSize:"+filters.PageSize + ", GetAll:" + filters.GetAll);
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: HybridTenantThresholdList;
            entityList = new HybridTenantThresholdList();
