...
export class AgentSharedManifestListService {
	private _http: HttpClient;
    private _apiUrl: string;   
	public static CachedData: Array<AgentSharedManifestList> = [];
    constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/agentsharedmanifestviews';  
    }
			...
			return this._http.get(this._apiUrl + '/getsingle/?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(			
					map((response: HttpResponse<any>) => {
						...
						var entity: AgentSharedManifestList;
						if (list) {
			...
			return this._http.get(this._apiUrl + '/getall', ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						var _mappedListsArray: Array<AgentSharedManifestList> = [];
						if (allLists) {
							for (var key in allLists) {				
								var entity: AgentSharedManifestList = this.MapJsonToEntityList(allLists[key]);
	...
	getByFilters(filters: ApiQueryFilters) {
					...
					map((response: HttpResponse<any>) => {
						...
						if (serviceResponse.Result) {
							for (var key in serviceResponse.Result) {				
								var entity: AgentSharedManifestList = this.MapJsonToEntityList(serviceResponse.Result[key]);
								_mappedListsArray.push(entity);
							}
						}   
	    ...
	    MapJsonToEntityList(jsonList: any) {
            ...
            var entityList: AgentSharedManifestList;
            entityList = new AgentSharedManifestList();
