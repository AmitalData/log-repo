	...
	insert(entityPM: CarrierAreaPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: CarrierAreaPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: CarrierAreaPM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapCarrierAreasPorts(entityPM: CarrierAreaPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.CarrierAreasPorts) {
            ...
            else
            {
 			...
 			newCarrierAreasPortPM.DisableMarkAsDirty = true;
            ...
            if (mapParent) {
			 ...
			 newCarrierAreasPortPM.DisableMarkAsDirty = false;
