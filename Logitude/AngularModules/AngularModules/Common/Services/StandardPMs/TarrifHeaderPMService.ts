	...
	insert(entityPM: TarrifHeaderPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: TarrifHeaderPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: TarrifHeaderPM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapTarrifCharges(entityPM: TarrifHeaderPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.TarrifCharges) {
            ...
            else
            {
 			...
 			newTarrifChargePM.DisableMarkAsDirty = true;
            ...
            if (mapParent) {
			 ...
			 newTarrifChargePM.DisableMarkAsDirty = false;
    ...
    MapTarrifFromToes(entityPM: TarrifHeaderPM, jsonPM: any, mapParent: boolean = true) {
        ...
        for (var item in jsonPM.TarrifFromToes) {
            ...
            else
            {
 			...
 			newTarrifFromToPM.DisableMarkAsDirty = true;
            ...
            if (mapParent) {
			 ...
			 newTarrifFromToPM.DisableMarkAsDirty = false;
