...
export class VendorPMService {
 private _http: HttpClient;
 private _apiUrl: string;
 constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/vendors';      
    }
			...
			return this._http.get(this._apiUrl + '/getsingle?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "Vendor", "GetSinglePM", 'id=' + id);
	...
	insert(entityPM: VendorPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: VendorPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: VendorPM = this.MapJsonToEntityPM(pm, true, entityPM);
								serviceResponse.Result = mappedResult;
							}						

							var servertime = response.headers.get('ServerExecutionTime');
							PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "Vendor", "SaveChanges", "");                    
	...
	update(entityPM: VendorPM) {
	  ...
	  MapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: VendorPM = null) {

         
        if (!entityPM) {
            
            entityPM = new VendorPM();
        }
    ...
    MapAddresses(entityPM: VendorPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapContacts(entityPM: VendorPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapCardExternalCodeByCurrencies(entityPM: VendorPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapCardCurrenciesAccountings(entityPM: VendorPM, jsonPM: any, mapParent: boolean = true) {
