...
export class AgentPMService {
 ...
 constructor() {
	...
	insert(entityPM: AgentPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: AgentPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: AgentPM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapCardCurrenciesAccountings(entityPM: AgentPM, jsonPM: any, mapParent: boolean = true) {
