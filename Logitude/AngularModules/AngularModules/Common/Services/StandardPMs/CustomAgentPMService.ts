...
export class CustomAgentPMService {
 private _http: HttpClient;
 private _apiUrl: string;
 constructor() {
        this._http = ServiceHelper.HttpClient;
        this._apiUrl = ServiceHelper.GetLogitudeURL() + 'api/customagents';      
    }
			...
			return this._http.get(this._apiUrl + '/getsingle?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "CustomAgent", "GetSinglePM", 'id=' + id);
	...
	insert(entityPM: CustomAgentPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: CustomAgentPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: CustomAgentPM = this.MapJsonToEntityPM(pm, true, entityPM);
								serviceResponse.Result = mappedResult;
							}						

							var servertime = response.headers.get('ServerExecutionTime');
							PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "CustomAgent", "SaveChanges", "");                    
	...
	update(entityPM: CustomAgentPM) {
	  ...
	  MapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: CustomAgentPM = null) {

         
        if (!entityPM) {
            
            entityPM = new CustomAgentPM();
        }
    ...
    MapAddresses(entityPM: CustomAgentPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapContacts(entityPM: CustomAgentPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapCardExternalCodeByCurrencies(entityPM: CustomAgentPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapCardCurrenciesAccountings(entityPM: CustomAgentPM, jsonPM: any, mapParent: boolean = true) {
