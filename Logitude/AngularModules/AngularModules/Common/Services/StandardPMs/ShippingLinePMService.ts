...
export class ShippingLinePMService {
 ...
 constructor() {
	...
	insert(entityPM: ShippingLinePM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: ShippingLinePM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: ShippingLinePM = this.MapJsonToEntityPM(pm, true, entityPM);
    ...
    MapCardCurrenciesAccountings(entityPM: ShippingLinePM, jsonPM: any, mapParent: boolean = true) {
