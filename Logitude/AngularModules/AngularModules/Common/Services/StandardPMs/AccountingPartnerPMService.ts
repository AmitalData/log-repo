...
export class AccountingPartnerPMService {
 ...
 constructor() {
			...
			return this._http.get(this._apiUrl + '/getsingle?' + 'id=' + id, ServiceHelper.GetHttpFullHeaders())
				.pipe(
					map((response: HttpResponse<any>) => {
						...
						var entity: AccountingPartnerPM;
						if (pm) {
						...
						PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "AccountingPartner", "GetSinglePM", 'id=' + id);
	...
	insert(entityPM: AccountingPartnerPM) {
		...
		return defer(() => {
			...
			var errorsArray = validator.Validate("AccountingPartner", entityPM);


			if (errorsArray.length == 0) {

				var mappedEntity: AccountingPartnerPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: AccountingPartnerPM = this.MapJsonToEntityPM(pm, true, entityPM);
								serviceResponse.Result = mappedResult;
							}						

							var servertime = response.headers.get('ServerExecutionTime');
							PerformanceLogger.InsertPerformanceLog(callTime, new Date(), Number(servertime), "AccountingPartner", "SaveChanges", "");                    
	...
	update(entityPM: AccountingPartnerPM) {
	  ...
	  MapJsonToEntityPM(jsonPM: any, mapParent: boolean = true, entityPM: AccountingPartnerPM = null) {
    ...
    MapAddresses(entityPM: AccountingPartnerPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapContacts(entityPM: AccountingPartnerPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapCardExternalCodeByCurrencies(entityPM: AccountingPartnerPM, jsonPM: any, mapParent: boolean = true) {
    ...
    MapCardCurrenciesAccountings(entityPM: AccountingPartnerPM, jsonPM: any, mapParent: boolean = true) {
	  ...
	  public GetNewEntityPM() {		 
		    var entityPM: AccountingPartnerPM;
			entityPM = new AccountingPartnerPM();
