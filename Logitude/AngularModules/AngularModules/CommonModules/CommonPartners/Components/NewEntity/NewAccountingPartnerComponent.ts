...
@Component({
    ...
    templateUrl: './NewAccountingPartnerComponent.html',
})

export class NewAccountingPartnerComponent {
    public EntityPM: AccountingPartnerPM;
    public PartnerTypeId: string = "AC";
    ...
    constructor() {
        this.EntityPM = new AccountingPartnerPM();
    ...
    OkButtonClicked() {
        ...
        if (errors.length == 0) {
            ...
            args.AccountingPartner = this.EntityPM;
            ...
            this.DomainService.PostPartnerAddress(args).subscribe((myResponse: ServiceResponse) => {
                ...
                if (!myResponse.HasError) {
                    this.EntityPM = myResponse.Result.AccountingPartner;
