    ...
    constructor(private CD: ChangeDetectorRef) {
        ...
        if (!AppTool.IsNullOrEmpty(SessionLocator.TenantPM.ProfitCurrencyId)) {
            this._currencyListService.getAllFromCache().subscribe(result => {
                ...
                this.CustomerProductionRevenueHeader = TextCodeTranslator.Translate("CustomerProductLocation.F.CommitmentRevenue") + " (" + this.myCurrencyCode + ")";
            });
        }
        else {
            this.CustomerProductionRevenueHeader = TextCodeTranslator.Translate("CustomerProductLocation.F.CommitmentRevenue");
        }
    }
