...
export class AirlineSurchargeTabComponent extends BaseComponent implements OnInit {
...
export class TariffHeaderItem extends BaseComponent {
    ...
    constructor(entityPM: TarrifHeaderPM, private isNew: boolean, public fatherComponent: AirlineSurchargeTabComponent, public CD: ChangeDetectorRef) {
        super();
