...
export class QuoteOPMenuButtonsHandler {
            ...
            if (this.entityArgs.EditComponent != null) {
                ...
                for (var i = 0; i < menuButtons.length; i++) {
                    ...
                    if (button.EventCode == "BuildShipment") {
                        ...
                        var myDeclinedStage: QuoteOPStageList = this.allStages.filter(d => d.Code == "QTDC")[0];
                    ...
                    if (button.EventCode == "SetAsSentToCustomer") {
                        ...
                        var mySentStage: QuoteOPStageList = this.allStages.filter(d => d.Code == "QTST")[0];
                    ...
                    if (button.EventCode == "CancelQuote") {
                        ...
                        var myCreatedStage: QuoteOPStageList = this.allStages.filter(d => d.Code == "QTCR")[0];
    ...
    private myQuoteOPStageListService: QuoteOPStageListService;
    ...
    Validate() {
        var validator = new QuoteOPValidator();
    ...
    private BuildShipment() {
        ...
        if (this.isValid) {
            if (this.EntityPM.QuoteTypeCode != "A") {
                ...
                var list: QuoteOPStageList = this.allStages.filter(d => d.Id == this.EntityPM.StageId)[0];
    ...
    private OpenQuotationWindow() {
        ...
        if (quoteCharges != null && quoteCharges.length > 0) {
            ...
            var windowArgs: any = {};
            windowArgs.QuoteOPPM = this.EntityPM;
            var logWindow = new LogitudeWindow();
