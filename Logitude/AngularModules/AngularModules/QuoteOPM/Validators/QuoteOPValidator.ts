...
export class QuoteOPValidator {  
    ...
    private ValidateFCLDuplicatedPackages(entityPM: QuoteOPPM, errors: string[]) {
    ...
    private ValidateCharge(charge: QuoteOPChargePM, errors: string[]) {
    ...
    public CheckDuplicateInCharges(entitpPM: QuoteOPPM, charge: QuoteOPChargePM, errors: string[]) {
