...
export class QuoteOPPMInitService {

    public static InitValues(entityPM: QuoteOPPM, isNew: boolean) {
        if (isNew) {
    ...
    public static ApplyUIPoperties(entityPM: QuoteOPPM, isNew: boolean) {
