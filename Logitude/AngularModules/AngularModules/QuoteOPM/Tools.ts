...
export class QuoteTool {
    ...
    public static OnQuoteQuantitiesChanged(entityPM: QuoteOPPM) {
        if (entityPM) {
    ...
    public static IsQuoteStageDraft(entityPM: QuoteOPPM) {
        var myResult: boolean = true;
        ...
        if (entityPM != null) {
            ...
            myService.getAllFromCache().subscribe((resp: any) => {
                if (!resp.HasError) {
                    ...
                    var draftStageId = "";
                    var draftStage: QuoteOPStageList = allStages.filter(d => d.Code == "QTDR")[0];
    ...
    public static CheckUpdateQuantities(entityPM: QuoteOPPM) {
    ...
    private static CheckUpdateQuantities_LCL(entityPM: QuoteOPPM) {
        var myResult: boolean = false;
    ...
    private static CheckUpdateMessageforPFCL(entityPM: QuoteOPPM): boolean {
    ...
    private static CheckUpdateQuantities_FCL(entityPM: QuoteOPPM) {
        var myResult: boolean = false;
