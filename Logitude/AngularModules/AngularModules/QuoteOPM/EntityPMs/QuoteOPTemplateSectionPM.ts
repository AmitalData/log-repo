...
export class QuoteOPTemplateSectionPM {
    ...
    private quoteOPTemplateSectionTypeCode: string;
    public get QuoteOPTemplateSectionTypeCode() { return this.quoteOPTemplateSectionTypeCode; }
    public set QuoteOPTemplateSectionTypeCode(newValue: string) { if (this.quoteOPTemplateSectionTypeCode != newValue) { this.quoteOPTemplateSectionTypeCode = newValue; this.MarkAsDirty("QuoteOPTemplateSectionTypeCode"); } }
    ...
    public OldEntityPM: QuoteOPTemplateSectionPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QuoteOPTemplateSection");
           
        }
       }
    }

    private MyClone: QuoteOPTemplateSectionPM;
