...
export class QuoteOPTemplateHeaderFieldPM {
    ...
    public OldEntityPM: QuoteOPTemplateHeaderFieldPM;
    ...
    MarkAsDirty(propertyName: string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QuoteTemplateHeaderField");

        }
    }
    private MyClone: QuoteOPTemplateHeaderFieldPM;
