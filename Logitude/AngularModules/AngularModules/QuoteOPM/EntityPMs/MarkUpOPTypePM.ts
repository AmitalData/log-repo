...
export class MarkUpOPTypePM {
    ...
    public OldEntityPM: MarkUpOPTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "MarkUpOPType");
           
        }
       }
    }

    private MyClone: MarkUpOPTypePM;
