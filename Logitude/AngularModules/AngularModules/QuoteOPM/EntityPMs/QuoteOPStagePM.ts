...
export class QuoteOPStagePM {
    ...
    public OldEntityPM: QuoteOPStagePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QuoteOPStage");
           
        }
       }
    }

    private MyClone: QuoteOPStagePM;
