...
export class QuoteOPComputedFieldPM {
    ...
    public OldEntityPM: QuoteOPComputedFieldPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QuoteOPComputedField");
           
        }
       }
    }

    private MyClone: QuoteOPComputedFieldPM;
