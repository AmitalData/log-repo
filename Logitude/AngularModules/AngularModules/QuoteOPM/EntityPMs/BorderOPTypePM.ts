...
export class BorderOPTypePM {
    ...
    public OldEntityPM: BorderOPTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BorderOPType");
           
        }
       }
    }

    private MyClone: BorderOPTypePM;
