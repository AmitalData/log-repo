...
export class OPSpecialServicesTypePM {
    ...
    public OldEntityPM: OPSpecialServicesTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "OPSpecialServicesType");
           
        }
       }
    }

    private MyClone: OPSpecialServicesTypePM;
