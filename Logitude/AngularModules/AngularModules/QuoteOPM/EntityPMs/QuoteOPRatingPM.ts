...
export class QuoteOPRatingPM {
    ...
    public OldEntityPM: QuoteOPRatingPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QuoteOPRating");
           
        }
       }
    }

    private MyClone: QuoteOPRatingPM;
