...
export class ShipmentFiltersMenuComponent implements AfterViewInit {
    ...
    constructor() {
        if (SessionLocator.CurrentSession == null) {
            ...
            var index_T = SessionLocator.CurrentSession.GetNewId("ShipmentTransportFilterMenu");
            var index_D = SessionLocator.CurrentSession.GetNewId("ShipmentDirectionFilterMenu");
