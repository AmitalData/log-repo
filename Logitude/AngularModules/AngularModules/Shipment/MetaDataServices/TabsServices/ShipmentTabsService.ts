...
export class ShipmentTabsService implements IObjectTableTabsService {
   
    GetTabs(args: any): ObjectTableTabPM[] {

      return  window.ObjectTableTabs.filter(d => d.ObjectTableId === args.ObjectTableId && d.Code == "SHAU");
    }
