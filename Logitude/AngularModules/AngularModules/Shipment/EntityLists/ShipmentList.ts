...
export class ShipmentList {
		...
		WarehouseLeg2WarehouseId: string;
		WarehouseLeg2AddressId: string;
		WarehouseLeg2TerminalCode: string;
		WarehouseLeg2ExpectedEntryDate: Date;
		WarehouseLeg2ActualEntryDate: Date;
		WarehouseLeg2ExpectedReleaseDate: Date;
		WarehouseLeg2ActualReleaseDate: Date;
		WarehouseLeg2Remarks: string;
		WarehouseLeg2Reference: string;
		WarehouseLeg2TerminalName: string;
		WarehouseLeg2EntryDate: Date;
		WarehouseLeg2ReleaseDate: Date;
		WarehouseLeg2AddressCountryName: string;
		WarehouseLeg2AddressCountryCode: string;
		WarehouseLeg2VGMCutOffDate: Date;
		WarehouseLeg2CutOffDate: Date;
		...
		TimeLineData: string;
		Transshipment1ATD: Date;
		Transshipment1ATA: Date;
		Transshipment1ETD: Date;
		Transshipment1ETA: Date;
		Transshipment2ATD: Date;
		Transshipment2ATA: Date;
		Transshipment2ETD: Date;
		Transshipment2ETA: Date;
		Transshipment3ATD: Date;
		Transshipment3ATA: Date;
		Transshipment3ETD: Date;
		Transshipment3ETA: Date;
		InlandDomesticFromCity: string;
		InlandDomesticToCity: string;
		InlandDomesticToTypeCode: string;
