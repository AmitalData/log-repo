...
export class PackagesTabComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    private SetLabels() {
        this.VolumeLabel = TextCodeTranslator.Translate("QuoteOP.F.Volume").replace("%VolumeCode", this.EntityPM.VolumeUnitCode);
        this.GrossWeightLabel = TextCodeTranslator.Translate("QuoteOP.F.GrossWeight").replace("%GrossWeightCode", this.EntityPM.GrossWeightUnitCode);

        if (this.EntityPM.TransportModeId == "A") {
            this.ChargeableWeightLabel = TextCodeTranslator.Translate("QuoteOP.F.ChargeableWeight").replace("%ChargWeightCode", this.EntityPM.ChargeableWeightUnitCode);
            this.ChargeableWeightUnitCodeLabel = TextCodeTranslator.Translate("QuoteOP.F.ChargeableWeightUnitCode");
        }

        else {
            this.ChargeableWeightLabel = TextCodeTranslator.Translate("QuoteOP.F.ChargeableWeight.Short").replace("%ChargWeightCode", this.EntityPM.ChargeableWeightUnitCode);
    ...
    EditPackageClicked(itemComponent: QuotePackageItem) {
        this.RunAddEditPackage(itemComponent, TextCodeTranslator.Translate("QuoteOP.S.Packages.EditPackage"));
    }
    ...
    DeletePackageClicked(itemComponent: QuotePackageItem) {
        ...
        confirmWindow.Show(TextCodeTranslator.Translate("QuoteOP.M.DeleteThisPackage"));
