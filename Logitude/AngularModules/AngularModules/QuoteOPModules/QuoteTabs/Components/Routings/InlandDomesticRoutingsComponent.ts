...
export class InlandDomesticRoutingsComponent extends BaseComponent implements OnDestroy {
    ...
    private SetLabels() {
        this.CarrierLabel = "QuoteOP.S.NewQuote.Carrier";

        switch (this.EntityPM.TransportModeId) {
            case "A": {
                this.CarrierLabel = "QuoteOP.S.NewQuote.Airline";
                this.CarrierDependencyProperty1 = "AL";
                break;
            }

            case "O": {
                this.CarrierLabel = "QuoteOP.S.NewQuote.Shippingline";
                this.CarrierDependencyProperty1 = "SL";
                break;
            }

            case "I": {
                this.CarrierLabel = "QuoteOP.S.NewQuote.Trucker";
