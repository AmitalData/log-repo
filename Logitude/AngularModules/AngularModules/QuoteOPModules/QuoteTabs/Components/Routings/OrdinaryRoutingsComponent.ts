...
export class OrdinaryRoutingsComponent extends BaseComponent implements OnDestroy {
    ...
    private SetLabels() {
        this.FromLabel = "QuoteOP.S.NewQuote.From";
        this.ToLabel = "QuoteOP.S.NewQuote.To";
        this.CarrierLabel = "QuoteOP.S.NewQuote.Carrier";

        switch (this.EntityPM.TransportModeId) {
            case "A": {
                this.FromLabel = "QuoteOP.S.NewQuote.Gateway";
                this.ToLabel = "QuoteOP.S.NewQuote.Destination";
            ...
            case "O": {
                this.FromLabel = "QuoteOP.S.NewQuote.LoadingPort";
                this.ToLabel = "QuoteOP.S.NewQuote.DischargePort";
    ...
    EditAddressClicked(myAddressCode: string) {
        ...
        if (!AppTool.IsNullOrEmpty(myAddressId) && !AppTool.IsNullOrEmpty(myPartnerId)) {
            ...
            logeWindow.Title = TextCodeTranslator.Translate("QuoteOP.S.Routings.EditAddress");
    ...
    AddAddressClicked(myAddressCode: string) {
        ...
        if (entityPM != null && !AppTool.IsNullOrEmpty(myPartnerId)) {
            ...
            logeWindow.Width = 630;
            logeWindow.Height = 430;
            logeWindow.Title = TextCodeTranslator.Translate("QuoteOP.S.Routings.AddAddress");
