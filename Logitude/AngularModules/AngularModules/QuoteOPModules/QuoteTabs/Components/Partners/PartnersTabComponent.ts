...
export class PartnersTabComponent implements OnInit, OnDestroy {
    ...
    AddPartner(myCode: string) {
        ...
        var myWindowTitle: string = TextCodeTranslator.Translate("QuoteOP.S.Partners.Add" + newPartnerItem.FullCode);        
    ...
    EditPartner(myPartnerItem: PartnerItem) {
        ...
        var myWindowTitle: string = TextCodeTranslator.Translate("QuoteOP.S.Partners.Edit" + myPartnerItem.FullCode); 
    ...
    DeletePartner(myPartnerItem: PartnerItem) {
        if (myPartnerItem.IsEditingEnabled) {
            ...
            confirmWindow.Show(TextCodeTranslator.Translate("QuoteOP.M.DeleteThisPartner"));
...
export class PartnerItem extends BaseComponent {
    ...
    InitializeProperties() {
        ...
        this.PartnerTypeName = TextCodeTranslator.Translate("QuoteOP.F." + this.FullCode + "Id");
    }
