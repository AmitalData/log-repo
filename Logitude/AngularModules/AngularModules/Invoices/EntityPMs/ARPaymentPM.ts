...
export class ARPaymentPM {
    ...
    public AddARPaymentInvoice(item: ARPaymentInvoicePM) {
        if (item != null) {
    ...
    public RemoveARPaymentInvoice(item: ARPaymentInvoicePM) {
        if (item != null) {
            var index = this. PaymentInvoices.indexOf(item);
            if (index > -1) {
    ...
    //public PaymentInvoices: Array<ARPaymentInvoicePM>= [];
    ...
    public AddARPaymentChequeReplica(item: ARPaymentChequeReplicaPM) {
        if (item != null) {
    ...
    public RemoveARPaymentChequeReplica(item: ARPaymentChequeReplicaPM) {
        if (item != null) {
            var index = this. ARPaymentChequeReplicas.indexOf(item);
            if (index > -1) {
    ...
    //public ARPaymentChequeReplicas: Array<ARPaymentChequeReplicaPM>= [];
	...
	private reconcileExternalPagesIds: ElasticPM[];
    get  ReconcileExternalPagesIds() {
        if (this.reconcileExternalPagesIds == null) {
            this.reconcileExternalPagesIds = [];
        }

        return this.reconcileExternalPagesIds;
    }
    set  ReconcileExternalPagesIds(newValue: ElasticPM[]) {
        if (this.reconcileExternalPagesIds != newValue) {
            this.reconcileExternalPagesIds = newValue;
        }
    }
    ...
    public AddARPaymentBankTranfer(item: ARPaymentBankTranferPM) {
        if (item != null) {
    ...
    public RemoveARPaymentBankTranfer(item: ARPaymentBankTranferPM) {
        if (item != null) {
            var index = this. ARPaymentBankTranfers.indexOf(item);
            if (index > -1) {
    ...
    //public ARPaymentBankTranfers: Array<ARPaymentBankTranferPM>= [];
