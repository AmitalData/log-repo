...
export class APInvoiceStatusPM {
    ...
    public OldEntityPM: APInvoiceStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "APInvoiceStatus");
           
        }
       }
    }

    private MyClone: APInvoiceStatusPM;
