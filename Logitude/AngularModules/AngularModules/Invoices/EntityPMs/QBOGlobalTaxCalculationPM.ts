...
export class QBOGlobalTaxCalculationPM {
    ...
    public OldEntityPM: QBOGlobalTaxCalculationPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "QBOGlobalTaxCalculation");
           
        }
       }
    }

    private MyClone: QBOGlobalTaxCalculationPM;
