...
export class ARInvoicePM {
    ...
    public AddARInvoiceLine(item: ARInvoiceLinePM) {
        if (item != null) {
    ...
    public RemoveARInvoiceLine(item: ARInvoiceLinePM) {
        if (item != null) {
            var index = this. InvoiceLines.indexOf(item);
            if (index > -1) {
    ...
    //public InvoiceLines: Array<ARInvoiceLinePM>= [];
    ...
    public AddARInvoicePayment(item: ARInvoicePaymentPM) {
        if (item != null) {
    ...
    public RemoveARInvoicePayment(item: ARInvoicePaymentPM) {
        if (item != null) {
            var index = this. InvoicePayments.indexOf(item);
            if (index > -1) {
    ...
    //public InvoicePayments: Array<ARInvoicePaymentPM>= [];
    ...
    public AddConstituent(item: ConstituentPM) {
        if (item != null) {
    ...
    public RemoveConstituent(item: ConstituentPM) {
        if (item != null) {
            var index = this. ConstituentInvoices.indexOf(item);
            if (index > -1) {
    ...
    //public ConstituentInvoices: Array<ConstituentPM>= [];
    ...
    public AddARInvoiceTotalVAT(item: ARInvoiceTotalVATPM) {
        if (item != null) {
    ...
    public RemoveARInvoiceTotalVAT(item: ARInvoiceTotalVATPM) {
        if (item != null) {
            var index = this. TotalVATs.indexOf(item);
            if (index > -1) {
    ...
    //public TotalVATs: Array<ARInvoiceTotalVATPM>= [];
    ...
    private totalExamptFortaxReport: number;
    public get TotalExamptFortaxReport() { return this.totalExamptFortaxReport; }
    public set TotalExamptFortaxReport(newValue: number) { if (this.totalExamptFortaxReport != newValue) { this.totalExamptFortaxReport = newValue; this.MarkAsDirty("TotalExamptFortaxReport"); } }
    ...
    private totalAmountNotForTaxReport: number;
    public get TotalAmountNotForTaxReport() { return this.totalAmountNotForTaxReport; }
    public set TotalAmountNotForTaxReport(newValue: number) { if (this.totalAmountNotForTaxReport != newValue) { this.totalAmountNotForTaxReport = newValue; this.MarkAsDirty("TotalAmountNotForTaxReport"); } }
    ...
    private isAutoCredited: boolean;
    public get IsAutoCredited() { return this.isAutoCredited; }
    public set IsAutoCredited(newValue: boolean) { if (this.isAutoCredited != newValue) { this.isAutoCredited = newValue; this.MarkAsDirty("IsAutoCredited"); } }
    ...
    private isSignedName: string;
    public get IsSignedName() { return this.isSignedName; }
    public set IsSignedName(newValue: string) { if (this.isSignedName != newValue) { this.isSignedName = newValue; this.MarkAsDirty("IsSignedName"); } }
