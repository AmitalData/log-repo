...
export class ARPaymentTransferStatusPM {
    ...
    public OldEntityPM: ARPaymentTransferStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARPaymentTransferStatus");
           
        }
       }
    }

    private MyClone: ARPaymentTransferStatusPM;
