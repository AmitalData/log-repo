...
export class APInvoiceTypePM {
    ...
    public OldEntityPM: APInvoiceTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "APInvoiceType");
           
        }
       }
    }

    private MyClone: APInvoiceTypePM;
