...
export class AccountTypePM {
    ...
    public OldEntityPM: AccountTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AccountType");
           
        }
       }
    }

    private MyClone: AccountTypePM;
