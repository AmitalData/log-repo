...
export class ARInvoiceStatusPM {
    ...
    public OldEntityPM: ARInvoiceStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARInvoiceStatus");
           
        }
       }
    }

    private MyClone: ARInvoiceStatusPM;
