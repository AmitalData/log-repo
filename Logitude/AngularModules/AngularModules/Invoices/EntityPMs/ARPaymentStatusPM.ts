...
export class ARPaymentStatusPM {
    ...
    public OldEntityPM: ARPaymentStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARPaymentStatus");
           
        }
       }
    }

    private MyClone: ARPaymentStatusPM;
