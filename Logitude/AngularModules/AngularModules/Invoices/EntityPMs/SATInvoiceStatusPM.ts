...
export class SATInvoiceStatusPM {
    ...
    public OldEntityPM: SATInvoiceStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "SATInvoiceStatus");
           
        }
       }
    }

    private MyClone: SATInvoiceStatusPM;
