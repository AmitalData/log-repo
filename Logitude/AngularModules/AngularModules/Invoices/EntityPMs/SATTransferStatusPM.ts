...
export class SATTransferStatusPM {
    ...
    public OldEntityPM: SATTransferStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "SATTransferStatus");
           
        }
       }
    }

    private MyClone: SATTransferStatusPM;
