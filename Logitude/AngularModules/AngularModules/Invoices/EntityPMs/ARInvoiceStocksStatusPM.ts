...
export class ARInvoiceStocksStatusPM {
    ...
    public OldEntityPM: ARInvoiceStocksStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARInvoiceStocksStatus");
           
        }
       }
    }

    private MyClone: ARInvoiceStocksStatusPM;
