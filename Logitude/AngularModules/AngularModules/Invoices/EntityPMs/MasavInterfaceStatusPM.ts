...
export class MasavInterfaceStatusPM {
    ...
    public OldEntityPM: MasavInterfaceStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "MasavInterfaceStatus");
           
        }
       }
    }

    private MyClone: MasavInterfaceStatusPM;
