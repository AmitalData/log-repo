...
export class ARInvoiceTransferStatusPM {
    ...
    public OldEntityPM: ARInvoiceTransferStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARInvoiceTransferStatus");
           
        }
       }
    }

    private MyClone: ARInvoiceTransferStatusPM;
