...
export class ARInvoiceStockPM {
    ...
    public AddARInvoiceStockLine(item: ARInvoiceStockLinePM) {
        if (item != null) {
    ...
    public RemoveARInvoiceStockLine(item: ARInvoiceStockLinePM) {
        if (item != null) {
            var index = this. ARInvoiceStockLines.indexOf(item);
            if (index > -1) {
    ...
    //public ARInvoiceStockLines: Array<ARInvoiceStockLinePM>= [];
