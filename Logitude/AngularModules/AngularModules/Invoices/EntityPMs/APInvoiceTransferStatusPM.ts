...
export class APInvoiceTransferStatusPM {
    ...
    public OldEntityPM: APInvoiceTransferStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "APInvoiceTransferStatus");
           
        }
       }
    }

    private MyClone: APInvoiceTransferStatusPM;
