...
export class APInvoicePM {
    ...
    public AddAPInvoiceLine(item: APInvoiceLinePM) {
        if (item != null) {
    ...
    public RemoveAPInvoiceLine(item: APInvoiceLinePM) {
        if (item != null) {
            var index = this. InvoiceLines.indexOf(item);
            if (index > -1) {
    ...
    //public InvoiceLines: Array<APInvoiceLinePM>= [];
    ...
    public AddAPInvoiceEntity(item: APInvoiceEntityPM) {
        if (item != null) {
    ...
    public RemoveAPInvoiceEntity(item: APInvoiceEntityPM) {
        if (item != null) {
            var index = this. InvoiceEntities.indexOf(item);
            if (index > -1) {
    ...
    //public InvoiceEntities: Array<APInvoiceEntityPM>= [];
    ...
    public AddAPInvoicePayment(item: APInvoicePaymentPM) {
        if (item != null) {
    ...
    public RemoveAPInvoicePayment(item: APInvoicePaymentPM) {
        if (item != null) {
            var index = this. InvoicePayments.indexOf(item);
            if (index > -1) {
    ...
    //public InvoicePayments: Array<APInvoicePaymentPM>= [];
    ...
    public AddAPInvoiceMultipleShipment(item: APInvoiceMultipleShipmentPM) {
        if (item != null) {
    ...
    public RemoveAPInvoiceMultipleShipment(item: APInvoiceMultipleShipmentPM) {
        if (item != null) {
            var index = this. InvoiceMultipleShipments.indexOf(item);
            if (index > -1) {
    ...
    //public InvoiceMultipleShipments: Array<APInvoiceMultipleShipmentPM>= [];
    ...
    public AddAPTransferLine(item: APTransferLinePM) {
        if (item != null) {
    ...
    public RemoveAPTransferLine(item: APTransferLinePM) {
        if (item != null) {
            var index = this. TransferLines.indexOf(item);
            if (index > -1) {
    ...
    //public TransferLines: Array<APTransferLinePM>= [];
    ...
    public AddAPInvoiceTotalVAT(item: APInvoiceTotalVATPM) {
        if (item != null) {
    ...
    public RemoveAPInvoiceTotalVAT(item: APInvoiceTotalVATPM) {
        if (item != null) {
            var index = this. TotalVATs.indexOf(item);
            if (index > -1) {
    ...
    //public TotalVATs: Array<APInvoiceTotalVATPM>= [];
