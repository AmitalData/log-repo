...
export class ARInvoiceTypePM {
    ...
    public OldEntityPM: ARInvoiceTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ARInvoiceType");
           
        }
       }
    }

    private MyClone: ARInvoiceTypePM;
