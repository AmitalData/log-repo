...
export class SATPaymentMethodPM {
    ...
    public OldEntityPM: SATPaymentMethodPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "SATPaymentMethod");
           
        }
       }
    }

    private MyClone: SATPaymentMethodPM;
