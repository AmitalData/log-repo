	...
	insert(entityPM: AWBAdditionalHandlingInfoPM) {
		...
		return defer(() => {
			...
			if (errorsArray.length == 0) {
				...
				var mappedEntity: AWBAdditionalHandlingInfoPM = this.MapJsonToEntityPM(entityPM, false);
				...
				return this._http.post(this._apiUrl, JSON.stringify(mappedEntity), ServiceHelper.GetHttpFullHeaders())
					.pipe(
						map((response: HttpResponse<any>) => {
							...
							var pm = response.body;
							if (pm) {
								var mappedResult: AWBAdditionalHandlingInfoPM = this.MapJsonToEntityPM(pm, true, entityPM);
