...
export class ShipmentFiltersMenuComponent implements AfterViewInit {
    ...
    constructor() {
        if (this.CurrentSession == null) {
            ...
            var index_D = this.CurrentSession.GetNewId("ShipmentDirectionFilterMenu");
        ...
        if (FeatureLocator.HasFeaturePermession("Shipment", "IMPORTSHIPMETNS")) {
