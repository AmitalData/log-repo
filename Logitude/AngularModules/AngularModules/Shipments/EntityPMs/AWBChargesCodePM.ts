...
export class AWBChargesCodePM {
    ...
    public OldEntityPM: AWBChargesCodePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "AWBChargesCode");
           
        }
       }
    }

    private MyClone: AWBChargesCodePM;
