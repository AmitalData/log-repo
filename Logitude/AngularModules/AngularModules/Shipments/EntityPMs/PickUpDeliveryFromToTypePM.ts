...
export class PickUpDeliveryFromToTypePM {
    ...
    public OldEntityPM: PickUpDeliveryFromToTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "PickUpDeliveryFromToType");
           
        }
       }
    }

    private MyClone: PickUpDeliveryFromToTypePM;
