...
export class ShipmentReceivableStatusPM {
    ...
    public OldEntityPM: ShipmentReceivableStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ShipmentReceivableStatus");
           
        }
       }
    }

    private MyClone: ShipmentReceivableStatusPM;
