...
export class ShipmentCommodityPM {
    ...
    public AddCommodityPackage(item: CommodityPackagePM) {
        if (item != null) {
    ...
    public RemoveCommodityPackage(item: CommodityPackagePM) {
        if (item != null) {
            var index = this. CommodityPackages.indexOf(item);
            if (index > -1) {
    ...
    //public CommodityPackages: Array<CommodityPackagePM>= [];
