...
export class ShipmentPickUpDeliveryPackagePM {
    ...
    public AddPickUpDeliveryPackageHarmonize(item: PickUpDeliveryPackageHarmonizePM) {
        if (item != null) {
    ...
    public RemovePickUpDeliveryPackageHarmonize(item: PickUpDeliveryPackageHarmonizePM) {
        if (item != null) {
            var index = this. PickUpDeliveryPackageHarmonizes.indexOf(item);
            if (index > -1) {
    ...
    //public PickUpDeliveryPackageHarmonizes: Array<PickUpDeliveryPackageHarmonizePM>= [];
