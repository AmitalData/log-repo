...
export class ShipmentPayablePM extends ChildEntitiesCustomFieldPM {
    ...
    private childShipmentPayables: string;
    public get ChildShipmentPayables() { return this.childShipmentPayables; }
    public set ChildShipmentPayables(newValue: string) { if (this.childShipmentPayables != newValue) { this.childShipmentPayables = newValue; this.MarkAsDirty("ChildShipmentPayables"); } }
