...
export class ShipmentLevelPM {
    ...
    public OldEntityPM: ShipmentLevelPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ShipmentLevel");
           
        }
       }
    }

    private MyClone: ShipmentLevelPM;
