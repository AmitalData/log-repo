...
export class INTTRABookingTransStatusPM {
    ...
    public OldEntityPM: INTTRABookingTransStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "INTTRABookingTransStatus");
           
        }
       }
    }

    private MyClone: INTTRABookingTransStatusPM;
