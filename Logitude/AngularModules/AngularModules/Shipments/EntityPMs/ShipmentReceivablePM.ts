...
export class ShipmentReceivablePM extends ChildEntitiesCustomFieldPM {
    ...
    private childShipmentReceivables: string;
    public get ChildShipmentReceivables() { return this.childShipmentReceivables; }
    public set ChildShipmentReceivables(newValue: string) { if (this.childShipmentReceivables != newValue) { this.childShipmentReceivables = newValue; this.MarkAsDirty("ChildShipmentReceivables"); } }
