...
export class ShipmentDeliveryPM extends ChildEntitiesCustomFieldPM {
    ...
    private connectedPackageId: string;
    public get ConnectedPackageId() { return this.connectedPackageId; }
    public set ConnectedPackageId(newValue: string) { this.connectedPackageId = newValue; this.MarkAsDirty(); }   
    ...
    private allConnectedPackagesId: string[];
    public get AllConnectedPackagesId()
    {
    ...
    public OldEntityPM: ShipmentDeliveryPM;
