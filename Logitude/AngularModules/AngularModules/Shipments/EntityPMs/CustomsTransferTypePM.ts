...
export class CustomsTransferTypePM {
    ...
    public OldEntityPM: CustomsTransferTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "CustomsTransferType");
           
        }
       }
    }

    private MyClone: CustomsTransferTypePM;
