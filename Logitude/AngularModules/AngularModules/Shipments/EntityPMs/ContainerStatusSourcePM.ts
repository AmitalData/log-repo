...
export class ContainerStatusSourcePM {
    ...
    public OldEntityPM: ContainerStatusSourcePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "ContainerStatusSource");
           
        }
       }
    }

    private MyClone: ContainerStatusSourcePM;
