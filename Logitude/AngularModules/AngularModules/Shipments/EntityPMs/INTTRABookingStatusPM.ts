...
export class INTTRABookingStatusPM {
    ...
    public OldEntityPM: INTTRABookingStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "INTTRABookingStatus");
           
        }
       }
    }

    private MyClone: INTTRABookingStatusPM;
