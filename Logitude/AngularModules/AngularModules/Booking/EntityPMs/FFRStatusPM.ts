...
export class FFRStatusPM {
    ...
    public OldEntityPM: FFRStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "FFRStatus");
           
        }
    }

    private MyClone: FFRStatusPM;
