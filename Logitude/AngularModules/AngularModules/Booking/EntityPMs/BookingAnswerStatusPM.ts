...
export class BookingAnswerStatusPM {
    ...
    public OldEntityPM: BookingAnswerStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BookingAnswerStatus");
           
        }
    }

    private MyClone: BookingAnswerStatusPM;
