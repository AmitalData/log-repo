...
export class BookingProductPM {
    ...
    public OldEntityPM: BookingProductPM;
    ...
    MarkAsDirty(propertyName:string = null) {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "BookingProduct");
           
        }
    }

    private MyClone: BookingProductPM;
