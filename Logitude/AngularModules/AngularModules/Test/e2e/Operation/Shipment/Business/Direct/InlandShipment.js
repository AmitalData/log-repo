...
describe('DirectInlandShipment', function () {
    //it('Login', function () {
    //    Login();
    //});
    it('ExportInland-FTL Shipment', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewExportInlandFTLShipment();
    });
    it('ExportInland-LTL Shipment', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewExportInlandLTLShipment();
    });
    it('ImportInland-FTL Shipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewImportInlandFTLShipment();
    });
    it('ImportInland-LTL Shipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewImportInlandLTLShipment();
    });
    it('DomesticInland-FTL Shipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewDomesticInlandFTLShipment();
    });
    it('DomesticInland-LTL Shipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewDomesticInlandLTLShipment();
    });
    it('DropInland-FTL Shipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
        NewDropInlandFTLShipment();
    });
    it('DropInland-LTL Shipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenDirectWizard();
