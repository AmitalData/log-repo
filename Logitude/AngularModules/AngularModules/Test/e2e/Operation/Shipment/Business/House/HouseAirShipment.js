...
describe('HouseAirShipment', function () {
    //it('Login', function () {
    //    Login();
    //});
    it('ExportAirShipment', function () {
        GoToOperation();
        GoToShipments();
        OpenHouseWizard();
        NewExportAirShipment();
    });
    it(' ImportAirShipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenHouseWizard();
    ...
    it(' DomesticAirShipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenHouseWizard();
        NewDomesticAirShipment();
    });
    it(' DropAirShipment ', function () {
        GoToOperation();
        GoToShipments();
        OpenHouseWizard();
        NewDropAirShipment();
