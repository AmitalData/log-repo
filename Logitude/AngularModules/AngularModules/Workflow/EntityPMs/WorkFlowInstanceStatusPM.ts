...
export class WorkFlowInstanceStatusPM {
    ...
    public OldEntityPM: WorkFlowInstanceStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "WorkFlowInstanceStatus");
           
        }
       }
    }

    private MyClone: WorkFlowInstanceStatusPM;
