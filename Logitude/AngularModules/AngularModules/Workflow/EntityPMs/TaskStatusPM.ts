...
export class TaskStatusPM {
    ...
    public set Closed(newValue: boolean) { if (this.closed != newValue) { this.closed = newValue; this.MarkAsDirty("Closed"); } }
    ...
    public OldEntityPM: TaskStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaskStatus");
           
        }
       }
    }

    private MyClone: TaskStatusPM;
