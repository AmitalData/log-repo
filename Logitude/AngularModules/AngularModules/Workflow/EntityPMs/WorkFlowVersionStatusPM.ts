...
export class WorkFlowVersionStatusPM {
    ...
    public OldEntityPM: WorkFlowVersionStatusPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "WorkFlowVersionStatus");
           
        }
       }
    }

    private MyClone: WorkFlowVersionStatusPM;
