...
export class WorkFlowTriggerTypePM {
    ...
    public OldEntityPM: WorkFlowTriggerTypePM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "WorkFlowTriggerType");
           
        }
       }
    }

    private MyClone: WorkFlowTriggerTypePM;
