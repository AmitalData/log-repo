...
export class TaskPriorityPM {
    ...
    public get DisplayOrder() { return this.displayOrder; }
    public set DisplayOrder(newValue: number) { if (this.displayOrder != newValue) { this.displayOrder = newValue; this.MarkAsDirty("DisplayOrder"); } }
    ...
    public OldEntityPM: TaskPriorityPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "TaskPriority");
           
        }
       }
    }

    private MyClone: TaskPriorityPM;
