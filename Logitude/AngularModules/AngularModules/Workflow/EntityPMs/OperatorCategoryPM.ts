...
export class OperatorCategoryPM {
    ...
    public OldEntityPM: OperatorCategoryPM;
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "OperatorCategory");
           
        }
       }
    }

    private MyClone: OperatorCategoryPM;
