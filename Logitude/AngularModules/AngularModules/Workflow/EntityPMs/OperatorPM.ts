...
export class OperatorPM {
    ...
    private sign: string;
    public get Sign() { return this.sign; }
    public set Sign(newValue: string) { if (this.sign != newValue) { this.sign = newValue; this.MarkAsDirty("Sign"); } }
    ...
    MarkAsDirty(propertyName:string = null) {
       if(!this.DisableMarkAsDirty)
       {
        ...
        if (propertyName != null) {
            ...
            ServiceLocator.RulesValidator.ApplyEntityChangedRules(propertyName, this, "Operator");
           
        }
       }
    }

    private MyClone: OperatorPM;
