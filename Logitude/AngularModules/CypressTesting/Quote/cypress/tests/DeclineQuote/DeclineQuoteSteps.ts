...
Then("the quote should appear in all quotes list", () => {
  QuotesActions.AssertQuoteExistInCorrectList(QuoteSelectors.AllQuoteQuery, quoteDetails.QuoteNumber);
  QuotesActions.AssertQuoteSatgeHaveDeclineValue()
});
//#endregion