export class URLs {
    ...
    public static readonly Journals = "**/journals";IsChangedSelectors1
    ...
    public static readonly IsChanged = '**/declarations';
    public static readonly Pay = '**/DeclarationWebService';

    public static readonly supplierinvoices = '**/supplierinvoices';
