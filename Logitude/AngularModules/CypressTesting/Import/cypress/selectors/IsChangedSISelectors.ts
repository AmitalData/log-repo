export class IsChangedSISelectors {
    ...
    public static readonly IsChangeSITHInvoices= '#CustomsDeclarationTHInvoices';
    public static readonly IsChangedSIGeneral = '#GENERAL';
    //public static readonly Edit = '#Edit_3';
    public static readonly Edit ='.LogitudeIconButton:eq(7)';
    public static readonly IsChangedSISupplierInvoice = '#Customs\\.SupplierInvoice_InvoiceAmount';
    public static readonly SaveSupplierInvoic = '#SaveSupplierInvoice';


    
    //public static readonly IsChangedSaveButton = '#CustomsDeclaration-Save';
    public static readonly IsChangedSaveButton = '#CustomsDeclaration-Save_1';
