export class ChequeDepositSelectors {
    public static readonly NewDepositButton = "#NEWDEPOSIT"
    public static readonly AccountingDate = '#date_BankDeposit_AccountingDate';
