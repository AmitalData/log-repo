...
export function FillAPInvoiceDetails(aPInvoiceDetails: APInvoiceDetails) {
    ...
    cy.FillLogLov(APInvoiceSelectors.APInvoiceVendor, aPInvoiceDetails.Vendor, true);
    ...
    cy.FillLogLov(APInvoiceSelectors.APInvoicePaymentTerm,aPInvoiceDetails.PaymentTerm, true)
    cy.FillLogLov(APInvoiceSelectors.APInvoiceBranch,aPInvoiceDetails.BranchId, true)
}
