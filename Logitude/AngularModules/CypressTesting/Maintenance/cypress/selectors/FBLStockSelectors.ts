export class FBLStockSelectors {

  public static readonly MaintenanceItem = "#MaintenanceItemMTFS"
  public static readonly StartNumber = "#StartNumber";
  public static readonly EndNumber = "#EndNumber";
  public static readonly ByEndNumber = "#ByEndNumberRadio";
