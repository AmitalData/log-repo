export class PaymentTermsSelectors {
    ...
    public static readonly LocalName = "#PaymentTerm_LocalName"
    public static readonly Code = "#PaymentTerm_Code"
    public static readonly FromDate = "#PaymentTerm_FromDateTypeCode"
    public static readonly Days = "#PaymentTerm_Days"
