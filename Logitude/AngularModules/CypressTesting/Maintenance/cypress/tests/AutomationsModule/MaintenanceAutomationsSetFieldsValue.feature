...
Feature: Automations Creation and Updating for Set Fields Value Result
    ...
    Scenario: set field value OnUpdate with All conditions are fit
    ...
    Scenario:  set field value OnUpdate when ANY conditions are fit
        Given the user logged in
        And the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
    ...
    Scenario: set field value OnUpdate with one of the ANY conditions is not fit
        Given the user logged in
        And the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
    ...
    Scenario: set field value OnUpdate with no condition of the Any conditions is fit
        Given the user logged in
        And the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
    ...
    Scenario: set field value OnUpdate with one of the All conditions is not fit
        Given the user logged in
        And the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
