...
Feature: Automations Creation and Updating for Follow Up Result
    ...
    #follow up result
    Scenario: Create new automation OnUpdate with FU Creation result and conditions are fit(All conditions)
    ...
    Scenario: Create new automation OnUpdate with FU Creation result and conditions are fit(ANY conditions)
        Given the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
            | Name        | Shipments Automation  |
    ...
    Scenario: Create new automation OnUpdate with FU Creation result and one of the ANY conditions is not fit
        Given the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
            | Name        | Shipments Automation  |
    ...
    Scenario: Create new automation OnUpdate with FU Creation result and no condition of the Any conditions is fit
        Given the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
            | Name        | Shipments Automation  |
    ...
    Scenario: Create new automation OnUpdate with FU Creation result and one of the All conditions is not fit
        Given the user navigates to automations menu
        And the user select "Shipments" as entity
        And the user add automation "OnUpdate" with automation detailes as following
            | Name        | Shipments Automation  |
