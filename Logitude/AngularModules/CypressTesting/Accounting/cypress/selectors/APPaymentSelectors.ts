export class APPaymentSelectors {
    public static readonly NewAPPaymentHyperLink = '#NewAPPayment';
    public static readonly APPaymentVendor = '#APPayment_VendorId';
    public static readonly APPaymentVendorAddress = '#APPayment_VendorAddressId';
