...
Then("the details screen fields should be disabled", () => {
  AccountingActions.AssertAPInvoiceMultipleShipmentsDetailsFieldsDisabled()
});
//#endregion

//#region Cancel the APInvoice approvement
When("cancel the invoice approvement", () => {
  AccountingActions.MultipleShipmentAPInvoiceCancelApproval()
});
...
When("void invoice", () => {
  AccountingActions.VoidMultipleShipmentAPInvoice()
});
