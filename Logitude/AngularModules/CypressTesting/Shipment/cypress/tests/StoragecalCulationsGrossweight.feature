...
Feature: Storage Calculations Gross Weight without Rounding
    ...
    Scenario: Update Warehouse
        ...
        And open warehouse with "Testwarehouse" as name
        And fill with the following details for "CFS" Type
            | Currency | StorageFreeDays |
            | USD      | 2               |
        And "Air" weight details as following
            | Measurement  | Rounding |
            | Gross Weight | None     |
        And pricing defaults line as following
    ...
    Scenario: Create direct export air shipment
        ...
        And a shipment with the following details
            | ShipmentLevel | Direction | TransportMode | Consignee           | MainCarriageFromPort | MainCarriageToPort |
            | direct        | Import    | Air           | TestConsigneeImport | LHR                  | MIA                |
