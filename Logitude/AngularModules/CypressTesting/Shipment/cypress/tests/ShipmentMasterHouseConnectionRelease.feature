...
Feature: Shipment Master House Connection
    ...
    Scenario: Assert house wizerd inside master
    ...
    Scenario: Assert these actions are dim: convert the house to direct and cancel shipment
    ...
    Scenario: Assert these actions are not dim: convert the house to direct and cancel shipment
