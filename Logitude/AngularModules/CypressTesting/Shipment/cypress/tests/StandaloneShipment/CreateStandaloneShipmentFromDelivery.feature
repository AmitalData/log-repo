...
Feature: Create Standalone Shipment From Delivery
    ...
    create standalone shipment when the delivery is FullResponsibility and from partner to partner with different countries,
    create standalone shipment when the delivery is FullResponsibility and from partner to partner with same countries,
    create standalone shipment when the delivery is not FullResponsibility and from partner to partner with same countries
