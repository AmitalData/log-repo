...
Feature: UOM
    ...
    Scenario: Add Payable
        ...
        And a payable with "AFT" as a charges type
        And a  "GWTN" as a UOM
        Then the Quantity should should has "0.5" as a value
    ...
    Scenario: Add Payable
        ...
        And a payable with "AFT" as a charges type
        And a  "GRKG" as a UOM
        Then the Quantity should should has "226.796" as a value
    ...
    Scenario: Add Payable
        ...
        And a payable with "AFT" as a charges type
        And a  "QTY" as a UOM
        Then the Quantity should should has "2" as a value
