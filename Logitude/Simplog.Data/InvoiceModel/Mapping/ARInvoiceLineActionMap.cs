...
{
    public class ARInvoiceLineActionMap : EntityTypeConfiguration<ARInvoiceLineAction>
    {
        public ARInvoiceLineActionMap()
        {
            ...
            this.Property(t => t.LocalName).IsRequired().HasMaxLength(50).IsUnicode(true);
            this.Property(t => t.SearchFields).HasMaxLength(1000).IsUnicode(true);

            this.ToTable("ARInvoiceLineActions");
