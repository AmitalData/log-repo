...
{
    public class ARPaymentTransferStatusMap : EntityTypeConfiguration<ARPaymentTransferStatus>
    {
        public ARPaymentTransferStatusMap()
        {
            ...
            this.ToTable("ARPaymentTransferStatus");
