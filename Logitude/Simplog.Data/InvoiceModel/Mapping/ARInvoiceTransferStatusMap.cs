...
{
    public class ARInvoiceTransferStatusMap : EntityTypeConfiguration<ARInvoiceTransferStatus>
    {
        public ARInvoiceTransferStatusMap()
        {
            ...
            this.ToTable("ARInvoiceTransferStatus");
