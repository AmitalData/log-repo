...
namespace Simplog.Data.QuoteModel.Mapping
{
    ...
    public class QuoteTemplateHeaderFieldMap : EntityTypeConfiguration<QuoteTemplateHeaderField>
    {

        public QuoteTemplateHeaderFieldMap()
        {
           ...
           .IsUnicode(false);
            ...
            this.ToTable("QuoteTemplateHeaderFields");
