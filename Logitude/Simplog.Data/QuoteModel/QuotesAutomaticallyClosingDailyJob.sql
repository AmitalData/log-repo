...
IF OBJECT_ID('[dbo].[usp_QuotesAutomaticallyClosingDailyJob]', 'P') IS NOT NULL
drop PROCEDURE [dbo].[usp_QuotesAutomaticallyClosingDailyJob]
GO

Create PROCEDURE [dbo].[usp_QuotesAutomaticallyClosingDailyJob]
AS
