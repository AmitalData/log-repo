...
,dbo.Customers.RankId, dbo.Customers.LeadSourceId, dbo.Customers.IndustryId
...
ActivatedByUserContacts.EnglishName as ActivatedByUserName, SetAsInactiveByUserContacts.EnglishName as SetAsInactiveByUserName,
