...
namespace Simplog.Data.CommonDataModel.Mapping
{
    public class AccountingSettingMap : EntityTypeConfiguration<AccountingSetting>
    {
        public AccountingSettingMap()
        {
            ...
            this.Property(t => t.QBOAccessToken).HasMaxLength(200);
            this.Property(t => t.QBOAccessTokenSecret).HasMaxLength(200);
           ...
           // this.Property(t => t.RequestedPaymentMethodIsMandatory).HasColumnName("RequestedPaymentMethodIsMandatory");
