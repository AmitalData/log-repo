...
{
    public class ComputingPartnerTranslationMap : EntityTypeConfiguration<ComputingPartnerTranslation>
    {
        public ComputingPartnerTranslationMap()
        {
            ...
            this.Property(t => t.OurCode).IsRequired().HasMaxLength(50).IsUnicode(false);
            ...
            this.Property(t => t.OurCode).HasColumnName("OurCode");
