...
{
    public class TariffCarrierTranslationMap : EntityTypeConfiguration<TariffCarrierTranslation>
    {
        public TariffCarrierTranslationMap()
        {
            this.HasKey(t => t.Id);
            this.Property(t => t.Id).IsRequired().HasMaxLength(15).IsUnicode(false);
            this.Property(t => t.PartnerCode).IsRequired().HasMaxLength(50).IsUnicode(false);
            this.Property(t => t.PortId).IsRequired().HasMaxLength(15).IsUnicode(false);
            this.Property(t => t.CarrierId).IsRequired().HasMaxLength(15).IsUnicode(false);            
            ...
            this.ToTable("TariffCarrierTranslations");
            ...
            this.HasRequired(t => t.Port).WithMany().HasForeignKey(d => d.PortId);
            this.HasRequired(t => t.Carrier).WithMany().HasForeignKey(d => d.CarrierId);
