...
{
    public class ChildEntitiesCustomFieldMap : EntityTypeConfiguration<ChildEntitiesCustomField>
    {
        public ChildEntitiesCustomFieldMap()
        {
            ...
            this.Property(t => t.ChildEntityId).IsRequired().HasMaxLength(15).IsUnicode(false);
            this.Property(t => t.ChildObjectTableId).IsRequired().HasMaxLength(15).IsUnicode(false);
            ...
            this.Property(t => t.ChildObjectTableId).HasColumnName("ChildObjectTableId"); this.Property(t => t.Field1).HasColumnName("Field1");
