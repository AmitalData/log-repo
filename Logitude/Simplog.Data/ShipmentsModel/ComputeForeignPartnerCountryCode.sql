...
IF OBJECT_ID('[dbo].[usp_ComputeForeignPartnerCountryCode]', 'P') IS NOT NULL
drop PROCEDURE [dbo].[usp_ComputeForeignPartnerCountryCode]
GO

Create PROCEDURE [dbo].[usp_ComputeForeignPartnerCountryCode]
(
