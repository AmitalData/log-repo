...
IF OBJECT_ID('[dbo].[usp_UpdateCustomConnectToShipment]', 'P') IS NOT NULL
drop PROCEDURE [dbo].[usp_UpdateCustomConnectToShipment]
GO



Create PROCEDURE [dbo].[usp_UpdateCustomConnectToShipment]
(
