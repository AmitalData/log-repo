...
drop VIEW [dbo].ShipmentFollowUpDataView
go

/****** Object:  View [dbo].[ShipmentFollowUpDataView]    Script Date: 03/27/2014 13:58:58 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[ShipmentFollowUpDataView]
AS
SELECT         dbo.Shipments.Id, dbo.Shipments.Tenant, dbo.Shipments.ShipmentNumber, dbo.Shipments.ShipperReference1, dbo.Shipments.ARInvoiceIssued, dbo.Shipments.CreditNoteIssued,
						 ...
						 dbo.Shipments.NumberOfInsidePackages, dbo.Shipments.NumberOfInsidePackagesDetails, dbo.Shipments.OperationalDate, dbo.Shipments.CutoffDate,
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[40] 4[3] 2[31] 3) )"
      End
      ...
      Begin Tables = 
         ...
         Begin Table = "Transshipment1ToPorts"
            Begin Extent = 
               ...
               Left = 249
               Bottom = 267
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'
         ...
         Begin Table = "ShipperCards"
            Be' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane3', @value=N'gin Extent = 
               Top = 402
               Left = 888
               Bottom = 531
               Right = 1064
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane4', @value=N'   DisplayFlags = 280
            TopColumn = 0
         End
         ...
         Begin Table = "Transshipment3CarrierCards"
            ...
            TopColumn = 0
         End
         Begin Table = "PreCarriageCarrier' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane5', @value=N'Cards"
            Begin Extent = 
               Top = 1062
               Left = 894
               Bottom = 1191
            ...
            TopColumn = 0
         End
         Begin Table = "OnCarriageCarrierCards"
            Begin Extent = 
               Top = 1194
               Left = 38
               Bottom = 1323
         ...
         Begin Table = "MainCarriageAirline"
            Begin Extent = 
               ...
               Right = 419
            End
            Disp' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane6', @value=N'layFlags = 280
            TopColumn = 0
         End
   ...
   End
   Begin DataPane = 
      Begin Paramet' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane7', @value=N'erDefaults = ""
      End
      Begin ColumnWidths = 346
         Width = 284
         Width = 1500
         Width = 1500
         Width = 1500
         ...
         Width = 1500
         Width = 1500
         W' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane8', @value=N'idth = 1500
         Width = 1500
         Width = 1500
         Width = 1500
         Width = 1500
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane9', @value=N'idth = 1500
         Width = 1500
         Width = 1500
         Width = 1500
         Width = 1500
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=9 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ShipmentFollowUpDataView'
GO
