...
namespace Logitude.HybridTest.CommonServices
{
    ...
    public class TenantManagementDWTest
    {
        ...
        public void Test_TenantManagementDW_GetTenantManagements()
        {
            ...
            TenantManagementDW[] tenantManagementDW = (TenantManagementDW[])WcfServiceInvoker.InvokeServiceMethod(serviceProperties, serviceParameters, typeof(TenantManagementDW), ref serviceResponse);
