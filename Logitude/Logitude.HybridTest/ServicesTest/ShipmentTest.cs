...
namespace Logitude.HybridTest.ServicesTest
{
    ...
    public class ShipmentTest
    {
        ...
        public void Test_Shipment_CreateEvent()
        {
            ...
            Response serviceResponse = new Response();
            object[] serviceParameters = new object[] { TestEnvironmentGlobalParameters.Tenant1, null, HybridData.DirectShipmentCode, HybridData.UserIdHU, "CREV", DateTime.Now, DateTime.Now, "Hybrid Test Event" };
            serviceResponse = (Response)WcfServiceInvoker.InvokeServiceMethod(serviceProperties, serviceParameters, ref serviceResponse);
