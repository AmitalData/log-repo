...
namespace Logitude.TariffModule.BL.EntityDataMappings
{
   ...
   public partial class TariffProductDataMapping: IMapping<TariffProductPM, TariffProduct>,IMappingEncodeBase64NVARCHARFields<TariffProductPM>
   {
	    ...
	    public void PMToPOCO(TariffProductPM entityPM, TariffProduct entityPOCO)
        {
		...
		public void POCOToPM(TariffProductPM entityPM, TariffProduct entityPOCO)
        {
		...
		public void PMToOldPM(TariffProductPM entityPM, TariffProductPM oldEntityPM)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TariffProductPM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TariffProductPM entityPM, TariffProduct entityPOCO, bool isNewEntity)
        {
