...
namespace Logitude.TariffModule.BL.EntityDataMappings
{
   ...
   public partial class TariffTypeDataMapping: IMapping<TariffTypePM, TariffType>,IMappingEncodeBase64NVARCHARFields<TariffTypePM>
   {
	    ...
	    public void PMToPOCO(TariffTypePM entityPM, TariffType entityPOCO)
        {
		...
		public void POCOToPM(TariffTypePM entityPM, TariffType entityPOCO)
        {
	    ...
	    public void EncodeBase64NVARCHARFields(TariffTypePM entityPM)
        {
		...
		private void BuildSearchFieldsGenerated(TariffTypePM entityPM, TariffType entityPOCO, bool isNewEntity)
        {
