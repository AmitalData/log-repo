...
{
    public partial class TariffModuleValidationClass : ITariffModuleValidationClass
    {
        ...
        public TariffModuleValidationClass(string objectTableName, int tenant)
        {
            this.tenant = tenant;
        ...
        public string GetErrorMessage(object value, object instance, string propertyName)
        {
            ...
            if (field.IsRequiered)
            {
                ...
                if (value == null)
                {
                    error = TariffModuleTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", field.FullNameTextCode.Code, null, null, field.Tenant);
                }
            ...
            if (field.DataTypeCode == "Text")
            {
                ...
                {
                    error = TariffModuleTranslateTextsClass.GetTranslation("General.M.MinMax", field.FullNameTextCode.Code, field.MinLength.ToString(), field.MaxLength.ToString(), field.Tenant);
                }
            }
        ...
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            ...
            /* by islam
             */
            Validators.TariffModuleValidationClass temp = new Validators.TariffModuleValidationClass(objectTableName, tenant);
    ...
    interface ITariffModuleValidationClass
    {
