...
namespace Logitude.TariffModule.BL.Validators
{
    public partial class TariffModuleClassLevelValidator : ITariffModuleClassLevelValidator
    {
        int tenant;
        ...
        public TariffModuleClassLevelValidator(string objectTableName, int tenant)
        {
            ...
            foreach (ObjectField objectfeildprop in objectFieldList)
            {
                ...
                if (propertyInf != null)
                {
                    ...
                    if (objectfeildprop.IsRequiered)
                    {
                        ...
                        {
                            requiredError = requiredError + "," + TariffModuleTranslateTextsClass.GetTranslation("General.M.FieldIsRequired", objectfeildprop.FullNameTextCode.Code, null, null, objectfeildprop.Tenant);
                        }
        ...
        public static ValidationResult ValidateClass(object value, ValidationContext context)
        {
            if (value != null)
            {
                ...
                TariffModuleClassLevelValidator temp = new TariffModuleClassLevelValidator(objectTableName, tenant);
    ...
    public interface ITariffModuleClassLevelValidator
    {
