...
namespace Logitude.DatabaseMigration.LogitudeModel
{
    public class LogitudeMigrationContext : DbContext
    {
        public LogitudeMigrationContext()
            : base("LogitudeStr")
        {
            Database.CommandTimeout = 5; // migration timeout
        ...
        public static LogitudeMigrationContext GetContext()
        {
            DbConnection connection = DatabaseInitializer.GetConnection("LogitudeMainFirtsTestDB;sa;Saas256;.");
            LogitudeMigrationContext context = new LogitudeMigrationContext(connection);
            return context;
        }
        ...
        public IDbSet<TemperatureUnit> TemperatureUnit
        {
            get;
            set;
        }
        ...
        public IDbSet<GLAccountWithholdingTax> GLAccountWithholdingTaxes
        {
            get;
            set;
        }
        ...
        public IDbSet<GLAccountMoreData> GLAccountMoreDatas { get; set; }
        ...
        public IDbSet<TaxReport> TaxReports { get; set; }
        public IDbSet<TaxReportLine> TaxReportLines { get; set; }
        ...
        public IDbSet<TMRelease> TMReleases
        {
            get;
            set;
        ...
        public IDbSet<TMProjectCategory> TMProjectCategories
        {
            get;
            set;
