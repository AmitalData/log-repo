namespace Logitude.DatabaseMigration.Migrations
{
    ...
    public partial class adding_Metadata_StoredProcedures : DbMigration
    {
...
End");
            ...
            Sql(@"IF OBJECT_ID('[dbo].[usp_PreDeleteMetadata]', 'P') IS NOT NULL
...
from (select *
        ...
        End");
            ...
            Sql(@"IF OBJECT_ID('[dbo].[usp_ReconnectObjectTableMetadata]', 'P') IS NOT NULL
