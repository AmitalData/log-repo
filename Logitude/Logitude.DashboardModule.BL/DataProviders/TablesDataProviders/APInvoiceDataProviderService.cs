...
namespace Logitude.DashboardModule.BL.DataProviders.TablesDataProviders
{
    public class APInvoiceDataProviderService : BaseTablesDataProvider
    {
        ...
        public APInvoiceDataProviderService(WidgetPM widget, AnalyticsFactsMetaData entity) : base(widget, entity)
        {
        ...
        public override List<SeriesMeasure> GetChartData()
        {
            ...
            APInvoiceAnalyticIQueryable = APInvoiceAnalyticIQueryable.Where(e => e.Tenant == _Widget.Tenant);
        ...
        public override KpiChart GetKpiData()
        {
            ...
            APInvoiceAnalyticIQueryable = APInvoiceAnalyticIQueryable.Where(e => e.Tenant == _Widget.Tenant);
            return new KpiDataProviderService(_Widget, _Entity).GetData(APInvoiceAnalyticIQueryable);
        }
    }
}
