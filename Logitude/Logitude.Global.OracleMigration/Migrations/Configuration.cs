namespace Logitude.Global.OracleMigration.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Logitude.Global.OracleMigration.GlobalModel.GlobalContext>
    {
        public Configuration()
        {
            ...
            var connectionInfo =
                ...
                "User Id=AMINETCST_GLOBAL;  Password=AMINETCST_GLOBAL;Direct=True;Data Source=localhost;port=1521;sid=amital"
                );
        ...
        protected override void Seed(Logitude.Global.OracleMigration.GlobalModel.GlobalContext context)
        {
